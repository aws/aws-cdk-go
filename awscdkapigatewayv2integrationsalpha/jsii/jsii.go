...
//go:embed aws-cdk-aws-apigatewayv2-integrations-alpha-2.103.0-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-cdk/aws-apigatewayv2-integrations-alpha", "2.103.0-alpha.0", tarball)
}
