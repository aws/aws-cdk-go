...
import (
	...
	awscdkawsapigatewayv2alpha "github.com/aws/aws-cdk-go/awscdkawsapigatewayv2alpha/v2/jsii"
	constructs                 "github.com/aws/constructs-go/constructs/v10/jsii"
)

//go:embed aws-cdk-aws-apigatewayv2-integrations-alpha-2.0.0-alpha.1.tgz
var tarball []byte
...
func Initialize() {
	...
	awscdkawsapigatewayv2alpha.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-cdk/aws-apigatewayv2-integrations-alpha", "2.0.0-alpha.1", tarball)
}
