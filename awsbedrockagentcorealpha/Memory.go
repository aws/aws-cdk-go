...
//   var role Role
//
//   memory := bedrock_agentcore_alpha.NewMemory(this, jsii.String("MyMemory"), &MemoryProps{
...
func (m *jsiiProxy_Memory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
