...
func (j *jsiiProxy_RuntimeEndpoint) Env() *interfaces.ResourceEnvironment {
...
func (r *jsiiProxy_RuntimeEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
