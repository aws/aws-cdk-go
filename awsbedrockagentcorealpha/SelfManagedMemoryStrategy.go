...
//   var topic Topic
//
//   selfManagedMemoryStrategy := bedrock_agentcore_alpha.NewSelfManagedMemoryStrategy(bedrock_agentcore_alpha.MemoryStrategyType_SUMMARIZATION, &SelfManagedStrategyProps{
