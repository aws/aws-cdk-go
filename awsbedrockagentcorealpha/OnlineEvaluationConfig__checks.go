...
func (o *jsiiProxy_OnlineEvaluationConfig) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateOnlineEvaluationConfig_FromOnlineEvaluationConfigArnParameters(scope constructs.Construct, id *string, onlineEvaluationConfigArn *string) error {
	...
	if onlineEvaluationConfigArn == nil {
		return fmt.Errorf("parameter onlineEvaluationConfigArn is required, but nil was provided")
	}
...
func validateOnlineEvaluationConfig_FromOnlineEvaluationConfigIdParameters(scope constructs.Construct, id *string, onlineEvaluationConfigId *string) error {
	...
	if onlineEvaluationConfigId == nil {
		return fmt.Errorf("parameter onlineEvaluationConfigId is required, but nil was provided")
	}
