...
import (
	...
	awsbedrockalpha "github.com/aws/aws-cdk-go/awsbedrockalpha/v2/jsii"
	awscdk          "github.com/aws/aws-cdk-go/awscdk/v2/jsii"
	constructs      "github.com/aws/constructs-go/constructs/v10/jsii"
)

//go:embed aws-cdk-aws-bedrock-agentcore-alpha-2.226.0-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awsbedrockalpha.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-cdk/aws-bedrock-agentcore-alpha", "2.226.0-alpha.0", tarball)
}
