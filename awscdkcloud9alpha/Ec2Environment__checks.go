...
func (e *jsiiProxy_Ec2Environment) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateEc2Environment_FromEc2EnvironmentNameParameters(scope constructs.Construct, id *string, ec2EnvironmentName *string) error {
	...
	if ec2EnvironmentName == nil {
		return fmt.Errorf("parameter ec2EnvironmentName is required, but nil was provided")
	}
