...
func (j *jsiiProxy_Ec2Environment) Env() *interfaces.ResourceEnvironment {
...
func (e *jsiiProxy_Ec2Environment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_Ec2Environment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
