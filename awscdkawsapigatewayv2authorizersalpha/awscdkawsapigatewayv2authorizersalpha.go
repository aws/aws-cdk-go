...
import (
	_init_ "github.com/aws/aws-cdk-go/awscdkawsapigatewayv2authorizersalpha/v2/jsii"
	...
	"github.com/aws/aws-cdk-go/awscdkawsapigatewayv2authorizersalpha/v2/internal"
)
...
type HttpJwtAuthorizer interface {
	awscdkawsapigatewayv2alpha.IHttpRouteAuthorizer
	Bind(options *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerBindOptions) *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig
}

// The jsii proxy struct for HttpJwtAuthorizer
type jsiiProxy_HttpJwtAuthorizer struct {
	internal.Type__awscdkawsapigatewayv2alphaIHttpRouteAuthorizer
}
...
// Experimental.
func (h *jsiiProxy_HttpJwtAuthorizer) Bind(options *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerBindOptions) *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig {
	var returns *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig
...
// (experimental) Bind this authorizer to a specified Http route.
// Experimental.
func (h *jsiiProxy_HttpLambdaAuthorizer) Bind(options *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerBindOptions) *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig {
	var returns *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig
...
// (experimental) Bind this authorizer to a specified Http route.
// Experimental.
func (h *jsiiProxy_HttpUserPoolAuthorizer) Bind(options *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerBindOptions) *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig {
	var returns *awscdkawsapigatewayv2alpha.HttpRouteAuthorizerConfig
