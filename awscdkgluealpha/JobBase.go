...
func (j *jsiiProxy_JobBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_JobBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (j *jsiiProxy_JobBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
