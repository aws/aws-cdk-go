...
func (s *jsiiProxy_SecurityConfiguration) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateSecurityConfiguration_FromSecurityConfigurationNameParameters(scope constructs.Construct, id *string, securityConfigurationName *string) error {
	...
	if securityConfigurationName == nil {
		return fmt.Errorf("parameter securityConfigurationName is required, but nil was provided")
	}
