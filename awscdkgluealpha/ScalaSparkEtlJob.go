...
func (s *jsiiProxy_ScalaSparkEtlJob) CheckNoReservedArgs(defaultArguments *map[string]*string) *map[string]*string {
...
func (s *jsiiProxy_ScalaSparkEtlJob) NonExecutableCommonArguments(props *SparkJobProps) *map[string]*string {
...
func (s *jsiiProxy_ScalaSparkEtlJob) SetupContinuousLogging(role awsiam.IRole, props *ContinuousLoggingProps) interface{} {
...
func (s *jsiiProxy_ScalaSparkEtlJob) SetupExtraCodeArguments(args *map[string]*string, props *SparkExtraCodeProps) {
