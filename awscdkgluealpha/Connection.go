...
func (j *jsiiProxy_Connection) Env() *interfaces.ResourceEnvironment {
...
func Connection_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-glue-alpha.Connection",
...
func (c *jsiiProxy_Connection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
