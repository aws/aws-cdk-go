...
func (d *jsiiProxy_Database) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateDatabase_FromDatabaseArnParameters(scope constructs.Construct, id *string, databaseArn *string) error {
	...
	if databaseArn == nil {
		return fmt.Errorf("parameter databaseArn is required, but nil was provided")
	}
