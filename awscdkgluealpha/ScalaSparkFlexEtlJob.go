...
func (s *jsiiProxy_ScalaSparkFlexEtlJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ScalaSparkFlexEtlJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
