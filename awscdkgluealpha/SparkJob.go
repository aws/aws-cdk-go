...
func (j *jsiiProxy_SparkJob) JobRef() *interfacesawsglue.JobReference {
...
func (s *jsiiProxy_SparkJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SparkJob) MergeDefaultArguments(defaultArguments *map[string]*string) *map[string]*string {
...
func (s *jsiiProxy_SparkJob) NonExecutableCommonArguments(props *SparkJobProps) {
...
func (s *jsiiProxy_SparkJob) SetManagedArgument(key *string, value *string) {
...
func (s *jsiiProxy_SparkJob) SetupContinuousLogging(role awsiam.IRole, props *ContinuousLoggingProps, securityConfiguration ISecurityConfiguration) {
...
func (s *jsiiProxy_SparkJob) SetupExtraCodeArguments(props *SparkExtraCodeProps) {
