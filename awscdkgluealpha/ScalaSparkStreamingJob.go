...
func (j *jsiiProxy_ScalaSparkStreamingJob) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ScalaSparkStreamingJob) JobRef() *interfacesawsglue.JobReference {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) MergeDefaultArguments(defaultArguments *map[string]*string) *map[string]*string {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) NonExecutableCommonArguments(props *SparkJobProps) {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) SetManagedArgument(key *string, value *string) {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) SetupContinuousLogging(role awsiam.IRole, props *ContinuousLoggingProps, securityConfiguration ISecurityConfiguration) {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) SetupExtraCodeArguments(props *SparkExtraCodeProps) {
...
func (s *jsiiProxy_ScalaSparkStreamingJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
