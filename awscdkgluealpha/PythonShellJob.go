...
// The jsii proxy struct for PythonShellJob
type jsiiProxy_PythonShellJob struct {
	jsiiProxy_Job
}

func (j *jsiiProxy_PythonShellJob) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_PythonShellJob) GrantPrincipal() awsiam.IPrincipal {
...
func (j *jsiiProxy_PythonShellJob) JobArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobArn",
...
func (j *jsiiProxy_PythonShellJob) JobName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobName",
...
func (j *jsiiProxy_PythonShellJob) Node() constructs.Node {
...
func (j *jsiiProxy_PythonShellJob) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_PythonShellJob) Role() awsiam.IRole {
...
func (j *jsiiProxy_PythonShellJob) Stack() awscdk.Stack {
...
func NewPythonShellJob(scope constructs.Construct, id *string, props *PythonShellJobProps) PythonShellJob {
	...
	if err := validateNewPythonShellJobParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// Experimental.
func PythonShellJob_FromJobAttributes(scope constructs.Construct, id *string, attrs *JobAttributes) IJob {
	_init_.Initialize()

	if err := validatePythonShellJob_FromJobAttributesParameters(scope, id, attrs); err != nil {
		panic(err)
	}
	var returns IJob
...
func PythonShellJob_IsConstruct(x interface{}) *bool {
	...
	if err := validatePythonShellJob_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PythonShellJob_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePythonShellJob_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PythonShellJob_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePythonShellJob_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PythonShellJob_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-glue-alpha.PythonShellJob",
...
func (p *jsiiProxy_PythonShellJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PythonShellJob) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (p *jsiiProxy_PythonShellJob) BuildJobArn(scope constructs.Construct, jobName *string) *string {
...
func (p *jsiiProxy_PythonShellJob) GeneratePhysicalName() *string {
	var returns *string
...
func (p *jsiiProxy_PythonShellJob) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (p *jsiiProxy_PythonShellJob) GetResourceNameAttribute(nameAttr *string) *string {
...
func (p *jsiiProxy_PythonShellJob) Metric(metricName *string, type_ MetricType, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (p *jsiiProxy_PythonShellJob) MetricFailure(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (p *jsiiProxy_PythonShellJob) MetricSuccess(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (p *jsiiProxy_PythonShellJob) MetricTimeout(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (p *jsiiProxy_PythonShellJob) OnEvent(id *string, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (p *jsiiProxy_PythonShellJob) OnFailure(id *string, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (p *jsiiProxy_PythonShellJob) OnStateChange(id *string, jobState JobState, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (p *jsiiProxy_PythonShellJob) OnSuccess(id *string, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (p *jsiiProxy_PythonShellJob) OnTimeout(id *string, options *awsevents.OnEventOptions) awsevents.Rule {
...
func (p *jsiiProxy_PythonShellJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
