...
func (j *jsiiProxy_Database) Env() *interfaces.ResourceEnvironment {
...
func Database_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-glue-alpha.Database",
...
func (d *jsiiProxy_Database) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
