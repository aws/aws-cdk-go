...
func (p *jsiiProxy_PySparkFlexEtlJob) CheckNoReservedArgs(defaultArguments *map[string]*string) *map[string]*string {
...
func (p *jsiiProxy_PySparkFlexEtlJob) NonExecutableCommonArguments(props *SparkJobProps) *map[string]*string {
...
func (p *jsiiProxy_PySparkFlexEtlJob) SetupContinuousLogging(role awsiam.IRole, props *ContinuousLoggingProps) interface{} {
...
func (p *jsiiProxy_PySparkFlexEtlJob) SetupExtraCodeArguments(args *map[string]*string, props *SparkExtraCodeProps) {
