...
func (w *jsiiProxy_WorkflowBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WorkflowBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
