...
// The jsii proxy struct for TransitGatewayBlackholeRoute
type jsiiProxy_TransitGatewayBlackholeRoute struct {
	internal.Type__awscdkResource
	jsiiProxy_ITransitGatewayRoute
}

func (j *jsiiProxy_TransitGatewayBlackholeRoute) DestinationCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransitGatewayBlackholeRoute) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_TransitGatewayBlackholeRoute) Node() constructs.Node {
...
func (j *jsiiProxy_TransitGatewayBlackholeRoute) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_TransitGatewayBlackholeRoute) RouteTable() ITransitGatewayRouteTable {
...
func (j *jsiiProxy_TransitGatewayBlackholeRoute) Stack() awscdk.Stack {
...
func NewTransitGatewayBlackholeRoute(scope constructs.Construct, id *string, props *TransitGatewayBlackholeRouteProps) TransitGatewayBlackholeRoute {
	...
	if err := validateNewTransitGatewayBlackholeRouteParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func TransitGatewayBlackholeRoute_IsConstruct(x interface{}) *bool {
	...
	if err := validateTransitGatewayBlackholeRoute_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func TransitGatewayBlackholeRoute_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateTransitGatewayBlackholeRoute_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func TransitGatewayBlackholeRoute_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateTransitGatewayBlackholeRoute_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) GeneratePhysicalName() *string {
	var returns *string
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) GetResourceNameAttribute(nameAttr *string) *string {
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TransitGatewayBlackholeRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
