...
func (j *jsiiProxy_VPCPeeringConnection) Env() *interfaces.ResourceEnvironment {
...
func (v *jsiiProxy_VPCPeeringConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
