...
func (j *jsiiProxy_TransitGateway) Env() *interfaces.ResourceEnvironment {
...
func (t *jsiiProxy_TransitGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TransitGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
