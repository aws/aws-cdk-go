...
func (j *jsiiProxy_VpcV2) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_VpcV2) VpcRef() *interfacesawsec2.VPCReference {
...
func (v *jsiiProxy_VpcV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
