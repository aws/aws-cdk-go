...
func (j *jsiiProxy_VpcV2Base) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_VpcV2Base) InternetGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"internetGatewayId",
...
func (j *jsiiProxy_VpcV2Base) VpcName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcName",
...
func (j *jsiiProxy_VpcV2Base) VpcRef() *interfacesawsec2.VPCReference {
...
func (v *jsiiProxy_VpcV2Base) AddEgressOnlyInternetGateway(options *EgressOnlyInternetGatewayOptions) EgressOnlyInternetGateway {
...
func (v *jsiiProxy_VpcV2Base) AddInternetGateway(options *InternetGatewayOptions) InternetGateway {
...
func (v *jsiiProxy_VpcV2Base) AddNatGateway(options *NatGatewayOptions) NatGateway {
...
func (v *jsiiProxy_VpcV2Base) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VpcV2Base) EnableVpnGatewayV2(options *VPNGatewayV2Options) VPNGatewayV2 {
...
func (v *jsiiProxy_VpcV2Base) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
