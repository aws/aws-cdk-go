...
func (j *jsiiProxy_NatGateway) Eip() awsec2.CfnEIP {
...
func (j *jsiiProxy_NatGateway) Env() *interfaces.ResourceEnvironment {
...
func (n *jsiiProxy_NatGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
