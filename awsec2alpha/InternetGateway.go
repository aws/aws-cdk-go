...
func (j *jsiiProxy_InternetGateway) Env() *interfaces.ResourceEnvironment {
...
func (i *jsiiProxy_InternetGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
