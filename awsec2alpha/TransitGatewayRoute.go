...
type jsiiProxy_TransitGatewayRoute struct {
	...
	jsiiProxy_ITransitGatewayRoute
}

func (j *jsiiProxy_TransitGatewayRoute) DestinationCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TransitGatewayRoute) Env() *interfaces.ResourceEnvironment {
...
func (t *jsiiProxy_TransitGatewayRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TransitGatewayRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
