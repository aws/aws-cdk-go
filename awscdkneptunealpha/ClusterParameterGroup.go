...
func (j *jsiiProxy_ClusterParameterGroup) Env() *interfaces.ResourceEnvironment {
...
func ClusterParameterGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-neptune-alpha.ClusterParameterGroup",
...
func (c *jsiiProxy_ClusterParameterGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_ClusterParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
