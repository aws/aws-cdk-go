...
import (
	...
	awsmediapackagev2alpha "github.com/aws/aws-cdk-go/awsmediapackagev2alpha/v2/jsii"
	constructs             "github.com/aws/constructs-go/constructs/v10/jsii"
)

//go:embed aws-cdk-aws-medialive-alpha-2.268.0-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awsmediapackagev2alpha.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-cdk/aws-medialive-alpha", "2.268.0-alpha.0", tarball)
}
