...
func (j *jsiiProxy_Cluster) ClusterChannelIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"clusterChannelIds",
...
func (j *jsiiProxy_Cluster) ClusterRef() *interfacesawsmedialive.ClusterReference {
...
func (j *jsiiProxy_Cluster) ClusterState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterState",
...
func NewCluster(scope constructs.Construct, id *string, props *ClusterProps) Cluster {
	...
	_jsii_.Create(
		"@aws-cdk/aws-medialive-alpha.Cluster",
