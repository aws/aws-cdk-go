...
//
// Experimental.
type MediaPackageV2OutputGroupProps struct {
	...
	//
	// MediaLive maps the channel pipelines to the
	// channel's ingest endpoints automatically based on the channel class.
	// Experimental.
	Channel awsmediapackagev2alpha.IChannel `field:"required" json:"channel" yaml:"channel"`
}
