...
//
// Experimental.
type H265Profile interface {
	// The underlying string value passed to CloudFormation.
	// Experimental.
	Value() *string
}

// The jsii proxy struct for H265Profile
type jsiiProxy_H265Profile struct {
	_ byte // padding
}

func (j *jsiiProxy_H265Profile) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
...
// Experimental.
func H265Profile_Of(value *string) H265Profile {
	_init_.Initialize()

	if err := validateH265Profile_OfParameters(value); err != nil {
		panic(err)
	}
	var returns H265Profile

	_jsii_.StaticInvoke(
		"@aws-cdk/aws-medialive-alpha.H265Profile",
		"of",
		[]interface{}{value},
		&returns,
	)
...
func H265Profile_MAIN() H265Profile {
	_init_.Initialize()
	var returns H265Profile
	_jsii_.StaticGet(
		"@aws-cdk/aws-medialive-alpha.H265Profile",
...
func H265Profile_MAIN_10BIT() H265Profile {
	_init_.Initialize()
	var returns H265Profile
	_jsii_.StaticGet(
		"@aws-cdk/aws-medialive-alpha.H265Profile",
