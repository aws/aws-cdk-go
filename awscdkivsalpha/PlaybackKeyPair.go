...
func (p *jsiiProxy_PlaybackKeyPair) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PlaybackKeyPair) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
