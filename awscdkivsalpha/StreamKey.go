...
func (j *jsiiProxy_StreamKey) Env() *interfaces.ResourceEnvironment {
...
func (s *jsiiProxy_StreamKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_StreamKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
