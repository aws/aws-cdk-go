...
func (s *jsiiProxy_StreamKey) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func validateStreamKey_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	return nil
}

func validateStreamKey_IsResourceParameters(construct constructs.IConstruct) error {
	return nil
}
