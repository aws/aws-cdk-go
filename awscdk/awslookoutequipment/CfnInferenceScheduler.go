...
func (j *jsiiProxy_CfnInferenceScheduler) CfnPropertyNames() *map[string]*string {
...
func CfnInferenceScheduler_IsCfnInferenceScheduler(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnInferenceScheduler_IsCfnInferenceSchedulerParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInferenceScheduler) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceScheduler) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInferenceScheduler) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInferenceScheduler) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInferenceScheduler) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInferenceScheduler) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceScheduler) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceScheduler) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceScheduler) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
