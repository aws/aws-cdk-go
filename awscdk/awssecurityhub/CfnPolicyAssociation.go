...
func (j *jsiiProxy_CfnPolicyAssociation) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnPolicyAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPolicyAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPolicyAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPolicyAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
