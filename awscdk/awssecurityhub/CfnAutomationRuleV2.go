...
func (j *jsiiProxy_CfnAutomationRuleV2) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAutomationRuleV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAutomationRuleV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAutomationRuleV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAutomationRuleV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomationRuleV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
