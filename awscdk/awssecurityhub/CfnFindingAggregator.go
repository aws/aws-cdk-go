...
//
//   cfnFindingAggregator := awscdk.Aws_securityhub.NewCfnFindingAggregator(this, jsii.String("MyCfnFindingAggregator"), &CfnFindingAggregatorProps{
...
func (j *jsiiProxy_CfnFindingAggregator) AttrFindingAggregatorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFindingAggregator) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnFindingAggregator) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnFindingAggregator) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFindingAggregator) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnFindingAggregator) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnFindingAggregator) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnFindingAggregator) Node() constructs.Node {
...
func (j *jsiiProxy_CfnFindingAggregator) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnFindingAggregator) RegionLinkingMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionLinkingMode",
...
func (j *jsiiProxy_CfnFindingAggregator) Regions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regions",
...
func (j *jsiiProxy_CfnFindingAggregator) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnFindingAggregator) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnFindingAggregator) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFindingAggregator(scope constructs.Construct, id *string, props *CfnFindingAggregatorProps) CfnFindingAggregator {
	...
	if err := validateNewCfnFindingAggregatorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFindingAggregator)SetRegionLinkingMode(val *string) {
...
func (j *jsiiProxy_CfnFindingAggregator)SetRegions(val *[]*string) {
	_jsii_.Set(
		j,
		"regions",
		val,
...
func CfnFindingAggregator_ArnForFindingAggregator(resource interfacesawssecurityhub.IFindingAggregatorRef) *string {
	_init_.Initialize()

	if err := validateCfnFindingAggregator_ArnForFindingAggregatorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFindingAggregator_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFindingAggregator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFindingAggregator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFindingAggregator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFindingAggregator_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFindingAggregator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFindingAggregator_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_securityhub.CfnFindingAggregator",
...
func (c *jsiiProxy_CfnFindingAggregator) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnFindingAggregator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFindingAggregator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFindingAggregator) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnFindingAggregator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFindingAggregator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFindingAggregator) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnFindingAggregator) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnFindingAggregator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFindingAggregator) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnFindingAggregator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingAggregator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingAggregator) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnFindingAggregator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingAggregator) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnFindingAggregator) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnFindingAggregator) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnFindingAggregator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
