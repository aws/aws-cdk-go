...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrIssues", GoGetter: "AttrIssues"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawssecurityhubIConnectorRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnector.AzureProviderConfigurationProperty",
		reflect.TypeOf((*CfnConnector_AzureProviderConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnector.AzureScopeConfigurationProperty",
		reflect.TypeOf((*CfnConnector_AzureScopeConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnector.HealthIssueProperty",
		reflect.TypeOf((*CfnConnector_HealthIssueProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnector.ProviderProperty",
		reflect.TypeOf((*CfnConnector_ProviderProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnectorProps",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnectorV2.AzureProviderConfigurationProperty",
		reflect.TypeOf((*CfnConnectorV2_AzureProviderConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnectorV2.AzureScopeConfigurationProperty",
		reflect.TypeOf((*CfnConnectorV2_AzureScopeConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityhub.CfnConnectorV2.HealthIssueProperty",
		reflect.TypeOf((*CfnConnectorV2_HealthIssueProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
