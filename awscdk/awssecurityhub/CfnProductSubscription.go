...
func (j *jsiiProxy_CfnProductSubscription) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnProductSubscription) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnProductSubscription) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProductSubscription) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnProductSubscription) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnProductSubscription) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnProductSubscription) Node() constructs.Node {
...
func (j *jsiiProxy_CfnProductSubscription) ProductArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"productArn",
...
func (j *jsiiProxy_CfnProductSubscription) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnProductSubscription) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnProductSubscription) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnProductSubscription) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnProductSubscription(scope constructs.Construct, id *string, props *CfnProductSubscriptionProps) CfnProductSubscription {
	...
	if err := validateNewCfnProductSubscriptionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnProductSubscription)SetProductArn(val *string) {
...
func CfnProductSubscription_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProductSubscription_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProductSubscription_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProductSubscription_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProductSubscription_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProductSubscription_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProductSubscription) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnProductSubscription) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProductSubscription) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProductSubscription) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnProductSubscription) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnProductSubscription) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnProductSubscription) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnProductSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProductSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProductSubscription) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnProductSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProductSubscription) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProductSubscription) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnProductSubscription) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnProductSubscription) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProductSubscription) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnProductSubscription) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProductSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProductSubscription) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnProductSubscription) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProductSubscription) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnProductSubscription) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnProductSubscription) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnProductSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
