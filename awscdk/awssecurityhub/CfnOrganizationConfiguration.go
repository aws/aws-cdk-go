...
//
//   cfnOrganizationConfiguration := awscdk.Aws_securityhub.NewCfnOrganizationConfiguration(this, jsii.String("MyCfnOrganizationConfiguration"), &CfnOrganizationConfigurationProps{
...
func (j *jsiiProxy_CfnOrganizationConfiguration) AttrOrganizationConfigurationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOrganizationConfiguration) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) AutoEnable() interface{} {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) AutoEnableStandards() *string {
	var returns *string
	_jsii_.Get(
		j,
		"autoEnableStandards",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) ConfigurationType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configurationType",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOrganizationConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOrganizationConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOrganizationConfiguration(scope constructs.Construct, id *string, props *CfnOrganizationConfigurationProps) CfnOrganizationConfiguration {
	...
	if err := validateNewCfnOrganizationConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOrganizationConfiguration)SetAutoEnable(val interface{}) {
...
func (j *jsiiProxy_CfnOrganizationConfiguration)SetAutoEnableStandards(val *string) {
	_jsii_.Set(
		j,
		"autoEnableStandards",
		val,
...
func (j *jsiiProxy_CfnOrganizationConfiguration)SetConfigurationType(val *string) {
	_jsii_.Set(
		j,
		"configurationType",
		val,
...
func CfnOrganizationConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganizationConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganizationConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganizationConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_securityhub.CfnOrganizationConfiguration",
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOrganizationConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOrganizationConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOrganizationConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
