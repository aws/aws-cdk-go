...
func (j *jsiiProxy_CfnInsight) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInsight) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInsight) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInsight) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInsight) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInsight) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
