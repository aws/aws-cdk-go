...
//
//   cfnSecurityControl := awscdk.Aws_securityhub.NewCfnSecurityControl(this, jsii.String("MyCfnSecurityControl"), &CfnSecurityControlProps{
...
func (j *jsiiProxy_CfnSecurityControl) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSecurityControl) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityControl) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSecurityControl) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSecurityControl) LastUpdateReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastUpdateReason",
...
func (j *jsiiProxy_CfnSecurityControl) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSecurityControl) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSecurityControl) Parameters() interface{} {
...
func (j *jsiiProxy_CfnSecurityControl) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSecurityControl) SecurityControlArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityControlArn",
...
func (j *jsiiProxy_CfnSecurityControl) SecurityControlId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityControlId",
...
func (j *jsiiProxy_CfnSecurityControl) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSecurityControl) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSecurityControl) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityControl(scope constructs.Construct, id *string, props *CfnSecurityControlProps) CfnSecurityControl {
	...
	if err := validateNewCfnSecurityControlParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSecurityControl)SetLastUpdateReason(val *string) {
	_jsii_.Set(
		j,
		"lastUpdateReason",
		val,
...
func (j *jsiiProxy_CfnSecurityControl)SetParameters(val interface{}) {
...
func (j *jsiiProxy_CfnSecurityControl)SetSecurityControlArn(val *string) {
	_jsii_.Set(
		j,
		"securityControlArn",
		val,
...
func (j *jsiiProxy_CfnSecurityControl)SetSecurityControlId(val *string) {
	_jsii_.Set(
		j,
		"securityControlId",
		val,
...
func CfnSecurityControl_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityControl_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityControl_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityControl_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityControl_IsCfnSecurityControl(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityControl_IsCfnSecurityControlParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityControl_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityControl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityControl_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_securityhub.CfnSecurityControl",
...
func (c *jsiiProxy_CfnSecurityControl) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSecurityControl) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityControl) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityControl) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityControl) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityControl) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSecurityControl) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityControl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityControl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityControl) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSecurityControl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityControl) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityControl) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSecurityControl) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSecurityControl) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityControl) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSecurityControl) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityControl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityControl) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSecurityControl) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityControl) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityControl) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSecurityControl) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSecurityControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
