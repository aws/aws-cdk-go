...
//
//   cfnConnector := awscdk.Aws_securityhub.NewCfnConnector(this, jsii.String("MyCfnConnector"), &CfnConnectorProps{
...
type CfnConnector interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssecurityhub.IConnectorRef
	awscdk.ITaggableV2
	...
	ConnectorRef() *interfacesawssecurityhub.ConnectorReference
...
type jsiiProxy_CfnConnector struct {
	...
	internal.Type__interfacesawssecurityhubIConnectorRef
...
func (j *jsiiProxy_CfnConnector) AttrConnectorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrConnectorId",
...
func (j *jsiiProxy_CfnConnector) AttrConnectorStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrConnectorStatus",
...
func (j *jsiiProxy_CfnConnector) AttrCreatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedBy",
...
func (j *jsiiProxy_CfnConnector) AttrIssues() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnConnector) AttrLastCheckedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastCheckedAt",
...
func (j *jsiiProxy_CfnConnector) AttrMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMessage",
...
func (j *jsiiProxy_CfnConnector) ConnectorRef() *interfacesawssecurityhub.ConnectorReference {
	var returns *interfacesawssecurityhub.ConnectorReference
	_jsii_.Get(
		j,
		"connectorRef",
		&returns,
...
func (j *jsiiProxy_CfnConnector) Provider() interface{} {
...
func (j *jsiiProxy_CfnConnector) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func NewCfnConnector(scope constructs.Construct, id *string, props *CfnConnectorProps) CfnConnector {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_securityhub.CfnConnector",
...
func (j *jsiiProxy_CfnConnector)SetProvider(val interface{}) {
...
func (j *jsiiProxy_CfnConnector)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnConnector_ArnForConnector(resource interfacesawssecurityhub.IConnectorRef) *string {
	_init_.Initialize()
