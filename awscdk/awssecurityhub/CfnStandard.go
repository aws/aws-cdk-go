...
func (j *jsiiProxy_CfnStandard) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnStandard) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnStandard) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStandard) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnStandard) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnStandard) DisabledStandardsControls() interface{} {
...
func (j *jsiiProxy_CfnStandard) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnStandard) Node() constructs.Node {
...
func (j *jsiiProxy_CfnStandard) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnStandard) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnStandard) StandardsArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"standardsArn",
...
func (j *jsiiProxy_CfnStandard) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnStandard) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStandard(scope constructs.Construct, id *string, props *CfnStandardProps) CfnStandard {
	...
	if err := validateNewCfnStandardParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStandard)SetDisabledStandardsControls(val interface{}) {
	if err := j.validateSetDisabledStandardsControlsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnStandard)SetStandardsArn(val *string) {
...
func CfnStandard_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStandard_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStandard_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStandard_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStandard_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStandard_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStandard) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnStandard) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStandard) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStandard) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnStandard) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnStandard) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnStandard) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnStandard) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStandard) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStandard) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnStandard) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStandard) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStandard) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnStandard) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnStandard) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStandard) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnStandard) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStandard) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStandard) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnStandard) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStandard) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnStandard) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnStandard) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnStandard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
