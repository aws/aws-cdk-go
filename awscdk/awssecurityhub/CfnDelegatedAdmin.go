...
func (j *jsiiProxy_CfnDelegatedAdmin) AttrDelegatedAdminIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDelegatedAdmin) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDelegatedAdmin) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDelegatedAdmin) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDelegatedAdmin) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDelegatedAdmin) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDelegatedAdmin) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDelegatedAdmin) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDelegatedAdmin) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDelegatedAdmin) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDelegatedAdmin) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDelegatedAdmin) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDelegatedAdmin) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDelegatedAdmin(scope constructs.Construct, id *string, props *CfnDelegatedAdminProps) CfnDelegatedAdmin {
	...
	if err := validateNewCfnDelegatedAdminParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDelegatedAdmin)SetAdminAccountId(val *string) {
...
func CfnDelegatedAdmin_IsCfnDelegatedAdmin(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDelegatedAdmin_IsCfnDelegatedAdminParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDelegatedAdmin_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDelegatedAdmin_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDelegatedAdmin_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDelegatedAdmin_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDelegatedAdmin_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDelegatedAdmin_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDelegatedAdmin) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDelegatedAdmin) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDelegatedAdmin) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDelegatedAdmin) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDelegatedAdmin) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDelegatedAdmin) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDelegatedAdmin) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDelegatedAdmin) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
