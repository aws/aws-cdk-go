...
func (j *jsiiProxy_CfnRegistry) AttrRegistryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRegistryName",
...
func (j *jsiiProxy_CfnRegistry) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRegistry) RegistryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"registryName",
...
func (j *jsiiProxy_CfnRegistry) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRegistry(scope constructs.Construct, id *string, props *CfnRegistryProps) CfnRegistry {
	...
	if err := validateNewCfnRegistryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRegistry)SetRegistryName(val *string) {
	_jsii_.Set(
		j,
		"registryName",
		val,
...
func CfnRegistry_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRegistry_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegistry_IsCfnRegistry(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRegistry_IsCfnRegistryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegistry_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRegistry_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegistry_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRegistry_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRegistry) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistry) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRegistry) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRegistry) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRegistry) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRegistry) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRegistry) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistry) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistry) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
