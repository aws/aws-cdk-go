...
func (j *jsiiProxy_CfnSchema) CfnPropertyNames() *map[string]*string {
...
func CfnSchema_ArnForSchema(resource interfacesawseventschemas.ISchemaRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSchema) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSchema) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSchema) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSchema) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchema) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
