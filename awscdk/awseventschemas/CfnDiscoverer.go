...
func (j *jsiiProxy_CfnDiscoverer) AttrDiscovererId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDiscovererId",
...
func (j *jsiiProxy_CfnDiscoverer) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDiscoverer) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDiscoverer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDiscoverer) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDiscoverer) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDiscoverer) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDiscoverer) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDiscoverer) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDiscoverer) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDiscoverer) SourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceArn",
...
func (j *jsiiProxy_CfnDiscoverer) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDiscoverer) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDiscoverer) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDiscoverer(scope constructs.Construct, id *string, props *CfnDiscovererProps) CfnDiscoverer {
	...
	if err := validateNewCfnDiscovererParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnDiscoverer{}
...
func (j *jsiiProxy_CfnDiscoverer)SetCrossAccount(val interface{}) {
	if err := j.validateSetCrossAccountParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDiscoverer)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDiscoverer)SetSourceArn(val *string) {
...
func CfnDiscoverer_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDiscoverer_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDiscoverer_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDiscoverer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDiscoverer_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDiscoverer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDiscoverer) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDiscoverer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscoverer) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscoverer) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscoverer) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscoverer) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDiscoverer) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscoverer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDiscoverer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDiscoverer) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDiscoverer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDiscoverer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDiscoverer) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDiscoverer) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDiscoverer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDiscoverer) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDiscoverer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscoverer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscoverer) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDiscoverer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscoverer) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDiscoverer) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDiscoverer) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDiscoverer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
