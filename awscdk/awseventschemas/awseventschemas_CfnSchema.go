...
func (j *jsiiProxy_CfnSchema) AttrSchemaName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSchemaName",
...
func (j *jsiiProxy_CfnSchema) AttrSchemaVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSchemaVersion",
...
func (j *jsiiProxy_CfnSchema) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_CfnSchema) RegistryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"registryName",
...
func (j *jsiiProxy_CfnSchema) SchemaName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaName",
...
func (j *jsiiProxy_CfnSchema) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSchema(scope constructs.Construct, id *string, props *CfnSchemaProps) CfnSchema {
	...
	if err := validateNewCfnSchemaParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSchema)SetContent(val *string) {
...
func (j *jsiiProxy_CfnSchema)SetRegistryName(val *string) {
...
func (j *jsiiProxy_CfnSchema)SetSchemaName(val *string) {
	_jsii_.Set(
		j,
		"schemaName",
		val,
...
func (j *jsiiProxy_CfnSchema)SetType(val *string) {
...
func CfnSchema_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSchema_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchema_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSchema_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchema) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchema) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSchema) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSchema) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSchema) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchema) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
