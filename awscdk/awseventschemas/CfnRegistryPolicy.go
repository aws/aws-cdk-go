...
type CfnRegistryPolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawseventschemas.IRegistryPolicyRef
	...
	RegistryPolicyRef() *interfacesawseventschemas.RegistryPolicyReference
...
type jsiiProxy_CfnRegistryPolicy struct {
	...
	internal.Type__interfacesawseventschemasIRegistryPolicyRef
}

func (j *jsiiProxy_CfnRegistryPolicy) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnRegistryPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRegistryPolicy) Policy() interface{} {
...
func (j *jsiiProxy_CfnRegistryPolicy) RegistryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"registryName",
...
func (j *jsiiProxy_CfnRegistryPolicy) RegistryPolicyRef() *interfacesawseventschemas.RegistryPolicyReference {
	var returns *interfacesawseventschemas.RegistryPolicyReference
	_jsii_.Get(
		j,
		"registryPolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnRegistryPolicy) RevisionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"revisionId",
...
func (j *jsiiProxy_CfnRegistryPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRegistryPolicy(scope constructs.Construct, id *string, props *CfnRegistryPolicyProps) CfnRegistryPolicy {
	...
	if err := validateNewCfnRegistryPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRegistryPolicy)SetPolicy(val interface{}) {
...
func (j *jsiiProxy_CfnRegistryPolicy)SetRegistryName(val *string) {
...
func (j *jsiiProxy_CfnRegistryPolicy)SetRevisionId(val *string) {
	_jsii_.Set(
		j,
		"revisionId",
		val,
...
func CfnRegistryPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRegistryPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegistryPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRegistryPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegistryPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRegistryPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRegistryPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistryPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRegistryPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRegistryPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRegistryPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRegistryPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRegistryPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistryPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistryPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegistryPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
