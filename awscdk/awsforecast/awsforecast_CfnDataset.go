...
func (j *jsiiProxy_CfnDataset) DataFrequency() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataFrequency",
...
func (j *jsiiProxy_CfnDataset) Domain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domain",
...
func (j *jsiiProxy_CfnDataset) EncryptionConfig() interface{} {
...
func (j *jsiiProxy_CfnDataset) Tags() *[]*CfnDataset_TagsItemsProperty {
	var returns *[]*CfnDataset_TagsItemsProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CfnDataset)SetDataFrequency(val *string) {
	_jsii_.Set(
		j,
		"dataFrequency",
		val,
...
func (j *jsiiProxy_CfnDataset)SetDomain(val *string) {
...
func (j *jsiiProxy_CfnDataset)SetTags(val *[]*CfnDataset_TagsItemsProperty) {
