...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsforecastIDatasetRef)
			return &j
		},
	)
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_forecast.CfnDataset.EncryptionConfigProperty",
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsforecastIDatasetGroupRef)
