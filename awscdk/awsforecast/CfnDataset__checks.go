...
func validateCfnDataset_ArnForDatasetParameters(resource interfacesawsforecast.IDatasetRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataset) validateSetDatasetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataset) validateSetDomainParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataset) validateSetTagsParameters(val *[]*CfnDataset_TagsItemsProperty) error {
