...
func (j *jsiiProxy_CfnDatasetGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDatasetGroup) DatasetArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"datasetArns",
...
func (j *jsiiProxy_CfnDatasetGroup) DatasetGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetGroupName",
...
func (j *jsiiProxy_CfnDatasetGroup) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDatasetGroup) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDatasetGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDatasetGroup(scope constructs.Construct, id *string, props *CfnDatasetGroupProps) CfnDatasetGroup {
	...
	if err := validateNewCfnDatasetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDatasetGroup)SetDatasetArns(val *[]*string) {
	_jsii_.Set(
		j,
		"datasetArns",
		val,
...
func (j *jsiiProxy_CfnDatasetGroup)SetDatasetGroupName(val *string) {
	if err := j.validateSetDatasetGroupNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDatasetGroup)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnDatasetGroup_ArnForDatasetGroup(resource interfacesawsforecast.IDatasetGroupRef) *string {
	_init_.Initialize()

	if err := validateCfnDatasetGroup_ArnForDatasetGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDatasetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDatasetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDatasetGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDatasetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDatasetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDatasetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDatasetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatasetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDatasetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDatasetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDatasetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDatasetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDatasetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatasetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatasetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatasetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
