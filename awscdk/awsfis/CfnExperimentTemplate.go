...
func (j *jsiiProxy_CfnExperimentTemplate) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnExperimentTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnExperimentTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnExperimentTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnExperimentTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExperimentTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
