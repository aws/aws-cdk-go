...
func validateCfnDataSource_ArnForDataSourceParameters(resource interfacesawskendra.IDataSourceRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnDataSource) validateSetIndexIdParameters(val *string) error {
	return nil
}
