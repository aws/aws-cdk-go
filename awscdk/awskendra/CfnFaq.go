...
func (j *jsiiProxy_CfnFaq) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFaq) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFaq(scope constructs.Construct, id *string, props *CfnFaqProps) CfnFaq {
	...
	if err := validateNewCfnFaqParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnFaq{}
...
func CfnFaq_ArnForFaq(resource interfacesawskendra.IFaqRef) *string {
	_init_.Initialize()

	if err := validateCfnFaq_ArnForFaqParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFaq_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFaq_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnFaq.
func CfnFaq_IsCfnFaq(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFaq_IsCfnFaqParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFaq_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFaq_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFaq_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFaq_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFaq) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFaq) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFaq) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFaq) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFaq) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFaq) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFaq) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFaq) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFaq) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFaq) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
