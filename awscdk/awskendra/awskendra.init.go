...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ChangeDetectingColumnsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ConfluenceAttachmentFieldMappingsListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ConfluenceBlogFieldMappingsListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ConfluencePageFieldMappingsListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ConfluenceSpaceFieldMappingsListProperty",
		reflect.TypeOf((*CfnDataSource_ConfluenceSpaceFieldMappingsListProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ConfluenceSpaceListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.DataSourceInclusionsExclusionsStringsProperty",
		reflect.TypeOf((*CfnDataSource_DataSourceInclusionsExclusionsStringsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.DataSourceToIndexFieldMappingListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ExcludeMimeTypesListProperty",
		reflect.TypeOf((*CfnDataSource_ExcludeMimeTypesListProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ExcludeSharedDrivesListProperty",
		reflect.TypeOf((*CfnDataSource_ExcludeSharedDrivesListProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.ExcludeUserAccountsListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.OneDriveUserListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.SalesforceChatterFeedIncludeFilterTypesProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.SalesforceCustomKnowledgeArticleTypeConfigurationListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.SalesforceKnowledgeArticleStateListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnDataSource.SalesforceStandardObjectConfigurationListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kendra.CfnIndex.ValueImportanceItemsProperty",
