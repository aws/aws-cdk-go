...
func (j *jsiiProxy_CfnDataAccessor) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDataAccessor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataAccessor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataAccessor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataAccessor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAccessor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
