...
func validateCfnApplication_ArnForApplicationParameters(resource interfacesawsqbusiness.IApplicationRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnApplication) validateSetAttachmentsConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnApplication_AttachmentsConfigurationProperty:
		val := val.(*CfnApplication_AttachmentsConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnApplication_AttachmentsConfigurationProperty:
		val_ := val.(CfnApplication_AttachmentsConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnApplication_AttachmentsConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnApplication) validateSetEncryptionConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnApplication_EncryptionConfigurationProperty:
		val := val.(*CfnApplication_EncryptionConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnApplication_EncryptionConfigurationProperty:
		val_ := val.(CfnApplication_EncryptionConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnApplication) validateSetQAppsConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnApplication_QAppsConfigurationProperty:
		val := val.(*CfnApplication_QAppsConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnApplication_QAppsConfigurationProperty:
		val_ := val.(CfnApplication_QAppsConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnApplication_QAppsConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnApplication) validateSetQuickSightConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnApplication_QuickSightConfigurationProperty:
		val := val.(*CfnApplication_QuickSightConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnApplication_QuickSightConfigurationProperty:
		val_ := val.(CfnApplication_QuickSightConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnApplication_QuickSightConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
