...
//
//   cfnPermission := awscdk.Aws_qbusiness.NewCfnPermission(this, jsii.String("MyCfnPermission"), &CfnPermissionProps{
//   	Actions: []*string{
//   		jsii.String("actions"),
//   	},
...
func (j *jsiiProxy_CfnPermission) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_CfnPermission) StatementId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statementId",
...
func (j *jsiiProxy_CfnPermission)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnPermission)SetStatementId(val *string) {
