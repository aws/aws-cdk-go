...
//
type CfnApplication_PersonalizationConfigurationProperty struct {
	...
	//
	PersonalizationControlMode *string `field:"required" json:"personalizationControlMode" yaml:"personalizationControlMode"`
}
