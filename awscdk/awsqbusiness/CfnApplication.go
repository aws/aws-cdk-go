...
//
//   cfnApplication := awscdk.Aws_qbusiness.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
func (j *jsiiProxy_CfnApplication) AttachmentsConfiguration() interface{} {
...
func (j *jsiiProxy_CfnApplication) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnApplication) AttrIdentityCenterApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnApplication) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnApplication) EncryptionConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnApplication)SetAttachmentsConfiguration(val interface{}) {
	if err := j.validateSetAttachmentsConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetRoleArn(val *string) {
	_jsii_.Set(
		j,
		"roleArn",
		val,
