...
func (j *jsiiProxy_CfnWebExperience) CfnPropertyNames() *map[string]*string {
...
func CfnWebExperience_ArnForWebExperience(resource interfacesawsqbusiness.IWebExperienceRef) *string {
	_init_.Initialize()

	if err := validateCfnWebExperience_ArnForWebExperienceParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnWebExperience) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWebExperience) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWebExperience) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWebExperience) RemoveResourceDependency(target awscdk.CfnResource) {
