...
//
//   cfnDataSource := awscdk.Aws_qbusiness.NewCfnDataSource(this, jsii.String("MyCfnDataSource"), &CfnDataSourceProps{
...
func (j *jsiiProxy_CfnDataSource) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_CfnDataSource) AttrDataSourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDataSourceId",
...
func (j *jsiiProxy_CfnDataSource) AttrType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrType",
...
func (j *jsiiProxy_CfnDataSource) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDataSource) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataSource) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnDataSource) DocumentEnrichmentConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataSource) SyncSchedule() *string {
	var returns *string
	_jsii_.Get(
		j,
		"syncSchedule",
...
func (j *jsiiProxy_CfnDataSource) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDataSource) VpcConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcConfiguration",
...
func (j *jsiiProxy_CfnDataSource)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnDataSource)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnDataSource)SetDocumentEnrichmentConfiguration(val interface{}) {
	if err := j.validateSetDocumentEnrichmentConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataSource)SetSyncSchedule(val *string) {
	_jsii_.Set(
		j,
		"syncSchedule",
		val,
...
func (j *jsiiProxy_CfnDataSource)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnDataSource)SetVpcConfiguration(val interface{}) {
...
func CfnDataSource_ArnForDataSource(resource interfacesawsqbusiness.IDataSourceRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataSource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataSource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataSource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataSource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
