...
//
//   cfnIndex := awscdk.Aws_qbusiness.NewCfnIndex(this, jsii.String("MyCfnIndex"), &CfnIndexProps{
...
func (j *jsiiProxy_CfnIndex) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_CfnIndex) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnIndex) AttrIndexArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIndexArn",
...
func (j *jsiiProxy_CfnIndex) AttrIndexId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIndexId",
...
func (j *jsiiProxy_CfnIndex) AttrIndexStatistics() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnIndex) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnIndex) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnIndex) CapacityConfiguration() interface{} {
...
func (j *jsiiProxy_CfnIndex) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnIndex) DocumentAttributeConfigurations() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIndex)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnIndex)SetCapacityConfiguration(val interface{}) {
	if err := j.validateSetCapacityConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIndex)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnIndex)SetDocumentAttributeConfigurations(val interface{}) {
	if err := j.validateSetDocumentAttributeConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIndex_ArnForIndex(resource interfacesawsqbusiness.IIndexRef) *string {
	_init_.Initialize()
