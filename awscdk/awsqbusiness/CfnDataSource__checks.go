...
func validateCfnDataSource_ArnForDataSourceParameters(resource interfacesawsqbusiness.IDataSourceRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetApplicationIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetDisplayNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetDocumentEnrichmentConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_DocumentEnrichmentConfigurationProperty:
		val := val.(*CfnDataSource_DocumentEnrichmentConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_DocumentEnrichmentConfigurationProperty:
		val_ := val.(CfnDataSource_DocumentEnrichmentConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_DocumentEnrichmentConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetMediaExtractionConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_MediaExtractionConfigurationProperty:
		val := val.(*CfnDataSource_MediaExtractionConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_MediaExtractionConfigurationProperty:
		val_ := val.(CfnDataSource_MediaExtractionConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_MediaExtractionConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
...
func (j *jsiiProxy_CfnDataSource) validateSetVpcConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_DataSourceVpcConfigurationProperty:
		val := val.(*CfnDataSource_DataSourceVpcConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_DataSourceVpcConfigurationProperty:
		val_ := val.(CfnDataSource_DataSourceVpcConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_DataSourceVpcConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
