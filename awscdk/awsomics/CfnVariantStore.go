...
func (j *jsiiProxy_CfnVariantStore) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnVariantStore) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnVariantStore) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnVariantStore) AttrStoreArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStoreArn",
...
func (j *jsiiProxy_CfnVariantStore) AttrStoreSizeBytes() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnVariantStore) AttrUpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdateTime",
...
func (j *jsiiProxy_CfnVariantStore) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnVariantStore) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVariantStore) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVariantStore) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVariantStore) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVariantStore) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnVariantStore) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVariantStore) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnVariantStore) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVariantStore) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVariantStore) Reference() interface{} {
...
func (j *jsiiProxy_CfnVariantStore) SseConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sseConfig",
...
func (j *jsiiProxy_CfnVariantStore) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVariantStore) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnVariantStore) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVariantStore(scope constructs.Construct, id *string, props *CfnVariantStoreProps) CfnVariantStore {
	...
	if err := validateNewCfnVariantStoreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnVariantStore)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnVariantStore)SetName(val *string) {
...
func (j *jsiiProxy_CfnVariantStore)SetReference(val interface{}) {
...
func (j *jsiiProxy_CfnVariantStore)SetSseConfig(val interface{}) {
...
func CfnVariantStore_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVariantStore_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVariantStore_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVariantStore_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVariantStore_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVariantStore_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVariantStore) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVariantStore) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariantStore) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariantStore) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVariantStore) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVariantStore) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVariantStore) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVariantStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVariantStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVariantStore) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVariantStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVariantStore) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVariantStore) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVariantStore) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVariantStore) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVariantStore) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVariantStore) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariantStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariantStore) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVariantStore) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariantStore) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnVariantStore) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnVariantStore) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnVariantStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
