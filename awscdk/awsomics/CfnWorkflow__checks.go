...
func (c *jsiiProxy_CfnWorkflow) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnWorkflow) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnWorkflow) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnWorkflow) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnWorkflow_ArnForWorkflowParameters(resource interfacesawsomics.IWorkflowRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnWorkflow) validateSetContainerRegistryMapParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnWorkflow_ContainerRegistryMapProperty:
		val := val.(*CfnWorkflow_ContainerRegistryMapProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnWorkflow_ContainerRegistryMapProperty:
		val_ := val.(CfnWorkflow_ContainerRegistryMapProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnWorkflow_ContainerRegistryMapProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnWorkflow) validateSetParameterTemplateParameters(val interface{}) error {
	...
	case *map[string]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnWorkflow_WorkflowParameterProperty:
				v := v.(*CfnWorkflow_WorkflowParameterProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnWorkflow_WorkflowParameterProperty:
				v_ := v.(CfnWorkflow_WorkflowParameterProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnWorkflow_WorkflowParameterProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case map[string]interface{}:
