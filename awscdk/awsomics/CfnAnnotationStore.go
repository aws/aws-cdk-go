...
func (j *jsiiProxy_CfnAnnotationStore) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAnnotationStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnnotationStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnnotationStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnnotationStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnnotationStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
