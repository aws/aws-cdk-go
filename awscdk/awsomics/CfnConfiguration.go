...
//
//   cfnConfiguration := awscdk.Aws_omics.NewCfnConfiguration(this, jsii.String("MyCfnConfiguration"), &CfnConfigurationProps{
...
type CfnConfiguration interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsomics.IConfigurationRef
	awscdk.ITaggableV2
	...
	ConfigurationRef() *interfacesawsomics.ConfigurationReference
	...
	Ref() *string
	RunConfigurations() interface{}
	SetRunConfigurations(val interface{})
...
type jsiiProxy_CfnConfiguration struct {
	...
	internal.Type__interfacesawsomicsIConfigurationRef
...
func (j *jsiiProxy_CfnConfiguration) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnConfiguration) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnConfiguration) AttrUuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUuid",
...
func (j *jsiiProxy_CfnConfiguration) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnConfiguration) ConfigurationRef() *interfacesawsomics.ConfigurationReference {
	var returns *interfacesawsomics.ConfigurationReference
	_jsii_.Get(
		j,
		"configurationRef",
		&returns,
...
func (j *jsiiProxy_CfnConfiguration) RunConfigurations() interface{} {
...
func (j *jsiiProxy_CfnConfiguration) Tags() *map[string]*string {
...
func (j *jsiiProxy_CfnConfiguration)SetRunConfigurations(val interface{}) {
	if err := j.validateSetRunConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfiguration)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnConfiguration_ArnForConfiguration(resource interfacesawsomics.IConfigurationRef) *string {
	_init_.Initialize()
