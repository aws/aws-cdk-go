...
func (j *jsiiProxy_CfnReferenceStore) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnReferenceStore) AttrReferenceStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnReferenceStore) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnReferenceStore) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnReferenceStore) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReferenceStore) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnReferenceStore) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnReferenceStore) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnReferenceStore) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnReferenceStore) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnReferenceStore) Node() constructs.Node {
...
func (j *jsiiProxy_CfnReferenceStore) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnReferenceStore) SseConfig() interface{} {
...
func (j *jsiiProxy_CfnReferenceStore) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnReferenceStore) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnReferenceStore) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnReferenceStore(scope constructs.Construct, id *string, props *CfnReferenceStoreProps) CfnReferenceStore {
	...
	if err := validateNewCfnReferenceStoreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnReferenceStore)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnReferenceStore)SetName(val *string) {
...
func (j *jsiiProxy_CfnReferenceStore)SetSseConfig(val interface{}) {
...
func CfnReferenceStore_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReferenceStore_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReferenceStore_IsCfnReferenceStore(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnReferenceStore_IsCfnReferenceStoreParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReferenceStore_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReferenceStore_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReferenceStore) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnReferenceStore) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReferenceStore) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReferenceStore) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnReferenceStore) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnReferenceStore) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnReferenceStore) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnReferenceStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReferenceStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReferenceStore) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnReferenceStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReferenceStore) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReferenceStore) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnReferenceStore) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnReferenceStore) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReferenceStore) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnReferenceStore) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReferenceStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReferenceStore) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnReferenceStore) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReferenceStore) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnReferenceStore) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnReferenceStore) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnReferenceStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
