...
func (j *jsiiProxy_CfnWorkflow) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnWorkflow) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnWorkflow) AttrType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrType",
...
func (j *jsiiProxy_CfnWorkflow) Engine() *string {
	var returns *string
	_jsii_.Get(
		j,
		"engine",
...
func (j *jsiiProxy_CfnWorkflow) Main() *string {
	var returns *string
	_jsii_.Get(
		j,
		"main",
...
func (j *jsiiProxy_CfnWorkflow) ParameterTemplate() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parameterTemplate",
...
func (j *jsiiProxy_CfnWorkflow) StorageCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageCapacity",
...
func (j *jsiiProxy_CfnWorkflow)SetDefinitionUri(val *string) {
	_jsii_.Set(
		j,
		"definitionUri",
		val,
...
func (j *jsiiProxy_CfnWorkflow)SetEngine(val *string) {
	_jsii_.Set(
		j,
		"engine",
		val,
...
func (j *jsiiProxy_CfnWorkflow)SetMain(val *string) {
	_jsii_.Set(
		j,
		"main",
		val,
...
func (j *jsiiProxy_CfnWorkflow)SetParameterTemplate(val interface{}) {
...
func CfnWorkflow_ArnForWorkflow(resource interfacesawsomics.IWorkflowRef) *string {
	_init_.Initialize()
