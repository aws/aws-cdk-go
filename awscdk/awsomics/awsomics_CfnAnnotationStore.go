...
func (j *jsiiProxy_CfnAnnotationStore) Node() awscdk.ConstructNode {
...
func CfnAnnotationStore_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAnnotationStore_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAnnotationStore) GetAtt(attributeName *string) awscdk.Reference {
...
func (c *jsiiProxy_CfnAnnotationStore) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnAnnotationStore) OnSynthesize(session constructs.ISynthesisSession) {
...
func (c *jsiiProxy_CfnAnnotationStore) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnAnnotationStore) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnAnnotationStore) Synthesize(session awscdk.ISynthesisSession) {
...
func (c *jsiiProxy_CfnAnnotationStore) Validate() *[]*string {
	var returns *[]*string
