...
func (j *jsiiProxy_CfnSequenceStore) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSequenceStore)SetFallbackLocation(val *string) {
	_jsii_.Set(
		j,
		"fallbackLocation",
		val,
...
func CfnSequenceStore_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSequenceStore_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSequenceStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSequenceStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSequenceStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSequenceStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSequenceStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
