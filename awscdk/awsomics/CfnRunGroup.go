...
func (j *jsiiProxy_CfnRunGroup) CfnPropertyNames() *map[string]*string {
...
func CfnRunGroup_ArnForRunGroup(resource interfacesawsomics.IRunGroupRef) *string {
	_init_.Initialize()

	if err := validateCfnRunGroup_ArnForRunGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRunGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRunGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRunGroup_IsCfnRunGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRunGroup_IsCfnRunGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRunGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRunGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRunGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRunGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRunGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
