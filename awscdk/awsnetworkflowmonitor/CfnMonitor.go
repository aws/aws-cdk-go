...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsnetworkflowmonitor/internal"
...
//
//   cfnMonitor := awscdk.Aws_networkflowmonitor.NewCfnMonitor(this, jsii.String("MyCfnMonitor"), &CfnMonitorProps{
...
type CfnMonitor interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsnetworkflowmonitor.IMonitorRef
	awscdk.ITaggableV2
	...
	LocalResources() interface{}
	SetLocalResources(val interface{})
	...
	MonitorRef() *interfacesawsnetworkflowmonitor.MonitorReference
	// The tree node.
	...
	RemoteResources() interface{}
	SetRemoteResources(val interface{})
...
type jsiiProxy_CfnMonitor struct {
	...
	internal.Type__interfacesawsnetworkflowmonitorIMonitorRef
...
func (j *jsiiProxy_CfnMonitor) AttrMonitorStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMonitorStatus",
...
func (j *jsiiProxy_CfnMonitor) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMonitor) LocalResources() interface{} {
...
func (j *jsiiProxy_CfnMonitor) MonitorRef() *interfacesawsnetworkflowmonitor.MonitorReference {
	var returns *interfacesawsnetworkflowmonitor.MonitorReference
	_jsii_.Get(
		j,
		"monitorRef",
		&returns,
...
func (j *jsiiProxy_CfnMonitor) RemoteResources() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"remoteResources",
...
func (j *jsiiProxy_CfnMonitor) ScopeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeArn",
...
func NewCfnMonitor(scope constructs.Construct, id *string, props *CfnMonitorProps) CfnMonitor {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_networkflowmonitor.CfnMonitor",
...
func (j *jsiiProxy_CfnMonitor)SetLocalResources(val interface{}) {
	if err := j.validateSetLocalResourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMonitor)SetRemoteResources(val interface{}) {
	if err := j.validateSetRemoteResourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMonitor)SetScopeArn(val *string) {
	_jsii_.Set(
		j,
		"scopeArn",
		val,
...
func CfnMonitor_ArnForMonitor(resource interfacesawsnetworkflowmonitor.IMonitorRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMonitor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMonitor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMonitor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMonitor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
