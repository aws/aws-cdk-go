...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrMonitorStatus", GoGetter: "AttrMonitorStatus"},
			...
			_jsii_.MemberProperty{JsiiProperty: "localResources", GoGetter: "LocalResources"},
			...
			_jsii_.MemberProperty{JsiiProperty: "remoteResources", GoGetter: "RemoteResources"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsnetworkflowmonitorIMonitorRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_networkflowmonitor.CfnMonitor.MonitorLocalResourceProperty",
		reflect.TypeOf((*CfnMonitor_MonitorLocalResourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_networkflowmonitor.CfnMonitor.MonitorRemoteResourceProperty",
		reflect.TypeOf((*CfnMonitor_MonitorRemoteResourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_networkflowmonitor.CfnMonitorProps",
