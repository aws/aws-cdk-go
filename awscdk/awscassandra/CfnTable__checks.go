...
func (j *jsiiProxy_CfnTable) validateSetAutoScalingSpecificationsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnTable_AutoScalingSpecificationProperty:
		val := val.(*CfnTable_AutoScalingSpecificationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnTable_AutoScalingSpecificationProperty:
		val_ := val.(CfnTable_AutoScalingSpecificationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_AutoScalingSpecificationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnTable) validateSetBillingModeParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_BillingModeProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnTable) validateSetCdcSpecificationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnTable_CdcSpecificationProperty:
		val := val.(*CfnTable_CdcSpecificationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnTable_CdcSpecificationProperty:
		val_ := val.(CfnTable_CdcSpecificationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_CdcSpecificationProperty; received %#v (a %T)", val, val)
		}
	}
		...
		for idx_97dfc6, v := range *val {
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnTable_ClusteringKeyColumnProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnTable) validateSetEncryptionSpecificationParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_EncryptionSpecificationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnTable) validateSetPartitionKeyColumnsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnTable_ColumnProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnTable) validateSetReplicaSpecificationsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnTable_ReplicaSpecificationProperty:
				v := v.(*CfnTable_ReplicaSpecificationProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnTable_ReplicaSpecificationProperty:
				v_ := v.(CfnTable_ReplicaSpecificationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnTable_ReplicaSpecificationProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
