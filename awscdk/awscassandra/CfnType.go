...
//
//   cfnType := awscdk.Aws_cassandra.NewCfnType(this, jsii.String("MyCfnType"), &CfnTypeProps{
//   	Fields: []interface{}{
//   		&FieldProperty{
...
type CfnType interface {
	...
	AttrDirectReferringTables() *[]*string
	// The unique identifier of the keyspace that contains this type in the format of Amazon Resource Name (ARN).
	AttrKeyspaceArn() *string
	// The last time this type was modified.
	AttrLastModifiedTimestamp() awscdk.IResolvable
	// The maximum nesting depth of this type.
	//
	// For more information, see [Amazon Keyspaces UDT quotas and default values](https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html#quotas-udts) in the *Amazon Keyspaces Developer Guide* .
	AttrMaxNestingDepth() *float64
...
func (j *jsiiProxy_CfnType) AttrDirectParentTypes() *[]*string {
	...
	_jsii_.Get(
		j,
		"attrDirectParentTypes",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnType) AttrDirectReferringTables() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrDirectReferringTables",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnType) AttrKeyspaceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrKeyspaceArn",
...
func (j *jsiiProxy_CfnType) AttrLastModifiedTimestamp() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnType) AttrMaxNestingDepth() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrMaxNestingDepth",
...
func (j *jsiiProxy_CfnType) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnType) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnType) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnType) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnType) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnType) Fields() interface{} {
...
func (j *jsiiProxy_CfnType) KeyspaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyspaceName",
...
func (j *jsiiProxy_CfnType) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnType) Node() constructs.Node {
...
func (j *jsiiProxy_CfnType) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnType) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnType) TypeName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeName",
...
func (j *jsiiProxy_CfnType) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnType) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnType(scope constructs.Construct, id *string, props *CfnTypeProps) CfnType {
	...
	if err := validateNewCfnTypeParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnType{}
...
func (j *jsiiProxy_CfnType)SetFields(val interface{}) {
...
func (j *jsiiProxy_CfnType)SetKeyspaceName(val *string) {
...
func (j *jsiiProxy_CfnType)SetTypeName(val *string) {
...
func CfnType_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnType_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnType_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnType_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnType_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnType_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnType_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cassandra.CfnType",
...
func (c *jsiiProxy_CfnType) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnType) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnType) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnType) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnType) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnType) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnType) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnType) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnType) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnType) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnType) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnType) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnType) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnType) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnType) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnType) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnType) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnType) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnType) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
