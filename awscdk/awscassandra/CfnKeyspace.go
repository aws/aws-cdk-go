...
func (j *jsiiProxy_CfnKeyspace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnKeyspace) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnKeyspace(scope constructs.Construct, id *string, props *CfnKeyspaceProps) CfnKeyspace {
	...
	if err := validateNewCfnKeyspaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnKeyspace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnKeyspace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyspace_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnKeyspace_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyspace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnKeyspace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnKeyspace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyspace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnKeyspace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnKeyspace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnKeyspace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnKeyspace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnKeyspace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyspace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyspace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
