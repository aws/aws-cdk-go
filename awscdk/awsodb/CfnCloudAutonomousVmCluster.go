...
func (j *jsiiProxy_CfnCloudAutonomousVmCluster) CfnPropertyNames() *map[string]*string {
...
func CfnCloudAutonomousVmCluster_ArnForCloudAutonomousVmCluster(resource interfacesawsodb.ICloudAutonomousVmClusterRef) *string {
	_init_.Initialize()

	if err := validateCfnCloudAutonomousVmCluster_ArnForCloudAutonomousVmClusterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_odb.CfnCloudAutonomousVmCluster",
		"arnForCloudAutonomousVmCluster",
		[]interface{}{resource},
		&returns,
	)
...
func CfnCloudAutonomousVmCluster_IsCfnCloudAutonomousVmCluster(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCloudAutonomousVmCluster_IsCfnCloudAutonomousVmClusterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCloudAutonomousVmCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCloudAutonomousVmCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCloudAutonomousVmCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCloudAutonomousVmCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCloudAutonomousVmCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
