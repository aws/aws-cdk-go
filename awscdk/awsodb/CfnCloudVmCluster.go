...
func (j *jsiiProxy_CfnCloudVmCluster) CfnPropertyNames() *map[string]*string {
...
func CfnCloudVmCluster_ArnForCloudVmCluster(resource interfacesawsodb.ICloudVmClusterRef) *string {
	_init_.Initialize()

	if err := validateCfnCloudVmCluster_ArnForCloudVmClusterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnCloudVmCluster_IsCfnCloudVmCluster(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCloudVmCluster_IsCfnCloudVmClusterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCloudVmCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCloudVmCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCloudVmCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCloudVmCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCloudVmCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
