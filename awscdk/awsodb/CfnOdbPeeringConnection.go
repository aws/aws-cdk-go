...
type CfnOdbPeeringConnection interface {
	...
	AttrOdbPeeringConnectionArn() *string
...
func (j *jsiiProxy_CfnOdbPeeringConnection) AttrOdbPeeringConnectionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOdbPeeringConnectionArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOdbPeeringConnection) AttrOdbPeeringConnectionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOdbPeeringConnectionId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOdbPeeringConnection) AttrPeerNetworkArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPeerNetworkArn",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) OdbNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"odbNetworkId",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) PeerNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerNetworkId",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnOdbPeeringConnection) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOdbPeeringConnection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOdbPeeringConnection(scope constructs.Construct, id *string, props *CfnOdbPeeringConnectionProps) CfnOdbPeeringConnection {
	...
	if err := validateNewCfnOdbPeeringConnectionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOdbPeeringConnection)SetOdbNetworkId(val *string) {
	_jsii_.Set(
		j,
		"odbNetworkId",
		val,
...
func (j *jsiiProxy_CfnOdbPeeringConnection)SetPeerNetworkId(val *string) {
	_jsii_.Set(
		j,
		"peerNetworkId",
		val,
...
func (j *jsiiProxy_CfnOdbPeeringConnection)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnOdbPeeringConnection_ArnForOdbPeeringConnection(resource interfacesawsodb.IOdbPeeringConnectionRef) *string {
	_init_.Initialize()

	if err := validateCfnOdbPeeringConnection_ArnForOdbPeeringConnectionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnOdbPeeringConnection_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOdbPeeringConnection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOdbPeeringConnection_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOdbPeeringConnection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOdbPeeringConnection_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOdbPeeringConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOdbPeeringConnection_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_odb.CfnOdbPeeringConnection",
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOdbPeeringConnection) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOdbPeeringConnection) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOdbPeeringConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
