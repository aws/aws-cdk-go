...
func (j *jsiiProxy_CfnOdbNetwork) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnOdbNetwork) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOdbNetwork) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOdbNetwork) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOdbNetwork) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOdbNetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
