...
func (j *jsiiProxy_CfnCloudExadataInfrastructure) CfnPropertyNames() *map[string]*string {
...
func CfnCloudExadataInfrastructure_ArnForCloudExadataInfrastructure(resource interfacesawsodb.ICloudExadataInfrastructureRef) *string {
	_init_.Initialize()

	if err := validateCfnCloudExadataInfrastructure_ArnForCloudExadataInfrastructureParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnCloudExadataInfrastructure) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCloudExadataInfrastructure) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCloudExadataInfrastructure) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCloudExadataInfrastructure) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCloudExadataInfrastructure) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
