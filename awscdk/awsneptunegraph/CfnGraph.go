...
func (j *jsiiProxy_CfnGraph) AttrGraphArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGraphArn",
...
func (j *jsiiProxy_CfnGraph) AttrGraphId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGraphId",
...
func (j *jsiiProxy_CfnGraph) DeletionProtection() interface{} {
...
func (j *jsiiProxy_CfnGraph) GraphName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"graphName",
...
func (j *jsiiProxy_CfnGraph) ProvisionedMemory() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"provisionedMemory",
...
func (j *jsiiProxy_CfnGraph) PublicConnectivity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"publicConnectivity",
...
func (j *jsiiProxy_CfnGraph) ReplicaCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"replicaCount",
...
func (j *jsiiProxy_CfnGraph) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnGraph) VectorSearchConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnGraph)SetDeletionProtection(val interface{}) {
...
func (j *jsiiProxy_CfnGraph)SetGraphName(val *string) {
	_jsii_.Set(
		j,
		"graphName",
		val,
...
func (j *jsiiProxy_CfnGraph)SetProvisionedMemory(val *float64) {
...
func (j *jsiiProxy_CfnGraph)SetPublicConnectivity(val interface{}) {
...
func (j *jsiiProxy_CfnGraph)SetReplicaCount(val *float64) {
	_jsii_.Set(
		j,
		"replicaCount",
		val,
...
func (j *jsiiProxy_CfnGraph)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnGraph)SetVectorSearchConfiguration(val interface{}) {
	if err := j.validateSetVectorSearchConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnGraph_ArnForGraph(resource interfacesawsneptunegraph.IGraphRef) *string {
	_init_.Initialize()
