...
func (j *jsiiProxy_CfnAutomationRule) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAutomationRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAutomationRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAutomationRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAutomationRule) RemoveResourceDependency(target awscdk.CfnResource) {
