...
func (c *jsiiProxy_CfnAutomationRule) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnAutomationRule) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnAutomationRule) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnAutomationRule) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnAutomationRule_IsCfnAutomationRuleParameters(x interface{}) error {
	if x == nil {
...
func (j *jsiiProxy_CfnAutomationRule) validateSetCriteriaParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnAutomationRule_CriteriaProperty:
		val := val.(*CfnAutomationRule_CriteriaProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnAutomationRule_CriteriaProperty:
		val_ := val.(CfnAutomationRule_CriteriaProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnAutomationRule_CriteriaProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnAutomationRule) validateSetOrganizationConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnAutomationRule_OrganizationConfigurationProperty:
		val := val.(*CfnAutomationRule_OrganizationConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnAutomationRule_OrganizationConfigurationProperty:
		val_ := val.(CfnAutomationRule_OrganizationConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnAutomationRule_OrganizationConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetRecommendedActionTypesParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetRuleTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetScheduleParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnAutomationRule_ScheduleProperty:
		val := val.(*CfnAutomationRule_ScheduleProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnAutomationRule_ScheduleProperty:
		val_ := val.(CfnAutomationRule_ScheduleProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnAutomationRule_ScheduleProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetStatusParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnAutomationRule) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
