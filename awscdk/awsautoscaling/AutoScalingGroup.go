...
func (j *jsiiProxy_AutoScalingGroup) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_AutoScalingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
