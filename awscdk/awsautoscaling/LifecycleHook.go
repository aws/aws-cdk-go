...
func (j *jsiiProxy_LifecycleHook) Env() *interfaces.ResourceEnvironment {
...
func LifecycleHook_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_autoscaling.LifecycleHook",
...
func (l *jsiiProxy_LifecycleHook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LifecycleHook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
