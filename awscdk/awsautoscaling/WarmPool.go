...
func (j *jsiiProxy_WarmPool) Env() *interfaces.ResourceEnvironment {
...
func (w *jsiiProxy_WarmPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WarmPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
