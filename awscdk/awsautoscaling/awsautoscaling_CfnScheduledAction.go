...
func (c *jsiiProxy_CfnScheduledAction) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAction) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScheduledAction) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScheduledAction) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnScheduledAction) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAction) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
