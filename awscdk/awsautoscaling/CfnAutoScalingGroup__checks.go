...
func (c *jsiiProxy_CfnAutoScalingGroup) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnAutoScalingGroup) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnAutoScalingGroup) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnAutoScalingGroup) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnAutoScalingGroup) validateSetCapacityReservationSpecificationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnAutoScalingGroup_CapacityReservationSpecificationProperty:
		val := val.(*CfnAutoScalingGroup_CapacityReservationSpecificationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnAutoScalingGroup_CapacityReservationSpecificationProperty:
		val_ := val.(CfnAutoScalingGroup_CapacityReservationSpecificationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnAutoScalingGroup_CapacityReservationSpecificationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnAutoScalingGroup) validateSetTrafficSourcesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnAutoScalingGroup_TrafficSourceIdentifierProperty:
				v := v.(*CfnAutoScalingGroup_TrafficSourceIdentifierProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnAutoScalingGroup_TrafficSourceIdentifierProperty:
				v_ := v.(CfnAutoScalingGroup_TrafficSourceIdentifierProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnAutoScalingGroup_TrafficSourceIdentifierProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
