...
func (i *jsiiProxy_IAutoScalingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAutoScalingGroup) Env() *interfaces.ResourceEnvironment {
