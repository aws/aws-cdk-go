...
func (j *jsiiProxy_CfnLifecycleHook) CfnPropertyNames() *map[string]*string {
...
func NewCfnLifecycleHook(scope constructs.Construct, id *string, props *CfnLifecycleHookProps) CfnLifecycleHook {
	...
	if err := validateNewCfnLifecycleHookParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLifecycleHook_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLifecycleHook_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLifecycleHook_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLifecycleHook_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLifecycleHook_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLifecycleHook_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLifecycleHook) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLifecycleHook) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLifecycleHook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLifecycleHook) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLifecycleHook) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLifecycleHook) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLifecycleHook) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLifecycleHook) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLifecycleHook) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLifecycleHook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
