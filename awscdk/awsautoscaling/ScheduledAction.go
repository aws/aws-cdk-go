...
func (j *jsiiProxy_ScheduledAction) Env() *interfaces.ResourceEnvironment {
...
func ScheduledAction_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_autoscaling.ScheduledAction",
...
func (s *jsiiProxy_ScheduledAction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ScheduledAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
