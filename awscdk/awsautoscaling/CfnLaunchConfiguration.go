...
func (j *jsiiProxy_CfnLaunchConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnLaunchConfiguration_IsCfnLaunchConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLaunchConfiguration_IsCfnLaunchConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunchConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunchConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunchConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
