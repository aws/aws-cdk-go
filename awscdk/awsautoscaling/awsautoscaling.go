...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_autoscaling.CfnAutoScalingGroup.NetworkBandwidthGbpsRequestProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_autoscaling.WarmPoolOptions",
		reflect.TypeOf((*WarmPoolOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_autoscaling.WarmPoolProps",
