...
func (j *jsiiProxy_CfnWarmPool) CfnPropertyNames() *map[string]*string {
...
func CfnWarmPool_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWarmPool_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWarmPool_IsCfnWarmPool(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWarmPool_IsCfnWarmPoolParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWarmPool) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWarmPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWarmPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWarmPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWarmPool) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWarmPool) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWarmPool) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWarmPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWarmPool) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWarmPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
