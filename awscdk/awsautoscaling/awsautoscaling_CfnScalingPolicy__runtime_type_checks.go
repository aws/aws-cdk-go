...
func (j *jsiiProxy_CfnScalingPolicy) validateSetAutoScalingGroupNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnScalingPolicy) validateSetPredictiveScalingConfigurationParameters(val interface{}) error {
	...
	case CfnScalingPolicy_PredictiveScalingConfigurationProperty:
		val_ := val.(CfnScalingPolicy_PredictiveScalingConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnScalingPolicy) validateSetStepAdjustmentsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnScalingPolicy_StepAdjustmentProperty:
				v_ := v.(CfnScalingPolicy_StepAdjustmentProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnScalingPolicy) validateSetTargetTrackingConfigurationParameters(val interface{}) error {
	...
	case CfnScalingPolicy_TargetTrackingConfigurationProperty:
		val_ := val.(CfnScalingPolicy_TargetTrackingConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
