...
func init() {
	_jsii_.RegisterEnum(
		"aws-cdk-lib.aws_autoscaling.AdditionalHealthCheckType",
		reflect.TypeOf((*AdditionalHealthCheckType)(nil)).Elem(),
		map[string]interface{}{
			"ELB": AdditionalHealthCheckType_ELB,
			"EBS": AdditionalHealthCheckType_EBS,
			"VPC_LATTICE": AdditionalHealthCheckType_VPC_LATTICE,
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_autoscaling.AdditionalHealthChecksOptions",
		reflect.TypeOf((*AdditionalHealthChecksOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_autoscaling.CfnAutoScalingGroup.AvailabilityZoneDistributionProperty",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2HealthChecksOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*HealthChecks)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "gracePeriod", GoGetter: "GracePeriod"},
			_jsii_.MemberProperty{JsiiProperty: "types", GoGetter: "Types"},
		},
		func() interface{} {
			return &jsiiProxy_HealthChecks{}
		},
	)
