...
func (j *jsiiProxy_CfnAutoScalingGroup) AttrAutoScalingGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAutoScalingGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAutoScalingGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAutoScalingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAutoScalingGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAutoScalingGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
