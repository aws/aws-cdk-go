...
type CommonAutoScalingGroupProps struct {
	...
	// Default: None.
	//
	AzCapacityDistributionStrategy CapacityDistributionStrategy `field:"optional" json:"azCapacityDistributionStrategy" yaml:"azCapacityDistributionStrategy"`
	...
	//
	HealthChecks HealthChecks `field:"optional" json:"healthChecks" yaml:"healthChecks"`
