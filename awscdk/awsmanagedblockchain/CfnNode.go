...
func (j *jsiiProxy_CfnNode)SetNodeConfiguration(val interface{}) {
	if err := j.validateSetNodeConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnNode_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnNode_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNode) ObtainResourceDependencies() *[]awscdk.CfnResource {
