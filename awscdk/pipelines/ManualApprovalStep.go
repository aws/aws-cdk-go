...
func (j *jsiiProxy_ManualApprovalStep) ConsumedStackOutputs() *[]StackOutputReference {
...
func (j *jsiiProxy_ManualApprovalStep) NotificationTopic() awssns.ITopic {
...
func (j *jsiiProxy_ManualApprovalStep) ReviewUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reviewUrl",
