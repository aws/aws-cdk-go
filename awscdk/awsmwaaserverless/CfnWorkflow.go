...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsmwaaserverless/internal"
...
//
//   cfnWorkflow := awscdk.Aws_mwaaserverless.NewCfnWorkflow(this, jsii.String("MyCfnWorkflow"), &CfnWorkflowProps{
...
type CfnWorkflow interface {
	...
	AttrWorkflowStatus() *string
	AttrWorkflowVersion() *string
	...
	WorkflowRef() *interfacesawsmwaaserverless.WorkflowReference
...
type jsiiProxy_CfnWorkflow struct {
	...
	internal.Type__interfacesawsmwaaserverlessIWorkflowRef
...
func (j *jsiiProxy_CfnWorkflow) AttrModifiedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrModifiedAt",
...
func (j *jsiiProxy_CfnWorkflow) AttrScheduleConfiguration() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrScheduleConfiguration",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnWorkflow) AttrWorkflowArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWorkflowArn",
...
func (j *jsiiProxy_CfnWorkflow) AttrWorkflowStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWorkflowStatus",
...
func (j *jsiiProxy_CfnWorkflow) AttrWorkflowVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWorkflowVersion",
...
func (j *jsiiProxy_CfnWorkflow) DefinitionS3Location() interface{} {
...
func (j *jsiiProxy_CfnWorkflow) EncryptionConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWorkflow) LoggingConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWorkflow) NetworkConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWorkflow) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnWorkflow) TriggerMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"triggerMode",
...
func (j *jsiiProxy_CfnWorkflow) WorkflowRef() *interfacesawsmwaaserverless.WorkflowReference {
	var returns *interfacesawsmwaaserverless.WorkflowReference
	_jsii_.Get(
		j,
		"workflowRef",
		&returns,
...
func (j *jsiiProxy_CfnWorkflow)SetDefinitionS3Location(val interface{}) {
...
func (j *jsiiProxy_CfnWorkflow)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnWorkflow)SetLoggingConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnWorkflow)SetNetworkConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnWorkflow)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnWorkflow)SetTriggerMode(val *string) {
	_jsii_.Set(
		j,
		"triggerMode",
		val,
...
func CfnWorkflow_ArnForWorkflow(resource interfacesawsmwaaserverless.IWorkflowRef) *string {
	_init_.Initialize()
