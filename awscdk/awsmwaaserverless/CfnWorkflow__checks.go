...
func (j *jsiiProxy_CfnWorkflow) validateSetCodeParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnWorkflow_CodeProperty:
		val := val.(*CfnWorkflow_CodeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnWorkflow_CodeProperty:
		val_ := val.(CfnWorkflow_CodeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnWorkflow_CodeProperty; received %#v (a %T)", val, val)
		}
	}
