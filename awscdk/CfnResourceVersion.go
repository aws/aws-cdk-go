...
func (j *jsiiProxy_CfnResourceVersion) CfnPropertyNames() *map[string]*string {
...
func CfnResourceVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceVersion_IsCfnResourceVersion(x interface{}) *bool {
	...
	if err := validateCfnResourceVersion_IsCfnResourceVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceVersion) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceVersion) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceVersion) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnResourceVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceVersion) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
