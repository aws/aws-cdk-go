...
type CfnDBSubnetGroup interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsneptune.IDBSubnetGroupRef
	awscdk.ITaggable
	...
	DbSubnetGroupRef() *interfacesawsneptune.DBSubnetGroupReference
...
type jsiiProxy_CfnDBSubnetGroup struct {
	...
	internal.Type__interfacesawsneptuneIDBSubnetGroupRef
...
func (j *jsiiProxy_CfnDBSubnetGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDBSubnetGroup) DbSubnetGroupRef() *interfacesawsneptune.DBSubnetGroupReference {
	var returns *interfacesawsneptune.DBSubnetGroupReference
	_jsii_.Get(
		j,
		"dbSubnetGroupRef",
		&returns,
...
func NewCfnDBSubnetGroup(scope constructs.Construct, id *string, props *CfnDBSubnetGroupProps) CfnDBSubnetGroup {
	...
	if err := validateNewCfnDBSubnetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDBSubnetGroup)SetDbSubnetGroupDescription(val *string) {
	if err := j.validateSetDbSubnetGroupDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDBSubnetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDBSubnetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBSubnetGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBSubnetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDBSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBSubnetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBSubnetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDBSubnetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDBSubnetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
