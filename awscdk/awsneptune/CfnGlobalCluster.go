...
//
//   cfnGlobalCluster := awscdk.Aws_neptune.NewCfnGlobalCluster(this, jsii.String("MyCfnGlobalCluster"), &CfnGlobalClusterProps{
...
type CfnGlobalCluster interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsneptune.IGlobalClusterRef
	awscdk.ITaggableV2
	...
	GlobalClusterRef() *interfacesawsneptune.GlobalClusterReference
...
type jsiiProxy_CfnGlobalCluster struct {
	...
	internal.Type__interfacesawsneptuneIGlobalClusterRef
...
func (j *jsiiProxy_CfnGlobalCluster) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGlobalCluster) GlobalClusterRef() *interfacesawsneptune.GlobalClusterReference {
	var returns *interfacesawsneptune.GlobalClusterReference
	_jsii_.Get(
		j,
		"globalClusterRef",
		&returns,
...
func NewCfnGlobalCluster(scope constructs.Construct, id *string, props *CfnGlobalClusterProps) CfnGlobalCluster {
	...
	if err := validateNewCfnGlobalClusterParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnGlobalCluster{}

	_jsii_.Create(
		"aws-cdk-lib.aws_neptune.CfnGlobalCluster",
...
func CfnGlobalCluster_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGlobalCluster_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGlobalCluster_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGlobalCluster_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGlobalCluster_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGlobalCluster_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGlobalCluster) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGlobalCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGlobalCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGlobalCluster) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGlobalCluster) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGlobalCluster) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalCluster) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
