...
func (j *jsiiProxy_CfnDBInstance) CfnPropertyNames() *map[string]*string {
...
func CfnDBInstance_IsCfnDBInstance(x interface{}) *bool {
	...
	if err := validateCfnDBInstance_IsCfnDBInstanceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
