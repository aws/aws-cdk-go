...
type CfnEventSubscription interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsneptune.IEventSubscriptionRef
	awscdk.ITaggableV2
	...
	EventSubscriptionRef() *interfacesawsneptune.EventSubscriptionReference
...
type jsiiProxy_CfnEventSubscription struct {
	...
	internal.Type__interfacesawsneptuneIEventSubscriptionRef
...
func (j *jsiiProxy_CfnEventSubscription) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventSubscription) EventSubscriptionRef() *interfacesawsneptune.EventSubscriptionReference {
	var returns *interfacesawsneptune.EventSubscriptionReference
	_jsii_.Get(
		j,
...
func CfnEventSubscription_ArnForEventSubscription(resource interfacesawsneptune.IEventSubscriptionRef) *string {
	_init_.Initialize()
...
func CfnEventSubscription_FromSubscriptionName(scope constructs.Construct, id *string, subscriptionName *string) interfacesawsneptune.IEventSubscriptionRef {
	_init_.Initialize()

	if err := validateCfnEventSubscription_FromSubscriptionNameParameters(scope, id, subscriptionName); err != nil {
		panic(err)
	}
	var returns interfacesawsneptune.IEventSubscriptionRef
...
func CfnEventSubscription_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEventSubscription_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
