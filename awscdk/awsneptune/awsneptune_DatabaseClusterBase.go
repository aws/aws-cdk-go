...
//
//   databaseClusterBase := awscdk.Aws_neptune.DatabaseClusterBase_FromDatabaseClusterAttributes(this, jsii.String("MyDatabaseClusterBase"), &DatabaseClusterAttributes{
