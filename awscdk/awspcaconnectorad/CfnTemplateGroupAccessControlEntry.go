...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) GroupDisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupDisplayName",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) GroupSecurityIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) TemplateArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateArn",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTemplateGroupAccessControlEntry(scope constructs.Construct, id *string, props *CfnTemplateGroupAccessControlEntryProps) CfnTemplateGroupAccessControlEntry {
	...
	if err := validateNewCfnTemplateGroupAccessControlEntryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry)SetAccessRights(val interface{}) {
	if err := j.validateSetAccessRightsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTemplateGroupAccessControlEntry)SetGroupDisplayName(val *string) {
...
func CfnTemplateGroupAccessControlEntry_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTemplateGroupAccessControlEntry_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTemplateGroupAccessControlEntry_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTemplateGroupAccessControlEntry_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTemplateGroupAccessControlEntry_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTemplateGroupAccessControlEntry_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTemplateGroupAccessControlEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
