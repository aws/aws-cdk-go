...
func (j *jsiiProxy_CfnServicePrincipalName) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnServicePrincipalName) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServicePrincipalName) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnServicePrincipalName) ConnectorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectorArn",
...
func (j *jsiiProxy_CfnServicePrincipalName) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnServicePrincipalName) DirectoryRegistrationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnServicePrincipalName) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnServicePrincipalName) Node() constructs.Node {
...
func (j *jsiiProxy_CfnServicePrincipalName) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnServicePrincipalName) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnServicePrincipalName) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnServicePrincipalName) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnServicePrincipalName(scope constructs.Construct, id *string, props *CfnServicePrincipalNameProps) CfnServicePrincipalName {
	...
	if err := validateNewCfnServicePrincipalNameParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnServicePrincipalName_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnServicePrincipalName_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServicePrincipalName_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnServicePrincipalName_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServicePrincipalName) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnServicePrincipalName) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServicePrincipalName) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnServicePrincipalName) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServicePrincipalName) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServicePrincipalName) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnServicePrincipalName) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnServicePrincipalName) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServicePrincipalName) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnServicePrincipalName) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServicePrincipalName) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServicePrincipalName) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnServicePrincipalName) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServicePrincipalName) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnServicePrincipalName) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnServicePrincipalName) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnServicePrincipalName) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
