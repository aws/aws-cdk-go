...
func (j *jsiiProxy_CfnConnector) CertificateAuthorityArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConnector) DirectoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"directoryId",
...
func (j *jsiiProxy_CfnConnector) VpcInformation() interface{} {
...
func (j *jsiiProxy_CfnConnector)SetCertificateAuthorityArn(val *string) {
...
func (j *jsiiProxy_CfnConnector)SetDirectoryId(val *string) {
...
func (j *jsiiProxy_CfnConnector)SetVpcInformation(val interface{}) {
	if err := j.validateSetVpcInformationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConnector_ArnForConnector(resource interfacesawspcaconnectorad.IConnectorRef) *string {
	_init_.Initialize()
