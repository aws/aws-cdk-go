...
func (j *jsiiProxy_CfnCapability) AttrCapabilityId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCapabilityId",
...
func (j *jsiiProxy_CfnCapability) InstructionsDocuments() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCapability) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnCapability)SetInstructionsDocuments(val interface{}) {
	if err := j.validateSetInstructionsDocumentsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCapability)SetName(val *string) {
