...
func (j *jsiiProxy_CfnTransformer) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnTransformer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransformer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransformer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransformer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransformer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
