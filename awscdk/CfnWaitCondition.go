...
func (c *jsiiProxy_CfnWaitCondition) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWaitCondition) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnWaitCondition) RemoveResourceDependency(target CfnResource) {
