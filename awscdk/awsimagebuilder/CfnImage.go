...
func (j *jsiiProxy_CfnImage) CfnPropertyNames() *map[string]*string {
...
func CfnImage_ArnForImage(resource interfacesawsimagebuilder.IImageRef) *string {
	_init_.Initialize()
...
func CfnImage_IsCfnImage(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnImage_IsCfnImageParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnImage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnImage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnImage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnImage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
