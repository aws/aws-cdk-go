...
func (j *jsiiProxy_CfnInfrastructureConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnInfrastructureConfiguration_IsCfnInfrastructureConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnInfrastructureConfiguration_IsCfnInfrastructureConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_imagebuilder.CfnInfrastructureConfiguration",
		"isCfnInfrastructureConfiguration",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInfrastructureConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
