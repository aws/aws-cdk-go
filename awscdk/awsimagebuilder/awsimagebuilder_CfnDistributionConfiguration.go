...
func (j *jsiiProxy_CfnDistributionConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDistributionConfiguration(scope constructs.Construct, id *string, props *CfnDistributionConfigurationProps) CfnDistributionConfiguration {
	...
	if err := validateNewCfnDistributionConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDistributionConfiguration)SetDistributions(val interface{}) {
	if err := j.validateSetDistributionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDistributionConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDistributionConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistributionConfiguration_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDistributionConfiguration_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistributionConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDistributionConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDistributionConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDistributionConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDistributionConfiguration) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDistributionConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
