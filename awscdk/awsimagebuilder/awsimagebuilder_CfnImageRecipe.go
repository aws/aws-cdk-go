...
func (j *jsiiProxy_CfnImageRecipe) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnImageRecipe(scope constructs.Construct, id *string, props *CfnImageRecipeProps) CfnImageRecipe {
	...
	if err := validateNewCfnImageRecipeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnImageRecipe)SetAdditionalInstanceConfiguration(val interface{}) {
	if err := j.validateSetAdditionalInstanceConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnImageRecipe_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnImageRecipe_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnImageRecipe_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnImageRecipe_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnImageRecipe_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnImageRecipe_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnImageRecipe) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImageRecipe) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnImageRecipe) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnImageRecipe) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnImageRecipe) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImageRecipe) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
