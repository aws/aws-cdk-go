...
func (j *jsiiProxy_CfnImagePipeline) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnImagePipeline) ImageTags() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"imageTags",
...
func (j *jsiiProxy_CfnImagePipeline)SetImageTags(val interface{}) {
	if err := j.validateSetImageTagsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnImagePipeline_IsCfnImagePipeline(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnImagePipeline_IsCfnImagePipelineParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnImagePipeline) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnImagePipeline) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnImagePipeline) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnImagePipeline) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImagePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
