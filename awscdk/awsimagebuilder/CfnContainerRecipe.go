...
func (j *jsiiProxy_CfnContainerRecipe) CfnPropertyNames() *map[string]*string {
...
func CfnContainerRecipe_IsCfnContainerRecipe(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnContainerRecipe_IsCfnContainerRecipeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContainerRecipe) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContainerRecipe) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContainerRecipe) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContainerRecipe) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContainerRecipe) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
