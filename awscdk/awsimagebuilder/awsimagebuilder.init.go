...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnDistributionConfiguration.FastLaunchConfigurationProperty",
		reflect.TypeOf((*CfnDistributionConfiguration_FastLaunchConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnDistributionConfiguration.FastLaunchLaunchTemplateSpecificationProperty",
		reflect.TypeOf((*CfnDistributionConfiguration_FastLaunchLaunchTemplateSpecificationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnDistributionConfiguration.FastLaunchSnapshotConfigurationProperty",
