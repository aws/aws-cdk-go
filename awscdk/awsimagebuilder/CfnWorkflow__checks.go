...
func (j *jsiiProxy_CfnWorkflow) validateSetNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnWorkflow) validateSetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnWorkflow) validateSetVersionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
