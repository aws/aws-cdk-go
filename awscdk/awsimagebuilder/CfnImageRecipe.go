...
func (j *jsiiProxy_CfnImageRecipe) AmiWatermarks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"amiWatermarks",
...
func (j *jsiiProxy_CfnImageRecipe) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnImageRecipe)SetAmiWatermarks(val *[]*string) {
	_jsii_.Set(
		j,
		"amiWatermarks",
		val,
...
func CfnImageRecipe_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnImageRecipe_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnImageRecipe) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnImageRecipe) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnImageRecipe) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnImageRecipe) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImageRecipe) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
