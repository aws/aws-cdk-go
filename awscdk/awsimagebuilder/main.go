...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnContainerRecipe.ComponentParameterProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnImage.EcrConfigurationProperty",
		reflect.TypeOf((*CfnImage_EcrConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnImage.ImageScanningConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnImagePipeline.EcrConfigurationProperty",
		reflect.TypeOf((*CfnImagePipeline_EcrConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_imagebuilder.CfnImagePipeline.ImageScanningConfigurationProperty",
