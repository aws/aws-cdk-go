...
func (j *jsiiProxy_CfnDistributionConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnDistributionConfiguration_ArnForDistributionConfiguration(resource interfacesawsimagebuilder.IDistributionConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnDistributionConfiguration_ArnForDistributionConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_imagebuilder.CfnDistributionConfiguration",
		"arnForDistributionConfiguration",
		[]interface{}{resource},
		&returns,
	)
...
func CfnDistributionConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDistributionConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDistributionConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDistributionConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDistributionConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDistributionConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
