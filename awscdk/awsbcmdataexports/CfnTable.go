...
//
//   cfnTable := awscdk.Aws_bcmdataexports.NewCfnTable(this, jsii.String("MyCfnTable"), &CfnTableProps{
...
type CfnTable interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbcmdataexports.ITableRef
	...
	TableRef() *interfacesawsbcmdataexports.TableReference
	// Deprecated.
...
type jsiiProxy_CfnTable struct {
	...
	internal.Type__interfacesawsbcmdataexportsITableRef
}
...
func (j *jsiiProxy_CfnTable) AttrDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDescription",
...
func (j *jsiiProxy_CfnTable) AttrSchema() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTable) TableRef() *interfacesawsbcmdataexports.TableReference {
	var returns *interfacesawsbcmdataexports.TableReference
	_jsii_.Get(
		j,
		"tableRef",
		&returns,
...
// Create a new `AWS::BCMDataExports::Table`.
func NewCfnTable(scope constructs.Construct, id *string, props *CfnTableProps) CfnTable {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_bcmdataexports.CfnTable",
...
func CfnTable_ArnForTable(resource interfacesawsbcmdataexports.ITableRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
