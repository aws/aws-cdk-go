...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_storagegateway.CfnTapePool",
		reflect.TypeOf((*CfnTapePool)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "tapePoolRef", GoGetter: "TapePoolRef"},
		...
		func() interface{} {
			j := jsiiProxy_CfnTapePool{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsstoragegatewayITapePoolRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_storagegateway.CfnTapePoolProps",
		reflect.TypeOf((*CfnTapePoolProps)(nil)).Elem(),
	)
}
