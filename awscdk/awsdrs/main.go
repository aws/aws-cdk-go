...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnSourceNetwork)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrSourceNetworkId", GoGetter: "AttrSourceNetworkId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "originAccountId", GoGetter: "OriginAccountId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceNetworkRef", GoGetter: "SourceNetworkRef"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsdrsISourceNetworkRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_drs.CfnSourceNetworkProps",
		reflect.TypeOf((*CfnSourceNetworkProps)(nil)).Elem(),
	)
}
