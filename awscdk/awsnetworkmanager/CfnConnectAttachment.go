...
func (j *jsiiProxy_CfnConnectAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConnectAttachment) ProposedSegmentChange() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConnectAttachment) RoutingPolicyLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingPolicyLabel",
...
func (j *jsiiProxy_CfnConnectAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConnectAttachment(scope constructs.Construct, id *string, props *CfnConnectAttachmentProps) CfnConnectAttachment {
	...
	if err := validateNewCfnConnectAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConnectAttachment)SetProposedSegmentChange(val interface{}) {
...
func (j *jsiiProxy_CfnConnectAttachment)SetRoutingPolicyLabel(val *string) {
	_jsii_.Set(
		j,
		"routingPolicyLabel",
		val,
...
func CfnConnectAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConnectAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConnectAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConnectAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConnectAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConnectAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConnectAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
