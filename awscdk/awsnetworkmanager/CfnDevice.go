...
func (j *jsiiProxy_CfnDevice) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDevice) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDevice) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDevice(scope constructs.Construct, id *string, props *CfnDeviceProps) CfnDevice {
	...
	if err := validateNewCfnDeviceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDevice_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDevice_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDevice_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDevice_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDevice) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDevice) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDevice) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDevice) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDevice) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDevice) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDevice) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDevice) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDevice) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDevice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
