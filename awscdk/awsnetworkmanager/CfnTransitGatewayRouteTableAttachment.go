...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAttachment) RoutingPolicyLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingPolicyLabel",
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAttachment)SetRoutingPolicyLabel(val *string) {
	_jsii_.Set(
		j,
		"routingPolicyLabel",
		val,
...
func CfnTransitGatewayRouteTableAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTableAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTableAttachment_IsCfnTransitGatewayRouteTableAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTransitGatewayRouteTableAttachment_IsCfnTransitGatewayRouteTableAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_networkmanager.CfnTransitGatewayRouteTableAttachment",
		"isCfnTransitGatewayRouteTableAttachment",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
