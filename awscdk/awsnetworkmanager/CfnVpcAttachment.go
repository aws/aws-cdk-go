...
func (j *jsiiProxy_CfnVpcAttachment) AttrProposedNetworkFunctionGroupChange() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnVpcAttachment) AttrProposedSegmentChange() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVpcAttachment) CfnPropertyNames() *map[string]*string {
...
func CfnVpcAttachment_IsCfnVpcAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcAttachment_IsCfnVpcAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
