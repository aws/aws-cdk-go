...
func (j *jsiiProxy_CfnVpcAttachment) AttrProposedSegmentChangeAttachmentPolicyRuleNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVpcAttachment) AttrProposedSegmentChangeSegmentName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVpcAttachment) AttrProposedSegmentChangeTags() awscdk.IResolvable {
