...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment) AttrProposedSegmentChangeAttachmentPolicyRuleNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment) AttrProposedSegmentChangeSegmentName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment) AttrProposedSegmentChangeTags() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSiteToSiteVpnAttachment(scope constructs.Construct, id *string, props *CfnSiteToSiteVpnAttachmentProps) CfnSiteToSiteVpnAttachment {
	...
	if err := validateNewCfnSiteToSiteVpnAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSiteToSiteVpnAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSiteToSiteVpnAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSiteToSiteVpnAttachment_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnSiteToSiteVpnAttachment_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSiteToSiteVpnAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSiteToSiteVpnAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
