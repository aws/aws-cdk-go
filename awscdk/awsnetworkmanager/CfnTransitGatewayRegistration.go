...
func (j *jsiiProxy_CfnTransitGatewayRegistration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRegistration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayRegistration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayRegistration(scope constructs.Construct, id *string, props *CfnTransitGatewayRegistrationProps) CfnTransitGatewayRegistration {
	...
	if err := validateNewCfnTransitGatewayRegistrationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTransitGatewayRegistration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRegistration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRegistration_IsCfnTransitGatewayRegistration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTransitGatewayRegistration_IsCfnTransitGatewayRegistrationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_networkmanager.CfnTransitGatewayRegistration",
		"isCfnTransitGatewayRegistration",
		[]interface{}{x},
		&returns,
	)
...
func CfnTransitGatewayRegistration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRegistration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRegistration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
