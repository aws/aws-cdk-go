...
func (j *jsiiProxy_CfnLinkAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLinkAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLinkAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLinkAssociation(scope constructs.Construct, id *string, props *CfnLinkAssociationProps) CfnLinkAssociation {
	...
	if err := validateNewCfnLinkAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLinkAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLinkAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLinkAssociation_IsCfnLinkAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLinkAssociation_IsCfnLinkAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLinkAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLinkAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLinkAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLinkAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLinkAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLinkAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLinkAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLinkAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLinkAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLinkAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLinkAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLinkAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLinkAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLinkAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
