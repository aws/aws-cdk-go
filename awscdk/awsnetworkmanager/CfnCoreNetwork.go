...
func (j *jsiiProxy_CfnCoreNetwork) CfnPropertyNames() *map[string]*string {
...
func CfnCoreNetwork_ArnForCoreNetwork(resource interfacesawsnetworkmanager.ICoreNetworkRef) *string {
	_init_.Initialize()

	if err := validateCfnCoreNetwork_ArnForCoreNetworkParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnCoreNetwork_IsCfnCoreNetwork(x interface{}) *bool {
	...
	if err := validateCfnCoreNetwork_IsCfnCoreNetworkParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCoreNetwork_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCoreNetwork_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCoreNetwork) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCoreNetwork) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCoreNetwork) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCoreNetwork) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreNetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
