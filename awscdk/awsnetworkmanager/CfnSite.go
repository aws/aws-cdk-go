...
func (j *jsiiProxy_CfnSite) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSite) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSite) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSite(scope constructs.Construct, id *string, props *CfnSiteProps) CfnSite {
	...
	if err := validateNewCfnSiteParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnSite{}
...
func CfnSite_ArnForSite(resource interfacesawsnetworkmanager.ISiteRef) *string {
	_init_.Initialize()

	if err := validateCfnSite_ArnForSiteParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnSite_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSite_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSite_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSite_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSite_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSite_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSite) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSite) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSite) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSite) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSite) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSite) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSite) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSite) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSite) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSite) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
