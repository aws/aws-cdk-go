...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment) ProposedSegmentChange() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachment)SetProposedSegmentChange(val interface{}) {
...
func CfnSiteToSiteVpnAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSiteToSiteVpnAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSiteToSiteVpnAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
