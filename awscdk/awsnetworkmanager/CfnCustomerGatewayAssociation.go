...
func (j *jsiiProxy_CfnCustomerGatewayAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCustomerGatewayAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCustomerGatewayAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCustomerGatewayAssociation(scope constructs.Construct, id *string, props *CfnCustomerGatewayAssociationProps) CfnCustomerGatewayAssociation {
	...
	if err := validateNewCfnCustomerGatewayAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCustomerGatewayAssociation_IsCfnCustomerGatewayAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCustomerGatewayAssociation_IsCfnCustomerGatewayAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomerGatewayAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomerGatewayAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomerGatewayAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCustomerGatewayAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomerGatewayAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomerGatewayAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGatewayAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
