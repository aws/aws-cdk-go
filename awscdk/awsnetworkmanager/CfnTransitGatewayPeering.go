...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrEdgeLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEdgeLocation",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrOwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerAccountId",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrPeeringId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPeeringId",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrPeeringType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPeeringType",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrResourceArn",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) AttrTransitGatewayPeeringAttachmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CoreNetworkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"coreNetworkId",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTransitGatewayPeering) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTransitGatewayPeering) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayPeering(scope constructs.Construct, id *string, props *CfnTransitGatewayPeeringProps) CfnTransitGatewayPeering {
	...
	if err := validateNewCfnTransitGatewayPeeringParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTransitGatewayPeering)SetCoreNetworkId(val *string) {
...
func (j *jsiiProxy_CfnTransitGatewayPeering)SetTransitGatewayArn(val *string) {
...
func CfnTransitGatewayPeering_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeering_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayPeering_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeering_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayPeering_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeering_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayPeering) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTransitGatewayPeering) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTransitGatewayPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
