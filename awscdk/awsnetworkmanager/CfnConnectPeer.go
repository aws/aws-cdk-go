...
func (j *jsiiProxy_CfnConnectPeer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConnectPeer) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConnectPeer) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnConnectPeer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConnectPeer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConnectPeer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectPeer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectPeer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectPeer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectPeer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConnectPeer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConnectPeer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectPeer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectPeer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectPeer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
