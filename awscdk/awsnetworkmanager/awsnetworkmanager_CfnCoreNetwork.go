...
func (j *jsiiProxy_CfnCoreNetwork) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCoreNetwork) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCoreNetwork(scope constructs.Construct, id *string, props *CfnCoreNetworkProps) CfnCoreNetwork {
	...
	if err := validateNewCfnCoreNetworkParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCoreNetwork_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCoreNetwork_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCoreNetwork_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCoreNetwork_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCoreNetwork_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCoreNetwork_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCoreNetwork) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreNetwork) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCoreNetwork) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCoreNetwork) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCoreNetwork) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreNetwork) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
