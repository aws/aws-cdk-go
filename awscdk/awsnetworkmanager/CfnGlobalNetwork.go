...
func (j *jsiiProxy_CfnGlobalNetwork) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGlobalNetwork) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGlobalNetwork) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGlobalNetwork(scope constructs.Construct, id *string, props *CfnGlobalNetworkProps) CfnGlobalNetwork {
	...
	if err := validateNewCfnGlobalNetworkParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGlobalNetwork_ArnForGlobalNetwork(resource interfacesawsnetworkmanager.IGlobalNetworkRef) *string {
	_init_.Initialize()

	if err := validateCfnGlobalNetwork_ArnForGlobalNetworkParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnGlobalNetwork_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGlobalNetwork_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGlobalNetwork_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGlobalNetwork_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGlobalNetwork_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGlobalNetwork_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGlobalNetwork) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalNetwork) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGlobalNetwork) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGlobalNetwork) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGlobalNetwork) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGlobalNetwork) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGlobalNetwork) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalNetwork) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalNetwork) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalNetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
