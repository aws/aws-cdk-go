...
func (j *jsiiProxy_CfnUser) validateSetAuthenticationModeParameters(val interface{}) error {
	...
	switch val.(type) {
	case *CfnUser_AuthenticationModeProperty:
		val := val.(*CfnUser_AuthenticationModeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnUser_AuthenticationModeProperty:
		val_ := val.(CfnUser_AuthenticationModeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnUser_AuthenticationModeProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
