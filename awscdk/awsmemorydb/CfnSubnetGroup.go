...
func (j *jsiiProxy_CfnSubnetGroup) AttrSupportedNetworkTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrSupportedNetworkTypes",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnSubnetGroup) CfnPropertyNames() *map[string]*string {
...
func CfnSubnetGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubnetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubnetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubnetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubnetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubnetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
