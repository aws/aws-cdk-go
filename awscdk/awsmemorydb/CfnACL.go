...
func (j *jsiiProxy_CfnACL) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnACL) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnACL(scope constructs.Construct, id *string, props *CfnACLProps) CfnACL {
	...
	if err := validateNewCfnACLParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnACL{}
...
func CfnACL_IsCfnACL(x interface{}) *bool {
	...
	if err := validateCfnACL_IsCfnACLParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnACL_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnACL_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnACL_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnACL_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnACL_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnACL_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnACL) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnACL) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnACL) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnACL) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnACL) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnACL) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnACL) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnACL) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnACL) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnACL) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
