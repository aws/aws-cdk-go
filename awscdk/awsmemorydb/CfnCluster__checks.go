...
func (j *jsiiProxy_CfnCluster) validateSetAclNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetAutoMinorVersionUpgradeParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
