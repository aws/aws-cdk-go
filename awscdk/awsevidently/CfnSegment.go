...
func (j *jsiiProxy_CfnSegment) CfnPropertyNames() *map[string]*string {
...
func NewCfnSegment(scope constructs.Construct, id *string, props *CfnSegmentProps) CfnSegment {
	...
	if err := validateNewCfnSegmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSegment_ArnForSegment(resource interfacesawsevidently.ISegmentRef) *string {
	_init_.Initialize()
...
func CfnSegment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSegment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSegment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSegment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSegment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSegment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSegment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSegment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSegment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSegment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSegment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSegment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSegment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSegment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSegment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSegment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
