...
func (j *jsiiProxy_CfnLaunch) CfnPropertyNames() *map[string]*string {
...
func CfnLaunch_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLaunch_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunch) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunch) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunch) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunch) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunch) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
