...
//   import "github.com/aws/aws-cdk-go/awscdk"
//
//   cfnSegment := awscdk.Aws_evidently.NewCfnSegment(this, jsii.String("MyCfnSegment"), &cfnSegmentProps{
//   	name: jsii.String("name"),
//
//   	// the properties below are optional
//   	description: jsii.String("description"),
...
func (j *jsiiProxy_CfnSegment) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnSegment) Pattern() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pattern",
...
func (j *jsiiProxy_CfnSegment) SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnSegment) SetPattern(val *string) {
	_jsii_.Set(
		j,
		"pattern",
		val,
