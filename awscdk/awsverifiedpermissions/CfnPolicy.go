...
//
//   cfnPolicy := awscdk.Aws_verifiedpermissions.NewCfnPolicy(this, jsii.String("MyCfnPolicy"), &CfnPolicyProps{
...
func (j *jsiiProxy_CfnPolicy) AttrPolicyType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPolicyType",
...
func (j *jsiiProxy_CfnPolicy) PolicyStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyStoreId",
