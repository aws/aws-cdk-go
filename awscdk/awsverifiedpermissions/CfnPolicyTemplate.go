...
func (j *jsiiProxy_CfnPolicyTemplate) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPolicyTemplate) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPolicyTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPolicyTemplate) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPolicyTemplate) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPolicyTemplate) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnPolicyTemplate) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPolicyTemplate) PolicyStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyStoreId",
...
func (j *jsiiProxy_CfnPolicyTemplate) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPolicyTemplate) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPolicyTemplate) Statement() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statement",
...
func (j *jsiiProxy_CfnPolicyTemplate) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnPolicyTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPolicyTemplate(scope constructs.Construct, id *string, props *CfnPolicyTemplateProps) CfnPolicyTemplate {
	...
	if err := validateNewCfnPolicyTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPolicyTemplate)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnPolicyTemplate)SetStatement(val *string) {
...
func CfnPolicyTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPolicyTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPolicyTemplate_IsCfnPolicyTemplate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPolicyTemplate_IsCfnPolicyTemplateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPolicyTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPolicyTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPolicyTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPolicyTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPolicyTemplate) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPolicyTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPolicyTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPolicyTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPolicyTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPolicyTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPolicyTemplate) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPolicyTemplate) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPolicyTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPolicyTemplate) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPolicyTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyTemplate) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPolicyTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyTemplate) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPolicyTemplate) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPolicyTemplate) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPolicyTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
