...
type CfnFunctionDefinitionVersion interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsgreengrass.IFunctionDefinitionVersionRef
	AttrId() *string
	...
	FunctionDefinitionVersionRef() *interfacesawsgreengrass.FunctionDefinitionVersionReference
...
type jsiiProxy_CfnFunctionDefinitionVersion struct {
	...
	internal.Type__interfacesawsgreengrassIFunctionDefinitionVersionRef
}
...
func (j *jsiiProxy_CfnFunctionDefinitionVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFunctionDefinitionVersion) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnFunctionDefinitionVersion) FunctionDefinitionVersionRef() *interfacesawsgreengrass.FunctionDefinitionVersionReference {
	var returns *interfacesawsgreengrass.FunctionDefinitionVersionReference
	_jsii_.Get(
		j,
...
func CfnFunctionDefinitionVersion_IsCfnFunctionDefinitionVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFunctionDefinitionVersion_IsCfnFunctionDefinitionVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
