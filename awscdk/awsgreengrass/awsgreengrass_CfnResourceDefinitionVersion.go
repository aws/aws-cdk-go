...
func (j *jsiiProxy_CfnResourceDefinitionVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceDefinitionVersion(scope constructs.Construct, id *string, props *CfnResourceDefinitionVersionProps) CfnResourceDefinitionVersion {
	...
	if err := validateNewCfnResourceDefinitionVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceDefinitionVersion)SetResourceDefinitionId(val *string) {
	if err := j.validateSetResourceDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResourceDefinitionVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceDefinitionVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinitionVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResourceDefinitionVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinitionVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceDefinitionVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
