...
func (j *jsiiProxy_CfnResourceDefinition) CfnPropertyNames() *map[string]*string {
...
func CfnResourceDefinition_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinition_IsCfnResourceDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceDefinition_IsCfnResourceDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
