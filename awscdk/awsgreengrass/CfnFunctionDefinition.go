...
func (j *jsiiProxy_CfnFunctionDefinition) CfnPropertyNames() *map[string]*string {
...
func NewCfnFunctionDefinition(scope constructs.Construct, id *string, props *CfnFunctionDefinitionProps) CfnFunctionDefinition {
	...
	if err := validateNewCfnFunctionDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnFunctionDefinition_ArnForFunctionDefinition(resource interfacesawsgreengrass.IFunctionDefinitionRef) *string {
	_init_.Initialize()

	if err := validateCfnFunctionDefinition_ArnForFunctionDefinitionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFunctionDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFunctionDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFunctionDefinition_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFunctionDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFunctionDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFunctionDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFunctionDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFunctionDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFunctionDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFunctionDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFunctionDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFunctionDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
