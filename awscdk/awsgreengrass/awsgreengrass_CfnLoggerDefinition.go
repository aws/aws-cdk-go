...
func NewCfnLoggerDefinition(scope constructs.Construct, id *string, props *CfnLoggerDefinitionProps) CfnLoggerDefinition {
	...
	if err := validateNewCfnLoggerDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLoggerDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLoggerDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLoggerDefinition_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnLoggerDefinition_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLoggerDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLoggerDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLoggerDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLoggerDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLoggerDefinition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLoggerDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
