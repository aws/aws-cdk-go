...
func (j *jsiiProxy_CfnLoggerDefinition) CfnPropertyNames() *map[string]*string {
...
func CfnLoggerDefinition_IsCfnLoggerDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLoggerDefinition_IsCfnLoggerDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLoggerDefinition_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLoggerDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLoggerDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLoggerDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLoggerDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLoggerDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
