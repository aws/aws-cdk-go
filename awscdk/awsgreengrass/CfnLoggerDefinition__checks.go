...
func (c *jsiiProxy_CfnLoggerDefinition) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnLoggerDefinition) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnLoggerDefinition) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnLoggerDefinition) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnLoggerDefinition_ArnForLoggerDefinitionParameters(resource interfacesawsgreengrass.ILoggerDefinitionRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnLoggerDefinition) validateSetInitialVersionParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnLoggerDefinition_LoggerDefinitionVersionProperty; received %#v (a %T)", val, val)
		}
	}
