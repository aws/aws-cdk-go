...
func (j *jsiiProxy_CfnDeviceDefinition) CfnPropertyNames() *map[string]*string {
...
func CfnDeviceDefinition_FromDeviceDefinitionId(scope constructs.Construct, id *string, deviceDefinitionId *string) interfacesawsgreengrass.IDeviceDefinitionRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_greengrass.CfnDeviceDefinition",
		"fromDeviceDefinitionId",
		[]interface{}{scope, id, deviceDefinitionId},
		&returns,
	)
...
func (c *jsiiProxy_CfnDeviceDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeviceDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeviceDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeviceDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
