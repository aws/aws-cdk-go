...
func (j *jsiiProxy_CfnGroupVersion) CfnPropertyNames() *map[string]*string {
...
func CfnGroupVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGroupVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGroupVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroupVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroupVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroupVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
