...
func (j *jsiiProxy_CfnCoreDefinition) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCoreDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCoreDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCoreDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCoreDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
