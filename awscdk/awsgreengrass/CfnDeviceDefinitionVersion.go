...
func (j *jsiiProxy_CfnDeviceDefinitionVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDeviceDefinitionVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDeviceDefinitionVersion(scope constructs.Construct, id *string, props *CfnDeviceDefinitionVersionProps) CfnDeviceDefinitionVersion {
	...
	if err := validateNewCfnDeviceDefinitionVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDeviceDefinitionVersion)SetDeviceDefinitionId(val *string) {
	if err := j.validateSetDeviceDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDeviceDefinitionVersion_IsCfnDeviceDefinitionVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeviceDefinitionVersion_IsCfnDeviceDefinitionVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceDefinitionVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeviceDefinitionVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceDefinitionVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeviceDefinitionVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceDefinitionVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeviceDefinitionVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinitionVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
