...
func (j *jsiiProxy_CfnLoggerDefinitionVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLoggerDefinitionVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLoggerDefinitionVersion(scope constructs.Construct, id *string, props *CfnLoggerDefinitionVersionProps) CfnLoggerDefinitionVersion {
	...
	if err := validateNewCfnLoggerDefinitionVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLoggerDefinitionVersion)SetLoggerDefinitionId(val *string) {
	if err := j.validateSetLoggerDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnLoggerDefinitionVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLoggerDefinitionVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLoggerDefinitionVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLoggerDefinitionVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLoggerDefinitionVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLoggerDefinitionVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggerDefinitionVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
