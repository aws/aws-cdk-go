...
func NewCfnGroupVersion(scope constructs.Construct, id *string, props *CfnGroupVersionProps) CfnGroupVersion {
	...
	if err := validateNewCfnGroupVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGroupVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGroupVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnGroupVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGroupVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGroupVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGroupVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGroupVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnGroupVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
