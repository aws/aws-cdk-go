...
func NewCfnResourceDefinition(scope constructs.Construct, id *string, props *CfnResourceDefinitionProps) CfnResourceDefinition {
	...
	if err := validateNewCfnResourceDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResourceDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinition_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResourceDefinition_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceDefinition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
