...
func NewCfnDeviceDefinition(scope constructs.Construct, id *string, props *CfnDeviceDefinitionProps) CfnDeviceDefinition {
	...
	if err := validateNewCfnDeviceDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDeviceDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeviceDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeviceDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeviceDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeviceDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeviceDefinition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDeviceDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
