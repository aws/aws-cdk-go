...
func (j *jsiiProxy_CfnGroup) TagsRaw() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsRaw",
...
func (j *jsiiProxy_CfnGroup)SetTagsRaw(val interface{}) {
...
func CfnGroup_ArnForGroup(resource interfacesawsgreengrass.IGroupRef) *string {
	_init_.Initialize()
