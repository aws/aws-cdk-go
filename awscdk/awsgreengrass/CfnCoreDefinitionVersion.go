...
type CfnCoreDefinitionVersion interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsgreengrass.ICoreDefinitionVersionRef
	AttrId() *string
	...
	CoreDefinitionVersionRef() *interfacesawsgreengrass.CoreDefinitionVersionReference
...
type jsiiProxy_CfnCoreDefinitionVersion struct {
	...
	internal.Type__interfacesawsgreengrassICoreDefinitionVersionRef
}
...
func (j *jsiiProxy_CfnCoreDefinitionVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCoreDefinitionVersion) CoreDefinitionVersionRef() *interfacesawsgreengrass.CoreDefinitionVersionReference {
	var returns *interfacesawsgreengrass.CoreDefinitionVersionReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCoreDefinitionVersion) Env() *interfaces.ResourceEnvironment {
...
func CfnCoreDefinitionVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCoreDefinitionVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
