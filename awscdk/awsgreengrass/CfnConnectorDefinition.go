...
func (j *jsiiProxy_CfnConnectorDefinition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConnectorDefinition) TagsRaw() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsRaw",
...
func NewCfnConnectorDefinition(scope constructs.Construct, id *string, props *CfnConnectorDefinitionProps) CfnConnectorDefinition {
	...
	if err := validateNewCfnConnectorDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConnectorDefinition)SetTagsRaw(val interface{}) {
...
func CfnConnectorDefinition_IsCfnConnectorDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectorDefinition_IsCfnConnectorDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectorDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConnectorDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectorDefinition_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectorDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectorDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConnectorDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConnectorDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectorDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectorDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectorDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectorDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConnectorDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConnectorDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectorDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectorDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectorDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
