...
func NewCfnFunctionDefinitionVersion(scope constructs.Construct, id *string, props *CfnFunctionDefinitionVersionProps) CfnFunctionDefinitionVersion {
	...
	if err := validateNewCfnFunctionDefinitionVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFunctionDefinitionVersion)SetDefaultConfig(val interface{}) {
	if err := j.validateSetDefaultConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnFunctionDefinitionVersion)SetFunctionDefinitionId(val *string) {
	if err := j.validateSetFunctionDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFunctionDefinitionVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFunctionDefinitionVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFunctionDefinitionVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFunctionDefinitionVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionDefinitionVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
