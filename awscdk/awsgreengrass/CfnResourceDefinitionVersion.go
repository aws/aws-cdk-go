...
type CfnResourceDefinitionVersion interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsgreengrass.IResourceDefinitionVersionRef
	AttrId() *string
	...
	ResourceDefinitionVersionRef() *interfacesawsgreengrass.ResourceDefinitionVersionReference
...
type jsiiProxy_CfnResourceDefinitionVersion struct {
	...
	internal.Type__interfacesawsgreengrassIResourceDefinitionVersionRef
}
...
func (j *jsiiProxy_CfnResourceDefinitionVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourceDefinitionVersion) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnResourceDefinitionVersion) ResourceDefinitionVersionRef() *interfacesawsgreengrass.ResourceDefinitionVersionReference {
	var returns *interfacesawsgreengrass.ResourceDefinitionVersionReference
	_jsii_.Get(
		j,
...
func CfnResourceDefinitionVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceDefinitionVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefinitionVersion_IsCfnResourceDefinitionVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceDefinitionVersion_IsCfnResourceDefinitionVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_greengrass.CfnResourceDefinitionVersion",
		"isCfnResourceDefinitionVersion",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefinitionVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
