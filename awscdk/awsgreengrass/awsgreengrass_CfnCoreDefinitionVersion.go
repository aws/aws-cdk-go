...
func NewCfnCoreDefinitionVersion(scope constructs.Construct, id *string, props *CfnCoreDefinitionVersionProps) CfnCoreDefinitionVersion {
	...
	if err := validateNewCfnCoreDefinitionVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCoreDefinitionVersion)SetCoreDefinitionId(val *string) {
	if err := j.validateSetCoreDefinitionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCoreDefinitionVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCoreDefinitionVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCoreDefinitionVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCoreDefinitionVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCoreDefinitionVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCoreDefinitionVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCoreDefinitionVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
