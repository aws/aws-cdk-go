...
func (j *jsiiProxy_CfnPermissionSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPermissionSet(scope constructs.Construct, id *string, props *CfnPermissionSetProps) CfnPermissionSet {
	...
	if err := validateNewCfnPermissionSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPermissionSet)SetCustomerManagedPolicyReferences(val interface{}) {
	if err := j.validateSetCustomerManagedPolicyReferencesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPermissionSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPermissionSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermissionSet_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPermissionSet_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermissionSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPermissionSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPermissionSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissionSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPermissionSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPermissionSet) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPermissionSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissionSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
