...
//
//   cfnApplication := awscdk.Aws_sso.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssso.IApplicationRef
	awscdk.ITaggableV2
	...
	SetPortalOptions(val interface{})
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsssoIApplicationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnApplication) ApplicationProviderArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawssso.ApplicationReference {
	var returns *interfacesawssso.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnApplication) PortalOptions() interface{} {
...
func (j *jsiiProxy_CfnApplication) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func NewCfnApplication(scope constructs.Construct, id *string, props *CfnApplicationProps) CfnApplication {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_sso.CfnApplication",
...
func (j *jsiiProxy_CfnApplication)SetApplicationProviderArn(val *string) {
...
func (j *jsiiProxy_CfnApplication)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnApplication)SetPortalOptions(val interface{}) {
	if err := j.validateSetPortalOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnApplication_ArnForApplication(resource interfacesawssso.IApplicationRef) *string {
	_init_.Initialize()
