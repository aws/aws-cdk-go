...
func (j *jsiiProxy_CfnInstance) AttrIdentityStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentityStoreId",
...
func (j *jsiiProxy_CfnInstance) AttrOwnerAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerAccountId",
...
func (j *jsiiProxy_CfnInstance) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnInstance) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnInstance)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func CfnInstance_IsCfnInstance(x interface{}) *bool {
	...
	if err := validateCfnInstance_IsCfnInstanceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
