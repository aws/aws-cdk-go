...
func (j *jsiiProxy_CfnPermissionSet) CfnPropertyNames() *map[string]*string {
...
func CfnPermissionSet_ArnForPermissionSet(resource interfacesawssso.IPermissionSetRef) *string {
	_init_.Initialize()

	if err := validateCfnPermissionSet_ArnForPermissionSetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPermissionSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPermissionSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPermissionSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPermissionSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPermissionSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPermissionSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissionSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
