...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnExecution)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrExecutionArn", GoGetter: "AttrExecutionArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrRedriveCount", GoGetter: "AttrRedriveCount"},
			_jsii_.MemberProperty{JsiiProperty: "attrRedriveStatus", GoGetter: "AttrRedriveStatus"},
			_jsii_.MemberProperty{JsiiProperty: "attrStartDate", GoGetter: "AttrStartDate"},
			_jsii_.MemberProperty{JsiiProperty: "attrStateMachineName", GoGetter: "AttrStateMachineName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "executionRef", GoGetter: "ExecutionRef"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsstatesIExecutionRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_states.CfnExecutionProps",
		reflect.TypeOf((*CfnExecutionProps)(nil)).Elem(),
	)
}
