...
func (j *jsiiProxy_CfnEnabledControl) CfnPropertyNames() *map[string]*string {
...
func CfnEnabledControl_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEnabledControl_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEnabledControl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEnabledControl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEnabledControl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEnabledControl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnabledControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
