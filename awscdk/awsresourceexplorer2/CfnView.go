...
//
//   cfnView := awscdk.Aws_resourceexplorer2.NewCfnView(this, jsii.String("MyCfnView"), &CfnViewProps{
...
func (j *jsiiProxy_CfnView) Filters() interface{} {
...
func (j *jsiiProxy_CfnView) IncludedProperties() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"includedProperties",
...
func (j *jsiiProxy_CfnView) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnView) ViewName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"viewName",
...
func (j *jsiiProxy_CfnView)SetFilters(val interface{}) {
...
func (j *jsiiProxy_CfnView)SetIncludedProperties(val interface{}) {
	if err := j.validateSetIncludedPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnView)SetViewName(val *string) {
...
func CfnView_ArnForView(resource interfacesawsresourceexplorer2.IViewRef) *string {
	_init_.Initialize()
