...
func (j *jsiiProxy_CfnDefaultViewAssociation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDefaultViewAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDefaultViewAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDefaultViewAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDefaultViewAssociation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDefaultViewAssociation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnDefaultViewAssociation) ViewArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"viewArn",
...
func NewCfnDefaultViewAssociation(scope constructs.Construct, id *string, props *CfnDefaultViewAssociationProps) CfnDefaultViewAssociation {
	...
	if err := validateNewCfnDefaultViewAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDefaultViewAssociation)SetViewArn(val *string) {
...
func CfnDefaultViewAssociation_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDefaultViewAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDefaultViewAssociation_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDefaultViewAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDefaultViewAssociation_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_resourceexplorer2.CfnDefaultViewAssociation",
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDefaultViewAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDefaultViewAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDefaultViewAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
