...
//
//   cfnIndex := awscdk.Aws_resourceexplorer2.NewCfnIndex(this, jsii.String("MyCfnIndex"), &CfnIndexProps{
...
func (j *jsiiProxy_CfnIndex) AttrIndexState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIndexState",
...
func (j *jsiiProxy_CfnIndex)SetType(val *string) {
