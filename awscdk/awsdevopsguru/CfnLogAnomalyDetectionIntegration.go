...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnLogAnomalyDetectionIntegration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnLogAnomalyDetectionIntegration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLogAnomalyDetectionIntegration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogAnomalyDetectionIntegration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLogAnomalyDetectionIntegration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogAnomalyDetectionIntegration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLogAnomalyDetectionIntegration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogAnomalyDetectionIntegration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_devopsguru.CfnLogAnomalyDetectionIntegration",
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnLogAnomalyDetectionIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
