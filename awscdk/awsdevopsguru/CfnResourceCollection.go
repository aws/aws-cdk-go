...
func (j *jsiiProxy_CfnResourceCollection) CfnPropertyNames() *map[string]*string {
...
func NewCfnResourceCollection(scope constructs.Construct, id *string, props *CfnResourceCollectionProps) CfnResourceCollection {
	...
	if err := validateNewCfnResourceCollectionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceCollection)SetResourceCollectionFilter(val interface{}) {
	if err := j.validateSetResourceCollectionFilterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResourceCollection_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceCollection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceCollection_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceCollection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceCollection_IsCfnResourceCollection(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceCollection_IsCfnResourceCollectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceCollection_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceCollection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceCollection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceCollection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceCollection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceCollection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceCollection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceCollection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceCollection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceCollection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceCollection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
