...
func validateCfnMonitor_FromMonitorNameParameters(scope constructs.Construct, id *string, monitorName *string) error {
	...
	if monitorName == nil {
		return fmt.Errorf("parameter monitorName is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnMonitor) validateSetInternetMeasurementsLogDeliveryParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnMonitor_InternetMeasurementsLogDeliveryProperty:
		val := val.(*CfnMonitor_InternetMeasurementsLogDeliveryProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnMonitor_InternetMeasurementsLogDeliveryProperty:
		val_ := val.(CfnMonitor_InternetMeasurementsLogDeliveryProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnMonitor_InternetMeasurementsLogDeliveryProperty; received %#v (a %T)", val, val)
		}
	}
