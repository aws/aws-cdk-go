...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnFlowTemplate)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "compatibleNamespaceVersion", GoGetter: "CompatibleNamespaceVersion"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnFlowTemplate_DefinitionDocumentProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
