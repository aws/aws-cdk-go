...
func (j *jsiiProxy_CfnFlowTemplate) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnFlowTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFlowTemplate) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnFlowTemplate) CompatibleNamespaceVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFlowTemplate) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnFlowTemplate) Definition() interface{} {
...
func (j *jsiiProxy_CfnFlowTemplate) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnFlowTemplate) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnFlowTemplate) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnFlowTemplate) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnFlowTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFlowTemplate(scope constructs.Construct, id *string, props *CfnFlowTemplateProps) CfnFlowTemplate {
	...
	if err := validateNewCfnFlowTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFlowTemplate)SetCompatibleNamespaceVersion(val *float64) {
	_jsii_.Set(
		j,
		"compatibleNamespaceVersion",
		val,
...
func (j *jsiiProxy_CfnFlowTemplate)SetDefinition(val interface{}) {
...
func CfnFlowTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFlowTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFlowTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFlowTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowTemplate) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnFlowTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnFlowTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFlowTemplate) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnFlowTemplate) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnFlowTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFlowTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowTemplate) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnFlowTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowTemplate) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnFlowTemplate) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnFlowTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
