...
func (j *jsiiProxy_CfnClusterSecurityGroupIngress) CfnPropertyNames() *map[string]*string {
...
func CfnClusterSecurityGroupIngress_IsCfnClusterSecurityGroupIngress(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterSecurityGroupIngress_IsCfnClusterSecurityGroupIngressParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_redshift.CfnClusterSecurityGroupIngress",
		"isCfnClusterSecurityGroupIngress",
		[]interface{}{x},
		&returns,
	)
...
func CfnClusterSecurityGroupIngress_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterSecurityGroupIngress_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
