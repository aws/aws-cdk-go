...
func (j *jsiiProxy_CfnEndpointAccess) AttrVpcEndpointNetworkInterfaces() awscdk.IResolvable {
	...
	_jsii_.Get(
		j,
		"attrVpcEndpointNetworkInterfaces",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnEndpointAccess) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEndpointAccess) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAccess) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEndpointAccess) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEndpointAccess) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEndpointAccess) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEndpointAccess) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEndpointAccess) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAccess) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAccess) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
