...
func (j *jsiiProxy_CfnEndpointAuthorization) CfnPropertyNames() *map[string]*string {
...
func NewCfnEndpointAuthorization(scope constructs.Construct, id *string, props *CfnEndpointAuthorizationProps) CfnEndpointAuthorization {
	...
	if err := validateNewCfnEndpointAuthorizationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEndpointAuthorization_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEndpointAuthorization_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEndpointAuthorization_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEndpointAuthorization_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEndpointAuthorization_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEndpointAuthorization_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEndpointAuthorization) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEndpointAuthorization) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEndpointAuthorization) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEndpointAuthorization) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointAuthorization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
