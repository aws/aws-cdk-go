...
func NewCfnClusterSecurityGroupIngress(scope constructs.Construct, id *string, props *CfnClusterSecurityGroupIngressProps) CfnClusterSecurityGroupIngress {
	...
	if err := validateNewCfnClusterSecurityGroupIngressParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnClusterSecurityGroupIngress)SetClusterSecurityGroupName(val *string) {
	if err := j.validateSetClusterSecurityGroupNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnClusterSecurityGroupIngress_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClusterSecurityGroupIngress_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSecurityGroupIngress_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnClusterSecurityGroupIngress_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSecurityGroupIngress_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClusterSecurityGroupIngress_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroupIngress) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
