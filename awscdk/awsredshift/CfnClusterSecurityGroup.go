...
func (j *jsiiProxy_CfnClusterSecurityGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnClusterSecurityGroup(scope constructs.Construct, id *string, props *CfnClusterSecurityGroupProps) CfnClusterSecurityGroup {
	...
	if err := validateNewCfnClusterSecurityGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnClusterSecurityGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClusterSecurityGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSecurityGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClusterSecurityGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterSecurityGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClusterSecurityGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSecurityGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
