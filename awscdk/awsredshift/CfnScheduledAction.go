...
func (j *jsiiProxy_CfnScheduledAction) CfnPropertyNames() *map[string]*string {
...
func CfnScheduledAction_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScheduledAction_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScheduledAction) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScheduledAction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScheduledAction) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScheduledAction) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
