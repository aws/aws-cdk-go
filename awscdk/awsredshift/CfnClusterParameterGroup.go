...
func (j *jsiiProxy_CfnClusterParameterGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnClusterParameterGroup) ParameterGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterGroupName",
...
func NewCfnClusterParameterGroup(scope constructs.Construct, id *string, props *CfnClusterParameterGroupProps) CfnClusterParameterGroup {
	...
	if err := validateNewCfnClusterParameterGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnClusterParameterGroup)SetParameterGroupName(val *string) {
	_jsii_.Set(
		j,
		"parameterGroupName",
		val,
...
func CfnClusterParameterGroup_IsCfnClusterParameterGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterParameterGroup_IsCfnClusterParameterGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterParameterGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClusterParameterGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterParameterGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterParameterGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterParameterGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClusterParameterGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterParameterGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClusterParameterGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClusterParameterGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClusterParameterGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
