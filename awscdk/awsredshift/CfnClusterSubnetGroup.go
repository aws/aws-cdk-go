...
func (j *jsiiProxy_CfnClusterSubnetGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnClusterSubnetGroup(scope constructs.Construct, id *string, props *CfnClusterSubnetGroupProps) CfnClusterSubnetGroup {
	...
	if err := validateNewCfnClusterSubnetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnClusterSubnetGroup_IsCfnClusterSubnetGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterSubnetGroup_IsCfnClusterSubnetGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSubnetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClusterSubnetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSubnetGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterSubnetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClusterSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterSubnetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClusterSubnetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
