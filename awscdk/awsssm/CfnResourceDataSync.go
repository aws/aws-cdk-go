...
func (j *jsiiProxy_CfnResourceDataSync) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnResourceDataSync) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceDataSync) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceDataSync) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceDataSync) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDataSync) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
