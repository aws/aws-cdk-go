...
type CfnMaintenanceWindowTask interface {
	...
	MaintenanceWindowTaskRef() *interfacesawsssm.MaintenanceWindowTaskReference
...
func (j *jsiiProxy_CfnMaintenanceWindowTask) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMaintenanceWindowTask) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnMaintenanceWindowTask) MaintenanceWindowTaskRef() *interfacesawsssm.MaintenanceWindowTaskReference {
	var returns *interfacesawsssm.MaintenanceWindowTaskReference
	_jsii_.Get(
		j,
...
func (c *jsiiProxy_CfnMaintenanceWindowTask) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTask) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTask) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMaintenanceWindowTask) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
