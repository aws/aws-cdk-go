...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsssm.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawsssm.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawsssmIResourcePolicyRef
}

func (j *jsiiProxy_CfnResourcePolicy) AttrPolicyHash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPolicyHash",
...
func (j *jsiiProxy_CfnResourcePolicy) AttrPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPolicyId",
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawsssm.ResourcePolicyReference {
	var returns *interfacesawsssm.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
...
func NewCfnResourcePolicy(scope constructs.Construct, id *string, props *CfnResourcePolicyProps) CfnResourcePolicy {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_ssm.CfnResourcePolicy",
