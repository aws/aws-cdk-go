...
func (j *jsiiProxy_CfnAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnAssociation_IsCfnAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAssociation_IsCfnAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
