...
type CfnMaintenanceWindow interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsssm.IMaintenanceWindowRef
	awscdk.ITaggable
	...
	MaintenanceWindowRef() *interfacesawsssm.MaintenanceWindowReference
...
type jsiiProxy_CfnMaintenanceWindow struct {
	...
	internal.Type__interfacesawsssmIMaintenanceWindowRef
...
func (j *jsiiProxy_CfnMaintenanceWindow) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMaintenanceWindow) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnMaintenanceWindow) MaintenanceWindowRef() *interfacesawsssm.MaintenanceWindowReference {
	var returns *interfacesawsssm.MaintenanceWindowReference
	_jsii_.Get(
		j,
...
func CfnMaintenanceWindow_IsCfnMaintenanceWindow(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMaintenanceWindow_IsCfnMaintenanceWindowParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMaintenanceWindow) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMaintenanceWindow) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMaintenanceWindow) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMaintenanceWindow) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
