...
func (j *jsiiProxy_StringParameter) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_StringParameter) ParameterRef() *interfacesawsssm.ParameterReference {
...
func StringParameter_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ssm.StringParameter",
...
func (s *jsiiProxy_StringParameter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_StringParameter) GrantOnKey(grantee awsiam.IGrantable, actions ...*string) *awsiam.GrantOnKeyResult {
...
func (s *jsiiProxy_StringParameter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
