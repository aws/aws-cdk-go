...
func (j *jsiiProxy_CfnParameter) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnParameter) CfnPropertyNames() *map[string]*string {
...
func CfnParameter_ArnForParameter(resource interfacesawsssm.IParameterRef) *string {
	_init_.Initialize()

	if err := validateCfnParameter_ArnForParameterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnParameter_IsCfnParameter(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnParameter_IsCfnParameterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnParameter_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnParameter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnParameter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnParameter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnParameter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnParameter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnParameter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnParameter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
