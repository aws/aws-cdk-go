...
func (j *jsiiProxy_CfnDocument) CfnPropertyNames() *map[string]*string {
...
func CfnDocument_IsCfnDocument(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDocument_IsCfnDocumentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocument_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDocument_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDocument) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDocument) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDocument) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDocument) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocument) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
