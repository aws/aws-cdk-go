...
func (j *jsiiProxy_CfnPatchBaseline) AvailableSecurityUpdatesComplianceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPatchBaseline) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPatchBaseline)SetAvailableSecurityUpdatesComplianceStatus(val *string) {
	_jsii_.Set(
		j,
		"availableSecurityUpdatesComplianceStatus",
		val,
...
func CfnPatchBaseline_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPatchBaseline_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPatchBaseline) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPatchBaseline) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPatchBaseline) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPatchBaseline) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPatchBaseline) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPatchBaseline) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPatchBaseline) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPatchBaseline) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPatchBaseline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
