...
func (s *jsiiProxy_StringParameter) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (s *jsiiProxy_StringParameter) validateGrantOnKeyParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
