...
//
//   cfnSession := awscdk.Aws_ssm.NewCfnSession(this, jsii.String("MyCfnSession"), &CfnSessionProps{
...
type CfnSession interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsssm.ISessionRef
	// The access type for the session.
	AttrAccessType() *string
	...
	SessionRef() *interfacesawsssm.SessionReference
...
type jsiiProxy_CfnSession struct {
	...
	internal.Type__interfacesawsssmISessionRef
}

func (j *jsiiProxy_CfnSession) AttrAccessType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAccessType",
...
func (j *jsiiProxy_CfnSession) AttrOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwner",
...
func (j *jsiiProxy_CfnSession) AttrStartDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStartDate",
...
func (j *jsiiProxy_CfnSession) Reason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"reason",
...
func (j *jsiiProxy_CfnSession) SessionRef() *interfacesawsssm.SessionReference {
	var returns *interfacesawsssm.SessionReference
	_jsii_.Get(
		j,
		"sessionRef",
		&returns,
...
func (j *jsiiProxy_CfnSession) Target() *string {
	var returns *string
	_jsii_.Get(
		j,
		"target",
...
func (j *jsiiProxy_CfnSession)SetReason(val *string) {
	_jsii_.Set(
		j,
		"reason",
		val,
...
func (j *jsiiProxy_CfnSession)SetTarget(val *string) {
	_jsii_.Set(
		j,
		"target",
		val,
...
func CfnSession_ArnForSession(resource interfacesawsssm.ISessionRef) *string {
	_init_.Initialize()
