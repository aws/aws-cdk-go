...
func (j *jsiiProxy_CfnMaintenanceWindowTarget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMaintenanceWindowTarget) Node() constructs.Node {
...
func NewCfnMaintenanceWindowTarget(scope constructs.Construct, id *string, props *CfnMaintenanceWindowTargetProps) CfnMaintenanceWindowTarget {
	...
	if err := validateNewCfnMaintenanceWindowTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMaintenanceWindowTarget_ArnForMaintenanceWindowTarget(resource interfacesawsssm.IMaintenanceWindowTargetRef) *string {
	_init_.Initialize()

	if err := validateCfnMaintenanceWindowTarget_ArnForMaintenanceWindowTargetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMaintenanceWindowTarget_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMaintenanceWindowTarget_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMaintenanceWindowTarget_IsCfnMaintenanceWindowTarget(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMaintenanceWindowTarget_IsCfnMaintenanceWindowTargetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMaintenanceWindowTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMaintenanceWindowTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindowTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
