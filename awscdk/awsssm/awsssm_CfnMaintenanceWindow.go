...
func (c *jsiiProxy_CfnMaintenanceWindow) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindow) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMaintenanceWindow) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMaintenanceWindow) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnMaintenanceWindow) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaintenanceWindow) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
