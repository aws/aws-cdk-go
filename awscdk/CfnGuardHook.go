...
func (c *jsiiProxy_CfnGuardHook) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGuardHook) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnGuardHook) RemoveResourceDependency(target CfnResource) {
