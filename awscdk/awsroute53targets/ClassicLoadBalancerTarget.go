...
func (c *jsiiProxy_ClassicLoadBalancerTarget) Bind(record awsroute53.IRecordSet, zone awsroute53.IHostedZone) *awsroute53.AliasRecordTargetConfig {
	if err := c.validateBindParameters(record); err != nil {
		panic(err)
	}
