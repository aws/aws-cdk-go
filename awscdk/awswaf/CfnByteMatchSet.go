...
type CfnByteMatchSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswaf.IByteMatchSetRef
	AttrId() *string
	// A reference to a ByteMatchSet resource.
	ByteMatchSetRef() *interfacesawswaf.ByteMatchSetReference
...
type jsiiProxy_CfnByteMatchSet struct {
	...
	internal.Type__interfacesawswafIByteMatchSetRef
}
...
func (j *jsiiProxy_CfnByteMatchSet) ByteMatchSetRef() *interfacesawswaf.ByteMatchSetReference {
	var returns *interfacesawswaf.ByteMatchSetReference
	_jsii_.Get(
		j,
		"byteMatchSetRef",
		&returns,
...
func (j *jsiiProxy_CfnByteMatchSet) CfnPropertyNames() *map[string]*string {
...
func CfnByteMatchSet_ArnForByteMatchSet(resource interfacesawswaf.IByteMatchSetRef) *string {
	_init_.Initialize()
...
func CfnByteMatchSet_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnByteMatchSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnByteMatchSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnByteMatchSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnByteMatchSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnByteMatchSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnByteMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
