...
func (j *jsiiProxy_CfnByteMatchSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnByteMatchSet(scope constructs.Construct, id *string, props *CfnByteMatchSetProps) CfnByteMatchSet {
	...
	if err := validateNewCfnByteMatchSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnByteMatchSet)SetByteMatchTuples(val interface{}) {
	if err := j.validateSetByteMatchTuplesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnByteMatchSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnByteMatchSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnByteMatchSet_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnByteMatchSet_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnByteMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnByteMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnByteMatchSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnByteMatchSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnByteMatchSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnByteMatchSet) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnByteMatchSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnByteMatchSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
