...
type CfnIPSet interface {
	...
	IpSetRef() *interfacesawswaf.IPSetReference
...
type jsiiProxy_CfnIPSet struct {
	...
	internal.Type__interfacesawswafIIPSetRef
}
...
func (j *jsiiProxy_CfnIPSet) IpSetRef() *interfacesawswaf.IPSetReference {
	var returns *interfacesawswaf.IPSetReference
	_jsii_.Get(
		j,
		"ipSetRef",
		&returns,
...
func CfnIPSet_ArnForIPSet(resource interfacesawswaf.IIPSetRef) *string {
	_init_.Initialize()
