...
type CfnRule interface {
	...
	RuleRef() *interfacesawswaf.RuleReference
...
type jsiiProxy_CfnRule struct {
	...
	internal.Type__interfacesawswafIRuleRef
}
...
func (j *jsiiProxy_CfnRule) RuleRef() *interfacesawswaf.RuleReference {
	var returns *interfacesawswaf.RuleReference
	_jsii_.Get(
		j,
		"ruleRef",
		&returns,
...
func CfnRule_ArnForRule(resource interfacesawswaf.IRuleRef) *string {
	_init_.Initialize()
