...
func (j *jsiiProxy_CfnSqlInjectionMatchSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSqlInjectionMatchSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSqlInjectionMatchSet(scope constructs.Construct, id *string, props *CfnSqlInjectionMatchSetProps) CfnSqlInjectionMatchSet {
	...
	if err := validateNewCfnSqlInjectionMatchSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSqlInjectionMatchSet)SetSqlInjectionMatchTuples(val interface{}) {
	if err := j.validateSetSqlInjectionMatchTuplesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSqlInjectionMatchSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSqlInjectionMatchSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSqlInjectionMatchSet_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSqlInjectionMatchSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSqlInjectionMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSqlInjectionMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSqlInjectionMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
