...
type CfnXssMatchSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswaf.IXssMatchSetRef
	AttrId() *string
	...
	XssMatchSetRef() *interfacesawswaf.XssMatchSetReference
...
type jsiiProxy_CfnXssMatchSet struct {
	...
	internal.Type__interfacesawswafIXssMatchSetRef
}
...
func (j *jsiiProxy_CfnXssMatchSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnXssMatchSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnXssMatchSet) XssMatchSetRef() *interfacesawswaf.XssMatchSetReference {
	var returns *interfacesawswaf.XssMatchSetReference
	_jsii_.Get(
		j,
		"xssMatchSetRef",
		&returns,
...
func NewCfnXssMatchSet(scope constructs.Construct, id *string, props *CfnXssMatchSetProps) CfnXssMatchSet {
	...
	if err := validateNewCfnXssMatchSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnXssMatchSet)SetXssMatchTuples(val interface{}) {
	if err := j.validateSetXssMatchTuplesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnXssMatchSet_ArnForXssMatchSet(resource interfacesawswaf.IXssMatchSetRef) *string {
	_init_.Initialize()
...
func CfnXssMatchSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnXssMatchSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnXssMatchSet_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnXssMatchSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnXssMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnXssMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnXssMatchSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnXssMatchSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnXssMatchSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnXssMatchSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnXssMatchSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnXssMatchSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnXssMatchSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnXssMatchSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnXssMatchSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnXssMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
