...
//
//   cfnSizeConstraintSet := awscdk.Aws_wafregional.NewCfnSizeConstraintSet(this, jsii.String("MyCfnSizeConstraintSet"), &CfnSizeConstraintSetProps{
...
func (j *jsiiProxy_CfnSizeConstraintSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSizeConstraintSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSizeConstraintSet(scope constructs.Construct, id *string, props *CfnSizeConstraintSetProps) CfnSizeConstraintSet {
	...
	if err := validateNewCfnSizeConstraintSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSizeConstraintSet)SetSizeConstraints(val interface{}) {
	if err := j.validateSetSizeConstraintsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSizeConstraintSet_ArnForSizeConstraintSet(resource interfacesawswafregional.ISizeConstraintSetRef) *string {
	_init_.Initialize()
...
func CfnSizeConstraintSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSizeConstraintSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSizeConstraintSet_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSizeConstraintSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSizeConstraintSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSizeConstraintSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSizeConstraintSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSizeConstraintSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSizeConstraintSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSizeConstraintSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSizeConstraintSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
