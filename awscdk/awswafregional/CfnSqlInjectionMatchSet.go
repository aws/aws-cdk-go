...
type CfnSqlInjectionMatchSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswafregional.ISqlInjectionMatchSetRef
	AttrId() *string
	...
	SqlInjectionMatchSetRef() *interfacesawswafregional.SqlInjectionMatchSetReference
...
type jsiiProxy_CfnSqlInjectionMatchSet struct {
	...
	internal.Type__interfacesawswafregionalISqlInjectionMatchSetRef
}
...
func (j *jsiiProxy_CfnSqlInjectionMatchSet) SqlInjectionMatchSetRef() *interfacesawswafregional.SqlInjectionMatchSetReference {
	var returns *interfacesawswafregional.SqlInjectionMatchSetReference
	_jsii_.Get(
		j,
...
func CfnSqlInjectionMatchSet_ArnForSqlInjectionMatchSet(resource interfacesawswafregional.ISqlInjectionMatchSetRef) *string {
	_init_.Initialize()
