...
type CfnIPSet_IPSetDescriptorProperty interface {
...
// The jsii proxy for CfnIPSet_IPSetDescriptorProperty
type jsiiProxy_CfnIPSet_IPSetDescriptorProperty struct {
	_ byte // padding
}

func (j *jsiiProxy_CfnIPSet_IPSetDescriptorProperty) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnIPSet_IPSetDescriptorProperty) Value() *string {
	var returns *string
	_jsii_.Get(
		j,
		"value",
