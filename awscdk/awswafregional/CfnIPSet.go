...
//
//   cfnIPSet := awscdk.Aws_wafregional.NewCfnIPSet(this, jsii.String("MyCfnIPSet"), &CfnIPSetProps{
...
type CfnIPSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswafregional.IIPSetRef
	AttrId() *string
	...
	IpSetRef() *interfacesawswafregional.IPSetReference
...
type jsiiProxy_CfnIPSet struct {
	...
	internal.Type__interfacesawswafregionalIIPSetRef
}
...
func (j *jsiiProxy_CfnIPSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIPSet) IpSetRef() *interfacesawswafregional.IPSetReference {
	var returns *interfacesawswafregional.IPSetReference
	_jsii_.Get(
		j,
		"ipSetRef",
		&returns,
...
func NewCfnIPSet(scope constructs.Construct, id *string, props *CfnIPSetProps) CfnIPSet {
	...
	if err := validateNewCfnIPSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIPSet)SetIpSetDescriptors(val interface{}) {
	if err := j.validateSetIpSetDescriptorsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIPSet_ArnForIPSet(resource interfacesawswafregional.IIPSetRef) *string {
	_init_.Initialize()

	if err := validateCfnIPSet_ArnForIPSetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnIPSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIPSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIPSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIPSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIPSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIPSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
