...
func (j *jsiiProxy_CfnRateBasedRule) CfnPropertyNames() *map[string]*string {
...
func CfnRateBasedRule_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRateBasedRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRateBasedRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRateBasedRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRateBasedRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRateBasedRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRateBasedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
