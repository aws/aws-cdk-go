...
//
//   cfnRegexPatternSet := awscdk.Aws_wafregional.NewCfnRegexPatternSet(this, jsii.String("MyCfnRegexPatternSet"), &cfnRegexPatternSetProps{
...
func (j *jsiiProxy_CfnRegexPatternSet) RegexPatternStrings() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regexPatternStrings",
...
func (j *jsiiProxy_CfnRegexPatternSet)SetRegexPatternStrings(val *[]*string) {
...
func CfnRegexPatternSet_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnRegexPatternSet_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
