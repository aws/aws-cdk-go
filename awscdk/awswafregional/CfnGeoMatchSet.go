...
//
//   cfnGeoMatchSet := awscdk.Aws_wafregional.NewCfnGeoMatchSet(this, jsii.String("MyCfnGeoMatchSet"), &CfnGeoMatchSetProps{
...
func (j *jsiiProxy_CfnGeoMatchSet) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGeoMatchSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGeoMatchSet) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGeoMatchSet) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGeoMatchSet) GeoMatchConstraints() interface{} {
...
func (j *jsiiProxy_CfnGeoMatchSet) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnGeoMatchSet) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnGeoMatchSet) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnGeoMatchSet) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGeoMatchSet) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnGeoMatchSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGeoMatchSet(scope constructs.Construct, id *string, props *CfnGeoMatchSetProps) CfnGeoMatchSet {
	...
	if err := validateNewCfnGeoMatchSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGeoMatchSet)SetGeoMatchConstraints(val interface{}) {
	if err := j.validateSetGeoMatchConstraintsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnGeoMatchSet)SetName(val *string) {
...
func CfnGeoMatchSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGeoMatchSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGeoMatchSet_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGeoMatchSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGeoMatchSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGeoMatchSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGeoMatchSet) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnGeoMatchSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGeoMatchSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGeoMatchSet) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGeoMatchSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGeoMatchSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGeoMatchSet) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnGeoMatchSet) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGeoMatchSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGeoMatchSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeoMatchSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeoMatchSet) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGeoMatchSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeoMatchSet) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnGeoMatchSet) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnGeoMatchSet) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnGeoMatchSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
