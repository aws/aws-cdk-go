...
//
//   cfnWebACL := awscdk.Aws_wafregional.NewCfnWebACL(this, jsii.String("MyCfnWebACL"), &CfnWebACLProps{
...
type CfnWebACL interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswafregional.IWebACLRef
	AttrId() *string
	...
	WebAclRef() *interfacesawswafregional.WebACLReference
...
type jsiiProxy_CfnWebACL struct {
	...
	internal.Type__interfacesawswafregionalIWebACLRef
}
...
func (j *jsiiProxy_CfnWebACL) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWebACL) WebAclRef() *interfacesawswafregional.WebACLReference {
	var returns *interfacesawswafregional.WebACLReference
	_jsii_.Get(
		j,
		"webAclRef",
		&returns,
...
func CfnWebACL_ArnForWebACL(resource interfacesawswafregional.IWebACLRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWebACL) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWebACL) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWebACL) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWebACL) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebACL) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
