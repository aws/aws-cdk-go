...
func (j *jsiiProxy_CfnDRTAccess) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDRTAccess) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDRTAccess) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
// Checks whether the given object is a CfnDRTAccess.
func CfnDRTAccess_IsCfnDRTAccess(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDRTAccess_IsCfnDRTAccessParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDRTAccess) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDRTAccess) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDRTAccess) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDRTAccess) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDRTAccess) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDRTAccess) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDRTAccess) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDRTAccess) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDRTAccess) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDRTAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
