...
type CfnProtection interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsshield.IProtectionRef
	awscdk.ITaggableV2
	...
	ProtectionRef() *interfacesawsshield.ProtectionReference
...
type jsiiProxy_CfnProtection struct {
	...
	internal.Type__interfacesawsshieldIProtectionRef
...
func (j *jsiiProxy_CfnProtection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProtection) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnProtection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnProtection) ProtectionRef() *interfacesawsshield.ProtectionReference {
	var returns *interfacesawsshield.ProtectionReference
	_jsii_.Get(
		j,
		"protectionRef",
		&returns,
...
func (j *jsiiProxy_CfnProtection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnProtection_ArnForProtection(resource interfacesawsshield.IProtectionRef) *string {
	_init_.Initialize()

	if err := validateCfnProtection_ArnForProtectionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnProtection_IsCfnProtection(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProtection_IsCfnProtectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProtection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProtection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProtection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProtection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProtection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProtection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProtection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProtection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
