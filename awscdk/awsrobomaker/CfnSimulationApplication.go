...
func (j *jsiiProxy_CfnSimulationApplication) CfnPropertyNames() *map[string]*string {
...
func NewCfnSimulationApplication(scope constructs.Construct, id *string, props *CfnSimulationApplicationProps) CfnSimulationApplication {
	...
	if err := validateNewCfnSimulationApplicationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSimulationApplication)SetRenderingEngine(val interface{}) {
	if err := j.validateSetRenderingEngineParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSimulationApplication)SetSimulationSoftwareSuite(val interface{}) {
	if err := j.validateSetSimulationSoftwareSuiteParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSimulationApplication_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSimulationApplication_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimulationApplication_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSimulationApplication_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimulationApplication_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSimulationApplication_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimulationApplication) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulationApplication) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSimulationApplication) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSimulationApplication) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSimulationApplication) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSimulationApplication) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSimulationApplication) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulationApplication) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulationApplication) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulationApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
