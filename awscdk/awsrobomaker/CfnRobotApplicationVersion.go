...
func (j *jsiiProxy_CfnRobotApplicationVersion) CfnPropertyNames() *map[string]*string {
...
func NewCfnRobotApplicationVersion(scope constructs.Construct, id *string, props *CfnRobotApplicationVersionProps) CfnRobotApplicationVersion {
	...
	if err := validateNewCfnRobotApplicationVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRobotApplicationVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRobotApplicationVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRobotApplicationVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRobotApplicationVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRobotApplicationVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRobotApplicationVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRobotApplicationVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRobotApplicationVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobotApplicationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
