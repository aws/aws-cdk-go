...
func (j *jsiiProxy_CfnRobot) CfnPropertyNames() *map[string]*string {
...
func NewCfnRobot(scope constructs.Construct, id *string, props *CfnRobotProps) CfnRobot {
	...
	if err := validateNewCfnRobotParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRobot)SetGreengrassGroupId(val *string) {
	if err := j.validateSetGreengrassGroupIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnRobot_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRobot_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRobot_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRobot_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnRobot.
func CfnRobot_IsCfnRobot(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRobot_IsCfnRobotParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRobot_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRobot_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRobot) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobot) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRobot) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRobot) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRobot) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRobot) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRobot) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobot) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobot) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRobot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
