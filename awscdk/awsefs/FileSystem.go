...
func (j *jsiiProxy_FileSystem) Env() *interfaces.ResourceEnvironment {
...
func (f *jsiiProxy_FileSystem) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
