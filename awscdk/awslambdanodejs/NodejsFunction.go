...
func (n *jsiiProxy_NodejsFunction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (n *jsiiProxy_NodejsFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
