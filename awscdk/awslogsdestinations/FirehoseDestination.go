...
func (f *jsiiProxy_FirehoseDestination) Bind(scope constructs.Construct, sourceLogGroup interfacesawslogs.ILogGroupRef) *awslogs.LogSubscriptionDestinationConfig {
