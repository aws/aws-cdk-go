...
func (j *jsiiProxy_CfnListenerCertificate) CfnPropertyNames() *map[string]*string {
...
func NewCfnListenerCertificate(scope constructs.Construct, id *string, props *CfnListenerCertificateProps) CfnListenerCertificate {
	...
	if err := validateNewCfnListenerCertificateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnListenerCertificate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnListenerCertificate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnListenerCertificate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnListenerCertificate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnListenerCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnListenerCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnListenerCertificate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnListenerCertificate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnListenerCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnListenerCertificate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnListenerCertificate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnListenerCertificate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnListenerCertificate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnListenerCertificate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnListenerCertificate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnListenerCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
