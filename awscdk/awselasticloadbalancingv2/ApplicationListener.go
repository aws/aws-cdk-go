...
func (j *jsiiProxy_ApplicationListener) Env() *interfaces.ResourceEnvironment {
...
func ApplicationListener_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancingv2.ApplicationListener",
...
func (a *jsiiProxy_ApplicationListener) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ApplicationListener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
