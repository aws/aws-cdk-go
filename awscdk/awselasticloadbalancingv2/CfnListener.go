...
func (j *jsiiProxy_CfnListener) CfnPropertyNames() *map[string]*string {
...
func CfnListener_ArnForListener(resource interfacesawselasticloadbalancingv2.IListenerRef) *string {
	_init_.Initialize()

	if err := validateCfnListener_ArnForListenerParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnListener) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnListener) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnListener) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnListener) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnListener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
