...
func (j *jsiiProxy_ApplicationLoadBalancer) Env() *interfaces.ResourceEnvironment {
...
func ApplicationLoadBalancer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancingv2.ApplicationLoadBalancer",
...
func (a *jsiiProxy_ApplicationLoadBalancer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ApplicationLoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
