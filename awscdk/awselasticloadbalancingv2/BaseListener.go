...
func (j *jsiiProxy_BaseListener) Env() *interfaces.ResourceEnvironment {
...
func BaseListener_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateBaseListener_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BaseListener) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BaseListener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
