...
func (j *jsiiProxy_ApplicationTargetGroup) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ApplicationTargetGroup) TargetGroupRef() *interfacesawselasticloadbalancingv2.TargetGroupReference {
...
func ApplicationTargetGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancingv2.ApplicationTargetGroup",
...
func (a *jsiiProxy_ApplicationTargetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
