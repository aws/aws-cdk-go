...
func (j *jsiiProxy_CfnListenerRule) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_CfnListenerRule) ListenerRuleRef() *ListenerRuleReference {
