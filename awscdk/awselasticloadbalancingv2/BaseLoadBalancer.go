...
func (j *jsiiProxy_BaseLoadBalancer) Env() *interfaces.ResourceEnvironment {
...
func (b *jsiiProxy_BaseLoadBalancer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BaseLoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
