...
func (j *jsiiProxy_NetworkLoadBalancer) Env() *interfaces.ResourceEnvironment {
...
func NetworkLoadBalancer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancingv2.NetworkLoadBalancer",
...
func (n *jsiiProxy_NetworkLoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
