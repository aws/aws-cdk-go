...
func (t *jsiiProxy_TrustStore) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateTrustStore_FromTrustStoreArnParameters(scope constructs.Construct, id *string, trustStoreArn *string) error {
	...
	if trustStoreArn == nil {
		return fmt.Errorf("parameter trustStoreArn is required, but nil was provided")
	}
