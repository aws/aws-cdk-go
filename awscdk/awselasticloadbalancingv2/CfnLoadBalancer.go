...
func (j *jsiiProxy_CfnLoadBalancer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLoadBalancer) Ipv4IpamPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv4IpamPoolId",
...
func (j *jsiiProxy_CfnLoadBalancer)SetIpv4IpamPoolId(val *string) {
	_jsii_.Set(
		j,
		"ipv4IpamPoolId",
		val,
...
func (c *jsiiProxy_CfnLoadBalancer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLoadBalancer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLoadBalancer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLoadBalancer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
