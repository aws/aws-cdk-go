...
func (j *jsiiProxy_NetworkListener) Env() *interfaces.ResourceEnvironment {
...
func NetworkListener_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancingv2.NetworkListener",
...
func (n *jsiiProxy_NetworkListener) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (n *jsiiProxy_NetworkListener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
