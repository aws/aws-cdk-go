...
func (j *jsiiProxy_CfnBotAlias) CfnPropertyNames() *map[string]*string {
...
func CfnBotAlias_IsCfnBotAlias(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBotAlias_IsCfnBotAliasParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBotAlias_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBotAlias_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBotAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBotAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBotAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBotAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBotAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
