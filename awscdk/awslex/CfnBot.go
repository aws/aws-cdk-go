...
func (j *jsiiProxy_CfnBot) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnBot) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBot) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBot) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBot) RemoveResourceDependency(target awscdk.CfnResource) {
