...
func (j *jsiiProxy_CfnBotVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBotVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBotVersion(scope constructs.Construct, id *string, props *CfnBotVersionProps) CfnBotVersion {
	...
	if err := validateNewCfnBotVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBotVersion)SetBotVersionLocaleSpecification(val interface{}) {
	if err := j.validateSetBotVersionLocaleSpecificationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBotVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBotVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBotVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBotVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBotVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBotVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBotVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBotVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBotVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBotVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBotVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBotVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBotVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBotVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBotVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBotVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
