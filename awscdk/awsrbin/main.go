...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrLockState", GoGetter: "AttrLockState"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rbin.CfnRule.ResourceTagProperty",
		reflect.TypeOf((*CfnRule_ResourceTagProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rbin.CfnRule.RetentionPeriodProperty",
		reflect.TypeOf((*CfnRule_RetentionPeriodProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rbin.CfnRule.UnlockDelayProperty",
		reflect.TypeOf((*CfnRule_UnlockDelayProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rbin.RuleReference",
