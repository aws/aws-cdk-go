...
func (j *jsiiProxy_ServerlessClusterFromSnapshot) DbClusterRef() *interfacesawsrds.DBClusterReference {
...
func (j *jsiiProxy_ServerlessClusterFromSnapshot) Env() *interfaces.ResourceEnvironment {
...
func ServerlessClusterFromSnapshot_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.ServerlessClusterFromSnapshot",
...
func (s *jsiiProxy_ServerlessClusterFromSnapshot) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ServerlessClusterFromSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
