...
func (j *jsiiProxy_DatabaseProxyEndpoint) Env() *interfaces.ResourceEnvironment {
...
func (d *jsiiProxy_DatabaseProxyEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DatabaseProxyEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
