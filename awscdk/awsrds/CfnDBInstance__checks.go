...
func (j *jsiiProxy_CfnDBInstance) validateSetAdditionalStorageVolumesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnDBInstance_AdditionalStorageVolumeProperty:
				v := v.(*CfnDBInstance_AdditionalStorageVolumeProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnDBInstance_AdditionalStorageVolumeProperty:
				v_ := v.(CfnDBInstance_AdditionalStorageVolumeProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnDBInstance_AdditionalStorageVolumeProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
