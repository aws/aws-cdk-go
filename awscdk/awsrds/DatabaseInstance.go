...
func (j *jsiiProxy_DatabaseInstance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DatabaseInstance) ManageMasterUserPassword() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatabaseInstance)SetManageMasterUserPassword(val *bool) {
	_jsii_.Set(
		j,
		"manageMasterUserPassword",
		val,
...
func DatabaseInstance_FromLookup(scope constructs.Construct, id *string, options *DatabaseInstanceLookupOptions) IDatabaseInstance {
	_init_.Initialize()

	if err := validateDatabaseInstance_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
	var returns IDatabaseInstance
...
func DatabaseInstance_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.DatabaseInstance",
...
func (d *jsiiProxy_DatabaseInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
