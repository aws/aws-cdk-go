...
func (d *jsiiProxy_DatabaseClusterBase) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (d *jsiiProxy_DatabaseClusterBase) validateGrantConnectParameters(grantee awsiam.IGrantable, dbUser *string) error {
	if grantee == nil {
...
func (d *jsiiProxy_DatabaseClusterBase) validateGrantDataApiAccessParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
		return fmt.Errorf("parameter grantee is required, but nil was provided")
	}
