...
func (j *jsiiProxy_OptionGroup) Env() *interfaces.ResourceEnvironment {
...
func OptionGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.OptionGroup",
...
func (o *jsiiProxy_OptionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
