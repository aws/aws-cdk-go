...
func (j *jsiiProxy_DatabaseClusterFromSnapshot) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DatabaseClusterFromSnapshot) ManageMasterUserPassword() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatabaseClusterFromSnapshot) PerformanceInsightEncryptionKey() awskms.IKey {
...
func (j *jsiiProxy_DatabaseClusterFromSnapshot) PerformanceInsightRetention() PerformanceInsightRetention {
...
func (j *jsiiProxy_DatabaseClusterFromSnapshot) PerformanceInsightsEnabled() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatabaseClusterFromSnapshot)SetManageMasterUserPassword(val *bool) {
	_jsii_.Set(
		j,
		"manageMasterUserPassword",
		val,
...
func DatabaseClusterFromSnapshot_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.DatabaseClusterFromSnapshot",
...
func (d *jsiiProxy_DatabaseClusterFromSnapshot) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DatabaseClusterFromSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
