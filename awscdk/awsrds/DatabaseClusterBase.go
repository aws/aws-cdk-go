...
func (j *jsiiProxy_DatabaseClusterBase) Env() *interfaces.ResourceEnvironment {
...
func (d *jsiiProxy_DatabaseClusterBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
