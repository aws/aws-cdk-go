...
func (c *jsiiProxy_CfnDBProxyEndpoint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDBProxyEndpoint) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
