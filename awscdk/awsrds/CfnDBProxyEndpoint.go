...
func (j *jsiiProxy_CfnDBProxyEndpoint) CfnPropertyNames() *map[string]*string {
...
func CfnDBProxyEndpoint_IsCfnDBProxyEndpoint(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDBProxyEndpoint_IsCfnDBProxyEndpointParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBProxyEndpoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBProxyEndpoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBProxyEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBProxyEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
