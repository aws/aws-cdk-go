...
func (j *jsiiProxy_DatabaseInstanceReadReplica) Env() *interfaces.ResourceEnvironment {
...
func DatabaseInstanceReadReplica_FromLookup(scope constructs.Construct, id *string, options *DatabaseInstanceLookupOptions) IDatabaseInstance {
	_init_.Initialize()

	if err := validateDatabaseInstanceReadReplica_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
	var returns IDatabaseInstance
...
func DatabaseInstanceReadReplica_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.DatabaseInstanceReadReplica",
...
func (d *jsiiProxy_DatabaseInstanceReadReplica) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
