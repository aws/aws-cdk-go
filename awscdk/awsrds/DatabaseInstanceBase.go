...
func (j *jsiiProxy_DatabaseInstanceBase) DbInstanceRef() *interfacesawsrds.DBInstanceReference {
...
func DatabaseInstanceBase_FromLookup(scope constructs.Construct, id *string, options *DatabaseInstanceLookupOptions) IDatabaseInstance {
	_init_.Initialize()

	if err := validateDatabaseInstanceBase_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
	var returns IDatabaseInstance
