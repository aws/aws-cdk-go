...
func (j *jsiiProxy_CfnDBCluster) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDBCluster) DeleteAutomatedBackups() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBCluster)SetDeleteAutomatedBackups(val interface{}) {
...
func CfnDBCluster_IsCfnDBCluster(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDBCluster_IsCfnDBClusterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
