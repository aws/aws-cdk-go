...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnReservedDBInstance)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrMultiAz", GoGetter: "AttrMultiAz"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrReservedDbInstanceArn", GoGetter: "AttrReservedDbInstanceArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrReservedDbInstanceId", GoGetter: "AttrReservedDbInstanceId"},
			_jsii_.MemberProperty{JsiiProperty: "attrReservedDbInstancesOfferingId", GoGetter: "AttrReservedDbInstancesOfferingId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "cfnResourceType", GoGetter: "CfnResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dbInstanceCount", GoGetter: "DbInstanceCount"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			_jsii_.MemberMethod{JsiiMethod: "getMetadata", GoMethod: "GetMetadata"},
			_jsii_.MemberMethod{JsiiMethod: "inspect", GoMethod: "Inspect"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsrdsIReservedDBInstanceRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rds.CfnReservedDBInstance.RecurringChargeProperty",
		reflect.TypeOf((*CfnReservedDBInstance_RecurringChargeProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rds.CfnReservedDBInstanceProps",
		reflect.TypeOf((*CfnReservedDBInstanceProps)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
