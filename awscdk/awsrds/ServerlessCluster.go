...
func (j *jsiiProxy_ServerlessCluster) Env() *interfaces.ResourceEnvironment {
...
func (s *jsiiProxy_ServerlessCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
