...
func (j *jsiiProxy_CfnDBSecurityGroupIngress) CfnPropertyNames() *map[string]*string {
...
func CfnDBSecurityGroupIngress_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBSecurityGroupIngress_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroupIngress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
