...
func (j *jsiiProxy_DatabaseInstanceFromSnapshot) DbInstanceRef() *interfacesawsrds.DBInstanceReference {
...
func (j *jsiiProxy_DatabaseInstanceFromSnapshot) Env() *interfaces.ResourceEnvironment {
...
func DatabaseInstanceFromSnapshot_FromLookup(scope constructs.Construct, id *string, options *DatabaseInstanceLookupOptions) IDatabaseInstance {
	_init_.Initialize()

	if err := validateDatabaseInstanceFromSnapshot_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
	var returns IDatabaseInstance
...
func DatabaseInstanceFromSnapshot_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.DatabaseInstanceFromSnapshot",
...
func (d *jsiiProxy_DatabaseInstanceFromSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
