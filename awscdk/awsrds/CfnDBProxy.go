...
func (j *jsiiProxy_CfnDBProxy) CfnPropertyNames() *map[string]*string {
...
func CfnDBProxy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBProxy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBProxy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBProxy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBProxy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBProxy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBProxy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
