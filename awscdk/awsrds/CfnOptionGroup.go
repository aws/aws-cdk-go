...
func (j *jsiiProxy_CfnOptionGroup) CfnPropertyNames() *map[string]*string {
...
func CfnOptionGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOptionGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOptionGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOptionGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOptionGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOptionGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOptionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
