...
func (j *jsiiProxy_DatabaseProxy) Env() *interfaces.ResourceEnvironment {
...
func DatabaseProxy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_rds.DatabaseProxy",
...
func (d *jsiiProxy_DatabaseProxy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DatabaseProxy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
