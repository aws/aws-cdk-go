...
type CfnDBInstance interface {
	...
	AttrIsStorageConfigUpgradeAvailable() awscdk.IResolvable
	// The latest time to which a database in this DB instance can be restored with point-in-time restore.
	AttrLatestRestorableTime() *string
	// This data type represents the information you need to connect to an Amazon RDS DB instance.
	//
	// This data type is used as a response element in the following actions:
	//   +   ``CreateDBInstance``
	...
	//
	//  For the data structure that represents Amazon Aurora DB cluster endpoints, see ``DBClusterEndpoint``.
	AttrListenerEndpoint() awscdk.IResolvable
	// Specifies the DNS address of the DB instance.
	AttrListenerEndpointAddress() *string
	// Specifies the ID that Amazon Route 53 assigns when you create a hosted zone.
	AttrListenerEndpointHostedZoneId() *string
	// Specifies the port that the database engine is listening on.
	AttrListenerEndpointPort() *string
...
func (j *jsiiProxy_CfnDBInstance) ApplyImmediately() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"applyImmediately",
...
func (j *jsiiProxy_CfnDBInstance) AttrDbInstanceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrInstanceCreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrIsStorageConfigUpgradeAvailable() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrLatestRestorableTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrListenerEndpoint() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrListenerEndpointAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrListenerEndpointHostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrListenerEndpointPort() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) AttrReadReplicaDbInstanceIdentifiers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance) DatabaseInsightsMode() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDBInstance)SetApplyImmediately(val interface{}) {
...
func (j *jsiiProxy_CfnDBInstance)SetDatabaseInsightsMode(val *string) {
	_jsii_.Set(
		j,
		"databaseInsightsMode",
		val,
...
func CfnDBInstance_ArnForDBInstance(resource interfacesawsrds.IDBInstanceRef) *string {
	_init_.Initialize()
