...
func (d *jsiiProxy_DatabaseCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DatabaseCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
