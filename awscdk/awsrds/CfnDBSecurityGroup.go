...
func (j *jsiiProxy_CfnDBSecurityGroup) CfnPropertyNames() *map[string]*string {
...
func CfnDBSecurityGroup_IsCfnDBSecurityGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDBSecurityGroup_IsCfnDBSecurityGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBSecurityGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBSecurityGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBSecurityGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBSecurityGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBSecurityGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBSecurityGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
