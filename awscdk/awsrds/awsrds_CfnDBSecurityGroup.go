...
func NewCfnDBSecurityGroup(scope constructs.Construct, id *string, props *CfnDBSecurityGroupProps) CfnDBSecurityGroup {
	...
	if err := validateNewCfnDBSecurityGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDBSecurityGroup)SetDbSecurityGroupIngress(val interface{}) {
	if err := j.validateSetDbSecurityGroupIngressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDBSecurityGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDBSecurityGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBSecurityGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDBSecurityGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBSecurityGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDBSecurityGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBSecurityGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDBSecurityGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDBSecurityGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDBSecurityGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBSecurityGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
