...
func (d *jsiiProxy_DatabaseInstanceReadReplica) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateDatabaseInstanceReadReplica_FromLookupParameters(scope constructs.Construct, id *string, options *DatabaseInstanceLookupOptions) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
