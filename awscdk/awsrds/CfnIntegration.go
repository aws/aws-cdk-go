...
//
//   cfnIntegration := awscdk.Aws_rds.NewCfnIntegration(this, jsii.String("MyCfnIntegration"), &CfnIntegrationProps{
...
func NewCfnIntegration(scope constructs.Construct, id *string, props *CfnIntegrationProps) CfnIntegration {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_rds.CfnIntegration",
...
func CfnIntegration_ArnForIntegration(resource interfacesawsrds.IIntegrationRef) *string {
	_init_.Initialize()
