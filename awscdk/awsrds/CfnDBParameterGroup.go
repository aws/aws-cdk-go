...
type CfnDBParameterGroup interface {
	...
	awscdk.ITaggable
	AttrDbParameterGroupArn() *string
...
func (j *jsiiProxy_CfnDBParameterGroup) AttrDbParameterGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDbParameterGroupArn",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnDBParameterGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDBParameterGroup) DbParameterGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewCfnDBParameterGroup(scope constructs.Construct, id *string, props *CfnDBParameterGroupProps) CfnDBParameterGroup {
	...
	if err := validateNewCfnDBParameterGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDBParameterGroup)SetDbParameterGroupName(val *string) {
	_jsii_.Set(
		j,
		"dbParameterGroupName",
		val,
...
func CfnDBParameterGroup_ArnForDBParameterGroup(resource interfacesawsrds.IDBParameterGroupRef) *string {
	_init_.Initialize()
...
func CfnDBParameterGroup_IsCfnDBParameterGroup(x interface{}) *bool {
	...
	if err := validateCfnDBParameterGroup_IsCfnDBParameterGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBParameterGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDBParameterGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBParameterGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDBParameterGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDBParameterGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDBParameterGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDBParameterGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBParameterGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDBParameterGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDBParameterGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDBParameterGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDBParameterGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDBParameterGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBParameterGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBParameterGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDBParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
