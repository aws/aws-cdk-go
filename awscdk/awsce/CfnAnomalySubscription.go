...
func (j *jsiiProxy_CfnAnomalySubscription) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAnomalySubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnomalySubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnomalySubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnomalySubscription) RemoveResourceDependency(target awscdk.CfnResource) {
