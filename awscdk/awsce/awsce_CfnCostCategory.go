...
func (j *jsiiProxy_CfnCostCategory) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCostCategory(scope constructs.Construct, id *string, props *CfnCostCategoryProps) CfnCostCategory {
	...
	if err := validateNewCfnCostCategoryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCostCategory_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCostCategory_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCostCategory_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCostCategory_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCostCategory_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCostCategory_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCostCategory) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCostCategory) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCostCategory) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCostCategory) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCostCategory) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCostCategory) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
