...
type CfnCostCategory interface {
	...
	Tags() *[]*CfnCostCategory_ResourceTagProperty
	SetTags(val *[]*CfnCostCategory_ResourceTagProperty)
	// Deprecated.
...
func (j *jsiiProxy_CfnCostCategory) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnCostCategory) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCostCategory) Tags() *[]*CfnCostCategory_ResourceTagProperty {
	var returns *[]*CfnCostCategory_ResourceTagProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CfnCostCategory)SetTags(val *[]*CfnCostCategory_ResourceTagProperty) {
...
func CfnCostCategory_ArnForCostCategory(resource interfacesawsce.ICostCategoryRef) *string {
	_init_.Initialize()

	if err := validateCfnCostCategory_ArnForCostCategoryParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnCostCategory_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCostCategory_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCostCategory) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCostCategory) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCostCategory) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCostCategory) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCostCategory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
