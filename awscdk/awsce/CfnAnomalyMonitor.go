...
type CfnAnomalyMonitor interface {
	...
	ResourceTags() *[]*CfnAnomalyMonitor_ResourceTagProperty
	SetResourceTags(val *[]*CfnAnomalyMonitor_ResourceTagProperty)
...
func (j *jsiiProxy_CfnAnomalyMonitor) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAnomalyMonitor) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAnomalyMonitor) ResourceTags() *[]*CfnAnomalyMonitor_ResourceTagProperty {
	var returns *[]*CfnAnomalyMonitor_ResourceTagProperty
	_jsii_.Get(
		j,
		"resourceTags",
		&returns,
...
func (j *jsiiProxy_CfnAnomalyMonitor)SetResourceTags(val *[]*CfnAnomalyMonitor_ResourceTagProperty) {
...
func CfnAnomalyMonitor_IsCfnAnomalyMonitor(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAnomalyMonitor_IsCfnAnomalyMonitorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAnomalyMonitor_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAnomalyMonitor_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAnomalyMonitor) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnomalyMonitor) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAnomalyMonitor) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAnomalyMonitor) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnomalyMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
