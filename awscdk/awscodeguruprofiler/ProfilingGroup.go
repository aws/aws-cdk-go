...
func (j *jsiiProxy_ProfilingGroup) Env() *interfaces.ResourceEnvironment {
...
func ProfilingGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codeguruprofiler.ProfilingGroup",
...
func (p *jsiiProxy_ProfilingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
