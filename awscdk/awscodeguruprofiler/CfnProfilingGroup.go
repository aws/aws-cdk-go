...
func (j *jsiiProxy_CfnProfilingGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnProfilingGroup(scope constructs.Construct, id *string, props *CfnProfilingGroupProps) CfnProfilingGroup {
	...
	if err := validateNewCfnProfilingGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnProfilingGroup)SetAnomalyDetectionNotificationConfiguration(val interface{}) {
	if err := j.validateSetAnomalyDetectionNotificationConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnProfilingGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProfilingGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProfilingGroup_IsCfnProfilingGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProfilingGroup_IsCfnProfilingGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProfilingGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProfilingGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProfilingGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProfilingGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProfilingGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilingGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProfilingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProfilingGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProfilingGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProfilingGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProfilingGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilingGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilingGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
