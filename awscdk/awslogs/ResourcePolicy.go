...
func (j *jsiiProxy_ResourcePolicy) Env() *interfaces.ResourceEnvironment {
...
func ResourcePolicy_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateResourcePolicy_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ResourcePolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.ResourcePolicy",
...
func (r *jsiiProxy_ResourcePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ResourcePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
