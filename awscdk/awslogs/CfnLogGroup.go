...
func (j *jsiiProxy_CfnLogGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLogGroup) DataProtectionPolicy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewCfnLogGroup(scope constructs.Construct, id *string, props *CfnLogGroupProps) CfnLogGroup {
	...
	if err := validateNewCfnLogGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLogGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLogGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogGroup_IsCfnLogGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLogGroup_IsCfnLogGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLogGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLogGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLogGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLogGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLogGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLogGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLogGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
