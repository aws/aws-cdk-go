...
func (j *jsiiProxy_CfnIntegration) ResourceConfig() interface{} {
...
func (j *jsiiProxy_CfnIntegration)SetResourceConfig(val interface{}) {
	if err := j.validateSetResourceConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
