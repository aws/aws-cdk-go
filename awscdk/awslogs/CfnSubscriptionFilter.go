...
func (j *jsiiProxy_CfnSubscriptionFilter) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubscriptionFilter) Distribution() *string {
	var returns *string
	_jsii_.Get(
		j,
		"distribution",
...
func NewCfnSubscriptionFilter(scope constructs.Construct, id *string, props *CfnSubscriptionFilterProps) CfnSubscriptionFilter {
	...
	if err := validateNewCfnSubscriptionFilterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSubscriptionFilter)SetDistribution(val *string) {
	_jsii_.Set(
		j,
		"distribution",
		val,
...
func (j *jsiiProxy_CfnSubscriptionFilter)SetFilterName(val *string) {
	_jsii_.Set(
		j,
		"filterName",
		val,
...
func CfnSubscriptionFilter_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionFilter_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriptionFilter_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionFilter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnSubscriptionFilter.
func CfnSubscriptionFilter_IsCfnSubscriptionFilter(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSubscriptionFilter_IsCfnSubscriptionFilterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriptionFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubscriptionFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubscriptionFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubscriptionFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubscriptionFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
