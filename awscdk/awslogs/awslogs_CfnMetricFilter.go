...
func NewCfnMetricFilter(scope constructs.Construct, id *string, props *CfnMetricFilterProps) CfnMetricFilter {
	...
	if err := validateNewCfnMetricFilterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMetricFilter)SetMetricTransformations(val interface{}) {
	if err := j.validateSetMetricTransformationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnMetricFilter_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMetricFilter_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMetricFilter_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnMetricFilter_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMetricFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMetricFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMetricFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMetricFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMetricFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMetricFilter) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnMetricFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMetricFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
