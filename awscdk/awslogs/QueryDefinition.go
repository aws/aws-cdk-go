...
func (j *jsiiProxy_QueryDefinition) Env() *interfaces.ResourceEnvironment {
...
func QueryDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.QueryDefinition",
...
func (q *jsiiProxy_QueryDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (q *jsiiProxy_QueryDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
