...
func (j *jsiiProxy_LogGroup) Env() *interfaces.ResourceEnvironment {
...
func LogGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.LogGroup",
...
func (l *jsiiProxy_LogGroup) AddTransformer(id *string, props *TransformerOptions) Transformer {
	if err := l.validateAddTransformerParameters(id, props); err != nil {
		panic(err)
	}
	var returns Transformer
...
func (l *jsiiProxy_LogGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LogGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
