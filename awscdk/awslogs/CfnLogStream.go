...
func (j *jsiiProxy_CfnLogStream) CfnPropertyNames() *map[string]*string {
...
func NewCfnLogStream(scope constructs.Construct, id *string, props *CfnLogStreamProps) CfnLogStream {
	...
	if err := validateNewCfnLogStreamParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLogStream_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLogStream_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogStream_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLogStream_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLogStream_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLogStream_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLogStream) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogStream) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLogStream) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLogStream) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLogStream) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLogStream) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogStream) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogStream) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
