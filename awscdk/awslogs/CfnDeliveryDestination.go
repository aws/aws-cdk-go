...
func (j *jsiiProxy_CfnDeliveryDestination) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDeliveryDestination) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDeliveryDestination) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDeliveryDestination) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDeliveryDestination) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDeliveryDestination) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDeliveryDestination) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDeliveryDestination) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDeliveryDestination) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDeliveryDestination) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDeliveryDestination) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDeliveryDestination) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDeliveryDestination(scope constructs.Construct, id *string, props *CfnDeliveryDestinationProps) CfnDeliveryDestination {
	...
	if err := validateNewCfnDeliveryDestinationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDeliveryDestination)SetDestinationResourceArn(val *string) {
	_jsii_.Set(
		j,
		"destinationResourceArn",
		val,
...
func (j *jsiiProxy_CfnDeliveryDestination)SetName(val *string) {
...
func (j *jsiiProxy_CfnDeliveryDestination)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDeliveryDestination_IsCfnDeliveryDestination(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeliveryDestination_IsCfnDeliveryDestinationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeliveryDestination_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeliveryDestination_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeliveryDestination_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeliveryDestination_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeliveryDestination_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeliveryDestination_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeliveryDestination) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliveryDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeliveryDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeliveryDestination) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDeliveryDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeliveryDestination) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeliveryDestination) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDeliveryDestination) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDeliveryDestination) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeliveryDestination) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDeliveryDestination) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryDestination) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryDestination) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDeliveryDestination) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryDestination) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDeliveryDestination) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDeliveryDestination) ValidateProperties(_properties interface{}) {
