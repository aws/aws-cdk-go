...
func NewCfnQueryDefinition(scope constructs.Construct, id *string, props *CfnQueryDefinitionProps) CfnQueryDefinition {
	...
	if err := validateNewCfnQueryDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnQueryDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnQueryDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueryDefinition_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnQueryDefinition_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueryDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnQueryDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueryDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueryDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnQueryDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnQueryDefinition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnQueryDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueryDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
