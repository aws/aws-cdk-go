...
func (j *jsiiProxy_CfnMetricFilter) CfnPropertyNames() *map[string]*string {
...
func CfnMetricFilter_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMetricFilter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMetricFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMetricFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMetricFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMetricFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMetricFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
