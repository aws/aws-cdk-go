...
func (j *jsiiProxy_SubscriptionFilter) Env() *interfaces.ResourceEnvironment {
...
func SubscriptionFilter_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSubscriptionFilter_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func SubscriptionFilter_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.SubscriptionFilter",
...
func (s *jsiiProxy_SubscriptionFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SubscriptionFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
