...
func (i *jsiiProxy_ILogGroup) AddTransformer(id *string, props *TransformerOptions) Transformer {
	if err := i.validateAddTransformerParameters(id, props); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_ILogGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
