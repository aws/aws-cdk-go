...
type CrossAccountDestination interface {
	...
	// function call.
	Bind(scope constructs.Construct, sourceLogGroup interfacesawslogs.ILogGroupRef) *LogSubscriptionDestinationConfig
...
func (j *jsiiProxy_CrossAccountDestination) Env() *interfaces.ResourceEnvironment {
...
func CrossAccountDestination_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.CrossAccountDestination",
...
func (c *jsiiProxy_CrossAccountDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CrossAccountDestination) Bind(scope constructs.Construct, sourceLogGroup interfacesawslogs.ILogGroupRef) *LogSubscriptionDestinationConfig {
	if err := c.validateBindParameters(scope, sourceLogGroup); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CrossAccountDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
