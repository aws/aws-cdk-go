...
func (j *jsiiProxy_CfnQueryDefinition) CfnPropertyNames() *map[string]*string {
...
func CfnQueryDefinition_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnQueryDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueryDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQueryDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQueryDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQueryDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueryDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
