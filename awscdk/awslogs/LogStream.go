...
func (j *jsiiProxy_LogStream) Env() *interfaces.ResourceEnvironment {
...
func LogStream_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.LogStream",
...
func (l *jsiiProxy_LogStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LogStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
