...
func (j *jsiiProxy_CfnDeliverySource) AttrResourceArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrResourceArns",
...
func (j *jsiiProxy_CfnDeliverySource) AttrService() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrService",
...
func (j *jsiiProxy_CfnDeliverySource) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDeliverySource) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDeliverySource) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDeliverySource) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDeliverySource) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDeliverySource) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDeliverySource) LogType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logType",
...
func (j *jsiiProxy_CfnDeliverySource) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDeliverySource) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDeliverySource) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDeliverySource) ResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceArn",
...
func (j *jsiiProxy_CfnDeliverySource) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDeliverySource) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDeliverySource) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDeliverySource) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDeliverySource(scope constructs.Construct, id *string, props *CfnDeliverySourceProps) CfnDeliverySource {
	...
	if err := validateNewCfnDeliverySourceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDeliverySource)SetLogType(val *string) {
	_jsii_.Set(
		j,
		"logType",
		val,
...
func (j *jsiiProxy_CfnDeliverySource)SetName(val *string) {
...
func (j *jsiiProxy_CfnDeliverySource)SetResourceArn(val *string) {
	_jsii_.Set(
		j,
		"resourceArn",
		val,
...
func (j *jsiiProxy_CfnDeliverySource)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDeliverySource_ArnForDeliverySource(resource interfacesawslogs.IDeliverySourceRef) *string {
	_init_.Initialize()

	if err := validateCfnDeliverySource_ArnForDeliverySourceParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDeliverySource_FromDeliverySourceName(scope constructs.Construct, id *string, deliverySourceName *string) interfacesawslogs.IDeliverySourceRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_logs.CfnDeliverySource",
		"fromDeliverySourceName",
		[]interface{}{scope, id, deliverySourceName},
		&returns,
	)
...
func CfnDeliverySource_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeliverySource_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeliverySource_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeliverySource_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeliverySource_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeliverySource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeliverySource) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDeliverySource) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliverySource) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliverySource) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliverySource) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliverySource) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDeliverySource) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDeliverySource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeliverySource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeliverySource) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDeliverySource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeliverySource) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeliverySource) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDeliverySource) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDeliverySource) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeliverySource) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDeliverySource) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliverySource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliverySource) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDeliverySource) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliverySource) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDeliverySource) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDeliverySource) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDeliverySource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
