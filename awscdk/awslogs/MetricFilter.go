...
func (j *jsiiProxy_MetricFilter) Env() *interfaces.ResourceEnvironment {
...
func MetricFilter_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateMetricFilter_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func MetricFilter_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_logs.MetricFilter",
...
func (m *jsiiProxy_MetricFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
