...
func (j *jsiiProxy_CfnDestination) CfnPropertyNames() *map[string]*string {
...
func NewCfnDestination(scope constructs.Construct, id *string, props *CfnDestinationProps) CfnDestination {
	...
	if err := validateNewCfnDestinationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDestination_FromDestinationName(scope constructs.Construct, id *string, destinationName *string) interfacesawslogs.IDestinationRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_logs.CfnDestination",
		"fromDestinationName",
		[]interface{}{scope, id, destinationName},
		&returns,
	)
...
func CfnDestination_IsCfnDestination(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDestination_IsCfnDestinationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDestination_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDestination_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDestination_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDestination_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDestination_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDestination_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDestination) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDestination) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDestination) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDestination) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDestination) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDestination) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
