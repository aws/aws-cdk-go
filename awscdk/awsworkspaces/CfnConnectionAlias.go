...
func (j *jsiiProxy_CfnConnectionAlias) CfnPropertyNames() *map[string]*string {
...
func NewCfnConnectionAlias(scope constructs.Construct, id *string, props *CfnConnectionAliasProps) CfnConnectionAlias {
	...
	if err := validateNewCfnConnectionAliasParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnConnectionAlias_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConnectionAlias_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionAlias_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConnectionAlias_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConnectionAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConnectionAlias) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectionAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectionAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectionAlias) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConnectionAlias) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConnectionAlias) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionAlias) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
