...
//
//   cfnWorkspacesPool := awscdk.Aws_workspaces.NewCfnWorkspacesPool(this, jsii.String("MyCfnWorkspacesPool"), &CfnWorkspacesPoolProps{
...
func (j *jsiiProxy_CfnWorkspacesPool) ApplicationSettings() interface{} {
...
func (j *jsiiProxy_CfnWorkspacesPool) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnWorkspacesPool) AttrPoolArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPoolArn",
...
func (j *jsiiProxy_CfnWorkspacesPool) AttrPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPoolId",
...
func (j *jsiiProxy_CfnWorkspacesPool) BundleId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bundleId",
...
func (j *jsiiProxy_CfnWorkspacesPool) Capacity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"capacity",
...
func (j *jsiiProxy_CfnWorkspacesPool) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnWorkspacesPool) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnWorkspacesPool) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnWorkspacesPool) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWorkspacesPool) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnWorkspacesPool) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnWorkspacesPool) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnWorkspacesPool) DirectoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"directoryId",
...
func (j *jsiiProxy_CfnWorkspacesPool) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnWorkspacesPool) Node() constructs.Node {
...
func (j *jsiiProxy_CfnWorkspacesPool) PoolName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"poolName",
...
func (j *jsiiProxy_CfnWorkspacesPool) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnWorkspacesPool) RunningMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"runningMode",
...
func (j *jsiiProxy_CfnWorkspacesPool) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnWorkspacesPool) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnWorkspacesPool) TimeoutSettings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutSettings",
...
func (j *jsiiProxy_CfnWorkspacesPool) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnWorkspacesPool) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnWorkspacesPool(scope constructs.Construct, id *string, props *CfnWorkspacesPoolProps) CfnWorkspacesPool {
	...
	if err := validateNewCfnWorkspacesPoolParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnWorkspacesPool)SetApplicationSettings(val interface{}) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetBundleId(val *string) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetCapacity(val interface{}) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnWorkspacesPool)SetDirectoryId(val *string) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetPoolName(val *string) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetRunningMode(val *string) {
	_jsii_.Set(
		j,
		"runningMode",
		val,
...
func (j *jsiiProxy_CfnWorkspacesPool)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnWorkspacesPool)SetTimeoutSettings(val interface{}) {
	if err := j.validateSetTimeoutSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnWorkspacesPool_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnWorkspacesPool_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWorkspacesPool_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWorkspacesPool_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWorkspacesPool_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnWorkspacesPool_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWorkspacesPool) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnWorkspacesPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWorkspacesPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWorkspacesPool) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnWorkspacesPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWorkspacesPool) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWorkspacesPool) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnWorkspacesPool) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnWorkspacesPool) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWorkspacesPool) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnWorkspacesPool) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspacesPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspacesPool) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnWorkspacesPool) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspacesPool) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnWorkspacesPool) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnWorkspacesPool) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnWorkspacesPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
