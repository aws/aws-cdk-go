...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsworkspaces/internal"
...
//
// Example:
//   import awscdk "github.com/aws/aws-cdk-go/awscdk"import workspaces "github.com/aws/aws-cdk-go/awscdk/aws_workspaces"
//   cfnConnectionAlias := workspaces.NewCfnConnectionAlias(this, jsii.String("MyCfnConnectionAlias"), &cfnConnectionAliasProps{
...
func (j *jsiiProxy_CfnConnectionAlias) Node() awscdk.ConstructNode {
...
func (c *jsiiProxy_CfnConnectionAlias) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnConnectionAlias) OnSynthesize(session constructs.ISynthesisSession) {
	_jsii_.InvokeVoid(
		c,
		"onSynthesize",
		[]interface{}{session},
...
func (c *jsiiProxy_CfnConnectionAlias) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnConnectionAlias) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnConnectionAlias) Synthesize(session awscdk.ISynthesisSession) {
	_jsii_.InvokeVoid(
		c,
		"synthesize",
		[]interface{}{session},
...
func (c *jsiiProxy_CfnConnectionAlias) Validate() *[]*string {
	var returns *[]*string
...
// Example:
//   import awscdk "github.com/aws/aws-cdk-go/awscdk"import workspaces "github.com/aws/aws-cdk-go/awscdk/aws_workspaces"
//   cfnWorkspace := workspaces.NewCfnWorkspace(this, jsii.String("MyCfnWorkspace"), &cfnWorkspaceProps{
