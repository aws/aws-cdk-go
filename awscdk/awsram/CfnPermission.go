...
//
//   cfnPermission := awscdk.Aws_ram.NewCfnPermission(this, jsii.String("MyCfnPermission"), &CfnPermissionProps{
...
type CfnPermission interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsram.IPermissionRef
	awscdk.ITaggable
	...
	AttrIsResourceTypeDefault() awscdk.IResolvable
	...
	PermissionRef() *interfacesawsram.PermissionReference
...
type jsiiProxy_CfnPermission struct {
	...
	internal.Type__interfacesawsramIPermissionRef
...
func (j *jsiiProxy_CfnPermission) AttrIsResourceTypeDefault() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnPermission) AttrPermissionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPermissionType",
...
func (j *jsiiProxy_CfnPermission) AttrVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersion",
...
func (j *jsiiProxy_CfnPermission) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPermission) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPermission) PermissionRef() *interfacesawsram.PermissionReference {
	var returns *interfacesawsram.PermissionReference
	_jsii_.Get(
		j,
		"permissionRef",
		&returns,
...
func (j *jsiiProxy_CfnPermission) PolicyTemplate() interface{} {
...
func (j *jsiiProxy_CfnPermission) ResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceType",
...
func (j *jsiiProxy_CfnPermission) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPermission) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPermission(scope constructs.Construct, id *string, props *CfnPermissionProps) CfnPermission {
	...
	if err := validateNewCfnPermissionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPermission)SetName(val *string) {
...
func (j *jsiiProxy_CfnPermission)SetPolicyTemplate(val interface{}) {
	if err := j.validateSetPolicyTemplateParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPermission)SetResourceType(val *string) {
...
func CfnPermission_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPermission_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermission_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPermission_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermission_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPermission_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPermission) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermission) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPermission) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPermission) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPermission) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPermission) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPermission) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermission) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermission) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
