...
func (j *jsiiProxy_CfnResourceShare) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourceShare) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceShare(scope constructs.Construct, id *string, props *CfnResourceShareProps) CfnResourceShare {
	...
	if err := validateNewCfnResourceShareParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResourceShare_ArnForResourceShare(resource interfacesawsram.IResourceShareRef) *string {
	_init_.Initialize()

	if err := validateCfnResourceShare_ArnForResourceShareParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnResourceShare_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceShare_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceShare_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceShare_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceShare_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceShare_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceShare) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceShare) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceShare) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceShare) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceShare) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceShare) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceShare) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceShare) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceShare) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
