...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsopensearch"
...
func (c *jsiiProxy_CfnDataSource) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnDataSource) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnDataSource) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnDataSource) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnDataSource_ArnForDataSourceParameters(resource interfacesawsopensearch.IDataSourceRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetDataSourceTypeParameters(val interface{}) error {
	if val == nil {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_DataSourceTypeProperty:
		val := val.(*CfnDataSource_DataSourceTypeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_DataSourceTypeProperty:
		val_ := val.(CfnDataSource_DataSourceTypeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_DataSourceTypeProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetDomainNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
