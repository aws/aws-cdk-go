...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsopensearch/internal"
...
//
//   cfnDataSource := awscdk.Aws_opensearch.NewCfnDataSource(this, jsii.String("MyCfnDataSource"), &CfnDataSourceProps{
...
type CfnDataSource interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsopensearch.IDataSourceRef
	...
	DataSourceRef() *interfacesawsopensearch.DataSourceReference
...
type jsiiProxy_CfnDataSource struct {
	...
	internal.Type__interfacesawsopensearchIDataSourceRef
}
...
func (j *jsiiProxy_CfnDataSource) DataSourceRef() *interfacesawsopensearch.DataSourceReference {
	var returns *interfacesawsopensearch.DataSourceReference
	_jsii_.Get(
		j,
		"dataSourceRef",
		&returns,
...
func (j *jsiiProxy_CfnDataSource) DataSourceType() interface{} {
...
func (j *jsiiProxy_CfnDataSource) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_CfnDataSource)SetDataSourceType(val interface{}) {
...
func (j *jsiiProxy_CfnDataSource)SetDomainName(val *string) {
...
func CfnDataSource_ArnForDataSource(resource interfacesawsopensearch.IDataSourceRef) *string {
	_init_.Initialize()
