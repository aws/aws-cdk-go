...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_opensearch.CfnDataSource",
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsopensearchIDataSourceRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearch.CfnDataSource.DataSourceTypeProperty",
		reflect.TypeOf((*CfnDataSource_DataSourceTypeProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearch.CfnDataSource.S3GlueDataCatalogProperty",
		reflect.TypeOf((*CfnDataSource_S3GlueDataCatalogProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearch.CfnDataSourceProps",
