...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnAllGroupMemberships)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsidentitystoreIAllGroupMembershipsRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_identitystore.CfnAllGroupMemberships.MemberIdProperty",
		reflect.TypeOf((*CfnAllGroupMemberships_MemberIdProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_identitystore.CfnAllGroupMembershipsProps",
		reflect.TypeOf((*CfnAllGroupMembershipsProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
