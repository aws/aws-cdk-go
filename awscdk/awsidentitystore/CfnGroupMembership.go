...
func (j *jsiiProxy_CfnGroupMembership) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnGroupMembership) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroupMembership) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroupMembership) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroupMembership) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
