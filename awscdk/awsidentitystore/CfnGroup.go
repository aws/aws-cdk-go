...
//
//   cfnGroup := awscdk.Aws_identitystore.NewCfnGroup(this, jsii.String("MyCfnGroup"), &CfnGroupProps{
...
func (j *jsiiProxy_CfnGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGroup) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnGroup) IdentityStoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityStoreId",
...
func NewCfnGroup(scope constructs.Construct, id *string, props *CfnGroupProps) CfnGroup {
	...
	if err := validateNewCfnGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGroup)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnGroup)SetIdentityStoreId(val *string) {
...
func CfnGroup_ArnForGroup(resource interfacesawsidentitystore.IGroupRef) *string {
	_init_.Initialize()
...
func CfnGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
