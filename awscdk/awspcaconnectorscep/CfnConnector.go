...
type CfnConnector interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawspcaconnectorscep.IConnectorRef
	awscdk.ITaggableV2
	...
	ConnectorRef() *interfacesawspcaconnectorscep.ConnectorReference
...
type jsiiProxy_CfnConnector struct {
	...
	internal.Type__interfacesawspcaconnectorscepIConnectorRef
...
func (j *jsiiProxy_CfnConnector) AttrEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEndpoint",
...
func (j *jsiiProxy_CfnConnector) AttrOpenIdConfiguration() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnConnector) AttrType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrType",
...
func (j *jsiiProxy_CfnConnector) ConnectorRef() *interfacesawspcaconnectorscep.ConnectorReference {
	var returns *interfacesawspcaconnectorscep.ConnectorReference
	_jsii_.Get(
		j,
		"connectorRef",
		&returns,
...
func (j *jsiiProxy_CfnConnector) MobileDeviceManagement() interface{} {
...
func (j *jsiiProxy_CfnConnector)SetMobileDeviceManagement(val interface{}) {
	if err := j.validateSetMobileDeviceManagementParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
