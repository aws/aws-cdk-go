...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnChallenge",
		reflect.TypeOf((*CfnChallenge)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrChallengeArn", GoGetter: "AttrChallengeArn"},
		...
		func() interface{} {
			j := jsiiProxy_CfnChallenge{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IChallengeRef)
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnChallengeProps",
		reflect.TypeOf((*CfnChallengeProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrOpenIdConfiguration", GoGetter: "AttrOpenIdConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "inspect", GoMethod: "Inspect"},
			_jsii_.MemberProperty{JsiiProperty: "logicalId", GoGetter: "LogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "mobileDeviceManagement", GoGetter: "MobileDeviceManagement"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "obtainDependencies", GoMethod: "ObtainDependencies"},
			_jsii_.MemberMethod{JsiiMethod: "obtainResourceDependencies", GoMethod: "ObtainResourceDependencies"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnConnector.IntuneConfigurationProperty",
		reflect.TypeOf((*CfnConnector_IntuneConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnConnector.MobileDeviceManagementProperty",
		reflect.TypeOf((*CfnConnector_MobileDeviceManagementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnConnector.OpenIdConfigurationProperty",
		reflect.TypeOf((*CfnConnector_OpenIdConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.CfnConnectorProps",
		reflect.TypeOf((*CfnConnectorProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.ChallengeReference",
		reflect.TypeOf((*ChallengeReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pcaconnectorscep.ConnectorReference",
