...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawsdax.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetIamRoleArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetReplicationFactorParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCluster) validateSetSseSpecificationParameters(val interface{}) error {
	...
	case CfnCluster_SSESpecificationProperty:
		val_ := val.(CfnCluster_SSESpecificationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
