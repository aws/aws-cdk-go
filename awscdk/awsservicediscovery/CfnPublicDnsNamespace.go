...
func (j *jsiiProxy_CfnPublicDnsNamespace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPublicDnsNamespace) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPublicDnsNamespace(scope constructs.Construct, id *string, props *CfnPublicDnsNamespaceProps) CfnPublicDnsNamespace {
	...
	if err := validateNewCfnPublicDnsNamespaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPublicDnsNamespace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPublicDnsNamespace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicDnsNamespace_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPublicDnsNamespace_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicDnsNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPublicDnsNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublicDnsNamespace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPublicDnsNamespace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
