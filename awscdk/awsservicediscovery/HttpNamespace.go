...
func (j *jsiiProxy_HttpNamespace) Env() *interfaces.ResourceEnvironment {
...
func HttpNamespace_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.HttpNamespace",
...
func (h *jsiiProxy_HttpNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
