...
func (j *jsiiProxy_CfnPrivateDnsNamespace) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPrivateDnsNamespace(scope constructs.Construct, id *string, props *CfnPrivateDnsNamespaceProps) CfnPrivateDnsNamespace {
	...
	if err := validateNewCfnPrivateDnsNamespaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPrivateDnsNamespace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPrivateDnsNamespace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrivateDnsNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPrivateDnsNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
