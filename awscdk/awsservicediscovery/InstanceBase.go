...
func (j *jsiiProxy_InstanceBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_InstanceBase) InstanceRef() *interfacesawsservicediscovery.InstanceReference {
...
func (i *jsiiProxy_InstanceBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (i *jsiiProxy_InstanceBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
