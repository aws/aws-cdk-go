...
func (j *jsiiProxy_AliasTargetInstance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_AliasTargetInstance) InstanceRef() *interfacesawsservicediscovery.InstanceReference {
...
func AliasTargetInstance_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.AliasTargetInstance",
...
func (a *jsiiProxy_AliasTargetInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AliasTargetInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
