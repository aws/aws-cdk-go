...
func (j *jsiiProxy_NonIpInstance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_NonIpInstance) InstanceRef() *interfacesawsservicediscovery.InstanceReference {
...
func NewNonIpInstance(scope constructs.Construct, id *string, props *NonIpInstanceProps) NonIpInstance {
	...
	if err := validateNewNonIpInstanceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func NonIpInstance_IsConstruct(x interface{}) *bool {
	...
	if err := validateNonIpInstance_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NonIpInstance_IsOwnedResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateNonIpInstance_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func NonIpInstance_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateNonIpInstance_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func NonIpInstance_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.NonIpInstance",
...
func (n *jsiiProxy_NonIpInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (n *jsiiProxy_NonIpInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
