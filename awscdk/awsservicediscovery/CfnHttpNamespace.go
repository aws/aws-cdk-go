...
func (j *jsiiProxy_CfnHttpNamespace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHttpNamespace) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnHttpNamespace(scope constructs.Construct, id *string, props *CfnHttpNamespaceProps) CfnHttpNamespace {
	...
	if err := validateNewCfnHttpNamespaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnHttpNamespace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnHttpNamespace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHttpNamespace_IsCfnHttpNamespace(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnHttpNamespace_IsCfnHttpNamespaceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHttpNamespace_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnHttpNamespace_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHttpNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnHttpNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHttpNamespace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHttpNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHttpNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHttpNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHttpNamespace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHttpNamespace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHttpNamespace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHttpNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHttpNamespace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHttpNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
