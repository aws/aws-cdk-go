...
func (j *jsiiProxy_IpInstance) Env() *interfaces.ResourceEnvironment {
...
func IpInstance_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.IpInstance",
...
func (i *jsiiProxy_IpInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
