...
func (j *jsiiProxy_CfnPrivateDnsNamespace) CfnPropertyNames() *map[string]*string {
...
func CfnPrivateDnsNamespace_IsCfnPrivateDnsNamespace(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPrivateDnsNamespace_IsCfnPrivateDnsNamespaceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrivateDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
