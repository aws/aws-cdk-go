...
func (j *jsiiProxy_CnameInstance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CnameInstance) InstanceRef() *interfacesawsservicediscovery.InstanceReference {
...
func CnameInstance_IsOwnedResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateCnameInstance_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CnameInstance_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.CnameInstance",
...
func (c *jsiiProxy_CnameInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CnameInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
