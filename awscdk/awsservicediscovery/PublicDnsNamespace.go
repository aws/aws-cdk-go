...
func (j *jsiiProxy_PublicDnsNamespace) Env() *interfaces.ResourceEnvironment {
...
func PublicDnsNamespace_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePublicDnsNamespace_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PublicDnsNamespace_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicediscovery.PublicDnsNamespace",
...
func (p *jsiiProxy_PublicDnsNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PublicDnsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
