...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrBackupPolicy", GoGetter: "AttrBackupPolicy"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrSubnetMapping", GoGetter: "AttrSubnetMapping"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscloudhsmIClusterRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudhsm.CfnCluster.BackupRetentionPolicyProperty",
		reflect.TypeOf((*CfnCluster_BackupRetentionPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudhsm.CfnCluster.TagsItemsProperty",
		reflect.TypeOf((*CfnCluster_TagsItemsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudhsm.CfnClusterProps",
