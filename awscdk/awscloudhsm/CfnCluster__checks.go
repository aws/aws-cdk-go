...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawscloudhsm"
...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawscloudhsm.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetBackupRetentionPolicyParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_BackupRetentionPolicyProperty:
		val := val.(*CfnCluster_BackupRetentionPolicyProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_BackupRetentionPolicyProperty:
		val_ := val.(CfnCluster_BackupRetentionPolicyProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_BackupRetentionPolicyProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCluster) validateSetHsmTypeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetTagsParameters(val *[]*CfnCluster_TagsItemsProperty) error {
