...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awscloudhsm/internal"
...
//
//   cfnCluster := awscdk.Aws_cloudhsm.NewCfnCluster(this, jsii.String("MyCfnCluster"), &CfnClusterProps{
...
type CfnCluster interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscloudhsm.IClusterRef
	awscdk.ITaggableV2
	// The Amazon Resource Name (ARN) of the cluster.
	AttrArn() *string
	// The cluster's backup policy.
	AttrBackupPolicy() *string
	...
	AttrSubnetMapping() awscdk.IResolvable
	// The identifier (ID) of the virtual private cloud (VPC) that contains the cluster.
	AttrVpcId() *string
	// A policy that defines how the service retains backups.
	BackupRetentionPolicy() interface{}
	SetBackupRetentionPolicy(val interface{})
	...
	ClusterRef() *interfacesawscloudhsm.ClusterReference
	...
	Tags() *[]*CfnCluster_TagsItemsProperty
	SetTags(val *[]*CfnCluster_TagsItemsProperty)
	// Deprecated.
...
type jsiiProxy_CfnCluster struct {
	...
	internal.Type__interfacesawscloudhsmIClusterRef
...
func (j *jsiiProxy_CfnCluster) AttrBackupPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrBackupPolicy",
...
func (j *jsiiProxy_CfnCluster) AttrClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrClusterId",
...
func (j *jsiiProxy_CfnCluster) AttrSecurityGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSecurityGroup",
...
func (j *jsiiProxy_CfnCluster) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnCluster) AttrSubnetMapping() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnCluster) AttrVpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVpcId",
...
func (j *jsiiProxy_CfnCluster) BackupRetentionPolicy() interface{} {
...
func (j *jsiiProxy_CfnCluster) ClusterRef() *interfacesawscloudhsm.ClusterReference {
	var returns *interfacesawscloudhsm.ClusterReference
	_jsii_.Get(
		j,
		"clusterRef",
		&returns,
...
func (j *jsiiProxy_CfnCluster) HsmType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hsmType",
...
func (j *jsiiProxy_CfnCluster) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_CfnCluster) Tags() *[]*CfnCluster_TagsItemsProperty {
	var returns *[]*CfnCluster_TagsItemsProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func NewCfnCluster(scope constructs.Construct, id *string, props *CfnClusterProps) CfnCluster {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_cloudhsm.CfnCluster",
...
func (j *jsiiProxy_CfnCluster)SetBackupRetentionPolicy(val interface{}) {
	if err := j.validateSetBackupRetentionPolicyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCluster)SetHsmType(val *string) {
...
func (j *jsiiProxy_CfnCluster)SetMode(val *string) {
	_jsii_.Set(
		j,
		"mode",
		val,
...
func (j *jsiiProxy_CfnCluster)SetTags(val *[]*CfnCluster_TagsItemsProperty) {
...
func CfnCluster_ArnForCluster(resource interfacesawscloudhsm.IClusterRef) *string {
	_init_.Initialize()
