...
func NewCfnEventType(scope constructs.Construct, id *string, props *CfnEventTypeProps) CfnEventType {
	...
	if err := validateNewCfnEventTypeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEventType)SetEntityTypes(val interface{}) {
	if err := j.validateSetEntityTypesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnEventType)SetEventVariables(val interface{}) {
	if err := j.validateSetEventVariablesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEventType_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEventType_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventType_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnEventType_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventType_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEventType_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventType) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventType) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEventType) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEventType) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnEventType) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventType) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
