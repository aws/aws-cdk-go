...
func (j *jsiiProxy_CfnVariable) CfnPropertyNames() *map[string]*string {
...
func CfnVariable_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVariable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVariable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVariable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVariable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVariable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
