...
func (j *jsiiProxy_CfnEntityType) CfnPropertyNames() *map[string]*string {
...
func NewCfnEntityType(scope constructs.Construct, id *string, props *CfnEntityTypeProps) CfnEntityType {
	...
	if err := validateNewCfnEntityTypeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEntityType_ArnForEntityType(resource interfacesawsfrauddetector.IEntityTypeRef) *string {
	_init_.Initialize()

	if err := validateCfnEntityType_ArnForEntityTypeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEntityType_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEntityType_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEntityType_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEntityType_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEntityType_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEntityType_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEntityType) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntityType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEntityType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEntityType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEntityType) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEntityType) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEntityType) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntityType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntityType) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntityType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
