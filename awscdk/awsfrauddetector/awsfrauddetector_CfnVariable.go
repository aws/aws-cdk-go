...
func NewCfnVariable(scope constructs.Construct, id *string, props *CfnVariableProps) CfnVariable {
	...
	if err := validateNewCfnVariableParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVariable_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVariable_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVariable_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnVariable_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVariable_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVariable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVariable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVariable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVariable) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnVariable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVariable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
