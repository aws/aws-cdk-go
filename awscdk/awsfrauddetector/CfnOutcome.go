...
func (j *jsiiProxy_CfnOutcome) CfnPropertyNames() *map[string]*string {
...
func NewCfnOutcome(scope constructs.Construct, id *string, props *CfnOutcomeProps) CfnOutcome {
	...
	if err := validateNewCfnOutcomeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnOutcome_ArnForOutcome(resource interfacesawsfrauddetector.IOutcomeRef) *string {
	_init_.Initialize()

	if err := validateCfnOutcome_ArnForOutcomeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnOutcome_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOutcome_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOutcome_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOutcome_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOutcome_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOutcome_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOutcome) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOutcome) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOutcome) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOutcome) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOutcome) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOutcome) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOutcome) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOutcome) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOutcome) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOutcome) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
