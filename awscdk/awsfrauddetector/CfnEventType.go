...
func (j *jsiiProxy_CfnEventType) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventType) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnEventType)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnEventType_ArnForEventType(resource interfacesawsfrauddetector.IEventTypeRef) *string {
	_init_.Initialize()

	if err := validateCfnEventType_ArnForEventTypeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEventType_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEventType_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
