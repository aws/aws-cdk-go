...
func (j *jsiiProxy_CfnLabel) CfnPropertyNames() *map[string]*string {
...
func NewCfnLabel(scope constructs.Construct, id *string, props *CfnLabelProps) CfnLabel {
	...
	if err := validateNewCfnLabelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLabel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLabel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLabel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLabel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLabel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLabel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLabel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLabel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLabel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLabel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLabel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLabel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLabel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLabel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLabel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLabel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
