...
func (j *jsiiProxy_CfnAlert) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAlert(scope constructs.Construct, id *string, props *CfnAlertProps) CfnAlert {
	...
	if err := validateNewCfnAlertParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAlert_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAlert_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAlert_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAlert_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAlert_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAlert_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAlert) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlert) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAlert) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAlert) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnAlert) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlert) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
