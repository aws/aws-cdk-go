...
func (j *jsiiProxy_CfnAlert) CfnPropertyNames() *map[string]*string {
...
func CfnAlert_ArnForAlert(resource interfacesawslookoutmetrics.IAlertRef) *string {
	...
	if err := validateCfnAlert_ArnForAlertParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAlert_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAlert_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAlert) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAlert) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAlert) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAlert) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlert) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
