...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_gamelift.CfnBuild.StorageLocationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_gamelift.CfnFleet.AnywhereConfigurationProperty",
	...
	_jsii_.RegisterClass(
		"monocdk.aws_gamelift.CfnLocation",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_gamelift.CfnLocationProps",
