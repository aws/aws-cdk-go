...
func (j *jsiiProxy_CfnScript) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScript) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnScript_IsCfnScript(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScript_IsCfnScriptParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScript) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScript) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScript) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScript) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScript) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScript) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScript) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScript) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScript) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScript) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
