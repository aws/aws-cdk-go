...
func (j *jsiiProxy_CfnGameSessionQueue) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnGameSessionQueue) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGameSessionQueue) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGameSessionQueue) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGameSessionQueue) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGameSessionQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
