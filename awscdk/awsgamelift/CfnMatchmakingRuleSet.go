...
//
//   cfnMatchmakingRuleSet := awscdk.Aws_gamelift.NewCfnMatchmakingRuleSet(this, jsii.String("MyCfnMatchmakingRuleSet"), &CfnMatchmakingRuleSetProps{
...
func (j *jsiiProxy_CfnMatchmakingRuleSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMatchmakingRuleSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMatchmakingRuleSet(scope constructs.Construct, id *string, props *CfnMatchmakingRuleSetProps) CfnMatchmakingRuleSet {
	...
	if err := validateNewCfnMatchmakingRuleSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMatchmakingRuleSet_ArnForMatchmakingRuleSet(resource interfacesawsgamelift.IMatchmakingRuleSetRef) *string {
	_init_.Initialize()

	if err := validateCfnMatchmakingRuleSet_ArnForMatchmakingRuleSetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMatchmakingRuleSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMatchmakingRuleSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMatchmakingRuleSet_IsCfnMatchmakingRuleSet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMatchmakingRuleSet_IsCfnMatchmakingRuleSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMatchmakingRuleSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMatchmakingRuleSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMatchmakingRuleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
