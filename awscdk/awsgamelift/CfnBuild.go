...
func (j *jsiiProxy_CfnBuild) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnBuild) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBuild) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBuild) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBuild) RemoveResourceDependency(target awscdk.CfnResource) {
