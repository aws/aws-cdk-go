...
//
//   cfnAlias := awscdk.Aws_gamelift.NewCfnAlias(this, jsii.String("MyCfnAlias"), &CfnAliasProps{
...
func (j *jsiiProxy_CfnAlias) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAlias) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAlias)SetTags(val *[]*awscdk.CfnTag) {
