...
func (j *jsiiProxy_CfnGameServerGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnGameServerGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGameServerGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGameServerGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGameServerGroup) RemoveResourceDependency(target awscdk.CfnResource) {
