...
func (j *jsiiProxy_CfnContainerGroupDefinition) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnContainerGroupDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContainerGroupDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContainerGroupDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContainerGroupDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
