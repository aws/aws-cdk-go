...
//
//   cfnLocation := awscdk.Aws_gamelift.NewCfnLocation(this, jsii.String("MyCfnLocation"), &CfnLocationProps{
...
func (j *jsiiProxy_CfnLocation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnLocation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnLocation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLocation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnLocation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnLocation) LocationName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationName",
...
func (j *jsiiProxy_CfnLocation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnLocation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLocation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnLocation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnLocation) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnLocation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLocation(scope constructs.Construct, id *string, props *CfnLocationProps) CfnLocation {
	...
	if err := validateNewCfnLocationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLocation)SetLocationName(val *string) {
...
func CfnLocation_ArnForLocation(resource interfacesawsgamelift.ILocationRef) *string {
	_init_.Initialize()

	if err := validateCfnLocation_ArnForLocationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnLocation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnLocation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnLocation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnLocation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnLocation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnLocation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnLocation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnLocation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnLocation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnLocation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
