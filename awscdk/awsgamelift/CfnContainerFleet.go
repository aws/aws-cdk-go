...
func (j *jsiiProxy_CfnContainerFleet) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnContainerFleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContainerFleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContainerFleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContainerFleet) RemoveResourceDependency(target awscdk.CfnResource) {
