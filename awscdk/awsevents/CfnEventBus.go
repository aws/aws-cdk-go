...
func (j *jsiiProxy_CfnEventBus) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventBus) LogConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"logConfig",
...
func (j *jsiiProxy_CfnEventBus) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEventBus(scope constructs.Construct, id *string, props *CfnEventBusProps) CfnEventBus {
	...
	if err := validateNewCfnEventBusParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEventBus)SetLogConfig(val interface{}) {
...
func CfnEventBus_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEventBus_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventBus_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEventBus_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventBus_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEventBus_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventBus) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBus) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventBus) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventBus) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventBus) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEventBus) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEventBus) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBus) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBus) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBus) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
