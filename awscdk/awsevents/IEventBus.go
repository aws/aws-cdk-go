...
func (i *jsiiProxy_IEventBus) GrantPutEventsTo(grantee awsiam.IGrantable, sid *string) awsiam.Grant {
...
func (i *jsiiProxy_IEventBus) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
