...
func (j *jsiiProxy_CfnApiDestination) AttrArnForPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArnForPolicy",
...
func (j *jsiiProxy_CfnApiDestination) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApiDestination) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApiDestination(scope constructs.Construct, id *string, props *CfnApiDestinationProps) CfnApiDestination {
	...
	if err := validateNewCfnApiDestinationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApiDestination_IsCfnApiDestination(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApiDestination_IsCfnApiDestinationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiDestination_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApiDestination_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiDestination_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApiDestination_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiDestination_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApiDestination_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApiDestination) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiDestination) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApiDestination) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApiDestination) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiDestination) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiDestination) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
