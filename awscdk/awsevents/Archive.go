...
func (j *jsiiProxy_Archive) Env() *interfaces.ResourceEnvironment {
...
func Archive_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_events.Archive",
...
func (a *jsiiProxy_Archive) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_Archive) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
