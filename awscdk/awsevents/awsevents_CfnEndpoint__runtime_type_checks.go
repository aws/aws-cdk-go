...
func (c *jsiiProxy_CfnEndpoint) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_CfnEndpoint) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetEventBusesParameters(val interface{}) error {
	if val == nil {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			switch v.(type) {
			case *CfnEndpoint_EndpointEventBusProperty:
				v := v.(*CfnEndpoint_EndpointEventBusProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnEndpoint_EndpointEventBusProperty:
				v_ := v.(CfnEndpoint_EndpointEventBusProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: *CfnEndpoint_EndpointEventBusProperty, awscdk.IResolvable; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnEndpoint) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetReplicationConfigParameters(val interface{}) error {
	switch val.(type) {
	case *CfnEndpoint_ReplicationConfigProperty:
		val := val.(*CfnEndpoint_ReplicationConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnEndpoint_ReplicationConfigProperty:
		val_ := val.(CfnEndpoint_ReplicationConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnEndpoint_ReplicationConfigProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetRoutingConfigParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case *CfnEndpoint_RoutingConfigProperty:
		val := val.(*CfnEndpoint_RoutingConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnEndpoint_RoutingConfigProperty:
		val_ := val.(CfnEndpoint_RoutingConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnEndpoint_RoutingConfigProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func validateNewCfnEndpointParameters(scope awscdk.Construct, id *string, props *CfnEndpointProps) error {
	if scope == nil {
