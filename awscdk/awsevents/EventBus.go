...
func (j *jsiiProxy_EventBus) Env() *interfaces.ResourceEnvironment {
...
func EventBus_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_events.EventBus",
...
func (e *jsiiProxy_EventBus) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EventBus) GrantPutEventsTo(grantee awsiam.IGrantable, sid *string) awsiam.Grant {
...
func (e *jsiiProxy_EventBus) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
