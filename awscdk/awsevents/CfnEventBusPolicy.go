...
func (j *jsiiProxy_CfnEventBusPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventBusPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnEventBusPolicy_IsCfnEventBusPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEventBusPolicy_IsCfnEventBusPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventBusPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEventBusPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventBusPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBusPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventBusPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventBusPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventBusPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEventBusPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEventBusPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBusPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBusPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventBusPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
