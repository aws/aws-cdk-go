...
func (j *jsiiProxy_ApiDestination) Env() *interfaces.ResourceEnvironment {
...
func ApiDestination_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_events.ApiDestination",
...
func (a *jsiiProxy_ApiDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ApiDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
