...
func (j *jsiiProxy_EventBusPolicy) Env() *interfaces.ResourceEnvironment {
...
func EventBusPolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_events.EventBusPolicy",
...
func (e *jsiiProxy_EventBusPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EventBusPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
