...
func (j *jsiiProxy_Rule) Env() *interfaces.ResourceEnvironment {
...
func Rule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_events.Rule",
...
func (r *jsiiProxy_Rule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
