...
func (j *jsiiProxy_CfnArchive) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnArchive) KmsKeyIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdentifier",
...
func (j *jsiiProxy_CfnArchive) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnArchive(scope constructs.Construct, id *string, props *CfnArchiveProps) CfnArchive {
	...
	if err := validateNewCfnArchiveParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnArchive)SetKmsKeyIdentifier(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyIdentifier",
		val,
...
func CfnArchive_IsCfnArchive(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnArchive_IsCfnArchiveParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnArchive_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnArchive_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnArchive_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnArchive_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnArchive_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnArchive_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnArchive) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnArchive) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnArchive) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnArchive) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnArchive) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnArchive) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnArchive) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnArchive) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnArchive) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnArchive) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
