...
func (c *jsiiProxy_Connection) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_Connection) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateConnection_FromEventBusArnParameters(scope constructs.Construct, id *string, connectionArn *string, connectionSecretArn *string) error {
	...
	if connectionArn == nil {
		return fmt.Errorf("parameter connectionArn is required, but nil was provided")
	}

	if connectionSecretArn == nil {
		return fmt.Errorf("parameter connectionSecretArn is required, but nil was provided")
	}
...
func validateConnection_IsResourceParameters(construct awscdk.IConstruct) error {
	if construct == nil {
