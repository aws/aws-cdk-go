...
//
//   cfnPolicy := awscdk.Aws_resiliencehubv2.NewCfnPolicy(this, jsii.String("MyCfnPolicy"), &CfnPolicyProps{
...
type CfnPolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsresiliencehubv2.IPolicyRef
	awscdk.ITaggableV2
	// The number of services associated with this policy.
	AttrAssociatedServiceCount() *float64
	...
	SetAvailabilitySlo(val interface{})
	...
	PolicyRef() *interfacesawsresiliencehubv2.PolicyReference
...
type jsiiProxy_CfnPolicy struct {
	...
	internal.Type__interfacesawsresiliencehubv2IPolicyRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnPolicy) AttrAssociatedServiceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrAssociatedServiceCount",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPolicy) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnPolicy) AttrPolicyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPolicyArn",
...
func (j *jsiiProxy_CfnPolicy) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnPolicy) AvailabilitySlo() interface{} {
...
func (j *jsiiProxy_CfnPolicy) DataRecovery() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataRecovery",
...
func (j *jsiiProxy_CfnPolicy) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnPolicy) MultiAz() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"multiAz",
...
func (j *jsiiProxy_CfnPolicy) MultiRegion() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"multiRegion",
...
func (j *jsiiProxy_CfnPolicy) PolicyRef() *interfacesawsresiliencehubv2.PolicyReference {
	var returns *interfacesawsresiliencehubv2.PolicyReference
	_jsii_.Get(
		j,
		"policyRef",
		&returns,
...
func (j *jsiiProxy_CfnPolicy)SetAvailabilitySlo(val interface{}) {
	if err := j.validateSetAvailabilitySloParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPolicy)SetDataRecovery(val interface{}) {
	if err := j.validateSetDataRecoveryParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPolicy)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnPolicy)SetMultiAz(val interface{}) {
...
func (j *jsiiProxy_CfnPolicy)SetMultiRegion(val interface{}) {
...
func CfnPolicy_ArnForPolicy(resource interfacesawsresiliencehubv2.IPolicyRef) *string {
	_init_.Initialize()
