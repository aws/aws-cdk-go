...
//
//   cfnService := awscdk.Aws_resiliencehubv2.NewCfnService(this, jsii.String("MyCfnService"), &CfnServiceProps{
...
type CfnService interface {
	...
	ServiceRef() *interfacesawsresiliencehubv2.ServiceReference
...
type jsiiProxy_CfnService struct {
	...
	internal.Type__interfacesawsresiliencehubv2IServiceRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnService) Assertions() interface{} {
...
func (j *jsiiProxy_CfnService) AssociatedSystems() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"associatedSystems",
...
func (j *jsiiProxy_CfnService) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnService) AttrEffectivePolicyValues() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrEffectivePolicyValues",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnService) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnService) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnService) DependencyDiscovery() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dependencyDiscovery",
...
func (j *jsiiProxy_CfnService) InputSources() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"inputSources",
...
func (j *jsiiProxy_CfnService) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnService) PermissionModel() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"permissionModel",
...
func (j *jsiiProxy_CfnService) PolicyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyArn",
...
func (j *jsiiProxy_CfnService) Regions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regions",
...
func (j *jsiiProxy_CfnService) ReportConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"reportConfiguration",
...
func (j *jsiiProxy_CfnService) ServiceRef() *interfacesawsresiliencehubv2.ServiceReference {
	var returns *interfacesawsresiliencehubv2.ServiceReference
	_jsii_.Get(
		j,
		"serviceRef",
		&returns,
...
func (j *jsiiProxy_CfnService)SetAssertions(val interface{}) {
	if err := j.validateSetAssertionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnService)SetAssociatedSystems(val interface{}) {
	if err := j.validateSetAssociatedSystemsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnService)SetDependencyDiscovery(val *string) {
	_jsii_.Set(
		j,
		"dependencyDiscovery",
		val,
...
func (j *jsiiProxy_CfnService)SetInputSources(val interface{}) {
	if err := j.validateSetInputSourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnService)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnService)SetPermissionModel(val interface{}) {
...
func (j *jsiiProxy_CfnService)SetPolicyArn(val *string) {
	_jsii_.Set(
		j,
		"policyArn",
		val,
...
func (j *jsiiProxy_CfnService)SetRegions(val *[]*string) {
...
func (j *jsiiProxy_CfnService)SetReportConfiguration(val interface{}) {
...
func CfnService_ArnForService(resource interfacesawsresiliencehubv2.IServiceRef) *string {
	_init_.Initialize()
...
func CfnService_IsCfnService(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnService_IsCfnServiceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnService) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnService) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnService) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
