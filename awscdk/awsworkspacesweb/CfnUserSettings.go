...
func (j *jsiiProxy_CfnUserSettings) CfnPropertyNames() *map[string]*string {
...
func CfnUserSettings_IsCfnUserSettings(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserSettings_IsCfnUserSettingsParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserSettings) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserSettings) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserSettings) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserSettings) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
