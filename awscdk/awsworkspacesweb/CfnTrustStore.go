...
func (j *jsiiProxy_CfnTrustStore) AttrTrustStoreArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTrustStoreArn",
...
func (j *jsiiProxy_CfnTrustStore) CertificateList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"certificateList",
...
func (j *jsiiProxy_CfnTrustStore) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTrustStore) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTrustStore) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrustStore) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTrustStore) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTrustStore) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTrustStore) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTrustStore) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTrustStore) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTrustStore) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTrustStore) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTrustStore) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTrustStore(scope constructs.Construct, id *string, props *CfnTrustStoreProps) CfnTrustStore {
	...
	if err := validateNewCfnTrustStoreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTrustStore)SetCertificateList(val *[]*string) {
	if err := j.validateSetCertificateListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTrustStore)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnTrustStore_ArnForTrustStore(resource interfacesawsworkspacesweb.ITrustStoreRef) *string {
	_init_.Initialize()
...
func CfnTrustStore_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrustStore_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrustStore_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTrustStore_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrustStore_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrustStore_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrustStore) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTrustStore) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustStore) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustStore) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustStore) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustStore) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTrustStore) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrustStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrustStore) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTrustStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrustStore) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrustStore) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTrustStore) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTrustStore) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrustStore) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTrustStore) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustStore) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTrustStore) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustStore) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTrustStore) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTrustStore) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTrustStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
