...
func (j *jsiiProxy_CfnContactChannel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnContactChannel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnContactChannel(scope constructs.Construct, id *string, props *CfnContactChannelProps) CfnContactChannel {
	...
	if err := validateNewCfnContactChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnContactChannel)SetChannelAddress(val *string) {
	if err := j.validateSetChannelAddressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnContactChannel)SetDeferActivation(val interface{}) {
	if err := j.validateSetDeferActivationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnContactChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnContactChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContactChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnContactChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContactChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnContactChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContactChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContactChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContactChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContactChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnContactChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnContactChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
