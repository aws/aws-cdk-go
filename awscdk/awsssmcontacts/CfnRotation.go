...
func (j *jsiiProxy_CfnRotation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRotation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRotation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRotation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRotation) ContactIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"contactIds",
...
func (j *jsiiProxy_CfnRotation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRotation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRotation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnRotation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRotation) Recurrence() interface{} {
...
func (j *jsiiProxy_CfnRotation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRotation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRotation) StartTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTime",
...
func (j *jsiiProxy_CfnRotation) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRotation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRotation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRotation(scope constructs.Construct, id *string, props *CfnRotationProps) CfnRotation {
	...
	if err := validateNewCfnRotationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnRotation{}
...
func (j *jsiiProxy_CfnRotation)SetContactIds(val *[]*string) {
...
func (j *jsiiProxy_CfnRotation)SetName(val *string) {
...
func (j *jsiiProxy_CfnRotation)SetRecurrence(val interface{}) {
...
func (j *jsiiProxy_CfnRotation)SetStartTime(val *string) {
...
func (j *jsiiProxy_CfnRotation)SetTimeZoneId(val *string) {
...
func CfnRotation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRotation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRotation_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRotation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRotation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRotation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRotation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRotation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRotation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRotation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRotation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRotation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRotation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRotation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRotation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRotation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRotation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRotation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRotation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRotation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRotation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRotation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRotation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRotation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRotation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
