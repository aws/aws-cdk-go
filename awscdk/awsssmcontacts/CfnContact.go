...
func (j *jsiiProxy_CfnContact) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnContact) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnContact) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnContact) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnContact(scope constructs.Construct, id *string, props *CfnContactProps) CfnContact {
	...
	if err := validateNewCfnContactParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnContact)SetTags(val *[]*awscdk.CfnTag) {
...
// Checks whether the given object is a CfnContact.
func CfnContact_IsCfnContact(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnContact_IsCfnContactParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContact_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnContact_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContact_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnContact_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContact) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContact) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContact) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContact) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContact) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnContact) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnContact) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContact) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContact) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContact) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
