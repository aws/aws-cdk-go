...
func (j *jsiiProxy_CfnCustomLineItem) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCustomLineItem) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomLineItem) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomLineItem) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomLineItem) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomLineItem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
