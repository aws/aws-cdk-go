...
func (j *jsiiProxy_CfnBillingGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBillingGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBillingGroup(scope constructs.Construct, id *string, props *CfnBillingGroupProps) CfnBillingGroup {
	...
	if err := validateNewCfnBillingGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBillingGroup)SetAccountGrouping(val interface{}) {
	if err := j.validateSetAccountGroupingParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnBillingGroup)SetComputationPreference(val interface{}) {
	if err := j.validateSetComputationPreferenceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBillingGroup_IsCfnBillingGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBillingGroup_IsCfnBillingGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBillingGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBillingGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBillingGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBillingGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBillingGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBillingGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBillingGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBillingGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBillingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBillingGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBillingGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBillingGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBillingGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBillingGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBillingGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBillingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
