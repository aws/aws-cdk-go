...
func (j *jsiiProxy_CfnPricingRule) CfnPropertyNames() *map[string]*string {
...
func CfnPricingRule_IsCfnPricingRule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPricingRule_IsCfnPricingRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPricingRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPricingRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPricingRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPricingRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPricingRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPricingRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
