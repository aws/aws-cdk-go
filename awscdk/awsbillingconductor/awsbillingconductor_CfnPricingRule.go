...
func (j *jsiiProxy_CfnPricingRule) BillingEntity() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingEntity",
...
func (j *jsiiProxy_CfnPricingRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPricingRule(scope constructs.Construct, id *string, props *CfnPricingRuleProps) CfnPricingRule {
	...
	if err := validateNewCfnPricingRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPricingRule)SetBillingEntity(val *string) {
	_jsii_.Set(
		j,
		"billingEntity",
		val,
...
func (j *jsiiProxy_CfnPricingRule)SetTiering(val interface{}) {
	if err := j.validateSetTieringParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPricingRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPricingRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPricingRule_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPricingRule_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPricingRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPricingRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPricingRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPricingRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPricingRule) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPricingRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
