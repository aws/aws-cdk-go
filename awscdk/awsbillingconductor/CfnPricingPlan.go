...
func (j *jsiiProxy_CfnPricingPlan) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPricingPlan) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPricingPlan(scope constructs.Construct, id *string, props *CfnPricingPlanProps) CfnPricingPlan {
	...
	if err := validateNewCfnPricingPlanParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPricingPlan_ArnForPricingPlan(resource interfacesawsbillingconductor.IPricingPlanRef) *string {
	_init_.Initialize()

	if err := validateCfnPricingPlan_ArnForPricingPlanParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPricingPlan_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPricingPlan_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPricingPlan_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPricingPlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPricingPlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPricingPlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPricingPlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingPlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPricingPlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPricingPlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPricingPlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPricingPlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPricingPlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingPlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingPlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPricingPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
