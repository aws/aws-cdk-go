...
func (j *jsiiProxy_CfnIdentitySource) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnIdentitySource) AttrIdentitySourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIdentitySource) AttrIdentitySourceParametersIamIdentityCenterApprovalPortalUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentitySourceParametersIamIdentityCenterApprovalPortalUrl",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnIdentitySource) AttrIdentitySourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentitySourceType",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnIdentitySource) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnIdentitySource) AttrStatusCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusCode",
...
func (j *jsiiProxy_CfnIdentitySource) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnIdentitySource) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnIdentitySource) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdentitySource) IdentitySourceParameters() interface{} {
...
func (j *jsiiProxy_CfnIdentitySource) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnIdentitySource)SetIdentitySourceParameters(val interface{}) {
	if err := j.validateSetIdentitySourceParametersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIdentitySource)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnIdentitySource_IsCfnIdentitySource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIdentitySource_IsCfnIdentitySourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentitySource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdentitySource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdentitySource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdentitySource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentitySource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
