...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3outposts.CfnBucket.FilterAndOperatorProperty",
		reflect.TypeOf((*CfnBucket_FilterAndOperatorProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_s3outposts.CfnBucket.FilterProperty",
		reflect.TypeOf((*CfnBucket_FilterProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_s3outposts.CfnBucket.FilterTagProperty",
