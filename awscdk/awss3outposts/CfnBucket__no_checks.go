...
func validateCfnBucket_ArnForBucketParameters(resource interfacesawss3outposts.IBucketRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnBucket) validateSetBucketNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_CfnBucket) validateSetOutpostIdParameters(val *string) error {
	return nil
}
