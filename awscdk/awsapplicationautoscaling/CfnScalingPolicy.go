...
func (j *jsiiProxy_CfnScalingPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScalingPolicy) PredictiveScalingPolicyConfiguration() interface{} {
...
func (j *jsiiProxy_CfnScalingPolicy)SetPredictiveScalingPolicyConfiguration(val interface{}) {
	if err := j.validateSetPredictiveScalingPolicyConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnScalingPolicy_ArnForScalingPolicy(resource interfacesawsapplicationautoscaling.IScalingPolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnScalingPolicy_ArnForScalingPolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnScalingPolicy_IsCfnScalingPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScalingPolicy_IsCfnScalingPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScalingPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScalingPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScalingPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScalingPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
