...
func (j *jsiiProxy_ScalableTarget) Env() *interfaces.ResourceEnvironment {
...
func ScalableTarget_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_applicationautoscaling.ScalableTarget",
...
func (s *jsiiProxy_ScalableTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
