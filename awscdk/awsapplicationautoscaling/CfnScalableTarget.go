...
func (j *jsiiProxy_CfnScalableTarget) CfnPropertyNames() *map[string]*string {
...
func CfnScalableTarget_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScalableTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScalableTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalableTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScalableTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScalableTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScalableTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScalableTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScalableTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalableTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalableTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalableTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
