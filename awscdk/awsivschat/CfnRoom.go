...
func (j *jsiiProxy_CfnRoom) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRoom) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRoom) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnRoom_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRoom_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRoom) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoom) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRoom) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRoom) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRoom) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRoom) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRoom) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoom) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoom) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoom) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
