...
func (j *jsiiProxy_CfnLoggingConfiguration) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnLoggingConfiguration) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnLoggingConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLoggingConfiguration) DestinationConfiguration() interface{} {
...
func (j *jsiiProxy_CfnLoggingConfiguration) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnLoggingConfiguration) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnLoggingConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnLoggingConfiguration)SetDestinationConfiguration(val interface{}) {
	if err := j.validateSetDestinationConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLoggingConfiguration)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func CfnLoggingConfiguration_ArnForLoggingConfiguration(resource interfacesawsivschat.ILoggingConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnLoggingConfiguration_ArnForLoggingConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnLoggingConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLoggingConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLoggingConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLoggingConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoggingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
