...
func (c *jsiiProxy_CfnTypeActivation) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnTypeActivation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTypeActivation) ObtainResourceDependencies() *[]CfnResource {
...
func (c *jsiiProxy_CfnTypeActivation) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) ReplaceDependency(target CfnResource, newTarget CfnResource) {
