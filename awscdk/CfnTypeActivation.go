...
func (c *jsiiProxy_CfnTypeActivation) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTypeActivation) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnTypeActivation) RemoveResourceDependency(target CfnResource) {
