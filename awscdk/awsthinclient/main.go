...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnSoftwareSet)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrReleasedAt", GoGetter: "AttrReleasedAt"},
			_jsii_.MemberProperty{JsiiProperty: "attrSoftware", GoGetter: "AttrSoftware"},
			_jsii_.MemberProperty{JsiiProperty: "attrValidationStatus", GoGetter: "AttrValidationStatus"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsthinclientISoftwareSetRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_thinclient.CfnSoftwareSet.SoftwareProperty",
		reflect.TypeOf((*CfnSoftwareSet_SoftwareProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_thinclient.CfnSoftwareSetProps",
		reflect.TypeOf((*CfnSoftwareSetProps)(nil)).Elem(),
	)
}
