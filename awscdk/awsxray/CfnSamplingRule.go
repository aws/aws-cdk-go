...
func (j *jsiiProxy_CfnSamplingRule) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSamplingRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSamplingRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSamplingRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSamplingRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSamplingRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
