...
//
type CfnSamplingRule_SamplingRateBoostProperty struct {
	...
	//
	CooldownWindowMinutes *float64 `field:"required" json:"cooldownWindowMinutes" yaml:"cooldownWindowMinutes"`
	...
	//
	MaxRate *float64 `field:"required" json:"maxRate" yaml:"maxRate"`
}
