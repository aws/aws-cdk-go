...
func (j *jsiiProxy_CfnFleet) validateSetConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFleet_FleetConfigurationProperty:
		val := val.(*CfnFleet_FleetConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFleet_FleetConfigurationProperty:
		val_ := val.(CfnFleet_FleetConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFleet_FleetConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFleet) validateSetHostConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFleet_HostConfigurationProperty:
		val := val.(*CfnFleet_HostConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFleet_HostConfigurationProperty:
		val_ := val.(CfnFleet_HostConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFleet_HostConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
