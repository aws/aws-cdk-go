...
func (j *jsiiProxy_CfnFleet) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnFleet) CfnPropertyNames() *map[string]*string {
...
func CfnFleet_IsCfnFleet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFleet_IsCfnFleetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFleet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
