...
func (c *jsiiProxy_CfnQueue) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnQueue) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnQueue) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnQueue) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnQueue_ArnForQueueParameters(resource interfacesawsdeadline.IQueueRef) error {
	if resource == nil {
...
func validateCfnQueue_IsCfnQueueParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateCfnQueue_IsCfnResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnQueue) validateSetDisplayNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnQueue) validateSetJobAttachmentSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnQueue_JobAttachmentSettingsProperty:
		val := val.(*CfnQueue_JobAttachmentSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnQueue_JobAttachmentSettingsProperty:
		val_ := val.(CfnQueue_JobAttachmentSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnQueue_JobAttachmentSettingsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnQueue) validateSetJobRunAsUserParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnQueue_JobRunAsUserProperty:
		val := val.(*CfnQueue_JobRunAsUserProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnQueue_JobRunAsUserProperty:
		val_ := val.(CfnQueue_JobRunAsUserProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnQueue_JobRunAsUserProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnQueue) validateSetSchedulingConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnQueue_SchedulingConfigurationProperty:
		val := val.(*CfnQueue_SchedulingConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnQueue_SchedulingConfigurationProperty:
		val_ := val.(CfnQueue_SchedulingConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnQueue_SchedulingConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
