...
func validateCfnFleet_ArnForFleetParameters(resource interfacesawsdeadline.IFleetRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnFleet) validateSetConfigurationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnFleet) validateSetDisplayNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_CfnFleet) validateSetRoleArnParameters(val *string) error {
	return nil
}
