...
//
//   cfnBudget := awscdk.Aws_deadline.NewCfnBudget(this, jsii.String("MyCfnBudget"), &CfnBudgetProps{
//   	Actions: []interface{}{
...
type CfnBudget interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdeadline.IBudgetRef
	awscdk.ITaggableV2
	...
	SetApproximateDollarLimit(val *float64)
	...
	BudgetRef() *interfacesawsdeadline.BudgetReference
	...
	UsageTrackingResource() interface{}
	SetUsageTrackingResource(val interface{})
...
type jsiiProxy_CfnBudget struct {
	...
	internal.Type__interfacesawsdeadlineIBudgetRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnBudget) Actions() interface{} {
...
func (j *jsiiProxy_CfnBudget) ApproximateDollarLimit() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBudget) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnBudget) AttrBudgetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrBudgetId",
...
func (j *jsiiProxy_CfnBudget) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnBudget) BudgetRef() *interfacesawsdeadline.BudgetReference {
	var returns *interfacesawsdeadline.BudgetReference
	_jsii_.Get(
		j,
		"budgetRef",
		&returns,
...
func (j *jsiiProxy_CfnBudget) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnBudget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBudget) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnBudget) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnBudget) FarmId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"farmId",
...
func (j *jsiiProxy_CfnBudget) Schedule() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"schedule",
...
func (j *jsiiProxy_CfnBudget) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnBudget) UsageTrackingResource() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBudget)SetActions(val interface{}) {
...
func (j *jsiiProxy_CfnBudget)SetApproximateDollarLimit(val *float64) {
	if err := j.validateSetApproximateDollarLimitParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnBudget)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnBudget)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnBudget)SetFarmId(val *string) {
...
func (j *jsiiProxy_CfnBudget)SetSchedule(val interface{}) {
...
func (j *jsiiProxy_CfnBudget)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnBudget)SetUsageTrackingResource(val interface{}) {
	if err := j.validateSetUsageTrackingResourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBudget_ArnForBudget(resource interfacesawsdeadline.IBudgetRef) *string {
	_init_.Initialize()

	if err := validateCfnBudget_ArnForBudgetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnBudget_IsCfnBudget(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBudget_IsCfnBudgetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBudget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBudget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBudget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBudget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBudget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
