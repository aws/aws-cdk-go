...
func (j *jsiiProxy_CfnQueueFleetAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnQueueFleetAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnQueueFleetAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) FarmId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"farmId",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) FleetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fleetId",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnQueueFleetAssociation) QueueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueId",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnQueueFleetAssociation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnQueueFleetAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnQueueFleetAssociation(scope constructs.Construct, id *string, props *CfnQueueFleetAssociationProps) CfnQueueFleetAssociation {
	...
	if err := validateNewCfnQueueFleetAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnQueueFleetAssociation)SetFarmId(val *string) {
...
func (j *jsiiProxy_CfnQueueFleetAssociation)SetFleetId(val *string) {
...
func (j *jsiiProxy_CfnQueueFleetAssociation)SetQueueId(val *string) {
...
func CfnQueueFleetAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnQueueFleetAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueueFleetAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnQueueFleetAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueueFleetAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnQueueFleetAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnQueueFleetAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnQueueFleetAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnQueueFleetAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
