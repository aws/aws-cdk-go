...
func (j *jsiiProxy_CfnFarm) AttrFarmId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFarmId",
...
func (j *jsiiProxy_CfnFarm) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnFarm) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnFarm) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFarm) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnFarm) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnFarm) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnFarm) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_CfnFarm) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnFarm) Node() constructs.Node {
...
func (j *jsiiProxy_CfnFarm) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnFarm) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnFarm) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFarm(scope constructs.Construct, id *string, props *CfnFarmProps) CfnFarm {
	...
	if err := validateNewCfnFarmParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnFarm{}
...
func (j *jsiiProxy_CfnFarm)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnFarm)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnFarm)SetKmsKeyArn(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyArn",
		val,
...
func CfnFarm_ArnForFarm(resource interfacesawsdeadline.IFarmRef) *string {
	_init_.Initialize()

	if err := validateCfnFarm_ArnForFarmParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFarm_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFarm_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFarm_IsCfnFarm(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFarm_IsCfnFarmParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFarm_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFarm_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFarm_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFarm_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFarm) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnFarm) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFarm) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFarm) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnFarm) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnFarm) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnFarm) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnFarm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFarm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFarm) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnFarm) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFarm) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFarm) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnFarm) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnFarm) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFarm) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnFarm) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFarm) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFarm) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnFarm) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFarm) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnFarm) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnFarm) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnFarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
