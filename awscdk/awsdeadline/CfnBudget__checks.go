...
func (j *jsiiProxy_CfnBudget) validateSetActionsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnBudget_BudgetActionToAddProperty:
				v := v.(*CfnBudget_BudgetActionToAddProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnBudget_BudgetActionToAddProperty:
				v_ := v.(CfnBudget_BudgetActionToAddProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnBudget_BudgetActionToAddProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnBudget) validateSetScheduleParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnBudget_BudgetScheduleProperty:
		val := val.(*CfnBudget_BudgetScheduleProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnBudget_BudgetScheduleProperty:
		val_ := val.(CfnBudget_BudgetScheduleProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnBudget_BudgetScheduleProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnBudget) validateSetUsageTrackingResourceParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnBudget_UsageTrackingResourceProperty:
		val := val.(*CfnBudget_UsageTrackingResourceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnBudget_UsageTrackingResourceProperty:
		val_ := val.(CfnBudget_UsageTrackingResourceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnBudget_UsageTrackingResourceProperty; received %#v (a %T)", val, val)
		}
	}
