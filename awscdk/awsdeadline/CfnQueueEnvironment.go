...
func (j *jsiiProxy_CfnQueueEnvironment) AttrQueueEnvironmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnQueueEnvironment) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnQueueEnvironment) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnQueueEnvironment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnQueueEnvironment) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnQueueEnvironment) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnQueueEnvironment) FarmId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"farmId",
...
func (j *jsiiProxy_CfnQueueEnvironment) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnQueueEnvironment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnQueueEnvironment) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_CfnQueueEnvironment) QueueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queueId",
...
func (j *jsiiProxy_CfnQueueEnvironment) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnQueueEnvironment) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnQueueEnvironment) Template() *string {
	var returns *string
	_jsii_.Get(
		j,
		"template",
...
func (j *jsiiProxy_CfnQueueEnvironment) TemplateType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateType",
...
func (j *jsiiProxy_CfnQueueEnvironment) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnQueueEnvironment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnQueueEnvironment(scope constructs.Construct, id *string, props *CfnQueueEnvironmentProps) CfnQueueEnvironment {
	...
	if err := validateNewCfnQueueEnvironmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnQueueEnvironment)SetFarmId(val *string) {
...
func (j *jsiiProxy_CfnQueueEnvironment)SetPriority(val *float64) {
...
func (j *jsiiProxy_CfnQueueEnvironment)SetQueueId(val *string) {
...
func (j *jsiiProxy_CfnQueueEnvironment)SetTemplate(val *string) {
...
func (j *jsiiProxy_CfnQueueEnvironment)SetTemplateType(val *string) {
...
func CfnQueueEnvironment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnQueueEnvironment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueueEnvironment_IsCfnQueueEnvironment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnQueueEnvironment_IsCfnQueueEnvironmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueueEnvironment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnQueueEnvironment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueueEnvironment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnQueueEnvironment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueueEnvironment) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnQueueEnvironment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQueueEnvironment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQueueEnvironment) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnQueueEnvironment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQueueEnvironment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnQueueEnvironment) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnQueueEnvironment) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnQueueEnvironment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnQueueEnvironment) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnQueueEnvironment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueEnvironment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueEnvironment) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnQueueEnvironment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueueEnvironment) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnQueueEnvironment) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnQueueEnvironment) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnQueueEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
