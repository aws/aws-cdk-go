...
//
type CfnQueue_SchedulingMaxPriorityOverrideProperty struct {
	...
	//
	AlwaysScheduleFirst interface{} `field:"required" json:"alwaysScheduleFirst" yaml:"alwaysScheduleFirst"`
}
