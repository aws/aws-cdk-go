...
func (j *jsiiProxy_CfnMeteredProduct) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMeteredProduct) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMeteredProduct) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMeteredProduct) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMeteredProduct) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMeteredProduct) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMeteredProduct) ProductId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"productId",
...
func (j *jsiiProxy_CfnMeteredProduct) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMeteredProduct) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMeteredProduct) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMeteredProduct) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMeteredProduct(scope constructs.Construct, id *string, props *CfnMeteredProductProps) CfnMeteredProduct {
	...
	if err := validateNewCfnMeteredProductParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMeteredProduct_ArnForMeteredProduct(resource interfacesawsdeadline.IMeteredProductRef) *string {
	_init_.Initialize()

	if err := validateCfnMeteredProduct_ArnForMeteredProductParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMeteredProduct_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMeteredProduct_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMeteredProduct_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMeteredProduct_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMeteredProduct_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMeteredProduct_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMeteredProduct) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMeteredProduct) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMeteredProduct) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMeteredProduct) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMeteredProduct) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMeteredProduct) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMeteredProduct) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMeteredProduct) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMeteredProduct) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMeteredProduct) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMeteredProduct) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMeteredProduct) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMeteredProduct) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMeteredProduct) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMeteredProduct) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMeteredProduct) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMeteredProduct) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMeteredProduct) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
