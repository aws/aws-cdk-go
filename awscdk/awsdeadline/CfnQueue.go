...
func (j *jsiiProxy_CfnQueue) AttrQueueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrQueueId",
...
func (j *jsiiProxy_CfnQueue) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnQueue) DefaultBudgetAction() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultBudgetAction",
...
func (j *jsiiProxy_CfnQueue) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnQueue) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnQueue) FarmId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"farmId",
...
func (j *jsiiProxy_CfnQueue) JobAttachmentSettings() interface{} {
...
func (j *jsiiProxy_CfnQueue) JobRunAsUser() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"jobRunAsUser",
...
func (j *jsiiProxy_CfnQueue) RequiredFileSystemLocationNames() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnQueue) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnQueue)SetAllowedStorageProfileIds(val *[]*string) {
	_jsii_.Set(
		j,
		"allowedStorageProfileIds",
		val,
...
func (j *jsiiProxy_CfnQueue)SetDefaultBudgetAction(val *string) {
	_jsii_.Set(
		j,
		"defaultBudgetAction",
		val,
...
func (j *jsiiProxy_CfnQueue)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnQueue)SetDisplayName(val *string) {
...
func (j *jsiiProxy_CfnQueue)SetJobAttachmentSettings(val interface{}) {
	if err := j.validateSetJobAttachmentSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnQueue)SetJobRunAsUser(val interface{}) {
	if err := j.validateSetJobRunAsUserParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnQueue)SetRequiredFileSystemLocationNames(val *[]*string) {
	_jsii_.Set(
		j,
		"requiredFileSystemLocationNames",
		val,
...
func (j *jsiiProxy_CfnQueue)SetRoleArn(val *string) {
	_jsii_.Set(
		j,
		"roleArn",
		val,
...
func CfnQueue_IsCfnQueue(x interface{}) *bool {
	...
	if err := validateCfnQueue_IsCfnQueueParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueue) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQueue) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQueue) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQueue) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
