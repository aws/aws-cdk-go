...
func (j *jsiiProxy_CfnBranch) CfnPropertyNames() *map[string]*string {
...
func CfnBranch_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBranch_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBranch) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBranch) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBranch) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBranch) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBranch) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
