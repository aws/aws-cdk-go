...
func (c *jsiiProxy_CfnDomain) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnDomain) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnDomain) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnDomain_ArnForDomainParameters(resource interfacesawsamplify.IDomainRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDomain) validateSetAppIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDomain) validateSetCertificateSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDomain_CertificateSettingsProperty:
		val := val.(*CfnDomain_CertificateSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDomain_CertificateSettingsProperty:
		val_ := val.(CfnDomain_CertificateSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDomain_CertificateSettingsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDomain) validateSetEnableAutoSubDomainParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnDomain) validateSetSubDomainSettingsParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnDomain_SubDomainSettingProperty:
				v_ := v.(CfnDomain_SubDomainSettingProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
