...
//
//   cfnWebhook := awscdk.Aws_amplify.NewCfnWebhook(this, jsii.String("MyCfnWebhook"), &CfnWebhookProps{
...
type CfnWebhook interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsamplify.IWebhookRef
	awscdk.ITaggableV2
	...
	AttrWebhookId() *string
	// The URL of the webhook.
	AttrWebhookUrl() *string
	...
	WebhookRef() *interfacesawsamplify.WebhookReference
...
type jsiiProxy_CfnWebhook struct {
	...
	internal.Type__interfacesawsamplifyIWebhookRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnWebhook) AppId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"appId",
...
func (j *jsiiProxy_CfnWebhook) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnWebhook) AttrWebhookId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWebhookId",
...
func (j *jsiiProxy_CfnWebhook) AttrWebhookUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWebhookUrl",
...
func (j *jsiiProxy_CfnWebhook) BranchName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"branchName",
...
func (j *jsiiProxy_CfnWebhook) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnWebhook) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWebhook) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnWebhook) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnWebhook) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnWebhook) WebhookRef() *interfacesawsamplify.WebhookReference {
	var returns *interfacesawsamplify.WebhookReference
	_jsii_.Get(
		j,
		"webhookRef",
		&returns,
...
func NewCfnWebhook(scope constructs.Construct, id *string, props *CfnWebhookProps) CfnWebhook {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_amplify.CfnWebhook",
...
func (j *jsiiProxy_CfnWebhook)SetAppId(val *string) {
	_jsii_.Set(
		j,
		"appId",
		val,
...
func (j *jsiiProxy_CfnWebhook)SetBranchName(val *string) {
...
func (j *jsiiProxy_CfnWebhook)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnWebhook)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnWebhook_ArnForWebhook(resource interfacesawsamplify.IWebhookRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWebhook) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWebhook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWebhook) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWebhook) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
