...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/amznsdc/internal"
...
//
//   cfnDeployment := awscdk.Amzn_sdc.NewCfnDeployment(this, jsii.String("MyCfnDeployment"), &CfnDeploymentProps{
...
type CfnDeployment interface {
	...
	SetTargetRegionOverride(val *string)
	// Deprecated.
...
func (j *jsiiProxy_CfnDeployment) ConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configName",
...
func (j *jsiiProxy_CfnDeployment) Dimension() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dimension",
...
func (j *jsiiProxy_CfnDeployment) PipelineId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pipelineId",
...
func (j *jsiiProxy_CfnDeployment) S3Bucket() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3Bucket",
...
func (j *jsiiProxy_CfnDeployment) S3Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3Key",
...
func (j *jsiiProxy_CfnDeployment) Stage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stage",
...
func (j *jsiiProxy_CfnDeployment) TargetRegionOverride() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewCfnDeployment(scope constructs.Construct, id *string, props *CfnDeploymentProps) CfnDeployment {
	...
	_jsii_.Create(
		"aws-cdk-lib.amzn_sdc.CfnDeployment",
...
func (j *jsiiProxy_CfnDeployment)SetConfigName(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetDimension(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetPipelineId(val *string) {
	_jsii_.Set(
		j,
		"pipelineId",
		val,
...
func (j *jsiiProxy_CfnDeployment)SetS3Bucket(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetS3Key(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetStage(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetTargetRegionOverride(val *string) {
	_jsii_.Set(
		j,
		"targetRegionOverride",
		val,
...
func (c *jsiiProxy_CfnDeployment) ObtainResourceDependencies() *[]awscdk.CfnResource {
