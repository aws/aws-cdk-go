...
//   })
//
type AssessmentTemplate interface {
	awscdk.Resource
...
// The jsii proxy struct for AssessmentTemplate
type jsiiProxy_AssessmentTemplate struct {
	internal.Type__awscdkResource
}

func (j *jsiiProxy_AssessmentTemplate) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_AssessmentTemplate) Node() constructs.Node {
...
func (j *jsiiProxy_AssessmentTemplate) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_AssessmentTemplate) Stack() awscdk.Stack {
...
func NewAssessmentTemplate(scope constructs.Construct, id *string, props *awscdk.ResourceProps) AssessmentTemplate {
	...
	if err := validateNewAssessmentTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func AssessmentTemplate_FromCfnAssessmentTemplate(scope constructs.Construct, id *string, template CfnAssessmentTemplate) IAssessmentTemplate {
	...
	if err := validateAssessmentTemplate_FromCfnAssessmentTemplateParameters(scope, id, template); err != nil {
		panic(err)
	}
	var returns IAssessmentTemplate

	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_inspector.AssessmentTemplate",
		"fromCfnAssessmentTemplate",
		[]interface{}{scope, id, template},
		&returns,
	)
...
func AssessmentTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateAssessmentTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func AssessmentTemplate_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAssessmentTemplate_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AssessmentTemplate_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAssessmentTemplate_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AssessmentTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AssessmentTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (a *jsiiProxy_AssessmentTemplate) GeneratePhysicalName() *string {
	var returns *string
...
func (a *jsiiProxy_AssessmentTemplate) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (a *jsiiProxy_AssessmentTemplate) GetResourceNameAttribute(nameAttr *string) *string {
...
func (a *jsiiProxy_AssessmentTemplate) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_AssessmentTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
