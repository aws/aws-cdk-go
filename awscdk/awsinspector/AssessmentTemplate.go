...
//
//   assessmentTemplate := awscdk.Aws_inspector.NewAssessmentTemplate(this, jsii.String("MyAssessmentTemplate"), &ResourceProps{
...
func (j *jsiiProxy_AssessmentTemplate) Env() *awscdk.ResourceEnvironment {
