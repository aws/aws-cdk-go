...
func (j *jsiiProxy_CfnAssessmentTemplate) CfnPropertyNames() *map[string]*string {
...
func CfnAssessmentTemplate_ArnForAssessmentTemplate(resource interfacesawsinspector.IAssessmentTemplateRef) *string {
	_init_.Initialize()

	if err := validateCfnAssessmentTemplate_ArnForAssessmentTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAssessmentTemplate_IsCfnAssessmentTemplate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAssessmentTemplate_IsCfnAssessmentTemplateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssessmentTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssessmentTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssessmentTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssessmentTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssessmentTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
