...
func (j *jsiiProxy_CfnAssessmentTarget) CfnPropertyNames() *map[string]*string {
...
func CfnAssessmentTarget_IsCfnAssessmentTarget(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAssessmentTarget_IsCfnAssessmentTargetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAssessmentTarget_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAssessmentTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssessmentTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssessmentTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssessmentTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssessmentTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssessmentTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
