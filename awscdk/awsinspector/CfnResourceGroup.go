...
func (j *jsiiProxy_CfnResourceGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnResourceGroup(scope constructs.Construct, id *string, props *CfnResourceGroupProps) CfnResourceGroup {
	...
	if err := validateNewCfnResourceGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceGroup)SetResourceGroupTags(val interface{}) {
	if err := j.validateSetResourceGroupTagsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResourceGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
