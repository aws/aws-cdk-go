...
func (j *jsiiProxy_NsRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_NsRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func NsRecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateNsRecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func NsRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.NsRecord",
...
func (n *jsiiProxy_NsRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (n *jsiiProxy_NsRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
