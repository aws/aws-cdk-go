...
func (c *jsiiProxy_CfnHostedZone) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHostedZone) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHostedZone) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHostedZone) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnHostedZone) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHostedZone) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
