...
func (j *jsiiProxy_CfnKeySigningKey) CfnPropertyNames() *map[string]*string {
...
func CfnKeySigningKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnKeySigningKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnKeySigningKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnKeySigningKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnKeySigningKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnKeySigningKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeySigningKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
