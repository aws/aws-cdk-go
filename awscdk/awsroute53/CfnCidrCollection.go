...
func (j *jsiiProxy_CfnCidrCollection) CfnPropertyNames() *map[string]*string {
...
func NewCfnCidrCollection(scope constructs.Construct, id *string, props *CfnCidrCollectionProps) CfnCidrCollection {
	...
	if err := validateNewCfnCidrCollectionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCidrCollection_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCidrCollection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCidrCollection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCidrCollection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCidrCollection_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCidrCollection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCidrCollection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCidrCollection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCidrCollection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCidrCollection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCidrCollection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCidrCollection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCidrCollection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCidrCollection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCidrCollection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCidrCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
