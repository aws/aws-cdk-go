...
func (j *jsiiProxy_CfnRecordSetGroup) CfnPropertyNames() *map[string]*string {
...
func CfnRecordSetGroup_IsCfnRecordSetGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRecordSetGroup_IsCfnRecordSetGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecordSetGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRecordSetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecordSetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecordSetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRecordSetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRecordSetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordSetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
