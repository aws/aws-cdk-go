...
func (j *jsiiProxy_RecordSet) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_RecordSet) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func RecordSet_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.RecordSet",
...
func (r *jsiiProxy_RecordSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RecordSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
