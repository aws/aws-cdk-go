...
func (j *jsiiProxy_HealthCheck) Env() *interfaces.ResourceEnvironment {
...
func HealthCheck_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.HealthCheck",
...
func (h *jsiiProxy_HealthCheck) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
