...
func (p *jsiiProxy_PrivateHostedZone) validateEnableDnssecParameters(options *ZoneSigningOptions) error {
	if options == nil {
...
func validatePrivateHostedZone_FromPrivateHostedZoneIdParameters(scope constructs.Construct, id *string, privateHostedZoneId *string) error {
	...
	if privateHostedZoneId == nil {
		return fmt.Errorf("parameter privateHostedZoneId is required, but nil was provided")
	}
