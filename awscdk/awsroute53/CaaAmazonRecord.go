...
func (j *jsiiProxy_CaaAmazonRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CaaAmazonRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func CaaAmazonRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.CaaAmazonRecord",
...
func (c *jsiiProxy_CaaAmazonRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CaaAmazonRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
