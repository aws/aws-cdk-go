...
func (k *jsiiProxy_KeySigningKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (k *jsiiProxy_KeySigningKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
