...
func (j *jsiiProxy_CfnDNSSEC) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDNSSEC) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDNSSEC(scope constructs.Construct, id *string, props *CfnDNSSECProps) CfnDNSSEC {
	...
	if err := validateNewCfnDNSSECParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDNSSEC_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDNSSEC_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDNSSEC_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDNSSEC_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDNSSEC_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDNSSEC_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDNSSEC) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDNSSEC) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDNSSEC) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDNSSEC) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDNSSEC) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDNSSEC) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDNSSEC) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDNSSEC) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDNSSEC) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDNSSEC) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
