...
func (j *jsiiProxy_CfnHealthCheck) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHealthCheck) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnHealthCheck(scope constructs.Construct, id *string, props *CfnHealthCheckProps) CfnHealthCheck {
	...
	if err := validateNewCfnHealthCheckParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnHealthCheck_ArnForHealthCheck(resource interfacesawsroute53.IHealthCheckRef) *string {
	_init_.Initialize()

	if err := validateCfnHealthCheck_ArnForHealthCheckParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnHealthCheck_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnHealthCheck_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnHealthCheck.
func CfnHealthCheck_IsCfnHealthCheck(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnHealthCheck_IsCfnHealthCheckParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHealthCheck_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHealthCheck_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHealthCheck_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnHealthCheck_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHealthCheck) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHealthCheck) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHealthCheck) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHealthCheck) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHealthCheck) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHealthCheck) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHealthCheck) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHealthCheck) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHealthCheck) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHealthCheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
