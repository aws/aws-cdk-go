...
func (j *jsiiProxy_HostedZone) Env() *interfaces.ResourceEnvironment {
...
func HostedZone_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.HostedZone",
...
func (h *jsiiProxy_HostedZone) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
