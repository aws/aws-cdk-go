...
func (j *jsiiProxy_CaaRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CaaRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func CaaRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.CaaRecord",
...
func (c *jsiiProxy_CaaRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CaaRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
