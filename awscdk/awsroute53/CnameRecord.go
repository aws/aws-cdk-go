...
func (j *jsiiProxy_CnameRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CnameRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func CnameRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.CnameRecord",
...
func (c *jsiiProxy_CnameRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
