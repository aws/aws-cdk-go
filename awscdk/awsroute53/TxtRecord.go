...
func (j *jsiiProxy_TxtRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_TxtRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func NewTxtRecord(scope constructs.Construct, id *string, props *TxtRecordProps) TxtRecord {
	...
	if err := validateNewTxtRecordParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func TxtRecord_IsConstruct(x interface{}) *bool {
	...
	if err := validateTxtRecord_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func TxtRecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateTxtRecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func TxtRecord_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateTxtRecord_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func TxtRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.TxtRecord",
...
func (t *jsiiProxy_TxtRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TxtRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
