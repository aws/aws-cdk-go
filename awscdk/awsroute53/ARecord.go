...
func (j *jsiiProxy_ARecord) Env() *interfaces.ResourceEnvironment {
...
func ARecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateARecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ARecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.ARecord",
...
func (a *jsiiProxy_ARecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ARecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
