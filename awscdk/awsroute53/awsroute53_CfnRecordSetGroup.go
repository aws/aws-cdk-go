...
func (j *jsiiProxy_CfnRecordSetGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRecordSetGroup(scope constructs.Construct, id *string, props *CfnRecordSetGroupProps) CfnRecordSetGroup {
	...
	if err := validateNewCfnRecordSetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRecordSetGroup)SetRecordSets(val interface{}) {
	if err := j.validateSetRecordSetsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnRecordSetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRecordSetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecordSetGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnRecordSetGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecordSetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRecordSetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecordSetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordSetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRecordSetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRecordSetGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnRecordSetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordSetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
