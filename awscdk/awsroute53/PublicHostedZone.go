...
func (j *jsiiProxy_PublicHostedZone) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_PublicHostedZone) Grants() HostedZoneGrants {
...
func (j *jsiiProxy_PublicHostedZone) HostedZoneRef() *interfacesawsroute53.HostedZoneReference {
...
func (j *jsiiProxy_PublicHostedZone) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func PublicHostedZone_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePublicHostedZone_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PublicHostedZone_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.PublicHostedZone",
...
func (p *jsiiProxy_PublicHostedZone) EnableDnssec(options *ZoneSigningOptions) IKeySigningKey {
...
func (p *jsiiProxy_PublicHostedZone) GrantDelegation(grantee awsiam.IGrantable, options *GrantDelegationOptions) awsiam.Grant {
...
func (p *jsiiProxy_PublicHostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
