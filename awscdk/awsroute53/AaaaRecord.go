...
func (j *jsiiProxy_AaaaRecord) Env() *interfaces.ResourceEnvironment {
...
func AaaaRecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAaaaRecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AaaaRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.AaaaRecord",
...
func (a *jsiiProxy_AaaaRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AaaaRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
