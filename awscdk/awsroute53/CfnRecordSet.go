...
func (j *jsiiProxy_CfnRecordSet) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnRecordSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecordSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRecordSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRecordSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
