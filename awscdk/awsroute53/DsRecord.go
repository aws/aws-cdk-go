...
func (j *jsiiProxy_DsRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DsRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func DsRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.DsRecord",
...
func (d *jsiiProxy_DsRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DsRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
