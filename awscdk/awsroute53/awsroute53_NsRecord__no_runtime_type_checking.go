...
func (n *jsiiProxy_NsRecord) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	return nil
}

func (n *jsiiProxy_NsRecord) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateNsRecord_IsResourceParameters(construct awscdk.IConstruct) error {
	return nil
}
