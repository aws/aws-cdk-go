...
func (j *jsiiProxy_ZoneDelegationRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ZoneDelegationRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func (z *jsiiProxy_ZoneDelegationRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
	if err := z.validateApplyCrossStackReferenceStrengthParameters(strength); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		z,
...
func (z *jsiiProxy_ZoneDelegationRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
