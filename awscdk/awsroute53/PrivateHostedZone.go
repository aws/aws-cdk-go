...
func (j *jsiiProxy_PrivateHostedZone) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_PrivateHostedZone) Grants() HostedZoneGrants {
...
func (j *jsiiProxy_PrivateHostedZone) HostedZoneRef() *interfacesawsroute53.HostedZoneReference {
...
func (j *jsiiProxy_PrivateHostedZone) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func PrivateHostedZone_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.PrivateHostedZone",
...
func (p *jsiiProxy_PrivateHostedZone) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PrivateHostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
