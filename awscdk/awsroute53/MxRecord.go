...
func (j *jsiiProxy_MxRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_MxRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func MxRecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateMxRecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func MxRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.MxRecord",
...
func (m *jsiiProxy_MxRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_MxRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
