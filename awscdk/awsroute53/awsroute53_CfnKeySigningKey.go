...
func (j *jsiiProxy_CfnKeySigningKey) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnKeySigningKey(scope constructs.Construct, id *string, props *CfnKeySigningKeyProps) CfnKeySigningKey {
	...
	if err := validateNewCfnKeySigningKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnKeySigningKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnKeySigningKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeySigningKey_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnKeySigningKey_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeySigningKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnKeySigningKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnKeySigningKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeySigningKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnKeySigningKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnKeySigningKey) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnKeySigningKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeySigningKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
