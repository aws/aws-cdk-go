...
func (j *jsiiProxy_CfnHostedZone) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHostedZone) HostedZoneTagsRaw() *[]*CfnHostedZone_HostedZoneTagProperty {
	var returns *[]*CfnHostedZone_HostedZoneTagProperty
	_jsii_.Get(
		j,
		"hostedZoneTagsRaw",
		&returns,
...
func (j *jsiiProxy_CfnHostedZone)SetHostedZoneTagsRaw(val *[]*CfnHostedZone_HostedZoneTagProperty) {
	if err := j.validateSetHostedZoneTagsRawParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnHostedZone_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHostedZone_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHostedZone) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHostedZone) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHostedZone) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHostedZone) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
