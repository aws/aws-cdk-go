...
//
//   svcbRecordProps := &SvcbRecordProps{
...
type SvcbRecordProps struct {
	...
	//
	CidrRoutingConfig CidrRoutingConfig `field:"optional" json:"cidrRoutingConfig" yaml:"cidrRoutingConfig"`
	...
	// The values.
	Values *[]SvcbRecordValue `field:"required" json:"values" yaml:"values"`
}
