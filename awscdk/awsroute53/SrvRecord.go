...
func (j *jsiiProxy_SrvRecord) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_SrvRecord) RecordSetRef() *interfacesawsroute53.RecordSetReference {
...
func NewSrvRecord(scope constructs.Construct, id *string, props *SrvRecordProps) SrvRecord {
	...
	if err := validateNewSrvRecordParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func SrvRecord_IsConstruct(x interface{}) *bool {
	...
	if err := validateSrvRecord_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SrvRecord_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSrvRecord_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func SrvRecord_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSrvRecord_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func SrvRecord_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_route53.SrvRecord",
...
func (s *jsiiProxy_SrvRecord) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SrvRecord) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
