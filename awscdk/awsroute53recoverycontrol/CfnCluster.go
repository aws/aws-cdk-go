...
type CfnCluster interface {
	...
	ClusterEndpoints() interface{}
	SetClusterEndpoints(val interface{})
...
func (j *jsiiProxy_CfnCluster) ClusterEndpoints() interface{} {
...
func (j *jsiiProxy_CfnCluster)SetClusterEndpoints(val interface{}) {
	if err := j.validateSetClusterEndpointsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
