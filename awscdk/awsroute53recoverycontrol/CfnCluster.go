...
type CfnCluster interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsroute53recoverycontrol.IClusterRef
	awscdk.ITaggable
	...
	ClusterRef() *interfacesawsroute53recoverycontrol.ClusterReference
...
type jsiiProxy_CfnCluster struct {
	...
	internal.Type__interfacesawsroute53recoverycontrolIClusterRef
...
func (j *jsiiProxy_CfnCluster) ClusterRef() *interfacesawsroute53recoverycontrol.ClusterReference {
	var returns *interfacesawsroute53recoverycontrol.ClusterReference
	_jsii_.Get(
		j,
		"clusterRef",
		&returns,
