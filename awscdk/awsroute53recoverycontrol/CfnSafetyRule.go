...
func (j *jsiiProxy_CfnSafetyRule) CfnPropertyNames() *map[string]*string {
...
func CfnSafetyRule_ArnForSafetyRule(resource interfacesawsroute53recoverycontrol.ISafetyRuleRef) *string {
	_init_.Initialize()

	if err := validateCfnSafetyRule_ArnForSafetyRuleParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnSafetyRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSafetyRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSafetyRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSafetyRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSafetyRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSafetyRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSafetyRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
