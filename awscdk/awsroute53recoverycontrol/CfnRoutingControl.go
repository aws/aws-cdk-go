...
func (j *jsiiProxy_CfnRoutingControl) CfnPropertyNames() *map[string]*string {
...
func NewCfnRoutingControl(scope constructs.Construct, id *string, props *CfnRoutingControlProps) CfnRoutingControl {
	...
	if err := validateNewCfnRoutingControlParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRoutingControl_ArnForRoutingControl(resource interfacesawsroute53recoverycontrol.IRoutingControlRef) *string {
	_init_.Initialize()

	if err := validateCfnRoutingControl_ArnForRoutingControlParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRoutingControl_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRoutingControl_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRoutingControl_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRoutingControl_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnRoutingControl.
func CfnRoutingControl_IsCfnRoutingControl(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRoutingControl_IsCfnRoutingControlParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRoutingControl_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRoutingControl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRoutingControl) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoutingControl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRoutingControl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRoutingControl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRoutingControl) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRoutingControl) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRoutingControl) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoutingControl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoutingControl) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoutingControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
