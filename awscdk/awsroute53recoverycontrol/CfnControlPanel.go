...
func (j *jsiiProxy_CfnControlPanel) CfnPropertyNames() *map[string]*string {
...
func CfnControlPanel_ArnForControlPanel(resource interfacesawsroute53recoverycontrol.IControlPanelRef) *string {
	_init_.Initialize()

	if err := validateCfnControlPanel_ArnForControlPanelParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnControlPanel_IsCfnControlPanel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnControlPanel_IsCfnControlPanelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnControlPanel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnControlPanel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnControlPanel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnControlPanel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnControlPanel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnControlPanel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnControlPanel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
