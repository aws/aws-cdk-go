...
func (j *jsiiProxy_CfnStudio) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStudio)SetStudioEncryptionConfiguration(val interface{}) {
	if err := j.validateSetStudioEncryptionConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStudio_IsCfnStudio(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStudio_IsCfnStudioParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStudio) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStudio) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStudio) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStudio) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudio) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
