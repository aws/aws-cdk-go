...
func (j *jsiiProxy_CfnLaunchProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLaunchProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLaunchProfile(scope constructs.Construct, id *string, props *CfnLaunchProfileProps) CfnLaunchProfile {
	...
	if err := validateNewCfnLaunchProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLaunchProfile_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLaunchProfile_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLaunchProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLaunchProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunchProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunchProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunchProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLaunchProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLaunchProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
