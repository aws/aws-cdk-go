...
func (j *jsiiProxy_CfnStreamingImage) AttrEncryptionConfigurationKeyType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnStreamingImage) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStreamingImage) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStreamingImage(scope constructs.Construct, id *string, props *CfnStreamingImageProps) CfnStreamingImage {
	...
	if err := validateNewCfnStreamingImageParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStreamingImage)SetEc2ImageId(val *string) {
	if err := j.validateSetEc2ImageIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStreamingImage_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStreamingImage_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamingImage_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStreamingImage_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamingImage_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStreamingImage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamingImage) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingImage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStreamingImage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStreamingImage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStreamingImage) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStreamingImage) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStreamingImage) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingImage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingImage) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
