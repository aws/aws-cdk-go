...
func (j *jsiiProxy_CfnStudioComponent) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnStudioComponent) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioComponent) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStudioComponent) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStudioComponent) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStudioComponent) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStudioComponent) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStudioComponent) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioComponent) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioComponent) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioComponent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
