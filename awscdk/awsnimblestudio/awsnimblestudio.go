...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_nimblestudio.CfnLaunchProfile.StreamConfigurationSessionBackupProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_nimblestudio.CfnLaunchProfile.VolumeConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_nimblestudio.CfnStreamingImage.StreamingImageEncryptionConfigurationProperty",
