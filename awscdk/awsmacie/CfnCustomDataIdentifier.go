...
func (j *jsiiProxy_CfnCustomDataIdentifier) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
