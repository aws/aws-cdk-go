...
func (j *jsiiProxy_CfnAllowList) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnAllowList) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnAllowList) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAllowList) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAllowList) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAllowList) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAllowList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAllowList) Criteria() interface{} {
...
func (j *jsiiProxy_CfnAllowList) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAllowList) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAllowList) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAllowList) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAllowList) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAllowList) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAllowList) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAllowList) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAllowList(scope constructs.Construct, id *string, props *CfnAllowListProps) CfnAllowList {
	...
	if err := validateNewCfnAllowListParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAllowList{}
...
func (j *jsiiProxy_CfnAllowList)SetCriteria(val interface{}) {
...
func (j *jsiiProxy_CfnAllowList)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAllowList)SetName(val *string) {
...
func CfnAllowList_ArnForAllowList(resource interfacesawsmacie.IAllowListRef) *string {
	_init_.Initialize()

	if err := validateCfnAllowList_ArnForAllowListParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnAllowList.
func CfnAllowList_IsCfnAllowList(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAllowList_IsCfnAllowListParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAllowList_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAllowList_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAllowList_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAllowList_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAllowList_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAllowList_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAllowList) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAllowList) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAllowList) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAllowList) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAllowList) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAllowList) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAllowList) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAllowList) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAllowList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAllowList) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAllowList) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAllowList) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAllowList) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAllowList) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAllowList) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAllowList) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAllowList) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAllowList) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAllowList) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAllowList) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAllowList) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAllowList) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAllowList) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAllowList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
