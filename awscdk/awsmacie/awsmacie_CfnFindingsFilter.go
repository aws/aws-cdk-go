...
func (j *jsiiProxy_CfnFindingsFilter) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFindingsFilter(scope constructs.Construct, id *string, props *CfnFindingsFilterProps) CfnFindingsFilter {
	...
	if err := validateNewCfnFindingsFilterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFindingsFilter)SetFindingCriteria(val interface{}) {
	if err := j.validateSetFindingCriteriaParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFindingsFilter_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFindingsFilter_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFindingsFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFindingsFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFindingsFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingsFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFindingsFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFindingsFilter) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnFindingsFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingsFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
