...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnAllowList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmacieIAllowListRef)
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnAllowList_CriteriaProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnAllowList.S3WordsListProperty",
		reflect.TypeOf((*CfnAllowList_S3WordsListProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnAllowListProps",
		reflect.TypeOf((*CfnAllowListProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_macie.CfnCustomDataIdentifier",
		reflect.TypeOf((*CfnCustomDataIdentifier)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmacieICustomDataIdentifierRef)
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnCustomDataIdentifierProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_macie.CfnFindingsFilter",
		reflect.TypeOf((*CfnFindingsFilter)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrFindingsFilterListItems", GoGetter: "AttrFindingsFilterListItems"},
			_jsii_.MemberProperty{JsiiProperty: "attrId", GoGetter: "AttrId"},
			_jsii_.MemberProperty{JsiiProperty: "cdkTagManager", GoGetter: "CdkTagManager"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmacieIFindingsFilterRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnFindingsFilter.CriterionAdditionalPropertiesProperty",
		reflect.TypeOf((*CfnFindingsFilter_CriterionAdditionalPropertiesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnFindingsFilter.FindingCriteriaProperty",
		reflect.TypeOf((*CfnFindingsFilter_FindingCriteriaProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnFindingsFilter.FindingsFilterListItemProperty",
		reflect.TypeOf((*CfnFindingsFilter_FindingsFilterListItemProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_macie.CfnFindingsFilterProps",
		reflect.TypeOf((*CfnFindingsFilterProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "addPropertyOverride", GoMethod: "AddPropertyOverride"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrAutomatedDiscoveryStatus", GoGetter: "AttrAutomatedDiscoveryStatus"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmacieISessionRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
