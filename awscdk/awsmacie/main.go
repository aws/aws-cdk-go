...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_macie.CfnAllowList.CriteriaProperty",
		reflect.TypeOf((*CfnAllowList_CriteriaProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_macie.CfnAllowList.S3WordsListProperty",
		reflect.TypeOf((*CfnAllowList_S3WordsListProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_macie.CfnAllowListProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_macie.CfnFindingsFilter.CriterionAdditionalPropertiesProperty",
