...
func (j *jsiiProxy_CfnFindingsFilter) CfnPropertyNames() *map[string]*string {
...
func CfnFindingsFilter_ArnForFindingsFilter(resource interfacesawsmacie.IFindingsFilterRef) *string {
	_init_.Initialize()

	if err := validateCfnFindingsFilter_ArnForFindingsFilterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFindingsFilter_IsCfnFindingsFilter(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFindingsFilter_IsCfnFindingsFilterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFindingsFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFindingsFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFindingsFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFindingsFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFindingsFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
