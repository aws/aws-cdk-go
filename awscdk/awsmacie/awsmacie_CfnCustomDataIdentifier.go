...
func (j *jsiiProxy_CfnCustomDataIdentifier) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCustomDataIdentifier(scope constructs.Construct, id *string, props *CfnCustomDataIdentifierProps) CfnCustomDataIdentifier {
	...
	if err := validateNewCfnCustomDataIdentifierParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCustomDataIdentifier_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomDataIdentifier_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomDataIdentifier_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomDataIdentifier_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomDataIdentifier) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomDataIdentifier) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomDataIdentifier) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
