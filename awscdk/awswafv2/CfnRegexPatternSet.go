...
type CfnRegexPatternSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswafv2.IRegexPatternSetRef
	awscdk.ITaggable
	...
	RegexPatternSetRef() *interfacesawswafv2.RegexPatternSetReference
...
type jsiiProxy_CfnRegexPatternSet struct {
	...
	internal.Type__interfacesawswafv2IRegexPatternSetRef
...
func (j *jsiiProxy_CfnRegexPatternSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRegexPatternSet) RegexPatternSetRef() *interfacesawswafv2.RegexPatternSetReference {
	var returns *interfacesawswafv2.RegexPatternSetReference
	_jsii_.Get(
		j,
		"regexPatternSetRef",
		&returns,
...
func (j *jsiiProxy_CfnRegexPatternSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRegexPatternSet(scope constructs.Construct, id *string, props *CfnRegexPatternSetProps) CfnRegexPatternSet {
	...
	if err := validateNewCfnRegexPatternSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRegexPatternSet)SetRegularExpressionList(val *[]*string) {
	if err := j.validateSetRegularExpressionListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnRegexPatternSet_ArnForRegexPatternSet(resource interfacesawswafv2.IRegexPatternSetRef) *string {
	_init_.Initialize()
...
func CfnRegexPatternSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRegexPatternSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegexPatternSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRegexPatternSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRegexPatternSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRegexPatternSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRegexPatternSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegexPatternSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRegexPatternSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRegexPatternSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRegexPatternSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRegexPatternSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRegexPatternSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegexPatternSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegexPatternSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRegexPatternSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
