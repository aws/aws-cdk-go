...
func (j *jsiiProxy_CfnWebACL) validateSetApplicationConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnWebACL_ApplicationConfigProperty:
		val := val.(*CfnWebACL_ApplicationConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnWebACL_ApplicationConfigProperty:
		val_ := val.(CfnWebACL_ApplicationConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnWebACL_ApplicationConfigProperty; received %#v (a %T)", val, val)
		}
	}
