...
type CfnWebACLAssociation interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawswafv2.IWebACLAssociationRef
	...
	WebAclAssociationRef() *interfacesawswafv2.WebACLAssociationReference
...
type jsiiProxy_CfnWebACLAssociation struct {
	...
	internal.Type__interfacesawswafv2IWebACLAssociationRef
}
...
func (j *jsiiProxy_CfnWebACLAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWebACLAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnWebACLAssociation) WebAclAssociationRef() *interfacesawswafv2.WebACLAssociationReference {
	var returns *interfacesawswafv2.WebACLAssociationReference
	_jsii_.Get(
		j,
...
func NewCfnWebACLAssociation(scope constructs.Construct, id *string, props *CfnWebACLAssociationProps) CfnWebACLAssociation {
	...
	if err := validateNewCfnWebACLAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnWebACLAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnWebACLAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebACLAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWebACLAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebACLAssociation_IsCfnWebACLAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWebACLAssociation_IsCfnWebACLAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebACLAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnWebACLAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWebACLAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebACLAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWebACLAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWebACLAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWebACLAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWebACLAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWebACLAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebACLAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebACLAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebACLAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
