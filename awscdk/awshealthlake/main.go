...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfile",
		reflect.TypeOf((*CfnDataTransformationProfile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrTargetFormat", GoGetter: "AttrTargetFormat"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dataTransformationProfileRef", GoGetter: "DataTransformationProfileRef"},
		...
		func() interface{} {
			j := jsiiProxy_CfnDataTransformationProfile{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawshealthlakeIDataTransformationProfileRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfile.ExistingVersionedProfileSourceProperty",
		reflect.TypeOf((*CfnDataTransformationProfile_ExistingVersionedProfileSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfile.ProfileMappingSourceProperty",
		reflect.TypeOf((*CfnDataTransformationProfile_ProfileMappingSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfile.SourceProperty",
		reflect.TypeOf((*CfnDataTransformationProfile_SourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfile.StarterProfileSourceProperty",
		reflect.TypeOf((*CfnDataTransformationProfile_StarterProfileSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_healthlake.CfnDataTransformationProfileProps",
		reflect.TypeOf((*CfnDataTransformationProfileProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
