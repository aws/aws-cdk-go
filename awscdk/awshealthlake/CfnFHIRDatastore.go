...
func (j *jsiiProxy_CfnFHIRDatastore) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnFHIRDatastore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFHIRDatastore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFHIRDatastore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFHIRDatastore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFHIRDatastore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
