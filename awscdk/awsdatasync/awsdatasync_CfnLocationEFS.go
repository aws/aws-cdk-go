...
func (c *jsiiProxy_CfnLocationEFS) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationEFS) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationEFS) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationEFS) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLocationEFS) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationEFS) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
