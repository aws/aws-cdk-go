...
func (j *jsiiProxy_CfnLocationFSxOpenZFS) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLocationFSxOpenZFS) Node() constructs.Node {
...
func NewCfnLocationFSxOpenZFS(scope constructs.Construct, id *string, props *CfnLocationFSxOpenZFSProps) CfnLocationFSxOpenZFS {
	...
	if err := validateNewCfnLocationFSxOpenZFSParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLocationFSxOpenZFS_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxOpenZFS_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxOpenZFS_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxOpenZFS_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxOpenZFS_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxOpenZFS_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxOpenZFS) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
