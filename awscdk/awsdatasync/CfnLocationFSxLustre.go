...
func (j *jsiiProxy_CfnLocationFSxLustre) CfnPropertyNames() *map[string]*string {
...
func NewCfnLocationFSxLustre(scope constructs.Construct, id *string, props *CfnLocationFSxLustreProps) CfnLocationFSxLustre {
	...
	if err := validateNewCfnLocationFSxLustreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLocationFSxLustre_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxLustre_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxLustre_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxLustre_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxLustre_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxLustre_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationFSxLustre) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationFSxLustre) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationFSxLustre) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationFSxLustre) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxLustre) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
