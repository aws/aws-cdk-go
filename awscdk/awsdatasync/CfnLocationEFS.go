...
func (j *jsiiProxy_CfnLocationEFS) CfnPropertyNames() *map[string]*string {
...
func CfnLocationEFS_IsCfnLocationEFS(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLocationEFS_IsCfnLocationEFSParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationEFS_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLocationEFS_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationEFS) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationEFS) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationEFS) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationEFS) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationEFS) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
