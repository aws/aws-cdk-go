...
func (j *jsiiProxy_CfnLocationSMB) AttrCmkSecretConfigSecretArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLocationSMB) AttrManagedSecretConfig() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnLocationSMB) CmkSecretConfig() interface{} {
...
func (j *jsiiProxy_CfnLocationSMB) CustomSecretConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customSecretConfig",
...
func (j *jsiiProxy_CfnLocationSMB)SetCmkSecretConfig(val interface{}) {
...
func (j *jsiiProxy_CfnLocationSMB)SetCustomSecretConfig(val interface{}) {
