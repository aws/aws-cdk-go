...
func (j *jsiiProxy_CfnLocationNFS) CfnPropertyNames() *map[string]*string {
...
func NewCfnLocationNFS(scope constructs.Construct, id *string, props *CfnLocationNFSProps) CfnLocationNFS {
	...
	if err := validateNewCfnLocationNFSParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLocationNFS)SetOnPremConfig(val interface{}) {
	if err := j.validateSetOnPremConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnLocationNFS_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationNFS_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationNFS_IsCfnLocationNFS(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLocationNFS_IsCfnLocationNFSParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationNFS_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLocationNFS_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationNFS_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationNFS_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationNFS) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationNFS) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationNFS) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationNFS) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationNFS) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationNFS) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationNFS) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationNFS) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationNFS) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationNFS) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
