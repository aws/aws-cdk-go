...
func (j *jsiiProxy_CfnLocationFSxWindows) CfnPropertyNames() *map[string]*string {
...
func NewCfnLocationFSxWindows(scope constructs.Construct, id *string, props *CfnLocationFSxWindowsProps) CfnLocationFSxWindows {
	...
	if err := validateNewCfnLocationFSxWindowsParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLocationFSxWindows_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxWindows_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxWindows_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxWindows_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxWindows_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxWindows_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationFSxWindows) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationFSxWindows) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationFSxWindows) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationFSxWindows) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxWindows) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
