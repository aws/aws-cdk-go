...
func (j *jsiiProxy_CfnLocationFSxONTAP) AttrFsxFilesystemArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLocationFSxONTAP) AttrLocationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLocationArn",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) AttrLocationUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLocationUri",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Protocol() interface{} {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) SecurityGroupArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"securityGroupArns",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) StorageVirtualMachineArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Subdirectory() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subdirectory",
...
func (j *jsiiProxy_CfnLocationFSxONTAP) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnLocationFSxONTAP) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func NewCfnLocationFSxONTAP(scope constructs.Construct, id *string, props *CfnLocationFSxONTAPProps) CfnLocationFSxONTAP {
	...
	if err := validateNewCfnLocationFSxONTAPParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLocationFSxONTAP)SetProtocol(val interface{}) {
...
func (j *jsiiProxy_CfnLocationFSxONTAP)SetSecurityGroupArns(val *[]*string) {
...
func (j *jsiiProxy_CfnLocationFSxONTAP)SetStorageVirtualMachineArn(val *string) {
...
func (j *jsiiProxy_CfnLocationFSxONTAP)SetSubdirectory(val *string) {
	_jsii_.Set(
		j,
		"subdirectory",
		val,
...
func (j *jsiiProxy_CfnLocationFSxONTAP)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnLocationFSxONTAP_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxONTAP_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxONTAP_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxONTAP_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationFSxONTAP_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationFSxONTAP_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationFSxONTAP) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnLocationFSxONTAP) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnLocationFSxONTAP) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
