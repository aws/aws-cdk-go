...
func (j *jsiiProxy_CfnLocationObjectStorage) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLocationObjectStorage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationObjectStorage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationObjectStorage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationObjectStorage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationObjectStorage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
