...
func (j *jsiiProxy_CfnLocationS3) CfnPropertyNames() *map[string]*string {
...
func NewCfnLocationS3(scope constructs.Construct, id *string, props *CfnLocationS3Props) CfnLocationS3 {
	...
	if err := validateNewCfnLocationS3Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLocationS3_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocationS3_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationS3_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationS3_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocationS3_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocationS3_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationS3) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationS3) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationS3) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationS3) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationS3) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocationS3) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocationS3) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationS3) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationS3) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationS3) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
