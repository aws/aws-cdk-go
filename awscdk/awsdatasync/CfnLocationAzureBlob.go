...
func (j *jsiiProxy_CfnLocationAzureBlob) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLocationAzureBlob) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationAzureBlob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationAzureBlob) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationAzureBlob) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationAzureBlob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
