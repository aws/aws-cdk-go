...
func (j *jsiiProxy_CfnLocationHDFS) CfnPropertyNames() *map[string]*string {
...
func CfnLocationHDFS_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocationHDFS_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocationHDFS) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocationHDFS) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocationHDFS) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocationHDFS) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocationHDFS) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
