...
func (c *jsiiProxy_CfnTask) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	return nil
}
...
func (c *jsiiProxy_CfnTask) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateCfnTask_IsCfnResourceParameters(construct constructs.IConstruct) error {
	return nil
}
...
func (j *jsiiProxy_CfnTask) validateSetDestinationLocationArnParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnTask) validateSetExcludesParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnTask) validateSetIncludesParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_CfnTask) validateSetScheduleParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnTask) validateSetSourceLocationArnParameters(val *string) error {
	return nil
}

func validateNewCfnTaskParameters(scope awscdk.Construct, id *string, props *CfnTaskProps) error {
	return nil
}
