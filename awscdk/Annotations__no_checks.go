...
func (a *jsiiProxy_Annotations) validateAcknowledgeInfoParameters(id *string) error {
	return nil
}
...
func (a *jsiiProxy_Annotations) validateAddInfoV2Parameters(id *string, message *string) error {
	return nil
}
