...
type CfnAnalysis_GeospatialMapConfigurationProperty struct {
	// `CfnAnalysis.GeospatialMapConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.MapStyleOptions`.
	MapStyleOptions interface{} `field:"optional" json:"mapStyleOptions" yaml:"mapStyleOptions"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.PointStyleOptions`.
	PointStyleOptions interface{} `field:"optional" json:"pointStyleOptions" yaml:"pointStyleOptions"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.VisualPalette`.
	VisualPalette interface{} `field:"optional" json:"visualPalette" yaml:"visualPalette"`
	// `CfnAnalysis.GeospatialMapConfigurationProperty.WindowOptions`.
