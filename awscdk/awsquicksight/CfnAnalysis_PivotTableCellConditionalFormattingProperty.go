...
type CfnAnalysis_PivotTableCellConditionalFormattingProperty struct {
	// `CfnAnalysis.PivotTableCellConditionalFormattingProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnAnalysis.PivotTableCellConditionalFormattingProperty.Scope`.
	Scope interface{} `field:"optional" json:"scope" yaml:"scope"`
	// `CfnAnalysis.PivotTableCellConditionalFormattingProperty.TextFormat`.
