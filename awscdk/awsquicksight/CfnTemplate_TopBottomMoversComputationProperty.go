...
type CfnTemplate_TopBottomMoversComputationProperty struct {
	// `CfnTemplate.TopBottomMoversComputationProperty.Category`.
	Category interface{} `field:"required" json:"category" yaml:"category"`
	// `CfnTemplate.TopBottomMoversComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnTemplate.TopBottomMoversComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnTemplate.TopBottomMoversComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnTemplate.TopBottomMoversComputationProperty.MoverSize`.
	MoverSize *float64 `field:"optional" json:"moverSize" yaml:"moverSize"`
	// `CfnTemplate.TopBottomMoversComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnTemplate.TopBottomMoversComputationProperty.SortOrder`.
	SortOrder *string `field:"optional" json:"sortOrder" yaml:"sortOrder"`
	// `CfnTemplate.TopBottomMoversComputationProperty.Value`.
