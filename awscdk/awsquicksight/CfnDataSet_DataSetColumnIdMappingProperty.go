...
//
type CfnDataSet_DataSetColumnIdMappingProperty struct {
	...
	//
	SourceColumnId *string `field:"required" json:"sourceColumnId" yaml:"sourceColumnId"`
	...
	//
	TargetColumnId *string `field:"required" json:"targetColumnId" yaml:"targetColumnId"`
}
