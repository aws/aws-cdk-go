...
type CfnAnalysis_PieChartAggregatedFieldWellsProperty struct {
	// `CfnAnalysis.PieChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnAnalysis.PieChartAggregatedFieldWellsProperty.SmallMultiples`.
	SmallMultiples interface{} `field:"optional" json:"smallMultiples" yaml:"smallMultiples"`
	// `CfnAnalysis.PieChartAggregatedFieldWellsProperty.Values`.
