...
type CfnTemplate_NumericFormatConfigurationProperty struct {
	// `CfnTemplate.NumericFormatConfigurationProperty.CurrencyDisplayFormatConfiguration`.
	...
	// `CfnTemplate.NumericFormatConfigurationProperty.NumberDisplayFormatConfiguration`.
	...
	// `CfnTemplate.NumericFormatConfigurationProperty.PercentageDisplayFormatConfiguration`.
