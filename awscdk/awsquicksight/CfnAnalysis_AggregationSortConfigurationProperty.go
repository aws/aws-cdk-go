...
type CfnAnalysis_AggregationSortConfigurationProperty struct {
	// `CfnAnalysis.AggregationSortConfigurationProperty.AggregationFunction`.
	AggregationFunction interface{} `field:"required" json:"aggregationFunction" yaml:"aggregationFunction"`
	// `CfnAnalysis.AggregationSortConfigurationProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnAnalysis.AggregationSortConfigurationProperty.SortDirection`.
