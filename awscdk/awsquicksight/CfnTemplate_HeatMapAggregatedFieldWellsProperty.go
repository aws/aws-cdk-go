...
type CfnTemplate_HeatMapAggregatedFieldWellsProperty struct {
	// `CfnTemplate.HeatMapAggregatedFieldWellsProperty.Columns`.
	Columns interface{} `field:"optional" json:"columns" yaml:"columns"`
	// `CfnTemplate.HeatMapAggregatedFieldWellsProperty.Rows`.
	Rows interface{} `field:"optional" json:"rows" yaml:"rows"`
	// `CfnTemplate.HeatMapAggregatedFieldWellsProperty.Values`.
