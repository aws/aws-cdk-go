...
type CfnAnalysis_NumericFormatConfigurationProperty struct {
	// `CfnAnalysis.NumericFormatConfigurationProperty.CurrencyDisplayFormatConfiguration`.
	...
	// `CfnAnalysis.NumericFormatConfigurationProperty.NumberDisplayFormatConfiguration`.
	...
	// `CfnAnalysis.NumericFormatConfigurationProperty.PercentageDisplayFormatConfiguration`.
