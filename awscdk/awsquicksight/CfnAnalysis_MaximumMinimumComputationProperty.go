...
type CfnAnalysis_MaximumMinimumComputationProperty struct {
	// `CfnAnalysis.MaximumMinimumComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnAnalysis.MaximumMinimumComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnAnalysis.MaximumMinimumComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnAnalysis.MaximumMinimumComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnAnalysis.MaximumMinimumComputationProperty.Value`.
