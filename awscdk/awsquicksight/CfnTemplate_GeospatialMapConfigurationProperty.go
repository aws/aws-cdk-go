...
type CfnTemplate_GeospatialMapConfigurationProperty struct {
	// `CfnTemplate.GeospatialMapConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.MapStyleOptions`.
	MapStyleOptions interface{} `field:"optional" json:"mapStyleOptions" yaml:"mapStyleOptions"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.PointStyleOptions`.
	PointStyleOptions interface{} `field:"optional" json:"pointStyleOptions" yaml:"pointStyleOptions"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.VisualPalette`.
	VisualPalette interface{} `field:"optional" json:"visualPalette" yaml:"visualPalette"`
	// `CfnTemplate.GeospatialMapConfigurationProperty.WindowOptions`.
