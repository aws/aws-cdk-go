...
type CfnAnalysis_ScatterPlotCategoricallyAggregatedFieldWellsProperty struct {
	// `CfnAnalysis.ScatterPlotCategoricallyAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnAnalysis.ScatterPlotCategoricallyAggregatedFieldWellsProperty.Size`.
	Size interface{} `field:"optional" json:"size" yaml:"size"`
	// `CfnAnalysis.ScatterPlotCategoricallyAggregatedFieldWellsProperty.XAxis`.
	XAxis interface{} `field:"optional" json:"xAxis" yaml:"xAxis"`
	// `CfnAnalysis.ScatterPlotCategoricallyAggregatedFieldWellsProperty.YAxis`.
