...
type CfnDashboard_RadarChartAggregatedFieldWellsProperty struct {
	// `CfnDashboard.RadarChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnDashboard.RadarChartAggregatedFieldWellsProperty.Color`.
	Color interface{} `field:"optional" json:"color" yaml:"color"`
	// `CfnDashboard.RadarChartAggregatedFieldWellsProperty.Values`.
