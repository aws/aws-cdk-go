...
type CfnAnalysis_LegendOptionsProperty struct {
	// `CfnAnalysis.LegendOptionsProperty.Height`.
	Height *string `field:"optional" json:"height" yaml:"height"`
	// `CfnAnalysis.LegendOptionsProperty.Position`.
	Position *string `field:"optional" json:"position" yaml:"position"`
	// `CfnAnalysis.LegendOptionsProperty.Title`.
	Title interface{} `field:"optional" json:"title" yaml:"title"`
	// `CfnAnalysis.LegendOptionsProperty.Visibility`.
	Visibility *string `field:"optional" json:"visibility" yaml:"visibility"`
	// `CfnAnalysis.LegendOptionsProperty.Width`.
