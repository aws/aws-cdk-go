...
type CfnAnalysis_TablePaginatedReportOptionsProperty struct {
	// `CfnAnalysis.TablePaginatedReportOptionsProperty.OverflowColumnHeaderVisibility`.
	...
	// `CfnAnalysis.TablePaginatedReportOptionsProperty.VerticalOverflowVisibility`.
