...
type CfnTemplate_ReferenceLineDynamicDataConfigurationProperty struct {
	// `CfnTemplate.ReferenceLineDynamicDataConfigurationProperty.Calculation`.
	Calculation interface{} `field:"required" json:"calculation" yaml:"calculation"`
	// `CfnTemplate.ReferenceLineDynamicDataConfigurationProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnTemplate.ReferenceLineDynamicDataConfigurationProperty.MeasureAggregationFunction`.
