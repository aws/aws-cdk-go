...
type CfnTemplate_ParameterTextFieldControlProperty struct {
	// `CfnTemplate.ParameterTextFieldControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnTemplate.ParameterTextFieldControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnTemplate.ParameterTextFieldControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnTemplate.ParameterTextFieldControlProperty.DisplayOptions`.
