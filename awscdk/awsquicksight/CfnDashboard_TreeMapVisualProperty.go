...
//
//   treeMapVisualProperty := &TreeMapVisualProperty{
...
//   		},
//   	},
//   	ChartConfiguration: &TreeMapConfigurationProperty{
...
type CfnDashboard_TreeMapVisualProperty struct {
	// `CfnDashboard.TreeMapVisualProperty.VisualId`.
	VisualId *string `field:"required" json:"visualId" yaml:"visualId"`
	// `CfnDashboard.TreeMapVisualProperty.Actions`.
	Actions interface{} `field:"optional" json:"actions" yaml:"actions"`
	// `CfnDashboard.TreeMapVisualProperty.ChartConfiguration`.
	ChartConfiguration interface{} `field:"optional" json:"chartConfiguration" yaml:"chartConfiguration"`
	// `CfnDashboard.TreeMapVisualProperty.ColumnHierarchies`.
	ColumnHierarchies interface{} `field:"optional" json:"columnHierarchies" yaml:"columnHierarchies"`
	// `CfnDashboard.TreeMapVisualProperty.Subtitle`.
	Subtitle interface{} `field:"optional" json:"subtitle" yaml:"subtitle"`
	// `CfnDashboard.TreeMapVisualProperty.Title`.
