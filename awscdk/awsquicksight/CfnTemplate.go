...
func (j *jsiiProxy_CfnTemplate) AttrVersionCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) AttrVersionDataSetConfigurations() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) AttrVersionDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) AttrVersionErrors() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrVersionErrors",
...
func (j *jsiiProxy_CfnTemplate) AttrVersionSheets() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrVersionSheets",
...
func (j *jsiiProxy_CfnTemplate) AttrVersionSourceEntityArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) AttrVersionStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersionStatus",
...
func (j *jsiiProxy_CfnTemplate) AttrVersionThemeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersionThemeArn",
...
func (j *jsiiProxy_CfnTemplate) AttrVersionVersionNumber() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) CfnPropertyNames() *map[string]*string {
...
func CfnTemplate_ArnForTemplate(resource interfacesawsquicksight.ITemplateRef) *string {
	_init_.Initialize()

	if err := validateCfnTemplate_ArnForTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTemplate_IsCfnTemplate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTemplate_IsCfnTemplateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
