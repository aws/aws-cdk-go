...
//
//   comboChartVisualProperty := &ComboChartVisualProperty{
...
//   		},
//   	},
//   	ChartConfiguration: &ComboChartConfigurationProperty{
//   		BarDataLabels: &DataLabelOptionsProperty{
...
//   			Visibility: jsii.String("visibility"),
//   		},
//   		FieldWells: &ComboChartFieldWellsProperty{
//   			ComboChartAggregatedFieldWells: &ComboChartAggregatedFieldWellsProperty{
//   				BarValues: []interface{}{
...
//   		},
//   		LineDataLabels: &DataLabelOptionsProperty{
//   			CategoryLabelVisibility: jsii.String("categoryLabelVisibility"),
//   			DataLabelTypes: []interface{}{
//   				&DataLabelTypeProperty{
//   					DataPathLabelType: &DataPathLabelTypeProperty{
...
//   			},
//   		},
//   		SecondaryYAxisDisplayOptions: &AxisDisplayOptionsProperty{
//   			AxisLineVisibility: jsii.String("axisLineVisibility"),
//   			AxisOffset: jsii.String("axisOffset"),
//   			DataOptions: &AxisDataOptionsProperty{
//   				DateAxisOptions: &DateAxisOptionsProperty{
...
type CfnDashboard_ComboChartVisualProperty struct {
	// `CfnDashboard.ComboChartVisualProperty.VisualId`.
	VisualId *string `field:"required" json:"visualId" yaml:"visualId"`
	// `CfnDashboard.ComboChartVisualProperty.Actions`.
	Actions interface{} `field:"optional" json:"actions" yaml:"actions"`
	// `CfnDashboard.ComboChartVisualProperty.ChartConfiguration`.
	ChartConfiguration interface{} `field:"optional" json:"chartConfiguration" yaml:"chartConfiguration"`
	// `CfnDashboard.ComboChartVisualProperty.ColumnHierarchies`.
	ColumnHierarchies interface{} `field:"optional" json:"columnHierarchies" yaml:"columnHierarchies"`
	// `CfnDashboard.ComboChartVisualProperty.Subtitle`.
	Subtitle interface{} `field:"optional" json:"subtitle" yaml:"subtitle"`
	// `CfnDashboard.ComboChartVisualProperty.Title`.
