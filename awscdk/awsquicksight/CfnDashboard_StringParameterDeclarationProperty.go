...
type CfnDashboard_StringParameterDeclarationProperty struct {
	// `CfnDashboard.StringParameterDeclarationProperty.Name`.
	Name *string `field:"required" json:"name" yaml:"name"`
	// `CfnDashboard.StringParameterDeclarationProperty.ParameterValueType`.
	ParameterValueType *string `field:"required" json:"parameterValueType" yaml:"parameterValueType"`
	// `CfnDashboard.StringParameterDeclarationProperty.DefaultValues`.
	...
	// `CfnDashboard.StringParameterDeclarationProperty.ValueWhenUnset`.
