...
type CfnAnalysis_BarChartSortConfigurationProperty struct {
	// `CfnAnalysis.BarChartSortConfigurationProperty.CategoryItemsLimit`.
	CategoryItemsLimit interface{} `field:"optional" json:"categoryItemsLimit" yaml:"categoryItemsLimit"`
	// `CfnAnalysis.BarChartSortConfigurationProperty.CategorySort`.
	CategorySort interface{} `field:"optional" json:"categorySort" yaml:"categorySort"`
	// `CfnAnalysis.BarChartSortConfigurationProperty.ColorItemsLimit`.
	ColorItemsLimit interface{} `field:"optional" json:"colorItemsLimit" yaml:"colorItemsLimit"`
	// `CfnAnalysis.BarChartSortConfigurationProperty.ColorSort`.
	ColorSort interface{} `field:"optional" json:"colorSort" yaml:"colorSort"`
	// `CfnAnalysis.BarChartSortConfigurationProperty.SmallMultiplesLimitConfiguration`.
	...
	// `CfnAnalysis.BarChartSortConfigurationProperty.SmallMultiplesSort`.
