...
type CfnTemplate_PieChartSortConfigurationProperty struct {
	// `CfnTemplate.PieChartSortConfigurationProperty.CategoryItemsLimit`.
	CategoryItemsLimit interface{} `field:"optional" json:"categoryItemsLimit" yaml:"categoryItemsLimit"`
	// `CfnTemplate.PieChartSortConfigurationProperty.CategorySort`.
	CategorySort interface{} `field:"optional" json:"categorySort" yaml:"categorySort"`
	// `CfnTemplate.PieChartSortConfigurationProperty.SmallMultiplesLimitConfiguration`.
	...
	// `CfnTemplate.PieChartSortConfigurationProperty.SmallMultiplesSort`.
