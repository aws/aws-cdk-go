...
type CfnDashboard_TopBottomRankedComputationProperty struct {
	// `CfnDashboard.TopBottomRankedComputationProperty.Category`.
	Category interface{} `field:"required" json:"category" yaml:"category"`
	// `CfnDashboard.TopBottomRankedComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnDashboard.TopBottomRankedComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnDashboard.TopBottomRankedComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnDashboard.TopBottomRankedComputationProperty.ResultSize`.
	ResultSize *float64 `field:"optional" json:"resultSize" yaml:"resultSize"`
	// `CfnDashboard.TopBottomRankedComputationProperty.Value`.
