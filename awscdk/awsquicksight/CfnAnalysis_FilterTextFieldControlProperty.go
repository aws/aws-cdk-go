...
type CfnAnalysis_FilterTextFieldControlProperty struct {
	// `CfnAnalysis.FilterTextFieldControlProperty.FilterControlId`.
	FilterControlId *string `field:"required" json:"filterControlId" yaml:"filterControlId"`
	// `CfnAnalysis.FilterTextFieldControlProperty.SourceFilterId`.
	SourceFilterId *string `field:"required" json:"sourceFilterId" yaml:"sourceFilterId"`
	// `CfnAnalysis.FilterTextFieldControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnAnalysis.FilterTextFieldControlProperty.DisplayOptions`.
