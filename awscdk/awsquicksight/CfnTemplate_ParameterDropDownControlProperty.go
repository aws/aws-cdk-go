...
type CfnTemplate_ParameterDropDownControlProperty struct {
	// `CfnTemplate.ParameterDropDownControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnTemplate.ParameterDropDownControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnTemplate.ParameterDropDownControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnTemplate.ParameterDropDownControlProperty.CascadingControlConfiguration`.
	...
	// `CfnTemplate.ParameterDropDownControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnTemplate.ParameterDropDownControlProperty.SelectableValues`.
	SelectableValues interface{} `field:"optional" json:"selectableValues" yaml:"selectableValues"`
	// `CfnTemplate.ParameterDropDownControlProperty.Type`.
