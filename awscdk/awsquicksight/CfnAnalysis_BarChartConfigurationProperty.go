...
type CfnAnalysis_BarChartConfigurationProperty struct {
	...
	// `CfnAnalysis.BarChartConfigurationProperty.DataLabels`.
	DataLabels interface{} `field:"optional" json:"dataLabels" yaml:"dataLabels"`
	// `CfnAnalysis.BarChartConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnAnalysis.BarChartConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnAnalysis.BarChartConfigurationProperty.Orientation`.
	Orientation *string `field:"optional" json:"orientation" yaml:"orientation"`
	// `CfnAnalysis.BarChartConfigurationProperty.ReferenceLines`.
	ReferenceLines interface{} `field:"optional" json:"referenceLines" yaml:"referenceLines"`
	// `CfnAnalysis.BarChartConfigurationProperty.SmallMultiplesOptions`.
	SmallMultiplesOptions interface{} `field:"optional" json:"smallMultiplesOptions" yaml:"smallMultiplesOptions"`
	// `CfnAnalysis.BarChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnAnalysis.BarChartConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnAnalysis.BarChartConfigurationProperty.ValueAxis`.
	ValueAxis interface{} `field:"optional" json:"valueAxis" yaml:"valueAxis"`
	// `CfnAnalysis.BarChartConfigurationProperty.ValueLabelOptions`.
	ValueLabelOptions interface{} `field:"optional" json:"valueLabelOptions" yaml:"valueLabelOptions"`
	// `CfnAnalysis.BarChartConfigurationProperty.VisualPalette`.
