...
type CfnAnalysis_LineChartAggregatedFieldWellsProperty struct {
	// `CfnAnalysis.LineChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnAnalysis.LineChartAggregatedFieldWellsProperty.Colors`.
	Colors interface{} `field:"optional" json:"colors" yaml:"colors"`
	// `CfnAnalysis.LineChartAggregatedFieldWellsProperty.SmallMultiples`.
	SmallMultiples interface{} `field:"optional" json:"smallMultiples" yaml:"smallMultiples"`
	// `CfnAnalysis.LineChartAggregatedFieldWellsProperty.Values`.
