...
type CfnDashboard_ParameterDateTimePickerControlProperty struct {
	// `CfnDashboard.ParameterDateTimePickerControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnDashboard.ParameterDateTimePickerControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnDashboard.ParameterDateTimePickerControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnDashboard.ParameterDateTimePickerControlProperty.DisplayOptions`.
