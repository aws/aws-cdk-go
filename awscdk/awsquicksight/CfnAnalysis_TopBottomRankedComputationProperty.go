...
type CfnAnalysis_TopBottomRankedComputationProperty struct {
	// `CfnAnalysis.TopBottomRankedComputationProperty.Category`.
	Category interface{} `field:"required" json:"category" yaml:"category"`
	// `CfnAnalysis.TopBottomRankedComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnAnalysis.TopBottomRankedComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnAnalysis.TopBottomRankedComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnAnalysis.TopBottomRankedComputationProperty.ResultSize`.
	ResultSize *float64 `field:"optional" json:"resultSize" yaml:"resultSize"`
	// `CfnAnalysis.TopBottomRankedComputationProperty.Value`.
