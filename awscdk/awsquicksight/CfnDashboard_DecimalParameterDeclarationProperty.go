...
type CfnDashboard_DecimalParameterDeclarationProperty struct {
	// `CfnDashboard.DecimalParameterDeclarationProperty.Name`.
	Name *string `field:"required" json:"name" yaml:"name"`
	// `CfnDashboard.DecimalParameterDeclarationProperty.ParameterValueType`.
	ParameterValueType *string `field:"required" json:"parameterValueType" yaml:"parameterValueType"`
	// `CfnDashboard.DecimalParameterDeclarationProperty.DefaultValues`.
	...
	// `CfnDashboard.DecimalParameterDeclarationProperty.ValueWhenUnset`.
