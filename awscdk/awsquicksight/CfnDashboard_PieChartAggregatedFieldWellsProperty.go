...
//
//   pieChartAggregatedFieldWellsProperty := &PieChartAggregatedFieldWellsProperty{
//   	Category: []interface{}{
...
type CfnDashboard_PieChartAggregatedFieldWellsProperty struct {
	// `CfnDashboard.PieChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnDashboard.PieChartAggregatedFieldWellsProperty.SmallMultiples`.
	SmallMultiples interface{} `field:"optional" json:"smallMultiples" yaml:"smallMultiples"`
	// `CfnDashboard.PieChartAggregatedFieldWellsProperty.Values`.
