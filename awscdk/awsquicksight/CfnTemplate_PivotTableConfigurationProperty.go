...
type CfnTemplate_PivotTableConfigurationProperty struct {
	// `CfnTemplate.PivotTableConfigurationProperty.FieldOptions`.
	FieldOptions interface{} `field:"optional" json:"fieldOptions" yaml:"fieldOptions"`
	// `CfnTemplate.PivotTableConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnTemplate.PivotTableConfigurationProperty.PaginatedReportOptions`.
	PaginatedReportOptions interface{} `field:"optional" json:"paginatedReportOptions" yaml:"paginatedReportOptions"`
	// `CfnTemplate.PivotTableConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnTemplate.PivotTableConfigurationProperty.TableOptions`.
	TableOptions interface{} `field:"optional" json:"tableOptions" yaml:"tableOptions"`
	// `CfnTemplate.PivotTableConfigurationProperty.TotalOptions`.
