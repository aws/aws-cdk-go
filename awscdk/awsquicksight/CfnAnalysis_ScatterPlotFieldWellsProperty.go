...
type CfnAnalysis_ScatterPlotFieldWellsProperty struct {
	// `CfnAnalysis.ScatterPlotFieldWellsProperty.ScatterPlotCategoricallyAggregatedFieldWells`.
	...
	// `CfnAnalysis.ScatterPlotFieldWellsProperty.ScatterPlotUnaggregatedFieldWells`.
