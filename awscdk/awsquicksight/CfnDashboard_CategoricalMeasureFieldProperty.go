...
type CfnDashboard_CategoricalMeasureFieldProperty struct {
	// `CfnDashboard.CategoricalMeasureFieldProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnDashboard.CategoricalMeasureFieldProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnDashboard.CategoricalMeasureFieldProperty.AggregationFunction`.
	AggregationFunction *string `field:"optional" json:"aggregationFunction" yaml:"aggregationFunction"`
	// `CfnDashboard.CategoricalMeasureFieldProperty.FormatConfiguration`.
