...
func (j *jsiiProxy_CfnTheme) AttrVersionBaseThemeId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTheme) AttrVersionCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTheme) AttrVersionDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTheme) AttrVersionErrors() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrVersionErrors",
...
func (j *jsiiProxy_CfnTheme) AttrVersionStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersionStatus",
...
func (j *jsiiProxy_CfnTheme) AttrVersionVersionNumber() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTheme) CfnPropertyNames() *map[string]*string {
...
func NewCfnTheme(scope constructs.Construct, id *string, props *CfnThemeProps) CfnTheme {
	...
	if err := validateNewCfnThemeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTheme_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTheme_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTheme_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTheme_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTheme_IsCfnTheme(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTheme_IsCfnThemeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTheme_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTheme_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTheme) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTheme) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTheme) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTheme) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTheme) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTheme) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTheme) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTheme) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTheme) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTheme) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
