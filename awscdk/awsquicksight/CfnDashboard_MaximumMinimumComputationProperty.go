...
type CfnDashboard_MaximumMinimumComputationProperty struct {
	// `CfnDashboard.MaximumMinimumComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnDashboard.MaximumMinimumComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnDashboard.MaximumMinimumComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnDashboard.MaximumMinimumComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnDashboard.MaximumMinimumComputationProperty.Value`.
