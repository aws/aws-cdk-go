...
type CfnTemplate_SankeyDiagramAggregatedFieldWellsProperty struct {
	// `CfnTemplate.SankeyDiagramAggregatedFieldWellsProperty.Destination`.
	Destination interface{} `field:"optional" json:"destination" yaml:"destination"`
	// `CfnTemplate.SankeyDiagramAggregatedFieldWellsProperty.Source`.
	Source interface{} `field:"optional" json:"source" yaml:"source"`
	// `CfnTemplate.SankeyDiagramAggregatedFieldWellsProperty.Weight`.
