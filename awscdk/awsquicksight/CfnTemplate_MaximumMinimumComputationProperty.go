...
type CfnTemplate_MaximumMinimumComputationProperty struct {
	// `CfnTemplate.MaximumMinimumComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnTemplate.MaximumMinimumComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnTemplate.MaximumMinimumComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnTemplate.MaximumMinimumComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnTemplate.MaximumMinimumComputationProperty.Value`.
