...
func validateCfnFlow_ArnForFlowParameters(resource interfacesawsquicksight.IFlowRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnFlow) validateSetAwsAccountIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnFlow) validateSetFlowDefinitionParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnFlow) validateSetPermissionsParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnFlow_PermissionProperty:
				v := v.(*CfnFlow_PermissionProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnFlow_PermissionProperty:
				v_ := v.(CfnFlow_PermissionProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnFlow_PermissionProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
