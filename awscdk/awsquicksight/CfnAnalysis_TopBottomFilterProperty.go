...
type CfnAnalysis_TopBottomFilterProperty struct {
	// `CfnAnalysis.TopBottomFilterProperty.AggregationSortConfigurations`.
	...
	// `CfnAnalysis.TopBottomFilterProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnAnalysis.TopBottomFilterProperty.FilterId`.
	FilterId *string `field:"required" json:"filterId" yaml:"filterId"`
	// `CfnAnalysis.TopBottomFilterProperty.Limit`.
	Limit *float64 `field:"optional" json:"limit" yaml:"limit"`
	// `CfnAnalysis.TopBottomFilterProperty.ParameterName`.
	ParameterName *string `field:"optional" json:"parameterName" yaml:"parameterName"`
	// `CfnAnalysis.TopBottomFilterProperty.TimeGranularity`.
