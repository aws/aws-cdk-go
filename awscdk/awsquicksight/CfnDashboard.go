...
func (j *jsiiProxy_CfnDashboard) Definition() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"definition",
...
func (j *jsiiProxy_CfnDashboard)SetDefinition(val interface{}) {
...
func CfnDashboard_ArnForDashboard(resource interfacesawsquicksight.IDashboardRef) *string {
	_init_.Initialize()
