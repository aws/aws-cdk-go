...
type CfnDashboard_ComboChartConfigurationProperty struct {
	...
	// `CfnDashboard.ComboChartConfigurationProperty.SecondaryYAxisLabelOptions`.
	SecondaryYAxisLabelOptions interface{} `field:"optional" json:"secondaryYAxisLabelOptions" yaml:"secondaryYAxisLabelOptions"`
	// `CfnDashboard.ComboChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnDashboard.ComboChartConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnDashboard.ComboChartConfigurationProperty.VisualPalette`.
