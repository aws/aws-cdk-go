...
type CfnDashboard_FilterDateTimePickerControlProperty struct {
	// `CfnDashboard.FilterDateTimePickerControlProperty.FilterControlId`.
	FilterControlId *string `field:"required" json:"filterControlId" yaml:"filterControlId"`
	// `CfnDashboard.FilterDateTimePickerControlProperty.SourceFilterId`.
	SourceFilterId *string `field:"required" json:"sourceFilterId" yaml:"sourceFilterId"`
	// `CfnDashboard.FilterDateTimePickerControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnDashboard.FilterDateTimePickerControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnDashboard.FilterDateTimePickerControlProperty.Type`.
