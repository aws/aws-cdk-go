...
type CfnDashboard_AggregationSortConfigurationProperty struct {
	// `CfnDashboard.AggregationSortConfigurationProperty.AggregationFunction`.
	AggregationFunction interface{} `field:"required" json:"aggregationFunction" yaml:"aggregationFunction"`
	// `CfnDashboard.AggregationSortConfigurationProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnDashboard.AggregationSortConfigurationProperty.SortDirection`.
