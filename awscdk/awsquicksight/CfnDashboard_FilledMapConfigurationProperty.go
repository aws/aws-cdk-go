...
type CfnDashboard_FilledMapConfigurationProperty struct {
	// `CfnDashboard.FilledMapConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnDashboard.FilledMapConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnDashboard.FilledMapConfigurationProperty.MapStyleOptions`.
	MapStyleOptions interface{} `field:"optional" json:"mapStyleOptions" yaml:"mapStyleOptions"`
	// `CfnDashboard.FilledMapConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnDashboard.FilledMapConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnDashboard.FilledMapConfigurationProperty.WindowOptions`.
