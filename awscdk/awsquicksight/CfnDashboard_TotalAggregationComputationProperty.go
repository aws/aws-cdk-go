...
type CfnDashboard_TotalAggregationComputationProperty struct {
	// `CfnDashboard.TotalAggregationComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnDashboard.TotalAggregationComputationProperty.Value`.
	Value interface{} `field:"required" json:"value" yaml:"value"`
	// `CfnDashboard.TotalAggregationComputationProperty.Name`.
