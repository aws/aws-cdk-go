...
func (j *jsiiProxy_CfnDashboard) validateSetAwsAccountIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDashboard) validateSetDashboardIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDashboard) validateSetDashboardPublishOptionsParameters(val interface{}) error {
	...
	case CfnDashboard_DashboardPublishOptionsProperty:
		val_ := val.(CfnDashboard_DashboardPublishOptionsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDashboard) validateSetDefinitionParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnDashboard_DashboardVersionDefinitionProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDashboard) validateSetParametersParameters(val interface{}) error {
	...
	case CfnDashboard_ParametersProperty:
		val_ := val.(CfnDashboard_ParametersProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDashboard) validateSetPermissionsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnDashboard_ResourcePermissionProperty:
				v_ := v.(CfnDashboard_ResourcePermissionProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnDashboard) validateSetSourceEntityParameters(val interface{}) error {
	...
	case CfnDashboard_DashboardSourceEntityProperty:
		val_ := val.(CfnDashboard_DashboardSourceEntityProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
