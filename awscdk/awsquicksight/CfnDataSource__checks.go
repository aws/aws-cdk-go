...
func validateCfnDataSource_ArnForDataSourceParameters(resource interfacesawsquicksight.IDataSourceRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetAlternateDataSourceParametersParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnDataSource_DataSourceParametersProperty:
				v_ := v.(CfnDataSource_DataSourceParametersProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnDataSource) validateSetCredentialsParameters(val interface{}) error {
	...
	case CfnDataSource_DataSourceCredentialsProperty:
		val_ := val.(CfnDataSource_DataSourceCredentialsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataSource) validateSetDataSourceParametersParameters(val interface{}) error {
	...
	case CfnDataSource_DataSourceParametersProperty:
		val_ := val.(CfnDataSource_DataSourceParametersProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataSource) validateSetErrorInfoParameters(val interface{}) error {
	...
	case CfnDataSource_DataSourceErrorInfoProperty:
		val_ := val.(CfnDataSource_DataSourceErrorInfoProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataSource) validateSetPermissionsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnDataSource_ResourcePermissionProperty:
				v_ := v.(CfnDataSource_ResourcePermissionProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnDataSource) validateSetSslPropertiesParameters(val interface{}) error {
	...
	case CfnDataSource_SslPropertiesProperty:
		val_ := val.(CfnDataSource_SslPropertiesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataSource) validateSetVpcConnectionPropertiesParameters(val interface{}) error {
	...
	case CfnDataSource_VpcConnectionPropertiesProperty:
		val_ := val.(CfnDataSource_VpcConnectionPropertiesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
