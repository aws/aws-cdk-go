...
type CfnTemplate_PivotTableCellConditionalFormattingProperty struct {
	// `CfnTemplate.PivotTableCellConditionalFormattingProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnTemplate.PivotTableCellConditionalFormattingProperty.Scope`.
	Scope interface{} `field:"optional" json:"scope" yaml:"scope"`
	// `CfnTemplate.PivotTableCellConditionalFormattingProperty.TextFormat`.
