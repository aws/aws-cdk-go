...
type CfnTemplate_PivotTablePaginatedReportOptionsProperty struct {
	// `CfnTemplate.PivotTablePaginatedReportOptionsProperty.OverflowColumnHeaderVisibility`.
	...
	// `CfnTemplate.PivotTablePaginatedReportOptionsProperty.VerticalOverflowVisibility`.
