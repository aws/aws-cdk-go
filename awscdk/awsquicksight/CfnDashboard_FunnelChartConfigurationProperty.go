...
type CfnDashboard_FunnelChartConfigurationProperty struct {
	// `CfnDashboard.FunnelChartConfigurationProperty.CategoryLabelOptions`.
	CategoryLabelOptions interface{} `field:"optional" json:"categoryLabelOptions" yaml:"categoryLabelOptions"`
	// `CfnDashboard.FunnelChartConfigurationProperty.DataLabelOptions`.
	DataLabelOptions interface{} `field:"optional" json:"dataLabelOptions" yaml:"dataLabelOptions"`
	// `CfnDashboard.FunnelChartConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnDashboard.FunnelChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnDashboard.FunnelChartConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnDashboard.FunnelChartConfigurationProperty.ValueLabelOptions`.
	ValueLabelOptions interface{} `field:"optional" json:"valueLabelOptions" yaml:"valueLabelOptions"`
	// `CfnDashboard.FunnelChartConfigurationProperty.VisualPalette`.
