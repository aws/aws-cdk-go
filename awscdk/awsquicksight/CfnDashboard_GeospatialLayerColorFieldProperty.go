...
//
//   geospatialLayerColorFieldProperty := &GeospatialLayerColorFieldProperty{
//   	ColorDimensionsFields: []interface{}{
...
//
type CfnDashboard_GeospatialLayerColorFieldProperty struct {
