...
//
//   cfnAgent := awscdk.Aws_quicksight.NewCfnAgent(this, jsii.String("MyCfnAgent"), &CfnAgentProps{
...
type CfnAgent interface {
	...
	AttrCustomPromptInterface() awscdk.IResolvable
	...
	CustomPromptInput() interface{}
	SetCustomPromptInput(val interface{})
	...
	StarterPrompts() *[]*string
	SetStarterPrompts(val *[]*string)
	// A list of key-value pairs to associate with the agent resource.
	Tags() *[]*CfnAgent_AgentTagProperty
	SetTags(val *[]*CfnAgent_AgentTagProperty)
	// Deprecated.
...
type jsiiProxy_CfnAgent struct {
	...
	internal.Type__interfacesawsquicksightIAgentRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnAgent) ActionConnectors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"actionConnectors",
...
func (j *jsiiProxy_CfnAgent) AgentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentId",
...
func (j *jsiiProxy_CfnAgent) AgentLifecycle() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentLifecycle",
...
func (j *jsiiProxy_CfnAgent) AgentRef() *interfacesawsquicksight.AgentReference {
	var returns *interfacesawsquicksight.AgentReference
	_jsii_.Get(
		j,
		"agentRef",
		&returns,
...
func (j *jsiiProxy_CfnAgent) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnAgent) AttrCreator() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreator",
...
func (j *jsiiProxy_CfnAgent) AttrCustomPromptInterface() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrCustomPromptInterface",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnAgent) AttrErrorMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrErrorMessage",
...
func (j *jsiiProxy_CfnAgent) AwsAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsAccountId",
...
func (j *jsiiProxy_CfnAgent) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAgent) CustomPromptInput() interface{} {
...
func (j *jsiiProxy_CfnAgent) IconId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iconId",
...
func (j *jsiiProxy_CfnAgent) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAgent) Spaces() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"spaces",
...
func (j *jsiiProxy_CfnAgent) StarterPrompts() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"starterPrompts",
...
func (j *jsiiProxy_CfnAgent) Tags() *[]*CfnAgent_AgentTagProperty {
	var returns *[]*CfnAgent_AgentTagProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CfnAgent) WelcomeMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"welcomeMessage",
...
func (j *jsiiProxy_CfnAgent)SetActionConnectors(val *[]*string) {
	_jsii_.Set(
		j,
		"actionConnectors",
		val,
...
func (j *jsiiProxy_CfnAgent)SetAgentId(val *string) {
...
func (j *jsiiProxy_CfnAgent)SetAgentLifecycle(val *string) {
	_jsii_.Set(
		j,
		"agentLifecycle",
		val,
...
func (j *jsiiProxy_CfnAgent)SetAwsAccountId(val *string) {
...
func (j *jsiiProxy_CfnAgent)SetCustomPromptInput(val interface{}) {
	if err := j.validateSetCustomPromptInputParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAgent)SetIconId(val *string) {
	_jsii_.Set(
		j,
		"iconId",
		val,
...
func (j *jsiiProxy_CfnAgent)SetName(val *string) {
...
func (j *jsiiProxy_CfnAgent)SetSpaces(val *[]*string) {
	_jsii_.Set(
		j,
		"spaces",
		val,
...
func (j *jsiiProxy_CfnAgent)SetStarterPrompts(val *[]*string) {
	_jsii_.Set(
		j,
		"starterPrompts",
		val,
...
func (j *jsiiProxy_CfnAgent)SetTags(val *[]*CfnAgent_AgentTagProperty) {
...
func (j *jsiiProxy_CfnAgent)SetWelcomeMessage(val *string) {
	_jsii_.Set(
		j,
		"welcomeMessage",
		val,
...
func CfnAgent_ArnForAgent(resource interfacesawsquicksight.IAgentRef) *string {
	_init_.Initialize()
...
func CfnAgent_IsCfnAgent(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAgent_IsCfnAgentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAgent) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAgent) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAgent) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAgent) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
