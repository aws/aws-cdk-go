...
type CfnTemplate_ParameterListControlProperty struct {
	// `CfnTemplate.ParameterListControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnTemplate.ParameterListControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnTemplate.ParameterListControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnTemplate.ParameterListControlProperty.CascadingControlConfiguration`.
	...
	// `CfnTemplate.ParameterListControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnTemplate.ParameterListControlProperty.SelectableValues`.
	SelectableValues interface{} `field:"optional" json:"selectableValues" yaml:"selectableValues"`
	// `CfnTemplate.ParameterListControlProperty.Type`.
