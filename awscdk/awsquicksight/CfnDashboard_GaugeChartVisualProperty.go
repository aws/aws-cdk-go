...
type CfnDashboard_GaugeChartVisualProperty struct {
	// `CfnDashboard.GaugeChartVisualProperty.VisualId`.
	VisualId *string `field:"required" json:"visualId" yaml:"visualId"`
	// `CfnDashboard.GaugeChartVisualProperty.Actions`.
	Actions interface{} `field:"optional" json:"actions" yaml:"actions"`
	// `CfnDashboard.GaugeChartVisualProperty.ChartConfiguration`.
	ChartConfiguration interface{} `field:"optional" json:"chartConfiguration" yaml:"chartConfiguration"`
	// `CfnDashboard.GaugeChartVisualProperty.ConditionalFormatting`.
	ConditionalFormatting interface{} `field:"optional" json:"conditionalFormatting" yaml:"conditionalFormatting"`
	// `CfnDashboard.GaugeChartVisualProperty.Subtitle`.
	Subtitle interface{} `field:"optional" json:"subtitle" yaml:"subtitle"`
	// `CfnDashboard.GaugeChartVisualProperty.Title`.
