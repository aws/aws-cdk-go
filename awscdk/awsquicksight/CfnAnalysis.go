...
func (j *jsiiProxy_CfnAnalysis) AttrErrors() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnAnalysis) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAnalysis) Definition() interface{} {
...
func (j *jsiiProxy_CfnAnalysis) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func NewCfnAnalysis(scope constructs.Construct, id *string, props *CfnAnalysisProps) CfnAnalysis {
	...
	if err := validateNewCfnAnalysisParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAnalysis)SetDefinition(val interface{}) {
...
func (j *jsiiProxy_CfnAnalysis)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnAnalysis_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAnalysis_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAnalysis_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAnalysis_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAnalysis_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAnalysis_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAnalysis) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalysis) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnalysis) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnalysis) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnalysis) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAnalysis) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAnalysis) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalysis) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalysis) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalysis) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
