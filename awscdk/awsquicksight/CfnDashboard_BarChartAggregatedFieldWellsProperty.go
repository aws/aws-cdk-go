...
//
//   barChartAggregatedFieldWellsProperty := &BarChartAggregatedFieldWellsProperty{
//   	Category: []interface{}{
...
type CfnDashboard_BarChartAggregatedFieldWellsProperty struct {
	// `CfnDashboard.BarChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnDashboard.BarChartAggregatedFieldWellsProperty.Colors`.
	Colors interface{} `field:"optional" json:"colors" yaml:"colors"`
	// `CfnDashboard.BarChartAggregatedFieldWellsProperty.SmallMultiples`.
	SmallMultiples interface{} `field:"optional" json:"smallMultiples" yaml:"smallMultiples"`
	// `CfnDashboard.BarChartAggregatedFieldWellsProperty.Values`.
