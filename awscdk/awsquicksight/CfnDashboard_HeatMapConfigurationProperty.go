...
type CfnDashboard_HeatMapConfigurationProperty struct {
	// `CfnDashboard.HeatMapConfigurationProperty.ColorScale`.
	ColorScale interface{} `field:"optional" json:"colorScale" yaml:"colorScale"`
	// `CfnDashboard.HeatMapConfigurationProperty.ColumnLabelOptions`.
	ColumnLabelOptions interface{} `field:"optional" json:"columnLabelOptions" yaml:"columnLabelOptions"`
	// `CfnDashboard.HeatMapConfigurationProperty.DataLabels`.
	DataLabels interface{} `field:"optional" json:"dataLabels" yaml:"dataLabels"`
	// `CfnDashboard.HeatMapConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnDashboard.HeatMapConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnDashboard.HeatMapConfigurationProperty.RowLabelOptions`.
	RowLabelOptions interface{} `field:"optional" json:"rowLabelOptions" yaml:"rowLabelOptions"`
	// `CfnDashboard.HeatMapConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnDashboard.HeatMapConfigurationProperty.Tooltip`.
