...
type CfnAnalysis_StringParameterDeclarationProperty struct {
	// `CfnAnalysis.StringParameterDeclarationProperty.Name`.
	Name *string `field:"required" json:"name" yaml:"name"`
	// `CfnAnalysis.StringParameterDeclarationProperty.ParameterValueType`.
	ParameterValueType *string `field:"required" json:"parameterValueType" yaml:"parameterValueType"`
	// `CfnAnalysis.StringParameterDeclarationProperty.DefaultValues`.
	...
	// `CfnAnalysis.StringParameterDeclarationProperty.ValueWhenUnset`.
