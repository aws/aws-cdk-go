...
type CfnTemplate_InsightVisualProperty struct {
	// `CfnTemplate.InsightVisualProperty.DataSetIdentifier`.
	DataSetIdentifier *string `field:"required" json:"dataSetIdentifier" yaml:"dataSetIdentifier"`
	// `CfnTemplate.InsightVisualProperty.VisualId`.
	VisualId *string `field:"required" json:"visualId" yaml:"visualId"`
	// `CfnTemplate.InsightVisualProperty.Actions`.
	Actions interface{} `field:"optional" json:"actions" yaml:"actions"`
	// `CfnTemplate.InsightVisualProperty.InsightConfiguration`.
	InsightConfiguration interface{} `field:"optional" json:"insightConfiguration" yaml:"insightConfiguration"`
	// `CfnTemplate.InsightVisualProperty.Subtitle`.
	Subtitle interface{} `field:"optional" json:"subtitle" yaml:"subtitle"`
	// `CfnTemplate.InsightVisualProperty.Title`.
