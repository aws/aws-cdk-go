...
func (j *jsiiProxy_CfnRefreshSchedule) AwsAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsAccountId",
...
func (j *jsiiProxy_CfnRefreshSchedule) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRefreshSchedule) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRefreshSchedule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRefreshSchedule) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRefreshSchedule) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRefreshSchedule) DataSetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataSetId",
...
func (j *jsiiProxy_CfnRefreshSchedule) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRefreshSchedule) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRefreshSchedule) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRefreshSchedule) Schedule() interface{} {
...
func (j *jsiiProxy_CfnRefreshSchedule) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRefreshSchedule) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRefreshSchedule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRefreshSchedule(scope constructs.Construct, id *string, props *CfnRefreshScheduleProps) CfnRefreshSchedule {
	...
	if err := validateNewCfnRefreshScheduleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRefreshSchedule)SetAwsAccountId(val *string) {
	_jsii_.Set(
		j,
		"awsAccountId",
		val,
...
func (j *jsiiProxy_CfnRefreshSchedule)SetDataSetId(val *string) {
	_jsii_.Set(
		j,
		"dataSetId",
		val,
...
func (j *jsiiProxy_CfnRefreshSchedule)SetSchedule(val interface{}) {
...
func CfnRefreshSchedule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRefreshSchedule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRefreshSchedule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRefreshSchedule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRefreshSchedule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRefreshSchedule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRefreshSchedule) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRefreshSchedule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRefreshSchedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRefreshSchedule) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRefreshSchedule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRefreshSchedule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRefreshSchedule) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRefreshSchedule) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRefreshSchedule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRefreshSchedule) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRefreshSchedule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRefreshSchedule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRefreshSchedule) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRefreshSchedule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRefreshSchedule) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRefreshSchedule) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRefreshSchedule) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRefreshSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
