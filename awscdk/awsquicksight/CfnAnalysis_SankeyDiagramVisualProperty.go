...
type CfnAnalysis_SankeyDiagramVisualProperty struct {
	// `CfnAnalysis.SankeyDiagramVisualProperty.VisualId`.
	VisualId *string `field:"required" json:"visualId" yaml:"visualId"`
	// `CfnAnalysis.SankeyDiagramVisualProperty.Actions`.
	Actions interface{} `field:"optional" json:"actions" yaml:"actions"`
	// `CfnAnalysis.SankeyDiagramVisualProperty.ChartConfiguration`.
	ChartConfiguration interface{} `field:"optional" json:"chartConfiguration" yaml:"chartConfiguration"`
	// `CfnAnalysis.SankeyDiagramVisualProperty.Subtitle`.
	Subtitle interface{} `field:"optional" json:"subtitle" yaml:"subtitle"`
	// `CfnAnalysis.SankeyDiagramVisualProperty.Title`.
