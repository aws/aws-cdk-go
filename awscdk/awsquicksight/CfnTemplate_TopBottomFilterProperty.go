...
type CfnTemplate_TopBottomFilterProperty struct {
	// `CfnTemplate.TopBottomFilterProperty.AggregationSortConfigurations`.
	...
	// `CfnTemplate.TopBottomFilterProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnTemplate.TopBottomFilterProperty.FilterId`.
	FilterId *string `field:"required" json:"filterId" yaml:"filterId"`
	// `CfnTemplate.TopBottomFilterProperty.Limit`.
	Limit *float64 `field:"optional" json:"limit" yaml:"limit"`
	// `CfnTemplate.TopBottomFilterProperty.ParameterName`.
	ParameterName *string `field:"optional" json:"parameterName" yaml:"parameterName"`
	// `CfnTemplate.TopBottomFilterProperty.TimeGranularity`.
