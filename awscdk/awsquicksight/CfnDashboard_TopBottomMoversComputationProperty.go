...
type CfnDashboard_TopBottomMoversComputationProperty struct {
	// `CfnDashboard.TopBottomMoversComputationProperty.Category`.
	Category interface{} `field:"required" json:"category" yaml:"category"`
	// `CfnDashboard.TopBottomMoversComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnDashboard.TopBottomMoversComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnDashboard.TopBottomMoversComputationProperty.Type`.
	Type *string `field:"required" json:"type" yaml:"type"`
	// `CfnDashboard.TopBottomMoversComputationProperty.MoverSize`.
	MoverSize *float64 `field:"optional" json:"moverSize" yaml:"moverSize"`
	// `CfnDashboard.TopBottomMoversComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnDashboard.TopBottomMoversComputationProperty.SortOrder`.
	SortOrder *string `field:"optional" json:"sortOrder" yaml:"sortOrder"`
	// `CfnDashboard.TopBottomMoversComputationProperty.Value`.
