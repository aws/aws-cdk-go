...
type CfnTemplate_LineChartSortConfigurationProperty struct {
	// `CfnTemplate.LineChartSortConfigurationProperty.CategoryItemsLimitConfiguration`.
	...
	// `CfnTemplate.LineChartSortConfigurationProperty.CategorySort`.
	CategorySort interface{} `field:"optional" json:"categorySort" yaml:"categorySort"`
	// `CfnTemplate.LineChartSortConfigurationProperty.ColorItemsLimitConfiguration`.
	...
	// `CfnTemplate.LineChartSortConfigurationProperty.SmallMultiplesLimitConfiguration`.
	...
	// `CfnTemplate.LineChartSortConfigurationProperty.SmallMultiplesSort`.
