...
type CfnTemplate_CategoricalDimensionFieldProperty struct {
	// `CfnTemplate.CategoricalDimensionFieldProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnTemplate.CategoricalDimensionFieldProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnTemplate.CategoricalDimensionFieldProperty.FormatConfiguration`.
	FormatConfiguration interface{} `field:"optional" json:"formatConfiguration" yaml:"formatConfiguration"`
	// `CfnTemplate.CategoricalDimensionFieldProperty.HierarchyId`.
