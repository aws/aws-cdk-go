...
//
//   radarChartAggregatedFieldWellsProperty := &RadarChartAggregatedFieldWellsProperty{
//   	Category: []interface{}{
...
type CfnAnalysis_RadarChartAggregatedFieldWellsProperty struct {
	// `CfnAnalysis.RadarChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnAnalysis.RadarChartAggregatedFieldWellsProperty.Color`.
	Color interface{} `field:"optional" json:"color" yaml:"color"`
	// `CfnAnalysis.RadarChartAggregatedFieldWellsProperty.Values`.
