...
type CfnDashboard_FilterListControlProperty struct {
	// `CfnDashboard.FilterListControlProperty.FilterControlId`.
	FilterControlId *string `field:"required" json:"filterControlId" yaml:"filterControlId"`
	// `CfnDashboard.FilterListControlProperty.SourceFilterId`.
	SourceFilterId *string `field:"required" json:"sourceFilterId" yaml:"sourceFilterId"`
	// `CfnDashboard.FilterListControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnDashboard.FilterListControlProperty.CascadingControlConfiguration`.
	...
	// `CfnDashboard.FilterListControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnDashboard.FilterListControlProperty.SelectableValues`.
	SelectableValues interface{} `field:"optional" json:"selectableValues" yaml:"selectableValues"`
	// `CfnDashboard.FilterListControlProperty.Type`.
