...
type CfnTemplate_PivotTableAggregatedFieldWellsProperty struct {
	// `CfnTemplate.PivotTableAggregatedFieldWellsProperty.Columns`.
	Columns interface{} `field:"optional" json:"columns" yaml:"columns"`
	// `CfnTemplate.PivotTableAggregatedFieldWellsProperty.Rows`.
	Rows interface{} `field:"optional" json:"rows" yaml:"rows"`
	// `CfnTemplate.PivotTableAggregatedFieldWellsProperty.Values`.
