...
type CfnAnalysis_DateDimensionFieldProperty struct {
	// `CfnAnalysis.DateDimensionFieldProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnAnalysis.DateDimensionFieldProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnAnalysis.DateDimensionFieldProperty.DateGranularity`.
	DateGranularity *string `field:"optional" json:"dateGranularity" yaml:"dateGranularity"`
	// `CfnAnalysis.DateDimensionFieldProperty.FormatConfiguration`.
	FormatConfiguration interface{} `field:"optional" json:"formatConfiguration" yaml:"formatConfiguration"`
	// `CfnAnalysis.DateDimensionFieldProperty.HierarchyId`.
