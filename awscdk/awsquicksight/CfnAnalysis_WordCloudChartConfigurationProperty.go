...
type CfnAnalysis_WordCloudChartConfigurationProperty struct {
	// `CfnAnalysis.WordCloudChartConfigurationProperty.CategoryLabelOptions`.
	CategoryLabelOptions interface{} `field:"optional" json:"categoryLabelOptions" yaml:"categoryLabelOptions"`
	// `CfnAnalysis.WordCloudChartConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnAnalysis.WordCloudChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnAnalysis.WordCloudChartConfigurationProperty.WordCloudOptions`.
