...
type CfnDashboard_ScatterPlotCategoricallyAggregatedFieldWellsProperty struct {
	// `CfnDashboard.ScatterPlotCategoricallyAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnDashboard.ScatterPlotCategoricallyAggregatedFieldWellsProperty.Size`.
	Size interface{} `field:"optional" json:"size" yaml:"size"`
	// `CfnDashboard.ScatterPlotCategoricallyAggregatedFieldWellsProperty.XAxis`.
	XAxis interface{} `field:"optional" json:"xAxis" yaml:"xAxis"`
	// `CfnDashboard.ScatterPlotCategoricallyAggregatedFieldWellsProperty.YAxis`.
