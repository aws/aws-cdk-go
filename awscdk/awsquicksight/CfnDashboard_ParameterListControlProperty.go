...
type CfnDashboard_ParameterListControlProperty struct {
	// `CfnDashboard.ParameterListControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnDashboard.ParameterListControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnDashboard.ParameterListControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnDashboard.ParameterListControlProperty.CascadingControlConfiguration`.
	...
	// `CfnDashboard.ParameterListControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnDashboard.ParameterListControlProperty.SelectableValues`.
	SelectableValues interface{} `field:"optional" json:"selectableValues" yaml:"selectableValues"`
	// `CfnDashboard.ParameterListControlProperty.Type`.
