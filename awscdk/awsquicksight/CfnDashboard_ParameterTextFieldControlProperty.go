...
type CfnDashboard_ParameterTextFieldControlProperty struct {
	// `CfnDashboard.ParameterTextFieldControlProperty.ParameterControlId`.
	ParameterControlId *string `field:"required" json:"parameterControlId" yaml:"parameterControlId"`
	// `CfnDashboard.ParameterTextFieldControlProperty.SourceParameterName`.
	SourceParameterName *string `field:"required" json:"sourceParameterName" yaml:"sourceParameterName"`
	// `CfnDashboard.ParameterTextFieldControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnDashboard.ParameterTextFieldControlProperty.DisplayOptions`.
