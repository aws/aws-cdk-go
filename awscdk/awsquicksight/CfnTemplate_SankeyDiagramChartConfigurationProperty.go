...
type CfnTemplate_SankeyDiagramChartConfigurationProperty struct {
	// `CfnTemplate.SankeyDiagramChartConfigurationProperty.DataLabels`.
	DataLabels interface{} `field:"optional" json:"dataLabels" yaml:"dataLabels"`
	// `CfnTemplate.SankeyDiagramChartConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnTemplate.SankeyDiagramChartConfigurationProperty.SortConfiguration`.
