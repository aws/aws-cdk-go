...
type CfnAnalysis_DateTimeFormatConfigurationProperty struct {
	// `CfnAnalysis.DateTimeFormatConfigurationProperty.DateTimeFormat`.
	DateTimeFormat *string `field:"optional" json:"dateTimeFormat" yaml:"dateTimeFormat"`
	// `CfnAnalysis.DateTimeFormatConfigurationProperty.NullValueFormatConfiguration`.
	...
	// `CfnAnalysis.DateTimeFormatConfigurationProperty.NumericFormatConfiguration`.
