...
type CfnDashboard_PeriodOverPeriodComputationProperty struct {
	// `CfnDashboard.PeriodOverPeriodComputationProperty.ComputationId`.
	ComputationId *string `field:"required" json:"computationId" yaml:"computationId"`
	// `CfnDashboard.PeriodOverPeriodComputationProperty.Time`.
	Time interface{} `field:"required" json:"time" yaml:"time"`
	// `CfnDashboard.PeriodOverPeriodComputationProperty.Name`.
	Name *string `field:"optional" json:"name" yaml:"name"`
	// `CfnDashboard.PeriodOverPeriodComputationProperty.Value`.
