...
type CfnTemplate_DateMeasureFieldProperty struct {
	// `CfnTemplate.DateMeasureFieldProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnTemplate.DateMeasureFieldProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnTemplate.DateMeasureFieldProperty.AggregationFunction`.
	AggregationFunction *string `field:"optional" json:"aggregationFunction" yaml:"aggregationFunction"`
	// `CfnTemplate.DateMeasureFieldProperty.FormatConfiguration`.
