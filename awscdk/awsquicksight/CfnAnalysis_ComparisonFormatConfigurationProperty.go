...
type CfnAnalysis_ComparisonFormatConfigurationProperty struct {
	// `CfnAnalysis.ComparisonFormatConfigurationProperty.NumberDisplayFormatConfiguration`.
	...
	// `CfnAnalysis.ComparisonFormatConfigurationProperty.PercentageDisplayFormatConfiguration`.
