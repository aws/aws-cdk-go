...
type CfnDashboard_ComparisonFormatConfigurationProperty struct {
	// `CfnDashboard.ComparisonFormatConfigurationProperty.NumberDisplayFormatConfiguration`.
	...
	// `CfnDashboard.ComparisonFormatConfigurationProperty.PercentageDisplayFormatConfiguration`.
