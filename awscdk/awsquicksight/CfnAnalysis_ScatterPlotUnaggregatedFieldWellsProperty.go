...
type CfnAnalysis_ScatterPlotUnaggregatedFieldWellsProperty struct {
	// `CfnAnalysis.ScatterPlotUnaggregatedFieldWellsProperty.Size`.
	Size interface{} `field:"optional" json:"size" yaml:"size"`
	// `CfnAnalysis.ScatterPlotUnaggregatedFieldWellsProperty.XAxis`.
	XAxis interface{} `field:"optional" json:"xAxis" yaml:"xAxis"`
	// `CfnAnalysis.ScatterPlotUnaggregatedFieldWellsProperty.YAxis`.
