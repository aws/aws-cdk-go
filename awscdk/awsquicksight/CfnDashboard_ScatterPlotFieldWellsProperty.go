...
type CfnDashboard_ScatterPlotFieldWellsProperty struct {
	// `CfnDashboard.ScatterPlotFieldWellsProperty.ScatterPlotCategoricallyAggregatedFieldWells`.
	...
	// `CfnDashboard.ScatterPlotFieldWellsProperty.ScatterPlotUnaggregatedFieldWells`.
