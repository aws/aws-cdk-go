...
type CfnDashboard_ComboChartAggregatedFieldWellsProperty struct {
	// `CfnDashboard.ComboChartAggregatedFieldWellsProperty.BarValues`.
	BarValues interface{} `field:"optional" json:"barValues" yaml:"barValues"`
	// `CfnDashboard.ComboChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnDashboard.ComboChartAggregatedFieldWellsProperty.Colors`.
	Colors interface{} `field:"optional" json:"colors" yaml:"colors"`
	// `CfnDashboard.ComboChartAggregatedFieldWellsProperty.LineValues`.
