...
type CfnAnalysis_ComboChartConfigurationProperty struct {
	...
	// `CfnAnalysis.ComboChartConfigurationProperty.SecondaryYAxisLabelOptions`.
	SecondaryYAxisLabelOptions interface{} `field:"optional" json:"secondaryYAxisLabelOptions" yaml:"secondaryYAxisLabelOptions"`
	// `CfnAnalysis.ComboChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnAnalysis.ComboChartConfigurationProperty.Tooltip`.
	Tooltip interface{} `field:"optional" json:"tooltip" yaml:"tooltip"`
	// `CfnAnalysis.ComboChartConfigurationProperty.VisualPalette`.
