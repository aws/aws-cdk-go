...
type CfnTemplate_BarChartAggregatedFieldWellsProperty struct {
	// `CfnTemplate.BarChartAggregatedFieldWellsProperty.Category`.
	Category interface{} `field:"optional" json:"category" yaml:"category"`
	// `CfnTemplate.BarChartAggregatedFieldWellsProperty.Colors`.
	Colors interface{} `field:"optional" json:"colors" yaml:"colors"`
	// `CfnTemplate.BarChartAggregatedFieldWellsProperty.SmallMultiples`.
	SmallMultiples interface{} `field:"optional" json:"smallMultiples" yaml:"smallMultiples"`
	// `CfnTemplate.BarChartAggregatedFieldWellsProperty.Values`.
