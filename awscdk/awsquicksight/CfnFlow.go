...
//
//   cfnFlow := awscdk.Aws_quicksight.NewCfnFlow(this, jsii.String("MyCfnFlow"), &CfnFlowProps{
...
type CfnFlow interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsquicksight.IFlowRef
	AttrArn() *string
	AttrCreatedTime() *string
	AttrFlowId() *string
	AttrLastUpdatedTime() *string
	AttrPublishState() *string
	AttrStepAliases() awscdk.IResolvable
	AwsAccountId() *string
	...
	FlowRef() *interfacesawsquicksight.FlowReference
...
type jsiiProxy_CfnFlow struct {
	...
	internal.Type__interfacesawsquicksightIFlowRef
}
...
func (j *jsiiProxy_CfnFlow) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnFlow) AttrFlowId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFlowId",
...
func (j *jsiiProxy_CfnFlow) AttrLastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedTime",
...
func (j *jsiiProxy_CfnFlow) AttrPublishState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPublishState",
...
func (j *jsiiProxy_CfnFlow) AttrStepAliases() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnFlow) AwsAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsAccountId",
...
func (j *jsiiProxy_CfnFlow) FlowDefinition() interface{} {
...
func (j *jsiiProxy_CfnFlow) FlowRef() *interfacesawsquicksight.FlowReference {
	var returns *interfacesawsquicksight.FlowReference
	_jsii_.Get(
		j,
		"flowRef",
		&returns,
...
func (j *jsiiProxy_CfnFlow) Permissions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"permissions",
...
func NewCfnFlow(scope constructs.Construct, id *string, props *CfnFlowProps) CfnFlow {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_quicksight.CfnFlow",
...
func (j *jsiiProxy_CfnFlow)SetAwsAccountId(val *string) {
...
func (j *jsiiProxy_CfnFlow)SetFlowDefinition(val interface{}) {
...
func (j *jsiiProxy_CfnFlow)SetPermissions(val interface{}) {
...
func CfnFlow_ArnForFlow(resource interfacesawsquicksight.IFlowRef) *string {
	_init_.Initialize()
