...
type CfnDashboard_NumericalDimensionFieldProperty struct {
	// `CfnDashboard.NumericalDimensionFieldProperty.Column`.
	Column interface{} `field:"required" json:"column" yaml:"column"`
	// `CfnDashboard.NumericalDimensionFieldProperty.FieldId`.
	FieldId *string `field:"required" json:"fieldId" yaml:"fieldId"`
	// `CfnDashboard.NumericalDimensionFieldProperty.FormatConfiguration`.
	FormatConfiguration interface{} `field:"optional" json:"formatConfiguration" yaml:"formatConfiguration"`
	// `CfnDashboard.NumericalDimensionFieldProperty.HierarchyId`.
