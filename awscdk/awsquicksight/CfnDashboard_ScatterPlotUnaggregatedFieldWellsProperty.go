...
type CfnDashboard_ScatterPlotUnaggregatedFieldWellsProperty struct {
	// `CfnDashboard.ScatterPlotUnaggregatedFieldWellsProperty.Size`.
	Size interface{} `field:"optional" json:"size" yaml:"size"`
	// `CfnDashboard.ScatterPlotUnaggregatedFieldWellsProperty.XAxis`.
	XAxis interface{} `field:"optional" json:"xAxis" yaml:"xAxis"`
	// `CfnDashboard.ScatterPlotUnaggregatedFieldWellsProperty.YAxis`.
