...
type CfnTemplate_WaterfallChartConfigurationProperty struct {
	// `CfnTemplate.WaterfallChartConfigurationProperty.CategoryAxisDisplayOptions`.
	CategoryAxisDisplayOptions interface{} `field:"optional" json:"categoryAxisDisplayOptions" yaml:"categoryAxisDisplayOptions"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.CategoryAxisLabelOptions`.
	CategoryAxisLabelOptions interface{} `field:"optional" json:"categoryAxisLabelOptions" yaml:"categoryAxisLabelOptions"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.DataLabels`.
	DataLabels interface{} `field:"optional" json:"dataLabels" yaml:"dataLabels"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.FieldWells`.
	FieldWells interface{} `field:"optional" json:"fieldWells" yaml:"fieldWells"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.Legend`.
	Legend interface{} `field:"optional" json:"legend" yaml:"legend"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.PrimaryYAxisDisplayOptions`.
	PrimaryYAxisDisplayOptions interface{} `field:"optional" json:"primaryYAxisDisplayOptions" yaml:"primaryYAxisDisplayOptions"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.PrimaryYAxisLabelOptions`.
	PrimaryYAxisLabelOptions interface{} `field:"optional" json:"primaryYAxisLabelOptions" yaml:"primaryYAxisLabelOptions"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.SortConfiguration`.
	SortConfiguration interface{} `field:"optional" json:"sortConfiguration" yaml:"sortConfiguration"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.VisualPalette`.
	VisualPalette interface{} `field:"optional" json:"visualPalette" yaml:"visualPalette"`
	// `CfnTemplate.WaterfallChartConfigurationProperty.WaterfallChartOptions`.
