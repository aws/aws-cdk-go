...
type CfnTemplate_FilterDropDownControlProperty struct {
	// `CfnTemplate.FilterDropDownControlProperty.FilterControlId`.
	FilterControlId *string `field:"required" json:"filterControlId" yaml:"filterControlId"`
	// `CfnTemplate.FilterDropDownControlProperty.SourceFilterId`.
	SourceFilterId *string `field:"required" json:"sourceFilterId" yaml:"sourceFilterId"`
	// `CfnTemplate.FilterDropDownControlProperty.Title`.
	Title *string `field:"required" json:"title" yaml:"title"`
	// `CfnTemplate.FilterDropDownControlProperty.CascadingControlConfiguration`.
	...
	// `CfnTemplate.FilterDropDownControlProperty.DisplayOptions`.
	DisplayOptions interface{} `field:"optional" json:"displayOptions" yaml:"displayOptions"`
	// `CfnTemplate.FilterDropDownControlProperty.SelectableValues`.
	SelectableValues interface{} `field:"optional" json:"selectableValues" yaml:"selectableValues"`
	// `CfnTemplate.FilterDropDownControlProperty.Type`.
