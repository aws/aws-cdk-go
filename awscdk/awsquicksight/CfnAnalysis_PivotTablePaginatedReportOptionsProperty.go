...
type CfnAnalysis_PivotTablePaginatedReportOptionsProperty struct {
	// `CfnAnalysis.PivotTablePaginatedReportOptionsProperty.OverflowColumnHeaderVisibility`.
	...
	// `CfnAnalysis.PivotTablePaginatedReportOptionsProperty.VerticalOverflowVisibility`.
