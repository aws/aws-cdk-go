...
func (j *jsiiProxy_ServerDeploymentConfig) DeploymentConfigRef() *interfacesawscodedeploy.DeploymentConfigReference {
...
func (j *jsiiProxy_ServerDeploymentConfig) Env() *interfaces.ResourceEnvironment {
...
func ServerDeploymentConfig_FromDeploymentConfigName(scope constructs.Construct, id *string, deploymentConfigName *string) IBaseDeploymentConfig {
	...
	if err := validateServerDeploymentConfig_FromDeploymentConfigNameParameters(scope, id, deploymentConfigName); err != nil {
		panic(err)
	}
...
func ServerDeploymentConfig_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateServerDeploymentConfig_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ServerDeploymentConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.ServerDeploymentConfig",
...
func (s *jsiiProxy_ServerDeploymentConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ServerDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
