...
func (s *jsiiProxy_ServerDeploymentConfig) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateServerDeploymentConfig_FromServerDeploymentConfigNameParameters(scope constructs.Construct, id *string, serverDeploymentConfigName *string) error {
	...
	if serverDeploymentConfigName == nil {
		return fmt.Errorf("parameter serverDeploymentConfigName is required, but nil was provided")
	}
