...
func CustomLambdaDeploymentConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.CustomLambdaDeploymentConfig",
...
func (c *jsiiProxy_CustomLambdaDeploymentConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CustomLambdaDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
