...
func (j *jsiiProxy_LambdaApplication) Env() *interfaces.ResourceEnvironment {
...
func LambdaApplication_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaApplication",
...
func (l *jsiiProxy_LambdaApplication) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LambdaApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
