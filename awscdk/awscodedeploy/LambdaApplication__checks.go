...
func (l *jsiiProxy_LambdaApplication) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateLambdaApplication_FromLambdaApplicationNameParameters(scope constructs.Construct, id *string, lambdaApplicationName *string) error {
	...
	if lambdaApplicationName == nil {
		return fmt.Errorf("parameter lambdaApplicationName is required, but nil was provided")
	}
