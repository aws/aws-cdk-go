...
func ServerDeploymentConfig_DeploymentConfig(name *string) IBaseDeploymentConfig {
	_init_.Initialize()

	if err := validateServerDeploymentConfig_DeploymentConfigParameters(name); err != nil {
		panic(err)
	}
...
func ServerDeploymentConfig_ALL_AT_ONCE() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.ServerDeploymentConfig",
...
func ServerDeploymentConfig_HALF_AT_A_TIME() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.ServerDeploymentConfig",
...
func ServerDeploymentConfig_ONE_AT_A_TIME() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.ServerDeploymentConfig",
