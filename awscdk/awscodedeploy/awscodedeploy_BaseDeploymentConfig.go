...
//
//   baseDeploymentConfig := awscdk.Aws_codedeploy.baseDeploymentConfig.deploymentConfig(jsii.String("name"))
//
...
func BaseDeploymentConfig_DeploymentConfig(name *string) IBaseDeploymentConfig {
	_init_.Initialize()

	if err := validateBaseDeploymentConfig_DeploymentConfigParameters(name); err != nil {
		panic(err)
	}
