...
func (j *jsiiProxy_EcsApplication) ApplicationRef() *interfacesawscodedeploy.ApplicationReference {
...
func (e *jsiiProxy_EcsApplication) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EcsApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
