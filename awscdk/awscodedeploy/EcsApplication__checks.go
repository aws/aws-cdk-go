...
func (e *jsiiProxy_EcsApplication) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateEcsApplication_FromEcsApplicationNameParameters(scope constructs.Construct, id *string, ecsApplicationName *string) error {
	...
	if ecsApplicationName == nil {
		return fmt.Errorf("parameter ecsApplicationName is required, but nil was provided")
	}
