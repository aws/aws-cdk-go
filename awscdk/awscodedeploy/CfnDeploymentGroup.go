...
func (j *jsiiProxy_CfnDeploymentGroup) CfnPropertyNames() *map[string]*string {
...
func CfnDeploymentGroup_IsCfnDeploymentGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeploymentGroup_IsCfnDeploymentGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeploymentGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeploymentGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeploymentGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeploymentGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
