...
func (j *jsiiProxy_CfnDeploymentConfig) CfnPropertyNames() *map[string]*string {
...
func NewCfnDeploymentConfig(scope constructs.Construct, id *string, props *CfnDeploymentConfigProps) CfnDeploymentConfig {
	...
	if err := validateNewCfnDeploymentConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDeploymentConfig)SetMinimumHealthyHosts(val interface{}) {
	if err := j.validateSetMinimumHealthyHostsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDeploymentConfig_IsCfnDeploymentConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeploymentConfig_IsCfnDeploymentConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeploymentConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentConfig_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeploymentConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeploymentConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeploymentConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeploymentConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeploymentConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeploymentConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeploymentConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeploymentConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
