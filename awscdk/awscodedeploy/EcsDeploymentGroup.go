...
func (j *jsiiProxy_EcsDeploymentGroup) DeploymentGroupRef() *interfacesawscodedeploy.DeploymentGroupReference {
...
func (j *jsiiProxy_EcsDeploymentGroup) Env() *interfaces.ResourceEnvironment {
...
func EcsDeploymentGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.EcsDeploymentGroup",
...
func (e *jsiiProxy_EcsDeploymentGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EcsDeploymentGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
