...
func (j *jsiiProxy_LambdaDeploymentConfig) Env() *interfaces.ResourceEnvironment {
...
func LambdaDeploymentConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func (l *jsiiProxy_LambdaDeploymentConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LambdaDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
