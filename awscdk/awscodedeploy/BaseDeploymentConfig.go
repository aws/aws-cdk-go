...
func (j *jsiiProxy_BaseDeploymentConfig) Env() *interfaces.ResourceEnvironment {
...
func (b *jsiiProxy_BaseDeploymentConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BaseDeploymentConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
