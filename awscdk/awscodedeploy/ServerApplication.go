...
func (j *jsiiProxy_ServerApplication) ApplicationRef() *interfacesawscodedeploy.ApplicationReference {
...
func (j *jsiiProxy_ServerApplication) Env() *interfaces.ResourceEnvironment {
...
func (s *jsiiProxy_ServerApplication) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ServerApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
