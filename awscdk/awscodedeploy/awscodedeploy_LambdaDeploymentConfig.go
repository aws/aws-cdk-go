...
func (j *jsiiProxy_LambdaDeploymentConfig) DeploymentConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentConfigArn",
...
func (j *jsiiProxy_LambdaDeploymentConfig) DeploymentConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaDeploymentConfig) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_LambdaDeploymentConfig) Node() constructs.Node {
...
func (j *jsiiProxy_LambdaDeploymentConfig) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_LambdaDeploymentConfig) Stack() awscdk.Stack {
...
func NewLambdaDeploymentConfig(scope constructs.Construct, id *string, props *LambdaDeploymentConfigProps) LambdaDeploymentConfig {
	...
	if err := validateNewLambdaDeploymentConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// This method should be used only for static references to predefined deployment configurations, like EcsDeploymentConfig.ALL_AT_ONCE.
//
// Returns: a reference to an existing custom Deployment Configuration.
func LambdaDeploymentConfig_DeploymentConfig(name *string) IBaseDeploymentConfig {
	_init_.Initialize()

	if err := validateLambdaDeploymentConfig_DeploymentConfigParameters(name); err != nil {
		panic(err)
	}
...
func LambdaDeploymentConfig_FromDeploymentConfigName(scope constructs.Construct, id *string, deploymentConfigName *string) IBaseDeploymentConfig {
	...
	if err := validateLambdaDeploymentConfig_FromDeploymentConfigNameParameters(scope, id, deploymentConfigName); err != nil {
		panic(err)
	}
	var returns IBaseDeploymentConfig
...
func LambdaDeploymentConfig_FromLambdaDeploymentConfigName(scope constructs.Construct, id *string, lambdaDeploymentConfigName *string) ILambdaDeploymentConfig {
	...
	if err := validateLambdaDeploymentConfig_FromLambdaDeploymentConfigNameParameters(scope, id, lambdaDeploymentConfigName); err != nil {
		panic(err)
	}
	...
	_jsii_.StaticInvoke(
		...
		[]interface{}{scope, id, lambdaDeploymentConfigName},
		&returns,
	)
...
func LambdaDeploymentConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateLambdaDeploymentConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func LambdaDeploymentConfig_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateLambdaDeploymentConfig_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func LambdaDeploymentConfig_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateLambdaDeploymentConfig_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func LambdaDeploymentConfig_ALL_AT_ONCE() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_CANARY_10PERCENT_10MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_CANARY_10PERCENT_15MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_CANARY_10PERCENT_30MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_CANARY_10PERCENT_5MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_LINEAR_10PERCENT_EVERY_10MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_LINEAR_10PERCENT_EVERY_1MINUTE() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_LINEAR_10PERCENT_EVERY_2MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func LambdaDeploymentConfig_LINEAR_10PERCENT_EVERY_3MINUTES() IBaseDeploymentConfig {
	_init_.Initialize()
	var returns IBaseDeploymentConfig
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentConfig",
...
func (l *jsiiProxy_LambdaDeploymentConfig) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (l *jsiiProxy_LambdaDeploymentConfig) GeneratePhysicalName() *string {
	var returns *string
...
func (l *jsiiProxy_LambdaDeploymentConfig) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (l *jsiiProxy_LambdaDeploymentConfig) GetResourceNameAttribute(nameAttr *string) *string {
...
func (l *jsiiProxy_LambdaDeploymentConfig) ToString() *string {
	var returns *string
