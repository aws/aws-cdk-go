...
func (j *jsiiProxy_LambdaDeploymentGroup) DeploymentGroupRef() *interfacesawscodedeploy.DeploymentGroupReference {
...
func (j *jsiiProxy_LambdaDeploymentGroup) Env() *interfaces.ResourceEnvironment {
...
func LambdaDeploymentGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codedeploy.LambdaDeploymentGroup",
...
func (l *jsiiProxy_LambdaDeploymentGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
