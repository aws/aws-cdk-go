...
func (j *jsiiProxy_CfnTracker) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTracker) CfnPropertyNames() *map[string]*string {
...
func CfnTracker_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTracker_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTracker_IsCfnTracker(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTracker_IsCfnTrackerParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTracker) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTracker) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTracker) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTracker) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTracker) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
