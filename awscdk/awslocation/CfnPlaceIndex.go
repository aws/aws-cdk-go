...
func (j *jsiiProxy_CfnPlaceIndex) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPlaceIndex) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPlaceIndex) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnPlaceIndex)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnPlaceIndex_IsCfnPlaceIndex(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPlaceIndex_IsCfnPlaceIndexParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlaceIndex_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPlaceIndex_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlaceIndex) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaceIndex) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPlaceIndex) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPlaceIndex) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPlaceIndex) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPlaceIndex) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPlaceIndex) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaceIndex) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaceIndex) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaceIndex) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
