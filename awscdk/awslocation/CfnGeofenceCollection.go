...
func (j *jsiiProxy_CfnGeofenceCollection) CfnPropertyNames() *map[string]*string {
...
func CfnGeofenceCollection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGeofenceCollection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGeofenceCollection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGeofenceCollection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGeofenceCollection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGeofenceCollection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeofenceCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
