...
func (j *jsiiProxy_CfnGeofenceCollection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (c *jsiiProxy_CfnGeofenceCollection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeofenceCollection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGeofenceCollection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGeofenceCollection) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnGeofenceCollection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGeofenceCollection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
