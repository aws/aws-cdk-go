...
type CfnRouteCalculator interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawslocation.IRouteCalculatorRef
	awscdk.ITaggableV2
	...
	RouteCalculatorRef() *interfacesawslocation.RouteCalculatorReference
...
type jsiiProxy_CfnRouteCalculator struct {
	...
	internal.Type__interfacesawslocationIRouteCalculatorRef
...
func (j *jsiiProxy_CfnRouteCalculator) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouteCalculator) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnRouteCalculator) RouteCalculatorRef() *interfacesawslocation.RouteCalculatorReference {
	var returns *interfacesawslocation.RouteCalculatorReference
	_jsii_.Get(
		j,
		"routeCalculatorRef",
		&returns,
...
func (j *jsiiProxy_CfnRouteCalculator) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRouteCalculator) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouteCalculator(scope constructs.Construct, id *string, props *CfnRouteCalculatorProps) CfnRouteCalculator {
	...
	if err := validateNewCfnRouteCalculatorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRouteCalculator)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnRouteCalculator_FromCalculatorName(scope constructs.Construct, id *string, calculatorName *string) interfacesawslocation.IRouteCalculatorRef {
	...
	var returns interfacesawslocation.IRouteCalculatorRef
...
func CfnRouteCalculator_FromRouteCalculatorArn(scope constructs.Construct, id *string, arn *string) interfacesawslocation.IRouteCalculatorRef {
	_init_.Initialize()
...
func CfnRouteCalculator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouteCalculator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteCalculator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRouteCalculator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteCalculator_IsCfnRouteCalculator(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRouteCalculator_IsCfnRouteCalculatorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteCalculator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouteCalculator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteCalculator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteCalculator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouteCalculator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouteCalculator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouteCalculator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouteCalculator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouteCalculator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteCalculator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteCalculator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteCalculator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
