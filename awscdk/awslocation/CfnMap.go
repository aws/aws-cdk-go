...
func (j *jsiiProxy_CfnMap) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMap) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMap(scope constructs.Construct, id *string, props *CfnMapProps) CfnMap {
	...
	if err := validateNewCfnMapParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnMap{}
...
func CfnMap_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMap_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMap_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMap_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMap_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMap_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMap) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMap) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMap) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMap) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMap) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMap) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMap) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMap) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMap) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMap) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
