...
func (j *jsiiProxy_CfnTrackerConsumer) CfnPropertyNames() *map[string]*string {
...
func NewCfnTrackerConsumer(scope constructs.Construct, id *string, props *CfnTrackerConsumerProps) CfnTrackerConsumer {
	...
	if err := validateNewCfnTrackerConsumerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTrackerConsumer_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrackerConsumer_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrackerConsumer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTrackerConsumer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrackerConsumer_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrackerConsumer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrackerConsumer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrackerConsumer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrackerConsumer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrackerConsumer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrackerConsumer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrackerConsumer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrackerConsumer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrackerConsumer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrackerConsumer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrackerConsumer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
