...
import (
	...
	awscdkcloudassemblyschema "github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v48/jsii"
)

//go:embed aws-cdk-lib-2.235.1.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("aws-cdk-lib", "2.235.1", tarball)
}
