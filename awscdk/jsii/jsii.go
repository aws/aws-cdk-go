...
import (
	...
	awscdkcloudassemblyschema "github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v41/jsii"
)

//go:embed aws-cdk-lib-2.197.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("aws-cdk-lib", "2.197.0", tarball)
}
