...
import (
	...
	awscdkcloudassemblyschema "github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v40/jsii"
)

//go:embed aws-cdk-lib-2.182.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("aws-cdk-lib", "2.182.0", tarball)
}
