...
import (
	...
	awscdkcloudassemblyschema "github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v50/jsii"
)

//go:embed aws-cdk-lib-2.239.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("aws-cdk-lib", "2.239.0", tarball)
}
