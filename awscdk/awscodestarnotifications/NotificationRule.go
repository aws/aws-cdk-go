...
func (j *jsiiProxy_NotificationRule) Env() *interfaces.ResourceEnvironment {
...
func NotificationRule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codestarnotifications.NotificationRule",
...
func (n *jsiiProxy_NotificationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
