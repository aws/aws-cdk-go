...
func (j *jsiiProxy_CfnNotificationRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNotificationRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNotificationRule(scope constructs.Construct, id *string, props *CfnNotificationRuleProps) CfnNotificationRule {
	...
	if err := validateNewCfnNotificationRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNotificationRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNotificationRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotificationRule_IsCfnNotificationRule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnNotificationRule_IsCfnNotificationRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotificationRule_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnNotificationRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotificationRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNotificationRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNotificationRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNotificationRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNotificationRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNotificationRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNotificationRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNotificationRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
