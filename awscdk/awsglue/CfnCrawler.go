...
func (c *jsiiProxy_CfnCrawler) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCrawler) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCrawler) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCrawler) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
