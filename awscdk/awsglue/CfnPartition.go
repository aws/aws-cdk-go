...
func (j *jsiiProxy_CfnPartition) CfnPropertyNames() *map[string]*string {
...
func CfnPartition_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPartition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPartition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPartition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPartition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPartition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
