...
//
//   cfnIntegration := awscdk.Aws_glue.NewCfnIntegration(this, jsii.String("MyCfnIntegration"), &CfnIntegrationProps{
...
type jsiiProxy_CfnIntegration struct {
	...
	internal.Type__interfacesawsglueIIntegrationRef
...
func (j *jsiiProxy_CfnIntegration) AttrCreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreateTime",
...
func (j *jsiiProxy_CfnIntegration) AttrIntegrationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIntegrationArn",
...
func (j *jsiiProxy_CfnIntegration) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnIntegration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIntegration) IntegrationConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"integrationConfig",
...
func (j *jsiiProxy_CfnIntegration) IntegrationRef() *interfacesawsglue.IntegrationReference {
	var returns *interfacesawsglue.IntegrationReference
	_jsii_.Get(
		j,
		"integrationRef",
		&returns,
...
func (j *jsiiProxy_CfnIntegration) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnIntegration) SourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceArn",
...
func (j *jsiiProxy_CfnIntegration) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnIntegration) TargetArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetArn",
...
func (j *jsiiProxy_CfnIntegration)SetAdditionalEncryptionContext(val interface{}) {
...
func (j *jsiiProxy_CfnIntegration)SetIntegrationConfig(val interface{}) {
	if err := j.validateSetIntegrationConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIntegration)SetIntegrationName(val *string) {
...
func (j *jsiiProxy_CfnIntegration)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnIntegration)SetSourceArn(val *string) {
...
func (j *jsiiProxy_CfnIntegration)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnIntegration)SetTargetArn(val *string) {
...
func CfnIntegration_ArnForIntegration(resource interfacesawsglue.IIntegrationRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIntegration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIntegration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIntegration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
