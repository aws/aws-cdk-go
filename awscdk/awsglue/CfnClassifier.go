...
func (j *jsiiProxy_CfnClassifier) CfnPropertyNames() *map[string]*string {
...
func CfnClassifier_IsCfnClassifier(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClassifier_IsCfnClassifierParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClassifier) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClassifier) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClassifier) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClassifier) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClassifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
