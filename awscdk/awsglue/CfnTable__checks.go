...
func (j *jsiiProxy_CfnTable) validateSetOpenTableFormatInputParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnTable_OpenTableFormatInputProperty:
		val := val.(*CfnTable_OpenTableFormatInputProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnTable_OpenTableFormatInputProperty:
		val_ := val.(CfnTable_OpenTableFormatInputProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_OpenTableFormatInputProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnTable) validateSetTableInputParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnTable_TableInputProperty:
		val := val.(*CfnTable_TableInputProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnTable_TableInputProperty:
		val_ := val.(CfnTable_TableInputProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTable_TableInputProperty; received %#v (a %T)", val, val)
		}
	}
