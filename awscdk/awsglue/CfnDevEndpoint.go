...
func (j *jsiiProxy_CfnDevEndpoint) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDevEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDevEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDevEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDevEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
