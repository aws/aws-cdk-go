...
func (j *jsiiProxy_CfnCatalog) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCatalog) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCatalog) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCatalog) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCatalog) RemoveResourceDependency(target awscdk.CfnResource) {
