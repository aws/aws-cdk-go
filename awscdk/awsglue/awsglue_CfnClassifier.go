...
func (j *jsiiProxy_CfnClassifier) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (c *jsiiProxy_CfnClassifier) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClassifier) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClassifier) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClassifier) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnClassifier) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClassifier) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
