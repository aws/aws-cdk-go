...
func (j *jsiiProxy_CfnDataCatalogEncryptionSettings) CfnPropertyNames() *map[string]*string {
...
func CfnDataCatalogEncryptionSettings_IsCfnDataCatalogEncryptionSettings(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataCatalogEncryptionSettings_IsCfnDataCatalogEncryptionSettingsParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_glue.CfnDataCatalogEncryptionSettings",
		"isCfnDataCatalogEncryptionSettings",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCatalogEncryptionSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
