...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_glue.CfnCrawler.DeltaTargetProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_glue.CfnDatabase.FederatedDatabaseProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_glue.CfnTrigger.EventBatchingConditionProperty",
