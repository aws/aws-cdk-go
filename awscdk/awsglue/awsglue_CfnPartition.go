...
func (c *jsiiProxy_CfnPartition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPartition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPartition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPartition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
