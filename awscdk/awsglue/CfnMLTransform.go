...
func (j *jsiiProxy_CfnMLTransform) CfnPropertyNames() *map[string]*string {
...
func CfnMLTransform_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMLTransform_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMLTransform) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMLTransform) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMLTransform) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMLTransform) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMLTransform) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
