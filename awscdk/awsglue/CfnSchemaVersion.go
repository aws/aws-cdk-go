...
func (j *jsiiProxy_CfnSchemaVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSchemaVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSchemaVersion(scope constructs.Construct, id *string, props *CfnSchemaVersionProps) CfnSchemaVersion {
	...
	if err := validateNewCfnSchemaVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSchemaVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSchemaVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchemaVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersion_IsCfnSchemaVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchemaVersion_IsCfnSchemaVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSchemaVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchemaVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSchemaVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSchemaVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSchemaVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSchemaVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSchemaVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
