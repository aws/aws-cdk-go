...
func (j *jsiiProxy_CfnSchemaVersionMetadata) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSchemaVersionMetadata) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSchemaVersionMetadata(scope constructs.Construct, id *string, props *CfnSchemaVersionMetadataProps) CfnSchemaVersionMetadata {
	...
	if err := validateNewCfnSchemaVersionMetadataParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSchemaVersionMetadata_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSchemaVersionMetadata_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersionMetadata_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchemaVersionMetadata_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersionMetadata_IsCfnSchemaVersionMetadata(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchemaVersionMetadata_IsCfnSchemaVersionMetadataParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchemaVersionMetadata_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSchemaVersionMetadata_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchemaVersionMetadata) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
