...
func (j *jsiiProxy_CfnDataQualityRuleset) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDataQualityRuleset) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataQualityRuleset) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDataQualityRuleset) ClientToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientToken",
...
func (j *jsiiProxy_CfnDataQualityRuleset) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDataQualityRuleset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDataQualityRuleset) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDataQualityRuleset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDataQualityRuleset) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDataQualityRuleset) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDataQualityRuleset) Ruleset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleset",
...
func (j *jsiiProxy_CfnDataQualityRuleset) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDataQualityRuleset) TargetTable() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetTable",
...
func (j *jsiiProxy_CfnDataQualityRuleset) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDataQualityRuleset) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDataQualityRuleset(scope constructs.Construct, id *string, props *CfnDataQualityRulesetProps) CfnDataQualityRuleset {
	...
	if err := validateNewCfnDataQualityRulesetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDataQualityRuleset)SetClientToken(val *string) {
	_jsii_.Set(
		j,
		"clientToken",
		val,
...
func (j *jsiiProxy_CfnDataQualityRuleset)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDataQualityRuleset)SetRuleset(val *string) {
	_jsii_.Set(
		j,
		"ruleset",
		val,
...
func (j *jsiiProxy_CfnDataQualityRuleset)SetTargetTable(val interface{}) {
	if err := j.validateSetTargetTableParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDataQualityRuleset_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataQualityRuleset_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataQualityRuleset_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataQualityRuleset_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataQualityRuleset_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataQualityRuleset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataQualityRuleset_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_glue.CfnDataQualityRuleset",
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataQualityRuleset) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataQualityRuleset) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDataQualityRuleset) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataQualityRuleset) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDataQualityRuleset) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDataQualityRuleset) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDataQualityRuleset) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDataQualityRuleset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
