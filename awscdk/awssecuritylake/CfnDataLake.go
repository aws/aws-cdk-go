...
func (j *jsiiProxy_CfnDataLake) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnDataLake) AttrS3BucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrS3BucketArn",
...
func (j *jsiiProxy_CfnDataLake) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDataLake) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDataLake) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDataLake) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataLake) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDataLake) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDataLake) EncryptionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnDataLake) LifecycleConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataLake) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDataLake) MetaStoreManagerRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataLake) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDataLake) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDataLake) ReplicationConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataLake) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDataLake) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDataLake) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDataLake) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDataLake(scope constructs.Construct, id *string, props *CfnDataLakeProps) CfnDataLake {
	...
	if err := validateNewCfnDataLakeParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnDataLake{}

	_jsii_.Create(
		"aws-cdk-lib.aws_securitylake.CfnDataLake",
...
func (j *jsiiProxy_CfnDataLake)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnDataLake)SetLifecycleConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnDataLake)SetMetaStoreManagerRoleArn(val *string) {
	_jsii_.Set(
		j,
		"metaStoreManagerRoleArn",
		val,
...
func (j *jsiiProxy_CfnDataLake)SetReplicationConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnDataLake)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDataLake_ArnForDataLake(resource interfacesawssecuritylake.IDataLakeRef) *string {
	_init_.Initialize()

	if err := validateCfnDataLake_ArnForDataLakeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDataLake_IsCfnDataLake(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataLake_IsCfnDataLakeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataLake_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDataLake_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataLake_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDataLake_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataLake_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDataLake_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataLake) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDataLake) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLake) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLake) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataLake) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataLake) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDataLake) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataLake) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataLake) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataLake) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDataLake) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataLake) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataLake) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDataLake) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDataLake) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataLake) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDataLake) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLake) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLake) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDataLake) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLake) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDataLake) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDataLake) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDataLake) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
