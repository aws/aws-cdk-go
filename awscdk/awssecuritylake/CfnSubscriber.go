...
func (j *jsiiProxy_CfnSubscriber) AccessTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"accessTypes",
...
func (j *jsiiProxy_CfnSubscriber) AttrResourceShareArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriber) AttrResourceShareName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriber) AttrS3BucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrS3BucketArn",
...
func (j *jsiiProxy_CfnSubscriber) AttrSubscriberArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSubscriberArn",
...
func (j *jsiiProxy_CfnSubscriber) AttrSubscriberRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriber) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnSubscriber) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSubscriber) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSubscriber) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubscriber) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSubscriber) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSubscriber) DataLakeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataLakeArn",
...
func (j *jsiiProxy_CfnSubscriber) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSubscriber) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSubscriber) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSubscriber) SubscriberDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriber) SubscriberIdentity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"subscriberIdentity",
...
func (j *jsiiProxy_CfnSubscriber) SubscriberName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriberName",
...
func (j *jsiiProxy_CfnSubscriber) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnSubscriber) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSubscriber) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubscriber(scope constructs.Construct, id *string, props *CfnSubscriberProps) CfnSubscriber {
	...
	if err := validateNewCfnSubscriberParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnSubscriber{}

	_jsii_.Create(
		"aws-cdk-lib.aws_securitylake.CfnSubscriber",
...
func (j *jsiiProxy_CfnSubscriber)SetAccessTypes(val *[]*string) {
	if err := j.validateSetAccessTypesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSubscriber)SetDataLakeArn(val *string) {
...
func (j *jsiiProxy_CfnSubscriber)SetSubscriberDescription(val *string) {
	_jsii_.Set(
		j,
		"subscriberDescription",
		val,
...
func (j *jsiiProxy_CfnSubscriber)SetSubscriberIdentity(val interface{}) {
	if err := j.validateSetSubscriberIdentityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSubscriber)SetSubscriberName(val *string) {
...
func (j *jsiiProxy_CfnSubscriber)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnSubscriber_ArnForSubscriber(resource interfacesawssecuritylake.ISubscriberRef) *string {
	_init_.Initialize()

	if err := validateCfnSubscriber_ArnForSubscriberParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnSubscriber_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubscriber_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriber_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubscriber_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriber_IsCfnSubscriber(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSubscriber_IsCfnSubscriberParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriber_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubscriber_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubscriber) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSubscriber) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriber) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriber) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriber) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriber) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSubscriber) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriber) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubscriber) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubscriber) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSubscriber) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubscriber) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubscriber) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSubscriber) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSubscriber) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubscriber) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSubscriber) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriber) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriber) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSubscriber) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriber) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSubscriber) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSubscriber) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSubscriber) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
