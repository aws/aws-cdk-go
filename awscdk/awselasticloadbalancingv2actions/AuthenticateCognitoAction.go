...
//
func AuthenticateCognitoAction_AuthenticateJwt(options *awselasticloadbalancingv2.AuthenticateJwtOptions) awselasticloadbalancingv2.ListenerAction {
	_init_.Initialize()

	if err := validateAuthenticateCognitoAction_AuthenticateJwtParameters(options); err != nil {
		panic(err)
	}
	var returns awselasticloadbalancingv2.ListenerAction
