...
func (j *jsiiProxy_CfnDeployment) ApplicationVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"applicationVersion",
...
func (j *jsiiProxy_CfnDeployment) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDeployment)SetApplicationVersion(val *float64) {
	if err := j.validateSetApplicationVersionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
