...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsm2IApplicationRef
	internal.Type__awscdkITaggable
}

func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawsm2.ApplicationReference {
	var returns *interfacesawsm2.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) Definition() interface{} {
...
func (j *jsiiProxy_CfnApplication) EngineType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"engineType",
...
func (j *jsiiProxy_CfnApplication) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnApplication)SetDefinition(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetEngineType(val *string) {
...
func (j *jsiiProxy_CfnApplication)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
