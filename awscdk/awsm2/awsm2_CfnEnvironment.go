...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsm2/internal"
...
func (j *jsiiProxy_CfnEnvironment) EngineType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"engineType",
...
func (j *jsiiProxy_CfnEnvironment) EngineVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"engineVersion",
...
func (j *jsiiProxy_CfnEnvironment) HighAvailabilityConfig() interface{} {
...
func (j *jsiiProxy_CfnEnvironment) InstanceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceType",
...
func (j *jsiiProxy_CfnEnvironment) PreferredMaintenanceWindow() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEnvironment) PubliclyAccessible() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"publiclyAccessible",
...
func (j *jsiiProxy_CfnEnvironment) SecurityGroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"securityGroupIds",
...
func (j *jsiiProxy_CfnEnvironment) StorageConfigurations() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEnvironment) SubnetIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnetIds",
...
func (j *jsiiProxy_CfnEnvironment)SetEngineType(val *string) {
...
func (j *jsiiProxy_CfnEnvironment)SetEngineVersion(val *string) {
	_jsii_.Set(
		j,
		"engineVersion",
		val,
...
func (j *jsiiProxy_CfnEnvironment)SetHighAvailabilityConfig(val interface{}) {
	if err := j.validateSetHighAvailabilityConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnEnvironment)SetInstanceType(val *string) {
...
func (j *jsiiProxy_CfnEnvironment)SetPreferredMaintenanceWindow(val *string) {
	_jsii_.Set(
		j,
		"preferredMaintenanceWindow",
		val,
...
func (j *jsiiProxy_CfnEnvironment)SetPubliclyAccessible(val interface{}) {
...
func (j *jsiiProxy_CfnEnvironment)SetSecurityGroupIds(val *[]*string) {
	_jsii_.Set(
		j,
		"securityGroupIds",
		val,
...
func (j *jsiiProxy_CfnEnvironment)SetStorageConfigurations(val interface{}) {
	if err := j.validateSetStorageConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnEnvironment)SetSubnetIds(val *[]*string) {
	_jsii_.Set(
		j,
		"subnetIds",
		val,
