...
func (j *jsiiProxy_CfnExtensionAssociation) AttrExtensionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrExtensionArn",
...
func (j *jsiiProxy_CfnExtensionAssociation) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnExtensionAssociation) AttrResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrResourceArn",
...
func (j *jsiiProxy_CfnExtensionAssociation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnExtensionAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnExtensionAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnExtensionAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnExtensionAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnExtensionAssociation) ExtensionIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"extensionIdentifier",
...
func (j *jsiiProxy_CfnExtensionAssociation) ExtensionVersionNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnExtensionAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnExtensionAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnExtensionAssociation) Parameters() interface{} {
...
func (j *jsiiProxy_CfnExtensionAssociation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnExtensionAssociation) ResourceIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceIdentifier",
...
func (j *jsiiProxy_CfnExtensionAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnExtensionAssociation) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnExtensionAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnExtensionAssociation(scope constructs.Construct, id *string, props *CfnExtensionAssociationProps) CfnExtensionAssociation {
	...
	if err := validateNewCfnExtensionAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnExtensionAssociation)SetExtensionIdentifier(val *string) {
	_jsii_.Set(
		j,
		"extensionIdentifier",
		val,
...
func (j *jsiiProxy_CfnExtensionAssociation)SetExtensionVersionNumber(val *float64) {
	_jsii_.Set(
		j,
		"extensionVersionNumber",
		val,
...
func (j *jsiiProxy_CfnExtensionAssociation)SetParameters(val interface{}) {
...
func (j *jsiiProxy_CfnExtensionAssociation)SetResourceIdentifier(val *string) {
	_jsii_.Set(
		j,
		"resourceIdentifier",
		val,
...
func CfnExtensionAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnExtensionAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExtensionAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnExtensionAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExtensionAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnExtensionAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnExtensionAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtensionAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnExtensionAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnExtensionAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnExtensionAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnExtensionAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnExtensionAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnExtensionAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnExtensionAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnExtensionAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnExtensionAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtensionAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtensionAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnExtensionAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtensionAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnExtensionAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnExtensionAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnExtensionAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
