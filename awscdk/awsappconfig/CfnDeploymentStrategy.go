...
func (j *jsiiProxy_CfnDeploymentStrategy) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDeploymentStrategy) CfnPropertyNames() *map[string]*string {
...
func CfnDeploymentStrategy_IsCfnDeploymentStrategy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeploymentStrategy_IsCfnDeploymentStrategyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentStrategy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeploymentStrategy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeploymentStrategy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeploymentStrategy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeploymentStrategy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeploymentStrategy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeploymentStrategy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
