...
func (j *jsiiProxy_CfnExtension) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnExtension) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnExtension) AttrVersionNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrVersionNumber",
...
func (j *jsiiProxy_CfnExtension) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnExtension) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnExtension) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnExtension) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnExtension) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnExtension) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnExtension) LatestVersionNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"latestVersionNumber",
...
func (j *jsiiProxy_CfnExtension) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnExtension) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnExtension) Node() constructs.Node {
...
func (j *jsiiProxy_CfnExtension) Parameters() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parameters",
...
func (j *jsiiProxy_CfnExtension) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnExtension) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnExtension) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnExtension) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnExtension(scope constructs.Construct, id *string, props *CfnExtensionProps) CfnExtension {
	...
	if err := validateNewCfnExtensionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnExtension)SetActions(val interface{}) {
...
func (j *jsiiProxy_CfnExtension)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnExtension)SetLatestVersionNumber(val *float64) {
	_jsii_.Set(
		j,
		"latestVersionNumber",
		val,
...
func (j *jsiiProxy_CfnExtension)SetName(val *string) {
...
func (j *jsiiProxy_CfnExtension)SetParameters(val interface{}) {
...
func CfnExtension_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnExtension_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExtension_IsCfnExtension(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnExtension_IsCfnExtensionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExtension_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnExtension_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExtension_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnExtension_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnExtension) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnExtension) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtension) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtension) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtension) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtension) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnExtension) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnExtension) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnExtension) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnExtension) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnExtension) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnExtension) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnExtension) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnExtension) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnExtension) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnExtension) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnExtension) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtension) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtension) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnExtension) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExtension) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnExtension) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnExtension) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnExtension) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
