...
func (j *jsiiProxy_CfnEnvironment) DeletionProtectionCheck() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEnvironment) EnvironmentRef() *interfacesawsappconfig.EnvironmentReference {
...
func (j *jsiiProxy_CfnEnvironment)SetDeletionProtectionCheck(val *string) {
	_jsii_.Set(
		j,
		"deletionProtectionCheck",
		val,
