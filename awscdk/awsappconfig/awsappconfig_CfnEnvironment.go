...
func (j *jsiiProxy_CfnEnvironment) Monitors() interface{} {
...
func (j *jsiiProxy_CfnEnvironment)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnEnvironment)SetMonitors(val interface{}) {
