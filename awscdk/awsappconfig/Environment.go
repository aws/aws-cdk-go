...
func (j *jsiiProxy_Environment) Env() *interfaces.ResourceEnvironment {
...
func (e *jsiiProxy_Environment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_Environment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
