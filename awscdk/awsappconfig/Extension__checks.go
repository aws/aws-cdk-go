...
func (e *jsiiProxy_Extension) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateExtension_FromExtensionArnParameters(scope constructs.Construct, id *string, extensionArn *string) error {
	...
	if extensionArn == nil {
		return fmt.Errorf("parameter extensionArn is required, but nil was provided")
	}
