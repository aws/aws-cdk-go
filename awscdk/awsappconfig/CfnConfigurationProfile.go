...
func (j *jsiiProxy_CfnConfigurationProfile) CfnPropertyNames() *map[string]*string {
...
func CfnConfigurationProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfigurationProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
