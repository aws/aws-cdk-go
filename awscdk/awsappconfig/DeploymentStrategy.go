...
func (j *jsiiProxy_DeploymentStrategy) Env() *interfaces.ResourceEnvironment {
...
func DeploymentStrategy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appconfig.DeploymentStrategy",
...
func (d *jsiiProxy_DeploymentStrategy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DeploymentStrategy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
