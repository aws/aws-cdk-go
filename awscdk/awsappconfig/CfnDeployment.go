...
func (j *jsiiProxy_CfnDeployment) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnDeployment) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDeployment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDeployment) ConfigurationProfileId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDeployment) ConfigurationVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDeployment) DeploymentStrategyId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDeployment)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetConfigurationProfileId(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetConfigurationVersion(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetDeploymentStrategyId(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetEnvironmentId(val *string) {
...
func CfnDeployment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeployment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeployment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeployment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeployment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeployment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeployment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeployment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeployment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeployment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeployment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
