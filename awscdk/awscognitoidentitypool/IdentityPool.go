...
type IdentityPool interface {
	...
	RoleAttachment() awscognito.CfnIdentityPoolRoleAttachment
...
func (j *jsiiProxy_IdentityPool) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IdentityPool) RoleAttachment() awscognito.CfnIdentityPoolRoleAttachment {
	var returns awscognito.CfnIdentityPoolRoleAttachment
	_jsii_.Get(
		j,
		"roleAttachment",
		&returns,
...
func IdentityPool_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito_identitypool.IdentityPool",
...
func (i *jsiiProxy_IdentityPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
