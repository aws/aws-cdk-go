...
//
//   cfnSyncConfiguration := awscdk.Aws_codestarconnections.NewCfnSyncConfiguration(this, jsii.String("MyCfnSyncConfiguration"), &CfnSyncConfigurationProps{
...
func (j *jsiiProxy_CfnSyncConfiguration) AttrProviderType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrProviderType",
...
func (j *jsiiProxy_CfnSyncConfiguration) AttrRepositoryName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRepositoryName",
...
func (j *jsiiProxy_CfnSyncConfiguration) Branch() *string {
	var returns *string
	_jsii_.Get(
		j,
		"branch",
...
func (j *jsiiProxy_CfnSyncConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSyncConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSyncConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSyncConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSyncConfiguration) ConfigFile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configFile",
...
func (j *jsiiProxy_CfnSyncConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSyncConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSyncConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSyncConfiguration) RepositoryLinkId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryLinkId",
...
func (j *jsiiProxy_CfnSyncConfiguration) ResourceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceName",
...
func (j *jsiiProxy_CfnSyncConfiguration) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnSyncConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSyncConfiguration) SyncType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"syncType",
...
func (j *jsiiProxy_CfnSyncConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSyncConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSyncConfiguration(scope constructs.Construct, id *string, props *CfnSyncConfigurationProps) CfnSyncConfiguration {
	...
	if err := validateNewCfnSyncConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSyncConfiguration)SetBranch(val *string) {
...
func (j *jsiiProxy_CfnSyncConfiguration)SetConfigFile(val *string) {
...
func (j *jsiiProxy_CfnSyncConfiguration)SetResourceName(val *string) {
...
func (j *jsiiProxy_CfnSyncConfiguration)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnSyncConfiguration)SetSyncType(val *string) {
...
func CfnSyncConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSyncConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncConfiguration_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSyncConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncConfiguration_IsCfnSyncConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSyncConfiguration_IsCfnSyncConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSyncConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codestarconnections.CfnSyncConfiguration",
...
func (c *jsiiProxy_CfnSyncConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSyncConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSyncConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSyncConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSyncConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSyncConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSyncConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSyncConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSyncConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSyncConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSyncConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSyncConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSyncConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSyncConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
