...
type CfnConnection interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscodestarconnections.IConnectionRef
	awscdk.ITaggable
	...
	ConnectionRef() *interfacesawscodestarconnections.ConnectionReference
...
type jsiiProxy_CfnConnection struct {
	...
	internal.Type__interfacesawscodestarconnectionsIConnectionRef
...
func (j *jsiiProxy_CfnConnection) ConnectionRef() *interfacesawscodestarconnections.ConnectionReference {
	var returns *interfacesawscodestarconnections.ConnectionReference
	_jsii_.Get(
		j,
		"connectionRef",
		&returns,
