...
func (j *jsiiProxy_SlackChannelConfiguration) Env() *interfaces.ResourceEnvironment {
...
func SlackChannelConfiguration_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_chatbot.SlackChannelConfiguration",
...
func (s *jsiiProxy_SlackChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
