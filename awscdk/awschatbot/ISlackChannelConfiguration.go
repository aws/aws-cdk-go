...
func (i *jsiiProxy_ISlackChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISlackChannelConfiguration) Env() *interfaces.ResourceEnvironment {
