...
func (j *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
