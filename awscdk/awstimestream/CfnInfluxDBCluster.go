...
func (j *jsiiProxy_CfnInfluxDBCluster) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInfluxDBCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInfluxDBCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInfluxDBCluster) RemoveResourceDependency(target awscdk.CfnResource) {
