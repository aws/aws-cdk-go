...
func (j *jsiiProxy_CfnInfluxDBInstance) AttrNextMaintenanceTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnInfluxDBInstance) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnInfluxDBInstance) MaintenanceSchedule() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"maintenanceSchedule",
...
func (j *jsiiProxy_CfnInfluxDBInstance)SetMaintenanceSchedule(val interface{}) {
...
func (c *jsiiProxy_CfnInfluxDBInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInfluxDBInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInfluxDBInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInfluxDBInstance) RemoveResourceDependency(target awscdk.CfnResource) {
