...
func (c *jsiiProxy_CfnDatabase) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatabase) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDatabase) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDatabase) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDatabase) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatabase) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
