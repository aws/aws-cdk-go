...
func (j *jsiiProxy_CfnFlowVpcInterface) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFlowVpcInterface) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFlowVpcInterface(scope constructs.Construct, id *string, props *CfnFlowVpcInterfaceProps) CfnFlowVpcInterface {
	...
	if err := validateNewCfnFlowVpcInterfaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnFlowVpcInterface_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFlowVpcInterface_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowVpcInterface_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFlowVpcInterface_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowVpcInterface_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFlowVpcInterface_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowVpcInterface) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowVpcInterface) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFlowVpcInterface) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFlowVpcInterface) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowVpcInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
