...
func (j *jsiiProxy_CfnBridge) AttrBridgeState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrBridgeState",
...
func (j *jsiiProxy_CfnBridge) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnBridge) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnBridge) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBridge) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnBridge) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnBridge) EgressGatewayBridge() interface{} {
...
func (j *jsiiProxy_CfnBridge) IngressGatewayBridge() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBridge) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnBridge) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnBridge) Node() constructs.Node {
...
func (j *jsiiProxy_CfnBridge) Outputs() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_CfnBridge) PlacementArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"placementArn",
...
func (j *jsiiProxy_CfnBridge) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnBridge) SourceFailoverConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBridge) Sources() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sources",
...
func (j *jsiiProxy_CfnBridge) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnBridge) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnBridge) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBridge(scope constructs.Construct, id *string, props *CfnBridgeProps) CfnBridge {
	...
	if err := validateNewCfnBridgeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBridge)SetEgressGatewayBridge(val interface{}) {
	if err := j.validateSetEgressGatewayBridgeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnBridge)SetIngressGatewayBridge(val interface{}) {
	if err := j.validateSetIngressGatewayBridgeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnBridge)SetName(val *string) {
...
func (j *jsiiProxy_CfnBridge)SetOutputs(val interface{}) {
...
func (j *jsiiProxy_CfnBridge)SetPlacementArn(val *string) {
...
func (j *jsiiProxy_CfnBridge)SetSourceFailoverConfig(val interface{}) {
...
func (j *jsiiProxy_CfnBridge)SetSources(val interface{}) {
...
func CfnBridge_ArnForBridge(resource interfacesawsmediaconnect.IBridgeRef) *string {
	...
	if err := validateCfnBridge_ArnForBridgeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnBridge_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBridge_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBridge_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBridge_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBridge_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBridge_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBridge) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnBridge) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridge) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridge) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridge) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridge) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnBridge) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridge) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBridge) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBridge) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnBridge) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBridge) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBridge) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnBridge) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnBridge) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBridge) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnBridge) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridge) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridge) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnBridge) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridge) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnBridge) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnBridge) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnBridge) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
