...
func (j *jsiiProxy_CfnFlowOutput) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFlowOutput) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnFlowOutput_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFlowOutput_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowOutput) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowOutput) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowOutput) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowOutput) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowOutput) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFlowOutput) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFlowOutput) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowOutput) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowOutput) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowOutput) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
