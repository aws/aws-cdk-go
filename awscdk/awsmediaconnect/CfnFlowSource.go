...
func (j *jsiiProxy_CfnFlowSource) CfnPropertyNames() *map[string]*string {
...
func CfnFlowSource_IsCfnFlowSource(x interface{}) *bool {
	...
	if err := validateCfnFlowSource_IsCfnFlowSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowSource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowSource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowSource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowSource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
