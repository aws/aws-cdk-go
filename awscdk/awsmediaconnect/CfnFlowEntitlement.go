...
func (j *jsiiProxy_CfnFlowEntitlement) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFlowEntitlement) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFlowEntitlement(scope constructs.Construct, id *string, props *CfnFlowEntitlementProps) CfnFlowEntitlement {
	...
	if err := validateNewCfnFlowEntitlementParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnFlowEntitlement_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFlowEntitlement_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowEntitlement_IsCfnFlowEntitlement(x interface{}) *bool {
	...
	if err := validateCfnFlowEntitlement_IsCfnFlowEntitlementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowEntitlement_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFlowEntitlement_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowEntitlement) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowEntitlement) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowEntitlement) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowEntitlement) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowEntitlement) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFlowEntitlement) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFlowEntitlement) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowEntitlement) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowEntitlement) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowEntitlement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
