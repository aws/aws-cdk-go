...
func (c *jsiiProxy_CfnFlow) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnFlow) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnFlow) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnFlow) validateSetEncodingConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFlow_EncodingConfigProperty:
		val := val.(*CfnFlow_EncodingConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFlow_EncodingConfigProperty:
		val_ := val.(CfnFlow_EncodingConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFlow_EncodingConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFlow) validateSetMaintenanceParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFlow_MaintenanceProperty:
		val := val.(*CfnFlow_MaintenanceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFlow_MaintenanceProperty:
		val_ := val.(CfnFlow_MaintenanceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFlow_MaintenanceProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFlow) validateSetMediaStreamsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnFlow_MediaStreamProperty:
				v := v.(*CfnFlow_MediaStreamProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnFlow_MediaStreamProperty:
				v_ := v.(CfnFlow_MediaStreamProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnFlow_MediaStreamProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnFlow) validateSetNdiConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFlow_NdiConfigProperty:
		val := val.(*CfnFlow_NdiConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFlow_NdiConfigProperty:
		val_ := val.(CfnFlow_NdiConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFlow_NdiConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFlow) validateSetSourceParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFlow_SourceProperty:
		val := val.(*CfnFlow_SourceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFlow_SourceProperty:
		val_ := val.(CfnFlow_SourceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFlow_SourceProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFlow) validateSetSourceFailoverConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFlow_FailoverConfigProperty:
		val := val.(*CfnFlow_FailoverConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFlow_FailoverConfigProperty:
		val_ := val.(CfnFlow_FailoverConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFlow_FailoverConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFlow) validateSetVpcInterfacesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnFlow_VpcInterfaceProperty:
				v := v.(*CfnFlow_VpcInterfaceProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnFlow_VpcInterfaceProperty:
				v_ := v.(CfnFlow_VpcInterfaceProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnFlow_VpcInterfaceProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
