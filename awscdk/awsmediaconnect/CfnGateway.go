...
func (j *jsiiProxy_CfnGateway) AttrGatewayState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGatewayState",
...
func (j *jsiiProxy_CfnGateway) EgressCidrBlocks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"egressCidrBlocks",
...
func (j *jsiiProxy_CfnGateway) Networks() interface{} {
...
func (j *jsiiProxy_CfnGateway)SetEgressCidrBlocks(val *[]*string) {
...
func (j *jsiiProxy_CfnGateway)SetNetworks(val interface{}) {
