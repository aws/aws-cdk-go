...
// The jsii proxy struct for CfnRouterOutput
type jsiiProxy_CfnRouterOutput struct {
...
func (j *jsiiProxy_CfnRouterOutput) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnRouterOutput) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnRouterOutput) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnRouterOutput) AttrIpAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIpAddress",
...
func (j *jsiiProxy_CfnRouterOutput) AttrMaintenanceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMaintenanceType",
...
func (j *jsiiProxy_CfnRouterOutput) AttrOutputType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOutputType",
...
func (j *jsiiProxy_CfnRouterOutput) AttrRoutedState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRoutedState",
...
func (j *jsiiProxy_CfnRouterOutput) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnRouterOutput) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnRouterOutput) AvailabilityZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityZone",
...
func (j *jsiiProxy_CfnRouterOutput) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRouterOutput) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRouterOutput) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRouterOutput) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouterOutput) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRouterOutput) Configuration() interface{} {
...
func (j *jsiiProxy_CfnRouterOutput) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRouterOutput) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnRouterOutput) MaintenanceConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRouterOutput) MaximumBitrate() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maximumBitrate",
...
func (j *jsiiProxy_CfnRouterOutput) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnRouterOutput) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRouterOutput) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRouterOutput) RegionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionName",
...
func (j *jsiiProxy_CfnRouterOutput) RouterOutputRef() *interfacesawsmediaconnect.RouterOutputReference {
...
func (j *jsiiProxy_CfnRouterOutput) RoutingScope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingScope",
...
func (j *jsiiProxy_CfnRouterOutput) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRouterOutput) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRouterOutput) Tier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tier",
...
func (j *jsiiProxy_CfnRouterOutput) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRouterOutput) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouterOutput(scope constructs.Construct, id *string, props *CfnRouterOutputProps) CfnRouterOutput {
	...
	if err := validateNewCfnRouterOutputParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnRouterOutput{}

	_jsii_.Create(
		"aws-cdk-lib.aws_mediaconnect.CfnRouterOutput",
...
func (j *jsiiProxy_CfnRouterOutput)SetAvailabilityZone(val *string) {
	_jsii_.Set(
		j,
		"availabilityZone",
		val,
...
func (j *jsiiProxy_CfnRouterOutput)SetConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnRouterOutput)SetMaintenanceConfiguration(val interface{}) {
	if err := j.validateSetMaintenanceConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRouterOutput)SetMaximumBitrate(val *float64) {
...
func (j *jsiiProxy_CfnRouterOutput)SetName(val *string) {
...
func (j *jsiiProxy_CfnRouterOutput)SetRegionName(val *string) {
	_jsii_.Set(
		j,
		"regionName",
		val,
...
func (j *jsiiProxy_CfnRouterOutput)SetRoutingScope(val *string) {
	if err := j.validateSetRoutingScopeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRouterOutput)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnRouterOutput)SetTier(val *string) {
...
func CfnRouterOutput_ArnForRouterOutput(resource interfacesawsmediaconnect.IRouterOutputRef) *string {
	...
	if err := validateCfnRouterOutput_ArnForRouterOutputParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRouterOutput_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouterOutput_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouterOutput_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRouterOutput_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouterOutput_IsCfnRouterOutput(x interface{}) *bool {
	...
	if err := validateCfnRouterOutput_IsCfnRouterOutputParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouterOutput_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouterOutput_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouterOutput) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRouterOutput) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouterOutput) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouterOutput) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouterOutput) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouterOutput) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRouterOutput) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouterOutput) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouterOutput) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouterOutput) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRouterOutput) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouterOutput) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouterOutput) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRouterOutput) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRouterOutput) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouterOutput) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRouterOutput) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouterOutput) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouterOutput) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRouterOutput) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouterOutput) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRouterOutput) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRouterOutput) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRouterOutput) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
