...
func (j *jsiiProxy_CfnBridgeSource) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnBridgeSource) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnBridgeSource) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBridgeSource) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnBridgeSource) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnBridgeSource) FlowSource() interface{} {
...
func (j *jsiiProxy_CfnBridgeSource) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnBridgeSource) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnBridgeSource) NetworkSource() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"networkSource",
...
func (j *jsiiProxy_CfnBridgeSource) Node() constructs.Node {
...
func (j *jsiiProxy_CfnBridgeSource) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnBridgeSource) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnBridgeSource) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnBridgeSource) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBridgeSource(scope constructs.Construct, id *string, props *CfnBridgeSourceProps) CfnBridgeSource {
	...
	if err := validateNewCfnBridgeSourceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBridgeSource)SetBridgeArn(val *string) {
...
func (j *jsiiProxy_CfnBridgeSource)SetFlowSource(val interface{}) {
	if err := j.validateSetFlowSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnBridgeSource)SetName(val *string) {
...
func (j *jsiiProxy_CfnBridgeSource)SetNetworkSource(val interface{}) {
	if err := j.validateSetNetworkSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBridgeSource_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBridgeSource_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBridgeSource_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBridgeSource_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBridgeSource_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBridgeSource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBridgeSource) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnBridgeSource) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridgeSource) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridgeSource) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridgeSource) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridgeSource) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnBridgeSource) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnBridgeSource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBridgeSource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBridgeSource) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnBridgeSource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBridgeSource) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBridgeSource) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnBridgeSource) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnBridgeSource) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBridgeSource) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnBridgeSource) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridgeSource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridgeSource) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnBridgeSource) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBridgeSource) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnBridgeSource) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnBridgeSource) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnBridgeSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
