...
func (j *jsiiProxy_CloudFormationStackDriftDetectionCheck) Env() *interfaces.ResourceEnvironment {
...
func CloudFormationStackDriftDetectionCheck_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_config.CloudFormationStackDriftDetectionCheck",
...
func (c *jsiiProxy_CloudFormationStackDriftDetectionCheck) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CloudFormationStackDriftDetectionCheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
