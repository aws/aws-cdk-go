...
func (j *jsiiProxy_CustomRule) ConfigRuleRef() *interfacesawsconfig.ConfigRuleReference {
...
func (j *jsiiProxy_CustomRule) Env() *interfaces.ResourceEnvironment {
...
func CustomRule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_config.CustomRule",
...
func (c *jsiiProxy_CustomRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CustomRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
