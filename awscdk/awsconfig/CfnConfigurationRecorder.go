...
func (j *jsiiProxy_CfnConfigurationRecorder) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConfigurationRecorder) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConfigurationRecorder) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConfigurationRecorder(scope constructs.Construct, id *string, props *CfnConfigurationRecorderProps) CfnConfigurationRecorder {
	...
	if err := validateNewCfnConfigurationRecorderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfigurationRecorder)SetRecordingGroup(val interface{}) {
	if err := j.validateSetRecordingGroupParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConfigurationRecorder_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfigurationRecorder_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationRecorder_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfigurationRecorder_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationRecorder_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfigurationRecorder_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationRecorder) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationRecorder) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfigurationRecorder) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfigurationRecorder) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationRecorder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
