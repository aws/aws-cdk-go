...
func (j *jsiiProxy_CfnOrganizationConformancePack) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOrganizationConformancePack) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOrganizationConformancePack) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
// Checks whether the given object is a CfnOrganizationConformancePack.
func CfnOrganizationConformancePack_IsCfnOrganizationConformancePack(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganizationConformancePack_IsCfnOrganizationConformancePackParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_config.CfnOrganizationConformancePack",
		"isCfnOrganizationConformancePack",
		[]interface{}{x},
		&returns,
	)
...
func CfnOrganizationConformancePack_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganizationConformancePack_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationConformancePack) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOrganizationConformancePack) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConformancePack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
