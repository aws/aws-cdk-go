...
func (j *jsiiProxy_ManagedRule) ConfigRuleRef() *interfacesawsconfig.ConfigRuleReference {
...
func (j *jsiiProxy_ManagedRule) Env() *interfaces.ResourceEnvironment {
...
func (m *jsiiProxy_ManagedRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_ManagedRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
