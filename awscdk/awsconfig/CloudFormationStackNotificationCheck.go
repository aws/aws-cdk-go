...
func (j *jsiiProxy_CloudFormationStackNotificationCheck) ConfigRuleRef() *interfacesawsconfig.ConfigRuleReference {
...
func (j *jsiiProxy_CloudFormationStackNotificationCheck) Env() *interfaces.ResourceEnvironment {
...
func (c *jsiiProxy_CloudFormationStackNotificationCheck) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CloudFormationStackNotificationCheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
