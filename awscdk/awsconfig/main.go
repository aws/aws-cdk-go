...
func init() {
	...
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_config.CfnConnector",
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsconfigIConnectorRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_config.CfnConnector.AzureConnectorConfigurationProperty",
		reflect.TypeOf((*CfnConnector_AzureConnectorConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_config.CfnConnector.ConnectorConfigurationProperty",
		reflect.TypeOf((*CfnConnector_ConnectorConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_config.CfnConnectorProps",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnOrganizationConfigRule_OrganizationCustomPolicyRuleMetadataProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
