...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_config.CfnConformancePack.TemplateSSMDocumentDetailsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_config.CfnOrganizationConfigRule.OrganizationCustomPolicyRuleMetadataProperty",
