...
func (j *jsiiProxy_CfnAggregationAuthorization) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAggregationAuthorization) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAggregationAuthorization) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAggregationAuthorization(scope constructs.Construct, id *string, props *CfnAggregationAuthorizationProps) CfnAggregationAuthorization {
	...
	if err := validateNewCfnAggregationAuthorizationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAggregationAuthorization)SetAuthorizedAccountId(val *string) {
	if err := j.validateSetAuthorizedAccountIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAggregationAuthorization_ArnForAggregationAuthorization(resource interfacesawsconfig.IAggregationAuthorizationRef) *string {
	_init_.Initialize()

	if err := validateCfnAggregationAuthorization_ArnForAggregationAuthorizationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_config.CfnAggregationAuthorization",
		"arnForAggregationAuthorization",
		[]interface{}{resource},
		&returns,
	)
...
func CfnAggregationAuthorization_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAggregationAuthorization_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAggregationAuthorization_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAggregationAuthorization_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAggregationAuthorization_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAggregationAuthorization_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAggregationAuthorization) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAggregationAuthorization) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAggregationAuthorization) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAggregationAuthorization) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAggregationAuthorization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
