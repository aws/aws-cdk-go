...
func (j *jsiiProxy_CfnOrganizationConfigRule) OrganizationCustomPolicyRuleMetadata() interface{} {
...
func (j *jsiiProxy_CfnOrganizationConfigRule)SetOrganizationCustomPolicyRuleMetadata(val interface{}) {
	if err := j.validateSetOrganizationCustomPolicyRuleMetadataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
