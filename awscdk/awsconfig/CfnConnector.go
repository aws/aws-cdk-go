...
//
//   cfnConnector := awscdk.Aws_config.NewCfnConnector(this, jsii.String("MyCfnConnector"), &CfnConnectorProps{
...
type CfnConnector interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsconfig.IConnectorRef
	awscdk.ITaggableV2
	...
	ConnectorRef() *interfacesawsconfig.ConnectorReference
...
type jsiiProxy_CfnConnector struct {
	...
	internal.Type__interfacesawsconfigIConnectorRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnConnector) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnConnector) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnConnector) AttrName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrName",
...
func (j *jsiiProxy_CfnConnector) ConnectorRef() *interfacesawsconfig.ConnectorReference {
	var returns *interfacesawsconfig.ConnectorReference
	_jsii_.Get(
		j,
		"connectorRef",
		&returns,
...
func CfnConnector_ArnForConnector(resource interfacesawsconfig.IConnectorRef) *string {
	_init_.Initialize()
