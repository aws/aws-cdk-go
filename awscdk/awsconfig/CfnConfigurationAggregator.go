...
func (j *jsiiProxy_CfnConfigurationAggregator) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConfigurationAggregator) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConfigurationAggregator) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConfigurationAggregator(scope constructs.Construct, id *string, props *CfnConfigurationAggregatorProps) CfnConfigurationAggregator {
	...
	if err := validateNewCfnConfigurationAggregatorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfigurationAggregator)SetAccountAggregationSources(val interface{}) {
	if err := j.validateSetAccountAggregationSourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfigurationAggregator)SetOrganizationAggregationSource(val interface{}) {
	if err := j.validateSetOrganizationAggregationSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConfigurationAggregator_ArnForConfigurationAggregator(resource interfacesawsconfig.IConfigurationAggregatorRef) *string {
	_init_.Initialize()

	if err := validateCfnConfigurationAggregator_ArnForConfigurationAggregatorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnConfigurationAggregator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfigurationAggregator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationAggregator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfigurationAggregator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationAggregator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationAggregator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfigurationAggregator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfigurationAggregator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAggregator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
