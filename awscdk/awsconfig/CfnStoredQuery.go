...
func (j *jsiiProxy_CfnStoredQuery) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStoredQuery) Node() constructs.Node {
...
func (j *jsiiProxy_CfnStoredQuery) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStoredQuery(scope constructs.Construct, id *string, props *CfnStoredQueryProps) CfnStoredQuery {
	...
	if err := validateNewCfnStoredQueryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnStoredQuery_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStoredQuery_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStoredQuery_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStoredQuery_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStoredQuery_IsCfnStoredQuery(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStoredQuery_IsCfnStoredQueryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStoredQuery_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStoredQuery_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStoredQuery) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStoredQuery) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStoredQuery) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStoredQuery) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStoredQuery) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStoredQuery) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStoredQuery) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStoredQuery) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStoredQuery) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStoredQuery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
