...
func (j *jsiiProxy_CfnOrganizationConfigRule) CfnPropertyNames() *map[string]*string {
...
func CfnOrganizationConfigRule_IsCfnOrganizationConfigRule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganizationConfigRule_IsCfnOrganizationConfigRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationConfigRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganizationConfigRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationConfigRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
