...
func (j *jsiiProxy_CfnConfigRule) CfnPropertyNames() *map[string]*string {
...
func CfnConfigRule_ArnForConfigRule(resource interfacesawsconfig.IConfigRuleRef) *string {
	_init_.Initialize()

	if err := validateCfnConfigRule_ArnForConfigRuleParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnConfigRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
