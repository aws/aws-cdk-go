...
func (j *jsiiProxy_CfnDeliveryChannel) CfnPropertyNames() *map[string]*string {
...
func CfnDeliveryChannel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeliveryChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeliveryChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeliveryChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeliveryChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeliveryChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeliveryChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeliveryChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
