...
func (c *jsiiProxy_CloudFormationStackDriftDetectionCheck) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateCloudFormationStackDriftDetectionCheck_FromConfigRuleNameParameters(scope constructs.Construct, id *string, configRuleName *string) error {
	...
	if configRuleName == nil {
		return fmt.Errorf("parameter configRuleName is required, but nil was provided")
	}
