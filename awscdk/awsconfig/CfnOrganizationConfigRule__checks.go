...
func (c *jsiiProxy_CfnOrganizationConfigRule) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnOrganizationConfigRule) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnOrganizationConfigRule) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnOrganizationConfigRule_ArnForOrganizationConfigRuleParameters(resource interfacesawsconfig.IOrganizationConfigRuleRef) error {
	if resource == nil {
...
func validateCfnOrganizationConfigRule_FromOrganizationConfigRuleIdParameters(scope constructs.Construct, id *string, organizationConfigRuleId *string) error {
	...
	if organizationConfigRuleId == nil {
		return fmt.Errorf("parameter organizationConfigRuleId is required, but nil was provided")
	}
...
func validateCfnOrganizationConfigRule_IsCfnOrganizationConfigRuleParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateCfnOrganizationConfigRule_IsCfnResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
