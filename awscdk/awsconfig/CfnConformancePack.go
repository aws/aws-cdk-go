...
func (j *jsiiProxy_CfnConformancePack) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnConformancePack) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConformancePack) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConformancePack) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConformancePack) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConformancePack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
