...
func (j *jsiiProxy_CfnInstanceStorageConfig) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
