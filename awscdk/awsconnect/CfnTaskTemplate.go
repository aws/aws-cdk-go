...
func (j *jsiiProxy_CfnTaskTemplate) CfnPropertyNames() *map[string]*string {
...
func NewCfnTaskTemplate(scope constructs.Construct, id *string, props *CfnTaskTemplateProps) CfnTaskTemplate {
	...
	if err := validateNewCfnTaskTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTaskTemplate_ArnForTaskTemplate(resource interfacesawsconnect.ITaskTemplateRef) *string {
	...
	if err := validateCfnTaskTemplate_ArnForTaskTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTaskTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTaskTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTaskTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTaskTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTaskTemplate_IsCfnTaskTemplate(x interface{}) *bool {
	...
	if err := validateCfnTaskTemplate_IsCfnTaskTemplateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTaskTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTaskTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTaskTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTaskTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTaskTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTaskTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTaskTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTaskTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
