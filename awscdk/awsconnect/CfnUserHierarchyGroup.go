...
func (j *jsiiProxy_CfnUserHierarchyGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnUserHierarchyGroup(scope constructs.Construct, id *string, props *CfnUserHierarchyGroupProps) CfnUserHierarchyGroup {
	...
	if err := validateNewCfnUserHierarchyGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserHierarchyGroup_ArnForUserHierarchyGroup(resource interfacesawsconnect.IUserHierarchyGroupRef) *string {
	...
	if err := validateCfnUserHierarchyGroup_ArnForUserHierarchyGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnUserHierarchyGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserHierarchyGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserHierarchyGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserHierarchyGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserHierarchyGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserHierarchyGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserHierarchyGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserHierarchyGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserHierarchyGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
