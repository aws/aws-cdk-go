...
func (j *jsiiProxy_CfnView) AttrViewContentSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnView) AttrViewId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrViewId",
...
func (j *jsiiProxy_CfnView) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnView) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnView) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnView) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnView) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnView) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnView) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnView) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnView) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnView) Node() constructs.Node {
...
func (j *jsiiProxy_CfnView) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnView) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnView) Template() interface{} {
...
func (j *jsiiProxy_CfnView) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnView(scope constructs.Construct, id *string, props *CfnViewProps) CfnView {
	...
	if err := validateNewCfnViewParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnView{}
...
func (j *jsiiProxy_CfnView)SetActions(val *[]*string) {
...
func (j *jsiiProxy_CfnView)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnView)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnView)SetName(val *string) {
...
func (j *jsiiProxy_CfnView)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnView)SetTemplate(val interface{}) {
...
func CfnView_ArnForView(resource interfacesawsconnect.IViewRef) *string {
	...
	if err := validateCfnView_ArnForViewParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnView_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnView_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnView_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnView_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnView_IsCfnView(x interface{}) *bool {
	...
	if err := validateCfnView_IsCfnViewParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnView_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnView_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnView) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnView) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnView) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnView) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnView) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnView) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnView) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnView) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnView) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnView) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnView) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnView) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnView) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnView) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnView) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnView) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnView) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnView) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnView) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnView) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnView) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnView) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnView) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnView) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
