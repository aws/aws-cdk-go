...
func (j *jsiiProxy_CfnQueue) AttrType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrType",
...
func (j *jsiiProxy_CfnQueue) HoursOfOperationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hoursOfOperationArn",
...
func (j *jsiiProxy_CfnQueue) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnQueue) MaxContacts() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxContacts",
...
func (j *jsiiProxy_CfnQueue) OutboundCallerConfig() interface{} {
...
func (j *jsiiProxy_CfnQueue) QueueRef() *interfacesawsconnect.QueueReference {
	var returns *interfacesawsconnect.QueueReference
	_jsii_.Get(
		j,
		"queueRef",
		&returns,
...
func (j *jsiiProxy_CfnQueue)SetHoursOfOperationArn(val *string) {
...
func (j *jsiiProxy_CfnQueue)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnQueue)SetMaxContacts(val *float64) {
	_jsii_.Set(
		j,
		"maxContacts",
		val,
...
func (j *jsiiProxy_CfnQueue)SetOutboundCallerConfig(val interface{}) {
	if err := j.validateSetOutboundCallerConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnQueue)SetQuickConnectArns(val *[]*string) {
	_jsii_.Set(
		j,
		"quickConnectArns",
		val,
