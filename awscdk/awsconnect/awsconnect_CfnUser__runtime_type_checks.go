...
func (c *jsiiProxy_CfnUser) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_CfnUser) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateCfnUser_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnUser) validateSetIdentityInfoParameters(val interface{}) error {
	...
	case CfnUser_UserIdentityInfoProperty:
		val_ := val.(CfnUser_UserIdentityInfoProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnUser) validateSetInstanceArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnUser) validateSetPhoneConfigParameters(val interface{}) error {
	...
	case CfnUser_UserPhoneConfigProperty:
		val_ := val.(CfnUser_UserPhoneConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnUser) validateSetRoutingProfileArnParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnUser) validateSetSecurityProfileArnsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnUser) validateSetUsernameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCfnUserParameters(scope awscdk.Construct, id *string, props *CfnUserProps) error {
	if scope == nil {
