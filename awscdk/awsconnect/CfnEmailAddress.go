...
func (j *jsiiProxy_CfnEmailAddress) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEmailAddress) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnEmailAddress) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnEmailAddress) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEmailAddress) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnEmailAddress) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnEmailAddress) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnEmailAddress) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnEmailAddress) EmailAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"emailAddress",
...
func (j *jsiiProxy_CfnEmailAddress) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnEmailAddress) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnEmailAddress) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEmailAddress) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnEmailAddress) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnEmailAddress) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnEmailAddress) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnEmailAddress) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEmailAddress(scope constructs.Construct, id *string, props *CfnEmailAddressProps) CfnEmailAddress {
	...
	if err := validateNewCfnEmailAddressParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEmailAddress)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnEmailAddress)SetDisplayName(val *string) {
	_jsii_.Set(
		j,
		"displayName",
		val,
...
func (j *jsiiProxy_CfnEmailAddress)SetEmailAddress(val *string) {
...
func (j *jsiiProxy_CfnEmailAddress)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnEmailAddress)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnEmailAddress_ArnForEmailAddress(resource interfacesawsconnect.IEmailAddressRef) *string {
	...
	if err := validateCfnEmailAddress_ArnForEmailAddressParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEmailAddress_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEmailAddress_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEmailAddress_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEmailAddress_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEmailAddress_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEmailAddress_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEmailAddress) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnEmailAddress) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailAddress) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailAddress) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnEmailAddress) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnEmailAddress) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnEmailAddress) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnEmailAddress) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEmailAddress) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEmailAddress) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnEmailAddress) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEmailAddress) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEmailAddress) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnEmailAddress) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnEmailAddress) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEmailAddress) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnEmailAddress) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailAddress) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailAddress) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnEmailAddress) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailAddress) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnEmailAddress) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnEmailAddress) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnEmailAddress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
