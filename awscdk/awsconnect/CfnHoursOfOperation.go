...
func (j *jsiiProxy_CfnHoursOfOperation) CfnPropertyNames() *map[string]*string {
...
func CfnHoursOfOperation_ArnForHoursOfOperation(resource interfacesawsconnect.IHoursOfOperationRef) *string {
	...
	if err := validateCfnHoursOfOperation_ArnForHoursOfOperationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnHoursOfOperation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHoursOfOperation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHoursOfOperation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHoursOfOperation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHoursOfOperation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHoursOfOperation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHoursOfOperation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
