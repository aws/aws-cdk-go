...
func (j *jsiiProxy_CfnEvaluationForm) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEvaluationForm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEvaluationForm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEvaluationForm) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEvaluationForm) RemoveResourceDependency(target awscdk.CfnResource) {
