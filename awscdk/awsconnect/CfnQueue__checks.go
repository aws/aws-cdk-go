...
func (j *jsiiProxy_CfnQueue) validateSetAdditionalEmailAddressesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnQueue_EmailAddressProperty:
				v := v.(*CfnQueue_EmailAddressProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnQueue_EmailAddressProperty:
				v_ := v.(CfnQueue_EmailAddressProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnQueue_EmailAddressProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnQueue) validateSetOutboundEmailConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnQueue_OutboundEmailConfigProperty:
		val := val.(*CfnQueue_OutboundEmailConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnQueue_OutboundEmailConfigProperty:
		val_ := val.(CfnQueue_OutboundEmailConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnQueue_OutboundEmailConfigProperty; received %#v (a %T)", val, val)
		}
	}
