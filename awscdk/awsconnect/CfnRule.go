...
func (j *jsiiProxy_CfnRule) AttrRuleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRuleArn",
...
func (j *jsiiProxy_CfnRule) Function() *string {
	var returns *string
	_jsii_.Get(
		j,
		"function",
...
func (j *jsiiProxy_CfnRule) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnRule) PublishStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publishStatus",
...
func (j *jsiiProxy_CfnRule)SetActions(val interface{}) {
...
func (j *jsiiProxy_CfnRule)SetFunction(val *string) {
...
func (j *jsiiProxy_CfnRule)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnRule)SetPublishStatus(val *string) {
	if err := j.validateSetPublishStatusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRule)SetTriggerEventSource(val interface{}) {
	if err := j.validateSetTriggerEventSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
