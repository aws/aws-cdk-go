...
//
//   cfnTestCase := awscdk.Aws_connect.NewCfnTestCase(this, jsii.String("MyCfnTestCase"), &CfnTestCaseProps{
...
type CfnTestCase interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsconnect.ITestCaseRef
	awscdk.ITaggableV2
	...
	SetEntryPoint(val interface{})
	Env() *interfaces.ResourceEnvironment
	// The initialization data of the test case.
	InitializationData() *string
	SetInitializationData(val *string)
	...
	TestCaseRef() *interfacesawsconnect.TestCaseReference
	// Deprecated.
...
type jsiiProxy_CfnTestCase struct {
	...
	internal.Type__interfacesawsconnectITestCaseRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnTestCase) AttrLastModifiedRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTestCase) AttrLastModifiedTime() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnTestCase) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_CfnTestCase) EntryPoint() interface{} {
...
func (j *jsiiProxy_CfnTestCase) InitializationData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"initializationData",
...
func (j *jsiiProxy_CfnTestCase) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnTestCase) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnTestCase) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTestCase) TestCaseRef() *interfacesawsconnect.TestCaseReference {
	var returns *interfacesawsconnect.TestCaseReference
	_jsii_.Get(
		j,
		"testCaseRef",
		&returns,
...
func (j *jsiiProxy_CfnTestCase)SetContent(val *string) {
...
func (j *jsiiProxy_CfnTestCase)SetEntryPoint(val interface{}) {
...
func (j *jsiiProxy_CfnTestCase)SetInitializationData(val *string) {
	_jsii_.Set(
		j,
		"initializationData",
		val,
...
func (j *jsiiProxy_CfnTestCase)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnTestCase)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func (j *jsiiProxy_CfnTestCase)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnTestCase_ArnForTestCase(resource interfacesawsconnect.ITestCaseRef) *string {
	_init_.Initialize()
