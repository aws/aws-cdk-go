...
func (j *jsiiProxy_CfnSecurityKey) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSecurityKey) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSecurityKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityKey) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSecurityKey) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSecurityKey) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_CfnSecurityKey) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_CfnSecurityKey) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSecurityKey) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSecurityKey) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSecurityKey) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSecurityKey) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSecurityKey) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityKey(scope constructs.Construct, id *string, props *CfnSecurityKeyProps) CfnSecurityKey {
	...
	if err := validateNewCfnSecurityKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSecurityKey)SetInstanceId(val *string) {
...
func (j *jsiiProxy_CfnSecurityKey)SetKey(val *string) {
...
func CfnSecurityKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecurityKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSecurityKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecurityKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityKey) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSecurityKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityKey) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityKey) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityKey) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityKey) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSecurityKey) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityKey) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSecurityKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityKey) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSecurityKey) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSecurityKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityKey) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSecurityKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityKey) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSecurityKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityKey) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityKey) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSecurityKey) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSecurityKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
