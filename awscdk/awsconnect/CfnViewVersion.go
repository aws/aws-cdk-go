...
func (j *jsiiProxy_CfnViewVersion) AttrViewVersionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrViewVersionArn",
...
func (j *jsiiProxy_CfnViewVersion) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnViewVersion) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnViewVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnViewVersion) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnViewVersion) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnViewVersion) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnViewVersion) Node() constructs.Node {
...
func (j *jsiiProxy_CfnViewVersion) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnViewVersion) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnViewVersion) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnViewVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnViewVersion) VersionDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionDescription",
...
func (j *jsiiProxy_CfnViewVersion) ViewArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"viewArn",
...
func (j *jsiiProxy_CfnViewVersion) ViewContentSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
		"viewContentSha256",
...
func NewCfnViewVersion(scope constructs.Construct, id *string, props *CfnViewVersionProps) CfnViewVersion {
	...
	if err := validateNewCfnViewVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnViewVersion{}
...
func (j *jsiiProxy_CfnViewVersion)SetVersionDescription(val *string) {
	_jsii_.Set(
		j,
		"versionDescription",
		val,
...
func (j *jsiiProxy_CfnViewVersion)SetViewArn(val *string) {
...
func (j *jsiiProxy_CfnViewVersion)SetViewContentSha256(val *string) {
	_jsii_.Set(
		j,
		"viewContentSha256",
		val,
...
func CfnViewVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnViewVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnViewVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnViewVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnViewVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnViewVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnViewVersion) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnViewVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnViewVersion) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnViewVersion) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnViewVersion) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnViewVersion) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnViewVersion) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnViewVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnViewVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnViewVersion) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnViewVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnViewVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnViewVersion) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnViewVersion) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnViewVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnViewVersion) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnViewVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnViewVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnViewVersion) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnViewVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnViewVersion) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnViewVersion) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnViewVersion) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnViewVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
