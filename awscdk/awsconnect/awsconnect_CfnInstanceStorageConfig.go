...
func (j *jsiiProxy_CfnInstanceStorageConfig) Node() awscdk.ConstructNode {
...
func NewCfnInstanceStorageConfig(scope awscdk.Construct, id *string, props *CfnInstanceStorageConfigProps) CfnInstanceStorageConfig {
	_init_.Initialize()
...
// Create a new `AWS::Connect::InstanceStorageConfig`.
func NewCfnInstanceStorageConfig_Override(c CfnInstanceStorageConfig, scope awscdk.Construct, id *string, props *CfnInstanceStorageConfigProps) {
	_init_.Initialize()
...
func CfnInstanceStorageConfig_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnInstanceStorageConfig_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInstanceStorageConfig) GetAtt(attributeName *string) awscdk.Reference {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnInstanceStorageConfig) OnSynthesize(session constructs.ISynthesisSession) {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnInstanceStorageConfig) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnInstanceStorageConfig) Synthesize(session awscdk.ISynthesisSession) {
...
func (c *jsiiProxy_CfnInstanceStorageConfig) Validate() *[]*string {
	var returns *[]*string
