...
func (j *jsiiProxy_CfnPrompt) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnPrompt) S3Uri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3Uri",
...
func NewCfnPrompt(scope constructs.Construct, id *string, props *CfnPromptProps) CfnPrompt {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_connect.CfnPrompt",
...
func (j *jsiiProxy_CfnPrompt)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnPrompt)SetS3Uri(val *string) {
	_jsii_.Set(
		j,
		"s3Uri",
		val,
