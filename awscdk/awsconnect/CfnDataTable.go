...
// The jsii proxy struct for CfnDataTable
type jsiiProxy_CfnDataTable struct {
	internal.Type__awscdkCfnResource
	internal.Type__awscdkIInspectable
	internal.Type__interfacesawsconnectIDataTableRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnDataTable) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnDataTable) AttrCreatedTime() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnDataTable) AttrLastModifiedRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataTable) AttrLastModifiedTime() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataTable) AttrLockVersion() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrLockVersion",
...
func (j *jsiiProxy_CfnDataTable) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDataTable) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDataTable) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDataTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataTable) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDataTable) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDataTable) DataTableRef() *interfacesawsconnect.DataTableReference {
	var returns *interfacesawsconnect.DataTableReference
	_jsii_.Get(
		j,
		"dataTableRef",
		&returns,
...
func (j *jsiiProxy_CfnDataTable) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDataTable) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnDataTable) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnDataTable) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDataTable) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDataTable) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDataTable) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDataTable) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDataTable) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnDataTable) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDataTable) TimeZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"timeZone",
...
func (j *jsiiProxy_CfnDataTable) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDataTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnDataTable) ValueLockLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"valueLockLevel",
...
func NewCfnDataTable(scope constructs.Construct, id *string, props *CfnDataTableProps) CfnDataTable {
	...
	if err := validateNewCfnDataTableParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDataTable)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDataTable)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDataTable_ArnForDataTable(resource interfacesawsconnect.IDataTableRef) *string {
	...
	if err := validateCfnDataTable_ArnForDataTableParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDataTable_IsCfnDataTable(x interface{}) *bool {
	...
	if err := validateCfnDataTable_IsCfnDataTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataTable_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDataTable_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataTable_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDataTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataTable_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDataTable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataTable) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDataTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataTable) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataTable) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataTable) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataTable) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDataTable) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataTable) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDataTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataTable) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDataTable) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDataTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataTable) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDataTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataTable) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDataTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataTable) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDataTable) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDataTable) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDataTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
