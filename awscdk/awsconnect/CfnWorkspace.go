...
type jsiiProxy_CfnWorkspace struct {
	...
	internal.Type__interfacesawsconnectIWorkspaceRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnWorkspace) Associations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"associations",
...
func (j *jsiiProxy_CfnWorkspace) InstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceArn",
...
func (j *jsiiProxy_CfnWorkspace) Media() interface{} {
...
func (j *jsiiProxy_CfnWorkspace) Pages() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"pages",
...
func (j *jsiiProxy_CfnWorkspace) Theme() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"theme",
...
func (j *jsiiProxy_CfnWorkspace) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_CfnWorkspace) Visibility() *string {
	var returns *string
	_jsii_.Get(
		j,
		"visibility",
...
func (j *jsiiProxy_CfnWorkspace) WorkspaceRef() *interfacesawsconnect.WorkspaceReference {
	var returns *interfacesawsconnect.WorkspaceReference
	_jsii_.Get(
		j,
		"workspaceRef",
		&returns,
...
func NewCfnWorkspace(scope constructs.Construct, id *string, props *CfnWorkspaceProps) CfnWorkspace {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_connect.CfnWorkspace",
...
func (j *jsiiProxy_CfnWorkspace)SetAssociations(val *[]*string) {
	_jsii_.Set(
		j,
		"associations",
		val,
...
func (j *jsiiProxy_CfnWorkspace)SetInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnWorkspace)SetMedia(val interface{}) {
...
func (j *jsiiProxy_CfnWorkspace)SetPages(val interface{}) {
	if err := j.validateSetPagesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnWorkspace)SetTheme(val interface{}) {
...
func (j *jsiiProxy_CfnWorkspace)SetTitle(val *string) {
	_jsii_.Set(
		j,
		"title",
		val,
...
func (j *jsiiProxy_CfnWorkspace)SetVisibility(val *string) {
	_jsii_.Set(
		j,
		"visibility",
		val,
