...
func (j *jsiiProxy_CfnHookVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHookVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnHookVersion(scope constructs.Construct, id *string, props *CfnHookVersionProps) CfnHookVersion {
	...
	if err := validateNewCfnHookVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnHookVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnHookVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHookVersion_IsCfnHookVersion(x interface{}) *bool {
	...
	if err := validateCfnHookVersion_IsCfnHookVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHookVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHookVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHookVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnHookVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHookVersion) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnHookVersion) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHookVersion) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnHookVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHookVersion) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnHookVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHookVersion) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnHookVersion) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnHookVersion) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnHookVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
