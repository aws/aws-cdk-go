...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrApplicationLastUpdateDate", GoGetter: "AttrApplicationLastUpdateDate"},
			_jsii_.MemberProperty{JsiiProperty: "attrApplicationState", GoGetter: "AttrApplicationState"},
			_jsii_.MemberProperty{JsiiProperty: "attrApplicationUrl", GoGetter: "AttrApplicationUrl"},
