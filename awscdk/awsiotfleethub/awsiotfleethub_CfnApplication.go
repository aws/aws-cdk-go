...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsiotfleethub/internal"
...
func (j *jsiiProxy_CfnApplication) AttrApplicationCreationDate() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) AttrApplicationLastUpdateDate() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) AttrApplicationState() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) AttrApplicationUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrApplicationUrl",
...
func (j *jsiiProxy_CfnApplication) AttrErrorMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrErrorMessage",
...
func (j *jsiiProxy_CfnApplication) AttrSsoClientId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSsoClientId",
