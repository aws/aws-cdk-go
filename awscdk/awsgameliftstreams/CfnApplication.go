...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsgameliftstreams.IApplicationRef
	awscdk.ITaggableV2
	...
	ApplicationRef() *interfacesawsgameliftstreams.ApplicationReference
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsgameliftstreamsIApplicationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnApplication) ApplicationLogOutputUri() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) ApplicationLogPaths() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"applicationLogPaths",
...
func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawsgameliftstreams.ApplicationReference {
	var returns *interfacesawsgameliftstreams.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) ApplicationSourceUri() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) ExecutablePath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executablePath",
...
func (j *jsiiProxy_CfnApplication) RuntimeEnvironment() interface{} {
...
func (j *jsiiProxy_CfnApplication) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func NewCfnApplication(scope constructs.Construct, id *string, props *CfnApplicationProps) CfnApplication {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_gameliftstreams.CfnApplication",
...
func (j *jsiiProxy_CfnApplication)SetApplicationLogOutputUri(val *string) {
	_jsii_.Set(
		j,
		"applicationLogOutputUri",
		val,
...
func (j *jsiiProxy_CfnApplication)SetApplicationLogPaths(val *[]*string) {
	_jsii_.Set(
		j,
		"applicationLogPaths",
		val,
...
func (j *jsiiProxy_CfnApplication)SetApplicationSourceUri(val *string) {
	if err := j.validateSetApplicationSourceUriParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetExecutablePath(val *string) {
...
func (j *jsiiProxy_CfnApplication)SetRuntimeEnvironment(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnApplication_ArnForApplication(resource interfacesawsgameliftstreams.IApplicationRef) *string {
	_init_.Initialize()
