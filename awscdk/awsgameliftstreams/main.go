...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_gameliftstreams.ApplicationReference",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "applicationLogOutputUri", GoGetter: "ApplicationLogOutputUri"},
			_jsii_.MemberProperty{JsiiProperty: "applicationLogPaths", GoGetter: "ApplicationLogPaths"},
			_jsii_.MemberProperty{JsiiProperty: "applicationRef", GoGetter: "ApplicationRef"},
			_jsii_.MemberProperty{JsiiProperty: "applicationSourceUri", GoGetter: "ApplicationSourceUri"},
			...
			_jsii_.MemberProperty{JsiiProperty: "executablePath", GoGetter: "ExecutablePath"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_gameliftstreams.CfnApplication.RuntimeEnvironmentProperty",
		reflect.TypeOf((*CfnApplication_RuntimeEnvironmentProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnStreamGroup)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "cfnResourceType", GoGetter: "CfnResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "defaultApplication", GoGetter: "DefaultApplication"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			_jsii_.MemberMethod{JsiiMethod: "getMetadata", GoMethod: "GetMetadata"},
			_jsii_.MemberMethod{JsiiMethod: "inspect", GoMethod: "Inspect"},
			_jsii_.MemberProperty{JsiiProperty: "locationConfigurations", GoGetter: "LocationConfigurations"},
			_jsii_.MemberProperty{JsiiProperty: "logicalId", GoGetter: "LogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "obtainDependencies", GoMethod: "ObtainDependencies"},
			_jsii_.MemberMethod{JsiiMethod: "obtainResourceDependencies", GoMethod: "ObtainResourceDependencies"},
			...
			_jsii_.MemberMethod{JsiiMethod: "shouldSynthesize", GoMethod: "ShouldSynthesize"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "streamClass", GoGetter: "StreamClass"},
		...
		func() interface{} {
			j := jsiiProxy_CfnStreamGroup{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IStreamGroupRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnStreamGroup_DefaultApplicationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_gameliftstreams.IStreamGroupRef",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_gameliftstreams.StreamGroupReference",
