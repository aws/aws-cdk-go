...
func (j *jsiiProxy_CustomResource) Env() *interfaces.ResourceEnvironment {
...
func (c *jsiiProxy_CustomResource) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CustomResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
