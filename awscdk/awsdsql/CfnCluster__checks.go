...
func (j *jsiiProxy_CfnCluster) validateSetDeletionProtectionEnabledParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnCluster) validateSetMultiRegionPropertiesParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_MultiRegionPropertiesProperty:
		val := val.(*CfnCluster_MultiRegionPropertiesProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_MultiRegionPropertiesProperty:
		val_ := val.(CfnCluster_MultiRegionPropertiesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_MultiRegionPropertiesProperty; received %#v (a %T)", val, val)
		}
	}
