...
func (j *jsiiProxy_CfnCluster) AttrEncryptionDetails() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnCluster) AttrIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentifier",
...
func (j *jsiiProxy_CfnCluster) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCluster) DeletionProtectionEnabled() interface{} {
...
func (j *jsiiProxy_CfnCluster) KmsEncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsEncryptionKey",
...
func (j *jsiiProxy_CfnCluster)SetDeletionProtectionEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnCluster)SetKmsEncryptionKey(val *string) {
	_jsii_.Set(
		j,
		"kmsEncryptionKey",
		val,
...
func (c *jsiiProxy_CfnCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCluster) RemoveResourceDependency(target awscdk.CfnResource) {
