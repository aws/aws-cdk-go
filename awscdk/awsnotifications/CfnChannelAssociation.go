...
func (j *jsiiProxy_CfnChannelAssociation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnChannelAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnChannelAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnChannelAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnChannelAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnChannelAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnChannelAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnChannelAssociation) NotificationConfigurationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnChannelAssociation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnChannelAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnChannelAssociation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnChannelAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnChannelAssociation(scope constructs.Construct, id *string, props *CfnChannelAssociationProps) CfnChannelAssociation {
	...
	if err := validateNewCfnChannelAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnChannelAssociation)SetArn(val *string) {
...
func (j *jsiiProxy_CfnChannelAssociation)SetNotificationConfigurationArn(val *string) {
...
func CfnChannelAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnChannelAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnChannelAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnChannelAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnChannelAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnChannelAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnChannelAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnChannelAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnChannelAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnChannelAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnChannelAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnChannelAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnChannelAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnChannelAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnChannelAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnChannelAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnChannelAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnChannelAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnChannelAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnChannelAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
