...
awscdk.CrossStackReferences_Of(consumer).Consume(awscdk.ReferenceStrength_WEAK)
```
...
bucket := s3.NewBucket(producer, jsii.String("SharedBucket"))
...
// This reference will use Fn::GetStackOutput regardless of the global setting
awscdk.NewCfnOutput(consumer, jsii.String("BucketName"), &CfnOutputProps{
...
consumer := awscdk.Newstack(app, jsii.String("Consumer"), &StackProps{
	Env: &Environment{
		Account: jsii.String("123456789012"),
		Region: jsii.String("us-east-1"),
	},
})
sns.NewSubscription(consumer, jsii.String("Subscription"), &SubscriptionProps{
	Topic: sns.Topic_FromTopicArn(consumer, jsii.String("Topic"), awscdk.*stack_ConsumeReference(topic.topicArn, awscdk.ReferenceStrength_WEAK)),
...
awscdk.NewCfnOutput(consumer, jsii.String("BucketArn"), &CfnOutputProps{
	Value: awscdk.*stack_ConsumeReference(bucket.bucketArn),
})
```
...
app := awscdk.NewApp()
awscdk.Validations_Of(app).AddPlugins(NewThirdPartyPluginX())
awscdk.Validations_Of(app).AddPlugins(NewThirdPartyPluginY())

// only apply to a particular stage
prodStage := awscdk.NewStage(app, jsii.String("ProdStage"))
awscdk.Validations_Of(prodStage).AddPlugins(NewThirdPartyPluginX())
```
...
app := awscdk.NewApp(&AppProps{
	Context: map[string]interface{}{
		"@aws-cdk/core:validationReportPrettyPrint": jsii.Boolean(false),
	},
})
```
