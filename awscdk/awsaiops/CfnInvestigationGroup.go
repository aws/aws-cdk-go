...
func (j *jsiiProxy_CfnInvestigationGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInvestigationGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInvestigationGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInvestigationGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInvestigationGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInvestigationGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
