...
func (j *jsiiProxy_CfnCanary) CfnPropertyNames() *map[string]*string {
...
func CfnCanary_IsCfnCanary(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCanary_IsCfnCanaryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCanary) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCanary) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCanary) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCanary) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCanary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
