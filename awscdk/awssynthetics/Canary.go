...
func (c *jsiiProxy_Canary) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_Canary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
