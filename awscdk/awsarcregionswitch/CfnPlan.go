...
func (j *jsiiProxy_CfnPlan) AssociatedAlarms() interface{} {
...
func (j *jsiiProxy_CfnPlan) AttrHealthChecksForPlan() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrHealthChecksForPlan",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPlan) AttrOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwner",
...
func (j *jsiiProxy_CfnPlan) AttrRoute53HealthChecks() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrRoute53HealthChecks",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPlan) AttrVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersion",
...
func (j *jsiiProxy_CfnPlan) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPlan) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPlan) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPlan) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPlan) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPlan) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPlan) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnPlan) ExecutionRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executionRole",
...
func (j *jsiiProxy_CfnPlan) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPlan) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPlan) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPlan) PrimaryRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"primaryRegion",
...
func (j *jsiiProxy_CfnPlan) RecoveryApproach() *string {
	var returns *string
	_jsii_.Get(
		j,
		"recoveryApproach",
...
func (j *jsiiProxy_CfnPlan) RecoveryTimeObjectiveMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPlan) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPlan) Regions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"regions",
...
func (j *jsiiProxy_CfnPlan) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnPlan) Triggers() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"triggers",
...
func (j *jsiiProxy_CfnPlan) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnPlan) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnPlan) Workflows() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"workflows",
...
func NewCfnPlan(scope constructs.Construct, id *string, props *CfnPlanProps) CfnPlan {
	...
	if err := validateNewCfnPlanParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnPlan{}
...
func (j *jsiiProxy_CfnPlan)SetAssociatedAlarms(val interface{}) {
	if err := j.validateSetAssociatedAlarmsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPlan)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnPlan)SetExecutionRole(val *string) {
...
func (j *jsiiProxy_CfnPlan)SetName(val *string) {
...
func (j *jsiiProxy_CfnPlan)SetPrimaryRegion(val *string) {
	_jsii_.Set(
		j,
		"primaryRegion",
		val,
...
func (j *jsiiProxy_CfnPlan)SetRecoveryApproach(val *string) {
...
func (j *jsiiProxy_CfnPlan)SetRecoveryTimeObjectiveMinutes(val *float64) {
	_jsii_.Set(
		j,
		"recoveryTimeObjectiveMinutes",
		val,
...
func (j *jsiiProxy_CfnPlan)SetRegions(val *[]*string) {
...
func (j *jsiiProxy_CfnPlan)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func (j *jsiiProxy_CfnPlan)SetTriggers(val interface{}) {
...
func (j *jsiiProxy_CfnPlan)SetWorkflows(val interface{}) {
...
func CfnPlan_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPlan_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlan_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlan) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlan) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlan) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPlan) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPlan) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPlan) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPlan) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPlan) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPlan) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPlan) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlan) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlan) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPlan) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPlan) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
