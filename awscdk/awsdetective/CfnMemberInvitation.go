...
func (j *jsiiProxy_CfnMemberInvitation) CfnPropertyNames() *map[string]*string {
...
func CfnMemberInvitation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMemberInvitation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMemberInvitation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMemberInvitation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMemberInvitation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMemberInvitation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemberInvitation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
