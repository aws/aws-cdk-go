...
func (j *jsiiProxy_CfnGraph) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGraph) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGraph) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGraph) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGraph) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnGraph) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGraph) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnGraph) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGraph(scope constructs.Construct, id *string, props *CfnGraphProps) CfnGraph {
	...
	if err := validateNewCfnGraphParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGraph_ArnForGraph(resource interfacesawsdetective.IGraphRef) *string {
	_init_.Initialize()

	if err := validateCfnGraph_ArnForGraphParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnGraph_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGraph_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGraph_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGraph_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGraph_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGraph_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGraph) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraph) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGraph) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGraph) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGraph) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGraph) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGraph) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraph) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraph) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGraph) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraph) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
