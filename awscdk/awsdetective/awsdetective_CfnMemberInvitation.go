...
func (j *jsiiProxy_CfnMemberInvitation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMemberInvitation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMemberInvitation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMemberInvitation) DisableEmailNotification() interface{} {
...
func (j *jsiiProxy_CfnMemberInvitation) GraphArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"graphArn",
...
func (j *jsiiProxy_CfnMemberInvitation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMemberInvitation) MemberEmailAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memberEmailAddress",
...
func (j *jsiiProxy_CfnMemberInvitation) MemberId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memberId",
...
func (j *jsiiProxy_CfnMemberInvitation) Message() *string {
	var returns *string
	_jsii_.Get(
		j,
		"message",
...
func (j *jsiiProxy_CfnMemberInvitation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMemberInvitation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMemberInvitation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMemberInvitation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMemberInvitation(scope constructs.Construct, id *string, props *CfnMemberInvitationProps) CfnMemberInvitation {
	...
	if err := validateNewCfnMemberInvitationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMemberInvitation)SetDisableEmailNotification(val interface{}) {
...
func (j *jsiiProxy_CfnMemberInvitation)SetGraphArn(val *string) {
...
func (j *jsiiProxy_CfnMemberInvitation)SetMemberEmailAddress(val *string) {
...
func (j *jsiiProxy_CfnMemberInvitation)SetMemberId(val *string) {
...
func (j *jsiiProxy_CfnMemberInvitation)SetMessage(val *string) {
	_jsii_.Set(
		j,
		"message",
		val,
...
func CfnMemberInvitation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMemberInvitation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMemberInvitation_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnMemberInvitation_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMemberInvitation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMemberInvitation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMemberInvitation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemberInvitation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMemberInvitation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMemberInvitation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnMemberInvitation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemberInvitation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMemberInvitation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
