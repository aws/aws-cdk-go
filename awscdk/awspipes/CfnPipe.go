...
func (j *jsiiProxy_CfnPipe) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnPipe) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPipe) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPipe) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPipe) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPipe) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
