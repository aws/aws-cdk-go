...
func (j *jsiiProxy_CfnConfiguredTable) AnalysisMethod() *string {
	var returns *string
	_jsii_.Get(
		j,
		"analysisMethod",
...
func (j *jsiiProxy_CfnConfiguredTable) AnalysisRules() interface{} {
...
func (j *jsiiProxy_CfnConfiguredTable) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnConfiguredTable) AttrConfiguredTableIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConfiguredTable) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnConfiguredTable) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnConfiguredTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConfiguredTable) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnConfiguredTable) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnConfiguredTable) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnConfiguredTable) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnConfiguredTable) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnConfiguredTable) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConfiguredTable) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnConfiguredTable) SelectedAnalysisMethods() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConfiguredTable) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnConfiguredTable) TableReference() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tableReference",
...
func (j *jsiiProxy_CfnConfiguredTable) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnConfiguredTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConfiguredTable(scope constructs.Construct, id *string, props *CfnConfiguredTableProps) CfnConfiguredTable {
	...
	if err := validateNewCfnConfiguredTableParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfiguredTable)SetAllowedColumns(val *[]*string) {
...
func (j *jsiiProxy_CfnConfiguredTable)SetAnalysisMethod(val *string) {
...
func (j *jsiiProxy_CfnConfiguredTable)SetAnalysisRules(val interface{}) {
...
func (j *jsiiProxy_CfnConfiguredTable)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnConfiguredTable)SetName(val *string) {
...
func (j *jsiiProxy_CfnConfiguredTable)SetSelectedAnalysisMethods(val *[]*string) {
	_jsii_.Set(
		j,
		"selectedAnalysisMethods",
		val,
...
func (j *jsiiProxy_CfnConfiguredTable)SetTableReference(val interface{}) {
	if err := j.validateSetTableReferenceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConfiguredTable_ArnForConfiguredTable(resource interfacesawscleanrooms.IConfiguredTableRef) *string {
	...
	if err := validateCfnConfiguredTable_ArnForConfiguredTableParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnConfiguredTable_IsCfnConfiguredTable(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTable_IsCfnConfiguredTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguredTable_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTable_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguredTable_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguredTable_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfiguredTable) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfiguredTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfiguredTable) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnConfiguredTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfiguredTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfiguredTable) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnConfiguredTable) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnConfiguredTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfiguredTable) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnConfiguredTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTable) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnConfiguredTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTable) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnConfiguredTable) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnConfiguredTable) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
