...
func (j *jsiiProxy_CfnAnalysisTemplate) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAnalysisTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnalysisTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnalysisTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnalysisTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalysisTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
