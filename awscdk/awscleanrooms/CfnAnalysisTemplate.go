...
func CfnAnalysisTemplate_IsCfnResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateCfnAnalysisTemplate_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
