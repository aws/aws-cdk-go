...
func (j *jsiiProxy_CfnMembership) AttrCollaborationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMembership) AttrCollaborationCreatorAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMembership) AttrMembershipIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMembership) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnMembership) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMembership) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMembership) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMembership) CollaborationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMembership) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMembership) DefaultJobResultConfiguration() interface{} {
...
func (j *jsiiProxy_CfnMembership) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMembership) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMembership) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMembership) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMembership) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMembership(scope constructs.Construct, id *string, props *CfnMembershipProps) CfnMembership {
	...
	if err := validateNewCfnMembershipParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMembership)SetCollaborationIdentifier(val *string) {
...
func (j *jsiiProxy_CfnMembership)SetDefaultJobResultConfiguration(val interface{}) {
	if err := j.validateSetDefaultJobResultConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMembership)SetJobLogStatus(val *string) {
	_jsii_.Set(
		j,
		"jobLogStatus",
		val,
...
func CfnMembership_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMembership_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMembership_IsCfnMembership(x interface{}) *bool {
	...
	if err := validateCfnMembership_IsCfnMembershipParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMembership_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMembership_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMembership) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMembership) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMembership) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMembership) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMembership) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMembership) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMembership) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMembership) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMembership) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMembership) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMembership) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMembership) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMembership) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMembership) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMembership) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMembership) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMembership) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMembership) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMembership) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMembership) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMembership) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMembership) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMembership) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
