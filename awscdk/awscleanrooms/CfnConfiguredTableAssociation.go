...
func (j *jsiiProxy_CfnConfiguredTableAssociation) AttrConfiguredTableAssociationIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) MembershipIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnConfiguredTableAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConfiguredTableAssociation(scope constructs.Construct, id *string, props *CfnConfiguredTableAssociationProps) CfnConfiguredTableAssociation {
	...
	if err := validateNewCfnConfiguredTableAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfiguredTableAssociation)SetConfiguredTableIdentifier(val *string) {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnConfiguredTableAssociation)SetMembershipIdentifier(val *string) {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation)SetName(val *string) {
...
func (j *jsiiProxy_CfnConfiguredTableAssociation)SetRoleArn(val *string) {
...
func CfnConfiguredTableAssociation_IsCfnConfiguredTableAssociation(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTableAssociation_IsCfnConfiguredTableAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_cleanrooms.CfnConfiguredTableAssociation",
		"isCfnConfiguredTableAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnConfiguredTableAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTableAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguredTableAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTableAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguredTableAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfiguredTableAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnConfiguredTableAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
