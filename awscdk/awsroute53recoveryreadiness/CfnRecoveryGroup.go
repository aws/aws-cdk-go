...
func (j *jsiiProxy_CfnRecoveryGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRecoveryGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRecoveryGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnRecoveryGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRecoveryGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecoveryGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecoveryGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecoveryGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRecoveryGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRecoveryGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRecoveryGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRecoveryGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecoveryGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecoveryGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecoveryGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
