...
func (j *jsiiProxy_CfnReadinessCheck) CfnPropertyNames() *map[string]*string {
...
func NewCfnReadinessCheck(scope constructs.Construct, id *string, props *CfnReadinessCheckProps) CfnReadinessCheck {
	...
	if err := validateNewCfnReadinessCheckParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReadinessCheck_ArnForReadinessCheck(resource interfacesawsroute53recoveryreadiness.IReadinessCheckRef) *string {
	_init_.Initialize()

	if err := validateCfnReadinessCheck_ArnForReadinessCheckParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnReadinessCheck_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReadinessCheck_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReadinessCheck_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReadinessCheck_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReadinessCheck_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReadinessCheck_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReadinessCheck) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReadinessCheck) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReadinessCheck) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReadinessCheck) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReadinessCheck) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReadinessCheck) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReadinessCheck) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReadinessCheck) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReadinessCheck) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReadinessCheck) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
