...
func (j *jsiiProxy_CfnCell) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCell) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCell) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCell(scope constructs.Construct, id *string, props *CfnCellProps) CfnCell {
	...
	if err := validateNewCfnCellParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnCell{}
...
func CfnCell_IsCfnCell(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCell_IsCfnCellParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCell_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCell_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCell_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCell_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCell_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCell_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCell) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCell) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCell) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCell) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCell) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCell) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCell) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCell) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCell) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCell) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
