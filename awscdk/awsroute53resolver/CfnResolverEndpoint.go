...
func (j *jsiiProxy_CfnResolverEndpoint) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnResolverEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
