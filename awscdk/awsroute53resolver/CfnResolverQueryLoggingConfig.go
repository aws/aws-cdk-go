...
func (j *jsiiProxy_CfnResolverQueryLoggingConfig) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnResolverQueryLoggingConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResolverQueryLoggingConfig) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnResolverQueryLoggingConfig)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnResolverQueryLoggingConfig_ArnForResolverQueryLoggingConfig(resource interfacesawsroute53resolver.IResolverQueryLoggingConfigRef) *string {
	_init_.Initialize()

	if err := validateCfnResolverQueryLoggingConfig_ArnForResolverQueryLoggingConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_route53resolver.CfnResolverQueryLoggingConfig",
		"arnForResolverQueryLoggingConfig",
		[]interface{}{resource},
		&returns,
	)
...
func CfnResolverQueryLoggingConfig_IsCfnResolverQueryLoggingConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResolverQueryLoggingConfig_IsCfnResolverQueryLoggingConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_route53resolver.CfnResolverQueryLoggingConfig",
		"isCfnResolverQueryLoggingConfig",
		[]interface{}{x},
		&returns,
	)
...
func CfnResolverQueryLoggingConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
