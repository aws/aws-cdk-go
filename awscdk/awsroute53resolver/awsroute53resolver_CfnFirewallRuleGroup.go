...
func (j *jsiiProxy_CfnFirewallRuleGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFirewallRuleGroup(scope constructs.Construct, id *string, props *CfnFirewallRuleGroupProps) CfnFirewallRuleGroup {
	...
	if err := validateNewCfnFirewallRuleGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFirewallRuleGroup)SetFirewallRules(val interface{}) {
	if err := j.validateSetFirewallRulesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFirewallRuleGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFirewallRuleGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallRuleGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnFirewallRuleGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallRuleGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFirewallRuleGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFirewallRuleGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFirewallRuleGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
