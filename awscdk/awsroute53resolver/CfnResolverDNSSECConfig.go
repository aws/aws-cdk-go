...
func (j *jsiiProxy_CfnResolverDNSSECConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResolverDNSSECConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResolverDNSSECConfig(scope constructs.Construct, id *string, props *CfnResolverDNSSECConfigProps) CfnResolverDNSSECConfig {
	...
	if err := validateNewCfnResolverDNSSECConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResolverDNSSECConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResolverDNSSECConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverDNSSECConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResolverDNSSECConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverDNSSECConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResolverDNSSECConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverDNSSECConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
