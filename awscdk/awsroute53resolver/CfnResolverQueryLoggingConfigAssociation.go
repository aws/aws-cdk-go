...
func (j *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnResolverQueryLoggingConfigAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfigAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
