...
func (j *jsiiProxy_CfnResolverRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResolverRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResolverRule(scope constructs.Construct, id *string, props *CfnResolverRuleProps) CfnResolverRule {
	...
	if err := validateNewCfnResolverRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResolverRule)SetTargetIps(val interface{}) {
	if err := j.validateSetTargetIpsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResolverRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResolverRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnResolverRule.
func CfnResolverRule_IsCfnResolverRule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResolverRule_IsCfnResolverRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResolverRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResolverRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResolverRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
