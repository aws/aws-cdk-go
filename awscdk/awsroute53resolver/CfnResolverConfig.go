...
func (j *jsiiProxy_CfnResolverConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResolverConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResolverConfig(scope constructs.Construct, id *string, props *CfnResolverConfigProps) CfnResolverConfig {
	...
	if err := validateNewCfnResolverConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResolverConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResolverConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnResolverConfig.
func CfnResolverConfig_IsCfnResolverConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResolverConfig_IsCfnResolverConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResolverConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResolverConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolverConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolverConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolverConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResolverConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResolverConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
