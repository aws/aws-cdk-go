...
func (j *jsiiProxy_CfnResolverQueryLoggingConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResolverQueryLoggingConfig(scope constructs.Construct, id *string, props *CfnResolverQueryLoggingConfigProps) CfnResolverQueryLoggingConfig {
	...
	if err := validateNewCfnResolverQueryLoggingConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResolverQueryLoggingConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverQueryLoggingConfig_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfig_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverQueryLoggingConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
