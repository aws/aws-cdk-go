...
func (j *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResolverQueryLoggingConfigAssociation(scope constructs.Construct, id *string, props *CfnResolverQueryLoggingConfigAssociationProps) CfnResolverQueryLoggingConfigAssociation {
	...
	if err := validateNewCfnResolverQueryLoggingConfigAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResolverQueryLoggingConfigAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfigAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverQueryLoggingConfigAssociation_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfigAssociation_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResolverQueryLoggingConfigAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResolverQueryLoggingConfigAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
