...
func (j *jsiiProxy_CfnFirewallRuleGroup) CfnPropertyNames() *map[string]*string {
...
func CfnFirewallRuleGroup_IsCfnFirewallRuleGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFirewallRuleGroup_IsCfnFirewallRuleGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallRuleGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFirewallRuleGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFirewallRuleGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallRuleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
