...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsserverlessrepo/internal"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsserverlessrepo"
...
//
//   cfnApplication := awscdk.Aws_serverlessrepo.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsserverlessrepo.IApplicationRef
	// A reference to a Application resource.
	ApplicationRef() *interfacesawsserverlessrepo.ApplicationReference
	// The Amazon Resource Name (ARN) of the application.
	AttrApplicationId() *string
	// The date and time this resource was created.
	AttrCreationTime() *string
	// Whether the author of this application has been verified.
	AttrIsVerifiedAuthor() awscdk.IResolvable
	...
	SetSourceCodeUrl(val *string)
	// A valid identifier from https://spdx.org/licenses/.
	SpdxLicenseId() *string
	SetSpdxLicenseId(val *string)
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsserverlessrepoIApplicationRef
}

func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawsserverlessrepo.ApplicationReference {
	var returns *interfacesawsserverlessrepo.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnApplication) AttrIsVerifiedAuthor() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrIsVerifiedAuthor",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnApplication) Author() *string {
	var returns *string
	_jsii_.Get(
		j,
		"author",
...
func (j *jsiiProxy_CfnApplication) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplication) HomePageUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"homePageUrl",
...
func (j *jsiiProxy_CfnApplication) Labels() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_CfnApplication) LicenseBody() *string {
	var returns *string
	_jsii_.Get(
		j,
		"licenseBody",
...
func (j *jsiiProxy_CfnApplication) ReadmeBody() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readmeBody",
...
func (j *jsiiProxy_CfnApplication) SemanticVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"semanticVersion",
...
func (j *jsiiProxy_CfnApplication) SourceCodeUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceCodeUrl",
...
func (j *jsiiProxy_CfnApplication) SpdxLicenseId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"spdxLicenseId",
...
func (j *jsiiProxy_CfnApplication) TemplateBody() *string {
	var returns *string
	_jsii_.Get(
		j,
		"templateBody",
...
func (j *jsiiProxy_CfnApplication)SetAuthor(val *string) {
	if err := j.validateSetAuthorParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetHomePageUrl(val *string) {
	_jsii_.Set(
		j,
		"homePageUrl",
		val,
...
func (j *jsiiProxy_CfnApplication)SetLabels(val *[]*string) {
	_jsii_.Set(
		j,
		"labels",
		val,
...
func (j *jsiiProxy_CfnApplication)SetLicenseBody(val *string) {
	_jsii_.Set(
		j,
		"licenseBody",
		val,
...
func (j *jsiiProxy_CfnApplication)SetReadmeBody(val *string) {
	_jsii_.Set(
		j,
		"readmeBody",
		val,
...
func (j *jsiiProxy_CfnApplication)SetSemanticVersion(val *string) {
	_jsii_.Set(
		j,
		"semanticVersion",
		val,
...
func (j *jsiiProxy_CfnApplication)SetSourceCodeUrl(val *string) {
	_jsii_.Set(
		j,
		"sourceCodeUrl",
		val,
...
func (j *jsiiProxy_CfnApplication)SetSpdxLicenseId(val *string) {
	_jsii_.Set(
		j,
		"spdxLicenseId",
		val,
...
func (j *jsiiProxy_CfnApplication)SetTemplateBody(val *string) {
	_jsii_.Set(
		j,
		"templateBody",
		val,
...
func (c *jsiiProxy_CfnApplication) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplication) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplication) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplication) RemoveResourceDependency(target awscdk.CfnResource) {
