...
func (j *jsiiProxy_CfnRepository) RepositoryRef() *interfacesawscodecommit.RepositoryReference {
...
func CfnRepository_ArnForRepository(resource interfacesawscodecommit.IRepositoryRef) *string {
	_init_.Initialize()
