...
func validateCfnFlow_ArnForFlowParameters(resource interfacesawsappflow.IFlowRef) error {
	if resource == nil {
...
func validateCfnFlow_FromFlowNameParameters(scope constructs.Construct, id *string, flowName *string) error {
	...
	if flowName == nil {
		return fmt.Errorf("parameter flowName is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnFlow) validateSetDestinationFlowConfigListParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnFlow_DestinationFlowConfigProperty:
				v_ := v.(CfnFlow_DestinationFlowConfigProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnFlow) validateSetMetadataCatalogConfigParameters(val interface{}) error {
	...
	case CfnFlow_MetadataCatalogConfigProperty:
		val_ := val.(CfnFlow_MetadataCatalogConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFlow) validateSetSourceFlowConfigParameters(val interface{}) error {
	...
	case CfnFlow_SourceFlowConfigProperty:
		val_ := val.(CfnFlow_SourceFlowConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFlow) validateSetTriggerConfigParameters(val interface{}) error {
	...
	case CfnFlow_TriggerConfigProperty:
		val_ := val.(CfnFlow_TriggerConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
