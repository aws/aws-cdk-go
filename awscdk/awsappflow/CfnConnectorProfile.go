...
func (j *jsiiProxy_CfnConnectorProfile) CfnPropertyNames() *map[string]*string {
...
func CfnConnectorProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConnectorProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConnectorProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectorProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectorProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectorProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectorProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
