...
func (j *jsiiProxy_CfnConnector) ConnectorLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectorLabel",
...
func (j *jsiiProxy_CfnConnector) ConnectorProvisioningConfig() interface{} {
...
func (j *jsiiProxy_CfnConnector) ConnectorProvisioningType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConnector)SetConnectorLabel(val *string) {
	_jsii_.Set(
		j,
		"connectorLabel",
		val,
...
func (j *jsiiProxy_CfnConnector)SetConnectorProvisioningConfig(val interface{}) {
	if err := j.validateSetConnectorProvisioningConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConnector)SetConnectorProvisioningType(val *string) {
	if err := j.validateSetConnectorProvisioningTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConnector_ArnForConnector(resource interfacesawsappflow.IConnectorRef) *string {
	_init_.Initialize()
