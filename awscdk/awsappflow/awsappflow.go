...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_appflow.CfnConnectorProfile.PardotConnectorProfileCredentialsProperty",
		reflect.TypeOf((*CfnConnectorProfile_PardotConnectorProfileCredentialsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_appflow.CfnConnectorProfile.PardotConnectorProfilePropertiesProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_appflow.CfnFlow.PardotSourcePropertiesProperty",
