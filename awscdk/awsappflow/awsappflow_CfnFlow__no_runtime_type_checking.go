...
func (c *jsiiProxy_CfnFlow) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	return nil
}
...
func (c *jsiiProxy_CfnFlow) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateCfnFlow_IsCfnResourceParameters(construct constructs.IConstruct) error {
	return nil
}
...
func (j *jsiiProxy_CfnFlow) validateSetDestinationFlowConfigListParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnFlow) validateSetFlowNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnFlow) validateSetSourceFlowConfigParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_CfnFlow) validateSetTriggerConfigParameters(val interface{}) error {
	return nil
}

func validateNewCfnFlowParameters(scope awscdk.Construct, id *string, props *CfnFlowProps) error {
	return nil
}
