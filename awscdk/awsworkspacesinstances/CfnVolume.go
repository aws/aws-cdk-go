...
//
//   cfnVolume := awscdk.Aws_workspacesinstances.NewCfnVolume(this, jsii.String("MyCfnVolume"), &CfnVolumeProps{
...
func (j *jsiiProxy_CfnVolume) SizeInGb() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"sizeInGb",
...
func (j *jsiiProxy_CfnVolume) TagSpecifications() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagSpecifications",
...
func (j *jsiiProxy_CfnVolume)SetSizeInGb(val *float64) {
	_jsii_.Set(
		j,
		"sizeInGb",
		val,
...
func (j *jsiiProxy_CfnVolume)SetTagSpecifications(val interface{}) {
