...
func (j *jsiiProxy_CfnWorkspaceInstance) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnWorkspaceInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWorkspaceInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWorkspaceInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWorkspaceInstance) RemoveResourceDependency(target awscdk.CfnResource) {
