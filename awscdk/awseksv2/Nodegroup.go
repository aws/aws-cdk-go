...
//
//   nodegroup := awscdk.Aws_eks_v2.NewNodegroup(this, jsii.String("MyNodegroup"), &NodegroupProps{
//   	Cluster: cluster,
//
...
func (n *jsiiProxy_Nodegroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (n *jsiiProxy_Nodegroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
