...
//
//   cfnCluster := awscdk.Aws_eks_v2.NewCfnCluster(this, jsii.String("MyCfnCluster"), &CfnClusterProps{
...
type CfnCluster interface {
	...
	SetRollbackConfig(val interface{})
...
func (j *jsiiProxy_CfnCluster) RollbackConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rollbackConfig",
...
func (j *jsiiProxy_CfnCluster)SetRollbackConfig(val interface{}) {
	if err := j.validateSetRollbackConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
