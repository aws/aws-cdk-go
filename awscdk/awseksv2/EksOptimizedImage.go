...
//
//   eksOptimizedImage := awscdk.Aws_eks_v2.NewEksOptimizedImage(&EksOptimizedImageProps{
//   	CpuArch: awscdk.*Aws_eks_v2.CpuArch_ARM_64,
//   	KubernetesVersion: jsii.String("kubernetesVersion"),
//   	NodeType: awscdk.*Aws_eks_v2.NodeType_STANDARD,
//   })
//
