...
//
//   cfnIdentityProviderConfig := awscdk.Aws_eks_v2.NewCfnIdentityProviderConfig(this, jsii.String("MyCfnIdentityProviderConfig"), &CfnIdentityProviderConfigProps{
...
func (j *jsiiProxy_CfnIdentityProviderConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdentityProviderConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIdentityProviderConfig(scope constructs.Construct, id *string, props *CfnIdentityProviderConfigProps) CfnIdentityProviderConfig {
	...
	if err := validateNewCfnIdentityProviderConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnIdentityProviderConfig{}

	_jsii_.Create(
		"aws-cdk-lib.aws_eks_v2.CfnIdentityProviderConfig",
...
func (j *jsiiProxy_CfnIdentityProviderConfig)SetOidc(val interface{}) {
	if err := j.validateSetOidcParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIdentityProviderConfig_ArnForIdentityProviderConfig(resource interfacesawseks.IIdentityProviderConfigRef) *string {
	_init_.Initialize()

	if err := validateCfnIdentityProviderConfig_ArnForIdentityProviderConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnIdentityProviderConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdentityProviderConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityProviderConfig_IsCfnIdentityProviderConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIdentityProviderConfig_IsCfnIdentityProviderConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityProviderConfig_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIdentityProviderConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityProviderConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdentityProviderConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentityProviderConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdentityProviderConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityProviderConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
