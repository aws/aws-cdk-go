...
//
//   cfnPodIdentityAssociation := awscdk.Aws_eks_v2.NewCfnPodIdentityAssociation(this, jsii.String("MyCfnPodIdentityAssociation"), &CfnPodIdentityAssociationProps{
...
func (j *jsiiProxy_CfnPodIdentityAssociation) AttrAssociationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAssociationId",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) ClusterName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterName",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) ServiceAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccount",
...
func (j *jsiiProxy_CfnPodIdentityAssociation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPodIdentityAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPodIdentityAssociation(scope constructs.Construct, id *string, props *CfnPodIdentityAssociationProps) CfnPodIdentityAssociation {
	...
	if err := validateNewCfnPodIdentityAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnPodIdentityAssociation{}

	_jsii_.Create(
		"aws-cdk-lib.aws_eks_v2.CfnPodIdentityAssociation",
...
func (j *jsiiProxy_CfnPodIdentityAssociation)SetClusterName(val *string) {
...
func (j *jsiiProxy_CfnPodIdentityAssociation)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnPodIdentityAssociation)SetServiceAccount(val *string) {
...
func (j *jsiiProxy_CfnPodIdentityAssociation)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnPodIdentityAssociation_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPodIdentityAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPodIdentityAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPodIdentityAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPodIdentityAssociation_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPodIdentityAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPodIdentityAssociation_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_eks_v2.CfnPodIdentityAssociation",
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPodIdentityAssociation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPodIdentityAssociation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPodIdentityAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
