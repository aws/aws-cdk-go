...
//
//   cfnNodegroup := awscdk.Aws_eks_v2.NewCfnNodegroup(this, jsii.String("MyCfnNodegroup"), &CfnNodegroupProps{
...
func (j *jsiiProxy_CfnNodegroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnNodegroup(scope constructs.Construct, id *string, props *CfnNodegroupProps) CfnNodegroup {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_eks_v2.CfnNodegroup",
...
func CfnNodegroup_IsCfnNodegroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnNodegroup_IsCfnNodegroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNodegroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnNodegroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNodegroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNodegroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNodegroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNodegroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNodegroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNodegroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNodegroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNodegroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNodegroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNodegroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
