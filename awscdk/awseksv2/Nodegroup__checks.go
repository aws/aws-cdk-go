...
func (n *jsiiProxy_Nodegroup) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateNodegroup_FromNodegroupNameParameters(scope constructs.Construct, id *string, nodegroupName *string) error {
	...
	if nodegroupName == nil {
		return fmt.Errorf("parameter nodegroupName is required, but nil was provided")
	}
