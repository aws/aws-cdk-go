...
//
//   cfnFargateProfile := awscdk.Aws_eks_v2.NewCfnFargateProfile(this, jsii.String("MyCfnFargateProfile"), &CfnFargateProfileProps{
...
func (j *jsiiProxy_CfnFargateProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFargateProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnFargateProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFargateProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFargateProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFargateProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFargateProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFargateProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFargateProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFargateProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFargateProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFargateProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFargateProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFargateProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
