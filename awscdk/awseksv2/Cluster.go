...
func (j *jsiiProxy_Cluster) ClusterRef() *interfacesawseks.ClusterReference {
...
func (j *jsiiProxy_Cluster) KubectlProvider() IKubectlProvider {
...
func (c *jsiiProxy_Cluster) GrantClusterAdmin(id *string, principal *string) AccessEntry {
	if err := c.validateGrantClusterAdminParameters(id, principal); err != nil {
		panic(err)
	}
