...
//
//   cfnAddon := awscdk.Aws_eks_v2.NewCfnAddon(this, jsii.String("MyCfnAddon"), &CfnAddonProps{
...
func (j *jsiiProxy_CfnAddon) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAddon) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAddon) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAddon(scope constructs.Construct, id *string, props *CfnAddonProps) CfnAddon {
	...
	if err := validateNewCfnAddonParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAddon{}

	_jsii_.Create(
		"aws-cdk-lib.aws_eks_v2.CfnAddon",
...
func (j *jsiiProxy_CfnAddon)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnAddon_ArnForAddon(resource interfacesawseks.IAddonRef) *string {
	_init_.Initialize()

	if err := validateCfnAddon_ArnForAddonParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAddon_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAddon_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAddon_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAddon_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAddon_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAddon_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAddon) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAddon) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAddon) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAddon) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAddon) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAddon) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
