...
//
//   cfnDashboard := awscdk.Aws_cloudtrail.NewCfnDashboard(this, jsii.String("MyCfnDashboard"), &CfnDashboardProps{
...
func (j *jsiiProxy_CfnDashboard) AttrCreatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDashboard) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDashboard) AttrType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrType",
...
func (j *jsiiProxy_CfnDashboard) AttrUpdatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDashboard) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDashboard) RefreshSchedule() interface{} {
...
func (j *jsiiProxy_CfnDashboard) TerminationProtectionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDashboard) Widgets() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"widgets",
...
func (j *jsiiProxy_CfnDashboard)SetRefreshSchedule(val interface{}) {
	if err := j.validateSetRefreshScheduleParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDashboard)SetTerminationProtectionEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnDashboard)SetWidgets(val interface{}) {
	if err := j.validateSetWidgetsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDashboard_ArnForDashboard(resource interfacesawscloudtrail.IDashboardRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDashboard) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDashboard) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDashboard) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDashboard) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDashboard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
