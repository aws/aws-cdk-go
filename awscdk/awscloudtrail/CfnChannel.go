...
type CfnChannel interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscloudtrail.IChannelRef
	awscdk.ITaggable
	...
	ChannelRef() *interfacesawscloudtrail.ChannelReference
...
type jsiiProxy_CfnChannel struct {
	...
	internal.Type__interfacesawscloudtrailIChannelRef
...
func (j *jsiiProxy_CfnChannel) ChannelRef() *interfacesawscloudtrail.ChannelReference {
	var returns *interfacesawscloudtrail.ChannelReference
	_jsii_.Get(
		j,
		"channelRef",
		&returns,
...
func (j *jsiiProxy_CfnChannel) Source() *string {
	var returns *string
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_CfnChannel)SetSource(val *string) {
	_jsii_.Set(
		j,
		"source",
		val,
