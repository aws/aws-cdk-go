...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscloudtrail.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawscloudtrail.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawscloudtrailIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawscloudtrail.ResourcePolicyReference {
	var returns *interfacesawscloudtrail.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
