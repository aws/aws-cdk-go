...
func (j *jsiiProxy_Trail) Env() *interfaces.ResourceEnvironment {
...
func Trail_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudtrail.Trail",
...
func (t *jsiiProxy_Trail) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
