...
func (j *jsiiProxy_CfnTrail) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnTrail) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrail) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrail) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrail) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrail) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
