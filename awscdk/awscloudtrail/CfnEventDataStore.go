...
func (j *jsiiProxy_CfnEventDataStore) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEventDataStore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventDataStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventDataStore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventDataStore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventDataStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
