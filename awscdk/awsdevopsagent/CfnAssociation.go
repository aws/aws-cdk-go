...
//
//   cfnAssociation := awscdk.Aws_devopsagent.NewCfnAssociation(this, jsii.String("MyCfnAssociation"), &CfnAssociationProps{
...
type CfnAssociation interface {
	...
	AssociationRef() *interfacesawsdevopsagent.AssociationReference
...
type jsiiProxy_CfnAssociation struct {
	...
	internal.Type__interfacesawsdevopsagentIAssociationRef
}

func (j *jsiiProxy_CfnAssociation) AgentSpaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentSpaceId",
...
func (j *jsiiProxy_CfnAssociation) AssociationRef() *interfacesawsdevopsagent.AssociationReference {
	var returns *interfacesawsdevopsagent.AssociationReference
	_jsii_.Get(
		j,
		"associationRef",
		&returns,
...
func (j *jsiiProxy_CfnAssociation) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnAssociation) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnAssociation) Configuration() interface{} {
...
func (j *jsiiProxy_CfnAssociation) ServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceId",
...
func (j *jsiiProxy_CfnAssociation)SetAgentSpaceId(val *string) {
...
func (j *jsiiProxy_CfnAssociation)SetConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnAssociation)SetServiceId(val *string) {
