...
//
//   cfnTrigger := awscdk.Aws_devopsagent.NewCfnTrigger(this, jsii.String("MyCfnTrigger"), &CfnTriggerProps{
//   	Action: action,
...
type CfnTrigger interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdevopsagent.ITriggerRef
	...
	//
	// Nested under the parent Agent Space: arn:<partition>:aidevops:<region>:<account-id>:agentspace/<agentspace-id>/trigger/<trigger-id>.
	AttrArn() *string
	// The timestamp when the trigger was created.
	AttrCreatedAt() *string
	// The unique identifier of the trigger (assigned by the service on Create).
	AttrTriggerId() *string
	...
	TriggerRef() *interfacesawsdevopsagent.TriggerReference
	// The type of trigger.
	Type() *string
	SetType(val *string)
	// Deprecated.
...
type jsiiProxy_CfnTrigger struct {
	...
	internal.Type__interfacesawsdevopsagentITriggerRef
}

func (j *jsiiProxy_CfnTrigger) Action() interface{} {
...
func (j *jsiiProxy_CfnTrigger) AgentSpaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentSpaceId",
...
func (j *jsiiProxy_CfnTrigger) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnTrigger) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnTrigger) AttrTriggerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTriggerId",
...
func (j *jsiiProxy_CfnTrigger) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnTrigger) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrigger) Condition() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"condition",
...
func (j *jsiiProxy_CfnTrigger) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnTrigger) TriggerRef() *interfacesawsdevopsagent.TriggerReference {
	var returns *interfacesawsdevopsagent.TriggerReference
	_jsii_.Get(
		j,
		"triggerRef",
		&returns,
...
func (j *jsiiProxy_CfnTrigger)SetAction(val interface{}) {
...
func (j *jsiiProxy_CfnTrigger)SetAgentSpaceId(val *string) {
...
func (j *jsiiProxy_CfnTrigger)SetCondition(val interface{}) {
...
func (j *jsiiProxy_CfnTrigger)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnTrigger_ArnForTrigger(resource interfacesawsdevopsagent.ITriggerRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTrigger) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrigger) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrigger) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrigger) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrigger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
