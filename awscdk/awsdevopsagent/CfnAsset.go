...
//
//   cfnAsset := awscdk.Aws_devopsagent.NewCfnAsset(this, jsii.String("MyCfnAsset"), &CfnAssetProps{
...
type CfnAsset interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdevopsagent.IAssetRef
	// The unique identifier of the parent Agent Space.
	AgentSpaceId() *string
	SetAgentSpaceId(val *string)
	// A reference to a Asset resource.
	AssetRef() *interfacesawsdevopsagent.AssetReference
	// The type of asset.
	AssetType() *string
	SetAssetType(val *string)
	// The Amazon Resource Name (ARN) of the asset.
	//
	// Nested under the parent Agent Space: arn:<partition>:aidevops:<region>:<account-id>:agentspace/<agentspace-id>/asset/<asset-id>.
	AttrArn() *string
...
type jsiiProxy_CfnAsset struct {
	...
	internal.Type__interfacesawsdevopsagentIAssetRef
}

func (j *jsiiProxy_CfnAsset) AgentSpaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentSpaceId",
...
func (j *jsiiProxy_CfnAsset) AssetRef() *interfacesawsdevopsagent.AssetReference {
	var returns *interfacesawsdevopsagent.AssetReference
	_jsii_.Get(
		j,
		"assetRef",
		&returns,
...
func (j *jsiiProxy_CfnAsset) AssetType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assetType",
...
func (j *jsiiProxy_CfnAsset) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnAsset) AttrVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrVersion",
...
func (j *jsiiProxy_CfnAsset) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAsset) Files() interface{} {
...
func (j *jsiiProxy_CfnAsset) Metadata() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"metadata",
...
func (j *jsiiProxy_CfnAsset) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnAsset) Zip() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zip",
...
func NewCfnAsset(scope constructs.Construct, id *string, props *CfnAssetProps) CfnAsset {
	...
	if err := validateNewCfnAssetParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAsset{}

	_jsii_.Create(
		"aws-cdk-lib.aws_devopsagent.CfnAsset",
...
func (j *jsiiProxy_CfnAsset)SetAgentSpaceId(val *string) {
...
func (j *jsiiProxy_CfnAsset)SetAssetType(val *string) {
...
func (j *jsiiProxy_CfnAsset)SetFiles(val interface{}) {
...
func (j *jsiiProxy_CfnAsset)SetMetadata(val interface{}) {
...
func (j *jsiiProxy_CfnAsset)SetZip(val *string) {
	_jsii_.Set(
		j,
		"zip",
		val,
...
func CfnAsset_ArnForAsset(resource interfacesawsdevopsagent.IAssetRef) *string {
	_init_.Initialize()
...
func CfnAsset_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAsset_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAsset_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAsset_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAsset_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAsset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAsset) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAsset) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAsset) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAsset) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAsset) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAsset) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAsset) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAsset) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAsset) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAsset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
