...
func validateCfnService_ArnForServiceParameters(resource interfacesawsdevopsagent.IServiceRef) error {
	if resource == nil {
...
func validateCfnService_FromServiceIdParameters(scope constructs.Construct, id *string, serviceId *string) error {
	...
	if serviceId == nil {
		return fmt.Errorf("parameter serviceId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnService) validateSetServiceDetailsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnService_ServiceDetailsProperty:
		val := val.(*CfnService_ServiceDetailsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnService_ServiceDetailsProperty:
		val_ := val.(CfnService_ServiceDetailsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnService_ServiceDetailsProperty; received %#v (a %T)", val, val)
		}
	}
