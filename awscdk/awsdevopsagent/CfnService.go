...
//
//   cfnService := awscdk.Aws_devopsagent.NewCfnService(this, jsii.String("MyCfnService"), &CfnServiceProps{
...
type CfnService interface {
	...
	ServiceRef() *interfacesawsdevopsagent.ServiceReference
...
func (j *jsiiProxy_CfnService) AttrAccessibleResources() awscdk.IResolvable {
	...
	_jsii_.Get(
		j,
		"attrAccessibleResources",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnService) AttrAdditionalServiceDetails() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrAdditionalServiceDetails",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnService) ServiceDetails() interface{} {
...
func (j *jsiiProxy_CfnService) ServiceRef() *interfacesawsdevopsagent.ServiceReference {
	var returns *interfacesawsdevopsagent.ServiceReference
	_jsii_.Get(
		j,
		"serviceRef",
		&returns,
...
func (j *jsiiProxy_CfnService) ServiceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceType",
...
func (j *jsiiProxy_CfnService)SetServiceType(val *string) {
...
func CfnService_FromServiceId(scope constructs.Construct, id *string, serviceId *string) interfacesawsdevopsagent.IServiceRef {
	_init_.Initialize()
