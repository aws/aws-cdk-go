...
func (j *jsiiProxy_CfnEnvironmentEC2) CfnPropertyNames() *map[string]*string {
...
func NewCfnEnvironmentEC2(scope constructs.Construct, id *string, props *CfnEnvironmentEC2Props) CfnEnvironmentEC2 {
	...
	if err := validateNewCfnEnvironmentEC2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEnvironmentEC2)SetRepositories(val interface{}) {
	if err := j.validateSetRepositoriesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEnvironmentEC2_ArnForEnvironmentEC2(resource interfacesawscloud9.IEnvironmentEC2Ref) *string {
	_init_.Initialize()

	if err := validateCfnEnvironmentEC2_ArnForEnvironmentEC2Parameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEnvironmentEC2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentEC2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentEC2_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentEC2_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentEC2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentEC2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEnvironmentEC2) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEnvironmentEC2) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEnvironmentEC2) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEnvironmentEC2) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentEC2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
