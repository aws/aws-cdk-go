...
type CfnStack interface {
	CfnResource
	IInspectable
	interfacesawscloudformation.IStackRef
	ITaggable
	...
	StackRef() *interfacesawscloudformation.StackReference
...
type jsiiProxy_CfnStack struct {
	...
	internal.Type__interfacesawscloudformationIStackRef
	jsiiProxy_ITaggable
}
...
func (j *jsiiProxy_CfnStack) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStack) StackRef() *interfacesawscloudformation.StackReference {
	var returns *interfacesawscloudformation.StackReference
	_jsii_.Get(
		j,
		"stackRef",
		&returns,
...
func (j *jsiiProxy_CfnStack) TagsRaw() *[]*CfnTag {
	var returns *[]*CfnTag
	_jsii_.Get(
		j,
		"tagsRaw",
...
func (j *jsiiProxy_CfnStack)SetTagsRaw(val *[]*CfnTag) {
...
func (c *jsiiProxy_CfnStack) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnStack) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStack) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnStack) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStack) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnStack) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnStack) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnStack) ReplaceDependency(target CfnResource, newTarget CfnResource) {
