...
type IDomain interface {
	interfacesawsopensearchservice.IDomainRef
	awscdk.IResource
...
type jsiiProxy_IDomain struct {
	internal.Type__interfacesawsopensearchserviceIDomainRef
...
func (i *jsiiProxy_IDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDomain) DomainRef() *interfacesawsopensearchservice.DomainReference {
