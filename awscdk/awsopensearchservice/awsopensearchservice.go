...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.IdpProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.OffPeakWindowOptionsProperty",
		reflect.TypeOf((*CfnDomain_OffPeakWindowOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.OffPeakWindowProperty",
		reflect.TypeOf((*CfnDomain_OffPeakWindowProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.SAMLOptionsProperty",
		reflect.TypeOf((*CfnDomain_SAMLOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.ServiceSoftwareOptionsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.SoftwareUpdateOptionsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_opensearchservice.CfnDomain.WindowStartTimeProperty",
