...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsopensearchserviceIApplicationRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnApplication.AppConfigProperty",
		reflect.TypeOf((*CfnApplication_AppConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnApplication.DataSourceProperty",
		reflect.TypeOf((*CfnApplication_DataSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnApplication.IamIdentityCenterOptionsProperty",
		reflect.TypeOf((*CfnApplication_IamIdentityCenterOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrDomainEndpointV2", GoGetter: "AttrDomainEndpointV2"},
			_jsii_.MemberProperty{JsiiProperty: "attrId", GoGetter: "AttrId"},
			_jsii_.MemberProperty{JsiiProperty: "attrIdentityCenterOptionsIdentityCenterApplicationArn", GoGetter: "AttrIdentityCenterOptionsIdentityCenterApplicationArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrIdentityCenterOptionsIdentityStoreId", GoGetter: "AttrIdentityCenterOptionsIdentityStoreId"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnDomain.IAMFederationOptionsProperty",
		reflect.TypeOf((*CfnDomain_IAMFederationOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnDomain.IdentityCenterOptionsProperty",
		reflect.TypeOf((*CfnDomain_IdentityCenterOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.CfnDomain.ServerlessVectorAccelerationProperty",
		reflect.TypeOf((*CfnDomain_ServerlessVectorAccelerationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterEnum(
		"aws-cdk-lib.aws_opensearchservice.IpAddressType",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NodeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opensearchservice.NodeOptions",
		reflect.TypeOf((*NodeOptions)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
		"aws-cdk-lib.aws_opensearchservice.NodeType",
		reflect.TypeOf((*NodeType)(nil)).Elem(),
		map[string]interface{}{
			"COORDINATOR": NodeType_COORDINATOR,
		},
	)
	_jsii_.RegisterStruct(
