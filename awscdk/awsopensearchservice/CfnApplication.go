...
//
//   cfnApplication := awscdk.Aws_opensearchservice.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsopensearchservice.IApplicationRef
	awscdk.ITaggableV2
	// List of application configurations.
	AppConfigs() interface{}
	SetAppConfigs(val interface{})
	// A reference to a Application resource.
	ApplicationRef() *interfacesawsopensearchservice.ApplicationReference
	// The Amazon Resource Name (ARN) of the domain.
	//
	// See [Identifiers for IAM Entities](https://docs.aws.amazon.com/IAM/latest/UserGuide/index.html) in *Using AWS Identity and Access Management* for more information.
	AttrArn() *string
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsopensearchserviceIApplicationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnApplication) AppConfigs() interface{} {
...
func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawsopensearchservice.ApplicationReference {
	var returns *interfacesawsopensearchservice.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) DataSources() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataSources",
...
func (j *jsiiProxy_CfnApplication) Endpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpoint",
...
func (j *jsiiProxy_CfnApplication) IamIdentityCenterOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewCfnApplication(scope constructs.Construct, id *string, props *CfnApplicationProps) CfnApplication {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_opensearchservice.CfnApplication",
...
func (j *jsiiProxy_CfnApplication)SetAppConfigs(val interface{}) {
	if err := j.validateSetAppConfigsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetDataSources(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetEndpoint(val *string) {
	_jsii_.Set(
		j,
		"endpoint",
		val,
...
func (j *jsiiProxy_CfnApplication)SetIamIdentityCenterOptions(val interface{}) {
...
func CfnApplication_ArnForApplication(resource interfacesawsopensearchservice.IApplicationRef) *string {
	_init_.Initialize()
