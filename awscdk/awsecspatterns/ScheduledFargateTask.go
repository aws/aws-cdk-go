...
func (j *jsiiProxy_ScheduledFargateTask) PropagateTags() awsecs.PropagatedTagSource {
...
func (j *jsiiProxy_ScheduledFargateTask) Tags() *[]*awseventstargets.Tag {
...
func (s *jsiiProxy_ScheduledFargateTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
