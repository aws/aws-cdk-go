...
func ApplicationLoadBalancedFargateService_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ecs_patterns.ApplicationLoadBalancedFargateService",
...
func (a *jsiiProxy_ApplicationLoadBalancedFargateService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
