...
func NetworkLoadBalancedFargateService_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ecs_patterns.NetworkLoadBalancedFargateService",
...
func (n *jsiiProxy_NetworkLoadBalancedFargateService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
