...
func (j *jsiiProxy_CfnResourceDefaultVersion) CfnPropertyNames() *map[string]*string {
...
func CfnResourceDefaultVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceDefaultVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceDefaultVersion) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
