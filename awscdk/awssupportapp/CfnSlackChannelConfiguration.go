...
//
//   cfnSlackChannelConfiguration := awscdk.Aws_supportapp.NewCfnSlackChannelConfiguration(this, jsii.String("MyCfnSlackChannelConfiguration"), &CfnSlackChannelConfigurationProps{
...
type CfnSlackChannelConfiguration interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssupportapp.ISlackChannelConfigurationRef
	...
	SlackChannelConfigurationRef() *interfacesawssupportapp.SlackChannelConfigurationReference
...
type jsiiProxy_CfnSlackChannelConfiguration struct {
	...
	internal.Type__interfacesawssupportappISlackChannelConfigurationRef
}
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) ChannelId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelId",
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) ChannelName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelName",
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) ChannelRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelRoleArn",
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) NotifyOnAddCorrespondenceToCase() interface{} {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) NotifyOnCaseSeverity() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) NotifyOnCreateOrReopenCase() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) NotifyOnResolveCase() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"notifyOnResolveCase",
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) SlackChannelConfigurationRef() *interfacesawssupportapp.SlackChannelConfigurationReference {
	var returns *interfacesawssupportapp.SlackChannelConfigurationReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSlackChannelConfiguration) TeamId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"teamId",
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetChannelId(val *string) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetChannelName(val *string) {
	_jsii_.Set(
		j,
		"channelName",
		val,
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetChannelRoleArn(val *string) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetNotifyOnAddCorrespondenceToCase(val interface{}) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetNotifyOnCaseSeverity(val *string) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetNotifyOnCreateOrReopenCase(val interface{}) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetNotifyOnResolveCase(val interface{}) {
...
func (j *jsiiProxy_CfnSlackChannelConfiguration)SetTeamId(val *string) {
...
func (c *jsiiProxy_CfnSlackChannelConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSlackChannelConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSlackChannelConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSlackChannelConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSlackChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
