...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_supportapp.CfnAccountAliasProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_supportapp.CfnSlackChannelConfigurationProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_supportapp.CfnSlackWorkspaceConfigurationProps",
