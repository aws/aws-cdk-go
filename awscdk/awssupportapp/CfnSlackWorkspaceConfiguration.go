...
func (j *jsiiProxy_CfnSlackWorkspaceConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnSlackWorkspaceConfiguration_IsCfnSlackWorkspaceConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSlackWorkspaceConfiguration_IsCfnSlackWorkspaceConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_supportapp.CfnSlackWorkspaceConfiguration",
		"isCfnSlackWorkspaceConfiguration",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnSlackWorkspaceConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSlackWorkspaceConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSlackWorkspaceConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSlackWorkspaceConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSlackWorkspaceConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
