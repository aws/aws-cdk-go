...
func (j *jsiiProxy_CfnAccountAlias) AttrAccountAliasResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccountAlias) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAccountAlias) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAccountAlias) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccountAlias) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAccountAlias) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAccountAlias) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAccountAlias) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAccountAlias) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAccountAlias) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAccountAlias) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAccountAlias) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccountAlias(scope constructs.Construct, id *string, props *CfnAccountAliasProps) CfnAccountAlias {
	...
	if err := validateNewCfnAccountAliasParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAccountAlias)SetAccountAlias(val *string) {
...
func CfnAccountAlias_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccountAlias_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccountAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccountAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccountAlias) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAccountAlias) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccountAlias) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccountAlias) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccountAlias) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccountAlias) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAccountAlias) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccountAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccountAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccountAlias) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAccountAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccountAlias) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccountAlias) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAccountAlias) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAccountAlias) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccountAlias) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAccountAlias) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccountAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccountAlias) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAccountAlias) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccountAlias) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAccountAlias) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAccountAlias) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAccountAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
