...
func validateNewActionParameters(actionProperties *awscodepipeline.ActionProperties) error {
	if actionProperties == nil {
		return fmt.Errorf("parameter actionProperties is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(actionProperties, func() string { return "parameter actionProperties" }); err != nil {
		return err
	}
