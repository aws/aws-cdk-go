...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EcrBuildAndPublishActionProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline_actions.EcrBuildAndPublishVariables",
		reflect.TypeOf((*EcrBuildAndPublishVariables)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*InspectorEcrImageScanAction)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionProperties", GoGetter: "ActionProperties"},
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
			_jsii_.MemberMethod{JsiiMethod: "bound", GoMethod: "Bound"},
			...
			_jsii_.MemberProperty{JsiiProperty: "providedActionProperties", GoGetter: "ProvidedActionProperties"},
			_jsii_.MemberMethod{JsiiMethod: "renderActionConfiguration", GoMethod: "RenderActionConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "variableExpression", GoMethod: "VariableExpression"},
			_jsii_.MemberProperty{JsiiProperty: "variables", GoGetter: "Variables"},
		},
		func() interface{} {
			j := jsiiProxy_InspectorEcrImageScanAction{}
			_jsii_.InitJsiiProxy(&j.jsiiProxy_InspectorScanActionBase)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline_actions.InspectorEcrImageScanActionProps",
		reflect.TypeOf((*InspectorEcrImageScanActionProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_codepipeline_actions.InspectorScanActionBase",
		reflect.TypeOf((*InspectorScanActionBase)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionProperties", GoGetter: "ActionProperties"},
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
			_jsii_.MemberMethod{JsiiMethod: "bound", GoMethod: "Bound"},
		...
		func() interface{} {
			j := jsiiProxy_InspectorScanActionBase{}
			_jsii_.InitJsiiProxy(&j.jsiiProxy_Action)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InspectorScanActionBaseProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline_actions.InspectorScanVariables",
		reflect.TypeOf((*InspectorScanVariables)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_codepipeline_actions.InspectorSourceCodeScanAction",
		reflect.TypeOf((*InspectorSourceCodeScanAction)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionProperties", GoGetter: "ActionProperties"},
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
			_jsii_.MemberMethod{JsiiMethod: "bound", GoMethod: "Bound"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline_actions.InspectorSourceCodeScanActionProps",
		reflect.TypeOf((*InspectorSourceCodeScanActionProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
