...
// This method is guaranteed to be called only once for each Action instance.
// Experimental.
func (m *jsiiProxy_ManualApprovalAction) Bound(scope constructs.Construct, _stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig {
	var returns *awscodepipeline.ActionConfig
...
// Experimental.
type ServiceCatalogDeployAction interface {
	Action
	ActionProperties() *awscodepipeline.ActionProperties
	Bind(scope constructs.Construct, stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig
	Bound(_scope constructs.Construct, _stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig
...
// The jsii proxy struct for ServiceCatalogDeployAction
type jsiiProxy_ServiceCatalogDeployAction struct {
	jsiiProxy_Action
}

func (j *jsiiProxy_ServiceCatalogDeployAction) ActionProperties() *awscodepipeline.ActionProperties {
	var returns *awscodepipeline.ActionProperties
	_jsii_.Get(
		j,
		"actionProperties",
...
// Experimental.
func NewServiceCatalogDeployAction(props *ServiceCatalogDeployActionProps) ServiceCatalogDeployAction {
	_init_.Initialize()

	j := jsiiProxy_ServiceCatalogDeployAction{}

	_jsii_.Create(
		"aws-cdk-lib.aws_codepipeline_actions.ServiceCatalogDeployAction",
		[]interface{}{props},
		&j,
	)
...
// Experimental.
func NewServiceCatalogDeployAction_Override(s ServiceCatalogDeployAction, props *ServiceCatalogDeployActionProps) {
	_init_.Initialize()
...
// The callback invoked when this Action is added to a Pipeline.
// Experimental.
func (s *jsiiProxy_ServiceCatalogDeployAction) Bind(scope constructs.Construct, stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig {
	var returns *awscodepipeline.ActionConfig
...
// This method is guaranteed to be called only once for each Action instance.
// Experimental.
func (s *jsiiProxy_ServiceCatalogDeployAction) Bound(_scope constructs.Construct, _stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig {
	var returns *awscodepipeline.ActionConfig
...
// Experimental.
func (s *jsiiProxy_ServiceCatalogDeployAction) VariableExpression(variableName *string) *string {
	var returns *string
...
// Experimental.
type ServiceCatalogDeployActionProps struct {
	// The physical, human-readable name of the Action.
	//
	// Note that Action names must be unique within a single Stage.
	// Experimental.
