...
// This method is guaranteed to be called only once for each Action instance.
// Experimental.
func (m *jsiiProxy_ManualApprovalAction) Bound(scope awscdk.Construct, _stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig {
	var returns *awscodepipeline.ActionConfig
...
// This method is guaranteed to be called only once for each Action instance.
// Experimental.
func (s *jsiiProxy_ServiceCatalogDeployAction) Bound(_scope awscdk.Construct, _stage awscodepipeline.IStage, options *awscodepipeline.ActionBindOptions) *awscodepipeline.ActionConfig {
	var returns *awscodepipeline.ActionConfig
