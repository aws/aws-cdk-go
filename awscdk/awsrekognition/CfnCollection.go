...
func (j *jsiiProxy_CfnCollection) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnCollection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCollection) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnCollection) CollectionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collectionId",
...
func (j *jsiiProxy_CfnCollection) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnCollection) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnCollection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCollection) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnCollection) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnCollection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCollection(scope constructs.Construct, id *string, props *CfnCollectionProps) CfnCollection {
	...
	if err := validateNewCfnCollectionParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnCollection{}
...
func (j *jsiiProxy_CfnCollection)SetCollectionId(val *string) {
...
func CfnCollection_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCollection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCollection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCollection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCollection_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCollection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCollection) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnCollection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCollection) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCollection) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnCollection) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnCollection) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnCollection) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnCollection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCollection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCollection) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnCollection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCollection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCollection) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnCollection) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnCollection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCollection) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnCollection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCollection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCollection) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnCollection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCollection) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnCollection) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnCollection) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnCollection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
