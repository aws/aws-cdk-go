...
func (j *jsiiProxy_CfnStreamProcessor) CfnPropertyNames() *map[string]*string {
...
func CfnStreamProcessor_ArnForStreamProcessor(resource interfacesawsrekognition.IStreamProcessorRef) *string {
	_init_.Initialize()

	if err := validateCfnStreamProcessor_ArnForStreamProcessorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnStreamProcessor_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStreamProcessor_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamProcessor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStreamProcessor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStreamProcessor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStreamProcessor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamProcessor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
