...
//
//   cfnDataset := awscdk.Aws_rekognition.NewCfnDataset(this, jsii.String("MyCfnDataset"), &CfnDatasetProps{
...
type CfnDataset interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsrekognition.IDatasetRef
	awscdk.ITaggableV2
	...
	DatasetRef() *interfacesawsrekognition.DatasetReference
...
type jsiiProxy_CfnDataset struct {
	...
	internal.Type__interfacesawsrekognitionIDatasetRef
...
func (j *jsiiProxy_CfnDataset) DatasetRef() *interfacesawsrekognition.DatasetReference {
	var returns *interfacesawsrekognition.DatasetReference
	_jsii_.Get(
		j,
		"datasetRef",
		&returns,
...
func (j *jsiiProxy_CfnDataset) ProjectArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectArn",
...
func (j *jsiiProxy_CfnDataset)SetProjectArn(val *string) {
	_jsii_.Set(
		j,
		"projectArn",
		val,
...
func CfnDataset_ArnForDataset(resource interfacesawsrekognition.IDatasetRef) *string {
	_init_.Initialize()
