...
func (j *jsiiProxy_CfnAIPromptVersion) AssistantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assistantId",
...
func (j *jsiiProxy_CfnAIPromptVersion) AttrAiPromptArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiPromptArn",
...
func (j *jsiiProxy_CfnAIPromptVersion) AttrAiPromptVersionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiPromptVersionId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnAIPromptVersion) AttrAssistantArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAssistantArn",
...
func (j *jsiiProxy_CfnAIPromptVersion) AttrVersionNumber() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnAIPromptVersion) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAIPromptVersion) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAIPromptVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAIPromptVersion) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAIPromptVersion) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAIPromptVersion) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAIPromptVersion) ModifiedTimeSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"modifiedTimeSeconds",
...
func (j *jsiiProxy_CfnAIPromptVersion) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAIPromptVersion) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAIPromptVersion) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAIPromptVersion) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAIPromptVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAIPromptVersion(scope constructs.Construct, id *string, props *CfnAIPromptVersionProps) CfnAIPromptVersion {
	...
	if err := validateNewCfnAIPromptVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAIPromptVersion)SetAiPromptId(val *string) {
...
func (j *jsiiProxy_CfnAIPromptVersion)SetAssistantId(val *string) {
...
func (j *jsiiProxy_CfnAIPromptVersion)SetModifiedTimeSeconds(val *float64) {
	_jsii_.Set(
		j,
		"modifiedTimeSeconds",
		val,
...
func CfnAIPromptVersion_IsCfnAIPromptVersion(x interface{}) *bool {
	...
	if err := validateCfnAIPromptVersion_IsCfnAIPromptVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIPromptVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAIPromptVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIPromptVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAIPromptVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIPromptVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAIPromptVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAIPromptVersion) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIPromptVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAIPromptVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAIPromptVersion) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAIPromptVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAIPromptVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAIPromptVersion) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAIPromptVersion) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAIPromptVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAIPromptVersion) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAIPromptVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPromptVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPromptVersion) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAIPromptVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPromptVersion) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAIPromptVersion) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAIPromptVersion) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAIPromptVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
