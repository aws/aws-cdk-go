...
func (j *jsiiProxy_CfnAIGuardrailVersion) AssistantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assistantId",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) AttrAiGuardrailArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiGuardrailArn",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) AttrAiGuardrailVersionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiGuardrailVersionId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnAIGuardrailVersion) AttrAssistantArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAssistantArn",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) AttrVersionNumber() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) ModifiedTimeSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"modifiedTimeSeconds",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAIGuardrailVersion) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAIGuardrailVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAIGuardrailVersion(scope constructs.Construct, id *string, props *CfnAIGuardrailVersionProps) CfnAIGuardrailVersion {
	...
	if err := validateNewCfnAIGuardrailVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAIGuardrailVersion)SetAiGuardrailId(val *string) {
...
func (j *jsiiProxy_CfnAIGuardrailVersion)SetAssistantId(val *string) {
...
func (j *jsiiProxy_CfnAIGuardrailVersion)SetModifiedTimeSeconds(val *float64) {
	_jsii_.Set(
		j,
		"modifiedTimeSeconds",
		val,
...
func CfnAIGuardrailVersion_IsCfnAIGuardrailVersion(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrailVersion_IsCfnAIGuardrailVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrailVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrailVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrailVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrailVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrailVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrailVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAIGuardrailVersion) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAIGuardrailVersion) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrailVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
