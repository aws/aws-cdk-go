...
func (j *jsiiProxy_CfnQuickResponse) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnQuickResponse) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQuickResponse) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQuickResponse) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQuickResponse) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQuickResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
