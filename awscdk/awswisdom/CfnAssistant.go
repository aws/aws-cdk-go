...
func (j *jsiiProxy_CfnAssistant) CfnPropertyNames() *map[string]*string {
...
func NewCfnAssistant(scope constructs.Construct, id *string, props *CfnAssistantProps) CfnAssistant {
	...
	if err := validateNewCfnAssistantParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAssistant_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAssistant_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAssistant_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAssistant_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAssistant_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAssistant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssistant) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssistant) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssistant) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssistant) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssistant) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAssistant) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAssistant) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssistant) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssistant) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssistant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
