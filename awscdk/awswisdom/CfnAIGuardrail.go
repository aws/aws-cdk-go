...
func (j *jsiiProxy_CfnAIGuardrail) AssistantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assistantId",
...
func (j *jsiiProxy_CfnAIGuardrail) AttrAiGuardrailArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiGuardrailArn",
...
func (j *jsiiProxy_CfnAIGuardrail) AttrAiGuardrailId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAiGuardrailId",
...
func (j *jsiiProxy_CfnAIGuardrail) AttrAssistantArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAssistantArn",
...
func (j *jsiiProxy_CfnAIGuardrail) BlockedInputMessaging() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAIGuardrail) BlockedOutputsMessaging() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAIGuardrail) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAIGuardrail) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAIGuardrail) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAIGuardrail) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAIGuardrail) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAIGuardrail) ContentPolicyConfig() interface{} {
...
func (j *jsiiProxy_CfnAIGuardrail) ContextualGroundingPolicyConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAIGuardrail) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAIGuardrail) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAIGuardrail) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAIGuardrail) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAIGuardrail) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAIGuardrail) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAIGuardrail) SensitiveInformationPolicyConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAIGuardrail) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAIGuardrail) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnAIGuardrail) TopicPolicyConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"topicPolicyConfig",
...
func (j *jsiiProxy_CfnAIGuardrail) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAIGuardrail) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnAIGuardrail) WordPolicyConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"wordPolicyConfig",
...
func NewCfnAIGuardrail(scope constructs.Construct, id *string, props *CfnAIGuardrailProps) CfnAIGuardrail {
	...
	if err := validateNewCfnAIGuardrailParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAIGuardrail)SetAssistantId(val *string) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetBlockedInputMessaging(val *string) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetBlockedOutputsMessaging(val *string) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetContentPolicyConfig(val interface{}) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetContextualGroundingPolicyConfig(val interface{}) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAIGuardrail)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnAIGuardrail)SetSensitiveInformationPolicyConfig(val interface{}) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func (j *jsiiProxy_CfnAIGuardrail)SetTopicPolicyConfig(val interface{}) {
...
func (j *jsiiProxy_CfnAIGuardrail)SetWordPolicyConfig(val interface{}) {
...
func CfnAIGuardrail_ArnForAIGuardrail(resource interfacesawswisdom.IAIGuardrailRef) *string {
	...
	if err := validateCfnAIGuardrail_ArnForAIGuardrailParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAIGuardrail_IsCfnAIGuardrail(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrail_IsCfnAIGuardrailParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrail_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrail_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrail_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrail_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrail_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAIGuardrail_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAIGuardrail) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrail) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAIGuardrail) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAIGuardrail) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAIGuardrail) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAIGuardrail) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAIGuardrail) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAIGuardrail) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAIGuardrail) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAIGuardrail) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAIGuardrail) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrail) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrail) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAIGuardrail) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIGuardrail) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAIGuardrail) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAIGuardrail) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAIGuardrail) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
