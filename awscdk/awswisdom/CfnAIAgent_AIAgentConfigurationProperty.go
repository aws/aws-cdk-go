...
type CfnAIAgent_AIAgentConfigurationProperty struct {
	...
	//
	SessionSummarizationAiAgentConfiguration interface{} `field:"optional" json:"sessionSummarizationAiAgentConfiguration" yaml:"sessionSummarizationAiAgentConfiguration"`
}
