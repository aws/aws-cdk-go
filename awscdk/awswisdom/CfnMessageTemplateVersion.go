...
func (j *jsiiProxy_CfnMessageTemplateVersion) AttrMessageTemplateVersionArn() *string {
	...
	_jsii_.Get(
		j,
		"attrMessageTemplateVersionArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnMessageTemplateVersion) AttrMessageTemplateVersionNumber() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrMessageTemplateVersionNumber",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnMessageTemplateVersion) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnMessageTemplateVersion) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMessageTemplateVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMessageTemplateVersion) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) MessageTemplateArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"messageTemplateArn",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) MessageTemplateContentSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMessageTemplateVersion) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMessageTemplateVersion) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMessageTemplateVersion) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMessageTemplateVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMessageTemplateVersion(scope constructs.Construct, id *string, props *CfnMessageTemplateVersionProps) CfnMessageTemplateVersion {
	...
	if err := validateNewCfnMessageTemplateVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMessageTemplateVersion)SetMessageTemplateArn(val *string) {
...
func (j *jsiiProxy_CfnMessageTemplateVersion)SetMessageTemplateContentSha256(val *string) {
	_jsii_.Set(
		j,
		"messageTemplateContentSha256",
		val,
...
func CfnMessageTemplateVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMessageTemplateVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMessageTemplateVersion_IsCfnMessageTemplateVersion(x interface{}) *bool {
	...
	if err := validateCfnMessageTemplateVersion_IsCfnMessageTemplateVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMessageTemplateVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMessageTemplateVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMessageTemplateVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMessageTemplateVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMessageTemplateVersion) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMessageTemplateVersion) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMessageTemplateVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
