...
func (j *jsiiProxy_CfnAIPrompt) CfnPropertyNames() *map[string]*string {
...
func CfnAIPrompt_IsCfnAIPrompt(x interface{}) *bool {
	...
	if err := validateCfnAIPrompt_IsCfnAIPromptParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAIPrompt) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAIPrompt) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAIPrompt) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAIPrompt) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAIPrompt) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
