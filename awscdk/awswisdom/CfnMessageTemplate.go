...
func (j *jsiiProxy_CfnMessageTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMessageTemplate) MessageTemplateAttachments() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMessageTemplate)SetMessageTemplateAttachments(val interface{}) {
	if err := j.validateSetMessageTemplateAttachmentsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnMessageTemplate_ArnForMessageTemplate(resource interfacesawswisdom.IMessageTemplateRef) *string {
	...
	if err := validateCfnMessageTemplate_ArnForMessageTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnMessageTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMessageTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMessageTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMessageTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMessageTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
