...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_wisdom.CfnAIAgent.SessionSummarizationAIAgentConfigurationProperty",
		reflect.TypeOf((*CfnAIAgent_SessionSummarizationAIAgentConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
