...
func (j *jsiiProxy_CfnOrganization) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnOrganization) AttrManagementAccountArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOrganization) AttrManagementAccountEmail() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOrganization) AttrManagementAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOrganization) AttrRootId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRootId",
...
func (j *jsiiProxy_CfnOrganization) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOrganization) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOrganization) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOrganization) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOrganization) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOrganization) FeatureSet() *string {
	var returns *string
	_jsii_.Get(
		j,
		"featureSet",
...
func (j *jsiiProxy_CfnOrganization) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOrganization) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOrganization) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOrganization) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOrganization) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOrganization) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOrganization(scope constructs.Construct, id *string, props *CfnOrganizationProps) CfnOrganization {
	...
	if err := validateNewCfnOrganizationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOrganization)SetFeatureSet(val *string) {
	_jsii_.Set(
		j,
		"featureSet",
		val,
...
func CfnOrganization_ArnForOrganization(resource interfacesawsorganizations.IOrganizationRef) *string {
	_init_.Initialize()

	if err := validateCfnOrganization_ArnForOrganizationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnOrganization_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOrganization_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganization_IsCfnOrganization(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganization_IsCfnOrganizationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganization_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganization_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganization_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOrganization_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOrganization) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOrganization) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganization) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganization) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganization) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganization) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOrganization) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganization) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganization) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganization) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOrganization) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganization) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOrganization) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOrganization) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOrganization) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOrganization) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOrganization) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganization) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganization) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOrganization) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganization) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOrganization) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOrganization) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOrganization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
