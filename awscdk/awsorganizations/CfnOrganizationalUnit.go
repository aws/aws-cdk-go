...
func (j *jsiiProxy_CfnOrganizationalUnit) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnOrganizationalUnit) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOrganizationalUnit) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOrganizationalUnit) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOrganizationalUnit) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOrganizationalUnit) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOrganizationalUnit) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOrganizationalUnit) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnOrganizationalUnit) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOrganizationalUnit) ParentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentId",
...
func (j *jsiiProxy_CfnOrganizationalUnit) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOrganizationalUnit) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOrganizationalUnit) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnOrganizationalUnit) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOrganizationalUnit(scope constructs.Construct, id *string, props *CfnOrganizationalUnitProps) CfnOrganizationalUnit {
	...
	if err := validateNewCfnOrganizationalUnitParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnOrganizationalUnit{}
...
func (j *jsiiProxy_CfnOrganizationalUnit)SetName(val *string) {
...
func (j *jsiiProxy_CfnOrganizationalUnit)SetParentId(val *string) {
...
func CfnOrganizationalUnit_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOrganizationalUnit_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationalUnit_IsCfnOrganizationalUnit(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOrganizationalUnit_IsCfnOrganizationalUnitParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationalUnit_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganizationalUnit_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationalUnit_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOrganizationalUnit_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganizationalUnit) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOrganizationalUnit) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOrganizationalUnit) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOrganizationalUnit) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOrganizationalUnit) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationalUnit) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOrganizationalUnit) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOrganizationalUnit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
