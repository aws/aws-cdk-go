...
func CfnAccount_ArnForAccount(resource interfacesawsorganizations.IAccountRef) *string {
	_init_.Initialize()

	if err := validateCfnAccount_ArnForAccountParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
