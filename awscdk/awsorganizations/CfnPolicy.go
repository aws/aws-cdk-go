...
type CfnPolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsorganizations.IPolicyRef
	awscdk.ITaggable
	...
	PolicyRef() *interfacesawsorganizations.PolicyReference
...
type jsiiProxy_CfnPolicy struct {
	...
	internal.Type__interfacesawsorganizationsIPolicyRef
...
func (j *jsiiProxy_CfnPolicy) AttrAwsManaged() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPolicy) Content() interface{} {
...
func (j *jsiiProxy_CfnPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPolicy) PolicyRef() *interfacesawsorganizations.PolicyReference {
	var returns *interfacesawsorganizations.PolicyReference
	_jsii_.Get(
		j,
		"policyRef",
		&returns,
...
func (j *jsiiProxy_CfnPolicy) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnPolicy)SetContent(val interface{}) {
...
func (j *jsiiProxy_CfnPolicy)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnPolicy)SetName(val *string) {
...
func (j *jsiiProxy_CfnPolicy)SetTargetIds(val *[]*string) {
	_jsii_.Set(
		j,
		"targetIds",
		val,
...
func (j *jsiiProxy_CfnPolicy)SetType(val *string) {
...
func CfnPolicy_ArnForPolicy(resource interfacesawsorganizations.IPolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnPolicy_ArnForPolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPolicy_IsCfnPolicy(x interface{}) *bool {
	...
	if err := validateCfnPolicy_IsCfnPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
