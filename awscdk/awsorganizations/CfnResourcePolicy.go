...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsorganizations.IResourcePolicyRef
	awscdk.ITaggable
	...
	ResourcePolicyRef() *interfacesawsorganizations.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawsorganizationsIResourcePolicyRef
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawsorganizations.ResourcePolicyReference {
	var returns *interfacesawsorganizations.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnResourcePolicy) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnResourcePolicy)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnResourcePolicy_ArnForResourcePolicy(resource interfacesawsorganizations.IResourcePolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnResourcePolicy_ArnForResourcePolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
