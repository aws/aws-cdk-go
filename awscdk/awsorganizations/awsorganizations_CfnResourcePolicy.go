...
func (j *jsiiProxy_CfnResourcePolicy) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnResourcePolicy) Content() interface{} {
...
func (j *jsiiProxy_CfnResourcePolicy) Tags() awscdk.TagManager {
...
func NewCfnResourcePolicy(scope awscdk.Construct, id *string, props *CfnResourcePolicyProps) CfnResourcePolicy {
	...
	_jsii_.Create(
		"monocdk.aws_organizations.CfnResourcePolicy",
...
func (j *jsiiProxy_CfnResourcePolicy)SetContent(val interface{}) {
