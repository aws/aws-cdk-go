...
func (j *jsiiProxy_CfnSecurityConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityConfiguration(scope constructs.Construct, id *string, props *CfnSecurityConfigurationProps) CfnSecurityConfiguration {
	...
	if err := validateNewCfnSecurityConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSecurityConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecurityConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSecurityConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecurityConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
