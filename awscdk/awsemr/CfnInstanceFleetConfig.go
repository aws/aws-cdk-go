...
func (j *jsiiProxy_CfnInstanceFleetConfig) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInstanceFleetConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInstanceFleetConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInstanceFleetConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInstanceFleetConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInstanceFleetConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
