...
func (j *jsiiProxy_CfnStep) CfnPropertyNames() *map[string]*string {
...
func CfnStep_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStep_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStep) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStep) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStep) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStep) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStep) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
