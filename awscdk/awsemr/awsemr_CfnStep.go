...
func (j *jsiiProxy_CfnStep) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStep(scope constructs.Construct, id *string, props *CfnStepProps) CfnStep {
	...
	if err := validateNewCfnStepParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnStep{}
...
func CfnStep_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStep_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStep_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnStep_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStep_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStep_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStep) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStep) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStep) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStep) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnStep) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStep) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
