...
func (j *jsiiProxy_CfnStudioSessionMapping) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStudioSessionMapping) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStudioSessionMapping(scope constructs.Construct, id *string, props *CfnStudioSessionMappingProps) CfnStudioSessionMapping {
	...
	if err := validateNewCfnStudioSessionMappingParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnStudioSessionMapping_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStudioSessionMapping_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStudioSessionMapping_IsCfnStudioSessionMapping(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStudioSessionMapping_IsCfnStudioSessionMappingParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStudioSessionMapping_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStudioSessionMapping_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStudioSessionMapping) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStudioSessionMapping) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStudioSessionMapping) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStudioSessionMapping) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioSessionMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
