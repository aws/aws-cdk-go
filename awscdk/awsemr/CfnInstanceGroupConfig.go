...
func (j *jsiiProxy_CfnInstanceGroupConfig) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInstanceGroupConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInstanceGroupConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInstanceGroupConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInstanceGroupConfig) RemoveResourceDependency(target awscdk.CfnResource) {
