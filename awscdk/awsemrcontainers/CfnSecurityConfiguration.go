...
//
//   cfnSecurityConfiguration := awscdk.Aws_emrcontainers.NewCfnSecurityConfiguration(this, jsii.String("MyCfnSecurityConfiguration"), &CfnSecurityConfigurationProps{
...
type CfnSecurityConfiguration interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsemrcontainers.ISecurityConfigurationRef
	awscdk.ITaggableV2
	...
	SecurityConfigurationData() interface{}
	SetSecurityConfigurationData(val interface{})
	// A reference to a SecurityConfiguration resource.
	SecurityConfigurationRef() *interfacesawsemrcontainers.SecurityConfigurationReference
...
type jsiiProxy_CfnSecurityConfiguration struct {
	...
	internal.Type__interfacesawsemrcontainersISecurityConfigurationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnSecurityConfiguration) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnSecurityConfiguration) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnSecurityConfiguration) ContainerProvider() interface{} {
...
func (j *jsiiProxy_CfnSecurityConfiguration) SecurityConfigurationData() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSecurityConfiguration) SecurityConfigurationRef() *interfacesawsemrcontainers.SecurityConfigurationReference {
	var returns *interfacesawsemrcontainers.SecurityConfigurationReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSecurityConfiguration) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnSecurityConfiguration)SetContainerProvider(val interface{}) {
...
func (j *jsiiProxy_CfnSecurityConfiguration)SetSecurityConfigurationData(val interface{}) {
	if err := j.validateSetSecurityConfigurationDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSecurityConfiguration)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnSecurityConfiguration_ArnForSecurityConfiguration(resource interfacesawsemrcontainers.ISecurityConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnSecurityConfiguration_ArnForSecurityConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
