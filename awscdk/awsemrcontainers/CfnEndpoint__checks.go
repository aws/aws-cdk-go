...
func (c *jsiiProxy_CfnEndpoint) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnEndpoint) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnEndpoint) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnEndpoint) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnEndpoint_ArnForEndpointParameters(resource interfacesawsemrcontainers.IEndpointRef) error {
	if resource == nil {
...
func validateCfnEndpoint_IsCfnEndpointParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetConfigurationOverridesParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnEndpoint_ConfigurationOverridesProperty:
		val := val.(*CfnEndpoint_ConfigurationOverridesProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnEndpoint_ConfigurationOverridesProperty:
		val_ := val.(CfnEndpoint_ConfigurationOverridesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnEndpoint_ConfigurationOverridesProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetExecutionRoleArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnEndpoint) validateSetReleaseLabelParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
...
func (j *jsiiProxy_CfnEndpoint) validateSetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetVirtualClusterIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
