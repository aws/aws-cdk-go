...
type CfnVirtualCluster interface {
	...
	SetSecurityConfigurationId(val *string)
	// Whether the virtual cluster is session-enabled for Spark Connect.
	SessionEnabled() interface{}
	SetSessionEnabled(val interface{})
...
func (j *jsiiProxy_CfnVirtualCluster) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVirtualCluster) SecurityConfigurationId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVirtualCluster) SessionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sessionEnabled",
...
func (j *jsiiProxy_CfnVirtualCluster)SetSecurityConfigurationId(val *string) {
	_jsii_.Set(
		j,
		"securityConfigurationId",
		val,
...
func (j *jsiiProxy_CfnVirtualCluster)SetSessionEnabled(val interface{}) {
	if err := j.validateSetSessionEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnVirtualCluster_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualCluster_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
