...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrAuthProxyUrl", GoGetter: "AttrAuthProxyUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sessionIdleTimeoutInMinutes", GoGetter: "SessionIdleTimeoutInMinutes"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sessionEnabled", GoGetter: "SessionEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "shouldSynthesize", GoMethod: "ShouldSynthesize"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "tags", GoGetter: "Tags"},
