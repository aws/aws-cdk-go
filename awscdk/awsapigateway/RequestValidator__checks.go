...
func (r *jsiiProxy_RequestValidator) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateRequestValidator_FromRequestValidatorIdParameters(scope constructs.Construct, id *string, requestValidatorId *string) error {
	...
	if requestValidatorId == nil {
		return fmt.Errorf("parameter requestValidatorId is required, but nil was provided")
	}
