...
func (i *jsiiProxy_IRestApi) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (i *jsiiProxy_IRestApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRestApi) Node() constructs.Node {
