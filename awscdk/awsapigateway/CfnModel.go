...
func (j *jsiiProxy_CfnModel) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnModel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
