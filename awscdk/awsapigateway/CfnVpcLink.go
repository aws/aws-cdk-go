...
func (j *jsiiProxy_CfnVpcLink) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVpcLink) VpcLinkRef() *interfacesawsapigateway.VpcLinkReference {
...
func NewCfnVpcLink(scope constructs.Construct, id *string, props *CfnVpcLinkProps) CfnVpcLink {
	...
	if err := validateNewCfnVpcLinkParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVpcLink_FromVpcLinkId(scope constructs.Construct, id *string, vpcLinkId *string) interfacesawsapigateway.IVpcLinkRef {
	_init_.Initialize()

	if err := validateCfnVpcLink_FromVpcLinkIdParameters(scope, id, vpcLinkId); err != nil {
		panic(err)
	}
	var returns interfacesawsapigateway.IVpcLinkRef
...
func CfnVpcLink_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVpcLink_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcLink_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVpcLink_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVpcLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcLink) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcLink) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcLink) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcLink) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcLink) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVpcLink) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVpcLink) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcLink) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcLink) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcLink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
