...
func (j *jsiiProxy_CfnApiKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApiKey)SetGenerateDistinctId(val interface{}) {
	if err := j.validateSetGenerateDistinctIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApiKey)SetStageKeys(val interface{}) {
	if err := j.validateSetStageKeysParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CfnApiKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
