...
func GatewayResponse_FromGatewayResponseId(scope constructs.Construct, id *string, gatewayResponseId *string) IGatewayResponse {
	_init_.Initialize()

	if err := validateGatewayResponse_FromGatewayResponseIdParameters(scope, id, gatewayResponseId); err != nil {
		panic(err)
	}
	var returns IGatewayResponse

	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_apigateway.GatewayResponse",
		"fromGatewayResponseId",
		[]interface{}{scope, id, gatewayResponseId},
		&returns,
	)
...
func GatewayResponse_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateGatewayResponse_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func GatewayResponse_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.GatewayResponse",
...
func (g *jsiiProxy_GatewayResponse) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GatewayResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
