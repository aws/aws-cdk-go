...
func (j *jsiiProxy_SpecRestApi) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_SpecRestApi) RestApiRef() *interfacesawsapigateway.RestApiReference {
...
func SpecRestApi_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.SpecRestApi",
...
func (s *jsiiProxy_SpecRestApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SpecRestApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
