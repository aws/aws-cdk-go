...
func (j *jsiiProxy_CfnDocumentationPart) CfnPropertyNames() *map[string]*string {
...
func NewCfnDocumentationPart(scope constructs.Construct, id *string, props *CfnDocumentationPartProps) CfnDocumentationPart {
	...
	if err := validateNewCfnDocumentationPartParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDocumentationPart_IsCfnDocumentationPart(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDocumentationPart_IsCfnDocumentationPartParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocumentationPart_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDocumentationPart_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocumentationPart_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDocumentationPart_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocumentationPart_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDocumentationPart_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDocumentationPart) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationPart) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDocumentationPart) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDocumentationPart) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDocumentationPart) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDocumentationPart) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDocumentationPart) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationPart) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationPart) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationPart) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
