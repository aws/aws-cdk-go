...
func (j *jsiiProxy_LambdaRestApi) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_LambdaRestApi) RestApiRef() *interfacesawsapigateway.RestApiReference {
...
func LambdaRestApi_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.LambdaRestApi",
...
func (l *jsiiProxy_LambdaRestApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
