...
func NewCfnModelV2(scope awscdk.Construct, id *string, props *CfnModelV2Props) CfnModelV2 {
	...
	if err := validateNewCfnModelV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnModelV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnModelV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelV2_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnModelV2_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnModelV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
