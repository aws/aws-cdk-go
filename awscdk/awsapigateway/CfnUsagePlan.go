...
func (j *jsiiProxy_CfnUsagePlan) CfnPropertyNames() *map[string]*string {
...
func NewCfnUsagePlan(scope constructs.Construct, id *string, props *CfnUsagePlanProps) CfnUsagePlan {
	...
	if err := validateNewCfnUsagePlanParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnUsagePlan)SetApiStages(val interface{}) {
	if err := j.validateSetApiStagesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnUsagePlan_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUsagePlan_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUsagePlan_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUsagePlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUsagePlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUsagePlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUsagePlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUsagePlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUsagePlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUsagePlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUsagePlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUsagePlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
