...
func (j *jsiiProxy_CfnMethod) CfnPropertyNames() *map[string]*string {
...
func CfnMethod_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMethod_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMethod) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMethod) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMethod) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMethod) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMethod) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
