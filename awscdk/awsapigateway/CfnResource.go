...
func (j *jsiiProxy_CfnResource) CfnPropertyNames() *map[string]*string {
...
func NewCfnResource(scope constructs.Construct, id *string, props *CfnResourceProps) CfnResource {
	...
	if err := validateNewCfnResourceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResource_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResource_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResource_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResource_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResource_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResource) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResource) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResource) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResource) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResource) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
