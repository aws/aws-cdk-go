...
func (j *jsiiProxy_ResourceBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ResourceBase) ResourceRef() *interfacesawsapigateway.ResourceReference {
...
func (r *jsiiProxy_ResourceBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ResourceBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
