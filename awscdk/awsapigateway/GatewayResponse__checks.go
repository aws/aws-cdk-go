...
func (g *jsiiProxy_GatewayResponse) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateGatewayResponse_FromGatewayResponseIdParameters(scope constructs.Construct, id *string, gatewayResponseId *string) error {
	if scope == nil {
	...
	if gatewayResponseId == nil {
		return fmt.Errorf("parameter gatewayResponseId is required, but nil was provided")
	}
