...
func (j *jsiiProxy_RequestValidator) Env() *interfaces.ResourceEnvironment {
...
func RequestValidator_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRequestValidator_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RequestValidator_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.RequestValidator",
...
func (r *jsiiProxy_RequestValidator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RequestValidator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
