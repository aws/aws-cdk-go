...
func (j *jsiiProxy_CognitoUserPoolsAuthorizer) Env() *interfaces.ResourceEnvironment {
...
func (c *jsiiProxy_CognitoUserPoolsAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CognitoUserPoolsAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
