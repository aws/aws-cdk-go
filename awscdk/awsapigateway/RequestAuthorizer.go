...
func (j *jsiiProxy_RequestAuthorizer) AuthorizerProps() *CfnAuthorizerProps {
...
func (j *jsiiProxy_RequestAuthorizer) Env() *interfaces.ResourceEnvironment {
...
func RequestAuthorizer_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRequestAuthorizer_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RequestAuthorizer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.RequestAuthorizer",
...
func (r *jsiiProxy_RequestAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RequestAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
