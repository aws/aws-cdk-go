...
func (j *jsiiProxy_CfnRequestValidator) CfnPropertyNames() *map[string]*string {
...
func NewCfnRequestValidator(scope constructs.Construct, id *string, props *CfnRequestValidatorProps) CfnRequestValidator {
	...
	if err := validateNewCfnRequestValidatorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRequestValidator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRequestValidator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRequestValidator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRequestValidator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRequestValidator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRequestValidator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRequestValidator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRequestValidator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRequestValidator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRequestValidator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRequestValidator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRequestValidator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRequestValidator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRequestValidator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRequestValidator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRequestValidator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
