...
func (j *jsiiProxy_RateLimitedApiKey) Grants() ApiKeyGrants {
...
func RateLimitedApiKey_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRateLimitedApiKey_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RateLimitedApiKey_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.RateLimitedApiKey",
...
func (r *jsiiProxy_RateLimitedApiKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
