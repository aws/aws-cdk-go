...
func (j *jsiiProxy_CfnRestApi) CfnPropertyNames() *map[string]*string {
...
func CfnRestApi_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRestApi_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRestApi) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRestApi) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRestApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRestApi) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRestApi) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRestApi) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRestApi) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRestApi) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRestApi) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRestApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
