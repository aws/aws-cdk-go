...
type CfnBasePathMapping interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsapigateway.IBasePathMappingRef
	// The base path name that callers of the API must provide as part of the URL after the domain name.
	BasePath() *string
	SetBasePath(val *string)
	// A reference to a BasePathMapping resource.
	BasePathMappingRef() *interfacesawsapigateway.BasePathMappingReference
...
type jsiiProxy_CfnBasePathMapping struct {
	...
	internal.Type__interfacesawsapigatewayIBasePathMappingRef
}
...
func (j *jsiiProxy_CfnBasePathMapping) BasePathMappingRef() *interfacesawsapigateway.BasePathMappingReference {
	var returns *interfacesawsapigateway.BasePathMappingReference
	_jsii_.Get(
		j,
		"basePathMappingRef",
		&returns,
...
func (j *jsiiProxy_CfnBasePathMapping) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBasePathMapping) Env() *interfaces.ResourceEnvironment {
...
func NewCfnBasePathMapping(scope constructs.Construct, id *string, props *CfnBasePathMappingProps) CfnBasePathMapping {
	...
	if err := validateNewCfnBasePathMappingParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnBasePathMapping_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBasePathMapping_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBasePathMapping_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBasePathMapping_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBasePathMapping_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBasePathMapping_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBasePathMapping) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBasePathMapping) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBasePathMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBasePathMapping) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBasePathMapping) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBasePathMapping) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBasePathMapping) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBasePathMapping) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBasePathMapping) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBasePathMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
