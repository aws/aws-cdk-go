...
func (j *jsiiProxy_CfnAuthorizer) CfnPropertyNames() *map[string]*string {
...
func CfnAuthorizer_IsCfnAuthorizer(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAuthorizer_IsCfnAuthorizerParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAuthorizer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAuthorizer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAuthorizer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAuthorizer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAuthorizer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAuthorizer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAuthorizer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAuthorizer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAuthorizer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAuthorizer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
