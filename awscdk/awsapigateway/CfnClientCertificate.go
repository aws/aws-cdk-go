...
func (j *jsiiProxy_CfnClientCertificate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnClientCertificate) TagsRaw() *[]*awscdk.CfnTag {
...
func NewCfnClientCertificate(scope constructs.Construct, id *string, props *CfnClientCertificateProps) CfnClientCertificate {
	...
	if err := validateNewCfnClientCertificateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnClientCertificate)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnClientCertificate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClientCertificate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientCertificate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnClientCertificate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClientCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientCertificate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientCertificate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClientCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClientCertificate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClientCertificate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClientCertificate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClientCertificate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientCertificate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientCertificate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
