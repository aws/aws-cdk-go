...
func (j *jsiiProxy_CfnDocumentationVersion) CfnPropertyNames() *map[string]*string {
...
func NewCfnDocumentationVersion(scope constructs.Construct, id *string, props *CfnDocumentationVersionProps) CfnDocumentationVersion {
	...
	if err := validateNewCfnDocumentationVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDocumentationVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDocumentationVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocumentationVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDocumentationVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDocumentationVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDocumentationVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDocumentationVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDocumentationVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDocumentationVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDocumentationVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDocumentationVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDocumentationVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
