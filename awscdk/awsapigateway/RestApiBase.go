...
func (j *jsiiProxy_RestApiBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_RestApiBase) RestApiRef() *interfacesawsapigateway.RestApiReference {
...
func (r *jsiiProxy_RestApiBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RestApiBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
