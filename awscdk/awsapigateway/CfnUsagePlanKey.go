...
func (j *jsiiProxy_CfnUsagePlanKey) CfnPropertyNames() *map[string]*string {
...
func NewCfnUsagePlanKey(scope constructs.Construct, id *string, props *CfnUsagePlanKeyProps) CfnUsagePlanKey {
	...
	if err := validateNewCfnUsagePlanKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUsagePlanKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUsagePlanKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUsagePlanKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUsagePlanKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUsagePlanKey_IsCfnUsagePlanKey(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUsagePlanKey_IsCfnUsagePlanKeyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUsagePlanKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUsagePlanKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUsagePlanKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlanKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUsagePlanKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUsagePlanKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUsagePlanKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUsagePlanKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUsagePlanKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlanKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlanKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUsagePlanKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
