...
func (r *jsiiProxy_Resource) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateResource_IsResourceParameters(construct awscdk.IConstruct) error {
	return nil
}
