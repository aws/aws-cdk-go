...
func (j *jsiiProxy_CfnGatewayResponse) CfnPropertyNames() *map[string]*string {
...
func NewCfnGatewayResponse(scope constructs.Construct, id *string, props *CfnGatewayResponseProps) CfnGatewayResponse {
	...
	if err := validateNewCfnGatewayResponseParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGatewayResponse_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGatewayResponse_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayResponse_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGatewayResponse_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayResponse_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGatewayResponse_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGatewayResponse) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayResponse) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGatewayResponse) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGatewayResponse) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGatewayResponse) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGatewayResponse) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGatewayResponse) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayResponse) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayResponse) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
