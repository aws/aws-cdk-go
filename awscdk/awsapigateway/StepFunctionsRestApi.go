...
func (j *jsiiProxy_StepFunctionsRestApi) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_StepFunctionsRestApi) RestApiRef() *interfacesawsapigateway.RestApiReference {
...
func StepFunctionsRestApi_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.StepFunctionsRestApi",
...
func (s *jsiiProxy_StepFunctionsRestApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
