...
func (j *jsiiProxy_Resource) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_Resource) ResourceRef() *interfacesawsapigateway.ResourceReference {
...
func Resource_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.Resource",
...
func (r *jsiiProxy_Resource) AddMethod(httpMethod *string, target Integration, options *MethodOptions) Method {
