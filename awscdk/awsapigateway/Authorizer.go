...
func (j *jsiiProxy_Authorizer) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_Authorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_Authorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
