...
func NewCfnDeploymentV2(scope awscdk.Construct, id *string, props *CfnDeploymentV2Props) CfnDeploymentV2 {
	...
	if err := validateNewCfnDeploymentV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDeploymentV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeploymentV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentV2_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDeploymentV2_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeploymentV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeploymentV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
