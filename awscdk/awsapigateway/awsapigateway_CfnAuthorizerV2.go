...
func NewCfnAuthorizerV2(scope awscdk.Construct, id *string, props *CfnAuthorizerV2Props) CfnAuthorizerV2 {
	...
	if err := validateNewCfnAuthorizerV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAuthorizerV2)SetJwtConfiguration(val interface{}) {
	if err := j.validateSetJwtConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAuthorizerV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAuthorizerV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAuthorizerV2_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAuthorizerV2_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAuthorizerV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAuthorizerV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
