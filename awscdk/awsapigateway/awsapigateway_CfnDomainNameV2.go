...
func NewCfnDomainNameV2(scope awscdk.Construct, id *string, props *CfnDomainNameV2Props) CfnDomainNameV2 {
	...
	if err := validateNewCfnDomainNameV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDomainNameV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDomainNameV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainNameV2_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDomainNameV2_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainNameV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDomainNameV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
