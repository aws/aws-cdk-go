...
func NewCfnApiMappingV2(scope awscdk.Construct, id *string, props *CfnApiMappingV2Props) CfnApiMappingV2 {
	...
	if err := validateNewCfnApiMappingV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApiMappingV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApiMappingV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiMappingV2_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnApiMappingV2_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiMappingV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApiMappingV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
