...
func ProxyResource_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.ProxyResource",
...
func (p *jsiiProxy_ProxyResource) AddMethod(httpMethod *string, target Integration, options *MethodOptions) Method {
...
func (p *jsiiProxy_ProxyResource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_ProxyResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
