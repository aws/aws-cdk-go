...
func (j *jsiiProxy_TokenAuthorizer) Env() *interfaces.ResourceEnvironment {
...
func TokenAuthorizer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.TokenAuthorizer",
...
func (t *jsiiProxy_TokenAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TokenAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
