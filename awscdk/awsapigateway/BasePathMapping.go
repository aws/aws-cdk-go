...
func (j *jsiiProxy_BasePathMapping) Env() *interfaces.ResourceEnvironment {
...
func BasePathMapping_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.BasePathMapping",
...
func (b *jsiiProxy_BasePathMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BasePathMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
