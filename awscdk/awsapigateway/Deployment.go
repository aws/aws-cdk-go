...
func (j *jsiiProxy_Deployment) Env() *interfaces.ResourceEnvironment {
...
func Deployment_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigateway.Deployment",
...
func (d *jsiiProxy_Deployment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_Deployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
