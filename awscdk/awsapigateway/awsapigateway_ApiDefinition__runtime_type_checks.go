...
func (a *jsiiProxy_ApiDefinition) validateBindParameters(scope awscdk.Construct) error {
	if scope == nil {
...
func (a *jsiiProxy_ApiDefinition) validateBindAfterCreateParameters(_scope awscdk.Construct, _restApi IRestApi) error {
	if _scope == nil {
