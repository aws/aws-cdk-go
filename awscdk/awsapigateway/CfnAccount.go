...
type CfnAccount interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsapigateway.IAccountRef
	// A reference to a Account resource.
	AccountRef() *interfacesawsapigateway.AccountReference
...
type jsiiProxy_CfnAccount struct {
	...
	internal.Type__interfacesawsapigatewayIAccountRef
}

func (j *jsiiProxy_CfnAccount) AccountRef() *interfacesawsapigateway.AccountReference {
	var returns *interfacesawsapigateway.AccountReference
	_jsii_.Get(
		j,
		"accountRef",
		&returns,
...
func (j *jsiiProxy_CfnAccount) CfnPropertyNames() *map[string]*string {
...
func CfnAccount_IsCfnAccount(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAccount_IsCfnAccountParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccount) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccount) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccount) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccount) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
