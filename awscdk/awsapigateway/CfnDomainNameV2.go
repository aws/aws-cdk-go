...
func (j *jsiiProxy_CfnDomainNameV2) AttrDomainNameArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainNameArn",
...
func (j *jsiiProxy_CfnDomainNameV2) AttrDomainNameId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainNameId",
...
func (j *jsiiProxy_CfnDomainNameV2) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDomainNameV2) CertificateArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificateArn",
...
func (j *jsiiProxy_CfnDomainNameV2) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDomainNameV2) Policy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnDomainNameV2) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDomainNameV2) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnDomainNameV2)SetCertificateArn(val *string) {
	_jsii_.Set(
		j,
		"certificateArn",
		val,
...
func (j *jsiiProxy_CfnDomainNameV2)SetEndpointConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnDomainNameV2)SetSecurityPolicy(val *string) {
	_jsii_.Set(
		j,
		"securityPolicy",
		val,
...
func (j *jsiiProxy_CfnDomainNameV2)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDomainNameV2_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDomainNameV2_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDomainNameV2) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDomainNameV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDomainNameV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDomainNameV2) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDomainNameV2) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDomainNameV2) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameV2) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
