...
func (m *jsiiProxy_Method) validateAddMethodResponseParameters(methodResponse *MethodResponse) error {
	if methodResponse == nil {
		return fmt.Errorf("parameter methodResponse is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(methodResponse, func() string { return "parameter methodResponse" }); err != nil {
		return err
	}
