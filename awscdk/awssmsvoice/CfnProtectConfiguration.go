...
//
//   cfnProtectConfiguration := awscdk.Aws_smsvoice.NewCfnProtectConfiguration(this, jsii.String("MyCfnProtectConfiguration"), &CfnProtectConfigurationProps{
...
type CfnProtectConfiguration interface {
	...
	AttrProtectConfigurationId() *string
	...
	CountryRuleSet() interface{}
	SetCountryRuleSet(val interface{})
...
func (j *jsiiProxy_CfnProtectConfiguration) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnProtectConfiguration) AttrProtectConfigurationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrProtectConfigurationId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnProtectConfiguration) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnProtectConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnProtectConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnProtectConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProtectConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnProtectConfiguration) CountryRuleSet() interface{} {
...
func (j *jsiiProxy_CfnProtectConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnProtectConfiguration) DeletionProtectionEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnProtectConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnProtectConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnProtectConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnProtectConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnProtectConfiguration) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnProtectConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnProtectConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnProtectConfiguration(scope constructs.Construct, id *string, props *CfnProtectConfigurationProps) CfnProtectConfiguration {
	...
	if err := validateNewCfnProtectConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnProtectConfiguration{}
...
func (j *jsiiProxy_CfnProtectConfiguration)SetCountryRuleSet(val interface{}) {
	if err := j.validateSetCountryRuleSetParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnProtectConfiguration)SetDeletionProtectionEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnProtectConfiguration)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnProtectConfiguration_FromProtectConfigurationId(scope constructs.Construct, id *string, protectConfigurationId *string) interfacesawssmsvoice.IProtectConfigurationRef {
	...
	_jsii_.StaticInvoke(
		...
		[]interface{}{scope, id, protectConfigurationId},
		&returns,
	)
...
func CfnProtectConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProtectConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProtectConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProtectConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProtectConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProtectConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProtectConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_smsvoice.CfnProtectConfiguration",
...
func (c *jsiiProxy_CfnProtectConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnProtectConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProtectConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProtectConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnProtectConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProtectConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProtectConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnProtectConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnProtectConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProtectConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnProtectConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtectConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtectConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnProtectConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProtectConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnProtectConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnProtectConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnProtectConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
