...
//
//   cfnResourcePolicy := awscdk.Aws_smsvoice.NewCfnResourcePolicy(this, jsii.String("MyCfnResourcePolicy"), &CfnResourcePolicyProps{
...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssmsvoice.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawssmsvoice.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawssmsvoiceIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) PolicyDocument() interface{} {
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawssmsvoice.ResourcePolicyReference {
	var returns *interfacesawssmsvoice.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnResourcePolicy)SetPolicyDocument(val interface{}) {
