...
//
//   cfnPool := awscdk.Aws_smsvoice.NewCfnPool(this, jsii.String("MyCfnPool"), &CfnPoolProps{
...
func (j *jsiiProxy_CfnPool) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnPool) AttrPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPoolId",
...
func (j *jsiiProxy_CfnPool) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPool) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPool) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPool) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPool) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPool) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPool) DeletionProtectionEnabled() interface{} {
...
func (j *jsiiProxy_CfnPool) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPool) MandatoryKeywords() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"mandatoryKeywords",
...
func (j *jsiiProxy_CfnPool) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPool) OptionalKeywords() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"optionalKeywords",
...
func (j *jsiiProxy_CfnPool) OptOutListName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"optOutListName",
...
func (j *jsiiProxy_CfnPool) OriginationIdentities() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPool) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPool) SelfManagedOptOutsEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPool) SharedRoutesEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sharedRoutesEnabled",
...
func (j *jsiiProxy_CfnPool) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPool) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPool) TwoWay() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"twoWay",
...
func (j *jsiiProxy_CfnPool) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnPool) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPool(scope constructs.Construct, id *string, props *CfnPoolProps) CfnPool {
	...
	if err := validateNewCfnPoolParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnPool{}
...
func (j *jsiiProxy_CfnPool)SetDeletionProtectionEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnPool)SetMandatoryKeywords(val interface{}) {
...
func (j *jsiiProxy_CfnPool)SetOptionalKeywords(val interface{}) {
...
func (j *jsiiProxy_CfnPool)SetOptOutListName(val *string) {
	_jsii_.Set(
		j,
		"optOutListName",
		val,
...
func (j *jsiiProxy_CfnPool)SetOriginationIdentities(val *[]*string) {
...
func (j *jsiiProxy_CfnPool)SetSelfManagedOptOutsEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnPool)SetSharedRoutesEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnPool)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnPool)SetTwoWay(val interface{}) {
...
func CfnPool_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPool_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPool_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPool_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPool_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPool_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPool_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_smsvoice.CfnPool",
...
func (c *jsiiProxy_CfnPool) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPool) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPool) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPool) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPool) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPool) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPool) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPool) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPool) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPool) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPool) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPool) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPool) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPool) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPool) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPool) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPool) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPool) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPool) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
