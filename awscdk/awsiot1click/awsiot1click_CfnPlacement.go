...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsiot1click/internal"
...
func (j *jsiiProxy_CfnPlacement) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPlacement) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPlacement(scope constructs.Construct, id *string, props *CfnPlacementProps) CfnPlacement {
	...
	if err := validateNewCfnPlacementParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPlacement_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPlacement_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlacement_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPlacement_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlacement_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPlacement_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlacement) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacement) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPlacement) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPlacement) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPlacement) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacement) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
