...
//
type CfnFileSystem_SynchronizationConfigurationProperty struct {
	...
	//
	ExpirationDataRules interface{} `field:"required" json:"expirationDataRules" yaml:"expirationDataRules"`
	...
	//
	ImportDataRules interface{} `field:"required" json:"importDataRules" yaml:"importDataRules"`
