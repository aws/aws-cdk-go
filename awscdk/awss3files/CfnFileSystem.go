...
type CfnFileSystem interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawss3files.IFileSystemRef
	awscdk.ITaggableV2
	AcceptBucketWarning() interface{}
	SetAcceptBucketWarning(val interface{})
	AttrCreationTime() *string
	AttrFileSystemArn() *string
	AttrFileSystemId() *string
	AttrOwnerId() *string
	AttrStatus() *string
	AttrStatusMessage() *string
	AttrSynchronizationConfigurationLatestVersionNumber() *float64
	Bucket() *string
	...
	FileSystemRef() *interfacesawss3files.FileSystemReference
	KmsKeyId() *string
	...
	Stack() awscdk.Stack
	SynchronizationConfiguration() interface{}
	SetSynchronizationConfiguration(val interface{})
	Tags() *[]*awscdk.CfnTag
...
type jsiiProxy_CfnFileSystem struct {
	...
	internal.Type__interfacesawss3filesIFileSystemRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnFileSystem) AcceptBucketWarning() interface{} {
...
func (j *jsiiProxy_CfnFileSystem) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnFileSystem) AttrFileSystemArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFileSystemArn",
...
func (j *jsiiProxy_CfnFileSystem) AttrOwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerId",
...
func (j *jsiiProxy_CfnFileSystem) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnFileSystem) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnFileSystem) AttrSynchronizationConfigurationLatestVersionNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrSynchronizationConfigurationLatestVersionNumber",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnFileSystem) Bucket() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucket",
...
func (j *jsiiProxy_CfnFileSystem) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnFileSystem) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFileSystem) ClientToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientToken",
...
func (j *jsiiProxy_CfnFileSystem) FileSystemRef() *interfacesawss3files.FileSystemReference {
	var returns *interfacesawss3files.FileSystemReference
	_jsii_.Get(
		j,
		"fileSystemRef",
		&returns,
...
func (j *jsiiProxy_CfnFileSystem) Prefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefix",
...
func (j *jsiiProxy_CfnFileSystem) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnFileSystem) SynchronizationConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFileSystem) Tags() *[]*awscdk.CfnTag {
...
func NewCfnFileSystem(scope constructs.Construct, id *string, props *CfnFileSystemProps) CfnFileSystem {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_s3files.CfnFileSystem",
...
func (j *jsiiProxy_CfnFileSystem)SetAcceptBucketWarning(val interface{}) {
...
func (j *jsiiProxy_CfnFileSystem)SetBucket(val *string) {
...
func (j *jsiiProxy_CfnFileSystem)SetClientToken(val *string) {
	_jsii_.Set(
		j,
		"clientToken",
		val,
...
func (j *jsiiProxy_CfnFileSystem)SetPrefix(val *string) {
	_jsii_.Set(
		j,
		"prefix",
		val,
...
func (j *jsiiProxy_CfnFileSystem)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnFileSystem)SetSynchronizationConfiguration(val interface{}) {
	if err := j.validateSetSynchronizationConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnFileSystem)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnFileSystem_ArnForFileSystem(resource interfacesawss3files.IFileSystemRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFileSystem) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFileSystem) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFileSystem) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFileSystem) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
