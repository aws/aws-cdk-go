...
type CfnAccessPoint interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawss3files.IAccessPointRef
	awscdk.ITaggableV2
	// A reference to a AccessPoint resource.
	AccessPointRef() *interfacesawss3files.AccessPointReference
	AttrAccessPointArn() *string
	...
	Stack() awscdk.Stack
	Tags() *[]*CfnAccessPoint_AccessPointTagProperty
	SetTags(val *[]*CfnAccessPoint_AccessPointTagProperty)
	// Deprecated.
...
type jsiiProxy_CfnAccessPoint struct {
	...
	internal.Type__interfacesawss3filesIAccessPointRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnAccessPoint) AccessPointRef() *interfacesawss3files.AccessPointReference {
	var returns *interfacesawss3files.AccessPointReference
	_jsii_.Get(
		j,
		"accessPointRef",
		&returns,
...
func (j *jsiiProxy_CfnAccessPoint) AttrAccessPointArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAccessPointArn",
...
func (j *jsiiProxy_CfnAccessPoint) AttrOwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerId",
...
func (j *jsiiProxy_CfnAccessPoint) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnAccessPoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccessPoint) Tags() *[]*CfnAccessPoint_AccessPointTagProperty {
...
func (j *jsiiProxy_CfnAccessPoint) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccessPoint(scope constructs.Construct, id *string, props *CfnAccessPointProps) CfnAccessPoint {
	...
	if err := validateNewCfnAccessPointParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAccessPoint{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3files.CfnAccessPoint",
...
func (j *jsiiProxy_CfnAccessPoint)SetTags(val *[]*CfnAccessPoint_AccessPointTagProperty) {
...
func CfnAccessPoint_ArnForAccessPoint(resource interfacesawss3files.IAccessPointRef) *string {
	_init_.Initialize()
...
func CfnAccessPoint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessPoint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccessPoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessPoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessPoint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessPoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessPoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessPoint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessPoint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessPoint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPoint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
