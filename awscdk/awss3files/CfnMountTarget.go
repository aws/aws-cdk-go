...
//
//   cfnMountTarget := awscdk.Aws_s3files.NewCfnMountTarget(this, jsii.String("MyCfnMountTarget"), &CfnMountTargetProps{
...
type CfnMountTarget interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawss3files.IMountTargetRef
	AttrAvailabilityZoneId() *string
	AttrMountTargetId() *string
	AttrNetworkInterfaceId() *string
	AttrOwnerId() *string
	AttrStatus() *string
	...
	MountTargetRef() *interfacesawss3files.MountTargetReference
	// The tree node.
...
type jsiiProxy_CfnMountTarget struct {
	...
	internal.Type__interfacesawss3filesIMountTargetRef
}

func (j *jsiiProxy_CfnMountTarget) AttrAvailabilityZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMountTarget) AttrMountTargetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMountTargetId",
...
func (j *jsiiProxy_CfnMountTarget) AttrNetworkInterfaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMountTarget) AttrOwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerId",
...
func (j *jsiiProxy_CfnMountTarget) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnMountTarget) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnMountTarget) AttrVpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVpcId",
...
func (j *jsiiProxy_CfnMountTarget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMountTarget) Ipv4Address() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipv4Address",
...
func (j *jsiiProxy_CfnMountTarget) MountTargetRef() *interfacesawss3files.MountTargetReference {
	var returns *interfacesawss3files.MountTargetReference
	_jsii_.Get(
		j,
		"mountTargetRef",
		&returns,
...
func (j *jsiiProxy_CfnMountTarget) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMountTarget(scope constructs.Construct, id *string, props *CfnMountTargetProps) CfnMountTarget {
	...
	if err := validateNewCfnMountTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnMountTarget{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3files.CfnMountTarget",
...
func (j *jsiiProxy_CfnMountTarget)SetIpv4Address(val *string) {
	_jsii_.Set(
		j,
		"ipv4Address",
		val,
...
func CfnMountTarget_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMountTarget_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMountTarget_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMountTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMountTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMountTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMountTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMountTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMountTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMountTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMountTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMountTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMountTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMountTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMountTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMountTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
