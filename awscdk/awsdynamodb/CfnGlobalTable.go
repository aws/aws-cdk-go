...
func (j *jsiiProxy_CfnGlobalTable) CfnPropertyNames() *map[string]*string {
...
func CfnGlobalTable_ArnForGlobalTable(resource interfacesawsdynamodb.IGlobalTableRef) *string {
	_init_.Initialize()

	if err := validateCfnGlobalTable_ArnForGlobalTableParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnGlobalTable_IsCfnGlobalTable(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGlobalTable_IsCfnGlobalTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGlobalTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGlobalTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGlobalTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGlobalTable) RemoveResourceDependency(target awscdk.CfnResource) {
