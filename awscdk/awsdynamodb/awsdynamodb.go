...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dynamodb.CfnGlobalTable.KinesisStreamSpecificationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dynamodb.CfnTable.CsvProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dynamodb.CfnTable.ImportSourceSpecificationProperty",
		reflect.TypeOf((*CfnTable_ImportSourceSpecificationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_dynamodb.CfnTable.InputFormatOptionsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dynamodb.CfnTable.S3BucketSourceProperty",
