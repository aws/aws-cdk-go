...
//
//   cfnStream := awscdk.Aws_dynamodb.NewCfnStream(this, jsii.String("MyCfnStream"), &CfnStreamProps{
...
type CfnStream interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdynamodb.IStreamRef
	AttrCreationRequestDateTime() *string
	AttrId() *string
	AttrKeySchema() awscdk.IResolvable
	AttrStreamArn() *string
	AttrStreamLabel() *string
	AttrStreamStatus() *string
	...
	StreamRef() *interfacesawsdynamodb.StreamReference
...
type jsiiProxy_CfnStream struct {
	...
	internal.Type__interfacesawsdynamodbIStreamRef
}

func (j *jsiiProxy_CfnStream) AttrCreationRequestDateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationRequestDateTime",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnStream) AttrKeySchema() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnStream) AttrStreamArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStreamArn",
...
func (j *jsiiProxy_CfnStream) AttrStreamLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStreamLabel",
...
func (j *jsiiProxy_CfnStream) AttrStreamStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStreamStatus",
...
func (j *jsiiProxy_CfnStream) StreamRef() *interfacesawsdynamodb.StreamReference {
	var returns *interfacesawsdynamodb.StreamReference
	_jsii_.Get(
		j,
		"streamRef",
		&returns,
...
func (j *jsiiProxy_CfnStream) StreamViewType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"streamViewType",
...
func (j *jsiiProxy_CfnStream) TableName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableName",
...
func (j *jsiiProxy_CfnStream)SetStreamViewType(val *string) {
	_jsii_.Set(
		j,
		"streamViewType",
		val,
...
func (j *jsiiProxy_CfnStream)SetTableName(val *string) {
	_jsii_.Set(
		j,
		"tableName",
		val,
...
func CfnStream_ArnForStream(resource interfacesawsdynamodb.IStreamRef) *string {
	_init_.Initialize()
