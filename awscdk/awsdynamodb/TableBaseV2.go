...
func (j *jsiiProxy_TableBaseV2) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_TableBaseV2) Grants() TableGrants {
...
func (t *jsiiProxy_TableBaseV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TableBaseV2) GrantOnKey(grantee awsiam.IGrantable, actions ...*string) *awsiam.GrantOnKeyResult {
...
func (t *jsiiProxy_TableBaseV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
