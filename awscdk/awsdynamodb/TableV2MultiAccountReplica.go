...
//   })
//
type TableV2MultiAccountReplica interface {
	TableBaseV2
...
// The jsii proxy struct for TableV2MultiAccountReplica
type jsiiProxy_TableV2MultiAccountReplica struct {
	jsiiProxy_TableBaseV2
}

func (j *jsiiProxy_TableV2MultiAccountReplica) EncryptionKey() awskms.IKey {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) Grants() TableGrants {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) HasIndex() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"hasIndex",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) Node() constructs.Node {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) ResourcePolicy() awsiam.PolicyDocument {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) Stack() awscdk.Stack {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) StreamResourcePolicy() awsiam.PolicyDocument {
	var returns awsiam.PolicyDocument
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TableV2MultiAccountReplica) TableArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableArn",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) TableId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableId",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) TableName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableName",
...
func (j *jsiiProxy_TableV2MultiAccountReplica) TableRef() *interfacesawsdynamodb.TableReference {
...
func (j *jsiiProxy_TableV2MultiAccountReplica) TableStreamArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableStreamArn",
...
func NewTableV2MultiAccountReplica(scope constructs.Construct, id *string, props *TableV2MultiAccountReplicaProps) TableV2MultiAccountReplica {
	_init_.Initialize()

	if err := validateNewTableV2MultiAccountReplicaParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func NewTableV2MultiAccountReplica_Override(t TableV2MultiAccountReplica, scope constructs.Construct, id *string, props *TableV2MultiAccountReplicaProps) {
	_init_.Initialize()
...
func (j *jsiiProxy_TableV2MultiAccountReplica)SetResourcePolicy(val awsiam.PolicyDocument) {
	_jsii_.Set(
		j,
		"resourcePolicy",
		val,
...
func (j *jsiiProxy_TableV2MultiAccountReplica)SetStreamResourcePolicy(val awsiam.PolicyDocument) {
	_jsii_.Set(
		j,
		"streamResourcePolicy",
		val,
...
func TableV2MultiAccountReplica_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTableV2MultiAccountReplica_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func TableV2MultiAccountReplica_IsOwnedResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateTableV2MultiAccountReplica_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func TableV2MultiAccountReplica_IsResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateTableV2MultiAccountReplica_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func TableV2MultiAccountReplica_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_dynamodb.TableV2MultiAccountReplica",
...
func (t *jsiiProxy_TableV2MultiAccountReplica) AddToResourcePolicy(statement awsiam.PolicyStatement) *awsiam.AddToResourcePolicyResult {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) AddToStreamResourcePolicy(statement awsiam.PolicyStatement) *awsiam.AddToResourcePolicyResult {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GeneratePhysicalName() *string {
	var returns *string
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GetResourceNameAttribute(nameAttr *string) *string {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) Grant(grantee awsiam.IGrantable, actions ...*string) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantFullAccess(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantOnKey(grantee awsiam.IGrantable, actions ...*string) *awsiam.GrantOnKeyResult {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantReadData(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantReadWriteData(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantStream(grantee awsiam.IGrantable, actions ...*string) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantStreamRead(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantTableListStreams(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) GrantWriteData(grantee awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricConditionalCheckFailedRequests(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricConsumedReadCapacityUnits(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricConsumedWriteCapacityUnits(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricSuccessfulRequestLatency(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricSystemErrors(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricSystemErrorsForOperations(props *SystemErrorsForOperationsMetricOptions) awscloudwatch.IMetric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricThrottledRequests(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricThrottledRequestsForOperation(operation *string, props *OperationsMetricOptions) awscloudwatch.IMetric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricThrottledRequestsForOperations(props *OperationsMetricOptions) awscloudwatch.IMetric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) MetricUserErrors(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (t *jsiiProxy_TableV2MultiAccountReplica) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TableV2MultiAccountReplica) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
