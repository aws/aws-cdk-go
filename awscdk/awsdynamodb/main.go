...
func init() {
	...
	_jsii_.RegisterEnum(
		"aws-cdk-lib.aws_dynamodb.ContributorInsightsMode",
		reflect.TypeOf((*ContributorInsightsMode)(nil)).Elem(),
		map[string]interface{}{
			"ACCESSED_AND_THROTTLED_KEYS": ContributorInsightsMode_ACCESSED_AND_THROTTLED_KEYS,
			"THROTTLED_KEYS": ContributorInsightsMode_THROTTLED_KEYS,
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_dynamodb.ContributorInsightsSpecification",
		reflect.TypeOf((*ContributorInsightsSpecification)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "addToResourcePolicy", GoMethod: "AddToResourcePolicy"},
			_jsii_.MemberMethod{JsiiMethod: "addToStreamResourcePolicy", GoMethod: "AddToStreamResourcePolicy"},
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "encryptionKey", GoGetter: "EncryptionKey"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourcePolicy", GoGetter: "ResourcePolicy"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "streamResourcePolicy", GoGetter: "StreamResourcePolicy"},
			_jsii_.MemberProperty{JsiiProperty: "tableArn", GoGetter: "TableArn"},
			_jsii_.MemberProperty{JsiiProperty: "tableId", GoGetter: "TableId"},
			_jsii_.MemberProperty{JsiiProperty: "tableName", GoGetter: "TableName"},
			_jsii_.MemberProperty{JsiiProperty: "tableRef", GoGetter: "TableRef"},
