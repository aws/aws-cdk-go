...
func (j *jsiiProxy_CfnRoute) CfnPropertyNames() *map[string]*string {
...
func CfnRoute_ArnForRoute(resource interfacesawsrefactorspaces.IRouteRef) *string {
	_init_.Initialize()
...
func CfnRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRoute_IsCfnRoute(x interface{}) *bool {
	...
	if err := validateCfnRoute_IsCfnRouteParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
