...
func validateCfnService_ArnForServiceParameters(resource interfacesawsrefactorspaces.IServiceRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnService) validateSetApplicationIdentifierParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnService) validateSetLambdaEndpointParameters(val interface{}) error {
	...
	case CfnService_LambdaEndpointInputProperty:
		val_ := val.(CfnService_LambdaEndpointInputProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnService) validateSetUrlEndpointParameters(val interface{}) error {
	...
	case CfnService_UrlEndpointInputProperty:
		val_ := val.(CfnService_UrlEndpointInputProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
