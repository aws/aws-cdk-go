...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataResidency", GoGetter: "DataResidency"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsawsexternalanthropicIWorkspaceRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_awsexternalanthropic.CfnWorkspace.DataResidencyProperty",
		reflect.TypeOf((*CfnWorkspace_DataResidencyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_awsexternalanthropic.CfnWorkspaceProps",
