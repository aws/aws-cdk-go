...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsawsexternalanthropic/internal"
...
//
//   cfnWorkspace := awscdk.Aws_awsexternalanthropic.NewCfnWorkspace(this, jsii.String("MyCfnWorkspace"), &CfnWorkspaceProps{
...
type CfnWorkspace interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsawsexternalanthropic.IWorkspaceRef
	awscdk.ITaggableV2
	...
	DataResidency() interface{}
	SetDataResidency(val interface{})
	...
	WorkspaceRef() *interfacesawsawsexternalanthropic.WorkspaceReference
...
type jsiiProxy_CfnWorkspace struct {
	...
	internal.Type__interfacesawsawsexternalanthropicIWorkspaceRef
...
func (j *jsiiProxy_CfnWorkspace) DataResidency() interface{} {
...
func (j *jsiiProxy_CfnWorkspace) WorkspaceRef() *interfacesawsawsexternalanthropic.WorkspaceReference {
	var returns *interfacesawsawsexternalanthropic.WorkspaceReference
	_jsii_.Get(
		j,
		"workspaceRef",
		&returns,
...
func NewCfnWorkspace(scope constructs.Construct, id *string, props *CfnWorkspaceProps) CfnWorkspace {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_awsexternalanthropic.CfnWorkspace",
...
func (j *jsiiProxy_CfnWorkspace)SetDataResidency(val interface{}) {
	if err := j.validateSetDataResidencyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnWorkspace_ArnForWorkspace(resource interfacesawsawsexternalanthropic.IWorkspaceRef) *string {
	_init_.Initialize()
