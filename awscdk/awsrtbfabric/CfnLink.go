...
func (j *jsiiProxy_CfnLink) AttrCreatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLink) AttrLinkDirection() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLinkDirection",
...
func (j *jsiiProxy_CfnLink) AttrLinkStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLinkStatus",
...
func (j *jsiiProxy_CfnLink) AttrUpdatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLink) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnLink) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLink) GatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gatewayId",
...
func (j *jsiiProxy_CfnLink) HttpResponderAllowed() interface{} {
...
func (j *jsiiProxy_CfnLink) LinkAttributes() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"linkAttributes",
...
func (j *jsiiProxy_CfnLink) LinkLogSettings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"linkLogSettings",
...
func (j *jsiiProxy_CfnLink) ModuleConfigurationList() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLink) PeerGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerGatewayId",
...
func (j *jsiiProxy_CfnLink) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnLink)SetGatewayId(val *string) {
...
func (j *jsiiProxy_CfnLink)SetHttpResponderAllowed(val interface{}) {
	if err := j.validateSetHttpResponderAllowedParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLink)SetLinkAttributes(val interface{}) {
...
func (j *jsiiProxy_CfnLink)SetLinkLogSettings(val interface{}) {
...
func (j *jsiiProxy_CfnLink)SetModuleConfigurationList(val interface{}) {
	if err := j.validateSetModuleConfigurationListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLink)SetPeerGatewayId(val *string) {
	if err := j.validateSetPeerGatewayIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLink)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnLink_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLink_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLink) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLink) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLink) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLink) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
