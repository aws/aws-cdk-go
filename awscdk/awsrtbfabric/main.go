...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnLinkRoutingRule)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsrtbfabricILinkRoutingRuleRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnLinkRoutingRule.QueryStringKeyValuePairProperty",
		reflect.TypeOf((*CfnLinkRoutingRule_QueryStringKeyValuePairProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnLinkRoutingRule.RuleConditionProperty",
		reflect.TypeOf((*CfnLinkRoutingRule_RuleConditionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnLinkRoutingRuleProps",
		reflect.TypeOf((*CfnLinkRoutingRuleProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink",
		reflect.TypeOf((*CfnOutboundExternalLink)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsrtbfabricIOutboundExternalLinkRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink.ApplicationLogsProperty",
		reflect.TypeOf((*CfnOutboundExternalLink_ApplicationLogsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink.LinkApplicationLogSamplingProperty",
		reflect.TypeOf((*CfnOutboundExternalLink_LinkApplicationLogSamplingProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink.LinkAttributesProperty",
		reflect.TypeOf((*CfnOutboundExternalLink_LinkAttributesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink.LinkLogSettingsProperty",
		reflect.TypeOf((*CfnOutboundExternalLink_LinkLogSettingsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLink.ResponderErrorMaskingForHttpCodeProperty",
		reflect.TypeOf((*CfnOutboundExternalLink_ResponderErrorMaskingForHttpCodeProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnOutboundExternalLinkProps",
		reflect.TypeOf((*CfnOutboundExternalLinkProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrCertificateAssociationStatus", GoGetter: "AttrCertificateAssociationStatus"},
			_jsii_.MemberProperty{JsiiProperty: "attrCreatedTimestamp", GoGetter: "AttrCreatedTimestamp"},
			_jsii_.MemberProperty{JsiiProperty: "attrExternalInboundEndpoint", GoGetter: "AttrExternalInboundEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "attrGatewayId", GoGetter: "AttrGatewayId"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_rtbfabric.CfnResponderGateway.ListenerConfigProperty",
		reflect.TypeOf((*CfnResponderGateway_ListenerConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
