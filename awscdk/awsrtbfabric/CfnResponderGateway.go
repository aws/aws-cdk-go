...
func (j *jsiiProxy_CfnResponderGateway) CfnPropertyNames() *map[string]*string {
...
func CfnResponderGateway_ArnForResponderGateway(resource interfacesawsrtbfabric.IResponderGatewayRef) *string {
	_init_.Initialize()

	if err := validateCfnResponderGateway_ArnForResponderGatewayParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnResponderGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResponderGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResponderGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResponderGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponderGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
