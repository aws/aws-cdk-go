...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsinterconnect/internal"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsinterconnect"
...
//
//   cfnConnection := awscdk.Aws_interconnect.NewCfnConnection(this, jsii.String("MyCfnConnection"), &CfnConnectionProps{
...
type CfnConnection interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsinterconnect.IConnectionRef
	awscdk.ITaggableV2
	...
	SetAttachPoint(val interface{})
	// The Amazon Resource Name (ARN) of the connection.
	AttrArn() *string
	// The billing tier for the connection.
	AttrBillingTier() *float64
	...
	AttrProvider() awscdk.IResolvable
	...
	ConnectionRef() *interfacesawsinterconnect.ConnectionReference
...
type jsiiProxy_CfnConnection struct {
	...
	internal.Type__interfacesawsinterconnectIConnectionRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnConnection) ActivationKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"activationKey",
...
func (j *jsiiProxy_CfnConnection) AttachPoint() interface{} {
...
func (j *jsiiProxy_CfnConnection) AttrBillingTier() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrBillingTier",
...
func (j *jsiiProxy_CfnConnection) AttrOwnerAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerAccount",
...
func (j *jsiiProxy_CfnConnection) AttrProvider() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnConnection) AttrSharedId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSharedId",
...
func (j *jsiiProxy_CfnConnection) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnConnection) Bandwidth() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bandwidth",
...
func (j *jsiiProxy_CfnConnection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConnection) ConnectionRef() *interfacesawsinterconnect.ConnectionReference {
	var returns *interfacesawsinterconnect.ConnectionReference
	_jsii_.Get(
		j,
		"connectionRef",
		&returns,
...
func (j *jsiiProxy_CfnConnection) EnvironmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentId",
...
func (j *jsiiProxy_CfnConnection) Tags() *[]*awscdk.CfnTag {
...
func NewCfnConnection(scope constructs.Construct, id *string, props *CfnConnectionProps) CfnConnection {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_interconnect.CfnConnection",
...
func (j *jsiiProxy_CfnConnection)SetActivationKey(val *string) {
	_jsii_.Set(
		j,
		"activationKey",
		val,
...
func (j *jsiiProxy_CfnConnection)SetAttachPoint(val interface{}) {
	if err := j.validateSetAttachPointParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConnection)SetBandwidth(val *string) {
	_jsii_.Set(
		j,
		"bandwidth",
		val,
...
func (j *jsiiProxy_CfnConnection)SetEnvironmentId(val *string) {
	_jsii_.Set(
		j,
		"environmentId",
		val,
...
func (j *jsiiProxy_CfnConnection)SetRemoteOwnerAccount(val *string) {
	_jsii_.Set(
		j,
		"remoteOwnerAccount",
		val,
...
func (j *jsiiProxy_CfnConnection)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnConnection_ArnForConnection(resource interfacesawsinterconnect.IConnectionRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
