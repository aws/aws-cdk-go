...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attachPoint", GoGetter: "AttachPoint"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrBillingTier", GoGetter: "AttrBillingTier"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrSharedId", GoGetter: "AttrSharedId"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsinterconnectIConnectionRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_interconnect.CfnConnection.AttachPointProperty",
		reflect.TypeOf((*CfnConnection_AttachPointProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
