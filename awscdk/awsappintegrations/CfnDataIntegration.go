...
func (j *jsiiProxy_CfnDataIntegration) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnDataIntegration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDataIntegration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDataIntegration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataIntegration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDataIntegration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDataIntegration) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDataIntegration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDataIntegration) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDataIntegration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDataIntegration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDataIntegration) ScheduleConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scheduleConfig",
...
func (j *jsiiProxy_CfnDataIntegration) SourceUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceUri",
...
func (j *jsiiProxy_CfnDataIntegration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDataIntegration) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDataIntegration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDataIntegration(scope constructs.Construct, id *string, props *CfnDataIntegrationProps) CfnDataIntegration {
	...
	if err := validateNewCfnDataIntegrationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDataIntegration)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDataIntegration)SetName(val *string) {
...
func (j *jsiiProxy_CfnDataIntegration)SetScheduleConfig(val interface{}) {
	if err := j.validateSetScheduleConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataIntegration)SetSourceUri(val *string) {
...
func CfnDataIntegration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDataIntegration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataIntegration_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataIntegration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataIntegration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDataIntegration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataIntegration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDataIntegration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataIntegration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataIntegration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataIntegration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataIntegration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDataIntegration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataIntegration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataIntegration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDataIntegration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataIntegration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataIntegration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDataIntegration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDataIntegration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataIntegration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDataIntegration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataIntegration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataIntegration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDataIntegration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataIntegration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDataIntegration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDataIntegration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDataIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
