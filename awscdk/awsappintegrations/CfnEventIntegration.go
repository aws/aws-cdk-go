...
func (j *jsiiProxy_CfnEventIntegration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventIntegration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEventIntegration(scope constructs.Construct, id *string, props *CfnEventIntegrationProps) CfnEventIntegration {
	...
	if err := validateNewCfnEventIntegrationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEventIntegration)SetEventBridgeBus(val *string) {
	if err := j.validateSetEventBridgeBusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEventIntegration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEventIntegration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventIntegration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEventIntegration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventIntegration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEventIntegration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventIntegration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventIntegration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventIntegration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventIntegration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEventIntegration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEventIntegration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventIntegration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventIntegration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
