...
//
//   cfnApplication := awscdk.Aws_appintegrations.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
func (j *jsiiProxy_CfnApplication) ApplicationConfig() interface{} {
...
func (j *jsiiProxy_CfnApplication) ApplicationSourceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) IframeConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"iframeConfig",
...
func (j *jsiiProxy_CfnApplication) InitializationTimeout() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) IsService() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isService",
...
func (j *jsiiProxy_CfnApplication) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_CfnApplication)SetApplicationConfig(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetApplicationSourceConfig(val interface{}) {
	if err := j.validateSetApplicationSourceConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetIframeConfig(val interface{}) {
	if err := j.validateSetIframeConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnApplication)SetInitializationTimeout(val *float64) {
	_jsii_.Set(
		j,
		"initializationTimeout",
		val,
...
func (j *jsiiProxy_CfnApplication)SetIsService(val interface{}) {
	if err := j.validateSetIsServiceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnApplication_ArnForApplication(resource interfacesawsappintegrations.IApplicationRef) *string {
	_init_.Initialize()
