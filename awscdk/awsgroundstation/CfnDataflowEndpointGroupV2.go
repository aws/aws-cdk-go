...
func (j *jsiiProxy_CfnDataflowEndpointGroupV2) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDataflowEndpointGroupV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroupV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroupV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataflowEndpointGroupV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroupV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
