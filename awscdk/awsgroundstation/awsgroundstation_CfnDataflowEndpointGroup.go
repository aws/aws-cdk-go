...
func NewCfnDataflowEndpointGroup(scope constructs.Construct, id *string, props *CfnDataflowEndpointGroupProps) CfnDataflowEndpointGroup {
	...
	if err := validateNewCfnDataflowEndpointGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDataflowEndpointGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDataflowEndpointGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataflowEndpointGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDataflowEndpointGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataflowEndpointGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDataflowEndpointGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
