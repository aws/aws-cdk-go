...
func (j *jsiiProxy_CfnConfig) CfnPropertyNames() *map[string]*string {
...
func NewCfnConfig(scope constructs.Construct, id *string, props *CfnConfigProps) CfnConfig {
	...
	if err := validateNewCfnConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfig)SetConfigData(val interface{}) {
	if err := j.validateSetConfigDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConfig_ArnForConfig(resource interfacesawsgroundstation.IConfigRef) *string {
	_init_.Initialize()

	if err := validateCfnConfig_ArnForConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnConfig_IsCfnConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfig_IsCfnConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfig_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
