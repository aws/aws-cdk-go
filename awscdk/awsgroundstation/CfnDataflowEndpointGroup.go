...
func (j *jsiiProxy_CfnDataflowEndpointGroup) CfnPropertyNames() *map[string]*string {
...
func CfnDataflowEndpointGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataflowEndpointGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataflowEndpointGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
