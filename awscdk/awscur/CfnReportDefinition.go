...
func (j *jsiiProxy_CfnReportDefinition) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnReportDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReportDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReportDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReportDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
