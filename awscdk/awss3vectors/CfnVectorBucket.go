...
//
//   cfnVectorBucket := awscdk.Aws_s3vectors.NewCfnVectorBucket(this, jsii.String("MyCfnVectorBucket"), &CfnVectorBucketProps{
...
func (j *jsiiProxy_CfnVectorBucket) AttrVectorBucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVectorBucketArn",
...
func (j *jsiiProxy_CfnVectorBucket) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnVectorBucket) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVectorBucket) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVectorBucket) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVectorBucket) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVectorBucket) EncryptionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnVectorBucket) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVectorBucket) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVectorBucket) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVectorBucket) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVectorBucket) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnVectorBucket) VectorBucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vectorBucketName",
...
func NewCfnVectorBucket(scope constructs.Construct, id *string, props *CfnVectorBucketProps) CfnVectorBucket {
	...
	if err := validateNewCfnVectorBucketParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnVectorBucket)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnVectorBucket)SetVectorBucketName(val *string) {
	_jsii_.Set(
		j,
		"vectorBucketName",
		val,
...
func CfnVectorBucket_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucket_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucket_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucket_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucket_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucket_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucket_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucket",
...
func (c *jsiiProxy_CfnVectorBucket) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVectorBucket) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucket) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucket) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucket) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucket) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVectorBucket) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucket) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVectorBucket) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVectorBucket) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVectorBucket) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVectorBucket) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVectorBucket) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVectorBucket) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVectorBucket) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVectorBucket) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVectorBucket) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucket) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucket) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVectorBucket) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucket) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnVectorBucket) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnVectorBucket) ValidateProperties(_properties interface{}) {
