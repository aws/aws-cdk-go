...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_s3vectors.CfnIndex",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnIndex_MetadataConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3vectors.CfnIndexProps",
		reflect.TypeOf((*CfnIndexProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucket",
		reflect.TypeOf((*CfnVectorBucket)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrCreationTime", GoGetter: "AttrCreationTime"},
			_jsii_.MemberProperty{JsiiProperty: "attrVectorBucketArn", GoGetter: "AttrVectorBucketArn"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
			_jsii_.MemberProperty{JsiiProperty: "cfnResourceType", GoGetter: "CfnResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucket.EncryptionConfigurationProperty",
		reflect.TypeOf((*CfnVectorBucket_EncryptionConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucketPolicy",
		reflect.TypeOf((*CfnVectorBucketPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucketPolicyProps",
		reflect.TypeOf((*CfnVectorBucketPolicyProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
