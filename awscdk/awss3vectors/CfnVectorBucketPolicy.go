...
//
//   cfnVectorBucketPolicy := awscdk.Aws_s3vectors.NewCfnVectorBucketPolicy(this, jsii.String("MyCfnVectorBucketPolicy"), &CfnVectorBucketPolicyProps{
//   	Policy: policy,
//
...
func (j *jsiiProxy_CfnVectorBucketPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVectorBucketPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVectorBucketPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVectorBucketPolicy) Policy() interface{} {
...
func (j *jsiiProxy_CfnVectorBucketPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVectorBucketPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) VectorBucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vectorBucketArn",
...
func (j *jsiiProxy_CfnVectorBucketPolicy) VectorBucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vectorBucketName",
...
func NewCfnVectorBucketPolicy(scope constructs.Construct, id *string, props *CfnVectorBucketPolicyProps) CfnVectorBucketPolicy {
	...
	if err := validateNewCfnVectorBucketPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnVectorBucketPolicy{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucketPolicy",
...
func (j *jsiiProxy_CfnVectorBucketPolicy)SetPolicy(val interface{}) {
...
func (j *jsiiProxy_CfnVectorBucketPolicy)SetVectorBucketArn(val *string) {
	_jsii_.Set(
		j,
		"vectorBucketArn",
		val,
...
func (j *jsiiProxy_CfnVectorBucketPolicy)SetVectorBucketName(val *string) {
	_jsii_.Set(
		j,
		"vectorBucketName",
		val,
...
func CfnVectorBucketPolicy_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucketPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucketPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucketPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucketPolicy_IsCfnVectorBucketPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucketPolicy_IsCfnVectorBucketPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucketPolicy_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVectorBucketPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVectorBucketPolicy_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_s3vectors.CfnVectorBucketPolicy",
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVectorBucketPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnVectorBucketPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnVectorBucketPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
