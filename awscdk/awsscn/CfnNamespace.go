...
//
//   cfnNamespace := awscdk.Aws_scn.NewCfnNamespace(this, jsii.String("MyCfnNamespace"), &CfnNamespaceProps{
...
type CfnNamespace interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsscn.INamespaceRef
	awscdk.ITaggableV2
	...
	NamespaceRef() *interfacesawsscn.NamespaceReference
	// The tree node.
...
type jsiiProxy_CfnNamespace struct {
	...
	internal.Type__interfacesawsscnINamespaceRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnNamespace) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnNamespace) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnNamespace) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnNamespace) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnNamespace) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnNamespace) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_CfnNamespace) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnNamespace) NamespaceRef() *interfacesawsscn.NamespaceReference {
	var returns *interfacesawsscn.NamespaceReference
	_jsii_.Get(
		j,
		"namespaceRef",
		&returns,
...
func (j *jsiiProxy_CfnNamespace) Tags() *[]*awscdk.CfnTag {
...
func NewCfnNamespace(scope constructs.Construct, id *string, props *CfnNamespaceProps) CfnNamespace {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_scn.CfnNamespace",
...
func (j *jsiiProxy_CfnNamespace)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnNamespace)SetInstanceId(val *string) {
...
func (j *jsiiProxy_CfnNamespace)SetName(val *string) {
...
func (j *jsiiProxy_CfnNamespace)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnNamespace_ArnForNamespace(resource interfacesawsscn.INamespaceRef) *string {
	_init_.Initialize()

	if err := validateCfnNamespace_ArnForNamespaceParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
