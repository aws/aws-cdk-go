...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsscn/internal"
...
//
//   cfnDataset := awscdk.Aws_scn.NewCfnDataset(this, jsii.String("MyCfnDataset"), &CfnDatasetProps{
...
type CfnDataset interface {
	...
	DatasetRef() *interfacesawsscn.DatasetReference
	...
	SetPartitionSpec(val interface{})
...
type jsiiProxy_CfnDataset struct {
	...
	internal.Type__interfacesawsscnIDatasetRef
...
func (j *jsiiProxy_CfnDataset) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataset) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataset) DatasetRef() *interfacesawsscn.DatasetReference {
	var returns *interfacesawsscn.DatasetReference
	_jsii_.Get(
		j,
		"datasetRef",
		&returns,
...
func (j *jsiiProxy_CfnDataset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDataset) InstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceId",
...
func (j *jsiiProxy_CfnDataset) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_CfnDataset) PartitionSpec() interface{} {
...
func (j *jsiiProxy_CfnDataset) Schema() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"schema",
...
func NewCfnDataset(scope constructs.Construct, id *string, props *CfnDatasetProps) CfnDataset {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_scn.CfnDataset",
...
func (j *jsiiProxy_CfnDataset)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDataset)SetInstanceId(val *string) {
...
func (j *jsiiProxy_CfnDataset)SetNamespace(val *string) {
...
func (j *jsiiProxy_CfnDataset)SetPartitionSpec(val interface{}) {
	if err := j.validateSetPartitionSpecParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataset)SetSchema(val interface{}) {
...
func CfnDataset_ArnForDataset(resource interfacesawsscn.IDatasetRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataset) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataset) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataset) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataset) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
