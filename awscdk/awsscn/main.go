...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsscnIDatasetRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.DataLakeDatasetPartitionFieldProperty",
		reflect.TypeOf((*CfnDataset_DataLakeDatasetPartitionFieldProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.DataLakeDatasetPrimaryKeyFieldProperty",
		reflect.TypeOf((*CfnDataset_DataLakeDatasetPrimaryKeyFieldProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.DataLakeDatasetSchemaFieldProperty",
		reflect.TypeOf((*CfnDataset_DataLakeDatasetSchemaFieldProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.PartitionSpecProperty",
		reflect.TypeOf((*CfnDataset_PartitionSpecProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.SchemaProperty",
		reflect.TypeOf((*CfnDataset_SchemaProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDataset.TransformProperty",
		reflect.TypeOf((*CfnDataset_TransformProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnDatasetProps",
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsscnINamespaceRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_scn.CfnNamespaceProps",
