...
type CfnWaitConditionHandle interface {
	CfnResource
	IInspectable
	interfacesawscloudformation.IWaitConditionHandleRef
	...
	WaitConditionHandleRef() *interfacesawscloudformation.WaitConditionHandleReference
...
type jsiiProxy_CfnWaitConditionHandle struct {
	...
	internal.Type__interfacesawscloudformationIWaitConditionHandleRef
}
...
func (j *jsiiProxy_CfnWaitConditionHandle) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWaitConditionHandle) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnWaitConditionHandle) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnWaitConditionHandle) WaitConditionHandleRef() *interfacesawscloudformation.WaitConditionHandleReference {
	var returns *interfacesawscloudformation.WaitConditionHandleReference
	_jsii_.Get(
		j,
...
func CfnWaitConditionHandle_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnWaitConditionHandle_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWaitConditionHandle_IsCfnWaitConditionHandle(x interface{}) *bool {
	...
	if err := validateCfnWaitConditionHandle_IsCfnWaitConditionHandleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWaitConditionHandle_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnWaitConditionHandle_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWaitConditionHandle) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWaitConditionHandle) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnWaitConditionHandle) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWaitConditionHandle) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
