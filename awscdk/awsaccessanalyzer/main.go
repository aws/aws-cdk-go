...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnAnalyzer_InternalAccessAnalysisRuleCriteriaProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_accessanalyzer.CfnAnalyzer.InternalAccessAnalysisRuleProperty",
		reflect.TypeOf((*CfnAnalyzer_InternalAccessAnalysisRuleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_accessanalyzer.CfnAnalyzer.InternalAccessConfigurationProperty",
		reflect.TypeOf((*CfnAnalyzer_InternalAccessConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_accessanalyzer.CfnArchiveRule",
		reflect.TypeOf((*CfnArchiveRule)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			j := jsiiProxy_CfnArchiveRule{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsaccessanalyzerIArchiveRuleRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_accessanalyzer.CfnArchiveRule.FilterItemsProperty",
		reflect.TypeOf((*CfnArchiveRule_FilterItemsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_accessanalyzer.CfnArchiveRuleProps",
		reflect.TypeOf((*CfnArchiveRuleProps)(nil)).Elem(),
	)
}
