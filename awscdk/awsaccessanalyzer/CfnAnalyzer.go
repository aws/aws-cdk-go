...
func (j *jsiiProxy_CfnAnalyzer) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAnalyzer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnalyzer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnalyzer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnalyzer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnalyzer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
