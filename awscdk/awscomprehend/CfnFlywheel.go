...
func (j *jsiiProxy_CfnFlywheel) CfnPropertyNames() *map[string]*string {
...
func CfnFlywheel_ArnForFlywheel(resource interfacesawscomprehend.IFlywheelRef) *string {
	_init_.Initialize()

	if err := validateCfnFlywheel_ArnForFlywheelParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnFlywheel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlywheel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlywheel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlywheel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlywheel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
