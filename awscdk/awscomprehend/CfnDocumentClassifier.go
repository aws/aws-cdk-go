...
func (j *jsiiProxy_CfnDocumentClassifier) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDocumentClassifier) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDocumentClassifier) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDocumentClassifier) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDocumentClassifier) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDocumentClassifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
