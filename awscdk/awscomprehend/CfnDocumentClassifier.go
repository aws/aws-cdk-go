...
func CfnDocumentClassifier_IsCfnResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateCfnDocumentClassifier_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
