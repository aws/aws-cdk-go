...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsconnectcampaigns/internal"
...
func (j *jsiiProxy_CfnCampaign) ConnectInstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectInstanceArn",
...
func (j *jsiiProxy_CfnCampaign) DialerConfig() interface{} {
...
func (j *jsiiProxy_CfnCampaign) OutboundCallConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outboundCallConfig",
...
func (j *jsiiProxy_CfnCampaign)SetConnectInstanceArn(val *string) {
...
func (j *jsiiProxy_CfnCampaign)SetDialerConfig(val interface{}) {
	if err := j.validateSetDialerConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCampaign)SetOutboundCallConfig(val interface{}) {
	if err := j.validateSetOutboundCallConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
