...
func validateCfnCampaign_ArnForCampaignParameters(resource interfacesawsconnectcampaigns.ICampaignRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCampaign) validateSetConnectInstanceArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnCampaign) validateSetDialerConfigParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	...
	case CfnCampaign_DialerConfigProperty:
		val_ := val.(CfnCampaign_DialerConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnCampaign) validateSetOutboundCallConfigParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	...
	case CfnCampaign_OutboundCallConfigProperty:
		val_ := val.(CfnCampaign_OutboundCallConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
