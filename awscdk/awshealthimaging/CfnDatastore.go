...
//
//   cfnDatastore := awscdk.Aws_healthimaging.NewCfnDatastore(this, jsii.String("MyCfnDatastore"), &CfnDatastoreProps{
...
func (j *jsiiProxy_CfnDatastore) AttrDatastoreArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDatastoreArn",
...
func (j *jsiiProxy_CfnDatastore) AttrDatastoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDatastoreId",
...
func (j *jsiiProxy_CfnDatastore) AttrDatastoreStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDatastoreStatus",
...
func (j *jsiiProxy_CfnDatastore) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnDatastore) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_CfnDatastore) Tags() *map[string]*string {
...
func (j *jsiiProxy_CfnDatastore)SetKmsKeyArn(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyArn",
		val,
...
func (j *jsiiProxy_CfnDatastore)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
