...
func (j *jsiiProxy_DnsValidatedCertificate) Env() *interfaces.ResourceEnvironment {
...
func DnsValidatedCertificate_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_certificatemanager.DnsValidatedCertificate",
...
func (d *jsiiProxy_DnsValidatedCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DnsValidatedCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
