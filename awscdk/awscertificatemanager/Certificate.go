...
func (j *jsiiProxy_Certificate) Env() *interfaces.ResourceEnvironment {
...
func Certificate_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_certificatemanager.Certificate",
...
func (c *jsiiProxy_Certificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
