...
func (j *jsiiProxy_PrivateCertificate) CertificateRef() *interfacesawscertificatemanager.CertificateReference {
...
func (j *jsiiProxy_PrivateCertificate) Env() *interfaces.ResourceEnvironment {
...
func PrivateCertificate_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_certificatemanager.PrivateCertificate",
...
func (p *jsiiProxy_PrivateCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PrivateCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
