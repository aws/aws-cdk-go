...
func (j *jsiiProxy_CfnCodeSigningConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCodeSigningConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCodeSigningConfig(scope constructs.Construct, id *string, props *CfnCodeSigningConfigProps) CfnCodeSigningConfig {
	...
	if err := validateNewCfnCodeSigningConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCodeSigningConfig)SetAllowedPublishers(val interface{}) {
	if err := j.validateSetAllowedPublishersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCodeSigningConfig)SetCodeSigningPolicies(val interface{}) {
	if err := j.validateSetCodeSigningPoliciesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCodeSigningConfig_IsCfnCodeSigningConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCodeSigningConfig_IsCfnCodeSigningConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCodeSigningConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCodeSigningConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCodeSigningConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCodeSigningConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCodeSigningConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCodeSigningConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCodeSigningConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCodeSigningConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCodeSigningConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCodeSigningConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeSigningConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
