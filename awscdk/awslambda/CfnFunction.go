...
func (j *jsiiProxy_CfnFunction) RecursiveLoop() *string {
	var returns *string
	_jsii_.Get(
		j,
		"recursiveLoop",
...
func (j *jsiiProxy_CfnFunction)SetRecursiveLoop(val *string) {
	_jsii_.Set(
		j,
		"recursiveLoop",
		val,
...
func CfnFunction_ArnForFunction(resource interfacesawslambda.IFunctionRef) *string {
	_init_.Initialize()
