...
func (j *jsiiProxy_CfnVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVersion(scope constructs.Construct, id *string, props *CfnVersionProps) CfnVersion {
	...
	if err := validateNewCfnVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
