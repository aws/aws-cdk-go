...
//
//   cfnResourcePolicy := awscdk.Aws_lambda.NewCfnResourcePolicy(this, jsii.String("MyCfnResourcePolicy"), &CfnResourcePolicyProps{
...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawslambda.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawslambda.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawslambdaIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawslambda.ResourcePolicyReference {
	var returns *interfacesawslambda.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
