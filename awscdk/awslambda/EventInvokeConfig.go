...
func (j *jsiiProxy_EventInvokeConfig) Env() *interfaces.ResourceEnvironment {
...
func EventInvokeConfig_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateEventInvokeConfig_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func EventInvokeConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.EventInvokeConfig",
...
func (e *jsiiProxy_EventInvokeConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EventInvokeConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
