...
func (c *jsiiProxy_CodeSigningConfig) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateCodeSigningConfig_FromCodeSigningConfigArnParameters(scope constructs.Construct, id *string, codeSigningConfigArn *string) error {
	...
	if codeSigningConfigArn == nil {
		return fmt.Errorf("parameter codeSigningConfigArn is required, but nil was provided")
	}
