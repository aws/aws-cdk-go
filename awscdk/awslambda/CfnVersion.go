...
func (j *jsiiProxy_CfnVersion) CfnPropertyNames() *map[string]*string {
...
func CfnVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
