...
func (s *jsiiProxy_S3Code) validateBindParameters(scope constructs.Construct) error {
	return nil
}
...
func validateS3Code_FromBucketV2Parameters(bucket awss3.IBucket, key *string, options *BucketOptions) error {
	return nil
}
