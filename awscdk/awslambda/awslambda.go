...
type CfnEventSourceMapping interface {
	...
	PartialBatchResponse() interface{}
	SetPartialBatchResponse(val interface{})
	Queues() *[]*string
...
func (j *jsiiProxy_CfnEventSourceMapping) PartialBatchResponse() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEventSourceMapping) SetPartialBatchResponse(val interface{}) {
	_jsii_.Set(
		j,
		"partialBatchResponse",
		val,
...
type CfnEventSourceMappingProps struct {
	...
	PartialBatchResponse interface{} `json:"partialBatchResponse"`
