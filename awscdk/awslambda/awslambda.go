...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnEventSourceMapping.AmazonManagedKafkaEventSourceConfigProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnEventSourceMapping.DocumentDBEventSourceConfigProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnEventSourceMapping.ScalingConfigProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnEventSourceMapping.SelfManagedKafkaEventSourceConfigProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnFunction.EphemeralStorageProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnFunction.RuntimeManagementConfigProperty",
		reflect.TypeOf((*CfnFunction_RuntimeManagementConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnFunction.SnapStartProperty",
		reflect.TypeOf((*CfnFunction_SnapStartProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnFunction.SnapStartResponseProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnUrl.CorsProperty",
		reflect.TypeOf((*CfnUrl_CorsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.CfnUrlProps",
	...
	_jsii_.RegisterEnum(
		"monocdk.aws_lambda.FunctionUrlAuthType",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.FunctionUrlCorsOptions",
		reflect.TypeOf((*FunctionUrlCorsOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.FunctionUrlOptions",
		reflect.TypeOf((*FunctionUrlOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_lambda.FunctionUrlProps",
	...
	_jsii_.RegisterInterface(
		"monocdk.aws_lambda.IFunctionUrl",
