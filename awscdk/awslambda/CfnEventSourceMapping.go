...
func (j *jsiiProxy_CfnEventSourceMapping) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEventSourceMapping) MetricsConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"metricsConfig",
...
func (j *jsiiProxy_CfnEventSourceMapping) ProvisionedPollerConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEventSourceMapping)SetMetricsConfig(val interface{}) {
...
func (j *jsiiProxy_CfnEventSourceMapping)SetProvisionedPollerConfig(val interface{}) {
	if err := j.validateSetProvisionedPollerConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CfnEventSourceMapping) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventSourceMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventSourceMapping) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventSourceMapping) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventSourceMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
