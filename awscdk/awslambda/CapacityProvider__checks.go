...
func (c *jsiiProxy_CapacityProvider) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateCapacityProvider_FromCapacityProviderArnParameters(scope constructs.Construct, id *string, capacityProviderArn *string) error {
	...
	if capacityProviderArn == nil {
		return fmt.Errorf("parameter capacityProviderArn is required, but nil was provided")
	}
