...
func (j *jsiiProxy_CfnUrl) CfnPropertyNames() *map[string]*string {
...
func CfnUrl_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUrl_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUrl_IsCfnUrl(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUrl_IsCfnUrlParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUrl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUrl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUrl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUrl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUrl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
