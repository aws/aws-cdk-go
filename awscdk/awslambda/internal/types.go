...
type Type__interfacesawslambdaILayerVersionRef = interfacesawslambda.ILayerVersionRef
type Type__interfacesawslambdaILayerVersionPermissionRef = interfacesawslambda.ILayerVersionPermissionRef
type Type__interfacesawslambdaIMicrovmImageRef = interfacesawslambda.IMicrovmImageRef
type Type__interfacesawslambdaINetworkConnectorRef = interfacesawslambda.INetworkConnectorRef
type Type__interfacesawslambdaIPermissionRef = interfacesawslambda.IPermissionRef
type Type__interfacesawslambdaIResourcePolicyRef = interfacesawslambda.IResourcePolicyRef
