...
func (j *jsiiProxy_CfnEventInvokeConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEventInvokeConfig(scope constructs.Construct, id *string, props *CfnEventInvokeConfigProps) CfnEventInvokeConfig {
	...
	if err := validateNewCfnEventInvokeConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEventInvokeConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEventInvokeConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventInvokeConfig_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnEventInvokeConfig_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEventInvokeConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEventInvokeConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventInvokeConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventInvokeConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEventInvokeConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEventInvokeConfig) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnEventInvokeConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventInvokeConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
