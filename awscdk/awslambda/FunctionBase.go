...
func (j *jsiiProxy_FunctionBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_FunctionBase) FunctionRef() *interfacesawslambda.FunctionReference {
...
func (j *jsiiProxy_FunctionBase) TenancyConfig() TenancyConfig {
...
func (f *jsiiProxy_FunctionBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FunctionBase) GrantInvoke(identity awsiam.IGrantable) awsiam.Grant {
...
func (f *jsiiProxy_FunctionBase) GrantInvokeLatestVersion(identity awsiam.IGrantable) awsiam.Grant {
...
func (f *jsiiProxy_FunctionBase) GrantInvokeUrl(identity awsiam.IGrantable) awsiam.Grant {
...
func (f *jsiiProxy_FunctionBase) GrantInvokeVersion(identity awsiam.IGrantable, version IVersion) awsiam.Grant {
...
func (f *jsiiProxy_FunctionBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
