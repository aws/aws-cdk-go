...
func EventSourceMapping_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.EventSourceMapping",
...
func (e *jsiiProxy_EventSourceMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EventSourceMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
