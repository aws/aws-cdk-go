...
func (j *jsiiProxy_CfnLayerVersionPermission) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLayerVersionPermission) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLayerVersionPermission) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLayerVersionPermission) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLayerVersionPermission) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayerVersionPermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
