...
func (j *jsiiProxy_CfnUrl) Node() constructs.Node {
...
func (j *jsiiProxy_CfnUrl) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUrl(scope constructs.Construct, id *string, props *CfnUrlProps) CfnUrl {
	...
	if err := validateNewCfnUrlParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnUrl{}
...
func (j *jsiiProxy_CfnUrl)SetTargetFunctionArn(val *string) {
	if err := j.validateSetTargetFunctionArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnUrl_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUrl_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUrl_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnUrl_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUrl_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUrl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUrl) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUrl) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUrl) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUrl) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnUrl) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUrl) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
