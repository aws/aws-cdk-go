...
func (j *jsiiProxy_CfnLayerVersion) CfnPropertyNames() *map[string]*string {
...
func NewCfnLayerVersion(scope constructs.Construct, id *string, props *CfnLayerVersionProps) CfnLayerVersion {
	...
	if err := validateNewCfnLayerVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLayerVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLayerVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLayerVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLayerVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLayerVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLayerVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLayerVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayerVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLayerVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLayerVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLayerVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLayerVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLayerVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayerVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayerVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
