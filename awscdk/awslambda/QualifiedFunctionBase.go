...
func (q *jsiiProxy_QualifiedFunctionBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (q *jsiiProxy_QualifiedFunctionBase) ConsiderWarningOnInvokeFunctionPermissions(scope constructs.Construct, action *string) {
	if err := q.validateConsiderWarningOnInvokeFunctionPermissionsParameters(scope, action); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		q,
...
func (q *jsiiProxy_QualifiedFunctionBase) GrantInvoke(identity awsiam.IGrantable) awsiam.Grant {
	if err := q.validateGrantInvokeParameters(identity); err != nil {
		panic(err)
	}
...
func (q *jsiiProxy_QualifiedFunctionBase) GrantInvokeLatestVersion(identity awsiam.IGrantable) awsiam.Grant {
	if err := q.validateGrantInvokeLatestVersionParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (q *jsiiProxy_QualifiedFunctionBase) GrantInvokeUrl(identity awsiam.IGrantable) awsiam.Grant {
	if err := q.validateGrantInvokeUrlParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (q *jsiiProxy_QualifiedFunctionBase) GrantInvokeVersion(identity awsiam.IGrantable, version IVersion) awsiam.Grant {
	if err := q.validateGrantInvokeVersionParameters(identity, version); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
