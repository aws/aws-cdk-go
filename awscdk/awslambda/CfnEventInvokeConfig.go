...
func (j *jsiiProxy_CfnEventInvokeConfig) CfnPropertyNames() *map[string]*string {
...
func CfnEventInvokeConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEventInvokeConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEventInvokeConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventInvokeConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventInvokeConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventInvokeConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEventInvokeConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
