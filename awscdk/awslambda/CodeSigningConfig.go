...
func CodeSigningConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.CodeSigningConfig",
...
func (c *jsiiProxy_CodeSigningConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CodeSigningConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
