...
func (j *jsiiProxy_DockerImageFunction) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_DockerImageFunction) FunctionRef() *interfacesawslambda.FunctionReference {
...
func (j *jsiiProxy_DockerImageFunction) TenancyConfig() TenancyConfig {
...
func DockerImageFunction_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.DockerImageFunction",
...
func (d *jsiiProxy_DockerImageFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
