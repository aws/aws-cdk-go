...
func (j *jsiiProxy_LayerVersion) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_LayerVersion) LayerVersionRef() *interfacesawslambda.LayerVersionReference {
...
func LayerVersion_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.LayerVersion",
...
func (l *jsiiProxy_LayerVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LayerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
