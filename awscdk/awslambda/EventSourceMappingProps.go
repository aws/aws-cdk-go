...
type EventSourceMappingProps struct {
	...
	// Default: - No logging.
	//
	LogLevel EventSourceMappingLogLevel `field:"optional" json:"logLevel" yaml:"logLevel"`
	...
	// Default: - none.
	//
	SchemaRegistryConfig ISchemaRegistry `field:"optional" json:"schemaRegistryConfig" yaml:"schemaRegistryConfig"`
