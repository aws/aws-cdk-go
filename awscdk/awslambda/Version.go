...
func Version_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.Version",
...
func (v *jsiiProxy_Version) ConsiderWarningOnInvokeFunctionPermissions(scope constructs.Construct, action *string) {
	if err := v.validateConsiderWarningOnInvokeFunctionPermissionsParameters(scope, action); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_Version) GrantInvoke(identity awsiam.IGrantable) awsiam.Grant {
	if err := v.validateGrantInvokeParameters(identity); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_Version) GrantInvokeLatestVersion(identity awsiam.IGrantable) awsiam.Grant {
	if err := v.validateGrantInvokeLatestVersionParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (v *jsiiProxy_Version) GrantInvokeUrl(identity awsiam.IGrantable) awsiam.Grant {
	if err := v.validateGrantInvokeUrlParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (v *jsiiProxy_Version) GrantInvokeVersion(identity awsiam.IGrantable, version IVersion) awsiam.Grant {
	if err := v.validateGrantInvokeVersionParameters(identity, version); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (v *jsiiProxy_Version) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
