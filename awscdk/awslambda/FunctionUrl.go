...
func (j *jsiiProxy_FunctionUrl) Env() *interfaces.ResourceEnvironment {
...
func FunctionUrl_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_lambda.FunctionUrl",
...
func (f *jsiiProxy_FunctionUrl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FunctionUrl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
