...
func (j *jsiiProxy_CfnNamedQuery) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNamedQuery) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNamedQuery(scope constructs.Construct, id *string, props *CfnNamedQueryProps) CfnNamedQuery {
	...
	if err := validateNewCfnNamedQueryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNamedQuery_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNamedQuery_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNamedQuery_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNamedQuery_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNamedQuery_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNamedQuery_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNamedQuery) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNamedQuery) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNamedQuery) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNamedQuery) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNamedQuery) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNamedQuery) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNamedQuery) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNamedQuery) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNamedQuery) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNamedQuery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
