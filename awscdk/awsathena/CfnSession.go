...
//
//   cfnSession := awscdk.Aws_athena.NewCfnSession(this, jsii.String("MyCfnSession"), &CfnSessionProps{
...
type CfnSession interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsathena.ISessionRef
	// The ARN of the session.
	AttrArn() *string
	// Contains additional notebook engine parameter mappings.
	AttrEngineConfigurationAdditionalConfigs() awscdk.IResolvable
	// Specifies custom jar files and Spark properties.
	AttrEngineConfigurationSparkProperties() awscdk.IResolvable
	...
	SetEngineConfiguration(val interface{})
	...
	SessionRef() *interfacesawsathena.SessionReference
...
type jsiiProxy_CfnSession struct {
	...
	internal.Type__interfacesawsathenaISessionRef
}
...
func (j *jsiiProxy_CfnSession) AttrEngineConfigurationAdditionalConfigs() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrEngineConfigurationAdditionalConfigs",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnSession) AttrEngineConfigurationSparkProperties() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrEngineConfigurationSparkProperties",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnSession) AttrEngineVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEngineVersion",
...
func (j *jsiiProxy_CfnSession) EngineConfiguration() interface{} {
...
func (j *jsiiProxy_CfnSession) ExecutionRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executionRole",
...
func (j *jsiiProxy_CfnSession) SessionRef() *interfacesawsathena.SessionReference {
	var returns *interfacesawsathena.SessionReference
	_jsii_.Get(
		j,
		"sessionRef",
		&returns,
...
func (j *jsiiProxy_CfnSession) WorkGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workGroup",
...
func (j *jsiiProxy_CfnSession)SetEngineConfiguration(val interface{}) {
	if err := j.validateSetEngineConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSession)SetExecutionRole(val *string) {
	_jsii_.Set(
		j,
		"executionRole",
		val,
...
func (j *jsiiProxy_CfnSession)SetWorkGroup(val *string) {
...
func CfnSession_ArnForSession(resource interfacesawsathena.ISessionRef) *string {
	_init_.Initialize()
