...
func (j *jsiiProxy_CfnPreparedStatement) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPreparedStatement) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPreparedStatement(scope constructs.Construct, id *string, props *CfnPreparedStatementProps) CfnPreparedStatement {
	...
	if err := validateNewCfnPreparedStatementParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPreparedStatement_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPreparedStatement_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPreparedStatement_IsCfnPreparedStatement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPreparedStatement_IsCfnPreparedStatementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPreparedStatement_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPreparedStatement_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPreparedStatement) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreparedStatement) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPreparedStatement) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPreparedStatement) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPreparedStatement) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPreparedStatement) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPreparedStatement) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreparedStatement) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreparedStatement) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreparedStatement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
