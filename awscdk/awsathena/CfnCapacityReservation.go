...
//
//   cfnCapacityReservation := awscdk.Aws_athena.NewCfnCapacityReservation(this, jsii.String("MyCfnCapacityReservation"), &CfnCapacityReservationProps{
...
type CfnCapacityReservation interface {
	...
	AttrLastSuccessfulAllocationTime() *string
...
func (j *jsiiProxy_CfnCapacityReservation) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnCapacityReservation) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnCapacityReservation) AttrLastSuccessfulAllocationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCapacityReservation) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnCapacityReservation) CapacityAssignmentConfiguration() interface{} {
...
func (j *jsiiProxy_CfnCapacityReservation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnCapacityReservation) TargetDpus() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"targetDpus",
...
func (j *jsiiProxy_CfnCapacityReservation)SetCapacityAssignmentConfiguration(val interface{}) {
	if err := j.validateSetCapacityAssignmentConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCapacityReservation)SetName(val *string) {
...
func (j *jsiiProxy_CfnCapacityReservation)SetTargetDpus(val *float64) {
...
func CfnCapacityReservation_ArnForCapacityReservation(resource interfacesawsathena.ICapacityReservationRef) *string {
	_init_.Initialize()
