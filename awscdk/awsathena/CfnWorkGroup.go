...
func (j *jsiiProxy_CfnWorkGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnWorkGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWorkGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWorkGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWorkGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
