...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnEntitledDataSets)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsdataexchangeIEntitledDataSetsRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_dataexchange.CfnEntitledDataSetsProps",
		reflect.TypeOf((*CfnEntitledDataSetsProps)(nil)).Elem(),
	)
}
