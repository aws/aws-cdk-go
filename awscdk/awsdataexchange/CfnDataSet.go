...
//
//   cfnDataSet := awscdk.Aws_dataexchange.NewCfnDataSet(this, jsii.String("MyCfnDataSet"), &CfnDataSetProps{
...
type CfnDataSet interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdataexchange.IDataSetRef
	awscdk.ITaggableV2
	...
	DataSetRef() *interfacesawsdataexchange.DataSetReference
...
type jsiiProxy_CfnDataSet struct {
	...
	internal.Type__interfacesawsdataexchangeIDataSetRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnDataSet) AssetType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"assetType",
...
func (j *jsiiProxy_CfnDataSet) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnDataSet) AttrOrigin() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOrigin",
...
func (j *jsiiProxy_CfnDataSet) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnDataSet) DataSetRef() *interfacesawsdataexchange.DataSetReference {
	var returns *interfacesawsdataexchange.DataSetReference
	_jsii_.Get(
		j,
		"dataSetRef",
		&returns,
...
func (j *jsiiProxy_CfnDataSet)SetAssetType(val *string) {
...
func CfnDataSet_ArnForDataSet(resource interfacesawsdataexchange.IDataSetRef) *string {
	_init_.Initialize()
