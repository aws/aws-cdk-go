...
func validateCfnDataSet_ArnForDataSetParameters(resource interfacesawsdataexchange.IDataSetRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataSet) validateSetAssetTypeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDataSet) validateSetDescriptionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
