...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnTunnel)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrTunnelArn", GoGetter: "AttrTunnelArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrTunnelId", GoGetter: "AttrTunnelId"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsiotsecuretunnelingITunnelRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_iotsecuretunneling.CfnTunnel.DestinationConfigProperty",
		reflect.TypeOf((*CfnTunnel_DestinationConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_iotsecuretunneling.CfnTunnel.TimeoutConfigProperty",
		reflect.TypeOf((*CfnTunnel_TimeoutConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_iotsecuretunneling.CfnTunnelProps",
		reflect.TypeOf((*CfnTunnelProps)(nil)).Elem(),
	)
}
