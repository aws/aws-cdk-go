...
func (j *jsiiProxy_CfnTestCase) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnTestCase) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTestCase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTestCase) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTestCase) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTestCase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
