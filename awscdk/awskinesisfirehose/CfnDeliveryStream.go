...
func (j *jsiiProxy_CfnDeliveryStream) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDeliveryStream) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeliveryStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeliveryStream) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeliveryStream) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeliveryStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
