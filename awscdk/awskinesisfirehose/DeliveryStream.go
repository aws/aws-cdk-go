...
func DeliveryStream_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_kinesisfirehose.DeliveryStream",
...
func (d *jsiiProxy_DeliveryStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DeliveryStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
