...
func (c *jsiiProxy_CfnDeliveryStream) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnDeliveryStream) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnDeliveryStream) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnDeliveryStream) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnDeliveryStream_ArnForDeliveryStreamParameters(resource interfacesawskinesisfirehose.IDeliveryStreamRef) error {
	if resource == nil {
...
func validateCfnDeliveryStream_FromDeliveryStreamArnParameters(scope constructs.Construct, id *string, arn *string) error {
	if scope == nil {
...
func validateCfnDeliveryStream_FromDeliveryStreamNameParameters(scope constructs.Construct, id *string, deliveryStreamName *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDeliveryStream) validateSetDirectPutSourceConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDeliveryStream_DirectPutSourceConfigurationProperty:
		val := val.(*CfnDeliveryStream_DirectPutSourceConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDeliveryStream_DirectPutSourceConfigurationProperty:
		val_ := val.(CfnDeliveryStream_DirectPutSourceConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDeliveryStream_DirectPutSourceConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDeliveryStream) validateSetIcebergDestinationConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDeliveryStream_IcebergDestinationConfigurationProperty:
		val := val.(*CfnDeliveryStream_IcebergDestinationConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDeliveryStream_IcebergDestinationConfigurationProperty:
		val_ := val.(CfnDeliveryStream_IcebergDestinationConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDeliveryStream_IcebergDestinationConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
