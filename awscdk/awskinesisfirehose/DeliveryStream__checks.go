...
func (d *jsiiProxy_DeliveryStream) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateDeliveryStream_FromDeliveryStreamNameParameters(scope constructs.Construct, id *string, deliveryStreamName *string) error {
	...
	if deliveryStreamName == nil {
		return fmt.Errorf("parameter deliveryStreamName is required, but nil was provided")
	}
...
func validateDeliveryStream_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateDeliveryStream_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
