...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawssecurityagentIApplicationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawssecurityagent.ApplicationReference {
	var returns *interfacesawssecurityagent.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) AttrDomain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomain",
...
func (j *jsiiProxy_CfnApplication) AttrIdCConfigurationIdCApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplication) DefaultKmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultKmsKeyId",
...
func (j *jsiiProxy_CfnApplication) IdCConfiguration() interface{} {
...
func (j *jsiiProxy_CfnApplication)SetDefaultKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"defaultKmsKeyId",
		val,
...
func (j *jsiiProxy_CfnApplication)SetIdCConfiguration(val interface{}) {
	if err := j.validateSetIdCConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnApplication_FromApplicationId(scope constructs.Construct, id *string, applicationId *string) interfacesawssecurityagent.IApplicationRef {
	...
	var returns interfacesawssecurityagent.IApplicationRef
