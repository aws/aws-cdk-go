...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnArtifact)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "artifactContent", GoGetter: "ArtifactContent"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrArtifactId", GoGetter: "AttrArtifactId"},
			_jsii_.MemberProperty{JsiiProperty: "attrUpdatedAt", GoGetter: "AttrUpdatedAt"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
			_jsii_.MemberMethod{JsiiMethod: "cfnPropertyName", GoMethod: "CfnPropertyName"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawssecurityagentIArtifactRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityagent.CfnArtifactProps",
		reflect.TypeOf((*CfnArtifactProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityagent.CfnPentest.CaCertificateSourceProperty",
		reflect.TypeOf((*CfnPentest_CaCertificateSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_securityagent.CfnPentest.TrustedCaCertificateProperty",
		reflect.TypeOf((*CfnPentest_TrustedCaCertificateProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
