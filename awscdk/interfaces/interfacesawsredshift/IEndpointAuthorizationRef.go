...
func (i *jsiiProxy_IEndpointAuthorizationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IEndpointAuthorizationRef) Env() *interfaces.ResourceEnvironment {
