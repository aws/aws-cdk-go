...
func (i *jsiiProxy_IAutoScalingConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAutoScalingConfigurationRef) Env() *interfaces.ResourceEnvironment {
