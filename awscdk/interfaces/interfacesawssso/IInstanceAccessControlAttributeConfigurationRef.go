...
func (i *jsiiProxy_IInstanceAccessControlAttributeConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IInstanceAccessControlAttributeConfigurationRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IInstanceAccessControlAttributeConfigurationRef) Node() constructs.Node {
