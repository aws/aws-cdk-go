...
func (i *jsiiProxy_IApplicationAssignmentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IApplicationAssignmentRef) Env() *interfaces.ResourceEnvironment {
