...
func (i *jsiiProxy_ISlackChannelConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISlackChannelConfigurationRef) Env() *interfaces.ResourceEnvironment {
