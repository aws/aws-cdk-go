...
func (i *jsiiProxy_IExperimentTemplateRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IExperimentTemplateRef) Env() *interfaces.ResourceEnvironment {
