...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawskms/internal"
...
func (i *jsiiProxy_IReplicaKeyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IReplicaKeyRef) Env() *interfaces.ResourceEnvironment {
