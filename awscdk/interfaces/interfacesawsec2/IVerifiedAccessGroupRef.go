...
func (i *jsiiProxy_IVerifiedAccessGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVerifiedAccessGroupRef) Env() *interfaces.ResourceEnvironment {
