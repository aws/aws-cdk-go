...
func (i *jsiiProxy_INetworkInsightsAccessScopeAnalysisRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INetworkInsightsAccessScopeAnalysisRef) Env() *interfaces.ResourceEnvironment {
