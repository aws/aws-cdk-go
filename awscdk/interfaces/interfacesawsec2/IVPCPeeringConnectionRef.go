...
func (i *jsiiProxy_IVPCPeeringConnectionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPCPeeringConnectionRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IVPCPeeringConnectionRef) Node() constructs.Node {
