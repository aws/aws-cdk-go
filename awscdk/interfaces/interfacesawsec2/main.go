...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_ec2.IIPAMPrefixListResolverRef",
		reflect.TypeOf((*IIPAMPrefixListResolverRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "ipamPrefixListResolverRef", GoGetter: "IpamPrefixListResolverRef"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "with", GoMethod: "With"},
		},
		func() interface{} {
			j := jsiiProxy_IIPAMPrefixListResolverRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_ec2.IVPNConcentratorRef",
		reflect.TypeOf((*IVPNConcentratorRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "vpnConcentratorRef", GoGetter: "VpnConcentratorRef"},
			_jsii_.MemberMethod{JsiiMethod: "with", GoMethod: "With"},
		},
		func() interface{} {
			j := jsiiProxy_IVPNConcentratorRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_ec2.VPNConcentratorReference",
		reflect.TypeOf((*VPNConcentratorReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
