...
func (i *jsiiProxy_ITrafficMirrorTargetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITrafficMirrorTargetRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ITrafficMirrorTargetRef) Node() constructs.Node {
