...
func (i *jsiiProxy_IVPCEndpointServicePermissionsRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPCEndpointServicePermissionsRef) Env() *interfaces.ResourceEnvironment {
