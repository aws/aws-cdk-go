...
func (i *jsiiProxy_IVPNConnectionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPNConnectionRef) Env() *interfaces.ResourceEnvironment {
