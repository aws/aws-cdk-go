...
func (i *jsiiProxy_ISubnetRouteTableAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubnetRouteTableAssociationRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ISubnetRouteTableAssociationRef) Node() constructs.Node {
