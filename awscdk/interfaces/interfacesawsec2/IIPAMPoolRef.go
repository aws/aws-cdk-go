...
func (i *jsiiProxy_IIPAMPoolRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IIPAMPoolRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IIPAMPoolRef) Node() constructs.Node {
