...
func (i *jsiiProxy_ITrafficMirrorSessionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITrafficMirrorSessionRef) Env() *interfaces.ResourceEnvironment {
