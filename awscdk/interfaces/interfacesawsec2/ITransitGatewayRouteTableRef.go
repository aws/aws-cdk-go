...
func (i *jsiiProxy_ITransitGatewayRouteTableRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITransitGatewayRouteTableRef) Env() *interfaces.ResourceEnvironment {
