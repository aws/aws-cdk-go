...
func (i *jsiiProxy_ILaunchTemplateRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILaunchTemplateRef) Env() *interfaces.ResourceEnvironment {
