...
func (i *jsiiProxy_ITransitGatewayConnectRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITransitGatewayConnectRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ITransitGatewayConnectRef) Node() constructs.Node {
