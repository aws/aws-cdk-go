...
func (i *jsiiProxy_IClientVpnTargetNetworkAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IClientVpnTargetNetworkAssociationRef) Env() *interfaces.ResourceEnvironment {
