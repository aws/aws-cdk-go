...
func (i *jsiiProxy_ICustomerGatewayRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomerGatewayRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ICustomerGatewayRef) Node() constructs.Node {
