...
func (i *jsiiProxy_IClientVpnAuthorizationRuleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IClientVpnAuthorizationRuleRef) Env() *interfaces.ResourceEnvironment {
