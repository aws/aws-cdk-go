...
func (i *jsiiProxy_IVerifiedAccessInstanceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVerifiedAccessInstanceRef) Env() *interfaces.ResourceEnvironment {
