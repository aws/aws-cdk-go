...
func (i *jsiiProxy_IVolumeAttachmentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVolumeAttachmentRef) Env() *interfaces.ResourceEnvironment {
