...
func (i *jsiiProxy_IIPAMRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IIPAMRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IIPAMRef) Node() constructs.Node {
