...
func (i *jsiiProxy_IVPCDHCPOptionsAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPCDHCPOptionsAssociationRef) Env() *interfaces.ResourceEnvironment {
