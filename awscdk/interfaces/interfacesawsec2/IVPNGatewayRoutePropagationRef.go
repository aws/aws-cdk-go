...
func (i *jsiiProxy_IVPNGatewayRoutePropagationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPNGatewayRoutePropagationRef) Env() *interfaces.ResourceEnvironment {
