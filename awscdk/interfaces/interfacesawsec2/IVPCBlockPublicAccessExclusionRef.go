...
func (i *jsiiProxy_IVPCBlockPublicAccessExclusionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVPCBlockPublicAccessExclusionRef) Env() *interfaces.ResourceEnvironment {
