...
func (i *jsiiProxy_INetworkInterfaceAttachmentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INetworkInterfaceAttachmentRef) Env() *interfaces.ResourceEnvironment {
