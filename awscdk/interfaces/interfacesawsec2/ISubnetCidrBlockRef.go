...
func (i *jsiiProxy_ISubnetCidrBlockRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubnetCidrBlockRef) Env() *interfaces.ResourceEnvironment {
