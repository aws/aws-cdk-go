...
func (i *jsiiProxy_IIPAMAllocationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IIPAMAllocationRef) Env() *interfaces.ResourceEnvironment {
