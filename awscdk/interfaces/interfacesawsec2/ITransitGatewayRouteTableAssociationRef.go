...
func (i *jsiiProxy_ITransitGatewayRouteTableAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITransitGatewayRouteTableAssociationRef) Env() *interfaces.ResourceEnvironment {
