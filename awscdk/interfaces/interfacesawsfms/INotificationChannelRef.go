...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsfms/internal"
...
func (i *jsiiProxy_INotificationChannelRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INotificationChannelRef) Env() *interfaces.ResourceEnvironment {
