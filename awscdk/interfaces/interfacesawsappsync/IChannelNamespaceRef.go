...
func (i *jsiiProxy_IChannelNamespaceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IChannelNamespaceRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IChannelNamespaceRef) Node() constructs.Node {
