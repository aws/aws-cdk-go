...
func (i *jsiiProxy_ISourceApiAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISourceApiAssociationRef) Env() *interfaces.ResourceEnvironment {
