...
func (i *jsiiProxy_IDomainNameRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDomainNameRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IDomainNameRef) Node() constructs.Node {
