...
func (i *jsiiProxy_IFunctionConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFunctionConfigurationRef) Env() *interfaces.ResourceEnvironment {
