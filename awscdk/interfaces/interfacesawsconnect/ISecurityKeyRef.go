...
func (i *jsiiProxy_ISecurityKeyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISecurityKeyRef) Env() *interfaces.ResourceEnvironment {
