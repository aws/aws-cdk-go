...
func (i *jsiiProxy_ITrafficDistributionGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITrafficDistributionGroupRef) Env() *interfaces.ResourceEnvironment {
