...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_connect.IDataTableAttributeRef",
		reflect.TypeOf((*IDataTableAttributeRef)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_connect.IDataTableRef",
		reflect.TypeOf((*IDataTableRef)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_connect.IMetricRef",
		reflect.TypeOf((*IMetricRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_connect.ITestCaseRef",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_connect.MetricReference",
		reflect.TypeOf((*MetricReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_connect.TestCaseReference",
