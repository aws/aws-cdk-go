...
func (i *jsiiProxy_IStudioSessionMappingRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IStudioSessionMappingRef) Env() *interfaces.ResourceEnvironment {
