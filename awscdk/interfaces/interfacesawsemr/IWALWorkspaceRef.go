...
func (i *jsiiProxy_IWALWorkspaceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IWALWorkspaceRef) Env() *interfaces.ResourceEnvironment {
