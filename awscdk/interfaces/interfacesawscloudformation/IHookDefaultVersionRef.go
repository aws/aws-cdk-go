...
func (i *jsiiProxy_IHookDefaultVersionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IHookDefaultVersionRef) Env() *interfaces.ResourceEnvironment {
