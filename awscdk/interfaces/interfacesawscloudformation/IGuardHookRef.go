...
func (i *jsiiProxy_IGuardHookRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IGuardHookRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IGuardHookRef) Node() constructs.Node {
