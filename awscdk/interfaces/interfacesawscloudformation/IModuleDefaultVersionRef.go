...
func (i *jsiiProxy_IModuleDefaultVersionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IModuleDefaultVersionRef) Env() *interfaces.ResourceEnvironment {
