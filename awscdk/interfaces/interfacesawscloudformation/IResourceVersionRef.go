...
func (i *jsiiProxy_IResourceVersionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResourceVersionRef) Env() *interfaces.ResourceEnvironment {
