...
func (i *jsiiProxy_ILaunchNotificationConstraintRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILaunchNotificationConstraintRef) Env() *interfaces.ResourceEnvironment {
