...
func (i *jsiiProxy_ICloudFormationProvisionedProductRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICloudFormationProvisionedProductRef) Env() *interfaces.ResourceEnvironment {
