...
func (i *jsiiProxy_IStackSetConstraintRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IStackSetConstraintRef) Env() *interfaces.ResourceEnvironment {
