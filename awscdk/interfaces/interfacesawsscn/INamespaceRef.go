...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsscn/internal"
...
func (i *jsiiProxy_INamespaceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
