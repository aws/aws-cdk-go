...
func (i *jsiiProxy_ISegmentDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISegmentDefinitionRef) Env() *interfaces.ResourceEnvironment {
