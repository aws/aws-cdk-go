...
func (i *jsiiProxy_ICalculatedAttributeDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICalculatedAttributeDefinitionRef) Env() *interfaces.ResourceEnvironment {
