...
func (i *jsiiProxy_ICustomEntityTypeRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomEntityTypeRef) Env() *interfaces.ResourceEnvironment {
