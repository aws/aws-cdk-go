...
func (i *jsiiProxy_IBlueprintRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBlueprintRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IBlueprintRef) Node() constructs.Node {
