...
func (i *jsiiProxy_IIntegrationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IIntegrationRef) Env() *interfaces.ResourceEnvironment {
