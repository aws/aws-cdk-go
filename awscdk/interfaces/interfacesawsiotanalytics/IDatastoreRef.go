...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsiotanalytics/internal"
...
func (i *jsiiProxy_IDatastoreRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDatastoreRef) Env() *interfaces.ResourceEnvironment {
