...
func (i *jsiiProxy_IEventBridgeRuleTemplateGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IEventBridgeRuleTemplateGroupRef) Env() *interfaces.ResourceEnvironment {
