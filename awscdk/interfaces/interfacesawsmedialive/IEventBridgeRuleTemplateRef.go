...
func (i *jsiiProxy_IEventBridgeRuleTemplateRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IEventBridgeRuleTemplateRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IEventBridgeRuleTemplateRef) Node() constructs.Node {
