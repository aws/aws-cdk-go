...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_medialive.INodeRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_medialive.IOfferingRef",
		reflect.TypeOf((*IOfferingRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_medialive.NodeReference",
		reflect.TypeOf((*NodeReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_medialive.OfferingReference",
		reflect.TypeOf((*OfferingReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
