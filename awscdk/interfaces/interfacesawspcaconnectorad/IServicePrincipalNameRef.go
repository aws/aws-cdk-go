...
func (i *jsiiProxy_IServicePrincipalNameRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IServicePrincipalNameRef) Env() *interfaces.ResourceEnvironment {
