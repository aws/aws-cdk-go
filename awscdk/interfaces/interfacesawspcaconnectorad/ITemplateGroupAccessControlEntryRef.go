...
func (i *jsiiProxy_ITemplateGroupAccessControlEntryRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITemplateGroupAccessControlEntryRef) Env() *interfaces.ResourceEnvironment {
