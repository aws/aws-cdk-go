...
func (i *jsiiProxy_INotebookInstanceLifecycleConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INotebookInstanceLifecycleConfigRef) Env() *interfaces.ResourceEnvironment {
