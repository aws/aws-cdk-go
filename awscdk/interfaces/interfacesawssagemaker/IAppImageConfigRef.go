...
func (i *jsiiProxy_IAppImageConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAppImageConfigRef) Env() *interfaces.ResourceEnvironment {
