...
func (i *jsiiProxy_ICodeRepositoryRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICodeRepositoryRef) Env() *interfaces.ResourceEnvironment {
