...
func (i *jsiiProxy_IMonitoringScheduleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMonitoringScheduleRef) Env() *interfaces.ResourceEnvironment {
