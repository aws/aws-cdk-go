...
func (i *jsiiProxy_IModelQualityJobDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IModelQualityJobDefinitionRef) Env() *interfaces.ResourceEnvironment {
