...
func (i *jsiiProxy_IModelBiasJobDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IModelBiasJobDefinitionRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IModelBiasJobDefinitionRef) Node() constructs.Node {
