...
func (i *jsiiProxy_IModelCardRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IModelCardRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IModelCardRef) Node() constructs.Node {
