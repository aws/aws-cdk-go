...
func (i *jsiiProxy_IInferenceComponentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IInferenceComponentRef) Env() *interfaces.ResourceEnvironment {
