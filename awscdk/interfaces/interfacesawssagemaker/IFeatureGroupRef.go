...
func (i *jsiiProxy_IFeatureGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFeatureGroupRef) Env() *interfaces.ResourceEnvironment {
