...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsmediastore/internal"
...
func (i *jsiiProxy_IContainerRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IContainerRef) Env() *interfaces.ResourceEnvironment {
