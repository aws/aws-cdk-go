...
func (i *jsiiProxy_IReplicationGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IReplicationGroupRef) Env() *interfaces.ResourceEnvironment {
