...
func (i *jsiiProxy_ICacheClusterRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICacheClusterRef) Env() *interfaces.ResourceEnvironment {
