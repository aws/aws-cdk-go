...
func (i *jsiiProxy_ISecurityGroupIngressRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISecurityGroupIngressRef) Env() *interfaces.ResourceEnvironment {
