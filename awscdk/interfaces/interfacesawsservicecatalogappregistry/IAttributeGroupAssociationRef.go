...
func (i *jsiiProxy_IAttributeGroupAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAttributeGroupAssociationRef) Env() *interfaces.ResourceEnvironment {
