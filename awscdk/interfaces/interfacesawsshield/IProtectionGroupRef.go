...
func (i *jsiiProxy_IProtectionGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IProtectionGroupRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IProtectionGroupRef) Node() constructs.Node {
