...
func (i *jsiiProxy_ISecurityConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISecurityConfigRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ISecurityConfigRef) Node() constructs.Node {
