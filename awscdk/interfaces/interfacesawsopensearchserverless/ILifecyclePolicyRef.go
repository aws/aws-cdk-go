...
func (i *jsiiProxy_ILifecyclePolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILifecyclePolicyRef) Env() *interfaces.ResourceEnvironment {
