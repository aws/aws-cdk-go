...
func (i *jsiiProxy_ISecurityPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISecurityPolicyRef) Env() *interfaces.ResourceEnvironment {
