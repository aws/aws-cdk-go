...
func (i *jsiiProxy_IConfigurationManagerRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IConfigurationManagerRef) Env() *interfaces.ResourceEnvironment {
