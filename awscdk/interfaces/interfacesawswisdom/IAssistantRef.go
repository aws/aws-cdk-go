...
func (i *jsiiProxy_IAssistantRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAssistantRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IAssistantRef) Node() constructs.Node {
