...
func (i *jsiiProxy_IAIAgentVersionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAIAgentVersionRef) Env() *interfaces.ResourceEnvironment {
