...
func (i *jsiiProxy_IQuickResponseRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IQuickResponseRef) Env() *interfaces.ResourceEnvironment {
