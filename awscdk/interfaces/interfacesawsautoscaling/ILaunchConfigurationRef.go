...
func (i *jsiiProxy_ILaunchConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILaunchConfigurationRef) Env() *interfaces.ResourceEnvironment {
