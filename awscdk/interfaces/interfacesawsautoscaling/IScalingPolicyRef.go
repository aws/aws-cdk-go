...
func (i *jsiiProxy_IScalingPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IScalingPolicyRef) Env() *interfaces.ResourceEnvironment {
