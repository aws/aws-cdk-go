...
func (i *jsiiProxy_IFHIRDatastoreRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFHIRDatastoreRef) Env() *interfaces.ResourceEnvironment {
