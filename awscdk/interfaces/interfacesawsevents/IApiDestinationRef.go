...
func (i *jsiiProxy_IApiDestinationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IApiDestinationRef) Env() *interfaces.ResourceEnvironment {
