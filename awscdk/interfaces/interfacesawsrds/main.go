...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_rds.IReservedDBInstanceRef",
		reflect.TypeOf((*IReservedDBInstanceRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "reservedDbInstanceRef", GoGetter: "ReservedDbInstanceRef"},
			_jsii_.MemberMethod{JsiiMethod: "with", GoMethod: "With"},
		},
		func() interface{} {
			j := jsiiProxy_IReservedDBInstanceRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_rds.ReservedDBInstanceReference",
		reflect.TypeOf((*ReservedDBInstanceReference)(nil)).Elem(),
	)
}
