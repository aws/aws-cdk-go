...
func (i *jsiiProxy_IDBProxyTargetGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDBProxyTargetGroupRef) Env() *interfaces.ResourceEnvironment {
