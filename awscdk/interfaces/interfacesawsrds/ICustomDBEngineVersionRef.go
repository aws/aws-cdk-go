...
func (i *jsiiProxy_ICustomDBEngineVersionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomDBEngineVersionRef) Env() *interfaces.ResourceEnvironment {
