...
func (i *jsiiProxy_IFlowVpcInterfaceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFlowVpcInterfaceRef) Env() *interfaces.ResourceEnvironment {
