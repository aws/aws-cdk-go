...
func (i *jsiiProxy_ICertificateAuthorityActivationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICertificateAuthorityActivationRef) Env() *interfaces.ResourceEnvironment {
