...
func (i *jsiiProxy_IFleetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFleetRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IFleetRef) Node() constructs.Node {
