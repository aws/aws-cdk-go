...
func (i *jsiiProxy_IRuleGroupsNamespaceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRuleGroupsNamespaceRef) Env() *interfaces.ResourceEnvironment {
