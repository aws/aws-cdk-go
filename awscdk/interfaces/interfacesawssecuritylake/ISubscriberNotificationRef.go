...
func (i *jsiiProxy_ISubscriberNotificationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubscriberNotificationRef) Env() *interfaces.ResourceEnvironment {
