...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.ApplicationOutputReference",
		reflect.TypeOf((*ApplicationOutputReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.ApplicationReference",
		reflect.TypeOf((*ApplicationReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.ApplicationReferenceDataSourceReference",
		reflect.TypeOf((*ApplicationReferenceDataSourceReference)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.IApplicationOutputRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.IApplicationRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_kinesisanalytics.IApplicationReferenceDataSourceRef",
