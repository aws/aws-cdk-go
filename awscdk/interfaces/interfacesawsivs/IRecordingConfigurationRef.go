...
func (i *jsiiProxy_IRecordingConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRecordingConfigurationRef) Env() *interfaces.ResourceEnvironment {
