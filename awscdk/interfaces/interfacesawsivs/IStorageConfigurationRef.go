...
func (i *jsiiProxy_IStorageConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IStorageConfigurationRef) Env() *interfaces.ResourceEnvironment {
