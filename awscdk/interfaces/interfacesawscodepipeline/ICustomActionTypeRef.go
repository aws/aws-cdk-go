...
func (i *jsiiProxy_ICustomActionTypeRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomActionTypeRef) Env() *interfaces.ResourceEnvironment {
