...
func (i *jsiiProxy_IServiceNetworkResourceAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IServiceNetworkResourceAssociationRef) Env() *interfaces.ResourceEnvironment {
