...
func (i *jsiiProxy_IUrlRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IUrlRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IUrlRef) Node() constructs.Node {
