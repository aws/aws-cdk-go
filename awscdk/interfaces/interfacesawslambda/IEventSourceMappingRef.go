...
func (i *jsiiProxy_IEventSourceMappingRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IEventSourceMappingRef) Env() *interfaces.ResourceEnvironment {
