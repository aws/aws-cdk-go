...
func (i *jsiiProxy_IEventInvokeConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IEventInvokeConfigRef) Env() *interfaces.ResourceEnvironment {
