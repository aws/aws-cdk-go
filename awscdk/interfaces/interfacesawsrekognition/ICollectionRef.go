...
func (i *jsiiProxy_ICollectionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICollectionRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ICollectionRef) Node() constructs.Node {
