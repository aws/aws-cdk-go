...
func (i *jsiiProxy_IRouteResponseRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRouteResponseRef) Env() *interfaces.ResourceEnvironment {
