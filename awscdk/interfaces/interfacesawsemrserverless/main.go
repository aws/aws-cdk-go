package interfacesawsemrserverless
...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_emrserverless.ApplicationReference",
		reflect.TypeOf((*ApplicationReference)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_emrserverless.IApplicationRef",
