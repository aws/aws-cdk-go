...
func (i *jsiiProxy_IConfigurationSetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IConfigurationSetRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IConfigurationSetRef) Node() constructs.Node {
