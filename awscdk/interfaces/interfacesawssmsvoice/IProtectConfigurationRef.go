...
func (i *jsiiProxy_IProtectConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IProtectConfigurationRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IProtectConfigurationRef) Node() constructs.Node {
