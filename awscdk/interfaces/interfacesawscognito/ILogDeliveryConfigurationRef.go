...
func (i *jsiiProxy_ILogDeliveryConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILogDeliveryConfigurationRef) Env() *interfaces.ResourceEnvironment {
