...
func (i *jsiiProxy_IManagedLoginBrandingRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IManagedLoginBrandingRef) Env() *interfaces.ResourceEnvironment {
