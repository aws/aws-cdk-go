...
func (i *jsiiProxy_IIdentityPoolPrincipalTagRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IIdentityPoolPrincipalTagRef) Env() *interfaces.ResourceEnvironment {
