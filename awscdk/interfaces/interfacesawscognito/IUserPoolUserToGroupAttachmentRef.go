...
func (i *jsiiProxy_IUserPoolUserToGroupAttachmentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IUserPoolUserToGroupAttachmentRef) Env() *interfaces.ResourceEnvironment {
