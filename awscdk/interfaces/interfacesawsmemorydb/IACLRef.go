...
func (i *jsiiProxy_IACLRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IACLRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IACLRef) Node() constructs.Node {
