...
func (i *jsiiProxy_IPrivateGraphEndpointRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPrivateGraphEndpointRef) Env() *interfaces.ResourceEnvironment {
