...
func (i *jsiiProxy_IImagePipelineRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IImagePipelineRef) Env() *interfaces.ResourceEnvironment {
