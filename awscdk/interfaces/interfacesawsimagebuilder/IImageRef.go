...
func (i *jsiiProxy_IImageRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IImageRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IImageRef) Node() constructs.Node {
