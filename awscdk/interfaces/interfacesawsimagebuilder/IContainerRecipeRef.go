...
func (i *jsiiProxy_IContainerRecipeRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IContainerRecipeRef) Env() *interfaces.ResourceEnvironment {
