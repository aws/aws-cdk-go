...
func (i *jsiiProxy_IBrowserCustomRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBrowserCustomRef) Env() *interfaces.ResourceEnvironment {
