...
func (i *jsiiProxy_IGatewayTargetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IGatewayTargetRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IGatewayTargetRef) Node() constructs.Node {
