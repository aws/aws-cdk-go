...
func (i *jsiiProxy_ICapacityProviderRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICapacityProviderRef) Env() *interfaces.ResourceEnvironment {
