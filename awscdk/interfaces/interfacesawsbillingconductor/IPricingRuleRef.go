...
func (i *jsiiProxy_IPricingRuleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPricingRuleRef) Env() *interfaces.ResourceEnvironment {
