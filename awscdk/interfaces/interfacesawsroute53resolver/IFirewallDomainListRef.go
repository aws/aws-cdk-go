...
func (i *jsiiProxy_IFirewallDomainListRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFirewallDomainListRef) Env() *interfaces.ResourceEnvironment {
