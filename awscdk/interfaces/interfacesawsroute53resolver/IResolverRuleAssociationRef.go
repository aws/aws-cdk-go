...
func (i *jsiiProxy_IResolverRuleAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResolverRuleAssociationRef) Env() *interfaces.ResourceEnvironment {
