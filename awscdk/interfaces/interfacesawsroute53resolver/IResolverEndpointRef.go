...
func (i *jsiiProxy_IResolverEndpointRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResolverEndpointRef) Env() *interfaces.ResourceEnvironment {
