...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawspricingplanmanager/internal"
...
func (i *jsiiProxy_ISubscriptionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubscriptionRef) Env() *interfaces.ResourceEnvironment {
