...
func (i *jsiiProxy_IControlPanelRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IControlPanelRef) Env() *interfaces.ResourceEnvironment {
