...
func (i *jsiiProxy_IDirectoryConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDirectoryConfigRef) Env() *interfaces.ResourceEnvironment {
