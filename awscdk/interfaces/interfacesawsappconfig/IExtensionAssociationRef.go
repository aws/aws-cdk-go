...
func (i *jsiiProxy_IExtensionAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IExtensionAssociationRef) Env() *interfaces.ResourceEnvironment {
