...
func (i *jsiiProxy_IConfigurationProfileRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IConfigurationProfileRef) Env() *interfaces.ResourceEnvironment {
