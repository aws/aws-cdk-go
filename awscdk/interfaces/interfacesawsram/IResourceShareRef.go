...
func (i *jsiiProxy_IResourceShareRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResourceShareRef) Env() *interfaces.ResourceEnvironment {
