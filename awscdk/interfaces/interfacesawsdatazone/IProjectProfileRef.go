...
func (i *jsiiProxy_IProjectProfileRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IProjectProfileRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IProjectProfileRef) Node() constructs.Node {
