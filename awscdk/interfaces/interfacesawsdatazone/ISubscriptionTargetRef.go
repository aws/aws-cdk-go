...
func (i *jsiiProxy_ISubscriptionTargetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubscriptionTargetRef) Env() *interfaces.ResourceEnvironment {
