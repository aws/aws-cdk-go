...
func (i *jsiiProxy_IProjectMembershipRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IProjectMembershipRef) Env() *interfaces.ResourceEnvironment {
