...
func (i *jsiiProxy_IContinuousDeploymentPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IContinuousDeploymentPolicyRef) Env() *interfaces.ResourceEnvironment {
