...
func (i *jsiiProxy_IOriginRequestPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IOriginRequestPolicyRef) Env() *interfaces.ResourceEnvironment {
