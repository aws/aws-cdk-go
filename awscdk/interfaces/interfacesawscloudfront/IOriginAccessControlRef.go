...
func (i *jsiiProxy_IOriginAccessControlRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IOriginAccessControlRef) Env() *interfaces.ResourceEnvironment {
