...
func (i *jsiiProxy_ICloudFrontOriginAccessIdentityRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICloudFrontOriginAccessIdentityRef) Env() *interfaces.ResourceEnvironment {
