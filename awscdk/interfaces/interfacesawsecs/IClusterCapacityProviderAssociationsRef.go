...
func (i *jsiiProxy_IClusterCapacityProviderAssociationsRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IClusterCapacityProviderAssociationsRef) Env() *interfaces.ResourceEnvironment {
