...
func (i *jsiiProxy_IAssessmentTargetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAssessmentTargetRef) Env() *interfaces.ResourceEnvironment {
