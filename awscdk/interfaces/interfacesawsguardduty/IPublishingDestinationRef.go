...
func (i *jsiiProxy_IPublishingDestinationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPublishingDestinationRef) Env() *interfaces.ResourceEnvironment {
