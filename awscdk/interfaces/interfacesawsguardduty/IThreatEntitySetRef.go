...
func (i *jsiiProxy_IThreatEntitySetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IThreatEntitySetRef) Env() *interfaces.ResourceEnvironment {
