...
func (i *jsiiProxy_ITrustedEntitySetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITrustedEntitySetRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ITrustedEntitySetRef) Node() constructs.Node {
