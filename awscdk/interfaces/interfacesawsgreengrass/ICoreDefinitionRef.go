...
func (i *jsiiProxy_ICoreDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICoreDefinitionRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ICoreDefinitionRef) Node() constructs.Node {
