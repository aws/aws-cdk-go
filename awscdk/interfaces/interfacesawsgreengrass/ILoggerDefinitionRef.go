...
func (i *jsiiProxy_ILoggerDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ILoggerDefinitionRef) Env() *interfaces.ResourceEnvironment {
