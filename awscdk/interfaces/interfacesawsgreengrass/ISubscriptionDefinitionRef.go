...
func (i *jsiiProxy_ISubscriptionDefinitionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISubscriptionDefinitionRef) Env() *interfaces.ResourceEnvironment {
