...
func (i *jsiiProxy_ITablePolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITablePolicyRef) Env() *interfaces.ResourceEnvironment {
