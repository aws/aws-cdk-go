...
func (i *jsiiProxy_IChannelGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IChannelGroupRef) Env() *interfaces.ResourceEnvironment {
