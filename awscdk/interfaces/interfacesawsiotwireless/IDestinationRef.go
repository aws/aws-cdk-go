...
func (i *jsiiProxy_IDestinationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDestinationRef) Env() *interfaces.ResourceEnvironment {
