...
func (i *jsiiProxy_INetworkAnalyzerConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INetworkAnalyzerConfigurationRef) Env() *interfaces.ResourceEnvironment {
