...
func (i *jsiiProxy_IPartnerAccountRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPartnerAccountRef) Env() *interfaces.ResourceEnvironment {
