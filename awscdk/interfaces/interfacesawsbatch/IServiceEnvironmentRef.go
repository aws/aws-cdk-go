...
func (i *jsiiProxy_IServiceEnvironmentRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IServiceEnvironmentRef) Env() *interfaces.ResourceEnvironment {
