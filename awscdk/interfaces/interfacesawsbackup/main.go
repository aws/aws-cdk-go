...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_backup.ILegalHoldRef",
		reflect.TypeOf((*ILegalHoldRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_backup.LegalHoldReference",
		reflect.TypeOf((*LegalHoldReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
