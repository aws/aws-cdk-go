...
func (i *jsiiProxy_IRestoreTestingSelectionRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRestoreTestingSelectionRef) Env() *interfaces.ResourceEnvironment {
