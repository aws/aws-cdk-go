...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawscodeconnections/internal"
...
func (i *jsiiProxy_IHostRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IHostRef) Env() *interfaces.ResourceEnvironment {
