...
func (i *jsiiProxy_ITrackerConsumerRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITrackerConsumerRef) Env() *interfaces.ResourceEnvironment {
