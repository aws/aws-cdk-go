...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_devicefarm.IUploadRef",
		reflect.TypeOf((*IUploadRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_devicefarm.UploadReference",
		reflect.TypeOf((*UploadReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
