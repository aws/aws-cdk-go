...
func (i *jsiiProxy_IResourceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResourceRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IResourceRef) Node() constructs.Node {
