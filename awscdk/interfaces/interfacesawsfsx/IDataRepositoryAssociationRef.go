...
func (i *jsiiProxy_IDataRepositoryAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDataRepositoryAssociationRef) Env() *interfaces.ResourceEnvironment {
