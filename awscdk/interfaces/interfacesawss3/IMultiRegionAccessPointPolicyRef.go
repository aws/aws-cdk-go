...
func (i *jsiiProxy_IMultiRegionAccessPointPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMultiRegionAccessPointPolicyRef) Env() *interfaces.ResourceEnvironment {
