...
func (i *jsiiProxy_IAccessGrantRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAccessGrantRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IAccessGrantRef) Node() constructs.Node {
