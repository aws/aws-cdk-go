...
func (i *jsiiProxy_ICustomPermissionsRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomPermissionsRef) Env() *interfaces.ResourceEnvironment {
