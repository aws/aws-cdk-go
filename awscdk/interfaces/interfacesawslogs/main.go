...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_logs.IStorageTierPolicyRef",
		reflect.TypeOf((*IStorageTierPolicyRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
		...
		func() interface{} {
			j := jsiiProxy_IStorageTierPolicyRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_logs.StorageTierPolicyReference",
		reflect.TypeOf((*StorageTierPolicyReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
