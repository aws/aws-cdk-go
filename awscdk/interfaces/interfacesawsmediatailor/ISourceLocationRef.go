...
func (i *jsiiProxy_ISourceLocationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISourceLocationRef) Env() *interfaces.ResourceEnvironment {
