...
func (i *jsiiProxy_IGroupPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IGroupPolicyRef) Env() *interfaces.ResourceEnvironment {
