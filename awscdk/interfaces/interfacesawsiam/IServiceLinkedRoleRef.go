...
func (i *jsiiProxy_IServiceLinkedRoleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IServiceLinkedRoleRef) Env() *interfaces.ResourceEnvironment {
