...
func (i *jsiiProxy_IRoleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRoleRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IRoleRef) Node() constructs.Node {
