...
func (i *jsiiProxy_IAccessKeyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAccessKeyRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IAccessKeyRef) Node() constructs.Node {
