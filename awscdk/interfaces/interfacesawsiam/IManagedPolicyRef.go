...
func (i *jsiiProxy_IManagedPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IManagedPolicyRef) Env() *interfaces.ResourceEnvironment {
