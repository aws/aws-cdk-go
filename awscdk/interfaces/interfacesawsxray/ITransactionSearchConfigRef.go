...
func (i *jsiiProxy_ITransactionSearchConfigRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITransactionSearchConfigRef) Env() *interfaces.ResourceEnvironment {
