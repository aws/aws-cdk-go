...
func (i *jsiiProxy_IDataCellsFilterRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IDataCellsFilterRef) Env() *interfaces.ResourceEnvironment {
