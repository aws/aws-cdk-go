...
func (i *jsiiProxy_IScheduleGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IScheduleGroupRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IScheduleGroupRef) Node() constructs.Node {
