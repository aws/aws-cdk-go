...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsscheduler/internal"
...
func (i *jsiiProxy_IScheduleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IScheduleRef) Env() *interfaces.ResourceEnvironment {
