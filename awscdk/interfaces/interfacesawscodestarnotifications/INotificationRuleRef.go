...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawscodestarnotifications/internal"
...
func (i *jsiiProxy_INotificationRuleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_INotificationRuleRef) Env() *interfaces.ResourceEnvironment {
