...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawscodecommit/internal"
...
func (i *jsiiProxy_IRepositoryRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRepositoryRef) Env() *interfaces.ResourceEnvironment {
