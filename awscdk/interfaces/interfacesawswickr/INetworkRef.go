...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawswickr/internal"
...
func (i *jsiiProxy_INetworkRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
