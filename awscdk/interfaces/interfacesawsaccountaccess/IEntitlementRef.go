...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsaccountaccess/internal"
...
func (i *jsiiProxy_IEntitlementRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
