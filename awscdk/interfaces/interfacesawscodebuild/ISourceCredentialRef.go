...
func (i *jsiiProxy_ISourceCredentialRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISourceCredentialRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ISourceCredentialRef) Node() constructs.Node {
