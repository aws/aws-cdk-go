...
func (i *jsiiProxy_ITopicRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITopicRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ITopicRef) Node() constructs.Node {
