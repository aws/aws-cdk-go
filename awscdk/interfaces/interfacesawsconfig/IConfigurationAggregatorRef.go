...
func (i *jsiiProxy_IConfigurationAggregatorRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IConfigurationAggregatorRef) Env() *interfaces.ResourceEnvironment {
