...
func (i *jsiiProxy_IApplicationInferenceProfileRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IApplicationInferenceProfileRef) Env() *interfaces.ResourceEnvironment {
