...
func (i *jsiiProxy_IPromptRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPromptRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IPromptRef) Node() constructs.Node {
