...
func (i *jsiiProxy_IPullThroughCacheRuleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IPullThroughCacheRuleRef) Env() *interfaces.ResourceEnvironment {
