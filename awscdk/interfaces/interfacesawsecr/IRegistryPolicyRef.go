...
func (i *jsiiProxy_IRegistryPolicyRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRegistryPolicyRef) Env() *interfaces.ResourceEnvironment {
