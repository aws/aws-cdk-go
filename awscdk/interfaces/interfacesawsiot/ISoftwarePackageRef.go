...
func (i *jsiiProxy_ISoftwarePackageRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISoftwarePackageRef) Env() *interfaces.ResourceEnvironment {
