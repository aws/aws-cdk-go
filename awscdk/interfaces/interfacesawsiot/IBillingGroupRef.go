...
func (i *jsiiProxy_IBillingGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBillingGroupRef) Env() *interfaces.ResourceEnvironment {
