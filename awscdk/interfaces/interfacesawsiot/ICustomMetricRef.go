...
func (i *jsiiProxy_ICustomMetricRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomMetricRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ICustomMetricRef) Node() constructs.Node {
