...
func (i *jsiiProxy_IResourceSpecificLoggingRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IResourceSpecificLoggingRef) Env() *interfaces.ResourceEnvironment {
