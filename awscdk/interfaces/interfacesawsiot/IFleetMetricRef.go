...
func (i *jsiiProxy_IFleetMetricRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IFleetMetricRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IFleetMetricRef) Node() constructs.Node {
