...
func (i *jsiiProxy_IJobTemplateRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IJobTemplateRef) Env() *interfaces.ResourceEnvironment {
