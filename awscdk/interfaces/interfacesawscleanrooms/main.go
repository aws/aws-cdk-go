...
func init() {
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_cleanrooms.IIntermediateTableRef",
		reflect.TypeOf((*IIntermediateTableRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
		...
		func() interface{} {
			j := jsiiProxy_IIntermediateTableRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_cleanrooms.IntermediateTableReference",
		reflect.TypeOf((*IntermediateTableReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
