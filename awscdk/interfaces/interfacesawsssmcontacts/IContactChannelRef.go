...
func (i *jsiiProxy_IContactChannelRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IContactChannelRef) Env() *interfaces.ResourceEnvironment {
