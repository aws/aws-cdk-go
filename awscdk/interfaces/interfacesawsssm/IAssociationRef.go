...
func (i *jsiiProxy_IAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IAssociationRef) Env() *interfaces.ResourceEnvironment {
