...
func (i *jsiiProxy_ICompositeAlarmRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICompositeAlarmRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ICompositeAlarmRef) Node() constructs.Node {
