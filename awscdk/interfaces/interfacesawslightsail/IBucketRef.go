...
func (i *jsiiProxy_IBucketRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBucketRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IBucketRef) Node() constructs.Node {
