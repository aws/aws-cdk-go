...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_lightsail.ContactMethodReference",
		reflect.TypeOf((*ContactMethodReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_lightsail.IContactMethodRef",
		reflect.TypeOf((*IContactMethodRef)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "contactMethodRef", GoGetter: "ContactMethodRef"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "with", GoMethod: "With"},
		},
		func() interface{} {
			j := jsiiProxy_IContactMethodRef{}
			_jsii_.InitJsiiProxy(&j.Type__constructsIConstruct)
			_jsii_.InitJsiiProxy(&j.Type__interfacesIEnvironmentAware)
			return &j
		},
