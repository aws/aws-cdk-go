...
func (i *jsiiProxy_IRateBasedRuleRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRateBasedRuleRef) Env() *interfaces.ResourceEnvironment {
