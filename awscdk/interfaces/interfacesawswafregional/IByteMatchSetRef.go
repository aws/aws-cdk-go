...
func (i *jsiiProxy_IByteMatchSetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IByteMatchSetRef) Env() *interfaces.ResourceEnvironment {
