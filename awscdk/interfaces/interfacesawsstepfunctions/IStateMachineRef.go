...
func (i *jsiiProxy_IStateMachineRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IStateMachineRef) Env() *interfaces.ResourceEnvironment {
