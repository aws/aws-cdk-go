...
func (i *jsiiProxy_ISqlInjectionMatchSetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ISqlInjectionMatchSetRef) Env() *interfaces.ResourceEnvironment {
