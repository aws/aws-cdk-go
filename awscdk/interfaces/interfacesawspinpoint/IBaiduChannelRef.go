...
func (i *jsiiProxy_IBaiduChannelRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBaiduChannelRef) Env() *interfaces.ResourceEnvironment {
