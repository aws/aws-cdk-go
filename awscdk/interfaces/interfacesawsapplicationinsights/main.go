package interfacesawsapplicationinsights
...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.interfaces.aws_applicationinsights.ApplicationReference",
		reflect.TypeOf((*ApplicationReference)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"aws-cdk-lib.interfaces.aws_applicationinsights.IApplicationRef",
