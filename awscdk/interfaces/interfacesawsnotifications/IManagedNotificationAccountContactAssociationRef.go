...
func (i *jsiiProxy_IManagedNotificationAccountContactAssociationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IManagedNotificationAccountContactAssociationRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IManagedNotificationAccountContactAssociationRef) Node() constructs.Node {
