...
func (i *jsiiProxy_IMatchmakingConfigurationRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMatchmakingConfigurationRef) Env() *interfaces.ResourceEnvironment {
