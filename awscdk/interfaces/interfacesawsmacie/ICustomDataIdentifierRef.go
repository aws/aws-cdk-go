...
func (i *jsiiProxy_ICustomDataIdentifierRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ICustomDataIdentifierRef) Env() *interfaces.ResourceEnvironment {
