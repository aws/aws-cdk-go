...
func (i *jsiiProxy_IRecordSetGroupRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IRecordSetGroupRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IRecordSetGroupRef) Node() constructs.Node {
