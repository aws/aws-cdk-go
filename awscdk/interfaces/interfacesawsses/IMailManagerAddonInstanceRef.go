...
func (i *jsiiProxy_IMailManagerAddonInstanceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMailManagerAddonInstanceRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IMailManagerAddonInstanceRef) Node() constructs.Node {
