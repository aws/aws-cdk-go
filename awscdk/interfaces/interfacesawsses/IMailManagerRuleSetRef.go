...
func (i *jsiiProxy_IMailManagerRuleSetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMailManagerRuleSetRef) Env() *interfaces.ResourceEnvironment {
