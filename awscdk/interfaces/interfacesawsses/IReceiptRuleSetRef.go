...
func (i *jsiiProxy_IReceiptRuleSetRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IReceiptRuleSetRef) Env() *interfaces.ResourceEnvironment {
