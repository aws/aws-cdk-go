...
func (i *jsiiProxy_IMailManagerIngressPointRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMailManagerIngressPointRef) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IMailManagerIngressPointRef) Node() constructs.Node {
