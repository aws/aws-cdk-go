...
func (i *jsiiProxy_IMailManagerAddressListRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMailManagerAddressListRef) Env() *interfaces.ResourceEnvironment {
