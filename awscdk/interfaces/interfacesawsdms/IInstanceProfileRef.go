...
func (i *jsiiProxy_IInstanceProfileRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IInstanceProfileRef) Env() *interfaces.ResourceEnvironment {
