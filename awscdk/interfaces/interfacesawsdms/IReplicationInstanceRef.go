...
func (i *jsiiProxy_IReplicationInstanceRef) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IReplicationInstanceRef) Env() *interfaces.ResourceEnvironment {
