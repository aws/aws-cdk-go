...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsoutposts/internal"
...
//
//   cfnSite := awscdk.Aws_outposts.NewCfnSite(this, jsii.String("MyCfnSite"), &CfnSiteProps{
...
type CfnSite interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsoutposts.ISiteRef
	awscdk.ITaggableV2
	AttrSiteArn() *string
	AttrSiteId() *string
	...
	Notes() *string
	SetNotes(val *string)
	OperatingAddress() interface{}
	SetOperatingAddress(val interface{})
	RackPhysicalProperties() interface{}
	SetRackPhysicalProperties(val interface{})
	...
	SetShippingAddress(val interface{})
	// A reference to a Site resource.
	SiteRef() *interfacesawsoutposts.SiteReference
...
type jsiiProxy_CfnSite struct {
	...
	internal.Type__interfacesawsoutpostsISiteRef
...
func (j *jsiiProxy_CfnSite) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnSite) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnSite) Notes() *string {
	var returns *string
	_jsii_.Get(
		j,
		"notes",
...
func (j *jsiiProxy_CfnSite) OperatingAddress() interface{} {
...
func (j *jsiiProxy_CfnSite) RackPhysicalProperties() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSite) ShippingAddress() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"shippingAddress",
...
func (j *jsiiProxy_CfnSite) SiteRef() *interfacesawsoutposts.SiteReference {
	var returns *interfacesawsoutposts.SiteReference
	_jsii_.Get(
		j,
		"siteRef",
		&returns,
...
func (j *jsiiProxy_CfnSite) Tags() *[]*awscdk.CfnTag {
...
func NewCfnSite(scope constructs.Construct, id *string, props *CfnSiteProps) CfnSite {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_outposts.CfnSite",
...
func (j *jsiiProxy_CfnSite)SetName(val *string) {
...
func (j *jsiiProxy_CfnSite)SetNotes(val *string) {
	_jsii_.Set(
		j,
		"notes",
		val,
...
func (j *jsiiProxy_CfnSite)SetOperatingAddress(val interface{}) {
	if err := j.validateSetOperatingAddressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSite)SetRackPhysicalProperties(val interface{}) {
	if err := j.validateSetRackPhysicalPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSite)SetShippingAddress(val interface{}) {
	if err := j.validateSetShippingAddressParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSite)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnSite_ArnForSite(resource interfacesawsoutposts.ISiteRef) *string {
	_init_.Initialize()
