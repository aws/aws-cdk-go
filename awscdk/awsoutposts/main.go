...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsoutpostsISiteRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_outposts.CfnSite.AddressProperty",
		reflect.TypeOf((*CfnSite_AddressProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_outposts.CfnSite.RackPhysicalPropertiesProperty",
		reflect.TypeOf((*CfnSite_RackPhysicalPropertiesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_outposts.CfnSiteProps",
