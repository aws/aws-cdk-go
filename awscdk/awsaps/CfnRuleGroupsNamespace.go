...
func (j *jsiiProxy_CfnRuleGroupsNamespace) CfnPropertyNames() *map[string]*string {
...
func NewCfnRuleGroupsNamespace(scope constructs.Construct, id *string, props *CfnRuleGroupsNamespaceProps) CfnRuleGroupsNamespace {
	...
	if err := validateNewCfnRuleGroupsNamespaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRuleGroupsNamespace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRuleGroupsNamespace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleGroupsNamespace_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRuleGroupsNamespace_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleGroupsNamespace_IsCfnRuleGroupsNamespace(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRuleGroupsNamespace_IsCfnRuleGroupsNamespaceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleGroupsNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRuleGroupsNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleGroupsNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
