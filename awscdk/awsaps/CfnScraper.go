...
func (j *jsiiProxy_CfnScraper) Alias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"alias",
...
func (j *jsiiProxy_CfnScraper) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnScraper) AttrRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRoleArn",
...
func (j *jsiiProxy_CfnScraper) AttrScraperId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrScraperId",
...
func (j *jsiiProxy_CfnScraper) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnScraper) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnScraper) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnScraper) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScraper) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnScraper) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnScraper) Destination() interface{} {
...
func (j *jsiiProxy_CfnScraper) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnScraper) Node() constructs.Node {
...
func (j *jsiiProxy_CfnScraper) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnScraper) Source() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_CfnScraper) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnScraper) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnScraper) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnScraper) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnScraper(scope constructs.Construct, id *string, props *CfnScraperProps) CfnScraper {
	...
	if err := validateNewCfnScraperParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnScraper)SetAlias(val *string) {
	_jsii_.Set(
		j,
		"alias",
		val,
...
func (j *jsiiProxy_CfnScraper)SetDestination(val interface{}) {
...
func (j *jsiiProxy_CfnScraper)SetScrapeConfiguration(val interface{}) {
	if err := j.validateSetScrapeConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnScraper)SetSource(val interface{}) {
...
func (j *jsiiProxy_CfnScraper)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnScraper_ArnForScraper(resource interfacesawsaps.IScraperRef) *string {
	_init_.Initialize()

	if err := validateCfnScraper_ArnForScraperParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnScraper_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnScraper_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScraper_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnScraper_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScraper_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnScraper_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScraper) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnScraper) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScraper) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScraper) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnScraper) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnScraper) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnScraper) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnScraper) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScraper) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScraper) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnScraper) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScraper) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScraper) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnScraper) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnScraper) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScraper) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnScraper) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScraper) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScraper) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnScraper) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScraper) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnScraper) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnScraper) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnScraper) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
