...
func (j *jsiiProxy_CfnAnomalyDetector) Alias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"alias",
...
func (j *jsiiProxy_CfnAnomalyDetector) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAnomalyDetector) EvaluationIntervalInSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAnomalyDetector) Labels() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"labels",
...
func (j *jsiiProxy_CfnAnomalyDetector) MissingDataAction() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"missingDataAction",
...
func (j *jsiiProxy_CfnAnomalyDetector) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAnomalyDetector) Workspace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspace",
...
func (j *jsiiProxy_CfnAnomalyDetector)SetAlias(val *string) {
...
func (j *jsiiProxy_CfnAnomalyDetector)SetEvaluationIntervalInSeconds(val *float64) {
	_jsii_.Set(
		j,
		"evaluationIntervalInSeconds",
		val,
...
func (j *jsiiProxy_CfnAnomalyDetector)SetLabels(val interface{}) {
...
func (j *jsiiProxy_CfnAnomalyDetector)SetMissingDataAction(val interface{}) {
	if err := j.validateSetMissingDataActionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAnomalyDetector)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnAnomalyDetector)SetWorkspace(val *string) {
...
func CfnAnomalyDetector_ArnForAnomalyDetector(resource interfacesawsaps.IAnomalyDetectorRef) *string {
	_init_.Initialize()
