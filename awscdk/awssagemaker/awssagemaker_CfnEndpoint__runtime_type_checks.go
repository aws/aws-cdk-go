...
func (j *jsiiProxy_CfnEndpoint) validateSetDeploymentConfigParameters(val interface{}) error {
	switch val.(type) {
	case *CfnEndpoint_DeploymentConfigProperty:
		val := val.(*CfnEndpoint_DeploymentConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnEndpoint_DeploymentConfigProperty:
		val_ := val.(CfnEndpoint_DeploymentConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnEndpoint_DeploymentConfigProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnEndpoint) validateSetEndpointConfigNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnEndpoint) validateSetExcludeRetainedVariantPropertiesParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			switch v.(type) {
			case *CfnEndpoint_VariantPropertyProperty:
				v := v.(*CfnEndpoint_VariantPropertyProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnEndpoint_VariantPropertyProperty:
				v_ := v.(CfnEndpoint_VariantPropertyProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: *CfnEndpoint_VariantPropertyProperty, awscdk.IResolvable; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnEndpoint) validateSetRetainAllVariantPropertiesParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnEndpoint) validateSetRetainDeploymentConfigParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
