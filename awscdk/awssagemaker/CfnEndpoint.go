...
func (j *jsiiProxy_CfnEndpoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEndpoint)SetDeploymentConfig(val interface{}) {
	if err := j.validateSetDeploymentConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnEndpoint)SetExcludeRetainedVariantProperties(val interface{}) {
	if err := j.validateSetExcludeRetainedVariantPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEndpoint_ArnForEndpoint(resource interfacesawssagemaker.IEndpointRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
