...
func (j *jsiiProxy_CfnEndpointConfig) CfnPropertyNames() *map[string]*string {
...
func CfnEndpointConfig_ArnForEndpointConfig(resource interfacesawssagemaker.IEndpointConfigRef) *string {
	_init_.Initialize()

	if err := validateCfnEndpointConfig_ArnForEndpointConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEndpointConfig_IsCfnEndpointConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEndpointConfig_IsCfnEndpointConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEndpointConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEndpointConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEndpointConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEndpointConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
