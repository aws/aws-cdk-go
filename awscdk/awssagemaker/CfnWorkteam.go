...
func (j *jsiiProxy_CfnWorkteam) CfnPropertyNames() *map[string]*string {
...
func CfnWorkteam_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWorkteam_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWorkteam) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWorkteam) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWorkteam) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWorkteam) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkteam) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
