...
func (j *jsiiProxy_CfnAppImageConfig) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAppImageConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAppImageConfig(scope constructs.Construct, id *string, props *CfnAppImageConfigProps) CfnAppImageConfig {
	...
	if err := validateNewCfnAppImageConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAppImageConfig)SetKernelGatewayImageConfig(val interface{}) {
	if err := j.validateSetKernelGatewayImageConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAppImageConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAppImageConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppImageConfig_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAppImageConfig_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppImageConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAppImageConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAppImageConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppImageConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAppImageConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAppImageConfig) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnAppImageConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppImageConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
