...
//
//   cfnExperiment := awscdk.Aws_sagemaker.NewCfnExperiment(this, jsii.String("MyCfnExperiment"), &CfnExperimentProps{
...
type CfnExperiment interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssagemaker.IExperimentRef
	awscdk.ITaggableV2
	...
	ExperimentRef() *interfacesawssagemaker.ExperimentReference
	...
	Tags() *[]*CfnExperiment_TagsItemsProperty
	SetTags(val *[]*CfnExperiment_TagsItemsProperty)
	// Deprecated.
...
type jsiiProxy_CfnExperiment struct {
	...
	internal.Type__interfacesawssagemakerIExperimentRef
...
func (j *jsiiProxy_CfnExperiment) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnExperiment) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnExperiment) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnExperiment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnExperiment) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnExperiment) ExperimentName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"experimentName",
...
func (j *jsiiProxy_CfnExperiment) ExperimentRef() *interfacesawssagemaker.ExperimentReference {
	var returns *interfacesawssagemaker.ExperimentReference
	_jsii_.Get(
		j,
		"experimentRef",
		&returns,
...
func (j *jsiiProxy_CfnExperiment) Tags() *[]*CfnExperiment_TagsItemsProperty {
	var returns *[]*CfnExperiment_TagsItemsProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func NewCfnExperiment(scope constructs.Construct, id *string, props *CfnExperimentProps) CfnExperiment {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_sagemaker.CfnExperiment",
...
func (j *jsiiProxy_CfnExperiment)SetDisplayName(val *string) {
	_jsii_.Set(
		j,
		"displayName",
		val,
...
func (j *jsiiProxy_CfnExperiment)SetExperimentName(val *string) {
...
func (j *jsiiProxy_CfnExperiment)SetTags(val *[]*CfnExperiment_TagsItemsProperty) {
...
func CfnExperiment_ArnForExperiment(resource interfacesawssagemaker.IExperimentRef) *string {
	_init_.Initialize()

	if err := validateCfnExperiment_ArnForExperimentParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnExperiment_IsCfnExperiment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnExperiment_IsCfnExperimentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnExperiment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnExperiment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnExperiment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnExperiment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnExperiment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnExperiment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnExperiment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
