...
func (j *jsiiProxy_CfnModelPackageGroup) CfnPropertyNames() *map[string]*string {
...
func CfnModelPackageGroup_IsCfnModelPackageGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnModelPackageGroup_IsCfnModelPackageGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelPackageGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnModelPackageGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModelPackageGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelPackageGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelPackageGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelPackageGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelPackageGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
