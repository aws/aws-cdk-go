...
type CfnCluster interface {
	...
	SetNodeProvisioningMode(val *string)
...
func (j *jsiiProxy_CfnCluster) NodeProvisioningMode() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCluster)SetNodeProvisioningMode(val *string) {
	_jsii_.Set(
		j,
		"nodeProvisioningMode",
		val,
...
func CfnCluster_ArnForCluster(resource interfacesawssagemaker.IClusterRef) *string {
	_init_.Initialize()
