...
type CfnModelQualityJobDefinition interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssagemaker.IModelQualityJobDefinitionRef
	awscdk.ITaggable
	...
	ModelQualityJobDefinitionRef() *interfacesawssagemaker.ModelQualityJobDefinitionReference
...
type jsiiProxy_CfnModelQualityJobDefinition struct {
	...
	internal.Type__interfacesawssagemakerIModelQualityJobDefinitionRef
...
func (j *jsiiProxy_CfnModelQualityJobDefinition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnModelQualityJobDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnModelQualityJobDefinition) ModelQualityJobDefinitionRef() *interfacesawssagemaker.ModelQualityJobDefinitionReference {
	var returns *interfacesawssagemaker.ModelQualityJobDefinitionReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnModelQualityJobDefinition) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnModelQualityJobDefinition)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnModelQualityJobDefinition_IsCfnModelQualityJobDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnModelQualityJobDefinition_IsCfnModelQualityJobDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_sagemaker.CfnModelQualityJobDefinition",
		"isCfnModelQualityJobDefinition",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnModelQualityJobDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelQualityJobDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelQualityJobDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelQualityJobDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelQualityJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
