...
func (j *jsiiProxy_CfnDeviceFleet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDeviceFleet) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDeviceFleet) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDeviceFleet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDeviceFleet(scope constructs.Construct, id *string, props *CfnDeviceFleetProps) CfnDeviceFleet {
	...
	if err := validateNewCfnDeviceFleetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDeviceFleet)SetOutputConfig(val interface{}) {
	if err := j.validateSetOutputConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDeviceFleet)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnDeviceFleet_IsCfnDeviceFleet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeviceFleet_IsCfnDeviceFleetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceFleet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeviceFleet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceFleet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeviceFleet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceFleet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeviceFleet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeviceFleet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceFleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeviceFleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeviceFleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeviceFleet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeviceFleet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeviceFleet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceFleet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceFleet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
