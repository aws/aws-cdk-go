...
//
type CfnInferenceComponent_InferenceComponentSchedulingConfigProperty struct {
	...
	//
	AvailabilityZoneBalance interface{} `field:"required" json:"availabilityZoneBalance" yaml:"availabilityZoneBalance"`
	...
	//
	PlacementStrategy *string `field:"required" json:"placementStrategy" yaml:"placementStrategy"`
}
