...
func (j *jsiiProxy_CfnModelPackageGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnModelPackageGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnModelPackageGroup(scope constructs.Construct, id *string, props *CfnModelPackageGroupProps) CfnModelPackageGroup {
	...
	if err := validateNewCfnModelPackageGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnModelPackageGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnModelPackageGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelPackageGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnModelPackageGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelPackageGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnModelPackageGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModelPackageGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelPackageGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnModelPackageGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnModelPackageGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnModelPackageGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelPackageGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
