...
func (j *jsiiProxy_CfnModelExplainabilityJobDefinition) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
