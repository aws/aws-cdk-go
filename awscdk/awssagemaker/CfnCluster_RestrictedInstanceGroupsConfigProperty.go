...
//
type CfnCluster_RestrictedInstanceGroupsConfigProperty struct {
	...
	//
	SharedEnvironmentConfig interface{} `field:"required" json:"sharedEnvironmentConfig" yaml:"sharedEnvironmentConfig"`
}
