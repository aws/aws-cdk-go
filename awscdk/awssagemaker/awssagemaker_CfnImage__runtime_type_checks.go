...
func (c *jsiiProxy_CfnImage) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_CfnImage) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateCfnImage_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnImage) validateSetImageNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnImage) validateSetImageRoleArnParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCfnImageParameters(scope awscdk.Construct, id *string, props *CfnImageProps) error {
	if scope == nil {
