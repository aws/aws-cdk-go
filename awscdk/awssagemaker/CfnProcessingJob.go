...
func (j *jsiiProxy_CfnProcessingJob) CfnPropertyNames() *map[string]*string {
...
func CfnProcessingJob_ArnForProcessingJob(resource interfacesawssagemaker.IProcessingJobRef) *string {
	_init_.Initialize()

	if err := validateCfnProcessingJob_ArnForProcessingJobParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnProcessingJob) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProcessingJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProcessingJob) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProcessingJob) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProcessingJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
