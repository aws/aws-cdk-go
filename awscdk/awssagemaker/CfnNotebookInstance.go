...
func (j *jsiiProxy_CfnNotebookInstance) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnNotebookInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNotebookInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNotebookInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNotebookInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotebookInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
