...
func (j *jsiiProxy_CfnDomain) validateSetAuthModeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDomain) validateSetDefaultUserSettingsParameters(val interface{}) error {
	...
	case CfnDomain_UserSettingsProperty:
		val_ := val.(CfnDomain_UserSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDomain) validateSetDomainSettingsParameters(val interface{}) error {
	...
	case CfnDomain_DomainSettingsProperty:
		val_ := val.(CfnDomain_DomainSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDomain) validateSetSubnetIdsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
