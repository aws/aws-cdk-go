...
func (j *jsiiProxy_CfnStudioLifecycleConfig) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnStudioLifecycleConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStudioLifecycleConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStudioLifecycleConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStudioLifecycleConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStudioLifecycleConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
