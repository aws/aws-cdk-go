...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawssagemaker.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetAutoScalingParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_ClusterAutoScalingConfigProperty:
		val := val.(*CfnCluster_ClusterAutoScalingConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_ClusterAutoScalingConfigProperty:
		val_ := val.(CfnCluster_ClusterAutoScalingConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_ClusterAutoScalingConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCluster) validateSetInstanceGroupsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnCluster_ClusterInstanceGroupProperty:
				v := v.(*CfnCluster_ClusterInstanceGroupProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnCluster_ClusterInstanceGroupProperty:
				v_ := v.(CfnCluster_ClusterInstanceGroupProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnCluster_ClusterInstanceGroupProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnCluster) validateSetOrchestratorParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_OrchestratorProperty:
		val := val.(*CfnCluster_OrchestratorProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_OrchestratorProperty:
		val_ := val.(CfnCluster_OrchestratorProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_OrchestratorProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCluster) validateSetRestrictedInstanceGroupsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnCluster_ClusterRestrictedInstanceGroupProperty:
				v := v.(*CfnCluster_ClusterRestrictedInstanceGroupProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnCluster_ClusterRestrictedInstanceGroupProperty:
				v_ := v.(CfnCluster_ClusterRestrictedInstanceGroupProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnCluster_ClusterRestrictedInstanceGroupProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnCluster) validateSetVpcConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_VpcConfigProperty:
		val := val.(*CfnCluster_VpcConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_VpcConfigProperty:
		val_ := val.(CfnCluster_VpcConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_VpcConfigProperty; received %#v (a %T)", val, val)
		}
	}
