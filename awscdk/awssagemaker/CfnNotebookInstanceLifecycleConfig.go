...
func (j *jsiiProxy_CfnNotebookInstanceLifecycleConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNotebookInstanceLifecycleConfig) Node() constructs.Node {
...
func (j *jsiiProxy_CfnNotebookInstanceLifecycleConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNotebookInstanceLifecycleConfig(scope constructs.Construct, id *string, props *CfnNotebookInstanceLifecycleConfigProps) CfnNotebookInstanceLifecycleConfig {
	...
	if err := validateNewCfnNotebookInstanceLifecycleConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNotebookInstanceLifecycleConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNotebookInstanceLifecycleConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotebookInstanceLifecycleConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNotebookInstanceLifecycleConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotebookInstanceLifecycleConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNotebookInstanceLifecycleConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
