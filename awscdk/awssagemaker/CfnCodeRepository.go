...
func (j *jsiiProxy_CfnCodeRepository) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCodeRepository) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCodeRepository) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCodeRepository(scope constructs.Construct, id *string, props *CfnCodeRepositoryProps) CfnCodeRepository {
	...
	if err := validateNewCfnCodeRepositoryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCodeRepository)SetGitConfig(val interface{}) {
	if err := j.validateSetGitConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCodeRepository_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCodeRepository_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCodeRepository_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCodeRepository_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCodeRepository_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCodeRepository_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCodeRepository) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeRepository) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCodeRepository) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCodeRepository) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCodeRepository) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCodeRepository) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCodeRepository) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeRepository) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeRepository) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCodeRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
