...
func (j *jsiiProxy_CfnAppImageConfig) CfnPropertyNames() *map[string]*string {
...
func CfnAppImageConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAppImageConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAppImageConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAppImageConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAppImageConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAppImageConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppImageConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
