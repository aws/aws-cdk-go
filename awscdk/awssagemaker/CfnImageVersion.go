...
func (j *jsiiProxy_CfnImageVersion) CfnPropertyNames() *map[string]*string {
...
func CfnImageVersion_ArnForImageVersion(resource interfacesawssagemaker.IImageVersionRef) *string {
	_init_.Initialize()

	if err := validateCfnImageVersion_ArnForImageVersionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnImageVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnImageVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnImageVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnImageVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImageVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
