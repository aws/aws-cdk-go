...
func (j *jsiiProxy_CfnInferenceExperiment) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInferenceExperiment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInferenceExperiment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInferenceExperiment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInferenceExperiment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceExperiment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
