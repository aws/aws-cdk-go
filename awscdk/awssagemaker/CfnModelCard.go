...
func (j *jsiiProxy_CfnModelCard) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnModelCard) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelCard) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelCard) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelCard) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelCard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
