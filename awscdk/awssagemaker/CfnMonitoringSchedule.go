...
func (j *jsiiProxy_CfnMonitoringSchedule) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnMonitoringSchedule.
func CfnMonitoringSchedule_IsCfnMonitoringSchedule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMonitoringSchedule_IsCfnMonitoringScheduleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMonitoringSchedule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMonitoringSchedule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMonitoringSchedule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMonitoringSchedule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMonitoringSchedule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMonitoringSchedule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitoringSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
