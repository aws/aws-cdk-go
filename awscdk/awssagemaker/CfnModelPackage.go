...
func (j *jsiiProxy_CfnModelPackage) CfnPropertyNames() *map[string]*string {
...
func CfnModelPackage_ArnForModelPackage(resource interfacesawssagemaker.IModelPackageRef) *string {
	_init_.Initialize()

	if err := validateCfnModelPackage_ArnForModelPackageParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnModelPackage.
func CfnModelPackage_IsCfnModelPackage(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnModelPackage_IsCfnModelPackageParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModelPackage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelPackage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelPackage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelPackage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelPackage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
