...
func (j *jsiiProxy_CfnUserProfile) CfnPropertyNames() *map[string]*string {
...
func CfnUserProfile_IsCfnUserProfile(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserProfile_IsCfnUserProfileParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
