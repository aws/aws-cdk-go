...
func (j *jsiiProxy_CfnFeatureGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnFeatureGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFeatureGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFeatureGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFeatureGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFeatureGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
