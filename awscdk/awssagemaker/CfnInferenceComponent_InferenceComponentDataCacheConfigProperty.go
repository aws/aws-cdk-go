...
//
type CfnInferenceComponent_InferenceComponentDataCacheConfigProperty struct {
	...
	//
	EnableCaching interface{} `field:"required" json:"enableCaching" yaml:"enableCaching"`
}
