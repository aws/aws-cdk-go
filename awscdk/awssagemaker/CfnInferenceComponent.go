...
func (j *jsiiProxy_CfnInferenceComponent) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnInferenceComponent) DeploymentConfig() interface{} {
...
func (j *jsiiProxy_CfnInferenceComponent)SetDeploymentConfig(val interface{}) {
...
func CfnInferenceComponent_ArnForInferenceComponent(resource interfacesawssagemaker.IInferenceComponentRef) *string {
	_init_.Initialize()

	if err := validateCfnInferenceComponent_ArnForInferenceComponentParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnInferenceComponent_IsCfnInferenceComponent(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnInferenceComponent_IsCfnInferenceComponentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInferenceComponent) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInferenceComponent) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInferenceComponent) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInferenceComponent) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInferenceComponent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
