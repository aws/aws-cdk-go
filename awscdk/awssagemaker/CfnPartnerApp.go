...
//
//   cfnPartnerApp := awscdk.Aws_sagemaker.NewCfnPartnerApp(this, jsii.String("MyCfnPartnerApp"), &CfnPartnerAppProps{
...
func (j *jsiiProxy_CfnPartnerApp) ApplicationConfig() interface{} {
...
func (j *jsiiProxy_CfnPartnerApp) AttrBaseUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrBaseUrl",
...
func (j *jsiiProxy_CfnPartnerApp) AuthType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authType",
...
func (j *jsiiProxy_CfnPartnerApp) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPartnerApp) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPartnerApp) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPartnerApp) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPartnerApp) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPartnerApp) ClientToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientToken",
...
func (j *jsiiProxy_CfnPartnerApp) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPartnerApp) EnableIamSessionBasedIdentity() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPartnerApp) ExecutionRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"executionRoleArn",
...
func (j *jsiiProxy_CfnPartnerApp) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnPartnerApp) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPartnerApp) MaintenanceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"maintenanceConfig",
...
func (j *jsiiProxy_CfnPartnerApp) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPartnerApp) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPartnerApp) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPartnerApp) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPartnerApp) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPartnerApp) Tier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tier",
...
func (j *jsiiProxy_CfnPartnerApp) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnPartnerApp) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnPartnerApp) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPartnerApp(scope constructs.Construct, id *string, props *CfnPartnerAppProps) CfnPartnerApp {
	...
	if err := validateNewCfnPartnerAppParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPartnerApp)SetApplicationConfig(val interface{}) {
...
func (j *jsiiProxy_CfnPartnerApp)SetClientToken(val *string) {
	_jsii_.Set(
		j,
		"clientToken",
		val,
...
func (j *jsiiProxy_CfnPartnerApp)SetEnableIamSessionBasedIdentity(val interface{}) {
	if err := j.validateSetEnableIamSessionBasedIdentityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPartnerApp)SetExecutionRoleArn(val *string) {
...
func (j *jsiiProxy_CfnPartnerApp)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnPartnerApp)SetMaintenanceConfig(val interface{}) {
	if err := j.validateSetMaintenanceConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPartnerApp)SetName(val *string) {
...
func (j *jsiiProxy_CfnPartnerApp)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnPartnerApp)SetTier(val *string) {
...
func (j *jsiiProxy_CfnPartnerApp)SetType(val *string) {
...
func CfnPartnerApp_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPartnerApp_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPartnerApp_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPartnerApp_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPartnerApp_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPartnerApp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPartnerApp_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_sagemaker.CfnPartnerApp",
...
func (c *jsiiProxy_CfnPartnerApp) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPartnerApp) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerApp) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerApp) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPartnerApp) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPartnerApp) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPartnerApp) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPartnerApp) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPartnerApp) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPartnerApp) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPartnerApp) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPartnerApp) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPartnerApp) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPartnerApp) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPartnerApp) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPartnerApp) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPartnerApp) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerApp) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerApp) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPartnerApp) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerApp) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPartnerApp) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPartnerApp) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPartnerApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
