...
type CfnProject interface {
	...
	TemplateProviderDetails() interface{}
	SetTemplateProviderDetails(val interface{})
	// Deprecated.
...
func (j *jsiiProxy_CfnProject) ServiceCatalogProvisionedProductDetails() interface{} {
...
func (j *jsiiProxy_CfnProject) TemplateProviderDetails() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnProject)SetServiceCatalogProvisionedProductDetails(val interface{}) {
	if err := j.validateSetServiceCatalogProvisionedProductDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnProject)SetTemplateProviderDetails(val interface{}) {
	if err := j.validateSetTemplateProviderDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
