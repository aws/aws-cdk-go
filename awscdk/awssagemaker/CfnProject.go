...
type CfnProject interface {
	...
	AttrServiceCatalogProvisionedProductDetailsProvisionedProductId() *string
	AttrServiceCatalogProvisionedProductDetailsProvisionedProductStatusMessage() *string
...
func (j *jsiiProxy_CfnProject) AttrServiceCatalogProvisionedProductDetailsProvisionedProductId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrServiceCatalogProvisionedProductDetailsProvisionedProductId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnProject) AttrServiceCatalogProvisionedProductDetailsProvisionedProductStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrServiceCatalogProvisionedProductDetailsProvisionedProductStatusMessage",
		&returns,
	)
	return returns
}
