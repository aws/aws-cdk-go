...
func (j *jsiiProxy_CfnWorkteam) Node() constructs.Node {
...
func (j *jsiiProxy_CfnWorkteam) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnWorkteam) WorkforceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workforceName",
...
func NewCfnWorkteam(scope constructs.Construct, id *string, props *CfnWorkteamProps) CfnWorkteam {
	...
	if err := validateNewCfnWorkteamParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnWorkteam)SetMemberDefinitions(val interface{}) {
	if err := j.validateSetMemberDefinitionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnWorkteam)SetWorkforceName(val *string) {
	_jsii_.Set(
		j,
		"workforceName",
		val,
...
func CfnWorkteam_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnWorkteam_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWorkteam_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnWorkteam_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWorkteam_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnWorkteam_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWorkteam) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkteam) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWorkteam) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWorkteam) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnWorkteam) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkteam) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
