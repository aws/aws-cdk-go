...
func (c *jsiiProxy_CfnPipeline) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func validateCfnPipeline_FromPipelineNameParameters(scope constructs.Construct, id *string, pipelineName *string) error {
	if scope == nil {
	...
	if pipelineName == nil {
		return fmt.Errorf("parameter pipelineName is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnPipeline) validateSetArtifactStoreParameters(val interface{}) error {
	...
	case CfnPipeline_ArtifactStoreProperty:
		val_ := val.(CfnPipeline_ArtifactStoreProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnPipeline) validateSetArtifactStoresParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnPipeline_ArtifactStoreMapProperty:
				v_ := v.(CfnPipeline_ArtifactStoreMapProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnPipeline) validateSetDisableInboundStageTransitionsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnPipeline_StageTransitionProperty:
				v_ := v.(CfnPipeline_StageTransitionProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnPipeline) validateSetRestartExecutionOnUpdateParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnPipeline) validateSetStagesParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnPipeline_StageDeclarationProperty:
				v_ := v.(CfnPipeline_StageDeclarationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnPipeline) validateSetTriggersParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnPipeline_PipelineTriggerDeclarationProperty:
				v := v.(*CfnPipeline_PipelineTriggerDeclarationProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnPipeline_PipelineTriggerDeclarationProperty:
				v_ := v.(CfnPipeline_PipelineTriggerDeclarationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnPipeline_PipelineTriggerDeclarationProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnPipeline) validateSetVariablesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnPipeline_VariableDeclarationProperty:
				v := v.(*CfnPipeline_VariableDeclarationProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnPipeline_VariableDeclarationProperty:
				v_ := v.(CfnPipeline_VariableDeclarationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnPipeline_VariableDeclarationProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
