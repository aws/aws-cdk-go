...
func (j *jsiiProxy_CfnCustomActionType) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCustomActionType(scope constructs.Construct, id *string, props *CfnCustomActionTypeProps) CfnCustomActionType {
	...
	if err := validateNewCfnCustomActionTypeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCustomActionType)SetConfigurationProperties(val interface{}) {
	if err := j.validateSetConfigurationPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCustomActionType)SetInputArtifactDetails(val interface{}) {
	if err := j.validateSetInputArtifactDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCustomActionType)SetOutputArtifactDetails(val interface{}) {
	if err := j.validateSetOutputArtifactDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCustomActionType_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomActionType_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomActionType_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCustomActionType_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomActionType_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomActionType_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomActionType) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomActionType) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomActionType) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomActionType) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCustomActionType) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomActionType) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
