...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline.Condition",
		reflect.TypeOf((*Condition)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline.Conditions",
		reflect.TypeOf((*Conditions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codepipeline.FailureConditions",
		reflect.TypeOf((*FailureConditions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterEnum(
		...
		reflect.TypeOf((*RetryMode)(nil)).Elem(),
		map[string]interface{}{
			"ALL_ACTIONS": RetryMode_ALL_ACTIONS,
			"FAILED_ACTIONS": RetryMode_FAILED_ACTIONS,
		},
	)
	_jsii_.RegisterClass(
