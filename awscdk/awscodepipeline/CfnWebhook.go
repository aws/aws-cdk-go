...
type CfnWebhook interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscodepipeline.IWebhookRef
	awscdk.ITaggableV2
	...
	WebhookRef() *interfacesawscodepipeline.WebhookReference
...
type jsiiProxy_CfnWebhook struct {
	...
	internal.Type__interfacesawscodepipelineIWebhookRef
...
func (j *jsiiProxy_CfnWebhook) WebhookRef() *interfacesawscodepipeline.WebhookReference {
	var returns *interfacesawscodepipeline.WebhookReference
	_jsii_.Get(
		j,
		"webhookRef",
		&returns,
