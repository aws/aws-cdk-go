...
func (j *jsiiProxy_CfnCustomActionType) CfnPropertyNames() *map[string]*string {
...
func CfnCustomActionType_IsCfnCustomActionType(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCustomActionType_IsCfnCustomActionTypeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomActionType_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCustomActionType_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomActionType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomActionType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomActionType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomActionType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomActionType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
