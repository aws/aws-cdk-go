...
func (j *jsiiProxy_CfnPipeline) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnPipeline)SetArtifactStore(val interface{}) {
	if err := j.validateSetArtifactStoreParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPipeline)SetArtifactStores(val interface{}) {
	if err := j.validateSetArtifactStoresParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPipeline)SetDisableInboundStageTransitions(val interface{}) {
	if err := j.validateSetDisableInboundStageTransitionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
// Creates a new IPipelineRef from an ARN.
func CfnPipeline_FromPipelineArn(scope constructs.Construct, id *string, arn *string) interfacesawscodepipeline.IPipelineRef {
	_init_.Initialize()

	if err := validateCfnPipeline_FromPipelineArnParameters(scope, id, arn); err != nil {
		panic(err)
	}
