...
func (j *jsiiProxy_CfnIdentity) CfnPropertyNames() *map[string]*string {
...
func CfnIdentity_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIdentity_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentity) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdentity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdentity) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdentity) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
