...
func (j *jsiiProxy_CfnConfigurationSetEventDestination) CfnPropertyNames() *map[string]*string {
...
func NewCfnConfigurationSetEventDestination(scope constructs.Construct, id *string, props *CfnConfigurationSetEventDestinationProps) CfnConfigurationSetEventDestination {
	...
	if err := validateNewCfnConfigurationSetEventDestinationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConfigurationSetEventDestination)SetEventDestination(val interface{}) {
	if err := j.validateSetEventDestinationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
// Checks whether the given object is a CfnConfigurationSetEventDestination.
func CfnConfigurationSetEventDestination_IsCfnConfigurationSetEventDestination(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfigurationSetEventDestination_IsCfnConfigurationSetEventDestinationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationSetEventDestination_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfigurationSetEventDestination_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationSetEventDestination_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfigurationSetEventDestination_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationSetEventDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
