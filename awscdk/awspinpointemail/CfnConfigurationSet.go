...
func (j *jsiiProxy_CfnConfigurationSet)SetDeliveryOptions(val interface{}) {
	if err := j.validateSetDeliveryOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfigurationSet)SetReputationOptions(val interface{}) {
	if err := j.validateSetReputationOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfigurationSet)SetSendingOptions(val interface{}) {
	if err := j.validateSetSendingOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfigurationSet)SetTrackingOptions(val interface{}) {
	if err := j.validateSetTrackingOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
