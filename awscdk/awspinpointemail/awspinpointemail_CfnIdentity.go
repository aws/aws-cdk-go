...
func NewCfnIdentity(scope constructs.Construct, id *string, props *CfnIdentityProps) CfnIdentity {
	...
	if err := validateNewCfnIdentityParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIdentity)SetDkimSigningEnabled(val interface{}) {
	if err := j.validateSetDkimSigningEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIdentity)SetFeedbackForwardingEnabled(val interface{}) {
	if err := j.validateSetFeedbackForwardingEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIdentity_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdentity_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentity_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnIdentity_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentity_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdentity_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentity) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentity) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdentity) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdentity) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnIdentity) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentity) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
