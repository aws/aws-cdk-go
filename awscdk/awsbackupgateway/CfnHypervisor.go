...
//
//   cfnHypervisor := awscdk.Aws_backupgateway.NewCfnHypervisor(this, jsii.String("MyCfnHypervisor"), &CfnHypervisorProps{
...
func (j *jsiiProxy_CfnHypervisor) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnHypervisor) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnHypervisor) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHypervisor) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnHypervisor) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnHypervisor) Host() *string {
	var returns *string
	_jsii_.Get(
		j,
		"host",
...
func (j *jsiiProxy_CfnHypervisor) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_CfnHypervisor) LogGroupArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logGroupArn",
...
func (j *jsiiProxy_CfnHypervisor) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnHypervisor) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnHypervisor) Node() constructs.Node {
...
func (j *jsiiProxy_CfnHypervisor) Password() *string {
	var returns *string
	_jsii_.Get(
		j,
		"password",
...
func (j *jsiiProxy_CfnHypervisor) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnHypervisor) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnHypervisor) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnHypervisor) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnHypervisor) Username() *string {
	var returns *string
	_jsii_.Get(
		j,
		"username",
...
func NewCfnHypervisor(scope constructs.Construct, id *string, props *CfnHypervisorProps) CfnHypervisor {
	...
	if err := validateNewCfnHypervisorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnHypervisor)SetHost(val *string) {
	_jsii_.Set(
		j,
		"host",
		val,
...
func (j *jsiiProxy_CfnHypervisor)SetKmsKeyArn(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyArn",
		val,
...
func (j *jsiiProxy_CfnHypervisor)SetLogGroupArn(val *string) {
	_jsii_.Set(
		j,
		"logGroupArn",
		val,
...
func (j *jsiiProxy_CfnHypervisor)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnHypervisor)SetPassword(val *string) {
	_jsii_.Set(
		j,
		"password",
		val,
...
func (j *jsiiProxy_CfnHypervisor)SetUsername(val *string) {
	_jsii_.Set(
		j,
		"username",
		val,
...
func CfnHypervisor_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnHypervisor_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHypervisor_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnHypervisor_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHypervisor_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_backupgateway.CfnHypervisor",
...
func (c *jsiiProxy_CfnHypervisor) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnHypervisor) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHypervisor) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHypervisor) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnHypervisor) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnHypervisor) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnHypervisor) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnHypervisor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHypervisor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHypervisor) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnHypervisor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHypervisor) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHypervisor) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnHypervisor) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnHypervisor) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHypervisor) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnHypervisor) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHypervisor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHypervisor) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnHypervisor) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHypervisor) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnHypervisor) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnHypervisor) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnHypervisor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
