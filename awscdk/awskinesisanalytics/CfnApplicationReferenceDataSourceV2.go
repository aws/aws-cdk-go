...
func (j *jsiiProxy_CfnApplicationReferenceDataSourceV2) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplicationReferenceDataSourceV2) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApplicationReferenceDataSourceV2(scope constructs.Construct, id *string, props *CfnApplicationReferenceDataSourceV2Props) CfnApplicationReferenceDataSourceV2 {
	...
	if err := validateNewCfnApplicationReferenceDataSourceV2Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnApplicationReferenceDataSourceV2)SetReferenceDataSource(val interface{}) {
	if err := j.validateSetReferenceDataSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
// Checks whether the given object is a CfnApplicationReferenceDataSourceV2.
// Deprecated: use `aws-kinesisanalyticsv2` instead.
func CfnApplicationReferenceDataSourceV2_IsCfnApplicationReferenceDataSourceV2(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationReferenceDataSourceV2_IsCfnApplicationReferenceDataSourceV2Parameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_kinesisanalytics.CfnApplicationReferenceDataSourceV2",
		"isCfnApplicationReferenceDataSourceV2",
		[]interface{}{x},
		&returns,
	)
...
func CfnApplicationReferenceDataSourceV2_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSourceV2_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationReferenceDataSourceV2_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSourceV2_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationReferenceDataSourceV2_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSourceV2_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSourceV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
