...
func (j *jsiiProxy_CfnApplicationReferenceDataSource) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApplicationReferenceDataSource(scope constructs.Construct, id *string, props *CfnApplicationReferenceDataSourceProps) CfnApplicationReferenceDataSource {
	...
	if err := validateNewCfnApplicationReferenceDataSourceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApplicationReferenceDataSource_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSource_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationReferenceDataSource_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnApplicationReferenceDataSource_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationReferenceDataSource_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
