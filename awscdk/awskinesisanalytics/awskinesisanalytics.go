...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kinesisanalytics.CfnApplicationV2.ApplicationMaintenanceConfigurationProperty",
		reflect.TypeOf((*CfnApplicationV2_ApplicationMaintenanceConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_kinesisanalytics.CfnApplicationV2.ApplicationRestoreConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kinesisanalytics.CfnApplicationV2.FlinkRunConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kinesisanalytics.CfnApplicationV2.RunConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_kinesisanalytics.CfnApplicationV2.VpcConfigurationProperty",
