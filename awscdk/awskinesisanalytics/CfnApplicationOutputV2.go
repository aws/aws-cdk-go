...
func (j *jsiiProxy_CfnApplicationOutputV2) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnApplicationOutputV2) CfnPropertyNames() *map[string]*string {
...
func CfnApplicationOutputV2_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApplicationOutputV2_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationOutputV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationOutputV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationOutputV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationOutputV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationOutputV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
