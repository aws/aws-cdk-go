...
func (c *jsiiProxy_CfnApplicationV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
