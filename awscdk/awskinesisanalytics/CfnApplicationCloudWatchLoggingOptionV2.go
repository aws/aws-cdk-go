...
func (j *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnApplicationCloudWatchLoggingOptionV2.
// Deprecated: use `aws-kinesisanalyticsv2` instead.
func CfnApplicationCloudWatchLoggingOptionV2_IsCfnApplicationCloudWatchLoggingOptionV2(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationCloudWatchLoggingOptionV2_IsCfnApplicationCloudWatchLoggingOptionV2Parameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_kinesisanalytics.CfnApplicationCloudWatchLoggingOptionV2",
		"isCfnApplicationCloudWatchLoggingOptionV2",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOptionV2) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
