...
type CfnApplicationReferenceDataSource interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawskinesisanalytics.IApplicationReferenceDataSourceRef
	// Name of an existing application.
	ApplicationName() *string
	SetApplicationName(val *string)
	// A reference to a ApplicationReferenceDataSource resource.
	ApplicationReferenceDataSourceRef() *interfacesawskinesisanalytics.ApplicationReferenceDataSourceReference
	AttrId() *string
...
type jsiiProxy_CfnApplicationReferenceDataSource struct {
	...
	internal.Type__interfacesawskinesisanalyticsIApplicationReferenceDataSourceRef
}
...
func (j *jsiiProxy_CfnApplicationReferenceDataSource) ApplicationReferenceDataSourceRef() *interfacesawskinesisanalytics.ApplicationReferenceDataSourceReference {
	var returns *interfacesawskinesisanalytics.ApplicationReferenceDataSourceReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplicationReferenceDataSource) CfnPropertyNames() *map[string]*string {
...
func CfnApplicationReferenceDataSource_IsCfnApplicationReferenceDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationReferenceDataSource_IsCfnApplicationReferenceDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_kinesisanalytics.CfnApplicationReferenceDataSource",
		"isCfnApplicationReferenceDataSource",
		[]interface{}{x},
		&returns,
	)
...
func CfnApplicationReferenceDataSource_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApplicationReferenceDataSource_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationReferenceDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
