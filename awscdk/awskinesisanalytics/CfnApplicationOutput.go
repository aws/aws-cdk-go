...
type CfnApplicationOutput interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawskinesisanalytics.IApplicationOutputRef
	// Name of the application to which you want to add the output configuration.
	ApplicationName() *string
	SetApplicationName(val *string)
	// A reference to a ApplicationOutput resource.
	ApplicationOutputRef() *interfacesawskinesisanalytics.ApplicationOutputReference
	AttrId() *string
...
type jsiiProxy_CfnApplicationOutput struct {
	...
	internal.Type__interfacesawskinesisanalyticsIApplicationOutputRef
}
...
func (j *jsiiProxy_CfnApplicationOutput) ApplicationOutputRef() *interfacesawskinesisanalytics.ApplicationOutputReference {
	var returns *interfacesawskinesisanalytics.ApplicationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplicationOutput) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplicationOutput) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnApplicationOutput) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApplicationOutput(scope constructs.Construct, id *string, props *CfnApplicationOutputProps) CfnApplicationOutput {
	...
	if err := validateNewCfnApplicationOutputParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApplicationOutput_IsCfnApplicationOutput(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationOutput_IsCfnApplicationOutputParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationOutput_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationOutput_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationOutput_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApplicationOutput_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationOutput_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationOutput_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationOutput) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationOutput) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationOutput) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationOutput) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationOutput) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationOutput) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationOutput) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationOutput) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationOutput) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationOutput) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
