...
func (j *jsiiProxy_IApplicationReferenceDataSourceRef) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_IApplicationReferenceDataSourceRef) Node() constructs.Node {
