...
func (j *jsiiProxy_CfnScalingPlan) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScalingPlan) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnScalingPlan_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScalingPlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScalingPlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalingPlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScalingPlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScalingPlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScalingPlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScalingPlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScalingPlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalingPlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalingPlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScalingPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
