...
func NestedStack_ConsumeListReference(value *[]*string, strength ReferenceStrength) *[]*string {
	_init_.Initialize()

	if err := validateNestedStack_ConsumeListReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *[]*string
...
//
// Returns: A token that resolves to the same value but uses the overridden strength.
func NestedStack_ConsumeReference(value *string, strength ReferenceStrength) *string {
	_init_.Initialize()

	if err := validateNestedStack_ConsumeReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *string
...
func (n *jsiiProxy_NestedStack) AddStackDependency(target Stack, reason *string) {
	if err := n.validateAddStackDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NestedStack) AddStackTag(tagName *string, tagValue *string) {
	if err := n.validateAddStackTagParameters(tagName, tagValue); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NestedStack) RemoveStackTag(tagName *string) {
	if err := n.validateRemoveStackTagParameters(tagName); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NestedStack) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
