...
func (j *jsiiProxy_CfnVehicle) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnVehicle) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnVehicle) Attributes() interface{} {
...
func (j *jsiiProxy_CfnVehicle) AttrLastModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVehicle) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnVehicle) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVehicle) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVehicle) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVehicle) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVehicle) DecoderManifestArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"decoderManifestArn",
...
func (j *jsiiProxy_CfnVehicle) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVehicle) ModelManifestArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modelManifestArn",
...
func (j *jsiiProxy_CfnVehicle) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnVehicle) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVehicle) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVehicle) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVehicle) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVehicle(scope constructs.Construct, id *string, props *CfnVehicleProps) CfnVehicle {
	...
	if err := validateNewCfnVehicleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnVehicle)SetAssociationBehavior(val *string) {
	_jsii_.Set(
		j,
		"associationBehavior",
		val,
...
func (j *jsiiProxy_CfnVehicle)SetAttributes(val interface{}) {
...
func (j *jsiiProxy_CfnVehicle)SetDecoderManifestArn(val *string) {
...
func (j *jsiiProxy_CfnVehicle)SetModelManifestArn(val *string) {
...
func (j *jsiiProxy_CfnVehicle)SetName(val *string) {
...
func CfnVehicle_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVehicle_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVehicle_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVehicle_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVehicle_IsCfnVehicle(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVehicle_IsCfnVehicleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVehicle_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVehicle_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVehicle) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVehicle) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVehicle) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVehicle) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVehicle) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVehicle) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVehicle) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVehicle) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVehicle) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVehicle) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVehicle) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVehicle) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVehicle) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVehicle) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVehicle) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVehicle) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVehicle) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVehicle) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVehicle) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVehicle) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVehicle) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnVehicle) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnVehicle) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnVehicle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
