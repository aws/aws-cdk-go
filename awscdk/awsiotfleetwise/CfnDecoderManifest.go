...
func (j *jsiiProxy_CfnDecoderManifest) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnDecoderManifest) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDecoderManifest) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDecoderManifest) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDecoderManifest) RemoveResourceDependency(target awscdk.CfnResource) {
