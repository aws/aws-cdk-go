...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iotfleetwise.CfnDecoderManifest.CanNetworkInterfaceProperty",
		reflect.TypeOf((*CfnDecoderManifest_CanNetworkInterfaceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iotfleetwise.CfnDecoderManifest.CanSignalDecoderProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iotfleetwise.CfnDecoderManifest.ObdNetworkInterfaceProperty",
		reflect.TypeOf((*CfnDecoderManifest_ObdNetworkInterfaceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iotfleetwise.CfnDecoderManifest.ObdSignalDecoderProperty",
