...
func (j *jsiiProxy_CfnFleet) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnFleet) AttrLastModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFleet) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CfnFleet) SignalCatalogArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"signalCatalogArn",
...
func (j *jsiiProxy_CfnFleet)SetId(val *string) {
...
func (j *jsiiProxy_CfnFleet)SetSignalCatalogArn(val *string) {
