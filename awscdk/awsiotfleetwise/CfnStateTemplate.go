...
//
//   cfnStateTemplate := awscdk.Aws_iotfleetwise.NewCfnStateTemplate(this, jsii.String("MyCfnStateTemplate"), &CfnStateTemplateProps{
...
func (j *jsiiProxy_CfnStateTemplate) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnStateTemplate) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnStateTemplate) AttrLastModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnStateTemplate) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnStateTemplate) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnStateTemplate) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnStateTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStateTemplate) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnStateTemplate) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnStateTemplate) DataExtraDimensions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dataExtraDimensions",
...
func (j *jsiiProxy_CfnStateTemplate) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnStateTemplate) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnStateTemplate) MetadataExtraDimensions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnStateTemplate) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnStateTemplate) Node() constructs.Node {
...
func (j *jsiiProxy_CfnStateTemplate) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnStateTemplate) SignalCatalogArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"signalCatalogArn",
...
func (j *jsiiProxy_CfnStateTemplate) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnStateTemplate) StateTemplateProperties() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnStateTemplate) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnStateTemplate) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnStateTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStateTemplate(scope constructs.Construct, id *string, props *CfnStateTemplateProps) CfnStateTemplate {
	...
	if err := validateNewCfnStateTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStateTemplate)SetDataExtraDimensions(val *[]*string) {
	_jsii_.Set(
		j,
		"dataExtraDimensions",
		val,
...
func (j *jsiiProxy_CfnStateTemplate)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnStateTemplate)SetMetadataExtraDimensions(val *[]*string) {
	_jsii_.Set(
		j,
		"metadataExtraDimensions",
		val,
...
func (j *jsiiProxy_CfnStateTemplate)SetName(val *string) {
...
func (j *jsiiProxy_CfnStateTemplate)SetSignalCatalogArn(val *string) {
...
func (j *jsiiProxy_CfnStateTemplate)SetStateTemplateProperties(val *[]*string) {
...
func (j *jsiiProxy_CfnStateTemplate)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnStateTemplate_ArnForStateTemplate(resource interfacesawsiotfleetwise.IStateTemplateRef) *string {
	_init_.Initialize()

	if err := validateCfnStateTemplate_ArnForStateTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnStateTemplate_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStateTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateTemplate_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStateTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateTemplate_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStateTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateTemplate_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iotfleetwise.CfnStateTemplate",
...
func (c *jsiiProxy_CfnStateTemplate) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnStateTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateTemplate) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateTemplate) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateTemplate) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateTemplate) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnStateTemplate) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStateTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStateTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnStateTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStateTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStateTemplate) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnStateTemplate) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnStateTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStateTemplate) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnStateTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateTemplate) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnStateTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateTemplate) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnStateTemplate) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnStateTemplate) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnStateTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
