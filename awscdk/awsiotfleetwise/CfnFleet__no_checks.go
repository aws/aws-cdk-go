...
func validateCfnFleet_ArnForFleetParameters(resource interfacesawsiotfleetwise.IFleetRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnFleet) validateSetIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnFleet) validateSetSignalCatalogArnParameters(val *string) error {
	return nil
}
