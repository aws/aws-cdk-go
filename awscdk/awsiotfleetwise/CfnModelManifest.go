...
func (j *jsiiProxy_CfnModelManifest) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnModelManifest) AttrLastModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnModelManifest) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnModelManifest) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnModelManifest) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnModelManifest) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnModelManifest) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnModelManifest) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnModelManifest) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnModelManifest) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnModelManifest) Node() constructs.Node {
...
func (j *jsiiProxy_CfnModelManifest) Nodes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"nodes",
...
func (j *jsiiProxy_CfnModelManifest) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnModelManifest) SignalCatalogArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"signalCatalogArn",
...
func (j *jsiiProxy_CfnModelManifest) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnModelManifest) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnModelManifest) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnModelManifest) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnModelManifest(scope constructs.Construct, id *string, props *CfnModelManifestProps) CfnModelManifest {
	...
	if err := validateNewCfnModelManifestParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnModelManifest)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnModelManifest)SetName(val *string) {
...
func (j *jsiiProxy_CfnModelManifest)SetNodes(val *[]*string) {
	_jsii_.Set(
		j,
		"nodes",
		val,
...
func (j *jsiiProxy_CfnModelManifest)SetSignalCatalogArn(val *string) {
...
func (j *jsiiProxy_CfnModelManifest)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnModelManifest_ArnForModelManifest(resource interfacesawsiotfleetwise.IModelManifestRef) *string {
	_init_.Initialize()

	if err := validateCfnModelManifest_ArnForModelManifestParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnModelManifest_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnModelManifest_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelManifest_IsCfnModelManifest(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnModelManifest_IsCfnModelManifestParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModelManifest_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnModelManifest_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModelManifest) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnModelManifest) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelManifest) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelManifest) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnModelManifest) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnModelManifest) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnModelManifest) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnModelManifest) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModelManifest) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModelManifest) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnModelManifest) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModelManifest) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnModelManifest) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnModelManifest) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnModelManifest) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnModelManifest) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnModelManifest) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelManifest) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelManifest) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnModelManifest) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModelManifest) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnModelManifest) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnModelManifest) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnModelManifest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
