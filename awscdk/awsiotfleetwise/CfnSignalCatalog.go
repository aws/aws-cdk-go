...
func (j *jsiiProxy_CfnSignalCatalog) CfnPropertyNames() *map[string]*string {
...
func CfnSignalCatalog_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSignalCatalog_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSignalCatalog_IsCfnSignalCatalog(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSignalCatalog_IsCfnSignalCatalogParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSignalCatalog) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSignalCatalog) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSignalCatalog) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSignalCatalog) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSignalCatalog) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
