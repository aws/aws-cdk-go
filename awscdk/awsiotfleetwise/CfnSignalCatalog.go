...
func (j *jsiiProxy_CfnSignalCatalog) Node() awscdk.ConstructNode {
...
func (c *jsiiProxy_CfnSignalCatalog) GetAtt(attributeName *string) awscdk.Reference {
...
func (c *jsiiProxy_CfnSignalCatalog) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnSignalCatalog) OnSynthesize(session constructs.ISynthesisSession) {
...
func (c *jsiiProxy_CfnSignalCatalog) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnSignalCatalog) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnSignalCatalog) Synthesize(session awscdk.ISynthesisSession) {
...
func (c *jsiiProxy_CfnSignalCatalog) Validate() *[]*string {
	var returns *[]*string
