...
//
type CfnVehicle_StateTemplateAssociationProperty struct {
	...
	//
	StateTemplateUpdateStrategy interface{} `field:"required" json:"stateTemplateUpdateStrategy" yaml:"stateTemplateUpdateStrategy"`
}
