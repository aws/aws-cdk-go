...
func (j *jsiiProxy_CfnDataSource) validateSetDataSourceConfigurationParameters(val interface{}) error {
	...
	case CfnDataSource_DataSourceConfigurationProperty:
		val_ := val.(CfnDataSource_DataSourceConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataSource) validateSetServerSideEncryptionConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_ServerSideEncryptionConfigurationProperty:
		val := val.(*CfnDataSource_ServerSideEncryptionConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_ServerSideEncryptionConfigurationProperty:
		val_ := val.(CfnDataSource_ServerSideEncryptionConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_ServerSideEncryptionConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetVectorIngestionConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_VectorIngestionConfigurationProperty:
		val := val.(*CfnDataSource_VectorIngestionConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_VectorIngestionConfigurationProperty:
		val_ := val.(CfnDataSource_VectorIngestionConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_VectorIngestionConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
