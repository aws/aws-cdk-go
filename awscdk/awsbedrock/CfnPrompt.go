...
func (j *jsiiProxy_CfnPrompt) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnPrompt) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnPrompt) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnPrompt) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnPrompt) AttrVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersion",
...
func (j *jsiiProxy_CfnPrompt) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPrompt) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPrompt) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPrompt) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPrompt) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPrompt) CustomerEncryptionKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPrompt) DefaultVariant() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultVariant",
...
func (j *jsiiProxy_CfnPrompt) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnPrompt) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPrompt) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPrompt) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPrompt) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPrompt) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPrompt) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnPrompt) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnPrompt) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnPrompt) Variants() interface{} {
...
func NewCfnPrompt(scope constructs.Construct, id *string, props *CfnPromptProps) CfnPrompt {
	...
	if err := validateNewCfnPromptParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPrompt)SetCustomerEncryptionKeyArn(val *string) {
	_jsii_.Set(
		j,
		"customerEncryptionKeyArn",
		val,
...
func (j *jsiiProxy_CfnPrompt)SetDefaultVariant(val *string) {
	_jsii_.Set(
		j,
		"defaultVariant",
		val,
...
func (j *jsiiProxy_CfnPrompt)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnPrompt)SetName(val *string) {
...
func (j *jsiiProxy_CfnPrompt)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func (j *jsiiProxy_CfnPrompt)SetVariants(val interface{}) {
...
func CfnPrompt_ArnForPrompt(resource interfacesawsbedrock.IPromptRef) *string {
	_init_.Initialize()

	if err := validateCfnPrompt_ArnForPromptParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPrompt_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPrompt_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrompt_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPrompt_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrompt_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPrompt_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPrompt) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPrompt) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrompt) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrompt) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnPrompt) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPrompt) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPrompt) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPrompt) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrompt) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrompt) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPrompt) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrompt) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPrompt) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnPrompt) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPrompt) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPrompt) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnPrompt) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrompt) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrompt) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPrompt) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrompt) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPrompt) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPrompt) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPrompt) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
