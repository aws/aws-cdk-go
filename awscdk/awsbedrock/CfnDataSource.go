...
func (j *jsiiProxy_CfnDataSource) AttrDataSourceConfigurationWebConfigurationCrawlerConfigurationUserAgentHeader() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataSource) AttrDataSourceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataSource) KnowledgeBaseId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"knowledgeBaseId",
...
func (j *jsiiProxy_CfnDataSource) ServerSideEncryptionConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataSource) VectorIngestionConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataSource)SetKnowledgeBaseId(val *string) {
...
func (j *jsiiProxy_CfnDataSource)SetServerSideEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnDataSource)SetVectorIngestionConfiguration(val interface{}) {
