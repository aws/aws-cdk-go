...
func (j *jsiiProxy_CfnAgentAlias) CfnPropertyNames() *map[string]*string {
...
func CfnAgentAlias_ArnForAgentAlias(resource interfacesawsbedrock.IAgentAliasRef) *string {
	_init_.Initialize()

	if err := validateCfnAgentAlias_ArnForAgentAliasParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnAgentAlias.
func CfnAgentAlias_IsCfnAgentAlias(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAgentAlias_IsCfnAgentAliasParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAgentAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAgentAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAgentAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAgentAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgentAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
