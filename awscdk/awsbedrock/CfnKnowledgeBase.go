...
func (j *jsiiProxy_CfnKnowledgeBase) AttrFailureReasons() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrFailureReasons",
...
func (j *jsiiProxy_CfnKnowledgeBase) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnKnowledgeBase)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnKnowledgeBase)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
