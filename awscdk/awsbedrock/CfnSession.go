...
//
//   cfnSession := awscdk.Aws_bedrock.NewCfnSession(this, jsii.String("MyCfnSession"), &CfnSessionProps{
...
type CfnSession interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrock.ISessionRef
	awscdk.ITaggableV2
	...
	AttrSessionArn() *string
	// The unique identifier of the session in UUID format.
	AttrSessionId() *string
	// The current status of the session.
	AttrSessionStatus() *string
	...
	SetSessionMetadata(val interface{})
	// A reference to a Session resource.
	SessionRef() *interfacesawsbedrock.SessionReference
...
type jsiiProxy_CfnSession struct {
	...
	internal.Type__interfacesawsbedrockISessionRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnSession) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnSession) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnSession) AttrSessionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSessionArn",
...
func (j *jsiiProxy_CfnSession) AttrSessionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSessionId",
...
func (j *jsiiProxy_CfnSession) AttrSessionStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSessionStatus",
...
func (j *jsiiProxy_CfnSession) EncryptionKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encryptionKeyArn",
...
func (j *jsiiProxy_CfnSession) SessionMetadata() interface{} {
...
func (j *jsiiProxy_CfnSession) SessionRef() *interfacesawsbedrock.SessionReference {
	var returns *interfacesawsbedrock.SessionReference
	_jsii_.Get(
		j,
		"sessionRef",
		&returns,
...
// Create a new `AWS::Bedrock::Session`.
...
func (j *jsiiProxy_CfnSession)SetEncryptionKeyArn(val *string) {
	_jsii_.Set(
		j,
		"encryptionKeyArn",
		val,
...
func (j *jsiiProxy_CfnSession)SetSessionMetadata(val interface{}) {
	if err := j.validateSetSessionMetadataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSession_ArnForSession(resource interfacesawsbedrock.ISessionRef) *string {
	_init_.Initialize()
