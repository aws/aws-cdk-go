...
//
//   cfnAutomatedReasoningPolicy := awscdk.Aws_bedrock.NewCfnAutomatedReasoningPolicy(this, jsii.String("MyCfnAutomatedReasoningPolicy"), &CfnAutomatedReasoningPolicyProps{
...
type CfnAutomatedReasoningPolicy interface {
	...
	SetPolicyDefinition(val interface{})
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) AttrDefinitionHash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDefinitionHash",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) AttrPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPolicyId",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) AttrVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVersion",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) PolicyDefinition() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policyDefinition",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAutomatedReasoningPolicy(scope constructs.Construct, id *string, props *CfnAutomatedReasoningPolicyProps) CfnAutomatedReasoningPolicy {
	...
	if err := validateNewCfnAutomatedReasoningPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy)SetName(val *string) {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy)SetPolicyDefinition(val interface{}) {
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicy)SetTags(val *[]*awscdk.CfnTag) {
...
// Checks whether the given object is a CfnAutomatedReasoningPolicy.
func CfnAutomatedReasoningPolicy_IsCfnAutomatedReasoningPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutomatedReasoningPolicy_IsCfnAutomatedReasoningPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutomatedReasoningPolicy_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutomatedReasoningPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutomatedReasoningPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutomatedReasoningPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutomatedReasoningPolicy_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutomatedReasoningPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutomatedReasoningPolicy_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_bedrock.CfnAutomatedReasoningPolicy",
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
