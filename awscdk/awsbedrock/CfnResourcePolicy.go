...
//
//   cfnResourcePolicy := awscdk.Aws_bedrock.NewCfnResourcePolicy(this, jsii.String("MyCfnResourcePolicy"), &CfnResourcePolicyProps{
...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrock.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawsbedrock.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawsbedrockIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawsbedrock.ResourcePolicyReference {
	var returns *interfacesawsbedrock.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
