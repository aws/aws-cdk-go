...
//
//   cfnDataAutomationProject := awscdk.Aws_bedrock.NewCfnDataAutomationProject(this, jsii.String("MyCfnDataAutomationProject"), &CfnDataAutomationProjectProps{
...
type CfnDataAutomationProject interface {
	...
	OverrideConfiguration() interface{}
	SetOverrideConfiguration(val interface{})
	...
	StandardOutputConfiguration() interface{}
	SetStandardOutputConfiguration(val interface{})
	// List of Tags.
	Tags() *[]*awscdk.CfnTag
...
func (j *jsiiProxy_CfnDataAutomationProject) AttrCreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationTime",
...
func (j *jsiiProxy_CfnDataAutomationProject) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject) AttrProjectArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrProjectArn",
...
func (j *jsiiProxy_CfnDataAutomationProject) AttrProjectStage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrProjectStage",
...
func (j *jsiiProxy_CfnDataAutomationProject) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDataAutomationProject) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDataAutomationProject) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDataAutomationProject) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDataAutomationProject) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDataAutomationProject) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDataAutomationProject) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDataAutomationProject) CustomOutputConfiguration() interface{} {
...
func (j *jsiiProxy_CfnDataAutomationProject) KmsEncryptionContext() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnDataAutomationProject) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDataAutomationProject) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDataAutomationProject) OverrideConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject) ProjectDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectDescription",
...
func (j *jsiiProxy_CfnDataAutomationProject) ProjectName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectName",
...
func (j *jsiiProxy_CfnDataAutomationProject) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDataAutomationProject) StandardOutputConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDataAutomationProject) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDataAutomationProject) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDataAutomationProject(scope constructs.Construct, id *string, props *CfnDataAutomationProjectProps) CfnDataAutomationProject {
	...
	if err := validateNewCfnDataAutomationProjectParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDataAutomationProject)SetCustomOutputConfiguration(val interface{}) {
	if err := j.validateSetCustomOutputConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject)SetKmsEncryptionContext(val interface{}) {
...
func (j *jsiiProxy_CfnDataAutomationProject)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnDataAutomationProject)SetOverrideConfiguration(val interface{}) {
	if err := j.validateSetOverrideConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject)SetProjectDescription(val *string) {
	_jsii_.Set(
		j,
		"projectDescription",
		val,
...
func (j *jsiiProxy_CfnDataAutomationProject)SetProjectName(val *string) {
...
func (j *jsiiProxy_CfnDataAutomationProject)SetStandardOutputConfiguration(val interface{}) {
	if err := j.validateSetStandardOutputConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataAutomationProject)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDataAutomationProject_IsCfnDataAutomationProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataAutomationProject_IsCfnDataAutomationProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataAutomationProject_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataAutomationProject_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataAutomationProject_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataAutomationProject_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataAutomationProject_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataAutomationProject_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataAutomationProject_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_bedrock.CfnDataAutomationProject",
...
func (c *jsiiProxy_CfnDataAutomationProject) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDataAutomationProject) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataAutomationProject) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataAutomationProject) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDataAutomationProject) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataAutomationProject) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataAutomationProject) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDataAutomationProject) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDataAutomationProject) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataAutomationProject) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDataAutomationProject) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAutomationProject) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAutomationProject) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDataAutomationProject) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataAutomationProject) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDataAutomationProject) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDataAutomationProject) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDataAutomationProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
