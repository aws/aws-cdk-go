...
func (c *jsiiProxy_CfnGuardrail) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnGuardrail) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnGuardrail) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnGuardrail) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnGuardrail_IsCfnGuardrailParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnGuardrail) validateSetAutomatedReasoningPolicyConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnGuardrail_AutomatedReasoningPolicyConfigProperty:
		val := val.(*CfnGuardrail_AutomatedReasoningPolicyConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnGuardrail_AutomatedReasoningPolicyConfigProperty:
		val_ := val.(CfnGuardrail_AutomatedReasoningPolicyConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardrail_AutomatedReasoningPolicyConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnGuardrail) validateSetContextualGroundingPolicyConfigParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnGuardrail_ContextualGroundingPolicyConfigProperty:
		val := val.(*CfnGuardrail_ContextualGroundingPolicyConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnGuardrail_ContextualGroundingPolicyConfigProperty:
		val_ := val.(CfnGuardrail_ContextualGroundingPolicyConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardrail_ContextualGroundingPolicyConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnGuardrail) validateSetCrossRegionConfigParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnGuardrail_GuardrailCrossRegionConfigProperty:
		val := val.(*CfnGuardrail_GuardrailCrossRegionConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnGuardrail_GuardrailCrossRegionConfigProperty:
		val_ := val.(CfnGuardrail_GuardrailCrossRegionConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardrail_GuardrailCrossRegionConfigProperty; received %#v (a %T)", val, val)
		}
	}
