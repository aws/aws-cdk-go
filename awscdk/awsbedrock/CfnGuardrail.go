...
func (j *jsiiProxy_CfnGuardrail) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnGuardrail) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGuardrail) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGuardrail) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGuardrail) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardrail) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
