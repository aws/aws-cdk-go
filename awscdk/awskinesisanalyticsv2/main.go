...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.ApplicationCloudWatchLoggingOptionReference",
		reflect.TypeOf((*ApplicationCloudWatchLoggingOptionReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.ApplicationOutputReference",
		reflect.TypeOf((*ApplicationOutputReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.ApplicationReference",
		reflect.TypeOf((*ApplicationReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.ApplicationReferenceDataSourceReference",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.CfnApplication.ApplicationEncryptionConfigurationProperty",
		reflect.TypeOf((*CfnApplication_ApplicationEncryptionConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_kinesisanalyticsv2.CfnApplication.ApplicationSystemRollbackConfigurationProperty",
		reflect.TypeOf((*CfnApplication_ApplicationSystemRollbackConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IApplicationCloudWatchLoggingOptionRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			return &j
		},
	)
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_kinesisanalyticsv2.IApplicationCloudWatchLoggingOptionRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_kinesisanalyticsv2.IApplicationOutputRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_kinesisanalyticsv2.IApplicationRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_kinesisanalyticsv2.IApplicationReferenceDataSourceRef",
