...
func (j *jsiiProxy_CfnApplicationCloudWatchLoggingOption) ApplicationCloudWatchLoggingOptionRef() *interfacesawskinesisanalyticsv2.ApplicationCloudWatchLoggingOptionReference {
...
func (j *jsiiProxy_CfnApplicationCloudWatchLoggingOption) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnApplicationCloudWatchLoggingOption) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplicationCloudWatchLoggingOption) Env() *interfaces.ResourceEnvironment {
...
func CfnApplicationCloudWatchLoggingOption_IsCfnApplicationCloudWatchLoggingOption(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationCloudWatchLoggingOption_IsCfnApplicationCloudWatchLoggingOptionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_kinesisanalyticsv2.CfnApplicationCloudWatchLoggingOption",
		"isCfnApplicationCloudWatchLoggingOption",
		[]interface{}{x},
		&returns,
	)
...
func CfnApplicationCloudWatchLoggingOption_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationCloudWatchLoggingOption_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationCloudWatchLoggingOption_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationCloudWatchLoggingOption_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationCloudWatchLoggingOption_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationCloudWatchLoggingOption_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOption) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOption) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOption) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOption) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationCloudWatchLoggingOption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
