...
func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawskinesisanalyticsv2.ApplicationReference {
...
func CfnApplication_ArnForApplication(resource interfacesawskinesisanalyticsv2.IApplicationRef) *string {
	_init_.Initialize()
...
func CfnApplication_FromApplicationName(scope constructs.Construct, id *string, applicationName *string) interfacesawskinesisanalyticsv2.IApplicationRef {
	_init_.Initialize()
