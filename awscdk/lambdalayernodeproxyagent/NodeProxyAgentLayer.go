...
func (j *jsiiProxy_NodeProxyAgentLayer) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_NodeProxyAgentLayer) LayerVersionRef() *interfacesawslambda.LayerVersionReference {
...
func NodeProxyAgentLayer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.lambda_layer_node_proxy_agent.NodeProxyAgentLayer",
...
func (n *jsiiProxy_NodeProxyAgentLayer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
