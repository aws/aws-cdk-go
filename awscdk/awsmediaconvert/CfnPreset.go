...
func (j *jsiiProxy_CfnPreset) AttrName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrName",
...
func (j *jsiiProxy_CfnPreset) Category() *string {
	var returns *string
	_jsii_.Get(
		j,
		"category",
...
func (j *jsiiProxy_CfnPreset) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnPreset) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnPreset) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPreset) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnPreset) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnPreset) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnPreset) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnPreset) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPreset) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPreset) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnPreset) SettingsJson() interface{} {
...
func (j *jsiiProxy_CfnPreset) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnPreset) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPreset) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPreset(scope constructs.Construct, id *string, props *CfnPresetProps) CfnPreset {
	...
	if err := validateNewCfnPresetParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnPreset{}
...
func (j *jsiiProxy_CfnPreset)SetCategory(val *string) {
	_jsii_.Set(
		j,
		"category",
		val,
...
func (j *jsiiProxy_CfnPreset)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnPreset)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnPreset)SetSettingsJson(val interface{}) {
...
func CfnPreset_ArnForPreset(resource interfacesawsmediaconvert.IPresetRef) *string {
	_init_.Initialize()

	if err := validateCfnPreset_ArnForPresetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPreset_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPreset_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPreset_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPreset_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPreset_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPreset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPreset) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnPreset) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreset) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnPreset) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnPreset) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnPreset) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPreset) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPreset) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnPreset) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPreset) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPreset) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnPreset) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPreset) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreset) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreset) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnPreset) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPreset) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnPreset) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnPreset) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnPreset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
