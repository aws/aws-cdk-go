...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsbedrockmantle/internal"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawsbedrockmantle"
...
//
//   cfnProject := awscdk.Aws_bedrockmantle.NewCfnProject(this, jsii.String("MyCfnProject"), &CfnProjectProps{
...
type CfnProject interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrockmantle.IProjectRef
	awscdk.ITaggableV2
	...
	ProjectRef() *interfacesawsbedrockmantle.ProjectReference
...
type jsiiProxy_CfnProject struct {
	...
	internal.Type__interfacesawsbedrockmantleIProjectRef
...
func (j *jsiiProxy_CfnProject) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProject) ProjectRef() *interfacesawsbedrockmantle.ProjectReference {
	var returns *interfacesawsbedrockmantle.ProjectReference
	_jsii_.Get(
		j,
		"projectRef",
		&returns,
...
func NewCfnProject(scope constructs.Construct, id *string, props *CfnProjectProps) CfnProject {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_bedrockmantle.CfnProject",
...
func CfnProject_ArnForProject(resource interfacesawsbedrockmantle.IProjectRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnProject) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProject) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProject) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProject) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
