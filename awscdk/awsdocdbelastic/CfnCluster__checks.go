...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawsdocdbelastic.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetAdminUserNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetAuthTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCluster) validateSetShardCapacityParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCluster) validateSetShardCountParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
