...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsdocdbelastic/internal"
...
func (j *jsiiProxy_CfnCluster) AdminUserPassword() *string {
	var returns *string
	_jsii_.Get(
		j,
		"adminUserPassword",
...
func (j *jsiiProxy_CfnCluster) AttrClusterEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrClusterEndpoint",
...
func (j *jsiiProxy_CfnCluster) AuthType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authType",
...
func (j *jsiiProxy_CfnCluster) ShardCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"shardCapacity",
...
func (j *jsiiProxy_CfnCluster) ShardCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"shardCount",
...
func (j *jsiiProxy_CfnCluster) SubnetIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnetIds",
...
func NewCfnCluster(scope awscdk.Construct, id *string, props *CfnClusterProps) CfnCluster {
	...
	_jsii_.Create(
		"monocdk.aws_docdbelastic.CfnCluster",
...
func (j *jsiiProxy_CfnCluster)SetAdminUserName(val *string) {
...
func (j *jsiiProxy_CfnCluster)SetAdminUserPassword(val *string) {
	_jsii_.Set(
		j,
		"adminUserPassword",
		val,
...
func (j *jsiiProxy_CfnCluster)SetAuthType(val *string) {
...
func (j *jsiiProxy_CfnCluster)SetShardCapacity(val *float64) {
...
func (j *jsiiProxy_CfnCluster)SetShardCount(val *float64) {
...
func (j *jsiiProxy_CfnCluster)SetSubnetIds(val *[]*string) {
	_jsii_.Set(
		j,
		"subnetIds",
		val,
