...
//
//   cfnFirewallDomainList := awscdk.Aws_route53globalresolver.NewCfnFirewallDomainList(this, jsii.String("MyCfnFirewallDomainList"), &CfnFirewallDomainListProps{
...
type CfnFirewallDomainList interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsroute53globalresolver.IFirewallDomainListRef
	awscdk.ITaggableV2
	AttrArn() *string
	AttrCreatedAt() *string
	AttrDomainCount() *float64
	AttrFirewallDomainListId() *string
	AttrStatus() *string
	...
	FirewallDomainListRef() *interfacesawsroute53globalresolver.FirewallDomainListReference
...
type jsiiProxy_CfnFirewallDomainList struct {
	...
	internal.Type__interfacesawsroute53globalresolverIFirewallDomainListRef
...
func (j *jsiiProxy_CfnFirewallDomainList) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnFirewallDomainList) AttrFirewallDomainListId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFirewallDomainListId",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnFirewallDomainList) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnFirewallDomainList) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnFirewallDomainList) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFirewallDomainList) ClientToken() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientToken",
...
func (j *jsiiProxy_CfnFirewallDomainList) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnFirewallDomainList) FirewallDomainListRef() *interfacesawsroute53globalresolver.FirewallDomainListReference {
	var returns *interfacesawsroute53globalresolver.FirewallDomainListReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFirewallDomainList) GlobalResolverId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"globalResolverId",
...
func (j *jsiiProxy_CfnFirewallDomainList) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnFirewallDomainList) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnFirewallDomainList(scope constructs.Construct, id *string, props *CfnFirewallDomainListProps) CfnFirewallDomainList {
	...
	if err := validateNewCfnFirewallDomainListParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFirewallDomainList)SetClientToken(val *string) {
	_jsii_.Set(
		j,
		"clientToken",
		val,
...
func (j *jsiiProxy_CfnFirewallDomainList)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnFirewallDomainList)SetGlobalResolverId(val *string) {
...
func (j *jsiiProxy_CfnFirewallDomainList)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnFirewallDomainList_ArnForFirewallDomainList(resource interfacesawsroute53globalresolver.IFirewallDomainListRef) *string {
	_init_.Initialize()
...
func CfnFirewallDomainList_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFirewallDomainList_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallDomainList_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFirewallDomainList_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallDomainList_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFirewallDomainList_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFirewallDomainList) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallDomainList) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFirewallDomainList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFirewallDomainList) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFirewallDomainList) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFirewallDomainList) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFirewallDomainList) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallDomainList) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallDomainList) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallDomainList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
