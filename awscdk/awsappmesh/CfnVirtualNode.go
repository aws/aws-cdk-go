...
func (j *jsiiProxy_CfnVirtualNode) CfnPropertyNames() *map[string]*string {
...
func CfnVirtualNode_ArnForVirtualNode(resource interfacesawsappmesh.IVirtualNodeRef) *string {
	_init_.Initialize()

	if err := validateCfnVirtualNode_ArnForVirtualNodeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnVirtualNode.
func CfnVirtualNode_IsCfnVirtualNode(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualNode_IsCfnVirtualNodeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualNode) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualNode) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualNode) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualNode) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualNode) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
