...
func (j *jsiiProxy_CfnGatewayRoute) CfnPropertyNames() *map[string]*string {
...
func CfnGatewayRoute_ArnForGatewayRoute(resource interfacesawsappmesh.IGatewayRouteRef) *string {
	_init_.Initialize()

	if err := validateCfnGatewayRoute_ArnForGatewayRouteParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnGatewayRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGatewayRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGatewayRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGatewayRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGatewayRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGatewayRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
