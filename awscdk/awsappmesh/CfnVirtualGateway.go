...
func (j *jsiiProxy_CfnVirtualGateway) CfnPropertyNames() *map[string]*string {
...
func CfnVirtualGateway_ArnForVirtualGateway(resource interfacesawsappmesh.IVirtualGatewayRef) *string {
	_init_.Initialize()

	if err := validateCfnVirtualGateway_ArnForVirtualGatewayParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnVirtualGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
