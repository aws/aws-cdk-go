...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.AcmCertificateOptions",
		reflect.TypeOf((*AcmCertificateOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.AcmTrustOptions",
		reflect.TypeOf((*AcmTrustOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ClientPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
		},
		func() interface{} {
			return &jsiiProxy_ClientPolicy{}
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.ClientPolicyConfig",
		reflect.TypeOf((*ClientPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.ClientPolicyOptions",
		reflect.TypeOf((*ClientPolicyOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.CloudMapServiceDiscoveryOptions",
		reflect.TypeOf((*CloudMapServiceDiscoveryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.FileCertificateOptions",
		reflect.TypeOf((*FileCertificateOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.FileTrustOptions",
		reflect.TypeOf((*FileTrustOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*HttpHeaderMatch)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
		},
		func() interface{} {
			return &jsiiProxy_HttpHeaderMatch{}
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_appmesh.HttpHeaderMatchConfig",
	...
	_jsii_.RegisterEnum(
		"aws-cdk-lib.aws_appmesh.HttpRouteMatchMethod",
		reflect.TypeOf((*HttpRouteMatchMethod)(nil)).Elem(),
		map[string]interface{}{
			"GET": HttpRouteMatchMethod_GET,
			"HEAD": HttpRouteMatchMethod_HEAD,
			"POST": HttpRouteMatchMethod_POST,
			"PUT": HttpRouteMatchMethod_PUT,
			"DELETE": HttpRouteMatchMethod_DELETE,
			"CONNECT": HttpRouteMatchMethod_CONNECT,
			"OPTIONS": HttpRouteMatchMethod_OPTIONS,
			"TRACE": HttpRouteMatchMethod_TRACE,
			"PATCH": HttpRouteMatchMethod_PATCH,
		},
	)
	_jsii_.RegisterEnum(
