...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_appmesh.TlsListener",
		reflect.TypeOf((*TlsListener)(nil)).Elem(),
	)
	_jsii_.RegisterEnum(
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_appmesh.TlsValidationAcmTrustOptions",
		reflect.TypeOf((*TlsValidationAcmTrustOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_appmesh.TlsValidationFileTrustOptions",
		reflect.TypeOf((*TlsValidationFileTrustOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
