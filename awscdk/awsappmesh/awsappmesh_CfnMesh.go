...
func (j *jsiiProxy_CfnMesh) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMesh(scope constructs.Construct, id *string, props *CfnMeshProps) CfnMesh {
	...
	if err := validateNewCfnMeshParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnMesh{}
...
func CfnMesh_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMesh_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMesh_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnMesh_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMesh_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMesh_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMesh) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMesh) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMesh) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMesh) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnMesh) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMesh) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
