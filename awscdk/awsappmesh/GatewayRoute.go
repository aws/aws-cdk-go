...
func (j *jsiiProxy_GatewayRoute) Env() *interfaces.ResourceEnvironment {
...
func GatewayRoute_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appmesh.GatewayRoute",
...
func (g *jsiiProxy_GatewayRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GatewayRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
