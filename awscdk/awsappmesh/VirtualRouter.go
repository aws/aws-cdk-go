...
func (j *jsiiProxy_VirtualRouter) Env() *interfaces.ResourceEnvironment {
...
func VirtualRouter_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appmesh.VirtualRouter",
...
func (v *jsiiProxy_VirtualRouter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VirtualRouter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
