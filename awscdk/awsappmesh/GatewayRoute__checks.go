...
func (g *jsiiProxy_GatewayRoute) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateGatewayRoute_FromGatewayRouteArnParameters(scope constructs.Construct, id *string, gatewayRouteArn *string) error {
	...
	if gatewayRouteArn == nil {
		return fmt.Errorf("parameter gatewayRouteArn is required, but nil was provided")
	}
