...
func (j *jsiiProxy_CfnMesh) CfnPropertyNames() *map[string]*string {
...
func CfnMesh_ArnForMesh(resource interfacesawsappmesh.IMeshRef) *string {
	_init_.Initialize()

	if err := validateCfnMesh_ArnForMeshParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMesh_IsCfnMesh(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMesh_IsCfnMeshParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMesh_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnMesh_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMesh) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMesh) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMesh) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMesh) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMesh) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
