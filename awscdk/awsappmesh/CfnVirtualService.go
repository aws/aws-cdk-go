...
func (j *jsiiProxy_CfnVirtualService) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVirtualService) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVirtualService(scope constructs.Construct, id *string, props *CfnVirtualServiceProps) CfnVirtualService {
	...
	if err := validateNewCfnVirtualServiceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVirtualService_ArnForVirtualService(resource interfacesawsappmesh.IVirtualServiceRef) *string {
	_init_.Initialize()

	if err := validateCfnVirtualService_ArnForVirtualServiceParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnVirtualService_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVirtualService_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVirtualService_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualService_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnVirtualService.
func CfnVirtualService_IsCfnVirtualService(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualService_IsCfnVirtualServiceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVirtualService_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVirtualService_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualService) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualService) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualService) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualService) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualService) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVirtualService) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVirtualService) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualService) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualService) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
