...
func (v *jsiiProxy_VirtualGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VirtualGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
