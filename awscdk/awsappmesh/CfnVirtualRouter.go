...
func (j *jsiiProxy_CfnVirtualRouter) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVirtualRouter) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnVirtualRouter_ArnForVirtualRouter(resource interfacesawsappmesh.IVirtualRouterRef) *string {
	_init_.Initialize()

	if err := validateCfnVirtualRouter_ArnForVirtualRouterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnVirtualRouter_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualRouter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualRouter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualRouter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualRouter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualRouter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualRouter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVirtualRouter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVirtualRouter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualRouter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualRouter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualRouter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
