...
func (j *jsiiProxy_CfnServer) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnServer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
