...
func (c *jsiiProxy_CfnServer) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnServer) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnServer) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnServer) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func validateCfnServer_ArnForServerParameters(resource interfacesawsopsworkscm.IServerRef) error {
	return nil
}
...
func validateCfnServer_IsCfnServerParameters(x interface{}) error {
	return nil
}
...
func (j *jsiiProxy_CfnServer) validateSetAssociatePublicIpAddressParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnServer) validateSetDisableAutomatedBackupParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnServer) validateSetEngineAttributesParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnServer) validateSetInstanceProfileArnParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnServer) validateSetInstanceTypeParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnServer) validateSetServiceRoleArnParameters(val *string) error {
	return nil
}
