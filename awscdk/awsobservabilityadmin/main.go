...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_observabilityadmin.CfnOrganizationTelemetryRule.LogDeliveryParametersProperty",
		reflect.TypeOf((*CfnOrganizationTelemetryRule_LogDeliveryParametersProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnTelemetryEnrichment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsobservabilityadminITelemetryEnrichmentRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_observabilityadmin.CfnTelemetryEnrichmentProps",
		reflect.TypeOf((*CfnTelemetryEnrichmentProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
