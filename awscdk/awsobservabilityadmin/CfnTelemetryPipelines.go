...
// The jsii proxy struct for CfnTelemetryPipelines
type jsiiProxy_CfnTelemetryPipelines struct {
	internal.Type__awscdkCfnResource
	internal.Type__awscdkIInspectable
	internal.Type__interfacesawsobservabilityadminITelemetryPipelinesRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnTelemetryPipelines) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnTelemetryPipelines) AttrPipeline() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnTelemetryPipelines) AttrPipelineIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPipelineIdentifier",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnTelemetryPipelines) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnTelemetryPipelines) AttrStatusReason() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrStatusReason",
...
func (j *jsiiProxy_CfnTelemetryPipelines) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTelemetryPipelines) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTelemetryPipelines) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTelemetryPipelines) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTelemetryPipelines) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTelemetryPipelines) Configuration() interface{} {
...
func (j *jsiiProxy_CfnTelemetryPipelines) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTelemetryPipelines) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnTelemetryPipelines) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTelemetryPipelines) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnTelemetryPipelines) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTelemetryPipelines) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTelemetryPipelines) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTelemetryPipelines) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTelemetryPipelines) TelemetryPipelinesRef() *interfacesawsobservabilityadmin.TelemetryPipelinesReference {
	var returns *interfacesawsobservabilityadmin.TelemetryPipelinesReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTelemetryPipelines) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTelemetryPipelines) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTelemetryPipelines(scope constructs.Construct, id *string, props *CfnTelemetryPipelinesProps) CfnTelemetryPipelines {
	...
	if err := validateNewCfnTelemetryPipelinesParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTelemetryPipelines)SetConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnTelemetryPipelines)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnTelemetryPipelines)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnTelemetryPipelines_ArnForTelemetryPipelines(resource interfacesawsobservabilityadmin.ITelemetryPipelinesRef) *string {
	...
	if err := validateCfnTelemetryPipelines_ArnForTelemetryPipelinesParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTelemetryPipelines_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTelemetryPipelines_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTelemetryPipelines_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTelemetryPipelines_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTelemetryPipelines_IsCfnTelemetryPipelines(x interface{}) *bool {
	...
	if err := validateCfnTelemetryPipelines_IsCfnTelemetryPipelinesParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTelemetryPipelines_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTelemetryPipelines_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTelemetryPipelines) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTelemetryPipelines) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTelemetryPipelines) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTelemetryPipelines) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTelemetryPipelines) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTelemetryPipelines) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTelemetryPipelines) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTelemetryPipelines) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
