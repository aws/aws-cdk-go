...
func (j *jsiiProxy_IOrganizationCentralizationRuleRef) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_IOrganizationCentralizationRuleRef) Node() constructs.Node {
