...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) AttrRegionStatuses() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) AttrRuleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRuleArn",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) Rule() interface{} {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) RuleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleName",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOrganizationTelemetryRule(scope constructs.Construct, id *string, props *CfnOrganizationTelemetryRuleProps) CfnOrganizationTelemetryRule {
	...
	if err := validateNewCfnOrganizationTelemetryRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule)SetRule(val interface{}) {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule)SetRuleName(val *string) {
...
func (j *jsiiProxy_CfnOrganizationTelemetryRule)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnOrganizationTelemetryRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOrganizationTelemetryRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationTelemetryRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOrganizationTelemetryRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOrganizationTelemetryRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOrganizationTelemetryRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOrganizationTelemetryRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
