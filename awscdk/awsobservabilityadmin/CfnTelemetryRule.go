...
func (j *jsiiProxy_CfnTelemetryRule) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTelemetryRule) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTelemetryRule) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTelemetryRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTelemetryRule) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTelemetryRule) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTelemetryRule) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTelemetryRule) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTelemetryRule) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTelemetryRule) Rule() interface{} {
...
func (j *jsiiProxy_CfnTelemetryRule) RuleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleName",
...
func (j *jsiiProxy_CfnTelemetryRule) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTelemetryRule) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTelemetryRule) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTelemetryRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTelemetryRule(scope constructs.Construct, id *string, props *CfnTelemetryRuleProps) CfnTelemetryRule {
	...
	if err := validateNewCfnTelemetryRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTelemetryRule)SetRule(val interface{}) {
...
func (j *jsiiProxy_CfnTelemetryRule)SetRuleName(val *string) {
...
func (j *jsiiProxy_CfnTelemetryRule)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnTelemetryRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTelemetryRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTelemetryRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTelemetryRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTelemetryRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTelemetryRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTelemetryRule) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTelemetryRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTelemetryRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTelemetryRule) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTelemetryRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTelemetryRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTelemetryRule) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTelemetryRule) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTelemetryRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTelemetryRule) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTelemetryRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryRule) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTelemetryRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTelemetryRule) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTelemetryRule) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTelemetryRule) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTelemetryRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
