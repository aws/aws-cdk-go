...
func NewCfnRuleset(scope constructs.Construct, id *string, props *CfnRulesetProps) CfnRuleset {
	...
	if err := validateNewCfnRulesetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRuleset_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRuleset_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleset_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnRuleset_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleset_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRuleset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuleset) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleset) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRuleset) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRuleset) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnRuleset) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleset) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
