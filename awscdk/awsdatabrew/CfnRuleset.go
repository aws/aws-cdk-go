...
func (j *jsiiProxy_CfnRuleset) CfnPropertyNames() *map[string]*string {
...
func CfnRuleset_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRuleset_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleset_IsCfnRuleset(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRuleset_IsCfnRulesetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuleset) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRuleset) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRuleset) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRuleset) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
