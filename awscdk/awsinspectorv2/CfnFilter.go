...
func (j *jsiiProxy_CfnFilter) CfnPropertyNames() *map[string]*string {
...
func CfnFilter_ArnForFilter(resource interfacesawsinspectorv2.IFilterRef) *string {
	_init_.Initialize()

	if err := validateCfnFilter_ArnForFilterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
