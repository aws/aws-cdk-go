...
func (c *jsiiProxy_CfnMacro) validateAddDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnMacro) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnMacro) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnMacro) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnMacro) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnMacro) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnMacro) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	return nil
}
...
func validateNewCfnMacroParameters(scope constructs.Construct, id *string, props *CfnMacroProps) error {
	return nil
}
