...
func (c *jsiiProxy_CfnWaitCondition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitCondition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWaitCondition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWaitCondition) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnWaitCondition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitCondition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
