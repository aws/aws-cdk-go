...
func (j *jsiiProxy_CfnMacro) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMacro) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMacro(scope constructs.Construct, id *string, props *CfnMacroProps) CfnMacro {
	...
	if err := validateNewCfnMacroParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMacro_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMacro_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMacro_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMacro_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMacro_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMacro_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMacro) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMacro) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMacro) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMacro) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMacro) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMacro) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMacro) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMacro) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMacro) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMacro) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
