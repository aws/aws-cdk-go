...
func (c *jsiiProxy_CfnHookTypeConfig) validateAddDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnHookTypeConfig) validateAddDependsOnParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnHookTypeConfig) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnHookTypeConfig) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}

func (c *jsiiProxy_CfnHookTypeConfig) validateApplyRemovalPolicyParameters(options *awscdk.RemovalPolicyOptions) error {
	return nil
}

func (c *jsiiProxy_CfnHookTypeConfig) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnHookTypeConfig) validateInspectParameters(inspector awscdk.TreeInspector) error {
	return nil
}
...
func (c *jsiiProxy_CfnHookTypeConfig) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnHookTypeConfig) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnHookTypeConfig) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	return nil
}
...
func validateCfnHookTypeConfig_IsCfnHookTypeConfigParameters(x interface{}) error {
	return nil
}

func validateCfnHookTypeConfig_IsCfnResourceParameters(x interface{}) error {
	return nil
}
