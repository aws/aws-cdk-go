...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudformation.CustomResourceProps",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudformation.CustomResourceProviderConfig",
		reflect.TypeOf((*CustomResourceProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_cloudformation.ICustomResourceProvider",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudformation.NestedStackProps",
