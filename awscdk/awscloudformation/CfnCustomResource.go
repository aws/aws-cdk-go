...
func (j *jsiiProxy_CfnCustomResource) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCustomResource) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCustomResource(scope constructs.Construct, id *string, props *CfnCustomResourceProps) CfnCustomResource {
	...
	if err := validateNewCfnCustomResourceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCustomResource_IsCfnCustomResource(x interface{}) *bool {
	...
	if err := validateCfnCustomResource_IsCfnCustomResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomResource_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomResource_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomResource_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCustomResource_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomResource_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomResource_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomResource) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomResource) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomResource) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomResource) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomResource) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomResource) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomResource) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomResource) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomResource) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
