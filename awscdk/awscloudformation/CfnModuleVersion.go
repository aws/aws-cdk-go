...
func (j *jsiiProxy_CfnModuleVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnModuleVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnModuleVersion(scope constructs.Construct, id *string, props *CfnModuleVersionProps) CfnModuleVersion {
	...
	if err := validateNewCfnModuleVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnModuleVersion)SetModulePackage(val *string) {
	if err := j.validateSetModulePackageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnModuleVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnModuleVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModuleVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnModuleVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModuleVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnModuleVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModuleVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModuleVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModuleVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModuleVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnModuleVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnModuleVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
