...
func (c *jsiiProxy_CfnModuleVersion) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateNewCfnModuleVersionParameters(scope awscdk.Construct, id *string, props *CfnModuleVersionProps) error {
	if scope == nil {
