...
func (j *jsiiProxy_CfnGuardHook) validateSetOptionsParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardHook_OptionsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnGuardHook) validateSetRuleLocationParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardHook_S3LocationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnGuardHook) validateSetStackFiltersParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardHook_StackFiltersProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnGuardHook) validateSetTargetFiltersParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnGuardHook_TargetFiltersProperty; received %#v (a %T)", val, val)
		}
	}
