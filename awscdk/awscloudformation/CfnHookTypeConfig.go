...
func (j *jsiiProxy_CfnHookTypeConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHookTypeConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnHookTypeConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHookTypeConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHookTypeConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookTypeConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHookTypeConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHookTypeConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHookTypeConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHookTypeConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHookTypeConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookTypeConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookTypeConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookTypeConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
