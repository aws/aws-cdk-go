...
func (j *jsiiProxy_CfnPublicTypeVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPublicTypeVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPublicTypeVersion(scope constructs.Construct, id *string, props *CfnPublicTypeVersionProps) CfnPublicTypeVersion {
	...
	if err := validateNewCfnPublicTypeVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPublicTypeVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPublicTypeVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicTypeVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPublicTypeVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicTypeVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPublicTypeVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublicTypeVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPublicTypeVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPublicTypeVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPublicTypeVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicTypeVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
