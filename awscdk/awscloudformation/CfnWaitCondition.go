...
func (j *jsiiProxy_CfnWaitCondition) CfnPropertyNames() *map[string]*string {
...
func CfnWaitCondition_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWaitCondition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWaitCondition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWaitCondition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWaitCondition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWaitCondition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitCondition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
