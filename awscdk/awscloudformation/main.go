...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_cloudformation.CfnChangeSet",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudformation.CfnChangeSet.TagsItemsProperty",
		reflect.TypeOf((*CfnChangeSet_TagsItemsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudformation.CfnChangeSetProps",
