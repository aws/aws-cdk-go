...
func (j *jsiiProxy_CfnTypeActivation) CfnPropertyNames() *map[string]*string {
...
func CfnTypeActivation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTypeActivation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTypeActivation_IsCfnTypeActivation(x interface{}) *bool {
	...
	if err := validateCfnTypeActivation_IsCfnTypeActivationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTypeActivation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTypeActivation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTypeActivation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTypeActivation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTypeActivation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTypeActivation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
