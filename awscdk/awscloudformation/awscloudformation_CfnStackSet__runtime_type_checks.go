...
func (c *jsiiProxy_CfnStackSet) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_CfnStackSet) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnStackSet) validateSetAutoDeploymentParameters(val interface{}) error {
	switch val.(type) {
	case *CfnStackSet_AutoDeploymentProperty:
		val := val.(*CfnStackSet_AutoDeploymentProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnStackSet_AutoDeploymentProperty:
		val_ := val.(CfnStackSet_AutoDeploymentProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnStackSet_AutoDeploymentProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnStackSet) validateSetManagedExecutionParameters(val interface{}) error {
	switch val.(type) {
	case *CfnStackSet_ManagedExecutionProperty:
		val := val.(*CfnStackSet_ManagedExecutionProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnStackSet_ManagedExecutionProperty:
		val_ := val.(CfnStackSet_ManagedExecutionProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnStackSet_ManagedExecutionProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnStackSet) validateSetOperationPreferencesParameters(val interface{}) error {
	switch val.(type) {
	case *CfnStackSet_OperationPreferencesProperty:
		val := val.(*CfnStackSet_OperationPreferencesProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnStackSet_OperationPreferencesProperty:
		val_ := val.(CfnStackSet_OperationPreferencesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnStackSet_OperationPreferencesProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnStackSet) validateSetParametersParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			switch v.(type) {
			case *CfnStackSet_ParameterProperty:
				v := v.(*CfnStackSet_ParameterProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnStackSet_ParameterProperty:
				v_ := v.(CfnStackSet_ParameterProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: *CfnStackSet_ParameterProperty, awscdk.IResolvable; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnStackSet) validateSetStackInstancesGroupParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			switch v.(type) {
			case *CfnStackSet_StackInstancesProperty:
				v := v.(*CfnStackSet_StackInstancesProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnStackSet_StackInstancesProperty:
				v_ := v.(CfnStackSet_StackInstancesProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			...
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: *CfnStackSet_StackInstancesProperty, awscdk.IResolvable; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func validateNewCfnStackSetParameters(scope awscdk.Construct, id *string, props *CfnStackSetProps) error {
	if scope == nil {
