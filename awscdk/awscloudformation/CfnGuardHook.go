...
//
//   cfnGuardHook := awscdk.Aws_cloudformation.NewCfnGuardHook(this, jsii.String("MyCfnGuardHook"), &CfnGuardHookProps{
...
func (j *jsiiProxy_CfnGuardHook) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnGuardHook) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGuardHook) Stack() awscdk.Stack {
...
func (c *jsiiProxy_CfnGuardHook) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardHook) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardHook) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGuardHook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGuardHook) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGuardHook) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGuardHook) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGuardHook) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGuardHook) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardHook) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardHook) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGuardHook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
