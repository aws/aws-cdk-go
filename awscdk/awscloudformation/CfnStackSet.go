...
func (j *jsiiProxy_CfnStackSet) CfnPropertyNames() *map[string]*string {
...
func CfnStackSet_IsCfnStackSet(x interface{}) *bool {
	...
	if err := validateCfnStackSet_IsCfnStackSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStackSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStackSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStackSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStackSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStackSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
