...
func (c *jsiiProxy_CfnResourceVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
