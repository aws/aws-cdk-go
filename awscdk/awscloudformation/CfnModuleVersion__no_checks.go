...
func (c *jsiiProxy_CfnModuleVersion) validateAddDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnModuleVersion) validateAddDependsOnParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnModuleVersion) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnModuleVersion) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}

func (c *jsiiProxy_CfnModuleVersion) validateApplyRemovalPolicyParameters(options *awscdk.RemovalPolicyOptions) error {
	return nil
}

func (c *jsiiProxy_CfnModuleVersion) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnModuleVersion) validateInspectParameters(inspector awscdk.TreeInspector) error {
	return nil
}
...
func (c *jsiiProxy_CfnModuleVersion) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnModuleVersion) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnModuleVersion) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	return nil
}
...
func validateCfnModuleVersion_IsCfnModuleVersionParameters(x interface{}) error {
	return nil
}

func validateCfnModuleVersion_IsCfnResourceParameters(x interface{}) error {
	return nil
}
