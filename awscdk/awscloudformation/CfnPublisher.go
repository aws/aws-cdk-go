...
func (c *jsiiProxy_CfnPublisher) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublisher) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublisher) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPublisher) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
