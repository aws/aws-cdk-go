...
//
//   cfnLambdaHook := awscdk.Aws_cloudformation.NewCfnLambdaHook(this, jsii.String("MyCfnLambdaHook"), &CfnLambdaHookProps{
...
func (j *jsiiProxy_CfnLambdaHook) Stack() awscdk.Stack {
...
func (c *jsiiProxy_CfnLambdaHook) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLambdaHook) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLambdaHook) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLambdaHook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLambdaHook) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnLambdaHook) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLambdaHook) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnLambdaHook) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLambdaHook) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLambdaHook) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
