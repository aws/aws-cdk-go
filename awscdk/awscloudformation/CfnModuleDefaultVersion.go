...
func (c *jsiiProxy_CfnModuleDefaultVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) RemoveResourceDependency(target awscdk.CfnResource) {
