...
func (j *jsiiProxy_CfnModuleDefaultVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnModuleDefaultVersion(scope constructs.Construct, id *string, props *CfnModuleDefaultVersionProps) CfnModuleDefaultVersion {
	...
	if err := validateNewCfnModuleDefaultVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnModuleDefaultVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnModuleDefaultVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModuleDefaultVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnModuleDefaultVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnModuleDefaultVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnModuleDefaultVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModuleDefaultVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
