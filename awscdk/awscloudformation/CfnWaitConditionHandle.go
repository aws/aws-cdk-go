...
//
//   cfnWaitConditionHandle := awscdk.Aws_cloudformation.NewCfnWaitConditionHandle(this, jsii.String("MyCfnWaitConditionHandle"), &CfnWaitConditionHandleProps{
//   })
//
...
func (c *jsiiProxy_CfnWaitConditionHandle) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWaitConditionHandle) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
