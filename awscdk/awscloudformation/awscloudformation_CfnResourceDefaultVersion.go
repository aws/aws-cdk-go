...
func (j *jsiiProxy_CfnResourceDefaultVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceDefaultVersion(scope constructs.Construct, id *string, props *CfnResourceDefaultVersionProps) CfnResourceDefaultVersion {
	...
	if err := validateNewCfnResourceDefaultVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResourceDefaultVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceDefaultVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefaultVersion_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResourceDefaultVersion_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceDefaultVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceDefaultVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceDefaultVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceDefaultVersion) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceDefaultVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
