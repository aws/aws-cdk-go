...
func (j *jsiiProxy_CfnHookDefaultVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHookDefaultVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnHookDefaultVersion(scope constructs.Construct, id *string, props *CfnHookDefaultVersionProps) CfnHookDefaultVersion {
	...
	if err := validateNewCfnHookDefaultVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnHookDefaultVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnHookDefaultVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHookDefaultVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHookDefaultVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHookDefaultVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnHookDefaultVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHookDefaultVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHookDefaultVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHookDefaultVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHookDefaultVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHookDefaultVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
