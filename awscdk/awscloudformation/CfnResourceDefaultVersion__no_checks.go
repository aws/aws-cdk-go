...
func (c *jsiiProxy_CfnResourceDefaultVersion) validateAddDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnResourceDefaultVersion) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnResourceDefaultVersion) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnResourceDefaultVersion) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnResourceDefaultVersion) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnResourceDefaultVersion) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnResourceDefaultVersion) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	return nil
}
...
func validateCfnResourceDefaultVersion_IsCfnResourceParameters(x interface{}) error {
	return nil
}

func validateCfnResourceDefaultVersion_IsCfnResourceDefaultVersionParameters(x interface{}) error {
	return nil
}
...
func validateNewCfnResourceDefaultVersionParameters(scope constructs.Construct, id *string, props *CfnResourceDefaultVersionProps) error {
	return nil
}
