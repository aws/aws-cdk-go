...
func (j *jsiiProxy_CfnVpcEndpoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVpcEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func NewCfnVpcEndpoint(scope constructs.Construct, id *string, props *CfnVpcEndpointProps) CfnVpcEndpoint {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_opensearchserverless.CfnVpcEndpoint",
...
func (j *jsiiProxy_CfnVpcEndpoint)SetName(val *string) {
...
func CfnVpcEndpoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVpcEndpoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcEndpoint_IsCfnVpcEndpoint(x interface{}) *bool {
	...
	if err := validateCfnVpcEndpoint_IsCfnVpcEndpointParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcEndpoint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcEndpoint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVpcEndpoint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVpcEndpoint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcEndpoint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
