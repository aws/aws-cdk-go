...
func (j *jsiiProxy_CfnSecurityConfig) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSecurityConfig) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSecurityConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityConfig) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSecurityConfig) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSecurityConfig) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnSecurityConfig) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSecurityConfig) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnSecurityConfig) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSecurityConfig) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSecurityConfig) SamlOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"samlOptions",
...
func (j *jsiiProxy_CfnSecurityConfig) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSecurityConfig) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnSecurityConfig) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSecurityConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityConfig(scope constructs.Construct, id *string, props *CfnSecurityConfigProps) CfnSecurityConfig {
	...
	if err := validateNewCfnSecurityConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnSecurityConfig{}

	_jsii_.Create(
		"aws-cdk-lib.aws_opensearchserverless.CfnSecurityConfig",
...
func (j *jsiiProxy_CfnSecurityConfig)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnSecurityConfig)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnSecurityConfig)SetSamlOptions(val interface{}) {
	if err := j.validateSetSamlOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSecurityConfig)SetType(val *string) {
	_jsii_.Set(
		j,
		"type",
		val,
...
func CfnSecurityConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecurityConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityConfig_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityConfig_IsCfnSecurityConfig(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityConfig_IsCfnSecurityConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecurityConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityConfig) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityConfig) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSecurityConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityConfig) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSecurityConfig) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSecurityConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityConfig) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSecurityConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfig) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSecurityConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityConfig) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityConfig) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSecurityConfig) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSecurityConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
