...
func (j *jsiiProxy_CfnSecurityPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSecurityPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSecurityPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSecurityPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnSecurityPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSecurityPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnSecurityPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSecurityPolicy) Policy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnSecurityPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSecurityPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSecurityPolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnSecurityPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSecurityPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityPolicy(scope constructs.Construct, id *string, props *CfnSecurityPolicyProps) CfnSecurityPolicy {
	...
	if err := validateNewCfnSecurityPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSecurityPolicy)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnSecurityPolicy)SetName(val *string) {
...
func (j *jsiiProxy_CfnSecurityPolicy)SetPolicy(val *string) {
...
func (j *jsiiProxy_CfnSecurityPolicy)SetType(val *string) {
...
func CfnSecurityPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecurityPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityPolicy_IsCfnSecurityPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecurityPolicy_IsCfnSecurityPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecurityPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSecurityPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSecurityPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSecurityPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSecurityPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSecurityPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSecurityPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSecurityPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSecurityPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
