...
type CfnLifecyclePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsopensearchserverless.ILifecyclePolicyRef
	...
	LifecyclePolicyRef() *interfacesawsopensearchserverless.LifecyclePolicyReference
...
type jsiiProxy_CfnLifecyclePolicy struct {
	...
	internal.Type__interfacesawsopensearchserverlessILifecyclePolicyRef
}
...
func (j *jsiiProxy_CfnLifecyclePolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLifecyclePolicy) LifecyclePolicyRef() *interfacesawsopensearchserverless.LifecyclePolicyReference {
	var returns *interfacesawsopensearchserverless.LifecyclePolicyReference
	_jsii_.Get(
		j,
		"lifecyclePolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnLifecyclePolicy) Policy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnLifecyclePolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnLifecyclePolicy)SetPolicy(val *string) {
...
func (j *jsiiProxy_CfnLifecyclePolicy)SetType(val *string) {
...
func (c *jsiiProxy_CfnLifecyclePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLifecyclePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLifecyclePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLifecyclePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLifecyclePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
