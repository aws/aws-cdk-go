...
func (j *jsiiProxy_CfnIndex) CollectionEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"collectionEndpoint",
...
func (j *jsiiProxy_CfnIndex) Mappings() interface{} {
...
func (j *jsiiProxy_CfnIndex) Settings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"settings",
...
func (j *jsiiProxy_CfnIndex)SetCollectionEndpoint(val *string) {
...
func (j *jsiiProxy_CfnIndex)SetMappings(val interface{}) {
...
func (j *jsiiProxy_CfnIndex)SetSettings(val interface{}) {
