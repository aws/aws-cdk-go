...
func (j *jsiiProxy_CfnAccessPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccessPolicy) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAccessPolicy) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAccessPolicy) Policy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnAccessPolicy) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnAccessPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccessPolicy(scope constructs.Construct, id *string, props *CfnAccessPolicyProps) CfnAccessPolicy {
	...
	if err := validateNewCfnAccessPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAccessPolicy)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAccessPolicy)SetName(val *string) {
...
func (j *jsiiProxy_CfnAccessPolicy)SetPolicy(val *string) {
...
func (j *jsiiProxy_CfnAccessPolicy)SetType(val *string) {
...
func CfnAccessPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAccessPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
