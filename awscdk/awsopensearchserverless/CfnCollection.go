...
func (j *jsiiProxy_CfnCollection) AttrCollectionEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCollection) AttrDashboardEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCollection) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnCollection) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnCollection)SetName(val *string) {
...
func (j *jsiiProxy_CfnCollection)SetType(val *string) {
	_jsii_.Set(
		j,
		"type",
		val,
...
func CfnCollection_ArnForCollection(resource interfacesawsopensearchserverless.ICollectionRef) *string {
	_init_.Initialize()
