...
type CfnAgreement interface {
	...
	CustomDirectories() interface{}
	SetCustomDirectories(val interface{})
...
func (j *jsiiProxy_CfnAgreement) AttrAgreementId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgreementId",
...
func (j *jsiiProxy_CfnAgreement) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnAgreement) BaseDirectory() *string {
	var returns *string
	_jsii_.Get(
		j,
		"baseDirectory",
...
func (j *jsiiProxy_CfnAgreement) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAgreement) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAgreement) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAgreement) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAgreement) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAgreement) CustomDirectories() interface{} {
...
func (j *jsiiProxy_CfnAgreement) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAgreement) EnforceMessageSigning() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAgreement) LocalProfileId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"localProfileId",
...
func (j *jsiiProxy_CfnAgreement) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAgreement) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAgreement) PartnerProfileId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"partnerProfileId",
...
func (j *jsiiProxy_CfnAgreement) PreserveFilename() *string {
	var returns *string
	_jsii_.Get(
		j,
		"preserveFilename",
...
func (j *jsiiProxy_CfnAgreement) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAgreement) ServerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverId",
...
func (j *jsiiProxy_CfnAgreement) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAgreement) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnAgreement) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnAgreement) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAgreement(scope constructs.Construct, id *string, props *CfnAgreementProps) CfnAgreement {
	...
	if err := validateNewCfnAgreementParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAgreement{}
...
func (j *jsiiProxy_CfnAgreement)SetAccessRole(val *string) {
...
func (j *jsiiProxy_CfnAgreement)SetBaseDirectory(val *string) {
	_jsii_.Set(
		j,
		"baseDirectory",
		val,
...
func (j *jsiiProxy_CfnAgreement)SetCustomDirectories(val interface{}) {
	if err := j.validateSetCustomDirectoriesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAgreement)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAgreement)SetEnforceMessageSigning(val *string) {
	_jsii_.Set(
		j,
		"enforceMessageSigning",
		val,
...
func (j *jsiiProxy_CfnAgreement)SetLocalProfileId(val *string) {
...
func (j *jsiiProxy_CfnAgreement)SetPartnerProfileId(val *string) {
...
func (j *jsiiProxy_CfnAgreement)SetPreserveFilename(val *string) {
	_jsii_.Set(
		j,
		"preserveFilename",
		val,
...
func (j *jsiiProxy_CfnAgreement)SetServerId(val *string) {
...
func (j *jsiiProxy_CfnAgreement)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
// Checks whether the given object is a CfnAgreement.
func CfnAgreement_IsCfnAgreement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAgreement_IsCfnAgreementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAgreement_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAgreement_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAgreement_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAgreement_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAgreement_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAgreement_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAgreement) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAgreement) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgreement) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgreement) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAgreement) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAgreement) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAgreement) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAgreement) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAgreement) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAgreement) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAgreement) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAgreement) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAgreement) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAgreement) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAgreement) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAgreement) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAgreement) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgreement) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgreement) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAgreement) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAgreement) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAgreement) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAgreement) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAgreement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
