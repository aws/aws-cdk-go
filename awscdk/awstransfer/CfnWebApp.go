...
//
//   cfnWebApp := awscdk.Aws_transfer.NewCfnWebApp(this, jsii.String("MyCfnWebApp"), &CfnWebAppProps{
...
type CfnWebApp interface {
	...
	WebAppCustomization() interface{}
	SetWebAppCustomization(val interface{})
...
func (j *jsiiProxy_CfnWebApp) AccessEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accessEndpoint",
...
func (j *jsiiProxy_CfnWebApp) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnWebApp) AttrIdentityProviderDetailsApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWebApp) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnWebApp) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnWebApp) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnWebApp) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWebApp) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnWebApp) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnWebApp) IdentityProviderDetails() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWebApp) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnWebApp) Node() constructs.Node {
...
func (j *jsiiProxy_CfnWebApp) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnWebApp) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnWebApp) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnWebApp) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnWebApp) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnWebApp) WebAppCustomization() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"webAppCustomization",
...
func (j *jsiiProxy_CfnWebApp) WebAppEndpointPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWebApp) WebAppUnits() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"webAppUnits",
...
func NewCfnWebApp(scope constructs.Construct, id *string, props *CfnWebAppProps) CfnWebApp {
	...
	if err := validateNewCfnWebAppParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnWebApp)SetAccessEndpoint(val *string) {
	_jsii_.Set(
		j,
		"accessEndpoint",
		val,
...
func (j *jsiiProxy_CfnWebApp)SetIdentityProviderDetails(val interface{}) {
...
func (j *jsiiProxy_CfnWebApp)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnWebApp)SetWebAppCustomization(val interface{}) {
	if err := j.validateSetWebAppCustomizationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnWebApp)SetWebAppEndpointPolicy(val *string) {
	_jsii_.Set(
		j,
		"webAppEndpointPolicy",
		val,
...
func (j *jsiiProxy_CfnWebApp)SetWebAppUnits(val interface{}) {
	if err := j.validateSetWebAppUnitsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnWebApp_ArnForWebApp(resource interfacesawstransfer.IWebAppRef) *string {
	_init_.Initialize()

	if err := validateCfnWebApp_ArnForWebAppParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnWebApp_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWebApp_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebApp_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWebApp_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebApp_IsCfnWebApp(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWebApp_IsCfnWebAppParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebApp_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWebApp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWebApp_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_transfer.CfnWebApp",
...
func (c *jsiiProxy_CfnWebApp) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnWebApp) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebApp) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebApp) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnWebApp) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnWebApp) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnWebApp) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnWebApp) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWebApp) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWebApp) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnWebApp) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWebApp) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWebApp) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnWebApp) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnWebApp) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWebApp) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnWebApp) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebApp) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebApp) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnWebApp) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWebApp) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnWebApp) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnWebApp) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnWebApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
