...
func validateCfnWorkflow_ArnForWorkflowParameters(resource interfacesawstransfer.IWorkflowRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnWorkflow) validateSetOnExceptionStepsParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnWorkflow_WorkflowStepProperty:
				v := v.(*CfnWorkflow_WorkflowStepProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnWorkflow_WorkflowStepProperty:
				v_ := v.(CfnWorkflow_WorkflowStepProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnWorkflow_WorkflowStepProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnWorkflow) validateSetStepsParameters(val interface{}) error {
	if val == nil {
