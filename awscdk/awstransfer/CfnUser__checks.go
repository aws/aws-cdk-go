...
func (j *jsiiProxy_CfnUser) validateSetHomeDirectoryMappingsParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnUser_HomeDirectoryMapEntryProperty:
				v_ := v.(CfnUser_HomeDirectoryMapEntryProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnUser) validateSetPosixProfileParameters(val interface{}) error {
	...
	case CfnUser_PosixProfileProperty:
		val_ := val.(CfnUser_PosixProfileProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnUser) validateSetRoleParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnUser) validateSetServerIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
