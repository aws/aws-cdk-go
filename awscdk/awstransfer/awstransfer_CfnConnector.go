...
func (j *jsiiProxy_CfnConnector) As2Config() interface{} {
...
func (j *jsiiProxy_CfnConnector) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnConnector) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
func (j *jsiiProxy_CfnConnector)SetAccessRole(val *string) {
