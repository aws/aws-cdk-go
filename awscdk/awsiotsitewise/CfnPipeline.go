...
//
//   cfnPipeline := awscdk.Aws_iotsitewise.NewCfnPipeline(this, jsii.String("MyCfnPipeline"), &CfnPipelineProps{
...
type CfnPipeline interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsiotsitewise.IPipelineRef
	awscdk.ITaggableV2
	...
	PipelineRef() *interfacesawsiotsitewise.PipelineReference
...
type jsiiProxy_CfnPipeline struct {
	...
	internal.Type__interfacesawsiotsitewiseIPipelineRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnPipeline) AttrPipelineArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPipelineArn",
...
func (j *jsiiProxy_CfnPipeline) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnPipeline) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPipeline) Computations() interface{} {
...
func (j *jsiiProxy_CfnPipeline) EnvironmentVariables() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPipeline) PipelineRef() *interfacesawsiotsitewise.PipelineReference {
	var returns *interfacesawsiotsitewise.PipelineReference
	_jsii_.Get(
		j,
		"pipelineRef",
		&returns,
...
func (j *jsiiProxy_CfnPipeline) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPipeline) WorkspaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceName",
...
func NewCfnPipeline(scope constructs.Construct, id *string, props *CfnPipelineProps) CfnPipeline {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_iotsitewise.CfnPipeline",
...
func (j *jsiiProxy_CfnPipeline)SetComputations(val interface{}) {
	if err := j.validateSetComputationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPipeline)SetEnvironmentVariables(val interface{}) {
...
func (j *jsiiProxy_CfnPipeline)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnPipeline)SetWorkspaceName(val *string) {
...
func CfnPipeline_ArnForPipeline(resource interfacesawsiotsitewise.IPipelineRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPipeline) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPipeline) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPipeline) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPipeline) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
