...
func (j *jsiiProxy_CfnPortal) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnPortal) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPortal) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPortal) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPortal) RemoveResourceDependency(target awscdk.CfnResource) {
