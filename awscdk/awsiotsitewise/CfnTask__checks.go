...
func (j *jsiiProxy_CfnTask) validateSetTaskConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnTask_TaskConfigurationProperty:
		val := val.(*CfnTask_TaskConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnTask_TaskConfigurationProperty:
		val_ := val.(CfnTask_TaskConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnTask_TaskConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
