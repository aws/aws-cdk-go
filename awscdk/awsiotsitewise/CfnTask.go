...
//
//   cfnTask := awscdk.Aws_iotsitewise.NewCfnTask(this, jsii.String("MyCfnTask"), &CfnTaskProps{
...
type CfnTask interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsiotsitewise.ITaskRef
	awscdk.ITaggableV2
	...
	SetTaskConfiguration(val interface{})
	// The name of the task.
	TaskName() *string
	SetTaskName(val *string)
	// A reference to a Task resource.
	TaskRef() *interfacesawsiotsitewise.TaskReference
	// Deprecated.
...
type jsiiProxy_CfnTask struct {
	...
	internal.Type__interfacesawsiotsitewiseITaskRef
...
func (j *jsiiProxy_CfnTask) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTask) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTask) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnTask) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTask) TaskConfiguration() interface{} {
...
func (j *jsiiProxy_CfnTask) TaskName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"taskName",
...
func (j *jsiiProxy_CfnTask) TaskRef() *interfacesawsiotsitewise.TaskReference {
	var returns *interfacesawsiotsitewise.TaskReference
	_jsii_.Get(
		j,
		"taskRef",
		&returns,
...
func (j *jsiiProxy_CfnTask) WorkspaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceName",
...
func NewCfnTask(scope constructs.Construct, id *string, props *CfnTaskProps) CfnTask {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_iotsitewise.CfnTask",
...
func (j *jsiiProxy_CfnTask)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnTask)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnTask)SetTaskConfiguration(val interface{}) {
	if err := j.validateSetTaskConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTask)SetTaskName(val *string) {
...
func (j *jsiiProxy_CfnTask)SetWorkspaceName(val *string) {
...
func CfnTask_ArnForTask(resource interfacesawsiotsitewise.ITaskRef) *string {
	_init_.Initialize()

	if err := validateCfnTask_ArnForTaskParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTask_IsCfnTask(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTask_IsCfnTaskParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTask) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTask) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTask) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTask) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
