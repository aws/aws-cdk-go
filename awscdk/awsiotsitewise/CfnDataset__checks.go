...
func validateCfnDataset_ArnForDatasetParameters(resource interfacesawsiotsitewise.IDatasetRef) error {
	if resource == nil {
...
func validateCfnDataset_FromDatasetArnParameters(scope constructs.Construct, id *string, arn *string) error {
	if scope == nil {
...
func validateCfnDataset_FromDatasetIdParameters(scope constructs.Construct, id *string, datasetId *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
	...
	if datasetId == nil {
		return fmt.Errorf("parameter datasetId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataset) validateSetDatasetNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDataset) validateSetDatasetSourceParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataset_DatasetSourceProperty:
		val := val.(*CfnDataset_DatasetSourceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataset_DatasetSourceProperty:
		val_ := val.(CfnDataset_DatasetSourceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataset_DatasetSourceProperty; received %#v (a %T)", val, val)
		}
	}
