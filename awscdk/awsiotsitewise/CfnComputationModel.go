...
func (j *jsiiProxy_CfnComputationModel) AttrComputationModelArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrComputationModelArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnComputationModel) AttrComputationModelId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrComputationModelId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnComputationModel) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnComputationModel) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnComputationModel) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnComputationModel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnComputationModel) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnComputationModel) ComputationModelConfiguration() interface{} {
...
func (j *jsiiProxy_CfnComputationModel) ComputationModelDataBinding() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnComputationModel) ComputationModelDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnComputationModel) ComputationModelName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnComputationModel) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnComputationModel) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnComputationModel) Node() constructs.Node {
...
func (j *jsiiProxy_CfnComputationModel) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnComputationModel) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnComputationModel) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnComputationModel) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnComputationModel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnComputationModel(scope constructs.Construct, id *string, props *CfnComputationModelProps) CfnComputationModel {
	...
	if err := validateNewCfnComputationModelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnComputationModel)SetComputationModelConfiguration(val interface{}) {
	if err := j.validateSetComputationModelConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnComputationModel)SetComputationModelDataBinding(val interface{}) {
	if err := j.validateSetComputationModelDataBindingParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnComputationModel)SetComputationModelDescription(val *string) {
	_jsii_.Set(
		j,
		"computationModelDescription",
		val,
...
func (j *jsiiProxy_CfnComputationModel)SetComputationModelName(val *string) {
	if err := j.validateSetComputationModelNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnComputationModel)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnComputationModel_ArnForComputationModel(resource interfacesawsiotsitewise.IComputationModelRef) *string {
	_init_.Initialize()

	if err := validateCfnComputationModel_ArnForComputationModelParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnComputationModel_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnComputationModel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnComputationModel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnComputationModel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnComputationModel_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnComputationModel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnComputationModel_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iotsitewise.CfnComputationModel",
...
func (c *jsiiProxy_CfnComputationModel) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnComputationModel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputationModel) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputationModel) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputationModel) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputationModel) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnComputationModel) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputationModel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComputationModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComputationModel) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnComputationModel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComputationModel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnComputationModel) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnComputationModel) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnComputationModel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnComputationModel) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnComputationModel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputationModel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputationModel) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnComputationModel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputationModel) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnComputationModel) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnComputationModel) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnComputationModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
