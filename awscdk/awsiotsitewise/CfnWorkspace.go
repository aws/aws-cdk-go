...
//
//   cfnWorkspace := awscdk.Aws_iotsitewise.NewCfnWorkspace(this, jsii.String("MyCfnWorkspace"), &CfnWorkspaceProps{
...
type CfnWorkspace interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsiotsitewise.IWorkspaceRef
	awscdk.ITaggableV2
	...
	SetWorkspaceDescription(val *string)
	// The name of the workspace.
	WorkspaceName() *string
	SetWorkspaceName(val *string)
	// A reference to a Workspace resource.
	WorkspaceRef() *interfacesawsiotsitewise.WorkspaceReference
...
type jsiiProxy_CfnWorkspace struct {
	...
	internal.Type__interfacesawsiotsitewiseIWorkspaceRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnWorkspace) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnWorkspace) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnWorkspace) AttrWorkspaceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWorkspaceArn",
...
func (j *jsiiProxy_CfnWorkspace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWorkspace) EncryptionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnWorkspace) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_CfnWorkspace) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnWorkspace) WorkspaceDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnWorkspace) WorkspaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceName",
...
func (j *jsiiProxy_CfnWorkspace) WorkspaceRef() *interfacesawsiotsitewise.WorkspaceReference {
	var returns *interfacesawsiotsitewise.WorkspaceReference
	_jsii_.Get(
		j,
		"workspaceRef",
		&returns,
...
func NewCfnWorkspace(scope constructs.Construct, id *string, props *CfnWorkspaceProps) CfnWorkspace {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_iotsitewise.CfnWorkspace",
...
func (j *jsiiProxy_CfnWorkspace)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnWorkspace)SetKmsKeyId(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyId",
		val,
...
func (j *jsiiProxy_CfnWorkspace)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnWorkspace)SetWorkspaceDescription(val *string) {
	_jsii_.Set(
		j,
		"workspaceDescription",
		val,
...
func (j *jsiiProxy_CfnWorkspace)SetWorkspaceName(val *string) {
...
func CfnWorkspace_ArnForWorkspace(resource interfacesawsiotsitewise.IWorkspaceRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWorkspace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWorkspace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWorkspace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWorkspace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
