...
func (j *jsiiProxy_CfnAssetModel) CfnPropertyNames() *map[string]*string {
...
func CfnAssetModel_FromAssetModelId(scope constructs.Construct, id *string, assetModelId *string) interfacesawsiotsitewise.IAssetModelRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_iotsitewise.CfnAssetModel",
		"fromAssetModelId",
		[]interface{}{scope, id, assetModelId},
		&returns,
	)
...
func CfnAssetModel_IsCfnAssetModel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAssetModel_IsCfnAssetModelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssetModel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssetModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssetModel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssetModel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssetModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
