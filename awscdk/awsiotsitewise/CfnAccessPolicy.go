...
func (j *jsiiProxy_CfnAccessPolicy)SetAccessPolicyIdentity(val interface{}) {
	if err := j.validateSetAccessPolicyIdentityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAccessPolicy)SetAccessPolicyPermission(val *string) {
	if err := j.validateSetAccessPolicyPermissionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAccessPolicy)SetAccessPolicyResource(val interface{}) {
	if err := j.validateSetAccessPolicyResourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
