...
func (j *jsiiProxy_CfnAsset)SetAssetHierarchies(val interface{}) {
	if err := j.validateSetAssetHierarchiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAsset)SetAssetProperties(val interface{}) {
	if err := j.validateSetAssetPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAsset_ArnForAsset(resource interfacesawsiotsitewise.IAssetRef) *string {
	_init_.Initialize()
