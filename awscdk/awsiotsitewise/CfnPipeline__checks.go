...
func validateCfnPipeline_ArnForPipelineParameters(resource interfacesawsiotsitewise.IPipelineRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnPipeline) validateSetComputationsParameters(val interface{}) error {
	if val == nil {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnPipeline_ComputeNodeProperty:
				v := v.(*CfnPipeline_ComputeNodeProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnPipeline_ComputeNodeProperty:
				v_ := v.(CfnPipeline_ComputeNodeProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnPipeline_ComputeNodeProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnPipeline) validateSetEnvironmentVariablesParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
...
func (j *jsiiProxy_CfnPipeline) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
	for idx_97dfc6, v := range *val {
		if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnPipeline) validateSetWorkspaceNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
