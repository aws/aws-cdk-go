...
//
//   cfnDataset := awscdk.Aws_iotsitewise.NewCfnDataset(this, jsii.String("MyCfnDataset"), &CfnDatasetProps{
...
func (j *jsiiProxy_CfnDataset) AttrDatasetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDatasetId",
...
func (j *jsiiProxy_CfnDataset) DatasetDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetDescription",
...
func (j *jsiiProxy_CfnDataset) DatasetSource() interface{} {
...
func (j *jsiiProxy_CfnDataset)SetDatasetDescription(val *string) {
	_jsii_.Set(
		j,
		"datasetDescription",
		val,
...
func (j *jsiiProxy_CfnDataset)SetDatasetSource(val interface{}) {
	if err := j.validateSetDatasetSourceParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
