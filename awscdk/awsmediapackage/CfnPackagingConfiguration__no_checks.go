...
func (c *jsiiProxy_CfnPackagingConfiguration) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnPackagingConfiguration) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnPackagingConfiguration) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnPackagingConfiguration) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func validateCfnPackagingConfiguration_ArnForPackagingConfigurationParameters(resource interfacesawsmediapackage.IPackagingConfigurationRef) error {
	return nil
}
...
func validateCfnPackagingConfiguration_IsCfnPackagingConfigurationParameters(x interface{}) error {
	return nil
}
