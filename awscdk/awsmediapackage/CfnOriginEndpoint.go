...
type CfnOriginEndpoint interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsmediapackage.IOriginEndpointRef
	awscdk.ITaggable
	...
	OriginEndpointRef() *interfacesawsmediapackage.OriginEndpointReference
...
type jsiiProxy_CfnOriginEndpoint struct {
	...
	internal.Type__interfacesawsmediapackageIOriginEndpointRef
...
func (j *jsiiProxy_CfnOriginEndpoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOriginEndpoint) OriginEndpointRef() *interfacesawsmediapackage.OriginEndpointReference {
	var returns *interfacesawsmediapackage.OriginEndpointReference
	_jsii_.Get(
		j,
		"originEndpointRef",
		&returns,
...
func (c *jsiiProxy_CfnOriginEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOriginEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOriginEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
