...
func (j *jsiiProxy_CfnPackagingGroup) CfnPropertyNames() *map[string]*string {
...
func CfnPackagingGroup_ArnForPackagingGroup(resource interfacesawsmediapackage.IPackagingGroupRef) *string {
	_init_.Initialize()

	if err := validateCfnPackagingGroup_ArnForPackagingGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPackagingGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPackagingGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackagingGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPackagingGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPackagingGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPackagingGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackagingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
