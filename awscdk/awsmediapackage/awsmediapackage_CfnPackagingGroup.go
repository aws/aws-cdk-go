...
func (j *jsiiProxy_CfnPackagingGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPackagingGroup(scope constructs.Construct, id *string, props *CfnPackagingGroupProps) CfnPackagingGroup {
	...
	if err := validateNewCfnPackagingGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPackagingGroup)SetEgressAccessLogs(val interface{}) {
	if err := j.validateSetEgressAccessLogsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPackagingGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPackagingGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackagingGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPackagingGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackagingGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPackagingGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackagingGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackagingGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPackagingGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPackagingGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPackagingGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackagingGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
