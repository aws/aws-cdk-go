...
func (j *jsiiProxy_CfnPackagingConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnPackagingConfiguration_ArnForPackagingConfiguration(resource interfacesawsmediapackage.IPackagingConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnPackagingConfiguration_ArnForPackagingConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPackagingConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPackagingConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackagingConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPackagingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPackagingConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPackagingConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackagingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
