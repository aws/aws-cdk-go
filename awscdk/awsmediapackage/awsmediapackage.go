...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getAtt", GoMethod: "GetAtt"},
			_jsii_.MemberMethod{JsiiMethod: "getMetadata", GoMethod: "GetMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "hlsIngest", GoGetter: "HlsIngest"},
			_jsii_.MemberProperty{JsiiProperty: "id", GoGetter: "Id"},
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_mediapackage.CfnChannel.HlsIngestProperty",
		reflect.TypeOf((*CfnChannel_HlsIngestProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_mediapackage.CfnChannel.IngestEndpointProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_mediapackage.CfnOriginEndpoint.EncryptionContractConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_mediapackage.CfnPackagingConfiguration.EncryptionContractConfigurationProperty",
