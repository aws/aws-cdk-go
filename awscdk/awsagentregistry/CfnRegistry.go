...
//
//   cfnRegistry := awscdk.Aws_agentregistry.NewCfnRegistry(this, jsii.String("MyCfnRegistry"), &CfnRegistryProps{
...
type CfnRegistry interface {
	...
	SetDiscoveryConfiguration(val interface{})
	...
	RegistryRef() *interfacesawsagentregistry.RegistryReference
...
type jsiiProxy_CfnRegistry struct {
	...
	internal.Type__interfacesawsagentregistryIRegistryRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnRegistry) ApprovalConfiguration() interface{} {
...
func (j *jsiiProxy_CfnRegistry) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnRegistry) AttrRegistryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRegistryId",
...
func (j *jsiiProxy_CfnRegistry) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnRegistry) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnRegistry) AuthorizerType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizerType",
...
func (j *jsiiProxy_CfnRegistry) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRegistry) DiscoveryConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRegistry) RegistryRef() *interfacesawsagentregistry.RegistryReference {
	var returns *interfacesawsagentregistry.RegistryReference
	_jsii_.Get(
		j,
		"registryRef",
		&returns,
...
func (j *jsiiProxy_CfnRegistry) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRegistry)SetApprovalConfiguration(val interface{}) {
	if err := j.validateSetApprovalConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRegistry)SetAuthorizerType(val *string) {
	_jsii_.Set(
		j,
		"authorizerType",
		val,
...
func (j *jsiiProxy_CfnRegistry)SetDiscoveryConfiguration(val interface{}) {
	if err := j.validateSetDiscoveryConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRegistry)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnRegistry_ArnForRegistry(resource interfacesawsagentregistry.IRegistryRef) *string {
	_init_.Initialize()
