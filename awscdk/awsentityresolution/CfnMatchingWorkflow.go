...
func (j *jsiiProxy_CfnMatchingWorkflow) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnMatchingWorkflow) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMatchingWorkflow) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMatchingWorkflow) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMatchingWorkflow) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMatchingWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
