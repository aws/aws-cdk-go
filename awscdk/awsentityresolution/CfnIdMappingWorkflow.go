...
func (j *jsiiProxy_CfnIdMappingWorkflow) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) AttrWorkflowArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrWorkflowArn",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) InputSourceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"inputSourceConfig",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) OutputSourceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outputSourceConfig",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnIdMappingWorkflow) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnIdMappingWorkflow) WorkflowName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workflowName",
...
func NewCfnIdMappingWorkflow(scope constructs.Construct, id *string, props *CfnIdMappingWorkflowProps) CfnIdMappingWorkflow {
	...
	if err := validateNewCfnIdMappingWorkflowParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetIdMappingTechniques(val interface{}) {
	if err := j.validateSetIdMappingTechniquesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetInputSourceConfig(val interface{}) {
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetOutputSourceConfig(val interface{}) {
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnIdMappingWorkflow)SetWorkflowName(val *string) {
...
func CfnIdMappingWorkflow_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdMappingWorkflow_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdMappingWorkflow_IsCfnIdMappingWorkflow(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIdMappingWorkflow_IsCfnIdMappingWorkflowParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdMappingWorkflow_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIdMappingWorkflow_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdMappingWorkflow_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdMappingWorkflow_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdMappingWorkflow) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnIdMappingWorkflow) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnIdMappingWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
