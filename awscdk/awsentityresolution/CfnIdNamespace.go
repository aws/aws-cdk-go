...
func (j *jsiiProxy_CfnIdNamespace) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnIdNamespace) AttrIdNamespaceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdNamespaceArn",
...
func (j *jsiiProxy_CfnIdNamespace) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnIdNamespace) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnIdNamespace) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnIdNamespace) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnIdNamespace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdNamespace) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnIdNamespace) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnIdNamespace) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnIdNamespace) IdMappingWorkflowProperties() interface{} {
...
func (j *jsiiProxy_CfnIdNamespace) IdNamespaceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idNamespaceName",
...
func (j *jsiiProxy_CfnIdNamespace) InputSourceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"inputSourceConfig",
...
func (j *jsiiProxy_CfnIdNamespace) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnIdNamespace) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIdNamespace) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnIdNamespace) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnIdNamespace) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnIdNamespace) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnIdNamespace) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnIdNamespace) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnIdNamespace) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIdNamespace(scope constructs.Construct, id *string, props *CfnIdNamespaceProps) CfnIdNamespace {
	...
	if err := validateNewCfnIdNamespaceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIdNamespace)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnIdNamespace)SetIdMappingWorkflowProperties(val interface{}) {
	if err := j.validateSetIdMappingWorkflowPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIdNamespace)SetIdNamespaceName(val *string) {
	if err := j.validateSetIdNamespaceNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnIdNamespace)SetInputSourceConfig(val interface{}) {
...
func (j *jsiiProxy_CfnIdNamespace)SetRoleArn(val *string) {
	_jsii_.Set(
		j,
		"roleArn",
		val,
...
func (j *jsiiProxy_CfnIdNamespace)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnIdNamespace)SetType(val *string) {
...
func CfnIdNamespace_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdNamespace_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdNamespace_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIdNamespace_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdNamespace_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdNamespace_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdNamespace) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnIdNamespace) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdNamespace) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdNamespace) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdNamespace) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdNamespace) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnIdNamespace) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdNamespace) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnIdNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdNamespace) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdNamespace) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnIdNamespace) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnIdNamespace) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdNamespace) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnIdNamespace) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdNamespace) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnIdNamespace) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdNamespace) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnIdNamespace) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnIdNamespace) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnIdNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
