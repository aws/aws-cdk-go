...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ssmincidents.CfnResponsePlan.DynamicSsmParameterProperty",
		reflect.TypeOf((*CfnResponsePlan_DynamicSsmParameterProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_ssmincidents.CfnResponsePlan.DynamicSsmParameterValueProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ssmincidents.CfnResponsePlan.IntegrationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ssmincidents.CfnResponsePlan.PagerDutyConfigurationProperty",
		reflect.TypeOf((*CfnResponsePlan_PagerDutyConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_ssmincidents.CfnResponsePlan.PagerDutyIncidentConfigurationProperty",
