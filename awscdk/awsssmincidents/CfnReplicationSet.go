...
func (j *jsiiProxy_CfnReplicationSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicationSet) Tags() awscdk.TagManager {
...
func NewCfnReplicationSet(scope constructs.Construct, id *string, props *CfnReplicationSetProps) CfnReplicationSet {
	...
	if err := validateNewCfnReplicationSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnReplicationSet)SetDeletionProtected(val interface{}) {
	if err := j.validateSetDeletionProtectedParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnReplicationSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReplicationSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnReplicationSet.
func CfnReplicationSet_IsCfnReplicationSet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnReplicationSet_IsCfnReplicationSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReplicationSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReplicationSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicationSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReplicationSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReplicationSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
