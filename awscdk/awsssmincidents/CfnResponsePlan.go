...
func (j *jsiiProxy_CfnResponsePlan) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResponsePlan) Integrations() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"integrations",
...
func NewCfnResponsePlan(scope constructs.Construct, id *string, props *CfnResponsePlanProps) CfnResponsePlan {
	...
	if err := validateNewCfnResponsePlanParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResponsePlan)SetIncidentTemplate(val interface{}) {
	if err := j.validateSetIncidentTemplateParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnResponsePlan)SetIntegrations(val interface{}) {
	if err := j.validateSetIntegrationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResponsePlan_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResponsePlan_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResponsePlan_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResponsePlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResponsePlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResponsePlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResponsePlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponsePlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResponsePlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResponsePlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResponsePlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResponsePlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResponsePlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponsePlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponsePlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponsePlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
