...
//
//   cfnPackage := awscdk.Aws_codeartifact.NewCfnPackage(this, jsii.String("MyCfnPackage"), &CfnPackageProps{
...
type CfnPackage interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscodeartifact.IPackageRef
	// The ARN of the package.
	AttrArn() *string
	// The package origin configuration for the package.
	AttrOriginConfiguration() awscdk.IResolvable
	...
	PackageRef() *interfacesawscodeartifact.PackageReference
...
type jsiiProxy_CfnPackage struct {
	...
	internal.Type__interfacesawscodeartifactIPackageRef
}
...
func (j *jsiiProxy_CfnPackage) AttrOriginConfiguration() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnPackage) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPackage) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_CfnPackage) Format() *string {
	var returns *string
	_jsii_.Get(
		j,
		"format",
...
func (j *jsiiProxy_CfnPackage) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPackage) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_CfnPackage) PackageRef() *interfacesawscodeartifact.PackageReference {
	var returns *interfacesawscodeartifact.PackageReference
	_jsii_.Get(
		j,
		"packageRef",
		&returns,
...
func (j *jsiiProxy_CfnPackage) Repository() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repository",
...
func (j *jsiiProxy_CfnPackage) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPackage(scope constructs.Construct, id *string, props *CfnPackageProps) CfnPackage {
	...
	if err := validateNewCfnPackageParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnPackage{}

	_jsii_.Create(
		"aws-cdk-lib.aws_codeartifact.CfnPackage",
...
func (j *jsiiProxy_CfnPackage)SetDomainName(val *string) {
...
func (j *jsiiProxy_CfnPackage)SetFormat(val *string) {
...
func (j *jsiiProxy_CfnPackage)SetName(val *string) {
...
func (j *jsiiProxy_CfnPackage)SetNamespace(val *string) {
	_jsii_.Set(
		j,
		"namespace",
		val,
...
func (j *jsiiProxy_CfnPackage)SetRepository(val *string) {
...
func CfnPackage_ArnForPackage(resource interfacesawscodeartifact.IPackageRef) *string {
	_init_.Initialize()
...
func CfnPackage_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPackage_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackage_IsCfnPackage(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPackage_IsCfnPackageParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackage_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPackage_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackage_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPackage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackage) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPackage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPackage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPackage) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPackage) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPackage) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackage) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
