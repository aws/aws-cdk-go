...
func (j *jsiiProxy_CfnDomain) AttrEncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEncryptionKey",
...
func (j *jsiiProxy_CfnDomain) AttrName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrName",
...
func (j *jsiiProxy_CfnDomain) AttrOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwner",
...
func (j *jsiiProxy_CfnDomain) EncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encryptionKey",
...
func (j *jsiiProxy_CfnDomain) PermissionsPolicyDocument() interface{} {
...
func (j *jsiiProxy_CfnDomain)SetEncryptionKey(val *string) {
	_jsii_.Set(
		j,
		"encryptionKey",
		val,
...
func CfnDomain_ArnForDomain(resource interfacesawscodeartifact.IDomainRef) *string {
	_init_.Initialize()
