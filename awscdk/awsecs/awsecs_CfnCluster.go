...
type CfnCluster interface {
	...
	//
	// This parameter is used to use CloudWatch Container Insights for a cluster. If this value is specified, it will override the `containerInsights` value set with [PutAccountSetting](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutAccountSetting.html) or [PutAccountSettingDefault](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutAccountSettingDefault.html) .
	ClusterSettings() interface{}
...
func (j *jsiiProxy_CfnCluster)SetClusterSettings(val interface{}) {
	if err := j.validateSetClusterSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
