...
func (j *jsiiProxy_FargateTaskDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_FargateTaskDefinition) RuntimePlatform() *RuntimePlatform {
...
func (j *jsiiProxy_FargateTaskDefinition) TaskDefinitionRef() *interfacesawsecs.TaskDefinitionReference {
...
func (f *jsiiProxy_FargateTaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
