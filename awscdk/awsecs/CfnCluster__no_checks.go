...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawsecs.IClusterRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnCluster) validateSetClusterSettingsParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_CfnCluster) validateSetDefaultCapacityProviderStrategyParameters(val interface{}) error {
	return nil
}
