...
func (j *jsiiProxy_TaskDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_TaskDefinition) RuntimePlatform() *RuntimePlatform {
...
func (j *jsiiProxy_TaskDefinition) TaskDefinitionRef() *interfacesawsecs.TaskDefinitionReference {
...
func TaskDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ecs.TaskDefinition",
...
func (t *jsiiProxy_TaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
