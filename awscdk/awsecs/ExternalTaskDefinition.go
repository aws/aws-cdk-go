...
func (j *jsiiProxy_ExternalTaskDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ExternalTaskDefinition) IsManagedInstancesCompatible() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ExternalTaskDefinition) PidMode() PidMode {
	var returns PidMode
	_jsii_.Get(
		j,
		"pidMode",
...
func ExternalTaskDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ecs.ExternalTaskDefinition",
...
func (e *jsiiProxy_ExternalTaskDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_ExternalTaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
