...
func (j *jsiiProxy_BaseService) Env() *interfaces.ResourceEnvironment {
...
func (b *jsiiProxy_BaseService) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BaseService) ForceNewDeployment(nonce *string) {
	_jsii_.InvokeVoid(
		b,
		"forceNewDeployment",
		[]interface{}{nonce},
...
func (b *jsiiProxy_BaseService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
