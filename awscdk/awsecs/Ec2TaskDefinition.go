...
func (j *jsiiProxy_Ec2TaskDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_Ec2TaskDefinition) PidMode() PidMode {
	var returns PidMode
	_jsii_.Get(
		j,
		"pidMode",
...
func (j *jsiiProxy_Ec2TaskDefinition) RuntimePlatform() *RuntimePlatform {
...
func (j *jsiiProxy_Ec2TaskDefinition) TaskDefinitionRef() *interfacesawsecs.TaskDefinitionReference {
...
func Ec2TaskDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ecs.Ec2TaskDefinition",
...
func (e *jsiiProxy_Ec2TaskDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_Ec2TaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
