...
func (j *jsiiProxy_CfnTaskSet) CfnPropertyNames() *map[string]*string {
...
func CfnTaskSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTaskSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTaskSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTaskSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTaskSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTaskSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTaskSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTaskSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
