...
func validateCfnCapacityProvider_ArnForCapacityProviderParameters(resource interfacesawsecs.ICapacityProviderRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCapacityProvider) validateSetAutoScalingGroupProviderParameters(val interface{}) error {
	...
	case CfnCapacityProvider_AutoScalingGroupProviderProperty:
		val_ := val.(CfnCapacityProvider_AutoScalingGroupProviderProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
