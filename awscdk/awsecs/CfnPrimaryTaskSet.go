...
func (j *jsiiProxy_CfnPrimaryTaskSet) CfnPropertyNames() *map[string]*string {
...
func NewCfnPrimaryTaskSet(scope constructs.Construct, id *string, props *CfnPrimaryTaskSetProps) CfnPrimaryTaskSet {
	...
	if err := validateNewCfnPrimaryTaskSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPrimaryTaskSet)SetTaskSetId(val *string) {
	if err := j.validateSetTaskSetIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPrimaryTaskSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPrimaryTaskSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrimaryTaskSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPrimaryTaskSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrimaryTaskSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPrimaryTaskSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPrimaryTaskSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPrimaryTaskSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrimaryTaskSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
