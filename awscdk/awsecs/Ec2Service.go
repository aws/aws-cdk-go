...
func (j *jsiiProxy_Ec2Service) ServiceRef() *interfacesawsecs.ServiceReference {
...
func (e *jsiiProxy_Ec2Service) ForceNewDeployment(nonce *string) {
	_jsii_.InvokeVoid(
		e,
		"forceNewDeployment",
		[]interface{}{nonce},
...
func (e *jsiiProxy_Ec2Service) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
