...
func (j *jsiiProxy_FargateService) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_FargateService) ServiceRef() *interfacesawsecs.ServiceReference {
...
func (f *jsiiProxy_FargateService) ForceNewDeployment(nonce *string) {
	_jsii_.InvokeVoid(
		f,
		"forceNewDeployment",
		[]interface{}{nonce},
...
func (f *jsiiProxy_FargateService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
