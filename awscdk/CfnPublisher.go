...
func (j *jsiiProxy_CfnPublisher) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPublisher) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPublisher(scope constructs.Construct, id *string, props *CfnPublisherProps) CfnPublisher {
	...
	if err := validateNewCfnPublisherParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPublisher)SetAcceptTermsAndConditions(val interface{}) {
	if err := j.validateSetAcceptTermsAndConditionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPublisher_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPublisher_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublisher_IsCfnPublisher(x interface{}) *bool {
	...
	if err := validateCfnPublisher_IsCfnPublisherParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublisher_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPublisher_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublisher_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPublisher_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublisher) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublisher) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublisher) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPublisher) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnPublisher) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPublisher) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnPublisher) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
