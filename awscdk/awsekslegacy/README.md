...
```go
cluster := eks.NewCluster(this, jsii.String("hello-eks"))

cluster.AddResource(jsii.String("mypod"), map[string]interface{}{
...
```go
eks.NewCluster(this, jsii.String("cluster-two-m5-large"))
```
...
```go
eks.NewCluster(this, jsii.String("cluster-with-no-capacity"), &ClusterProps{
...
```go
cluster := eks.NewCluster(this, jsii.String("my-cluster"))
cluster.DefaultCapacity.scaleOnCpuUtilization(jsii.String("up"), &CpuUtilizationScalingProps{
...
clusterAdmin := iam.NewRole(this, jsii.String("AdminRole"), &RoleProps{
...
```go
asg := cluster.AddCapacity(jsii.String("Nodes"), &CapacityOptions{
	InstanceType: ec2.NewInstanceType(jsii.String("t2.medium")),
	VpcSubnets: &SubnetSelection{
		SubnetType: ec2.SubnetType_PUBLIC,
	},
	KeyName: jsii.String("my-key-name"),
})

// Replace with desired IP
asg.connections.AllowFrom(ec2.Peer_Ipv4(jsii.String("1.2.3.4/32")), ec2.Port_Tcp(jsii.Number(22)))
```
...
```go
eks.NewCluster(this, jsii.String("cluster"), &ClusterProps{
	KubectlEnabled: jsii.Boolean(false),
})
```
