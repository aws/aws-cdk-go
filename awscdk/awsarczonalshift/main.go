...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_arczonalshift.CfnAutoshiftObserverNotificationStatusProps",
		reflect.TypeOf((*CfnAutoshiftObserverNotificationStatusProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_arczonalshift.CfnZonalAutoshiftConfiguration",
		reflect.TypeOf((*CfnZonalAutoshiftConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "obtainResourceDependencies", GoMethod: "ObtainResourceDependencies"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "practiceRunConfiguration", GoGetter: "PracticeRunConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "ref", GoGetter: "Ref"},
			_jsii_.MemberMethod{JsiiMethod: "removeDependency", GoMethod: "RemoveDependency"},
			_jsii_.MemberMethod{JsiiMethod: "renderProperties", GoMethod: "RenderProperties"},
			_jsii_.MemberMethod{JsiiMethod: "replaceDependency", GoMethod: "ReplaceDependency"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnZonalAutoshiftConfiguration_ControlConditionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_arczonalshift.CfnZonalAutoshiftConfiguration.PracticeRunConfigurationProperty",
		reflect.TypeOf((*CfnZonalAutoshiftConfiguration_PracticeRunConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
