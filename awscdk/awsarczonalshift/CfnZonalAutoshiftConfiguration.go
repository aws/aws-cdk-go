...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) PracticeRunConfiguration() interface{} {
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) ResourceIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceIdentifier",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration) ZonalAutoshiftStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewCfnZonalAutoshiftConfiguration(scope constructs.Construct, id *string, props *CfnZonalAutoshiftConfigurationProps) CfnZonalAutoshiftConfiguration {
	...
	if err := validateNewCfnZonalAutoshiftConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration)SetPracticeRunConfiguration(val interface{}) {
	if err := j.validateSetPracticeRunConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnZonalAutoshiftConfiguration)SetZonalAutoshiftStatus(val *string) {
	_jsii_.Set(
		j,
		"zonalAutoshiftStatus",
		val,
...
func CfnZonalAutoshiftConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnZonalAutoshiftConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnZonalAutoshiftConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnZonalAutoshiftConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnZonalAutoshiftConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnZonalAutoshiftConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnZonalAutoshiftConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
