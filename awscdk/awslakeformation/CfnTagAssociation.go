...
func (j *jsiiProxy_CfnTagAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTagAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTagAssociation(scope constructs.Construct, id *string, props *CfnTagAssociationProps) CfnTagAssociation {
	...
	if err := validateNewCfnTagAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTagAssociation)SetLfTags(val interface{}) {
	if err := j.validateSetLfTagsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnTagAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTagAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTagAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTagAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTagAssociation_IsCfnTagAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTagAssociation_IsCfnTagAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTagAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTagAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTagAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTagAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTagAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTagAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTagAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTagAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
