...
func (j *jsiiProxy_CfnDataCellsFilter) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (c *jsiiProxy_CfnDataCellsFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCellsFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDataCellsFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDataCellsFilter) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDataCellsFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCellsFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
