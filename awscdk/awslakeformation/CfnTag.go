...
func (j *jsiiProxy_CfnTag) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTag) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTag(scope constructs.Construct, id *string, props *CfnTagProps) CfnTag {
	...
	if err := validateNewCfnTagParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnTag{}
...
func CfnTag_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTag_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTag_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTag_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTag_IsCfnTag(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTag_IsCfnTagParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTag_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTag_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTag) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTag) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTag) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTag) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTag) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTag) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTag) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTag) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTag) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
