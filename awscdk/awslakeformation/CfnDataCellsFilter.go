...
func (j *jsiiProxy_CfnDataCellsFilter) CfnPropertyNames() *map[string]*string {
...
func CfnDataCellsFilter_IsCfnDataCellsFilter(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataCellsFilter_IsCfnDataCellsFilterParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDataCellsFilter_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDataCellsFilter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataCellsFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataCellsFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataCellsFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataCellsFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataCellsFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
