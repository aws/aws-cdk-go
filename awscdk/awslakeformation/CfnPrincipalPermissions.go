...
func (j *jsiiProxy_CfnPrincipalPermissions) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnPrincipalPermissions) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrincipalPermissions) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPrincipalPermissions) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPrincipalPermissions) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrincipalPermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
