...
func (j *jsiiProxy_CfnDataLakeSettings) CfnPropertyNames() *map[string]*string {
...
func CfnDataLakeSettings_IsCfnDataLakeSettings(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataLakeSettings_IsCfnDataLakeSettingsParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataLakeSettings) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataLakeSettings) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataLakeSettings) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataLakeSettings) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataLakeSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
