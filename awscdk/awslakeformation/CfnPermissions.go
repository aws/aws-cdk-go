...
func (j *jsiiProxy_CfnPermissions) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPermissions) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPermissions(scope constructs.Construct, id *string, props *CfnPermissionsProps) CfnPermissions {
	...
	if err := validateNewCfnPermissionsParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPermissions)SetDataLakePrincipal(val interface{}) {
	if err := j.validateSetDataLakePrincipalParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPermissions_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPermissions_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermissions_IsCfnPermissions(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPermissions_IsCfnPermissionsParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermissions_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPermissions_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPermissions_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPermissions_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPermissions) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissions) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPermissions) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPermissions) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPermissions) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPermissions) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPermissions) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissions) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissions) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
