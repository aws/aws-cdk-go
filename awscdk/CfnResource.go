...
func (c *jsiiProxy_CfnResource) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResource) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResource) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnResource) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnResource) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResource) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnResource) ReplaceDependency(target CfnResource, newTarget CfnResource) {
