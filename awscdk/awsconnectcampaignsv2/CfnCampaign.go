...
func (j *jsiiProxy_CfnCampaign) CfnPropertyNames() *map[string]*string {
...
func CfnCampaign_ArnForCampaign(resource interfacesawsconnectcampaignsv2.ICampaignRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCampaign) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCampaign) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCampaign) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCampaign) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCampaign) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
