...
func validateCfnCampaign_ArnForCampaignParameters(resource interfacesawsconnectcampaignsv2.ICampaignRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnCampaign) validateSetEntryLimitsConfigParameters(val interface{}) error {
	return nil
}
