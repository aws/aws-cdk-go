...
func (j *jsiiProxy_CfnForm) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnForm) Node() constructs.Node {
...
func (j *jsiiProxy_CfnForm) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnForm_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnForm_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnForm) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnForm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnForm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnForm) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnForm) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnForm) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnForm) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnForm) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnForm) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnForm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
