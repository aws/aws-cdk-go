...
func (j *jsiiProxy_CfnApp) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApp) TagsRaw() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsRaw",
...
func (j *jsiiProxy_CfnApp)SetTagsRaw(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tagsRaw",
		val,
...
func CfnApp_ArnForApp(resource interfacesawsresiliencehub.IAppRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApp) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApp) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApp) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApp) RemoveResourceDependency(target awscdk.CfnResource) {
