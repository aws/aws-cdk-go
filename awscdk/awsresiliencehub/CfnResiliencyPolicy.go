...
func (j *jsiiProxy_CfnResiliencyPolicy) CfnPropertyNames() *map[string]*string {
...
func CfnResiliencyPolicy_IsCfnResiliencyPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResiliencyPolicy_IsCfnResiliencyPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResiliencyPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResiliencyPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResiliencyPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResiliencyPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResiliencyPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
