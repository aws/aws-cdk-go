...
func NewCfnResiliencyPolicy(scope constructs.Construct, id *string, props *CfnResiliencyPolicyProps) CfnResiliencyPolicy {
	...
	if err := validateNewCfnResiliencyPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResiliencyPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResiliencyPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResiliencyPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResiliencyPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResiliencyPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResiliencyPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResiliencyPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResiliencyPolicy) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResiliencyPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResiliencyPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
