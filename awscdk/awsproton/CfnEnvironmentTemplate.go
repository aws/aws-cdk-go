...
func (j *jsiiProxy_CfnEnvironmentTemplate) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) EncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encryptionKey",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Provisioning() *string {
	var returns *string
	_jsii_.Get(
		j,
		"provisioning",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEnvironmentTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEnvironmentTemplate(scope constructs.Construct, id *string, props *CfnEnvironmentTemplateProps) CfnEnvironmentTemplate {
	...
	if err := validateNewCfnEnvironmentTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnEnvironmentTemplate{}
...
func (j *jsiiProxy_CfnEnvironmentTemplate)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnEnvironmentTemplate)SetDisplayName(val *string) {
	_jsii_.Set(
		j,
		"displayName",
		val,
...
func (j *jsiiProxy_CfnEnvironmentTemplate)SetEncryptionKey(val *string) {
	_jsii_.Set(
		j,
		"encryptionKey",
		val,
...
func (j *jsiiProxy_CfnEnvironmentTemplate)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnEnvironmentTemplate)SetProvisioning(val *string) {
	_jsii_.Set(
		j,
		"provisioning",
		val,
...
func CfnEnvironmentTemplate_ArnForEnvironmentTemplate(resource interfacesawsproton.IEnvironmentTemplateRef) *string {
	_init_.Initialize()

	if err := validateCfnEnvironmentTemplate_ArnForEnvironmentTemplateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEnvironmentTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEnvironmentTemplate) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnEnvironmentTemplate) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
