...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CodebuildRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"codebuildRoleArn",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) ComponentRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"componentRoleArn",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) EnvironmentAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) EnvironmentName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentName",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) ManagementAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"managementAccountId",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEnvironmentAccountConnection(scope constructs.Construct, id *string, props *CfnEnvironmentAccountConnectionProps) CfnEnvironmentAccountConnection {
	...
	if err := validateNewCfnEnvironmentAccountConnectionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetCodebuildRoleArn(val *string) {
	_jsii_.Set(
		j,
		"codebuildRoleArn",
		val,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetComponentRoleArn(val *string) {
	_jsii_.Set(
		j,
		"componentRoleArn",
		val,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetEnvironmentAccountId(val *string) {
	_jsii_.Set(
		j,
		"environmentAccountId",
		val,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetEnvironmentName(val *string) {
	_jsii_.Set(
		j,
		"environmentName",
		val,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetManagementAccountId(val *string) {
	_jsii_.Set(
		j,
		"managementAccountId",
		val,
...
func (j *jsiiProxy_CfnEnvironmentAccountConnection)SetRoleArn(val *string) {
	_jsii_.Set(
		j,
		"roleArn",
		val,
...
func CfnEnvironmentAccountConnection_ArnForEnvironmentAccountConnection(resource interfacesawsproton.IEnvironmentAccountConnectionRef) *string {
	_init_.Initialize()

	if err := validateCfnEnvironmentAccountConnection_ArnForEnvironmentAccountConnectionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_proton.CfnEnvironmentAccountConnection",
		"arnForEnvironmentAccountConnection",
		[]interface{}{resource},
		&returns,
	)
...
func CfnEnvironmentAccountConnection_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentAccountConnection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentAccountConnection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentAccountConnection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEnvironmentAccountConnection_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEnvironmentAccountConnection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnEnvironmentAccountConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
