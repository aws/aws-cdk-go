...
func (j *jsiiProxy_CfnVpcConnection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVpcConnection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVpcConnection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnVpcConnection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVpcConnection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcConnection_IsCfnVpcConnection(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcConnection_IsCfnVpcConnectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcConnection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcConnection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVpcConnection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVpcConnection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
