...
func (j *jsiiProxy_CfnServerlessCluster) Node() awscdk.ConstructNode {
...
func (c *jsiiProxy_CfnServerlessCluster) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnServerlessCluster) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnServerlessCluster) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnServerlessCluster) Validate() *[]*string {
	var returns *[]*string
