...
func (j *jsiiProxy_CfnServerlessCluster) CfnPropertyNames() *map[string]*string {
...
func CfnServerlessCluster_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnServerlessCluster_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServerlessCluster) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerlessCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServerlessCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServerlessCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServerlessCluster) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServerlessCluster) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServerlessCluster) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerlessCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerlessCluster) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerlessCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
