...
func (j *jsiiProxy_CfnBatchScramSecret) CfnPropertyNames() *map[string]*string {
...
func NewCfnBatchScramSecret(scope constructs.Construct, id *string, props *CfnBatchScramSecretProps) CfnBatchScramSecret {
	...
	if err := validateNewCfnBatchScramSecretParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnBatchScramSecret_IsCfnBatchScramSecret(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBatchScramSecret_IsCfnBatchScramSecretParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBatchScramSecret_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBatchScramSecret_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBatchScramSecret_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBatchScramSecret_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBatchScramSecret_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBatchScramSecret_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBatchScramSecret) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBatchScramSecret) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBatchScramSecret) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBatchScramSecret) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBatchScramSecret) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBatchScramSecret) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBatchScramSecret) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBatchScramSecret) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBatchScramSecret) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBatchScramSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
