...
func (j *jsiiProxy_CfnReplicator) AttrCurrentVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCurrentVersion",
...
func (j *jsiiProxy_CfnReplicator) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnReplicator) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnReplicator) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicator) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnReplicator) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnReplicator) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnReplicator) KafkaClusters() interface{} {
...
func (j *jsiiProxy_CfnReplicator) Node() constructs.Node {
...
func (j *jsiiProxy_CfnReplicator) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnReplicator) ReplicationInfoList() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"replicationInfoList",
...
func (j *jsiiProxy_CfnReplicator) ReplicatorName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"replicatorName",
...
func (j *jsiiProxy_CfnReplicator) ServiceExecutionRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnReplicator) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnReplicator) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnReplicator) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnReplicator) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnReplicator(scope constructs.Construct, id *string, props *CfnReplicatorProps) CfnReplicator {
	...
	if err := validateNewCfnReplicatorParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnReplicator{}
...
func (j *jsiiProxy_CfnReplicator)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnReplicator)SetKafkaClusters(val interface{}) {
	if err := j.validateSetKafkaClustersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnReplicator)SetReplicationInfoList(val interface{}) {
	if err := j.validateSetReplicationInfoListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnReplicator)SetReplicatorName(val *string) {
...
func (j *jsiiProxy_CfnReplicator)SetServiceExecutionRoleArn(val *string) {
...
func (j *jsiiProxy_CfnReplicator)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnReplicator_ArnForReplicator(resource interfacesawsmsk.IReplicatorRef) *string {
	_init_.Initialize()

	if err := validateCfnReplicator_ArnForReplicatorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnReplicator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReplicator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReplicator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReplicator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicator) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnReplicator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicator) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicator) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnReplicator) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnReplicator) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnReplicator) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnReplicator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicator) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnReplicator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReplicator) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnReplicator) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnReplicator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReplicator) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnReplicator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicator) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnReplicator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicator) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnReplicator) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnReplicator) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnReplicator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
