...
//
//   cfnTopic := awscdk.Aws_msk.NewCfnTopic(this, jsii.String("MyCfnTopic"), &CfnTopicProps{
...
type CfnTopic interface {
	...
	TopicRef() *interfacesawsmsk.TopicReference
	// Deprecated.
...
type jsiiProxy_CfnTopic struct {
	...
	internal.Type__interfacesawsmskITopicRef
}
...
func (j *jsiiProxy_CfnTopic) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTopic) ClusterArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterArn",
...
func (j *jsiiProxy_CfnTopic) Configs() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configs",
...
func (j *jsiiProxy_CfnTopic) PartitionCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"partitionCount",
...
func (j *jsiiProxy_CfnTopic) ReplicationFactor() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"replicationFactor",
...
func (j *jsiiProxy_CfnTopic) TopicRef() *interfacesawsmsk.TopicReference {
	var returns *interfacesawsmsk.TopicReference
	_jsii_.Get(
		j,
		"topicRef",
		&returns,
...
func (j *jsiiProxy_CfnTopic)SetClusterArn(val *string) {
...
func (j *jsiiProxy_CfnTopic)SetConfigs(val *string) {
	_jsii_.Set(
		j,
		"configs",
		val,
...
func (j *jsiiProxy_CfnTopic)SetPartitionCount(val *float64) {
...
func (j *jsiiProxy_CfnTopic)SetReplicationFactor(val *float64) {
...
func CfnTopic_ArnForTopic(resource interfacesawsmsk.ITopicRef) *string {
	_init_.Initialize()
...
func CfnTopic_IsCfnTopic(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTopic_IsCfnTopicParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTopic) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTopic) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTopic) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTopic) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
