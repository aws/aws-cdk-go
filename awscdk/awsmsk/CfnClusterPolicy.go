...
func (j *jsiiProxy_CfnClusterPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnClusterPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnClusterPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnClusterPolicy_IsCfnClusterPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnClusterPolicy_IsCfnClusterPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClusterPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnClusterPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClusterPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClusterPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClusterPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClusterPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClusterPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClusterPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClusterPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
