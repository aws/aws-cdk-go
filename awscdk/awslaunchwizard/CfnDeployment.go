...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awslaunchwizard/internal"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawslaunchwizard"
...
type CfnDeployment interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawslaunchwizard.IDeploymentRef
	awscdk.ITaggableV2
	...
	AttrDeletedAt() *string
	// The ID of the deployment.
	AttrDeploymentId() *string
	// The resource group of the deployment.
	AttrResourceGroup() *string
	...
	DeploymentRef() *interfacesawslaunchwizard.DeploymentReference
...
type jsiiProxy_CfnDeployment struct {
	...
	internal.Type__interfacesawslaunchwizardIDeploymentRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnDeployment) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnDeployment) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnDeployment) AttrDeletedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDeletedAt",
...
func (j *jsiiProxy_CfnDeployment) AttrResourceGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrResourceGroup",
...
func (j *jsiiProxy_CfnDeployment) DeploymentPatternName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDeployment) DeploymentRef() *interfacesawslaunchwizard.DeploymentReference {
	var returns *interfacesawslaunchwizard.DeploymentReference
	_jsii_.Get(
		j,
		"deploymentRef",
		&returns,
...
func (j *jsiiProxy_CfnDeployment) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDeployment) Specifications() interface{} {
...
func (j *jsiiProxy_CfnDeployment) WorkloadName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workloadName",
...
func (j *jsiiProxy_CfnDeployment)SetDeploymentPatternName(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetName(val *string) {
...
func (j *jsiiProxy_CfnDeployment)SetSpecifications(val interface{}) {
...
func (j *jsiiProxy_CfnDeployment)SetWorkloadName(val *string) {
