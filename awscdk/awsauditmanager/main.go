...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnAssessmentFramework)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrLastUpdatedBy", GoGetter: "AttrLastUpdatedBy"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsauditmanagerIAssessmentFrameworkRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_auditmanager.CfnAssessmentFramework.ControlSetControlProperty",
		reflect.TypeOf((*CfnAssessmentFramework_ControlSetControlProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_auditmanager.CfnAssessmentFramework.ControlSetProperty",
		reflect.TypeOf((*CfnAssessmentFramework_ControlSetProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_auditmanager.CfnAssessmentFrameworkProps",
		reflect.TypeOf((*CfnAssessmentFrameworkProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
