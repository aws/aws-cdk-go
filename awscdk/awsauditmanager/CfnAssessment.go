...
func (j *jsiiProxy_CfnAssessment) CfnPropertyNames() *map[string]*string {
...
func CfnAssessment_IsCfnAssessment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAssessment_IsCfnAssessmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAssessment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAssessment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAssessment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAssessment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAssessment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
