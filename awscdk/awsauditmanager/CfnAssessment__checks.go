...
func (c *jsiiProxy_CfnAssessment) validateAddDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
...
func (c *jsiiProxy_CfnAssessment) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnAssessment) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnAssessment) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnAssessment) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnAssessment) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnAssessment) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnAssessment_FromAssessmentIdParameters(scope constructs.Construct, id *string, assessmentId *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
	...
	if assessmentId == nil {
		return fmt.Errorf("parameter assessmentId is required, but nil was provided")
	}
...
func validateCfnAssessment_IsCfnResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnAssessment) validateSetDelegationsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnAssessment_DelegationProperty:
				v_ := v.(CfnAssessment_DelegationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnAssessment) validateSetTagsRawParameters(val *[]*awscdk.CfnTag) error {
	for idx_97dfc6, v := range *val {
		if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
			return err
		}
