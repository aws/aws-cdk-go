...
func (j *jsiiProxy_CfnStorageLens) CfnPropertyNames() *map[string]*string {
...
func NewCfnStorageLens(scope constructs.Construct, id *string, props *CfnStorageLensProps) CfnStorageLens {
	...
	if err := validateNewCfnStorageLensParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStorageLens)SetStorageLensConfiguration(val interface{}) {
	if err := j.validateSetStorageLensConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStorageLens_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStorageLens_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStorageLens_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStorageLens_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStorageLens_IsCfnStorageLens(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStorageLens_IsCfnStorageLensParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStorageLens_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStorageLens_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStorageLens) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageLens) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStorageLens) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStorageLens) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStorageLens) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStorageLens) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStorageLens) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageLens) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageLens) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageLens) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
