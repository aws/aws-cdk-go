...
func (j *jsiiProxy_CfnAccessGrant) AccessGrantsLocationId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessGrant) ApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationArn",
...
func (j *jsiiProxy_CfnAccessGrant) AttrAccessGrantArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAccessGrantArn",
...
func (j *jsiiProxy_CfnAccessGrant) AttrAccessGrantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAccessGrantId",
...
func (j *jsiiProxy_CfnAccessGrant) AttrGrantScope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGrantScope",
...
func (j *jsiiProxy_CfnAccessGrant) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAccessGrant) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAccessGrant) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccessGrant) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAccessGrant) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAccessGrant) Grantee() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grantee",
...
func (j *jsiiProxy_CfnAccessGrant) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAccessGrant) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAccessGrant) Permission() *string {
	var returns *string
	_jsii_.Get(
		j,
		"permission",
...
func (j *jsiiProxy_CfnAccessGrant) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAccessGrant) S3PrefixType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3PrefixType",
...
func (j *jsiiProxy_CfnAccessGrant) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAccessGrant) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAccessGrant) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAccessGrant) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccessGrant(scope constructs.Construct, id *string, props *CfnAccessGrantProps) CfnAccessGrant {
	...
	if err := validateNewCfnAccessGrantParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAccessGrant{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3.CfnAccessGrant",
...
func (j *jsiiProxy_CfnAccessGrant)SetAccessGrantsLocationConfiguration(val interface{}) {
	if err := j.validateSetAccessGrantsLocationConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAccessGrant)SetAccessGrantsLocationId(val *string) {
...
func (j *jsiiProxy_CfnAccessGrant)SetApplicationArn(val *string) {
	_jsii_.Set(
		j,
		"applicationArn",
		val,
...
func (j *jsiiProxy_CfnAccessGrant)SetGrantee(val interface{}) {
...
func (j *jsiiProxy_CfnAccessGrant)SetPermission(val *string) {
...
func (j *jsiiProxy_CfnAccessGrant)SetS3PrefixType(val *string) {
	_jsii_.Set(
		j,
		"s3PrefixType",
		val,
...
func (j *jsiiProxy_CfnAccessGrant)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnAccessGrant_ArnForAccessGrant(resource interfacesawss3.IAccessGrantRef) *string {
	_init_.Initialize()

	if err := validateCfnAccessGrant_ArnForAccessGrantParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAccessGrant_IsCfnAccessGrant(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAccessGrant_IsCfnAccessGrantParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrant_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessGrant_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrant_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccessGrant_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrant_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessGrant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessGrant) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAccessGrant) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrant) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrant) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrant) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrant) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAccessGrant) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrant) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessGrant) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessGrant) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAccessGrant) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessGrant) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessGrant) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAccessGrant) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAccessGrant) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessGrant) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAccessGrant) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrant) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrant) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAccessGrant) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrant) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAccessGrant) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAccessGrant) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAccessGrant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
