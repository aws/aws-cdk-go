...
type IBucketNotificationDestination interface {
	...
	Bind(scope constructs.Construct, bucket IBucketRef) *BucketNotificationDestinationConfig
}
...
func (i *jsiiProxy_IBucketNotificationDestination) Bind(scope constructs.Construct, bucket IBucketRef) *BucketNotificationDestinationConfig {
