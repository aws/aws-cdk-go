...
func (b *jsiiProxy_BucketBase) validateGrantOnKeyParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
...
func (b *jsiiProxy_BucketBase) validateGrantReplicationPermissionParameters(identity awsiam.IGrantable, props *GrantReplicationPermissionProps) error {
	if identity == nil {
		return fmt.Errorf("parameter identity is required, but nil was provided")
	}
