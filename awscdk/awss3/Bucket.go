...
func (j *jsiiProxy_Bucket) BucketRef() *interfacesawss3.BucketReference {
...
func (j *jsiiProxy_Bucket) Env() *interfaces.ResourceEnvironment {
...
func Bucket_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_s3.Bucket",
...
func (b *jsiiProxy_Bucket) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_Bucket) GrantReplicationPermission(identity awsiam.IGrantable, props *GrantReplicationPermissionProps) awsiam.Grant {
	if err := b.validateGrantReplicationPermissionParameters(identity, props); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
