...
func (j *jsiiProxy_BucketBase) NotificationsSkipDestinationValidation() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BucketBase) ReplicationRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"replicationRoleArn",
...
func (j *jsiiProxy_BucketBase)SetNotificationsSkipDestinationValidation(val *bool) {
	_jsii_.Set(
		j,
		"notificationsSkipDestinationValidation",
		val,
...
func (j *jsiiProxy_BucketBase)SetReplicationRoleArn(val *string) {
	_jsii_.Set(
		j,
		"replicationRoleArn",
		val,
...
func (b *jsiiProxy_BucketBase) AddReplicationPolicy(roleArn *string, accessControlTransition *bool, account *string) {
...
func (b *jsiiProxy_BucketBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BucketBase) GrantReplicationPermission(identity awsiam.IGrantable, props *GrantReplicationPermissionProps) awsiam.Grant {
...
func (b *jsiiProxy_BucketBase) MaybeAutoCreatePolicy() {
	_jsii_.InvokeVoid(
		b,
		"maybeAutoCreatePolicy",
		nil, // no parameters
...
func (b *jsiiProxy_BucketBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
