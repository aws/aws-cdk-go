...
func (j *jsiiProxy_CfnAccessPoint) BucketAccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketAccountId",
...
func (j *jsiiProxy_CfnAccessPoint)SetBucketAccountId(val *string) {
	_jsii_.Set(
		j,
		"bucketAccountId",
		val,
...
func CfnAccessPoint_ArnForAccessPoint(resource interfacesawss3.IAccessPointRef) *string {
	_init_.Initialize()
