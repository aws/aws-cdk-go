...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnAccessPoint.PolicyStatusProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnMultiRegionAccessPointPolicy.PolicyStatusProperty",
		reflect.TypeOf((*CfnMultiRegionAccessPointPolicy_PolicyStatusProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty",
		reflect.TypeOf((*CfnStorageLens_AdvancedCostOptimizationMetricsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnStorageLens.DetailedStatusCodesMetricsProperty",
		reflect.TypeOf((*CfnStorageLens_DetailedStatusCodesMetricsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_s3.CfnStorageLens.SSEKMSProperty",
