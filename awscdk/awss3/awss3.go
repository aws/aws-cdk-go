...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3.CfnAccessPoint.PolicyStatusProperty",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3.CfnMultiRegionAccessPointPolicy.PolicyStatusProperty",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3.CfnStorageLens.AdvancedCostOptimizationMetricsProperty",
		reflect.TypeOf((*CfnStorageLens_AdvancedCostOptimizationMetricsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3.CfnStorageLens.AdvancedDataProtectionMetricsProperty",
