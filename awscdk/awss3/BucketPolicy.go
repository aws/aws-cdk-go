...
func (b *jsiiProxy_BucketPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BucketPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
