...
func (j *jsiiProxy_CfnAccessGrantsLocation) AttrAccessGrantsLocationId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessGrantsLocation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) IamRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iamRoleArn",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) LocationScope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationScope",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnAccessGrantsLocation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAccessGrantsLocation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccessGrantsLocation(scope constructs.Construct, id *string, props *CfnAccessGrantsLocationProps) CfnAccessGrantsLocation {
	...
	if err := validateNewCfnAccessGrantsLocationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAccessGrantsLocation{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3.CfnAccessGrantsLocation",
...
func (j *jsiiProxy_CfnAccessGrantsLocation)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnAccessGrantsLocation_ArnForAccessGrantsLocation(resource interfacesawss3.IAccessGrantsLocationRef) *string {
	_init_.Initialize()

	if err := validateCfnAccessGrantsLocation_ArnForAccessGrantsLocationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAccessGrantsLocation_IsCfnAccessGrantsLocation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAccessGrantsLocation_IsCfnAccessGrantsLocationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrantsLocation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessGrantsLocation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrantsLocation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccessGrantsLocation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessGrantsLocation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessGrantsLocation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessGrantsLocation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAccessGrantsLocation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAccessGrantsLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
