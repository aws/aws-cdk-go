...
func (b *jsiiProxy_Bucket) validateAddReplicationPolicyParameters(roleArn *string) error {
	return nil
}
...
func (b *jsiiProxy_Bucket) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (b *jsiiProxy_Bucket) validateGrantReplicationPermissionParameters(identity awsiam.IGrantable, props *GrantReplicationPermissionProps) error {
	return nil
}
