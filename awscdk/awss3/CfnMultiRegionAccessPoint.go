...
func (j *jsiiProxy_CfnMultiRegionAccessPoint) CfnPropertyNames() *map[string]*string {
...
func CfnMultiRegionAccessPoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMultiRegionAccessPoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMultiRegionAccessPoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMultiRegionAccessPoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMultiRegionAccessPoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMultiRegionAccessPoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMultiRegionAccessPoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
