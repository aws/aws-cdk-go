...
func (i *jsiiProxy_IBucket) GrantReplicationPermission(identity awsiam.IGrantable, props *GrantReplicationPermissionProps) awsiam.Grant {
	if err := i.validateGrantReplicationPermissionParameters(identity, props); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
...
func (i *jsiiProxy_IBucket) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (i *jsiiProxy_IBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IBucket) Node() constructs.Node {
...
func (j *jsiiProxy_IBucket) Stack() awscdk.Stack {
