...
func (j *jsiiProxy_CfnSignalMap) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSignalMap) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSignalMap) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSignalMap) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSignalMap) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSignalMap) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
