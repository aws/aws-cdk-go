...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawsmedialive.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetNetworkSettingsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_ClusterNetworkSettingsProperty:
		val := val.(*CfnCluster_ClusterNetworkSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_ClusterNetworkSettingsProperty:
		val_ := val.(CfnCluster_ClusterNetworkSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_ClusterNetworkSettingsProperty; received %#v (a %T)", val, val)
		}
	}
