...
func (j *jsiiProxy_CfnChannel) ChannelEngineVersion() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnChannel) DryRun() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dryRun",
...
func (j *jsiiProxy_CfnChannel)SetChannelEngineVersion(val interface{}) {
	if err := j.validateSetChannelEngineVersionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnChannel)SetDryRun(val interface{}) {
