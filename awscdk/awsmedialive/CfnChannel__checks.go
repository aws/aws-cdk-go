...
func validateCfnChannel_ArnForChannelParameters(resource interfacesawsmedialive.IChannelRef) error {
	if resource == nil {
...
func validateCfnChannel_FromChannelIdParameters(scope constructs.Construct, id *string, channelId *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
	...
	if channelId == nil {
		return fmt.Errorf("parameter channelId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnChannel) validateSetAnywhereSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_AnywhereSettingsProperty:
		val := val.(*CfnChannel_AnywhereSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_AnywhereSettingsProperty:
		val_ := val.(CfnChannel_AnywhereSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_AnywhereSettingsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetChannelEngineVersionParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_ChannelEngineVersionRequestProperty:
		val := val.(*CfnChannel_ChannelEngineVersionRequestProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_ChannelEngineVersionRequestProperty:
		val_ := val.(CfnChannel_ChannelEngineVersionRequestProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_ChannelEngineVersionRequestProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetDryRunParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnChannel) validateSetLinkedChannelSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_LinkedChannelSettingsProperty:
		val := val.(*CfnChannel_LinkedChannelSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_LinkedChannelSettingsProperty:
		val_ := val.(CfnChannel_LinkedChannelSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_LinkedChannelSettingsProperty; received %#v (a %T)", val, val)
		}
	}
