...
func CfnMultiplexprogram_IsCfnResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateCfnMultiplexprogram_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
