...
func (j *jsiiProxy_CfnMultiplexprogram) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnMultiplexprogram) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMultiplexprogram) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMultiplexprogram) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMultiplexprogram) RemoveResourceDependency(target awscdk.CfnResource) {
