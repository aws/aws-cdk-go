...
//
//   cfnNode := awscdk.Aws_medialive.NewCfnNode(this, jsii.String("MyCfnNode"), &CfnNodeProps{
...
type CfnNode interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsmedialive.INodeRef
	awscdk.ITaggableV2
	// The ARN of the Node.
	//
	...
	AttrChannelPlacementGroups() *[]*string
	// The current connection state of the Node.
	AttrConnectionState() *string
	...
	NodeInterfaceMappings() interface{}
	SetNodeInterfaceMappings(val interface{})
	// A reference to a Node resource.
	NodeRef() *interfacesawsmedialive.NodeReference
	...
	SdiSourceMappings() interface{}
	SetSdiSourceMappings(val interface{})
...
type jsiiProxy_CfnNode struct {
	...
	internal.Type__interfacesawsmedialiveINodeRef
...
func (j *jsiiProxy_CfnNode) AttrChannelPlacementGroups() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrChannelPlacementGroups",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnNode) AttrConnectionState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrConnectionState",
...
func (j *jsiiProxy_CfnNode) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnNode) AttrInstanceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrInstanceArn",
...
func (j *jsiiProxy_CfnNode) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnNode) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnNode) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNode) ClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterId",
...
func (j *jsiiProxy_CfnNode) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnNode) NodeInterfaceMappings() interface{} {
...
func (j *jsiiProxy_CfnNode) NodeRef() *interfacesawsmedialive.NodeReference {
	var returns *interfacesawsmedialive.NodeReference
	_jsii_.Get(
		j,
		"nodeRef",
		&returns,
...
func (j *jsiiProxy_CfnNode) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_CfnNode) SdiSourceMappings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sdiSourceMappings",
...
func (j *jsiiProxy_CfnNode) Tags() *[]*awscdk.CfnTag {
...
func NewCfnNode(scope constructs.Construct, id *string, props *CfnNodeProps) CfnNode {
	...
	if err := validateNewCfnNodeParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnNode{}

	_jsii_.Create(
		"aws-cdk-lib.aws_medialive.CfnNode",
...
func (j *jsiiProxy_CfnNode)SetClusterId(val *string) {
...
func (j *jsiiProxy_CfnNode)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnNode)SetNodeInterfaceMappings(val interface{}) {
	if err := j.validateSetNodeInterfaceMappingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnNode)SetRole(val *string) {
	_jsii_.Set(
		j,
		"role",
		val,
...
func (j *jsiiProxy_CfnNode)SetSdiSourceMappings(val interface{}) {
	if err := j.validateSetSdiSourceMappingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnNode)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnNode_ArnForNode(resource interfacesawsmedialive.INodeRef) *string {
	_init_.Initialize()
...
func CfnNode_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNode_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNode_IsCfnNode(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnNode_IsCfnNodeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNode_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNode_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNode_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNode_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNode) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNode) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNode) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNode) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNode) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNode) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNode) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNode) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNode) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNode) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
