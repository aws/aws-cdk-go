...
func (c *jsiiProxy_CfnInput) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnInput) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnInput) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnInput) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnInput_FromInputIdParameters(scope constructs.Construct, id *string, inputId *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
	...
	if inputId == nil {
		return fmt.Errorf("parameter inputId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnInput) validateSetSmpte2110ReceiverGroupSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnInput_Smpte2110ReceiverGroupSettingsProperty:
		val := val.(*CfnInput_Smpte2110ReceiverGroupSettingsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnInput_Smpte2110ReceiverGroupSettingsProperty:
		val_ := val.(CfnInput_Smpte2110ReceiverGroupSettingsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnInput_Smpte2110ReceiverGroupSettingsProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnInput) validateSetSrtSettingsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnInput_SrtSettingsRequestProperty:
		val := val.(*CfnInput_SrtSettingsRequestProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnInput_SrtSettingsRequestProperty:
		val_ := val.(CfnInput_SrtSettingsRequestProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnInput_SrtSettingsRequestProperty; received %#v (a %T)", val, val)
		}
	}
