...
type CfnInput interface {
	...
	SetSmpte2110ReceiverGroupSettings(val interface{})
...
func (j *jsiiProxy_CfnInput) Smpte2110ReceiverGroupSettings() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnInput)SetSdiSources(val *[]*string) {
	_jsii_.Set(
		j,
		"sdiSources",
		val,
...
func (j *jsiiProxy_CfnInput)SetSmpte2110ReceiverGroupSettings(val interface{}) {
	if err := j.validateSetSmpte2110ReceiverGroupSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
