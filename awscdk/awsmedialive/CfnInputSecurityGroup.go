...
func (j *jsiiProxy_CfnInputSecurityGroup) CfnPropertyNames() *map[string]*string {
...
func CfnInputSecurityGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnInputSecurityGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInputSecurityGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInputSecurityGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInputSecurityGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInputSecurityGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInputSecurityGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
