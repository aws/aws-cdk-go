...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnChannel.DisabledLockingSettingsProperty",
		reflect.TypeOf((*CfnChannel_DisabledLockingSettingsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrChannelPlacementGroups", GoGetter: "AttrChannelPlacementGroups"},
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "nodeInterfaceMappings", GoGetter: "NodeInterfaceMappings"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sdiSourceMappings", GoGetter: "SdiSourceMappings"},
			_jsii_.MemberMethod{JsiiMethod: "shouldSynthesize", GoMethod: "ShouldSynthesize"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "tags", GoGetter: "Tags"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmedialiveINodeRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnNode.NodeInterfaceMappingProperty",
		reflect.TypeOf((*CfnNode_NodeInterfaceMappingProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnNode.SdiSourceMappingProperty",
		reflect.TypeOf((*CfnNode_SdiSourceMappingProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnNodeProps",
		reflect.TypeOf((*CfnNodeProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_medialive.CfnOffering",
		reflect.TypeOf((*CfnOffering)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrCurrencyCode", GoGetter: "AttrCurrencyCode"},
			_jsii_.MemberProperty{JsiiProperty: "attrDuration", GoGetter: "AttrDuration"},
			_jsii_.MemberProperty{JsiiProperty: "attrDurationUnits", GoGetter: "AttrDurationUnits"},
			_jsii_.MemberProperty{JsiiProperty: "attrFixedPrice", GoGetter: "AttrFixedPrice"},
			_jsii_.MemberProperty{JsiiProperty: "attrOfferingDescription", GoGetter: "AttrOfferingDescription"},
			_jsii_.MemberProperty{JsiiProperty: "attrOfferingId", GoGetter: "AttrOfferingId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrResourceSpecification", GoGetter: "AttrResourceSpecification"},
			...
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "obtainDependencies", GoMethod: "ObtainDependencies"},
			_jsii_.MemberProperty{JsiiProperty: "offeringRef", GoGetter: "OfferingRef"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "ref", GoGetter: "Ref"},
			_jsii_.MemberMethod{JsiiMethod: "removeDependency", GoMethod: "RemoveDependency"},
			_jsii_.MemberMethod{JsiiMethod: "removeResourceDependency", GoMethod: "RemoveResourceDependency"},
		...
		func() interface{} {
			j := jsiiProxy_CfnOffering{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsmedialiveIOfferingRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnOffering.ReservationResourceSpecificationProperty",
		reflect.TypeOf((*CfnOffering_ReservationResourceSpecificationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_medialive.CfnOfferingProps",
		reflect.TypeOf((*CfnOfferingProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
