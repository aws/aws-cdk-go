...
func (j *jsiiProxy_CfnInputSecurityGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnInputSecurityGroup(scope constructs.Construct, id *string, props *CfnInputSecurityGroupProps) CfnInputSecurityGroup {
	...
	if err := validateNewCfnInputSecurityGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnInputSecurityGroup)SetWhitelistRules(val interface{}) {
	if err := j.validateSetWhitelistRulesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnInputSecurityGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnInputSecurityGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInputSecurityGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnInputSecurityGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInputSecurityGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnInputSecurityGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInputSecurityGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInputSecurityGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnInputSecurityGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInputSecurityGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnInputSecurityGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInputSecurityGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
