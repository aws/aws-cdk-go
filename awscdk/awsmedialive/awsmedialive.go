...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.AudioDolbyEDecodeProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.DolbyVision81SettingsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.Eac3AtmosSettingsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.EsamProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.MaintenanceCreateSettingsProperty",
		reflect.TypeOf((*CfnChannel_MaintenanceCreateSettingsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.MaintenanceUpdateSettingsProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_medialive.CfnChannel.TimecodeBurninSettingsProperty",
