...
//
//   cfnCluster := awscdk.Aws_medialive.NewCfnCluster(this, jsii.String("MyCfnCluster"), &CfnClusterProps{
...
type CfnCluster interface {
	...
	SetNetworkSettings(val interface{})
	// The tree node.
...
func (j *jsiiProxy_CfnCluster) AttrChannelIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrChannelIds",
...
func (j *jsiiProxy_CfnCluster) InstanceRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceRoleArn",
...
func (j *jsiiProxy_CfnCluster) NetworkSettings() interface{} {
...
func (j *jsiiProxy_CfnCluster)SetInstanceRoleArn(val *string) {
	_jsii_.Set(
		j,
		"instanceRoleArn",
		val,
...
func (j *jsiiProxy_CfnCluster)SetNetworkSettings(val interface{}) {
	if err := j.validateSetNetworkSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
