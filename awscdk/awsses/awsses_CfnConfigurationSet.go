...
func (j *jsiiProxy_CfnConfigurationSet) VdmOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vdmOptions",
...
func (j *jsiiProxy_CfnConfigurationSet)SetSuppressionOptions(val interface{}) {
	if err := j.validateSetSuppressionOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnConfigurationSet)SetVdmOptions(val interface{}) {
	if err := j.validateSetVdmOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnConfigurationSet_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnConfigurationSet_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
