...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "archivingOptions", GoGetter: "ArchivingOptions"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_ses.CfnConfigurationSet.ArchivingOptionsProperty",
		reflect.TypeOf((*CfnConfigurationSet_ArchivingOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnCustomVerificationEmailTemplate)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberProperty{JsiiProperty: "failureRedirectionUrl", GoGetter: "FailureRedirectionUrl"},
			...
			_jsii_.MemberMethod{JsiiMethod: "shouldSynthesize", GoMethod: "ShouldSynthesize"},
			_jsii_.MemberProperty{JsiiProperty: "stack", GoGetter: "Stack"},
			_jsii_.MemberProperty{JsiiProperty: "successRedirectionUrl", GoGetter: "SuccessRedirectionUrl"},
			_jsii_.MemberProperty{JsiiProperty: "tags", GoGetter: "Tags"},
			...
			_jsii_.MemberProperty{JsiiProperty: "templateSubject", GoGetter: "TemplateSubject"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "updatedProperites", GoGetter: "UpdatedProperites"},
			_jsii_.MemberProperty{JsiiProperty: "updatedProperties", GoGetter: "UpdatedProperties"},
			_jsii_.MemberMethod{JsiiMethod: "validateProperties", GoMethod: "ValidateProperties"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawssesICustomVerificationEmailTemplateRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_ses.CfnCustomVerificationEmailTemplateProps",
		reflect.TypeOf((*CfnCustomVerificationEmailTemplateProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_ses.ConfigurationSetEventDestinationAttributes",
		reflect.TypeOf((*ConfigurationSetEventDestinationAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_ses.ReceiptRuleAttributes",
		reflect.TypeOf((*ReceiptRuleAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
