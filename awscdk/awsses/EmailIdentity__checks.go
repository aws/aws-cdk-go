...
func (e *jsiiProxy_EmailIdentity) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateEmailIdentity_FromEmailIdentityArnParameters(scope constructs.Construct, id *string, emailIdentityArn *string) error {
	if scope == nil {
	...
	if emailIdentityArn == nil {
		return fmt.Errorf("parameter emailIdentityArn is required, but nil was provided")
	}
...
func validateEmailIdentity_FromEmailIdentityNameParameters(scope constructs.Construct, id *string, emailIdentityName *string) error {
	...
	if emailIdentityName == nil {
		return fmt.Errorf("parameter emailIdentityName is required, but nil was provided")
	}
