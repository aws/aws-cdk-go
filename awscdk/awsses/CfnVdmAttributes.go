...
func (j *jsiiProxy_CfnVdmAttributes) CfnPropertyNames() *map[string]*string {
...
func CfnVdmAttributes_IsCfnVdmAttributes(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVdmAttributes_IsCfnVdmAttributesParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVdmAttributes) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVdmAttributes) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVdmAttributes) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVdmAttributes) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVdmAttributes) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
