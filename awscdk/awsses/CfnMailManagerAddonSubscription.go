...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) AddonName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"addonName",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) AttrAddonSubscriptionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAddonSubscriptionArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnMailManagerAddonSubscription) AttrAddonSubscriptionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAddonSubscriptionId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnMailManagerAddonSubscription) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMailManagerAddonSubscription(scope constructs.Construct, id *string, props *CfnMailManagerAddonSubscriptionProps) CfnMailManagerAddonSubscription {
	...
	if err := validateNewCfnMailManagerAddonSubscriptionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription)SetAddonName(val *string) {
...
func (j *jsiiProxy_CfnMailManagerAddonSubscription)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnMailManagerAddonSubscription_ArnForMailManagerAddonSubscription(resource interfacesawsses.IMailManagerAddonSubscriptionRef) *string {
	_init_.Initialize()

	if err := validateCfnMailManagerAddonSubscription_ArnForMailManagerAddonSubscriptionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ses.CfnMailManagerAddonSubscription",
		"arnForMailManagerAddonSubscription",
		[]interface{}{resource},
		&returns,
	)
...
func CfnMailManagerAddonSubscription_FromAddonSubscriptionId(scope constructs.Construct, id *string, addonSubscriptionId *string) interfacesawsses.IMailManagerAddonSubscriptionRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ses.CfnMailManagerAddonSubscription",
		"fromAddonSubscriptionId",
		[]interface{}{scope, id, addonSubscriptionId},
		&returns,
	)
...
func CfnMailManagerAddonSubscription_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMailManagerAddonSubscription_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMailManagerAddonSubscription_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMailManagerAddonSubscription_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMailManagerAddonSubscription_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMailManagerAddonSubscription_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMailManagerAddonSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
