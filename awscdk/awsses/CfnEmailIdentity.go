...
func (j *jsiiProxy_CfnEmailIdentity) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnEmailIdentity.
func CfnEmailIdentity_IsCfnEmailIdentity(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEmailIdentity_IsCfnEmailIdentityParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEmailIdentity) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEmailIdentity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEmailIdentity) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEmailIdentity) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
