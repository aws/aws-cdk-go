...
func (j *jsiiProxy_CfnReceiptRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReceiptRule) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnReceiptRule) ReceiptRuleRef() *interfacesawsses.ReceiptRuleReference {
...
func NewCfnReceiptRule(scope constructs.Construct, id *string, props *CfnReceiptRuleProps) CfnReceiptRule {
	...
	if err := validateNewCfnReceiptRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReceiptRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReceiptRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReceiptRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReceiptRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReceiptRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReceiptRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReceiptRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReceiptRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReceiptRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReceiptRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
