...
func (j *jsiiProxy_CfnReceiptFilter) CfnPropertyNames() *map[string]*string {
...
func CfnReceiptFilter_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReceiptFilter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReceiptFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReceiptFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReceiptFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReceiptFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
