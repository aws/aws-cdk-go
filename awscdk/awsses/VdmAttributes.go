...
func (j *jsiiProxy_VdmAttributes) Env() *interfaces.ResourceEnvironment {
...
func VdmAttributes_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ses.VdmAttributes",
...
func (v *jsiiProxy_VdmAttributes) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VdmAttributes) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
