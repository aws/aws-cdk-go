...
func (j *jsiiProxy_ReceiptRuleSet) Env() *interfaces.ResourceEnvironment {
...
func (r *jsiiProxy_ReceiptRuleSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ReceiptRuleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
