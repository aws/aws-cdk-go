...
func (j *jsiiProxy_ConfigurationSet) Env() *interfaces.ResourceEnvironment {
...
func NewConfigurationSet(scope constructs.Construct, id *string, props *ConfigurationSetProps) ConfigurationSet {
	...
	if err := validateNewConfigurationSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func ConfigurationSet_FromConfigurationSetName(scope constructs.Construct, id *string, configurationSetName *string) IConfigurationSet {
	...
	if err := validateConfigurationSet_FromConfigurationSetNameParameters(scope, id, configurationSetName); err != nil {
		panic(err)
	}
...
func ConfigurationSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateConfigurationSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ConfigurationSet_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateConfigurationSet_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ConfigurationSet_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateConfigurationSet_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ConfigurationSet_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ses.ConfigurationSet",
...
func (c *jsiiProxy_ConfigurationSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_ConfigurationSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
