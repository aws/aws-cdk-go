...
func (j *jsiiProxy_ReceiptFilter) Env() *interfaces.ResourceEnvironment {
...
func ReceiptFilter_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ses.ReceiptFilter",
...
func (r *jsiiProxy_ReceiptFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ReceiptFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
