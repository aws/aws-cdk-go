...
func NewCfnReceiptRuleSet(scope constructs.Construct, id *string, props *CfnReceiptRuleSetProps) CfnReceiptRuleSet {
	...
	if err := validateNewCfnReceiptRuleSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReceiptRuleSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReceiptRuleSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptRuleSet_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnReceiptRuleSet_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptRuleSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReceiptRuleSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReceiptRuleSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRuleSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReceiptRuleSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReceiptRuleSet) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnReceiptRuleSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRuleSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
