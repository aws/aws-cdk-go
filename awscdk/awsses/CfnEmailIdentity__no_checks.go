...
func (c *jsiiProxy_CfnEmailIdentity) validateAddDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnEmailIdentity) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnEmailIdentity) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnEmailIdentity) validateRemoveDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnEmailIdentity) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func (c *jsiiProxy_CfnEmailIdentity) validateReplaceDependencyParameters(target awscdk.CfnResource, newTarget awscdk.CfnResource) error {
	return nil
}
...
func validateCfnEmailIdentity_IsCfnEmailIdentityParameters(x interface{}) error {
	return nil
}

func validateCfnEmailIdentity_IsCfnResourceParameters(x interface{}) error {
	return nil
}
