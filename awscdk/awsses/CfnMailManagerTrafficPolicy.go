...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) AttrTrafficPolicyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) AttrTrafficPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTrafficPolicyId",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) DefaultAction() *string {
	var returns *string
	_jsii_.Get(
		j,
		"defaultAction",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) MaxMessageSizeBytes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxMessageSizeBytes",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) PolicyStatements() interface{} {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) TrafficPolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"trafficPolicyName",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMailManagerTrafficPolicy(scope constructs.Construct, id *string, props *CfnMailManagerTrafficPolicyProps) CfnMailManagerTrafficPolicy {
	...
	if err := validateNewCfnMailManagerTrafficPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy)SetDefaultAction(val *string) {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy)SetMaxMessageSizeBytes(val *float64) {
	_jsii_.Set(
		j,
		"maxMessageSizeBytes",
		val,
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy)SetPolicyStatements(val interface{}) {
	if err := j.validateSetPolicyStatementsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicy)SetTrafficPolicyName(val *string) {
	_jsii_.Set(
		j,
		"trafficPolicyName",
		val,
...
func CfnMailManagerTrafficPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMailManagerTrafficPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMailManagerTrafficPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMailManagerTrafficPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMailManagerTrafficPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMailManagerTrafficPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
