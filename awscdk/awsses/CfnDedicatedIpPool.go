...
func (j *jsiiProxy_CfnDedicatedIpPool) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDedicatedIpPool) DedicatedIpPoolRef() *interfacesawsses.DedicatedIpPoolReference {
...
func NewCfnDedicatedIpPool(scope constructs.Construct, id *string, props *CfnDedicatedIpPoolProps) CfnDedicatedIpPool {
	...
	if err := validateNewCfnDedicatedIpPoolParameters(scope, id, props); err != nil {
		panic(err)
	}
...
// Checks whether the given object is a CfnDedicatedIpPool.
func CfnDedicatedIpPool_IsCfnDedicatedIpPool(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDedicatedIpPool_IsCfnDedicatedIpPoolParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDedicatedIpPool_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDedicatedIpPool_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDedicatedIpPool_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDedicatedIpPool_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDedicatedIpPool_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDedicatedIpPool_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDedicatedIpPool) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDedicatedIpPool) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDedicatedIpPool) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDedicatedIpPool) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDedicatedIpPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
