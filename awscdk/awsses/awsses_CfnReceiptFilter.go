...
func NewCfnReceiptFilter(scope constructs.Construct, id *string, props *CfnReceiptFilterProps) CfnReceiptFilter {
	...
	if err := validateNewCfnReceiptFilterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReceiptFilter_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReceiptFilter_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptFilter_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnReceiptFilter_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReceiptFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReceiptFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReceiptFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReceiptFilter) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnReceiptFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
