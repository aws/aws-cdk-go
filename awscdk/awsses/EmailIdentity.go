...
func (j *jsiiProxy_EmailIdentity) Env() *interfaces.ResourceEnvironment {
...
func (e *jsiiProxy_EmailIdentity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EmailIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
