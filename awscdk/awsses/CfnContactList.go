...
func (j *jsiiProxy_CfnContactList) CfnPropertyNames() *map[string]*string {
...
func NewCfnContactList(scope constructs.Construct, id *string, props *CfnContactListProps) CfnContactList {
	...
	if err := validateNewCfnContactListParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnContactList_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnContactList_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContactList_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnContactList_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContactList_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnContactList_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContactList) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactList) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContactList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContactList) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContactList) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnContactList) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnContactList) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactList) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactList) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContactList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
