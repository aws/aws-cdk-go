...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ses.CfnConfigurationSetEventDestination.SnsDestinationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ses.CfnDedicatedIpPoolProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_ses.CfnVdmAttributes.DashboardAttributesProperty",
		reflect.TypeOf((*CfnVdmAttributes_DashboardAttributesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_ses.CfnVdmAttributes.GuardianAttributesProperty",
		reflect.TypeOf((*CfnVdmAttributes_GuardianAttributesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_ses.CfnVdmAttributesProps",
