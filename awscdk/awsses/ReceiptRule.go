...
func (j *jsiiProxy_ReceiptRule) Env() *interfaces.ResourceEnvironment {
...
func ReceiptRule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ses.ReceiptRule",
...
func (r *jsiiProxy_ReceiptRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
