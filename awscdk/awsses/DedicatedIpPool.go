...
func (d *jsiiProxy_DedicatedIpPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DedicatedIpPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
