...
func (j *jsiiProxy_CfnReceiptRuleSet) CfnPropertyNames() *map[string]*string {
...
func CfnReceiptRuleSet_IsCfnReceiptRuleSet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnReceiptRuleSet_IsCfnReceiptRuleSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReceiptRuleSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReceiptRuleSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReceiptRuleSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReceiptRuleSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReceiptRuleSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReceiptRuleSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReceiptRuleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
