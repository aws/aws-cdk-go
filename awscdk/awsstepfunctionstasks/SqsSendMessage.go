...
func (s *jsiiProxy_SqsSendMessage) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (s *jsiiProxy_SqsSendMessage) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqsSendMessage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
