...
func (j *jsiiProxy_EmrCancelStep) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_EmrCancelStep) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_EmrCancelStep) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_EmrCancelStep)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_EmrCancelStep)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EmrCancelStep) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (e *jsiiProxy_EmrCancelStep) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EmrCancelStep) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrCancelStep) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmrCancelStep) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrCancelStep) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
