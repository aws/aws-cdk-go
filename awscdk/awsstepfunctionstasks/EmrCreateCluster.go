...
func (j *jsiiProxy_EmrCreateCluster) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_EmrCreateCluster) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_EmrCreateCluster) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func NewEmrCreateCluster(scope constructs.Construct, id *string, props *EmrCreateClusterProps) EmrCreateCluster {
	...
	if err := validateNewEmrCreateClusterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EmrCreateCluster)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_EmrCreateCluster)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func EmrCreateCluster_FilterNextables(states *[]awsstepfunctions.State) *[]awsstepfunctions.INextable {
	...
	if err := validateEmrCreateCluster_FilterNextablesParameters(states); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.INextable
...
func EmrCreateCluster_FindReachableEndStates(start awsstepfunctions.State, options *awsstepfunctions.FindStateOptions) *[]awsstepfunctions.State {
	...
	if err := validateEmrCreateCluster_FindReachableEndStatesParameters(start, options); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.State
...
func EmrCreateCluster_FindReachableStates(start awsstepfunctions.State, options *awsstepfunctions.FindStateOptions) *[]awsstepfunctions.State {
	...
	if err := validateEmrCreateCluster_FindReachableStatesParameters(start, options); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.State
...
func EmrCreateCluster_IsConstruct(x interface{}) *bool {
	...
	if err := validateEmrCreateCluster_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func EmrCreateCluster_PrefixStates(root constructs.IConstruct, prefix *string) {
	...
	if err := validateEmrCreateCluster_PrefixStatesParameters(root, prefix); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EmrCreateCluster) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (e *jsiiProxy_EmrCreateCluster) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EmrCreateCluster) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrCreateCluster) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EmrCreateCluster) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrCreateCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
