...
func (c *jsiiProxy_CallAwsService) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	return nil
}

func (c *jsiiProxy_CallAwsService) validateAddItemProcessorParameters(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) error {
	return nil
}
...
func (c *jsiiProxy_CallAwsService) validateNextParameters(state awsstepfunctions.IChainable) error {
	return nil
}
...
func (j *jsiiProxy_CallAwsService) validateSetProcessorConfigParameters(val *awsstepfunctions.ProcessorConfig) error {
	return nil
}
