...
func (j *jsiiProxy_EmrContainersCreateVirtualCluster) ProcessorMode() awsstepfunctions.ProcessorMode {
...
func (j *jsiiProxy_EmrContainersCreateVirtualCluster)SetProcessorMode(val awsstepfunctions.ProcessorMode) {
	_jsii_.Set(
		j,
		"processorMode",
		val,
...
func (e *jsiiProxy_EmrContainersCreateVirtualCluster) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrContainersCreateVirtualCluster) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrContainersCreateVirtualCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
