...
func (j *jsiiProxy_GlueStartCrawlerRun) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_GlueStartCrawlerRun) DefaultChoice() awsstepfunctions.State {
...
func (j *jsiiProxy_GlueStartCrawlerRun) EndStates() *[]awsstepfunctions.INextable {
...
func (j *jsiiProxy_GlueStartCrawlerRun) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GlueStartCrawlerRun) InputPath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"inputPath",
...
func (j *jsiiProxy_GlueStartCrawlerRun) Iteration() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"iteration",
...
func (j *jsiiProxy_GlueStartCrawlerRun) Node() constructs.Node {
...
func (j *jsiiProxy_GlueStartCrawlerRun) OutputPath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outputPath",
...
func (j *jsiiProxy_GlueStartCrawlerRun) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_GlueStartCrawlerRun) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_GlueStartCrawlerRun) ProcessorMode() awsstepfunctions.ProcessorMode {
...
func (j *jsiiProxy_GlueStartCrawlerRun) ResultPath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resultPath",
...
func (j *jsiiProxy_GlueStartCrawlerRun) ResultSelector() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"resultSelector",
...
func (j *jsiiProxy_GlueStartCrawlerRun) StartState() awsstepfunctions.State {
	var returns awsstepfunctions.State
	_jsii_.Get(
		j,
		"startState",
...
func (j *jsiiProxy_GlueStartCrawlerRun) StateId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateId",
...
func (j *jsiiProxy_GlueStartCrawlerRun) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_GlueStartCrawlerRun) TaskMetrics() *awsstepfunctions.TaskMetricsConfig {
...
func (j *jsiiProxy_GlueStartCrawlerRun) TaskPolicies() *[]awsiam.PolicyStatement {
...
func NewGlueStartCrawlerRun(scope constructs.Construct, id *string, props *GlueStartCrawlerRunProps) GlueStartCrawlerRun {
	...
	if err := validateNewGlueStartCrawlerRunParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_GlueStartCrawlerRun)SetDefaultChoice(val awsstepfunctions.State) {
	_jsii_.Set(
		j,
		"defaultChoice",
		val,
...
func (j *jsiiProxy_GlueStartCrawlerRun)SetIteration(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"iteration",
		val,
...
func (j *jsiiProxy_GlueStartCrawlerRun)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_GlueStartCrawlerRun)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (j *jsiiProxy_GlueStartCrawlerRun)SetProcessorMode(val awsstepfunctions.ProcessorMode) {
	_jsii_.Set(
		j,
		"processorMode",
		val,
...
func GlueStartCrawlerRun_FilterNextables(states *[]awsstepfunctions.State) *[]awsstepfunctions.INextable {
	...
	if err := validateGlueStartCrawlerRun_FilterNextablesParameters(states); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.INextable
...
func GlueStartCrawlerRun_FindReachableEndStates(start awsstepfunctions.State, options *awsstepfunctions.FindStateOptions) *[]awsstepfunctions.State {
	...
	if err := validateGlueStartCrawlerRun_FindReachableEndStatesParameters(start, options); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.State
...
func GlueStartCrawlerRun_FindReachableStates(start awsstepfunctions.State, options *awsstepfunctions.FindStateOptions) *[]awsstepfunctions.State {
	...
	if err := validateGlueStartCrawlerRun_FindReachableStatesParameters(start, options); err != nil {
		panic(err)
	}
	var returns *[]awsstepfunctions.State
...
func GlueStartCrawlerRun_IsConstruct(x interface{}) *bool {
	...
	if err := validateGlueStartCrawlerRun_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func GlueStartCrawlerRun_PrefixStates(root constructs.IConstruct, prefix *string) {
	...
	if err := validateGlueStartCrawlerRun_PrefixStatesParameters(root, prefix); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddBranch(branch awsstepfunctions.StateGraph) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddCatch(handler awsstepfunctions.IChainable, props *awsstepfunctions.CatchProps) awsstepfunctions.TaskStateBase {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddIterator(iteration awsstepfunctions.StateGraph) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddPrefix(x *string) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) AddRetry(props *awsstepfunctions.RetryProps) awsstepfunctions.TaskStateBase {
...
func (g *jsiiProxy_GlueStartCrawlerRun) BindToGraph(graph awsstepfunctions.StateGraph) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MakeDefault(def awsstepfunctions.State) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MakeNext(next awsstepfunctions.State) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricFailed(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricHeartbeatTimedOut(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricRunTime(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricScheduled(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricScheduleTime(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricStarted(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricSucceeded(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricTime(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) MetricTimedOut(props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (g *jsiiProxy_GlueStartCrawlerRun) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (g *jsiiProxy_GlueStartCrawlerRun) RenderInputOutput() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueStartCrawlerRun) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueStartCrawlerRun) RenderIterator() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueStartCrawlerRun) RenderNextEnd() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueStartCrawlerRun) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlueStartCrawlerRun) ToString() *string {
	var returns *string
...
func (g *jsiiProxy_GlueStartCrawlerRun) ValidateState() *[]*string {
	var returns *[]*string
...
func (g *jsiiProxy_GlueStartCrawlerRun) WhenBoundToGraph(graph awsstepfunctions.StateGraph) {
...
func (g *jsiiProxy_GlueStartCrawlerRun) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
