...
func (j *jsiiProxy_EcsRunTask) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_EcsRunTask) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_EcsRunTask) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_EcsRunTask) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_EcsRunTask) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_EcsRunTask) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func (j *jsiiProxy_EcsRunTask) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_EcsRunTask)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_EcsRunTask)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func EcsRunTask_Jsonata(scope constructs.Construct, id *string, props *EcsRunTaskJsonataProps) EcsRunTask {
	...
	if err := validateEcsRunTask_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns EcsRunTask
...
func EcsRunTask_JsonPath(scope constructs.Construct, id *string, props *EcsRunTaskJsonPathProps) EcsRunTask {
	...
	if err := validateEcsRunTask_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns EcsRunTask
...
func EcsRunTask_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_stepfunctions_tasks.EcsRunTask",
...
func (e *jsiiProxy_EcsRunTask) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (e *jsiiProxy_EcsRunTask) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EcsRunTask) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EcsRunTask) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (e *jsiiProxy_EcsRunTask) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsRunTask) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsRunTask) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsRunTask) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EcsRunTask) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EcsRunTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
