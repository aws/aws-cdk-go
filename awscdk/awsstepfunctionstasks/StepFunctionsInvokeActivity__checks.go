...
func (s *jsiiProxy_StepFunctionsInvokeActivity) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	if condition == nil {
...
func (s *jsiiProxy_StepFunctionsInvokeActivity) validateAddItemProcessorParameters(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) error {
	if processor == nil {
...
func (s *jsiiProxy_StepFunctionsInvokeActivity) validateNextParameters(state awsstepfunctions.IChainable) error {
	if state == nil {
...
func (j *jsiiProxy_StepFunctionsInvokeActivity) validateSetProcessorConfigParameters(val *awsstepfunctions.ProcessorConfig) error {
