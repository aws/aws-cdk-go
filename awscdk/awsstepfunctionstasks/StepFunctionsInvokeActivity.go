...
func (s *jsiiProxy_StepFunctionsInvokeActivity) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (s *jsiiProxy_StepFunctionsInvokeActivity) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StepFunctionsInvokeActivity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
