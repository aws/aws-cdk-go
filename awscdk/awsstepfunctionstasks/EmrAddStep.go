...
func (e *jsiiProxy_EmrAddStep) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrAddStep) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrAddStep) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
