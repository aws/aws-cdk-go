...
func (s *jsiiProxy_SageMakerCreateEndpoint) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	if condition == nil {
...
func (s *jsiiProxy_SageMakerCreateEndpoint) validateAddItemProcessorParameters(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) error {
	if processor == nil {
...
func validateSageMakerCreateEndpoint_JsonataParameters(scope constructs.Construct, id *string, props *SageMakerCreateEndpointJsonataProps) error {
	if scope == nil {
...
func validateSageMakerCreateEndpoint_JsonPathParameters(scope constructs.Construct, id *string, props *SageMakerCreateEndpointJsonPathProps) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
...
func (j *jsiiProxy_SageMakerCreateEndpoint) validateSetProcessorConfigParameters(val *awsstepfunctions.ProcessorConfig) error {
