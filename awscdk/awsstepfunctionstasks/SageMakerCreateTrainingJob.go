...
func (j *jsiiProxy_SageMakerCreateTrainingJob) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_SageMakerCreateTrainingJob) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_SageMakerCreateTrainingJob) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_SageMakerCreateTrainingJob)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_SageMakerCreateTrainingJob)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func SageMakerCreateTrainingJob_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_stepfunctions_tasks.SageMakerCreateTrainingJob",
...
func (s *jsiiProxy_SageMakerCreateTrainingJob) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (s *jsiiProxy_SageMakerCreateTrainingJob) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (s *jsiiProxy_SageMakerCreateTrainingJob) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SageMakerCreateTrainingJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
