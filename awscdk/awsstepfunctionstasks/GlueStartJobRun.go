...
func (j *jsiiProxy_GlueStartJobRun) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_GlueStartJobRun) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_GlueStartJobRun) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_GlueStartJobRun)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_GlueStartJobRun)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (g *jsiiProxy_GlueStartJobRun) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (g *jsiiProxy_GlueStartJobRun) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (g *jsiiProxy_GlueStartJobRun) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlueStartJobRun) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
