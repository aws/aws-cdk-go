...
func (j *jsiiProxy_DynamoUpdateItem) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_DynamoUpdateItem) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_DynamoUpdateItem) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_DynamoUpdateItem) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func DynamoUpdateItem_Jsonata(scope constructs.Construct, id *string, props *DynamoUpdateItemJsonataProps) DynamoUpdateItem {
	...
	if err := validateDynamoUpdateItem_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns DynamoUpdateItem
...
func DynamoUpdateItem_JsonPath(scope constructs.Construct, id *string, props *DynamoUpdateItemJsonPathProps) DynamoUpdateItem {
	...
	if err := validateDynamoUpdateItem_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns DynamoUpdateItem
...
func (d *jsiiProxy_DynamoUpdateItem) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (d *jsiiProxy_DynamoUpdateItem) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (d *jsiiProxy_DynamoUpdateItem) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DynamoUpdateItem) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DynamoUpdateItem) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DynamoUpdateItem) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
