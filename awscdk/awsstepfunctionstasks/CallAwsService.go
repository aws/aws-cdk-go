...
func (j *jsiiProxy_CallAwsService) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_CallAwsService) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_CallAwsService) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_CallAwsService) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_CallAwsService) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_CallAwsService) ProcessorMode() awsstepfunctions.ProcessorMode {
...
func (j *jsiiProxy_CallAwsService) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func (j *jsiiProxy_CallAwsService)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_CallAwsService)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (j *jsiiProxy_CallAwsService)SetProcessorMode(val awsstepfunctions.ProcessorMode) {
	_jsii_.Set(
		j,
		"processorMode",
		val,
...
func CallAwsService_Jsonata(scope constructs.Construct, id *string, props *CallAwsServiceJsonataProps) CallAwsService {
	...
	if err := validateCallAwsService_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns CallAwsService
...
func CallAwsService_JsonPath(scope constructs.Construct, id *string, props *CallAwsServiceJsonPathProps) CallAwsService {
	...
	if err := validateCallAwsService_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns CallAwsService
...
func (c *jsiiProxy_CallAwsService) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (c *jsiiProxy_CallAwsService) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (c *jsiiProxy_CallAwsService) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (c *jsiiProxy_CallAwsService) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (c *jsiiProxy_CallAwsService) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CallAwsService) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CallAwsService) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CallAwsService) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CallAwsService) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CallAwsService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
