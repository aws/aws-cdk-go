...
func (e *jsiiProxy_EcsEc2LaunchTarget) Bind(task EcsRunTask, launchTargetOptions *LaunchTargetBindOptions) *EcsLaunchTargetConfig {
	if err := e.validateBindParameters(task, launchTargetOptions); err != nil {
		panic(err)
	}
