...
func (s *jsiiProxy_StepFunctionsStartExecution) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	return nil
}
...
func (s *jsiiProxy_StepFunctionsStartExecution) validateNextParameters(state awsstepfunctions.IChainable) error {
	return nil
}
