...
func (j *jsiiProxy_LambdaInvoke) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_LambdaInvoke) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_LambdaInvoke) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_LambdaInvoke)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_LambdaInvoke)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (l *jsiiProxy_LambdaInvoke) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
	if err := l.validateAddItemProcessorParameters(processor, config); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LambdaInvoke) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
	if err := l.validateNextParameters(state); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LambdaInvoke) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LambdaInvoke) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LambdaInvoke) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
