...
func (e *jsiiProxy_EmrSetClusterTerminationProtection) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrSetClusterTerminationProtection) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrSetClusterTerminationProtection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
