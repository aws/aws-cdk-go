...
func (e *jsiiProxy_EvaluateExpression) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EvaluateExpression) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EvaluateExpression) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
