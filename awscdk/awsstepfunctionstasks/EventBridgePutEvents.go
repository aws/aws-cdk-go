...
func (e *jsiiProxy_EventBridgePutEvents) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EventBridgePutEvents) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventBridgePutEvents) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
