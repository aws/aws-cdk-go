...
func (j *jsiiProxy_SnsPublish) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_SnsPublish) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_SnsPublish) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_SnsPublish) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_SnsPublish) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_SnsPublish) ProcessorMode() awsstepfunctions.ProcessorMode {
...
func (j *jsiiProxy_SnsPublish) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func (j *jsiiProxy_SnsPublish) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_SnsPublish)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_SnsPublish)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (j *jsiiProxy_SnsPublish)SetProcessorMode(val awsstepfunctions.ProcessorMode) {
	_jsii_.Set(
		j,
		"processorMode",
		val,
...
func SnsPublish_Jsonata(scope constructs.Construct, id *string, props *SnsPublishJsonataProps) SnsPublish {
	...
	if err := validateSnsPublish_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns SnsPublish
...
func SnsPublish_JsonPath(scope constructs.Construct, id *string, props *SnsPublishJsonPathProps) SnsPublish {
	...
	if err := validateSnsPublish_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns SnsPublish
...
func (s *jsiiProxy_SnsPublish) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (s *jsiiProxy_SnsPublish) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (s *jsiiProxy_SnsPublish) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (s *jsiiProxy_SnsPublish) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (s *jsiiProxy_SnsPublish) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SnsPublish) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SnsPublish) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SnsPublish) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SnsPublish) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SnsPublish) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
