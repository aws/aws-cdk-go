...
func (e *jsiiProxy_EventBridgeSchedulerCreateScheduleTask) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EventBridgeSchedulerCreateScheduleTask) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventBridgeSchedulerCreateScheduleTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
