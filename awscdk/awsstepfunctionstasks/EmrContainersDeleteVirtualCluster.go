...
func (e *jsiiProxy_EmrContainersDeleteVirtualCluster) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (e *jsiiProxy_EmrContainersDeleteVirtualCluster) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EmrContainersDeleteVirtualCluster) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EmrContainersDeleteVirtualCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
