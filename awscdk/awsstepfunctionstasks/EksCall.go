...
func (j *jsiiProxy_EksCall) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_EksCall) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_EksCall)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_EksCall)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EksCall) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (e *jsiiProxy_EksCall) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (e *jsiiProxy_EksCall) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (e *jsiiProxy_EksCall) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EksCall) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EksCall) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
