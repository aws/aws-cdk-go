...
func (j *jsiiProxy_DynamoDeleteItem) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_DynamoDeleteItem) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_DynamoDeleteItem) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_DynamoDeleteItem)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_DynamoDeleteItem)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func (d *jsiiProxy_DynamoDeleteItem) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (d *jsiiProxy_DynamoDeleteItem) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (d *jsiiProxy_DynamoDeleteItem) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (d *jsiiProxy_DynamoDeleteItem) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DynamoDeleteItem) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DynamoDeleteItem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
