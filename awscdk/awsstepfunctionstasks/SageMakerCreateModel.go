...
func (j *jsiiProxy_SageMakerCreateModel) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_SageMakerCreateModel) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_SageMakerCreateModel) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_SageMakerCreateModel) Processor() awsstepfunctions.StateGraph {
	var returns awsstepfunctions.StateGraph
	_jsii_.Get(
		j,
		"processor",
...
func (j *jsiiProxy_SageMakerCreateModel) ProcessorConfig() *awsstepfunctions.ProcessorConfig {
...
func (j *jsiiProxy_SageMakerCreateModel) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func (j *jsiiProxy_SageMakerCreateModel) StateName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateName",
...
func (j *jsiiProxy_SageMakerCreateModel)SetProcessor(val awsstepfunctions.StateGraph) {
	_jsii_.Set(
		j,
		"processor",
		val,
...
func (j *jsiiProxy_SageMakerCreateModel)SetProcessorConfig(val *awsstepfunctions.ProcessorConfig) {
...
func SageMakerCreateModel_Jsonata(scope constructs.Construct, id *string, props *SageMakerCreateModelJsonataProps) SageMakerCreateModel {
	...
	if err := validateSageMakerCreateModel_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns SageMakerCreateModel
...
func SageMakerCreateModel_JsonPath(scope constructs.Construct, id *string, props *SageMakerCreateModelJsonPathProps) SageMakerCreateModel {
	...
	if err := validateSageMakerCreateModel_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns SageMakerCreateModel
...
func SageMakerCreateModel_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_stepfunctions_tasks.SageMakerCreateModel",
...
func (s *jsiiProxy_SageMakerCreateModel) AddChoice(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) {
...
func (s *jsiiProxy_SageMakerCreateModel) AddItemProcessor(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) {
...
func (s *jsiiProxy_SageMakerCreateModel) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (s *jsiiProxy_SageMakerCreateModel) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (s *jsiiProxy_SageMakerCreateModel) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SageMakerCreateModel) RenderItemProcessor() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SageMakerCreateModel) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SageMakerCreateModel) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SageMakerCreateModel) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SageMakerCreateModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
