...
func (e *jsiiProxy_EventBridgePutEvents) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	return nil
}
...
func (e *jsiiProxy_EventBridgePutEvents) validateNextParameters(state awsstepfunctions.IChainable) error {
	return nil
}
