...
func (d *jsiiProxy_DynamoUpdateItem) validateAddChoiceParameters(condition awsstepfunctions.Condition, next awsstepfunctions.State, options *awsstepfunctions.ChoiceTransitionOptions) error {
	return nil
}

func (d *jsiiProxy_DynamoUpdateItem) validateAddItemProcessorParameters(processor awsstepfunctions.StateGraph, config *awsstepfunctions.ProcessorConfig) error {
	return nil
}
...
func (d *jsiiProxy_DynamoUpdateItem) validateNextParameters(state awsstepfunctions.IChainable) error {
	return nil
}
...
func (j *jsiiProxy_DynamoUpdateItem) validateSetProcessorConfigParameters(val *awsstepfunctions.ProcessorConfig) error {
	return nil
}
