...
func (j *jsiiProxy_AthenaGetQueryResults) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_AthenaGetQueryResults) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_AthenaGetQueryResults) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_AthenaGetQueryResults) QueryLanguage() awsstepfunctions.QueryLanguage {
...
func AthenaGetQueryResults_Jsonata(scope constructs.Construct, id *string, props *AthenaGetQueryResultsJsonataProps) AthenaGetQueryResults {
	...
	if err := validateAthenaGetQueryResults_JsonataParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns AthenaGetQueryResults
...
func AthenaGetQueryResults_JsonPath(scope constructs.Construct, id *string, props *AthenaGetQueryResultsJsonPathProps) AthenaGetQueryResults {
	...
	if err := validateAthenaGetQueryResults_JsonPathParameters(scope, id, props); err != nil {
		panic(err)
	}
	var returns AthenaGetQueryResults
...
func (a *jsiiProxy_AthenaGetQueryResults) Next(state awsstepfunctions.IChainable) awsstepfunctions.Chain {
...
func (a *jsiiProxy_AthenaGetQueryResults) RenderAssign(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
...
func (a *jsiiProxy_AthenaGetQueryResults) RenderChoices(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AthenaGetQueryResults) RenderQueryLanguage(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AthenaGetQueryResults) RenderRetryCatch(topLevelQueryLanguage awsstepfunctions.QueryLanguage) interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AthenaGetQueryResults) ToStateJson(stateMachineQueryLanguage awsstepfunctions.QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AthenaGetQueryResults) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
