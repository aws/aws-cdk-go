...
func Secret_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_secretsmanager.Secret",
...
func (s *jsiiProxy_Secret) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_Secret) SecretValueFromJson(key *string) awscdk.SecretValue {
