...
func (j *jsiiProxy_CfnRotationSchedule) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnRotationSchedule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRotationSchedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRotationSchedule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRotationSchedule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRotationSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
