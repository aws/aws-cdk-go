...
func (j *jsiiProxy_CfnSecretTargetAttachment) CfnPropertyNames() *map[string]*string {
...
func NewCfnSecretTargetAttachment(scope constructs.Construct, id *string, props *CfnSecretTargetAttachmentProps) CfnSecretTargetAttachment {
	...
	if err := validateNewCfnSecretTargetAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSecretTargetAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecretTargetAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecretTargetAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSecretTargetAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecretTargetAttachment_IsCfnSecretTargetAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSecretTargetAttachment_IsCfnSecretTargetAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecretTargetAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecretTargetAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecretTargetAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecretTargetAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecretTargetAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
