...
func (j *jsiiProxy_CfnSecret) CfnPropertyNames() *map[string]*string {
...
func CfnSecret_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSecret_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecret) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecret) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecret) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecret) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecret) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecret) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecret) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecret) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecret) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecret) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
