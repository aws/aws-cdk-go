...
func (s *jsiiProxy_Secret) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (s *jsiiProxy_Secret) validateCfnDynamicReferenceKeyParameters(options *awscdk.SecretsManagerSecretOptions) error {
	return nil
}
