...
func (j *jsiiProxy_RotationSchedule) Env() *interfaces.ResourceEnvironment {
...
func RotationSchedule_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRotationSchedule_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RotationSchedule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_secretsmanager.RotationSchedule",
...
func (r *jsiiProxy_RotationSchedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RotationSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
