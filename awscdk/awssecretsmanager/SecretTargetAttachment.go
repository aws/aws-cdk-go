...
func SecretTargetAttachment_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_secretsmanager.SecretTargetAttachment",
...
func (s *jsiiProxy_SecretTargetAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SecretTargetAttachment) SecretValueFromJson(key *string) awscdk.SecretValue {
...
func (s *jsiiProxy_SecretTargetAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
