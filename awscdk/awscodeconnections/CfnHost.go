...
//
//   cfnHost := awscdk.Aws_codeconnections.NewCfnHost(this, jsii.String("MyCfnHost"), &CfnHostProps{
...
type CfnHost interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscodeconnections.IHostRef
	awscdk.ITaggableV2
	...
	HostRef() *interfacesawscodeconnections.HostReference
...
type jsiiProxy_CfnHost struct {
	...
	internal.Type__interfacesawscodeconnectionsIHostRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnHost) AttrHostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrHostArn",
...
func (j *jsiiProxy_CfnHost) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnHost) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnHost) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnHost) HostRef() *interfacesawscodeconnections.HostReference {
	var returns *interfacesawscodeconnections.HostReference
	_jsii_.Get(
		j,
		"hostRef",
		&returns,
...
func (j *jsiiProxy_CfnHost) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnHost) ProviderEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerEndpoint",
...
func (j *jsiiProxy_CfnHost) ProviderType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerType",
...
func (j *jsiiProxy_CfnHost) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnHost) VpcConfiguration() interface{} {
...
func NewCfnHost(scope constructs.Construct, id *string, props *CfnHostProps) CfnHost {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_codeconnections.CfnHost",
...
func (j *jsiiProxy_CfnHost)SetName(val *string) {
...
func (j *jsiiProxy_CfnHost)SetProviderEndpoint(val *string) {
...
func (j *jsiiProxy_CfnHost)SetProviderType(val *string) {
...
func (j *jsiiProxy_CfnHost)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnHost)SetVpcConfiguration(val interface{}) {
...
func CfnHost_ArnForHost(resource interfacesawscodeconnections.IHostRef) *string {
	_init_.Initialize()

	if err := validateCfnHost_ArnForHostParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnHost_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnHost_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHost) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHost) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHost) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHost) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHost) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
