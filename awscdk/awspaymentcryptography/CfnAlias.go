...
type CfnAlias interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawspaymentcryptography.IAliasRef
	...
	AliasRef() *interfacesawspaymentcryptography.AliasReference
...
type jsiiProxy_CfnAlias struct {
	...
	internal.Type__interfacesawspaymentcryptographyIAliasRef
}
...
func (j *jsiiProxy_CfnAlias) AliasRef() *interfacesawspaymentcryptography.AliasReference {
	var returns *interfacesawspaymentcryptography.AliasReference
	_jsii_.Get(
		j,
		"aliasRef",
		&returns,
...
func (j *jsiiProxy_CfnAlias) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAlias) KeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyArn",
...
func (j *jsiiProxy_CfnAlias) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
// Create a new `AWS::PaymentCryptography::Alias`.
func NewCfnAlias(scope constructs.Construct, id *string, props *CfnAliasProps) CfnAlias {
	_init_.Initialize()

	if err := validateNewCfnAliasParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAlias)SetKeyArn(val *string) {
	_jsii_.Set(
		j,
		"keyArn",
		val,
...
func CfnAlias_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAlias_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAlias_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAlias_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAlias) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAlias) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAlias) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAlias) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlias) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
