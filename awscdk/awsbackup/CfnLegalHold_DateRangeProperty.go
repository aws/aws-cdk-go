...
//
type CfnLegalHold_DateRangeProperty struct {
	...
	//
	FromDate *string `field:"required" json:"fromDate" yaml:"fromDate"`
	...
	//
	ToDate *string `field:"required" json:"toDate" yaml:"toDate"`
}
