...
func (j *jsiiProxy_CfnReportPlan) CfnPropertyNames() *map[string]*string {
...
func CfnReportPlan_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReportPlan_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReportPlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReportPlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReportPlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReportPlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
