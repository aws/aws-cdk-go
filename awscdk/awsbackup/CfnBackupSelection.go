...
func (j *jsiiProxy_CfnBackupSelection) CfnPropertyNames() *map[string]*string {
...
func NewCfnBackupSelection(scope constructs.Construct, id *string, props *CfnBackupSelectionProps) CfnBackupSelection {
	...
	if err := validateNewCfnBackupSelectionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBackupSelection)SetBackupSelection(val interface{}) {
	if err := j.validateSetBackupSelectionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBackupSelection_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBackupSelection_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBackupSelection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBackupSelection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBackupSelection_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBackupSelection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBackupSelection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupSelection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBackupSelection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBackupSelection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBackupSelection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBackupSelection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBackupSelection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupSelection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupSelection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupSelection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
