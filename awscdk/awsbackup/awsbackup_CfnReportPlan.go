...
func NewCfnReportPlan(scope constructs.Construct, id *string, props *CfnReportPlanProps) CfnReportPlan {
	...
	if err := validateNewCfnReportPlanParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnReportPlan)SetReportDeliveryChannel(val interface{}) {
	if err := j.validateSetReportDeliveryChannelParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnReportPlan)SetReportSetting(val interface{}) {
	if err := j.validateSetReportSettingParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnReportPlan_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReportPlan_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReportPlan_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnReportPlan_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReportPlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReportPlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReportPlan) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportPlan) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReportPlan) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReportPlan) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnReportPlan) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportPlan) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
