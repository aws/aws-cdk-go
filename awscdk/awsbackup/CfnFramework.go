...
func (j *jsiiProxy_CfnFramework) CfnPropertyNames() *map[string]*string {
...
func NewCfnFramework(scope constructs.Construct, id *string, props *CfnFrameworkProps) CfnFramework {
	...
	if err := validateNewCfnFrameworkParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnFramework)SetFrameworkControls(val interface{}) {
	if err := j.validateSetFrameworkControlsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFramework_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFramework_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFramework_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFramework_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFramework_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFramework_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFramework) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFramework) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFramework) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFramework) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFramework) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFramework) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFramework) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFramework) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFramework) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFramework) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
