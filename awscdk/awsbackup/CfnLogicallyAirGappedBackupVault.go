...
func (j *jsiiProxy_CfnLogicallyAirGappedBackupVault) CfnPropertyNames() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"cfnPropertyNames",
...
func (c *jsiiProxy_CfnLogicallyAirGappedBackupVault) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogicallyAirGappedBackupVault) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLogicallyAirGappedBackupVault) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLogicallyAirGappedBackupVault) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogicallyAirGappedBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
