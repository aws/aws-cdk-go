...
func (j *jsiiProxy_CfnBackupVault) CfnPropertyNames() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"cfnPropertyNames",
...
func CfnBackupVault_IsCfnBackupVault(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBackupVault_IsCfnBackupVaultParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBackupVault_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBackupVault_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBackupVault) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupVault) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBackupVault) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBackupVault) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBackupVault) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBackupVault) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBackupVault) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupVault) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupVault) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
