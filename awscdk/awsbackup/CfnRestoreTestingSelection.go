...
func (j *jsiiProxy_CfnRestoreTestingSelection) CfnPropertyNames() *map[string]*string {
...
func CfnRestoreTestingSelection_IsCfnRestoreTestingSelection(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRestoreTestingSelection_IsCfnRestoreTestingSelectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRestoreTestingSelection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRestoreTestingSelection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRestoreTestingSelection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRestoreTestingSelection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRestoreTestingSelection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
