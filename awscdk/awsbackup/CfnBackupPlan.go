...
func (j *jsiiProxy_CfnBackupPlan) CfnPropertyNames() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"cfnPropertyNames",
...
func (c *jsiiProxy_CfnBackupPlan) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBackupPlan) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBackupPlan) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBackupPlan) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBackupPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
