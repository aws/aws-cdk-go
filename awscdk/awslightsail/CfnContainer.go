...
func (j *jsiiProxy_CfnContainer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnContainer)SetContainerServiceDeployment(val interface{}) {
	if err := j.validateSetContainerServiceDeploymentParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnContainer)SetPublicDomainNames(val interface{}) {
	if err := j.validateSetPublicDomainNamesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnContainer_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnContainer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContainer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContainer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContainer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContainer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContainer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnContainer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContainer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContainer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContainer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
