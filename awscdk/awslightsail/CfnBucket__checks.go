...
func (j *jsiiProxy_CfnBucket) validateSetAccessRulesParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnBucket_AccessRulesProperty:
		val := val.(*CfnBucket_AccessRulesProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnBucket_AccessRulesProperty:
		val_ := val.(CfnBucket_AccessRulesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnBucket_AccessRulesProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnBucket) validateSetBundleIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnBucket) validateSetObjectVersioningParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
