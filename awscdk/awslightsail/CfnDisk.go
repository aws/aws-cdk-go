...
func (j *jsiiProxy_CfnDisk) CfnPropertyNames() *map[string]*string {
...
func CfnDisk_ArnForDisk(resource interfacesawslightsail.IDiskRef) *string {
	_init_.Initialize()

	if err := validateCfnDisk_ArnForDiskParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnDisk.
func CfnDisk_IsCfnDisk(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDisk_IsCfnDiskParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDisk) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDisk) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDisk) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDisk) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDisk) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
