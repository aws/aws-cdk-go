...
func (j *jsiiProxy_CfnBucket) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBucket)SetAccessRules(val interface{}) {
	if err := j.validateSetAccessRulesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBucket_ArnForBucket(resource interfacesawslightsail.IBucketRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBucket) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBucket) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBucket) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBucket) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
