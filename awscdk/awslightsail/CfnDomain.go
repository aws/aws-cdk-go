...
//
//   cfnDomain := awscdk.Aws_lightsail.NewCfnDomain(this, jsii.String("MyCfnDomain"), &CfnDomainProps{
...
type CfnDomain interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawslightsail.IDomainRef
	awscdk.ITaggableV2
	...
	DomainEntries() interface{}
	SetDomainEntries(val interface{})
	// The fully qualified domain name in the certificate request.
	DomainName() *string
	SetDomainName(val *string)
	// A reference to a Domain resource.
	DomainRef() *interfacesawslightsail.DomainReference
...
type jsiiProxy_CfnDomain struct {
	...
	internal.Type__interfacesawslightsailIDomainRef
...
func (j *jsiiProxy_CfnDomain) AttrLocation() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnDomain) AttrResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrResourceType",
...
func (j *jsiiProxy_CfnDomain) AttrSupportCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSupportCode",
...
func (j *jsiiProxy_CfnDomain) DomainEntries() interface{} {
...
func (j *jsiiProxy_CfnDomain) DomainRef() *interfacesawslightsail.DomainReference {
	var returns *interfacesawslightsail.DomainReference
	_jsii_.Get(
		j,
		"domainRef",
		&returns,
...
func (j *jsiiProxy_CfnDomain) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDomain)SetDomainEntries(val interface{}) {
	if err := j.validateSetDomainEntriesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDomain)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDomain_ArnForDomain(resource interfacesawslightsail.IDomainRef) *string {
	_init_.Initialize()
