...
func (j *jsiiProxy_CfnAlarm) CfnPropertyNames() *map[string]*string {
...
func CfnAlarm_IsCfnAlarm(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAlarm_IsCfnAlarmParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAlarm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAlarm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAlarm) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAlarm) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
