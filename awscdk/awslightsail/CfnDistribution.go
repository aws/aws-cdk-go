...
func (j *jsiiProxy_CfnDistribution) CfnPropertyNames() *map[string]*string {
...
func NewCfnDistribution(scope constructs.Construct, id *string, props *CfnDistributionProps) CfnDistribution {
	...
	if err := validateNewCfnDistributionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDistribution)SetCacheBehaviors(val interface{}) {
	if err := j.validateSetCacheBehaviorsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDistribution)SetCacheBehaviorSettings(val interface{}) {
	if err := j.validateSetCacheBehaviorSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDistribution)SetDefaultCacheBehavior(val interface{}) {
	if err := j.validateSetDefaultCacheBehaviorParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDistribution_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDistribution_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistribution_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDistribution_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistribution_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDistribution_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDistribution) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistribution) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDistribution) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDistribution) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDistribution) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDistribution) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDistribution) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistribution) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistribution) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistribution) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
