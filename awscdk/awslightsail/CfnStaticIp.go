...
func (j *jsiiProxy_CfnStaticIp) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStaticIp) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStaticIp(scope constructs.Construct, id *string, props *CfnStaticIpProps) CfnStaticIp {
	...
	if err := validateNewCfnStaticIpParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnStaticIp_ArnForStaticIp(resource interfacesawslightsail.IStaticIpRef) *string {
	_init_.Initialize()

	if err := validateCfnStaticIp_ArnForStaticIpParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnStaticIp_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStaticIp_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStaticIp_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStaticIp_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStaticIp_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStaticIp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStaticIp) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStaticIp) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStaticIp) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStaticIp) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStaticIp) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStaticIp) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStaticIp) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStaticIp) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStaticIp) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStaticIp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
