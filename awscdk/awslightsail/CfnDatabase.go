...
func (j *jsiiProxy_CfnDatabase) CfnPropertyNames() *map[string]*string {
...
func CfnDatabase_ArnForDatabase(resource interfacesawslightsail.IDatabaseRef) *string {
	_init_.Initialize()
...
func CfnDatabase_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDatabase_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDatabase) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDatabase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDatabase) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDatabase) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
