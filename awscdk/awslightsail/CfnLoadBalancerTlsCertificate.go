...
func (j *jsiiProxy_CfnLoadBalancerTlsCertificate) CfnPropertyNames() *map[string]*string {
...
func CfnLoadBalancerTlsCertificate_ArnForLoadBalancerTlsCertificate(resource interfacesawslightsail.ILoadBalancerTlsCertificateRef) *string {
	_init_.Initialize()

	if err := validateCfnLoadBalancerTlsCertificate_ArnForLoadBalancerTlsCertificateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnLoadBalancerTlsCertificate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLoadBalancerTlsCertificate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
