...
func (j *jsiiProxy_Listener) Env() *interfaces.ResourceEnvironment {
...
func Listener_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_globalaccelerator.Listener",
...
func (l *jsiiProxy_Listener) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_Listener) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
