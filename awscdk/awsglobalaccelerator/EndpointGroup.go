...
func (j *jsiiProxy_EndpointGroup) Env() *interfaces.ResourceEnvironment {
...
func (e *jsiiProxy_EndpointGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EndpointGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
