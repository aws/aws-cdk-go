...
func (j *jsiiProxy_CfnAccelerator) AttrDualStackDnsName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccelerator) AttrIpv6Addresses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrIpv6Addresses",
...
func (j *jsiiProxy_CfnAccelerator) CfnPropertyNames() *map[string]*string {
...
func NewCfnAccelerator(scope constructs.Construct, id *string, props *CfnAcceleratorProps) CfnAccelerator {
	...
	if err := validateNewCfnAcceleratorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAccelerator_ArnForAccelerator(resource interfacesawsglobalaccelerator.IAcceleratorRef) *string {
	_init_.Initialize()

	if err := validateCfnAccelerator_ArnForAcceleratorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAccelerator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccelerator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccelerator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccelerator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccelerator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccelerator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccelerator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccelerator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccelerator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccelerator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccelerator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccelerator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccelerator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccelerator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccelerator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccelerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
