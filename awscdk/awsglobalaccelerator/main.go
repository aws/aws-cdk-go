...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnCrossAccountAttachment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "addPropertyOverride", GoMethod: "AddPropertyOverride"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrAttachmentArn", GoGetter: "AttrAttachmentArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnCrossAccountAttachment_ResourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_globalaccelerator.CfnCrossAccountAttachmentProps",
		reflect.TypeOf((*CfnCrossAccountAttachmentProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
