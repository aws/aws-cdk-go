...
func (j *jsiiProxy_Accelerator) Env() *interfaces.ResourceEnvironment {
...
func Accelerator_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_globalaccelerator.Accelerator",
...
func (a *jsiiProxy_Accelerator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_Accelerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
