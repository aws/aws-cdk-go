...
func (j *jsiiProxy_CfnEndpointGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEndpointGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEndpointGroup(scope constructs.Construct, id *string, props *CfnEndpointGroupProps) CfnEndpointGroup {
	...
	if err := validateNewCfnEndpointGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEndpointGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEndpointGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEndpointGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEndpointGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEndpointGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEndpointGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEndpointGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEndpointGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEndpointGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEndpointGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEndpointGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEndpointGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEndpointGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
