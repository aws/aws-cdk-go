...
func DeployTimeSubstitutedFile_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_s3_deployment.DeployTimeSubstitutedFile",
...
func (d *jsiiProxy_DeployTimeSubstitutedFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
