...
func validateSource_DataParameters(objectKey *string, data *string, markersConfig *MarkersConfig) error {
	...
	if err := _jsii_.ValidateStruct(markersConfig, func() string { return "parameter markersConfig" }); err != nil {
		return err
	}
...
func validateSource_JsonDataParameters(objectKey *string, obj interface{}, jsonProcessingOptions *JsonProcessingOptions) error {
	...
	if err := _jsii_.ValidateStruct(jsonProcessingOptions, func() string { return "parameter jsonProcessingOptions" }); err != nil {
		return err
	}
