...
func (j *jsiiProxy_CfnSuiteDefinition) AttrSuiteDefinitionId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSuiteDefinition) AttrSuiteDefinitionVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSuiteDefinition) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSuiteDefinition) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSuiteDefinition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSuiteDefinition) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSuiteDefinition) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSuiteDefinition) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSuiteDefinition) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSuiteDefinition) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSuiteDefinition) SuiteDefinitionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnSuiteDefinition) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnSuiteDefinition) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSuiteDefinition(scope constructs.Construct, id *string, props *CfnSuiteDefinitionProps) CfnSuiteDefinition {
	...
	if err := validateNewCfnSuiteDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSuiteDefinition)SetSuiteDefinitionConfiguration(val interface{}) {
	if err := j.validateSetSuiteDefinitionConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSuiteDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSuiteDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSuiteDefinition_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSuiteDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSuiteDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSuiteDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSuiteDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSuiteDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSuiteDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSuiteDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSuiteDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSuiteDefinition) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSuiteDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSuiteDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSuiteDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSuiteDefinition) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSuiteDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSuiteDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
