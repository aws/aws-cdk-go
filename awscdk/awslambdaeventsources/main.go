...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConfluentSchemaRegistry)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
		},
		func() interface{} {
			j := jsiiProxy_ConfluentSchemaRegistry{}
			_jsii_.InitJsiiProxy(&j.Type__awslambdaISchemaRegistry)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_lambda_event_sources.ConfluentSchemaRegistryProps",
		reflect.TypeOf((*ConfluentSchemaRegistryProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KinesisConsumerEventSource)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "bind", GoMethod: "Bind"},
			_jsii_.MemberMethod{JsiiMethod: "enrichMappingOptions", GoMethod: "EnrichMappingOptions"},
			_jsii_.MemberProperty{JsiiProperty: "eventSourceMappingArn", GoGetter: "EventSourceMappingArn"},
			_jsii_.MemberProperty{JsiiProperty: "eventSourceMappingId", GoGetter: "EventSourceMappingId"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "streamConsumer", GoGetter: "StreamConsumer"},
		},
		func() interface{} {
