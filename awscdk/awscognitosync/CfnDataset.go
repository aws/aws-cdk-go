...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awscognitosync/internal"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces"
	"github.com/aws/aws-cdk-go/awscdk/v2/interfaces/interfacesawscognitosync"
...
//
//   cfnDataset := awscdk.Aws_cognitosync.NewCfnDataset(this, jsii.String("MyCfnDataset"), &CfnDatasetProps{
...
type CfnDataset interface {
	...
	DatasetRef() *interfacesawscognitosync.DatasetReference
...
type jsiiProxy_CfnDataset struct {
	...
	internal.Type__interfacesawscognitosyncIDatasetRef
}
...
func (j *jsiiProxy_CfnDataset) AttrCreationDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationDate",
...
func (j *jsiiProxy_CfnDataset) AttrDataStorage() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrDataStorage",
...
func (j *jsiiProxy_CfnDataset) AttrLastModifiedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastModifiedBy",
...
func (j *jsiiProxy_CfnDataset) AttrLastModifiedDate() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDataset) AttrNumRecords() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrNumRecords",
...
func (j *jsiiProxy_CfnDataset) DatasetRef() *interfacesawscognitosync.DatasetReference {
	var returns *interfacesawscognitosync.DatasetReference
	_jsii_.Get(
		j,
		"datasetRef",
		&returns,
...
func (j *jsiiProxy_CfnDataset) IdentityId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityId",
...
func (j *jsiiProxy_CfnDataset) IdentityPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityPoolId",
...
func (j *jsiiProxy_CfnDataset)SetIdentityId(val *string) {
	_jsii_.Set(
		j,
		"identityId",
		val,
...
func (j *jsiiProxy_CfnDataset)SetIdentityPoolId(val *string) {
	_jsii_.Set(
		j,
		"identityPoolId",
		val,
...
func CfnDataset_ArnForDataset(resource interfacesawscognitosync.IDatasetRef) *string {
	_init_.Initialize()
