...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_cognitosync.CfnDataset",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrDataStorage", GoGetter: "AttrDataStorage"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrNumRecords", GoGetter: "AttrNumRecords"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscognitosyncIDatasetRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognitosync.CfnDatasetProps",
