...
func (i *jsiiProxy_IBedrockAgentRuntime) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (i *jsiiProxy_IBedrockAgentRuntime) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
