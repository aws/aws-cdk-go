...
func (c *jsiiProxy_CfnCapacityProvider) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnCapacityProvider) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnCapacityProvider) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func validateCfnCapacityProvider_ArnForCapacityProviderParameters(resource interfacesawsbedrockagentcore.ICapacityProviderRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCapacityProvider) validateSetComputeConfigurationParameters(val interface{}) error {
	if val == nil {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnCapacityProvider_ComputeConfigurationProperty:
		val := val.(*CfnCapacityProvider_ComputeConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCapacityProvider_ComputeConfigurationProperty:
		val_ := val.(CfnCapacityProvider_ComputeConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCapacityProvider_ComputeConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCapacityProvider) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCapacityProvider) validateSetPermissionsConfigurationParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCapacityProvider_PermissionsConfigurationProperty:
		val := val.(*CfnCapacityProvider_PermissionsConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCapacityProvider_PermissionsConfigurationProperty:
		val_ := val.(CfnCapacityProvider_PermissionsConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCapacityProvider_PermissionsConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
