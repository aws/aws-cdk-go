...
func (j *jsiiProxy_CodeInterpreterCustom) CodeInterpreterCustomName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (c *jsiiProxy_CodeInterpreterCustom) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
