...
func (j *jsiiProxy_CfnRuntime) AgentRuntimeArtifact() interface{} {
...
func (j *jsiiProxy_CfnRuntime) AgentRuntimeName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentRuntimeName",
...
func (j *jsiiProxy_CfnRuntime) AttrAgentRuntimeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgentRuntimeArn",
...
func (j *jsiiProxy_CfnRuntime) AttrAgentRuntimeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgentRuntimeId",
...
func (j *jsiiProxy_CfnRuntime) AttrAgentRuntimeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgentRuntimeVersion",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnRuntime) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnRuntime) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnRuntime) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnRuntime) AttrWorkloadIdentityDetails() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnRuntime) AuthorizerConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRuntime) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRuntime) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRuntime) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRuntime) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRuntime) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRuntime) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnRuntime) EnvironmentVariables() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRuntime) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRuntime) NetworkConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRuntime) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRuntime) ProtocolConfiguration() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRuntime) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRuntime) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRuntime) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnRuntime) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRuntime) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRuntime(scope constructs.Construct, id *string, props *CfnRuntimeProps) CfnRuntime {
	...
	if err := validateNewCfnRuntimeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRuntime)SetAgentRuntimeArtifact(val interface{}) {
	if err := j.validateSetAgentRuntimeArtifactParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnRuntime)SetAgentRuntimeName(val *string) {
...
func (j *jsiiProxy_CfnRuntime)SetAuthorizerConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnRuntime)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnRuntime)SetEnvironmentVariables(val interface{}) {
...
func (j *jsiiProxy_CfnRuntime)SetProtocolConfiguration(val *string) {
	_jsii_.Set(
		j,
		"protocolConfiguration",
		val,
...
func (j *jsiiProxy_CfnRuntime)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnRuntime)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnRuntime_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRuntime_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuntime_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRuntime_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuntime_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRuntime_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuntime) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRuntime) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntime) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntime) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntime) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntime) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRuntime) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntime) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRuntime) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRuntime) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRuntime) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRuntime) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRuntime) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRuntime) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRuntime) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRuntime) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRuntime) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntime) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntime) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRuntime) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntime) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRuntime) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRuntime) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRuntime) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
