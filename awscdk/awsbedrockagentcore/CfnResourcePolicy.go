...
//
//   cfnResourcePolicy := awscdk.Aws_bedrockagentcore.NewCfnResourcePolicy(this, jsii.String("MyCfnResourcePolicy"), &CfnResourcePolicyProps{
...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrockagentcore.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawsbedrockagentcore.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawsbedrockagentcoreIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourcePolicy) Policy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawsbedrockagentcore.ResourcePolicyReference {
	var returns *interfacesawsbedrockagentcore.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnResourcePolicy)SetPolicy(val *string) {
...
func CfnResourcePolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourcePolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourcePolicy_IsCfnResourcePolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourcePolicy_IsCfnResourcePolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourcePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourcePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourcePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourcePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourcePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
