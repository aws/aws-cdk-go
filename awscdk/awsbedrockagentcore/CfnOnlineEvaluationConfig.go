...
// The jsii proxy struct for CfnOnlineEvaluationConfig
type jsiiProxy_CfnOnlineEvaluationConfig struct {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrOnlineEvaluationConfigArn() *string {
	...
	_jsii_.Get(
		j,
		"attrOnlineEvaluationConfigArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrOnlineEvaluationConfigId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOnlineEvaluationConfigId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrOutputConfig() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) DataSourceConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dataSourceConfig",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) EvaluationExecutionRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Evaluators() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"evaluators",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) OnlineEvaluationConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) OnlineEvaluationConfigRef() *interfacesawsbedrockagentcore.OnlineEvaluationConfigReference {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Rule() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rule",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOnlineEvaluationConfig(scope constructs.Construct, id *string, props *CfnOnlineEvaluationConfigProps) CfnOnlineEvaluationConfig {
	...
	if err := validateNewCfnOnlineEvaluationConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetEvaluationExecutionRoleArn(val *string) {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetEvaluators(val interface{}) {
	if err := j.validateSetEvaluatorsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetOnlineEvaluationConfigName(val *string) {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetRule(val interface{}) {
...
func (j *jsiiProxy_CfnOnlineEvaluationConfig)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnOnlineEvaluationConfig_ArnForOnlineEvaluationConfig(resource interfacesawsbedrockagentcore.IOnlineEvaluationConfigRef) *string {
	...
	if err := validateCfnOnlineEvaluationConfig_ArnForOnlineEvaluationConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnOnlineEvaluationConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOnlineEvaluationConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOnlineEvaluationConfig_IsCfnOnlineEvaluationConfig(x interface{}) *bool {
	...
	if err := validateCfnOnlineEvaluationConfig_IsCfnOnlineEvaluationConfigParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOnlineEvaluationConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOnlineEvaluationConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOnlineEvaluationConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOnlineEvaluationConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
