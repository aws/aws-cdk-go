...
//
type CfnCapacityProvider_Ec2ConfigurationProperty struct {
	...
	//
	LaunchTemplateSource interface{} `field:"required" json:"launchTemplateSource" yaml:"launchTemplateSource"`
