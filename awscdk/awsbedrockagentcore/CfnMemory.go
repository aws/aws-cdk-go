...
func (j *jsiiProxy_CfnMemory) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnMemory) AttrFailureReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFailureReason",
...
func (j *jsiiProxy_CfnMemory) AttrMemoryArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMemoryArn",
...
func (j *jsiiProxy_CfnMemory) AttrMemoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrMemoryId",
...
func (j *jsiiProxy_CfnMemory) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnMemory) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnMemory) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnMemory) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnMemory) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnMemory) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMemory) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnMemory) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnMemory) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnMemory) EncryptionKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encryptionKeyArn",
...
func (j *jsiiProxy_CfnMemory) EventExpiryDuration() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"eventExpiryDuration",
...
func (j *jsiiProxy_CfnMemory) IndexedKeys() interface{} {
...
func (j *jsiiProxy_CfnMemory) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnMemory) MemoryExecutionRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnMemory) MemoryStrategies() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"memoryStrategies",
...
func (j *jsiiProxy_CfnMemory) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnMemory) Node() constructs.Node {
...
func (j *jsiiProxy_CfnMemory) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnMemory) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnMemory) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnMemory) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnMemory(scope constructs.Construct, id *string, props *CfnMemoryProps) CfnMemory {
	...
	if err := validateNewCfnMemoryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnMemory)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnMemory)SetEncryptionKeyArn(val *string) {
	_jsii_.Set(
		j,
		"encryptionKeyArn",
		val,
...
func (j *jsiiProxy_CfnMemory)SetEventExpiryDuration(val *float64) {
...
func (j *jsiiProxy_CfnMemory)SetIndexedKeys(val interface{}) {
	if err := j.validateSetIndexedKeysParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMemory)SetMemoryExecutionRoleArn(val *string) {
	_jsii_.Set(
		j,
		"memoryExecutionRoleArn",
		val,
...
func (j *jsiiProxy_CfnMemory)SetMemoryStrategies(val interface{}) {
	if err := j.validateSetMemoryStrategiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnMemory)SetName(val *string) {
...
func (j *jsiiProxy_CfnMemory)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnMemory_ArnForMemory(resource interfacesawsbedrockagentcore.IMemoryRef) *string {
	...
	if err := validateCfnMemory_ArnForMemoryParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMemory_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMemory_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMemory_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMemory_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMemory_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMemory_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMemory) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnMemory) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemory) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemory) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnMemory) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnMemory) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnMemory) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnMemory) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMemory) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMemory) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnMemory) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMemory) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMemory) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnMemory) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnMemory) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMemory) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnMemory) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemory) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemory) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnMemory) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMemory) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnMemory) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnMemory) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnMemory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
