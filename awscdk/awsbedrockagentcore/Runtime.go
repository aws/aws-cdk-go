...
func (j *jsiiProxy_Runtime) ApplicationLogGroup() awslogs.ILogGroup {
...
func (r *jsiiProxy_Runtime) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
