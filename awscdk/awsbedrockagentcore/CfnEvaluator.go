...
// The jsii proxy struct for CfnEvaluator
type jsiiProxy_CfnEvaluator struct {
...
func (j *jsiiProxy_CfnEvaluator) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnEvaluator) AttrEvaluatorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEvaluatorArn",
...
func (j *jsiiProxy_CfnEvaluator) AttrEvaluatorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEvaluatorId",
...
func (j *jsiiProxy_CfnEvaluator) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnEvaluator) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnEvaluator) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEvaluator) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnEvaluator) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnEvaluator) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEvaluator) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnEvaluator) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnEvaluator) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnEvaluator) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnEvaluator) EvaluatorConfig() interface{} {
...
func (j *jsiiProxy_CfnEvaluator) EvaluatorName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"evaluatorName",
...
func (j *jsiiProxy_CfnEvaluator) EvaluatorRef() *interfacesawsbedrockagentcore.EvaluatorReference {
...
func (j *jsiiProxy_CfnEvaluator) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnEvaluator) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEvaluator) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnEvaluator) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnEvaluator) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnEvaluator) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnEvaluator) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEvaluator(scope constructs.Construct, id *string, props *CfnEvaluatorProps) CfnEvaluator {
	...
	if err := validateNewCfnEvaluatorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEvaluator)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnEvaluator)SetEvaluatorConfig(val interface{}) {
	if err := j.validateSetEvaluatorConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnEvaluator)SetEvaluatorName(val *string) {
...
func (j *jsiiProxy_CfnEvaluator)SetLevel(val *string) {
...
func (j *jsiiProxy_CfnEvaluator)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnEvaluator_ArnForEvaluator(resource interfacesawsbedrockagentcore.IEvaluatorRef) *string {
	...
	if err := validateCfnEvaluator_ArnForEvaluatorParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnEvaluator_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEvaluator_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEvaluator_IsCfnEvaluator(x interface{}) *bool {
	...
	if err := validateCfnEvaluator_IsCfnEvaluatorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEvaluator_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEvaluator_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEvaluator_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEvaluator_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEvaluator) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnEvaluator) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEvaluator) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEvaluator) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnEvaluator) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnEvaluator) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnEvaluator) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnEvaluator) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEvaluator) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEvaluator) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnEvaluator) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEvaluator) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEvaluator) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnEvaluator) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnEvaluator) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEvaluator) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnEvaluator) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEvaluator) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEvaluator) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnEvaluator) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEvaluator) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnEvaluator) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnEvaluator) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnEvaluator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
