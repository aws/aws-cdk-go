...
// The jsii proxy struct for CfnApiKeyCredentialProvider
type jsiiProxy_CfnApiKeyCredentialProvider struct {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) ApiKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKey",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) ApiKeyCredentialProviderRef() *interfacesawsbedrockagentcore.ApiKeyCredentialProviderReference {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) AttrCredentialProviderArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) AttrLastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedTime",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Node() constructs.Node {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApiKeyCredentialProvider(scope constructs.Construct, id *string, props *CfnApiKeyCredentialProviderProps) CfnApiKeyCredentialProvider {
	...
	if err := validateNewCfnApiKeyCredentialProviderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider)SetApiKey(val *string) {
	_jsii_.Set(
		j,
		"apiKey",
		val,
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider)SetName(val *string) {
...
func (j *jsiiProxy_CfnApiKeyCredentialProvider)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnApiKeyCredentialProvider_IsCfnApiKeyCredentialProvider(x interface{}) *bool {
	...
	if err := validateCfnApiKeyCredentialProvider_IsCfnApiKeyCredentialProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiKeyCredentialProvider_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApiKeyCredentialProvider_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiKeyCredentialProvider_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApiKeyCredentialProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiKeyCredentialProvider_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApiKeyCredentialProvider_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnApiKeyCredentialProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
