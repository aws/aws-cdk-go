...
func validateCfnDataset_ArnForDatasetParameters(resource interfacesawsbedrockagentcore.IDatasetRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataset) validateSetSchemaTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataset) validateSetSourceParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataset_DataSourceTypeProperty:
		val := val.(*CfnDataset_DataSourceTypeProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataset_DataSourceTypeProperty:
		val_ := val.(CfnDataset_DataSourceTypeProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataset_DataSourceTypeProperty; received %#v (a %T)", val, val)
		}
	}
