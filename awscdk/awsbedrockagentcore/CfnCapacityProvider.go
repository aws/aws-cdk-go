...
//
//   cfnCapacityProvider := awscdk.Aws_bedrockagentcore.NewCfnCapacityProvider(this, jsii.String("MyCfnCapacityProvider"), &CfnCapacityProviderProps{
...
type CfnCapacityProvider interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrockagentcore.ICapacityProviderRef
	awscdk.ITaggableV2
	// The ARN of the capacity provider.
	AttrArn() *string
	// The unique identifier of the capacity provider.
	AttrCapacityProviderId() *string
	...
	CapacityProviderRef() *interfacesawsbedrockagentcore.CapacityProviderReference
	...
	PermissionsConfiguration() interface{}
	SetPermissionsConfiguration(val interface{})
...
type jsiiProxy_CfnCapacityProvider struct {
	...
	internal.Type__interfacesawsbedrockagentcoreICapacityProviderRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnCapacityProvider) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnCapacityProvider) AttrCapacityProviderId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCapacityProvider) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnCapacityProvider) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnCapacityProvider) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnCapacityProvider) CapacityProviderRef() *interfacesawsbedrockagentcore.CapacityProviderReference {
	var returns *interfacesawsbedrockagentcore.CapacityProviderReference
	_jsii_.Get(
		j,
		"capacityProviderRef",
		&returns,
...
func (j *jsiiProxy_CfnCapacityProvider) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnCapacityProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCapacityProvider) ComputeConfiguration() interface{} {
...
func (j *jsiiProxy_CfnCapacityProvider) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnCapacityProvider) PermissionsConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCapacityProvider) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnCapacityProvider)SetComputeConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnCapacityProvider)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnCapacityProvider)SetPermissionsConfiguration(val interface{}) {
	if err := j.validateSetPermissionsConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCapacityProvider)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnCapacityProvider_ArnForCapacityProvider(resource interfacesawsbedrockagentcore.ICapacityProviderRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCapacityProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCapacityProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCapacityProvider) RemoveResourceDependency(target awscdk.CfnResource) {
