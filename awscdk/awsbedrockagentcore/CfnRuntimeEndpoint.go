...
func (j *jsiiProxy_CfnRuntimeEndpoint) AgentRuntimeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentRuntimeId",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AgentRuntimeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"agentRuntimeVersion",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrAgentRuntimeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgentRuntimeArn",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrAgentRuntimeEndpointArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAgentRuntimeEndpointArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnRuntimeEndpoint) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrFailureReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFailureReason",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrLiveVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLiveVersion",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) AttrTargetVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTargetVersion",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRuntimeEndpoint) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRuntimeEndpoint) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRuntimeEndpoint(scope constructs.Construct, id *string, props *CfnRuntimeEndpointProps) CfnRuntimeEndpoint {
	...
	if err := validateNewCfnRuntimeEndpointParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRuntimeEndpoint)SetAgentRuntimeId(val *string) {
...
func (j *jsiiProxy_CfnRuntimeEndpoint)SetAgentRuntimeVersion(val *string) {
	_jsii_.Set(
		j,
		"agentRuntimeVersion",
		val,
...
func (j *jsiiProxy_CfnRuntimeEndpoint)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnRuntimeEndpoint)SetName(val *string) {
...
func (j *jsiiProxy_CfnRuntimeEndpoint)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnRuntimeEndpoint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRuntimeEndpoint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuntimeEndpoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRuntimeEndpoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuntimeEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRuntimeEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRuntimeEndpoint) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRuntimeEndpoint) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRuntimeEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
