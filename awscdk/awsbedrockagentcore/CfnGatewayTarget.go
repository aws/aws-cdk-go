...
func (j *jsiiProxy_CfnGatewayTarget) AttrGatewayArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGatewayArn",
...
func (j *jsiiProxy_CfnGatewayTarget) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnGatewayTarget) AttrStatusReasons() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"attrStatusReasons",
...
func (j *jsiiProxy_CfnGatewayTarget) AttrTargetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTargetId",
...
func (j *jsiiProxy_CfnGatewayTarget) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnGatewayTarget) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnGatewayTarget) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGatewayTarget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGatewayTarget) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGatewayTarget) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGatewayTarget) CredentialProviderConfigurations() interface{} {
...
func (j *jsiiProxy_CfnGatewayTarget) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnGatewayTarget) GatewayIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gatewayIdentifier",
...
func (j *jsiiProxy_CfnGatewayTarget) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnGatewayTarget) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGatewayTarget) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGatewayTarget) TargetConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetConfiguration",
...
func (j *jsiiProxy_CfnGatewayTarget) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnGatewayTarget) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGatewayTarget(scope constructs.Construct, id *string, props *CfnGatewayTargetProps) CfnGatewayTarget {
	...
	if err := validateNewCfnGatewayTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGatewayTarget)SetCredentialProviderConfigurations(val interface{}) {
...
func (j *jsiiProxy_CfnGatewayTarget)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnGatewayTarget)SetGatewayIdentifier(val *string) {
	_jsii_.Set(
		j,
		"gatewayIdentifier",
		val,
...
func (j *jsiiProxy_CfnGatewayTarget)SetTargetConfiguration(val interface{}) {
...
func CfnGatewayTarget_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGatewayTarget_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayTarget_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGatewayTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGatewayTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGatewayTarget) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnGatewayTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGatewayTarget) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGatewayTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGatewayTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGatewayTarget) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnGatewayTarget) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGatewayTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGatewayTarget) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnGatewayTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayTarget) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGatewayTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayTarget) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnGatewayTarget) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnGatewayTarget) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnGatewayTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
