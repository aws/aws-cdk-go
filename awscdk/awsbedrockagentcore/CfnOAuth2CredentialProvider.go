...
type CfnOAuth2CredentialProvider interface {
	...
	AttrClientSecretJsonKey() *string
	// The source of the client secret.
	AttrClientSecretSource() *string
...
// The jsii proxy struct for CfnOAuth2CredentialProvider
type jsiiProxy_CfnOAuth2CredentialProvider struct {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrCallbackUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCallbackUrl",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrClientSecretArn() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrClientSecretJsonKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrClientSecretJsonKey",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrClientSecretSource() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrClientSecretSource",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrCredentialProviderArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrLastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedTime",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) AttrOauth2ProviderConfigOutput() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) CredentialProviderVendor() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) OAuth2CredentialProviderRef() *interfacesawsbedrockagentcore.OAuth2CredentialProviderReference {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Oauth2ProviderConfigInput() interface{} {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOAuth2CredentialProvider(scope constructs.Construct, id *string, props *CfnOAuth2CredentialProviderProps) CfnOAuth2CredentialProvider {
	...
	if err := validateNewCfnOAuth2CredentialProviderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider)SetCredentialProviderVendor(val *string) {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider)SetName(val *string) {
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider)SetOauth2ProviderConfigInput(val interface{}) {
	if err := j.validateSetOauth2ProviderConfigInputParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnOAuth2CredentialProvider)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnOAuth2CredentialProvider_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOAuth2CredentialProvider_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOAuth2CredentialProvider_IsCfnOAuth2CredentialProvider(x interface{}) *bool {
	...
	if err := validateCfnOAuth2CredentialProvider_IsCfnOAuth2CredentialProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOAuth2CredentialProvider_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOAuth2CredentialProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOAuth2CredentialProvider_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOAuth2CredentialProvider_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOAuth2CredentialProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
