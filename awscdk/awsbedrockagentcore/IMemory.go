...
func (i *jsiiProxy_IMemory) Metric(metricName *string, props *awscloudwatch.MetricOptions) awscloudwatch.Metric {
...
func (i *jsiiProxy_IMemory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IMemory) Env() *interfaces.ResourceEnvironment {
