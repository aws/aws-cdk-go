...
//
//   cfnDataset := awscdk.Aws_bedrockagentcore.NewCfnDataset(this, jsii.String("MyCfnDataset"), &CfnDatasetProps{
...
type CfnDataset interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsbedrockagentcore.IDatasetRef
	awscdk.ITaggableV2
	...
	DatasetRef() *interfacesawsbedrockagentcore.DatasetReference
...
type jsiiProxy_CfnDataset struct {
	...
	internal.Type__interfacesawsbedrockagentcoreIDatasetRef
...
func (j *jsiiProxy_CfnDataset) AttrExampleCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrExampleCount",
...
func (j *jsiiProxy_CfnDataset) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDataset) DatasetRef() *interfacesawsbedrockagentcore.DatasetReference {
	var returns *interfacesawsbedrockagentcore.DatasetReference
	_jsii_.Get(
		j,
		"datasetRef",
		&returns,
...
func (j *jsiiProxy_CfnDataset) KmsKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyArn",
...
func (j *jsiiProxy_CfnDataset) SchemaType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaType",
...
func (j *jsiiProxy_CfnDataset) Source() interface{} {
...
func (j *jsiiProxy_CfnDataset)SetKmsKeyArn(val *string) {
	_jsii_.Set(
		j,
		"kmsKeyArn",
		val,
...
func (j *jsiiProxy_CfnDataset)SetSchemaType(val *string) {
...
func (j *jsiiProxy_CfnDataset)SetSource(val interface{}) {
...
func CfnDataset_ArnForDataset(resource interfacesawsbedrockagentcore.IDatasetRef) *string {
	_init_.Initialize()
