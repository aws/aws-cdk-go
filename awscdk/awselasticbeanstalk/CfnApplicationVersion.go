...
func (j *jsiiProxy_CfnApplicationVersion) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnApplicationVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplicationVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApplicationVersion(scope constructs.Construct, id *string, props *CfnApplicationVersionProps) CfnApplicationVersion {
	...
	if err := validateNewCfnApplicationVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnApplicationVersion)SetSourceBundle(val interface{}) {
	if err := j.validateSetSourceBundleParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnApplicationVersion_IsCfnApplicationVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationVersion_IsCfnApplicationVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationVersion_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
