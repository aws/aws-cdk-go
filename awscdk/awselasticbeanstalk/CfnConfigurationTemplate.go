...
func (j *jsiiProxy_CfnConfigurationTemplate) CfnPropertyNames() *map[string]*string {
...
func CfnConfigurationTemplate_IsCfnConfigurationTemplate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfigurationTemplate_IsCfnConfigurationTemplateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationTemplate_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfigurationTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
