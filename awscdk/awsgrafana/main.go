...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_grafana.CfnWorkspace.NetworkAccessControlProperty",
		reflect.TypeOf((*CfnWorkspace_NetworkAccessControlProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_grafana.CfnWorkspace.VpcConfigurationProperty",
