...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awsgrafana/internal"
...
func (j *jsiiProxy_CfnWorkspace) GrafanaVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"grafanaVersion",
...
func (j *jsiiProxy_CfnWorkspace)SetGrafanaVersion(val *string) {
	_jsii_.Set(
		j,
		"grafanaVersion",
		val,
