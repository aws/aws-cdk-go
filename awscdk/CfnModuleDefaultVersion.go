...
func (j *jsiiProxy_CfnModuleDefaultVersion) CfnPropertyNames() *map[string]*string {
...
func CfnModuleDefaultVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnModuleDefaultVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnModuleDefaultVersion) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) ReplaceDependency(target CfnResource, newTarget CfnResource) {
...
func (c *jsiiProxy_CfnModuleDefaultVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
