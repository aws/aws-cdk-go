...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnAdapter)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "adapterName", GoGetter: "AdapterName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrAdapterId", GoGetter: "AttrAdapterId"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawstextractIAdapterRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_textract.CfnAdapterProps",
		reflect.TypeOf((*CfnAdapterProps)(nil)).Elem(),
	)
}
