...
//
//   cfnResourcePolicy := awscdk.Aws_kinesis.NewCfnResourcePolicy(this, jsii.String("MyCfnResourcePolicy"), &CfnResourcePolicyProps{
...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawskinesis.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawskinesis.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawskinesisIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawskinesis.ResourcePolicyReference {
	var returns *interfacesawskinesis.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
