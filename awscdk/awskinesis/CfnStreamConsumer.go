...
func (j *jsiiProxy_CfnStreamConsumer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStreamConsumer) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStreamConsumer(scope constructs.Construct, id *string, props *CfnStreamConsumerProps) CfnStreamConsumer {
	...
	if err := validateNewCfnStreamConsumerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStreamConsumer)SetConsumerName(val *string) {
	if err := j.validateSetConsumerNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStreamConsumer_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStreamConsumer_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamConsumer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStreamConsumer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamConsumer_IsCfnStreamConsumer(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStreamConsumer_IsCfnStreamConsumerParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamConsumer_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStreamConsumer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamConsumer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamConsumer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStreamConsumer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStreamConsumer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStreamConsumer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStreamConsumer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStreamConsumer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamConsumer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamConsumer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamConsumer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
