...
func (j *jsiiProxy_CfnProjectProfile) AttrCreatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedBy",
...
func (j *jsiiProxy_CfnProjectProfile) AttrDomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainId",
...
func (j *jsiiProxy_CfnProjectProfile) AttrDomainUnitId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainUnitId",
...
func (j *jsiiProxy_CfnProjectProfile) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnProjectProfile) AttrIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentifier",
...
func (j *jsiiProxy_CfnProjectProfile) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnProjectProfile) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnProjectProfile) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnProjectProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProjectProfile) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnProjectProfile) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnProjectProfile) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnProjectProfile) DomainUnitIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnProjectProfile) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnProjectProfile) Node() constructs.Node {
...
func (j *jsiiProxy_CfnProjectProfile) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnProjectProfile) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnProjectProfile) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnProjectProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnProjectProfile(scope constructs.Construct, id *string, props *CfnProjectProfileProps) CfnProjectProfile {
	...
	if err := validateNewCfnProjectProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnProjectProfile)SetDomainIdentifier(val *string) {
	_jsii_.Set(
		j,
		"domainIdentifier",
		val,
...
func (j *jsiiProxy_CfnProjectProfile)SetDomainUnitIdentifier(val *string) {
	_jsii_.Set(
		j,
		"domainUnitIdentifier",
		val,
...
func (j *jsiiProxy_CfnProjectProfile)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnProjectProfile_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProjectProfile_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProjectProfile_IsCfnProjectProfile(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnProjectProfile_IsCfnProjectProfileParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProjectProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProjectProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProjectProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProjectProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProjectProfile) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnProjectProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectProfile) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectProfile) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectProfile) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectProfile) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnProjectProfile) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProjectProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProjectProfile) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnProjectProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProjectProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProjectProfile) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnProjectProfile) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnProjectProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProjectProfile) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnProjectProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectProfile) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnProjectProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectProfile) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnProjectProfile) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnProjectProfile) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnProjectProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
