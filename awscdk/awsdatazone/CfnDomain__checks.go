...
func validateCfnDomain_ArnForDomainParameters(resource interfacesawsdatazone.IDomainRef) error {
	if resource == nil {
...
func validateCfnDomain_FromDomainIdParameters(scope constructs.Construct, id *string, domainId *string) error {
	...
	if domainId == nil {
		return fmt.Errorf("parameter domainId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDomain) validateSetSingleSignOnParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDomain_SingleSignOnProperty:
		val := val.(*CfnDomain_SingleSignOnProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDomain_SingleSignOnProperty:
		val_ := val.(CfnDomain_SingleSignOnProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDomain_SingleSignOnProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDomain) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
