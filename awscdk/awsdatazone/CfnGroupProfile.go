...
func (j *jsiiProxy_CfnGroupProfile) AttrGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGroupName",
...
func (j *jsiiProxy_CfnGroupProfile) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnGroupProfile) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGroupProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGroupProfile) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGroupProfile) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGroupProfile) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnGroupProfile) GroupIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupIdentifier",
...
func (j *jsiiProxy_CfnGroupProfile) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGroupProfile) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnGroupProfile) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGroupProfile) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnGroupProfile) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnGroupProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGroupProfile(scope constructs.Construct, id *string, props *CfnGroupProfileProps) CfnGroupProfile {
	...
	if err := validateNewCfnGroupProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGroupProfile)SetDomainIdentifier(val *string) {
...
func (j *jsiiProxy_CfnGroupProfile)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnGroupProfile_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGroupProfile_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGroupProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGroupProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGroupProfile) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnGroupProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupProfile) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupProfile) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupProfile) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupProfile) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnGroupProfile) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroupProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroupProfile) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGroupProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroupProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGroupProfile) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnGroupProfile) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGroupProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGroupProfile) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnGroupProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupProfile) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGroupProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupProfile) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnGroupProfile) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnGroupProfile) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnGroupProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
