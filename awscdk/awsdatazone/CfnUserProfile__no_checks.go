...
func (j *jsiiProxy_CfnUserProfile) validateSetDomainIdentifierParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnUserProfile) validateSetUserIdentifierParameters(val *string) error {
	return nil
}
