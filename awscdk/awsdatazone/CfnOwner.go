...
func (j *jsiiProxy_CfnOwner) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOwner) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOwner) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOwner) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOwner) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnOwner) EntityIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"entityIdentifier",
...
func (j *jsiiProxy_CfnOwner) EntityType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"entityType",
...
func (j *jsiiProxy_CfnOwner) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOwner) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOwner) Owner() interface{} {
...
func (j *jsiiProxy_CfnOwner) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOwner) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOwner) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOwner) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOwner(scope constructs.Construct, id *string, props *CfnOwnerProps) CfnOwner {
	...
	if err := validateNewCfnOwnerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOwner)SetDomainIdentifier(val *string) {
...
func (j *jsiiProxy_CfnOwner)SetEntityIdentifier(val *string) {
...
func (j *jsiiProxy_CfnOwner)SetEntityType(val *string) {
...
func (j *jsiiProxy_CfnOwner)SetOwner(val interface{}) {
...
func CfnOwner_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOwner_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOwner_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOwner_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOwner_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOwner_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOwner) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOwner) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOwner) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOwner) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOwner) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOwner) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOwner) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOwner) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOwner) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOwner) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOwner) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOwner) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOwner) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOwner) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOwner) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOwner) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOwner) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOwner) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOwner) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOwner) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOwner) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOwner) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOwner) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOwner) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
