...
func validateCfnDataSource_ArnForDataSourceParameters(resource interfacesawsdatazone.IDataSourceRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetAssetFormsInputParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnDataSource_FormInputProperty:
				v := v.(*CfnDataSource_FormInputProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnDataSource_FormInputProperty:
				v_ := v.(CfnDataSource_FormInputProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_FormInputProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnDataSource) validateSetConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_DataSourceConfigurationInputProperty:
		val := val.(*CfnDataSource_DataSourceConfigurationInputProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_DataSourceConfigurationInputProperty:
		val_ := val.(CfnDataSource_DataSourceConfigurationInputProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_DataSourceConfigurationInputProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetDomainIdentifierParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDataSource) validateSetProjectIdentifierParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetPublishOnImportParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnDataSource) validateSetRecommendationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_RecommendationConfigurationProperty:
		val := val.(*CfnDataSource_RecommendationConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_RecommendationConfigurationProperty:
		val_ := val.(CfnDataSource_RecommendationConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_RecommendationConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnDataSource) validateSetScheduleParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnDataSource_ScheduleConfigurationProperty:
		val := val.(*CfnDataSource_ScheduleConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnDataSource_ScheduleConfigurationProperty:
		val_ := val.(CfnDataSource_ScheduleConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnDataSource_ScheduleConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
