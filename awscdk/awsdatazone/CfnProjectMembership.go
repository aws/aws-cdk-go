...
func (j *jsiiProxy_CfnProjectMembership) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnProjectMembership) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProjectMembership) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnProjectMembership) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnProjectMembership) Designation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"designation",
...
func (j *jsiiProxy_CfnProjectMembership) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnProjectMembership) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnProjectMembership) Member() interface{} {
...
func (j *jsiiProxy_CfnProjectMembership) Node() constructs.Node {
...
func (j *jsiiProxy_CfnProjectMembership) ProjectIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectIdentifier",
...
func (j *jsiiProxy_CfnProjectMembership) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnProjectMembership) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnProjectMembership) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnProjectMembership) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnProjectMembership(scope constructs.Construct, id *string, props *CfnProjectMembershipProps) CfnProjectMembership {
	...
	if err := validateNewCfnProjectMembershipParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnProjectMembership)SetDesignation(val *string) {
...
func (j *jsiiProxy_CfnProjectMembership)SetDomainIdentifier(val *string) {
...
func (j *jsiiProxy_CfnProjectMembership)SetMember(val interface{}) {
...
func (j *jsiiProxy_CfnProjectMembership)SetProjectIdentifier(val *string) {
...
func CfnProjectMembership_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProjectMembership_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProjectMembership_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProjectMembership_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProjectMembership_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProjectMembership_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProjectMembership) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnProjectMembership) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectMembership) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectMembership) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectMembership) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectMembership) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnProjectMembership) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnProjectMembership) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProjectMembership) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProjectMembership) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnProjectMembership) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProjectMembership) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProjectMembership) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnProjectMembership) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnProjectMembership) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProjectMembership) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnProjectMembership) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectMembership) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectMembership) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnProjectMembership) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProjectMembership) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnProjectMembership) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnProjectMembership) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnProjectMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
