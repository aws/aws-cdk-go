...
//
type CfnPolicyGrant_DomainUnitGrantFilterProperty struct {
	...
	//
	AllDomainUnitsGrantFilter interface{} `field:"required" json:"allDomainUnitsGrantFilter" yaml:"allDomainUnitsGrantFilter"`
}
