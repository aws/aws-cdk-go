...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrCreatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedBy",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrDomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainId",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrEnvironmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEnvironmentId",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrProjectId",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AttrUpdatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedBy",
...
func (j *jsiiProxy_CfnSubscriptionTarget) AuthorizedPrincipals() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriptionTarget) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSubscriptionTarget) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSubscriptionTarget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubscriptionTarget) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSubscriptionTarget) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSubscriptionTarget) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnSubscriptionTarget) EnvironmentIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSubscriptionTarget) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSubscriptionTarget) ManageAccessRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"manageAccessRole",
...
func (j *jsiiProxy_CfnSubscriptionTarget) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnSubscriptionTarget) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSubscriptionTarget) Provider() *string {
	var returns *string
	_jsii_.Get(
		j,
		"provider",
...
func (j *jsiiProxy_CfnSubscriptionTarget) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSubscriptionTarget) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSubscriptionTarget) SubscriptionTargetConfig() interface{} {
...
func (j *jsiiProxy_CfnSubscriptionTarget) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnSubscriptionTarget) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSubscriptionTarget) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubscriptionTarget(scope constructs.Construct, id *string, props *CfnSubscriptionTargetProps) CfnSubscriptionTarget {
	...
	if err := validateNewCfnSubscriptionTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetApplicableAssetTypes(val *[]*string) {
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetAuthorizedPrincipals(val *[]*string) {
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetDomainIdentifier(val *string) {
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetEnvironmentIdentifier(val *string) {
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetName(val *string) {
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetProvider(val *string) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetSubscriptionTargetConfig(val interface{}) {
	if err := j.validateSetSubscriptionTargetConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSubscriptionTarget)SetType(val *string) {
...
func CfnSubscriptionTarget_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionTarget_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriptionTarget_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscriptionTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubscriptionTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubscriptionTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubscriptionTarget) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSubscriptionTarget) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubscriptionTarget) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSubscriptionTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSubscriptionTarget) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSubscriptionTarget) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSubscriptionTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
