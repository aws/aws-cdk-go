...
func (j *jsiiProxy_CfnProject) AttrCreatedBy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedBy",
...
func (j *jsiiProxy_CfnProject) AttrDomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainId",
...
func (j *jsiiProxy_CfnProject) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnProject) DomainIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainIdentifier",
...
func (j *jsiiProxy_CfnProject)SetDomainIdentifier(val *string) {
