...
func (j *jsiiProxy_CfnBudget) validateSetBudgetParameters(val interface{}) error {
	if val == nil {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnBudget_BudgetDataProperty:
		val := val.(*CfnBudget_BudgetDataProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnBudget_BudgetDataProperty:
		val_ := val.(CfnBudget_BudgetDataProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnBudget_BudgetDataProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnBudget) validateSetNotificationsWithSubscribersParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnBudget_NotificationWithSubscribersProperty:
				v := v.(*CfnBudget_NotificationWithSubscribersProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnBudget_NotificationWithSubscribersProperty:
				v_ := v.(CfnBudget_NotificationWithSubscribersProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnBudget_NotificationWithSubscribersProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnBudget) validateSetResourceTagsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnBudget_ResourceTagProperty:
				v := v.(*CfnBudget_ResourceTagProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnBudget_ResourceTagProperty:
				v_ := v.(CfnBudget_ResourceTagProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnBudget_ResourceTagProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
