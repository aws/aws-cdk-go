...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_budgets.CfnBudget.CostCategoryValuesProperty",
		reflect.TypeOf((*CfnBudget_CostCategoryValuesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnBudget_ExpressionDimensionValuesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_budgets.CfnBudget.ExpressionProperty",
		reflect.TypeOf((*CfnBudget_ExpressionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_budgets.CfnBudget.TagValuesProperty",
		reflect.TypeOf((*CfnBudget_TagValuesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
