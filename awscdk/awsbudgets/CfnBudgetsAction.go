...
func (j *jsiiProxy_CfnBudgetsAction) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBudgetsAction) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBudgetsAction(scope constructs.Construct, id *string, props *CfnBudgetsActionProps) CfnBudgetsAction {
	...
	if err := validateNewCfnBudgetsActionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnBudgetsAction)SetActionThreshold(val interface{}) {
	if err := j.validateSetActionThresholdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnBudgetsAction_IsCfnBudgetsAction(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBudgetsAction_IsCfnBudgetsActionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBudgetsAction_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBudgetsAction_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBudgetsAction_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnBudgetsAction_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBudgetsAction_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBudgetsAction_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBudgetsAction) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBudgetsAction) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBudgetsAction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBudgetsAction) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBudgetsAction) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBudgetsAction) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBudgetsAction) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBudgetsAction) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBudgetsAction) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBudgetsAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
