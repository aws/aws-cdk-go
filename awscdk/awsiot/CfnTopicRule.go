...
func (j *jsiiProxy_CfnTopicRule) CfnPropertyNames() *map[string]*string {
...
func CfnTopicRule_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTopicRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicRule_IsCfnTopicRule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTopicRule_IsCfnTopicRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTopicRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTopicRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTopicRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTopicRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
