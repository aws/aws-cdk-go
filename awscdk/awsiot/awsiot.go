...
func init() {
	...
	_jsii_.RegisterClass(
		"monocdk.aws_iot.CfnBillingGroup",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnBillingGroup.BillingGroupPropertiesProperty",
		reflect.TypeOf((*CfnBillingGroup_BillingGroupPropertiesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnBillingGroupProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnCACertificate.RegistrationConfigProperty",
		reflect.TypeOf((*CfnCACertificate_RegistrationConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnCACertificateProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnDomainConfiguration.TlsConfigProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnRoleAliasProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnThingGroup.AttributePayloadProperty",
		reflect.TypeOf((*CfnThingGroup_AttributePayloadProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnThingGroup.ThingGroupPropertiesProperty",
		reflect.TypeOf((*CfnThingGroup_ThingGroupPropertiesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnThingGroupProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnThingType.ThingTypePropertiesProperty",
		reflect.TypeOf((*CfnThingType_ThingTypePropertiesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnThingTypeProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnTopicRule.RepublishActionHeadersProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_iot.CfnTopicRule.UserPropertyProperty",
