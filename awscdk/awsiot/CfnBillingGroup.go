...
func (j *jsiiProxy_CfnBillingGroup) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnBillingGroup) BillingGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"billingGroupName",
...
func (j *jsiiProxy_CfnBillingGroup) BillingGroupProperties() interface{} {
...
func (j *jsiiProxy_CfnBillingGroup)SetBillingGroupName(val *string) {
	_jsii_.Set(
		j,
		"billingGroupName",
		val,
...
func (j *jsiiProxy_CfnBillingGroup)SetBillingGroupProperties(val interface{}) {
	if err := j.validateSetBillingGroupPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
