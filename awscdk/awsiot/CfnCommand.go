...
func (j *jsiiProxy_CfnCommand) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCommand) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCommand) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCommand) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCommand) RemoveResourceDependency(target awscdk.CfnResource) {
