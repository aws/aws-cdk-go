...
func (j *jsiiProxy_CfnLogging) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnLogging.
func CfnLogging_IsCfnLogging(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLogging_IsCfnLoggingParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLogging) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogging) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLogging) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLogging) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLogging) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
