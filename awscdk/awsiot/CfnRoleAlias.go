...
func (j *jsiiProxy_CfnRoleAlias) CfnPropertyNames() *map[string]*string {
...
func NewCfnRoleAlias(scope constructs.Construct, id *string, props *CfnRoleAliasProps) CfnRoleAlias {
	...
	if err := validateNewCfnRoleAliasParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRoleAlias_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRoleAlias_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRoleAlias_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRoleAlias_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnRoleAlias.
func CfnRoleAlias_IsCfnRoleAlias(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRoleAlias_IsCfnRoleAliasParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRoleAlias_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRoleAlias_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRoleAlias) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoleAlias) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRoleAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRoleAlias) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRoleAlias) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRoleAlias) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRoleAlias) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoleAlias) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoleAlias) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRoleAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
