...
func (j *jsiiProxy_CfnResourceSpecificLogging) CfnPropertyNames() *map[string]*string {
...
func CfnResourceSpecificLogging_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceSpecificLogging_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSpecificLogging_IsCfnResourceSpecificLogging(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceSpecificLogging_IsCfnResourceSpecificLoggingParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceSpecificLogging) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
