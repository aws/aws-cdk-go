...
//
//   cfnStream := awscdk.Aws_iot.NewCfnStream(this, jsii.String("MyCfnStream"), &CfnStreamProps{
//   	Files: []interface{}{
//   		&StreamFileProperty{
...
type CfnStream interface {
	...
	StreamRef() *interfacesawsiot.StreamReference
...
type jsiiProxy_CfnStream struct {
	...
	internal.Type__interfacesawsiotIStreamRef
...
func (j *jsiiProxy_CfnStream) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnStream) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnStream) AttrStreamVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrStreamVersion",
...
func (j *jsiiProxy_CfnStream) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnStream) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStream) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnStream) Files() interface{} {
...
func (j *jsiiProxy_CfnStream) StreamId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"streamId",
...
func (j *jsiiProxy_CfnStream) StreamRef() *interfacesawsiot.StreamReference {
	var returns *interfacesawsiot.StreamReference
	_jsii_.Get(
		j,
		"streamRef",
		&returns,
...
func (j *jsiiProxy_CfnStream) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnStream) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStream(scope constructs.Construct, id *string, props *CfnStreamProps) CfnStream {
	...
	if err := validateNewCfnStreamParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnStream{}

	_jsii_.Create(
		"aws-cdk-lib.aws_iot.CfnStream",
...
func (j *jsiiProxy_CfnStream)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnStream)SetFiles(val interface{}) {
...
func (j *jsiiProxy_CfnStream)SetStreamId(val *string) {
...
func (j *jsiiProxy_CfnStream)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnStream_ArnForStream(resource interfacesawsiot.IStreamRef) *string {
	_init_.Initialize()
...
func CfnStream_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStream_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStream_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStream_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStream_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStream_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStream) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStream) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStream) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStream) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStream) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStream) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStream) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStream) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
