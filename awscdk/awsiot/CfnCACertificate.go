...
func (j *jsiiProxy_CfnCACertificate) CfnPropertyNames() *map[string]*string {
...
func NewCfnCACertificate(scope constructs.Construct, id *string, props *CfnCACertificateProps) CfnCACertificate {
	...
	if err := validateNewCfnCACertificateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCACertificate)SetRegistrationConfig(val interface{}) {
	if err := j.validateSetRegistrationConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCACertificate_IsCfnCACertificate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCACertificate_IsCfnCACertificateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCACertificate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCACertificate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCACertificate_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCACertificate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCACertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCACertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCACertificate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCACertificate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCACertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCACertificate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCACertificate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCACertificate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCACertificate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCACertificate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCACertificate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCACertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
