...
//
//   cfnCertificateProvider := awscdk.Aws_iot.NewCfnCertificateProvider(this, jsii.String("MyCfnCertificateProvider"), &CfnCertificateProviderProps{
...
func (j *jsiiProxy_CfnCertificateProvider) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnCertificateProvider) CertificateProviderName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCertificateProvider) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnCertificateProvider) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnCertificateProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCertificateProvider) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnCertificateProvider) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnCertificateProvider) LambdaFunctionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lambdaFunctionArn",
...
func (j *jsiiProxy_CfnCertificateProvider) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnCertificateProvider) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCertificateProvider) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnCertificateProvider) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnCertificateProvider) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnCertificateProvider) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnCertificateProvider) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCertificateProvider(scope constructs.Construct, id *string, props *CfnCertificateProviderProps) CfnCertificateProvider {
	...
	if err := validateNewCfnCertificateProviderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCertificateProvider)SetAccountDefaultForOperations(val *[]*string) {
	if err := j.validateSetAccountDefaultForOperationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCertificateProvider)SetCertificateProviderName(val *string) {
	_jsii_.Set(
		j,
		"certificateProviderName",
		val,
...
func (j *jsiiProxy_CfnCertificateProvider)SetLambdaFunctionArn(val *string) {
...
func (j *jsiiProxy_CfnCertificateProvider)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnCertificateProvider_ArnForCertificateProvider(resource interfacesawsiot.ICertificateProviderRef) *string {
	_init_.Initialize()

	if err := validateCfnCertificateProvider_ArnForCertificateProviderParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
// Checks whether the given object is a CfnCertificateProvider.
func CfnCertificateProvider_IsCfnCertificateProvider(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCertificateProvider_IsCfnCertificateProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCertificateProvider_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCertificateProvider_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCertificateProvider_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCertificateProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCertificateProvider_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCertificateProvider_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCertificateProvider_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iot.CfnCertificateProvider",
...
func (c *jsiiProxy_CfnCertificateProvider) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnCertificateProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCertificateProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCertificateProvider) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnCertificateProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCertificateProvider) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCertificateProvider) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnCertificateProvider) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnCertificateProvider) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCertificateProvider) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnCertificateProvider) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateProvider) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnCertificateProvider) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateProvider) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnCertificateProvider) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnCertificateProvider) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnCertificateProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
