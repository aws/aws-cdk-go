...
func (j *jsiiProxy_CfnThingPrincipalAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnThingPrincipalAttachment) ThingPrincipalType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingPrincipalType",
...
func (j *jsiiProxy_CfnThingPrincipalAttachment)SetThingPrincipalType(val *string) {
	_jsii_.Set(
		j,
		"thingPrincipalType",
		val,
...
func CfnThingPrincipalAttachment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnThingPrincipalAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThingPrincipalAttachment_IsCfnThingPrincipalAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnThingPrincipalAttachment_IsCfnThingPrincipalAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
