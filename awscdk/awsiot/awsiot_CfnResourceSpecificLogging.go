...
func NewCfnResourceSpecificLogging(scope constructs.Construct, id *string, props *CfnResourceSpecificLoggingProps) CfnResourceSpecificLogging {
	...
	if err := validateNewCfnResourceSpecificLoggingParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResourceSpecificLogging_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceSpecificLogging_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSpecificLogging_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResourceSpecificLogging_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSpecificLogging_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceSpecificLogging_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceSpecificLogging) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceSpecificLogging) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSpecificLogging) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
