...
func (j *jsiiProxy_CfnSoftwarePackageVersion) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnSoftwarePackageVersion.
func CfnSoftwarePackageVersion_IsCfnSoftwarePackageVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSoftwarePackageVersion_IsCfnSoftwarePackageVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSoftwarePackageVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSoftwarePackageVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSoftwarePackageVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSoftwarePackageVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSoftwarePackageVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
