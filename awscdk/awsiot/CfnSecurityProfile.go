...
func (j *jsiiProxy_CfnSecurityProfile) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSecurityProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityProfile) RemoveResourceDependency(target awscdk.CfnResource) {
