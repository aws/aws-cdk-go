...
func NewCfnThingPrincipalAttachment(scope constructs.Construct, id *string, props *CfnThingPrincipalAttachmentProps) CfnThingPrincipalAttachment {
	...
	if err := validateNewCfnThingPrincipalAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnThingPrincipalAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnThingPrincipalAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThingPrincipalAttachment_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnThingPrincipalAttachment_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThingPrincipalAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnThingPrincipalAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThingPrincipalAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
