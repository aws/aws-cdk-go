...
func (j *jsiiProxy_CfnJobTemplate) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnJobTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnJobTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnJobTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnJobTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnJobTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
