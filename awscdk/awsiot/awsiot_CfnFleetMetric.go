...
func (c *jsiiProxy_CfnFleetMetric) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFleetMetric) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFleetMetric) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFleetMetric) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnFleetMetric) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFleetMetric) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
