...
func (j *jsiiProxy_CfnFleetMetric) CfnPropertyNames() *map[string]*string {
...
func CfnFleetMetric_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFleetMetric_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFleetMetric) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFleetMetric) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFleetMetric) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFleetMetric) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFleetMetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
