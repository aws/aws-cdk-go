...
//
//   cfnIndex := awscdk.Aws_iot.NewCfnIndex(this, jsii.String("MyCfnIndex"), &CfnIndexProps{
...
type CfnIndex interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsiot.IIndexRef
	AttrArn() *string
	AttrId() *string
	AttrIndexStatus() *string
	AttrSchema() *string
	...
	IndexRef() *interfacesawsiot.IndexReference
...
type jsiiProxy_CfnIndex struct {
	...
	internal.Type__interfacesawsiotIIndexRef
}
...
func (j *jsiiProxy_CfnIndex) AttrIndexStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIndexStatus",
...
func (j *jsiiProxy_CfnIndex) AttrSchema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSchema",
...
func (j *jsiiProxy_CfnIndex) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIndex) IndexName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"indexName",
...
func (j *jsiiProxy_CfnIndex) IndexRef() *interfacesawsiot.IndexReference {
	var returns *interfacesawsiot.IndexReference
	_jsii_.Get(
		j,
		"indexRef",
		&returns,
...
func (j *jsiiProxy_CfnIndex)SetIndexName(val *string) {
	_jsii_.Set(
		j,
		"indexName",
		val,
...
func CfnIndex_ArnForIndex(resource interfacesawsiot.IIndexRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIndex) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIndex) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIndex) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIndex) RemoveResourceDependency(target awscdk.CfnResource) {
