...
func (j *jsiiProxy_CfnDomainConfiguration) CfnPropertyNames() *map[string]*string {
...
func NewCfnDomainConfiguration(scope constructs.Construct, id *string, props *CfnDomainConfigurationProps) CfnDomainConfiguration {
	...
	if err := validateNewCfnDomainConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDomainConfiguration)SetTlsConfig(val interface{}) {
...
func CfnDomainConfiguration_FromDomainConfigurationName(scope constructs.Construct, id *string, domainConfigurationName *string) interfacesawsiot.IDomainConfigurationRef {
	...
	_jsii_.StaticInvoke(
		...
		[]interface{}{scope, id, domainConfigurationName},
		&returns,
	)
...
func CfnDomainConfiguration_IsCfnDomainConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDomainConfiguration_IsCfnDomainConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDomainConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainConfiguration_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDomainConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDomainConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDomainConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDomainConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDomainConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDomainConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDomainConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDomainConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
