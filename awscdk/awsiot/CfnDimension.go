...
func (j *jsiiProxy_CfnDimension) CfnPropertyNames() *map[string]*string {
...
func NewCfnDimension(scope constructs.Construct, id *string, props *CfnDimensionProps) CfnDimension {
	...
	if err := validateNewCfnDimensionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDimension_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDimension_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDimension_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDimension_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDimension_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDimension_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDimension) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDimension) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDimension) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDimension) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDimension) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDimension) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDimension) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDimension) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDimension) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDimension) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
