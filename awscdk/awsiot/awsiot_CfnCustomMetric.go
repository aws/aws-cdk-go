...
func NewCfnCustomMetric(scope constructs.Construct, id *string, props *CfnCustomMetricProps) CfnCustomMetric {
	...
	if err := validateNewCfnCustomMetricParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCustomMetric_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomMetric_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomMetric_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCustomMetric_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomMetric_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomMetric_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomMetric) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomMetric) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomMetric) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomMetric) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCustomMetric) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomMetric) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
