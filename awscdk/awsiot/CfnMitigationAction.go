...
func (j *jsiiProxy_CfnMitigationAction) CfnPropertyNames() *map[string]*string {
...
func NewCfnMitigationAction(scope constructs.Construct, id *string, props *CfnMitigationActionProps) CfnMitigationAction {
	...
	if err := validateNewCfnMitigationActionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMitigationAction_ArnForMitigationAction(resource interfacesawsiot.IMitigationActionRef) *string {
	_init_.Initialize()

	if err := validateCfnMitigationAction_ArnForMitigationActionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnMitigationAction_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMitigationAction_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMitigationAction_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMitigationAction_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMitigationAction_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMitigationAction_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMitigationAction) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMitigationAction) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMitigationAction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMitigationAction) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMitigationAction) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMitigationAction) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMitigationAction) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMitigationAction) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMitigationAction) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMitigationAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
