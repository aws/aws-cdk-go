...
func (j *jsiiProxy_CfnCustomMetric) CfnPropertyNames() *map[string]*string {
...
func CfnCustomMetric_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCustomMetric_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomMetric) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomMetric) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomMetric) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomMetric) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomMetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
