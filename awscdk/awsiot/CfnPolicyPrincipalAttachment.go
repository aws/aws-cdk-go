...
func (j *jsiiProxy_CfnPolicyPrincipalAttachment) CfnPropertyNames() *map[string]*string {
...
func CfnPolicyPrincipalAttachment_IsCfnPolicyPrincipalAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPolicyPrincipalAttachment_IsCfnPolicyPrincipalAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_iot.CfnPolicyPrincipalAttachment",
		"isCfnPolicyPrincipalAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnPolicyPrincipalAttachment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPolicyPrincipalAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
