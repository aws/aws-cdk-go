...
func (j *jsiiProxy_CfnThing) CfnPropertyNames() *map[string]*string {
...
func CfnThing_ArnForThing(resource interfacesawsiot.IThingRef) *string {
	_init_.Initialize()

	if err := validateCfnThing_ArnForThingParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnThing_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnThing_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThing) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnThing) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnThing) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnThing) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThing) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
