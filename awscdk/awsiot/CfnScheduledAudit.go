...
func (j *jsiiProxy_CfnScheduledAudit) CfnPropertyNames() *map[string]*string {
...
func NewCfnScheduledAudit(scope constructs.Construct, id *string, props *CfnScheduledAuditProps) CfnScheduledAudit {
	...
	if err := validateNewCfnScheduledAuditParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnScheduledAudit_ArnForScheduledAudit(resource interfacesawsiot.IScheduledAuditRef) *string {
	_init_.Initialize()

	if err := validateCfnScheduledAudit_ArnForScheduledAuditParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnScheduledAudit_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnScheduledAudit_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScheduledAudit_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnScheduledAudit_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScheduledAudit_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnScheduledAudit_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScheduledAudit) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAudit) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScheduledAudit) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScheduledAudit) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScheduledAudit) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScheduledAudit) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScheduledAudit) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAudit) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAudit) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduledAudit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
