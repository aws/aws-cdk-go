...
func NewCfnPolicyPrincipalAttachment(scope constructs.Construct, id *string, props *CfnPolicyPrincipalAttachmentProps) CfnPolicyPrincipalAttachment {
	...
	if err := validateNewCfnPolicyPrincipalAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPolicyPrincipalAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPolicyPrincipalAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPolicyPrincipalAttachment_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPolicyPrincipalAttachment_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPolicyPrincipalAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPolicyPrincipalAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPolicyPrincipalAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
