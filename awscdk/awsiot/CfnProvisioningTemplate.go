...
func (j *jsiiProxy_CfnProvisioningTemplate) CfnPropertyNames() *map[string]*string {
...
func NewCfnProvisioningTemplate(scope constructs.Construct, id *string, props *CfnProvisioningTemplateProps) CfnProvisioningTemplate {
	...
	if err := validateNewCfnProvisioningTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnProvisioningTemplate)SetPreProvisioningHook(val interface{}) {
	if err := j.validateSetPreProvisioningHookParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnProvisioningTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProvisioningTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProvisioningTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProvisioningTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProvisioningTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProvisioningTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProvisioningTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProvisioningTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProvisioningTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProvisioningTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProvisioningTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
