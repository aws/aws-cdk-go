...
func (c *jsiiProxy_CfnCommand) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnCommand) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnCommand) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnCommand) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCommand) validateSetPreprocessorParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnCommand_CommandPreprocessorProperty:
		val := val.(*CfnCommand_CommandPreprocessorProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCommand_CommandPreprocessorProperty:
		val_ := val.(CfnCommand_CommandPreprocessorProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCommand_CommandPreprocessorProperty; received %#v (a %T)", val, val)
		}
	}
