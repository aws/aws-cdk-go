...
func (j *jsiiProxy_CfnTopicRuleDestination) CfnPropertyNames() *map[string]*string {
...
func NewCfnTopicRuleDestination(scope constructs.Construct, id *string, props *CfnTopicRuleDestinationProps) CfnTopicRuleDestination {
	...
	if err := validateNewCfnTopicRuleDestinationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTopicRuleDestination)SetHttpUrlProperties(val interface{}) {
	if err := j.validateSetHttpUrlPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTopicRuleDestination)SetVpcProperties(val interface{}) {
	if err := j.validateSetVpcPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnTopicRuleDestination_ArnForTopicRuleDestination(resource interfacesawsiot.ITopicRuleDestinationRef) *string {
	_init_.Initialize()

	if err := validateCfnTopicRuleDestination_ArnForTopicRuleDestinationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTopicRuleDestination_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTopicRuleDestination_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicRuleDestination_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTopicRuleDestination_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicRuleDestination_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTopicRuleDestination_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTopicRuleDestination) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTopicRuleDestination) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTopicRuleDestination) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTopicRuleDestination) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicRuleDestination) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
