...
func (j *jsiiProxy_CfnThing) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func NewCfnThing(scope constructs.Construct, id *string, props *CfnThingProps) CfnThing {
	...
	if err := validateNewCfnThingParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnThing)SetAttributePayload(val interface{}) {
	if err := j.validateSetAttributePayloadParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnThing_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnThing_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThing_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnThing_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThing_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnThing_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThing) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThing) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnThing) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnThing) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnThing) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThing) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
