...
func (a *jsiiProxy_AccessEntry) validateAddAccessPoliciesParameters(newAccessPolicies *[]IAccessPolicy) error {
	if newAccessPolicies == nil {
		return fmt.Errorf("parameter newAccessPolicies is required, but nil was provided")
	}

	return nil
}

func (a *jsiiProxy_AccessEntry) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
