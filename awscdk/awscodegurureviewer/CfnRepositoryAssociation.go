...
func (j *jsiiProxy_CfnRepositoryAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRepositoryAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRepositoryAssociation(scope constructs.Construct, id *string, props *CfnRepositoryAssociationProps) CfnRepositoryAssociation {
	...
	if err := validateNewCfnRepositoryAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRepositoryAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRepositoryAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRepositoryAssociation_IsCfnRepositoryAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRepositoryAssociation_IsCfnRepositoryAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRepositoryAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRepositoryAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRepositoryAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRepositoryAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRepositoryAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRepositoryAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
