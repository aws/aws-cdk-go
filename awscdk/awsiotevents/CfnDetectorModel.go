...
func (j *jsiiProxy_CfnDetectorModel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDetectorModel) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDetectorModel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnDetectorModel)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnDetectorModel_ArnForDetectorModel(resource interfacesawsiotevents.IDetectorModelRef) *string {
	_init_.Initialize()

	if err := validateCfnDetectorModel_ArnForDetectorModelParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDetectorModel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDetectorModel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDetectorModel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDetectorModel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDetectorModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDetectorModel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDetectorModel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDetectorModel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDetectorModel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDetectorModel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDetectorModel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDetectorModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
