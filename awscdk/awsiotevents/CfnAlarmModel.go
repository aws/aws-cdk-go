...
func (j *jsiiProxy_CfnAlarmModel) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAlarmModel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAlarmModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAlarmModel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAlarmModel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAlarmModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
