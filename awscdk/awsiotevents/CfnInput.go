...
func (j *jsiiProxy_CfnInput) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnInput) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnInput) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnInput(scope constructs.Construct, id *string, props *CfnInputProps) CfnInput {
	...
	if err := validateNewCfnInputParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnInput)SetInputDefinition(val interface{}) {
	if err := j.validateSetInputDefinitionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnInput)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnInput_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnInput_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInput_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnInput_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInput) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInput) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInput) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInput) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInput) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnInput) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInput) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInput) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInput) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInput) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
