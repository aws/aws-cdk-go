...
func validateCfnNamespace_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnNamespace) validateSetNamespaceParameters(val interface{}) error {
	switch val.(type) {
	case *CfnNamespace_NamespaceProperty:
		val := val.(*CfnNamespace_NamespaceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnNamespace_NamespaceProperty:
		val_ := val.(CfnNamespace_NamespaceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnNamespace_NamespaceProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
