...
func (j *jsiiProxy_CfnSkill) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSkill) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSkill(scope constructs.Construct, id *string, props *CfnSkillProps) CfnSkill {
	...
	if err := validateNewCfnSkillParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSkill)SetSkillPackage(val interface{}) {
	if err := j.validateSetSkillPackageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSkill_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSkill_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSkill_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSkill_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSkill_IsCfnSkill(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSkill_IsCfnSkillParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSkill_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSkill_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSkill) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSkill) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSkill) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSkill) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSkill) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSkill) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSkill) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSkill) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSkill) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSkill) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
