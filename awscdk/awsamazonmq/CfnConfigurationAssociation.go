...
func (j *jsiiProxy_CfnConfigurationAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConfigurationAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConfigurationAssociation(scope constructs.Construct, id *string, props *CfnConfigurationAssociationProps) CfnConfigurationAssociation {
	...
	if err := validateNewCfnConfigurationAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnConfigurationAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfigurationAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfigurationAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfigurationAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfigurationAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfigurationAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConfigurationAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConfigurationAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfigurationAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfigurationAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
