...
func (j *jsiiProxy_CfnBroker) CfnPropertyNames() *map[string]*string {
...
func CfnBroker_ArnForBroker(resource interfacesawsamazonmq.IBrokerRef) *string {
	_init_.Initialize()

	if err := validateCfnBroker_ArnForBrokerParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnBroker) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBroker) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBroker) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBroker) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBroker) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
