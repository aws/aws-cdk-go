...
func NewCfnConfiguration(scope constructs.Construct, id *string, props *CfnConfigurationProps) CfnConfiguration {
	...
	if err := validateNewCfnConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnConfiguration_ArnForConfiguration(resource interfacesawsamazonmq.IConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnConfiguration_ArnForConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnConfiguration_IsCfnConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConfiguration_IsCfnConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
