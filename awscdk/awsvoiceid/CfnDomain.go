...
//
//   cfnDomain := awscdk.Aws_voiceid.NewCfnDomain(this, jsii.String("MyCfnDomain"), &CfnDomainProps{
...
func (j *jsiiProxy_CfnDomain) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDomain) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnDomain) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDomain) ServerSideEncryptionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnDomain)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnDomain)SetName(val *string) {
...
func (j *jsiiProxy_CfnDomain)SetServerSideEncryptionConfiguration(val interface{}) {
...
func CfnDomain_ArnForDomain(resource interfacesawsvoiceid.IDomainRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDomain) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDomain) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDomain) RemoveResourceDependency(target awscdk.CfnResource) {
