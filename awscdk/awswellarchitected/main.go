...
func init() {
	...
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_wellarchitected.CfnWorkload",
		reflect.TypeOf((*CfnWorkload)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrImprovementStatus", GoGetter: "AttrImprovementStatus"},
			_jsii_.MemberProperty{JsiiProperty: "attrWorkloadArn", GoGetter: "AttrWorkloadArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrWorkloadId", GoGetter: "AttrWorkloadId"},
		...
		func() interface{} {
			j := jsiiProxy_CfnWorkload{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawswellarchitectedIWorkloadRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_wellarchitected.CfnWorkload.DiscoveryConfigProperty",
		reflect.TypeOf((*CfnWorkload_DiscoveryConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_wellarchitected.CfnWorkload.TagsItemsProperty",
		reflect.TypeOf((*CfnWorkload_TagsItemsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_wellarchitected.CfnWorkloadProps",
		reflect.TypeOf((*CfnWorkloadProps)(nil)).Elem(),
	)
}
