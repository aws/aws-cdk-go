...
//
//   cfnDomain := awscdk.Aws_cases.NewCfnDomain(this, jsii.String("MyCfnDomain"), &CfnDomainProps{
...
type CfnDomain interface {
	...
	DomainRef() *interfacesawscases.DomainReference
...
type jsiiProxy_CfnDomain struct {
	...
	internal.Type__interfacesawscasesIDomainRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnDomain) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnDomain) DomainRef() *interfacesawscases.DomainReference {
	var returns *interfacesawscases.DomainReference
	_jsii_.Get(
		j,
		"domainRef",
		&returns,
...
func CfnDomain_ArnForDomain(resource interfacesawscases.IDomainRef) *string {
	_init_.Initialize()
