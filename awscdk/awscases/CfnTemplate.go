...
//
//   cfnTemplate := awscdk.Aws_cases.NewCfnTemplate(this, jsii.String("MyCfnTemplate"), &CfnTemplateProps{
...
type CfnTemplate interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscases.ITemplateRef
	awscdk.ITaggableV2
	...
	SetLayoutConfiguration(val interface{})
	...
	RequiredFields() interface{}
	SetRequiredFields(val interface{})
	...
	TemplateRef() *interfacesawscases.TemplateReference
	// Deprecated.
...
type jsiiProxy_CfnTemplate struct {
	...
	internal.Type__interfacesawscasesITemplateRef
...
func (j *jsiiProxy_CfnTemplate) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTemplate) AttrTemplateId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTemplateId",
...
func (j *jsiiProxy_CfnTemplate) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnTemplate) DomainId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainId",
...
func (j *jsiiProxy_CfnTemplate) LayoutConfiguration() interface{} {
...
func (j *jsiiProxy_CfnTemplate) RequiredFields() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"requiredFields",
...
func (j *jsiiProxy_CfnTemplate) Rules() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rules",
...
func (j *jsiiProxy_CfnTemplate) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_CfnTemplate) TemplateRef() *interfacesawscases.TemplateReference {
	var returns *interfacesawscases.TemplateReference
	_jsii_.Get(
		j,
		"templateRef",
		&returns,
...
func (j *jsiiProxy_CfnTemplate)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnTemplate)SetDomainId(val *string) {
	_jsii_.Set(
		j,
		"domainId",
		val,
...
func (j *jsiiProxy_CfnTemplate)SetLayoutConfiguration(val interface{}) {
	if err := j.validateSetLayoutConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTemplate)SetRequiredFields(val interface{}) {
	if err := j.validateSetRequiredFieldsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnTemplate)SetRules(val interface{}) {
...
func (j *jsiiProxy_CfnTemplate)SetStatus(val *string) {
	_jsii_.Set(
		j,
		"status",
		val,
...
func CfnTemplate_ArnForTemplate(resource interfacesawscases.ITemplateRef) *string {
	_init_.Initialize()
