...
func (j *jsiiProxy_CfnApplicationInstance) CfnPropertyNames() *map[string]*string {
...
func CfnApplicationInstance_IsCfnApplicationInstance(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationInstance_IsCfnApplicationInstanceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationInstance_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApplicationInstance_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
