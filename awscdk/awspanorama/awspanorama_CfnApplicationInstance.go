...
func (j *jsiiProxy_CfnApplicationInstance) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (c *jsiiProxy_CfnApplicationInstance) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationInstance) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationInstance) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationInstance) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnApplicationInstance) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationInstance) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
