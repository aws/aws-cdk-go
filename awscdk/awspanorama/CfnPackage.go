...
func (j *jsiiProxy_CfnPackage) AttrStorageLocationBinaryPrefixLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStorageLocationBinaryPrefixLocation",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPackage) AttrStorageLocationBucket() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStorageLocationBucket",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPackage) AttrStorageLocationGeneratedPrefixLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStorageLocationGeneratedPrefixLocation",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPackage) AttrStorageLocationManifestPrefixLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStorageLocationManifestPrefixLocation",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnPackage) AttrStorageLocationRepoPrefixLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStorageLocationRepoPrefixLocation",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnPackage) StorageLocation() interface{} {
...
func (j *jsiiProxy_CfnPackage)SetStorageLocation(val interface{}) {
...
func CfnPackage_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPackage_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackage) ObtainResourceDependencies() *[]awscdk.CfnResource {
