...
func (j *jsiiProxy_CfnPackageVersion) CfnPropertyNames() *map[string]*string {
...
func CfnPackageVersion_IsCfnPackageVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPackageVersion_IsCfnPackageVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPackageVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPackageVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPackageVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackageVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPackageVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPackageVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPackageVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPackageVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPackageVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackageVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackageVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPackageVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
