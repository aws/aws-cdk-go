...
func (c *jsiiProxy_CfnRecommender) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecommender) RemoveResourceDependency(target awscdk.CfnResource) {
