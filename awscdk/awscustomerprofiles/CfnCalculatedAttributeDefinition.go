...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) AttributeDetails() interface{} {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CalculatedAttributeName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Conditions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"conditions",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) DomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"domainName",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) Statistic() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statistic",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCalculatedAttributeDefinition(scope constructs.Construct, id *string, props *CfnCalculatedAttributeDefinitionProps) CfnCalculatedAttributeDefinition {
	...
	if err := validateNewCfnCalculatedAttributeDefinitionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetAttributeDetails(val interface{}) {
	if err := j.validateSetAttributeDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetCalculatedAttributeName(val *string) {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetConditions(val interface{}) {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetDisplayName(val *string) {
	_jsii_.Set(
		j,
		"displayName",
		val,
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetDomainName(val *string) {
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinition)SetStatistic(val *string) {
...
func CfnCalculatedAttributeDefinition_IsCfnCalculatedAttributeDefinition(x interface{}) *bool {
	...
	if err := validateCfnCalculatedAttributeDefinition_IsCfnCalculatedAttributeDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_customerprofiles.CfnCalculatedAttributeDefinition",
		"isCfnCalculatedAttributeDefinition",
		[]interface{}{x},
		&returns,
	)
...
func CfnCalculatedAttributeDefinition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCalculatedAttributeDefinition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCalculatedAttributeDefinition_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCalculatedAttributeDefinition_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCalculatedAttributeDefinition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCalculatedAttributeDefinition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnCalculatedAttributeDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
