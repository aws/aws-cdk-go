...
func (j *jsiiProxy_CfnEventTrigger) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEventTrigger) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEventTrigger) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEventTrigger) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEventTrigger) RemoveResourceDependency(target awscdk.CfnResource) {
