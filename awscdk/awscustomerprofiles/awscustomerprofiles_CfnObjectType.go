...
func (j *jsiiProxy_CfnObjectType) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnObjectType(scope constructs.Construct, id *string, props *CfnObjectTypeProps) CfnObjectType {
	...
	if err := validateNewCfnObjectTypeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnObjectType)SetAllowProfileCreation(val interface{}) {
	if err := j.validateSetAllowProfileCreationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnObjectType_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnObjectType_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnObjectType_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnObjectType_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnObjectType_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnObjectType_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnObjectType) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObjectType) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnObjectType) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnObjectType) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnObjectType) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObjectType) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
