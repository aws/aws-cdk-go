...
func (j *jsiiProxy_CfnSegmentDefinition) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSegmentDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSegmentDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSegmentDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSegmentDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSegmentDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
