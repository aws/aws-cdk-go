...
func (j *jsiiProxy_CfnObjectType) CfnPropertyNames() *map[string]*string {
...
func CfnObjectType_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnObjectType_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnObjectType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnObjectType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnObjectType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnObjectType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObjectType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
