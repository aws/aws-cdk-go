...
func (j *jsiiProxy_CfnProfilePermission) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnProfilePermission) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnProfilePermission(scope constructs.Construct, id *string, props *CfnProfilePermissionProps) CfnProfilePermission {
	...
	if err := validateNewCfnProfilePermissionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnProfilePermission_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnProfilePermission_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProfilePermission_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnProfilePermission_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnProfilePermission_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnProfilePermission_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnProfilePermission) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilePermission) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnProfilePermission) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnProfilePermission) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnProfilePermission) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnProfilePermission) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnProfilePermission) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilePermission) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilePermission) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnProfilePermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
