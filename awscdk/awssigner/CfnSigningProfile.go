...
func (j *jsiiProxy_CfnSigningProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSigningProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnSigningProfile_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSigningProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSigningProfile_IsCfnSigningProfile(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSigningProfile_IsCfnSigningProfileParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSigningProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSigningProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSigningProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSigningProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSigningProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSigningProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSigningProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSigningProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSigningProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSigningProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
