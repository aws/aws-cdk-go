...
func (j *jsiiProxy_SigningProfile) Env() *interfaces.ResourceEnvironment {
...
func SigningProfile_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_signer.SigningProfile",
...
func (s *jsiiProxy_SigningProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SigningProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
