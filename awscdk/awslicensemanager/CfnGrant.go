...
func (j *jsiiProxy_CfnGrant) CfnPropertyNames() *map[string]*string {
...
func NewCfnGrant(scope constructs.Construct, id *string, props *CfnGrantProps) CfnGrant {
	...
	if err := validateNewCfnGrantParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGrant_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGrant_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGrant_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGrant_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGrant_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGrant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGrant) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGrant) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGrant) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGrant) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGrant) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGrant) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGrant) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGrant) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGrant) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
