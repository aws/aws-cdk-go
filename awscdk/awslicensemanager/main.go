...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnLicenseAssetRuleSet)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrLicenseAssetRulesetArn", GoGetter: "AttrLicenseAssetRulesetArn"},
			_jsii_.MemberProperty{JsiiProperty: "cdkTagManager", GoGetter: "CdkTagManager"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
			_jsii_.MemberMethod{JsiiMethod: "cfnPropertyName", GoMethod: "CfnPropertyName"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawslicensemanagerILicenseAssetRuleSetRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.AndRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_AndRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.InstanceRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_InstanceRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.LicenseAssetRuleProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_LicenseAssetRuleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.LicenseConfigurationRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_LicenseConfigurationRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.LicenseRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_LicenseRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.MatchingRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_MatchingRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.OrRuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_OrRuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSet.RuleStatementProperty",
		reflect.TypeOf((*CfnLicenseAssetRuleSet_RuleStatementProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_licensemanager.CfnLicenseAssetRuleSetProps",
		reflect.TypeOf((*CfnLicenseAssetRuleSetProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
