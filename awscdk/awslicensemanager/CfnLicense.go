...
func (j *jsiiProxy_CfnLicense) CfnPropertyNames() *map[string]*string {
...
func CfnLicense_IsCfnLicense(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLicense_IsCfnLicenseParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLicense_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLicense_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLicense) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLicense) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLicense) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLicense) RemoveResourceDependency(target awscdk.CfnResource) {
