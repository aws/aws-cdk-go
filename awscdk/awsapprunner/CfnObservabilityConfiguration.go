...
func (j *jsiiProxy_CfnObservabilityConfiguration) CfnPropertyNames() *map[string]*string {
...
func NewCfnObservabilityConfiguration(scope constructs.Construct, id *string, props *CfnObservabilityConfigurationProps) CfnObservabilityConfiguration {
	...
	if err := validateNewCfnObservabilityConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnObservabilityConfiguration)SetTraceConfiguration(val interface{}) {
	if err := j.validateSetTraceConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnObservabilityConfiguration_ArnForObservabilityConfiguration(resource interfacesawsapprunner.IObservabilityConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnObservabilityConfiguration_ArnForObservabilityConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_apprunner.CfnObservabilityConfiguration",
		"arnForObservabilityConfiguration",
		[]interface{}{resource},
		&returns,
	)
...
func CfnObservabilityConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnObservabilityConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnObservabilityConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnObservabilityConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnObservabilityConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnObservabilityConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnObservabilityConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnObservabilityConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnObservabilityConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
