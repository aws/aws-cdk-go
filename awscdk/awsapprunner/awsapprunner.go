...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnObservabilityConfiguration.TraceConfigurationProperty",
		reflect.TypeOf((*CfnObservabilityConfiguration_TraceConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnObservabilityConfigurationProps",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnService.IngressConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnService.ServiceObservabilityConfigurationProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnVpcIngressConnection.IngressVpcConfigurationProperty",
		reflect.TypeOf((*CfnVpcIngressConnection_IngressVpcConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.CfnVpcIngressConnectionProps",
	...
	_jsii_.RegisterInterface(
		"monocdk.aws_apprunner.IVpcConnector",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.VpcConnectorAttributes",
		reflect.TypeOf((*VpcConnectorAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_apprunner.VpcConnectorProps",
