...
func (j *jsiiProxy_CfnVpcConnector) CfnPropertyNames() *map[string]*string {
...
func NewCfnVpcConnector(scope constructs.Construct, id *string, props *CfnVpcConnectorProps) CfnVpcConnector {
	...
	if err := validateNewCfnVpcConnectorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVpcConnector_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVpcConnector_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcConnector_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcConnector_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcConnector_IsCfnVpcConnector(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcConnector_IsCfnVpcConnectorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcConnector_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVpcConnector_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcConnector) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnector) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcConnector) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcConnector) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcConnector) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVpcConnector) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVpcConnector) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnector) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnector) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
