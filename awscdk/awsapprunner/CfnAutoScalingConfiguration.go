...
//
//   cfnAutoScalingConfiguration := awscdk.Aws_apprunner.NewCfnAutoScalingConfiguration(this, jsii.String("MyCfnAutoScalingConfiguration"), &CfnAutoScalingConfigurationProps{
...
type CfnAutoScalingConfiguration interface {
	...
	AttrAutoScalingConfigurationRevision() *float64
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) AttrAutoScalingConfigurationRevision() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) AttrLatest() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) AutoScalingConfigurationName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) MaxConcurrency() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxConcurrency",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) MaxSize() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxSize",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) MinSize() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minSize",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAutoScalingConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAutoScalingConfiguration(scope constructs.Construct, id *string, props *CfnAutoScalingConfigurationProps) CfnAutoScalingConfiguration {
	...
	if err := validateNewCfnAutoScalingConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAutoScalingConfiguration)SetAutoScalingConfigurationName(val *string) {
	_jsii_.Set(
		j,
		"autoScalingConfigurationName",
		val,
...
func (j *jsiiProxy_CfnAutoScalingConfiguration)SetMaxConcurrency(val *float64) {
	_jsii_.Set(
		j,
		"maxConcurrency",
		val,
...
func (j *jsiiProxy_CfnAutoScalingConfiguration)SetMaxSize(val *float64) {
	_jsii_.Set(
		j,
		"maxSize",
		val,
...
func (j *jsiiProxy_CfnAutoScalingConfiguration)SetMinSize(val *float64) {
	_jsii_.Set(
		j,
		"minSize",
		val,
...
func CfnAutoScalingConfiguration_ArnForAutoScalingConfiguration(resource interfacesawsapprunner.IAutoScalingConfigurationRef) *string {
	_init_.Initialize()

	if err := validateCfnAutoScalingConfiguration_ArnForAutoScalingConfigurationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAutoScalingConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutoScalingConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutoScalingConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAutoScalingConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAutoScalingConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apprunner.CfnAutoScalingConfiguration",
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAutoScalingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
