...
func (j *jsiiProxy_CfnVpcIngressConnection) CfnPropertyNames() *map[string]*string {
...
func CfnVpcIngressConnection_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcIngressConnection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVpcIngressConnection_IsCfnVpcIngressConnection(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcIngressConnection_IsCfnVpcIngressConnectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcIngressConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcIngressConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcIngressConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcIngressConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcIngressConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
