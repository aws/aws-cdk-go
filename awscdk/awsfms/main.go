...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_fms.CfnPolicy.NetworkFirewallPolicyProperty",
		reflect.TypeOf((*CfnPolicy_NetworkFirewallPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_fms.CfnPolicy.PolicyOptionProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_fms.CfnPolicy.SecurityServicePolicyDataProperty",
		reflect.TypeOf((*CfnPolicy_SecurityServicePolicyDataProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_fms.CfnPolicy.ThirdPartyFirewallPolicyProperty",
	...
	_jsii_.RegisterClass(
		"monocdk.aws_fms.CfnResourceSet",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_fms.CfnResourceSetProps",
