...
func (j *jsiiProxy_CfnResourceSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourceSet) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnResourceSet) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnResourceSet) Node() constructs.Node {
...
func (j *jsiiProxy_CfnResourceSet) Resources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resources",
...
func (j *jsiiProxy_CfnResourceSet) ResourceTypeList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypeList",
...
func (j *jsiiProxy_CfnResourceSet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceSet(scope constructs.Construct, id *string, props *CfnResourceSetProps) CfnResourceSet {
	...
	if err := validateNewCfnResourceSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceSet)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnResourceSet)SetName(val *string) {
...
func (j *jsiiProxy_CfnResourceSet)SetResources(val *[]*string) {
	_jsii_.Set(
		j,
		"resources",
		val,
...
func (j *jsiiProxy_CfnResourceSet)SetResourceTypeList(val *[]*string) {
...
func CfnResourceSet_ArnForResourceSet(resource interfacesawsfms.IResourceSetRef) *string {
	_init_.Initialize()

	if err := validateCfnResourceSet_ArnForResourceSetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnResourceSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSet_IsCfnResourceSet(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceSet_IsCfnResourceSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
