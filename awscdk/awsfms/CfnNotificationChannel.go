...
type CfnNotificationChannel interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsfms.INotificationChannelRef
	...
	NotificationChannelRef() *interfacesawsfms.NotificationChannelReference
...
type jsiiProxy_CfnNotificationChannel struct {
	...
	internal.Type__interfacesawsfmsINotificationChannelRef
}
...
func (j *jsiiProxy_CfnNotificationChannel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNotificationChannel) NotificationChannelRef() *interfacesawsfms.NotificationChannelReference {
	var returns *interfacesawsfms.NotificationChannelReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnNotificationChannel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNotificationChannel(scope constructs.Construct, id *string, props *CfnNotificationChannelProps) CfnNotificationChannel {
	...
	if err := validateNewCfnNotificationChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnNotificationChannel)SetSnsRoleName(val *string) {
	if err := j.validateSetSnsRoleNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnNotificationChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNotificationChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotificationChannel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNotificationChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNotificationChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNotificationChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNotificationChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNotificationChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNotificationChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNotificationChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNotificationChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNotificationChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNotificationChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
