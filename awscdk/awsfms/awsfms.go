...
// The jsii proxy for CfnPolicy_IEMapProperty
type jsiiProxy_CfnPolicy_IEMapProperty struct {
	_ byte // padding
}

func (j *jsiiProxy_CfnPolicy_IEMapProperty) Account() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"account",
...
func (j *jsiiProxy_CfnPolicy_IEMapProperty) Orgunit() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"orgunit",
