...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awspricingplanmanager/internal"
...
//
//   cfnSubscription := awscdk.Aws_pricingplanmanager.NewCfnSubscription(this, jsii.String("MyCfnSubscription"), &CfnSubscriptionProps{
...
type CfnSubscription interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawspricingplanmanager.ISubscriptionRef
	...
	PlanFamily() *string
	SetPlanFamily(val *string)
	// The tier of the pricing plan.
	PlanTier() *string
	SetPlanTier(val *string)
	...
	SubscriptionRef() *interfacesawspricingplanmanager.SubscriptionReference
	// Deprecated.
...
type jsiiProxy_CfnSubscription struct {
	...
	internal.Type__interfacesawspricingplanmanagerISubscriptionRef
}
...
func (j *jsiiProxy_CfnSubscription) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnSubscription) AttrCurrentPlanTier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCurrentPlanTier",
...
func (j *jsiiProxy_CfnSubscription) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnSubscription) AttrStatusReason() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusReason",
...
func (j *jsiiProxy_CfnSubscription) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnSubscription) PlanFamily() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planFamily",
...
func (j *jsiiProxy_CfnSubscription) PlanTier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planTier",
...
func (j *jsiiProxy_CfnSubscription) ResourceArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceArns",
...
func (j *jsiiProxy_CfnSubscription) SubscriptionRef() *interfacesawspricingplanmanager.SubscriptionReference {
	var returns *interfacesawspricingplanmanager.SubscriptionReference
	_jsii_.Get(
		j,
		"subscriptionRef",
		&returns,
...
func (j *jsiiProxy_CfnSubscription) UsageLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usageLevel",
...
func (j *jsiiProxy_CfnSubscription)SetPlanFamily(val *string) {
	if err := j.validateSetPlanFamilyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSubscription)SetPlanTier(val *string) {
	if err := j.validateSetPlanTierParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSubscription)SetResourceArns(val *[]*string) {
...
func (j *jsiiProxy_CfnSubscription)SetUsageLevel(val *string) {
	_jsii_.Set(
		j,
		"usageLevel",
		val,
...
func CfnSubscription_ArnForSubscription(resource interfacesawspricingplanmanager.ISubscriptionRef) *string {
	_init_.Initialize()
