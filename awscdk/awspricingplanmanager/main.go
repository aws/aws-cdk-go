...
func init() {
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_pricingplanmanager.CfnSubscription",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrCurrentPlanTier", GoGetter: "AttrCurrentPlanTier"},
			...
			_jsii_.MemberProperty{JsiiProperty: "planFamily", GoGetter: "PlanFamily"},
			_jsii_.MemberProperty{JsiiProperty: "planTier", GoGetter: "PlanTier"},
			...
			_jsii_.MemberProperty{JsiiProperty: "usageLevel", GoGetter: "UsageLevel"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawspricingplanmanagerISubscriptionRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_pricingplanmanager.CfnSubscriptionProps",
