...
func (j *jsiiProxy_CfnVirtualMFADevice) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVirtualMFADevice) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVirtualMFADevice(scope constructs.Construct, id *string, props *CfnVirtualMFADeviceProps) CfnVirtualMFADevice {
	...
	if err := validateNewCfnVirtualMFADeviceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVirtualMFADevice_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVirtualMFADevice_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVirtualMFADevice_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnVirtualMFADevice_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVirtualMFADevice_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVirtualMFADevice_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualMFADevice) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualMFADevice) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVirtualMFADevice) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVirtualMFADevice) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnVirtualMFADevice) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualMFADevice) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
