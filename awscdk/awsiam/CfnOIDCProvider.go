...
func (j *jsiiProxy_CfnOIDCProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOIDCProvider) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOIDCProvider) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnOIDCProvider_ArnForOIDCProvider(resource interfacesawsiam.IOIDCProviderRef) *string {
	_init_.Initialize()

	if err := validateCfnOIDCProvider_ArnForOIDCProviderParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnOIDCProvider_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOIDCProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOIDCProvider) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOIDCProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOIDCProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOIDCProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOIDCProvider) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOIDCProvider) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOIDCProvider) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOIDCProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOIDCProvider) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOIDCProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
