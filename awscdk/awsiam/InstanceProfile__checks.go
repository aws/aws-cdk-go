...
func (i *jsiiProxy_InstanceProfile) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateInstanceProfile_FromInstanceProfileArnParameters(scope constructs.Construct, id *string, instanceProfileArn *string) error {
	...
	if instanceProfileArn == nil {
		return fmt.Errorf("parameter instanceProfileArn is required, but nil was provided")
	}
...
func validateInstanceProfile_FromInstanceProfileNameParameters(scope constructs.Construct, id *string, instanceProfileName *string) error {
	...
	if instanceProfileName == nil {
		return fmt.Errorf("parameter instanceProfileName is required, but nil was provided")
	}
