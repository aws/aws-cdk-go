...
func validateCfnUser_ArnForUserParameters(resource interfacesawsiam.IUserRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnUser) validateSetLoginProfileParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnUser_LoginProfileProperty:
		val := val.(*CfnUser_LoginProfileProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnUser_LoginProfileProperty:
		val_ := val.(CfnUser_LoginProfileProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnUser_LoginProfileProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnUser) validateSetPoliciesParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnUser_PolicyProperty:
				v := v.(*CfnUser_PolicyProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnUser_PolicyProperty:
				v_ := v.(CfnUser_PolicyProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnUser_PolicyProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
