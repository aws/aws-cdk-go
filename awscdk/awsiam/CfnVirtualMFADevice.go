...
func (j *jsiiProxy_CfnVirtualMFADevice) CfnPropertyNames() *map[string]*string {
...
func CfnVirtualMFADevice_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVirtualMFADevice_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVirtualMFADevice_IsCfnVirtualMFADevice(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVirtualMFADevice_IsCfnVirtualMFADeviceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVirtualMFADevice) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVirtualMFADevice) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVirtualMFADevice) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVirtualMFADevice) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVirtualMFADevice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
