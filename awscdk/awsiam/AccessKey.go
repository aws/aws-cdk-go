...
func AccessKey_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAccessKey_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AccessKey_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAccessKey_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AccessKey_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iam.AccessKey",
...
func (a *jsiiProxy_AccessKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AccessKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
