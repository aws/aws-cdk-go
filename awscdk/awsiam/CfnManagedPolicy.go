...
func (j *jsiiProxy_CfnManagedPolicy) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnManagedPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnManagedPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnManagedPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnManagedPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnManagedPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
