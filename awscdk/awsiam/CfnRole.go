...
func (j *jsiiProxy_CfnRole) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRole) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRole) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRole) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRole(scope constructs.Construct, id *string, props *CfnRoleProps) CfnRole {
	...
	if err := validateNewCfnRoleParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnRole{}
...
func (j *jsiiProxy_CfnRole)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnRole_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRole_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRole_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRole_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRole_IsCfnRole(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRole_IsCfnRoleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRole_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRole_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRole) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRole) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRole) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRole) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRole) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRole) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRole) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRole) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRole) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
