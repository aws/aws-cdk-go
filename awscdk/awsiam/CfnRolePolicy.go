...
func (j *jsiiProxy_CfnRolePolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRolePolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRolePolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRolePolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRolePolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRolePolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRolePolicy) PolicyDocument() interface{} {
...
func (j *jsiiProxy_CfnRolePolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_CfnRolePolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRolePolicy) RoleName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleName",
...
func (j *jsiiProxy_CfnRolePolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRolePolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRolePolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRolePolicy(scope constructs.Construct, id *string, props *CfnRolePolicyProps) CfnRolePolicy {
	...
	if err := validateNewCfnRolePolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRolePolicy)SetPolicyName(val *string) {
...
func (j *jsiiProxy_CfnRolePolicy)SetRoleName(val *string) {
...
func CfnRolePolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRolePolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRolePolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRolePolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRolePolicy_IsCfnRolePolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRolePolicy_IsCfnRolePolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRolePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRolePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRolePolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRolePolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRolePolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRolePolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRolePolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRolePolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRolePolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRolePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRolePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRolePolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRolePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRolePolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRolePolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRolePolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRolePolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRolePolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRolePolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRolePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRolePolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRolePolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRolePolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRolePolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRolePolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRolePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
