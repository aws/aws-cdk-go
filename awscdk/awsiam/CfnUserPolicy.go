...
func (j *jsiiProxy_CfnUserPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnUserPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnUserPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnUserPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnUserPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnUserPolicy) PolicyDocument() interface{} {
...
func (j *jsiiProxy_CfnUserPolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_CfnUserPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnUserPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnUserPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnUserPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnUserPolicy) UserName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userName",
...
func NewCfnUserPolicy(scope constructs.Construct, id *string, props *CfnUserPolicyProps) CfnUserPolicy {
	...
	if err := validateNewCfnUserPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnUserPolicy)SetPolicyDocument(val interface{}) {
...
func (j *jsiiProxy_CfnUserPolicy)SetPolicyName(val *string) {
...
func (j *jsiiProxy_CfnUserPolicy)SetUserName(val *string) {
...
func CfnUserPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnUserPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnUserPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnUserPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnUserPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnUserPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnUserPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnUserPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnUserPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnUserPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnUserPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnUserPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnUserPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnUserPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
