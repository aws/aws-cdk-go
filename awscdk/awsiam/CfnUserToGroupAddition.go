...
func (j *jsiiProxy_CfnUserToGroupAddition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserToGroupAddition) Node() constructs.Node {
...
func (j *jsiiProxy_CfnUserToGroupAddition) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserToGroupAddition(scope constructs.Construct, id *string, props *CfnUserToGroupAdditionProps) CfnUserToGroupAddition {
	...
	if err := validateNewCfnUserToGroupAdditionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserToGroupAddition_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserToGroupAddition_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserToGroupAddition_IsCfnUserToGroupAddition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserToGroupAddition_IsCfnUserToGroupAdditionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserToGroupAddition_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserToGroupAddition_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserToGroupAddition) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserToGroupAddition) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserToGroupAddition) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserToGroupAddition) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserToGroupAddition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
