...
func SamlProvider_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iam.SamlProvider",
...
func (s *jsiiProxy_SamlProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_SamlProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
