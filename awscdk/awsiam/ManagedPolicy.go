...
func ManagedPolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_iam.ManagedPolicy",
...
func (m *jsiiProxy_ManagedPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_ManagedPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
