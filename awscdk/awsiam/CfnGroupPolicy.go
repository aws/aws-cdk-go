...
func (j *jsiiProxy_CfnGroupPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGroupPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGroupPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGroupPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGroupPolicy) GroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupName",
...
func (j *jsiiProxy_CfnGroupPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnGroupPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGroupPolicy) PolicyDocument() interface{} {
...
func (j *jsiiProxy_CfnGroupPolicy) PolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyName",
...
func (j *jsiiProxy_CfnGroupPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnGroupPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGroupPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnGroupPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGroupPolicy(scope constructs.Construct, id *string, props *CfnGroupPolicyProps) CfnGroupPolicy {
	...
	if err := validateNewCfnGroupPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGroupPolicy)SetGroupName(val *string) {
...
func (j *jsiiProxy_CfnGroupPolicy)SetPolicyDocument(val interface{}) {
...
func (j *jsiiProxy_CfnGroupPolicy)SetPolicyName(val *string) {
...
func CfnGroupPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGroupPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupPolicy_IsCfnGroupPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGroupPolicy_IsCfnGroupPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGroupPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGroupPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGroupPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroupPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroupPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGroupPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroupPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGroupPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnGroupPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGroupPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGroupPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnGroupPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGroupPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnGroupPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnGroupPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnGroupPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
