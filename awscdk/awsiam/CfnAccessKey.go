...
func (j *jsiiProxy_CfnAccessKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAccessKey) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAccessKey) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAccessKey(scope constructs.Construct, id *string, props *CfnAccessKeyProps) CfnAccessKey {
	...
	if err := validateNewCfnAccessKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAccessKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccessKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
