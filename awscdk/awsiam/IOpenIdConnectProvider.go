...
func (j *jsiiProxy_IOpenIdConnectProvider) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_IOpenIdConnectProvider) OidcProviderRef() *interfacesawsiam.OIDCProviderReference {
