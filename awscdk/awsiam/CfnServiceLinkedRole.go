...
func (j *jsiiProxy_CfnServiceLinkedRole) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServiceLinkedRole) Node() constructs.Node {
...
func (j *jsiiProxy_CfnServiceLinkedRole) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnServiceLinkedRole(scope constructs.Construct, id *string, props *CfnServiceLinkedRoleProps) CfnServiceLinkedRole {
	...
	if err := validateNewCfnServiceLinkedRoleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnServiceLinkedRole_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnServiceLinkedRole_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceLinkedRole_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnServiceLinkedRole_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceLinkedRole_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnServiceLinkedRole_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServiceLinkedRole) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceLinkedRole) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServiceLinkedRole) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServiceLinkedRole) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceLinkedRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
