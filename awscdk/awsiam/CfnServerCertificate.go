...
func (j *jsiiProxy_CfnServerCertificate) CfnPropertyNames() *map[string]*string {
...
func CfnServerCertificate_ArnForServerCertificate(resource interfacesawsiam.IServerCertificateRef) *string {
	_init_.Initialize()

	if err := validateCfnServerCertificate_ArnForServerCertificateParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnServerCertificate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnServerCertificate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServerCertificate_IsCfnServerCertificate(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnServerCertificate_IsCfnServerCertificateParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServerCertificate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerCertificate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServerCertificate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServerCertificate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServerCertificate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServerCertificate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServerCertificate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerCertificate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerCertificate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
