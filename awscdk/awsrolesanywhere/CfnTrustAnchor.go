...
func (j *jsiiProxy_CfnTrustAnchor) AttrTrustAnchorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTrustAnchorId",
...
func (j *jsiiProxy_CfnTrustAnchor) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTrustAnchor) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTrustAnchor) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrustAnchor) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTrustAnchor) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTrustAnchor) Enabled() interface{} {
...
func (j *jsiiProxy_CfnTrustAnchor) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTrustAnchor) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnTrustAnchor) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTrustAnchor) Source() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_CfnTrustAnchor) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTrustAnchor) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnTrustAnchor) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTrustAnchor(scope constructs.Construct, id *string, props *CfnTrustAnchorProps) CfnTrustAnchor {
	...
	if err := validateNewCfnTrustAnchorParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTrustAnchor)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnTrustAnchor)SetSource(val interface{}) {
...
func CfnTrustAnchor_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrustAnchor_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrustAnchor_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrustAnchor_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrustAnchor) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTrustAnchor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrustAnchor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrustAnchor) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTrustAnchor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrustAnchor) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrustAnchor) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTrustAnchor) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTrustAnchor) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrustAnchor) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTrustAnchor) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustAnchor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustAnchor) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTrustAnchor) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrustAnchor) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTrustAnchor) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTrustAnchor) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTrustAnchor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
