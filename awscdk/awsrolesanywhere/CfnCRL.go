...
func (j *jsiiProxy_CfnCRL) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnCRL) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnCRL) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCRL) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnCRL) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnCRL) CrlData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"crlData",
...
func (j *jsiiProxy_CfnCRL) Enabled() interface{} {
...
func (j *jsiiProxy_CfnCRL) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnCRL) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnCRL) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCRL) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnCRL) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnCRL) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnCRL) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnCRL) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCRL(scope constructs.Construct, id *string, props *CfnCRLProps) CfnCRL {
	...
	if err := validateNewCfnCRLParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnCRL{}
...
func (j *jsiiProxy_CfnCRL)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnCRL)SetTrustAnchorArn(val *string) {
	_jsii_.Set(
		j,
		"trustAnchorArn",
		val,
...
func CfnCRL_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCRL_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCRL_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCRL_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCRL_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCRL_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCRL) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnCRL) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCRL) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCRL) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnCRL) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnCRL) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnCRL) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnCRL) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCRL) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCRL) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnCRL) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCRL) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCRL) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnCRL) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnCRL) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCRL) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnCRL) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCRL) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCRL) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnCRL) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCRL) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnCRL) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnCRL) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnCRL) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
