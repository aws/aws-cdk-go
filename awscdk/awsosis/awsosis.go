...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_osis.CfnPipeline.CloudWatchLogDestinationProperty",
		reflect.TypeOf((*CfnPipeline_CloudWatchLogDestinationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_osis.CfnPipeline.LogPublishingOptionsProperty",
		reflect.TypeOf((*CfnPipeline_LogPublishingOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_osis.CfnPipeline.VpcEndpointProperty",
		reflect.TypeOf((*CfnPipeline_VpcEndpointProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_osis.CfnPipeline.VpcOptionsProperty",
		reflect.TypeOf((*CfnPipeline_VpcOptionsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_osis.CfnPipelineProps",
