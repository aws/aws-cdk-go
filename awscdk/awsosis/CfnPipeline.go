...
func (j *jsiiProxy_CfnPipeline) AttrVpcEndpoints() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnPipeline) LogPublishingOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPipeline) MaxUnits() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxUnits",
...
func (j *jsiiProxy_CfnPipeline) MinUnits() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minUnits",
...
func (j *jsiiProxy_CfnPipeline) PipelineConfigurationBody() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPipeline) VpcOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcOptions",
...
func (j *jsiiProxy_CfnPipeline)SetLogPublishingOptions(val interface{}) {
...
func (j *jsiiProxy_CfnPipeline)SetMaxUnits(val *float64) {
...
func (j *jsiiProxy_CfnPipeline)SetMinUnits(val *float64) {
...
func (j *jsiiProxy_CfnPipeline)SetPipelineConfigurationBody(val *string) {
...
func (j *jsiiProxy_CfnPipeline)SetVpcOptions(val interface{}) {
...
func CfnPipeline_ArnForPipeline(resource interfacesawsosis.IPipelineRef) *string {
	_init_.Initialize()
