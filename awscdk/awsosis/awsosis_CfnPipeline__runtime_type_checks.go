...
func (j *jsiiProxy_CfnPipeline) validateSetLogPublishingOptionsParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnPipeline_LogPublishingOptionsProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnPipeline) validateSetVpcOptionsParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnPipeline_VpcOptionsProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
