...
func init() {
	...
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_osis.CfnPipelineBlueprint",
		reflect.TypeOf((*CfnPipelineBlueprint)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrDisplayDescription", GoGetter: "AttrDisplayDescription"},
			_jsii_.MemberProperty{JsiiProperty: "attrDisplayName", GoGetter: "AttrDisplayName"},
			_jsii_.MemberProperty{JsiiProperty: "attrPipelineConfigurationBody", GoGetter: "AttrPipelineConfigurationBody"},
			_jsii_.MemberProperty{JsiiProperty: "attrService", GoGetter: "AttrService"},
			_jsii_.MemberProperty{JsiiProperty: "attrUseCase", GoGetter: "AttrUseCase"},
		...
		func() interface{} {
			j := jsiiProxy_CfnPipelineBlueprint{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsosisIPipelineBlueprintRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_osis.CfnPipelineBlueprintProps",
		reflect.TypeOf((*CfnPipelineBlueprintProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
