...
type CfnAccessPoint interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawss3objectlambda.IAccessPointRef
	// A reference to a AccessPoint resource.
	AccessPointRef() *interfacesawss3objectlambda.AccessPointReference
...
type jsiiProxy_CfnAccessPoint struct {
	...
	internal.Type__interfacesawss3objectlambdaIAccessPointRef
}

func (j *jsiiProxy_CfnAccessPoint) AccessPointRef() *interfacesawss3objectlambda.AccessPointReference {
	var returns *interfacesawss3objectlambda.AccessPointReference
	_jsii_.Get(
		j,
		"accessPointRef",
		&returns,
...
func (j *jsiiProxy_CfnAccessPoint) AttrPublicAccessBlockConfigurationBlockPublicAcls() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessPoint) AttrPublicAccessBlockConfigurationBlockPublicPolicy() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessPoint) AttrPublicAccessBlockConfigurationIgnorePublicAcls() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessPoint) AttrPublicAccessBlockConfigurationRestrictPublicBuckets() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAccessPoint)SetObjectLambdaConfiguration(val interface{}) {
	if err := j.validateSetObjectLambdaConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAccessPoint_ArnForAccessPoint(resource interfacesawss3objectlambda.IAccessPointRef) *string {
	_init_.Initialize()
