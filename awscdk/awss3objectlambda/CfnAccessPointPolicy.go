...
func (j *jsiiProxy_CfnAccessPointPolicy) CfnPropertyNames() *map[string]*string {
...
func NewCfnAccessPointPolicy(scope constructs.Construct, id *string, props *CfnAccessPointPolicyProps) CfnAccessPointPolicy {
	...
	if err := validateNewCfnAccessPointPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAccessPointPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAccessPointPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPointPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAccessPointPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAccessPointPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAccessPointPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAccessPointPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAccessPointPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAccessPointPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAccessPointPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAccessPointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
