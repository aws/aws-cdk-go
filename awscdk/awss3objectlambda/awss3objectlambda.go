...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3objectlambda.CfnAccessPoint.ContentTransformationProperty",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3objectlambda.CfnAccessPoint.PolicyStatusProperty",
		reflect.TypeOf((*CfnAccessPoint_PolicyStatusProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_s3objectlambda.CfnAccessPoint.PublicAccessBlockConfigurationProperty",
