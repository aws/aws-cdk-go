...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dlm.CfnLifecyclePolicy.ArchiveRetainRuleProperty",
		reflect.TypeOf((*CfnLifecyclePolicy_ArchiveRetainRuleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_dlm.CfnLifecyclePolicy.ArchiveRuleProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_dlm.CfnLifecyclePolicy.RetentionArchiveTierProperty",
