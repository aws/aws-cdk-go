...
func (c *jsiiProxy_CfnMacro) AddDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnMacro) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMacro) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnMacro) GetAtt(attributeName *string, typeHint ResolutionTypeHint) Reference {
...
func (c *jsiiProxy_CfnMacro) RemoveDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnMacro) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnMacro) ReplaceDependency(target CfnResource, newTarget CfnResource) {
