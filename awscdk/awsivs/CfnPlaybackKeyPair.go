...
func (j *jsiiProxy_CfnPlaybackKeyPair) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPlaybackKeyPair) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPlaybackKeyPair(scope constructs.Construct, id *string, props *CfnPlaybackKeyPairProps) CfnPlaybackKeyPair {
	...
	if err := validateNewCfnPlaybackKeyPairParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPlaybackKeyPair_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPlaybackKeyPair_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlaybackKeyPair_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPlaybackKeyPair_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlaybackKeyPair_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPlaybackKeyPair_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlaybackKeyPair) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPlaybackKeyPair) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaybackKeyPair) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
