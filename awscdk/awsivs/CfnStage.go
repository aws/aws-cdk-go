...
type CfnStage interface {
	...
	StageRef() *interfacesawsivs.StageReference
...
type jsiiProxy_CfnStage struct {
	...
	internal.Type__interfacesawsivsIStageRef
...
func (j *jsiiProxy_CfnStage) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnStage) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStage) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnStage) StageRef() *interfacesawsivs.StageReference {
	var returns *interfacesawsivs.StageReference
	_jsii_.Get(
		j,
		"stageRef",
		&returns,
...
func (j *jsiiProxy_CfnStage) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnStage)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnStage)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnStage_ArnForStage(resource interfacesawsivs.IStageRef) *string {
	_init_.Initialize()

	if err := validateCfnStage_ArnForStageParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnStage_IsCfnStage(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStage_IsCfnStageParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStage) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStage) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStage) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
