...
func (j *jsiiProxy_CfnStreamKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStreamKey) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStreamKey(scope constructs.Construct, id *string, props *CfnStreamKeyProps) CfnStreamKey {
	...
	if err := validateNewCfnStreamKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnStreamKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStreamKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamKey_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStreamKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnStreamKey.
func CfnStreamKey_IsCfnStreamKey(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStreamKey_IsCfnStreamKeyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStreamKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStreamKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStreamKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStreamKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStreamKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStreamKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
