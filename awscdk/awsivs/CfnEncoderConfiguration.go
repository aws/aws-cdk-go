...
func (j *jsiiProxy_CfnEncoderConfiguration) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnEncoderConfiguration) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEncoderConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnEncoderConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnEncoderConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEncoderConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnEncoderConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnEncoderConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnEncoderConfiguration) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnEncoderConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEncoderConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnEncoderConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnEncoderConfiguration) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnEncoderConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnEncoderConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnEncoderConfiguration) Video() interface{} {
...
func NewCfnEncoderConfiguration(scope constructs.Construct, id *string, props *CfnEncoderConfigurationProps) CfnEncoderConfiguration {
	...
	if err := validateNewCfnEncoderConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnEncoderConfiguration{}
...
func (j *jsiiProxy_CfnEncoderConfiguration)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnEncoderConfiguration)SetTags(val *[]*awscdk.CfnTag) {
...
func (j *jsiiProxy_CfnEncoderConfiguration)SetVideo(val interface{}) {
	if err := j.validateSetVideoParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEncoderConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEncoderConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEncoderConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEncoderConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEncoderConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnEncoderConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEncoderConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_ivs.CfnEncoderConfiguration",
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEncoderConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEncoderConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnEncoderConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEncoderConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnEncoderConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnEncoderConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnEncoderConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnEncoderConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
