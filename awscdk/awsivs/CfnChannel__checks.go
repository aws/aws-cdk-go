...
func (j *jsiiProxy_CfnChannel) validateSetAuthorizedParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnChannel) validateSetInsecureIngestParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
