...
func (j *jsiiProxy_CfnPublicKey) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnPublicKey) AttrFingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFingerprint",
...
func (j *jsiiProxy_CfnPublicKey) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnPublicKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPublicKey) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnPublicKey) PublicKeyMaterial() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicKeyMaterial",
...
func (j *jsiiProxy_CfnPublicKey) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPublicKey) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPublicKey(scope constructs.Construct, id *string, props *CfnPublicKeyProps) CfnPublicKey {
	...
	if err := validateNewCfnPublicKeyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPublicKey)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnPublicKey)SetPublicKeyMaterial(val *string) {
	_jsii_.Set(
		j,
		"publicKeyMaterial",
		val,
...
func (j *jsiiProxy_CfnPublicKey)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnPublicKey_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPublicKey_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPublicKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicKey_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPublicKey_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublicKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublicKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublicKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPublicKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPublicKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPublicKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
