...
func (j *jsiiProxy_CfnRecordingConfiguration) RecordingReconnectWindowSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRecordingConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRecordingConfiguration(scope constructs.Construct, id *string, props *CfnRecordingConfigurationProps) CfnRecordingConfiguration {
	...
	if err := validateNewCfnRecordingConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRecordingConfiguration)SetRecordingReconnectWindowSeconds(val *float64) {
	_jsii_.Set(
		j,
		"recordingReconnectWindowSeconds",
		val,
...
func (j *jsiiProxy_CfnRecordingConfiguration)SetThumbnailConfiguration(val interface{}) {
	if err := j.validateSetThumbnailConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnRecordingConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRecordingConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecordingConfiguration_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnRecordingConfiguration_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecordingConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRecordingConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecordingConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordingConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRecordingConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRecordingConfiguration) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnRecordingConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordingConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
