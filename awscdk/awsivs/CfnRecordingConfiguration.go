...
func (j *jsiiProxy_CfnRecordingConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnRecordingConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRecordingConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecordingConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecordingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRecordingConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRecordingConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecordingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
