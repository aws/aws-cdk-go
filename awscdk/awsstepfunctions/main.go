...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnMapRun)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrExecutionCounts", GoGetter: "AttrExecutionCounts"},
			_jsii_.MemberProperty{JsiiProperty: "attrItemCounts", GoGetter: "AttrItemCounts"},
			_jsii_.MemberProperty{JsiiProperty: "attrMapRunArn", GoGetter: "AttrMapRunArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrMaxConcurrency", GoGetter: "AttrMaxConcurrency"},
			_jsii_.MemberProperty{JsiiProperty: "attrStartDate", GoGetter: "AttrStartDate"},
			_jsii_.MemberProperty{JsiiProperty: "attrStatus", GoGetter: "AttrStatus"},
			_jsii_.MemberProperty{JsiiProperty: "attrStopDate", GoGetter: "AttrStopDate"},
			_jsii_.MemberProperty{JsiiProperty: "attrToleratedFailureCount", GoGetter: "AttrToleratedFailureCount"},
			_jsii_.MemberProperty{JsiiProperty: "attrToleratedFailurePercentage", GoGetter: "AttrToleratedFailurePercentage"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
			_jsii_.MemberMethod{JsiiMethod: "cfnPropertyName", GoMethod: "CfnPropertyName"},
			_jsii_.MemberProperty{JsiiProperty: "cfnPropertyNames", GoGetter: "CfnPropertyNames"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsstepfunctionsIMapRunRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_stepfunctions.CfnMapRun.MapRunExecutionCountsProperty",
		reflect.TypeOf((*CfnMapRun_MapRunExecutionCountsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_stepfunctions.CfnMapRun.MapRunItemCountsProperty",
		reflect.TypeOf((*CfnMapRun_MapRunItemCountsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_stepfunctions.CfnMapRunProps",
		reflect.TypeOf((*CfnMapRunProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "iteration", GoGetter: "Iteration"},
			_jsii_.MemberProperty{JsiiProperty: "jsonataItemSelector", GoGetter: "JsonataItemSelector"},
			_jsii_.MemberMethod{JsiiMethod: "makeDefault", GoMethod: "MakeDefault"},
			_jsii_.MemberMethod{JsiiMethod: "makeNext", GoMethod: "MakeNext"},
			_jsii_.MemberMethod{JsiiMethod: "next", GoMethod: "Next"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "providePolicyStatements", GoMethod: "ProvidePolicyStatements"},
			_jsii_.MemberMethod{JsiiMethod: "render", GoMethod: "Render"},
			_jsii_.MemberMethod{JsiiMethod: "validateResultWriter", GoMethod: "ValidateResultWriter"},
