...
func (p *jsiiProxy_Parallel) Next(state IChainable) Chain {
	if err := p.validateNextParameters(state); err != nil {
		panic(err)
	}
	var returns Chain
...
func (p *jsiiProxy_Parallel) ToStateJson(stateMachineQueryLanguage QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_Parallel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
