...
func (j *jsiiProxy_StateMachine) Env() *interfaces.ResourceEnvironment {
...
func (s *jsiiProxy_StateMachine) GrantRedriveExecution(identity awsiam.IGrantable) awsiam.Grant {
	if err := s.validateGrantRedriveExecutionParameters(identity); err != nil {
		panic(err)
	}
	var returns awsiam.Grant
