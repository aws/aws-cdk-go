...
func (p *jsiiProxy_Pass) Next(state IChainable) Chain {
...
func (p *jsiiProxy_Pass) ToStateJson(stateMachineQueryLanguage QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_Pass) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
