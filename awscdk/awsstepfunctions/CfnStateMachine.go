...
func CfnStateMachine_ArnForStateMachine(resource interfacesawsstepfunctions.IStateMachineRef) *string {
	_init_.Initialize()

	if err := validateCfnStateMachine_ArnForStateMachineParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
