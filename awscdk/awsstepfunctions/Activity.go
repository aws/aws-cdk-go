...
func (j *jsiiProxy_Activity) Env() *interfaces.ResourceEnvironment {
...
func Activity_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_stepfunctions.Activity",
...
func (a *jsiiProxy_Activity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_Activity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
