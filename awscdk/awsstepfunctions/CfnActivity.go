...
func (j *jsiiProxy_CfnActivity) CfnPropertyNames() *map[string]*string {
...
func CfnActivity_IsCfnActivity(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnActivity_IsCfnActivityParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnActivity_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnActivity_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnActivity) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnActivity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnActivity) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnActivity) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnActivity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
