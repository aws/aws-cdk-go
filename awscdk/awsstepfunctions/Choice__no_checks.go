...
func (c *jsiiProxy_Choice) validateAddItemProcessorParameters(processor StateGraph, config *ProcessorConfig) error {
	return nil
}
...
func (j *jsiiProxy_Choice) validateSetProcessorConfigParameters(val *ProcessorConfig) error {
	return nil
}
