...
func (c *jsiiProxy_Choice) ToStateJson(stateMachineQueryLanguage QueryLanguage) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_Choice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
