...
func (j *jsiiProxy_TaskStateBase) Arguments() *map[string]interface{} {
...
func (j *jsiiProxy_TaskStateBase) Assign() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"assign",
...
func (j *jsiiProxy_TaskStateBase) Outputs() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_TaskStateBase) QueryLanguage() QueryLanguage {
...
func (t *jsiiProxy_TaskStateBase) RenderAssign(topLevelQueryLanguage QueryLanguage) interface{} {
...
func (t *jsiiProxy_TaskStateBase) RenderChoices(topLevelQueryLanguage QueryLanguage) interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TaskStateBase) RenderQueryLanguage(topLevelQueryLanguage QueryLanguage) interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TaskStateBase) RenderRetryCatch(topLevelQueryLanguage QueryLanguage) interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TaskStateBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
