...
//
//   cfnStateMachineVersion := awscdk.Aws_stepfunctions.NewCfnStateMachineVersion(this, jsii.String("MyCfnStateMachineVersion"), &CfnStateMachineVersionProps{
...
func (j *jsiiProxy_CfnStateMachineVersion) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnStateMachineVersion) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnStateMachineVersion) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnStateMachineVersion) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnStateMachineVersion) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnStateMachineVersion) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnStateMachineVersion) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnStateMachineVersion) Node() constructs.Node {
...
func (j *jsiiProxy_CfnStateMachineVersion) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnStateMachineVersion) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnStateMachineVersion) StateMachineArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateMachineArn",
...
func (j *jsiiProxy_CfnStateMachineVersion) StateMachineRevisionId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnStateMachineVersion) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnStateMachineVersion) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStateMachineVersion(scope constructs.Construct, id *string, props *CfnStateMachineVersionProps) CfnStateMachineVersion {
	...
	if err := validateNewCfnStateMachineVersionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStateMachineVersion)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnStateMachineVersion)SetStateMachineArn(val *string) {
	if err := j.validateSetStateMachineArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnStateMachineVersion)SetStateMachineRevisionId(val *string) {
	_jsii_.Set(
		j,
		"stateMachineRevisionId",
		val,
...
func CfnStateMachineVersion_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStateMachineVersion_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateMachineVersion_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStateMachineVersion_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateMachineVersion_IsCfnStateMachineVersion(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStateMachineVersion_IsCfnStateMachineVersionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStateMachineVersion_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStateMachineVersion_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStateMachineVersion) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnStateMachineVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStateMachineVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStateMachineVersion) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnStateMachineVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStateMachineVersion) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStateMachineVersion) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnStateMachineVersion) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnStateMachineVersion) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStateMachineVersion) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnStateMachineVersion) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachineVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachineVersion) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnStateMachineVersion) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachineVersion) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnStateMachineVersion) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnStateMachineVersion) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnStateMachineVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
