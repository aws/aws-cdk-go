...
type CfnUserPool interface {
	...
	IssuerConfiguration() interface{}
	SetIssuerConfiguration(val interface{})
	KeyConfiguration() interface{}
	SetKeyConfiguration(val interface{})
...
func (j *jsiiProxy_CfnUserPool) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPool) IssuerConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"issuerConfiguration",
...
func (j *jsiiProxy_CfnUserPool) KeyConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"keyConfiguration",
...
func (j *jsiiProxy_CfnUserPool)SetIssuerConfiguration(val interface{}) {
	if err := j.validateSetIssuerConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnUserPool)SetKeyConfiguration(val interface{}) {
	if err := j.validateSetKeyConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnUserPool_IsCfnUserPool(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPool_IsCfnUserPoolParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
