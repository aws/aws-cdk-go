...
func (j *jsiiProxy_CfnUserPoolUICustomizationAttachment) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
