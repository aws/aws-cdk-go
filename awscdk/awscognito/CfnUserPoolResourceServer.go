...
func (j *jsiiProxy_CfnUserPoolResourceServer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPoolResourceServer) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserPoolResourceServer(scope constructs.Construct, id *string, props *CfnUserPoolResourceServerProps) CfnUserPoolResourceServer {
	...
	if err := validateNewCfnUserPoolResourceServerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserPoolResourceServer_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPoolResourceServer_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolResourceServer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolResourceServer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolResourceServer_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPoolResourceServer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolResourceServer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolResourceServer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolResourceServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
