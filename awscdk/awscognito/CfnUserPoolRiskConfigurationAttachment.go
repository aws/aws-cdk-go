...
func (j *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) CfnPropertyNames() *map[string]*string {
...
func CfnUserPoolRiskConfigurationAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolRiskConfigurationAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
