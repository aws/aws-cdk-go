...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getMetadata", GoMethod: "GetMetadata"},
			_jsii_.MemberMethod{JsiiMethod: "inspect", GoMethod: "Inspect"},
			_jsii_.MemberProperty{JsiiProperty: "issuerConfiguration", GoGetter: "IssuerConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "keyConfiguration", GoGetter: "KeyConfiguration"},
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPool.IssuerConfigurationProperty",
		reflect.TypeOf((*CfnUserPool_IssuerConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPool.KeyConfigurationProperty",
		reflect.TypeOf((*CfnUserPool_KeyConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscognitoIUserPoolRegionalConfigurationAttachmentRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachment.CustomEmailSenderProperty",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_CustomEmailSenderProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachment.CustomSMSSenderProperty",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_CustomSMSSenderProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_InboundFederationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachment.LambdaConfigProperty",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_LambdaConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachment.PreTokenGenerationConfigProperty",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_PreTokenGenerationConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachment.SmsConfigurationProperty",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachment_SmsConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolRegionalConfigurationAttachmentProps",
		reflect.TypeOf((*CfnUserPoolRegionalConfigurationAttachmentProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_cognito.CfnUserPoolReplica",
		reflect.TypeOf((*CfnUserPoolReplica)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userPoolTagsAtCreate", GoGetter: "UserPoolTagsAtCreate"},
			_jsii_.MemberMethod{JsiiMethod: "validateProperties", GoMethod: "ValidateProperties"},
			_jsii_.MemberMethod{JsiiMethod: "with", GoMethod: "With"},
		},
		func() interface{} {
			j := jsiiProxy_CfnUserPoolReplica{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscognitoIUserPoolReplicaRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cognito.CfnUserPoolReplicaProps",
		reflect.TypeOf((*CfnUserPoolReplicaProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
