...
func (j *jsiiProxy_CfnUserPoolIdentityProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPoolIdentityProvider) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserPoolIdentityProvider(scope constructs.Construct, id *string, props *CfnUserPoolIdentityProviderProps) CfnUserPoolIdentityProvider {
	...
	if err := validateNewCfnUserPoolIdentityProviderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserPoolIdentityProvider_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPoolIdentityProvider_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolIdentityProvider_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolIdentityProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolIdentityProvider_IsCfnUserPoolIdentityProvider(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolIdentityProvider_IsCfnUserPoolIdentityProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolIdentityProvider_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPoolIdentityProvider_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolIdentityProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
