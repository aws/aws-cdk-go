...
func (j *jsiiProxy_CfnUserPoolUser) CfnPropertyNames() *map[string]*string {
...
func CfnUserPoolUser_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUser_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolUser_IsCfnUserPoolUser(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolUser_IsCfnUserPoolUserParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolUser) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUser) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolUser) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolUser) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolUser) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolUser) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolUser) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUser) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUser) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
