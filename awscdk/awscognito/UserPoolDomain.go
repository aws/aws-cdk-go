...
func (j *jsiiProxy_UserPoolDomain) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolDomain) UserPoolDomainRef() *interfacesawscognito.UserPoolDomainReference {
...
func UserPoolDomain_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolDomain",
...
func (u *jsiiProxy_UserPoolDomain) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
