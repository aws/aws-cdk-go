...
func (j *jsiiProxy_CfnUserPoolUserToGroupAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPoolUserToGroupAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserPoolUserToGroupAttachment(scope constructs.Construct, id *string, props *CfnUserPoolUserToGroupAttachmentProps) CfnUserPoolUserToGroupAttachment {
	...
	if err := validateNewCfnUserPoolUserToGroupAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserPoolUserToGroupAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUserToGroupAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolUserToGroupAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUserToGroupAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolUserToGroupAttachment_IsCfnUserPoolUserToGroupAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolUserToGroupAttachment_IsCfnUserPoolUserToGroupAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_cognito.CfnUserPoolUserToGroupAttachment",
		"isCfnUserPoolUserToGroupAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnUserPoolUserToGroupAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUserToGroupAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
