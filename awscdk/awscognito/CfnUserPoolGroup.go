...
func (j *jsiiProxy_CfnUserPoolGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPoolGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnUserPoolGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolGroup_IsCfnUserPoolGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolGroup_IsCfnUserPoolGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
