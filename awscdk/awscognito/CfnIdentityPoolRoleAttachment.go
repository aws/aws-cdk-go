...
func (j *jsiiProxy_CfnIdentityPoolRoleAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdentityPoolRoleAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIdentityPoolRoleAttachment(scope constructs.Construct, id *string, props *CfnIdentityPoolRoleAttachmentProps) CfnIdentityPoolRoleAttachment {
	...
	if err := validateNewCfnIdentityPoolRoleAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIdentityPoolRoleAttachment)SetRoleMappings(val interface{}) {
	if err := j.validateSetRoleMappingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIdentityPoolRoleAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolRoleAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityPoolRoleAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolRoleAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityPoolRoleAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolRoleAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolRoleAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
