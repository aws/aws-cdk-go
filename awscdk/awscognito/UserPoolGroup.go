...
func (j *jsiiProxy_UserPoolGroup) Env() *interfaces.ResourceEnvironment {
...
func (u *jsiiProxy_UserPoolGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
