...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) UserPoolIdentityProviderRef() *interfacesawscognito.UserPoolIdentityProviderReference {
...
func UserPoolIdentityProviderSaml_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderSaml",
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
