...
func (j *jsiiProxy_CfnUserPoolClient) CfnPropertyNames() *map[string]*string {
...
func CfnUserPoolClient_IsCfnUserPoolClient(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolClient_IsCfnUserPoolClientParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolClient) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolClient) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolClient) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolClient) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolClient) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
