...
func (j *jsiiProxy_CfnUserPoolDomain) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUserPoolDomain) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserPoolDomain(scope constructs.Construct, id *string, props *CfnUserPoolDomainProps) CfnUserPoolDomain {
	...
	if err := validateNewCfnUserPoolDomainParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnUserPoolDomain)SetCustomDomainConfig(val interface{}) {
	if err := j.validateSetCustomDomainConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnUserPoolDomain_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPoolDomain_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolDomain_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnUserPoolDomain_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolDomain_IsCfnUserPoolDomain(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserPoolDomain_IsCfnUserPoolDomainParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolDomain_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPoolDomain_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolDomain) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolDomain) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserPoolDomain) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserPoolDomain) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserPoolDomain) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolDomain) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolDomain) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolDomain) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolDomain) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
