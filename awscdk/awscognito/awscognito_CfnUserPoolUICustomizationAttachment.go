...
func (j *jsiiProxy_CfnUserPoolUICustomizationAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserPoolUICustomizationAttachment(scope constructs.Construct, id *string, props *CfnUserPoolUICustomizationAttachmentProps) CfnUserPoolUICustomizationAttachment {
	...
	if err := validateNewCfnUserPoolUICustomizationAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserPoolUICustomizationAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUICustomizationAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserPoolUICustomizationAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserPoolUICustomizationAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
