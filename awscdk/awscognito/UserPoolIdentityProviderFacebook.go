...
func (j *jsiiProxy_UserPoolIdentityProviderFacebook) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderFacebook) UserPoolIdentityProviderRef() *interfacesawscognito.UserPoolIdentityProviderReference {
...
func NewUserPoolIdentityProviderFacebook(scope constructs.Construct, id *string, props *UserPoolIdentityProviderFacebookProps) UserPoolIdentityProviderFacebook {
	...
	if err := validateNewUserPoolIdentityProviderFacebookParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func UserPoolIdentityProviderFacebook_IsConstruct(x interface{}) *bool {
	...
	if err := validateUserPoolIdentityProviderFacebook_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderFacebook_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolIdentityProviderFacebook_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderFacebook_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolIdentityProviderFacebook_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderFacebook_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderFacebook",
...
func (u *jsiiProxy_UserPoolIdentityProviderFacebook) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolIdentityProviderFacebook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
