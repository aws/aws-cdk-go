...
// The jsii proxy struct for UserPoolIdentityProviderSaml
type jsiiProxy_UserPoolIdentityProviderSaml struct {
	internal.Type__awscdkResource
	jsiiProxy_IUserPoolIdentityProvider
}

func (j *jsiiProxy_UserPoolIdentityProviderSaml) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) Node() constructs.Node {
...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) ProviderName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerName",
...
func (j *jsiiProxy_UserPoolIdentityProviderSaml) Stack() awscdk.Stack {
...
func NewUserPoolIdentityProviderSaml(scope constructs.Construct, id *string, props *UserPoolIdentityProviderSamlProps) UserPoolIdentityProviderSaml {
	...
	if err := validateNewUserPoolIdentityProviderSamlParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func UserPoolIdentityProviderSaml_IsConstruct(x interface{}) *bool {
	...
	if err := validateUserPoolIdentityProviderSaml_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderSaml_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolIdentityProviderSaml_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderSaml_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolIdentityProviderSaml_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) ConfigureAttributeMapping() interface{} {
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) GeneratePhysicalName() *string {
	var returns *string
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) GetResourceNameAttribute(nameAttr *string) *string {
...
func (u *jsiiProxy_UserPoolIdentityProviderSaml) ToString() *string {
	var returns *string
