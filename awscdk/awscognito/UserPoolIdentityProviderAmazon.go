...
func (j *jsiiProxy_UserPoolIdentityProviderAmazon) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderAmazon) UserPoolIdentityProviderRef() *interfacesawscognito.UserPoolIdentityProviderReference {
...
func UserPoolIdentityProviderAmazon_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolIdentityProviderAmazon_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolIdentityProviderAmazon_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderAmazon",
...
func (u *jsiiProxy_UserPoolIdentityProviderAmazon) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
