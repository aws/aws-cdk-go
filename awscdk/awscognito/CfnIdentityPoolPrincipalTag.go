...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) IdentityPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"identityPoolId",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) IdentityProviderName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) PrincipalTags() interface{} {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag) UseDefaults() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"useDefaults",
...
func NewCfnIdentityPoolPrincipalTag(scope constructs.Construct, id *string, props *CfnIdentityPoolPrincipalTagProps) CfnIdentityPoolPrincipalTag {
	...
	if err := validateNewCfnIdentityPoolPrincipalTagParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag)SetIdentityPoolId(val *string) {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag)SetIdentityProviderName(val *string) {
...
func (j *jsiiProxy_CfnIdentityPoolPrincipalTag)SetUseDefaults(val interface{}) {
...
func CfnIdentityPoolPrincipalTag_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolPrincipalTag_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityPoolPrincipalTag_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolPrincipalTag_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIdentityPoolPrincipalTag_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIdentityPoolPrincipalTag_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnIdentityPoolPrincipalTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
