...
func (j *jsiiProxy_UserPoolResourceServer) Env() *interfaces.ResourceEnvironment {
...
func UserPoolResourceServer_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateUserPoolResourceServer_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func UserPoolResourceServer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolResourceServer",
...
func (u *jsiiProxy_UserPoolResourceServer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolResourceServer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
