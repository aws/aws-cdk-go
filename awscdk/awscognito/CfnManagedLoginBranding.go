...
func (j *jsiiProxy_CfnManagedLoginBranding) CfnPropertyNames() *map[string]*string {
...
func CfnManagedLoginBranding_IsCfnManagedLoginBranding(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnManagedLoginBranding_IsCfnManagedLoginBrandingParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnManagedLoginBranding) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnManagedLoginBranding) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnManagedLoginBranding) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnManagedLoginBranding) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnManagedLoginBranding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
