...
func (u *jsiiProxy_UserPoolDomain) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (u *jsiiProxy_UserPoolDomain) validateSignInUrlParameters(client UserPoolClient, options *SignInUrlOptions) error {
	if client == nil {
		return fmt.Errorf("parameter client is required, but nil was provided")
	}
...
func validateUserPoolDomain_FromDomainNameParameters(scope constructs.Construct, id *string, userPoolDomainName *string) error {
	...
	if userPoolDomainName == nil {
		return fmt.Errorf("parameter userPoolDomainName is required, but nil was provided")
	}
