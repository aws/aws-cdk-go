...
func (j *jsiiProxy_UserPoolIdentityProviderGoogle) Env() *interfaces.ResourceEnvironment {
...
func UserPoolIdentityProviderGoogle_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderGoogle",
...
func (u *jsiiProxy_UserPoolIdentityProviderGoogle) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolIdentityProviderGoogle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
