...
func (u *jsiiProxy_UserPoolClient) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (u *jsiiProxy_UserPoolClient) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateUserPoolClient_FromUserPoolClientIdParameters(scope constructs.Construct, id *string, userPoolClientId *string) error {
	...
	if userPoolClientId == nil {
		return fmt.Errorf("parameter userPoolClientId is required, but nil was provided")
	}
...
func validateUserPoolClient_IsResourceParameters(construct awscdk.IConstruct) error {
	if construct == nil {
