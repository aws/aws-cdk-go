...
func (j *jsiiProxy_UserPoolIdentityProviderApple) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderApple) UserPoolIdentityProviderRef() *interfacesawscognito.UserPoolIdentityProviderReference {
...
func UserPoolIdentityProviderApple_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderApple",
...
func (u *jsiiProxy_UserPoolIdentityProviderApple) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolIdentityProviderApple) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
