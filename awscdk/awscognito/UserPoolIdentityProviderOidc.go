...
func (j *jsiiProxy_UserPoolIdentityProviderOidc) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_UserPoolIdentityProviderOidc) UserPoolIdentityProviderRef() *interfacesawscognito.UserPoolIdentityProviderReference {
...
func UserPoolIdentityProviderOidc_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolIdentityProviderOidc",
...
func (u *jsiiProxy_UserPoolIdentityProviderOidc) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolIdentityProviderOidc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
