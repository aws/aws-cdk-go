...
func (j *jsiiProxy_UserPoolClient) Env() *interfaces.ResourceEnvironment {
...
func UserPoolClient_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cognito.UserPoolClient",
...
func (u *jsiiProxy_UserPoolClient) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UserPoolClient) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
