...
func (j *jsiiProxy_CfnComputeEnvironment) CfnPropertyNames() *map[string]*string {
...
func CfnComputeEnvironment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnComputeEnvironment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnComputeEnvironment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComputeEnvironment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComputeEnvironment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComputeEnvironment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
