...
func (j *jsiiProxy_CfnJobQueue) CfnPropertyNames() *map[string]*string {
...
func CfnJobQueue_ArnForJobQueue(resource interfacesawsbatch.IJobQueueRef) *string {
	_init_.Initialize()

	if err := validateCfnJobQueue_ArnForJobQueueParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnJobQueue) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnJobQueue) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnJobQueue) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnJobQueue) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnJobQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
