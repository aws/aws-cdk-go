...
func (j *jsiiProxy_EksJobDefinition) Env() *interfaces.ResourceEnvironment {
...
func EksJobDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_batch.EksJobDefinition",
...
func (e *jsiiProxy_EksJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
