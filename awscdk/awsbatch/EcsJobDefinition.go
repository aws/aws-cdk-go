...
func (j *jsiiProxy_EcsJobDefinition) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_EcsJobDefinition) SkipDeregisterOnUpdate() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func EcsJobDefinition_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_batch.EcsJobDefinition",
...
func (e *jsiiProxy_EcsJobDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EcsJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
