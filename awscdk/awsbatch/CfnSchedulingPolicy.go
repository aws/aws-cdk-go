...
func (j *jsiiProxy_CfnSchedulingPolicy) CfnPropertyNames() *map[string]*string {
...
func CfnSchedulingPolicy_ArnForSchedulingPolicy(resource interfacesawsbatch.ISchedulingPolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnSchedulingPolicy_ArnForSchedulingPolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnSchedulingPolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchedulingPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchedulingPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSchedulingPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSchedulingPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSchedulingPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchedulingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
