...
func (j *jsiiProxy_ManagedEc2EcsComputeEnvironment) ComputeEnvironmentRef() *interfacesawsbatch.ComputeEnvironmentReference {
...
func ManagedEc2EcsComputeEnvironment_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_batch.ManagedEc2EcsComputeEnvironment",
...
func (m *jsiiProxy_ManagedEc2EcsComputeEnvironment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_ManagedEc2EcsComputeEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
