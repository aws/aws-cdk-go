...
func (j *jsiiProxy_CfnJobDefinition) CfnPropertyNames() *map[string]*string {
...
func CfnJobDefinition_IsCfnJobDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnJobDefinition_IsCfnJobDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnJobDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnJobDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnJobDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnJobDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnJobDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
