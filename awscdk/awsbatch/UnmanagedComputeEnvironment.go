...
func (j *jsiiProxy_UnmanagedComputeEnvironment) Env() *interfaces.ResourceEnvironment {
...
func (u *jsiiProxy_UnmanagedComputeEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
