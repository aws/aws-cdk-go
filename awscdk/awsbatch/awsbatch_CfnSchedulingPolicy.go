...
func (j *jsiiProxy_CfnSchedulingPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSchedulingPolicy(scope constructs.Construct, id *string, props *CfnSchedulingPolicyProps) CfnSchedulingPolicy {
	...
	if err := validateNewCfnSchedulingPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSchedulingPolicy)SetFairsharePolicy(val interface{}) {
	if err := j.validateSetFairsharePolicyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSchedulingPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSchedulingPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchedulingPolicy_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnSchedulingPolicy_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSchedulingPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSchedulingPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchedulingPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchedulingPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSchedulingPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSchedulingPolicy) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSchedulingPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchedulingPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
