...
func (j *jsiiProxy_FairshareSchedulingPolicy) Env() *interfaces.ResourceEnvironment {
...
func (f *jsiiProxy_FairshareSchedulingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
