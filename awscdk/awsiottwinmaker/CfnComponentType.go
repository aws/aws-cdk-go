...
func (j *jsiiProxy_CfnComponentType) CfnPropertyNames() *map[string]*string {
...
func CfnComponentType_ArnForComponentType(resource interfacesawsiottwinmaker.IComponentTypeRef) *string {
	_init_.Initialize()

	if err := validateCfnComponentType_ArnForComponentTypeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnComponentType) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComponentType) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComponentType) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComponentType) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComponentType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
