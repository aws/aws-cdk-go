...
func (j *jsiiProxy_CfnScene) AttrGeneratedSceneMetadata() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnScene) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScene) SceneMetadata() interface{} {
...
func NewCfnScene(scope constructs.Construct, id *string, props *CfnSceneProps) CfnScene {
	...
	if err := validateNewCfnSceneParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnScene)SetSceneMetadata(val interface{}) {
...
func CfnScene_ArnForScene(resource interfacesawsiottwinmaker.ISceneRef) *string {
	_init_.Initialize()

	if err := validateCfnScene_ArnForSceneParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnScene_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnScene_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScene_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnScene_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScene) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScene) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScene) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScene) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScene) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScene) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScene) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScene) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScene) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScene) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
