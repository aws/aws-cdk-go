...
func (j *jsiiProxy_CfnSyncJob) AttrCreationDateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnSyncJob) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnSyncJob) AttrUpdateDateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdateDateTime",
...
func (j *jsiiProxy_CfnSyncJob) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSyncJob) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSyncJob) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSyncJob) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSyncJob) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSyncJob) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSyncJob) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSyncJob) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSyncJob) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSyncJob) SyncRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"syncRole",
...
func (j *jsiiProxy_CfnSyncJob) SyncSource() *string {
	var returns *string
	_jsii_.Get(
		j,
		"syncSource",
...
func (j *jsiiProxy_CfnSyncJob) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnSyncJob) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnSyncJob) WorkspaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"workspaceId",
...
func NewCfnSyncJob(scope constructs.Construct, id *string, props *CfnSyncJobProps) CfnSyncJob {
	...
	if err := validateNewCfnSyncJobParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSyncJob)SetSyncRole(val *string) {
...
func (j *jsiiProxy_CfnSyncJob)SetSyncSource(val *string) {
...
func (j *jsiiProxy_CfnSyncJob)SetWorkspaceId(val *string) {
...
func CfnSyncJob_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSyncJob_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncJob_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSyncJob_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSyncJob_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSyncJob_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSyncJob) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSyncJob) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncJob) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncJob) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncJob) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncJob) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSyncJob) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSyncJob) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSyncJob) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSyncJob) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSyncJob) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSyncJob) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSyncJob) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSyncJob) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSyncJob) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSyncJob) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSyncJob) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncJob) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncJob) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSyncJob) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSyncJob) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSyncJob) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSyncJob) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSyncJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
