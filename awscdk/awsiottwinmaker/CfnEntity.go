...
func (j *jsiiProxy_CfnEntity) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEntity) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEntity) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEntity) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEntity) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
