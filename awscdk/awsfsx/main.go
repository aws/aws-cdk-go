...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnFileSystem_DataReadCacheConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnS3AccessPointAttachment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnS3AccessPointAttachment_S3AccessPointOpenZFSConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_fsx.CfnS3AccessPointAttachment.S3AccessPointProperty",
		reflect.TypeOf((*CfnS3AccessPointAttachment_S3AccessPointProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_fsx.CfnS3AccessPointAttachment.S3AccessPointVpcConfigurationProperty",
		reflect.TypeOf((*CfnS3AccessPointAttachment_S3AccessPointVpcConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_fsx.CfnS3AccessPointAttachmentProps",
		reflect.TypeOf((*CfnS3AccessPointAttachmentProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
