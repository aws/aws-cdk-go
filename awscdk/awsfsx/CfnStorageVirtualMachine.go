...
func (j *jsiiProxy_CfnStorageVirtualMachine) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStorageVirtualMachine) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStorageVirtualMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
