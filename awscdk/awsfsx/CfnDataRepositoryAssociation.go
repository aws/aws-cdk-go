...
func (j *jsiiProxy_CfnDataRepositoryAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnDataRepositoryAssociation_IsCfnDataRepositoryAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDataRepositoryAssociation_IsCfnDataRepositoryAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_fsx.CfnDataRepositoryAssociation",
		"isCfnDataRepositoryAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnDataRepositoryAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDataRepositoryAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDataRepositoryAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataRepositoryAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataRepositoryAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataRepositoryAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataRepositoryAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
