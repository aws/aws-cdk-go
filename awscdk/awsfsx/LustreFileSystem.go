...
func (j *jsiiProxy_LustreFileSystem) Env() *interfaces.ResourceEnvironment {
...
func LustreFileSystem_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_fsx.LustreFileSystem",
...
func (l *jsiiProxy_LustreFileSystem) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (l *jsiiProxy_LustreFileSystem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
