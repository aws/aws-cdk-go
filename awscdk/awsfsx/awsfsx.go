...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_fsx.CfnDataRepositoryAssociation.AutoExportPolicyProperty",
		reflect.TypeOf((*CfnDataRepositoryAssociation_AutoExportPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_fsx.CfnDataRepositoryAssociation.AutoImportPolicyProperty",
		reflect.TypeOf((*CfnDataRepositoryAssociation_AutoImportPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_fsx.CfnDataRepositoryAssociation.S3Property",
		reflect.TypeOf((*CfnDataRepositoryAssociation_S3Property)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_fsx.CfnDataRepositoryAssociationProps",
