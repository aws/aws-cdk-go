...
func (j *jsiiProxy_FileSystemBase) Env() *interfaces.ResourceEnvironment {
...
func FileSystemBase_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateFileSystemBase_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FileSystemBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FileSystemBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
