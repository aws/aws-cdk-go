...
func (j *jsiiProxy_CfnS3AccessPointAttachment) AttrS3AccessPointAlias() *string {
	...
	_jsii_.Get(
		j,
		"attrS3AccessPointAlias",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnS3AccessPointAttachment) AttrS3AccessPointResourceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrS3AccessPointResourceArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnS3AccessPointAttachment) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) S3AccessPoint() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3AccessPoint",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnS3AccessPointAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnS3AccessPointAttachment(scope constructs.Construct, id *string, props *CfnS3AccessPointAttachmentProps) CfnS3AccessPointAttachment {
	...
	if err := validateNewCfnS3AccessPointAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnS3AccessPointAttachment)SetName(val *string) {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment)SetOpenZfsConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnS3AccessPointAttachment)SetS3AccessPoint(val interface{}) {
	if err := j.validateSetS3AccessPointParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnS3AccessPointAttachment)SetType(val *string) {
...
func CfnS3AccessPointAttachment_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnS3AccessPointAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnS3AccessPointAttachment_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnS3AccessPointAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnS3AccessPointAttachment_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnS3AccessPointAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnS3AccessPointAttachment_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_fsx.CfnS3AccessPointAttachment",
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnS3AccessPointAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
