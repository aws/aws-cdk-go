...
func (j *jsiiProxy_CfnSnapshot) CfnPropertyNames() *map[string]*string {
...
func NewCfnSnapshot(scope constructs.Construct, id *string, props *CfnSnapshotProps) CfnSnapshot {
	...
	if err := validateNewCfnSnapshotParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSnapshot_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSnapshot_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSnapshot_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSnapshot_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSnapshot_IsCfnSnapshot(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSnapshot_IsCfnSnapshotParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSnapshot_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSnapshot_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSnapshot) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshot) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSnapshot) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSnapshot) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSnapshot) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSnapshot) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSnapshot) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshot) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshot) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
