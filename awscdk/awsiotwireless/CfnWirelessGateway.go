...
func (j *jsiiProxy_CfnWirelessGateway) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnWirelessGateway) ThingName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingName",
...
func (j *jsiiProxy_CfnWirelessGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnWirelessGateway(scope constructs.Construct, id *string, props *CfnWirelessGatewayProps) CfnWirelessGateway {
	...
	if err := validateNewCfnWirelessGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnWirelessGateway)SetThingName(val *string) {
	_jsii_.Set(
		j,
		"thingName",
		val,
...
func CfnWirelessGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnWirelessGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWirelessGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWirelessGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnWirelessGateway.
func CfnWirelessGateway_IsCfnWirelessGateway(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWirelessGateway_IsCfnWirelessGatewayParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWirelessGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnWirelessGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWirelessGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWirelessGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWirelessGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWirelessGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWirelessGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWirelessGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
