...
func (j *jsiiProxy_CfnWirelessDeviceImportTask) CfnPropertyNames() *map[string]*string {
...
func CfnWirelessDeviceImportTask_ArnForWirelessDeviceImportTask(resource interfacesawsiotwireless.IWirelessDeviceImportTaskRef) *string {
	_init_.Initialize()

	if err := validateCfnWirelessDeviceImportTask_ArnForWirelessDeviceImportTaskParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnWirelessDeviceImportTask_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWirelessDeviceImportTask_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWirelessDeviceImportTask_IsCfnWirelessDeviceImportTask(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWirelessDeviceImportTask_IsCfnWirelessDeviceImportTaskParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWirelessDeviceImportTask) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWirelessDeviceImportTask) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWirelessDeviceImportTask) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWirelessDeviceImportTask) RemoveResourceDependency(target awscdk.CfnResource) {
