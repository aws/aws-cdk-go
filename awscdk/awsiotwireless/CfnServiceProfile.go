...
func (j *jsiiProxy_CfnServiceProfile) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServiceProfile) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnServiceProfile)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnServiceProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnServiceProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServiceProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServiceProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServiceProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
