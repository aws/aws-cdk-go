...
func (j *jsiiProxy_CfnDeviceProfile) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDeviceProfile(scope constructs.Construct, id *string, props *CfnDeviceProfileProps) CfnDeviceProfile {
	...
	if err := validateNewCfnDeviceProfileParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDeviceProfile_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDeviceProfile_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceProfile_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnDeviceProfile_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceProfile_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDeviceProfile_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeviceProfile) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceProfile) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDeviceProfile) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDeviceProfile) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnDeviceProfile) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceProfile) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
