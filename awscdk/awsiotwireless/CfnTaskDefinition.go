...
func (j *jsiiProxy_CfnTaskDefinition) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTaskDefinition)SetLoRaWanUpdateGatewayTaskEntry(val interface{}) {
	if err := j.validateSetLoRaWanUpdateGatewayTaskEntryParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnTaskDefinition_ArnForTaskDefinition(resource interfacesawsiotwireless.ITaskDefinitionRef) *string {
	_init_.Initialize()
...
func CfnTaskDefinition_IsCfnTaskDefinition(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTaskDefinition_IsCfnTaskDefinitionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTaskDefinition) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTaskDefinition) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTaskDefinition) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTaskDefinition) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTaskDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
