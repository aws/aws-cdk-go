...
func (j *jsiiProxy_CfnWirelessDevice) CfnPropertyNames() *map[string]*string {
...
func CfnWirelessDevice_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnWirelessDevice_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnWirelessDevice_IsCfnWirelessDevice(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnWirelessDevice_IsCfnWirelessDeviceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnWirelessDevice) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessDevice) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnWirelessDevice) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnWirelessDevice) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnWirelessDevice) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnWirelessDevice) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnWirelessDevice) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessDevice) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessDevice) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnWirelessDevice) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
