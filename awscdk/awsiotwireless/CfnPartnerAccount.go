...
func (j *jsiiProxy_CfnPartnerAccount) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPartnerAccount) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
// Checks whether the given object is a CfnPartnerAccount.
func CfnPartnerAccount_IsCfnPartnerAccount(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPartnerAccount_IsCfnPartnerAccountParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPartnerAccount_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPartnerAccount_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPartnerAccount) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerAccount) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPartnerAccount) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPartnerAccount) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPartnerAccount) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPartnerAccount) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPartnerAccount) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerAccount) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerAccount) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPartnerAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
