...
func (j *jsiiProxy_CfnDeviceProfile) CfnPropertyNames() *map[string]*string {
...
func CfnDeviceProfile_IsCfnDeviceProfile(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDeviceProfile_IsCfnDeviceProfileParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDeviceProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDeviceProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDeviceProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDeviceProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDeviceProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDeviceProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDeviceProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
