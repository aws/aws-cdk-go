...
func (j *jsiiProxy_CfnMulticastGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnMulticastGroup) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnMulticastGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnMulticastGroup)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnMulticastGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMulticastGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMulticastGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMulticastGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMulticastGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMulticastGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMulticastGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMulticastGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMulticastGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMulticastGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMulticastGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMulticastGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
