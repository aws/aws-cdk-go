...
func (j *jsiiProxy_CfnFuotaTask) CfnPropertyNames() *map[string]*string {
...
func NewCfnFuotaTask(scope constructs.Construct, id *string, props *CfnFuotaTaskProps) CfnFuotaTask {
	...
	if err := validateNewCfnFuotaTaskParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnFuotaTask_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFuotaTask_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFuotaTask_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFuotaTask_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFuotaTask_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFuotaTask_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFuotaTask) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFuotaTask) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFuotaTask) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFuotaTask) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFuotaTask) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFuotaTask) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFuotaTask) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFuotaTask) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFuotaTask) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFuotaTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
