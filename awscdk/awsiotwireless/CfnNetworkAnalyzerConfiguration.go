...
func (j *jsiiProxy_CfnNetworkAnalyzerConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkAnalyzerConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNetworkAnalyzerConfiguration(scope constructs.Construct, id *string, props *CfnNetworkAnalyzerConfigurationProps) CfnNetworkAnalyzerConfiguration {
	...
	if err := validateNewCfnNetworkAnalyzerConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNetworkAnalyzerConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNetworkAnalyzerConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAnalyzerConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkAnalyzerConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAnalyzerConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNetworkAnalyzerConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
