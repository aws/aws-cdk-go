...
func (j *jsiiProxy_CfnSimpleTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSimpleTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnSimpleTable_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSimpleTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimpleTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSimpleTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSimpleTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSimpleTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSimpleTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSimpleTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
