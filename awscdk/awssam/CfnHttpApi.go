...
func (j *jsiiProxy_CfnHttpApi) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnHttpApi) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnHttpApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnHttpApi) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnHttpApi) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHttpApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
