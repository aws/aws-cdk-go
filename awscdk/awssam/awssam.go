...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_sam.CfnFunction.CognitoEventProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_sam.CfnFunction.HttpApiEventProperty",
		reflect.TypeOf((*CfnFunction_HttpApiEventProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_sam.CfnFunction.HttpApiFunctionAuthProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_sam.CfnFunction.RouteSettingsProperty",
