...
func (j *jsiiProxy_CfnStateMachine) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnStateMachine) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStateMachine) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStateMachine) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStateMachine) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStateMachine) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
