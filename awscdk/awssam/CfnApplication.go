...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawssam.IApplicationRef
	awscdk.ITaggable
	// A reference to a Application resource.
	ApplicationRef() *interfacesawssam.ApplicationReference
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawssamIApplicationRef
	internal.Type__awscdkITaggable
}

func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawssam.ApplicationReference {
	var returns *interfacesawssam.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
