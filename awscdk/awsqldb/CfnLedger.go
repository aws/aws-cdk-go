...
func (j *jsiiProxy_CfnLedger) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLedger) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLedger) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLedger) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLedger) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLedger) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
