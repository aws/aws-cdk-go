...
//
//   cfnLedger := awscdk.Aws_qldb.NewCfnLedger(this, jsii.String("MyCfnLedger"), &cfnLedgerProps{
...
func (j *jsiiProxy_CfnLedger) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLedger(scope constructs.Construct, id *string, props *CfnLedgerProps) CfnLedger {
	...
	if err := validateNewCfnLedgerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLedger_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLedger_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLedger_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLedger_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLedger) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLedger) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLedger) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLedger) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLedger) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLedger) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
