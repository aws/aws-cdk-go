...
//
//   cfnStream := awscdk.Aws_qldb.NewCfnStream(this, jsii.String("MyCfnStream"), &CfnStreamProps{
...
func (j *jsiiProxy_CfnStream)SetKinesisConfiguration(val interface{}) {
	if err := j.validateSetKinesisConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStream_ArnForStream(resource interfacesawsqldb.IStreamRef) *string {
	_init_.Initialize()
