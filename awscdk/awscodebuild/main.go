...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrBuildComplete", GoGetter: "AttrBuildComplete"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrCurrentPhase", GoGetter: "AttrCurrentPhase"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrInitiator", GoGetter: "AttrInitiator"},
			_jsii_.MemberProperty{JsiiProperty: "attrQueuedTimeoutInMinutes", GoGetter: "AttrQueuedTimeoutInMinutes"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrTimeoutInMinutes", GoGetter: "AttrTimeoutInMinutes"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscodebuildIBuildRef)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_codebuild.CfnBuildBatch",
		reflect.TypeOf((*CfnBuildBatch)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrArn", GoGetter: "AttrArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrBuildBatchNumber", GoGetter: "AttrBuildBatchNumber"},
			_jsii_.MemberProperty{JsiiProperty: "attrBuildBatchStatus", GoGetter: "AttrBuildBatchStatus"},
			_jsii_.MemberProperty{JsiiProperty: "attrBuildTimeoutInMinutes", GoGetter: "AttrBuildTimeoutInMinutes"},
			_jsii_.MemberProperty{JsiiProperty: "attrComplete", GoGetter: "AttrComplete"},
			_jsii_.MemberProperty{JsiiProperty: "attrCurrentPhase", GoGetter: "AttrCurrentPhase"},
			_jsii_.MemberProperty{JsiiProperty: "attrEncryptionKey", GoGetter: "AttrEncryptionKey"},
			_jsii_.MemberProperty{JsiiProperty: "attrId", GoGetter: "AttrId"},
			_jsii_.MemberProperty{JsiiProperty: "attrInitiator", GoGetter: "AttrInitiator"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscodebuildIBuildBatchRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codebuild.CfnBuildBatchProps",
		reflect.TypeOf((*CfnBuildBatchProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codebuild.CfnBuildProps",
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnProject_DockerServerProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_codebuild.CfnProject.PullRequestBuildPolicyProperty",
		reflect.TypeOf((*CfnProject_PullRequestBuildPolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
