...
func NewCfnReportGroup(scope constructs.Construct, id *string, props *CfnReportGroupProps) CfnReportGroup {
	...
	if err := validateNewCfnReportGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnReportGroup)SetExportConfig(val interface{}) {
	if err := j.validateSetExportConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnReportGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReportGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReportGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnReportGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReportGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReportGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReportGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReportGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReportGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnReportGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
