...
func (j *jsiiProxy_CfnReportGroup) CfnPropertyNames() *map[string]*string {
...
func CfnReportGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReportGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReportGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReportGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReportGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReportGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReportGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
