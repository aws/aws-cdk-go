...
func (j *jsiiProxy_ReportGroup) Env() *interfaces.ResourceEnvironment {
...
func ReportGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.ReportGroup",
...
func (r *jsiiProxy_ReportGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ReportGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
