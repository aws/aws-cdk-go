...
func (f *jsiiProxy_Fleet) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateFleet_FromFleetArnParameters(scope constructs.Construct, id *string, fleetArn *string) error {
	...
	if fleetArn == nil {
		return fmt.Errorf("parameter fleetArn is required, but nil was provided")
	}
