...
func (j *jsiiProxy_GitHubSourceCredentials) Env() *interfaces.ResourceEnvironment {
...
func GitHubSourceCredentials_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.GitHubSourceCredentials",
...
func (g *jsiiProxy_GitHubSourceCredentials) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GitHubSourceCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
