...
func (j *jsiiProxy_CfnProject) ProjectRef() *interfacesawscodebuild.ProjectReference {
...
func CfnProject_ArnForProject(resource interfacesawscodebuild.IProjectRef) *string {
	_init_.Initialize()
