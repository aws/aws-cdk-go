...
func LinuxLambdaBuildImage_AMAZON_LINUX_2023_GO_1_24() IBuildImage {
	_init_.Initialize()
	var returns IBuildImage
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.LinuxLambdaBuildImage",
...
func LinuxLambdaBuildImage_AMAZON_LINUX_2023_NODE_22() IBuildImage {
	_init_.Initialize()
	var returns IBuildImage
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.LinuxLambdaBuildImage",
...
func LinuxLambdaBuildImage_AMAZON_LINUX_2023_NODE_24() IBuildImage {
	_init_.Initialize()
	var returns IBuildImage
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.LinuxLambdaBuildImage",
...
func LinuxLambdaBuildImage_AMAZON_LINUX_2023_PYTHON_3_13() IBuildImage {
	_init_.Initialize()
	var returns IBuildImage
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.LinuxLambdaBuildImage",
...
func LinuxLambdaBuildImage_AMAZON_LINUX_2023_RUBY_3_4() IBuildImage {
	_init_.Initialize()
	var returns IBuildImage
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.LinuxLambdaBuildImage",
