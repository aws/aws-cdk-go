...
func (j *jsiiProxy_GitHubEnterpriseSourceCredentials) Env() *interfaces.ResourceEnvironment {
...
func GitHubEnterpriseSourceCredentials_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.GitHubEnterpriseSourceCredentials",
...
func (g *jsiiProxy_GitHubEnterpriseSourceCredentials) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GitHubEnterpriseSourceCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
