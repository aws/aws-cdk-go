...
func (j *jsiiProxy_CfnFleet) BaseCapacity() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"baseCapacity",
...
func (j *jsiiProxy_CfnFleet) EnvironmentType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentType",
...
func (j *jsiiProxy_CfnFleet)SetBaseCapacity(val *float64) {
	_jsii_.Set(
		j,
		"baseCapacity",
		val,
...
func (j *jsiiProxy_CfnFleet)SetEnvironmentType(val *string) {
	_jsii_.Set(
		j,
		"environmentType",
		val,
...
func CfnFleet_ArnForFleet(resource interfacesawscodebuild.IFleetRef) *string {
	_init_.Initialize()
