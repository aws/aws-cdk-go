...
func (j *jsiiProxy_Project) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_Project) ProjectRef() *interfacesawscodebuild.ProjectReference {
...
func Project_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.Project",
...
func (p *jsiiProxy_Project) AddToRolePolicy(policyStatement awsiam.PolicyStatement) {
...
func (p *jsiiProxy_Project) BindAsNotificationRuleSource(scope constructs.Construct) *awscodestarnotifications.NotificationRuleSourceConfig {
...
func (p *jsiiProxy_Project) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
