...
func (j *jsiiProxy_PipelineProject) Env() *interfaces.ResourceEnvironment {
...
func PipelineProject_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.PipelineProject",
...
func (p *jsiiProxy_PipelineProject) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PipelineProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
