...
func (j *jsiiProxy_BitBucketSourceCredentials) Env() *interfaces.ResourceEnvironment {
...
func BitBucketSourceCredentials_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateBitBucketSourceCredentials_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func BitBucketSourceCredentials_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.BitBucketSourceCredentials",
...
func (b *jsiiProxy_BitBucketSourceCredentials) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_BitBucketSourceCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
