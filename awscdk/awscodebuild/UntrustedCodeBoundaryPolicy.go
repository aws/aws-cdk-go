...
func UntrustedCodeBoundaryPolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_codebuild.UntrustedCodeBoundaryPolicy",
...
func (u *jsiiProxy_UntrustedCodeBoundaryPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (u *jsiiProxy_UntrustedCodeBoundaryPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
