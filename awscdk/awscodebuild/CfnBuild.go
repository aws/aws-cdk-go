...
//
//   cfnBuild := awscdk.Aws_codebuild.NewCfnBuild(this, jsii.String("MyCfnBuild"), &CfnBuildProps{
...
type CfnBuild interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawscodebuild.IBuildRef
	AttrArn() *string
	AttrBuildComplete() awscdk.IResolvable
	AttrBuildNumber() *float64
	...
	BuildRef() *interfacesawscodebuild.BuildReference
...
type jsiiProxy_CfnBuild struct {
	...
	internal.Type__interfacesawscodebuildIBuildRef
}

func (j *jsiiProxy_CfnBuild) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnBuild) AttrBuildComplete() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnBuild) AttrBuildNumber() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"attrBuildNumber",
...
func (j *jsiiProxy_CfnBuild) AttrBuildStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrBuildStatus",
...
func (j *jsiiProxy_CfnBuild) AttrCurrentPhase() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCurrentPhase",
...
func (j *jsiiProxy_CfnBuild) AttrEncryptionKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEncryptionKey",
...
func (j *jsiiProxy_CfnBuild) AttrEndTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEndTime",
...
func (j *jsiiProxy_CfnBuild) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnBuild) AttrInitiator() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrInitiator",
...
func (j *jsiiProxy_CfnBuild) AttrQueuedTimeoutInMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBuild) AttrServiceRole() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrServiceRole",
...
func (j *jsiiProxy_CfnBuild) AttrStartTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStartTime",
...
func (j *jsiiProxy_CfnBuild) AttrTimeoutInMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnBuild) BuildRef() *interfacesawscodebuild.BuildReference {
	var returns *interfacesawscodebuild.BuildReference
	_jsii_.Get(
		j,
		"buildRef",
		&returns,
...
func (j *jsiiProxy_CfnBuild) ProjectName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectName",
...
func NewCfnBuild(scope constructs.Construct, id *string, props *CfnBuildProps) CfnBuild {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_codebuild.CfnBuild",
...
func (j *jsiiProxy_CfnBuild)SetProjectName(val *string) {
	_jsii_.Set(
		j,
		"projectName",
		val,
...
func CfnBuild_ArnForBuild(resource interfacesawscodebuild.IBuildRef) *string {
	_init_.Initialize()
...
func CfnBuild_FromBuildArn(scope constructs.Construct, id *string, arn *string) interfacesawscodebuild.IBuildRef {
	_init_.Initialize()

	if err := validateCfnBuild_FromBuildArnParameters(scope, id, arn); err != nil {
		panic(err)
	}
	var returns interfacesawscodebuild.IBuildRef
...
func CfnBuild_FromBuildId(scope constructs.Construct, id *string, buildId *string) interfacesawscodebuild.IBuildRef {
	_init_.Initialize()
