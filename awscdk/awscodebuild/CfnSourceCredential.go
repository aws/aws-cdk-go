...
func (j *jsiiProxy_CfnSourceCredential) CfnPropertyNames() *map[string]*string {
...
func NewCfnSourceCredential(scope constructs.Construct, id *string, props *CfnSourceCredentialProps) CfnSourceCredential {
	...
	if err := validateNewCfnSourceCredentialParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSourceCredential_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSourceCredential_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSourceCredential_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSourceCredential_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSourceCredential_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSourceCredential_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSourceCredential) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSourceCredential) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSourceCredential) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSourceCredential) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSourceCredential) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSourceCredential) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSourceCredential) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSourceCredential) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSourceCredential) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSourceCredential) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
