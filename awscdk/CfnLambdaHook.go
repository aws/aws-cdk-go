...
func (j *jsiiProxy_CfnLambdaHook) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLambdaHook) AddResourceDependency(target CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLambdaHook) ApplyCrossStackReferenceStrength(strength ReferenceStrength) {
...
func (c *jsiiProxy_CfnLambdaHook) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLambdaHook) RemoveResourceDependency(target CfnResource) {
...
func (c *jsiiProxy_CfnLambdaHook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
