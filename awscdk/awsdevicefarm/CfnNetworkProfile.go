...
func (j *jsiiProxy_CfnNetworkProfile) CfnPropertyNames() *map[string]*string {
...
func CfnNetworkProfile_ArnForNetworkProfile(resource interfacesawsdevicefarm.INetworkProfileRef) *string {
	_init_.Initialize()

	if err := validateCfnNetworkProfile_ArnForNetworkProfileParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnNetworkProfile_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkProfile_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkProfile) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkProfile) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkProfile) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
