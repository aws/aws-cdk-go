...
func (j *jsiiProxy_CfnInstanceProfile) ExcludeAppPackagesFromCleanup() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnInstanceProfile) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnInstanceProfile) PackageCleanup() interface{} {
...
func (j *jsiiProxy_CfnInstanceProfile) RebootAfterUse() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rebootAfterUse",
...
func (j *jsiiProxy_CfnInstanceProfile) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnInstanceProfile)SetExcludeAppPackagesFromCleanup(val *[]*string) {
	_jsii_.Set(
		j,
		"excludeAppPackagesFromCleanup",
		val,
...
func (j *jsiiProxy_CfnInstanceProfile)SetName(val *string) {
...
func (j *jsiiProxy_CfnInstanceProfile)SetPackageCleanup(val interface{}) {
...
func (j *jsiiProxy_CfnInstanceProfile)SetRebootAfterUse(val interface{}) {
...
func CfnInstanceProfile_ArnForInstanceProfile(resource interfacesawsdevicefarm.IInstanceProfileRef) *string {
	_init_.Initialize()
