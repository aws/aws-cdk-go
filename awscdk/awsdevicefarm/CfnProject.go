...
func (j *jsiiProxy_CfnProject) DefaultJobTimeoutMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnProject)SetDefaultJobTimeoutMinutes(val *float64) {
	_jsii_.Set(
		j,
		"defaultJobTimeoutMinutes",
		val,
...
func CfnProject_ArnForProject(resource interfacesawsdevicefarm.IProjectRef) *string {
	_init_.Initialize()
