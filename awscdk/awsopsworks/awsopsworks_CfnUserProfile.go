...
//
//   cfnUserProfile := awscdk.Aws_opsworks.NewCfnUserProfile(this, jsii.String("MyCfnUserProfile"), &cfnUserProfileProps{
...
func (j *jsiiProxy_CfnUserProfile)SetIamUserArn(val *string) {
	if err := j.validateSetIamUserArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
