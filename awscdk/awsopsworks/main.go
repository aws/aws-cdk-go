...
func init() {
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opsworks.AppReference",
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IElasticLoadBalancerAttachmentRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.jsiiProxy_ILayerRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_opsworks.IStackRef",
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_opsworks.IVolumeRef",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opsworks.InstanceReference",
		reflect.TypeOf((*InstanceReference)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_opsworks.LayerReference",
