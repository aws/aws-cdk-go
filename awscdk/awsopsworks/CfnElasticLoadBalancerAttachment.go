...
func (j *jsiiProxy_CfnElasticLoadBalancerAttachment) CfnPropertyNames() *map[string]*string {
...
func CfnElasticLoadBalancerAttachment_IsCfnElasticLoadBalancerAttachment(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnElasticLoadBalancerAttachment_IsCfnElasticLoadBalancerAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_opsworks.CfnElasticLoadBalancerAttachment",
		"isCfnElasticLoadBalancerAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnElasticLoadBalancerAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnElasticLoadBalancerAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnElasticLoadBalancerAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnElasticLoadBalancerAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnElasticLoadBalancerAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnElasticLoadBalancerAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnElasticLoadBalancerAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
