...
func (j *jsiiProxy_CfnLayer) CfnPropertyNames() *map[string]*string {
...
func CfnLayer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLayer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLayer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLayer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLayer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLayer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLayer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
