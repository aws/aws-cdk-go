...
func validateCfnLayer_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnLayer) validateSetCustomRecipesParameters(val interface{}) error {
	...
	case CfnLayer_RecipesProperty:
		val_ := val.(CfnLayer_RecipesProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnLayer) validateSetLifecycleEventConfigurationParameters(val interface{}) error {
	...
	case CfnLayer_LifecycleEventConfigurationProperty:
		val_ := val.(CfnLayer_LifecycleEventConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnLayer) validateSetLoadBasedAutoScalingParameters(val interface{}) error {
	...
	case CfnLayer_LoadBasedAutoScalingProperty:
		val_ := val.(CfnLayer_LoadBasedAutoScalingProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnLayer) validateSetVolumeConfigurationsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnLayer_VolumeConfigurationProperty:
				v_ := v.(CfnLayer_VolumeConfigurationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
