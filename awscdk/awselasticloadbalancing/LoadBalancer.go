...
func (j *jsiiProxy_LoadBalancer) Env() *interfaces.ResourceEnvironment {
...
func LoadBalancer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_elasticloadbalancing.LoadBalancer",
...
func (l *jsiiProxy_LoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
