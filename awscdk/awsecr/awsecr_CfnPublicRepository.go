...
func (j *jsiiProxy_CfnPublicRepository) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPublicRepository(scope constructs.Construct, id *string, props *CfnPublicRepositoryProps) CfnPublicRepository {
	...
	if err := validateNewCfnPublicRepositoryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPublicRepository_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPublicRepository_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicRepository_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnPublicRepository_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicRepository_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPublicRepository_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublicRepository) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicRepository) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPublicRepository) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPublicRepository) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnPublicRepository) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicRepository) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
