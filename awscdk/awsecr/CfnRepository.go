...
func (j *jsiiProxy_CfnRepository) CfnPropertyNames() *map[string]*string {
...
func CfnRepository_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRepository_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRepository) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepository) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRepository) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRepository) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRepository) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRepository) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRepository) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepository) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepository) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
