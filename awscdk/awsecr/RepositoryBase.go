...
func (j *jsiiProxy_RepositoryBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_RepositoryBase) RegistryUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"registryUri",
...
func (j *jsiiProxy_RepositoryBase) RepositoryRef() *interfacesawsecr.RepositoryReference {
...
func (r *jsiiProxy_RepositoryBase) GrantPush(grantee awsiam.IGrantable) awsiam.Grant {
...
func (r *jsiiProxy_RepositoryBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
