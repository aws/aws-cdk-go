...
func (j *jsiiProxy_CfnReplicationConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicationConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnReplicationConfiguration(scope constructs.Construct, id *string, props *CfnReplicationConfigurationProps) CfnReplicationConfiguration {
	...
	if err := validateNewCfnReplicationConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReplicationConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReplicationConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReplicationConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReplicationConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicationConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReplicationConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReplicationConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
