...
func (j *jsiiProxy_CfnPublicRepository) CfnPropertyNames() *map[string]*string {
...
func CfnPublicRepository_IsCfnPublicRepository(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPublicRepository_IsCfnPublicRepositoryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPublicRepository_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPublicRepository_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPublicRepository) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPublicRepository) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPublicRepository) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPublicRepository) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPublicRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
