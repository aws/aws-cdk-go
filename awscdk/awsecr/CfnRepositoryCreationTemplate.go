...
//
//   cfnRepositoryCreationTemplate := awscdk.Aws_ecr.NewCfnRepositoryCreationTemplate(this, jsii.String("MyCfnRepositoryCreationTemplate"), &CfnRepositoryCreationTemplateProps{
//   	AppliedFor: []*string{
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) EncryptionConfiguration() interface{} {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) ImageTagMutability() *string {
	var returns *string
	_jsii_.Get(
		j,
		"imageTagMutability",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) Prefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"prefix",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) RepositoryPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryPolicy",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) ResourceTags() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourceTags",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRepositoryCreationTemplate(scope constructs.Construct, id *string, props *CfnRepositoryCreationTemplateProps) CfnRepositoryCreationTemplate {
	...
	if err := validateNewCfnRepositoryCreationTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetAppliedFor(val *[]*string) {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetEncryptionConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetImageTagMutability(val *string) {
	_jsii_.Set(
		j,
		"imageTagMutability",
		val,
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetLifecyclePolicy(val *string) {
	_jsii_.Set(
		j,
		"lifecyclePolicy",
		val,
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetPrefix(val *string) {
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetRepositoryPolicy(val *string) {
	_jsii_.Set(
		j,
		"repositoryPolicy",
		val,
...
func (j *jsiiProxy_CfnRepositoryCreationTemplate)SetResourceTags(val interface{}) {
...
func CfnRepositoryCreationTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRepositoryCreationTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRepositoryCreationTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRepositoryCreationTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRepositoryCreationTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRepositoryCreationTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRepositoryCreationTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
