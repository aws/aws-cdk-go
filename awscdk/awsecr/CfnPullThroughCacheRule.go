...
func (j *jsiiProxy_CfnPullThroughCacheRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPullThroughCacheRule) CustomRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customRoleArn",
...
func (j *jsiiProxy_CfnPullThroughCacheRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnPullThroughCacheRule) UpstreamRepositoryPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewCfnPullThroughCacheRule(scope constructs.Construct, id *string, props *CfnPullThroughCacheRuleProps) CfnPullThroughCacheRule {
	...
	if err := validateNewCfnPullThroughCacheRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnPullThroughCacheRule)SetCustomRoleArn(val *string) {
	_jsii_.Set(
		j,
		"customRoleArn",
		val,
...
func (j *jsiiProxy_CfnPullThroughCacheRule)SetUpstreamRepositoryPrefix(val *string) {
	_jsii_.Set(
		j,
		"upstreamRepositoryPrefix",
		val,
...
func CfnPullThroughCacheRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPullThroughCacheRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPullThroughCacheRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPullThroughCacheRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPullThroughCacheRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPullThroughCacheRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPullThroughCacheRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
