...
func (j *jsiiProxy_CfnDataset) validateSetDatasetGroupArnParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnDataset) validateSetDatasetImportJobParameters(val interface{}) error {
	...
	case CfnDataset_DatasetImportJobProperty:
		val_ := val.(CfnDataset_DatasetImportJobProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnDataset) validateSetSchemaArnParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
