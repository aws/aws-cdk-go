...
func (j *jsiiProxy_CfnDatasetGroup) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDatasetGroup) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDatasetGroup)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDatasetGroup_ArnForDatasetGroup(resource interfacesawspersonalize.IDatasetGroupRef) *string {
	_init_.Initialize()
