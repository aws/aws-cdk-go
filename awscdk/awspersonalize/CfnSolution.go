...
func (j *jsiiProxy_CfnSolution) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSolution) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSolution) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSolution) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSolution) RemoveResourceDependency(target awscdk.CfnResource) {
