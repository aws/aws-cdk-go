...
//
//   cfnRecipe := awscdk.Aws_personalize.NewCfnRecipe(this, jsii.String("MyCfnRecipe"), &CfnRecipeProps{
...
type CfnRecipe interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawspersonalize.IRecipeRef
	...
	RecipeRef() *interfacesawspersonalize.RecipeReference
...
type jsiiProxy_CfnRecipe struct {
	...
	internal.Type__interfacesawspersonalizeIRecipeRef
}

func (j *jsiiProxy_CfnRecipe) AttrAlgorithmArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrAlgorithmArn",
...
func (j *jsiiProxy_CfnRecipe) AttrCreationDateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRecipe) AttrDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDescription",
...
func (j *jsiiProxy_CfnRecipe) AttrFeatureTransformationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrFeatureTransformationArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnRecipe) AttrLastUpdatedDateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRecipe) AttrRecipeArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRecipeArn",
...
func (j *jsiiProxy_CfnRecipe) AttrRecipeType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRecipeType",
...
func (j *jsiiProxy_CfnRecipe) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnRecipe) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRecipe) RecipeRef() *interfacesawspersonalize.RecipeReference {
	var returns *interfacesawspersonalize.RecipeReference
	_jsii_.Get(
		j,
		"recipeRef",
		&returns,
...
func NewCfnRecipe(scope constructs.Construct, id *string, props *CfnRecipeProps) CfnRecipe {
	...
	if err := validateNewCfnRecipeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRecipe_ArnForRecipe(resource interfacesawspersonalize.IRecipeRef) *string {
	_init_.Initialize()

	if err := validateCfnRecipe_ArnForRecipeParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRecipe_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRecipe_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecipe_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRecipe_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRecipe_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRecipe_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRecipe) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecipe) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRecipe) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRecipe) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRecipe) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRecipe) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRecipe) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecipe) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecipe) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRecipe) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
