...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront_origins.VpcOriginProps",
		reflect.TypeOf((*VpcOriginProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront_origins.VpcOriginWithEndpointProps",
		reflect.TypeOf((*VpcOriginWithEndpointProps)(nil)).Elem(),
	)
}
