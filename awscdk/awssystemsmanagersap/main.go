...
func init() {
	_jsii_.RegisterClass(
		"monocdk.aws_systemsmanagersap.CfnApplication",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sapInstanceNumber", GoGetter: "SapInstanceNumber"},
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_systemsmanagersap.CfnApplication.CredentialProperty",
		reflect.TypeOf((*CfnApplication_CredentialProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_systemsmanagersap.CfnApplicationProps",
