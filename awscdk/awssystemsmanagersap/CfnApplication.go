...
//
//   cfnApplication := awscdk.Aws_systemsmanagersap.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
func (j *jsiiProxy_CfnApplication) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_CfnApplication) Credentials() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"credentials",
...
func (j *jsiiProxy_CfnApplication) SapInstanceNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sapInstanceNumber",
...
func (j *jsiiProxy_CfnApplication) Sid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sid",
...
func (j *jsiiProxy_CfnApplication)SetApplicationId(val *string) {
...
func (j *jsiiProxy_CfnApplication)SetCredentials(val interface{}) {
...
func (j *jsiiProxy_CfnApplication)SetInstances(val *[]*string) {
	_jsii_.Set(
		j,
		"instances",
		val,
...
func (j *jsiiProxy_CfnApplication)SetSapInstanceNumber(val *string) {
	_jsii_.Set(
		j,
		"sapInstanceNumber",
		val,
...
func (j *jsiiProxy_CfnApplication)SetSid(val *string) {
	_jsii_.Set(
		j,
		"sid",
		val,
...
func CfnApplication_ArnForApplication(resource interfacesawssystemsmanagersap.IApplicationRef) *string {
	_init_.Initialize()
