...
func (j *jsiiProxy_Queue) Env() *interfaces.ResourceEnvironment {
...
func Queue_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_sqs.Queue",
...
func (q *jsiiProxy_Queue) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (q *jsiiProxy_Queue) MetricApproximateNumberOfMessagesOutstanding(props *awscloudwatch.MetricOptions) awscloudwatch.MathExpression {
