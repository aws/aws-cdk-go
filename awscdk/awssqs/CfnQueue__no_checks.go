...
func (j *jsiiProxy_CfnQueue) validateSetContentBasedDeduplicationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnQueue) validateSetFifoQueueParameters(val interface{}) error {
	return nil
}
