...
func (j *jsiiProxy_CfnQueuePolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnQueuePolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnQueuePolicy(scope constructs.Construct, id *string, props *CfnQueuePolicyProps) CfnQueuePolicy {
	...
	if err := validateNewCfnQueuePolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnQueuePolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnQueuePolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueuePolicy_IsCfnQueuePolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnQueuePolicy_IsCfnQueuePolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueuePolicy_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnQueuePolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnQueuePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnQueuePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnQueuePolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueuePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnQueuePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnQueuePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnQueuePolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnQueuePolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnQueuePolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueuePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueuePolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnQueuePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
