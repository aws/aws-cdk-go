...
func (j *jsiiProxy_QueuePolicy) Env() *interfaces.ResourceEnvironment {
...
func QueuePolicy_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateQueuePolicy_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func QueuePolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_sqs.QueuePolicy",
...
func (q *jsiiProxy_QueuePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (q *jsiiProxy_QueuePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
