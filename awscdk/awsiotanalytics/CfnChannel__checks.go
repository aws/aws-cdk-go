...
func (c *jsiiProxy_CfnChannel) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_CfnChannel) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateCfnChannel_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnChannel) validateSetChannelStorageParameters(val interface{}) error {
	switch val.(type) {
	case *CfnChannel_ChannelStorageProperty:
		val := val.(*CfnChannel_ChannelStorageProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_ChannelStorageProperty:
		val_ := val.(CfnChannel_ChannelStorageProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnChannel_ChannelStorageProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetRetentionPeriodParameters(val interface{}) error {
	switch val.(type) {
	case *CfnChannel_RetentionPeriodProperty:
		val := val.(*CfnChannel_RetentionPeriodProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_RetentionPeriodProperty:
		val_ := val.(CfnChannel_RetentionPeriodProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnChannel_RetentionPeriodProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func validateNewCfnChannelParameters(scope awscdk.Construct, id *string, props *CfnChannelProps) error {
	if scope == nil {
