...
//
// You must specify both a `channel` and a `datastore` activity and, optionally, as many as 23 additional activities in the `pipelineActivities` array. For more information, see [How to Use](https://docs.aws.amazon.com/iotanalytics/latest/userguide/welcome.html#aws-iot-analytics-how) in the *User Guide* .
//
// Example:
...
type CfnPipeline interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsiotanalytics.IPipelineRef
	awscdk.ITaggable
	AttrId() *string
	...
	PipelineRef() *interfacesawsiotanalytics.PipelineReference
...
type jsiiProxy_CfnPipeline struct {
	...
	internal.Type__interfacesawsiotanalyticsIPipelineRef
...
func (j *jsiiProxy_CfnPipeline) PipelineRef() *interfacesawsiotanalytics.PipelineReference {
	var returns *interfacesawsiotanalytics.PipelineReference
	_jsii_.Get(
		j,
		"pipelineRef",
		&returns,
...
func (j *jsiiProxy_CfnPipeline)SetPipelineActivities(val interface{}) {
	if err := j.validateSetPipelineActivitiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnPipeline_FromPipelineName(scope constructs.Construct, id *string, pipelineName *string) interfacesawsiotanalytics.IPipelineRef {
	...
	var returns interfacesawsiotanalytics.IPipelineRef
