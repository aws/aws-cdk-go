...
func validateCfnPipeline_ArnForPipelineParameters(resource interfacesawsiotanalytics.IPipelineRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnPipeline) validateSetPipelineActivitiesParameters(val interface{}) error {
	if val == nil {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnPipeline_ActivityProperty:
				v := v.(*CfnPipeline_ActivityProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnPipeline_ActivityProperty:
				v_ := v.(CfnPipeline_ActivityProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnPipeline_ActivityProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
