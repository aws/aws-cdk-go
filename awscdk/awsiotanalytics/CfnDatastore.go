...
func (j *jsiiProxy_CfnDatastore) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDatastore) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDatastore(scope constructs.Construct, id *string, props *CfnDatastoreProps) CfnDatastore {
	...
	if err := validateNewCfnDatastoreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDatastore)SetDatastorePartitions(val interface{}) {
	if err := j.validateSetDatastorePartitionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDatastore)SetDatastoreStorage(val interface{}) {
	if err := j.validateSetDatastoreStorageParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDatastore)SetFileFormatConfiguration(val interface{}) {
	if err := j.validateSetFileFormatConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDatastore_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDatastore_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDatastore_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDatastore_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDatastore_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDatastore_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDatastore) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatastore) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDatastore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDatastore) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDatastore) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDatastore) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDatastore) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatastore) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatastore) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDatastore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
