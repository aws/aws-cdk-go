...
func (j *jsiiProxy_CfnComponentVersion) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnComponentVersion) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComponentVersion) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComponentVersion) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComponentVersion) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComponentVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
