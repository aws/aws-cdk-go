...
//
//   cfnComponent := awscdk.Aws_greengrassv2.NewCfnComponent(this, jsii.String("MyCfnComponent"), &CfnComponentProps{
...
type CfnComponent interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsgreengrassv2.IComponentRef
	awscdk.ITaggableV2
	...
	ComponentRef() *interfacesawsgreengrassv2.ComponentReference
	...
	Tags() *[]*CfnComponent_TagsItemsProperty
	SetTags(val *[]*CfnComponent_TagsItemsProperty)
	// Deprecated.
...
type jsiiProxy_CfnComponent struct {
	...
	internal.Type__interfacesawsgreengrassv2IComponentRef
...
func (j *jsiiProxy_CfnComponent) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnComponent) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnComponent) ComponentName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"componentName",
...
func (j *jsiiProxy_CfnComponent) ComponentRef() *interfacesawsgreengrassv2.ComponentReference {
	var returns *interfacesawsgreengrassv2.ComponentReference
	_jsii_.Get(
		j,
		"componentRef",
		&returns,
...
func (j *jsiiProxy_CfnComponent) Tags() *[]*CfnComponent_TagsItemsProperty {
	var returns *[]*CfnComponent_TagsItemsProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func NewCfnComponent(scope constructs.Construct, id *string, props *CfnComponentProps) CfnComponent {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_greengrassv2.CfnComponent",
...
func (j *jsiiProxy_CfnComponent)SetComponentName(val *string) {
	_jsii_.Set(
		j,
		"componentName",
		val,
...
func (j *jsiiProxy_CfnComponent)SetTags(val *[]*CfnComponent_TagsItemsProperty) {
...
func CfnComponent_ArnForComponent(resource interfacesawsgreengrassv2.IComponentRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnComponent) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComponent) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComponent) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComponent) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComponent) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
