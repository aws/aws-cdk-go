...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/awssimspaceweaver/internal"
...
func (j *jsiiProxy_CfnSimulation) Node() awscdk.ConstructNode {
...
func NewCfnSimulation(scope awscdk.Construct, id *string, props *CfnSimulationProps) CfnSimulation {
	_init_.Initialize()
	...
	_jsii_.Create(
		"monocdk.aws_simspaceweaver.CfnSimulation",
...
// Create a new `AWS::SimSpaceWeaver::Simulation`.
func NewCfnSimulation_Override(c CfnSimulation, scope awscdk.Construct, id *string, props *CfnSimulationProps) {
	_init_.Initialize()
...
// Experimental.
func CfnSimulation_IsCfnResource(construct constructs.IConstruct) *bool {
	_init_.Initialize()

	if err := validateCfnSimulation_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimulation) GetAtt(attributeName *string) awscdk.Reference {
...
func (c *jsiiProxy_CfnSimulation) OnPrepare() {
	_jsii_.InvokeVoid(
		c,
		"onPrepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnSimulation) OnSynthesize(session constructs.ISynthesisSession) {
...
func (c *jsiiProxy_CfnSimulation) OnValidate() *[]*string {
	var returns *[]*string
...
func (c *jsiiProxy_CfnSimulation) Prepare() {
	_jsii_.InvokeVoid(
		c,
		"prepare",
		nil, // no parameters
...
func (c *jsiiProxy_CfnSimulation) Synthesize(session awscdk.ISynthesisSession) {
...
func (c *jsiiProxy_CfnSimulation) Validate() *[]*string {
	var returns *[]*string
