...
func (j *jsiiProxy_CfnSimulation) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSimulation) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSimulation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSimulation) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSimulation) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSimulation) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSimulation) MaximumDuration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"maximumDuration",
...
func (j *jsiiProxy_CfnSimulation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnSimulation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSimulation) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSimulation) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_CfnSimulation) SchemaS3Location() interface{} {
...
func (j *jsiiProxy_CfnSimulation) SnapshotS3Location() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"snapshotS3Location",
...
func (j *jsiiProxy_CfnSimulation) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSimulation) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSimulation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSimulation(scope constructs.Construct, id *string, props *CfnSimulationProps) CfnSimulation {
	...
	if err := validateNewCfnSimulationParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnSimulation{}
...
func (j *jsiiProxy_CfnSimulation)SetMaximumDuration(val *string) {
	_jsii_.Set(
		j,
		"maximumDuration",
		val,
...
func (j *jsiiProxy_CfnSimulation)SetName(val *string) {
...
func (j *jsiiProxy_CfnSimulation)SetRoleArn(val *string) {
...
func (j *jsiiProxy_CfnSimulation)SetSchemaS3Location(val interface{}) {
	if err := j.validateSetSchemaS3LocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSimulation)SetSnapshotS3Location(val interface{}) {
	if err := j.validateSetSnapshotS3LocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnSimulation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSimulation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimulation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSimulation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimulation_IsCfnSimulation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSimulation_IsCfnSimulationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimulation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSimulation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimulation) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSimulation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulation) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulation) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSimulation) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSimulation) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSimulation) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSimulation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSimulation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSimulation) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSimulation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSimulation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSimulation) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSimulation) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSimulation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSimulation) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSimulation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulation) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSimulation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimulation) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSimulation) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSimulation) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSimulation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
