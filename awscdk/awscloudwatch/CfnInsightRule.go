...
func (j *jsiiProxy_CfnInsightRule) ApplyOnTransformedLogs() interface{} {
...
func (j *jsiiProxy_CfnInsightRule) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnInsightRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnInsightRule(scope constructs.Construct, id *string, props *CfnInsightRuleProps) CfnInsightRule {
	...
	if err := validateNewCfnInsightRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnInsightRule)SetApplyOnTransformedLogs(val interface{}) {
...
func (j *jsiiProxy_CfnInsightRule)SetRuleBody(val *string) {
	if err := j.validateSetRuleBodyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnInsightRule_ArnForInsightRule(resource interfacesawscloudwatch.IInsightRuleRef) *string {
	_init_.Initialize()

	if err := validateCfnInsightRule_ArnForInsightRuleParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnInsightRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnInsightRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInsightRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnInsightRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInsightRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnInsightRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInsightRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInsightRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInsightRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInsightRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInsightRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnInsightRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInsightRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInsightRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInsightRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInsightRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
