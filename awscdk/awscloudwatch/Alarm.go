...
func (j *jsiiProxy_Alarm) AlarmRef() *interfacesawscloudwatch.AlarmReference {
...
func (j *jsiiProxy_Alarm) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_Alarm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_Alarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
