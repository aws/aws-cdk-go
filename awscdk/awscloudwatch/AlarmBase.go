...
func (j *jsiiProxy_AlarmBase) Env() *interfaces.ResourceEnvironment {
...
func AlarmBase_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAlarmBase_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AlarmBase) AddAlarmMuteRule(id *string, options *AlarmMuteRuleOptions) AlarmMuteRule {
...
func (a *jsiiProxy_AlarmBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AlarmBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
