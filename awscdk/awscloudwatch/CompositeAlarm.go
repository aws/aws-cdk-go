...
func (j *jsiiProxy_CompositeAlarm) AlarmRef() *interfacesawscloudwatch.AlarmReference {
...
func (j *jsiiProxy_CompositeAlarm) Env() *interfaces.ResourceEnvironment {
...
func CompositeAlarm_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudwatch.CompositeAlarm",
...
func (c *jsiiProxy_CompositeAlarm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CompositeAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
