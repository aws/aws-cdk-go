...
func (a *jsiiProxy_AlarmBase) validateAddAlarmMuteRuleParameters(id *string, options *AlarmMuteRuleOptions) error {
	return nil
}

func (a *jsiiProxy_AlarmBase) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
