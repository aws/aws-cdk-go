...
func (j *jsiiProxy_CfnMetricStream) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnMetricStream) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMetricStream) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMetricStream) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMetricStream) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMetricStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
