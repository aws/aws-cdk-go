...
func (j *jsiiProxy_CfnAnomalyDetector) CfnPropertyNames() *map[string]*string {
...
func CfnAnomalyDetector_IsCfnAnomalyDetector(x interface{}) *bool {
	...
	if err := validateCfnAnomalyDetector_IsCfnAnomalyDetectorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAnomalyDetector) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAnomalyDetector) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAnomalyDetector) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAnomalyDetector) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAnomalyDetector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
