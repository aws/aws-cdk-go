...
//
//   cfnLogAlarmProps := &CfnLogAlarmProps{
...
type CfnLogAlarmProps struct {
	...
	//
	ScheduledQueryConfiguration interface{} `field:"required" json:"scheduledQueryConfiguration" yaml:"scheduledQueryConfiguration"`
