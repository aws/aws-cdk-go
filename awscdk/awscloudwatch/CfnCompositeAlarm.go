...
func (j *jsiiProxy_CfnCompositeAlarm) CfnPropertyNames() *map[string]*string {
...
func CfnCompositeAlarm_IsCfnCompositeAlarm(x interface{}) *bool {
	...
	if err := validateCfnCompositeAlarm_IsCfnCompositeAlarmParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCompositeAlarm_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCompositeAlarm_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCompositeAlarm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCompositeAlarm) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCompositeAlarm) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCompositeAlarm) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCompositeAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
