...
func (c *jsiiProxy_CfnLogAlarm) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLogAlarm) RemoveResourceDependency(target awscdk.CfnResource) {
