...
func (j *jsiiProxy_CfnFunction) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnFunction)SetFunctionCode(val *string) {
	if err := j.validateSetFunctionCodeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnFunction)SetFunctionConfig(val interface{}) {
	if err := j.validateSetFunctionConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnFunction)SetFunctionMetadata(val interface{}) {
	if err := j.validateSetFunctionMetadataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFunction_ArnForFunction(resource interfacesawscloudfront.IFunctionRef) *string {
	_init_.Initialize()

	if err := validateCfnFunction_ArnForFunctionParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnFunction) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFunction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFunction) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFunction) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
