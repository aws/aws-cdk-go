...
func PublicKey_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.PublicKey",
...
func (p *jsiiProxy_PublicKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PublicKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
