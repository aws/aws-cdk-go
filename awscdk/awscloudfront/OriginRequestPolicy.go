...
func OriginRequestPolicy_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateOriginRequestPolicy_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (o *jsiiProxy_OriginRequestPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (o *jsiiProxy_OriginRequestPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
