...
func ResponseHeadersPolicy_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateResponseHeadersPolicy_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func ResponseHeadersPolicy_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.ResponseHeadersPolicy",
...
func (r *jsiiProxy_ResponseHeadersPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_ResponseHeadersPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
