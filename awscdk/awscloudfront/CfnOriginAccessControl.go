...
func (j *jsiiProxy_CfnOriginAccessControl) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnOriginAccessControl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOriginAccessControl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOriginAccessControl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOriginAccessControl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginAccessControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
