...
func (j *jsiiProxy_CfnFunction) validateSetAutoPublishParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnFunction) validateSetFunctionCodeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnFunction) validateSetFunctionConfigParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	...
	case CfnFunction_FunctionConfigProperty:
		val_ := val.(CfnFunction_FunctionConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFunction) validateSetFunctionMetadataParameters(val interface{}) error {
	...
	case CfnFunction_FunctionMetadataProperty:
		val_ := val.(CfnFunction_FunctionMetadataProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFunction) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
