...
func (j *jsiiProxy_CfnRealtimeLogConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRealtimeLogConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRealtimeLogConfig(scope constructs.Construct, id *string, props *CfnRealtimeLogConfigProps) CfnRealtimeLogConfig {
	...
	if err := validateNewCfnRealtimeLogConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRealtimeLogConfig_ArnForRealtimeLogConfig(resource interfacesawscloudfront.IRealtimeLogConfigRef) *string {
	_init_.Initialize()

	if err := validateCfnRealtimeLogConfig_ArnForRealtimeLogConfigParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRealtimeLogConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRealtimeLogConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRealtimeLogConfig_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRealtimeLogConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRealtimeLogConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRealtimeLogConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRealtimeLogConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRealtimeLogConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRealtimeLogConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
