...
func (j *jsiiProxy_KeyGroup) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_KeyGroup) KeyGroupRef() *interfacesawscloudfront.KeyGroupReference {
...
func KeyGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.KeyGroup",
...
func (k *jsiiProxy_KeyGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (k *jsiiProxy_KeyGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
