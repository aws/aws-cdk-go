...
func (f *jsiiProxy_Function) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_Function) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
