...
func (j *jsiiProxy_CfnResponseHeadersPolicy) CfnPropertyNames() *map[string]*string {
...
func NewCfnResponseHeadersPolicy(scope constructs.Construct, id *string, props *CfnResponseHeadersPolicyProps) CfnResponseHeadersPolicy {
	...
	if err := validateNewCfnResponseHeadersPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResponseHeadersPolicy)SetResponseHeadersPolicyConfig(val interface{}) {
	if err := j.validateSetResponseHeadersPolicyConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResponseHeadersPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResponseHeadersPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResponseHeadersPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResponseHeadersPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResponseHeadersPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResponseHeadersPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResponseHeadersPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
