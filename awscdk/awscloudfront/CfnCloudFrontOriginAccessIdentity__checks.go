...
func (c *jsiiProxy_CfnCloudFrontOriginAccessIdentity) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnCloudFrontOriginAccessIdentity) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCloudFrontOriginAccessIdentity) validateSetCloudFrontOriginAccessIdentityConfigParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCloudFrontOriginAccessIdentity_CloudFrontOriginAccessIdentityConfigProperty; received %#v (a %T)", val, val)
		}
	}
