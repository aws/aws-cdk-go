...
func (j *jsiiProxy_CfnOriginRequestPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOriginRequestPolicy(scope constructs.Construct, id *string, props *CfnOriginRequestPolicyProps) CfnOriginRequestPolicy {
	...
	if err := validateNewCfnOriginRequestPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnOriginRequestPolicy)SetOriginRequestPolicyConfig(val interface{}) {
	if err := j.validateSetOriginRequestPolicyConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnOriginRequestPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOriginRequestPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOriginRequestPolicy_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnOriginRequestPolicy_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOriginRequestPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOriginRequestPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOriginRequestPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOriginRequestPolicy) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
