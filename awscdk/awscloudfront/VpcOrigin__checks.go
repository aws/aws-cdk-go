...
func (v *jsiiProxy_VpcOrigin) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateVpcOrigin_FromVpcOriginArnParameters(scope constructs.Construct, id *string, vpcOriginArn *string) error {
	...
	if vpcOriginArn == nil {
		return fmt.Errorf("parameter vpcOriginArn is required, but nil was provided")
	}
...
func validateVpcOrigin_FromVpcOriginIdParameters(scope constructs.Construct, id *string, vpcOriginId *string) error {
	...
	if vpcOriginId == nil {
		return fmt.Errorf("parameter vpcOriginId is required, but nil was provided")
	}
