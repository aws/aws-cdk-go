...
func (k *jsiiProxy_KeyValueStore) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (k *jsiiProxy_KeyValueStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
