...
func (j *jsiiProxy_CfnCachePolicy) CfnPropertyNames() *map[string]*string {
...
func CfnCachePolicy_ArnForCachePolicy(resource interfacesawscloudfront.ICachePolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnCachePolicy_ArnForCachePolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnCachePolicy_IsCfnCachePolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCachePolicy_IsCfnCachePolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCachePolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCachePolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCachePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCachePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCachePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCachePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCachePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
