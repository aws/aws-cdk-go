...
func (j *jsiiProxy_CfnCachePolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCachePolicy(scope constructs.Construct, id *string, props *CfnCachePolicyProps) CfnCachePolicy {
	...
	if err := validateNewCfnCachePolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCachePolicy)SetCachePolicyConfig(val interface{}) {
	if err := j.validateSetCachePolicyConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnCachePolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCachePolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCachePolicy_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCachePolicy_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCachePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCachePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCachePolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCachePolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCachePolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCachePolicy) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCachePolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCachePolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
