...
func (j *jsiiProxy_CfnConnectionGroup) AnycastIpListId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"anycastIpListId",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrETag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrETag",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrIsDefault() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnConnectionGroup) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnConnectionGroup) AttrRoutingEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRoutingEndpoint",
...
func (j *jsiiProxy_CfnConnectionGroup) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnConnectionGroup) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnConnectionGroup) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnConnectionGroup) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnConnectionGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnConnectionGroup) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnConnectionGroup) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnConnectionGroup) Enabled() interface{} {
...
func (j *jsiiProxy_CfnConnectionGroup) Ipv6Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ipv6Enabled",
...
func (j *jsiiProxy_CfnConnectionGroup) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnConnectionGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnConnectionGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnConnectionGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnConnectionGroup) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnConnectionGroup) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnConnectionGroup) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnConnectionGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnConnectionGroup(scope constructs.Construct, id *string, props *CfnConnectionGroupProps) CfnConnectionGroup {
	...
	if err := validateNewCfnConnectionGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnConnectionGroup)SetAnycastIpListId(val *string) {
	_jsii_.Set(
		j,
		"anycastIpListId",
		val,
...
func (j *jsiiProxy_CfnConnectionGroup)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnConnectionGroup)SetIpv6Enabled(val interface{}) {
...
func (j *jsiiProxy_CfnConnectionGroup)SetName(val *string) {
...
func (j *jsiiProxy_CfnConnectionGroup)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnConnectionGroup_ArnForConnectionGroup(resource interfacesawscloudfront.IConnectionGroupRef) *string {
	_init_.Initialize()

	if err := validateCfnConnectionGroup_ArnForConnectionGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnConnectionGroup_IsCfnConnectionGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectionGroup_IsCfnConnectionGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionGroup_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectionGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectionGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionGroup_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnConnectionGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnConnectionGroup_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.CfnConnectionGroup",
...
func (c *jsiiProxy_CfnConnectionGroup) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnConnectionGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnConnectionGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnConnectionGroup) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnConnectionGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnConnectionGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnConnectionGroup) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnConnectionGroup) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnConnectionGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnConnectionGroup) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnConnectionGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionGroup) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnConnectionGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnConnectionGroup) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnConnectionGroup) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnConnectionGroup) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnConnectionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
