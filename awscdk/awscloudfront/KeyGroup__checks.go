...
func (k *jsiiProxy_KeyGroup) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateKeyGroup_FromKeyGroupIdParameters(scope constructs.Construct, id *string, keyGroupId *string) error {
	...
	if keyGroupId == nil {
		return fmt.Errorf("parameter keyGroupId is required, but nil was provided")
	}
