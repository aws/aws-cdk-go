...
func (j *jsiiProxy_CfnMonitoringSubscription) CfnPropertyNames() *map[string]*string {
...
func CfnMonitoringSubscription_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMonitoringSubscription_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMonitoringSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMonitoringSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMonitoringSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMonitoringSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMonitoringSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
