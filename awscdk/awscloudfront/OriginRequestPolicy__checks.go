...
func (o *jsiiProxy_OriginRequestPolicy) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateOriginRequestPolicy_FromOriginRequestPolicyIdParameters(scope constructs.Construct, id *string, originRequestPolicyId *string) error {
	...
	if originRequestPolicyId == nil {
		return fmt.Errorf("parameter originRequestPolicyId is required, but nil was provided")
	}
