...
func (j *jsiiProxy_CfnDistributionTenant) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnDistributionTenant) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnDistributionTenant) AttrDomainResults() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnDistributionTenant) AttrETag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrETag",
...
func (j *jsiiProxy_CfnDistributionTenant) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnDistributionTenant) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDistributionTenant) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnDistributionTenant) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDistributionTenant) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDistributionTenant) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDistributionTenant) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDistributionTenant) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDistributionTenant) ConnectionGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"connectionGroupId",
...
func (j *jsiiProxy_CfnDistributionTenant) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDistributionTenant) Customizations() interface{} {
...
func (j *jsiiProxy_CfnDistributionTenant) DistributionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"distributionId",
...
func (j *jsiiProxy_CfnDistributionTenant) Domains() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"domains",
...
func (j *jsiiProxy_CfnDistributionTenant) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_CfnDistributionTenant) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDistributionTenant) ManagedCertificateRequest() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnDistributionTenant) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnDistributionTenant) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDistributionTenant) Parameters() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parameters",
...
func (j *jsiiProxy_CfnDistributionTenant) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDistributionTenant) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDistributionTenant) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDistributionTenant) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDistributionTenant) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDistributionTenant(scope constructs.Construct, id *string, props *CfnDistributionTenantProps) CfnDistributionTenant {
	...
	if err := validateNewCfnDistributionTenantParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDistributionTenant)SetConnectionGroupId(val *string) {
	_jsii_.Set(
		j,
		"connectionGroupId",
		val,
...
func (j *jsiiProxy_CfnDistributionTenant)SetCustomizations(val interface{}) {
	if err := j.validateSetCustomizationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDistributionTenant)SetDistributionId(val *string) {
...
func (j *jsiiProxy_CfnDistributionTenant)SetDomains(val *[]*string) {
...
func (j *jsiiProxy_CfnDistributionTenant)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_CfnDistributionTenant)SetManagedCertificateRequest(val interface{}) {
	if err := j.validateSetManagedCertificateRequestParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDistributionTenant)SetName(val *string) {
...
func (j *jsiiProxy_CfnDistributionTenant)SetParameters(val interface{}) {
...
func (j *jsiiProxy_CfnDistributionTenant)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDistributionTenant_ArnForDistributionTenant(resource interfacesawscloudfront.IDistributionTenantRef) *string {
	_init_.Initialize()

	if err := validateCfnDistributionTenant_ArnForDistributionTenantParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnDistributionTenant_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDistributionTenant_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistributionTenant_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDistributionTenant_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistributionTenant_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDistributionTenant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDistributionTenant_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.CfnDistributionTenant",
...
func (c *jsiiProxy_CfnDistributionTenant) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDistributionTenant) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDistributionTenant) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDistributionTenant) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDistributionTenant) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDistributionTenant) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDistributionTenant) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDistributionTenant) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDistributionTenant) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDistributionTenant) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDistributionTenant) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionTenant) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionTenant) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDistributionTenant) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDistributionTenant) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDistributionTenant) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDistributionTenant) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDistributionTenant) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
