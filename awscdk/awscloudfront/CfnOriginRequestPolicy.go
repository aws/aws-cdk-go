...
func (j *jsiiProxy_CfnOriginRequestPolicy) CfnPropertyNames() *map[string]*string {
...
func CfnOriginRequestPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOriginRequestPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOriginRequestPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginRequestPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
