...
func (j *jsiiProxy_CfnStreamingDistribution) CfnPropertyNames() *map[string]*string {
...
func CfnStreamingDistribution_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnStreamingDistribution_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamingDistribution_IsCfnStreamingDistribution(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStreamingDistribution_IsCfnStreamingDistributionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamingDistribution) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStreamingDistribution) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStreamingDistribution) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStreamingDistribution) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingDistribution) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
