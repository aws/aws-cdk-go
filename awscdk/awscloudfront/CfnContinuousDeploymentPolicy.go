...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) AttrLastModifiedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) ContinuousDeploymentPolicyConfig() interface{} {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnContinuousDeploymentPolicy(scope constructs.Construct, id *string, props *CfnContinuousDeploymentPolicyProps) CfnContinuousDeploymentPolicy {
	...
	if err := validateNewCfnContinuousDeploymentPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicy)SetContinuousDeploymentPolicyConfig(val interface{}) {
	if err := j.validateSetContinuousDeploymentPolicyConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnContinuousDeploymentPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnContinuousDeploymentPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnContinuousDeploymentPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnContinuousDeploymentPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
