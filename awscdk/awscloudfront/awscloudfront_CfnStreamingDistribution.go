...
func (j *jsiiProxy_CfnStreamingDistribution) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStreamingDistribution(scope constructs.Construct, id *string, props *CfnStreamingDistributionProps) CfnStreamingDistribution {
	...
	if err := validateNewCfnStreamingDistributionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnStreamingDistribution)SetStreamingDistributionConfig(val interface{}) {
	if err := j.validateSetStreamingDistributionConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnStreamingDistribution_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStreamingDistribution_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamingDistribution_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnStreamingDistribution_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStreamingDistribution_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStreamingDistribution_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStreamingDistribution) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingDistribution) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStreamingDistribution) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStreamingDistribution) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnStreamingDistribution) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStreamingDistribution) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
