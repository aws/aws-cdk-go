...
func (r *jsiiProxy_ResponseHeadersPolicy) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateResponseHeadersPolicy_FromResponseHeadersPolicyIdParameters(scope constructs.Construct, id *string, responseHeadersPolicyId *string) error {
	...
	if responseHeadersPolicyId == nil {
		return fmt.Errorf("parameter responseHeadersPolicyId is required, but nil was provided")
	}
