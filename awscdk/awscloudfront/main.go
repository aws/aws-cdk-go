...
func init() {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnConnectionFunction)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrConnectionFunctionArn", GoGetter: "AttrConnectionFunctionArn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "cfnPropertyNames", GoGetter: "CfnPropertyNames"},
			_jsii_.MemberProperty{JsiiProperty: "cfnResourceType", GoGetter: "CfnResourceType"},
			_jsii_.MemberProperty{JsiiProperty: "connectionFunctionCode", GoGetter: "ConnectionFunctionCode"},
			_jsii_.MemberProperty{JsiiProperty: "connectionFunctionConfig", GoGetter: "ConnectionFunctionConfig"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscloudfrontIConnectionFunctionRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnConnectionFunction.ConnectionFunctionConfigProperty",
		reflect.TypeOf((*CfnConnectionFunction_ConnectionFunctionConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnConnectionFunction.KeyValueStoreAssociationProperty",
		reflect.TypeOf((*CfnConnectionFunction_KeyValueStoreAssociationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnConnectionFunctionProps",
		reflect.TypeOf((*CfnConnectionFunctionProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnDistribution.CacheTagConfigProperty",
		reflect.TypeOf((*CfnDistribution_CacheTagConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnDistribution.ConnectionFunctionAssociationProperty",
		reflect.TypeOf((*CfnDistribution_ConnectionFunctionAssociationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnDistribution.TrustStoreConfigProperty",
		reflect.TypeOf((*CfnDistribution_TrustStoreConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnDistribution.ViewerMtlsConfigProperty",
		reflect.TypeOf((*CfnDistribution_ViewerMtlsConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawscloudfrontITrustStoreRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnTrustStore.CaCertificatesBundleS3LocationProperty",
		reflect.TypeOf((*CfnTrustStore_CaCertificatesBundleS3LocationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnTrustStore.CaCertificatesBundleSourceProperty",
		reflect.TypeOf((*CfnTrustStore_CaCertificatesBundleSourceProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_cloudfront.CfnTrustStoreProps",
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			return &jsiiProxy_DistributionGrants{}
		},
	)
	_jsii_.RegisterStruct(
