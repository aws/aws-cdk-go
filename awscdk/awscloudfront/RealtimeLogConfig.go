...
// The jsii proxy struct for RealtimeLogConfig
type jsiiProxy_RealtimeLogConfig struct {
	internal.Type__awscdkResource
	jsiiProxy_IRealtimeLogConfig
}

func (j *jsiiProxy_RealtimeLogConfig) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_RealtimeLogConfig) Node() constructs.Node {
...
func (j *jsiiProxy_RealtimeLogConfig) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_RealtimeLogConfig) RealtimeLogConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RealtimeLogConfig) RealtimeLogConfigName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RealtimeLogConfig) RealtimeLogConfigRef() *interfacesawscloudfront.RealtimeLogConfigReference {
...
func (j *jsiiProxy_RealtimeLogConfig) Stack() awscdk.Stack {
...
func NewRealtimeLogConfig(scope constructs.Construct, id *string, props *RealtimeLogConfigProps) RealtimeLogConfig {
	...
	if err := validateNewRealtimeLogConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func RealtimeLogConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateRealtimeLogConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func RealtimeLogConfig_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRealtimeLogConfig_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RealtimeLogConfig_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateRealtimeLogConfig_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func RealtimeLogConfig_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_cloudfront.RealtimeLogConfig",
...
func (r *jsiiProxy_RealtimeLogConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (r *jsiiProxy_RealtimeLogConfig) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (r *jsiiProxy_RealtimeLogConfig) GeneratePhysicalName() *string {
	var returns *string
...
func (r *jsiiProxy_RealtimeLogConfig) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (r *jsiiProxy_RealtimeLogConfig) GetResourceNameAttribute(nameAttr *string) *string {
...
func (r *jsiiProxy_RealtimeLogConfig) ToString() *string {
	var returns *string
...
func (r *jsiiProxy_RealtimeLogConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
