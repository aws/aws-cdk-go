...
func (j *jsiiProxy_CfnKeyGroup) CfnPropertyNames() *map[string]*string {
...
func NewCfnKeyGroup(scope constructs.Construct, id *string, props *CfnKeyGroupProps) CfnKeyGroup {
	...
	if err := validateNewCfnKeyGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnKeyGroup)SetKeyGroupConfig(val interface{}) {
	if err := j.validateSetKeyGroupConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnKeyGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnKeyGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnKeyGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnKeyGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnKeyGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnKeyGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnKeyGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnKeyGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnKeyGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnKeyGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
