...
func (c *jsiiProxy_CachePolicy) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateCachePolicy_FromCachePolicyIdParameters(scope constructs.Construct, id *string, cachePolicyId *string) error {
	...
	if cachePolicyId == nil {
		return fmt.Errorf("parameter cachePolicyId is required, but nil was provided")
	}
