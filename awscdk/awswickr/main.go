...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attrMigrationState", GoGetter: "AttrMigrationState"},
			_jsii_.MemberProperty{JsiiProperty: "attrNetworkArn", GoGetter: "AttrNetworkArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrNetworkId", GoGetter: "AttrNetworkId"},
			_jsii_.MemberProperty{JsiiProperty: "attrStanding", GoGetter: "AttrStanding"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawswickrINetworkRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_wickr.CfnNetworkProps",
