...
func validateCfnGlobalReplicationGroup_FromGlobalReplicationGroupIdParameters(scope constructs.Construct, id *string, globalReplicationGroupId *string) error {
	...
	if globalReplicationGroupId == nil {
		return fmt.Errorf("parameter globalReplicationGroupId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnGlobalReplicationGroup) validateSetMembersParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnGlobalReplicationGroup_GlobalReplicationGroupMemberProperty:
				v_ := v.(CfnGlobalReplicationGroup_GlobalReplicationGroupMemberProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
...
func (j *jsiiProxy_CfnGlobalReplicationGroup) validateSetRegionalConfigurationsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnGlobalReplicationGroup_RegionalConfigurationProperty:
				v_ := v.(CfnGlobalReplicationGroup_RegionalConfigurationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
