...
func (j *jsiiProxy_CfnUserGroup) CfnPropertyNames() *map[string]*string {
...
func CfnUserGroup_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserGroup_IsCfnUserGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnUserGroup_IsCfnUserGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUserGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUserGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUserGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
