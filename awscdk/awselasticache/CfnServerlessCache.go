...
func (j *jsiiProxy_CfnServerlessCache) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnServerlessCache) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServerlessCache) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServerlessCache) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServerlessCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
