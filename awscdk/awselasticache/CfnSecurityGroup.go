...
func (j *jsiiProxy_CfnSecurityGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSecurityGroup(scope constructs.Construct, id *string, props *CfnSecurityGroupProps) CfnSecurityGroup {
	...
	if err := validateNewCfnSecurityGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSecurityGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSecurityGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSecurityGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityGroup_IsCfnSecurityGroup(x interface{}) *bool {
	...
	if err := validateCfnSecurityGroup_IsCfnSecurityGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSecurityGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSecurityGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
