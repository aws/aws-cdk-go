...
type CfnUser interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawselasticache.IUserRef
	awscdk.ITaggable
	...
	UserRef() *interfacesawselasticache.UserReference
...
type jsiiProxy_CfnUser struct {
	...
	internal.Type__interfacesawselasticacheIUserRef
...
func (j *jsiiProxy_CfnUser) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnUser) UserRef() *interfacesawselasticache.UserReference {
	var returns *interfacesawselasticache.UserReference
	_jsii_.Get(
		j,
		"userRef",
		&returns,
...
func (c *jsiiProxy_CfnUser) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnUser) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnUser) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnUser) RemoveResourceDependency(target awscdk.CfnResource) {
