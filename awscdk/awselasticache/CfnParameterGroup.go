...
func (j *jsiiProxy_CfnParameterGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnParameterGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnParameterGroup(scope constructs.Construct, id *string, props *CfnParameterGroupProps) CfnParameterGroup {
	...
	if err := validateNewCfnParameterGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnParameterGroup)SetCacheParameterGroupFamily(val *string) {
	if err := j.validateSetCacheParameterGroupFamilyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnParameterGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnParameterGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnParameterGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnParameterGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnParameterGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnParameterGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnParameterGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameterGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnParameterGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnParameterGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnParameterGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnParameterGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnParameterGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameterGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameterGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnParameterGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
