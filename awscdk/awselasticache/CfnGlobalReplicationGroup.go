...
func (j *jsiiProxy_CfnGlobalReplicationGroup) CfnPropertyNames() *map[string]*string {
...
func CfnGlobalReplicationGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGlobalReplicationGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGlobalReplicationGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
