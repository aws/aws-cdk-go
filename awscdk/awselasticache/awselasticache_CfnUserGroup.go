...
func (j *jsiiProxy_CfnUserGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnUserGroup(scope constructs.Construct, id *string, props *CfnUserGroupProps) CfnUserGroup {
	...
	if err := validateNewCfnUserGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnUserGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnUserGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnUserGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnUserGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnUserGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnUserGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnUserGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnUserGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnUserGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnUserGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
