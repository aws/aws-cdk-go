...
func (j *jsiiProxy_CfnReplicationGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnReplicationGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
