...
func (j *jsiiProxy_CfnSubnetGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubnetGroup(scope constructs.Construct, id *string, props *CfnSubnetGroupProps) CfnSubnetGroup {
	...
	if err := validateNewCfnSubnetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSubnetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubnetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnSubnetGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubnetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubnetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubnetGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSubnetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
