...
func (j *jsiiProxy_CfnSecurityGroupIngress) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityGroupIngress)SetCacheSecurityGroupName(val *string) {
	if err := j.validateSetCacheSecurityGroupNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnSecurityGroupIngress)SetEc2SecurityGroupName(val *string) {
	if err := j.validateSetEc2SecurityGroupNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CfnSecurityGroupIngress) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityGroupIngress) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityGroupIngress) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityGroupIngress) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroupIngress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
