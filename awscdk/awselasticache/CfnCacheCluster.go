...
func (j *jsiiProxy_CfnCacheCluster) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCacheCluster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCacheCluster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCacheCluster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCacheCluster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCacheCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
