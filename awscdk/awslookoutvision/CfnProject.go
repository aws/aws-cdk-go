...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awslookoutvision/internal"
...
type CfnProject interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawslookoutvision.IProjectRef
	...
	ProjectRef() *interfacesawslookoutvision.ProjectReference
...
type jsiiProxy_CfnProject struct {
	...
	internal.Type__interfacesawslookoutvisionIProjectRef
}
...
func (j *jsiiProxy_CfnProject) ProjectRef() *interfacesawslookoutvision.ProjectReference {
	var returns *interfacesawslookoutvision.ProjectReference
	_jsii_.Get(
		j,
		"projectRef",
		&returns,
...
func CfnProject_FromProjectArn(scope constructs.Construct, id *string, arn *string) interfacesawslookoutvision.IProjectRef {
	...
	var returns interfacesawslookoutvision.IProjectRef
...
func CfnProject_FromProjectName(scope constructs.Construct, id *string, projectName *string) interfacesawslookoutvision.IProjectRef {
	_init_.Initialize()
