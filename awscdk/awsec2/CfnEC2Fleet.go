...
func (j *jsiiProxy_CfnEC2Fleet) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnEC2Fleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEC2Fleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEC2Fleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEC2Fleet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEC2Fleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
