...
func (j *jsiiProxy_CfnCarrierGateway) CfnPropertyNames() *map[string]*string {
...
func CfnCarrierGateway_IsCfnCarrierGateway(x interface{}) *bool {
	...
	if err := validateCfnCarrierGateway_IsCfnCarrierGatewayParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCarrierGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCarrierGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCarrierGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCarrierGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCarrierGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCarrierGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCarrierGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
