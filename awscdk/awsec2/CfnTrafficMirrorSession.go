...
func (j *jsiiProxy_CfnTrafficMirrorSession) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrafficMirrorSession) OwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_CfnTrafficMirrorSession)SetOwnerId(val *string) {
	_jsii_.Set(
		j,
		"ownerId",
		val,
...
func (c *jsiiProxy_CfnTrafficMirrorSession) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
