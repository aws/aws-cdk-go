...
func validateCfnVerifiedAccessTrustProvider_FromVerifiedAccessTrustProviderIdParameters(scope constructs.Construct, id *string, verifiedAccessTrustProviderId *string) error {
	...
	if verifiedAccessTrustProviderId == nil {
		return fmt.Errorf("parameter verifiedAccessTrustProviderId is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) validateSetNativeApplicationOidcOptionsParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnVerifiedAccessTrustProvider_NativeApplicationOidcOptionsProperty:
		val := val.(*CfnVerifiedAccessTrustProvider_NativeApplicationOidcOptionsProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnVerifiedAccessTrustProvider_NativeApplicationOidcOptionsProperty:
		val_ := val.(CfnVerifiedAccessTrustProvider_NativeApplicationOidcOptionsProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnVerifiedAccessTrustProvider_NativeApplicationOidcOptionsProperty; received %#v (a %T)", val, val)
		}
	}
