...
func (j *jsiiProxy_CfnNetworkInterface) CfnPropertyNames() *map[string]*string {
...
func CfnNetworkInterface_IsCfnNetworkInterface(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterface_IsCfnNetworkInterfaceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkInterface_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterface_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkInterface) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterface) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInterface) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInterface) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInterface) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkInterface) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkInterface) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterface) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterface) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterface) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
