...
func (j *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnTransitGatewayMulticastDomainAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayMulticastDomainAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayMulticastDomainAssociation_IsCfnTransitGatewayMulticastDomainAssociation(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayMulticastDomainAssociation_IsCfnTransitGatewayMulticastDomainAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTransitGatewayMulticastDomainAssociation",
		"isCfnTransitGatewayMulticastDomainAssociation",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastDomainAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
