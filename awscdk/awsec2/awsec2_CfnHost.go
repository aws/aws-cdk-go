...
func (j *jsiiProxy_CfnHost) InstanceFamily() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceFamily",
...
func (j *jsiiProxy_CfnHost) Node() constructs.Node {
...
func (j *jsiiProxy_CfnHost) OutpostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outpostArn",
...
func (j *jsiiProxy_CfnHost) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnHost(scope constructs.Construct, id *string, props *CfnHostProps) CfnHost {
	...
	if err := validateNewCfnHostParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnHost{}
...
func (j *jsiiProxy_CfnHost)SetInstanceFamily(val *string) {
	_jsii_.Set(
		j,
		"instanceFamily",
		val,
...
func (j *jsiiProxy_CfnHost)SetOutpostArn(val *string) {
	_jsii_.Set(
		j,
		"outpostArn",
		val,
...
func CfnHost_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnHost_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHost_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnHost_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnHost_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnHost_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnHost) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHost) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnHost) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnHost) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnHost) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnHost) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
