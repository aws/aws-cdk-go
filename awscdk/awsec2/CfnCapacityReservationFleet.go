...
func (j *jsiiProxy_CfnCapacityReservationFleet) CfnPropertyNames() *map[string]*string {
...
func CfnCapacityReservationFleet_IsCfnCapacityReservationFleet(x interface{}) *bool {
	...
	if err := validateCfnCapacityReservationFleet_IsCfnCapacityReservationFleetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCapacityReservationFleet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCapacityReservationFleet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCapacityReservationFleet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCapacityReservationFleet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityReservationFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
