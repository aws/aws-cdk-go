...
func (j *jsiiProxy_CfnEIP) AttrPublicIp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrPublicIp",
...
func (j *jsiiProxy_CfnEIP) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEIP) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEIP(scope constructs.Construct, id *string, props *CfnEIPProps) CfnEIP {
	...
	if err := validateNewCfnEIPParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnEIP{}
...
func (j *jsiiProxy_CfnEIP)SetTransferAddress(val *string) {
	_jsii_.Set(
		j,
		"transferAddress",
		val,
...
func CfnEIP_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEIP_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEIP_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEIP_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEIP_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEIP_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEIP) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIP) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEIP) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEIP) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEIP) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEIP) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEIP) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIP) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIP) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIP) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
