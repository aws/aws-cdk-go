...
func (j *jsiiProxy_CfnEIPAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEIPAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEIPAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEIPAssociation(scope constructs.Construct, id *string, props *CfnEIPAssociationProps) CfnEIPAssociation {
	...
	if err := validateNewCfnEIPAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEIPAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEIPAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEIPAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEIPAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEIPAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEIPAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEIPAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIPAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEIPAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEIPAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEIPAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEIPAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEIPAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIPAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIPAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEIPAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
