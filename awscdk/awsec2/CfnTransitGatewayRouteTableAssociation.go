...
type CfnTransitGatewayRouteTableAssociation interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsec2.ITransitGatewayRouteTableAssociationRef
	...
	TransitGatewayRouteTableAssociationRef() *interfacesawsec2.TransitGatewayRouteTableAssociationReference
...
type jsiiProxy_CfnTransitGatewayRouteTableAssociation struct {
	...
	internal.Type__interfacesawsec2ITransitGatewayRouteTableAssociationRef
}
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAssociation) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAssociation) TransitGatewayRouteTableAssociationRef() *interfacesawsec2.TransitGatewayRouteTableAssociationReference {
	var returns *interfacesawsec2.TransitGatewayRouteTableAssociationReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnTransitGatewayRouteTableAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayRouteTableAssociation(scope constructs.Construct, id *string, props *CfnTransitGatewayRouteTableAssociationProps) CfnTransitGatewayRouteTableAssociation {
	...
	if err := validateNewCfnTransitGatewayRouteTableAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTransitGatewayRouteTableAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTableAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTableAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTableAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTableAssociation_IsCfnTransitGatewayRouteTableAssociation(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTableAssociation_IsCfnTransitGatewayRouteTableAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTransitGatewayRouteTableAssociation",
		"isCfnTransitGatewayRouteTableAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnTransitGatewayRouteTableAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTableAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTableAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
