...
func (j *jsiiProxy_CfnVPCEndpointConnectionNotification) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPCEndpointConnectionNotification) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPCEndpointConnectionNotification) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnVPCEndpointConnectionNotification_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointConnectionNotification_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCEndpointConnectionNotification_IsCfnVPCEndpointConnectionNotification(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointConnectionNotification_IsCfnVPCEndpointConnectionNotificationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnVPCEndpointConnectionNotification",
		"isCfnVPCEndpointConnectionNotification",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointConnectionNotification) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
