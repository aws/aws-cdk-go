...
func (j *jsiiProxy_Subnet) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_Subnet) SubnetRef() *interfacesawsec2.SubnetReference {
...
func (s *jsiiProxy_Subnet) AddIpv6DefaultInternetRoute(gatewayId *string, gatewayAttachment constructs.IDependable) {
...
func (s *jsiiProxy_Subnet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_Subnet) AssociateNetworkAcl(id *string, acl INetworkAcl) {
