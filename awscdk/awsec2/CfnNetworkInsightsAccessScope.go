...
type jsiiProxy_CfnNetworkInsightsAccessScope struct {
	...
	internal.Type__interfacesawsec2INetworkInsightsAccessScopeRef
...
func (j *jsiiProxy_CfnNetworkInsightsAccessScope) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkInsightsAccessScope) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnNetworkInsightsAccessScope) NetworkInsightsAccessScopeRef() *interfacesawsec2.NetworkInsightsAccessScopeReference {
	var returns *interfacesawsec2.NetworkInsightsAccessScopeReference
	_jsii_.Get(
		j,
...
func CfnNetworkInsightsAccessScope_FromNetworkInsightsAccessScopeArn(scope constructs.Construct, id *string, arn *string) interfacesawsec2.INetworkInsightsAccessScopeRef {
	...
	var returns interfacesawsec2.INetworkInsightsAccessScopeRef
...
func CfnNetworkInsightsAccessScope_IsCfnNetworkInsightsAccessScope(x interface{}) *bool {
	...
	if err := validateCfnNetworkInsightsAccessScope_IsCfnNetworkInsightsAccessScopeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnNetworkInsightsAccessScope",
		"isCfnNetworkInsightsAccessScope",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScope) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScope) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScope) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScope) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScope) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
