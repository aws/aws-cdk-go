...
func (g *jsiiProxy_GatewayVpcEndpoint) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateGatewayVpcEndpoint_FromGatewayVpcEndpointIdParameters(scope constructs.Construct, id *string, gatewayVpcEndpointId *string) error {
	...
	if gatewayVpcEndpointId == nil {
		return fmt.Errorf("parameter gatewayVpcEndpointId is required, but nil was provided")
	}
