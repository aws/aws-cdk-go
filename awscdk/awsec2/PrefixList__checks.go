...
func (p *jsiiProxy_PrefixList) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validatePrefixList_FromLookupParameters(scope constructs.Construct, id *string, options *PrefixListLookupOptions) error {
	if scope == nil {
