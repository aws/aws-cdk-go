...
func (j *jsiiProxy_CfnClientVpnRoute) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnClientVpnRoute) Node() constructs.Node {
...
func (j *jsiiProxy_CfnClientVpnRoute) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnClientVpnRoute(scope constructs.Construct, id *string, props *CfnClientVpnRouteProps) CfnClientVpnRoute {
	...
	if err := validateNewCfnClientVpnRouteParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnClientVpnRoute_IsCfnClientVpnRoute(x interface{}) *bool {
	...
	if err := validateCfnClientVpnRoute_IsCfnClientVpnRouteParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnRoute_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClientVpnRoute_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnClientVpnRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnRoute_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClientVpnRoute_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientVpnRoute) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClientVpnRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClientVpnRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClientVpnRoute) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClientVpnRoute) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClientVpnRoute) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnRoute) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
