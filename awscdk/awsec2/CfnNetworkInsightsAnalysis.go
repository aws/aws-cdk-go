...
func (j *jsiiProxy_CfnNetworkInsightsAnalysis) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkInsightsAnalysis) FilterOutArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"filterOutArns",
...
func (j *jsiiProxy_CfnNetworkInsightsAnalysis)SetFilterOutArns(val *[]*string) {
	_jsii_.Set(
		j,
		"filterOutArns",
		val,
...
func CfnNetworkInsightsAnalysis_ArnForNetworkInsightsAnalysis(resource interfacesawsec2.INetworkInsightsAnalysisRef) *string {
	...
	if err := validateCfnNetworkInsightsAnalysis_ArnForNetworkInsightsAnalysisParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnNetworkInsightsAnalysis) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInsightsAnalysis) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInsightsAnalysis) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInsightsAnalysis) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInsightsAnalysis) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
