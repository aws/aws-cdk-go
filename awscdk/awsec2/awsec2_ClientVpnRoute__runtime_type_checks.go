...
func (c *jsiiProxy_ClientVpnRoute) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (c *jsiiProxy_ClientVpnRoute) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateClientVpnRoute_IsResourceParameters(construct awscdk.IConstruct) error {
	if construct == nil {
