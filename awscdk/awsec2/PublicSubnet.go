...
func (j *jsiiProxy_PublicSubnet) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_PublicSubnet) SubnetRef() *interfacesawsec2.SubnetReference {
...
func (p *jsiiProxy_PublicSubnet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PublicSubnet) AssociateNetworkAcl(id *string, acl INetworkAcl) {
	if err := p.validateAssociateNetworkAclParameters(id, acl); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
...
func (p *jsiiProxy_PublicSubnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
