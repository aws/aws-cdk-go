...
func (v *jsiiProxy_VpnGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VpnGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
