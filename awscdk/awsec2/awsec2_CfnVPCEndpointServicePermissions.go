...
func (j *jsiiProxy_CfnVPCEndpointServicePermissions) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPCEndpointServicePermissions) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVPCEndpointServicePermissions(scope constructs.Construct, id *string, props *CfnVPCEndpointServicePermissionsProps) CfnVPCEndpointServicePermissions {
	...
	if err := validateNewCfnVPCEndpointServicePermissionsParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPCEndpointServicePermissions_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointServicePermissions_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCEndpointServicePermissions_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnVPCEndpointServicePermissions_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCEndpointServicePermissions_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointServicePermissions_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
