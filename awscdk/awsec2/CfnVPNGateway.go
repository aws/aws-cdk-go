...
func (j *jsiiProxy_CfnVPNGateway) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPNGateway) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPNGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVPNGateway(scope constructs.Construct, id *string, props *CfnVPNGatewayProps) CfnVPNGateway {
	...
	if err := validateNewCfnVPNGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPNGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPNGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPNGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPNGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPNGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPNGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPNGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPNGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPNGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPNGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPNGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPNGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
