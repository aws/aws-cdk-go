...
func (j *jsiiProxy_CfnIPAMPoolCidr) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnIPAMPoolCidr) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnIPAMPoolCidr) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIPAMPoolCidr) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) Cidr() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cidr",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) IpamPoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipamPoolId",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) NetmaskLength() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"netmaskLength",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIPAMPoolCidr) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnIPAMPoolCidr) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnIPAMPoolCidr) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIPAMPoolCidr(scope constructs.Construct, id *string, props *CfnIPAMPoolCidrProps) CfnIPAMPoolCidr {
	...
	if err := validateNewCfnIPAMPoolCidrParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIPAMPoolCidr)SetCidr(val *string) {
	_jsii_.Set(
		j,
		"cidr",
		val,
...
func (j *jsiiProxy_CfnIPAMPoolCidr)SetIpamPoolId(val *string) {
...
func (j *jsiiProxy_CfnIPAMPoolCidr)SetNetmaskLength(val *float64) {
	_jsii_.Set(
		j,
		"netmaskLength",
		val,
...
func CfnIPAMPoolCidr_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIPAMPoolCidr_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMPoolCidr_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIPAMPoolCidr_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMPoolCidr_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIPAMPoolCidr_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIPAMPoolCidr) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnIPAMPoolCidr) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnIPAMPoolCidr) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
