...
func (j *jsiiProxy_PrefixList) CanInlineRule() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"canInlineRule",
...
func (j *jsiiProxy_PrefixList) Connections() Connections {
...
func (j *jsiiProxy_PrefixList) UniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uniqueId",
...
func PrefixList_FromLookup(scope constructs.Construct, id *string, options *PrefixListLookupOptions) IPrefixList {
	_init_.Initialize()

	if err := validatePrefixList_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrefixList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PrefixList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
