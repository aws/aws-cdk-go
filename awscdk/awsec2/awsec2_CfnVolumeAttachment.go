...
func (j *jsiiProxy_CfnVolumeAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVolumeAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVolumeAttachment(scope constructs.Construct, id *string, props *CfnVolumeAttachmentProps) CfnVolumeAttachment {
	...
	if err := validateNewCfnVolumeAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVolumeAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVolumeAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVolumeAttachment_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnVolumeAttachment_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVolumeAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVolumeAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVolumeAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVolumeAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVolumeAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVolumeAttachment) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnVolumeAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVolumeAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
