...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) AttrLocalGatewayRouteTableId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) AttrOutpostArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOutpostArn",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) AttrOwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerId",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) LocalGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"localGatewayId",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLocalGatewayRouteTable(scope constructs.Construct, id *string, props *CfnLocalGatewayRouteTableProps) CfnLocalGatewayRouteTable {
	...
	if err := validateNewCfnLocalGatewayRouteTableParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable)SetLocalGatewayId(val *string) {
...
func (j *jsiiProxy_CfnLocalGatewayRouteTable)SetMode(val *string) {
	_jsii_.Set(
		j,
		"mode",
		val,
...
func CfnLocalGatewayRouteTable_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRouteTable_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocalGatewayRouteTable_IsCfnLocalGatewayRouteTable(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRouteTable_IsCfnLocalGatewayRouteTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocalGatewayRouteTable_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRouteTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocalGatewayRouteTable_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRouteTable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnLocalGatewayRouteTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
