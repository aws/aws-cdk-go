...
func (j *jsiiProxy_CfnVerifiedAccessEndpoint) CfnPropertyNames() *map[string]*string {
...
func CfnVerifiedAccessEndpoint_IsCfnVerifiedAccessEndpoint(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessEndpoint_IsCfnVerifiedAccessEndpointParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVerifiedAccessEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVerifiedAccessEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVerifiedAccessEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
