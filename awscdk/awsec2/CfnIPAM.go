...
func (j *jsiiProxy_CfnIPAM) CfnPropertyNames() *map[string]*string {
...
func CfnIPAM_IsCfnIPAM(x interface{}) *bool {
	...
	if err := validateCfnIPAM_IsCfnIPAMParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAM) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAM) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAM) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAM) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAM) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
