...
func (j *jsiiProxy_Instance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_Instance) InstanceRef() *interfacesawsec2.InstanceReference {
...
func (i *jsiiProxy_Instance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (i *jsiiProxy_Instance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
