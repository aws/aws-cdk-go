...
func (j *jsiiProxy_CfnSpotFleet) CfnPropertyNames() *map[string]*string {
...
func CfnSpotFleet_IsCfnSpotFleet(x interface{}) *bool {
	...
	if err := validateCfnSpotFleet_IsCfnSpotFleetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSpotFleet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSpotFleet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSpotFleet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSpotFleet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSpotFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
