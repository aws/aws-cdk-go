...
func (j *jsiiProxy_CfnIPAMPool) CfnPropertyNames() *map[string]*string {
...
func CfnIPAMPool_IsCfnIPAMPool(x interface{}) *bool {
	...
	if err := validateCfnIPAMPool_IsCfnIPAMPoolParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMPool) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAMPool) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAMPool) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAMPool) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
