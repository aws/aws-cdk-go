...
func (j *jsiiProxy_CfnClientVpnEndpoint) CfnPropertyNames() *map[string]*string {
...
func CfnClientVpnEndpoint_IsCfnClientVpnEndpoint(x interface{}) *bool {
	...
	if err := validateCfnClientVpnEndpoint_IsCfnClientVpnEndpointParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientVpnEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClientVpnEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClientVpnEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClientVpnEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
