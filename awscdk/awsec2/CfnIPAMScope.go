...
func (j *jsiiProxy_CfnIPAMScope) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIPAMScope) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIPAMScope) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIPAMScope(scope constructs.Construct, id *string, props *CfnIPAMScopeProps) CfnIPAMScope {
	...
	if err := validateNewCfnIPAMScopeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnIPAMScope_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIPAMScope_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMScope_IsCfnIPAMScope(x interface{}) *bool {
	...
	if err := validateCfnIPAMScope_IsCfnIPAMScopeParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMScope_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIPAMScope_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMScope_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIPAMScope_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMScope) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMScope) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAMScope) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAMScope) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAMScope) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIPAMScope) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIPAMScope) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMScope) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMScope) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMScope) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
