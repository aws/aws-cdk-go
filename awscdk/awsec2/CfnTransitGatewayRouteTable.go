...
func (j *jsiiProxy_CfnTransitGatewayRouteTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTable) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnTransitGatewayRouteTable_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTable_IsCfnTransitGatewayRouteTable(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTable_IsCfnTransitGatewayRouteTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
