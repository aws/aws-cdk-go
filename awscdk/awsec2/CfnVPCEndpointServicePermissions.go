...
func (j *jsiiProxy_CfnVPCEndpointServicePermissions) CfnPropertyNames() *map[string]*string {
...
func CfnVPCEndpointServicePermissions_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointServicePermissions_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCEndpointServicePermissions_IsCfnVPCEndpointServicePermissions(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointServicePermissions_IsCfnVPCEndpointServicePermissionsParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnVPCEndpointServicePermissions",
		"isCfnVPCEndpointServicePermissions",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointServicePermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
