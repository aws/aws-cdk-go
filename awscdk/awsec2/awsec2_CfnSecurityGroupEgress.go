...
func (c *jsiiProxy_CfnSecurityGroupEgress) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSecurityGroupEgress) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
