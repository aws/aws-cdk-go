...
func (j *jsiiProxy_CfnVPCGatewayAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPCGatewayAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPCGatewayAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVPCGatewayAttachment(scope constructs.Construct, id *string, props *CfnVPCGatewayAttachmentProps) CfnVPCGatewayAttachment {
	...
	if err := validateNewCfnVPCGatewayAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPCGatewayAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPCGatewayAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCGatewayAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPCGatewayAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCGatewayAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
