...
func (j *jsiiProxy_CfnIPAMAllocation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIPAMAllocation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIPAMAllocation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIPAMAllocation(scope constructs.Construct, id *string, props *CfnIPAMAllocationProps) CfnIPAMAllocation {
	...
	if err := validateNewCfnIPAMAllocationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnIPAMAllocation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIPAMAllocation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMAllocation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIPAMAllocation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMAllocation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIPAMAllocation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMAllocation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMAllocation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAMAllocation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAMAllocation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAMAllocation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIPAMAllocation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIPAMAllocation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMAllocation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMAllocation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMAllocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
