...
type CfnSecurityGroupEgress interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsec2.ISecurityGroupEgressRef
	AttrId() *string
	...
	SecurityGroupEgressRef() *interfacesawsec2.SecurityGroupEgressReference
...
type jsiiProxy_CfnSecurityGroupEgress struct {
	...
	internal.Type__interfacesawsec2ISecurityGroupEgressRef
}
...
func (j *jsiiProxy_CfnSecurityGroupEgress) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSecurityGroupEgress) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnSecurityGroupEgress) SecurityGroupEgressRef() *interfacesawsec2.SecurityGroupEgressReference {
	var returns *interfacesawsec2.SecurityGroupEgressReference
	_jsii_.Get(
		j,
...
func CfnSecurityGroupEgress_IsCfnSecurityGroupEgress(x interface{}) *bool {
	...
	if err := validateCfnSecurityGroupEgress_IsCfnSecurityGroupEgressParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSecurityGroupEgress) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSecurityGroupEgress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
