...
func (j *jsiiProxy_CfnClientVpnAuthorizationRule) Node() constructs.Node {
...
func (j *jsiiProxy_CfnClientVpnAuthorizationRule) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnClientVpnAuthorizationRule(scope constructs.Construct, id *string, props *CfnClientVpnAuthorizationRuleProps) CfnClientVpnAuthorizationRule {
	...
	if err := validateNewCfnClientVpnAuthorizationRuleParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnClientVpnAuthorizationRule_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClientVpnAuthorizationRule_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnAuthorizationRule_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnClientVpnAuthorizationRule_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnAuthorizationRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClientVpnAuthorizationRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
