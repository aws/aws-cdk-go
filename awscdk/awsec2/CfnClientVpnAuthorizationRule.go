...
func (j *jsiiProxy_CfnClientVpnAuthorizationRule) CfnPropertyNames() *map[string]*string {
...
func CfnClientVpnAuthorizationRule_IsCfnClientVpnAuthorizationRule(x interface{}) *bool {
	...
	if err := validateCfnClientVpnAuthorizationRule_IsCfnClientVpnAuthorizationRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnClientVpnAuthorizationRule",
		"isCfnClientVpnAuthorizationRule",
		[]interface{}{x},
		&returns,
	)
...
func CfnClientVpnAuthorizationRule_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnClientVpnAuthorizationRule_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
