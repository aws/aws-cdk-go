...
func (j *jsiiProxy_CfnTrafficMirrorFilter) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnTrafficMirrorFilter) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrafficMirrorFilter) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTrafficMirrorFilter) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTrafficMirrorFilter) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTrafficMirrorFilter(scope constructs.Construct, id *string, props *CfnTrafficMirrorFilterProps) CfnTrafficMirrorFilter {
	...
	if err := validateNewCfnTrafficMirrorFilterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTrafficMirrorFilter)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnTrafficMirrorFilter_FromTrafficMirrorFilterId(scope constructs.Construct, id *string, trafficMirrorFilterId *string) interfacesawsec2.ITrafficMirrorFilterRef {
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTrafficMirrorFilter",
		"fromTrafficMirrorFilterId",
		[]interface{}{scope, id, trafficMirrorFilterId},
		&returns,
	)
...
func CfnTrafficMirrorFilter_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorFilter_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrafficMirrorFilter_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorFilter_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrafficMirrorFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
