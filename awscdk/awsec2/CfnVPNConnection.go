...
func (j *jsiiProxy_CfnVPNConnection) CfnPropertyNames() *map[string]*string {
...
func CfnVPNConnection_IsCfnVPNConnection(x interface{}) *bool {
	...
	if err := validateCfnVPNConnection_IsCfnVPNConnectionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPNConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPNConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPNConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPNConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
