...
func (j *jsiiProxy_ClientVpnRoute) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ClientVpnRoute) Node() constructs.Node {
...
func ClientVpnRoute_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateClientVpnRoute_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ClientVpnRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_ClientVpnRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
