...
func (j *jsiiProxy_IVPCEndpointServicePermissionsRef) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_IVPCEndpointServicePermissionsRef) Node() constructs.Node {
