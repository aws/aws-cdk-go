...
func (j *jsiiProxy_CfnVPCEndpointService) CfnPropertyNames() *map[string]*string {
...
func CfnVPCEndpointService_IsCfnVPCEndpointService(x interface{}) *bool {
	...
	if err := validateCfnVPCEndpointService_IsCfnVPCEndpointServiceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCEndpointService) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCEndpointService) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCEndpointService) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCEndpointService) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEndpointService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
