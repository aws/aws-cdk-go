...
func (j *jsiiProxy_InterfaceVpcEndpoint) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_InterfaceVpcEndpoint) VpcEndpointRef() *interfacesawsec2.VPCEndpointReference {
...
func (i *jsiiProxy_InterfaceVpcEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (i *jsiiProxy_InterfaceVpcEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
