...
func (j *jsiiProxy_CfnFlowLog) CfnPropertyNames() *map[string]*string {
...
func CfnFlowLog_IsCfnFlowLog(x interface{}) *bool {
	...
	if err := validateCfnFlowLog_IsCfnFlowLogParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFlowLog_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFlowLog_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFlowLog) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowLog) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFlowLog) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFlowLog) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFlowLog) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFlowLog) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFlowLog) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowLog) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowLog) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFlowLog) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
