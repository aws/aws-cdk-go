...
func (j *jsiiProxy_CfnSubnetNetworkAclAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubnetNetworkAclAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSubnetNetworkAclAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubnetNetworkAclAssociation(scope constructs.Construct, id *string, props *CfnSubnetNetworkAclAssociationProps) CfnSubnetNetworkAclAssociation {
	...
	if err := validateNewCfnSubnetNetworkAclAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSubnetNetworkAclAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubnetNetworkAclAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetNetworkAclAssociation_IsCfnSubnetNetworkAclAssociation(x interface{}) *bool {
	...
	if err := validateCfnSubnetNetworkAclAssociation_IsCfnSubnetNetworkAclAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnSubnetNetworkAclAssociation",
		"isCfnSubnetNetworkAclAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnSubnetNetworkAclAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubnetNetworkAclAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
