...
func (j *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMeteringPolicyEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
