...
type CfnSubnet interface {
	...
	AttrBlockPublicAccessStates() awscdk.IResolvable
...
func (j *jsiiProxy_CfnSubnet) AttrBlockPublicAccessStates() awscdk.IResolvable {
	var returns awscdk.IResolvable
	_jsii_.Get(
		j,
		"attrBlockPublicAccessStates",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnSubnet) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnSubnet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubnet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubnet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubnet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
