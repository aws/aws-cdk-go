...
func (j *jsiiProxy_CfnSubnetCidrBlock) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubnetCidrBlock) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSubnetCidrBlock) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubnetCidrBlock(scope constructs.Construct, id *string, props *CfnSubnetCidrBlockProps) CfnSubnetCidrBlock {
	...
	if err := validateNewCfnSubnetCidrBlockParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSubnetCidrBlock_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubnetCidrBlock_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetCidrBlock_IsCfnSubnetCidrBlock(x interface{}) *bool {
	...
	if err := validateCfnSubnetCidrBlock_IsCfnSubnetCidrBlockParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetCidrBlock_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubnetCidrBlock_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubnetCidrBlock) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubnetCidrBlock) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetCidrBlock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
