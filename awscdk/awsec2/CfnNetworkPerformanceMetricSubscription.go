...
func (j *jsiiProxy_CfnNetworkPerformanceMetricSubscription) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnNetworkPerformanceMetricSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkPerformanceMetricSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkPerformanceMetricSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkPerformanceMetricSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkPerformanceMetricSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
