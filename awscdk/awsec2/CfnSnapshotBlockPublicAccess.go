...
//
//   cfnSnapshotBlockPublicAccess := awscdk.Aws_ec2.NewCfnSnapshotBlockPublicAccess(this, jsii.String("MyCfnSnapshotBlockPublicAccess"), &CfnSnapshotBlockPublicAccessProps{
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSnapshotBlockPublicAccess(scope constructs.Construct, id *string, props *CfnSnapshotBlockPublicAccessProps) CfnSnapshotBlockPublicAccess {
	...
	if err := validateNewCfnSnapshotBlockPublicAccessParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnSnapshotBlockPublicAccess)SetState(val *string) {
...
func CfnSnapshotBlockPublicAccess_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSnapshotBlockPublicAccess_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSnapshotBlockPublicAccess_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSnapshotBlockPublicAccess_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSnapshotBlockPublicAccess_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSnapshotBlockPublicAccess_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnSnapshotBlockPublicAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
