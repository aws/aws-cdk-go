...
func (j *jsiiProxy_CfnTrafficMirrorTarget) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTrafficMirrorTarget) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTrafficMirrorTarget) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTrafficMirrorTarget(scope constructs.Construct, id *string, props *CfnTrafficMirrorTargetProps) CfnTrafficMirrorTarget {
	...
	if err := validateNewCfnTrafficMirrorTargetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTrafficMirrorTarget_ArnForTrafficMirrorTarget(resource interfacesawsec2.ITrafficMirrorTargetRef) *string {
	...
	if err := validateCfnTrafficMirrorTarget_ArnForTrafficMirrorTargetParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTrafficMirrorTarget_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorTarget_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrafficMirrorTarget_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorTarget_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrafficMirrorTarget_IsCfnTrafficMirrorTarget(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorTarget_IsCfnTrafficMirrorTargetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTrafficMirrorTarget_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorTarget_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
