...
func (j *jsiiProxy_CfnVolumeAttachment) CfnPropertyNames() *map[string]*string {
...
func CfnVolumeAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVolumeAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVolumeAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVolumeAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVolumeAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVolumeAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVolumeAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
