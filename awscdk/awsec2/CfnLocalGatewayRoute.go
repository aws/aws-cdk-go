...
type jsiiProxy_CfnLocalGatewayRoute struct {
	...
	internal.Type__interfacesawsec2ILocalGatewayRouteRef
}
...
func (j *jsiiProxy_CfnLocalGatewayRoute) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnLocalGatewayRoute) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnLocalGatewayRoute) LocalGatewayRouteRef() *interfacesawsec2.LocalGatewayRouteReference {
	var returns *interfacesawsec2.LocalGatewayRouteReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnLocalGatewayRoute) NetworkInterfaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInterfaceId",
...
func (j *jsiiProxy_CfnLocalGatewayRoute) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLocalGatewayRoute) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLocalGatewayRoute(scope constructs.Construct, id *string, props *CfnLocalGatewayRouteProps) CfnLocalGatewayRoute {
	...
	if err := validateNewCfnLocalGatewayRouteParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLocalGatewayRoute)SetNetworkInterfaceId(val *string) {
	_jsii_.Set(
		j,
		"networkInterfaceId",
		val,
...
func CfnLocalGatewayRoute_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRoute_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocalGatewayRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLocalGatewayRoute_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLocalGatewayRoute_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLocalGatewayRoute) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLocalGatewayRoute) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
