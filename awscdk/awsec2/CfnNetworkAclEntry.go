...
func (j *jsiiProxy_CfnNetworkAclEntry) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkAclEntry) Node() constructs.Node {
...
func (j *jsiiProxy_CfnNetworkAclEntry) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnNetworkAclEntry_IsCfnNetworkAclEntry(x interface{}) *bool {
	...
	if err := validateCfnNetworkAclEntry_IsCfnNetworkAclEntryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAclEntry_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkAclEntry_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkAclEntry) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkAclEntry) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkAclEntry) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkAclEntry) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAclEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
