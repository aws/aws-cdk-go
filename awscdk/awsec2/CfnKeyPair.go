...
func (j *jsiiProxy_CfnKeyPair) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnKeyPair) Node() constructs.Node {
...
func (j *jsiiProxy_CfnKeyPair) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnKeyPair(scope constructs.Construct, id *string, props *CfnKeyPairProps) CfnKeyPair {
	...
	if err := validateNewCfnKeyPairParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnKeyPair_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnKeyPair_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyPair_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnKeyPair_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnKeyPair_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnKeyPair_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnKeyPair) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyPair) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnKeyPair) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnKeyPair) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnKeyPair) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnKeyPair) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnKeyPair) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyPair) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyPair) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKeyPair) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
