...
func (p *jsiiProxy_PrivateSubnet) AddIpv6DefaultInternetRoute(gatewayId *string, gatewayAttachment constructs.IDependable) {
...
func (p *jsiiProxy_PrivateSubnet) AssociateNetworkAcl(id *string, acl INetworkAcl) {
...
func (p *jsiiProxy_PrivateSubnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
