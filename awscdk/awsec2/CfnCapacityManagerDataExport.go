...
func (j *jsiiProxy_CfnCapacityManagerDataExport) AttrCapacityManagerDataExportId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCapacityManagerDataExportId",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) OutputFormat() *string {
	var returns *string
	_jsii_.Get(
		j,
		"outputFormat",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) S3BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3BucketName",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) S3BucketPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3BucketPrefix",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) Schedule() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schedule",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnCapacityManagerDataExport) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCapacityManagerDataExport(scope constructs.Construct, id *string, props *CfnCapacityManagerDataExportProps) CfnCapacityManagerDataExport {
	...
	if err := validateNewCfnCapacityManagerDataExportParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnCapacityManagerDataExport)SetOutputFormat(val *string) {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport)SetS3BucketName(val *string) {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport)SetS3BucketPrefix(val *string) {
	_jsii_.Set(
		j,
		"s3BucketPrefix",
		val,
...
func (j *jsiiProxy_CfnCapacityManagerDataExport)SetSchedule(val *string) {
...
func (j *jsiiProxy_CfnCapacityManagerDataExport)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnCapacityManagerDataExport_IsCfnCapacityManagerDataExport(x interface{}) *bool {
	...
	if err := validateCfnCapacityManagerDataExport_IsCfnCapacityManagerDataExportParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnCapacityManagerDataExport",
		"isCfnCapacityManagerDataExport",
		[]interface{}{x},
		&returns,
	)
...
func CfnCapacityManagerDataExport_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCapacityManagerDataExport_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCapacityManagerDataExport_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCapacityManagerDataExport_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCapacityManagerDataExport_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCapacityManagerDataExport_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnCapacityManagerDataExport) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
