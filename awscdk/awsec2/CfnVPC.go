...
func (j *jsiiProxy_CfnVPC) CfnPropertyNames() *map[string]*string {
...
func CfnVPC_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPC_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPC_IsCfnVPC(x interface{}) *bool {
	...
	if err := validateCfnVPC_IsCfnVPCParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPC) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPC) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPC) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPC) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPC) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPC) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPC) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPC) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPC) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPC) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
