...
//
//   cfnVerifiedAccessTrustProvider := awscdk.Aws_ec2.NewCfnVerifiedAccessTrustProvider(this, jsii.String("MyCfnVerifiedAccessTrustProvider"), &CfnVerifiedAccessTrustProviderProps{
...
type CfnVerifiedAccessTrustProvider interface {
	...
	SetDeviceOptions(val interface{})
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) AttrLastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedTime",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) AttrVerifiedAccessTrustProviderId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) DeviceOptions() interface{} {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) DeviceTrustProviderType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) OidcOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"oidcOptions",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) PolicyReferenceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyReferenceName",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) SseSpecification() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sseSpecification",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetDeviceOptions(val interface{}) {
	if err := j.validateSetDeviceOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetDeviceTrustProviderType(val *string) {
	_jsii_.Set(
		j,
		"deviceTrustProviderType",
		val,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetOidcOptions(val interface{}) {
	if err := j.validateSetOidcOptionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetPolicyReferenceName(val *string) {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetSseSpecification(val interface{}) {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetTrustProviderType(val *string) {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider)SetUserTrustProviderType(val *string) {
	_jsii_.Set(
		j,
		"userTrustProviderType",
		val,
...
func CfnVerifiedAccessTrustProvider_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessTrustProvider_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVerifiedAccessTrustProvider_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessTrustProvider_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVerifiedAccessTrustProvider_IsCfnVerifiedAccessTrustProvider(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessTrustProvider_IsCfnVerifiedAccessTrustProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnVerifiedAccessTrustProvider",
		"isCfnVerifiedAccessTrustProvider",
		[]interface{}{x},
		&returns,
	)
...
func CfnVerifiedAccessTrustProvider_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessTrustProvider_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
