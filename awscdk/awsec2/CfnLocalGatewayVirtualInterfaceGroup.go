...
func (j *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfaceGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
