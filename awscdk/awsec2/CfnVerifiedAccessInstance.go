...
type CfnVerifiedAccessInstance interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsec2.IVerifiedAccessInstanceRef
	awscdk.ITaggable
	// The name servers.
	...
	VerifiedAccessInstanceRef() *interfacesawsec2.VerifiedAccessInstanceReference
	// The IDs of the AWS Verified Access trust providers.
	VerifiedAccessTrustProviderIds() *[]*string
	SetVerifiedAccessTrustProviderIds(val *[]*string)
	// The IDs of the AWS Verified Access trust providers.
	VerifiedAccessTrustProviders() interface{}
	SetVerifiedAccessTrustProviders(val interface{})
...
// The jsii proxy struct for CfnVerifiedAccessInstance
type jsiiProxy_CfnVerifiedAccessInstance struct {
	internal.Type__awscdkCfnResource
	internal.Type__awscdkIInspectable
	internal.Type__interfacesawsec2IVerifiedAccessInstanceRef
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) AttrLastUpdatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedTime",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) AttrVerifiedAccessInstanceId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) VerifiedAccessInstanceRef() *interfacesawsec2.VerifiedAccessInstanceReference {
	var returns *interfacesawsec2.VerifiedAccessInstanceReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) VerifiedAccessTrustProviderIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance) VerifiedAccessTrustProviders() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewCfnVerifiedAccessInstance(scope constructs.Construct, id *string, props *CfnVerifiedAccessInstanceProps) CfnVerifiedAccessInstance {
	...
	if err := validateNewCfnVerifiedAccessInstanceParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnVerifiedAccessInstance)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance)SetLoggingConfigurations(val interface{}) {
	if err := j.validateSetLoggingConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance)SetVerifiedAccessTrustProviderIds(val *[]*string) {
	_jsii_.Set(
		j,
		"verifiedAccessTrustProviderIds",
		val,
...
func (j *jsiiProxy_CfnVerifiedAccessInstance)SetVerifiedAccessTrustProviders(val interface{}) {
	if err := j.validateSetVerifiedAccessTrustProvidersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnVerifiedAccessInstance_FromVerifiedAccessInstanceId(scope constructs.Construct, id *string, verifiedAccessInstanceId *string) interfacesawsec2.IVerifiedAccessInstanceRef {
	...
	var returns interfacesawsec2.IVerifiedAccessInstanceRef
...
func CfnVerifiedAccessInstance_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessInstance_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVerifiedAccessInstance_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessInstance_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVerifiedAccessInstance_IsCfnVerifiedAccessInstance(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessInstance_IsCfnVerifiedAccessInstanceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVerifiedAccessInstance_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVerifiedAccessInstance_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnVerifiedAccessInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
