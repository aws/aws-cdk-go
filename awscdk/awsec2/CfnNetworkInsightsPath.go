...
func (j *jsiiProxy_CfnNetworkInsightsPath) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnNetworkInsightsPath) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInsightsPath) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInsightsPath) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInsightsPath) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInsightsPath) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
