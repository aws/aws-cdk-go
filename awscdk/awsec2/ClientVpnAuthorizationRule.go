...
func (j *jsiiProxy_ClientVpnAuthorizationRule) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_ClientVpnAuthorizationRule) Node() constructs.Node {
...
func ClientVpnAuthorizationRule_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateClientVpnAuthorizationRule_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ClientVpnAuthorizationRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_ClientVpnAuthorizationRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
