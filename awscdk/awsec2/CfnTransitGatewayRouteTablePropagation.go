...
func (j *jsiiProxy_CfnTransitGatewayRouteTablePropagation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTablePropagation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayRouteTablePropagation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayRouteTablePropagation(scope constructs.Construct, id *string, props *CfnTransitGatewayRouteTablePropagationProps) CfnTransitGatewayRouteTablePropagation {
	...
	if err := validateNewCfnTransitGatewayRouteTablePropagationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTransitGatewayRouteTablePropagation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTablePropagation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTablePropagation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTablePropagation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRouteTablePropagation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRouteTablePropagation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropagation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
