...
func (j *jsiiProxy_CfnNetworkInterfaceAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkInterfaceAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnNetworkInterfaceAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNetworkInterfaceAttachment(scope constructs.Construct, id *string, props *CfnNetworkInterfaceAttachmentProps) CfnNetworkInterfaceAttachment {
	...
	if err := validateNewCfnNetworkInterfaceAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNetworkInterfaceAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfaceAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkInterfaceAttachment_IsCfnNetworkInterfaceAttachment(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfaceAttachment_IsCfnNetworkInterfaceAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnNetworkInterfaceAttachment",
		"isCfnNetworkInterfaceAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnNetworkInterfaceAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfaceAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
