...
func (j *jsiiProxy_CfnCustomerGateway) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnCustomerGateway) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCustomerGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCustomerGateway(scope constructs.Construct, id *string, props *CfnCustomerGatewayProps) CfnCustomerGateway {
	...
	if err := validateNewCfnCustomerGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCustomerGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCustomerGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomerGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnCustomerGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCustomerGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCustomerGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCustomerGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCustomerGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCustomerGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCustomerGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCustomerGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCustomerGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCustomerGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
