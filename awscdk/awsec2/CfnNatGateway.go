...
func (j *jsiiProxy_CfnNatGateway) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNatGateway) PrivateIpAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"privateIpAddress",
...
func (j *jsiiProxy_CfnNatGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNatGateway(scope constructs.Construct, id *string, props *CfnNatGatewayProps) CfnNatGateway {
	...
	if err := validateNewCfnNatGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNatGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNatGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNatGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNatGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNatGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNatGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNatGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNatGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNatGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNatGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNatGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNatGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNatGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNatGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNatGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNatGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
