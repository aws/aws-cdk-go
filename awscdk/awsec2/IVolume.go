...
func (i *jsiiProxy_IVolume) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (i *jsiiProxy_IVolume) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_IVolume) Node() constructs.Node {
...
func (j *jsiiProxy_IVolume) Stack() awscdk.Stack {
