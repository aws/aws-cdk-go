...
//
//   cfnRouteServerEndpoint := awscdk.Aws_ec2.NewCfnRouteServerEndpoint(this, jsii.String("MyCfnRouteServerEndpoint"), &CfnRouteServerEndpointProps{
...
func (j *jsiiProxy_CfnRouteServerEndpoint) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) AttrEniAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEniAddress",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) AttrEniId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEniId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) AttrVpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVpcId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) RouteServerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routeServerId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) SubnetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subnetId",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRouteServerEndpoint) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRouteServerEndpoint) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouteServerEndpoint(scope constructs.Construct, id *string, props *CfnRouteServerEndpointProps) CfnRouteServerEndpoint {
	...
	if err := validateNewCfnRouteServerEndpointParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRouteServerEndpoint)SetRouteServerId(val *string) {
...
func (j *jsiiProxy_CfnRouteServerEndpoint)SetSubnetId(val *string) {
...
func (j *jsiiProxy_CfnRouteServerEndpoint)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnRouteServerEndpoint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouteServerEndpoint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerEndpoint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRouteServerEndpoint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerEndpoint_IsCfnRouteServerEndpoint(x interface{}) *bool {
	...
	if err := validateCfnRouteServerEndpoint_IsCfnRouteServerEndpointParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouteServerEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouteServerEndpoint) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRouteServerEndpoint) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRouteServerEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
