...
func VpcEndpointService_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateVpcEndpointService_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpcEndpointService) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
