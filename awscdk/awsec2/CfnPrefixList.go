...
func (j *jsiiProxy_CfnPrefixList) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPrefixList) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPrefixList) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPrefixList(scope constructs.Construct, id *string, props *CfnPrefixListProps) CfnPrefixList {
	...
	if err := validateNewCfnPrefixListParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPrefixList_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPrefixList_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrefixList_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPrefixList_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPrefixList_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPrefixList_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPrefixList) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrefixList) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrefixList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrefixList) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrefixList) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPrefixList) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPrefixList) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrefixList) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrefixList) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPrefixList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
