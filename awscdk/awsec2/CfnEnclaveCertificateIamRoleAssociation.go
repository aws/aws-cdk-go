...
func (j *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnEnclaveCertificateIamRoleAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEnclaveCertificateIamRoleAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEnclaveCertificateIamRoleAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
