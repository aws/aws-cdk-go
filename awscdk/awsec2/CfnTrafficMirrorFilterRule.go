...
func (j *jsiiProxy_CfnTrafficMirrorFilterRule) CfnPropertyNames() *map[string]*string {
...
func CfnTrafficMirrorFilterRule_ArnForTrafficMirrorFilterRule(resource interfacesawsec2.ITrafficMirrorFilterRuleRef) *string {
	...
	if err := validateCfnTrafficMirrorFilterRule_ArnForTrafficMirrorFilterRuleParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnTrafficMirrorFilterRule_IsCfnTrafficMirrorFilterRule(x interface{}) *bool {
	...
	if err := validateCfnTrafficMirrorFilterRule_IsCfnTrafficMirrorFilterRuleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
