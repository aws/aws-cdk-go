...
func (j *jsiiProxy_CfnVPCPeeringConnection) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPCPeeringConnection) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPCPeeringConnection) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnVPCPeeringConnection_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPCPeeringConnection_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCPeeringConnection) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPCPeeringConnection) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCPeeringConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
