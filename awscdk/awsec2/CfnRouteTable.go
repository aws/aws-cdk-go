...
func (j *jsiiProxy_CfnRouteTable) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouteTable) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRouteTable) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouteTable(scope constructs.Construct, id *string, props *CfnRouteTableProps) CfnRouteTable {
	...
	if err := validateNewCfnRouteTableParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRouteTable_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouteTable_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteTable_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRouteTable_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteTable_IsCfnRouteTable(x interface{}) *bool {
	...
	if err := validateCfnRouteTable_IsCfnRouteTableParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteTable_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouteTable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteTable) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteTable) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouteTable) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouteTable) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouteTable) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouteTable) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouteTable) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteTable) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteTable) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
