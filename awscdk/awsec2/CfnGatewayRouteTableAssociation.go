...
type jsiiProxy_CfnGatewayRouteTableAssociation struct {
	...
	internal.Type__interfacesawsec2IGatewayRouteTableAssociationRef
}
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociation) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociation) GatewayRouteTableAssociationRef() *interfacesawsec2.GatewayRouteTableAssociationReference {
	var returns *interfacesawsec2.GatewayRouteTableAssociationReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGatewayRouteTableAssociation(scope constructs.Construct, id *string, props *CfnGatewayRouteTableAssociationProps) CfnGatewayRouteTableAssociation {
	...
	if err := validateNewCfnGatewayRouteTableAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGatewayRouteTableAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGatewayRouteTableAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayRouteTableAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGatewayRouteTableAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGatewayRouteTableAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGatewayRouteTableAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
