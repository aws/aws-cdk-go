...
func (j *jsiiProxy_CfnTransitGatewayRoute) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayRoute) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayRoute) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayRoute(scope constructs.Construct, id *string, props *CfnTransitGatewayRouteProps) CfnTransitGatewayRoute {
	...
	if err := validateNewCfnTransitGatewayRouteParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTransitGatewayRoute_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRoute_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRoute_IsCfnTransitGatewayRoute(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRoute_IsCfnTransitGatewayRouteParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayRoute_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayRoute_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayRoute) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayRoute) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
