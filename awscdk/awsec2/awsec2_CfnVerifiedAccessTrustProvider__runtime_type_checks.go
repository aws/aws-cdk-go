...
func validateCfnVerifiedAccessTrustProvider_IsCfnResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) validateSetDeviceOptionsParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnVerifiedAccessTrustProvider_DeviceOptionsProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProvider) validateSetOidcOptionsParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *CfnVerifiedAccessTrustProvider_OidcOptionsProperty, awscdk.IResolvable; received %#v (a %T)", val, val)
		}
	}
