...
func (j *jsiiProxy_CfnEgressOnlyInternetGateway) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnEgressOnlyInternetGateway) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEgressOnlyInternetGateway) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnEgressOnlyInternetGateway)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnEgressOnlyInternetGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEgressOnlyInternetGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEgressOnlyInternetGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEgressOnlyInternetGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEgressOnlyInternetGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEgressOnlyInternetGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEgressOnlyInternetGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
