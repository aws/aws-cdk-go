...
func (j *jsiiProxy_CfnTransitGateway) CfnPropertyNames() *map[string]*string {
...
func CfnTransitGateway_IsCfnTransitGateway(x interface{}) *bool {
	...
	if err := validateCfnTransitGateway_IsCfnTransitGatewayParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
