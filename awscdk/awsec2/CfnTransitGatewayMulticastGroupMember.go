...
func (j *jsiiProxy_CfnTransitGatewayMulticastGroupMember) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayMulticastGroupMember) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayMulticastGroupMember) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnTransitGatewayMulticastGroupMember_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayMulticastGroupMember_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayMulticastGroupMember_IsCfnTransitGatewayMulticastGroupMember(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayMulticastGroupMember_IsCfnTransitGatewayMulticastGroupMemberParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTransitGatewayMulticastGroupMember",
		"isCfnTransitGatewayMulticastGroupMember",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
