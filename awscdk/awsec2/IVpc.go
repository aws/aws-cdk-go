...
func (i *jsiiProxy_IVpc) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (j *jsiiProxy_IVpc) Node() constructs.Node {
...
func (j *jsiiProxy_IVpc) Stack() awscdk.Stack {
