...
func (j *jsiiProxy_CfnVPNGatewayRoutePropagation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPNGatewayRoutePropagation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPNGatewayRoutePropagation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVPNGatewayRoutePropagation(scope constructs.Construct, id *string, props *CfnVPNGatewayRoutePropagationProps) CfnVPNGatewayRoutePropagation {
	...
	if err := validateNewCfnVPNGatewayRoutePropagationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPNGatewayRoutePropagation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPNGatewayRoutePropagation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPNGatewayRoutePropagation_IsCfnVPNGatewayRoutePropagation(x interface{}) *bool {
	...
	if err := validateCfnVPNGatewayRoutePropagation_IsCfnVPNGatewayRoutePropagationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnVPNGatewayRoutePropagation",
		"isCfnVPNGatewayRoutePropagation",
		[]interface{}{x},
		&returns,
	)
...
func CfnVPNGatewayRoutePropagation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPNGatewayRoutePropagation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNGatewayRoutePropagation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
