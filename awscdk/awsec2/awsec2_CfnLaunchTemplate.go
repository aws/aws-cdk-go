...
func (j *jsiiProxy_CfnLaunchTemplate) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLaunchTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnLaunchTemplate) VersionDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"versionDescription",
...
func NewCfnLaunchTemplate(scope constructs.Construct, id *string, props *CfnLaunchTemplateProps) CfnLaunchTemplate {
	...
	if err := validateNewCfnLaunchTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnLaunchTemplate)SetLaunchTemplateData(val interface{}) {
	if err := j.validateSetLaunchTemplateDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLaunchTemplate)SetVersionDescription(val *string) {
	_jsii_.Set(
		j,
		"versionDescription",
		val,
...
func CfnLaunchTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLaunchTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLaunchTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLaunchTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLaunchTemplate) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLaunchTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
