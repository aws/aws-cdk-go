...
func (j *jsiiProxy_CfnTrafficMirrorSession) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTrafficMirrorSession) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (c *jsiiProxy_CfnTrafficMirrorSession) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTrafficMirrorSession) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTrafficMirrorSession) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
