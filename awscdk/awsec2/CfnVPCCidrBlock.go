...
func (j *jsiiProxy_CfnVPCCidrBlock) CfnPropertyNames() *map[string]*string {
...
func CfnVPCCidrBlock_IsCfnVPCCidrBlock(x interface{}) *bool {
	...
	if err := validateCfnVPCCidrBlock_IsCfnVPCCidrBlockParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCCidrBlock) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCCidrBlock) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCCidrBlock) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCCidrBlock) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCCidrBlock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
