...
func (p *jsiiProxy_PlacementGroup) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validatePlacementGroup_FromPlacementGroupNameParameters(scope constructs.Construct, id *string, placementGroupName *string) error {
	...
	if placementGroupName == nil {
		return fmt.Errorf("parameter placementGroupName is required, but nil was provided")
	}
