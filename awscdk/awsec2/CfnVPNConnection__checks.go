...
func (c *jsiiProxy_CfnVPNConnection) validateAddDeletionOverrideParameters(path *string) error {
	if path == nil {
...
func (c *jsiiProxy_CfnVPNConnection) validateAddMetadataParameters(key *string, value interface{}) error {
	if key == nil {
...
func (c *jsiiProxy_CfnVPNConnection) validateAddOverrideParameters(path *string, value interface{}) error {
	if path == nil {
		return fmt.Errorf("parameter path is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnVPNConnection) validateAddPropertyDeletionOverrideParameters(propertyPath *string) error {
	if propertyPath == nil {
...
func (c *jsiiProxy_CfnVPNConnection) validateAddPropertyOverrideParameters(propertyPath *string, value interface{}) error {
	if propertyPath == nil {
		return fmt.Errorf("parameter propertyPath is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnVPNConnection) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnVPNConnection) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func (c *jsiiProxy_CfnVPNConnection) validateApplyRemovalPolicyParameters(options *awscdk.RemovalPolicyOptions) error {
...
func (c *jsiiProxy_CfnVPNConnection) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
...
func (c *jsiiProxy_CfnVPNConnection) validateGetAttParameters(attributeName *string) error {
...
func (c *jsiiProxy_CfnVPNConnection) validateGetMetadataParameters(key *string) error {
	if key == nil {
		return fmt.Errorf("parameter key is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnVPNConnection) validateInspectParameters(inspector awscdk.TreeInspector) error {
	if inspector == nil {
...
func (c *jsiiProxy_CfnVPNConnection) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	if target == nil {
		return fmt.Errorf("parameter target is required, but nil was provided")
	}
...
func (c *jsiiProxy_CfnVPNConnection) validateValidatePropertiesParameters(_properties interface{}) error {
	if _properties == nil {
...
func validateCfnVPNConnection_ArnForVPNConnectionParameters(resource interfacesawsec2.IVPNConnectionRef) error {
	if resource == nil {
...
func validateCfnVPNConnection_IsCfnResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnVPNConnection) validateSetCustomerGatewayIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnVPNConnection) validateSetVpnTunnelOptionsSpecificationsParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case CfnVPNConnection_VpnTunnelOptionsSpecificationProperty:
				v_ := v.(CfnVPNConnection_VpnTunnelOptionsSpecificationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
