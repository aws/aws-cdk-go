...
func (j *jsiiProxy_CfnInternetGateway) Node() constructs.Node {
...
func (j *jsiiProxy_CfnInternetGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnInternetGateway(scope constructs.Construct, id *string, props *CfnInternetGatewayProps) CfnInternetGateway {
	...
	if err := validateNewCfnInternetGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnInternetGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnInternetGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInternetGateway_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnInternetGateway_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnInternetGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnInternetGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInternetGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInternetGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnInternetGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnInternetGateway) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnInternetGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInternetGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
