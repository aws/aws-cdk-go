...
func (j *jsiiProxy_CfnNetworkInterfacePermission) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkInterfacePermission) Node() constructs.Node {
...
func (j *jsiiProxy_CfnNetworkInterfacePermission) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNetworkInterfacePermission(scope constructs.Construct, id *string, props *CfnNetworkInterfacePermissionProps) CfnNetworkInterfacePermission {
	...
	if err := validateNewCfnNetworkInterfacePermissionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNetworkInterfacePermission_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfacePermission_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkInterfacePermission_IsCfnNetworkInterfacePermission(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfacePermission_IsCfnNetworkInterfacePermissionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnNetworkInterfacePermission",
		"isCfnNetworkInterfacePermission",
		[]interface{}{x},
		&returns,
	)
...
func CfnNetworkInterfacePermission_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfacePermission_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkInterfacePermission_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNetworkInterfacePermission_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkInterfacePermission) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
