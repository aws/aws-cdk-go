...
func (j *jsiiProxy_CfnCarrierGateway) Node() constructs.Node {
...
func (j *jsiiProxy_CfnCarrierGateway) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCarrierGateway(scope constructs.Construct, id *string, props *CfnCarrierGatewayProps) CfnCarrierGateway {
	...
	if err := validateNewCfnCarrierGatewayParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCarrierGateway_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCarrierGateway_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCarrierGateway_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnCarrierGateway_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCarrierGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCarrierGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCarrierGateway) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCarrierGateway) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCarrierGateway) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCarrierGateway) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCarrierGateway) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCarrierGateway) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
