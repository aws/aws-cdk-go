...
// The jsii proxy struct for CfnIPAMResourceDiscovery
type jsiiProxy_CfnIPAMResourceDiscovery struct {
	internal.Type__awscdkCfnResource
	internal.Type__awscdkIInspectable
	internal.Type__interfacesawsec2IIPAMResourceDiscoveryRef
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) AttrIpamResourceDiscoveryId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) AttrIpamResourceDiscoveryRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) AttrIsDefault() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) AttrOwnerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrOwnerId",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) IpamResourceDiscoveryRef() *interfacesawsec2.IPAMResourceDiscoveryReference {
	var returns *interfacesawsec2.IPAMResourceDiscoveryReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Node() constructs.Node {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) OperatingRegions() interface{} {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) OrganizationalUnitExclusions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIPAMResourceDiscovery(scope constructs.Construct, id *string, props *CfnIPAMResourceDiscoveryProps) CfnIPAMResourceDiscovery {
	...
	if err := validateNewCfnIPAMResourceDiscoveryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery)SetOperatingRegions(val interface{}) {
...
func (j *jsiiProxy_CfnIPAMResourceDiscovery)SetOrganizationalUnitExclusions(val interface{}) {
	if err := j.validateSetOrganizationalUnitExclusionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnIPAMResourceDiscovery_FromIpamResourceDiscoveryId(scope constructs.Construct, id *string, ipamResourceDiscoveryId *string) interfacesawsec2.IIPAMResourceDiscoveryRef {
	...
	if err := validateCfnIPAMResourceDiscovery_FromIpamResourceDiscoveryIdParameters(scope, id, ipamResourceDiscoveryId); err != nil {
		panic(err)
	}
	var returns interfacesawsec2.IIPAMResourceDiscoveryRef
...
func CfnIPAMResourceDiscovery_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIPAMResourceDiscovery_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMResourceDiscovery_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnIPAMResourceDiscovery_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIPAMResourceDiscovery_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIPAMResourceDiscovery_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnIPAMResourceDiscovery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
