...
func (j *jsiiProxy_CfnPlacementGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPlacementGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnPlacementGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnPlacementGroup(scope constructs.Construct, id *string, props *CfnPlacementGroupProps) CfnPlacementGroup {
	...
	if err := validateNewCfnPlacementGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPlacementGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPlacementGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlacementGroup_IsCfnPlacementGroup(x interface{}) *bool {
	...
	if err := validateCfnPlacementGroup_IsCfnPlacementGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlacementGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPlacementGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPlacementGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPlacementGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlacementGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacementGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPlacementGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPlacementGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPlacementGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPlacementGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPlacementGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacementGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacementGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlacementGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
