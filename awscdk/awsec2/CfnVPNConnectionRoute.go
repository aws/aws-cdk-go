...
type CfnVPNConnectionRoute interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsec2.IVPNConnectionRouteRef
	...
	VpnConnectionRouteRef() *interfacesawsec2.VPNConnectionRouteReference
...
type jsiiProxy_CfnVPNConnectionRoute struct {
	...
	internal.Type__interfacesawsec2IVPNConnectionRouteRef
}
...
func (j *jsiiProxy_CfnVPNConnectionRoute) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPNConnectionRoute) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnVPNConnectionRoute) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPNConnectionRoute) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnVPNConnectionRoute) VpnConnectionRouteRef() *interfacesawsec2.VPNConnectionRouteReference {
	var returns *interfacesawsec2.VPNConnectionRouteReference
	_jsii_.Get(
		j,
...
func NewCfnVPNConnectionRoute(scope constructs.Construct, id *string, props *CfnVPNConnectionRouteProps) CfnVPNConnectionRoute {
	...
	if err := validateNewCfnVPNConnectionRouteParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPNConnectionRoute_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPNConnectionRoute_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPNConnectionRoute_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPNConnectionRoute_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPNConnectionRoute_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPNConnectionRoute_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPNConnectionRoute) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPNConnectionRoute) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPNConnectionRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
