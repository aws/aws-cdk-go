...
//
//   cfnRouteServerPeer := awscdk.Aws_ec2.NewCfnRouteServerPeer(this, jsii.String("MyCfnRouteServerPeer"), &CfnRouteServerPeerProps{
...
type CfnRouteServerPeer interface {
	...
	AttrEndpointEniAddress() *string
	// The ID of the Elastic network interface for the route server endpoint.
	AttrEndpointEniId() *string
	// The ID of the route server peer.
	AttrId() *string
	// The ID of the route server associated with this peer.
	AttrRouteServerId() *string
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrEndpointEniAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrEndpointEniId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEndpointEniId",
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrRouteServerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrRouteServerId",
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrSubnetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrSubnetId",
...
func (j *jsiiProxy_CfnRouteServerPeer) AttrVpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrVpcId",
...
func (j *jsiiProxy_CfnRouteServerPeer) BgpOptions() interface{} {
...
func (j *jsiiProxy_CfnRouteServerPeer) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRouteServerPeer) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnRouteServerPeer) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnRouteServerPeer) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouteServerPeer) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnRouteServerPeer) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnRouteServerPeer) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnRouteServerPeer) Node() constructs.Node {
...
func (j *jsiiProxy_CfnRouteServerPeer) PeerAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerAddress",
...
func (j *jsiiProxy_CfnRouteServerPeer) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnRouteServerPeer) RouteServerEndpointId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnRouteServerPeer) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnRouteServerPeer) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnRouteServerPeer) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnRouteServerPeer) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouteServerPeer(scope constructs.Construct, id *string, props *CfnRouteServerPeerProps) CfnRouteServerPeer {
	...
	if err := validateNewCfnRouteServerPeerParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnRouteServerPeer)SetBgpOptions(val interface{}) {
...
func (j *jsiiProxy_CfnRouteServerPeer)SetPeerAddress(val *string) {
...
func (j *jsiiProxy_CfnRouteServerPeer)SetRouteServerEndpointId(val *string) {
...
func (j *jsiiProxy_CfnRouteServerPeer)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnRouteServerPeer_ArnForRouteServerPeer(resource interfacesawsec2.IRouteServerPeerRef) *string {
	...
	if err := validateCfnRouteServerPeer_ArnForRouteServerPeerParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnRouteServerPeer_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouteServerPeer_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerPeer_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRouteServerPeer_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerPeer_IsCfnRouteServerPeer(x interface{}) *bool {
	...
	if err := validateCfnRouteServerPeer_IsCfnRouteServerPeerParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteServerPeer_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouteServerPeer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteServerPeer) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnRouteServerPeer) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouteServerPeer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouteServerPeer) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnRouteServerPeer) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouteServerPeer) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouteServerPeer) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnRouteServerPeer) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnRouteServerPeer) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouteServerPeer) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnRouteServerPeer) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerPeer) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerPeer) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnRouteServerPeer) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteServerPeer) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnRouteServerPeer) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnRouteServerPeer) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnRouteServerPeer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
