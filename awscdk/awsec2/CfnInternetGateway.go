...
func (j *jsiiProxy_CfnInternetGateway) CfnPropertyNames() *map[string]*string {
...
func CfnInternetGateway_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnInternetGateway_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnInternetGateway) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInternetGateway) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInternetGateway) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInternetGateway) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnInternetGateway) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
