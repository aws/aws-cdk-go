...
func (j *jsiiProxy_CfnNetworkAcl) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNetworkAcl) Node() constructs.Node {
...
func (j *jsiiProxy_CfnNetworkAcl) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnNetworkAcl(scope constructs.Construct, id *string, props *CfnNetworkAclProps) CfnNetworkAcl {
	...
	if err := validateNewCfnNetworkAclParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnNetworkAcl_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnNetworkAcl_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAcl_IsCfnNetworkAcl(x interface{}) *bool {
	...
	if err := validateCfnNetworkAcl_IsCfnNetworkAclParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAcl_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnNetworkAcl_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnNetworkAcl_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnNetworkAcl_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnNetworkAcl) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAcl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNetworkAcl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNetworkAcl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNetworkAcl) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnNetworkAcl) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnNetworkAcl) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAcl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAcl) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNetworkAcl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
