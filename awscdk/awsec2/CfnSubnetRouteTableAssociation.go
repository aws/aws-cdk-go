...
func (j *jsiiProxy_CfnSubnetRouteTableAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubnetRouteTableAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnSubnetRouteTableAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSubnetRouteTableAssociation(scope constructs.Construct, id *string, props *CfnSubnetRouteTableAssociationProps) CfnSubnetRouteTableAssociation {
	...
	if err := validateNewCfnSubnetRouteTableAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSubnetRouteTableAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubnetRouteTableAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetRouteTableAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubnetRouteTableAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubnetRouteTableAssociation_IsCfnSubnetRouteTableAssociation(x interface{}) *bool {
	...
	if err := validateCfnSubnetRouteTableAssociation_IsCfnSubnetRouteTableAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnSubnetRouteTableAssociation",
		"isCfnSubnetRouteTableAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnSubnetRouteTableAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubnetRouteTableAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubnetRouteTableAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
