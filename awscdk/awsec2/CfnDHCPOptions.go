...
func (j *jsiiProxy_CfnDHCPOptions) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDHCPOptions) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDHCPOptions) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnDHCPOptions_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDHCPOptions_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDHCPOptions) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDHCPOptions) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDHCPOptions) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDHCPOptions) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDHCPOptions) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDHCPOptions) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDHCPOptions) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDHCPOptions) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDHCPOptions) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDHCPOptions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
