...
func (j *jsiiProxy_CfnClientVpnTargetNetworkAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnClientVpnTargetNetworkAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnClientVpnTargetNetworkAssociation(scope constructs.Construct, id *string, props *CfnClientVpnTargetNetworkAssociationProps) CfnClientVpnTargetNetworkAssociation {
	...
	if err := validateNewCfnClientVpnTargetNetworkAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnClientVpnTargetNetworkAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnClientVpnTargetNetworkAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnClientVpnTargetNetworkAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnClientVpnTargetNetworkAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
