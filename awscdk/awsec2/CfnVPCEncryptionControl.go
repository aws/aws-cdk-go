...
func (j *jsiiProxy_CfnVPCEncryptionControl) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnVPCEncryptionControl) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCEncryptionControl) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCEncryptionControl) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCEncryptionControl) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCEncryptionControl) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
