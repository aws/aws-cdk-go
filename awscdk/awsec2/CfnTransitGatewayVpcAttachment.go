...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachment) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayVpcAttachment(scope constructs.Construct, id *string, props *CfnTransitGatewayVpcAttachmentProps) CfnTransitGatewayVpcAttachment {
	...
	if err := validateNewCfnTransitGatewayVpcAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachment)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnTransitGatewayVpcAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayVpcAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayVpcAttachment_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayVpcAttachment_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayVpcAttachment_IsCfnTransitGatewayVpcAttachment(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayVpcAttachment_IsCfnTransitGatewayVpcAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTransitGatewayVpcAttachment",
		"isCfnTransitGatewayVpcAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnTransitGatewayVpcAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayVpcAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayVpcAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
