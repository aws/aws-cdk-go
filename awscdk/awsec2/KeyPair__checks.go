...
func (k *jsiiProxy_KeyPair) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateKeyPair_FromKeyPairNameParameters(scope constructs.Construct, id *string, keyPairName *string) error {
	...
	if keyPairName == nil {
		return fmt.Errorf("parameter keyPairName is required, but nil was provided")
	}
