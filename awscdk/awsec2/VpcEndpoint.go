...
func VpcEndpoint_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateVpcEndpoint_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VpcEndpoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VpcEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
