...
func (j *jsiiProxy_CfnClientVpnTargetNetworkAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnClientVpnTargetNetworkAssociation_IsCfnClientVpnTargetNetworkAssociation(x interface{}) *bool {
	...
	if err := validateCfnClientVpnTargetNetworkAssociation_IsCfnClientVpnTargetNetworkAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnClientVpnTargetNetworkAssociation",
		"isCfnClientVpnTargetNetworkAssociation",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
