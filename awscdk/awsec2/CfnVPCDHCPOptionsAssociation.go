...
func (j *jsiiProxy_CfnVPCDHCPOptionsAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVPCDHCPOptionsAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnVPCDHCPOptionsAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVPCDHCPOptionsAssociation(scope constructs.Construct, id *string, props *CfnVPCDHCPOptionsAssociationProps) CfnVPCDHCPOptionsAssociation {
	...
	if err := validateNewCfnVPCDHCPOptionsAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVPCDHCPOptionsAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVPCDHCPOptionsAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCDHCPOptionsAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnVPCDHCPOptionsAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVPCDHCPOptionsAssociation_IsCfnVPCDHCPOptionsAssociation(x interface{}) *bool {
	...
	if err := validateCfnVPCDHCPOptionsAssociation_IsCfnVPCDHCPOptionsAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnVPCDHCPOptionsAssociation",
		"isCfnVPCDHCPOptionsAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnVPCDHCPOptionsAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVPCDHCPOptionsAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
