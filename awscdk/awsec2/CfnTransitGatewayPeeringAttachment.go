...
func (j *jsiiProxy_CfnTransitGatewayPeeringAttachment) AttrStatusCode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusCode",
...
func (j *jsiiProxy_CfnTransitGatewayPeeringAttachment) AttrStatusMessage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatusMessage",
...
func (j *jsiiProxy_CfnTransitGatewayPeeringAttachment) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTransitGatewayPeeringAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTransitGatewayPeeringAttachment) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTransitGatewayPeeringAttachment(scope constructs.Construct, id *string, props *CfnTransitGatewayPeeringAttachmentProps) CfnTransitGatewayPeeringAttachment {
	...
	if err := validateNewCfnTransitGatewayPeeringAttachmentParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTransitGatewayPeeringAttachment_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeeringAttachment_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransitGatewayPeeringAttachment_IsCfnTransitGatewayPeeringAttachment(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeeringAttachment_IsCfnTransitGatewayPeeringAttachmentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_ec2.CfnTransitGatewayPeeringAttachment",
		"isCfnTransitGatewayPeeringAttachment",
		[]interface{}{x},
		&returns,
	)
...
func CfnTransitGatewayPeeringAttachment_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTransitGatewayPeeringAttachment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTransitGatewayPeeringAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
