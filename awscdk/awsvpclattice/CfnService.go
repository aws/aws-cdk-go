...
//
//   cfnService := awscdk.Aws_vpclattice.NewCfnService(this, jsii.String("MyCfnService"), &CfnServiceProps{
...
func (j *jsiiProxy_CfnService) AttrDnsEntryDomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnService) AttrDnsEntryHostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnService) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnService) AuthType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authType",
...
func (j *jsiiProxy_CfnService) CertificateArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"certificateArn",
...
func (j *jsiiProxy_CfnService) CustomDomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customDomainName",
...
func (j *jsiiProxy_CfnService) DnsEntry() interface{} {
...
func (j *jsiiProxy_CfnService) IdleTimeoutSeconds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"idleTimeoutSeconds",
...
func (j *jsiiProxy_CfnService)SetAuthType(val *string) {
	_jsii_.Set(
		j,
		"authType",
		val,
...
func (j *jsiiProxy_CfnService)SetCertificateArn(val *string) {
	_jsii_.Set(
		j,
		"certificateArn",
		val,
...
func (j *jsiiProxy_CfnService)SetCustomDomainName(val *string) {
	_jsii_.Set(
		j,
		"customDomainName",
		val,
...
func (j *jsiiProxy_CfnService)SetDnsEntry(val interface{}) {
...
func (j *jsiiProxy_CfnService)SetIdleTimeoutSeconds(val *float64) {
	_jsii_.Set(
		j,
		"idleTimeoutSeconds",
		val,
...
func CfnService_ArnForService(resource interfacesawsvpclattice.IServiceRef) *string {
	_init_.Initialize()
