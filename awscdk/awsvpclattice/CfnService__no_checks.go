...
func validateCfnService_ArnForServiceParameters(resource interfacesawsvpclattice.IServiceRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnService) validateSetDnsEntryParameters(val interface{}) error {
	return nil
}
