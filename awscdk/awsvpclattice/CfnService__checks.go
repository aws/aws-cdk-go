...
func (j *jsiiProxy_CfnService) validateSetDnsEntryParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnService_DnsEntryProperty:
		val := val.(*CfnService_DnsEntryProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnService_DnsEntryProperty:
		val_ := val.(CfnService_DnsEntryProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnService_DnsEntryProperty; received %#v (a %T)", val, val)
		}
	}
