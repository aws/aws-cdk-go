...
//
//   cfnRule := awscdk.Aws_vpclattice.NewCfnRule(this, jsii.String("MyCfnRule"), &cfnRuleProps{
...
func (j *jsiiProxy_CfnRule) ListenerIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"listenerIdentifier",
...
func (j *jsiiProxy_CfnRule) Match() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"match",
...
func (j *jsiiProxy_CfnRule) Priority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"priority",
...
func (j *jsiiProxy_CfnRule) ServiceIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceIdentifier",
...
func (j *jsiiProxy_CfnRule) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnRule)SetAction(val interface{}) {
...
func (j *jsiiProxy_CfnRule)SetListenerIdentifier(val *string) {
	_jsii_.Set(
		j,
		"listenerIdentifier",
		val,
...
func (j *jsiiProxy_CfnRule)SetMatch(val interface{}) {
...
func (j *jsiiProxy_CfnRule)SetPriority(val *float64) {
...
func (j *jsiiProxy_CfnRule)SetServiceIdentifier(val *string) {
	_jsii_.Set(
		j,
		"serviceIdentifier",
		val,
