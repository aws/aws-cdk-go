...
//
//   cfnListener := awscdk.Aws_vpclattice.NewCfnListener(this, jsii.String("MyCfnListener"), &cfnListenerProps{
...
func (j *jsiiProxy_CfnListener) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnListener) AttrServiceArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrServiceArn",
...
func (j *jsiiProxy_CfnListener) AttrServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrServiceId",
...
func (j *jsiiProxy_CfnListener) DefaultAction() interface{} {
...
func (j *jsiiProxy_CfnListener) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnListener) ServiceIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceIdentifier",
...
func (j *jsiiProxy_CfnListener) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnListener)SetDefaultAction(val interface{}) {
...
func (j *jsiiProxy_CfnListener)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnListener)SetServiceIdentifier(val *string) {
	_jsii_.Set(
		j,
		"serviceIdentifier",
		val,
