...
type CfnResourcePolicy interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsvpclattice.IResourcePolicyRef
	...
	ResourcePolicyRef() *interfacesawsvpclattice.ResourcePolicyReference
...
type jsiiProxy_CfnResourcePolicy struct {
	...
	internal.Type__interfacesawsvpclatticeIResourcePolicyRef
}
...
func (j *jsiiProxy_CfnResourcePolicy) ResourcePolicyRef() *interfacesawsvpclattice.ResourcePolicyReference {
	var returns *interfacesawsvpclattice.ResourcePolicyReference
	_jsii_.Get(
		j,
		"resourcePolicyRef",
		&returns,
