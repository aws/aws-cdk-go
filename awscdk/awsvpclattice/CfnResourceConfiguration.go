...
func (j *jsiiProxy_CfnResourceConfiguration) AllowAssociationToSharableServiceNetwork() interface{} {
...
func (j *jsiiProxy_CfnResourceConfiguration) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnResourceConfiguration) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnResourceConfiguration) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnResourceConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnResourceConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnResourceConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourceConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnResourceConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnResourceConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnResourceConfiguration) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnResourceConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnResourceConfiguration) PortRanges() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"portRanges",
...
func (j *jsiiProxy_CfnResourceConfiguration) ProtocolType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protocolType",
...
func (j *jsiiProxy_CfnResourceConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnResourceConfiguration) ResourceConfigurationAuthType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnResourceConfiguration) ResourceConfigurationDefinition() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnResourceConfiguration) ResourceConfigurationGroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnResourceConfiguration) ResourceConfigurationType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnResourceConfiguration) ResourceGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGatewayId",
...
func (j *jsiiProxy_CfnResourceConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnResourceConfiguration) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnResourceConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnResourceConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceConfiguration(scope constructs.Construct, id *string, props *CfnResourceConfigurationProps) CfnResourceConfiguration {
	...
	if err := validateNewCfnResourceConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceConfiguration)SetAllowAssociationToSharableServiceNetwork(val interface{}) {
...
func (j *jsiiProxy_CfnResourceConfiguration)SetPortRanges(val *[]*string) {
	_jsii_.Set(
		j,
		"portRanges",
		val,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetProtocolType(val *string) {
	_jsii_.Set(
		j,
		"protocolType",
		val,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetResourceConfigurationAuthType(val *string) {
	_jsii_.Set(
		j,
		"resourceConfigurationAuthType",
		val,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetResourceConfigurationDefinition(val interface{}) {
	if err := j.validateSetResourceConfigurationDefinitionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetResourceConfigurationGroupId(val *string) {
	_jsii_.Set(
		j,
		"resourceConfigurationGroupId",
		val,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetResourceGatewayId(val *string) {
	_jsii_.Set(
		j,
		"resourceGatewayId",
		val,
...
func (j *jsiiProxy_CfnResourceConfiguration)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnResourceConfiguration_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceConfiguration_IsCfnResourceConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceConfiguration_IsCfnResourceConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceConfiguration_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnResourceConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnResourceConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnResourceConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnResourceConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnResourceConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnResourceConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnResourceConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnResourceConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnResourceConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
