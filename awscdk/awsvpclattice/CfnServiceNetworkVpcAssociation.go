...
func (j *jsiiProxy_CfnServiceNetworkVpcAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServiceNetworkVpcAssociation) Node() constructs.Node {
...
func (j *jsiiProxy_CfnServiceNetworkVpcAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnServiceNetworkVpcAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnServiceNetworkVpcAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
