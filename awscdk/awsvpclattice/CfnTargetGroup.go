...
//
//   cfnTargetGroup := awscdk.Aws_vpclattice.NewCfnTargetGroup(this, jsii.String("MyCfnTargetGroup"), &CfnTargetGroupProps{
...
func (j *jsiiProxy_CfnTargetGroup) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnTargetGroup) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnTargetGroup) AttrLastUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLastUpdatedAt",
...
func (j *jsiiProxy_CfnTargetGroup) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnTargetGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTargetGroup) Config() interface{} {
...
func (j *jsiiProxy_CfnTargetGroup) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_CfnTargetGroup)SetConfig(val interface{}) {
...
func (j *jsiiProxy_CfnTargetGroup)SetType(val *string) {
...
func CfnTargetGroup_ArnForTargetGroup(resource interfacesawsvpclattice.ITargetGroupRef) *string {
	_init_.Initialize()
...
func CfnTargetGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTargetGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTargetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTargetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTargetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTargetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTargetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
