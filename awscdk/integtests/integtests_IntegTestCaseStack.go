...
func (j *jsiiProxy_IntegTestCaseStack) Node() awscdk.ConstructNode {
...
func (j *jsiiProxy_IntegTestCaseStack) ParentStack() awscdk.Stack {
	var returns awscdk.Stack
	_jsii_.Get(
		j,
		"parentStack",
...
func (i *jsiiProxy_IntegTestCaseStack) OnPrepare() {
	_jsii_.InvokeVoid(
		i,
		"onPrepare",
		nil, // no parameters
...
func (i *jsiiProxy_IntegTestCaseStack) OnValidate() *[]*string {
	var returns *[]*string
...
func (i *jsiiProxy_IntegTestCaseStack) Prepare() {
	_jsii_.InvokeVoid(
		i,
		"prepare",
		nil, // no parameters
...
func (i *jsiiProxy_IntegTestCaseStack) Validate() *[]*string {
	var returns *[]*string
