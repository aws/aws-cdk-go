...
func (j *jsiiProxy_CfnAttributeGroupAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAttributeGroupAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnAttributeGroupAssociation_IsCfnAttributeGroupAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAttributeGroupAssociation_IsCfnAttributeGroupAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_servicecatalogappregistry.CfnAttributeGroupAssociation",
		"isCfnAttributeGroupAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnAttributeGroupAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAttributeGroupAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
