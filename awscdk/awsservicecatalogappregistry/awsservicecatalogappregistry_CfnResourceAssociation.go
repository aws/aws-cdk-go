...
func (j *jsiiProxy_CfnResourceAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceAssociation(scope constructs.Construct, id *string, props *CfnResourceAssociationProps) CfnResourceAssociation {
	...
	if err := validateNewCfnResourceAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnResourceAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceAssociation_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnResourceAssociation_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceAssociation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnResourceAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
