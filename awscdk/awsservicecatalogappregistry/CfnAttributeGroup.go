...
func (j *jsiiProxy_CfnAttributeGroup) CfnPropertyNames() *map[string]*string {
...
func CfnAttributeGroup_IsCfnAttributeGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAttributeGroup_IsCfnAttributeGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAttributeGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnAttributeGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAttributeGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAttributeGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAttributeGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAttributeGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
