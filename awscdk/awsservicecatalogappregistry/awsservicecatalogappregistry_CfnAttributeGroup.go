...
func (j *jsiiProxy_CfnAttributeGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAttributeGroup(scope constructs.Construct, id *string, props *CfnAttributeGroupProps) CfnAttributeGroup {
	...
	if err := validateNewCfnAttributeGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAttributeGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAttributeGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAttributeGroup_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAttributeGroup_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAttributeGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAttributeGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAttributeGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAttributeGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAttributeGroup) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnAttributeGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAttributeGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
