...
func (j *jsiiProxy_CfnResourceAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnResourceAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnResourceAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
