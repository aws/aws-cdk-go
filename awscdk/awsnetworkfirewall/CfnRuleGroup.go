...
type CfnRuleGroup interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsnetworkfirewall.IRuleGroupRef
	awscdk.ITaggable
	...
	RuleGroupRef() *interfacesawsnetworkfirewall.RuleGroupReference
...
type jsiiProxy_CfnRuleGroup struct {
	...
	internal.Type__interfacesawsnetworkfirewallIRuleGroupRef
...
func (j *jsiiProxy_CfnRuleGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRuleGroup) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnRuleGroup) RuleGroupRef() *interfacesawsnetworkfirewall.RuleGroupReference {
	var returns *interfacesawsnetworkfirewall.RuleGroupReference
	_jsii_.Get(
		j,
		"ruleGroupRef",
		&returns,
...
func CfnRuleGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnRuleGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRuleGroup_IsCfnRuleGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRuleGroup_IsCfnRuleGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRuleGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRuleGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRuleGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRuleGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRuleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
