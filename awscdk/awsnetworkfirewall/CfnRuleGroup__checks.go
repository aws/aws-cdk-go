...
func validateCfnRuleGroup_ArnForRuleGroupParameters(resource interfacesawsnetworkfirewall.IRuleGroupRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnRuleGroup) validateSetRuleGroupParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnRuleGroup_RuleGroupProperty:
		val := val.(*CfnRuleGroup_RuleGroupProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnRuleGroup_RuleGroupProperty:
		val_ := val.(CfnRuleGroup_RuleGroupProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnRuleGroup_RuleGroupProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnRuleGroup) validateSetSummaryConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnRuleGroup_SummaryConfigurationProperty:
		val := val.(*CfnRuleGroup_SummaryConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnRuleGroup_SummaryConfigurationProperty:
		val_ := val.(CfnRuleGroup_SummaryConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnRuleGroup_SummaryConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
