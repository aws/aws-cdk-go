...
func (j *jsiiProxy_CfnFirewall) CfnPropertyNames() *map[string]*string {
...
func CfnFirewall_ArnForFirewall(resource interfacesawsnetworkfirewall.IFirewallRef) *string {
	_init_.Initialize()

	if err := validateCfnFirewall_ArnForFirewallParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnFirewall) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFirewall) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFirewall) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFirewall) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewall) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
