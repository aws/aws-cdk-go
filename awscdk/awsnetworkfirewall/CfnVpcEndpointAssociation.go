...
func (j *jsiiProxy_CfnVpcEndpointAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnVpcEndpointAssociation_ArnForVpcEndpointAssociation(resource interfacesawsnetworkfirewall.IVpcEndpointAssociationRef) *string {
	_init_.Initialize()

	if err := validateCfnVpcEndpointAssociation_ArnForVpcEndpointAssociationParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnVpcEndpointAssociation_IsCfnVpcEndpointAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVpcEndpointAssociation_IsCfnVpcEndpointAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVpcEndpointAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVpcEndpointAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVpcEndpointAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVpcEndpointAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVpcEndpointAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
