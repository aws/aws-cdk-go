...
func (j *jsiiProxy_CfnFirewallPolicy) CfnPropertyNames() *map[string]*string {
...
func NewCfnFirewallPolicy(scope constructs.Construct, id *string, props *CfnFirewallPolicyProps) CfnFirewallPolicy {
	...
	if err := validateNewCfnFirewallPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnFirewallPolicy_ArnForFirewallPolicy(resource interfacesawsnetworkfirewall.IFirewallPolicyRef) *string {
	_init_.Initialize()

	if err := validateCfnFirewallPolicy_ArnForFirewallPolicyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnFirewallPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnFirewallPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFirewallPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFirewallPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnFirewallPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFirewallPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFirewallPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFirewallPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFirewallPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnFirewallPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnFirewallPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFirewallPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
