...
import (
	...
	"github.com/aws/aws-cdk-go/awscdk/v2/awsaccountaccess/internal"
...
//
//   cfnEntitlement := awscdk.Aws_accountaccess.NewCfnEntitlement(this, jsii.String("MyCfnEntitlement"), &CfnEntitlementProps{
...
type CfnEntitlement interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsaccountaccess.IEntitlementRef
	...
	AttrEntitlementId() *string
	// The AWS account ID.
	AttrEntitlementPrincipalRoleAccount() *string
	...
	SetEntitlement(val interface{})
	// A reference to a Entitlement resource.
	EntitlementRef() *interfacesawsaccountaccess.EntitlementReference
...
type jsiiProxy_CfnEntitlement struct {
	...
	internal.Type__interfacesawsaccountaccessIEntitlementRef
}

func (j *jsiiProxy_CfnEntitlement) ApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationArn",
...
func (j *jsiiProxy_CfnEntitlement) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnEntitlement) AttrEntitlementId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEntitlementId",
...
func (j *jsiiProxy_CfnEntitlement) AttrEntitlementPrincipalRoleAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEntitlementPrincipalRoleAccount",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnEntitlement) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnEntitlement) Entitlement() interface{} {
...
func (j *jsiiProxy_CfnEntitlement) EntitlementRef() *interfacesawsaccountaccess.EntitlementReference {
	var returns *interfacesawsaccountaccess.EntitlementReference
	_jsii_.Get(
		j,
		"entitlementRef",
		&returns,
...
func (j *jsiiProxy_CfnEntitlement)SetApplicationArn(val *string) {
...
func (j *jsiiProxy_CfnEntitlement)SetEntitlement(val interface{}) {
	if err := j.validateSetEntitlementParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEntitlement_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEntitlement_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEntitlement) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEntitlement) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEntitlement) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEntitlement) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntitlement) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
