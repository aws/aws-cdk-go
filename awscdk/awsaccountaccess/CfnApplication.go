...
//
//   cfnApplication := awscdk.Aws_accountaccess.NewCfnApplication(this, jsii.String("MyCfnApplication"), &CfnApplicationProps{
...
type CfnApplication interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsaccountaccess.IApplicationRef
	awscdk.ITaggableV2
	// A reference to a Application resource.
	ApplicationRef() *interfacesawsaccountaccess.ApplicationReference
	// The ARN of the application.
	AttrApplicationArn() *string
	// The timestamp when the application was created.
	AttrCreatedAt() *string
	// The ARN of the associated Identity Center application.
	AttrIdentitySourceIdentityCenterApplicationArn() *string
	...
	SetIdentitySource(val interface{})
...
type jsiiProxy_CfnApplication struct {
	...
	internal.Type__interfacesawsaccountaccessIApplicationRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnApplication) ApplicationRef() *interfacesawsaccountaccess.ApplicationReference {
	var returns *interfacesawsaccountaccess.ApplicationReference
	_jsii_.Get(
		j,
		"applicationRef",
		&returns,
...
func (j *jsiiProxy_CfnApplication) AttrIdentitySourceIdentityCenterApplicationArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrIdentitySourceIdentityCenterApplicationArn",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnApplication) AttrTenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTenantId",
...
func (j *jsiiProxy_CfnApplication) IdentitySource() interface{} {
...
func (j *jsiiProxy_CfnApplication)SetIdentitySource(val interface{}) {
...
func CfnApplication_ArnForApplication(resource interfacesawsaccountaccess.IApplicationRef) *string {
	_init_.Initialize()
