...
func (j *jsiiProxy_CfnTableBucketPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTableBucketPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTableBucketPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTableBucketPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTableBucketPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTableBucketPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTableBucketPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTableBucketPolicy) ResourcePolicy() interface{} {
...
func (j *jsiiProxy_CfnTableBucketPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTableBucketPolicy) TableBucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableBucketArn",
...
func (j *jsiiProxy_CfnTableBucketPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTableBucketPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTableBucketPolicy(scope constructs.Construct, id *string, props *CfnTableBucketPolicyProps) CfnTableBucketPolicy {
	...
	if err := validateNewCfnTableBucketPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnTableBucketPolicy{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3tables.CfnTableBucketPolicy",
...
func (j *jsiiProxy_CfnTableBucketPolicy)SetResourcePolicy(val interface{}) {
...
func (j *jsiiProxy_CfnTableBucketPolicy)SetTableBucketArn(val *string) {
...
func CfnTableBucketPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTableBucketPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTableBucketPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTableBucketPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTableBucketPolicy_IsCfnTableBucketPolicy(x interface{}) *bool {
	...
	if err := validateCfnTableBucketPolicy_IsCfnTableBucketPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTableBucketPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTableBucketPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTableBucketPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTableBucketPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTableBucketPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTableBucketPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTableBucketPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTableBucketPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTableBucketPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTableBucketPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
