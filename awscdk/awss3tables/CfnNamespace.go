...
func (j *jsiiProxy_CfnNamespace) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnNamespace) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_CfnNamespace) TableBucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableBucketArn",
...
func NewCfnNamespace(scope constructs.Construct, id *string, props *CfnNamespaceProps) CfnNamespace {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_s3tables.CfnNamespace",
...
func (j *jsiiProxy_CfnNamespace)SetNamespace(val *string) {
...
func (j *jsiiProxy_CfnNamespace)SetTableBucketArn(val *string) {
...
func (c *jsiiProxy_CfnNamespace) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnNamespace) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnNamespace) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnNamespace) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnNamespace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
