...
func (j *jsiiProxy_CfnTablePolicy) AttrTableBucketArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTableBucketArn",
...
func (j *jsiiProxy_CfnTablePolicy) AttrTableName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrTableName",
...
func (j *jsiiProxy_CfnTablePolicy) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnTablePolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnTablePolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTablePolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnTablePolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnTablePolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnTablePolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnTablePolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnTablePolicy) ResourcePolicy() interface{} {
...
func (j *jsiiProxy_CfnTablePolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnTablePolicy) TableArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableArn",
...
func (j *jsiiProxy_CfnTablePolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnTablePolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnTablePolicy(scope constructs.Construct, id *string, props *CfnTablePolicyProps) CfnTablePolicy {
	...
	if err := validateNewCfnTablePolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnTablePolicy{}

	_jsii_.Create(
		"aws-cdk-lib.aws_s3tables.CfnTablePolicy",
...
func (j *jsiiProxy_CfnTablePolicy)SetResourcePolicy(val interface{}) {
...
func (j *jsiiProxy_CfnTablePolicy)SetTableArn(val *string) {
...
func CfnTablePolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTablePolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTablePolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTablePolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTablePolicy_IsCfnTablePolicy(x interface{}) *bool {
	...
	if err := validateCfnTablePolicy_IsCfnTablePolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTablePolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTablePolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTablePolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnTablePolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTablePolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTablePolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnTablePolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnTablePolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnTablePolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnTablePolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTablePolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTablePolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnTablePolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTablePolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTablePolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnTablePolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnTablePolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTablePolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnTablePolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTablePolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTablePolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnTablePolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTablePolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnTablePolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnTablePolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnTablePolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
