...
func (j *jsiiProxy_CfnNamespace) validateSetNamespaceParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnNamespace) validateSetTableBucketArnParameters(val *string) error {
	return nil
}
