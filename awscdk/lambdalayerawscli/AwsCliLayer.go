...
func (a *jsiiProxy_AwsCliLayer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AwsCliLayer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
