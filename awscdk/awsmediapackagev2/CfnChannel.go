...
func (j *jsiiProxy_CfnChannel) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnChannel) AttrIngestEndpoints() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnChannel) AttrModifiedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrModifiedAt",
...
func (j *jsiiProxy_CfnChannel) ChannelGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelGroupName",
...
func (j *jsiiProxy_CfnChannel) InputSwitchConfiguration() interface{} {
...
func (j *jsiiProxy_CfnChannel) OutputHeaderConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnChannel) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnChannel)SetInputSwitchConfiguration(val interface{}) {
	if err := j.validateSetInputSwitchConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnChannel)SetOutputHeaderConfiguration(val interface{}) {
	if err := j.validateSetOutputHeaderConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnChannel)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnChannel_ArnForChannel(resource interfacesawsmediapackagev2.IChannelRef) *string {
	_init_.Initialize()
