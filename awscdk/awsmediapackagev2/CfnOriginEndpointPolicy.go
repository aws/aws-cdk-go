...
func (j *jsiiProxy_CfnOriginEndpointPolicy) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) ChannelGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelGroupName",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) ChannelName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelName",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) OriginEndpointName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"originEndpointName",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) Policy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"policy",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnOriginEndpointPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnOriginEndpointPolicy(scope constructs.Construct, id *string, props *CfnOriginEndpointPolicyProps) CfnOriginEndpointPolicy {
	...
	if err := validateNewCfnOriginEndpointPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnOriginEndpointPolicy{}
...
func (j *jsiiProxy_CfnOriginEndpointPolicy)SetPolicy(val interface{}) {
...
func CfnOriginEndpointPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnOriginEndpointPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOriginEndpointPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnOriginEndpointPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOriginEndpointPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnOriginEndpointPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnOriginEndpointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
