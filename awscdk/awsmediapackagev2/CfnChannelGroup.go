...
func (j *jsiiProxy_CfnChannelGroup) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnChannelGroup) AttrEgressDomain() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrEgressDomain",
...
func (j *jsiiProxy_CfnChannelGroup) AttrModifiedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrModifiedAt",
...
func (j *jsiiProxy_CfnChannelGroup) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnChannelGroup) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnChannelGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnChannelGroup) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnChannelGroup) ChannelGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"channelGroupName",
...
func (j *jsiiProxy_CfnChannelGroup) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnChannelGroup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnChannelGroup) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnChannelGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnChannelGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnChannelGroup) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnChannelGroup) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnChannelGroup) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnChannelGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnChannelGroup(scope constructs.Construct, id *string, props *CfnChannelGroupProps) CfnChannelGroup {
	...
	if err := validateNewCfnChannelGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnChannelGroup)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnChannelGroup)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnChannelGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnChannelGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnChannelGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnChannelGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnChannelGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnChannelGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnChannelGroup) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnChannelGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelGroup) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelGroup) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelGroup) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelGroup) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnChannelGroup) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnChannelGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnChannelGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnChannelGroup) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnChannelGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnChannelGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnChannelGroup) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnChannelGroup) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnChannelGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnChannelGroup) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnChannelGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelGroup) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnChannelGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnChannelGroup) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnChannelGroup) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnChannelGroup) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnChannelGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
