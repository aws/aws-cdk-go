...
func validateCfnChannel_ArnForChannelParameters(resource interfacesawsmediapackagev2.IChannelRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnChannel) validateSetChannelGroupNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnChannel) validateSetInputSwitchConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_InputSwitchConfigurationProperty:
		val := val.(*CfnChannel_InputSwitchConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_InputSwitchConfigurationProperty:
		val_ := val.(CfnChannel_InputSwitchConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_InputSwitchConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetOutputHeaderConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_OutputHeaderConfigurationProperty:
		val := val.(*CfnChannel_OutputHeaderConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_OutputHeaderConfigurationProperty:
		val_ := val.(CfnChannel_OutputHeaderConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_OutputHeaderConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
