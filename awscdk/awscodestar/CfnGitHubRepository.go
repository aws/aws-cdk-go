...
func (j *jsiiProxy_CfnGitHubRepository) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGitHubRepository) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnGitHubRepository_IsCfnGitHubRepository(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGitHubRepository_IsCfnGitHubRepositoryParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGitHubRepository_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGitHubRepository_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGitHubRepository) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGitHubRepository) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGitHubRepository) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGitHubRepository) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGitHubRepository) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGitHubRepository) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGitHubRepository) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGitHubRepository) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGitHubRepository) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGitHubRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
