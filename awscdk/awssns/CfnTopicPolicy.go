...
func (j *jsiiProxy_CfnTopicPolicy) CfnPropertyNames() *map[string]*string {
...
func NewCfnTopicPolicy(scope constructs.Construct, id *string, props *CfnTopicPolicyProps) CfnTopicPolicy {
	...
	if err := validateNewCfnTopicPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTopicPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTopicPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicPolicy_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnTopicPolicy_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicPolicy_IsCfnTopicPolicy(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTopicPolicy_IsCfnTopicPolicyParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTopicPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTopicPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTopicPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTopicPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTopicPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTopicPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTopicPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTopicPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTopicPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
