...
func (i *jsiiProxy_ITopic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
...
func (j *jsiiProxy_ITopic) MasterKey() awskms.IKey {
...
func (j *jsiiProxy_ITopic) Env() *interfaces.ResourceEnvironment {
