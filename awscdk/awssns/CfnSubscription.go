...
func (j *jsiiProxy_CfnSubscription) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSubscription) Node() constructs.Node {
...
func NewCfnSubscription(scope constructs.Construct, id *string, props *CfnSubscriptionProps) CfnSubscription {
	...
	if err := validateNewCfnSubscriptionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSubscription_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSubscription_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscription_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSubscription_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscription_IsCfnSubscription(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSubscription_IsCfnSubscriptionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSubscription_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSubscription_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSubscription) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscription) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSubscription) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSubscription) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSubscription) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSubscription) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSubscription) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscription) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscription) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
