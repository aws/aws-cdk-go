...
func (j *jsiiProxy_TopicPolicy) Env() *interfaces.ResourceEnvironment {
...
func (t *jsiiProxy_TopicPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TopicPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
