...
func (j *jsiiProxy_Subscription) Env() *interfaces.ResourceEnvironment {
...
func Subscription_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSubscription_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func Subscription_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSubscription_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func Subscription_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_sns.Subscription",
...
func (s *jsiiProxy_Subscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
