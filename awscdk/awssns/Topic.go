...
func (j *jsiiProxy_Topic) Grants() TopicGrants {
...
func (j *jsiiProxy_Topic) MasterKey() awskms.IKey {
...
func (j *jsiiProxy_Topic) TopicRef() *interfacesawssns.TopicReference {
...
func Topic_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_sns.Topic",
...
func (t *jsiiProxy_Topic) BindAsNotificationRuleTarget(scope constructs.Construct) *awscodestarnotifications.NotificationRuleTargetConfig {
...
func (t *jsiiProxy_Topic) GrantOnKey(grantee awsiam.IGrantable, actions ...*string) *awsiam.GrantOnKeyResult {
...
func (t *jsiiProxy_Topic) GrantPublish(identity awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_Topic) GrantSubscribe(identity awsiam.IGrantable) awsiam.Grant {
...
func (t *jsiiProxy_Topic) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
