...
func (t *jsiiProxy_TopicGrants) Actions(grantee awsiam.IGrantable, actions *[]*string, options *awscdk.EncryptedPermissionsOptions) awsiam.Grant {
	if err := t.validateActionsParameters(grantee, actions, options); err != nil {
		panic(err)
	}
