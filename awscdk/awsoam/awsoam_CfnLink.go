...
//
//   cfnLink := awscdk.Aws_oam.NewCfnLink(this, jsii.String("MyCfnLink"), &cfnLinkProps{
...
func (j *jsiiProxy_CfnLink) AttrLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrLabel",
...
func (j *jsiiProxy_CfnLink) LabelTemplate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelTemplate",
...
func (j *jsiiProxy_CfnLink) Node() constructs.Node {
...
func (j *jsiiProxy_CfnLink) ResourceTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourceTypes",
...
func (j *jsiiProxy_CfnLink) SinkIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sinkIdentifier",
...
func (j *jsiiProxy_CfnLink) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnLink(scope constructs.Construct, id *string, props *CfnLinkProps) CfnLink {
	...
	if err := validateNewCfnLinkParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnLink{}
...
func (j *jsiiProxy_CfnLink)SetLabelTemplate(val *string) {
	if err := j.validateSetLabelTemplateParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnLink)SetResourceTypes(val *[]*string) {
...
func (j *jsiiProxy_CfnLink)SetSinkIdentifier(val *string) {
...
func CfnLink_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLink_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLink_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnLink_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLink) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLink) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLink) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLink) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLink) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLink) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
