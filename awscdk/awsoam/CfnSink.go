...
func (j *jsiiProxy_CfnSink) CfnPropertyNames() *map[string]*string {
...
func CfnSink_ArnForSink(resource interfacesawsoam.ISinkRef) *string {
	_init_.Initialize()

	if err := validateCfnSink_ArnForSinkParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnSink_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnSink_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSink_IsCfnSink(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSink_IsCfnSinkParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSink) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSink) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSink) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSink) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
