...
func init() {
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsemrserverlessIApplicationRef)
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_emrserverless.CfnApplication.IdentityCenterConfigurationProperty",
		reflect.TypeOf((*CfnApplication_IdentityCenterConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
