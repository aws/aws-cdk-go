...
func validateCfnChannel_ArnForChannelParameters(resource interfacesawsmediatailor.IChannelRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnChannel) validateSetFillerSlateParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnChannel) validateSetLogConfigurationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnChannel) validateSetOutputsParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnChannel) validateSetPlaybackModeParameters(val *string) error {
	return nil
}
