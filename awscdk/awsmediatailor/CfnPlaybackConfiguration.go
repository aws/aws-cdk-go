...
type CfnPlaybackConfiguration interface {
	...
	AdsPersonalizationConcurrency() interface{}
	SetAdsPersonalizationConcurrency(val interface{})
	// The ad decision server (ADS) request timeouts and personalization time budgets for live, VOD, and prefetch workflows.
	AdsPersonalizationTimeouts() interface{}
	SetAdsPersonalizationTimeouts(val interface{})
...
func (j *jsiiProxy_CfnPlaybackConfiguration) AdsPersonalizationConcurrency() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPlaybackConfiguration) AdsPersonalizationTimeouts() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnPlaybackConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPlaybackConfiguration) InsertionMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"insertionMode",
...
func (j *jsiiProxy_CfnPlaybackConfiguration) LogConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"logConfiguration",
...
func (j *jsiiProxy_CfnPlaybackConfiguration) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnPlaybackConfiguration)SetAdsPersonalizationConcurrency(val interface{}) {
	if err := j.validateSetAdsPersonalizationConcurrencyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPlaybackConfiguration)SetAdsPersonalizationTimeouts(val interface{}) {
	if err := j.validateSetAdsPersonalizationTimeoutsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnPlaybackConfiguration)SetInsertionMode(val *string) {
	_jsii_.Set(
		j,
		"insertionMode",
		val,
...
func (j *jsiiProxy_CfnPlaybackConfiguration)SetLogConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnPlaybackConfiguration)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnPlaybackConfiguration_IsCfnPlaybackConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPlaybackConfiguration_IsCfnPlaybackConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPlaybackConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPlaybackConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPlaybackConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPlaybackConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPlaybackConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
