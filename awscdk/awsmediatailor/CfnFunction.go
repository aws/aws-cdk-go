...
//
//   cfnFunction := awscdk.Aws_mediatailor.NewCfnFunction(this, jsii.String("MyCfnFunction"), &CfnFunctionProps{
...
type CfnFunction interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsmediatailor.IFunctionRef
	awscdk.ITaggableV2
	...
	SequentialExecutorConfiguration() interface{}
	SetSequentialExecutorConfiguration(val interface{})
...
type jsiiProxy_CfnFunction struct {
	...
	internal.Type__interfacesawsmediatailorIFunctionRef
...
func (j *jsiiProxy_CfnFunction) CustomOutputConfiguration() interface{} {
...
func (j *jsiiProxy_CfnFunction) FunctionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionId",
...
func (j *jsiiProxy_CfnFunction) FunctionRef() *interfacesawsmediatailor.FunctionReference {
	var returns *interfacesawsmediatailor.FunctionReference
	_jsii_.Get(
		j,
		"functionRef",
		&returns,
...
func (j *jsiiProxy_CfnFunction) FunctionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionType",
...
func (j *jsiiProxy_CfnFunction) HttpRequestConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFunction) SequentialExecutorConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnFunction)SetCustomOutputConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnFunction)SetFunctionId(val *string) {
...
func (j *jsiiProxy_CfnFunction)SetFunctionType(val *string) {
...
func (j *jsiiProxy_CfnFunction)SetHttpRequestConfiguration(val interface{}) {
	if err := j.validateSetHttpRequestConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnFunction)SetSequentialExecutorConfiguration(val interface{}) {
	if err := j.validateSetSequentialExecutorConfigurationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnFunction_ArnForFunction(resource interfacesawsmediatailor.IFunctionRef) *string {
	_init_.Initialize()
