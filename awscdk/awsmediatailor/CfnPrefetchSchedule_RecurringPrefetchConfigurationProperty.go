...
//
type CfnPrefetchSchedule_RecurringPrefetchConfigurationProperty struct {
	...
	//
	RecurringConsumption interface{} `field:"required" json:"recurringConsumption" yaml:"recurringConsumption"`
	...
	//
	RecurringRetrieval interface{} `field:"required" json:"recurringRetrieval" yaml:"recurringRetrieval"`
