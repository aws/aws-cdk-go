...
func (c *jsiiProxy_CfnFunction) validateAddResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}

func (c *jsiiProxy_CfnFunction) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (c *jsiiProxy_CfnFunction) validateCfnPropertyNameParameters(cdkPropertyName *string) error {
	return nil
}
...
func (c *jsiiProxy_CfnFunction) validateRemoveResourceDependencyParameters(target awscdk.CfnResource) error {
	return nil
}
...
func validateCfnFunction_ArnForFunctionParameters(resource interfacesawsmediatailor.IFunctionRef) error {
	return nil
}
...
func (j *jsiiProxy_CfnFunction) validateSetCustomOutputConfigurationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnFunction) validateSetFunctionIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnFunction) validateSetFunctionTypeParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_CfnFunction) validateSetHttpRequestConfigurationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnFunction) validateSetSequentialExecutorConfigurationParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_CfnFunction) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
	return nil
}
