...
//
//   cfnChannel := awscdk.Aws_mediatailor.NewCfnChannel(this, jsii.String("MyCfnChannel"), &CfnChannelProps{
...
func (j *jsiiProxy_CfnChannel) FillerSlate() interface{} {
...
func (j *jsiiProxy_CfnChannel) LogConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"logConfiguration",
...
func (j *jsiiProxy_CfnChannel) Outputs() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"outputs",
...
func (j *jsiiProxy_CfnChannel) PlaybackMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playbackMode",
...
func (j *jsiiProxy_CfnChannel) Tier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tier",
...
func (j *jsiiProxy_CfnChannel)SetFillerSlate(val interface{}) {
	if err := j.validateSetFillerSlateParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnChannel)SetLogConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnChannel)SetOutputs(val interface{}) {
...
func (j *jsiiProxy_CfnChannel)SetPlaybackMode(val *string) {
...
func (j *jsiiProxy_CfnChannel)SetTier(val *string) {
	_jsii_.Set(
		j,
		"tier",
		val,
