...
//
type CfnPlaybackConfiguration_AdConditioningConfigurationProperty struct {
	...
	//
	StreamingMediaFileConditioning *string `field:"required" json:"streamingMediaFileConditioning" yaml:"streamingMediaFileConditioning"`
}
