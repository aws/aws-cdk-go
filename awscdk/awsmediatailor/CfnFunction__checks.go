...
func (j *jsiiProxy_CfnFunction) validateSetCustomOutputConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFunction_CustomOutputConfigurationProperty:
		val := val.(*CfnFunction_CustomOutputConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFunction_CustomOutputConfigurationProperty:
		val_ := val.(CfnFunction_CustomOutputConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFunction_CustomOutputConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFunction) validateSetHttpRequestConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFunction_HttpRequestConfigurationProperty:
		val := val.(*CfnFunction_HttpRequestConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFunction_HttpRequestConfigurationProperty:
		val_ := val.(CfnFunction_HttpRequestConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFunction_HttpRequestConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFunction) validateSetSequentialExecutorConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnFunction_SequentialExecutorConfigurationProperty:
		val := val.(*CfnFunction_SequentialExecutorConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFunction_SequentialExecutorConfigurationProperty:
		val_ := val.(CfnFunction_SequentialExecutorConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFunction_SequentialExecutorConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
