...
func (j *jsiiProxy_CfnChannel) validateSetFillerSlateParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_SlateSourceProperty:
		val := val.(*CfnChannel_SlateSourceProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_SlateSourceProperty:
		val_ := val.(CfnChannel_SlateSourceProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_SlateSourceProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetLogConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnChannel_LogConfigurationForChannelProperty:
		val := val.(*CfnChannel_LogConfigurationForChannelProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnChannel_LogConfigurationForChannelProperty:
		val_ := val.(CfnChannel_LogConfigurationForChannelProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnChannel_LogConfigurationForChannelProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnChannel) validateSetOutputsParameters(val interface{}) error {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnChannel_RequestOutputItemProperty:
				v := v.(*CfnChannel_RequestOutputItemProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnChannel_RequestOutputItemProperty:
				v_ := v.(CfnChannel_RequestOutputItemProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnChannel_RequestOutputItemProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
