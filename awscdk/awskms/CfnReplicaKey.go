...
func (j *jsiiProxy_CfnReplicaKey) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicaKey) TagsRaw() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnReplicaKey)SetTagsRaw(val *[]*awscdk.CfnTag) {
...
func CfnReplicaKey_ArnForReplicaKey(resource interfacesawskms.IReplicaKeyRef) *string {
	_init_.Initialize()

	if err := validateCfnReplicaKey_ArnForReplicaKeyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnReplicaKey_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnReplicaKey_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicaKey) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicaKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicaKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicaKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicaKey) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReplicaKey) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReplicaKey) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicaKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicaKey) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicaKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
