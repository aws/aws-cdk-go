...
func (j *jsiiProxy_CfnKey) CfnPropertyNames() *map[string]*string {
...
func CfnKey_ArnForKey(resource interfacesawskms.IKeyRef) *string {
	_init_.Initialize()

	if err := validateCfnKey_ArnForKeyParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnKey) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnKey) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnKey) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnKey) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
