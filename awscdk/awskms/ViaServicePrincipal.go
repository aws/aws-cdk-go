...
func (v *jsiiProxy_ViaServicePrincipal) AddToPrincipalPolicy(statement awsiam.PolicyStatement) *awsiam.AddToPrincipalPolicyResult {
	if err := v.validateAddToPrincipalPolicyParameters(statement); err != nil {
		panic(err)
	}
