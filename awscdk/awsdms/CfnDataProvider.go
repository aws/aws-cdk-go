...
func (j *jsiiProxy_CfnDataProvider) CfnPropertyNames() *map[string]*string {
...
func CfnDataProvider_ArnForDataProvider(resource interfacesawsdms.IDataProviderRef) *string {
	_init_.Initialize()

	if err := validateCfnDataProvider_ArnForDataProviderParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func (c *jsiiProxy_CfnDataProvider) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDataProvider) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDataProvider) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDataProvider) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDataProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
