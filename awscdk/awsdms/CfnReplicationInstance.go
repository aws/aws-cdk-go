...
func (j *jsiiProxy_CfnReplicationInstance) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicationInstance) DnsNameServers() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsNameServers",
...
func (j *jsiiProxy_CfnReplicationInstance)SetDnsNameServers(val *string) {
	_jsii_.Set(
		j,
		"dnsNameServers",
		val,
...
func CfnReplicationInstance_IsCfnReplicationInstance(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnReplicationInstance_IsCfnReplicationInstanceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicationInstance) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationInstance) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationInstance) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationInstance) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
