...
func (j *jsiiProxy_CfnReplicationTask) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnReplicationTask) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationTask) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationTask) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationTask) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationTask) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
