...
func (j *jsiiProxy_CfnReplicationSubnetGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnReplicationSubnetGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnReplicationSubnetGroup(scope constructs.Construct, id *string, props *CfnReplicationSubnetGroupProps) CfnReplicationSubnetGroup {
	...
	if err := validateNewCfnReplicationSubnetGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnReplicationSubnetGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnReplicationSubnetGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationSubnetGroup_IsCfnReplicationSubnetGroup(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnReplicationSubnetGroup_IsCfnReplicationSubnetGroupParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnReplicationSubnetGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnReplicationSubnetGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnReplicationSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
