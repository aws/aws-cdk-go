...
func (j *jsiiProxy_CfnCertificateAuthorityActivation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnCertificateAuthorityActivation(scope constructs.Construct, id *string, props *CfnCertificateAuthorityActivationProps) CfnCertificateAuthorityActivation {
	...
	if err := validateNewCfnCertificateAuthorityActivationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnCertificateAuthorityActivation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnCertificateAuthorityActivation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnCertificateAuthorityActivation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnCertificateAuthorityActivation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
