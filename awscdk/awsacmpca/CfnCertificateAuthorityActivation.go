...
func (j *jsiiProxy_CfnCertificateAuthorityActivation) CfnPropertyNames() *map[string]*string {
...
func CfnCertificateAuthorityActivation_IsCfnCertificateAuthorityActivation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCertificateAuthorityActivation_IsCfnCertificateAuthorityActivationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_acmpca.CfnCertificateAuthorityActivation",
		"isCfnCertificateAuthorityActivation",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCertificateAuthorityActivation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
