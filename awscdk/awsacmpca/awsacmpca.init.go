...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_acmpca.CfnCertificate.CertificatePolicyListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_acmpca.CfnCertificate.ExtendedKeyUsageListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_acmpca.CfnCertificate.GeneralNameListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_acmpca.CfnCertificate.PolicyQualifierInfoListProperty",
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_acmpca.CfnCertificateAuthority.SubjectInformationAccessProperty",
