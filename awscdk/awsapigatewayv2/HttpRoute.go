...
func (h *jsiiProxy_HttpRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HttpRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
