...
func (w *jsiiProxy_WebSocketIntegration) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (w *jsiiProxy_WebSocketIntegration) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateWebSocketIntegration_IsResourceParameters(construct awscdk.IConstruct) error {
	if construct == nil {
