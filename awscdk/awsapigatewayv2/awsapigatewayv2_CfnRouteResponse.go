...
func (j *jsiiProxy_CfnRouteResponse) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnRouteResponse(scope constructs.Construct, id *string, props *CfnRouteResponseProps) CfnRouteResponse {
	...
	if err := validateNewCfnRouteResponseParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnRouteResponse_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnRouteResponse_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnRouteResponse_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnRouteResponse_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteResponse) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteResponse) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnRouteResponse) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnRouteResponse) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnRouteResponse) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteResponse) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
