...
func (w *jsiiProxy_WebSocketStage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WebSocketStage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
