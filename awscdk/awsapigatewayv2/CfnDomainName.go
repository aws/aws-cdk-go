...
func (j *jsiiProxy_CfnDomainName) DomainNameRef() *interfacesawsapigatewayv2.DomainNameReference {
...
func (j *jsiiProxy_CfnDomainName)SetDomainNameConfigurations(val interface{}) {
	if err := j.validateSetDomainNameConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDomainName)SetMutualTlsAuthentication(val interface{}) {
	if err := j.validateSetMutualTlsAuthenticationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
