...
func (j *jsiiProxy_CfnApiMapping) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApiMapping) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApiMapping(scope constructs.Construct, id *string, props *CfnApiMappingProps) CfnApiMapping {
	...
	if err := validateNewCfnApiMappingParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApiMapping_IsCfnApiMapping(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApiMapping_IsCfnApiMappingParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiMapping_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApiMapping_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiMapping_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApiMapping_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApiMapping) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiMapping) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiMapping) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiMapping) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApiMapping) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApiMapping) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiMapping) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiMapping) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
