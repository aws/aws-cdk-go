...
func (j *jsiiProxy_HttpStage) Env() *interfaces.ResourceEnvironment {
...
func HttpStage_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.HttpStage",
...
func (h *jsiiProxy_HttpStage) AddStageVariable(name *string, value *string) {
	if err := h.validateAddStageVariableParameters(name, value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		h,
...
func (h *jsiiProxy_HttpStage) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HttpStage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
