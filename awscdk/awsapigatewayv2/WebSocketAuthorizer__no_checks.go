...
func (w *jsiiProxy_WebSocketAuthorizer) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func validateWebSocketAuthorizer_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	return nil
}

func validateWebSocketAuthorizer_IsResourceParameters(construct constructs.IConstruct) error {
	return nil
}
