...
func (j *jsiiProxy_HttpApi) Env() *interfaces.ResourceEnvironment {
...
func HttpApi_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.HttpApi",
...
func (h *jsiiProxy_HttpApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HttpApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
