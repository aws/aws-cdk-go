...
func (h *jsiiProxy_HttpIntegration) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	if session == nil {
...
func (h *jsiiProxy_HttpIntegration) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	if session == nil {
		return fmt.Errorf("parameter session is required, but nil was provided")
	}
...
func validateHttpIntegration_IsResourceParameters(construct awscdk.IConstruct) error {
	if construct == nil {
