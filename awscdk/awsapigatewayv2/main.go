...
func init() {
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.ApiKeyOptions",
		reflect.TypeOf((*ApiKeyOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.ApiKeyProps",
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnPortalProduct)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDeletionOverride", GoMethod: "AddDeletionOverride"},
			_jsii_.MemberMethod{JsiiMethod: "addDependency", GoMethod: "AddDependency"},
			_jsii_.MemberMethod{JsiiMethod: "addDependsOn", GoMethod: "AddDependsOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "attrPortalProductArn", GoGetter: "AttrPortalProductArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrPortalProductId", GoGetter: "AttrPortalProductId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "obtainDependencies", GoMethod: "ObtainDependencies"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "portalProductRef", GoGetter: "PortalProductRef"},
			_jsii_.MemberProperty{JsiiProperty: "ref", GoGetter: "Ref"},
			_jsii_.MemberMethod{JsiiMethod: "removeDependency", GoMethod: "RemoveDependency"},
			_jsii_.MemberMethod{JsiiMethod: "removeResourceDependency", GoMethod: "RemoveResourceDependency"},
			_jsii_.MemberMethod{JsiiMethod: "renderProperties", GoMethod: "RenderProperties"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkCfnResource)
			_jsii_.InitJsiiProxy(&j.Type__awscdkIInspectable)
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsapigatewayv2IPortalProductRef)
			_jsii_.InitJsiiProxy(&j.Type__awscdkITaggableV2)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnPortalProductProps",
		reflect.TypeOf((*CfnPortalProductProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnRoutingRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "attrRoutingRuleArn", GoGetter: "AttrRoutingRuleArn"},
			_jsii_.MemberProperty{JsiiProperty: "attrRoutingRuleId", GoGetter: "AttrRoutingRuleId"},
			_jsii_.MemberProperty{JsiiProperty: "cfnOptions", GoGetter: "CfnOptions"},
			_jsii_.MemberProperty{JsiiProperty: "cfnProperties", GoGetter: "CfnProperties"},
			_jsii_.MemberMethod{JsiiMethod: "cfnPropertyName", GoMethod: "CfnPropertyName"},
			_jsii_.MemberProperty{JsiiProperty: "cfnPropertyNames", GoGetter: "CfnPropertyNames"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CfnRoutingRule_ActionInvokeApiProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRule.ActionProperty",
		reflect.TypeOf((*CfnRoutingRule_ActionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRule.ConditionProperty",
		reflect.TypeOf((*CfnRoutingRule_ConditionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRule.MatchBasePathsProperty",
		reflect.TypeOf((*CfnRoutingRule_MatchBasePathsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRule.MatchHeaderValueProperty",
		reflect.TypeOf((*CfnRoutingRule_MatchHeaderValueProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRule.MatchHeadersProperty",
		reflect.TypeOf((*CfnRoutingRule_MatchHeadersProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.CfnRoutingRuleProps",
		reflect.TypeOf((*CfnRoutingRuleProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addStageVariable", GoMethod: "AddStageVariable"},
			_jsii_.MemberProperty{JsiiProperty: "api", GoGetter: "Api"},
			_jsii_.MemberMethod{JsiiMethod: "applyCrossStackReferenceStrength", GoMethod: "ApplyCrossStackReferenceStrength"},
			_jsii_.MemberMethod{JsiiMethod: "applyRemovalPolicy", GoMethod: "ApplyRemovalPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "baseApi", GoGetter: "BaseApi"},
			_jsii_.MemberMethod{JsiiMethod: "defaultAccessLogFormat", GoMethod: "DefaultAccessLogFormat"},
			_jsii_.MemberProperty{JsiiProperty: "domainUrl", GoGetter: "DomainUrl"},
			_jsii_.MemberProperty{JsiiProperty: "env", GoGetter: "Env"},
			_jsii_.MemberMethod{JsiiMethod: "generatePhysicalName", GoMethod: "GeneratePhysicalName"},
			_jsii_.MemberMethod{JsiiMethod: "getResourceArnAttribute", GoMethod: "GetResourceArnAttribute"},
	...
	_jsii_.RegisterInterface(
		...
		reflect.TypeOf((*IAccessLogSettings)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			return &jsiiProxy_IAccessLogSettings{}
		},
	)
	_jsii_.RegisterInterface(
	...
	_jsii_.RegisterInterface(
		"aws-cdk-lib.aws_apigatewayv2.IUsagePlan",
	...
	_jsii_.RegisterClass(
		"aws-cdk-lib.aws_apigatewayv2.UsagePlan",
	...
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_apigatewayv2.UsagePlanPerApiStage",
