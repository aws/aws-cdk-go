...
func (j *jsiiProxy_WebSocketIntegration) Env() *interfaces.ResourceEnvironment {
...
func WebSocketIntegration_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.WebSocketIntegration",
...
func (w *jsiiProxy_WebSocketIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WebSocketIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
