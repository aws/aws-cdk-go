...
func (j *jsiiProxy_HttpAuthorizer) Env() *interfaces.ResourceEnvironment {
...
func HttpAuthorizer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.HttpAuthorizer",
...
func (h *jsiiProxy_HttpAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HttpAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
