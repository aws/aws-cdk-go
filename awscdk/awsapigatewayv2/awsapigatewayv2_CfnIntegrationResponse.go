...
func (j *jsiiProxy_CfnIntegrationResponse) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnIntegrationResponse(scope constructs.Construct, id *string, props *CfnIntegrationResponseProps) CfnIntegrationResponse {
	...
	if err := validateNewCfnIntegrationResponseParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnIntegrationResponse_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnIntegrationResponse_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIntegrationResponse_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnIntegrationResponse_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIntegrationResponse_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnIntegrationResponse_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIntegrationResponse) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIntegrationResponse) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnIntegrationResponse) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnIntegrationResponse) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnIntegrationResponse) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIntegrationResponse) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
