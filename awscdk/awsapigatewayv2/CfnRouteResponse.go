...
type CfnRouteResponse interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsapigatewayv2.IRouteResponseRef
	// The API identifier.
	ApiId() *string
	SetApiId(val *string)
	...
	RouteResponseRef() *interfacesawsapigatewayv2.RouteResponseReference
...
type jsiiProxy_CfnRouteResponse struct {
	...
	internal.Type__interfacesawsapigatewayv2IRouteResponseRef
}
...
func (j *jsiiProxy_CfnRouteResponse) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnRouteResponse) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnRouteResponse) RouteResponseRef() *interfacesawsapigatewayv2.RouteResponseReference {
	var returns *interfacesawsapigatewayv2.RouteResponseReference
	_jsii_.Get(
		j,
		"routeResponseRef",
		&returns,
...
func CfnRouteResponse_IsCfnRouteResponse(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnRouteResponse_IsCfnRouteResponseParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnRouteResponse) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnRouteResponse) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnRouteResponse) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnRouteResponse) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnRouteResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
