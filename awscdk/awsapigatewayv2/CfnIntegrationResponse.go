...
func (j *jsiiProxy_CfnIntegrationResponse) CfnPropertyNames() *map[string]*string {
...
func CfnIntegrationResponse_IsCfnIntegrationResponse(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIntegrationResponse_IsCfnIntegrationResponseParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnIntegrationResponse_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnIntegrationResponse_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnIntegrationResponse) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnIntegrationResponse) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnIntegrationResponse) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnIntegrationResponse) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnIntegrationResponse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
