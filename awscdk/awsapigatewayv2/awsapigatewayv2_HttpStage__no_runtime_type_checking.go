...
func (h *jsiiProxy_HttpStage) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	return nil
}

func (h *jsiiProxy_HttpStage) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateHttpStage_IsResourceParameters(construct awscdk.IConstruct) error {
	return nil
}
