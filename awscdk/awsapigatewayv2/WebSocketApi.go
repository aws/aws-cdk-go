...
func (w *jsiiProxy_WebSocketApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WebSocketApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
