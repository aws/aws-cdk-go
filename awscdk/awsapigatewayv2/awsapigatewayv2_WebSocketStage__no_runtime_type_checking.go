...
func (w *jsiiProxy_WebSocketStage) validateOnSynthesizeParameters(session constructs.ISynthesisSession) error {
	return nil
}

func (w *jsiiProxy_WebSocketStage) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateWebSocketStage_IsResourceParameters(construct awscdk.IConstruct) error {
	return nil
}
