...
func (j *jsiiProxy_CfnApiGatewayManagedOverrides) CfnPropertyNames() *map[string]*string {
...
func CfnApiGatewayManagedOverrides_IsCfnApiGatewayManagedOverrides(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApiGatewayManagedOverrides_IsCfnApiGatewayManagedOverridesParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_apigatewayv2.CfnApiGatewayManagedOverrides",
		"isCfnApiGatewayManagedOverrides",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnApiGatewayManagedOverrides) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiGatewayManagedOverrides) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiGatewayManagedOverrides) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiGatewayManagedOverrides) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiGatewayManagedOverrides) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
