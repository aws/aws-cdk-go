...
func (j *jsiiProxy_ApiMapping) Env() *interfaces.ResourceEnvironment {
...
func ApiMapping_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.ApiMapping",
...
func (a *jsiiProxy_ApiMapping) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ApiMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
