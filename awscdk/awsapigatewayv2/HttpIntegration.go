...
func (j *jsiiProxy_HttpIntegration) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_HttpIntegration) IntegrationRef() *interfacesawsapigatewayv2.IntegrationReference {
...
func HttpIntegration_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.HttpIntegration",
...
func (h *jsiiProxy_HttpIntegration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (h *jsiiProxy_HttpIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
