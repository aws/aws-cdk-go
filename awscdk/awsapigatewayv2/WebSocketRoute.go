...
func WebSocketRoute_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.WebSocketRoute",
...
func (w *jsiiProxy_WebSocketRoute) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WebSocketRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
