...
func (j *jsiiProxy_WebSocketAuthorizer) Env() *interfaces.ResourceEnvironment {
...
func WebSocketAuthorizer_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_apigatewayv2.WebSocketAuthorizer",
...
func (w *jsiiProxy_WebSocketAuthorizer) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (w *jsiiProxy_WebSocketAuthorizer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
