...
func (j *jsiiProxy_CfnDirectoryBucket) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnDirectoryBucket) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDirectoryBucket) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDirectoryBucket) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDirectoryBucket) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDirectoryBucket) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDirectoryBucket) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDirectoryBucket) DataRedundancy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataRedundancy",
...
func (j *jsiiProxy_CfnDirectoryBucket) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDirectoryBucket) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDirectoryBucket) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDirectoryBucket) Tags() *[]*awscdk.CfnTag {
...
func (j *jsiiProxy_CfnDirectoryBucket) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDirectoryBucket) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDirectoryBucket(scope constructs.Construct, id *string, props *CfnDirectoryBucketProps) CfnDirectoryBucket {
	...
	if err := validateNewCfnDirectoryBucketParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDirectoryBucket)SetBucketName(val *string) {
	_jsii_.Set(
		j,
		"bucketName",
		val,
...
func (j *jsiiProxy_CfnDirectoryBucket)SetDataRedundancy(val *string) {
...
func (j *jsiiProxy_CfnDirectoryBucket)SetLocationName(val *string) {
...
func (j *jsiiProxy_CfnDirectoryBucket)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDirectoryBucket_IsCfnDirectoryBucket(x interface{}) *bool {
	...
	if err := validateCfnDirectoryBucket_IsCfnDirectoryBucketParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDirectoryBucket_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDirectoryBucket_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDirectoryBucket_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDirectoryBucket_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDirectoryBucket_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDirectoryBucket_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDirectoryBucket) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDirectoryBucket) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDirectoryBucket) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDirectoryBucket) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDirectoryBucket) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDirectoryBucket) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDirectoryBucket) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDirectoryBucket) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDirectoryBucket) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDirectoryBucket) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDirectoryBucket) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryBucket) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryBucket) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDirectoryBucket) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryBucket) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDirectoryBucket) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDirectoryBucket) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDirectoryBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
