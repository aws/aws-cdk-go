...
type jsiiProxy_CfnBucketPolicy struct {
	...
	internal.Type__interfacesawss3expressIBucketPolicyRef
}
...
func (j *jsiiProxy_CfnBucketPolicy) BucketPolicyRef() *interfacesawss3express.BucketPolicyReference {
	var returns *interfacesawss3express.BucketPolicyReference
	_jsii_.Get(
		j,
		"bucketPolicyRef",
		&returns,
...
func (j *jsiiProxy_CfnBucketPolicy) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnBucketPolicy) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnBucketPolicy(scope constructs.Construct, id *string, props *CfnBucketPolicyProps) CfnBucketPolicy {
	...
	if err := validateNewCfnBucketPolicyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnBucketPolicy_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBucketPolicy_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBucketPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBucketPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBucketPolicy) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBucketPolicy) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBucketPolicy) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBucketPolicy) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBucketPolicy) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBucketPolicy) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBucketPolicy) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBucketPolicy) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBucketPolicy) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBucketPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
