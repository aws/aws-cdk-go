...
//
//   cfnDiscovery := awscdk.Aws_applicationsignals.NewCfnDiscovery(this, jsii.String("MyCfnDiscovery"), &CfnDiscoveryProps{
//   })
//
...
func (j *jsiiProxy_CfnDiscovery) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnDiscovery) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnDiscovery) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDiscovery) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnDiscovery) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnDiscovery) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnDiscovery) Node() constructs.Node {
...
func (j *jsiiProxy_CfnDiscovery) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnDiscovery) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnDiscovery) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnDiscovery) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDiscovery(scope constructs.Construct, id *string, props *CfnDiscoveryProps) CfnDiscovery {
	...
	if err := validateNewCfnDiscoveryParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDiscovery_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDiscovery_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDiscovery_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDiscovery_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDiscovery_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDiscovery_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDiscovery_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_applicationsignals.CfnDiscovery",
...
func (c *jsiiProxy_CfnDiscovery) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnDiscovery) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscovery) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscovery) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscovery) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscovery) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnDiscovery) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnDiscovery) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDiscovery) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDiscovery) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnDiscovery) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDiscovery) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDiscovery) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnDiscovery) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnDiscovery) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDiscovery) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnDiscovery) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscovery) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscovery) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnDiscovery) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDiscovery) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnDiscovery) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnDiscovery) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnDiscovery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
