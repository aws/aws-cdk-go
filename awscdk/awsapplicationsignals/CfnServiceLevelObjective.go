...
func (j *jsiiProxy_CfnServiceLevelObjective) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnServiceLevelObjective) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceLevelObjective) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceLevelObjective) RemoveResourceDependency(target awscdk.CfnResource) {
