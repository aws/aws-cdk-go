...
//
//   cfnGroupingConfiguration := awscdk.Aws_applicationsignals.NewCfnGroupingConfiguration(this, jsii.String("MyCfnGroupingConfiguration"), &CfnGroupingConfigurationProps{
...
func (j *jsiiProxy_CfnGroupingConfiguration) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnGroupingConfiguration) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnGroupingConfiguration) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnGroupingConfiguration) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGroupingConfiguration) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnGroupingConfiguration) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnGroupingConfiguration) GroupingAttributeDefinitions() interface{} {
...
func (j *jsiiProxy_CfnGroupingConfiguration) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnGroupingConfiguration) Node() constructs.Node {
...
func (j *jsiiProxy_CfnGroupingConfiguration) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnGroupingConfiguration) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnGroupingConfiguration) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnGroupingConfiguration) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnGroupingConfiguration(scope constructs.Construct, id *string, props *CfnGroupingConfigurationProps) CfnGroupingConfiguration {
	...
	if err := validateNewCfnGroupingConfigurationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnGroupingConfiguration)SetGroupingAttributeDefinitions(val interface{}) {
	if err := j.validateSetGroupingAttributeDefinitionsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnGroupingConfiguration_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGroupingConfiguration_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupingConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGroupingConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupingConfiguration_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGroupingConfiguration_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGroupingConfiguration_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_applicationsignals.CfnGroupingConfiguration",
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGroupingConfiguration) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGroupingConfiguration) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnGroupingConfiguration) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGroupingConfiguration) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnGroupingConfiguration) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnGroupingConfiguration) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnGroupingConfiguration) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnGroupingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
