...
//
//   domainGrants := awscdk.Aws_elasticsearch.DomainGrants_FromDomain(domainRef)
//
type DomainGrants interface {
	Resource() interfacesawselasticsearch.IDomainRef
...
func (j *jsiiProxy_DomainGrants) Resource() interfacesawselasticsearch.IDomainRef {
...
func DomainGrants_FromDomain(resource interfacesawselasticsearch.IDomainRef) DomainGrants {
	_init_.Initialize()
