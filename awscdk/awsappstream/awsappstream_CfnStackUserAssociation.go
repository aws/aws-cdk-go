...
func (j *jsiiProxy_CfnStackUserAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnStackUserAssociation(scope constructs.Construct, id *string, props *CfnStackUserAssociationProps) CfnStackUserAssociation {
	...
	if err := validateNewCfnStackUserAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnStackUserAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnStackUserAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStackUserAssociation_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnStackUserAssociation_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStackUserAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnStackUserAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStackUserAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStackUserAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnStackUserAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnStackUserAssociation) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnStackUserAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStackUserAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
