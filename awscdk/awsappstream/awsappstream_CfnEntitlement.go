...
func (j *jsiiProxy_CfnEntitlement) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnEntitlement(scope constructs.Construct, id *string, props *CfnEntitlementProps) CfnEntitlement {
	...
	if err := validateNewCfnEntitlementParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnEntitlement)SetAppVisibility(val *string) {
	if err := j.validateSetAppVisibilityParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnEntitlement_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEntitlement_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEntitlement_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnEntitlement_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEntitlement_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEntitlement_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEntitlement) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntitlement) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEntitlement) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEntitlement) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnEntitlement) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEntitlement) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
