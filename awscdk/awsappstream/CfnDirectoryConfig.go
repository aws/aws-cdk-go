...
func (j *jsiiProxy_CfnDirectoryConfig) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDirectoryConfig) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDirectoryConfig(scope constructs.Construct, id *string, props *CfnDirectoryConfigProps) CfnDirectoryConfig {
	...
	if err := validateNewCfnDirectoryConfigParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDirectoryConfig)SetCertificateBasedAuthProperties(val interface{}) {
	if err := j.validateSetCertificateBasedAuthPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDirectoryConfig)SetServiceAccountCredentials(val interface{}) {
	if err := j.validateSetServiceAccountCredentialsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDirectoryConfig_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDirectoryConfig_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDirectoryConfig_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDirectoryConfig_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDirectoryConfig_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDirectoryConfig_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDirectoryConfig) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryConfig) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDirectoryConfig) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDirectoryConfig) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDirectoryConfig) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDirectoryConfig) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDirectoryConfig) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryConfig) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryConfig) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDirectoryConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
