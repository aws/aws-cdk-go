...
func (j *jsiiProxy_CfnFleet) validateSetComputeCapacityParameters(val interface{}) error {
	...
	case CfnFleet_ComputeCapacityProperty:
		val_ := val.(CfnFleet_ComputeCapacityProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFleet) validateSetDomainJoinInfoParameters(val interface{}) error {
	...
	case CfnFleet_DomainJoinInfoProperty:
		val_ := val.(CfnFleet_DomainJoinInfoProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
...
func (j *jsiiProxy_CfnFleet) validateSetEnableDefaultInternetAccessParameters(val interface{}) error {
	switch val.(type) {
	case *bool:
		// ok
	case bool:
...
func (j *jsiiProxy_CfnFleet) validateSetInstanceTypeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnFleet) validateSetRootVolumeConfigParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnFleet_VolumeConfigProperty:
		val := val.(*CfnFleet_VolumeConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnFleet_VolumeConfigProperty:
		val_ := val.(CfnFleet_VolumeConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnFleet_VolumeConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnFleet) validateSetSessionScriptS3LocationParameters(val interface{}) error {
	...
	case CfnFleet_S3LocationProperty:
		val_ := val.(CfnFleet_S3LocationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
