...
func (c *jsiiProxy_CfnStack) validateSynthesizeParameters(session awscdk.ISynthesisSession) error {
	return nil
}
...
func validateNewCfnStackParameters(scope awscdk.Construct, id *string, props *CfnStackProps) error {
	return nil
}
