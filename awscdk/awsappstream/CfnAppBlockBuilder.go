...
//
//   cfnAppBlockBuilder := awscdk.Aws_appstream.NewCfnAppBlockBuilder(this, jsii.String("MyCfnAppBlockBuilder"), &CfnAppBlockBuilderProps{
...
func (j *jsiiProxy_CfnAppBlockBuilder) AppBlockArns() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"appBlockArns",
...
func (j *jsiiProxy_CfnAppBlockBuilder) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnAppBlockBuilder) AttrCreatedTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedTime",
...
func (j *jsiiProxy_CfnAppBlockBuilder) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnAppBlockBuilder) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnAppBlockBuilder) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAppBlockBuilder) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnAppBlockBuilder) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnAppBlockBuilder) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CfnAppBlockBuilder) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_CfnAppBlockBuilder) EnableDefaultInternetAccess() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAppBlockBuilder) IamRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"iamRoleArn",
...
func (j *jsiiProxy_CfnAppBlockBuilder) InstanceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceType",
...
func (j *jsiiProxy_CfnAppBlockBuilder) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnAppBlockBuilder) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnAppBlockBuilder) Node() constructs.Node {
...
func (j *jsiiProxy_CfnAppBlockBuilder) Platform() *string {
	var returns *string
	_jsii_.Get(
		j,
		"platform",
...
func (j *jsiiProxy_CfnAppBlockBuilder) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnAppBlockBuilder) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnAppBlockBuilder) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnAppBlockBuilder) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func (j *jsiiProxy_CfnAppBlockBuilder) VpcConfig() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"vpcConfig",
...
func NewCfnAppBlockBuilder(scope constructs.Construct, id *string, props *CfnAppBlockBuilderProps) CfnAppBlockBuilder {
	...
	if err := validateNewCfnAppBlockBuilderParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetAccessEndpoints(val interface{}) {
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetAppBlockArns(val *[]*string) {
	_jsii_.Set(
		j,
		"appBlockArns",
		val,
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetDisplayName(val *string) {
	_jsii_.Set(
		j,
		"displayName",
		val,
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetEnableDefaultInternetAccess(val interface{}) {
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetIamRoleArn(val *string) {
	_jsii_.Set(
		j,
		"iamRoleArn",
		val,
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetInstanceType(val *string) {
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetName(val *string) {
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetPlatform(val *string) {
...
func (j *jsiiProxy_CfnAppBlockBuilder)SetVpcConfig(val interface{}) {
...
func CfnAppBlockBuilder_IsCfnElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAppBlockBuilder_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppBlockBuilder_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAppBlockBuilder_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppBlockBuilder_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAppBlockBuilder_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppBlockBuilder_CFN_RESOURCE_TYPE_NAME() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appstream.CfnAppBlockBuilder",
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAppBlockBuilder) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAppBlockBuilder) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnAppBlockBuilder) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAppBlockBuilder) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnAppBlockBuilder) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnAppBlockBuilder) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnAppBlockBuilder) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnAppBlockBuilder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
