...
func (j *jsiiProxy_CfnImageBuilder) CfnPropertyNames() *map[string]*string {
...
func CfnImageBuilder_IsCfnImageBuilder(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnImageBuilder_IsCfnImageBuilderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnImageBuilder) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnImageBuilder) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnImageBuilder) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnImageBuilder) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnImageBuilder) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
