...
func (j *jsiiProxy_CfnApplicationEntitlementAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnApplicationEntitlementAssociation_IsCfnApplicationEntitlementAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationEntitlementAssociation_IsCfnApplicationEntitlementAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_appstream.CfnApplicationEntitlementAssociation",
		"isCfnApplicationEntitlementAssociation",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationEntitlementAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
