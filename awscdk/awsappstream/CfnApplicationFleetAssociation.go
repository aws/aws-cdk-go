...
type CfnApplicationFleetAssociation interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsappstream.IApplicationFleetAssociationRef
	// The ARN of the application.
	ApplicationArn() *string
	SetApplicationArn(val *string)
	// A reference to a ApplicationFleetAssociation resource.
	ApplicationFleetAssociationRef() *interfacesawsappstream.ApplicationFleetAssociationReference
...
type jsiiProxy_CfnApplicationFleetAssociation struct {
	...
	internal.Type__interfacesawsappstreamIApplicationFleetAssociationRef
}
...
func (j *jsiiProxy_CfnApplicationFleetAssociation) ApplicationFleetAssociationRef() *interfacesawsappstream.ApplicationFleetAssociationReference {
	var returns *interfacesawsappstream.ApplicationFleetAssociationReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnApplicationFleetAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApplicationFleetAssociation) Env() *interfaces.ResourceEnvironment {
...
func NewCfnApplicationFleetAssociation(scope constructs.Construct, id *string, props *CfnApplicationFleetAssociationProps) CfnApplicationFleetAssociation {
	...
	if err := validateNewCfnApplicationFleetAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApplicationFleetAssociation_IsCfnApplicationFleetAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationFleetAssociation_IsCfnApplicationFleetAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_appstream.CfnApplicationFleetAssociation",
		"isCfnApplicationFleetAssociation",
		[]interface{}{x},
		&returns,
	)
...
func CfnApplicationFleetAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationFleetAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationFleetAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationFleetAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationFleetAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
