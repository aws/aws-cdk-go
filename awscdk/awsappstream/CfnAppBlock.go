...
func (j *jsiiProxy_CfnAppBlock) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAppBlock) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnAppBlock(scope constructs.Construct, id *string, props *CfnAppBlockProps) CfnAppBlock {
	...
	if err := validateNewCfnAppBlockParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnAppBlock)SetSetupScriptDetails(val interface{}) {
	if err := j.validateSetSetupScriptDetailsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnAppBlock)SetSourceS3Location(val interface{}) {
	if err := j.validateSetSourceS3LocationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnAppBlock_ArnForAppBlock(resource interfacesawsappstream.IAppBlockRef) *string {
	_init_.Initialize()

	if err := validateCfnAppBlock_ArnForAppBlockParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnAppBlock_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAppBlock_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppBlock_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAppBlock_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAppBlock_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAppBlock_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAppBlock) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlock) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAppBlock) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAppBlock) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAppBlock) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAppBlock) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAppBlock) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlock) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlock) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppBlock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
