...
func (j *jsiiProxy_CfnStackUserAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnStackUserAssociation_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStackUserAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStackUserAssociation_IsCfnStackUserAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStackUserAssociation_IsCfnStackUserAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStackUserAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStackUserAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStackUserAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStackUserAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStackUserAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
