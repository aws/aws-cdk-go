...
func (j *jsiiProxy_CfnADMChannel) CfnPropertyNames() *map[string]*string {
...
func NewCfnADMChannel(scope constructs.Construct, id *string, props *CfnADMChannelProps) CfnADMChannel {
	...
	if err := validateNewCfnADMChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnADMChannel_IsCfnADMChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnADMChannel_IsCfnADMChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnADMChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnADMChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnADMChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnADMChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnADMChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnADMChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnADMChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnADMChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnADMChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnADMChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnADMChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnADMChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnADMChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnADMChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnADMChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnADMChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
