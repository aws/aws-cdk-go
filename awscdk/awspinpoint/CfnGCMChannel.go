...
func (j *jsiiProxy_CfnGCMChannel) CfnPropertyNames() *map[string]*string {
...
func CfnGCMChannel_IsCfnGCMChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnGCMChannel_IsCfnGCMChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGCMChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGCMChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGCMChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGCMChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGCMChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
