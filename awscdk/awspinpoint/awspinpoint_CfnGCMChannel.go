...
func NewCfnGCMChannel(scope constructs.Construct, id *string, props *CfnGCMChannelProps) CfnGCMChannel {
	...
	if err := validateNewCfnGCMChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnGCMChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnGCMChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnGCMChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnGCMChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGCMChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGCMChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGCMChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGCMChannel) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnGCMChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGCMChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
