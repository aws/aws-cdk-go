...
func (j *jsiiProxy_CfnApplicationSettings) CfnPropertyNames() *map[string]*string {
...
func NewCfnApplicationSettings(scope constructs.Construct, id *string, props *CfnApplicationSettingsProps) CfnApplicationSettings {
	...
	if err := validateNewCfnApplicationSettingsParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnApplicationSettings)SetQuietTime(val interface{}) {
	if err := j.validateSetQuietTimeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnApplicationSettings_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApplicationSettings_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationSettings_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnApplicationSettings_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApplicationSettings_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApplicationSettings_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApplicationSettings) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationSettings) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApplicationSettings) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApplicationSettings) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApplicationSettings) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApplicationSettings) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApplicationSettings) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationSettings) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationSettings) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApplicationSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
