...
func NewCfnEmailTemplate(scope constructs.Construct, id *string, props *CfnEmailTemplateProps) CfnEmailTemplate {
	...
	if err := validateNewCfnEmailTemplateParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnEmailTemplate_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnEmailTemplate_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEmailTemplate_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnEmailTemplate_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnEmailTemplate_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnEmailTemplate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEmailTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEmailTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEmailTemplate) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnEmailTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
