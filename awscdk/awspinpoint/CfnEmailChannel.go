...
func (j *jsiiProxy_CfnEmailChannel) CfnPropertyNames() *map[string]*string {
...
func CfnEmailChannel_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEmailChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEmailChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEmailChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEmailChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEmailChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnEmailChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnEmailChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
