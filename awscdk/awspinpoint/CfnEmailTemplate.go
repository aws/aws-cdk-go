...
func (j *jsiiProxy_CfnEmailTemplate) CfnPropertyNames() *map[string]*string {
...
func CfnEmailTemplate_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnEmailTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnEmailTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnEmailTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnEmailTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnEmailTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnEmailTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
