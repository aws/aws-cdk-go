...
func (j *jsiiProxy_CfnVoiceChannel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnVoiceChannel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnVoiceChannel(scope constructs.Construct, id *string, props *CfnVoiceChannelProps) CfnVoiceChannel {
	...
	if err := validateNewCfnVoiceChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnVoiceChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnVoiceChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVoiceChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVoiceChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Checks whether the given object is a CfnVoiceChannel.
func CfnVoiceChannel_IsCfnVoiceChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnVoiceChannel_IsCfnVoiceChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnVoiceChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnVoiceChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnVoiceChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVoiceChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnVoiceChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnVoiceChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnVoiceChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnVoiceChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnVoiceChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVoiceChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVoiceChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnVoiceChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
