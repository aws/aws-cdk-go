...
func (j *jsiiProxy_CfnAPNSVoipSandboxChannel) CfnPropertyNames() *map[string]*string {
...
// Checks whether the given object is a CfnAPNSVoipSandboxChannel.
func CfnAPNSVoipSandboxChannel_IsCfnAPNSVoipSandboxChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSVoipSandboxChannel_IsCfnAPNSVoipSandboxChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
