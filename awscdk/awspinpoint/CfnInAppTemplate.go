...
func (j *jsiiProxy_CfnInAppTemplate) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnInAppTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnInAppTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnInAppTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnInAppTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
