...
func (j *jsiiProxy_CfnBaiduChannel) CfnPropertyNames() *map[string]*string {
...
func NewCfnBaiduChannel(scope constructs.Construct, id *string, props *CfnBaiduChannelProps) CfnBaiduChannel {
	...
	if err := validateNewCfnBaiduChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnBaiduChannel_IsCfnBaiduChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBaiduChannel_IsCfnBaiduChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBaiduChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnBaiduChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBaiduChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnBaiduChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnBaiduChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnBaiduChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnBaiduChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBaiduChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnBaiduChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnBaiduChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnBaiduChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnBaiduChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnBaiduChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBaiduChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBaiduChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnBaiduChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
