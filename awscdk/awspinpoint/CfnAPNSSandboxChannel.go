...
type CfnAPNSSandboxChannel interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawspinpoint.IAPNSSandboxChannelRef
	// A reference to a APNSSandboxChannel resource.
	ApnsSandboxChannelRef() *interfacesawspinpoint.APNSSandboxChannelReference
...
type jsiiProxy_CfnAPNSSandboxChannel struct {
	...
	internal.Type__interfacesawspinpointIAPNSSandboxChannelRef
}

func (j *jsiiProxy_CfnAPNSSandboxChannel) ApnsSandboxChannelRef() *interfacesawspinpoint.APNSSandboxChannelReference {
	var returns *interfacesawspinpoint.APNSSandboxChannelReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnAPNSSandboxChannel) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnAPNSSandboxChannel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnAPNSSandboxChannel) Env() *interfaces.ResourceEnvironment {
...
func CfnAPNSSandboxChannel_IsCfnAPNSSandboxChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSSandboxChannel_IsCfnAPNSSandboxChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSSandboxChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSSandboxChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
