...
func (j *jsiiProxy_CfnSmsTemplate) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSmsTemplate) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnSmsTemplate_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSmsTemplate_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSmsTemplate) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSmsTemplate) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSmsTemplate) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSmsTemplate) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSmsTemplate) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSmsTemplate) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSmsTemplate) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSmsTemplate) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSmsTemplate) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSmsTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
