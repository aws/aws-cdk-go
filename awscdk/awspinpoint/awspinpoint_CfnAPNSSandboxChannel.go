...
func NewCfnAPNSSandboxChannel(scope constructs.Construct, id *string, props *CfnAPNSSandboxChannelProps) CfnAPNSSandboxChannel {
	...
	if err := validateNewCfnAPNSSandboxChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAPNSSandboxChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAPNSSandboxChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSSandboxChannel_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnAPNSSandboxChannel_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSSandboxChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAPNSSandboxChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSSandboxChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
