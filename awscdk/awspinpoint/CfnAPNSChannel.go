...
func (j *jsiiProxy_CfnAPNSChannel) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnAPNSChannel) CfnPropertyNames() *map[string]*string {
...
func NewCfnAPNSChannel(scope constructs.Construct, id *string, props *CfnAPNSChannelProps) CfnAPNSChannel {
	...
	if err := validateNewCfnAPNSChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAPNSChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAPNSChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAPNSChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAPNSChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAPNSChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAPNSChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAPNSChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAPNSChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAPNSChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
