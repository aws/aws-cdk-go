...
func (j *jsiiProxy_CfnAPNSVoipChannel) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnAPNSVoipChannel) CfnPropertyNames() *map[string]*string {
...
func CfnAPNSVoipChannel_IsCfnAPNSVoipChannel(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSVoipChannel_IsCfnAPNSVoipChannelParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAPNSVoipChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAPNSVoipChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAPNSVoipChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAPNSVoipChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAPNSVoipChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAPNSVoipChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAPNSVoipChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
