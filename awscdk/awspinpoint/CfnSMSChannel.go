...
func (j *jsiiProxy_CfnSMSChannel) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnSMSChannel) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnSMSChannel(scope constructs.Construct, id *string, props *CfnSMSChannelProps) CfnSMSChannel {
	...
	if err := validateNewCfnSMSChannelParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSMSChannel_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSMSChannel_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSMSChannel_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSMSChannel_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSMSChannel_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSMSChannel_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSMSChannel) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSMSChannel) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSMSChannel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSMSChannel) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSMSChannel) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSMSChannel) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSMSChannel) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSMSChannel) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSMSChannel) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSMSChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
