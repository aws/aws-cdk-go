...
func (j *jsiiProxy_CfnAppMonitor) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnAppMonitor) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAppMonitor) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAppMonitor) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAppMonitor) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAppMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
