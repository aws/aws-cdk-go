...
func init() {
	...
	_jsii_.RegisterStruct(
		"monocdk.aws_rum.CfnAppMonitor.CustomEventsProperty",
		reflect.TypeOf((*CfnAppMonitor_CustomEventsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_rum.CfnAppMonitor.MetricDefinitionProperty",
		reflect.TypeOf((*CfnAppMonitor_MetricDefinitionProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"monocdk.aws_rum.CfnAppMonitor.MetricDestinationProperty",
