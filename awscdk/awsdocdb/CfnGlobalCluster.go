...
//
//   cfnGlobalCluster := awscdk.Aws_docdb.NewCfnGlobalCluster(this, jsii.String("MyCfnGlobalCluster"), &CfnGlobalClusterProps{
...
type CfnGlobalCluster interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdocdb.IGlobalClusterRef
	awscdk.ITaggableV2
	// The Amazon Resource Name (ARN) for the global cluster.
	AttrGlobalClusterArn() *string
	...
	AttrGlobalClusterResourceId() *string
	...
	GlobalClusterRef() *interfacesawsdocdb.GlobalClusterReference
...
type jsiiProxy_CfnGlobalCluster struct {
	...
	internal.Type__interfacesawsdocdbIGlobalClusterRef
	internal.Type__awscdkITaggableV2
}

func (j *jsiiProxy_CfnGlobalCluster) AttrGlobalClusterArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGlobalClusterArn",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CfnGlobalCluster) AttrGlobalClusterResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrGlobalClusterResourceId",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CfnGlobalCluster) GlobalClusterRef() *interfacesawsdocdb.GlobalClusterReference {
	var returns *interfacesawsdocdb.GlobalClusterReference
	_jsii_.Get(
		j,
		"globalClusterRef",
		&returns,
...
func NewCfnGlobalCluster(scope constructs.Construct, id *string, props *CfnGlobalClusterProps) CfnGlobalCluster {
	...
	_jsii_.Create(
		"aws-cdk-lib.aws_docdb.CfnGlobalCluster",
...
func CfnGlobalCluster_ArnForGlobalCluster(resource interfacesawsdocdb.IGlobalClusterRef) *string {
	_init_.Initialize()

	if err := validateCfnGlobalCluster_ArnForGlobalClusterParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
