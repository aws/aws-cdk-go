...
func (j *jsiiProxy_CfnGraphQLApi) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnGraphQLApi) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGraphQLApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGraphQLApi) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGraphQLApi) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraphQLApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
