...
func (j *jsiiProxy_CfnResolver) CfnPropertyNames() *map[string]*string {
...
func CfnResolver_IsCfnResolver(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResolver_IsCfnResolverParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResolver) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResolver) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResolver) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResolver) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResolver) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
