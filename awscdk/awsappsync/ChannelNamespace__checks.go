...
func (c *jsiiProxy_ChannelNamespace) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateChannelNamespace_FromChannelNamespaceArnParameters(scope constructs.Construct, id *string, channelNamespaceArn *string) error {
	...
	if channelNamespaceArn == nil {
		return fmt.Errorf("parameter channelNamespaceArn is required, but nil was provided")
	}
