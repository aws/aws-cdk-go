...
func (j *jsiiProxy_AppsyncFunction) Env() *interfaces.ResourceEnvironment {
...
func AppsyncFunction_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateAppsyncFunction_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func AppsyncFunction_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appsync.AppsyncFunction",
...
func (a *jsiiProxy_AppsyncFunction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
