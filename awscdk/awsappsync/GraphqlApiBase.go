...
func (j *jsiiProxy_GraphqlApiBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_GraphqlApiBase) GraphQlApiRef() *interfacesawsappsync.GraphQLApiReference {
...
func (g *jsiiProxy_GraphqlApiBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
