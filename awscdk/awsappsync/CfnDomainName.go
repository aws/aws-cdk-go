...
func (j *jsiiProxy_CfnDomainName) AttrDomainNameArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDomainNameArn",
...
func (j *jsiiProxy_CfnDomainName) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnDomainName) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDomainName) Tags() *[]*awscdk.CfnTag {
...
func NewCfnDomainName(scope constructs.Construct, id *string, props *CfnDomainNameProps) CfnDomainName {
	...
	if err := validateNewCfnDomainNameParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnDomainName)SetTags(val *[]*awscdk.CfnTag) {
...
func CfnDomainName_ArnForDomainName(resource interfacesawsappsync.IDomainNameRef) *string {
	_init_.Initialize()
...
func CfnDomainName_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDomainName_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainName_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDomainName_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainName_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDomainName_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDomainName) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainName) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDomainName) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDomainName) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDomainName) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDomainName) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDomainName) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainName) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainName) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainName) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
