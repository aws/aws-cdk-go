...
func (j *jsiiProxy_CfnFunctionConfiguration) CfnPropertyNames() *map[string]*string {
...
func CfnFunctionConfiguration_IsCfnFunctionConfiguration(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnFunctionConfiguration_IsCfnFunctionConfigurationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnFunctionConfiguration_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnFunctionConfiguration_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnFunctionConfiguration) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnFunctionConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnFunctionConfiguration) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnFunctionConfiguration) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnFunctionConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
