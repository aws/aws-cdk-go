...
func (j *jsiiProxy_CfnApi) ApiRef() *interfacesawsappsync.ApiReference {
...
func (j *jsiiProxy_CfnApi) CfnPropertyNames() *map[string]*string {
...
func CfnApi_ArnForApi(resource interfacesawsappsync.IApiRef) *string {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApi) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApi) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApi) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
