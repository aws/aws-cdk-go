...
func (j *jsiiProxy_CfnDomainNameApiAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnDomainNameApiAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnDomainNameApiAssociation(scope constructs.Construct, id *string, props *CfnDomainNameApiAssociationProps) CfnDomainNameApiAssociation {
	...
	if err := validateNewCfnDomainNameApiAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnDomainNameApiAssociation_IsCfnDomainNameApiAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnDomainNameApiAssociation_IsCfnDomainNameApiAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainNameApiAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnDomainNameApiAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainNameApiAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnDomainNameApiAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnDomainNameApiAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnDomainNameApiAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDomainNameApiAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
