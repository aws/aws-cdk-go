...
func (j *jsiiProxy_CfnApiCache) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnApiCache) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnApiCache(scope constructs.Construct, id *string, props *CfnApiCacheProps) CfnApiCache {
	...
	if err := validateNewCfnApiCacheParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnApiCache_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnApiCache_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiCache_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnApiCache_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnApiCache_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnApiCache_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnApiCache) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiCache) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnApiCache) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnApiCache) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnApiCache) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnApiCache) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnApiCache) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiCache) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiCache) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnApiCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
