...
func (j *jsiiProxy_CfnGraphQLSchema) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnGraphQLSchema) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func CfnGraphQLSchema_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnGraphQLSchema_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnGraphQLSchema) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraphQLSchema) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnGraphQLSchema) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnGraphQLSchema) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnGraphQLSchema) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnGraphQLSchema) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnGraphQLSchema) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraphQLSchema) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraphQLSchema) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnGraphQLSchema) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
