...
func (j *jsiiProxy_CfnDataSource)SetDynamoDbConfig(val interface{}) {
	if err := j.validateSetDynamoDbConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataSource)SetElasticsearchConfig(val interface{}) {
	if err := j.validateSetElasticsearchConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataSource)SetOpenSearchServiceConfig(val interface{}) {
	if err := j.validateSetOpenSearchServiceConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnDataSource)SetRelationalDatabaseConfig(val interface{}) {
	if err := j.validateSetRelationalDatabaseConfigParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnDataSource_ArnForDataSource(resource interfacesawsappsync.IDataSourceRef) *string {
	_init_.Initialize()
