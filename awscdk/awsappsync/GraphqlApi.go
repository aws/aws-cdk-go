...
func (j *jsiiProxy_GraphqlApi) Env() *interfaces.ResourceEnvironment {
...
func GraphqlApi_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_appsync.GraphqlApi",
...
func (g *jsiiProxy_GraphqlApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GraphqlApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
