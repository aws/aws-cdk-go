...
func (j *jsiiProxy_CfnApi) validateSetEventConfigParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnApi_EventConfigProperty:
		val := val.(*CfnApi_EventConfigProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnApi_EventConfigProperty:
		val_ := val.(CfnApi_EventConfigProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnApi_EventConfigProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnApi) validateSetNameParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnApi) validateSetTagsParameters(val *[]*awscdk.CfnTag) error {
