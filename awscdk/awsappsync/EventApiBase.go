...
func (j *jsiiProxy_EventApiBase) ApiRef() *interfacesawsappsync.ApiReference {
...
func (e *jsiiProxy_EventApiBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
