...
func (e *jsiiProxy_EventApi) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (e *jsiiProxy_EventApi) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
