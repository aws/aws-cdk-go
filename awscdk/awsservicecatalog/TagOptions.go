...
func (j *jsiiProxy_TagOptions) Env() *interfaces.ResourceEnvironment {
...
func TagOptions_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicecatalog.TagOptions",
...
func (t *jsiiProxy_TagOptions) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TagOptions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
