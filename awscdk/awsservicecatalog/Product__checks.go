...
func (p *jsiiProxy_Product) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateProduct_FromProductArnParameters(scope constructs.Construct, id *string, productArn *string) error {
	...
	if productArn == nil {
		return fmt.Errorf("parameter productArn is required, but nil was provided")
	}
