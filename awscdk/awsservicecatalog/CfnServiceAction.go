...
func (j *jsiiProxy_CfnServiceAction) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServiceAction) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnServiceAction(scope constructs.Construct, id *string, props *CfnServiceActionProps) CfnServiceAction {
	...
	if err := validateNewCfnServiceActionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnServiceAction)SetDefinitionType(val *string) {
	if err := j.validateSetDefinitionTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnServiceAction_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnServiceAction_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceAction_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnServiceAction_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceAction_IsCfnServiceAction(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnServiceAction_IsCfnServiceActionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceAction_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnServiceAction_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServiceAction) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceAction) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceAction) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServiceAction) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceAction) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServiceAction) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServiceAction) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceAction) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceAction) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
