...
func (j *jsiiProxy_CfnCloudFormationProduct) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnCloudFormationProduct) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCloudFormationProduct) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCloudFormationProduct) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCloudFormationProduct) RemoveResourceDependency(target awscdk.CfnResource) {
