...
func (j *jsiiProxy_CfnPortfolio) CfnPropertyNames() *map[string]*string {
...
func NewCfnPortfolio(scope constructs.Construct, id *string, props *CfnPortfolioProps) CfnPortfolio {
	...
	if err := validateNewCfnPortfolioParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPortfolio_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPortfolio_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolio_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPortfolio_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolio_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPortfolio_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPortfolio) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolio) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPortfolio) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPortfolio) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPortfolio) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPortfolio) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPortfolio) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolio) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolio) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolio) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
