...
func (j *jsiiProxy_CfnStackSetConstraint) CfnPropertyNames() *map[string]*string {
...
func CfnStackSetConstraint_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStackSetConstraint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnStackSetConstraint_IsCfnStackSetConstraint(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnStackSetConstraint_IsCfnStackSetConstraintParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnStackSetConstraint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnStackSetConstraint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnStackSetConstraint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnStackSetConstraint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnStackSetConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
