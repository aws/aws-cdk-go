...
func (j *jsiiProxy_Product) Env() *interfaces.ResourceEnvironment {
...
func (p *jsiiProxy_Product) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_Product) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
