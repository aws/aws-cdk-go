...
func (j *jsiiProxy_CfnCloudFormationProvisionedProduct) CfnPropertyNames() *map[string]*string {
...
func CfnCloudFormationProvisionedProduct_IsCfnCloudFormationProvisionedProduct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnCloudFormationProvisionedProduct_IsCfnCloudFormationProvisionedProductParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_servicecatalog.CfnCloudFormationProvisionedProduct",
		"isCfnCloudFormationProvisionedProduct",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnCloudFormationProvisionedProduct) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnCloudFormationProvisionedProduct) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnCloudFormationProvisionedProduct) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnCloudFormationProvisionedProduct) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnCloudFormationProvisionedProduct) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
