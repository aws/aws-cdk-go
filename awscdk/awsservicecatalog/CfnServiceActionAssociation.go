...
func (j *jsiiProxy_CfnServiceActionAssociation) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnServiceActionAssociation) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnServiceActionAssociation(scope constructs.Construct, id *string, props *CfnServiceActionAssociationProps) CfnServiceActionAssociation {
	...
	if err := validateNewCfnServiceActionAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnServiceActionAssociation)SetServiceActionId(val *string) {
	if err := j.validateSetServiceActionIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnServiceActionAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnServiceActionAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceActionAssociation_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnServiceActionAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnServiceActionAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnServiceActionAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnServiceActionAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnServiceActionAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnServiceActionAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnServiceActionAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnServiceActionAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
