...
func (j *jsiiProxy_CfnAcceptedPortfolioShare) CfnPropertyNames() *map[string]*string {
...
func NewCfnAcceptedPortfolioShare(scope constructs.Construct, id *string, props *CfnAcceptedPortfolioShareProps) CfnAcceptedPortfolioShare {
	...
	if err := validateNewCfnAcceptedPortfolioShareParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnAcceptedPortfolioShare_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnAcceptedPortfolioShare_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAcceptedPortfolioShare_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnAcceptedPortfolioShare_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnAcceptedPortfolioShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
