...
func (j *jsiiProxy_CfnLaunchRoleConstraint) CfnPropertyNames() *map[string]*string {
...
func NewCfnLaunchRoleConstraint(scope constructs.Construct, id *string, props *CfnLaunchRoleConstraintProps) CfnLaunchRoleConstraint {
	...
	if err := validateNewCfnLaunchRoleConstraintParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLaunchRoleConstraint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLaunchRoleConstraint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchRoleConstraint_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnLaunchRoleConstraint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchRoleConstraint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLaunchRoleConstraint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchRoleConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
