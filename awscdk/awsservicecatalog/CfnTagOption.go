...
type CfnTagOption interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsservicecatalog.ITagOptionRef
	...
	TagOptionRef() *interfacesawsservicecatalog.TagOptionReference
	// Deprecated.
...
type jsiiProxy_CfnTagOption struct {
	...
	internal.Type__interfacesawsservicecatalogITagOptionRef
}
...
func (j *jsiiProxy_CfnTagOption) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnTagOption) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnTagOption) TagOptionRef() *interfacesawsservicecatalog.TagOptionReference {
	var returns *interfacesawsservicecatalog.TagOptionReference
	_jsii_.Get(
		j,
		"tagOptionRef",
		&returns,
...
func NewCfnTagOption(scope constructs.Construct, id *string, props *CfnTagOptionProps) CfnTagOption {
	...
	if err := validateNewCfnTagOptionParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnTagOption_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnTagOption_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTagOption_IsCfnTagOption(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTagOption_IsCfnTagOptionParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTagOption_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnTagOption_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnTagOption) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagOption) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnTagOption) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnTagOption) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnTagOption) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnTagOption) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnTagOption) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagOption) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagOption) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnTagOption) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
