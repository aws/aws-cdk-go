...
func (j *jsiiProxy_CfnLaunchNotificationConstraint) CfnPropertyNames() *map[string]*string {
...
func NewCfnLaunchNotificationConstraint(scope constructs.Construct, id *string, props *CfnLaunchNotificationConstraintProps) CfnLaunchNotificationConstraint {
	...
	if err := validateNewCfnLaunchNotificationConstraintParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLaunchNotificationConstraint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLaunchNotificationConstraint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchNotificationConstraint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLaunchNotificationConstraint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchNotificationConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
