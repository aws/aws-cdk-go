...
type CfnPortfolioShare interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsservicecatalog.IPortfolioShareRef
	// The language code.
	...
	PortfolioShareRef() *interfacesawsservicecatalog.PortfolioShareReference
...
type jsiiProxy_CfnPortfolioShare struct {
	...
	internal.Type__interfacesawsservicecatalogIPortfolioShareRef
}
...
func (j *jsiiProxy_CfnPortfolioShare) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnPortfolioShare) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnPortfolioShare) PortfolioShareRef() *interfacesawsservicecatalog.PortfolioShareReference {
	var returns *interfacesawsservicecatalog.PortfolioShareReference
	_jsii_.Get(
		j,
		"portfolioShareRef",
		&returns,
...
func NewCfnPortfolioShare(scope constructs.Construct, id *string, props *CfnPortfolioShareProps) CfnPortfolioShare {
	...
	if err := validateNewCfnPortfolioShareParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPortfolioShare_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPortfolioShare_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolioShare_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPortfolioShare_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolioShare_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPortfolioShare_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPortfolioShare) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioShare) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPortfolioShare) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPortfolioShare) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPortfolioShare) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPortfolioShare) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPortfolioShare) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioShare) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioShare) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioShare) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
