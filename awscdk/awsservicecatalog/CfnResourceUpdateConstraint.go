...
func (j *jsiiProxy_CfnResourceUpdateConstraint) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnResourceUpdateConstraint) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnResourceUpdateConstraint(scope constructs.Construct, id *string, props *CfnResourceUpdateConstraintProps) CfnResourceUpdateConstraint {
	...
	if err := validateNewCfnResourceUpdateConstraintParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnResourceUpdateConstraint)SetTagUpdateOnProvisionedProduct(val *string) {
	if err := j.validateSetTagUpdateOnProvisionedProductParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func CfnResourceUpdateConstraint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnResourceUpdateConstraint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceUpdateConstraint_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnResourceUpdateConstraint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnResourceUpdateConstraint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnResourceUpdateConstraint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnResourceUpdateConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
