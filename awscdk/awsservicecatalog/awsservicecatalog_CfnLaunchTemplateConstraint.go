...
func NewCfnLaunchTemplateConstraint(scope constructs.Construct, id *string, props *CfnLaunchTemplateConstraintProps) CfnLaunchTemplateConstraint {
	...
	if err := validateNewCfnLaunchTemplateConstraintParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnLaunchTemplateConstraint_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnLaunchTemplateConstraint_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchTemplateConstraint_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnLaunchTemplateConstraint_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchTemplateConstraint_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnLaunchTemplateConstraint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
