...
func (j *jsiiProxy_CfnLaunchTemplateConstraint) CfnPropertyNames() *map[string]*string {
...
func CfnLaunchTemplateConstraint_IsCfnLaunchTemplateConstraint(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLaunchTemplateConstraint_IsCfnLaunchTemplateConstraintParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnLaunchTemplateConstraint_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnLaunchTemplateConstraint_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnLaunchTemplateConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
