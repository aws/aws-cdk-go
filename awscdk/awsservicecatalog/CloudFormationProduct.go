...
func (j *jsiiProxy_CloudFormationProduct) CloudFormationProductRef() *interfacesawsservicecatalog.CloudFormationProductReference {
...
func (j *jsiiProxy_CloudFormationProduct) Env() *interfaces.ResourceEnvironment {
...
func CloudFormationProduct_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicecatalog.CloudFormationProduct",
...
func (c *jsiiProxy_CloudFormationProduct) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CloudFormationProduct) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
