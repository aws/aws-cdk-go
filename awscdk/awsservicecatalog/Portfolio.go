...
func (j *jsiiProxy_Portfolio) Env() *interfaces.ResourceEnvironment {
...
func Portfolio_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"aws-cdk-lib.aws_servicecatalog.Portfolio",
...
func (p *jsiiProxy_Portfolio) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
