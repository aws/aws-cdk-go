...
func (j *jsiiProxy_CfnPortfolioPrincipalAssociation) CfnPropertyNames() *map[string]*string {
...
func CfnPortfolioPrincipalAssociation_IsCfnPortfolioPrincipalAssociation(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnPortfolioPrincipalAssociation_IsCfnPortfolioPrincipalAssociationParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
	...
	_jsii_.StaticInvoke(
		"aws-cdk-lib.aws_servicecatalog.CfnPortfolioPrincipalAssociation",
		"isCfnPortfolioPrincipalAssociation",
		[]interface{}{x},
		&returns,
	)
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
