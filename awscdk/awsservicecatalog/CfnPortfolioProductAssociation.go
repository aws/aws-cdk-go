...
func (j *jsiiProxy_CfnPortfolioProductAssociation) CfnPropertyNames() *map[string]*string {
...
func NewCfnPortfolioProductAssociation(scope constructs.Construct, id *string, props *CfnPortfolioProductAssociationProps) CfnPortfolioProductAssociation {
	...
	if err := validateNewCfnPortfolioProductAssociationParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnPortfolioProductAssociation_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnPortfolioProductAssociation_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolioProductAssociation_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnPortfolioProductAssociation_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnPortfolioProductAssociation_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnPortfolioProductAssociation_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnPortfolioProductAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
