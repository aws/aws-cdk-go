...
func validateCfnCluster_ArnForClusterParameters(resource interfacesawspcs.IClusterRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnCluster) validateSetNetworkingParameters(val interface{}) error {
	if val == nil {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_NetworkingProperty:
		val := val.(*CfnCluster_NetworkingProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_NetworkingProperty:
		val_ := val.(CfnCluster_NetworkingProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_NetworkingProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCluster) validateSetSchedulerParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_SchedulerProperty:
		val := val.(*CfnCluster_SchedulerProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_SchedulerProperty:
		val_ := val.(CfnCluster_SchedulerProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_SchedulerProperty; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_CfnCluster) validateSetSizeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_CfnCluster) validateSetSlurmConfigurationParameters(val interface{}) error {
	switch val.(type) {
	case awscdk.IResolvable:
		// ok
	case *CfnCluster_SlurmConfigurationProperty:
		val := val.(*CfnCluster_SlurmConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnCluster_SlurmConfigurationProperty:
		val_ := val.(CfnCluster_SlurmConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnCluster_SlurmConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
