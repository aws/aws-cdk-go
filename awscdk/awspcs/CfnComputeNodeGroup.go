...
func (j *jsiiProxy_CfnComputeNodeGroup) AmiId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"amiId",
...
func (j *jsiiProxy_CfnComputeNodeGroup) AttrArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrArn",
...
func (j *jsiiProxy_CfnComputeNodeGroup) AttrErrorInfo() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnComputeNodeGroup) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnComputeNodeGroup) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnComputeNodeGroup) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnComputeNodeGroup) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnComputeNodeGroup) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnComputeNodeGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnComputeNodeGroup) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnComputeNodeGroup) ClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterId",
...
func (j *jsiiProxy_CfnComputeNodeGroup) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnComputeNodeGroup) CustomLaunchTemplate() interface{} {
...
func (j *jsiiProxy_CfnComputeNodeGroup) IamInstanceProfileArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnComputeNodeGroup) InstanceConfigs() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"instanceConfigs",
...
func (j *jsiiProxy_CfnComputeNodeGroup) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnComputeNodeGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnComputeNodeGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnComputeNodeGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnComputeNodeGroup) ScalingConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnComputeNodeGroup) SlurmConfiguration() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"slurmConfiguration",
...
func (j *jsiiProxy_CfnComputeNodeGroup) SpotOptions() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"spotOptions",
...
func (j *jsiiProxy_CfnComputeNodeGroup) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnComputeNodeGroup) SubnetIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"subnetIds",
...
func (j *jsiiProxy_CfnComputeNodeGroup) Tags() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_CfnComputeNodeGroup) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnComputeNodeGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnComputeNodeGroup(scope constructs.Construct, id *string, props *CfnComputeNodeGroupProps) CfnComputeNodeGroup {
	...
	if err := validateNewCfnComputeNodeGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetAmiId(val *string) {
	_jsii_.Set(
		j,
		"amiId",
		val,
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetClusterId(val *string) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetCustomLaunchTemplate(val interface{}) {
	if err := j.validateSetCustomLaunchTemplateParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetIamInstanceProfileArn(val *string) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetInstanceConfigs(val interface{}) {
	if err := j.validateSetInstanceConfigsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetPurchaseOption(val *string) {
	_jsii_.Set(
		j,
		"purchaseOption",
		val,
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetScalingConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetSlurmConfiguration(val interface{}) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetSpotOptions(val interface{}) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetSubnetIds(val *[]*string) {
...
func (j *jsiiProxy_CfnComputeNodeGroup)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnComputeNodeGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnComputeNodeGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnComputeNodeGroup_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnComputeNodeGroup_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnComputeNodeGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnComputeNodeGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnComputeNodeGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnComputeNodeGroup) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnComputeNodeGroup) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnComputeNodeGroup) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnComputeNodeGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnComputeNodeGroup) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnComputeNodeGroup) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnComputeNodeGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
