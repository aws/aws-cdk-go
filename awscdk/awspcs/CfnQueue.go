...
type CfnQueue interface {
	...
	QueueRef() *interfacesawspcs.QueueReference
...
type jsiiProxy_CfnQueue struct {
	...
	internal.Type__interfacesawspcsIQueueRef
...
func (j *jsiiProxy_CfnQueue) AttrErrorInfo() awscdk.IResolvable {
...
func (j *jsiiProxy_CfnQueue) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnQueue) ClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterId",
...
func (j *jsiiProxy_CfnQueue) ComputeNodeGroupConfigurations() interface{} {
...
func (j *jsiiProxy_CfnQueue) QueueRef() *interfacesawspcs.QueueReference {
	var returns *interfacesawspcs.QueueReference
	_jsii_.Get(
		j,
		"queueRef",
		&returns,
...
func (j *jsiiProxy_CfnQueue) Tags() *map[string]*string {
...
func (j *jsiiProxy_CfnQueue)SetClusterId(val *string) {
...
func (j *jsiiProxy_CfnQueue)SetComputeNodeGroupConfigurations(val interface{}) {
	if err := j.validateSetComputeNodeGroupConfigurationsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CfnQueue)SetTags(val *map[string]*string) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func CfnQueue_ArnForQueue(resource interfacesawspcs.IQueueRef) *string {
	_init_.Initialize()
