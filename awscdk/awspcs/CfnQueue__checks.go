...
func validateCfnQueue_ArnForQueueParameters(resource interfacesawspcs.IQueueRef) error {
	if resource == nil {
...
func (j *jsiiProxy_CfnQueue) validateSetClusterIdParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CfnQueue) validateSetComputeNodeGroupConfigurationsParameters(val interface{}) error {
	switch val.(type) {
	...
	case *[]interface{}:
		...
		for idx_97dfc6, v := range *val {
			...
			case awscdk.IResolvable:
				// ok
			case *CfnQueue_ComputeNodeGroupConfigurationProperty:
				v := v.(*CfnQueue_ComputeNodeGroupConfigurationProperty)
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			case CfnQueue_ComputeNodeGroupConfigurationProperty:
				v_ := v.(CfnQueue_ComputeNodeGroupConfigurationProperty)
				v := &v_
				if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
					return err
				}
			default:
				if !_jsii_.IsAnonymousProxy(v) {
					return fmt.Errorf("parameter val[%#v] must be one of the allowed types: awscdk.IResolvable, *CfnQueue_ComputeNodeGroupConfigurationProperty; received %#v (a %T)", idx_97dfc6, v, v)
				}
			}
		}
	case []interface{}:
...
func (j *jsiiProxy_CfnQueue) validateSetSlurmConfigurationParameters(val interface{}) error {
	...
	case awscdk.IResolvable:
		// ok
	case *CfnQueue_SlurmConfigurationProperty:
		val := val.(*CfnQueue_SlurmConfigurationProperty)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case CfnQueue_SlurmConfigurationProperty:
		val_ := val.(CfnQueue_SlurmConfigurationProperty)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: awscdk.IResolvable, *CfnQueue_SlurmConfigurationProperty; received %#v (a %T)", val, val)
		}
	}
