...
func (j *jsiiProxy_CfnScheduleGroup) AttrCreationDate() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreationDate",
...
func (j *jsiiProxy_CfnScheduleGroup) AttrLastModificationDate() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CfnScheduleGroup) AttrState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrState",
...
func (j *jsiiProxy_CfnScheduleGroup) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnScheduleGroup) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnScheduleGroup) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnScheduleGroup) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnScheduleGroup) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnScheduleGroup) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnScheduleGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnScheduleGroup) Node() constructs.Node {
...
func (j *jsiiProxy_CfnScheduleGroup) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnScheduleGroup) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnScheduleGroup) Tags() awscdk.TagManager {
...
func (j *jsiiProxy_CfnScheduleGroup) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnScheduleGroup(scope constructs.Construct, id *string, props *CfnScheduleGroupProps) CfnScheduleGroup {
	...
	if err := validateNewCfnScheduleGroupParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnScheduleGroup)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func CfnScheduleGroup_ArnForScheduleGroup(resource interfacesawsscheduler.IScheduleGroupRef) *string {
	_init_.Initialize()

	if err := validateCfnScheduleGroup_ArnForScheduleGroupParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnScheduleGroup_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnScheduleGroup_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnScheduleGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnScheduleGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnScheduleGroup) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnScheduleGroup) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnScheduleGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnScheduleGroup) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnScheduleGroup) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnScheduleGroup) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnScheduleGroup) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnScheduleGroup) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnScheduleGroup) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnScheduleGroup) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnScheduleGroup) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduleGroup) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduleGroup) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnScheduleGroup) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnScheduleGroup) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnScheduleGroup) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnScheduleGroup) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnScheduleGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
