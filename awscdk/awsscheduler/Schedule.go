...
func (j *jsiiProxy_Schedule) Env() *interfaces.ResourceEnvironment {
...
func (s *jsiiProxy_Schedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
