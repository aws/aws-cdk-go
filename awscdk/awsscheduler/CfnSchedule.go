...
func (j *jsiiProxy_CfnSchedule) CfnPropertyNames() *map[string]*string {
...
func CfnSchedule_IsCfnSchedule(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSchedule_IsCfnScheduleParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSchedule) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSchedule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSchedule) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSchedule) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
