...
//
//   cfnDirectConnectGatewayAssociationProps := &CfnDirectConnectGatewayAssociationProps{
...
//
type CfnDirectConnectGatewayAssociationProps struct {
	...
	//
	AssociatedGatewayId interface{} `field:"required" json:"associatedGatewayId" yaml:"associatedGatewayId"`
