...
//
//   cfnConnection := awscdk.Aws_directconnect.NewCfnConnection(this, jsii.String("MyCfnConnection"), &CfnConnectionProps{
...
type CfnConnection interface {
	awscdk.CfnResource
	awscdk.IInspectable
	interfacesawsdirectconnect.IConnectionRef
	awscdk.ITaggableV2
	...
	ConnectionRef() *interfacesawsdirectconnect.ConnectionReference
...
type jsiiProxy_CfnConnection struct {
	...
	internal.Type__interfacesawsdirectconnectIConnectionRef
...
func (j *jsiiProxy_CfnConnection) AttrConnectionState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrConnectionState",
...
func (j *jsiiProxy_CfnConnection) ConnectionRef() *interfacesawsdirectconnect.ConnectionReference {
	var returns *interfacesawsdirectconnect.ConnectionReference
	_jsii_.Get(
		j,
		"connectionRef",
		&returns,
...
func (j *jsiiProxy_CfnConnection) LagId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lagId",
...
func (j *jsiiProxy_CfnConnection) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_CfnConnection) ProviderName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"providerName",
...
func (j *jsiiProxy_CfnConnection) RequestMacSec() interface{} {
...
func (j *jsiiProxy_CfnConnection)SetLagId(val *string) {
	_jsii_.Set(
		j,
		"lagId",
		val,
...
func (j *jsiiProxy_CfnConnection)SetLocation(val *string) {
...
func (j *jsiiProxy_CfnConnection)SetProviderName(val *string) {
	_jsii_.Set(
		j,
		"providerName",
		val,
...
func (j *jsiiProxy_CfnConnection)SetRequestMacSec(val interface{}) {
...
func CfnConnection_ArnForConnection(resource interfacesawsdirectconnect.IConnectionRef) *string {
	_init_.Initialize()
