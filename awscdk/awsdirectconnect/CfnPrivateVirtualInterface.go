...
func (j *jsiiProxy_CfnPrivateVirtualInterface) CfnPropertyNames() *map[string]*string {
...
func CfnPrivateVirtualInterface_ArnForPrivateVirtualInterface(resource interfacesawsdirectconnect.IPrivateVirtualInterfaceRef) *string {
	_init_.Initialize()

	if err := validateCfnPrivateVirtualInterface_ArnForPrivateVirtualInterfaceParameters(resource); err != nil {
		panic(err)
	}
	var returns *string
...
func CfnPrivateVirtualInterface_FromVirtualInterfaceId(scope constructs.Construct, id *string, virtualInterfaceId *string) interfacesawsdirectconnect.IPrivateVirtualInterfaceRef {
	_init_.Initialize()

	if err := validateCfnPrivateVirtualInterface_FromVirtualInterfaceIdParameters(scope, id, virtualInterfaceId); err != nil {
		panic(err)
	}
	var returns interfacesawsdirectconnect.IPrivateVirtualInterfaceRef
...
func (c *jsiiProxy_CfnPrivateVirtualInterface) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnPrivateVirtualInterface) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnPrivateVirtualInterface) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnPrivateVirtualInterface) RemoveResourceDependency(target awscdk.CfnResource) {
