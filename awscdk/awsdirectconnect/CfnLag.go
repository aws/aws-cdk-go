...
func (j *jsiiProxy_CfnLag) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnLag) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnLag) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnLag) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnLag) RemoveResourceDependency(target awscdk.CfnResource) {
