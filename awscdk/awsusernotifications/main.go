...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CfnManagedNotificationConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "subCategory", GoGetter: "SubCategory"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__interfacesawsusernotificationsIManagedNotificationConfigurationRef)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"aws-cdk-lib.aws_usernotifications.CfnManagedNotificationConfigurationProps",
		reflect.TypeOf((*CfnManagedNotificationConfigurationProps)(nil)).Elem(),
	)
}
