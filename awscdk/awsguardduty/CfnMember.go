...
func (j *jsiiProxy_CfnMember) CfnPropertyNames() *map[string]*string {
...
func NewCfnMember(scope constructs.Construct, id *string, props *CfnMemberProps) CfnMember {
	...
	if err := validateNewCfnMemberParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMember_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMember_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMember_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMember_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMember_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMember_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMember) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMember) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMember) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMember) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMember) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMember) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMember) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMember) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMember) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
