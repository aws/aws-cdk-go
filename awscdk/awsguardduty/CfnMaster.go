...
func (j *jsiiProxy_CfnMaster) CfnPropertyNames() *map[string]*string {
...
func NewCfnMaster(scope constructs.Construct, id *string, props *CfnMasterProps) CfnMaster {
	...
	if err := validateNewCfnMasterParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnMaster_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnMaster_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMaster_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnMaster_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnMaster_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnMaster_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnMaster) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaster) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMaster) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMaster) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMaster) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnMaster) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnMaster) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaster) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaster) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMaster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
