...
func (j *jsiiProxy_CfnDetector) CfnPropertyNames() *map[string]*string {
...
func CfnDetector_IsCfnDetector(x interface{}) *bool {
	...
	if err := validateCfnDetector_IsCfnDetectorParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnDetector) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnDetector) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnDetector) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnDetector) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnDetector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
