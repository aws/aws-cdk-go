...
type jsiiProxy_CfnThreatIntelSet struct {
	...
	internal.Type__interfacesawsguarddutyIThreatIntelSetRef
...
func (j *jsiiProxy_CfnThreatIntelSet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnThreatIntelSet) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_CfnThreatIntelSet) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_CfnThreatIntelSet) ThreatIntelSetRef() *interfacesawsguardduty.ThreatIntelSetReference {
	var returns *interfacesawsguardduty.ThreatIntelSetReference
	_jsii_.Get(
		j,
		"threatIntelSetRef",
		&returns,
...
func NewCfnThreatIntelSet(scope constructs.Construct, id *string, props *CfnThreatIntelSetProps) CfnThreatIntelSet {
	...
	if err := validateNewCfnThreatIntelSetParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CfnThreatIntelSet)SetExpectedBucketOwner(val *string) {
	_jsii_.Set(
		j,
		"expectedBucketOwner",
		val,
...
func CfnThreatIntelSet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnThreatIntelSet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThreatIntelSet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnThreatIntelSet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThreatIntelSet_IsCfnThreatIntelSet(x interface{}) *bool {
	...
	if err := validateCfnThreatIntelSet_IsCfnThreatIntelSetParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThreatIntelSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnThreatIntelSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThreatIntelSet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatIntelSet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnThreatIntelSet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnThreatIntelSet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnThreatIntelSet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnThreatIntelSet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnThreatIntelSet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatIntelSet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatIntelSet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatIntelSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
