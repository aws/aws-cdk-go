...
func (j *jsiiProxy_CfnThreatEntitySet) Activate() interface{} {
...
func (j *jsiiProxy_CfnThreatEntitySet) AttrCreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrCreatedAt",
...
func (j *jsiiProxy_CfnThreatEntitySet) AttrErrorDetails() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrErrorDetails",
...
func (j *jsiiProxy_CfnThreatEntitySet) AttrId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrId",
...
func (j *jsiiProxy_CfnThreatEntitySet) AttrStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrStatus",
...
func (j *jsiiProxy_CfnThreatEntitySet) AttrUpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrUpdatedAt",
...
func (j *jsiiProxy_CfnThreatEntitySet) CdkTagManager() awscdk.TagManager {
...
func (j *jsiiProxy_CfnThreatEntitySet) CfnOptions() awscdk.ICfnResourceOptions {
...
func (j *jsiiProxy_CfnThreatEntitySet) CfnProperties() *map[string]interface{} {
...
func (j *jsiiProxy_CfnThreatEntitySet) CfnPropertyNames() *map[string]*string {
...
func (j *jsiiProxy_CfnThreatEntitySet) CfnResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cfnResourceType",
...
func (j *jsiiProxy_CfnThreatEntitySet) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CfnThreatEntitySet) DetectorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"detectorId",
...
func (j *jsiiProxy_CfnThreatEntitySet) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_CfnThreatEntitySet) Format() *string {
	var returns *string
	_jsii_.Get(
		j,
		"format",
...
func (j *jsiiProxy_CfnThreatEntitySet) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_CfnThreatEntitySet) LogicalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logicalId",
...
func (j *jsiiProxy_CfnThreatEntitySet) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CfnThreatEntitySet) Node() constructs.Node {
...
func (j *jsiiProxy_CfnThreatEntitySet) Ref() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ref",
...
func (j *jsiiProxy_CfnThreatEntitySet) Stack() awscdk.Stack {
...
func (j *jsiiProxy_CfnThreatEntitySet) Tags() *[]*CfnThreatEntitySet_TagItemProperty {
	var returns *[]*CfnThreatEntitySet_TagItemProperty
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CfnThreatEntitySet) UpdatedProperites() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperites",
...
func (j *jsiiProxy_CfnThreatEntitySet) UpdatedProperties() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
		"updatedProperties",
...
func NewCfnThreatEntitySet(scope constructs.Construct, id *string, props *CfnThreatEntitySetProps) CfnThreatEntitySet {
	...
	if err := validateNewCfnThreatEntitySetParameters(scope, id, props); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnThreatEntitySet{}
...
func (j *jsiiProxy_CfnThreatEntitySet)SetActivate(val interface{}) {
...
func (j *jsiiProxy_CfnThreatEntitySet)SetDetectorId(val *string) {
	_jsii_.Set(
		j,
		"detectorId",
		val,
...
func (j *jsiiProxy_CfnThreatEntitySet)SetExpectedBucketOwner(val *string) {
	_jsii_.Set(
		j,
		"expectedBucketOwner",
		val,
...
func (j *jsiiProxy_CfnThreatEntitySet)SetFormat(val *string) {
...
func (j *jsiiProxy_CfnThreatEntitySet)SetLocation(val *string) {
...
func (j *jsiiProxy_CfnThreatEntitySet)SetName(val *string) {
	_jsii_.Set(
		j,
		"name",
		val,
...
func (j *jsiiProxy_CfnThreatEntitySet)SetTags(val *[]*CfnThreatEntitySet_TagItemProperty) {
...
func CfnThreatEntitySet_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnThreatEntitySet_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThreatEntitySet_IsCfnResource(x interface{}) *bool {
	...
	if err := validateCfnThreatEntitySet_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnThreatEntitySet_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnThreatEntitySet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnThreatEntitySet) AddDeletionOverride(path *string) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddDependsOn(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddMetadata(key *string, value interface{}) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddPropertyDeletionOverride(propertyPath *string) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddPropertyOverride(propertyPath *string, value interface{}) {
...
func (c *jsiiProxy_CfnThreatEntitySet) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnThreatEntitySet) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnThreatEntitySet) ApplyRemovalPolicy(policy awscdk.RemovalPolicy, options *awscdk.RemovalPolicyOptions) {
...
func (c *jsiiProxy_CfnThreatEntitySet) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnThreatEntitySet) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnThreatEntitySet) GetMetadata(key *string) interface{} {
...
func (c *jsiiProxy_CfnThreatEntitySet) Inspect(inspector awscdk.TreeInspector) {
...
func (c *jsiiProxy_CfnThreatEntitySet) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnThreatEntitySet) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CfnThreatEntitySet) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatEntitySet) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatEntitySet) RenderProperties(props *map[string]interface{}) *map[string]interface{} {
...
func (c *jsiiProxy_CfnThreatEntitySet) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnThreatEntitySet) ShouldSynthesize() *bool {
	var returns *bool
...
func (c *jsiiProxy_CfnThreatEntitySet) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CfnThreatEntitySet) ValidateProperties(_properties interface{}) {
...
func (c *jsiiProxy_CfnThreatEntitySet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
