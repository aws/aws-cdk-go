...
func (j *jsiiProxy_CfnMicrosoftAD) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CfnMicrosoftAD) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnMicrosoftAD) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnMicrosoftAD) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnMicrosoftAD) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnMicrosoftAD) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
