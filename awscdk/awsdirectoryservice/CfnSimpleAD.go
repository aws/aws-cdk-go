...
func (j *jsiiProxy_CfnSimpleAD) CfnPropertyNames() *map[string]*string {
...
func CfnSimpleAD_IsCfnResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSimpleAD_IsCfnResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimpleAD_IsCfnSimpleAD(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnSimpleAD_IsCfnSimpleADParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimpleAD) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CfnSimpleAD) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CfnSimpleAD) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CfnSimpleAD) RemoveResourceDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleAD) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
