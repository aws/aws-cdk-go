...
func (j *jsiiProxy_CfnSimpleAD) AttrDirectoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"attrDirectoryId",
...
func NewCfnSimpleAD(scope constructs.Construct, id *string, props *CfnSimpleADProps) CfnSimpleAD {
	...
	if err := validateNewCfnSimpleADParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func CfnSimpleAD_IsCfnElement(x interface{}) *bool {
	...
	if err := validateCfnSimpleAD_IsCfnElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimpleAD_IsCfnResource(construct constructs.IConstruct) *bool {
	...
	if err := validateCfnSimpleAD_IsCfnResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnSimpleAD_IsConstruct(x interface{}) *bool {
	...
	if err := validateCfnSimpleAD_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_CfnSimpleAD) AddDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleAD) GetAtt(attributeName *string, typeHint awscdk.ResolutionTypeHint) awscdk.Reference {
...
func (c *jsiiProxy_CfnSimpleAD) ObtainDependencies() *[]interface{} {
	var returns *[]interface{}
...
func (c *jsiiProxy_CfnSimpleAD) ObtainResourceDependencies() *[]awscdk.CfnResource {
...
func (c *jsiiProxy_CfnSimpleAD) RemoveDependency(target awscdk.CfnResource) {
...
func (c *jsiiProxy_CfnSimpleAD) ReplaceDependency(target awscdk.CfnResource, newTarget awscdk.CfnResource) {
