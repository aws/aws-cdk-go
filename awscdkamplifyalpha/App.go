...
func (j *jsiiProxy_App) ComputeRole() awsiam.IRole {
...
func (j *jsiiProxy_App) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_App) Platform() Platform {
...
func App_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-amplify-alpha.App",
