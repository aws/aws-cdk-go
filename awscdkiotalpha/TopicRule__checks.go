...
func (t *jsiiProxy_TopicRule) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateTopicRule_FromTopicRuleArnParameters(scope constructs.Construct, id *string, topicRuleArn *string) error {
	...
	if topicRuleArn == nil {
		return fmt.Errorf("parameter topicRuleArn is required, but nil was provided")
	}
