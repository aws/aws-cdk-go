...
func (j *jsiiProxy_ScheduledAudit) Env() *interfaces.ResourceEnvironment {
...
func ScheduledAudit_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-iot-alpha.ScheduledAudit",
...
func (s *jsiiProxy_ScheduledAudit) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ScheduledAudit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
