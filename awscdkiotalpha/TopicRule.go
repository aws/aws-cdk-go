...
func (j *jsiiProxy_TopicRule) Env() *interfaces.ResourceEnvironment {
...
func TopicRule_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-iot-alpha.TopicRule",
...
func (t *jsiiProxy_TopicRule) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (t *jsiiProxy_TopicRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
