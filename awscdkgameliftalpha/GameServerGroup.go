...
func (j *jsiiProxy_GameServerGroup) Env() *interfaces.ResourceEnvironment {
...
func GameServerGroup_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-gamelift-alpha.GameServerGroup",
...
func (g *jsiiProxy_GameServerGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GameServerGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
