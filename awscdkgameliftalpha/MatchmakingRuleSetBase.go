...
func (j *jsiiProxy_MatchmakingRuleSetBase) Env() *interfaces.ResourceEnvironment {
...
func (m *jsiiProxy_MatchmakingRuleSetBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_MatchmakingRuleSetBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
