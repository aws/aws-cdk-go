...
func (j *jsiiProxy_MatchmakingRuleSet) Env() *interfaces.ResourceEnvironment {
...
func MatchmakingRuleSet_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-gamelift-alpha.MatchmakingRuleSet",
...
func (m *jsiiProxy_MatchmakingRuleSet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
