...
//   var topic topic
//
//   matchmakingConfigurationBase := gamelift_alpha.matchmakingConfigurationBase.fromMatchmakingConfigurationAttributes(this, jsii.String("MyMatchmakingConfigurationBase"), &matchmakingConfigurationAttributes{
