...
func (j *jsiiProxy_Build) Env() *interfaces.ResourceEnvironment {
...
func (b *jsiiProxy_Build) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (b *jsiiProxy_Build) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
