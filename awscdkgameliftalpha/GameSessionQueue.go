...
func (j *jsiiProxy_GameSessionQueue) Env() *interfaces.ResourceEnvironment {
...
func GameSessionQueue_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-gamelift-alpha.GameSessionQueue",
...
func (g *jsiiProxy_GameSessionQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
