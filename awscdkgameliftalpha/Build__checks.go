...
func (b *jsiiProxy_Build) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateBuild_FromBuildArnParameters(scope constructs.Construct, id *string, buildArn *string) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
	...
	if buildArn == nil {
		return fmt.Errorf("parameter buildArn is required, but nil was provided")
	}
