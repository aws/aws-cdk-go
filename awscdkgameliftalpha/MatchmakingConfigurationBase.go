...
func (j *jsiiProxy_MatchmakingConfigurationBase) Env() *interfaces.ResourceEnvironment {
...
func (m *jsiiProxy_MatchmakingConfigurationBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_MatchmakingConfigurationBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
