...
func (j *jsiiProxy_BuildFleet) Env() *interfaces.ResourceEnvironment {
...
func BuildFleet_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-gamelift-alpha.BuildFleet",
...
func (b *jsiiProxy_BuildFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
