...
func (j *jsiiProxy_QueuedMatchmakingConfiguration) Env() *interfaces.ResourceEnvironment {
...
func (q *jsiiProxy_QueuedMatchmakingConfiguration) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (q *jsiiProxy_QueuedMatchmakingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
