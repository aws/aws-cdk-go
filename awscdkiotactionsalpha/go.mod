...
require (
	...
	github.com/aws/aws-cdk-go/awscdkiotalpha/v2 v2.68.0-alpha.0
	github.com/aws/aws-cdk-go/awscdkioteventsalpha/v2 v2.68.0-alpha.0
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosealpha/v2 v2.68.0-alpha.0
