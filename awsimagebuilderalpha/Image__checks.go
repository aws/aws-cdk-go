...
func (i *jsiiProxy_Image) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateImage_FromImageArnParameters(scope constructs.Construct, id *string, imageArn *string) error {
	...
	if imageArn == nil {
		return fmt.Errorf("parameter imageArn is required, but nil was provided")
	}
