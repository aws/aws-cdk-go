...
func (i *jsiiProxy_ImagePipeline) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (i *jsiiProxy_ImagePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
