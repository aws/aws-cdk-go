...
func (c *jsiiProxy_Component) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateComponent_FromComponentArnParameters(scope constructs.Construct, id *string, componentArn *string) error {
	...
	if componentArn == nil {
		return fmt.Errorf("parameter componentArn is required, but nil was provided")
	}
...
func validateComponent_FromComponentNameParameters(scope constructs.Construct, id *string, componentName *string) error {
	...
	if componentName == nil {
		return fmt.Errorf("parameter componentName is required, but nil was provided")
	}
