...
func (o *jsiiProxy_OriginEndpoint) validateSegmentValidationParameters(segmentContainerType ContainerType, segment *SegmentConfiguration) error {
	if segmentContainerType == "" {
		return fmt.Errorf("parameter segmentContainerType is required, but nil was provided")
	}

	if err := _jsii_.ValidateStruct(segment, func() string { return "parameter segment" }); err != nil {
		return err
	}
