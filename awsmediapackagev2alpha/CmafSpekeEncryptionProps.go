...
//
// Experimental.
type CmafSpekeEncryptionProps struct {
	...
	// Experimental.
	DrmSystems *[]CmafDrmSystem `field:"required" json:"drmSystems" yaml:"drmSystems"`
	// The encryption method to use.
	// Experimental.
	Method CmafEncryptionMethod `field:"required" json:"method" yaml:"method"`
	...
	//
	// Experimental.
	ExcludeSegmentDrmMetadata *bool `field:"optional" json:"excludeSegmentDrmMetadata" yaml:"excludeSegmentDrmMetadata"`
