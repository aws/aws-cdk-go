...
import (
	_init_ "github.com/aws/aws-cdk-go/awscdkawskinesisfirehosedestinationsalpha/v2/jsii"
	...
	"github.com/aws/aws-cdk-go/awscdkawskinesisfirehosealpha/v2"
	"github.com/aws/aws-cdk-go/awscdkawskinesisfirehosedestinationsalpha/v2/internal"
...
type CommonDestinationProps struct {
	...
	// Experimental.
	Processor awscdkawskinesisfirehosealpha.IDataProcessor `json:"processor"`
...
type jsiiProxy_S3Bucket struct {
	internal.Type__awscdkawskinesisfirehosealphaIDestination
}
...
// Experimental.
func (s *jsiiProxy_S3Bucket) Bind(scope constructs.Construct, _options *awscdkawskinesisfirehosealpha.DestinationBindOptions) *awscdkawskinesisfirehosealpha.DestinationConfig {
	var returns *awscdkawskinesisfirehosealpha.DestinationConfig
