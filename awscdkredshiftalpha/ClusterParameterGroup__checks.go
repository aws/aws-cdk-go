...
func (c *jsiiProxy_ClusterParameterGroup) validateAddParameterParameters(name *string, value *string) error {
	if name == nil {
...
func validateClusterParameterGroup_FromClusterParameterGroupNameParameters(scope constructs.Construct, id *string, clusterParameterGroupName *string) error {
	...
	if clusterParameterGroupName == nil {
		return fmt.Errorf("parameter clusterParameterGroupName is required, but nil was provided")
	}
