...
func (j *jsiiProxy_ClusterSubnetGroup) Env() *interfaces.ResourceEnvironment {
...
func (c *jsiiProxy_ClusterSubnetGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_ClusterSubnetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
