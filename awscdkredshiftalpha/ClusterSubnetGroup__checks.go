...
func (c *jsiiProxy_ClusterSubnetGroup) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateClusterSubnetGroup_FromClusterSubnetGroupNameParameters(scope constructs.Construct, id *string, clusterSubnetGroupName *string) error {
	...
	if clusterSubnetGroupName == nil {
		return fmt.Errorf("parameter clusterSubnetGroupName is required, but nil was provided")
	}
...
func validateClusterSubnetGroup_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateClusterSubnetGroup_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
