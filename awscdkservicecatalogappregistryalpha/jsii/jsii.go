...
//go:embed aws-cdk-aws-servicecatalogappregistry-alpha-2.143.1-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-cdk/aws-servicecatalogappregistry-alpha", "2.143.1-alpha.0", tarball)
}
