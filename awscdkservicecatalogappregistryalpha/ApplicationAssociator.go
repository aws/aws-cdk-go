...
func (j *jsiiProxy_ApplicationAssociator) AppRegistryApplication() IApplication {
...
func (a *jsiiProxy_ApplicationAssociator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
