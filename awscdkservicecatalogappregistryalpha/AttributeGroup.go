...
func (j *jsiiProxy_AttributeGroup) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_AttributeGroup) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AttributeGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
