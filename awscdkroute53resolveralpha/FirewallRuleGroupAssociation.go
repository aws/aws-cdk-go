...
func (j *jsiiProxy_FirewallRuleGroupAssociation) Env() *interfaces.ResourceEnvironment {
...
func FirewallRuleGroupAssociation_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-route53resolver-alpha.FirewallRuleGroupAssociation",
...
func (f *jsiiProxy_FirewallRuleGroupAssociation) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FirewallRuleGroupAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
