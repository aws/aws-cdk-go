...
func validateFirewallRuleGroup_FromFirewallRuleGroupIdParameters(scope constructs.Construct, id *string, firewallRuleGroupId *string) error {
	...
	if firewallRuleGroupId == nil {
		return fmt.Errorf("parameter firewallRuleGroupId is required, but nil was provided")
	}
...
func validateFirewallRuleGroup_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateFirewallRuleGroup_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
