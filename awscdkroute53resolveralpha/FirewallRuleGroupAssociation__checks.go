...
func (f *jsiiProxy_FirewallRuleGroupAssociation) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateFirewallRuleGroupAssociation_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateFirewallRuleGroupAssociation_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
