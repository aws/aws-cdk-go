...
func (f *jsiiProxy_FirewallDomainList) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateFirewallDomainList_FromFirewallDomainListIdParameters(scope constructs.Construct, id *string, firewallDomainListId *string) error {
	...
	if firewallDomainListId == nil {
		return fmt.Errorf("parameter firewallDomainListId is required, but nil was provided")
	}
...
func validateFirewallDomainList_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateFirewallDomainList_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
