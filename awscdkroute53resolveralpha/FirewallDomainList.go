...
func (j *jsiiProxy_FirewallDomainList) Env() *interfaces.ResourceEnvironment {
...
func (f *jsiiProxy_FirewallDomainList) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FirewallDomainList) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
