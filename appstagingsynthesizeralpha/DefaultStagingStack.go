...
func DefaultStagingStack_ConsumeListReference(value *[]*string, strength awscdk.ReferenceStrength) *[]*string {
	...
	if err := validateDefaultStagingStack_ConsumeListReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *[]*string
...
func DefaultStagingStack_ConsumeReference(value *string, strength awscdk.ReferenceStrength) *string {
	...
	if err := validateDefaultStagingStack_ConsumeReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *string
...
func (d *jsiiProxy_DefaultStagingStack) AddStackDependency(target awscdk.Stack, reason *string) {
	if err := d.validateAddStackDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
