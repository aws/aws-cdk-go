...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsgroundstation/mixinsawsgroundstation/internal"
...
func (c *jsiiProxy_CfnDataflowEndpointGroupPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
