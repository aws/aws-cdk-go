...
func (j *jsiiProxy_CfnImageRecipePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnImageRecipePropsMixin) ApplyTo(construct constructs.IConstruct) {
