...
//
//   cfnInfrastructureConfigurationMixinProps := &CfnInfrastructureConfigurationMixinProps{
...
//
type CfnInfrastructureConfigurationMixinProps struct {
	...
	//
	InstanceProfileName interface{} `field:"optional" json:"instanceProfileName" yaml:"instanceProfileName"`
