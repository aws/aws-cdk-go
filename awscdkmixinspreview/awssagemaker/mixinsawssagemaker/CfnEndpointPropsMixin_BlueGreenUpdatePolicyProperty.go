...
//
type CfnEndpointPropsMixin_BlueGreenUpdatePolicyProperty struct {
	...
	//
	TrafficRoutingConfiguration interface{} `field:"optional" json:"trafficRoutingConfiguration" yaml:"trafficRoutingConfiguration"`
}
