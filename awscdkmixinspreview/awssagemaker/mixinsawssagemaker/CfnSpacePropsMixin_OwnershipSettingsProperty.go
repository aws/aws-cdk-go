...
//
type CfnSpacePropsMixin_OwnershipSettingsProperty struct {
	...
	//
	OwnerUserProfileName *string `field:"optional" json:"ownerUserProfileName" yaml:"ownerUserProfileName"`
}
