...
//
type CfnDataflowEndpointGroupV2PropsMixin_DownlinkDataflowDetailsProperty struct {
	...
	//
	AgentConnectionDetails interface{} `field:"optional" json:"agentConnectionDetails" yaml:"agentConnectionDetails"`
}
