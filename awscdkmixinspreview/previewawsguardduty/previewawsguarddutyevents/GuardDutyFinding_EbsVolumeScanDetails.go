...
//
// Experimental.
type GuardDutyFinding_EbsVolumeScanDetails struct {
	...
	//
	// Experimental.
	ScanDetections *GuardDutyFinding_ScanDetections `field:"optional" json:"scanDetections" yaml:"scanDetections"`
	// scanId property.
	//
