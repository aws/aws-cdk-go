...
//
//   remoteIpDetails1 := &RemoteIpDetails1{
//   	City: &City1{
//   		CityName: []*string{
...
//
// Experimental.
type DetectorEvents_GuardDutyFinding_RemoteIpDetails1 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *DetectorEvents_GuardDutyFinding_City1 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *DetectorEvents_GuardDutyFinding_Country1 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	GeoLocation *DetectorEvents_GuardDutyFinding_GeoLocation `field:"optional" json:"geoLocation" yaml:"geoLocation"`
	...
	//
	// Experimental.
	Organization *DetectorEvents_GuardDutyFinding_Organization1 `field:"optional" json:"organization" yaml:"organization"`
}
