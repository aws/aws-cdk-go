...
//
// Experimental.
type GuardDutyFinding_KubernetesApiCallAction struct {
	// parameters property.
	//
	...
	//
	// Experimental.
	RemoteIpDetails *GuardDutyFinding_RemoteIpDetails2 `field:"optional" json:"remoteIpDetails" yaml:"remoteIpDetails"`
	// requestUri property.
	//
