...
//
// Experimental.
type GuardDutyFinding_InstanceDetails struct {
	...
	//
	// Experimental.
	IamInstanceProfile *GuardDutyFinding_IamInstanceProfile `field:"optional" json:"iamInstanceProfile" yaml:"iamInstanceProfile"`
	...
	//
	// Experimental.
	NetworkInterfaces *[]*GuardDutyFinding_InstanceDetailsItem `field:"optional" json:"networkInterfaces" yaml:"networkInterfaces"`
	// outpostArn property.
	//
	...
	//
	// Experimental.
	ProductCodes *[]*GuardDutyFinding_InstanceDetailsItem1 `field:"optional" json:"productCodes" yaml:"productCodes"`
	// tags property.
	//
