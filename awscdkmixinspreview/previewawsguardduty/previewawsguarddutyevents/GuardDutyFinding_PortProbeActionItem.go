...
//
// Experimental.
type GuardDutyFinding_PortProbeActionItem struct {
	...
	//
	// Experimental.
	LocalIpDetails *GuardDutyFinding_LocalIpDetails1 `field:"optional" json:"localIpDetails" yaml:"localIpDetails"`
	...
	//
	// Experimental.
	LocalPortDetails *GuardDutyFinding_LocalPortDetails1 `field:"optional" json:"localPortDetails" yaml:"localPortDetails"`
	...
	//
	// Experimental.
	RemoteIpDetails *GuardDutyFinding_RemoteIpDetails4 `field:"optional" json:"remoteIpDetails" yaml:"remoteIpDetails"`
}
