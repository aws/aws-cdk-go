...
//
// Experimental.
type GuardDutyFinding_AdditionalInfo struct {
	...
	//
	// Experimental.
	Anomalies *GuardDutyFinding_Anomalies `field:"optional" json:"anomalies" yaml:"anomalies"`
	// apiCalls property.
	//
	...
	//
	// Experimental.
	ApiCalls *[]*GuardDutyFinding_AdditionalInfoItem `field:"optional" json:"apiCalls" yaml:"apiCalls"`
	// domain property.
	//
	...
	//
	// Experimental.
	NewPolicy *GuardDutyFinding_NewPolicy `field:"optional" json:"newPolicy" yaml:"newPolicy"`
	// oldPolicy property.
	//
	...
	//
	// Experimental.
	OldPolicy *GuardDutyFinding_OldPolicy `field:"optional" json:"oldPolicy" yaml:"oldPolicy"`
	// outBytes property.
	//
	...
	//
	// Experimental.
	ProfiledBehavior *GuardDutyFinding_ProfiledBehavior `field:"optional" json:"profiledBehavior" yaml:"profiledBehavior"`
	...
	//
	// Experimental.
	RecentCredentials *[]*GuardDutyFinding_AdditionalInfoItem1 `field:"optional" json:"recentCredentials" yaml:"recentCredentials"`
	// sample property.
	//
	...
	//
	// Experimental.
	UnusualBehavior *GuardDutyFinding_UnusualBehavior `field:"optional" json:"unusualBehavior" yaml:"unusualBehavior"`
	...
	//
	// Experimental.
	UserAgent *GuardDutyFinding_UserAgent `field:"optional" json:"userAgent" yaml:"userAgent"`
	// value property.
	//
