...
//
// Experimental.
type GuardDutyFinding_RemoteIpDetails struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *GuardDutyFinding_City `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *GuardDutyFinding_Country `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *GuardDutyFinding_Organization `field:"optional" json:"organization" yaml:"organization"`
}
