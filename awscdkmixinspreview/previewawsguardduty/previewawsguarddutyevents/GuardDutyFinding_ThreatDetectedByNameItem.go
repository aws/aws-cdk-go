...
//
// Experimental.
type GuardDutyFinding_ThreatDetectedByNameItem struct {
	// filePaths property.
	//
	...
	//
	// Experimental.
	FilePaths *[]*GuardDutyFinding_ThreatDetectedByNameItemItem `field:"optional" json:"filePaths" yaml:"filePaths"`
	// itemCount property.
	//
