...
//
// Experimental.
type GuardDutyFinding_ScanDetections struct {
	...
	//
	// Experimental.
	HighestSeverityThreatDetails *GuardDutyFinding_HighestSeverityThreatDetails `field:"optional" json:"highestSeverityThreatDetails" yaml:"highestSeverityThreatDetails"`
	...
	//
	// Experimental.
	ScannedItemCount *GuardDutyFinding_ScannedItemCount `field:"optional" json:"scannedItemCount" yaml:"scannedItemCount"`
	...
	//
	// Experimental.
	ThreatDetectedByName *GuardDutyFinding_ThreatDetectedByName `field:"optional" json:"threatDetectedByName" yaml:"threatDetectedByName"`
	...
	//
	// Experimental.
	ThreatsDetectedItemCount *GuardDutyFinding_ThreatsDetectedItemCount `field:"optional" json:"threatsDetectedItemCount" yaml:"threatsDetectedItemCount"`
}
