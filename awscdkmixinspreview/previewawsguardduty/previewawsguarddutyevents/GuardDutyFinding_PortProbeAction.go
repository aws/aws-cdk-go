...
//
// Experimental.
type GuardDutyFinding_PortProbeAction struct {
	// blocked property.
	//
	...
	//
	// Experimental.
	PortProbeDetails *[]*GuardDutyFinding_PortProbeActionItem `field:"optional" json:"portProbeDetails" yaml:"portProbeDetails"`
}
