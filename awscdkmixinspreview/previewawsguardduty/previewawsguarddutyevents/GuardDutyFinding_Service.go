...
//
// Experimental.
type GuardDutyFinding_Service struct {
	// action property.
	//
	...
	//
	// Experimental.
	Action *GuardDutyFinding_Action `field:"optional" json:"action" yaml:"action"`
	...
	//
	// Experimental.
	AdditionalInfo *GuardDutyFinding_AdditionalInfo `field:"optional" json:"additionalInfo" yaml:"additionalInfo"`
	// archived property.
	//
	...
	//
	// Experimental.
	AwsApiCallAction *GuardDutyFinding_AwsApiCallAction `field:"optional" json:"awsApiCallAction" yaml:"awsApiCallAction"`
	// count property.
	//
	...
	//
	// Experimental.
	EbsVolumeScanDetails *GuardDutyFinding_EbsVolumeScanDetails `field:"optional" json:"ebsVolumeScanDetails" yaml:"ebsVolumeScanDetails"`
	...
	//
	// Experimental.
	Evidence *GuardDutyFinding_Evidence `field:"optional" json:"evidence" yaml:"evidence"`
