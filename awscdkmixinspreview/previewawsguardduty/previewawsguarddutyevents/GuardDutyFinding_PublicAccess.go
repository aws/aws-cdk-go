...
//
// Experimental.
type GuardDutyFinding_PublicAccess struct {
	...
	//
	// Experimental.
	PermissionConfiguration *GuardDutyFinding_PermissionConfiguration `field:"optional" json:"permissionConfiguration" yaml:"permissionConfiguration"`
}
