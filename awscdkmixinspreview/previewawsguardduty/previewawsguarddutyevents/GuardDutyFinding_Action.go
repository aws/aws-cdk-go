...
//
// Experimental.
type GuardDutyFinding_Action struct {
	// actionType property.
	//
	...
	//
	// Experimental.
	AwsApiCallAction *GuardDutyFinding_AwsApiCallAction1 `field:"optional" json:"awsApiCallAction" yaml:"awsApiCallAction"`
	...
	//
	// Experimental.
	DnsRequestAction *GuardDutyFinding_DnsRequestAction `field:"optional" json:"dnsRequestAction" yaml:"dnsRequestAction"`
	...
	//
	// Experimental.
	KubernetesApiCallAction *GuardDutyFinding_KubernetesApiCallAction `field:"optional" json:"kubernetesApiCallAction" yaml:"kubernetesApiCallAction"`
	...
	//
	// Experimental.
	NetworkConnectionAction *GuardDutyFinding_NetworkConnectionAction `field:"optional" json:"networkConnectionAction" yaml:"networkConnectionAction"`
	...
	//
	// Experimental.
	PortProbeAction *GuardDutyFinding_PortProbeAction `field:"optional" json:"portProbeAction" yaml:"portProbeAction"`
}
