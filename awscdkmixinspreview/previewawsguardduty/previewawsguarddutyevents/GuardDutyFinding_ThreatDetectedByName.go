...
//
// Experimental.
type GuardDutyFinding_ThreatDetectedByName struct {
	// itemCount property.
	//
	...
	//
	// Experimental.
	ThreatNames *[]*GuardDutyFinding_ThreatDetectedByNameItem `field:"optional" json:"threatNames" yaml:"threatNames"`
