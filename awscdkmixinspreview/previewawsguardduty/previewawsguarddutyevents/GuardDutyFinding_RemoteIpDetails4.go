...
//
// Experimental.
type GuardDutyFinding_RemoteIpDetails4 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *GuardDutyFinding_City4 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *GuardDutyFinding_Country4 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	GeoLocation *GuardDutyFinding_GeoLocation1 `field:"optional" json:"geoLocation" yaml:"geoLocation"`
	...
	//
	// Experimental.
	Organization *GuardDutyFinding_Organization4 `field:"optional" json:"organization" yaml:"organization"`
}
