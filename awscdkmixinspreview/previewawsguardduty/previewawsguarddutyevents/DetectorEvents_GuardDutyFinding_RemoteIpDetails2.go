...
//
//   remoteIpDetails2 := &RemoteIpDetails2{
//   	City: &City2{
//   		CityName: []*string{
...
//
// Experimental.
type DetectorEvents_GuardDutyFinding_RemoteIpDetails2 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *DetectorEvents_GuardDutyFinding_City2 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *DetectorEvents_GuardDutyFinding_Country2 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *DetectorEvents_GuardDutyFinding_Organization2 `field:"optional" json:"organization" yaml:"organization"`
}
