...
//
// Experimental.
type GuardDutyFinding_AwsApiCallAction1 struct {
	...
	//
	// Experimental.
	AffectedResources *GuardDutyFinding_AffectedResources1 `field:"optional" json:"affectedResources" yaml:"affectedResources"`
	// api property.
	//
	...
	//
	// Experimental.
	RemoteAccountDetails *GuardDutyFinding_RemoteAccountDetails `field:"optional" json:"remoteAccountDetails" yaml:"remoteAccountDetails"`
	...
	//
	// Experimental.
	RemoteIpDetails *GuardDutyFinding_RemoteIpDetails1 `field:"optional" json:"remoteIpDetails" yaml:"remoteIpDetails"`
