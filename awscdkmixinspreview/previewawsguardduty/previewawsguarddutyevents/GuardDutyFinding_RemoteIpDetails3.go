...
//
// Experimental.
type GuardDutyFinding_RemoteIpDetails3 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *GuardDutyFinding_City3 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *GuardDutyFinding_Country3 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	GeoLocation *GuardDutyFinding_GeoLocation `field:"optional" json:"geoLocation" yaml:"geoLocation"`
	...
	//
	// Experimental.
	Organization *GuardDutyFinding_Organization3 `field:"optional" json:"organization" yaml:"organization"`
}
