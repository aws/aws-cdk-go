...
//
// Experimental.
type GuardDutyFinding_KubernetesDetails struct {
	...
	//
	// Experimental.
	KubernetesUserDetails *GuardDutyFinding_KubernetesUserDetails `field:"optional" json:"kubernetesUserDetails" yaml:"kubernetesUserDetails"`
	...
	//
	// Experimental.
	KubernetesWorkloadDetails *GuardDutyFinding_KubernetesWorkloadDetails `field:"optional" json:"kubernetesWorkloadDetails" yaml:"kubernetesWorkloadDetails"`
}
