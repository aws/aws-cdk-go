...
//
// Experimental.
type GuardDutyFinding_KubernetesWorkloadDetails struct {
	// containers property.
	//
	...
	//
	// Experimental.
	Containers *[]*GuardDutyFinding_KubernetesWorkloadDetailsItem `field:"optional" json:"containers" yaml:"containers"`
	// name property.
	//
