...
//
// Experimental.
type GuardDutyFinding_PermissionConfiguration struct {
	...
	//
	// Experimental.
	AccountLevelPermissions *GuardDutyFinding_AccountLevelPermissions `field:"optional" json:"accountLevelPermissions" yaml:"accountLevelPermissions"`
	...
	//
	// Experimental.
	BucketLevelPermissions *GuardDutyFinding_BucketLevelPermissions `field:"optional" json:"bucketLevelPermissions" yaml:"bucketLevelPermissions"`
}
