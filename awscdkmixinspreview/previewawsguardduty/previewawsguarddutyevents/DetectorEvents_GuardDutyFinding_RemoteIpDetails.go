...
//
// Experimental.
type DetectorEvents_GuardDutyFinding_RemoteIpDetails struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *DetectorEvents_GuardDutyFinding_City `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *DetectorEvents_GuardDutyFinding_Country `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *DetectorEvents_GuardDutyFinding_Organization `field:"optional" json:"organization" yaml:"organization"`
}
