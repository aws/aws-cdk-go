...
//
// Experimental.
type GuardDutyFinding_InstanceDetailsItem struct {
	...
	//
	// Experimental.
	PrivateIpAddresses *[]*GuardDutyFinding_InstanceDetailsItemItem `field:"optional" json:"privateIpAddresses" yaml:"privateIpAddresses"`
	...
	//
	// Experimental.
	SecurityGroups *[]*GuardDutyFinding_InstanceDetailsItemItem1 `field:"optional" json:"securityGroups" yaml:"securityGroups"`
	// subnetId property.
	//
