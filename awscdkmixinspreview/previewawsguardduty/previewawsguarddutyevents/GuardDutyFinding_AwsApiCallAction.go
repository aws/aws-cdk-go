...
//
// Experimental.
type GuardDutyFinding_AwsApiCallAction struct {
	...
	//
	// Experimental.
	RemoteIpDetails *GuardDutyFinding_RemoteIpDetails `field:"optional" json:"remoteIpDetails" yaml:"remoteIpDetails"`
