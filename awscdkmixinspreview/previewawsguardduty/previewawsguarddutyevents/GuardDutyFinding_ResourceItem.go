...
//
// Experimental.
type GuardDutyFinding_ResourceItem struct {
	// arn property.
	//
	...
	//
	// Experimental.
	DefaultServerSideEncryption *GuardDutyFinding_DefaultServerSideEncryption `field:"optional" json:"defaultServerSideEncryption" yaml:"defaultServerSideEncryption"`
	// name property.
	//
	...
	//
	// Experimental.
	Owner *GuardDutyFinding_Owner `field:"optional" json:"owner" yaml:"owner"`
	...
	//
	// Experimental.
	PublicAccess *GuardDutyFinding_PublicAccess `field:"optional" json:"publicAccess" yaml:"publicAccess"`
	// tags property.
	//
