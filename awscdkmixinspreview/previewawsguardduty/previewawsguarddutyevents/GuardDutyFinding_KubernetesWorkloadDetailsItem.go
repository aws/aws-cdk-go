...
//
// Experimental.
type GuardDutyFinding_KubernetesWorkloadDetailsItem struct {
	// image property.
	//
	...
	//
	// Experimental.
	SecurityContext *GuardDutyFinding_SecurityContext `field:"optional" json:"securityContext" yaml:"securityContext"`
}
