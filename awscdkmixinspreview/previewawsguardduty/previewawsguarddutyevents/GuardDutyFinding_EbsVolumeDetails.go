...
//
// Experimental.
type GuardDutyFinding_EbsVolumeDetails struct {
	...
	//
	// Experimental.
	ScannedVolumeDetails *[]*GuardDutyFinding_EbsVolumeDetailsItem `field:"optional" json:"scannedVolumeDetails" yaml:"scannedVolumeDetails"`
