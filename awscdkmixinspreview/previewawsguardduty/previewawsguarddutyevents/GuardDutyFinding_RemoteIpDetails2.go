...
//
// Experimental.
type GuardDutyFinding_RemoteIpDetails2 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *GuardDutyFinding_City2 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *GuardDutyFinding_Country2 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *GuardDutyFinding_Organization2 `field:"optional" json:"organization" yaml:"organization"`
}
