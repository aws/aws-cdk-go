...
//
// Experimental.
type GuardDutyFinding_Evidence struct {
	...
	//
	// Experimental.
	ThreatIntelligenceDetails *[]*GuardDutyFinding_EvidenceItem `field:"optional" json:"threatIntelligenceDetails" yaml:"threatIntelligenceDetails"`
}
