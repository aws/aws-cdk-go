...
//
// Experimental.
type GuardDutyFinding_GuardDutyFindingProps struct {
	// accountId property.
	//
	...
	//
	// Experimental.
	Resource *GuardDutyFinding_Resource `field:"optional" json:"resource" yaml:"resource"`
	...
	//
	// Experimental.
	Service *GuardDutyFinding_Service `field:"optional" json:"service" yaml:"service"`
	// severity property.
	//
