...
//
//   remoteIpDetails3 := &RemoteIpDetails3{
//   	City: &City3{
//   		CityName: []*string{
...
//
// Experimental.
type DetectorEvents_GuardDutyFinding_RemoteIpDetails3 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *DetectorEvents_GuardDutyFinding_City3 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *DetectorEvents_GuardDutyFinding_Country3 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *DetectorEvents_GuardDutyFinding_Organization3 `field:"optional" json:"organization" yaml:"organization"`
}
