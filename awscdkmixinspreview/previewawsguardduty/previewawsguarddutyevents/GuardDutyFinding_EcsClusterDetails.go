...
//
// Experimental.
type GuardDutyFinding_EcsClusterDetails struct {
	// arn property.
	//
	...
	//
	// Experimental.
	Tags *[]*GuardDutyFinding_EcsClusterDetailsItem `field:"optional" json:"tags" yaml:"tags"`
	...
	//
	// Experimental.
	TaskDetails *GuardDutyFinding_TaskDetails `field:"optional" json:"taskDetails" yaml:"taskDetails"`
}
