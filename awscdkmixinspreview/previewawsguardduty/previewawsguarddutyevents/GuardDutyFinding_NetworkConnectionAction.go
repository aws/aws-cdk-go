...
//
// Experimental.
type GuardDutyFinding_NetworkConnectionAction struct {
	// blocked property.
	//
	...
	//
	// Experimental.
	LocalIpDetails *GuardDutyFinding_LocalIpDetails `field:"optional" json:"localIpDetails" yaml:"localIpDetails"`
	...
	//
	// Experimental.
	LocalPortDetails *GuardDutyFinding_LocalPortDetails `field:"optional" json:"localPortDetails" yaml:"localPortDetails"`
	// protocol property.
	//
	...
	//
	// Experimental.
	RemoteIpDetails *GuardDutyFinding_RemoteIpDetails3 `field:"optional" json:"remoteIpDetails" yaml:"remoteIpDetails"`
	...
	//
	// Experimental.
	RemotePortDetails *GuardDutyFinding_RemotePortDetails `field:"optional" json:"remotePortDetails" yaml:"remotePortDetails"`
}
