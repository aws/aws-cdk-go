...
//
// Experimental.
type GuardDutyFinding_RemoteIpDetails1 struct {
	// city property.
	//
	...
	//
	// Experimental.
	City *GuardDutyFinding_City1 `field:"optional" json:"city" yaml:"city"`
	// country property.
	//
	...
	//
	// Experimental.
	Country *GuardDutyFinding_Country1 `field:"optional" json:"country" yaml:"country"`
	...
	//
	// Experimental.
	Organization *GuardDutyFinding_Organization1 `field:"optional" json:"organization" yaml:"organization"`
}
