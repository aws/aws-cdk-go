...
//
// Experimental.
type GuardDutyFinding_Resource struct {
	...
	//
	// Experimental.
	AccessKeyDetails *GuardDutyFinding_AccessKeyDetails `field:"optional" json:"accessKeyDetails" yaml:"accessKeyDetails"`
	...
	//
	// Experimental.
	ContainerDetails *GuardDutyFinding_ContainerDetails `field:"optional" json:"containerDetails" yaml:"containerDetails"`
	...
	//
	// Experimental.
	EbsVolumeDetails *GuardDutyFinding_EbsVolumeDetails `field:"optional" json:"ebsVolumeDetails" yaml:"ebsVolumeDetails"`
	...
	//
	// Experimental.
	EcsClusterDetails *GuardDutyFinding_EcsClusterDetails `field:"optional" json:"ecsClusterDetails" yaml:"ecsClusterDetails"`
	...
	//
	// Experimental.
	EksClusterDetails *GuardDutyFinding_EksClusterDetails `field:"optional" json:"eksClusterDetails" yaml:"eksClusterDetails"`
	...
	//
	// Experimental.
	InstanceDetails *GuardDutyFinding_InstanceDetails `field:"optional" json:"instanceDetails" yaml:"instanceDetails"`
	...
	//
	// Experimental.
	KubernetesDetails *GuardDutyFinding_KubernetesDetails `field:"optional" json:"kubernetesDetails" yaml:"kubernetesDetails"`
	...
	//
	// Experimental.
	S3BucketDetails *[]*GuardDutyFinding_ResourceItem `field:"optional" json:"s3BucketDetails" yaml:"s3BucketDetails"`
}
