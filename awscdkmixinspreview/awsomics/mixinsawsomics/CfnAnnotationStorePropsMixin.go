...
//
//   cfnAnnotationStorePropsMixin := awscdkmixinspreview.Mixins.NewCfnAnnotationStorePropsMixin(&CfnAnnotationStoreMixinProps{
...
func (j *jsiiProxy_CfnAnnotationStorePropsMixin) Props() *CfnAnnotationStoreMixinProps {
	var returns *CfnAnnotationStoreMixinProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func (j *jsiiProxy_CfnAnnotationStorePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnAnnotationStorePropsMixin(props *CfnAnnotationStoreMixinProps, options *mixins.CfnPropertyMixinOptions) CfnAnnotationStorePropsMixin {
	_init_.Initialize()

	if err := validateNewCfnAnnotationStorePropsMixinParameters(props, options); err != nil {
		panic(err)
	}
...
// Create a mixin to apply properties to `AWS::Omics::AnnotationStore`.
func NewCfnAnnotationStorePropsMixin_Override(c CfnAnnotationStorePropsMixin, props *CfnAnnotationStoreMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func CfnAnnotationStorePropsMixin_IsMixin(x interface{}) *bool {
	...
	if err := validateCfnAnnotationStorePropsMixin_IsMixinParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAnnotationStorePropsMixin_CFN_PROPERTY_KEYS() *[]*string {
	_init_.Initialize()
	var returns *[]*string
	_jsii_.StaticGet(
		"@aws-cdk/mixins-preview.aws_omics.mixins.CfnAnnotationStorePropsMixin",
...
func (c *jsiiProxy_CfnAnnotationStorePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
...
func (c *jsiiProxy_CfnAnnotationStorePropsMixin) Supports(construct constructs.IConstruct) *bool {
