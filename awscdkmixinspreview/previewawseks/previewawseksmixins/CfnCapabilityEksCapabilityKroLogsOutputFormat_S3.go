...
// Experimental.
type CfnCapabilityEksCapabilityKroLogsOutputFormat_S3 string
...
const (
	...
	// Experimental.
	CfnCapabilityEksCapabilityKroLogsOutputFormat_S3_PARQUET CfnCapabilityEksCapabilityKroLogsOutputFormat_S3 = "PARQUET"
)
