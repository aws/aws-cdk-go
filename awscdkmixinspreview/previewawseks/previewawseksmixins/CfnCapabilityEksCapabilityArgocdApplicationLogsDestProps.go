...
//
//   cfnCapabilityEksCapabilityArgocdApplicationLogsDestProps := &CfnCapabilityEksCapabilityArgocdApplicationLogsDestProps{
...
//
// Experimental.
type CfnCapabilityEksCapabilityArgocdApplicationLogsDestProps struct {
