...
//
//   cfnFargateProfileMixinProps := &CfnFargateProfileMixinProps{
...
//
type CfnFargateProfileMixinProps struct {
	...
	//
	PodExecutionRoleArn *string `field:"optional" json:"podExecutionRoleArn" yaml:"podExecutionRoleArn"`
