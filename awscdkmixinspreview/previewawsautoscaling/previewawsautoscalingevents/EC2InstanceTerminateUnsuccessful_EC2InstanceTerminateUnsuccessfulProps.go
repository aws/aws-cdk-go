...
//
// Experimental.
type EC2InstanceTerminateUnsuccessful_EC2InstanceTerminateUnsuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *EC2InstanceTerminateUnsuccessful_Details `field:"optional" json:"details" yaml:"details"`
