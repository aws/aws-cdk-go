...
// Props type for AutoScalingGroup aws.autoscaling@EC2InstanceLaunchUnsuccessful event.
//
// Example:
...
//
//   eC2InstanceLaunchUnsuccessfulProps := &EC2InstanceLaunchUnsuccessfulProps{
//   	ActivityId: []*string{
...
//
// Experimental.
type AutoScalingGroupEvents_EC2InstanceLaunchUnsuccessful_EC2InstanceLaunchUnsuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *AutoScalingGroupEvents_EC2InstanceLaunchUnsuccessful_Details `field:"optional" json:"details" yaml:"details"`
