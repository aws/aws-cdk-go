...
// Props type for AutoScalingGroup aws.autoscaling@EC2InstanceLaunchSuccessful event.
//
// Example:
...
//
//   eC2InstanceLaunchSuccessfulProps := &EC2InstanceLaunchSuccessfulProps{
//   	ActivityId: []*string{
...
//
// Experimental.
type AutoScalingGroupEvents_EC2InstanceLaunchSuccessful_EC2InstanceLaunchSuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *AutoScalingGroupEvents_EC2InstanceLaunchSuccessful_Details `field:"optional" json:"details" yaml:"details"`
