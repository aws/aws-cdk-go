...
//
// Experimental.
type EC2InstanceTerminateSuccessful_EC2InstanceTerminateSuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *EC2InstanceTerminateSuccessful_Details `field:"optional" json:"details" yaml:"details"`
