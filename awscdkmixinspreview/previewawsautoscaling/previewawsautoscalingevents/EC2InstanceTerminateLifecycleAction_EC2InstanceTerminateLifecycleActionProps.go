...
//
//   eC2InstanceTerminateLifecycleActionProps := &EC2InstanceTerminateLifecycleActionProps{
...
//
// Experimental.
type EC2InstanceTerminateLifecycleAction_EC2InstanceTerminateLifecycleActionProps struct {
