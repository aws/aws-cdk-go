...
// Props type for AutoScalingGroup aws.autoscaling@EC2InstanceTerminateSuccessful event.
//
// Example:
...
//
//   eC2InstanceTerminateSuccessfulProps := &EC2InstanceTerminateSuccessfulProps{
//   	ActivityId: []*string{
...
//
// Experimental.
type AutoScalingGroupEvents_EC2InstanceTerminateSuccessful_EC2InstanceTerminateSuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *AutoScalingGroupEvents_EC2InstanceTerminateSuccessful_Details `field:"optional" json:"details" yaml:"details"`
