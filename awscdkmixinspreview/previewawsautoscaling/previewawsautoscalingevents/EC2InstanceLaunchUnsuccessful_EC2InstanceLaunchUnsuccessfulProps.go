...
//
// Experimental.
type EC2InstanceLaunchUnsuccessful_EC2InstanceLaunchUnsuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *EC2InstanceLaunchUnsuccessful_Details `field:"optional" json:"details" yaml:"details"`
