...
//
// Experimental.
type EC2InstanceLaunchSuccessful_EC2InstanceLaunchSuccessfulProps struct {
	// ActivityId property.
	//
	...
	//
	// Experimental.
	Details *EC2InstanceLaunchSuccessful_Details `field:"optional" json:"details" yaml:"details"`
