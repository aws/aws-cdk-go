...
func (j *jsiiProxy_CfnScheduledActionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnScheduledActionPropsMixin) ApplyTo(construct constructs.IConstruct) {
