...
//
//   translateParallelDataStateChangeProps := &TranslateParallelDataStateChangeProps{
...
//
// Experimental.
type TranslateParallelDataStateChange_TranslateParallelDataStateChangeProps struct {
