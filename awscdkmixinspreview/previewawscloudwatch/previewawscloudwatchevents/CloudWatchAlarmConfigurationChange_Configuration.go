...
//
// Experimental.
type CloudWatchAlarmConfigurationChange_Configuration struct {
	...
	//
	// Experimental.
	Metrics *[]*CloudWatchAlarmConfigurationChange_ConfigurationItem `field:"optional" json:"metrics" yaml:"metrics"`
	// okActions property.
	//
