...
//
// Experimental.
type CloudWatchAlarmStateChange_CloudWatchAlarmStateChangeProps struct {
	// alarmName property.
	//
	...
	//
	// Experimental.
	Configuration *CloudWatchAlarmStateChange_Configuration `field:"optional" json:"configuration" yaml:"configuration"`
	...
	//
	// Experimental.
	PreviousState *CloudWatchAlarmStateChange_State `field:"optional" json:"previousState" yaml:"previousState"`
	// state property.
	//
	...
	//
	// Experimental.
	State *CloudWatchAlarmStateChange_State `field:"optional" json:"state" yaml:"state"`
}
