...
//
// Experimental.
type AlarmEvents_CloudWatchAlarmStateChange_ConfigurationItem struct {
	// id property.
	//
	...
	//
	// Experimental.
	MetricStat *AlarmEvents_CloudWatchAlarmStateChange_MetricStat `field:"optional" json:"metricStat" yaml:"metricStat"`
	// returnData property.
	//
