...
//
// Experimental.
type CloudWatchAlarmConfigurationChange_CloudWatchAlarmConfigurationChangeProps struct {
	// alarmName property.
	//
	...
	//
	// Experimental.
	Configuration *CloudWatchAlarmConfigurationChange_Configuration `field:"optional" json:"configuration" yaml:"configuration"`
	...
	//
	// Experimental.
	State *CloudWatchAlarmConfigurationChange_State `field:"optional" json:"state" yaml:"state"`
}
