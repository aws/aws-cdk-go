...
//
// Experimental.
type CloudWatchAlarmStateChange_ConfigurationItem struct {
	// id property.
	//
	...
	//
	// Experimental.
	MetricStat *CloudWatchAlarmStateChange_MetricStat `field:"optional" json:"metricStat" yaml:"metricStat"`
	// returnData property.
	//
