...
//
// Experimental.
type CloudWatchAlarmConfigurationChange_ConfigurationItem struct {
	// id property.
	//
	...
	//
	// Experimental.
	MetricStat *CloudWatchAlarmConfigurationChange_MetricStat `field:"optional" json:"metricStat" yaml:"metricStat"`
	// returnData property.
	//
