...
//
// Experimental.
type AlarmEvents_CloudWatchAlarmConfigurationChange_MetricStat struct {
	// metric property.
	//
	...
	//
	// Experimental.
	Metric *AlarmEvents_CloudWatchAlarmConfigurationChange_Metric `field:"optional" json:"metric" yaml:"metric"`
	// period property.
	//
