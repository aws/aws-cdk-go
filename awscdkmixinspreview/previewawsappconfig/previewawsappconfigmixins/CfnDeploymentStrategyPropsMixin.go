...
func (j *jsiiProxy_CfnDeploymentStrategyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDeploymentStrategyPropsMixin) ApplyTo(construct constructs.IConstruct) {
