...
//
//   cfnDeploymentStrategyMixinProps := &CfnDeploymentStrategyMixinProps{
...
//
type CfnDeploymentStrategyMixinProps struct {
	...
	//
	DeploymentDurationInMinutes *float64 `field:"optional" json:"deploymentDurationInMinutes" yaml:"deploymentDurationInMinutes"`
	...
	//
	ReplicateTo *string `field:"optional" json:"replicateTo" yaml:"replicateTo"`
