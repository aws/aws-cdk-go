...
//
//   cfnEC2FleetMixinProps := &CfnEC2FleetMixinProps{
...
//
type CfnEC2FleetMixinProps struct {
	// Reserved.
	...
	//
	TargetCapacitySpecification interface{} `field:"optional" json:"targetCapacitySpecification" yaml:"targetCapacitySpecification"`
