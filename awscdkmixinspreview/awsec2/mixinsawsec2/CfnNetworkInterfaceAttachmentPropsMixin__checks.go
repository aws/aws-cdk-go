...
func validateNewCfnNetworkInterfaceAttachmentPropsMixinParameters(props *CfnNetworkInterfaceAttachmentMixinProps, options *mixins.CfnPropertyMixinOptions) error {
	if props == nil {
