...
func validateNewCfnVPCBlockPublicAccessExclusionPropsMixinParameters(props *CfnVPCBlockPublicAccessExclusionMixinProps, options *mixins.CfnPropertyMixinOptions) error {
	if props == nil {
