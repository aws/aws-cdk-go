...
//
//   cfnClientVpnAuthorizationRuleMixinProps := &CfnClientVpnAuthorizationRuleMixinProps{
...
//
type CfnClientVpnAuthorizationRuleMixinProps struct {
	...
	//
	TargetNetworkCidr *string `field:"optional" json:"targetNetworkCidr" yaml:"targetNetworkCidr"`
}
