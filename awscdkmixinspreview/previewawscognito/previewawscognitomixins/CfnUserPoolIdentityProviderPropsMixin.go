...
//
//   cfnUserPoolIdentityProviderPropsMixin := awscdkmixinspreview.Mixins.NewCfnUserPoolIdentityProviderPropsMixin(&CfnUserPoolIdentityProviderMixinProps{
...
func (j *jsiiProxy_CfnUserPoolIdentityProviderPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnUserPoolIdentityProviderPropsMixin(props *CfnUserPoolIdentityProviderMixinProps, options *mixins.CfnPropertyMixinOptions) CfnUserPoolIdentityProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolIdentityProvider`.
func NewCfnUserPoolIdentityProviderPropsMixin_Override(c CfnUserPoolIdentityProviderPropsMixin, props *CfnUserPoolIdentityProviderMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserPoolIdentityProviderPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
