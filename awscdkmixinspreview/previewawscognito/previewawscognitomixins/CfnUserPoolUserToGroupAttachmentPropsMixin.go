...
func (j *jsiiProxy_CfnUserPoolUserToGroupAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnUserPoolUserToGroupAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
