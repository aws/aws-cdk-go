...
func (j *jsiiProxy_CfnUserPoolUICustomizationAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnUserPoolUICustomizationAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
