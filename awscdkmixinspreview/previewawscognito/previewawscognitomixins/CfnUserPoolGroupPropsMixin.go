...
func (j *jsiiProxy_CfnUserPoolGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnUserPoolGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
