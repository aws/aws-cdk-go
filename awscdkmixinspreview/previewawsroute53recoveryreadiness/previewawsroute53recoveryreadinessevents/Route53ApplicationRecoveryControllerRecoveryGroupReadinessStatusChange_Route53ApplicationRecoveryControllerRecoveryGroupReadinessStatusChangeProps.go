...
//
// Experimental.
type Route53ApplicationRecoveryControllerRecoveryGroupReadinessStatusChange_Route53ApplicationRecoveryControllerRecoveryGroupReadinessStatusChangeProps struct {
	...
	//
	// Experimental.
	NewState *Route53ApplicationRecoveryControllerRecoveryGroupReadinessStatusChange_State `field:"optional" json:"newState" yaml:"newState"`
	...
	//
	// Experimental.
	PreviousState *Route53ApplicationRecoveryControllerRecoveryGroupReadinessStatusChange_State `field:"optional" json:"previousState" yaml:"previousState"`
