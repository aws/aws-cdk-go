...
//
// Experimental.
type Route53ApplicationRecoveryControllerCellReadinessStatusChange_Route53ApplicationRecoveryControllerCellReadinessStatusChangeProps struct {
	// cell-name property.
	//
	...
	//
	// Experimental.
	NewState *Route53ApplicationRecoveryControllerCellReadinessStatusChange_State `field:"optional" json:"newState" yaml:"newState"`
	...
	//
	// Experimental.
	PreviousState *Route53ApplicationRecoveryControllerCellReadinessStatusChange_State `field:"optional" json:"previousState" yaml:"previousState"`
}
