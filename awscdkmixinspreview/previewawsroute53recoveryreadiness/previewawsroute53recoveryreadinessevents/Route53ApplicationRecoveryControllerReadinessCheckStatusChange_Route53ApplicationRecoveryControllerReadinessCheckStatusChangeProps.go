...
//
// Experimental.
type Route53ApplicationRecoveryControllerReadinessCheckStatusChange_Route53ApplicationRecoveryControllerReadinessCheckStatusChangeProps struct {
	...
	//
	// Experimental.
	NewState *Route53ApplicationRecoveryControllerReadinessCheckStatusChange_State `field:"optional" json:"newState" yaml:"newState"`
	...
	//
	// Experimental.
	PreviousState *Route53ApplicationRecoveryControllerReadinessCheckStatusChange_State `field:"optional" json:"previousState" yaml:"previousState"`
