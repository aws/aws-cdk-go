...
//
//   cfnDataMigrationMixinProps := &CfnDataMigrationMixinProps{
...
//
type CfnDataMigrationMixinProps struct {
	...
	//
	DataMigrationType *string `field:"optional" json:"dataMigrationType" yaml:"dataMigrationType"`
