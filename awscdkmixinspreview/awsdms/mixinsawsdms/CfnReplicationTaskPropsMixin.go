...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnReplicationTaskPropsMixin := awscdkmixinspreview.Mixins.NewCfnReplicationTaskPropsMixin(&CfnReplicationTaskMixinProps{
...
func (j *jsiiProxy_CfnReplicationTaskPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnReplicationTaskPropsMixin(props *CfnReplicationTaskMixinProps, options *mixins.CfnPropertyMixinOptions) CfnReplicationTaskPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DMS::ReplicationTask`.
func NewCfnReplicationTaskPropsMixin_Override(c CfnReplicationTaskPropsMixin, props *CfnReplicationTaskMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReplicationTaskPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
