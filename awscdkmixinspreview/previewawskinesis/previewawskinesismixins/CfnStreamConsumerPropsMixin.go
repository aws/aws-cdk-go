...
func (j *jsiiProxy_CfnStreamConsumerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnStreamConsumerPropsMixin) ApplyTo(construct constructs.IConstruct) {
