...
//
type CfnBudgetPropsMixin_HistoricalOptionsProperty struct {
	...
	//
	BudgetAdjustmentPeriod *float64 `field:"optional" json:"budgetAdjustmentPeriod" yaml:"budgetAdjustmentPeriod"`
}
