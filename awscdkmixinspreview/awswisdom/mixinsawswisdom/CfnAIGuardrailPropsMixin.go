...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnAIGuardrailPropsMixin := awscdkmixinspreview.Mixins.NewCfnAIGuardrailPropsMixin(&CfnAIGuardrailMixinProps{
...
//
type CfnAIGuardrailPropsMixin interface {
	core.Mixin
	core.IMixin
	Props() *CfnAIGuardrailMixinProps
...
// The jsii proxy struct for CfnAIGuardrailPropsMixin
type jsiiProxy_CfnAIGuardrailPropsMixin struct {
	internal.Type__coreMixin
	internal.Type__coreIMixin
}

func (j *jsiiProxy_CfnAIGuardrailPropsMixin) Props() *CfnAIGuardrailMixinProps {
	var returns *CfnAIGuardrailMixinProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func (j *jsiiProxy_CfnAIGuardrailPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnAIGuardrailPropsMixin(props *CfnAIGuardrailMixinProps, options *mixins.CfnPropertyMixinOptions) CfnAIGuardrailPropsMixin {
	_init_.Initialize()

	if err := validateNewCfnAIGuardrailPropsMixinParameters(props, options); err != nil {
		panic(err)
	}
	j := jsiiProxy_CfnAIGuardrailPropsMixin{}

	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_wisdom.mixins.CfnAIGuardrailPropsMixin",
...
// Create a mixin to apply properties to `AWS::Wisdom::AIGuardrail`.
func NewCfnAIGuardrailPropsMixin_Override(c CfnAIGuardrailPropsMixin, props *CfnAIGuardrailMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
// Experimental.
func CfnAIGuardrailPropsMixin_IsMixin(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnAIGuardrailPropsMixin_IsMixinParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnAIGuardrailPropsMixin_CFN_PROPERTY_KEYS() *[]*string {
	_init_.Initialize()
	var returns *[]*string
	_jsii_.StaticGet(
		"@aws-cdk/mixins-preview.aws_wisdom.mixins.CfnAIGuardrailPropsMixin",
...
func (c *jsiiProxy_CfnAIGuardrailPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
...
func (c *jsiiProxy_CfnAIGuardrailPropsMixin) Supports(construct constructs.IConstruct) *bool {
