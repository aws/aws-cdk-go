...
//
//   cfnMessageTemplateMixinProps := &CfnMessageTemplateMixinProps{
...
//
type CfnMessageTemplateMixinProps struct {
	...
	//
	ChannelSubtype *string `field:"optional" json:"channelSubtype" yaml:"channelSubtype"`
