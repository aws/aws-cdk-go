...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnQuickResponsePropsMixin := awscdkmixinspreview.Mixins.NewCfnQuickResponsePropsMixin(&CfnQuickResponseMixinProps{
//   	Channels: []*string{
...
func (j *jsiiProxy_CfnQuickResponsePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnQuickResponsePropsMixin(props *CfnQuickResponseMixinProps, options *mixins.CfnPropertyMixinOptions) CfnQuickResponsePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Wisdom::QuickResponse`.
func NewCfnQuickResponsePropsMixin_Override(c CfnQuickResponsePropsMixin, props *CfnQuickResponseMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnQuickResponsePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
