...
func (j *jsiiProxy_CfnSubscriptionDefinitionVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnSubscriptionDefinitionVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
