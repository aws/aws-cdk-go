...
//
// Experimental.
type SFTPConnectorFileSendFailed_SFTPConnectorFileSendFailedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *SFTPConnectorFileSendFailed_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
