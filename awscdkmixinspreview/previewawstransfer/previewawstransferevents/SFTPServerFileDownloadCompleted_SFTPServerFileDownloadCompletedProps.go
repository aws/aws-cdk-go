...
//
//   sFTPServerFileDownloadCompletedProps := &SFTPServerFileDownloadCompletedProps{
//   	Bytes: []*string{
//   		jsii.String("bytes"),
//   	},
//   	ClientIp: []*string{
...
//
// Experimental.
type SFTPServerFileDownloadCompleted_SFTPServerFileDownloadCompletedProps struct {
	// bytes property.
	//
