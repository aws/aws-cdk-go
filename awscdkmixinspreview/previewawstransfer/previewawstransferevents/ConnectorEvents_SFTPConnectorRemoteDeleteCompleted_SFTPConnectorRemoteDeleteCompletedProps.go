...
// Props type for Connector aws.transfer@SFTPConnectorRemoteDeleteCompleted event.
//
// Example:
...
//
// Experimental.
type ConnectorEvents_SFTPConnectorRemoteDeleteCompleted_SFTPConnectorRemoteDeleteCompletedProps struct {
