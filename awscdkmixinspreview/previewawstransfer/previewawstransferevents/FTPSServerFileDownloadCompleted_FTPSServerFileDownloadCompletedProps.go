...
//
//   fTPSServerFileDownloadCompletedProps := &FTPSServerFileDownloadCompletedProps{
//   	Bytes: []*string{
//   		jsii.String("bytes"),
//   	},
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPSServerFileDownloadCompleted_FTPSServerFileDownloadCompletedProps struct {
	// bytes property.
	//
