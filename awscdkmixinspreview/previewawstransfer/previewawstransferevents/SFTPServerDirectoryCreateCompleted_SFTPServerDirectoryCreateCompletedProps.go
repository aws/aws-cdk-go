...
//
//   sFTPServerDirectoryCreateCompletedProps := &SFTPServerDirectoryCreateCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type SFTPServerDirectoryCreateCompleted_SFTPServerDirectoryCreateCompletedProps struct {
	// client-ip property.
	//
