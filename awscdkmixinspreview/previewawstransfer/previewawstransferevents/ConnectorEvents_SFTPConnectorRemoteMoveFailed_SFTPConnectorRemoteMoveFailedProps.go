...
//
//   sFTPConnectorRemoteMoveFailedProps := &SFTPConnectorRemoteMoveFailedProps{
//   	ConnectorId: []*string{
...
//
// Experimental.
type ConnectorEvents_SFTPConnectorRemoteMoveFailed_SFTPConnectorRemoteMoveFailedProps struct {
