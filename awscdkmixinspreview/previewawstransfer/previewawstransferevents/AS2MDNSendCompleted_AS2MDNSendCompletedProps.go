...
//
// Experimental.
type AS2MDNSendCompleted_AS2MDNSendCompletedProps struct {
	...
	//
	// Experimental.
	S3Attributes *AS2MDNSendCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
	// server-id property.
	//
