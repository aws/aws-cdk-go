...
// Props type for Connector aws.transfer@SFTPConnectorRemoteMoveCompleted event.
//
// Example:
...
//
//   sFTPConnectorRemoteMoveCompletedProps := &SFTPConnectorRemoteMoveCompletedProps{
//   	ConnectorId: []*string{
...
//   		jsii.String("moveSourcePath"),
//   	},
//   	MoveTargetPath: []*string{
//   		jsii.String("moveTargetPath"),
//   	},
//   	Operation: []*string{
...
//
// Experimental.
type ConnectorEvents_SFTPConnectorRemoteMoveCompleted_SFTPConnectorRemoteMoveCompletedProps struct {
	...
	//
	// Experimental.
	MoveId *[]*string `field:"optional" json:"moveId" yaml:"moveId"`
	...
	//
	// Experimental.
	MoveSourcePath *[]*string `field:"optional" json:"moveSourcePath" yaml:"moveSourcePath"`
	...
	//
	// Experimental.
	MoveTargetPath *[]*string `field:"optional" json:"moveTargetPath" yaml:"moveTargetPath"`
	// operation property.
	//
