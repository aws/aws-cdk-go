...
//
// Experimental.
type AS2PayloadReceiveCompleted_AS2PayloadReceiveCompletedProps struct {
	...
	//
	// Experimental.
	S3Attributes *AS2PayloadReceiveCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
	// server-id property.
	//
