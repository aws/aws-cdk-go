...
//
//   fTPSServerDirectoryDeleteFailedProps := &FTPSServerDirectoryDeleteFailedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPSServerDirectoryDeleteFailed_FTPSServerDirectoryDeleteFailedProps struct {
	// client-ip property.
	//
