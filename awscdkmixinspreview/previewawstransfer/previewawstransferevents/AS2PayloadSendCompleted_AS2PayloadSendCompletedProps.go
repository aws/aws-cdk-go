...
//
// Experimental.
type AS2PayloadSendCompleted_AS2PayloadSendCompletedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *AS2PayloadSendCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
