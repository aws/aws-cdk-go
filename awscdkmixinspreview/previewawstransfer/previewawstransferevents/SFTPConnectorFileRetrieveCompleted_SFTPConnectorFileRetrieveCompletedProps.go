...
//
// Experimental.
type SFTPConnectorFileRetrieveCompleted_SFTPConnectorFileRetrieveCompletedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *SFTPConnectorFileRetrieveCompleted_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
