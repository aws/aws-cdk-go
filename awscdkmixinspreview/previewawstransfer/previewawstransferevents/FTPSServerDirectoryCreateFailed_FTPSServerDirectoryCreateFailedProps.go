...
//
//   fTPSServerDirectoryCreateFailedProps := &FTPSServerDirectoryCreateFailedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPSServerDirectoryCreateFailed_FTPSServerDirectoryCreateFailedProps struct {
	// client-ip property.
	//
