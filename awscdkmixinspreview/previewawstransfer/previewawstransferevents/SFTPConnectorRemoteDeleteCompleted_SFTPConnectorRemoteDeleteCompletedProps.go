...
//
//   sFTPConnectorRemoteDeleteCompletedProps := &SFTPConnectorRemoteDeleteCompletedProps{
//   	ConnectorId: []*string{
...
//
// Experimental.
type SFTPConnectorRemoteDeleteCompleted_SFTPConnectorRemoteDeleteCompletedProps struct {
