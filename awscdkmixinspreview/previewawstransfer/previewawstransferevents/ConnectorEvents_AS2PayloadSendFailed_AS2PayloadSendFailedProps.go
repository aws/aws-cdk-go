...
//
//   aS2PayloadSendFailedProps := &AS2PayloadSendFailedProps{
//   	As2From: []*string{
//   		jsii.String("as2From"),
//   	},
//   	As2MessageId: []*string{
...
//
// Experimental.
type ConnectorEvents_AS2PayloadSendFailed_AS2PayloadSendFailedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *ConnectorEvents_AS2PayloadSendFailed_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
