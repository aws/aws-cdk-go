...
//
// Experimental.
type AS2MDNReceiveFailed_AS2MDNReceiveFailedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *AS2MDNReceiveFailed_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
