...
//
//   sFTPServerDirectoryDeleteFailedProps := &SFTPServerDirectoryDeleteFailedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type SFTPServerDirectoryDeleteFailed_SFTPServerDirectoryDeleteFailedProps struct {
	// client-ip property.
	//
