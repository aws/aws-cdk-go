...
//
//   fTPServerDirectoryDeleteCompletedProps := &FTPServerDirectoryDeleteCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPServerDirectoryDeleteCompleted_FTPServerDirectoryDeleteCompletedProps struct {
	// client-ip property.
	//
