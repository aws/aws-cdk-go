...
// Experimental.
func AS2PayloadSendFailed_EventPattern(options *AS2PayloadSendFailed_AS2PayloadSendFailedProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateAS2PayloadSendFailed_EventPatternParameters(options); err != nil {
		panic(err)
	}
