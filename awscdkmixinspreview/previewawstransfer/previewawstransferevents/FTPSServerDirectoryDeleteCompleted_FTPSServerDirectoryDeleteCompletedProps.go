...
//
//   fTPSServerDirectoryDeleteCompletedProps := &FTPSServerDirectoryDeleteCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPSServerDirectoryDeleteCompleted_FTPSServerDirectoryDeleteCompletedProps struct {
	// client-ip property.
	//
