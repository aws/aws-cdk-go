...
//
//   sFTPServerDirectoryDeleteCompletedProps := &SFTPServerDirectoryDeleteCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type SFTPServerDirectoryDeleteCompleted_SFTPServerDirectoryDeleteCompletedProps struct {
	// client-ip property.
	//
