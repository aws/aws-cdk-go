...
//
//   fTPSServerDirectoryCreateCompletedProps := &FTPSServerDirectoryCreateCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPSServerDirectoryCreateCompleted_FTPSServerDirectoryCreateCompletedProps struct {
	// client-ip property.
	//
