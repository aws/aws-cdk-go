...
//
// Experimental.
type SFTPConnectorDirectoryListingCompleted_SFTPConnectorDirectoryListingCompletedProps struct {
	...
	//
	// Experimental.
	OutputFileLocation *SFTPConnectorDirectoryListingCompleted_OutputFileLocation `field:"optional" json:"outputFileLocation" yaml:"outputFileLocation"`
