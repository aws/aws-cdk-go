...
//
//   sFTPConnectorFileSendFailedProps := &SFTPConnectorFileSendFailedProps{
//   	Bytes: []*string{
//   		jsii.String("bytes"),
//   	},
//   	ConnectorId: []*string{
...
//
// Experimental.
type ConnectorEvents_SFTPConnectorFileSendFailed_SFTPConnectorFileSendFailedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *ConnectorEvents_SFTPConnectorFileSendFailed_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
