...
//
// Experimental.
type AS2PayloadReceiveFailed_AS2PayloadReceiveFailedProps struct {
	...
	//
	// Experimental.
	S3Attributes *AS2PayloadReceiveFailed_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
	// server-id property.
	//
