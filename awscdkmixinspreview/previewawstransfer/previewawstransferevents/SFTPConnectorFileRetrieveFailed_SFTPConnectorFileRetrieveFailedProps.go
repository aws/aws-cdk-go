...
//
// Experimental.
type SFTPConnectorFileRetrieveFailed_SFTPConnectorFileRetrieveFailedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *SFTPConnectorFileRetrieveFailed_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
