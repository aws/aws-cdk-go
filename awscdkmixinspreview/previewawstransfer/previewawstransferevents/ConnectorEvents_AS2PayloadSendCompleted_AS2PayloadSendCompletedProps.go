...
//
//   aS2PayloadSendCompletedProps := &AS2PayloadSendCompletedProps{
//   	As2From: []*string{
//   		jsii.String("as2From"),
//   	},
//   	As2MessageId: []*string{
...
//
// Experimental.
type ConnectorEvents_AS2PayloadSendCompleted_AS2PayloadSendCompletedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *ConnectorEvents_AS2PayloadSendCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
