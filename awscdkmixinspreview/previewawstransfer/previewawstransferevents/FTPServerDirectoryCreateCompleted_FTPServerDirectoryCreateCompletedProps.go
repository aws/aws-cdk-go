...
//
//   fTPServerDirectoryCreateCompletedProps := &FTPServerDirectoryCreateCompletedProps{
//   	ClientIp: []*string{
...
//
// Experimental.
type FTPServerDirectoryCreateCompleted_FTPServerDirectoryCreateCompletedProps struct {
	// client-ip property.
	//
