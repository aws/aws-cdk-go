...
//
// Experimental.
type SFTPConnectorFileSendCompleted_SFTPConnectorFileSendCompletedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *SFTPConnectorFileSendCompleted_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
