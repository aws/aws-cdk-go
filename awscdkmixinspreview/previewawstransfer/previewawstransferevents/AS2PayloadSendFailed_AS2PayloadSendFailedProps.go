...
//
// Experimental.
type AS2PayloadSendFailed_AS2PayloadSendFailedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *AS2PayloadSendFailed_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
