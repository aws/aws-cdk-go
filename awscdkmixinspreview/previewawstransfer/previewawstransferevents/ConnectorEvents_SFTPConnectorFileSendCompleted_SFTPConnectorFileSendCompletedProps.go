...
// Props type for Connector aws.transfer@SFTPConnectorFileSendCompleted event.
//
// Example:
...
//
//   sFTPConnectorFileSendCompletedProps := &SFTPConnectorFileSendCompletedProps{
//   	Bytes: []*string{
//   		jsii.String("bytes"),
//   	},
//   	ConnectorId: []*string{
...
//
// Experimental.
type ConnectorEvents_SFTPConnectorFileSendCompleted_SFTPConnectorFileSendCompletedProps struct {
	// bytes property.
	//
	...
	//
	// Experimental.
	LocalFileLocation *ConnectorEvents_SFTPConnectorFileSendCompleted_LocalFileLocation `field:"optional" json:"localFileLocation" yaml:"localFileLocation"`
	// operation property.
	//
