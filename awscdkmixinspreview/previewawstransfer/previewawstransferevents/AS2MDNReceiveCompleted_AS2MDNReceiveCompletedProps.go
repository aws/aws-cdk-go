...
//
// Experimental.
type AS2MDNReceiveCompleted_AS2MDNReceiveCompletedProps struct {
	// as2-from property.
	//
	...
	//
	// Experimental.
	S3Attributes *AS2MDNReceiveCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
