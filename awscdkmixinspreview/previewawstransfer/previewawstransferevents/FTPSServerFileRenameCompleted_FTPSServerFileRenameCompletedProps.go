...
//
//   fTPSServerFileRenameCompletedProps := &FTPSServerFileRenameCompletedProps{
//   	ClientIp: []*string{
...
//   		jsii.String("originalFilePath"),
//   	},
//   	Protocol: []*string{
//   		jsii.String("protocol"),
//   	},
//   	RenamedFilePath: []*string{
//   		jsii.String("renamedFilePath"),
//   	},
//   	ServerId: []*string{
...
//
// Experimental.
type FTPSServerFileRenameCompleted_FTPSServerFileRenameCompletedProps struct {
	// client-ip property.
	//
	...
	//
	// Experimental.
	OriginalFilePath *[]*string `field:"optional" json:"originalFilePath" yaml:"originalFilePath"`
	// protocol property.
	//
	...
	//
	// Experimental.
	RenamedFilePath *[]*string `field:"optional" json:"renamedFilePath" yaml:"renamedFilePath"`
	// server-id property.
	//
