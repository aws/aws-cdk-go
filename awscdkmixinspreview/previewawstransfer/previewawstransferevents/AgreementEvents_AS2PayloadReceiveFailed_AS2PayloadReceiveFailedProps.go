...
//
//   aS2PayloadReceiveFailedProps := &AS2PayloadReceiveFailedProps{
//   	AgreementId: []*string{
...
//
// Experimental.
type AgreementEvents_AS2PayloadReceiveFailed_AS2PayloadReceiveFailedProps struct {
	...
	//
	// Experimental.
	S3Attributes *AgreementEvents_AS2PayloadReceiveFailed_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
	// server-id property.
	//
