...
// Props type for Agreement aws.transfer@AS2MDNSendCompleted event.
//
// Example:
...
//
//   aS2MDNSendCompletedProps := &AS2MDNSendCompletedProps{
//   	AgreementId: []*string{
...
//
// Experimental.
type AgreementEvents_AS2MDNSendCompleted_AS2MDNSendCompletedProps struct {
	...
	//
	// Experimental.
	S3Attributes *AgreementEvents_AS2MDNSendCompleted_S3Attributes `field:"optional" json:"s3Attributes" yaml:"s3Attributes"`
	// server-id property.
	//
