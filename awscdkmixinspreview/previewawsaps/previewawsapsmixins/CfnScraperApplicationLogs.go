...
type CfnScraperApplicationLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnScraperLogsMixin
}
...
func (c *jsiiProxy_CfnScraperApplicationLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnScraperLogsMixin {
