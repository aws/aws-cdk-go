...
//
//   cfnPlaybackConfigurationMixinProps := &CfnPlaybackConfigurationMixinProps{
...
//
type CfnPlaybackConfigurationMixinProps struct {
	...
	//
	VideoContentSourceUrl *string `field:"optional" json:"videoContentSourceUrl" yaml:"videoContentSourceUrl"`
}
