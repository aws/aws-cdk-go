...
//   var keyRef IKeyRef
//
//   cfnClusterPcsJobcompLogsS3Props := &CfnClusterPcsJobcompLogsS3Props{
//   	EncryptionKey: keyRef,
//   	OutputFormat: awscdkmixinspreview.Mixins.CfnClusterPcsJobcompLogsOutputFormat.S3_PLAIN,
...
//
// Experimental.
type CfnClusterPcsJobcompLogsS3Props struct {
	// Encrpytion key for your delivery bucket.
	// Experimental.
	EncryptionKey interfacesawskms.IKeyRef `field:"optional" json:"encryptionKey" yaml:"encryptionKey"`
	// Format for log output, options are plain,json,w3c,parquet.
	// Experimental.
	OutputFormat CfnClusterPcsJobcompLogsOutputFormat_S3 `field:"optional" json:"outputFormat" yaml:"outputFormat"`
