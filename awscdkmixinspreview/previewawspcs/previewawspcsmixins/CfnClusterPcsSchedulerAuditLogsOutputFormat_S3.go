...
// Experimental.
type CfnClusterPcsSchedulerAuditLogsOutputFormat_S3 string
...
const (
	...
	// Experimental.
	CfnClusterPcsSchedulerAuditLogsOutputFormat_S3_PARQUET CfnClusterPcsSchedulerAuditLogsOutputFormat_S3 = "PARQUET"
)
