...
func (j *jsiiProxy_CfnPatchBaselinePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPatchBaselinePropsMixin) ApplyTo(construct constructs.IConstruct) {
