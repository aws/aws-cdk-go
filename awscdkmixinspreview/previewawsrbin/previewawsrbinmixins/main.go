...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_rbin.mixins.CfnRuleMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_rbin.mixins.CfnRulePropsMixin.ResourceTagProperty",
		reflect.TypeOf((*CfnRulePropsMixin_ResourceTagProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_rbin.mixins.CfnRulePropsMixin.RetentionPeriodProperty",
		reflect.TypeOf((*CfnRulePropsMixin_RetentionPeriodProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_rbin.mixins.CfnRulePropsMixin.UnlockDelayProperty",
