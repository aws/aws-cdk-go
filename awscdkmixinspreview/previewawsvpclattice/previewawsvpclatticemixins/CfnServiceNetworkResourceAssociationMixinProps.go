...
//
//   cfnServiceNetworkResourceAssociationMixinProps := &CfnServiceNetworkResourceAssociationMixinProps{
...
//
type CfnServiceNetworkResourceAssociationMixinProps struct {
