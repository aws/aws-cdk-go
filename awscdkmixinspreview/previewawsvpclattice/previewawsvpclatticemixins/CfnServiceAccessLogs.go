...
type CfnServiceAccessLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnServiceLogsMixin
}
...
func (c *jsiiProxy_CfnServiceAccessLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnServiceLogsMixin {
