...
//
//   cfnHealthCheckMixinProps := &CfnHealthCheckMixinProps{
...
//
type CfnHealthCheckMixinProps struct {
	...
	//
	HealthCheckTags *[]*CfnHealthCheckPropsMixin_HealthCheckTagProperty `field:"optional" json:"healthCheckTags" yaml:"healthCheckTags"`
}
