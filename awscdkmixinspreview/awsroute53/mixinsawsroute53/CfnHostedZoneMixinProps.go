...
//
//   cfnHostedZoneMixinProps := &CfnHostedZoneMixinProps{
...
//
type CfnHostedZoneMixinProps struct {
	...
	//
	HostedZoneTags *[]*CfnHostedZonePropsMixin_HostedZoneTagProperty `field:"optional" json:"hostedZoneTags" yaml:"hostedZoneTags"`
