...
//
type CfnDataAccessorPropsMixin_ActionFilterConfigurationProperty struct {
	...
	//
	DocumentAttributeFilter interface{} `field:"optional" json:"documentAttributeFilter" yaml:"documentAttributeFilter"`
}
