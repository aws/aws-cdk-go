...
//
//   cfnProtectionGroupMixinProps := &CfnProtectionGroupMixinProps{
...
//
type CfnProtectionGroupMixinProps struct {
	...
	//
	ProtectionGroupId *string `field:"optional" json:"protectionGroupId" yaml:"protectionGroupId"`
