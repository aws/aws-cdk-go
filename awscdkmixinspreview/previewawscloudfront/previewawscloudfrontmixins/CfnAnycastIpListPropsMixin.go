...
func (j *jsiiProxy_CfnAnycastIpListPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnAnycastIpListPropsMixin(props *CfnAnycastIpListMixinProps, options *mixins.CfnPropertyMixinOptions) CfnAnycastIpListPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::AnycastIpList`.
func NewCfnAnycastIpListPropsMixin_Override(c CfnAnycastIpListPropsMixin, props *CfnAnycastIpListMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAnycastIpListPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
