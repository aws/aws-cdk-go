...
func (j *jsiiProxy_CfnConnectionGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnConnectionGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
