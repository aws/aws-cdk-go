...
func (j *jsiiProxy_CfnMonitoringSubscriptionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnMonitoringSubscriptionPropsMixin) ApplyTo(construct constructs.IConstruct) {
