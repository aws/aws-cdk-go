...
//
type CfnBudgetPropsMixin_BudgetDataProperty struct {
	...
	//
	BudgetType *string `field:"optional" json:"budgetType" yaml:"budgetType"`
	...
	//
	FilterExpression interface{} `field:"optional" json:"filterExpression" yaml:"filterExpression"`
