...
// Experimental.
func MediaPackageInputNotification_EventPattern(options *MediaPackageInputNotification_MediaPackageInputNotificationProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateMediaPackageInputNotification_EventPatternParameters(options); err != nil {
		panic(err)
	}
