...
//
// Experimental.
type MediaPackageHarvestJobNotification_HarvestJob struct {
	// arn property.
	//
	...
	//
	// Experimental.
	S3Destination *MediaPackageHarvestJobNotification_S3Destination `field:"optional" json:"s3Destination" yaml:"s3Destination"`
	// start_time property.
	//
