...
// Experimental.
func MediaPackageHarvestJobNotification_MediaPackageHarvestJobNotificationPattern(options *MediaPackageHarvestJobNotification_MediaPackageHarvestJobNotificationProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateMediaPackageHarvestJobNotification_MediaPackageHarvestJobNotificationPatternParameters(options); err != nil {
		panic(err)
	}
