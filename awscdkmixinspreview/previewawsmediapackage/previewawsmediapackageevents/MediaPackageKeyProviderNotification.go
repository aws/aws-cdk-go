...
// Experimental.
func MediaPackageKeyProviderNotification_EventPattern(options *MediaPackageKeyProviderNotification_MediaPackageKeyProviderNotificationProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateMediaPackageKeyProviderNotification_EventPatternParameters(options); err != nil {
		panic(err)
	}
