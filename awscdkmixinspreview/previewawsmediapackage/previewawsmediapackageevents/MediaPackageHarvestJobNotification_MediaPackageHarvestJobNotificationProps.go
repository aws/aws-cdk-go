...
//
// Experimental.
type MediaPackageHarvestJobNotification_MediaPackageHarvestJobNotificationProps struct {
	...
	//
	// Experimental.
	HarvestJob *MediaPackageHarvestJobNotification_HarvestJob `field:"optional" json:"harvestJob" yaml:"harvestJob"`
}
