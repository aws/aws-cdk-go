...
//
//   cfnPoolMixinProps := &CfnPoolMixinProps{
...
type CfnPoolMixinProps struct {
	...
	//
	OriginationIdentities *[]*string `field:"optional" json:"originationIdentities" yaml:"originationIdentities"`
