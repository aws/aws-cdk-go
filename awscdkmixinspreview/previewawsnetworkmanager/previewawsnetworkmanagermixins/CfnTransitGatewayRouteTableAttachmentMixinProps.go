...
//
//   cfnTransitGatewayRouteTableAttachmentMixinProps := &CfnTransitGatewayRouteTableAttachmentMixinProps{
...
//
type CfnTransitGatewayRouteTableAttachmentMixinProps struct {
	...
	//
	PeeringId *string `field:"optional" json:"peeringId" yaml:"peeringId"`
	...
	//
	TransitGatewayRouteTableArn *string `field:"optional" json:"transitGatewayRouteTableArn" yaml:"transitGatewayRouteTableArn"`
}
