...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_oam.mixins.CfnLinkMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_oam.mixins.CfnLinkPropsMixin.LinkConfigurationProperty",
		reflect.TypeOf((*CfnLinkPropsMixin_LinkConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_oam.mixins.CfnLinkPropsMixin.LinkFilterProperty",
		reflect.TypeOf((*CfnLinkPropsMixin_LinkFilterProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_oam.mixins.CfnSinkMixinProps",
