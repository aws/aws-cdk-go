...
//
// Experimental.
type KeyEvents_AWSAPICallViaCloudTrail_AWSAPICallViaCloudTrailProps struct {
	// awsRegion property.
	//
	...
	//
	// Experimental.
	RequestParameters *KeyEvents_AWSAPICallViaCloudTrail_RequestParameters `field:"optional" json:"requestParameters" yaml:"requestParameters"`
	// resources property.
	//
	...
	//
	// Experimental.
	Resources *[]*KeyEvents_AWSAPICallViaCloudTrail_AwsapiCallViaCloudTrailItem `field:"optional" json:"resources" yaml:"resources"`
	...
	//
	// Experimental.
	UserIdentity *KeyEvents_AWSAPICallViaCloudTrail_UserIdentity `field:"optional" json:"userIdentity" yaml:"userIdentity"`
}
