...
//
// Experimental.
type KeyEvents_AWSAPICallViaCloudTrail_UserIdentity struct {
	...
	//
	// Experimental.
	SessionContext *KeyEvents_AWSAPICallViaCloudTrail_SessionContext `field:"optional" json:"sessionContext" yaml:"sessionContext"`
	// type property.
	//
