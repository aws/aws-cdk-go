...
//
// Experimental.
type KeyEvents_AWSAPICallViaCloudTrail_SessionContext struct {
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *KeyEvents_AWSAPICallViaCloudTrail_Attributes `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	SessionIssuer *KeyEvents_AWSAPICallViaCloudTrail_SessionIssuer `field:"optional" json:"sessionIssuer" yaml:"sessionIssuer"`
}
