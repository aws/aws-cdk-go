...
//
type CfnDomainPropsMixin_ConflictResolutionProperty struct {
	...
	//
	ConflictResolvingModel *string `field:"optional" json:"conflictResolvingModel" yaml:"conflictResolvingModel"`
