...
//
type CfnScalingPlanPropsMixin_PredefinedScalingMetricSpecificationProperty struct {
	// The metric type.
	//
	...
	//
	PredefinedScalingMetricType *string `field:"optional" json:"predefinedScalingMetricType" yaml:"predefinedScalingMetricType"`
