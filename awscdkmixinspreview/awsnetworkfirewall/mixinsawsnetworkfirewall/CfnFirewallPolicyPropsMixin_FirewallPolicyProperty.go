...
//
type CfnFirewallPolicyPropsMixin_FirewallPolicyProperty struct {
	...
	//
	StatelessDefaultActions *[]*string `field:"optional" json:"statelessDefaultActions" yaml:"statelessDefaultActions"`
	...
	//
	StatelessFragmentDefaultActions *[]*string `field:"optional" json:"statelessFragmentDefaultActions" yaml:"statelessFragmentDefaultActions"`
