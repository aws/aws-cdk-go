...
// EventBridge event pattern for aws.elasticloadbalancing@AWSAPICallViaCloudTrail.
//
// Example:
...
func NewAWSAPICallViaCloudTrail() AWSAPICallViaCloudTrail {
	...
	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_elasticloadbalancing.events.AWSAPICallViaCloudTrail",
		nil, // no parameters
		&j,
	)
