...
func (j *jsiiProxy_CfnMultiRegionAccessPointPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnMultiRegionAccessPointPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
