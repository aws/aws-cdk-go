...
//
// Experimental.
type AWSAPICallViaCloudTrail_AdditionalEventData struct {
	...
	//
	// Experimental.
	ObjectRetentionInfo *AWSAPICallViaCloudTrail_ObjectRetentionInfo `field:"optional" json:"objectRetentionInfo" yaml:"objectRetentionInfo"`
