...
// Props type for Bucket aws.s3@ObjectTagsAdded event.
//
// Example:
...
//
//   objectTagsAddedProps := &ObjectTagsAddedProps{
//   	Bucket: &Bucket{
//   		Name: []*string{
//   			jsii.String("name"),
//   		},
...
//
// Experimental.
type BucketEvents_ObjectTagsAdded_ObjectTagsAddedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *BucketEvents_ObjectTagsAdded_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *BucketEvents_ObjectTagsAdded_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
