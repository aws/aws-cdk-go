...
//
// Experimental.
type BucketEvents_AWSAPICallViaCloudTrail_UserIdentity struct {
	...
	//
	// Experimental.
	SessionContext *BucketEvents_AWSAPICallViaCloudTrail_SessionContext `field:"optional" json:"sessionContext" yaml:"sessionContext"`
	// type property.
	//
