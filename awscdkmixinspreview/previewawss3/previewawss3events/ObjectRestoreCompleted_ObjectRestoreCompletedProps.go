...
//
// Experimental.
type ObjectRestoreCompleted_ObjectRestoreCompletedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectRestoreCompleted_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectRestoreCompleted_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
