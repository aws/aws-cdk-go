...
//
// Experimental.
type ObjectRestoreExpired_ObjectRestoreExpiredProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectRestoreExpired_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectRestoreExpired_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
