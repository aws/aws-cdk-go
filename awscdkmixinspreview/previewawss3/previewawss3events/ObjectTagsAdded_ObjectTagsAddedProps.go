...
//
// Experimental.
type ObjectTagsAdded_ObjectTagsAddedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectTagsAdded_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectTagsAdded_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
