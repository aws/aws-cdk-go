...
//
// Experimental.
type ObjectStorageClassChanged_ObjectStorageClassChangedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectStorageClassChanged_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectStorageClassChanged_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
