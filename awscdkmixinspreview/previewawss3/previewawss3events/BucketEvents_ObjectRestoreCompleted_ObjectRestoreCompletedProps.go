...
//
//   objectRestoreCompletedProps := &ObjectRestoreCompletedProps{
//   	Bucket: &Bucket{
//   		Name: []*string{
//   			jsii.String("name"),
//   		},
...
//
// Experimental.
type BucketEvents_ObjectRestoreCompleted_ObjectRestoreCompletedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *BucketEvents_ObjectRestoreCompleted_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *BucketEvents_ObjectRestoreCompleted_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
	...
	//
	// Experimental.
	RestoreExpiryTime *[]*string `field:"optional" json:"restoreExpiryTime" yaml:"restoreExpiryTime"`
