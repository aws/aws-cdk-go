...
//
// Experimental.
type ObjectAccessTierChanged_ObjectAccessTierChangedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectAccessTierChanged_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectAccessTierChanged_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
