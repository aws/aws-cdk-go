...
//
// Experimental.
type AWSAPICallViaCloudTrail_ObjectRetentionInfo struct {
	...
	//
	// Experimental.
	LegalHoldInfo *AWSAPICallViaCloudTrail_LegalHoldInfo `field:"optional" json:"legalHoldInfo" yaml:"legalHoldInfo"`
	...
	//
	// Experimental.
	RetentionInfo *AWSAPICallViaCloudTrail_RetentionInfo `field:"optional" json:"retentionInfo" yaml:"retentionInfo"`
}
