...
//
// Experimental.
type ObjectTagsDeleted_ObjectTagsDeletedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectTagsDeleted_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectTagsDeleted_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
