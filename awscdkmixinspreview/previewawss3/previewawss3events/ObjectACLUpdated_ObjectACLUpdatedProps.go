...
//
// Experimental.
type ObjectACLUpdated_ObjectACLUpdatedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectACLUpdated_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectACLUpdated_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
