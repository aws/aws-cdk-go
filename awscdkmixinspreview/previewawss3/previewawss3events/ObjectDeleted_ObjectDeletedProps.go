...
//
// Experimental.
type ObjectDeleted_ObjectDeletedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectDeleted_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectDeleted_ObjectType `field:"optional" json:"object" yaml:"object"`
	// reason property.
	//
