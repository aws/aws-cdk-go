...
// Props type for Bucket aws.s3@ObjectTagsDeleted event.
//
// Example:
...
//
//   objectTagsDeletedProps := &ObjectTagsDeletedProps{
//   	Bucket: &Bucket{
//   		Name: []*string{
//   			jsii.String("name"),
//   		},
...
//
// Experimental.
type BucketEvents_ObjectTagsDeleted_ObjectTagsDeletedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *BucketEvents_ObjectTagsDeleted_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *BucketEvents_ObjectTagsDeleted_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
