...
//
// Experimental.
type ObjectCreated_ObjectCreatedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectCreated_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectCreated_ObjectType `field:"optional" json:"object" yaml:"object"`
	// reason property.
	//
