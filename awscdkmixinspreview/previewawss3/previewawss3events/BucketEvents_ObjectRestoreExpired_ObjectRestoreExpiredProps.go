...
//
//   objectRestoreExpiredProps := &ObjectRestoreExpiredProps{
//   	Bucket: &Bucket{
//   		Name: []*string{
//   			jsii.String("name"),
//   		},
...
//
// Experimental.
type BucketEvents_ObjectRestoreExpired_ObjectRestoreExpiredProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *BucketEvents_ObjectRestoreExpired_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *BucketEvents_ObjectRestoreExpired_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
