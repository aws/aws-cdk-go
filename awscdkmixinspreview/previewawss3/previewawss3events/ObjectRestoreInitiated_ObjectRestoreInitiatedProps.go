...
//
// Experimental.
type ObjectRestoreInitiated_ObjectRestoreInitiatedProps struct {
	// bucket property.
	//
	...
	//
	// Experimental.
	Bucket *ObjectRestoreInitiated_Bucket `field:"optional" json:"bucket" yaml:"bucket"`
	...
	//
	// Experimental.
	Object *ObjectRestoreInitiated_ObjectType `field:"optional" json:"object" yaml:"object"`
	// requester property.
	//
