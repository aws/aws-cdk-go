...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnBrowserSettingsPropsMixin := awscdkmixinspreview.Mixins.NewCfnBrowserSettingsPropsMixin(&CfnBrowserSettingsMixinProps{
...
func (j *jsiiProxy_CfnBrowserSettingsPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnBrowserSettingsPropsMixin(props *CfnBrowserSettingsMixinProps, options *mixins.CfnPropertyMixinOptions) CfnBrowserSettingsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_workspacesweb.mixins.CfnBrowserSettingsPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::BrowserSettings`.
func NewCfnBrowserSettingsPropsMixin_Override(c CfnBrowserSettingsPropsMixin, props *CfnBrowserSettingsMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBrowserSettingsPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
