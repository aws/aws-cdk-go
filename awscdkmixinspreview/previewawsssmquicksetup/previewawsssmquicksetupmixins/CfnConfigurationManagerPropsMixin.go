...
func (j *jsiiProxy_CfnConfigurationManagerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnConfigurationManagerPropsMixin) ApplyTo(construct constructs.IConstruct) {
