...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnMailManagerTrafficPolicyPropsMixin := awscdkmixinspreview.Mixins.NewCfnMailManagerTrafficPolicyPropsMixin(&CfnMailManagerTrafficPolicyMixinProps{
...
func (j *jsiiProxy_CfnMailManagerTrafficPolicyPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnMailManagerTrafficPolicyPropsMixin(props *CfnMailManagerTrafficPolicyMixinProps, options *mixins.CfnPropertyMixinOptions) CfnMailManagerTrafficPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::MailManagerTrafficPolicy`.
func NewCfnMailManagerTrafficPolicyPropsMixin_Override(c CfnMailManagerTrafficPolicyPropsMixin, props *CfnMailManagerTrafficPolicyMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMailManagerTrafficPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
