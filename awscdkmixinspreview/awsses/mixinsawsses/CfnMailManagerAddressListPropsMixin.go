...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnMailManagerAddressListPropsMixin := awscdkmixinspreview.Mixins.NewCfnMailManagerAddressListPropsMixin(&CfnMailManagerAddressListMixinProps{
...
func (j *jsiiProxy_CfnMailManagerAddressListPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnMailManagerAddressListPropsMixin(props *CfnMailManagerAddressListMixinProps, options *mixins.CfnPropertyMixinOptions) CfnMailManagerAddressListPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::MailManagerAddressList`.
func NewCfnMailManagerAddressListPropsMixin_Override(c CfnMailManagerAddressListPropsMixin, props *CfnMailManagerAddressListMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMailManagerAddressListPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
