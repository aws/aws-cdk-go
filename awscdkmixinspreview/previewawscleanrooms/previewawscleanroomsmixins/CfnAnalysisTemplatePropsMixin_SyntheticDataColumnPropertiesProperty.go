...
//
type CfnAnalysisTemplatePropsMixin_SyntheticDataColumnPropertiesProperty struct {
	...
	//
	IsPredictiveValue interface{} `field:"optional" json:"isPredictiveValue" yaml:"isPredictiveValue"`
}
