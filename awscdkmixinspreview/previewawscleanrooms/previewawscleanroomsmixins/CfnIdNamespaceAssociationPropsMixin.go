...
func (j *jsiiProxy_CfnIdNamespaceAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnIdNamespaceAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
