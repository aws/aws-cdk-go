...
//
//   cfnInferenceSchedulerMixinProps := &CfnInferenceSchedulerMixinProps{
...
//
type CfnInferenceSchedulerMixinProps struct {
	...
	//
	DataInputConfiguration interface{} `field:"optional" json:"dataInputConfiguration" yaml:"dataInputConfiguration"`
	...
	//
	DataOutputConfiguration interface{} `field:"optional" json:"dataOutputConfiguration" yaml:"dataOutputConfiguration"`
	...
	//
	DataUploadFrequency *string `field:"optional" json:"dataUploadFrequency" yaml:"dataUploadFrequency"`
