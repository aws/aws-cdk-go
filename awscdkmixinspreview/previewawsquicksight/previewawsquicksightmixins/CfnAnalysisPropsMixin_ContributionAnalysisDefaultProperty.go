...
//
type CfnAnalysisPropsMixin_ContributionAnalysisDefaultProperty struct {
	...
	//
	ContributorDimensions interface{} `field:"optional" json:"contributorDimensions" yaml:"contributorDimensions"`
	...
	//
	MeasureFieldId *string `field:"optional" json:"measureFieldId" yaml:"measureFieldId"`
}
