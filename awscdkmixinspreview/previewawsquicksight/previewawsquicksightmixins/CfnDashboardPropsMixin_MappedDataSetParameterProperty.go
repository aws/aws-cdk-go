...
//
type CfnDashboardPropsMixin_MappedDataSetParameterProperty struct {
	...
	//
	DataSetParameterName *string `field:"optional" json:"dataSetParameterName" yaml:"dataSetParameterName"`
}
