...
//
//   cfnCustomPermissionsMixinProps := &CfnCustomPermissionsMixinProps{
...
//
type CfnCustomPermissionsMixinProps struct {
	...
	//
	CustomPermissionsName *string `field:"optional" json:"customPermissionsName" yaml:"customPermissionsName"`
