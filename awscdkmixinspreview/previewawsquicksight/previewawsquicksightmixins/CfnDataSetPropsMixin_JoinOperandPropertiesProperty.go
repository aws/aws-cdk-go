...
//
type CfnDataSetPropsMixin_JoinOperandPropertiesProperty struct {
	...
	//
	OutputColumnNameOverrides interface{} `field:"optional" json:"outputColumnNameOverrides" yaml:"outputColumnNameOverrides"`
}
