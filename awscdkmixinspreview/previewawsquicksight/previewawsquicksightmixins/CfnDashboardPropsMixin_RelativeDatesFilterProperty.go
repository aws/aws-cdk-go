...
//
type CfnDashboardPropsMixin_RelativeDatesFilterProperty struct {
	...
	//
	AnchorDateConfiguration interface{} `field:"optional" json:"anchorDateConfiguration" yaml:"anchorDateConfiguration"`
	...
	//
	RelativeDateType *string `field:"optional" json:"relativeDateType" yaml:"relativeDateType"`
