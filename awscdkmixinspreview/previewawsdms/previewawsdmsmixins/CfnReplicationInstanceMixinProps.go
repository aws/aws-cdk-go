...
//
//   cfnReplicationInstanceMixinProps := &CfnReplicationInstanceMixinProps{
...
//
type CfnReplicationInstanceMixinProps struct {
	...
	//
	ReplicationInstanceClass *string `field:"optional" json:"replicationInstanceClass" yaml:"replicationInstanceClass"`
