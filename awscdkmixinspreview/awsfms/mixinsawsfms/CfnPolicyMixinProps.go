...
type CfnPolicyMixinProps struct {
	...
	//
	SecurityServicePolicyData interface{} `field:"optional" json:"securityServicePolicyData" yaml:"securityServicePolicyData"`
	...
	//
	Tags *[]*CfnPolicyPropsMixin_PolicyTagProperty `field:"optional" json:"tags" yaml:"tags"`
}
