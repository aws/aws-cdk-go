...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awscodedeploy/mixinsawscodedeploy/internal"
...
func (c *jsiiProxy_CfnDeploymentConfigPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
