...
func (c *jsiiProxy_CfnAppMonitorRumTelemetryLogs) validateToFirehoseParameters(deliveryStream interfacesawskinesisfirehose.IDeliveryStreamRef) error {
...
func (c *jsiiProxy_CfnAppMonitorRumTelemetryLogs) validateToLogGroupParameters(logGroup interfacesawslogs.ILogGroupRef) error {
	if logGroup == nil {
...
func (c *jsiiProxy_CfnAppMonitorRumTelemetryLogs) validateToS3Parameters(bucket interfacesawss3.IBucketRef) error {
	if bucket == nil {
