...
func (j *jsiiProxy_CfnDataAccessorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDataAccessorPropsMixin) ApplyTo(construct constructs.IConstruct) {
