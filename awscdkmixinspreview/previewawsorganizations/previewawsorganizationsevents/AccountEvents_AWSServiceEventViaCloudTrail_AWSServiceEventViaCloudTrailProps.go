...
// Props type for Account aws.organizations@AWSServiceEventViaCloudTrail event.
//
// Example:
...
//
//   aWSServiceEventViaCloudTrailProps := &AWSServiceEventViaCloudTrailProps{
//   	AwsRegion: []*string{
...
//
// Experimental.
type AccountEvents_AWSServiceEventViaCloudTrail_AWSServiceEventViaCloudTrailProps struct {
	// awsRegion property.
	//
	...
	//
	// Experimental.
	ServiceEventDetails *AccountEvents_AWSServiceEventViaCloudTrail_ServiceEventDetails `field:"optional" json:"serviceEventDetails" yaml:"serviceEventDetails"`
	...
	//
	// Experimental.
	UserIdentity *AccountEvents_AWSServiceEventViaCloudTrail_UserIdentity `field:"optional" json:"userIdentity" yaml:"userIdentity"`
}
