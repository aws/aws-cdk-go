...
// Props type for aws.organizations@AWSServiceEventViaCloudTrail event.
//
// Example:
...
//
// Experimental.
type AWSServiceEventViaCloudTrail_AWSServiceEventViaCloudTrailProps struct {
	// awsRegion property.
	//
	...
	//
	// Experimental.
	ServiceEventDetails *AWSServiceEventViaCloudTrail_ServiceEventDetails `field:"optional" json:"serviceEventDetails" yaml:"serviceEventDetails"`
	...
	//
	// Experimental.
	UserIdentity *AWSServiceEventViaCloudTrail_UserIdentity `field:"optional" json:"userIdentity" yaml:"userIdentity"`
}
