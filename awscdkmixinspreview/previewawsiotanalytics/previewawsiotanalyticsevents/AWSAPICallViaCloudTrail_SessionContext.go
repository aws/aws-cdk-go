...
//
// Experimental.
type AWSAPICallViaCloudTrail_SessionContext struct {
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *AWSAPICallViaCloudTrail_Attributes `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	SessionIssuer *AWSAPICallViaCloudTrail_SessionIssuer `field:"optional" json:"sessionIssuer" yaml:"sessionIssuer"`
	...
	//
	// Experimental.
	WebIdFederationData *AWSAPICallViaCloudTrail_WebIdFederationData `field:"optional" json:"webIdFederationData" yaml:"webIdFederationData"`
}
