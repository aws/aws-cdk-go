...
func (j *jsiiProxy_CfnCustomDataIdentifierPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnCustomDataIdentifierPropsMixin) ApplyTo(construct constructs.IConstruct) {
