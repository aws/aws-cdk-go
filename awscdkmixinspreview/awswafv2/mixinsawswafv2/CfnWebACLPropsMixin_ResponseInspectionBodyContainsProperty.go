...
//
type CfnWebACLPropsMixin_ResponseInspectionBodyContainsProperty struct {
	...
	//
	FailureStrings *[]*string `field:"optional" json:"failureStrings" yaml:"failureStrings"`
	...
	//
	SuccessStrings *[]*string `field:"optional" json:"successStrings" yaml:"successStrings"`
}
