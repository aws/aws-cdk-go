...
func (j *jsiiProxy_CfnFirewallRuleGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnFirewallRuleGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
