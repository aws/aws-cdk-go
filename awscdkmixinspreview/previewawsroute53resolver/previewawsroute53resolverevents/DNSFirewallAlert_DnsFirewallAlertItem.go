...
//
// Experimental.
type DNSFirewallAlert_DnsFirewallAlertItem struct {
	...
	//
	// Experimental.
	ResolverEndpointDetails *DNSFirewallAlert_ResolverEndpointDetails `field:"optional" json:"resolverEndpointDetails" yaml:"resolverEndpointDetails"`
	...
	//
	// Experimental.
	ResolverNetworkInterfaceDetails *DNSFirewallAlert_ResolverNetworkInterfaceDetails `field:"optional" json:"resolverNetworkInterfaceDetails" yaml:"resolverNetworkInterfaceDetails"`
