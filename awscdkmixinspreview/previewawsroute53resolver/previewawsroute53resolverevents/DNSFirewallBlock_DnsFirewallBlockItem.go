...
//
// Experimental.
type DNSFirewallBlock_DnsFirewallBlockItem struct {
	...
	//
	// Experimental.
	ResolverEndpointDetails *DNSFirewallBlock_ResolverEndpointDetails `field:"optional" json:"resolverEndpointDetails" yaml:"resolverEndpointDetails"`
	...
	//
	// Experimental.
	ResolverNetworkInterfaceDetails *DNSFirewallBlock_ResolverNetworkInterfaceDetails `field:"optional" json:"resolverNetworkInterfaceDetails" yaml:"resolverNetworkInterfaceDetails"`
