...
//
//   dNSFirewallAlertProps := &DNSFirewallAlertProps{
//   	AccountId: []*string{
...
//   	},
//   	Resources: []DnsFirewallAlertItem{
//   		&DnsFirewallAlertItem{
...
//
// Experimental.
type DNSFirewallAlert_DNSFirewallAlertProps struct {
	// account-id property.
	//
	...
	//
	// Experimental.
	Resources *[]*DNSFirewallAlert_DnsFirewallAlertItem `field:"optional" json:"resources" yaml:"resources"`
	// src-addr property.
	//
