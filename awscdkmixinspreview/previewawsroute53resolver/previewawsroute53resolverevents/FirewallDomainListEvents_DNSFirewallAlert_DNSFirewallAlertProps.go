...
// Props type for FirewallDomainList aws.route53resolver@DNSFirewallAlert event.
//
// Example:
...
//
// Experimental.
type FirewallDomainListEvents_DNSFirewallAlert_DNSFirewallAlertProps struct {
	// account-id property.
	//
	...
	//
	// Experimental.
	Resources *[]*FirewallDomainListEvents_DNSFirewallAlert_DnsFirewallAlertItem `field:"optional" json:"resources" yaml:"resources"`
	// src-addr property.
	//
