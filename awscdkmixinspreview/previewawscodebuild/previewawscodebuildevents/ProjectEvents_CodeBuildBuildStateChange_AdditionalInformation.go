...
//
// Experimental.
type ProjectEvents_CodeBuildBuildStateChange_AdditionalInformation struct {
	// artifact property.
	//
	...
	//
	// Experimental.
	Artifact *ProjectEvents_CodeBuildBuildStateChange_Artifact `field:"optional" json:"artifact" yaml:"artifact"`
	...
	//
	// Experimental.
	Cache *ProjectEvents_CodeBuildBuildStateChange_Cache `field:"optional" json:"cache" yaml:"cache"`
	...
	//
	// Experimental.
	Environment *ProjectEvents_CodeBuildBuildStateChange_Environment `field:"optional" json:"environment" yaml:"environment"`
	// initiator property.
	//
	...
	//
	// Experimental.
	Logs *ProjectEvents_CodeBuildBuildStateChange_Logs `field:"optional" json:"logs" yaml:"logs"`
	...
	//
	// Experimental.
	NetworkInterface *ProjectEvents_CodeBuildBuildStateChange_NetworkInterface `field:"optional" json:"networkInterface" yaml:"networkInterface"`
	// phases property.
	//
	...
	//
	// Experimental.
	Phases *[]*ProjectEvents_CodeBuildBuildStateChange_AdditionalInformationItem `field:"optional" json:"phases" yaml:"phases"`
	...
	//
	// Experimental.
	Source *ProjectEvents_CodeBuildBuildStateChange_Source `field:"optional" json:"source" yaml:"source"`
	...
	//
	// Experimental.
	VpcConfig *ProjectEvents_CodeBuildBuildStateChange_VpcConfig `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
