...
//
// Experimental.
type ProjectEvents_CodeBuildBuildStateChange_Environment struct {
	...
	//
	// Experimental.
	EnvironmentVariables *[]*ProjectEvents_CodeBuildBuildStateChange_EnvironmentItem `field:"optional" json:"environmentVariables" yaml:"environmentVariables"`
	// image property.
	//
