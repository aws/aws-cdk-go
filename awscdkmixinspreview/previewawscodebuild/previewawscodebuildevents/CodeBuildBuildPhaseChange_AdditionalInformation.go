...
//
// Experimental.
type CodeBuildBuildPhaseChange_AdditionalInformation struct {
	// artifact property.
	//
	...
	//
	// Experimental.
	Artifact *CodeBuildBuildPhaseChange_Artifact `field:"optional" json:"artifact" yaml:"artifact"`
	...
	//
	// Experimental.
	Cache *CodeBuildBuildPhaseChange_Cache `field:"optional" json:"cache" yaml:"cache"`
	...
	//
	// Experimental.
	Environment *CodeBuildBuildPhaseChange_Environment `field:"optional" json:"environment" yaml:"environment"`
	// initiator property.
	//
	...
	//
	// Experimental.
	Logs *CodeBuildBuildPhaseChange_Logs `field:"optional" json:"logs" yaml:"logs"`
	...
	//
	// Experimental.
	NetworkInterface *CodeBuildBuildPhaseChange_NetworkInterface `field:"optional" json:"networkInterface" yaml:"networkInterface"`
	// phases property.
	//
	...
	//
	// Experimental.
	Phases *[]*CodeBuildBuildPhaseChange_AdditionalInformationItem `field:"optional" json:"phases" yaml:"phases"`
	...
	//
	// Experimental.
	Source *CodeBuildBuildPhaseChange_Source `field:"optional" json:"source" yaml:"source"`
	...
	//
	// Experimental.
	VpcConfig *CodeBuildBuildPhaseChange_VpcConfig `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
