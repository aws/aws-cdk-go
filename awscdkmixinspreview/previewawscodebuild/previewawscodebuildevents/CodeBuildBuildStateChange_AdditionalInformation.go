...
//
// Experimental.
type CodeBuildBuildStateChange_AdditionalInformation struct {
	// artifact property.
	//
	...
	//
	// Experimental.
	Artifact *CodeBuildBuildStateChange_Artifact `field:"optional" json:"artifact" yaml:"artifact"`
	...
	//
	// Experimental.
	Cache *CodeBuildBuildStateChange_Cache `field:"optional" json:"cache" yaml:"cache"`
	...
	//
	// Experimental.
	Environment *CodeBuildBuildStateChange_Environment `field:"optional" json:"environment" yaml:"environment"`
	// initiator property.
	//
	...
	//
	// Experimental.
	Logs *CodeBuildBuildStateChange_Logs `field:"optional" json:"logs" yaml:"logs"`
	...
	//
	// Experimental.
	NetworkInterface *CodeBuildBuildStateChange_NetworkInterface `field:"optional" json:"networkInterface" yaml:"networkInterface"`
	// phases property.
	//
	...
	//
	// Experimental.
	Phases *[]*CodeBuildBuildStateChange_AdditionalInformationItem `field:"optional" json:"phases" yaml:"phases"`
	...
	//
	// Experimental.
	Source *CodeBuildBuildStateChange_Source `field:"optional" json:"source" yaml:"source"`
	...
	//
	// Experimental.
	VpcConfig *CodeBuildBuildStateChange_VpcConfig `field:"optional" json:"vpcConfig" yaml:"vpcConfig"`
}
