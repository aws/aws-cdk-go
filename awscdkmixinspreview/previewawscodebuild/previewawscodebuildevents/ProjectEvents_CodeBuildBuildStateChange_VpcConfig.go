...
//
// Experimental.
type ProjectEvents_CodeBuildBuildStateChange_VpcConfig struct {
	...
	//
	// Experimental.
	Subnets *[]*ProjectEvents_CodeBuildBuildStateChange_VpcConfigItem `field:"optional" json:"subnets" yaml:"subnets"`
	// vpc-id property.
	//
