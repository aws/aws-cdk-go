...
//
// Experimental.
type CodeBuildBuildPhaseChange_Environment struct {
	...
	//
	// Experimental.
	EnvironmentVariables *[]*CodeBuildBuildPhaseChange_EnvironmentItem `field:"optional" json:"environmentVariables" yaml:"environmentVariables"`
	// image property.
	//
