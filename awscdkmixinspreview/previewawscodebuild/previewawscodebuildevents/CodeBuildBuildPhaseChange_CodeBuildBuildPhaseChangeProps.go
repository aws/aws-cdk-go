...
//
// Experimental.
type CodeBuildBuildPhaseChange_CodeBuildBuildPhaseChangeProps struct {
	...
	//
	// Experimental.
	AdditionalInformation *CodeBuildBuildPhaseChange_AdditionalInformation `field:"optional" json:"additionalInformation" yaml:"additionalInformation"`
	// build-id property.
	//
