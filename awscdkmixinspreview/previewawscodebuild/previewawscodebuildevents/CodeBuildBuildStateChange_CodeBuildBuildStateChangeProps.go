...
//
// Experimental.
type CodeBuildBuildStateChange_CodeBuildBuildStateChangeProps struct {
	...
	//
	// Experimental.
	AdditionalInformation *CodeBuildBuildStateChange_AdditionalInformation `field:"optional" json:"additionalInformation" yaml:"additionalInformation"`
	// build-id property.
	//
