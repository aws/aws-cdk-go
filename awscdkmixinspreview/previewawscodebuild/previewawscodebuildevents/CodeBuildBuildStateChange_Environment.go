...
//
// Experimental.
type CodeBuildBuildStateChange_Environment struct {
	...
	//
	// Experimental.
	EnvironmentVariables *[]*CodeBuildBuildStateChange_EnvironmentItem `field:"optional" json:"environmentVariables" yaml:"environmentVariables"`
	// image property.
	//
