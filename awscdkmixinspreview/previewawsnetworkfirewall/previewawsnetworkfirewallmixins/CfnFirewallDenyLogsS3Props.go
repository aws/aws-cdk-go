...
//   var keyRef IKeyRef
//
//   cfnFirewallDenyLogsS3Props := &CfnFirewallDenyLogsS3Props{
//   	EncryptionKey: keyRef,
//   	OutputFormat: awscdkmixinspreview.Mixins.CfnFirewallDenyLogsOutputFormat.S3_PLAIN,
...
//
// Experimental.
type CfnFirewallDenyLogsS3Props struct {
	// Encrpytion key for your delivery bucket.
	// Experimental.
	EncryptionKey interfacesawskms.IKeyRef `field:"optional" json:"encryptionKey" yaml:"encryptionKey"`
	// Format for log output, options are plain,json,w3c,parquet.
	// Experimental.
	OutputFormat CfnFirewallDenyLogsOutputFormat_S3 `field:"optional" json:"outputFormat" yaml:"outputFormat"`
