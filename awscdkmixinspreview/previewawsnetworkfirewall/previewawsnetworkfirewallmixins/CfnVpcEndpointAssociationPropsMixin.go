...
func (j *jsiiProxy_CfnVpcEndpointAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnVpcEndpointAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
