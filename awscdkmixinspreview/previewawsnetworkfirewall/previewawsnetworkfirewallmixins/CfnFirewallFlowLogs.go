...
type CfnFirewallFlowLogs interface {
	...
	ToFirehose(deliveryStream interfacesawskinesisfirehose.IDeliveryStreamRef, props *CfnFirewallFlowLogsFirehoseProps) CfnFirewallLogsMixin
	// Send logs to a CloudWatch Log Group.
	ToLogGroup(logGroup interfacesawslogs.ILogGroupRef, props *CfnFirewallFlowLogsLogGroupProps) CfnFirewallLogsMixin
	// Send logs to an S3 Bucket.
	ToS3(bucket interfacesawss3.IBucketRef, props *CfnFirewallFlowLogsS3Props) CfnFirewallLogsMixin
}
...
func (c *jsiiProxy_CfnFirewallFlowLogs) ToFirehose(deliveryStream interfacesawskinesisfirehose.IDeliveryStreamRef, props *CfnFirewallFlowLogsFirehoseProps) CfnFirewallLogsMixin {
...
func (c *jsiiProxy_CfnFirewallFlowLogs) ToLogGroup(logGroup interfacesawslogs.ILogGroupRef, props *CfnFirewallFlowLogsLogGroupProps) CfnFirewallLogsMixin {
...
func (c *jsiiProxy_CfnFirewallFlowLogs) ToS3(bucket interfacesawss3.IBucketRef, props *CfnFirewallFlowLogsS3Props) CfnFirewallLogsMixin {
