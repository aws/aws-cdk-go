...
//
//   firewallTransitGatewayAttachmentStatusChangedProps := &FirewallTransitGatewayAttachmentStatusChangedProps{
//   	Data: &Data{
//   		AttachmentId: []*string{
...
//
// Experimental.
type FirewallTransitGatewayAttachmentStatusChanged_FirewallTransitGatewayAttachmentStatusChangedProps struct {
	// data property.
	//
	...
	//
	// Experimental.
	Data *FirewallTransitGatewayAttachmentStatusChanged_Data `field:"optional" json:"data" yaml:"data"`
	...
	//
	// Experimental.
	Metadata *FirewallTransitGatewayAttachmentStatusChanged_Metadata `field:"optional" json:"metadata" yaml:"metadata"`
	// version property.
	//
