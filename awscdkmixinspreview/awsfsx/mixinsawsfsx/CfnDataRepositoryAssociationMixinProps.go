...
//
//   cfnDataRepositoryAssociationMixinProps := &CfnDataRepositoryAssociationMixinProps{
...
//
type CfnDataRepositoryAssociationMixinProps struct {
	...
	//
	DataRepositoryPath *string `field:"optional" json:"dataRepositoryPath" yaml:"dataRepositoryPath"`
