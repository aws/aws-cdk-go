...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsroute53profiles/mixinsawsroute53profiles/internal"
...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnProfileResourceAssociationPropsMixin := awscdkmixinspreview.Mixins.NewCfnProfileResourceAssociationPropsMixin(&CfnProfileResourceAssociationMixinProps{
...
func (j *jsiiProxy_CfnProfileResourceAssociationPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnProfileResourceAssociationPropsMixin(props *CfnProfileResourceAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) CfnProfileResourceAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Profiles::ProfileResourceAssociation`.
func NewCfnProfileResourceAssociationPropsMixin_Override(c CfnProfileResourceAssociationPropsMixin, props *CfnProfileResourceAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnProfileResourceAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
