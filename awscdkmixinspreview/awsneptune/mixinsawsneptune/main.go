...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBClusterMixinProps",
		reflect.TypeOf((*CfnDBClusterMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBClusterParameterGroupMixinProps",
		reflect.TypeOf((*CfnDBClusterParameterGroupMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBClusterParameterGroupPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBClusterPropsMixin.DBClusterRoleProperty",
		reflect.TypeOf((*CfnDBClusterPropsMixin_DBClusterRoleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBClusterPropsMixin.ServerlessScalingConfigurationProperty",
		reflect.TypeOf((*CfnDBClusterPropsMixin_ServerlessScalingConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBInstanceMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBParameterGroupMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBSubnetGroupMixinProps",
		reflect.TypeOf((*CfnDBSubnetGroupMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnDBSubnetGroupPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_neptune.mixins.CfnEventSubscriptionMixinProps",
