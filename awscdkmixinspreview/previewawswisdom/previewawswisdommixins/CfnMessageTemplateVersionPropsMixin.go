...
func (j *jsiiProxy_CfnMessageTemplateVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnMessageTemplateVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
