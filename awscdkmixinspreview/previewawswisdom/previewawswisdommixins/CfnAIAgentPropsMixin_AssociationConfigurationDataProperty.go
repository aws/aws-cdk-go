...
//
type CfnAIAgentPropsMixin_AssociationConfigurationDataProperty struct {
	...
	//
	KnowledgeBaseAssociationConfigurationData interface{} `field:"optional" json:"knowledgeBaseAssociationConfigurationData" yaml:"knowledgeBaseAssociationConfigurationData"`
}
