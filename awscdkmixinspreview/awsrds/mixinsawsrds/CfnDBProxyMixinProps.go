...
//
//   cfnDBProxyMixinProps := &CfnDBProxyMixinProps{
//   	Auth: []interface{}{
//   		&AuthFormatProperty{
...
//
type CfnDBProxyMixinProps struct {
	...
	//
	EngineFamily *string `field:"optional" json:"engineFamily" yaml:"engineFamily"`
	...
	//
	Tags *[]*CfnDBProxyPropsMixin_TagFormatProperty `field:"optional" json:"tags" yaml:"tags"`
