...
//
//   cfnDBSecurityGroupIngressMixinProps := &CfnDBSecurityGroupIngressMixinProps{
...
//
type CfnDBSecurityGroupIngressMixinProps struct {
	...
	//
	DbSecurityGroupName *string `field:"optional" json:"dbSecurityGroupName" yaml:"dbSecurityGroupName"`
