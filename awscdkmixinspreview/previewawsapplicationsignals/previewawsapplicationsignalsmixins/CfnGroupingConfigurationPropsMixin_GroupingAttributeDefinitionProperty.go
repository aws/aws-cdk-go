...
//
type CfnGroupingConfigurationPropsMixin_GroupingAttributeDefinitionProperty struct {
	...
	//
	GroupingName *string `field:"optional" json:"groupingName" yaml:"groupingName"`
	...
	//
	GroupingSourceKeys *[]*string `field:"optional" json:"groupingSourceKeys" yaml:"groupingSourceKeys"`
}
