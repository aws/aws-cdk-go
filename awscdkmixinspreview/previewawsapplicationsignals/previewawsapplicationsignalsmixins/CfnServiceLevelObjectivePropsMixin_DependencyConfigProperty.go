...
//
type CfnServiceLevelObjectivePropsMixin_DependencyConfigProperty struct {
	...
	//
	DependencyKeyAttributes interface{} `field:"optional" json:"dependencyKeyAttributes" yaml:"dependencyKeyAttributes"`
