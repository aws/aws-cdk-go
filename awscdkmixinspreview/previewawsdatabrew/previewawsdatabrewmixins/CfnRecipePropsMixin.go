...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnRecipePropsMixin := awscdkmixinspreview.Mixins.NewCfnRecipePropsMixin(&CfnRecipeMixinProps{
...
func (j *jsiiProxy_CfnRecipePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnRecipePropsMixin(props *CfnRecipeMixinProps, options *mixins.CfnPropertyMixinOptions) CfnRecipePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataBrew::Recipe`.
func NewCfnRecipePropsMixin_Override(c CfnRecipePropsMixin, props *CfnRecipeMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRecipePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
