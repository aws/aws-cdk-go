...
// Experimental.
func StreamHealthChange_StreamHealthChangePattern(options *StreamHealthChange_StreamHealthChangeProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateStreamHealthChange_StreamHealthChangePatternParameters(options); err != nil {
		panic(err)
	}
