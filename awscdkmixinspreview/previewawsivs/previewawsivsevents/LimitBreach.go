...
// Experimental.
func LimitBreach_LimitBreachPattern(options *LimitBreach_LimitBreachProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateLimitBreach_LimitBreachPatternParameters(options); err != nil {
		panic(err)
	}
