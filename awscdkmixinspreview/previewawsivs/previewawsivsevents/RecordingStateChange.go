...
// Experimental.
func RecordingStateChange_RecordingStateChangePattern(options *RecordingStateChange_RecordingStateChangeProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateRecordingStateChange_RecordingStateChangePatternParameters(options); err != nil {
		panic(err)
	}
