...
// Experimental.
func StreamStateChange_EventPattern(options *StreamStateChange_StreamStateChangeProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateStreamStateChange_EventPatternParameters(options); err != nil {
		panic(err)
	}
