...
//
type CfnRateBasedRulePropsMixin_PredicateProperty struct {
	...
	//
	DataId *string `field:"optional" json:"dataId" yaml:"dataId"`
	...
	//
	Negated interface{} `field:"optional" json:"negated" yaml:"negated"`
