...
//
//   cfnResolverQueryLoggingConfigAssociationMixinProps := &CfnResolverQueryLoggingConfigAssociationMixinProps{
...
//
type CfnResolverQueryLoggingConfigAssociationMixinProps struct {
