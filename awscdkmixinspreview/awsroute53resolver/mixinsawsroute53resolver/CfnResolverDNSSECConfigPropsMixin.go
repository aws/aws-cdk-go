...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsroute53resolver/mixinsawsroute53resolver/internal"
...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnResolverDNSSECConfigPropsMixin := awscdkmixinspreview.Mixins.NewCfnResolverDNSSECConfigPropsMixin(&CfnResolverDNSSECConfigMixinProps{
...
func (j *jsiiProxy_CfnResolverDNSSECConfigPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnResolverDNSSECConfigPropsMixin(props *CfnResolverDNSSECConfigMixinProps, options *mixins.CfnPropertyMixinOptions) CfnResolverDNSSECConfigPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_route53resolver.mixins.CfnResolverDNSSECConfigPropsMixin",
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverDNSSECConfig`.
func NewCfnResolverDNSSECConfigPropsMixin_Override(c CfnResolverDNSSECConfigPropsMixin, props *CfnResolverDNSSECConfigMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResolverDNSSECConfigPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
