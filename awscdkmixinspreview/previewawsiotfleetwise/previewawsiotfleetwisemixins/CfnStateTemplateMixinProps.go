...
//
//   cfnStateTemplateMixinProps := &CfnStateTemplateMixinProps{
...
//
type CfnStateTemplateMixinProps struct {
	...
	//
	StateTemplateProperties *[]*string `field:"optional" json:"stateTemplateProperties" yaml:"stateTemplateProperties"`
