...
type CfnVehicleIotFleetwiseLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnVehicleLogsMixin
}
...
func (c *jsiiProxy_CfnVehicleIotFleetwiseLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnVehicleLogsMixin {
