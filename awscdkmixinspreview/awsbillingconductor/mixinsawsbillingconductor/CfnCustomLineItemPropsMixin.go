...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnCustomLineItemPropsMixin := awscdkmixinspreview.Mixins.NewCfnCustomLineItemPropsMixin(&CfnCustomLineItemMixinProps{
...
func (j *jsiiProxy_CfnCustomLineItemPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnCustomLineItemPropsMixin(props *CfnCustomLineItemMixinProps, options *mixins.CfnPropertyMixinOptions) CfnCustomLineItemPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BillingConductor::CustomLineItem`.
func NewCfnCustomLineItemPropsMixin_Override(c CfnCustomLineItemPropsMixin, props *CfnCustomLineItemMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCustomLineItemPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
