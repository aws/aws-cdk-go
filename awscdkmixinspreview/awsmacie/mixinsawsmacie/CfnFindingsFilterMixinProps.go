...
//
//   cfnFindingsFilterMixinProps := &CfnFindingsFilterMixinProps{
...
//
type CfnFindingsFilterMixinProps struct {
	...
	//
	FindingCriteria interface{} `field:"optional" json:"findingCriteria" yaml:"findingCriteria"`
