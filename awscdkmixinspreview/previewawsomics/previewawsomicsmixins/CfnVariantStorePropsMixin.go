...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnVariantStorePropsMixin := awscdkmixinspreview.Mixins.NewCfnVariantStorePropsMixin(&CfnVariantStoreMixinProps{
...
func (j *jsiiProxy_CfnVariantStorePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnVariantStorePropsMixin(props *CfnVariantStoreMixinProps, options *mixins.CfnPropertyMixinOptions) CfnVariantStorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Omics::VariantStore`.
func NewCfnVariantStorePropsMixin_Override(c CfnVariantStorePropsMixin, props *CfnVariantStoreMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVariantStorePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
