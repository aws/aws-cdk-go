...
//
//   readSetActivationJobStatusChangeProps := &ReadSetActivationJobStatusChangeProps{
...
//
// Experimental.
type ReadSetActivationJobStatusChange_ReadSetActivationJobStatusChangeProps struct {
