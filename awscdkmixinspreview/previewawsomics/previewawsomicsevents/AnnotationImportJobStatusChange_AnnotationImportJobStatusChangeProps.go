...
//
//   annotationImportJobStatusChangeProps := &AnnotationImportJobStatusChangeProps{
//   	Arn: []*string{
//   		jsii.String("arn"),
//   	},
...
//
// Experimental.
type AnnotationImportJobStatusChange_AnnotationImportJobStatusChangeProps struct {
	// arn property.
	//
