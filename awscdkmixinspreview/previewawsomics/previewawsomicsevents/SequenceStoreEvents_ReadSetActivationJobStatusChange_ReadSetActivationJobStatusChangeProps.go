...
// Props type for SequenceStore aws.omics@ReadSetActivationJobStatusChange event.
//
// Example:
...
//
// Experimental.
type SequenceStoreEvents_ReadSetActivationJobStatusChange_ReadSetActivationJobStatusChangeProps struct {
