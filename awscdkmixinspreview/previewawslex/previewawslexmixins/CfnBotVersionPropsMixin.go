...
func (j *jsiiProxy_CfnBotVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnBotVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
