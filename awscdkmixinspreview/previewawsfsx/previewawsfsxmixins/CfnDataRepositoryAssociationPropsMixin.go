...
func (j *jsiiProxy_CfnDataRepositoryAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDataRepositoryAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
