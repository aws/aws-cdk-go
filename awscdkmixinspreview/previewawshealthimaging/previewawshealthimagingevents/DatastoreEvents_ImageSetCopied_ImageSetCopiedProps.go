...
// Props type for Datastore aws.healthimaging@ImageSetCopied event.
//
// Example:
...
//
//   imageSetCopiedProps := &ImageSetCopiedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_ImageSetCopied_ImageSetCopiedProps struct {
