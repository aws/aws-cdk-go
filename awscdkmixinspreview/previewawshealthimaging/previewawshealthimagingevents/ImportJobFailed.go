...
// Experimental.
func ImportJobFailed_EventPattern(options *ImportJobFailed_ImportJobFailedProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateImportJobFailed_EventPatternParameters(options); err != nil {
		panic(err)
	}
