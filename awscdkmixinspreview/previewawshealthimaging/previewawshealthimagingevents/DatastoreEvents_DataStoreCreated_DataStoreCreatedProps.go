...
// Props type for Datastore aws.healthimaging@DataStoreCreated event.
//
// Example:
...
//
//   dataStoreCreatedProps := &DataStoreCreatedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_DataStoreCreated_DataStoreCreatedProps struct {
