...
// Experimental.
func ImageSetUpdated_ImageSetUpdatedPattern(options *ImageSetUpdated_ImageSetUpdatedProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateImageSetUpdated_ImageSetUpdatedPatternParameters(options); err != nil {
		panic(err)
	}
