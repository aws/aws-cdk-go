...
// Props type for Datastore aws.healthimaging@ImageSetUpdated event.
//
// Example:
...
//
//   imageSetUpdatedProps := &ImageSetUpdatedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_ImageSetUpdated_ImageSetUpdatedProps struct {
