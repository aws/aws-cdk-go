...
// Props type for Datastore aws.healthimaging@ImageSetCopyingWithReadOnlyAccess event.
//
// Example:
...
//
// Experimental.
type DatastoreEvents_ImageSetCopyingWithReadOnlyAccess_ImageSetCopyingWithReadOnlyAccessProps struct {
