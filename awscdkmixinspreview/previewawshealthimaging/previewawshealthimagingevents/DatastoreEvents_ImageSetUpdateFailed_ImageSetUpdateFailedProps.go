...
// Props type for Datastore aws.healthimaging@ImageSetUpdateFailed event.
//
// Example:
...
//
//   imageSetUpdateFailedProps := &ImageSetUpdateFailedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_ImageSetUpdateFailed_ImageSetUpdateFailedProps struct {
