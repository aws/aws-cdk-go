...
// Experimental.
func ImageSetDeleted_ImageSetDeletedPattern(options *ImageSetDeleted_ImageSetDeletedProps) *awsevents.EventPattern {
	_init_.Initialize()

	if err := validateImageSetDeleted_ImageSetDeletedPatternParameters(options); err != nil {
		panic(err)
	}
