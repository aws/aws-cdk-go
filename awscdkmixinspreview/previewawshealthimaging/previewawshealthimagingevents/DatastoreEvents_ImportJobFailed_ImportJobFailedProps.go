...
// Props type for Datastore aws.healthimaging@ImportJobFailed event.
//
// Example:
...
//
//   importJobFailedProps := &ImportJobFailedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_ImportJobFailed_ImportJobFailedProps struct {
