...
// Props type for Datastore aws.healthimaging@DataStoreDeleted event.
//
// Example:
...
//
//   dataStoreDeletedProps := &DataStoreDeletedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_DataStoreDeleted_DataStoreDeletedProps struct {
