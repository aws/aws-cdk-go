...
// Props type for Datastore aws.healthimaging@ImageSetDeleting event.
//
// Example:
...
//
//   imageSetDeletingProps := &ImageSetDeletingProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type DatastoreEvents_ImageSetDeleting_ImageSetDeletingProps struct {
