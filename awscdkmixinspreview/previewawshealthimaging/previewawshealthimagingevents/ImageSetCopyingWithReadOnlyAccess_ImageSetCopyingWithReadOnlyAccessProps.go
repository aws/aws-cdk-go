...
//
//   imageSetCopyingWithReadOnlyAccessProps := &ImageSetCopyingWithReadOnlyAccessProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ImageSetCopyingWithReadOnlyAccess_ImageSetCopyingWithReadOnlyAccessProps struct {
