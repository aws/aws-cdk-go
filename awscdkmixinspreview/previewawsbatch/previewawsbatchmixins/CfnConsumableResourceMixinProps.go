...
//
//   cfnConsumableResourceMixinProps := &CfnConsumableResourceMixinProps{
...
//
type CfnConsumableResourceMixinProps struct {
	...
	//
	TotalQuantity *float64 `field:"optional" json:"totalQuantity" yaml:"totalQuantity"`
}
