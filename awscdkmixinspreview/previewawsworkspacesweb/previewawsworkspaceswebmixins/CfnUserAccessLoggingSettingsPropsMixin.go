...
func (j *jsiiProxy_CfnUserAccessLoggingSettingsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnUserAccessLoggingSettingsPropsMixin) ApplyTo(construct constructs.IConstruct) {
