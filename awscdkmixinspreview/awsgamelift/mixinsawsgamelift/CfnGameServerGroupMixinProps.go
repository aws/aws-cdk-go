...
//
//   cfnGameServerGroupMixinProps := &CfnGameServerGroupMixinProps{
...
//
type CfnGameServerGroupMixinProps struct {
	...
	//
	InstanceDefinitions interface{} `field:"optional" json:"instanceDefinitions" yaml:"instanceDefinitions"`
