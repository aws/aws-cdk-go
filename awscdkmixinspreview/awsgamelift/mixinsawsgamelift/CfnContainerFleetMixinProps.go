...
//
//   cfnContainerFleetMixinProps := &CfnContainerFleetMixinProps{
...
//
type CfnContainerFleetMixinProps struct {
	...
	//
	FleetRoleArn *string `field:"optional" json:"fleetRoleArn" yaml:"fleetRoleArn"`
