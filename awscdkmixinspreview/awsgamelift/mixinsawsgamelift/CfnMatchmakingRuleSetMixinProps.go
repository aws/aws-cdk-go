...
//
//   cfnMatchmakingRuleSetMixinProps := &CfnMatchmakingRuleSetMixinProps{
...
//
type CfnMatchmakingRuleSetMixinProps struct {
	...
	//
	RuleSetBody *string `field:"optional" json:"ruleSetBody" yaml:"ruleSetBody"`
