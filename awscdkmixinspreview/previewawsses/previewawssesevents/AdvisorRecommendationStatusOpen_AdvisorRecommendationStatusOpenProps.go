...
//
//   advisorRecommendationStatusOpenProps := &AdvisorRecommendationStatusOpenProps{
//   	Data: []*string{
//   		jsii.String("data"),
//   	},
...
//
// Experimental.
type AdvisorRecommendationStatusOpen_AdvisorRecommendationStatusOpenProps struct {
	// data property.
	//
