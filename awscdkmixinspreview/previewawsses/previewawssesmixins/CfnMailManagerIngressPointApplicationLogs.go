...
func (c *jsiiProxy_CfnMailManagerIngressPointApplicationLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnMailManagerIngressPointLogsMixin {
