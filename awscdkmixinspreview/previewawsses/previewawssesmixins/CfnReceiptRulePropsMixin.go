...
func (j *jsiiProxy_CfnReceiptRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnReceiptRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
