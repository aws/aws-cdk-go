...
type CfnMailManagerRuleSetApplicationLogs interface {
	...
	ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnMailManagerRuleSetLogsMixin
...
func (c *jsiiProxy_CfnMailManagerRuleSetApplicationLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnMailManagerRuleSetLogsMixin {
