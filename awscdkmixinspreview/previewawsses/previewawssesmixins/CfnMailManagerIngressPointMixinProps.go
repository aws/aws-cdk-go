...
//
//   cfnMailManagerIngressPointMixinProps := &CfnMailManagerIngressPointMixinProps{
...
//
type CfnMailManagerIngressPointMixinProps struct {
	...
	//
	TrafficPolicyId *string `field:"optional" json:"trafficPolicyId" yaml:"trafficPolicyId"`
