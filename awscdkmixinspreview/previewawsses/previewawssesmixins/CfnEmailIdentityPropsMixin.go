...
func (j *jsiiProxy_CfnEmailIdentityPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnEmailIdentityPropsMixin) ApplyTo(construct constructs.IConstruct) {
