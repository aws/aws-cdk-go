...
//
type CfnConfigurationSetPropsMixin_ValidationOptionsProperty struct {
	...
	//
	ConditionThreshold interface{} `field:"optional" json:"conditionThreshold" yaml:"conditionThreshold"`
}
