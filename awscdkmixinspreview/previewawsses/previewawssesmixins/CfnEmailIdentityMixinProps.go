...
//
//   cfnEmailIdentityMixinProps := &CfnEmailIdentityMixinProps{
...
//
type CfnEmailIdentityMixinProps struct {
	...
	//
	EmailIdentity *string `field:"optional" json:"emailIdentity" yaml:"emailIdentity"`
