...
//
//   cfnPrimaryTaskSetMixinProps := &CfnPrimaryTaskSetMixinProps{
...
//
type CfnPrimaryTaskSetMixinProps struct {
	...
	//
	TaskSetId *string `field:"optional" json:"taskSetId" yaml:"taskSetId"`
}
