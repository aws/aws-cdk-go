...
//
type CfnResourceDefinitionVersionPropsMixin_GroupOwnerSettingProperty struct {
	...
	//
	AutoAddGroupOwner interface{} `field:"optional" json:"autoAddGroupOwner" yaml:"autoAddGroupOwner"`
