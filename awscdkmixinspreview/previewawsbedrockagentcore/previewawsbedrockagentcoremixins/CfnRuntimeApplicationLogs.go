...
type CfnRuntimeApplicationLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnRuntimeLogsMixin
}
...
func (c *jsiiProxy_CfnRuntimeApplicationLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnRuntimeLogsMixin {
