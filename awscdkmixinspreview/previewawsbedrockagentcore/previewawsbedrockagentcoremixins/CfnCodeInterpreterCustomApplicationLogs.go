...
func (c *jsiiProxy_CfnCodeInterpreterCustomApplicationLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnCodeInterpreterCustomLogsMixin {
