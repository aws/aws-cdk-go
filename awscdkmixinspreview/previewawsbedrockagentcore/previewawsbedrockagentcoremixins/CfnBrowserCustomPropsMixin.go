...
func (j *jsiiProxy_CfnBrowserCustomPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnBrowserCustomPropsMixin) ApplyTo(construct constructs.IConstruct) {
