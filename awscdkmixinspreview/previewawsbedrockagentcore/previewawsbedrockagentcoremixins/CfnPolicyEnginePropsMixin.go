...
//
//   cfnPolicyEnginePropsMixin := awscdkmixinspreview.Mixins.NewCfnPolicyEnginePropsMixin(&CfnPolicyEngineMixinProps{
...
func NewCfnPolicyEnginePropsMixin(props *CfnPolicyEngineMixinProps, options *mixins.CfnPropertyMixinOptions) CfnPolicyEnginePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::PolicyEngine`.
func NewCfnPolicyEnginePropsMixin_Override(c CfnPolicyEnginePropsMixin, props *CfnPolicyEngineMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
