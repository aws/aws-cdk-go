...
//
//   cfnEvaluatorPropsMixin := awscdkmixinspreview.Mixins.NewCfnEvaluatorPropsMixin(&CfnEvaluatorMixinProps{
...
func NewCfnEvaluatorPropsMixin(props *CfnEvaluatorMixinProps, options *mixins.CfnPropertyMixinOptions) CfnEvaluatorPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_bedrockagentcore.mixins.CfnEvaluatorPropsMixin",
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::Evaluator`.
func NewCfnEvaluatorPropsMixin_Override(c CfnEvaluatorPropsMixin, props *CfnEvaluatorMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
