...
type CfnDatabaseMixinProps struct {
	...
	//
	MasterDatabaseName *string `field:"optional" json:"masterDatabaseName" yaml:"masterDatabaseName"`
	...
	//
	RelationalDatabaseBlueprintId *string `field:"optional" json:"relationalDatabaseBlueprintId" yaml:"relationalDatabaseBlueprintId"`
	...
	//
	RelationalDatabaseBundleId *string `field:"optional" json:"relationalDatabaseBundleId" yaml:"relationalDatabaseBundleId"`
