...
func (j *jsiiProxy_CfnContactFlowModulePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnContactFlowModulePropsMixin(props *CfnContactFlowModuleMixinProps, options *mixins.CfnPropertyMixinOptions) CfnContactFlowModulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::ContactFlowModule`.
func NewCfnContactFlowModulePropsMixin_Override(c CfnContactFlowModulePropsMixin, props *CfnContactFlowModuleMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnContactFlowModulePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
