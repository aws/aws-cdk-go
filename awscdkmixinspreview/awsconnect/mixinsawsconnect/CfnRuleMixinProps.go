...
type CfnRuleMixinProps struct {
	...
	//
	PublishStatus *string `field:"optional" json:"publishStatus" yaml:"publishStatus"`
	...
	//
	TriggerEventSource interface{} `field:"optional" json:"triggerEventSource" yaml:"triggerEventSource"`
}
