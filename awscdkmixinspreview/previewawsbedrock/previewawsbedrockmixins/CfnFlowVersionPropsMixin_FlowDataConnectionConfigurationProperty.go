...
//
type CfnFlowVersionPropsMixin_FlowDataConnectionConfigurationProperty struct {
	...
	//
	SourceOutput *string `field:"optional" json:"sourceOutput" yaml:"sourceOutput"`
	...
	//
	TargetInput *string `field:"optional" json:"targetInput" yaml:"targetInput"`
}
