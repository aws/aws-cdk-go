...
func (j *jsiiProxy_CfnPromptVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPromptVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
