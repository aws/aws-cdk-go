...
type CfnAgentAliasEventLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnAgentAliasLogsMixin
}
...
func (c *jsiiProxy_CfnAgentAliasEventLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnAgentAliasLogsMixin {
