...
type CfnAgentAliasEventLogs interface {
	...
	ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnAgentAliasLogsMixin
...
func (c *jsiiProxy_CfnAgentAliasEventLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnAgentAliasLogsMixin {
