...
type CfnFlowApplicationLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnFlowLogsMixin
}
...
func (c *jsiiProxy_CfnFlowApplicationLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnFlowLogsMixin {
