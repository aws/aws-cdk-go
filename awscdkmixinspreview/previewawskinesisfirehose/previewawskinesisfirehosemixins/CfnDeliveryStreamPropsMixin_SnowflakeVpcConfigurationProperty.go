...
//
type CfnDeliveryStreamPropsMixin_SnowflakeVpcConfigurationProperty struct {
	...
	//
	PrivateLinkVpceId *string `field:"optional" json:"privateLinkVpceId" yaml:"privateLinkVpceId"`
}
