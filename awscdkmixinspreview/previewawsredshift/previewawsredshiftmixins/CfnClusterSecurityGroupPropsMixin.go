...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnClusterSecurityGroupPropsMixin := awscdkmixinspreview.Mixins.NewCfnClusterSecurityGroupPropsMixin(&CfnClusterSecurityGroupMixinProps{
...
func (j *jsiiProxy_CfnClusterSecurityGroupPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnClusterSecurityGroupPropsMixin(props *CfnClusterSecurityGroupMixinProps, options *mixins.CfnPropertyMixinOptions) CfnClusterSecurityGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Redshift::ClusterSecurityGroup`.
func NewCfnClusterSecurityGroupPropsMixin_Override(c CfnClusterSecurityGroupPropsMixin, props *CfnClusterSecurityGroupMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnClusterSecurityGroupPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
