...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnClusterParameterGroupPropsMixin := awscdkmixinspreview.Mixins.NewCfnClusterParameterGroupPropsMixin(&CfnClusterParameterGroupMixinProps{
...
func (j *jsiiProxy_CfnClusterParameterGroupPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnClusterParameterGroupPropsMixin(props *CfnClusterParameterGroupMixinProps, options *mixins.CfnPropertyMixinOptions) CfnClusterParameterGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Redshift::ClusterParameterGroup`.
func NewCfnClusterParameterGroupPropsMixin_Override(c CfnClusterParameterGroupPropsMixin, props *CfnClusterParameterGroupMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnClusterParameterGroupPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
