...
//
//   cfnAccessGrantMixinProps := &CfnAccessGrantMixinProps{
...
//
type CfnAccessGrantMixinProps struct {
	...
	//
	AccessGrantsLocationId *string `field:"optional" json:"accessGrantsLocationId" yaml:"accessGrantsLocationId"`
