...
func (j *jsiiProxy_CfnCACertificatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnCACertificatePropsMixin) ApplyTo(construct constructs.IConstruct) {
