...
func (j *jsiiProxy_CfnSoftwarePackagePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnSoftwarePackagePropsMixin) ApplyTo(construct constructs.IConstruct) {
