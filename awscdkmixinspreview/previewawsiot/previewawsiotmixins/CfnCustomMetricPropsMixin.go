...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnCustomMetricPropsMixin := awscdkmixinspreview.Mixins.NewCfnCustomMetricPropsMixin(&CfnCustomMetricMixinProps{
...
func (j *jsiiProxy_CfnCustomMetricPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnCustomMetricPropsMixin(props *CfnCustomMetricMixinProps, options *mixins.CfnPropertyMixinOptions) CfnCustomMetricPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::CustomMetric`.
func NewCfnCustomMetricPropsMixin_Override(c CfnCustomMetricPropsMixin, props *CfnCustomMetricMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCustomMetricPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
