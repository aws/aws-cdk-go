...
//
//   syntheticsCanaryTestRunSuccessfulProps := &SyntheticsCanaryTestRunSuccessfulProps{
//   	AccountId: []*string{
...
//
// Experimental.
type SyntheticsCanaryTestRunSuccessful_SyntheticsCanaryTestRunSuccessfulProps struct {
	// account-id property.
	//
	...
	//
	// Experimental.
	CanaryRunTimeline *SyntheticsCanaryTestRunSuccessful_CanaryRunTimeline `field:"optional" json:"canaryRunTimeline" yaml:"canaryRunTimeline"`
