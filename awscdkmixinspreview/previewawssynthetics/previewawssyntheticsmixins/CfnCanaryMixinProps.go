...
//
//   cfnCanaryMixinProps := &CfnCanaryMixinProps{
...
//
type CfnCanaryMixinProps struct {
	...
	//
	ArtifactS3Location *string `field:"optional" json:"artifactS3Location" yaml:"artifactS3Location"`
