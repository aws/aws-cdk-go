...
//
// Experimental.
type CodeConnectContact_CodeConnectContactProps struct {
	// agentInfo property.
	//
	...
	//
	// Experimental.
	AgentInfo *CodeConnectContact_AgentInfo `field:"optional" json:"agentInfo" yaml:"agentInfo"`
	// channel property.
	//
	...
	//
	// Experimental.
	QueueInfo *CodeConnectContact_QueueInfo `field:"optional" json:"queueInfo" yaml:"queueInfo"`
}
