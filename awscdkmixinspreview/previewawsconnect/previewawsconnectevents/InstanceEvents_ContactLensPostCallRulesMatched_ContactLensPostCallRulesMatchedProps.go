...
// Props type for Instance aws.connect@ContactLensPostCallRulesMatched event.
//
// Example:
...
//
//   contactLensPostCallRulesMatchedProps := &ContactLensPostCallRulesMatchedProps{
//   	ActionName: []*string{
...
//
// Experimental.
type InstanceEvents_ContactLensPostCallRulesMatched_ContactLensPostCallRulesMatchedProps struct {
	// actionName property.
	//
