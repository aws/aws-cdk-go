...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnDataTableRecordPropsMixin := awscdkmixinspreview.Mixins.NewCfnDataTableRecordPropsMixin(&CfnDataTableRecordMixinProps{
...
func (j *jsiiProxy_CfnDataTableRecordPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnDataTableRecordPropsMixin(props *CfnDataTableRecordMixinProps, options *mixins.CfnPropertyMixinOptions) CfnDataTableRecordPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::DataTableRecord`.
func NewCfnDataTableRecordPropsMixin_Override(c CfnDataTableRecordPropsMixin, props *CfnDataTableRecordMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataTableRecordPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
