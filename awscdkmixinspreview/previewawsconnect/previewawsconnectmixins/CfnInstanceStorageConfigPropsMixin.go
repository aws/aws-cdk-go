...
func (j *jsiiProxy_CfnInstanceStorageConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnInstanceStorageConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
