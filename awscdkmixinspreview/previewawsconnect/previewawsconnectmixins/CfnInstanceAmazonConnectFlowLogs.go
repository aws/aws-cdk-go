...
type CfnInstanceAmazonConnectFlowLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnInstanceLogsMixin
}
...
func (c *jsiiProxy_CfnInstanceAmazonConnectFlowLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnInstanceLogsMixin {
