...
//
//   cfnTemplateGroupAccessControlEntryMixinProps := &CfnTemplateGroupAccessControlEntryMixinProps{
...
//
type CfnTemplateGroupAccessControlEntryMixinProps struct {
	...
	//
	AccessRights interface{} `field:"optional" json:"accessRights" yaml:"accessRights"`
	...
	//
	GroupDisplayName *string `field:"optional" json:"groupDisplayName" yaml:"groupDisplayName"`
