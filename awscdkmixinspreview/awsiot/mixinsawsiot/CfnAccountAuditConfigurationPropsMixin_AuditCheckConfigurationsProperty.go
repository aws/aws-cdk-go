...
//
type CfnAccountAuditConfigurationPropsMixin_AuditCheckConfigurationsProperty struct {
	...
	//
	DeviceCertificateAgeCheck interface{} `field:"optional" json:"deviceCertificateAgeCheck" yaml:"deviceCertificateAgeCheck"`
