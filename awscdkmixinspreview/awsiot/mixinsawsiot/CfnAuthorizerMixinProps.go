...
//
//   cfnAuthorizerMixinProps := &CfnAuthorizerMixinProps{
...
//
type CfnAuthorizerMixinProps struct {
	...
	//
	AuthorizerFunctionArn *string `field:"optional" json:"authorizerFunctionArn" yaml:"authorizerFunctionArn"`
	// The authorizer name.
