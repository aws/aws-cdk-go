...
//
//   cfnAccountAuditConfigurationMixinProps := &CfnAccountAuditConfigurationMixinProps{
...
//
type CfnAccountAuditConfigurationMixinProps struct {
	...
	//
	AuditCheckConfigurations interface{} `field:"optional" json:"auditCheckConfigurations" yaml:"auditCheckConfigurations"`
