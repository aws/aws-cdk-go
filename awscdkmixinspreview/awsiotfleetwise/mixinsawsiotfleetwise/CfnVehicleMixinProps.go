...
//
//   cfnVehicleMixinProps := &CfnVehicleMixinProps{
...
//
type CfnVehicleMixinProps struct {
	...
	//
	DecoderManifestArn *string `field:"optional" json:"decoderManifestArn" yaml:"decoderManifestArn"`
