...
//
//   cfnGuardHookMixinProps := &CfnGuardHookMixinProps{
...
//
type CfnGuardHookMixinProps struct {
	...
	//
	RuleLocation interface{} `field:"optional" json:"ruleLocation" yaml:"ruleLocation"`
	...
	//
	TargetOperations *[]*string `field:"optional" json:"targetOperations" yaml:"targetOperations"`
}
