...
func (j *jsiiProxy_CfnLambdaHookPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnLambdaHookPropsMixin) ApplyTo(construct constructs.IConstruct) {
