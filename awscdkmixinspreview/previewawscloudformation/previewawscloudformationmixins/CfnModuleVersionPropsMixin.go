...
func (j *jsiiProxy_CfnModuleVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnModuleVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
