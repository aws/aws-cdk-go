...
//
//   cfnPublisherMixinProps := &CfnPublisherMixinProps{
...
//
type CfnPublisherMixinProps struct {
	...
	//
	AcceptTermsAndConditions interface{} `field:"optional" json:"acceptTermsAndConditions" yaml:"acceptTermsAndConditions"`
