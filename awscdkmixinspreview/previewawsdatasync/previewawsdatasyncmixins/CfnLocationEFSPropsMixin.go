...
func (j *jsiiProxy_CfnLocationEFSPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnLocationEFSPropsMixin) ApplyTo(construct constructs.IConstruct) {
