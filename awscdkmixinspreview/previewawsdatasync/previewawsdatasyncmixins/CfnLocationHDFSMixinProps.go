...
//
//   cfnLocationHDFSMixinProps := &CfnLocationHDFSMixinProps{
//   	AgentArns: []*string{
...
//
type CfnLocationHDFSMixinProps struct {
	...
	//
	NameNodes interface{} `field:"optional" json:"nameNodes" yaml:"nameNodes"`
