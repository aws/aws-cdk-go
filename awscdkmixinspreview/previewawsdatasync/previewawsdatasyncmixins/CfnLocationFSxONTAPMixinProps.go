...
//
//   cfnLocationFSxONTAPMixinProps := &CfnLocationFSxONTAPMixinProps{
...
//
type CfnLocationFSxONTAPMixinProps struct {
	...
	//
	StorageVirtualMachineArn *string `field:"optional" json:"storageVirtualMachineArn" yaml:"storageVirtualMachineArn"`
