...
//
//   cfnLifecycleAutomationMixinProps := &CfnLifecycleAutomationMixinProps{
...
//
type CfnLifecycleAutomationMixinProps struct {
	...
	//
	AutomationDocument *string `field:"optional" json:"automationDocument" yaml:"automationDocument"`
	...
	//
	AutomationParameters interface{} `field:"optional" json:"automationParameters" yaml:"automationParameters"`
