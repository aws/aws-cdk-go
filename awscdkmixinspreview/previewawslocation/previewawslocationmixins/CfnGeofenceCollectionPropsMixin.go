...
func (j *jsiiProxy_CfnGeofenceCollectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnGeofenceCollectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
