...
//
type CfnAPIKeyPropsMixin_ApiKeyRestrictionsProperty struct {
	...
	//
	AllowActions *[]*string `field:"optional" json:"allowActions" yaml:"allowActions"`
	...
	//
	AllowResources *[]*string `field:"optional" json:"allowResources" yaml:"allowResources"`
}
