...
//
//   cfnRouteCalculatorMixinProps := &CfnRouteCalculatorMixinProps{
...
//
type CfnRouteCalculatorMixinProps struct {
	...
	//
	CalculatorName *string `field:"optional" json:"calculatorName" yaml:"calculatorName"`
