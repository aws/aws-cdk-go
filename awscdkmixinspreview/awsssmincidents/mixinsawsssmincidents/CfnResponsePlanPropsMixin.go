...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsssmincidents/mixinsawsssmincidents/internal"
...
func (c *jsiiProxy_CfnResponsePlanPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
