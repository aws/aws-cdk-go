...
//
//   cfnMaintenanceWindowTargetMixinProps := &CfnMaintenanceWindowTargetMixinProps{
...
//
type CfnMaintenanceWindowTargetMixinProps struct {
	...
	//
	WindowId *string `field:"optional" json:"windowId" yaml:"windowId"`
}
