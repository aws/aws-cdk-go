...
func (j *jsiiProxy_CfnMultiRegionClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnMultiRegionClusterPropsMixin) ApplyTo(construct constructs.IConstruct) {
