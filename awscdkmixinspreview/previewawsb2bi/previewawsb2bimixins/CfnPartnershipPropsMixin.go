...
func (j *jsiiProxy_CfnPartnershipPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPartnershipPropsMixin) ApplyTo(construct constructs.IConstruct) {
