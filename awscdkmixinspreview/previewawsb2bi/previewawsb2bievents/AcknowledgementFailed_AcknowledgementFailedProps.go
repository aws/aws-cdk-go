...
//
//   acknowledgementFailedProps := &AcknowledgementFailedProps{
//   	AckX12Type: []*string{
...
//
// Experimental.
type AcknowledgementFailed_AcknowledgementFailedProps struct {
	...
	//
	// Experimental.
	InputFileS3Attributes *AcknowledgementFailed_InputFileS3Attributes `field:"optional" json:"inputFileS3Attributes" yaml:"inputFileS3Attributes"`
