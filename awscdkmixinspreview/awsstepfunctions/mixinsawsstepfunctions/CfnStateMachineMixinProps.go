...
//
//   cfnStateMachineMixinProps := &CfnStateMachineMixinProps{
...
//
type CfnStateMachineMixinProps struct {
	...
	//
	Tags *[]*CfnStateMachinePropsMixin_TagsEntryProperty `field:"optional" json:"tags" yaml:"tags"`
