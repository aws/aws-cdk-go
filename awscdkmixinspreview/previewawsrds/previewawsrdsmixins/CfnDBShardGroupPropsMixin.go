...
func (j *jsiiProxy_CfnDBShardGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDBShardGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
