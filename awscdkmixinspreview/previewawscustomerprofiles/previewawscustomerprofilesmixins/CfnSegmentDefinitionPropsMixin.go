...
func (j *jsiiProxy_CfnSegmentDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnSegmentDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
