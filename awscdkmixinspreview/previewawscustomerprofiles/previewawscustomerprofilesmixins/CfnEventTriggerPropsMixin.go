...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnEventTriggerPropsMixin := awscdkmixinspreview.Mixins.NewCfnEventTriggerPropsMixin(&CfnEventTriggerMixinProps{
...
func (j *jsiiProxy_CfnEventTriggerPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnEventTriggerPropsMixin(props *CfnEventTriggerMixinProps, options *mixins.CfnPropertyMixinOptions) CfnEventTriggerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CustomerProfiles::EventTrigger`.
func NewCfnEventTriggerPropsMixin_Override(c CfnEventTriggerPropsMixin, props *CfnEventTriggerMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEventTriggerPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
