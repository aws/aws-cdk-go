...
type CfnDashboardMixinProps struct {
	...
	//
	DashboardDefinition *string `field:"optional" json:"dashboardDefinition" yaml:"dashboardDefinition"`
	...
	//
	DashboardDescription *string `field:"optional" json:"dashboardDescription" yaml:"dashboardDescription"`
