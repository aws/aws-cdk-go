...
//
//   cfnAssetModelMixinProps := &CfnAssetModelMixinProps{
...
//
type CfnAssetModelMixinProps struct {
	...
	//
	AssetModelName *string `field:"optional" json:"assetModelName" yaml:"assetModelName"`
