...
func NewCfnAssetPropsMixin(props *CfnAssetMixinProps, options *mixins.CfnPropertyMixinOptions) CfnAssetPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/mixins-preview.aws_iotsitewise.mixins.CfnAssetPropsMixin",
...
func (c *jsiiProxy_CfnAssetPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
