...
//
//   eMRInstanceGroupStatusNotificationProps := &EMRInstanceGroupStatusNotificationProps{
//   	BidPrice: []*string{
...
//
// Experimental.
type EMRInstanceGroupStatusNotification_EMRInstanceGroupStatusNotificationProps struct {
	// bidPrice property.
	//
