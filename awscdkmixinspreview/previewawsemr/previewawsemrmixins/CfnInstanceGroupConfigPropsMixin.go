...
func (j *jsiiProxy_CfnInstanceGroupConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnInstanceGroupConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
