...
//
type CfnDocumentClassifierPropsMixin_DocumentReaderConfigProperty struct {
	...
	//
	DocumentReadAction *string `field:"optional" json:"documentReadAction" yaml:"documentReadAction"`
