...
func (j *jsiiProxy_CfnDocumentClassifierPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDocumentClassifierPropsMixin) ApplyTo(construct constructs.IConstruct) {
