...
func (c *jsiiProxy_CfnPlaybackConfigurationManifestServiceLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnPlaybackConfigurationLogsMixin {
