...
//
//   cfnRestoreTestingSelectionMixinProps := &CfnRestoreTestingSelectionMixinProps{
...
//
type CfnRestoreTestingSelectionMixinProps struct {
	...
	//
	ProtectedResourceType *string `field:"optional" json:"protectedResourceType" yaml:"protectedResourceType"`
	...
	//
	RestoreTestingPlanName *string `field:"optional" json:"restoreTestingPlanName" yaml:"restoreTestingPlanName"`
	...
	//
	RestoreTestingSelectionName *string `field:"optional" json:"restoreTestingSelectionName" yaml:"restoreTestingSelectionName"`
