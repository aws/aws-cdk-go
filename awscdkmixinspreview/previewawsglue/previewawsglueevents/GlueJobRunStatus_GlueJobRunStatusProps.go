...
//
// Experimental.
type GlueJobRunStatus_GlueJobRunStatusProps struct {
	...
	//
	// Experimental.
	NotificationCondition *GlueJobRunStatus_NotificationCondition `field:"optional" json:"notificationCondition" yaml:"notificationCondition"`
	// severity property.
	//
