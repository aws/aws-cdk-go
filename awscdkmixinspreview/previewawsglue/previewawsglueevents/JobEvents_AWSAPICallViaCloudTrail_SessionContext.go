...
//
// Experimental.
type JobEvents_AWSAPICallViaCloudTrail_SessionContext struct {
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *JobEvents_AWSAPICallViaCloudTrail_Attributes `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	SessionIssuer *JobEvents_AWSAPICallViaCloudTrail_SessionIssuer `field:"optional" json:"sessionIssuer" yaml:"sessionIssuer"`
}
