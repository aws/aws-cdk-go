...
func (j *jsiiProxy_CfnIntegrationResourcePropertyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnIntegrationResourcePropertyPropsMixin) ApplyTo(construct constructs.IConstruct) {
