...
func (j *jsiiProxy_CfnMLTransformPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnMLTransformPropsMixin) ApplyTo(construct constructs.IConstruct) {
