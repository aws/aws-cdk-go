...
func (j *jsiiProxy_CfnIdentityCenterConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnIdentityCenterConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
