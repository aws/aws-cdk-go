...
func (j *jsiiProxy_CfnSchemaVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnSchemaVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
