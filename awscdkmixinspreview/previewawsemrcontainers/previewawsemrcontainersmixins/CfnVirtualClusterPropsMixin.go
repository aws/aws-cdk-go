...
func (j *jsiiProxy_CfnVirtualClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnVirtualClusterPropsMixin) ApplyTo(construct constructs.IConstruct) {
