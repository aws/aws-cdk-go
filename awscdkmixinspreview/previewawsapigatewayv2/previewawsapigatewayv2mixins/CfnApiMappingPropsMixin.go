...
func (j *jsiiProxy_CfnApiMappingPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnApiMappingPropsMixin) ApplyTo(construct constructs.IConstruct) {
