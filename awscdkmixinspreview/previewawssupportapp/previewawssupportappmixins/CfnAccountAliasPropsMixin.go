...
func (j *jsiiProxy_CfnAccountAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnAccountAliasPropsMixin) ApplyTo(construct constructs.IConstruct) {
