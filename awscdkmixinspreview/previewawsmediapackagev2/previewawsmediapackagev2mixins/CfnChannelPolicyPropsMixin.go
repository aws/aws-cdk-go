...
//
//   cfnChannelPolicyPropsMixin := awscdkmixinspreview.Mixins.NewCfnChannelPolicyPropsMixin(&CfnChannelPolicyMixinProps{
...
func (j *jsiiProxy_CfnChannelPolicyPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnChannelPolicyPropsMixin(props *CfnChannelPolicyMixinProps, options *mixins.CfnPropertyMixinOptions) CfnChannelPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaPackageV2::ChannelPolicy`.
func NewCfnChannelPolicyPropsMixin_Override(c CfnChannelPolicyPropsMixin, props *CfnChannelPolicyMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnChannelPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
