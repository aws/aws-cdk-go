...
// Experimental.
type CfnChannelGroupIngressAccessLogsOutputFormat_S3 string
...
const (
	...
	// Experimental.
	CfnChannelGroupIngressAccessLogsOutputFormat_S3_PARQUET CfnChannelGroupIngressAccessLogsOutputFormat_S3 = "PARQUET"
)
