...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnChannelGroupPropsMixin := awscdkmixinspreview.Mixins.NewCfnChannelGroupPropsMixin(&CfnChannelGroupMixinProps{
...
func (j *jsiiProxy_CfnChannelGroupPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnChannelGroupPropsMixin(props *CfnChannelGroupMixinProps, options *mixins.CfnPropertyMixinOptions) CfnChannelGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaPackageV2::ChannelGroup`.
func NewCfnChannelGroupPropsMixin_Override(c CfnChannelGroupPropsMixin, props *CfnChannelGroupMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnChannelGroupPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
