...
type CfnChannelGroupEgressAccessLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnChannelGroupLogsMixin
}
...
func (c *jsiiProxy_CfnChannelGroupEgressAccessLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnChannelGroupLogsMixin {
