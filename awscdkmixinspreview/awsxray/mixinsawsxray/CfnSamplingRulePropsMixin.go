...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsxray/mixinsawsxray/internal"
...
func (c *jsiiProxy_CfnSamplingRulePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
