...
//
type CfnCertificateAuthorityPropsMixin_CrlDistributionPointExtensionConfigurationProperty struct {
	...
	//
	OmitExtension interface{} `field:"optional" json:"omitExtension" yaml:"omitExtension"`
}
