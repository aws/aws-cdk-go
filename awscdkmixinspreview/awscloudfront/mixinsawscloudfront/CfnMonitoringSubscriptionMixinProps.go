...
//
//   cfnMonitoringSubscriptionMixinProps := &CfnMonitoringSubscriptionMixinProps{
...
//
type CfnMonitoringSubscriptionMixinProps struct {
	...
	//
	MonitoringSubscription interface{} `field:"optional" json:"monitoringSubscription" yaml:"monitoringSubscription"`
}
