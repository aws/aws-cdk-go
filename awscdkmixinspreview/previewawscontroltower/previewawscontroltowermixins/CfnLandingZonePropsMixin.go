...
func (j *jsiiProxy_CfnLandingZonePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnLandingZonePropsMixin) ApplyTo(construct constructs.IConstruct) {
