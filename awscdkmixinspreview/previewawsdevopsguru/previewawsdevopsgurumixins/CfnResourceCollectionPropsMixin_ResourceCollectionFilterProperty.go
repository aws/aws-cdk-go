...
//
type CfnResourceCollectionPropsMixin_ResourceCollectionFilterProperty struct {
	...
	//
	Tags *[]*CfnResourceCollectionPropsMixin_TagCollectionProperty `field:"optional" json:"tags" yaml:"tags"`
}
