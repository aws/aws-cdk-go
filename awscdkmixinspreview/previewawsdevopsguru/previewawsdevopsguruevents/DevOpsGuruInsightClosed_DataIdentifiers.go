...
//
// Experimental.
type DevOpsGuruInsightClosed_DataIdentifiers struct {
	...
	//
	// Experimental.
	AlarmCondition *DevOpsGuruInsightClosed_AlarmCondition `field:"optional" json:"alarmCondition" yaml:"alarmCondition"`
	// dimensions property.
	//
	...
	//
	// Experimental.
	Dimensions *[]*DevOpsGuruInsightClosed_CloudWatchDimension `field:"optional" json:"dimensions" yaml:"dimensions"`
	...
	//
	// Experimental.
	MetricQuery *DevOpsGuruInsightClosed_MetricQuery `field:"optional" json:"metricQuery" yaml:"metricQuery"`
	// name property.
	//
