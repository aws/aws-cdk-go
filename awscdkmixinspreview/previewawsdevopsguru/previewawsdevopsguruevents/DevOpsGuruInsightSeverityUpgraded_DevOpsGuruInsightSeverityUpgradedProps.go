...
//
//   devOpsGuruInsightSeverityUpgradedProps := &DevOpsGuruInsightSeverityUpgradedProps{
//   	AccountId: []*string{
...
//
// Experimental.
type DevOpsGuruInsightSeverityUpgraded_DevOpsGuruInsightSeverityUpgradedProps struct {
	// accountId property.
	//
	...
	//
	// Experimental.
	Anomalies *[]*DevOpsGuruInsightSeverityUpgraded_Anomaly `field:"optional" json:"anomalies" yaml:"anomalies"`
	...
	//
	// Experimental.
	ResourceCollection *DevOpsGuruInsightSeverityUpgraded_ResourceCollection `field:"optional" json:"resourceCollection" yaml:"resourceCollection"`
	// startTime property.
	//
