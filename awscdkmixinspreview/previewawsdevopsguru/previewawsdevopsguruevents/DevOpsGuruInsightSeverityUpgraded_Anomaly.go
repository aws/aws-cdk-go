...
//
// Experimental.
type DevOpsGuruInsightSeverityUpgraded_Anomaly struct {
	...
	//
	// Experimental.
	AnomalyResources *[]*DevOpsGuruInsightSeverityUpgraded_AnomalyResource `field:"optional" json:"anomalyResources" yaml:"anomalyResources"`
	...
	//
	// Experimental.
	SourceDetails *[]*DevOpsGuruInsightSeverityUpgraded_SourceDetail `field:"optional" json:"sourceDetails" yaml:"sourceDetails"`
	...
	//
	// Experimental.
	SourceMetadata *DevOpsGuruInsightSeverityUpgraded_AnomalySourceMetadata `field:"optional" json:"sourceMetadata" yaml:"sourceMetadata"`
	// startTime property.
	//
