...
//
// Experimental.
type DevOpsGuruInsightClosed_AlarmCondition struct {
	...
	//
	// Experimental.
	ReferenceValue *DevOpsGuruInsightClosed_ReferenceValue `field:"optional" json:"referenceValue" yaml:"referenceValue"`
}
