...
//
// Experimental.
type DevOpsGuruNewAnomalyAssociation_AlarmCondition struct {
	...
	//
	// Experimental.
	ReferenceValue *DevOpsGuruNewAnomalyAssociation_ReferenceValue `field:"optional" json:"referenceValue" yaml:"referenceValue"`
}
