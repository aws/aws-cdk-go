...
//
// Experimental.
type DevOpsGuruInsightSeverityUpgraded_DataIdentifiers struct {
	...
	//
	// Experimental.
	AlarmCondition *DevOpsGuruInsightSeverityUpgraded_AlarmCondition `field:"optional" json:"alarmCondition" yaml:"alarmCondition"`
	// dimensions property.
	//
	...
	//
	// Experimental.
	Dimensions *[]*DevOpsGuruInsightSeverityUpgraded_CloudWatchDimension `field:"optional" json:"dimensions" yaml:"dimensions"`
	...
	//
	// Experimental.
	MetricQuery *DevOpsGuruInsightSeverityUpgraded_MetricQuery `field:"optional" json:"metricQuery" yaml:"metricQuery"`
	// name property.
	//
