...
//
//   devOpsGuruNewAnomalyAssociationProps := &DevOpsGuruNewAnomalyAssociationProps{
//   	AccountId: []*string{
...
//
// Experimental.
type DevOpsGuruNewAnomalyAssociation_DevOpsGuruNewAnomalyAssociationProps struct {
	// accountId property.
	//
	...
	//
	// Experimental.
	Anomalies *[]*DevOpsGuruNewAnomalyAssociation_Anomaly `field:"optional" json:"anomalies" yaml:"anomalies"`
	...
	//
	// Experimental.
	ResourceCollection *DevOpsGuruNewAnomalyAssociation_ResourceCollection `field:"optional" json:"resourceCollection" yaml:"resourceCollection"`
	// startTime property.
	//
