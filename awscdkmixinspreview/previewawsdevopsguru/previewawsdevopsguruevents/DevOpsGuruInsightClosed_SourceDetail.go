...
//
// Experimental.
type DevOpsGuruInsightClosed_SourceDetail struct {
	...
	//
	// Experimental.
	DataIdentifiers *DevOpsGuruInsightClosed_DataIdentifiers `field:"optional" json:"dataIdentifiers" yaml:"dataIdentifiers"`
	// dataSource property.
	//
