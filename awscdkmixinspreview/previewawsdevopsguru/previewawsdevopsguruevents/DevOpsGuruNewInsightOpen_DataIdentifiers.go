...
//
// Experimental.
type DevOpsGuruNewInsightOpen_DataIdentifiers struct {
	...
	//
	// Experimental.
	AlarmCondition *DevOpsGuruNewInsightOpen_AlarmCondition `field:"optional" json:"alarmCondition" yaml:"alarmCondition"`
	// dimensions property.
	//
	...
	//
	// Experimental.
	Dimensions *[]*DevOpsGuruNewInsightOpen_CloudWatchDimension `field:"optional" json:"dimensions" yaml:"dimensions"`
	...
	//
	// Experimental.
	MetricQuery *DevOpsGuruNewInsightOpen_MetricQuery `field:"optional" json:"metricQuery" yaml:"metricQuery"`
	// name property.
	//
