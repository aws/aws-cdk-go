...
//
// Experimental.
type DevOpsGuruInsightClosed_Anomaly struct {
	...
	//
	// Experimental.
	AnomalyResources *[]*DevOpsGuruInsightClosed_AnomalyResource `field:"optional" json:"anomalyResources" yaml:"anomalyResources"`
	...
	//
	// Experimental.
	CloseTime *[]*string `field:"optional" json:"closeTime" yaml:"closeTime"`
	...
	//
	// Experimental.
	CloseTimeIso *[]*string `field:"optional" json:"closeTimeIso" yaml:"closeTimeIso"`
	...
	//
	// Experimental.
	SourceDetails *[]*DevOpsGuruInsightClosed_SourceDetail `field:"optional" json:"sourceDetails" yaml:"sourceDetails"`
	...
	//
	// Experimental.
	SourceMetadata *DevOpsGuruInsightClosed_AnomalySourceMetadata `field:"optional" json:"sourceMetadata" yaml:"sourceMetadata"`
	// startTime property.
	//
