...
//
// Experimental.
type DevOpsGuruNewInsightOpen_Anomaly struct {
	...
	//
	// Experimental.
	AnomalyResources *[]*DevOpsGuruNewInsightOpen_AnomalyResource `field:"optional" json:"anomalyResources" yaml:"anomalyResources"`
	...
	//
	// Experimental.
	SourceDetails *[]*DevOpsGuruNewInsightOpen_SourceDetail `field:"optional" json:"sourceDetails" yaml:"sourceDetails"`
	...
	//
	// Experimental.
	SourceMetadata *DevOpsGuruNewInsightOpen_AnomalySourceMetadata `field:"optional" json:"sourceMetadata" yaml:"sourceMetadata"`
	// startTime property.
	//
