...
//
// Experimental.
type DevOpsGuruNewInsightOpen_AlarmCondition struct {
	...
	//
	// Experimental.
	ReferenceValue *DevOpsGuruNewInsightOpen_ReferenceValue `field:"optional" json:"referenceValue" yaml:"referenceValue"`
}
