...
//
// Experimental.
type DevOpsGuruNewAnomalyAssociation_SourceDetail struct {
	...
	//
	// Experimental.
	DataIdentifiers *DevOpsGuruNewAnomalyAssociation_DataIdentifiers `field:"optional" json:"dataIdentifiers" yaml:"dataIdentifiers"`
	// dataSource property.
	//
