...
//
// Experimental.
type DevOpsGuruInsightClosed_ResourceCollection struct {
	...
	//
	// Experimental.
	CloudFormation *DevOpsGuruInsightClosed_CloudFormation `field:"optional" json:"cloudFormation" yaml:"cloudFormation"`
	// tags property.
	//
	...
	//
	// Experimental.
	Tags *[]*DevOpsGuruInsightClosed_TagType `field:"optional" json:"tags" yaml:"tags"`
}
