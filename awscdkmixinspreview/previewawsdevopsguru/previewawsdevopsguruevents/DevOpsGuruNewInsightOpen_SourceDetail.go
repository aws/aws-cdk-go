...
//
// Experimental.
type DevOpsGuruNewInsightOpen_SourceDetail struct {
	...
	//
	// Experimental.
	DataIdentifiers *DevOpsGuruNewInsightOpen_DataIdentifiers `field:"optional" json:"dataIdentifiers" yaml:"dataIdentifiers"`
	// dataSource property.
	//
