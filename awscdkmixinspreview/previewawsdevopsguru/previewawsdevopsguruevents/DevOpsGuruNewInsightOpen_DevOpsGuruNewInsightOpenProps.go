...
//
//   devOpsGuruNewInsightOpenProps := &DevOpsGuruNewInsightOpenProps{
//   	AccountId: []*string{
...
//
// Experimental.
type DevOpsGuruNewInsightOpen_DevOpsGuruNewInsightOpenProps struct {
	// accountId property.
	//
	...
	//
	// Experimental.
	Anomalies *[]*DevOpsGuruNewInsightOpen_Anomaly `field:"optional" json:"anomalies" yaml:"anomalies"`
	...
	//
	// Experimental.
	ResourceCollection *DevOpsGuruNewInsightOpen_ResourceCollection `field:"optional" json:"resourceCollection" yaml:"resourceCollection"`
	// startTime property.
	//
