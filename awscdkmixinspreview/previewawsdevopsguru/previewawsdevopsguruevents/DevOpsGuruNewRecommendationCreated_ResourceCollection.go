...
//
// Experimental.
type DevOpsGuruNewRecommendationCreated_ResourceCollection struct {
	...
	//
	// Experimental.
	CloudFormation *DevOpsGuruNewRecommendationCreated_CloudFormation `field:"optional" json:"cloudFormation" yaml:"cloudFormation"`
	// tags property.
	//
	...
	//
	// Experimental.
	Tags *[]*DevOpsGuruNewRecommendationCreated_TagType `field:"optional" json:"tags" yaml:"tags"`
}
