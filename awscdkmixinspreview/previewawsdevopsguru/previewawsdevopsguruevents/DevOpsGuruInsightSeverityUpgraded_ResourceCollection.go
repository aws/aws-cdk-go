...
//
// Experimental.
type DevOpsGuruInsightSeverityUpgraded_ResourceCollection struct {
	...
	//
	// Experimental.
	CloudFormation *DevOpsGuruInsightSeverityUpgraded_CloudFormation `field:"optional" json:"cloudFormation" yaml:"cloudFormation"`
	// tags property.
	//
	...
	//
	// Experimental.
	Tags *[]*DevOpsGuruInsightSeverityUpgraded_TagType `field:"optional" json:"tags" yaml:"tags"`
}
