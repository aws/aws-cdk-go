...
//
type CfnSqlInjectionMatchSetPropsMixin_SqlInjectionMatchTupleProperty struct {
	...
	//
	TextTransformation *string `field:"optional" json:"textTransformation" yaml:"textTransformation"`
}
