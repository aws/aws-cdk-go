...
//
type CfnCertificateAuthorityPropsMixin_AccessDescriptionProperty struct {
	...
	//
	AccessLocation interface{} `field:"optional" json:"accessLocation" yaml:"accessLocation"`
	...
	//
	AccessMethod interface{} `field:"optional" json:"accessMethod" yaml:"accessMethod"`
}
