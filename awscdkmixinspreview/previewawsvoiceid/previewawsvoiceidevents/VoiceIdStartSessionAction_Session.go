...
//
// Experimental.
type VoiceIdStartSessionAction_Session struct {
	...
	//
	// Experimental.
	AuthenticationAudioProgress *VoiceIdStartSessionAction_AuthenticationAudioProgress `field:"optional" json:"authenticationAudioProgress" yaml:"authenticationAudioProgress"`
	...
	//
	// Experimental.
	AuthenticationConfiguration *VoiceIdStartSessionAction_AuthenticationConfiguration `field:"optional" json:"authenticationConfiguration" yaml:"authenticationConfiguration"`
	...
	//
	// Experimental.
	EnrollmentAudioProgress *VoiceIdStartSessionAction_EnrollmentAudioProgress `field:"optional" json:"enrollmentAudioProgress" yaml:"enrollmentAudioProgress"`
	...
	//
	// Experimental.
	FraudDetectionAudioProgress *VoiceIdStartSessionAction_AuthenticationAudioProgress `field:"optional" json:"fraudDetectionAudioProgress" yaml:"fraudDetectionAudioProgress"`
	...
	//
	// Experimental.
	FraudDetectionConfiguration *VoiceIdStartSessionAction_FraudDetectionConfiguration `field:"optional" json:"fraudDetectionConfiguration" yaml:"fraudDetectionConfiguration"`
	...
	//
	// Experimental.
	StreamingConfiguration *VoiceIdStartSessionAction_StreamingConfiguration `field:"optional" json:"streamingConfiguration" yaml:"streamingConfiguration"`
}
