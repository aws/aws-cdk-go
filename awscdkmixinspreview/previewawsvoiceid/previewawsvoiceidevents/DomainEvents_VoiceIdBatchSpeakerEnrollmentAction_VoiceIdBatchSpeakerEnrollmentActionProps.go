...
// Props type for Domain aws.voiceid@VoiceIdBatchSpeakerEnrollmentAction event.
//
// Example:
...
//
// Experimental.
type DomainEvents_VoiceIdBatchSpeakerEnrollmentAction_VoiceIdBatchSpeakerEnrollmentActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	Data *DomainEvents_VoiceIdBatchSpeakerEnrollmentAction_Data `field:"optional" json:"data" yaml:"data"`
	// domainId property.
	//
	...
	//
	// Experimental.
	ErrorInfo *DomainEvents_VoiceIdBatchSpeakerEnrollmentAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
