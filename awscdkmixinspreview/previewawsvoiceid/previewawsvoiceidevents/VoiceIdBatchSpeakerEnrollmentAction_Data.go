...
//
// Experimental.
type VoiceIdBatchSpeakerEnrollmentAction_Data struct {
	...
	//
	// Experimental.
	EnrollmentConfig *VoiceIdBatchSpeakerEnrollmentAction_EnrollmentConfig `field:"optional" json:"enrollmentConfig" yaml:"enrollmentConfig"`
	...
	//
	// Experimental.
	InputDataConfig *VoiceIdBatchSpeakerEnrollmentAction_InputDataConfig `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	...
	//
	// Experimental.
	OutputDataConfig *VoiceIdBatchSpeakerEnrollmentAction_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
}
