...
//
// Experimental.
type VoiceIdEvaluateSessionAction_Session struct {
	...
	//
	// Experimental.
	AuthenticationResult *VoiceIdEvaluateSessionAction_AuthenticationResult `field:"optional" json:"authenticationResult" yaml:"authenticationResult"`
	...
	//
	// Experimental.
	FraudDetectionResult *VoiceIdEvaluateSessionAction_FraudDetectionResult `field:"optional" json:"fraudDetectionResult" yaml:"fraudDetectionResult"`
