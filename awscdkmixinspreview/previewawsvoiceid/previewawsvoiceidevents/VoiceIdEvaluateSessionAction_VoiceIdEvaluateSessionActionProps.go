...
//
// Experimental.
type VoiceIdEvaluateSessionAction_VoiceIdEvaluateSessionActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdEvaluateSessionAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
	...
	//
	// Experimental.
	Session *VoiceIdEvaluateSessionAction_Session `field:"optional" json:"session" yaml:"session"`
	// sourceId property.
	//
	...
	//
	// Experimental.
	SystemAttributes *VoiceIdEvaluateSessionAction_SystemAttributes `field:"optional" json:"systemAttributes" yaml:"systemAttributes"`
}
