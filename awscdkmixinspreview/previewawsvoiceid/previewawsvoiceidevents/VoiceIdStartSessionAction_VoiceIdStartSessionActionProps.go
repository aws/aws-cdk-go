...
//
// Experimental.
type VoiceIdStartSessionAction_VoiceIdStartSessionActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdStartSessionAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
	...
	//
	// Experimental.
	Session *VoiceIdStartSessionAction_Session `field:"optional" json:"session" yaml:"session"`
	// sourceId property.
	//
	...
	//
	// Experimental.
	SystemAttributes *VoiceIdStartSessionAction_SystemAttributes `field:"optional" json:"systemAttributes" yaml:"systemAttributes"`
}
