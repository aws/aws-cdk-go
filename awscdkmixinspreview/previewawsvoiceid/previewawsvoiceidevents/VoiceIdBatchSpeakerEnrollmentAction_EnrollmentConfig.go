...
//
// Experimental.
type VoiceIdBatchSpeakerEnrollmentAction_EnrollmentConfig struct {
	...
	//
	// Experimental.
	FraudDetectionConfig *VoiceIdBatchSpeakerEnrollmentAction_FraudDetectionConfig `field:"optional" json:"fraudDetectionConfig" yaml:"fraudDetectionConfig"`
}
