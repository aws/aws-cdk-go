...
//
// Experimental.
type VoiceIdUpdateSessionAction_Session struct {
	...
	//
	// Experimental.
	AuthenticationConfiguration *VoiceIdUpdateSessionAction_AuthenticationConfiguration `field:"optional" json:"authenticationConfiguration" yaml:"authenticationConfiguration"`
	...
	//
	// Experimental.
	FraudDetectionConfiguration *VoiceIdUpdateSessionAction_FraudDetectionConfiguration `field:"optional" json:"fraudDetectionConfiguration" yaml:"fraudDetectionConfiguration"`
