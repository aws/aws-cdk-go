...
//
// Experimental.
type VoiceIdBatchFraudsterRegistrationAction_Data struct {
	...
	//
	// Experimental.
	InputDataConfig *VoiceIdBatchFraudsterRegistrationAction_InputDataConfig `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	...
	//
	// Experimental.
	OutputDataConfig *VoiceIdBatchFraudsterRegistrationAction_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	...
	//
	// Experimental.
	RegistrationConfig *VoiceIdBatchFraudsterRegistrationAction_RegistrationConfig `field:"optional" json:"registrationConfig" yaml:"registrationConfig"`
}
