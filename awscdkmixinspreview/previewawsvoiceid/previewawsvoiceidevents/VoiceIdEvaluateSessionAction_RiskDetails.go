...
//
// Experimental.
type VoiceIdEvaluateSessionAction_RiskDetails struct {
	...
	//
	// Experimental.
	KnownFraudsterRisk *VoiceIdEvaluateSessionAction_KnownFraudsterRisk `field:"optional" json:"knownFraudsterRisk" yaml:"knownFraudsterRisk"`
	...
	//
	// Experimental.
	VoiceSpoofingRisk *VoiceIdEvaluateSessionAction_VoiceSpoofingRisk `field:"optional" json:"voiceSpoofingRisk" yaml:"voiceSpoofingRisk"`
}
