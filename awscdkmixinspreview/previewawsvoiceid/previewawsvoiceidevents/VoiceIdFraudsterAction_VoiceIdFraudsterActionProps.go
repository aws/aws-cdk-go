...
//
// Experimental.
type VoiceIdFraudsterAction_VoiceIdFraudsterActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	Data *VoiceIdFraudsterAction_Data `field:"optional" json:"data" yaml:"data"`
	// domainId property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdFraudsterAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
