...
//
// Experimental.
type VoiceIdBatchFraudsterRegistrationAction_VoiceIdBatchFraudsterRegistrationActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	Data *VoiceIdBatchFraudsterRegistrationAction_Data `field:"optional" json:"data" yaml:"data"`
	// domainId property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdBatchFraudsterRegistrationAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
