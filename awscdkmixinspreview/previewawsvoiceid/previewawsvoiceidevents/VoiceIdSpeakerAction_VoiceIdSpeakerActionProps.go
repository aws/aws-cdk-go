...
//
// Experimental.
type VoiceIdSpeakerAction_VoiceIdSpeakerActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	Data *VoiceIdSpeakerAction_Data `field:"optional" json:"data" yaml:"data"`
	// domainId property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdSpeakerAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
	...
	//
	// Experimental.
	SystemAttributes *VoiceIdSpeakerAction_SystemAttributes `field:"optional" json:"systemAttributes" yaml:"systemAttributes"`
}
