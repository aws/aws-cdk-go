...
//
//   voiceIdBatchSpeakerEnrollmentActionProps := &VoiceIdBatchSpeakerEnrollmentActionProps{
//   	Action: []*string{
//   		jsii.String("action"),
//   	},
//   	BatchJobId: []*string{
...
//
// Experimental.
type VoiceIdBatchSpeakerEnrollmentAction_VoiceIdBatchSpeakerEnrollmentActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	Data *VoiceIdBatchSpeakerEnrollmentAction_Data `field:"optional" json:"data" yaml:"data"`
	// domainId property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdBatchSpeakerEnrollmentAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
