...
//
// Experimental.
type VoiceIdEvaluateSessionAction_FraudDetectionResult struct {
	...
	//
	// Experimental.
	Configuration *VoiceIdEvaluateSessionAction_ConfigurationFraud `field:"optional" json:"configuration" yaml:"configuration"`
	// decision property.
	//
	...
	//
	// Experimental.
	RiskDetails *VoiceIdEvaluateSessionAction_RiskDetails `field:"optional" json:"riskDetails" yaml:"riskDetails"`
}
