...
//
// Experimental.
type VoiceIdSessionSpeakerEnrollmentAction_VoiceIdSessionSpeakerEnrollmentActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdSessionSpeakerEnrollmentAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
	...
	//
	// Experimental.
	SystemAttributes *VoiceIdSessionSpeakerEnrollmentAction_SystemAttributes `field:"optional" json:"systemAttributes" yaml:"systemAttributes"`
}
