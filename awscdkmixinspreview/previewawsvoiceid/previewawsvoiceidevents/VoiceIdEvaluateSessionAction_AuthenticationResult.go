...
//
// Experimental.
type VoiceIdEvaluateSessionAction_AuthenticationResult struct {
	...
	//
	// Experimental.
	Configuration *VoiceIdEvaluateSessionAction_ConfigurationAuthentication `field:"optional" json:"configuration" yaml:"configuration"`
	// decision property.
	//
