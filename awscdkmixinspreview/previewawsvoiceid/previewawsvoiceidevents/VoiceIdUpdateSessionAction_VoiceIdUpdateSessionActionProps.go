...
//
// Experimental.
type VoiceIdUpdateSessionAction_VoiceIdUpdateSessionActionProps struct {
	// action property.
	//
	...
	//
	// Experimental.
	ErrorInfo *VoiceIdUpdateSessionAction_ErrorInfo `field:"optional" json:"errorInfo" yaml:"errorInfo"`
	...
	//
	// Experimental.
	Session *VoiceIdUpdateSessionAction_Session `field:"optional" json:"session" yaml:"session"`
	// sourceId property.
	//
