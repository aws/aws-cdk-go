...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_voiceid.mixins.CfnDomainMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_voiceid.mixins.CfnDomainPropsMixin.ServerSideEncryptionConfigurationProperty",
