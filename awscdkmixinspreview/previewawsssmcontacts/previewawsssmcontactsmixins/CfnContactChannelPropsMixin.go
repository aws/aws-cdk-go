...
func (j *jsiiProxy_CfnContactChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnContactChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
