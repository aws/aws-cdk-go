...
//
//   createProjectPolicyGrantDetailProperty := &CreateProjectPolicyGrantDetailProperty{
...
//
type CfnPolicyGrantPropsMixin_CreateProjectPolicyGrantDetailProperty struct {
