...
// Experimental.
type CfnLoadBalancerAlbConnectionLogsOutputFormat_S3 string
...
const (
	...
	// Experimental.
	CfnLoadBalancerAlbConnectionLogsOutputFormat_S3_PARQUET CfnLoadBalancerAlbConnectionLogsOutputFormat_S3 = "PARQUET"
)
