...
func (j *jsiiProxy_CfnListenerRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnListenerRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
