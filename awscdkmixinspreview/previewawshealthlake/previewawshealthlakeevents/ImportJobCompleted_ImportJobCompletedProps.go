...
//
//   importJobCompletedProps := &ImportJobCompletedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ImportJobCompleted_ImportJobCompletedProps struct {
	...
	//
	// Experimental.
	InputDataConfig *ImportJobCompleted_InputDataConfig `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	// jobId property.
	//
