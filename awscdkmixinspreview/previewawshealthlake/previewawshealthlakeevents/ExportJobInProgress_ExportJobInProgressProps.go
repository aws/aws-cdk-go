...
//
//   exportJobInProgressProps := &ExportJobInProgressProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ExportJobInProgress_ExportJobInProgressProps struct {
	...
	//
	// Experimental.
	OutputDataConfig *ExportJobInProgress_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	// submitTime property.
	//
