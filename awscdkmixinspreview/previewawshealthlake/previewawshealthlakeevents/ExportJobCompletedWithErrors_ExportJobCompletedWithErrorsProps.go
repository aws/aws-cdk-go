...
//
//   exportJobCompletedWithErrorsProps := &ExportJobCompletedWithErrorsProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ExportJobCompletedWithErrors_ExportJobCompletedWithErrorsProps struct {
	...
	//
	// Experimental.
	OutputDataConfig *ExportJobCompletedWithErrors_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	// submitTime property.
	//
