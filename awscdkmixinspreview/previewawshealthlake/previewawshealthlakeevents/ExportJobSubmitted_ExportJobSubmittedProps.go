...
//
//   exportJobSubmittedProps := &ExportJobSubmittedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ExportJobSubmitted_ExportJobSubmittedProps struct {
	...
	//
	// Experimental.
	OutputDataConfig *ExportJobSubmitted_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	// submitTime property.
	//
