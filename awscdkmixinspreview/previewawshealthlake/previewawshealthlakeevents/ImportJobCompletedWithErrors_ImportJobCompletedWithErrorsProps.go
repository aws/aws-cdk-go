...
//
//   importJobCompletedWithErrorsProps := &ImportJobCompletedWithErrorsProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ImportJobCompletedWithErrors_ImportJobCompletedWithErrorsProps struct {
	...
	//
	// Experimental.
	InputDataConfig *ImportJobCompletedWithErrors_InputDataConfig `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	// jobId property.
	//
