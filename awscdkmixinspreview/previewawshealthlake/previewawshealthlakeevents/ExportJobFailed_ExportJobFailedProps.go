...
//
//   exportJobFailedProps := &ExportJobFailedProps{
//   	DatastoreId: []*string{
...
//
// Experimental.
type ExportJobFailed_ExportJobFailedProps struct {
	...
	//
	// Experimental.
	OutputDataConfig *ExportJobFailed_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	// submitTime property.
	//
