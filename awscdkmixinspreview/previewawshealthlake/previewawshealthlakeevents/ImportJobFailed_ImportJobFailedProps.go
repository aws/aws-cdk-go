...
//
// Experimental.
type ImportJobFailed_ImportJobFailedProps struct {
	...
	//
	// Experimental.
	InputDataConfig *ImportJobFailed_InputDataConfig `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	// jobId property.
	//
