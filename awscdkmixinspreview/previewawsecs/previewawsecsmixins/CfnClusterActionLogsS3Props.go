...
//   var keyRef IKeyRef
//
//   cfnClusterActionLogsS3Props := &CfnClusterActionLogsS3Props{
//   	EncryptionKey: keyRef,
//   	OutputFormat: awscdkmixinspreview.Mixins.CfnClusterActionLogsOutputFormat.S3_JSON,
...
//
// Experimental.
type CfnClusterActionLogsS3Props struct {
	// Encrpytion key for your delivery bucket.
	// Experimental.
	EncryptionKey interfacesawskms.IKeyRef `field:"optional" json:"encryptionKey" yaml:"encryptionKey"`
	// Format for log output, options are json.
	// Experimental.
	OutputFormat CfnClusterActionLogsOutputFormat_S3 `field:"optional" json:"outputFormat" yaml:"outputFormat"`
