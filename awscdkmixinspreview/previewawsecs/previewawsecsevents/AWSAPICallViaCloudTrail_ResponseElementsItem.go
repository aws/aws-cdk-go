...
type AWSAPICallViaCloudTrail_ResponseElementsItem struct {
	...
	//
	// Experimental.
	Attachments *[]*AWSAPICallViaCloudTrail_ResponseElementsItemItem `field:"optional" json:"attachments" yaml:"attachments"`
	// clusterArn property.
	//
	...
	//
	// Experimental.
	Containers *[]*AWSAPICallViaCloudTrail_ResponseElementsItemItem1 `field:"optional" json:"containers" yaml:"containers"`
	// cpu property.
	//
	...
	//
	// Experimental.
	Overrides *AWSAPICallViaCloudTrail_Overrides1 `field:"optional" json:"overrides" yaml:"overrides"`
