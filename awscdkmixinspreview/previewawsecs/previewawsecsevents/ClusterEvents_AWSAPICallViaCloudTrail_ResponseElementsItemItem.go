...
//
//   responseElementsItemItem := &ResponseElementsItemItem{
...
//
// Experimental.
type ClusterEvents_AWSAPICallViaCloudTrail_ResponseElementsItemItem struct {
	// details property.
	//
	...
	//
	// Experimental.
	Details *[]*ClusterEvents_AWSAPICallViaCloudTrail_ResponseElementsItemItemItem `field:"optional" json:"details" yaml:"details"`
	// id property.
	//
