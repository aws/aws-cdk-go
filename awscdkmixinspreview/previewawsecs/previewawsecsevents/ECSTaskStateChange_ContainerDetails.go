...
//
// Experimental.
type ECSTaskStateChange_ContainerDetails struct {
	...
	//
	// Experimental.
	NetworkBindings *[]*ECSTaskStateChange_NetworkBindingDetails `field:"optional" json:"networkBindings" yaml:"networkBindings"`
	...
	//
	// Experimental.
	NetworkInterfaces *[]*ECSTaskStateChange_NetworkInterfaceDetails `field:"optional" json:"networkInterfaces" yaml:"networkInterfaces"`
	// reason property.
	//
