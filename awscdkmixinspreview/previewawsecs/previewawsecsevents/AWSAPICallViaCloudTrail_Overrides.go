...
//
// Experimental.
type AWSAPICallViaCloudTrail_Overrides struct {
	...
	//
	// Experimental.
	ContainerOverrides *[]*AWSAPICallViaCloudTrail_OverridesItem `field:"optional" json:"containerOverrides" yaml:"containerOverrides"`
}
