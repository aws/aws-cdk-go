...
//
// Experimental.
type AWSAPICallViaCloudTrail_NetworkConfiguration struct {
	...
	//
	// Experimental.
	AwsvpcConfiguration *AWSAPICallViaCloudTrail_AwsvpcConfiguration `field:"optional" json:"awsvpcConfiguration" yaml:"awsvpcConfiguration"`
}
