...
//
// Experimental.
type AWSAPICallViaCloudTrail_ResponseElementsItemItem struct {
	// details property.
	//
	...
	//
	// Experimental.
	Details *[]*AWSAPICallViaCloudTrail_ResponseElementsItemItemItem `field:"optional" json:"details" yaml:"details"`
	// id property.
	//
