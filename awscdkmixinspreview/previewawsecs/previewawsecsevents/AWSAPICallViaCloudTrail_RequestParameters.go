...
type AWSAPICallViaCloudTrail_RequestParameters struct {
	...
	//
	// Experimental.
	Containers *[]*AWSAPICallViaCloudTrail_RequestParametersItem1 `field:"optional" json:"containers" yaml:"containers"`
	// count property.
	//
	...
	//
	// Experimental.
	NetworkConfiguration *AWSAPICallViaCloudTrail_NetworkConfiguration `field:"optional" json:"networkConfiguration" yaml:"networkConfiguration"`
	// overrides property.
	//
	...
	//
	// Experimental.
	Overrides *AWSAPICallViaCloudTrail_Overrides `field:"optional" json:"overrides" yaml:"overrides"`
	...
	//
	// Experimental.
	PlacementConstraints *[]*AWSAPICallViaCloudTrail_RequestParametersItem `field:"optional" json:"placementConstraints" yaml:"placementConstraints"`
