...
//
// Experimental.
type ECSContainerInstanceStateChange_AttachmentDetails struct {
	// details property.
	//
	...
	//
	// Experimental.
	Details *[]*ECSContainerInstanceStateChange_DetailsItems `field:"optional" json:"details" yaml:"details"`
	// id property.
	//
