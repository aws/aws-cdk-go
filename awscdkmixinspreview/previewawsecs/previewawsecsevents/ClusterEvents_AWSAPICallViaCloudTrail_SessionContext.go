...
//
// Experimental.
type ClusterEvents_AWSAPICallViaCloudTrail_SessionContext struct {
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *ClusterEvents_AWSAPICallViaCloudTrail_Attributes `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	SessionIssuer *ClusterEvents_AWSAPICallViaCloudTrail_SessionIssuer `field:"optional" json:"sessionIssuer" yaml:"sessionIssuer"`
