...
//
// Experimental.
type AWSAPICallViaCloudTrail_Overrides1 struct {
	...
	//
	// Experimental.
	ContainerOverrides *[]*AWSAPICallViaCloudTrail_Overrides1Item `field:"optional" json:"containerOverrides" yaml:"containerOverrides"`
