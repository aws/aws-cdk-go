...
//
// Experimental.
type ECSTaskStateChange_Overrides struct {
	...
	//
	// Experimental.
	ContainerOverrides *[]*ECSTaskStateChange_OverridesItem `field:"optional" json:"containerOverrides" yaml:"containerOverrides"`
}
