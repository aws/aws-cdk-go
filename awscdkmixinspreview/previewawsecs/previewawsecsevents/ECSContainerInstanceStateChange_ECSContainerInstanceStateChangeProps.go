...
//
// Experimental.
type ECSContainerInstanceStateChange_ECSContainerInstanceStateChangeProps struct {
	...
	//
	// Experimental.
	Attachments *[]*ECSContainerInstanceStateChange_AttachmentDetails `field:"optional" json:"attachments" yaml:"attachments"`
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *[]*ECSContainerInstanceStateChange_AttributesDetails `field:"optional" json:"attributes" yaml:"attributes"`
	// clusterArn property.
	//
	...
	//
	// Experimental.
	RegisteredResources *[]*ECSContainerInstanceStateChange_ResourceDetails `field:"optional" json:"registeredResources" yaml:"registeredResources"`
	...
	//
	// Experimental.
	RemainingResources *[]*ECSContainerInstanceStateChange_ResourceDetails `field:"optional" json:"remainingResources" yaml:"remainingResources"`
	...
	//
	// Experimental.
	VersionInfo *ECSContainerInstanceStateChange_VersionInfo `field:"optional" json:"versionInfo" yaml:"versionInfo"`
}
