...
//
// Experimental.
type ECSTaskStateChange_ECSTaskStateChangeProps struct {
	...
	//
	// Experimental.
	Attachments *[]*ECSTaskStateChange_AttachmentDetails `field:"optional" json:"attachments" yaml:"attachments"`
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *[]*ECSTaskStateChange_AttributesDetails `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	Containers *[]*ECSTaskStateChange_ContainerDetails `field:"optional" json:"containers" yaml:"containers"`
	// cpu property.
	//
	...
	//
	// Experimental.
	Overrides *ECSTaskStateChange_Overrides `field:"optional" json:"overrides" yaml:"overrides"`
