...
//
// Experimental.
type ClusterEvents_ECSTaskStateChange_AttachmentDetails struct {
	// details property.
	//
	...
	//
	// Experimental.
	Details *ClusterEvents_ECSTaskStateChange_Details `field:"optional" json:"details" yaml:"details"`
	// id property.
	//
