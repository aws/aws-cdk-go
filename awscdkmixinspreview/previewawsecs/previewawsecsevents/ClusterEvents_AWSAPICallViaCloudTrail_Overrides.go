...
//
// Experimental.
type ClusterEvents_AWSAPICallViaCloudTrail_Overrides struct {
	...
	//
	// Experimental.
	ContainerOverrides *[]*ClusterEvents_AWSAPICallViaCloudTrail_OverridesItem `field:"optional" json:"containerOverrides" yaml:"containerOverrides"`
}
