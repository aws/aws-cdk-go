...
//
type CfnInferenceSchedulerPropsMixin_DataInputConfigurationProperty struct {
	...
	//
	S3InputConfiguration interface{} `field:"optional" json:"s3InputConfiguration" yaml:"s3InputConfiguration"`
}
