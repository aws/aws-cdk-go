...
//
type CfnModelExplainabilityJobDefinitionPropsMixin_BatchTransformInputProperty struct {
	...
	//
	DatasetFormat interface{} `field:"optional" json:"datasetFormat" yaml:"datasetFormat"`
