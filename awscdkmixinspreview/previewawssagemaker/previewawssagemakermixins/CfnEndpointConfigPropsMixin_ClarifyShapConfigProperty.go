...
//
type CfnEndpointConfigPropsMixin_ClarifyShapConfigProperty struct {
	...
	//
	ShapBaselineConfig interface{} `field:"optional" json:"shapBaselineConfig" yaml:"shapBaselineConfig"`
