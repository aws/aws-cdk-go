...
func (j *jsiiProxy_CfnFeatureGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnFeatureGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
