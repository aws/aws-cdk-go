...
func (j *jsiiProxy_CfnStudioLifecycleConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnStudioLifecycleConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
