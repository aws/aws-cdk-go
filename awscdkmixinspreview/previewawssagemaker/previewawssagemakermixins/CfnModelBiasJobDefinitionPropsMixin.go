...
func NewCfnModelBiasJobDefinitionPropsMixin(props *CfnModelBiasJobDefinitionMixinProps, options *mixins.CfnPropertyMixinOptions) CfnModelBiasJobDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ModelBiasJobDefinition`.
func NewCfnModelBiasJobDefinitionPropsMixin_Override(c CfnModelBiasJobDefinitionPropsMixin, props *CfnModelBiasJobDefinitionMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnModelBiasJobDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
