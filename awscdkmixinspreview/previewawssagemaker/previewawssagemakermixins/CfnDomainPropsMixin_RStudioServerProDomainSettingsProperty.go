...
//
type CfnDomainPropsMixin_RStudioServerProDomainSettingsProperty struct {
	...
	//
	DomainExecutionRoleArn *string `field:"optional" json:"domainExecutionRoleArn" yaml:"domainExecutionRoleArn"`
