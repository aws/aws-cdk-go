...
func (j *jsiiProxy_CfnModelQualityJobDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnModelQualityJobDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
