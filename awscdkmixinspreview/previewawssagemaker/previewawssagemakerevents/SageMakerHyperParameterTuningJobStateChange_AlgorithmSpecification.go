...
//
// Experimental.
type SageMakerHyperParameterTuningJobStateChange_AlgorithmSpecification struct {
	...
	//
	// Experimental.
	MetricDefinitions *[]*SageMakerHyperParameterTuningJobStateChange_AlgorithmSpecificationItem `field:"optional" json:"metricDefinitions" yaml:"metricDefinitions"`
