...
//
// Experimental.
type SageMakerHyperParameterTuningJobStateChange_DataSource struct {
	...
	//
	// Experimental.
	S3DataSource *SageMakerHyperParameterTuningJobStateChange_S3DataSource `field:"optional" json:"s3DataSource" yaml:"s3DataSource"`
}
