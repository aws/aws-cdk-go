...
//
// Experimental.
type ModelEvents_AWSAPICallViaCloudTrail_DataSource struct {
	...
	//
	// Experimental.
	S3DataSource *ModelEvents_AWSAPICallViaCloudTrail_S3DataSource `field:"optional" json:"s3DataSource" yaml:"s3DataSource"`
}
