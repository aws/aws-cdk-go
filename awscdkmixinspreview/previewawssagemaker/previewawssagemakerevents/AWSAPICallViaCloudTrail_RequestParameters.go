...
type AWSAPICallViaCloudTrail_RequestParameters struct {
	...
	//
	// Experimental.
	AlgorithmSpecification *AWSAPICallViaCloudTrail_AlgorithmSpecification `field:"optional" json:"algorithmSpecification" yaml:"algorithmSpecification"`
	...
	//
	// Experimental.
	HyperParameters *AWSAPICallViaCloudTrail_HyperParameters `field:"optional" json:"hyperParameters" yaml:"hyperParameters"`
	...
	//
	// Experimental.
	InputDataConfig *[]*AWSAPICallViaCloudTrail_RequestParametersItem2 `field:"optional" json:"inputDataConfig" yaml:"inputDataConfig"`
	// modelName property.
	//
	...
	//
	// Experimental.
	OutputDataConfig *AWSAPICallViaCloudTrail_OutputDataConfig `field:"optional" json:"outputDataConfig" yaml:"outputDataConfig"`
	...
	//
	// Experimental.
	PrimaryContainer *AWSAPICallViaCloudTrail_PrimaryContainer `field:"optional" json:"primaryContainer" yaml:"primaryContainer"`
	...
	//
	// Experimental.
	ProductionVariants *[]*AWSAPICallViaCloudTrail_RequestParametersItem `field:"optional" json:"productionVariants" yaml:"productionVariants"`
	...
	//
	// Experimental.
	ResourceConfig *AWSAPICallViaCloudTrail_ResourceConfig `field:"optional" json:"resourceConfig" yaml:"resourceConfig"`
	// roleArn property.
	//
	...
	//
	// Experimental.
	StoppingCondition *AWSAPICallViaCloudTrail_StoppingCondition `field:"optional" json:"stoppingCondition" yaml:"stoppingCondition"`
	// tags property.
	//
	...
	//
	// Experimental.
	TransformInput *AWSAPICallViaCloudTrail_TransformInput `field:"optional" json:"transformInput" yaml:"transformInput"`
	...
	//
	// Experimental.
	TransformOutput *AWSAPICallViaCloudTrail_TransformOutput `field:"optional" json:"transformOutput" yaml:"transformOutput"`
	...
	//
	// Experimental.
	TransformResources *AWSAPICallViaCloudTrail_TransformResources `field:"optional" json:"transformResources" yaml:"transformResources"`
}
