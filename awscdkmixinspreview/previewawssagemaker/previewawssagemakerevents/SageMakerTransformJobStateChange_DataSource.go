...
//
// Experimental.
type SageMakerTransformJobStateChange_DataSource struct {
	...
	//
	// Experimental.
	S3DataSource *SageMakerTransformJobStateChange_S3DataSource `field:"optional" json:"s3DataSource" yaml:"s3DataSource"`
}
