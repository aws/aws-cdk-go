...
//
// Experimental.
type SageMakerTrainingJobStateChange_DataSource struct {
	...
	//
	// Experimental.
	S3DataSource *SageMakerTrainingJobStateChange_S3DataSource `field:"optional" json:"s3DataSource" yaml:"s3DataSource"`
}
