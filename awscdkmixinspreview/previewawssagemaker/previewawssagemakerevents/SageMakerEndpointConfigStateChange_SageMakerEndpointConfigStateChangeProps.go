...
//
// Experimental.
type SageMakerEndpointConfigStateChange_SageMakerEndpointConfigStateChangeProps struct {
	...
	//
	// Experimental.
	ProductionVariants *[]*SageMakerEndpointConfigStateChange_SageMakerEndpointConfigStateChangeItem `field:"optional" json:"productionVariants" yaml:"productionVariants"`
	// Tags property.
	//
	...
	//
	// Experimental.
	Tags *[]*SageMakerEndpointConfigStateChange_Tags `field:"optional" json:"tags" yaml:"tags"`
}
