...
//
// Experimental.
type SageMakerTransformJobStateChange_SageMakerTransformJobStateChangeProps struct {
	...
	//
	// Experimental.
	Tags *[]*SageMakerTransformJobStateChange_Tags `field:"optional" json:"tags" yaml:"tags"`
	...
	//
	// Experimental.
	TransformInput *SageMakerTransformJobStateChange_TransformInput `field:"optional" json:"transformInput" yaml:"transformInput"`
	...
	//
	// Experimental.
	TransformOutput *SageMakerTransformJobStateChange_TransformOutput `field:"optional" json:"transformOutput" yaml:"transformOutput"`
	...
	//
	// Experimental.
	TransformResources *SageMakerTransformJobStateChange_TransformResources `field:"optional" json:"transformResources" yaml:"transformResources"`
