...
//
// Experimental.
type SageMakerTransformJobStateChange_TransformInput struct {
	...
	//
	// Experimental.
	DataSource *SageMakerTransformJobStateChange_DataSource `field:"optional" json:"dataSource" yaml:"dataSource"`
	// SplitType property.
	//
