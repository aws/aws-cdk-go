...
//
// Experimental.
type ModelEvents_AWSAPICallViaCloudTrail_DataSource1 struct {
	...
	//
	// Experimental.
	S3DataSource *ModelEvents_AWSAPICallViaCloudTrail_S3DataSource1 `field:"optional" json:"s3DataSource" yaml:"s3DataSource"`
}
