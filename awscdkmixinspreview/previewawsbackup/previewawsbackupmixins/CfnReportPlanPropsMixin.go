...
func (j *jsiiProxy_CfnReportPlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnReportPlanPropsMixin) ApplyTo(construct constructs.IConstruct) {
