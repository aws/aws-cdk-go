...
func (j *jsiiProxy_CfnRestoreTestingSelectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnRestoreTestingSelectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
