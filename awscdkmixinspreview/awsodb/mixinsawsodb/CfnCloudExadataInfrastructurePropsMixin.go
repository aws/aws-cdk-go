...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awsodb/mixinsawsodb/internal"
...
func (c *jsiiProxy_CfnCloudExadataInfrastructurePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
