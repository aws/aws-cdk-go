...
func (j *jsiiProxy_CfnOrganizationConformancePackPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnOrganizationConformancePackPropsMixin) ApplyTo(construct constructs.IConstruct) {
