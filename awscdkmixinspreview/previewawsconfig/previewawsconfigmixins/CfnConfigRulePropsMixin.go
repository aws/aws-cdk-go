...
func (j *jsiiProxy_CfnConfigRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnConfigRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
