...
func (j *jsiiProxy_CfnDeliveryChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnDeliveryChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
