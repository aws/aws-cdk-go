...
func (j *jsiiProxy_CfnEventInvokeConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnEventInvokeConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
