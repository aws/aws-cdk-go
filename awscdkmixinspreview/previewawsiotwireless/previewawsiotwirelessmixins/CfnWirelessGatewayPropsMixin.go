...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnWirelessGatewayPropsMixin := awscdkmixinspreview.Mixins.NewCfnWirelessGatewayPropsMixin(&CfnWirelessGatewayMixinProps{
...
func (j *jsiiProxy_CfnWirelessGatewayPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnWirelessGatewayPropsMixin(props *CfnWirelessGatewayMixinProps, options *mixins.CfnPropertyMixinOptions) CfnWirelessGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTWireless::WirelessGateway`.
func NewCfnWirelessGatewayPropsMixin_Override(c CfnWirelessGatewayPropsMixin, props *CfnWirelessGatewayMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWirelessGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
