...
func (j *jsiiProxy_CfnTagOptionAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnTagOptionAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
