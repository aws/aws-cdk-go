...
func (j *jsiiProxy_CfnPortfolioPrincipalAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPortfolioPrincipalAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
