...
//
//   cfnAutoshiftObserverNotificationStatusMixinProps := &CfnAutoshiftObserverNotificationStatusMixinProps{
...
//
type CfnAutoshiftObserverNotificationStatusMixinProps struct {
