...
//
//   cfnKeySigningKeyMixinProps := &CfnKeySigningKeyMixinProps{
...
//
type CfnKeySigningKeyMixinProps struct {
	...
	//
	KeyManagementServiceArn *string `field:"optional" json:"keyManagementServiceArn" yaml:"keyManagementServiceArn"`
