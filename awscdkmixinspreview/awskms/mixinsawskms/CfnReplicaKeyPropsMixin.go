...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awskms/mixinsawskms/internal"
...
func (c *jsiiProxy_CfnReplicaKeyPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
