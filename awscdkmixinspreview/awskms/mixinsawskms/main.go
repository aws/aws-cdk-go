...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_kms.mixins.CfnAliasMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_kms.mixins.CfnKeyMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_kms.mixins.CfnReplicaKeyMixinProps",
		reflect.TypeOf((*CfnReplicaKeyMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/mixins-preview.aws_kms.mixins.CfnReplicaKeyPropsMixin",
		reflect.TypeOf((*CfnReplicaKeyPropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "applyTo", GoMethod: "ApplyTo"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "strategy", GoGetter: "Strategy"},
