...
//
type CfnApplicationReferenceDataSourcePropsMixin_S3ReferenceDataSourceProperty struct {
	...
	//
	ReferenceRoleArn *string `field:"optional" json:"referenceRoleArn" yaml:"referenceRoleArn"`
}
