...
func (j *jsiiProxy_CfnEnvironmentProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnEnvironmentProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
