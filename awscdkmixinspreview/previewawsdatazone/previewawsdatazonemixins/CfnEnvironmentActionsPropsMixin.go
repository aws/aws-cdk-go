...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnEnvironmentActionsPropsMixin := awscdkmixinspreview.Mixins.NewCfnEnvironmentActionsPropsMixin(&CfnEnvironmentActionsMixinProps{
...
func (j *jsiiProxy_CfnEnvironmentActionsPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnEnvironmentActionsPropsMixin(props *CfnEnvironmentActionsMixinProps, options *mixins.CfnPropertyMixinOptions) CfnEnvironmentActionsPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::EnvironmentActions`.
func NewCfnEnvironmentActionsPropsMixin_Override(c CfnEnvironmentActionsPropsMixin, props *CfnEnvironmentActionsMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEnvironmentActionsPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
