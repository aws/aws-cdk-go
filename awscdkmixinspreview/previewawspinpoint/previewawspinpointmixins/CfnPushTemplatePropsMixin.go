...
func (j *jsiiProxy_CfnPushTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPushTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
