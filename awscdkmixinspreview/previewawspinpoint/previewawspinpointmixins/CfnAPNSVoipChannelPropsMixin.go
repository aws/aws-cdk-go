...
func (j *jsiiProxy_CfnAPNSVoipChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnAPNSVoipChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
