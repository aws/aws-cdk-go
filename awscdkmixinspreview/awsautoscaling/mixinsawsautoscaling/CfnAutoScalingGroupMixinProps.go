...
//
//   cfnAutoScalingGroupMixinProps := &CfnAutoScalingGroupMixinProps{
...
//
type CfnAutoScalingGroupMixinProps struct {
	...
	//
	Tags *[]*CfnAutoScalingGroupPropsMixin_TagPropertyProperty `field:"optional" json:"tags" yaml:"tags"`
