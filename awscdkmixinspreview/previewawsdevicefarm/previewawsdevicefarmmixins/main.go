...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnDevicePoolMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnDevicePoolPropsMixin.RuleProperty",
		reflect.TypeOf((*CfnDevicePoolPropsMixin_RuleProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnInstanceProfileMixinProps",
		reflect.TypeOf((*CfnInstanceProfileMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnInstanceProfilePropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnNetworkProfileMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnProjectMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnTestGridProjectMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnTestGridProjectPropsMixin.VpcConfigProperty",
		reflect.TypeOf((*CfnTestGridProjectPropsMixin_VpcConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/mixins-preview.aws_devicefarm.mixins.CfnVPCEConfigurationMixinProps",
