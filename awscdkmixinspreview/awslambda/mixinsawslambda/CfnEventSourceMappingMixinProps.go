...
//
//   cfnEventSourceMappingMixinProps := &CfnEventSourceMappingMixinProps{
...
//
type CfnEventSourceMappingMixinProps struct {
	...
	//
	ProvisionedPollerConfig interface{} `field:"optional" json:"provisionedPollerConfig" yaml:"provisionedPollerConfig"`
