...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkmixinspreview/v2/awslambda/mixinsawslambda/internal"
...
func (c *jsiiProxy_CfnEventSourceMappingPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
