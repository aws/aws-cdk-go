...
type AWSAPICallViaCloudTrail_RequestParameters struct {
	...
	//
	// Experimental.
	DeleteFiles *[]*AWSAPICallViaCloudTrail_RequestParametersItem `field:"optional" json:"deleteFiles" yaml:"deleteFiles"`
	...
	//
	// Experimental.
	PutFiles *[]*AWSAPICallViaCloudTrail_RequestParametersItem `field:"optional" json:"putFiles" yaml:"putFiles"`
	// references property.
	//
	...
	//
	// Experimental.
	References *[]*AWSAPICallViaCloudTrail_RequestParametersItem1 `field:"optional" json:"references" yaml:"references"`
	...
	//
	// Experimental.
	Targets *[]*AWSAPICallViaCloudTrail_RequestParametersItem2 `field:"optional" json:"targets" yaml:"targets"`
	...
	//
	// Experimental.
	ThrowIfClosed *[]*string `field:"optional" json:"throwIfClosed" yaml:"throwIfClosed"`
	// title property.
	//
