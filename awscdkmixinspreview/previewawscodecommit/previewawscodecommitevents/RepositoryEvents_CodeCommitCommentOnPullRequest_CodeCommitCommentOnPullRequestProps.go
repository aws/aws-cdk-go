...
//
//   codeCommitCommentOnPullRequestProps := &CodeCommitCommentOnPullRequestProps{
...
//
// Experimental.
type RepositoryEvents_CodeCommitCommentOnPullRequest_CodeCommitCommentOnPullRequestProps struct {
