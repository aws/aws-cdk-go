...
//
type CfnBotVersionPropsMixin_BotVersionLocaleSpecificationProperty struct {
	...
	//
	BotVersionLocaleDetails interface{} `field:"optional" json:"botVersionLocaleDetails" yaml:"botVersionLocaleDetails"`
