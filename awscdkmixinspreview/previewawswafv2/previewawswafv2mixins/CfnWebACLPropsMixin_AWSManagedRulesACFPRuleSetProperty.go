...
//
type CfnWebACLPropsMixin_AWSManagedRulesACFPRuleSetProperty struct {
	...
	//
	CreationPath *string `field:"optional" json:"creationPath" yaml:"creationPath"`
	...
	//
	RegistrationPagePath *string `field:"optional" json:"registrationPagePath" yaml:"registrationPagePath"`
