...
//
//   cfnSignalMapMixinProps := &CfnSignalMapMixinProps{
...
//
type CfnSignalMapMixinProps struct {
	...
	//
	DiscoveryEntryPointArn *string `field:"optional" json:"discoveryEntryPointArn" yaml:"discoveryEntryPointArn"`
