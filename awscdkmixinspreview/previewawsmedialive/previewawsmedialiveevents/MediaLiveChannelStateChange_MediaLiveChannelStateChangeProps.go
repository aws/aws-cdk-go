...
//
//   mediaLiveChannelStateChangeProps := &MediaLiveChannelStateChangeProps{
//   	ChannelArn: []*string{
...
//   		jsii.String("pipelinesRunningCount"),
//   	},
//   	State: []*string{
//   		jsii.String("state"),
//   	},
...
//
// Experimental.
type MediaLiveChannelStateChange_MediaLiveChannelStateChangeProps struct {
	...
	//
	// Experimental.
	PipelinesRunningCount *[]*string `field:"optional" json:"pipelinesRunningCount" yaml:"pipelinesRunningCount"`
	// state property.
	//
