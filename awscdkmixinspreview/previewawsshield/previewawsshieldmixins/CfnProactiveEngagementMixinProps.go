...
//
//   cfnProactiveEngagementMixinProps := &CfnProactiveEngagementMixinProps{
...
//
type CfnProactiveEngagementMixinProps struct {
	...
	//
	EmergencyContactList interface{} `field:"optional" json:"emergencyContactList" yaml:"emergencyContactList"`
	...
	//
	ProactiveEngagementStatus *string `field:"optional" json:"proactiveEngagementStatus" yaml:"proactiveEngagementStatus"`
}
