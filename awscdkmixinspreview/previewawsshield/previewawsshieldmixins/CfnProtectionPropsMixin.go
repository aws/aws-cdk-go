...
func (j *jsiiProxy_CfnProtectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnProtectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
