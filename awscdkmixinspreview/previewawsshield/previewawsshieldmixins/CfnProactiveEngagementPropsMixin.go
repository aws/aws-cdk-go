...
func (j *jsiiProxy_CfnProactiveEngagementPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnProactiveEngagementPropsMixin) ApplyTo(construct constructs.IConstruct) {
