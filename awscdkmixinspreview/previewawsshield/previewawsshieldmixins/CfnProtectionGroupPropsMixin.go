...
func (j *jsiiProxy_CfnProtectionGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnProtectionGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
