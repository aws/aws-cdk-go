...
type CfnProtectionFlowLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnProtectionLogsMixin
}
...
func (c *jsiiProxy_CfnProtectionFlowLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnProtectionLogsMixin {
