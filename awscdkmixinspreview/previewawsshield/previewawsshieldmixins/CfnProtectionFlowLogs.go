...
type CfnProtectionFlowLogs interface {
	...
	ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnProtectionLogsMixin
...
func (c *jsiiProxy_CfnProtectionFlowLogs) ToDestination(destination interfacesawslogs.IDeliveryDestinationRef) CfnProtectionLogsMixin {
