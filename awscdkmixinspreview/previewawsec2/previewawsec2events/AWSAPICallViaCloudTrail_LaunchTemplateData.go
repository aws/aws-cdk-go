...
//
// Experimental.
type AWSAPICallViaCloudTrail_LaunchTemplateData struct {
	// ImageId property.
	//
	...
	//
	// Experimental.
	InstanceMarketOptions *AWSAPICallViaCloudTrail_InstanceMarketOptions1 `field:"optional" json:"instanceMarketOptions" yaml:"instanceMarketOptions"`
	...
	//
	// Experimental.
	NetworkInterface *AWSAPICallViaCloudTrail_NetworkInterface1 `field:"optional" json:"networkInterface" yaml:"networkInterface"`
	// UserData property.
	//
