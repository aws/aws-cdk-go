...
//
// Experimental.
type AWSAPICallViaCloudTrail_CreateFleetRequest struct {
	...
	//
	// Experimental.
	ExistingInstances *AWSAPICallViaCloudTrail_ExistingInstances `field:"optional" json:"existingInstances" yaml:"existingInstances"`
	...
	//
	// Experimental.
	LaunchTemplateConfigs *AWSAPICallViaCloudTrail_LaunchTemplateConfigs `field:"optional" json:"launchTemplateConfigs" yaml:"launchTemplateConfigs"`
	...
	//
	// Experimental.
	OnDemandOptions *AWSAPICallViaCloudTrail_OnDemandOptions `field:"optional" json:"onDemandOptions" yaml:"onDemandOptions"`
	...
	//
	// Experimental.
	SpotOptions *AWSAPICallViaCloudTrail_SpotOptions `field:"optional" json:"spotOptions" yaml:"spotOptions"`
	...
	//
	// Experimental.
	TagSpecification *AWSAPICallViaCloudTrail_TagSpecification `field:"optional" json:"tagSpecification" yaml:"tagSpecification"`
	...
	//
	// Experimental.
	TargetCapacitySpecification *AWSAPICallViaCloudTrail_TargetCapacitySpecification `field:"optional" json:"targetCapacitySpecification" yaml:"targetCapacitySpecification"`
	// Type property.
	//
