...
// Props type for Instance aws.ec2@EC2SpotInstanceInterruptionWarning event.
//
// Example:
...
//
//   eC2SpotInstanceInterruptionWarningProps := &EC2SpotInstanceInterruptionWarningProps{
...
//
// Experimental.
type InstanceEvents_EC2SpotInstanceInterruptionWarning_EC2SpotInstanceInterruptionWarningProps struct {
	...
	//
	// Experimental.
	InstanceAction *[]*string `field:"optional" json:"instanceAction" yaml:"instanceAction"`
