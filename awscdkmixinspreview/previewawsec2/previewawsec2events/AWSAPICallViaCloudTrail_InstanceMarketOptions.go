...
//
// Experimental.
type AWSAPICallViaCloudTrail_InstanceMarketOptions struct {
	// marketType property.
	//
	...
	//
	// Experimental.
	SpotOptions *AWSAPICallViaCloudTrail_SpotOptions1 `field:"optional" json:"spotOptions" yaml:"spotOptions"`
}
