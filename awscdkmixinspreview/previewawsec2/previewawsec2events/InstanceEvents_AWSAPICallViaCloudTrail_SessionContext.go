...
//
// Experimental.
type InstanceEvents_AWSAPICallViaCloudTrail_SessionContext struct {
	// attributes property.
	//
	...
	//
	// Experimental.
	Attributes *InstanceEvents_AWSAPICallViaCloudTrail_Attributes `field:"optional" json:"attributes" yaml:"attributes"`
	...
	//
	// Experimental.
	SessionIssuer *InstanceEvents_AWSAPICallViaCloudTrail_SessionIssuer `field:"optional" json:"sessionIssuer" yaml:"sessionIssuer"`
