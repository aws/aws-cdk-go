...
//
// Experimental.
type AWSAPICallViaCloudTrail_CreateLaunchTemplateRequest struct {
	...
	//
	// Experimental.
	LaunchTemplateData *AWSAPICallViaCloudTrail_LaunchTemplateData `field:"optional" json:"launchTemplateData" yaml:"launchTemplateData"`
