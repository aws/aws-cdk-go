...
//
// Experimental.
type AWSAPICallViaCloudTrail_TagSpecificationSetItem struct {
	...
	//
	// Experimental.
	Tags *[]*AWSAPICallViaCloudTrail_TagSpecificationSetItemItem `field:"optional" json:"tags" yaml:"tags"`
}
