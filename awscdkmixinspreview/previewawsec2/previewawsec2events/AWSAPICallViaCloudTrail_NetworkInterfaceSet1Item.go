...
//
// Experimental.
type AWSAPICallViaCloudTrail_NetworkInterfaceSet1Item struct {
	// attachment property.
	//
	...
	//
	// Experimental.
	Attachment *AWSAPICallViaCloudTrail_Attachment `field:"optional" json:"attachment" yaml:"attachment"`
	// groupSet property.
	//
	...
	//
	// Experimental.
	GroupSet *AWSAPICallViaCloudTrail_GroupSet3 `field:"optional" json:"groupSet" yaml:"groupSet"`
	...
	//
	// Experimental.
	PrivateIpAddressesSet *AWSAPICallViaCloudTrail_PrivateIpAddressesSet2 `field:"optional" json:"privateIpAddressesSet" yaml:"privateIpAddressesSet"`
