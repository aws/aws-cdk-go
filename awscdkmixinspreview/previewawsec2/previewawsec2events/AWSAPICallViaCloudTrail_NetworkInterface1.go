...
//
// Experimental.
type AWSAPICallViaCloudTrail_NetworkInterface1 struct {
	...
	//
	// Experimental.
	SecurityGroupId *AWSAPICallViaCloudTrail_SecurityGroupId `field:"optional" json:"securityGroupId" yaml:"securityGroupId"`
	// SubnetId property.
	//
