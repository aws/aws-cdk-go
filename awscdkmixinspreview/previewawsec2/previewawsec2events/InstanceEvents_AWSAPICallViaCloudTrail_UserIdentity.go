...
//
// Experimental.
type InstanceEvents_AWSAPICallViaCloudTrail_UserIdentity struct {
	...
	//
	// Experimental.
	SessionContext *InstanceEvents_AWSAPICallViaCloudTrail_SessionContext `field:"optional" json:"sessionContext" yaml:"sessionContext"`
	// type property.
	//
