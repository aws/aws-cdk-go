...
type AWSAPICallViaCloudTrail_ResponseElements struct {
	...
	//
	// Experimental.
	CreateFleetResponse *AWSAPICallViaCloudTrail_CreateFleetResponse `field:"optional" json:"createFleetResponse" yaml:"createFleetResponse"`
	...
	//
	// Experimental.
	CreateLaunchTemplateResponse *AWSAPICallViaCloudTrail_DeleteLaunchTemplateResponse `field:"optional" json:"createLaunchTemplateResponse" yaml:"createLaunchTemplateResponse"`
	...
	//
	// Experimental.
	DeleteLaunchTemplateResponse *AWSAPICallViaCloudTrail_DeleteLaunchTemplateResponse `field:"optional" json:"deleteLaunchTemplateResponse" yaml:"deleteLaunchTemplateResponse"`
	// groupId property.
	//
	...
	//
	// Experimental.
	InstancesSet *AWSAPICallViaCloudTrail_InstancesSet `field:"optional" json:"instancesSet" yaml:"instancesSet"`
	...
	//
	// Experimental.
	NetworkInterface *AWSAPICallViaCloudTrail_NetworkInterface `field:"optional" json:"networkInterface" yaml:"networkInterface"`
	// ownerId property.
	//
