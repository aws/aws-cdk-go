...
//
// Experimental.
type AWSAPICallViaCloudTrail_InstanceMarketOptions1 struct {
	// MarketType property.
	//
	...
	//
	// Experimental.
	SpotOptions *AWSAPICallViaCloudTrail_SpotOptions2 `field:"optional" json:"spotOptions" yaml:"spotOptions"`
}
