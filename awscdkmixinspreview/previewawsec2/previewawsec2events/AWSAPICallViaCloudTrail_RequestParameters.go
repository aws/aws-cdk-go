...
type AWSAPICallViaCloudTrail_RequestParameters struct {
	...
	//
	// Experimental.
	CreateFleetRequest *AWSAPICallViaCloudTrail_CreateFleetRequest `field:"optional" json:"createFleetRequest" yaml:"createFleetRequest"`
	...
	//
	// Experimental.
	CreateLaunchTemplateRequest *AWSAPICallViaCloudTrail_CreateLaunchTemplateRequest `field:"optional" json:"createLaunchTemplateRequest" yaml:"createLaunchTemplateRequest"`
	...
	//
	// Experimental.
	DeleteLaunchTemplateRequest *AWSAPICallViaCloudTrail_DeleteLaunchTemplateRequest `field:"optional" json:"deleteLaunchTemplateRequest" yaml:"deleteLaunchTemplateRequest"`
	...
	//
	// Experimental.
	GroupSet *AWSAPICallViaCloudTrail_GroupSet1 `field:"optional" json:"groupSet" yaml:"groupSet"`
	...
	//
	// Experimental.
	InstanceMarketOptions *AWSAPICallViaCloudTrail_InstanceMarketOptions `field:"optional" json:"instanceMarketOptions" yaml:"instanceMarketOptions"`
	...
	//
	// Experimental.
	InstancesSet *AWSAPICallViaCloudTrail_InstancesSet1 `field:"optional" json:"instancesSet" yaml:"instancesSet"`
	...
	//
	// Experimental.
	Monitoring *AWSAPICallViaCloudTrail_Monitoring `field:"optional" json:"monitoring" yaml:"monitoring"`
	...
	//
	// Experimental.
	NetworkInterfaceSet *AWSAPICallViaCloudTrail_NetworkInterfaceSet `field:"optional" json:"networkInterfaceSet" yaml:"networkInterfaceSet"`
	...
	//
	// Experimental.
	TagSpecificationSet *AWSAPICallViaCloudTrail_TagSpecificationSet `field:"optional" json:"tagSpecificationSet" yaml:"tagSpecificationSet"`
	// userData property.
	//
