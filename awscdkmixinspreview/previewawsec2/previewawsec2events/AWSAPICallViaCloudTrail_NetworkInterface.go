...
//
// Experimental.
type AWSAPICallViaCloudTrail_NetworkInterface struct {
	...
	//
	// Experimental.
	PrivateIpAddressesSet *AWSAPICallViaCloudTrail_PrivateIpAddressesSet1 `field:"optional" json:"privateIpAddressesSet" yaml:"privateIpAddressesSet"`
