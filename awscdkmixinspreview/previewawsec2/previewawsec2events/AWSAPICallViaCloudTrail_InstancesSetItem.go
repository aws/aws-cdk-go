...
//
// Experimental.
type AWSAPICallViaCloudTrail_InstancesSetItem struct {
	...
	//
	// Experimental.
	CapacityReservationSpecification *AWSAPICallViaCloudTrail_CapacityReservationSpecification `field:"optional" json:"capacityReservationSpecification" yaml:"capacityReservationSpecification"`
	...
	//
	// Experimental.
	CpuOptions *AWSAPICallViaCloudTrail_CpuOptions `field:"optional" json:"cpuOptions" yaml:"cpuOptions"`
	...
	//
	// Experimental.
	CurrentState *AWSAPICallViaCloudTrail_InstanceState `field:"optional" json:"currentState" yaml:"currentState"`
	...
	//
	// Experimental.
	EnclaveOptions *AWSAPICallViaCloudTrail_EnclaveOptions `field:"optional" json:"enclaveOptions" yaml:"enclaveOptions"`
	// groupSet property.
	//
	...
	//
	// Experimental.
	GroupSet *AWSAPICallViaCloudTrail_GroupSet2 `field:"optional" json:"groupSet" yaml:"groupSet"`
	// hypervisor property.
	//
	...
	//
	// Experimental.
	InstanceState *AWSAPICallViaCloudTrail_InstanceState `field:"optional" json:"instanceState" yaml:"instanceState"`
	...
	//
	// Experimental.
	Monitoring *AWSAPICallViaCloudTrail_Monitoring1 `field:"optional" json:"monitoring" yaml:"monitoring"`
	...
	//
	// Experimental.
	NetworkInterfaceSet *AWSAPICallViaCloudTrail_NetworkInterfaceSet1 `field:"optional" json:"networkInterfaceSet" yaml:"networkInterfaceSet"`
	// placement property.
	//
	...
	//
	// Experimental.
	Placement *AWSAPICallViaCloudTrail_Placement `field:"optional" json:"placement" yaml:"placement"`
	...
	//
	// Experimental.
	PreviousState *AWSAPICallViaCloudTrail_InstanceState `field:"optional" json:"previousState" yaml:"previousState"`
	...
	//
	// Experimental.
	StateReason *AWSAPICallViaCloudTrail_StateReason `field:"optional" json:"stateReason" yaml:"stateReason"`
	// subnetId property.
	//
	...
	//
	// Experimental.
	TagSet *AWSAPICallViaCloudTrail_TagSet `field:"optional" json:"tagSet" yaml:"tagSet"`
