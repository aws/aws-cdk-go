...
func (j *jsiiProxy_CfnTrafficMirrorFilterRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnTrafficMirrorFilterRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
