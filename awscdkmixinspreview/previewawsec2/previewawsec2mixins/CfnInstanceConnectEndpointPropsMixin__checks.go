...
func validateNewCfnInstanceConnectEndpointPropsMixinParameters(props *CfnInstanceConnectEndpointMixinProps, options *mixins.CfnPropertyMixinOptions) error {
	if props == nil {
