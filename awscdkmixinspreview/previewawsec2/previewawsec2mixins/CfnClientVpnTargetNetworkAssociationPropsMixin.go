...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnClientVpnTargetNetworkAssociationPropsMixin := awscdkmixinspreview.Mixins.NewCfnClientVpnTargetNetworkAssociationPropsMixin(&CfnClientVpnTargetNetworkAssociationMixinProps{
...
func (j *jsiiProxy_CfnClientVpnTargetNetworkAssociationPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnClientVpnTargetNetworkAssociationPropsMixin(props *CfnClientVpnTargetNetworkAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) CfnClientVpnTargetNetworkAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::ClientVpnTargetNetworkAssociation`.
func NewCfnClientVpnTargetNetworkAssociationPropsMixin_Override(c CfnClientVpnTargetNetworkAssociationPropsMixin, props *CfnClientVpnTargetNetworkAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnClientVpnTargetNetworkAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
