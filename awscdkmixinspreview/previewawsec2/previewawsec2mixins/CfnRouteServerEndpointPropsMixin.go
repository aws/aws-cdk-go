...
func (j *jsiiProxy_CfnRouteServerEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnRouteServerEndpointPropsMixin) ApplyTo(construct constructs.IConstruct) {
