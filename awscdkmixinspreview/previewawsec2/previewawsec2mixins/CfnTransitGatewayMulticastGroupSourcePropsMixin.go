...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnTransitGatewayMulticastGroupSourcePropsMixin := awscdkmixinspreview.Mixins.NewCfnTransitGatewayMulticastGroupSourcePropsMixin(&CfnTransitGatewayMulticastGroupSourceMixinProps{
...
func (j *jsiiProxy_CfnTransitGatewayMulticastGroupSourcePropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnTransitGatewayMulticastGroupSourcePropsMixin(props *CfnTransitGatewayMulticastGroupSourceMixinProps, options *mixins.CfnPropertyMixinOptions) CfnTransitGatewayMulticastGroupSourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayMulticastGroupSource`.
func NewCfnTransitGatewayMulticastGroupSourcePropsMixin_Override(c CfnTransitGatewayMulticastGroupSourcePropsMixin, props *CfnTransitGatewayMulticastGroupSourceMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupSourcePropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
