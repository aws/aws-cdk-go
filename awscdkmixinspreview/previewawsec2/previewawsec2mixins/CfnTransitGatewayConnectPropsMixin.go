...
func (j *jsiiProxy_CfnTransitGatewayConnectPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnTransitGatewayConnectPropsMixin) ApplyTo(construct constructs.IConstruct) {
