...
//
//   cfnTransitGatewayMulticastGroupMemberMixinProps := &CfnTransitGatewayMulticastGroupMemberMixinProps{
...
//
type CfnTransitGatewayMulticastGroupMemberMixinProps struct {
