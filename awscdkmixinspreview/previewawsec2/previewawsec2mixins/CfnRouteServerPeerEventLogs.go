...
type CfnRouteServerPeerEventLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnRouteServerPeerLogsMixin
}
...
func (c *jsiiProxy_CfnRouteServerPeerEventLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnRouteServerPeerLogsMixin {
