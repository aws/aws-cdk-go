...
func (j *jsiiProxy_CfnVPNGatewayPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnVPNGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) {
