...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnGatewayRouteTableAssociationPropsMixin := awscdkmixinspreview.Mixins.NewCfnGatewayRouteTableAssociationPropsMixin(&CfnGatewayRouteTableAssociationMixinProps{
...
func (j *jsiiProxy_CfnGatewayRouteTableAssociationPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnGatewayRouteTableAssociationPropsMixin(props *CfnGatewayRouteTableAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) CfnGatewayRouteTableAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::GatewayRouteTableAssociation`.
func NewCfnGatewayRouteTableAssociationPropsMixin_Override(c CfnGatewayRouteTableAssociationPropsMixin, props *CfnGatewayRouteTableAssociationMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGatewayRouteTableAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) constructs.IConstruct {
