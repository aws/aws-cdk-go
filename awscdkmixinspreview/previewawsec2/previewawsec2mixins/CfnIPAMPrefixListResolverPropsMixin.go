...
//   import "github.com/aws/aws-cdk-go/awscdkmixinspreview"
//
//   cfnIPAMPrefixListResolverPropsMixin := awscdkmixinspreview.Mixins.NewCfnIPAMPrefixListResolverPropsMixin(&CfnIPAMPrefixListResolverMixinProps{
...
func (j *jsiiProxy_CfnIPAMPrefixListResolverPropsMixin) Strategy() mixins.PropertyMergeStrategy {
...
func NewCfnIPAMPrefixListResolverPropsMixin(props *CfnIPAMPrefixListResolverMixinProps, options *mixins.CfnPropertyMixinOptions) CfnIPAMPrefixListResolverPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::IPAMPrefixListResolver`.
func NewCfnIPAMPrefixListResolverPropsMixin_Override(c CfnIPAMPrefixListResolverPropsMixin, props *CfnIPAMPrefixListResolverMixinProps, options *mixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
