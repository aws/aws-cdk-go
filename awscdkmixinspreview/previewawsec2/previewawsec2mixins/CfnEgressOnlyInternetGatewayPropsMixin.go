...
func (j *jsiiProxy_CfnEgressOnlyInternetGatewayPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnEgressOnlyInternetGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) {
