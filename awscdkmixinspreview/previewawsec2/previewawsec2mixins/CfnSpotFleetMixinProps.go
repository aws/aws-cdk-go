...
//
//   cfnSpotFleetMixinProps := &CfnSpotFleetMixinProps{
...
//
type CfnSpotFleetMixinProps struct {
	...
	//
	SpotFleetRequestConfigData interface{} `field:"optional" json:"spotFleetRequestConfigData" yaml:"spotFleetRequestConfigData"`
