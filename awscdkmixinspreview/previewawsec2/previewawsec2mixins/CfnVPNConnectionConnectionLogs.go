...
type CfnVPNConnectionConnectionLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef) CfnVPNConnectionLogsMixin
}
...
func (c *jsiiProxy_CfnVPNConnectionConnectionLogs) ToS3(bucket interfacesawss3.IBucketRef) CfnVPNConnectionLogsMixin {
