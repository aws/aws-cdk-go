...
func (j *jsiiProxy_CfnStateMachineVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnStateMachineVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
