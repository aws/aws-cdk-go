...
//
type CfnPlanPropsMixin_CustomActionLambdaConfigurationProperty struct {
	...
	//
	Lambdas interface{} `field:"optional" json:"lambdas" yaml:"lambdas"`
	...
	//
	RegionToRun *string `field:"optional" json:"regionToRun" yaml:"regionToRun"`
	...
	//
	RetryIntervalMinutes *float64 `field:"optional" json:"retryIntervalMinutes" yaml:"retryIntervalMinutes"`
