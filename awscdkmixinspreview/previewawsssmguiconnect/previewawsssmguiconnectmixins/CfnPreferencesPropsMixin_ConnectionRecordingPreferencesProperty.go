...
//
type CfnPreferencesPropsMixin_ConnectionRecordingPreferencesProperty struct {
	...
	//
	RecordingDestinations interface{} `field:"optional" json:"recordingDestinations" yaml:"recordingDestinations"`
}
