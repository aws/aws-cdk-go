...
type CfnCacheClusterElasticacheLogs interface {
	...
	ToS3(bucket interfacesawss3.IBucketRef, props previewawslogs.IS3LogsDestinationProps) CfnCacheClusterLogsMixin
}
...
func (c *jsiiProxy_CfnCacheClusterElasticacheLogs) ToS3(bucket interfacesawss3.IBucketRef, props previewawslogs.IS3LogsDestinationProps) CfnCacheClusterLogsMixin {
