...
//
// Experimental.
type RepositoryEvents_AWSAPICallViaCloudTrail_UserIdentity struct {
	...
	//
	// Experimental.
	SessionContext *RepositoryEvents_AWSAPICallViaCloudTrail_SessionContext `field:"optional" json:"sessionContext" yaml:"sessionContext"`
	// type property.
	//
