...
//
// Experimental.
type ECRImageScan_ECRImageScanProps struct {
	...
	//
	// Experimental.
	FindingSeverityCounts *ECRImageScan_FindingSeverityCounts `field:"optional" json:"findingSeverityCounts" yaml:"findingSeverityCounts"`
