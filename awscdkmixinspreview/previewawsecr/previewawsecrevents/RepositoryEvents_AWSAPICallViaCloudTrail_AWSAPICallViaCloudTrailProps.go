...
// Props type for Repository aws.ecr@AWSAPICallViaCloudTrail event.
//
// Example:
...
type RepositoryEvents_AWSAPICallViaCloudTrail_AWSAPICallViaCloudTrailProps struct {
	...
	//
	// Experimental.
	RequestParameters *RepositoryEvents_AWSAPICallViaCloudTrail_RequestParameters `field:"optional" json:"requestParameters" yaml:"requestParameters"`
	// resources property.
	//
	...
	//
	// Experimental.
	Resources *[]*RepositoryEvents_AWSAPICallViaCloudTrail_AwsapiCallViaCloudTrailItem `field:"optional" json:"resources" yaml:"resources"`
	...
	//
	// Experimental.
	UserIdentity *RepositoryEvents_AWSAPICallViaCloudTrail_UserIdentity `field:"optional" json:"userIdentity" yaml:"userIdentity"`
}
