...
func (j *jsiiProxy_CfnPublicRepositoryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnPublicRepositoryPropsMixin) ApplyTo(construct constructs.IConstruct) {
