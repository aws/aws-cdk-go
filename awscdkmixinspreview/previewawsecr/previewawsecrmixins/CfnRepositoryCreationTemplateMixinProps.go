...
//
//   cfnRepositoryCreationTemplateMixinProps := &CfnRepositoryCreationTemplateMixinProps{
//   	AppliedFor: []*string{
...
//
type CfnRepositoryCreationTemplateMixinProps struct {
	...
	//
	AppliedFor *[]*string `field:"optional" json:"appliedFor" yaml:"appliedFor"`
