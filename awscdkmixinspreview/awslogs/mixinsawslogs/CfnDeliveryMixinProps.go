...
//
//   cfnDeliveryMixinProps := &CfnDeliveryMixinProps{
...
//
type CfnDeliveryMixinProps struct {
	...
	//
	DeliveryDestinationArn *string `field:"optional" json:"deliveryDestinationArn" yaml:"deliveryDestinationArn"`
	...
	//
	DeliverySourceName *string `field:"optional" json:"deliverySourceName" yaml:"deliverySourceName"`
