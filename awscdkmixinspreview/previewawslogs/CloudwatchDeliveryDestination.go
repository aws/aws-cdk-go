...
func (j *jsiiProxy_CloudwatchDeliveryDestination) CfnPropertyNames() *map[string]*string {
...
func (c *jsiiProxy_CloudwatchDeliveryDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
...
func (c *jsiiProxy_CloudwatchDeliveryDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (c *jsiiProxy_CloudwatchDeliveryDestination) CfnPropertyName(cdkPropertyName *string) *string {
...
func (c *jsiiProxy_CloudwatchDeliveryDestination) RemoveResourceDependency(target awscdk.CfnResource) {
