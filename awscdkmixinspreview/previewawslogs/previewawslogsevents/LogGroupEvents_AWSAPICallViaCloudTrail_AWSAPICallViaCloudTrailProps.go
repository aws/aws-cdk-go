...
// Props type for LogGroup aws.logs@AWSAPICallViaCloudTrail event.
//
// Example:
...
//
// Experimental.
type LogGroupEvents_AWSAPICallViaCloudTrail_AWSAPICallViaCloudTrailProps struct {
	// apiVersion property.
	//
	...
	//
	// Experimental.
	RequestParameters *LogGroupEvents_AWSAPICallViaCloudTrail_RequestParameters `field:"optional" json:"requestParameters" yaml:"requestParameters"`
	...
	//
	// Experimental.
	UserIdentity *LogGroupEvents_AWSAPICallViaCloudTrail_UserIdentity `field:"optional" json:"userIdentity" yaml:"userIdentity"`
}
