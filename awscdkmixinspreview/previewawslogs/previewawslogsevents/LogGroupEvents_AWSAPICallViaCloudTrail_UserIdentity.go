...
//
// Experimental.
type LogGroupEvents_AWSAPICallViaCloudTrail_UserIdentity struct {
	...
	//
	// Experimental.
	SessionContext *LogGroupEvents_AWSAPICallViaCloudTrail_SessionContext `field:"optional" json:"sessionContext" yaml:"sessionContext"`
	// type property.
	//
