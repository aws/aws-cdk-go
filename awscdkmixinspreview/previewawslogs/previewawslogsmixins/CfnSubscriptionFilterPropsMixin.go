...
func (j *jsiiProxy_CfnSubscriptionFilterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnSubscriptionFilterPropsMixin) ApplyTo(construct constructs.IConstruct) {
