...
func (j *jsiiProxy_CfnAccountPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnAccountPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
