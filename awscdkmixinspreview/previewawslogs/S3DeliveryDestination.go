...
func (s *jsiiProxy_S3DeliveryDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
	if err := s.validateAddResourceDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_S3DeliveryDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_S3DeliveryDestination) RemoveResourceDependency(target awscdk.CfnResource) {
	if err := s.validateRemoveResourceDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
