...
func (f *jsiiProxy_FirehoseDeliveryDestination) AddResourceDependency(target awscdk.CfnResource, reason *string) {
	if err := f.validateAddResourceDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
...
func (f *jsiiProxy_FirehoseDeliveryDestination) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (f *jsiiProxy_FirehoseDeliveryDestination) RemoveResourceDependency(target awscdk.CfnResource) {
	if err := f.validateRemoveResourceDependencyParameters(target); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		f,
