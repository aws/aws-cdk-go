...
func (j *jsiiProxy_CfnAccessPointPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func (c *jsiiProxy_CfnAccessPointPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
