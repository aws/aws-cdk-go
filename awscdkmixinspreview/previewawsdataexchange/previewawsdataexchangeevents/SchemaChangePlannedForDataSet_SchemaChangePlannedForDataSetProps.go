...
//
//   schemaChangePlannedForDataSetProps := &SchemaChangePlannedForDataSetProps{
//   	DataSet: &DataSet{
//   		AssetType: []*string{
...
//
// Experimental.
type SchemaChangePlannedForDataSet_SchemaChangePlannedForDataSetProps struct {
	// DataSet property.
	//
	...
	//
	// Experimental.
	DataSet *SchemaChangePlannedForDataSet_DataSet `field:"optional" json:"dataSet" yaml:"dataSet"`
	...
	//
	// Experimental.
	Notification *SchemaChangePlannedForDataSet_Notification `field:"optional" json:"notification" yaml:"notification"`
	// Product property.
	//
	...
	//
	// Experimental.
	Product *SchemaChangePlannedForDataSet_Product `field:"optional" json:"product" yaml:"product"`
}
