...
//
// Experimental.
type DataSetUpdateDelayed_Scope struct {
	...
	//
	// Experimental.
	LakeFormationTagPolicies *[]*DataSetUpdateDelayed_LakeFormationTagPolicyDetails `field:"optional" json:"lakeFormationTagPolicies" yaml:"lakeFormationTagPolicies"`
	...
	//
	// Experimental.
	RedshiftDataShares *[]*DataSetUpdateDelayed_RedshiftDataShareDetails `field:"optional" json:"redshiftDataShares" yaml:"redshiftDataShares"`
	...
	//
	// Experimental.
	S3DataAccesses *[]*DataSetUpdateDelayed_S3DataAccessDetails `field:"optional" json:"s3DataAccesses" yaml:"s3DataAccesses"`
}
