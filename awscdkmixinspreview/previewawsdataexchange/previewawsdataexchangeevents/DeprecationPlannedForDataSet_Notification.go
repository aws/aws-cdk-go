...
//
// Experimental.
type DeprecationPlannedForDataSet_Notification struct {
	// Comment property.
	//
	...
	//
	// Experimental.
	Details *DeprecationPlannedForDataSet_Details `field:"optional" json:"details" yaml:"details"`
	// Scope property.
	//
	...
	//
	// Experimental.
	Scope *DeprecationPlannedForDataSet_Scope `field:"optional" json:"scope" yaml:"scope"`
	// Type property.
	//
