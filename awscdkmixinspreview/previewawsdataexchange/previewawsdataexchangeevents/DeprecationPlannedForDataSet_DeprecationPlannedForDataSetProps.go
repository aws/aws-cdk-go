...
//
//   deprecationPlannedForDataSetProps := &DeprecationPlannedForDataSetProps{
//   	DataSet: &DataSet{
//   		AssetType: []*string{
...
//
// Experimental.
type DeprecationPlannedForDataSet_DeprecationPlannedForDataSetProps struct {
	// DataSet property.
	//
	...
	//
	// Experimental.
	DataSet *DeprecationPlannedForDataSet_DataSet `field:"optional" json:"dataSet" yaml:"dataSet"`
	...
	//
	// Experimental.
	Notification *DeprecationPlannedForDataSet_Notification `field:"optional" json:"notification" yaml:"notification"`
	// Product property.
	//
	...
	//
	// Experimental.
	Product *DeprecationPlannedForDataSet_Product `field:"optional" json:"product" yaml:"product"`
}
