...
//
// Experimental.
type DataUpdatedInDataSet_Scope struct {
	...
	//
	// Experimental.
	LakeFormationTagPolicies *[]*DataUpdatedInDataSet_LakeFormationTagPolicyDetails `field:"optional" json:"lakeFormationTagPolicies" yaml:"lakeFormationTagPolicies"`
	...
	//
	// Experimental.
	RedshiftDataShares *[]*DataUpdatedInDataSet_RedshiftDataShareDetails `field:"optional" json:"redshiftDataShares" yaml:"redshiftDataShares"`
	...
	//
	// Experimental.
	S3DataAccesses *[]*DataUpdatedInDataSet_S3DataAccessDetails `field:"optional" json:"s3DataAccesses" yaml:"s3DataAccesses"`
}
