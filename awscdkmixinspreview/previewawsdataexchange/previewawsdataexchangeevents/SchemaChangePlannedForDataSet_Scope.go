...
//
// Experimental.
type SchemaChangePlannedForDataSet_Scope struct {
	...
	//
	// Experimental.
	LakeFormationTagPolicies *[]*SchemaChangePlannedForDataSet_LakeFormationTagPolicyDetails `field:"optional" json:"lakeFormationTagPolicies" yaml:"lakeFormationTagPolicies"`
	...
	//
	// Experimental.
	RedshiftDataShares *[]*SchemaChangePlannedForDataSet_RedshiftDataShareDetails `field:"optional" json:"redshiftDataShares" yaml:"redshiftDataShares"`
	...
	//
	// Experimental.
	S3DataAccesses *[]*SchemaChangePlannedForDataSet_S3DataAccessDetails `field:"optional" json:"s3DataAccesses" yaml:"s3DataAccesses"`
}
