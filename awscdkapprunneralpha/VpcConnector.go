...
func (j *jsiiProxy_VpcConnector) Env() *interfaces.ResourceEnvironment {
...
func VpcConnector_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-apprunner-alpha.VpcConnector",
...
func (v *jsiiProxy_VpcConnector) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (v *jsiiProxy_VpcConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
