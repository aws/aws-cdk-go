...
func (j *jsiiProxy_VpcIngressConnection) Env() *interfaces.ResourceEnvironment {
...
func (v *jsiiProxy_VpcIngressConnection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
