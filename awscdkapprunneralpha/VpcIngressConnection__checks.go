...
func (v *jsiiProxy_VpcIngressConnection) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateVpcIngressConnection_FromArnParameters(scope constructs.Construct, id *string, vpcIngressConnectionArn *string) error {
	...
	if vpcIngressConnectionArn == nil {
		return fmt.Errorf("parameter vpcIngressConnectionArn is required, but nil was provided")
	}
