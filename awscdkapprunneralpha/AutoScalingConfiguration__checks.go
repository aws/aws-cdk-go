...
func (a *jsiiProxy_AutoScalingConfiguration) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateAutoScalingConfiguration_FromArnParameters(scope constructs.Construct, id *string, autoScalingConfigurationArn *string) error {
	...
	if autoScalingConfigurationArn == nil {
		return fmt.Errorf("parameter autoScalingConfigurationArn is required, but nil was provided")
	}
