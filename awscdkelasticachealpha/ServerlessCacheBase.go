...
func (s *jsiiProxy_ServerlessCacheBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (s *jsiiProxy_ServerlessCacheBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
