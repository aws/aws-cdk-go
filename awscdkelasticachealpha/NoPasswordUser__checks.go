...
func (n *jsiiProxy_NoPasswordUser) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateNoPasswordUser_FromUserArnParameters(scope constructs.Construct, id *string, userArn *string) error {
	...
	if userArn == nil {
		return fmt.Errorf("parameter userArn is required, but nil was provided")
	}
