...
require (
	...
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosealpha/v2 v2.173.4-alpha.0
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosedestinationsalpha/v2 v2.173.4-alpha.0
	github.com/aws/aws-cdk-go/awscdkscheduleralpha/v2 v2.173.4-alpha.0
