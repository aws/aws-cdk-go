...
require (
	...
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosealpha/v2 v2.171.0-alpha.0
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosedestinationsalpha/v2 v2.171.0-alpha.0
	github.com/aws/aws-cdk-go/awscdkscheduleralpha/v2 v2.171.0-alpha.0
