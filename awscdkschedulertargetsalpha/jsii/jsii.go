...
import (
	...
	awscdkscheduleralpha "github.com/aws/aws-cdk-go/awscdkscheduleralpha/v2/jsii"
	constructs           "github.com/aws/constructs-go/constructs/v10/jsii"
)

//go:embed aws-cdk-aws-scheduler-targets-alpha-2.121.1-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awscdkscheduleralpha.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-cdk/aws-scheduler-targets-alpha", "2.121.1-alpha.0", tarball)
}
