...
import (
	...
	awscdkpipesalpha "github.com/aws/aws-cdk-go/awscdkpipesalpha/v2/jsii"
	constructs       "github.com/aws/constructs-go/constructs/v10/jsii"
)

//go:embed aws-cdk-aws-pipes-enrichments-alpha-2.159.1-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awscdkpipesalpha.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-cdk/aws-pipes-enrichments-alpha", "2.159.1-alpha.0", tarball)
}
