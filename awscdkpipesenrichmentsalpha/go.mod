module github.com/aws/aws-cdk-go/awscdkpipesenrichmentsalpha/v2

go 1.18

require (
	github.com/aws/jsii-runtime-go v1.104.0
	github.com/aws/aws-cdk-go/awscdkpipesalpha/v2 v2.174.0-alpha.0
	github.com/aws/aws-cdk-go/awscdk/v2 v2.174.0
	github.com/aws/constructs-go/constructs/v10 v10.4.2
	github.com/aws/aws-cdk-go/awscdkkinesisfirehosealpha/v2 v2.174.0-alpha.0 // indirect
