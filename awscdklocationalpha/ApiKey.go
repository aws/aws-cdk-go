...
func (j *jsiiProxy_ApiKey) ApiKeyArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyArn",
...
func (j *jsiiProxy_ApiKey) ApiKeyCreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyCreateTime",
...
func (j *jsiiProxy_ApiKey) ApiKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyName",
...
func (j *jsiiProxy_ApiKey) ApiKeyUpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKeyUpdateTime",
...
func ApiKey_FromApiKeyArn(scope constructs.Construct, id *string, apiKeyArn *string) IApiKey {
	...
	if err := validateApiKey_FromApiKeyArnParameters(scope, id, apiKeyArn); err != nil {
		panic(err)
	}
	var returns IApiKey
...
func ApiKey_FromApiKeyName(scope constructs.Construct, id *string, apiKeyName *string) IApiKey {
	...
	if err := validateApiKey_FromApiKeyNameParameters(scope, id, apiKeyName); err != nil {
		panic(err)
	}
	var returns IApiKey
