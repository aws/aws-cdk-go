...
func (t *jsiiProxy_Tracker) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateTracker_FromTrackerArnParameters(scope constructs.Construct, id *string, trackerArn *string) error {
	...
	if trackerArn == nil {
		return fmt.Errorf("parameter trackerArn is required, but nil was provided")
	}
