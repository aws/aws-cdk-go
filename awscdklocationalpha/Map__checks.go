...
func (m *jsiiProxy_Map) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateMap_FromMapArnParameters(scope constructs.Construct, id *string, mapArn *string) error {
	...
	if mapArn == nil {
		return fmt.Errorf("parameter mapArn is required, but nil was provided")
	}
