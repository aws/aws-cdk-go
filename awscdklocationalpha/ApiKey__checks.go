...
func (a *jsiiProxy_ApiKey) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateApiKey_FromApiKeyArnParameters(scope constructs.Construct, id *string, apiKeyArn *string) error {
	...
	if apiKeyArn == nil {
		return fmt.Errorf("parameter apiKeyArn is required, but nil was provided")
	}
