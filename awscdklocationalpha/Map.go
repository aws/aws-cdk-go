...
func (m *jsiiProxy_Map) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_Map) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
