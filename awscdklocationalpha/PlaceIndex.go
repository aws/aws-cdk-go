...
func (j *jsiiProxy_PlaceIndex) Env() *interfaces.ResourceEnvironment {
...
func (p *jsiiProxy_PlaceIndex) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (p *jsiiProxy_PlaceIndex) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
