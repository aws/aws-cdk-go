...
//go:embed aws-cdk-aws-kinesisfirehose-destinations-alpha-2.79.1-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-cdk/aws-kinesisfirehose-destinations-alpha", "2.79.1-alpha.0", tarball)
}
