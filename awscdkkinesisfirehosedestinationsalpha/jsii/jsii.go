...
//go:embed aws-cdk-aws-kinesisfirehose-destinations-alpha-2.0.0-alpha.2.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-cdk/aws-kinesisfirehose-destinations-alpha", "2.0.0-alpha.2", tarball)
}
