...
//go:embed aws-cdk-aws-kinesisfirehose-destinations-alpha-2.137.0-alpha.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-cdk/aws-kinesisfirehose-destinations-alpha", "2.137.0-alpha.0", tarball)
}
