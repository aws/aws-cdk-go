...
func (m *jsiiProxy_Model) validateAddContainerParameters(container *ContainerDefinition) error {
	if container == nil {
...
func (m *jsiiProxy_Model) validateAddToRolePolicyParameters(statement awsiam.PolicyStatement) error {
	if statement == nil {
...
func (m *jsiiProxy_Model) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateModel_FromModelArnParameters(scope constructs.Construct, id *string, modelArn *string) error {
	if scope == nil {
	...
	if modelArn == nil {
		return fmt.Errorf("parameter modelArn is required, but nil was provided")
	}

	return nil
}

func validateModel_FromModelAttributesParameters(scope constructs.Construct, id *string, attrs *ModelAttributes) error {
	if scope == nil {
		return fmt.Errorf("parameter scope is required, but nil was provided")
	}
