...
func (m *jsiiProxy_Model) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (m *jsiiProxy_Model) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
