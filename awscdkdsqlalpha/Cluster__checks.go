...
func (c *jsiiProxy_Cluster) validateGrantParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
...
func (c *jsiiProxy_Cluster) validateGrantConnectParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
		return fmt.Errorf("parameter grantee is required, but nil was provided")
	}
...
func (c *jsiiProxy_Cluster) validateGrantConnectAdminParameters(grantee awsiam.IGrantable) error {
	if grantee == nil {
		return fmt.Errorf("parameter grantee is required, but nil was provided")
	}
