...
//   var app app
//
//   assert := awscdkintegtestsalpha.NewDeployAssert(app)
//   assert.assert(jsii.String("CustomAssertion"), awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
//   	"foo": jsii.String("bar"),
...
//   	"QueueUrl": jsii.String("url"),
//   })
//   message.assert(awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
//   	"Messages": []interface{}{
//   		map[string]*string{
...
type AwsApiCall interface {
	...
	//
	//   invoke := awscdkintegtestsalpha.NewLambdaInvokeFunction(assert, jsii.String("Invoke"), &lambdaInvokeFunctionProps{
	//   	functionName: jsii.String("my-func"),
	//   })
	//   invoke.assert(awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
	...
	//   	},
	//   }
	//   message := awscdkintegtestsalpha.NewAwsApiCall(assert, jsii.String("ReceiveMessage"), &awsApiCallProps{
...
//
//
//   awscdkintegtestsalpha.NewAwsApiCall(assert, jsii.String("MyAssertion"), &awsApiCallProps{
//   	service: jsii.String("SQS"),
//   	api: jsii.String("receiveMessage"),
...
type DeployAssert interface {
	...
	//
	//   deployAssert.assert(jsii.String("invoke"), awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
	//   	"Payload": jsii.String("OK"),
...
func (j *jsiiProxy_DeployAssert) Node() constructs.Node {
	var returns constructs.Node
	_jsii_.Get(
		j,
		"node",
...
func NewDeployAssert(scope constructs.Construct) DeployAssert {
	...
	_jsii_.Create(
		"@aws-cdk/integ-tests-alpha.DeployAssert",
		[]interface{}{scope},
		&j,
	)
...
//   })
//
//   awscdkintegtestsalpha.NewEqualsAssertion(integ.assert, jsii.String("ReceiveMessage"), &equalsAssertionProps{
//   	actual: awscdkintegtestsalpha.ActualResult.fromAwsApiCall(message, jsii.String("Messages.0.Body")),
//   	expected: awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
