...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AssertionsProviderProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "stateMachineArn", GoGetter: "StateMachineArn"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "waiterProvider", GoGetter: "WaiterProvider"},
			_jsii_.MemberMethod{JsiiMethod: "waitForAssertions", GoMethod: "WaitForAssertions"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LambdaFunctionProviderProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "isCompleteProvider", GoGetter: "IsCompleteProvider"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WaiterStateMachineOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
