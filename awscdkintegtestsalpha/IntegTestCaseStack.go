...
// Experimental.
func IntegTestCaseStack_ConsumeListReference(value *[]*string, strength awscdk.ReferenceStrength) *[]*string {
	_init_.Initialize()

	if err := validateIntegTestCaseStack_ConsumeListReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *[]*string
...
// Returns: A token that resolves to the same value but uses the overridden strength.
// Experimental.
func IntegTestCaseStack_ConsumeReference(value *string, strength awscdk.ReferenceStrength) *string {
	_init_.Initialize()

	if err := validateIntegTestCaseStack_ConsumeReferenceParameters(value); err != nil {
		panic(err)
	}
	var returns *string
