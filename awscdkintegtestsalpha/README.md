...
awscdkintegtestsalpha.NewAwsApiCall(assert, jsii.String("GetObject"), &awsApiCallProps{
...
// assert the results
describe.assert(awscdkintegtestsalpha.ExpectedResult.objectLike(map[string]interface{}{
