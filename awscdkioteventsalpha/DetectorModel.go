...
func (j *jsiiProxy_DetectorModel) Env() *interfaces.ResourceEnvironment {
...
func DetectorModel_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-iotevents-alpha.DetectorModel",
...
func (d *jsiiProxy_DetectorModel) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (d *jsiiProxy_DetectorModel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
