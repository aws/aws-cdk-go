...
func (p *jsiiProxy_PythonFunction) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	return nil
}
...
func (p *jsiiProxy_PythonFunction) validateConsiderWarningOnInvokeFunctionPermissionsParameters(scope constructs.Construct, action *string) error {
	return nil
}
...
func (p *jsiiProxy_PythonFunction) validateGrantInvokeParameters(identity awsiam.IGrantable) error {
	return nil
}
...
func (p *jsiiProxy_PythonFunction) validateGrantInvokeLatestVersionParameters(identity awsiam.IGrantable) error {
	return nil
}

func (p *jsiiProxy_PythonFunction) validateGrantInvokeUrlParameters(identity awsiam.IGrantable) error {
	return nil
}

func (p *jsiiProxy_PythonFunction) validateGrantInvokeVersionParameters(identity awsiam.IGrantable, version awslambda.IVersion) error {
	return nil
}
...
func (p *jsiiProxy_PythonFunction) validateWarnInvokeFunctionPermissionsParameters(scope constructs.Construct) error {
	return nil
}
...
func validatePythonFunction_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	return nil
}

func validatePythonFunction_IsResourceParameters(construct constructs.IConstruct) error {
	return nil
}
...
func validateNewPythonFunctionParameters(scope constructs.Construct, id *string, props *PythonFunctionProps) error {
	return nil
}
