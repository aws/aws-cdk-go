...
func PythonLayerVersion_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePythonLayerVersion_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PythonLayerVersion_PROPERTY_INJECTION_ID() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@aws-cdk/aws-lambda-python-alpha.PythonLayerVersion",
...
func (p *jsiiProxy_PythonLayerVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
