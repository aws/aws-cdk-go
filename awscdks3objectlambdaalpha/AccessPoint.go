...
func (j *jsiiProxy_AccessPoint) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_AccessPoint) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
