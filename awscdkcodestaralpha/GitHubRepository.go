...
func (g *jsiiProxy_GitHubRepository) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (g *jsiiProxy_GitHubRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
