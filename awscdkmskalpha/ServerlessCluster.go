...
func (j *jsiiProxy_ServerlessCluster) ClusterName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterName",
...
// Experimental.
func ServerlessCluster_FromClusterArn(scope constructs.Construct, id *string, clusterArn *string) ICluster {
	_init_.Initialize()

	if err := validateServerlessCluster_FromClusterArnParameters(scope, id, clusterArn); err != nil {
		panic(err)
	}
