...
* **[Auto Mode](#eks-auto-mode)** (Default) – The fully managed capacity mode in EKS.
  ...
  ```go
  cluster := eks.NewCluster(this, jsii.String("AutoModeCluster"), &ClusterProps{
  	Version: eks.KubernetesVersion_V1_34(),
  })
  ```
...
cluster.AddAutoScalingGroupCapacity(jsii.String("self-managed-nodes"), &AutoScalingGroupCapacityOptions{
	InstanceType: ec2.InstanceType_Of(ec2.InstanceClass_T3, ec2.InstanceSize_MEDIUM),
	MinCapacity: jsii.Number(1),
...
cluster.AddAutoScalingGroupCapacity(jsii.String("custom-subnet-nodes"), &AutoScalingGroupCapacityOptions{
