...
func (a *jsiiProxy_AgentAliasBase) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AgentAliasBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
