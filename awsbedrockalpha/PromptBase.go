...
// The jsii proxy struct for PromptBase
type jsiiProxy_PromptBase struct {
	internal.Type__awscdkResource
	jsiiProxy_IPrompt
}

func (j *jsiiProxy_PromptBase) Env() *interfaces.ResourceEnvironment {
...
func (j *jsiiProxy_PromptBase) KmsKey() awskms.IKey {
...
func (j *jsiiProxy_PromptBase) Node() constructs.Node {
...
func (j *jsiiProxy_PromptBase) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_PromptBase) PromptArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"promptArn",
...
func (j *jsiiProxy_PromptBase) PromptId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"promptId",
...
func (j *jsiiProxy_PromptBase) PromptVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"promptVersion",
...
func (j *jsiiProxy_PromptBase) Stack() awscdk.Stack {
...
func PromptBase_IsConstruct(x interface{}) *bool {
	...
	if err := validatePromptBase_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PromptBase_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePromptBase_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func PromptBase_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validatePromptBase_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PromptBase) GeneratePhysicalName() *string {
	var returns *string
...
func (p *jsiiProxy_PromptBase) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (p *jsiiProxy_PromptBase) GetResourceNameAttribute(nameAttr *string) *string {
...
func (p *jsiiProxy_PromptBase) GrantGet(grantee awsiam.IGrantable) awsiam.Grant {
...
func (p *jsiiProxy_PromptBase) ToString() *string {
	var returns *string
...
func (p *jsiiProxy_PromptBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
