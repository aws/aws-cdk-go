...
func (a *jsiiProxy_ApplicationInferenceProfile) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_ApplicationInferenceProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
