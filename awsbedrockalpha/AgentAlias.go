...
func (j *jsiiProxy_AgentAlias) Env() *interfaces.ResourceEnvironment {
...
func (a *jsiiProxy_AgentAlias) ApplyCrossStackReferenceStrength(strength awscdk.ReferenceStrength) {
...
func (a *jsiiProxy_AgentAlias) GrantGet(grantee awsiam.IGrantable) awsiam.Grant {
...
func (a *jsiiProxy_AgentAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
