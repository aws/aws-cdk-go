...
func (a *jsiiProxy_ApplicationInferenceProfile) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validateApplicationInferenceProfile_FromCfnApplicationInferenceProfileParameters(cfnApplicationInferenceProfile awsbedrock.CfnApplicationInferenceProfile) error {
	if cfnApplicationInferenceProfile == nil {
		return fmt.Errorf("parameter cfnApplicationInferenceProfile is required, but nil was provided")
	}
