...
func validateComputeEnvironment_FromComputeEnvironmentArnParameters(scope constructs.Construct, id *string, computeEnvironmentArn *string) error {
	...
	if computeEnvironmentArn == nil {
		return fmt.Errorf("parameter computeEnvironmentArn is required, but nil was provided")
	}
...
func validateComputeEnvironment_IsOwnedResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
...
func validateComputeEnvironment_IsResourceParameters(construct constructs.IConstruct) error {
	if construct == nil {
		return fmt.Errorf("parameter construct is required, but nil was provided")
	}
