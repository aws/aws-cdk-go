...
func (l *jsiiProxy_LinuxParameters) RenderLinuxParameters() *awsbatch.CfnJobDefinition_LinuxParametersProperty {
	var returns *awsbatch.CfnJobDefinition_LinuxParametersProperty
