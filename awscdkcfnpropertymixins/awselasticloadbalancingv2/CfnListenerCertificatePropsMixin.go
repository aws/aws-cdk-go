...
//
//   cfnListenerCertificatePropsMixin := awscdkcfnpropertymixins.Aws_elasticloadbalancingv2.NewCfnListenerCertificatePropsMixin(&CfnListenerCertificateMixinProps{
...
func (j *jsiiProxy_CfnListenerCertificatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnListenerCertificatePropsMixin(props *CfnListenerCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnListenerCertificatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElasticLoadBalancingV2::ListenerCertificate`.
func NewCfnListenerCertificatePropsMixin_Override(c CfnListenerCertificatePropsMixin, props *CfnListenerCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
