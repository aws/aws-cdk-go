...
//
//   cfnListenerRulePropsMixin := awscdkcfnpropertymixins.Aws_elasticloadbalancingv2.NewCfnListenerRulePropsMixin(&CfnListenerRuleMixinProps{
//   	Actions: []interface{}{
//   		&ActionProperty{
...
func NewCfnListenerRulePropsMixin(props *CfnListenerRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnListenerRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElasticLoadBalancingV2::ListenerRule`.
func NewCfnListenerRulePropsMixin_Override(c CfnListenerRulePropsMixin, props *CfnListenerRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
