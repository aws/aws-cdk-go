...
//
//   cfnTargetGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticloadbalancingv2.NewCfnTargetGroupPropsMixin(&CfnTargetGroupMixinProps{
...
func (j *jsiiProxy_CfnTargetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTargetGroupPropsMixin(props *CfnTargetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTargetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElasticLoadBalancingV2::TargetGroup`.
func NewCfnTargetGroupPropsMixin_Override(c CfnTargetGroupPropsMixin, props *CfnTargetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
