...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awspipes/internal"
...
//
//   cfnPipePropsMixin := awscdkcfnpropertymixins.Aws_pipes.NewCfnPipePropsMixin(&CfnPipeMixinProps{
...
func NewCfnPipePropsMixin(props *CfnPipeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPipePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Pipes::Pipe`.
func NewCfnPipePropsMixin_Override(c CfnPipePropsMixin, props *CfnPipeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
