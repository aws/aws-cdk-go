...
//
type CfnTLSInspectionConfigurationPropsMixin_AddressProperty struct {
	...
	//
	AddressDefinition *string `field:"optional" json:"addressDefinition" yaml:"addressDefinition"`
}
