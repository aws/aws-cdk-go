...
//
//   cfnVpcEndpointAssociationPropsMixin := awscdkcfnpropertymixins.Aws_networkfirewall.NewCfnVpcEndpointAssociationPropsMixin(&CfnVpcEndpointAssociationMixinProps{
...
func NewCfnVpcEndpointAssociationPropsMixin(props *CfnVpcEndpointAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcEndpointAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkFirewall::VpcEndpointAssociation`.
func NewCfnVpcEndpointAssociationPropsMixin_Override(c CfnVpcEndpointAssociationPropsMixin, props *CfnVpcEndpointAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
