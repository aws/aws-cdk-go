...
//
//   cfnFirewallPropsMixin := awscdkcfnpropertymixins.Aws_networkfirewall.NewCfnFirewallPropsMixin(&CfnFirewallMixinProps{
...
func (j *jsiiProxy_CfnFirewallPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFirewallPropsMixin(props *CfnFirewallMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFirewallPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkFirewall::Firewall`.
func NewCfnFirewallPropsMixin_Override(c CfnFirewallPropsMixin, props *CfnFirewallMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
