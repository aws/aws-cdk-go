...
//
//   cfnFirewallPolicyPropsMixin := awscdkcfnpropertymixins.Aws_networkfirewall.NewCfnFirewallPolicyPropsMixin(&CfnFirewallPolicyMixinProps{
...
func (j *jsiiProxy_CfnFirewallPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFirewallPolicyPropsMixin(props *CfnFirewallPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFirewallPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkFirewall::FirewallPolicy`.
func NewCfnFirewallPolicyPropsMixin_Override(c CfnFirewallPolicyPropsMixin, props *CfnFirewallPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFirewallPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
