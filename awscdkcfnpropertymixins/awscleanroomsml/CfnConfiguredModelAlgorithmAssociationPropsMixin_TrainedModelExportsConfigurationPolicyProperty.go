...
//
type CfnConfiguredModelAlgorithmAssociationPropsMixin_TrainedModelExportsConfigurationPolicyProperty struct {
	...
	//
	MaxSize interface{} `field:"optional" json:"maxSize" yaml:"maxSize"`
}
