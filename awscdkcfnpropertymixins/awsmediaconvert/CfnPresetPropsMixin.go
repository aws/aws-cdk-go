...
//   var tags interface{}
//
//   cfnPresetPropsMixin := awscdkcfnpropertymixins.Aws_mediaconvert.NewCfnPresetPropsMixin(&CfnPresetMixinProps{
...
func (j *jsiiProxy_CfnPresetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPresetPropsMixin(props *CfnPresetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPresetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConvert::Preset`.
func NewCfnPresetPropsMixin_Override(c CfnPresetPropsMixin, props *CfnPresetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
