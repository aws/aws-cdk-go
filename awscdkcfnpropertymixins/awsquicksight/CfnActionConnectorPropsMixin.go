...
//
//   cfnActionConnectorPropsMixin := awscdkcfnpropertymixins.Aws_quicksight.NewCfnActionConnectorPropsMixin(&CfnActionConnectorMixinProps{
...
func (j *jsiiProxy_CfnActionConnectorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnActionConnectorPropsMixin(props *CfnActionConnectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnActionConnectorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QuickSight::ActionConnector`.
func NewCfnActionConnectorPropsMixin_Override(c CfnActionConnectorPropsMixin, props *CfnActionConnectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnActionConnectorPropsMixin) ApplyTo(construct constructs.IConstruct) {
