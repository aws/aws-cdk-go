...
//
type CfnTopicPropsMixin_TopicCalculatedFieldProperty struct {
	...
	//
	CalculatedFieldName *string `field:"optional" json:"calculatedFieldName" yaml:"calculatedFieldName"`
