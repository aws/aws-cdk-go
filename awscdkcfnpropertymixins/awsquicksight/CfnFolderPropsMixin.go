...
//
//   cfnFolderPropsMixin := awscdkcfnpropertymixins.Aws_quicksight.NewCfnFolderPropsMixin(&CfnFolderMixinProps{
...
func NewCfnFolderPropsMixin(props *CfnFolderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFolderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QuickSight::Folder`.
func NewCfnFolderPropsMixin_Override(c CfnFolderPropsMixin, props *CfnFolderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
