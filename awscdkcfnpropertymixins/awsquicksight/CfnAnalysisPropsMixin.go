...
func NewCfnAnalysisPropsMixin(props *CfnAnalysisMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAnalysisPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QuickSight::Analysis`.
func NewCfnAnalysisPropsMixin_Override(c CfnAnalysisPropsMixin, props *CfnAnalysisMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
