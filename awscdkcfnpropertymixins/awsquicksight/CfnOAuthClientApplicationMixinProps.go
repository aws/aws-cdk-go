...
// Properties for CfnOAuthClientApplicationPropsMixin.
//
// Example:
...
//
//   cfnOAuthClientApplicationMixinProps := &CfnOAuthClientApplicationMixinProps{
...
//
type CfnOAuthClientApplicationMixinProps struct {
	...
	//
	OAuthClientApplicationId *string `field:"optional" json:"oAuthClientApplicationId" yaml:"oAuthClientApplicationId"`
	...
	//
	OAuthClientAuthenticationType *string `field:"optional" json:"oAuthClientAuthenticationType" yaml:"oAuthClientAuthenticationType"`
	...
	//
	OAuthTokenEndpointUrl *string `field:"optional" json:"oAuthTokenEndpointUrl" yaml:"oAuthTokenEndpointUrl"`
