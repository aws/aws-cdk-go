...
//
//   cfnTopicPropsMixin := awscdkcfnpropertymixins.Aws_quicksight.NewCfnTopicPropsMixin(&CfnTopicMixinProps{
...
func NewCfnTopicPropsMixin(props *CfnTopicMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTopicPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QuickSight::Topic`.
func NewCfnTopicPropsMixin_Override(c CfnTopicPropsMixin, props *CfnTopicMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
