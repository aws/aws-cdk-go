...
//
//   cfnSpacePropsMixin := awscdkcfnpropertymixins.Aws_quicksight.NewCfnSpacePropsMixin(&CfnSpaceMixinProps{
...
// Create a mixin to apply properties to `AWS::QuickSight::Space`.
