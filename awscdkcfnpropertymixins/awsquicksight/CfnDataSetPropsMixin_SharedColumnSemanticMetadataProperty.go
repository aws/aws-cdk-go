...
//
type CfnDataSetPropsMixin_SharedColumnSemanticMetadataProperty struct {
	...
	//
	ColumnProperties interface{} `field:"optional" json:"columnProperties" yaml:"columnProperties"`
}
