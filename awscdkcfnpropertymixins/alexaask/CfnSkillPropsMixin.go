...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/alexaask/internal"
...
//
//   cfnSkillPropsMixin := awscdkcfnpropertymixins.Alexa_ask.NewCfnSkillPropsMixin(&CfnSkillMixinProps{
...
func (j *jsiiProxy_CfnSkillPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSkillPropsMixin(props *CfnSkillMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSkillPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.alexa_ask.CfnSkillPropsMixin",
...
// Create a mixin to apply properties to `Alexa::ASK::Skill`.
func NewCfnSkillPropsMixin_Override(c CfnSkillPropsMixin, props *CfnSkillMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSkillPropsMixin) ApplyTo(construct constructs.IConstruct) {
