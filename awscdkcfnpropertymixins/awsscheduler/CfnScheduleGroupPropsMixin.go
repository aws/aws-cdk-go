...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsscheduler/internal"
...
//
//   cfnScheduleGroupPropsMixin := awscdkcfnpropertymixins.Aws_scheduler.NewCfnScheduleGroupPropsMixin(&CfnScheduleGroupMixinProps{
...
func NewCfnScheduleGroupPropsMixin(props *CfnScheduleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScheduleGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Scheduler::ScheduleGroup`.
func NewCfnScheduleGroupPropsMixin_Override(c CfnScheduleGroupPropsMixin, props *CfnScheduleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
