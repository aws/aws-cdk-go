...
//
//   cfnConfigurationTemplatePropsMixin := awscdkcfnpropertymixins.Aws_elasticbeanstalk.NewCfnConfigurationTemplatePropsMixin(&CfnConfigurationTemplateMixinProps{
...
func NewCfnConfigurationTemplatePropsMixin(props *CfnConfigurationTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElasticBeanstalk::ConfigurationTemplate`.
func NewCfnConfigurationTemplatePropsMixin_Override(c CfnConfigurationTemplatePropsMixin, props *CfnConfigurationTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
