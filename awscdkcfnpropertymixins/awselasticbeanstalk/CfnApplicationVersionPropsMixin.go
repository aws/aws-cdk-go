...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awselasticbeanstalk/internal"
...
//
//   cfnApplicationVersionPropsMixin := awscdkcfnpropertymixins.Aws_elasticbeanstalk.NewCfnApplicationVersionPropsMixin(&CfnApplicationVersionMixinProps{
...
func (j *jsiiProxy_CfnApplicationVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnApplicationVersionPropsMixin(props *CfnApplicationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElasticBeanstalk::ApplicationVersion`.
func NewCfnApplicationVersionPropsMixin_Override(c CfnApplicationVersionPropsMixin, props *CfnApplicationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApplicationVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
