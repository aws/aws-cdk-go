...
//
//   cfnTemplatePropsMixin := awscdkcfnpropertymixins.Aws_pcaconnectorad.NewCfnTemplatePropsMixin(&CfnTemplateMixinProps{
...
func NewCfnTemplatePropsMixin(props *CfnTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTemplatePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pcaconnectorad.CfnTemplatePropsMixin",
