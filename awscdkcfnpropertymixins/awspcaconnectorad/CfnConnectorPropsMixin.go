...
//
//   cfnConnectorPropsMixin := awscdkcfnpropertymixins.Aws_pcaconnectorad.NewCfnConnectorPropsMixin(&CfnConnectorMixinProps{
...
func NewCfnConnectorPropsMixin(props *CfnConnectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectorPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pcaconnectorad.CfnConnectorPropsMixin",
