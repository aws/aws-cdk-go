...
//
//   cfnACLPropsMixin := awscdkcfnpropertymixins.Aws_memorydb.NewCfnACLPropsMixin(&CfnACLMixinProps{
...
func (j *jsiiProxy_CfnACLPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnACLPropsMixin(props *CfnACLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnACLPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MemoryDB::ACL`.
func NewCfnACLPropsMixin_Override(c CfnACLPropsMixin, props *CfnACLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnACLPropsMixin) ApplyTo(construct constructs.IConstruct) {
