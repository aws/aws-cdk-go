...
//
//   cfnMultiRegionClusterPropsMixin := awscdkcfnpropertymixins.Aws_memorydb.NewCfnMultiRegionClusterPropsMixin(&CfnMultiRegionClusterMixinProps{
...
func NewCfnMultiRegionClusterPropsMixin(props *CfnMultiRegionClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMultiRegionClusterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MemoryDB::MultiRegionCluster`.
func NewCfnMultiRegionClusterPropsMixin_Override(c CfnMultiRegionClusterPropsMixin, props *CfnMultiRegionClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
