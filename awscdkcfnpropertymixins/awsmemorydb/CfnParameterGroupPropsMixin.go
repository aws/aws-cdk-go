...
//
//   cfnParameterGroupPropsMixin := awscdkcfnpropertymixins.Aws_memorydb.NewCfnParameterGroupPropsMixin(&CfnParameterGroupMixinProps{
...
func (j *jsiiProxy_CfnParameterGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnParameterGroupPropsMixin(props *CfnParameterGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnParameterGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MemoryDB::ParameterGroup`.
func NewCfnParameterGroupPropsMixin_Override(c CfnParameterGroupPropsMixin, props *CfnParameterGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
