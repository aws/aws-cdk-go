...
//
//   cfnEventTypePropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnEventTypePropsMixin(&CfnEventTypeMixinProps{
...
func NewCfnEventTypePropsMixin(props *CfnEventTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::EventType`.
func NewCfnEventTypePropsMixin_Override(c CfnEventTypePropsMixin, props *CfnEventTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
