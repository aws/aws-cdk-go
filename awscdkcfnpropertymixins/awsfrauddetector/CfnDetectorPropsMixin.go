...
//
//   cfnDetectorPropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnDetectorPropsMixin(&CfnDetectorMixinProps{
...
func (j *jsiiProxy_CfnDetectorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDetectorPropsMixin(props *CfnDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDetectorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::Detector`.
func NewCfnDetectorPropsMixin_Override(c CfnDetectorPropsMixin, props *CfnDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDetectorPropsMixin) ApplyTo(construct constructs.IConstruct) {
