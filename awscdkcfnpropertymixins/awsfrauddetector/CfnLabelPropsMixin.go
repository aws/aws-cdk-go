...
//
//   cfnLabelPropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnLabelPropsMixin(&CfnLabelMixinProps{
...
func (j *jsiiProxy_CfnLabelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLabelPropsMixin(props *CfnLabelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLabelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::Label`.
func NewCfnLabelPropsMixin_Override(c CfnLabelPropsMixin, props *CfnLabelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
