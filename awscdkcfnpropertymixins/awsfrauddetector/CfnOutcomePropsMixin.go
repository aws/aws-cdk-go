...
//
//   cfnOutcomePropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnOutcomePropsMixin(&CfnOutcomeMixinProps{
...
func NewCfnOutcomePropsMixin(props *CfnOutcomeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOutcomePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::Outcome`.
func NewCfnOutcomePropsMixin_Override(c CfnOutcomePropsMixin, props *CfnOutcomeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
