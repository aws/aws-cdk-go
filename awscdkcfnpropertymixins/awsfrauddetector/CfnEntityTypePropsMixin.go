...
//
//   cfnEntityTypePropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnEntityTypePropsMixin(&CfnEntityTypeMixinProps{
...
func (j *jsiiProxy_CfnEntityTypePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEntityTypePropsMixin(props *CfnEntityTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEntityTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::EntityType`.
func NewCfnEntityTypePropsMixin_Override(c CfnEntityTypePropsMixin, props *CfnEntityTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEntityTypePropsMixin) ApplyTo(construct constructs.IConstruct) {
