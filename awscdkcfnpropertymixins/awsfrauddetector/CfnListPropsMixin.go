...
//
//   cfnListPropsMixin := awscdkcfnpropertymixins.Aws_frauddetector.NewCfnListPropsMixin(&CfnListMixinProps{
...
func (j *jsiiProxy_CfnListPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnListPropsMixin(props *CfnListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnListPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FraudDetector::List`.
func NewCfnListPropsMixin_Override(c CfnListPropsMixin, props *CfnListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnListPropsMixin) ApplyTo(construct constructs.IConstruct) {
