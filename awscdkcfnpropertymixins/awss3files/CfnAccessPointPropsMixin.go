...
//
//   cfnAccessPointPropsMixin := awscdkcfnpropertymixins.Aws_s3files.NewCfnAccessPointPropsMixin(&CfnAccessPointMixinProps{
...
func NewCfnAccessPointPropsMixin(props *CfnAccessPointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessPointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Files::AccessPoint`.
func NewCfnAccessPointPropsMixin_Override(c CfnAccessPointPropsMixin, props *CfnAccessPointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAccessPointPropsMixin) ApplyTo(construct constructs.IConstruct) {
