...
//
//   cfnMountTargetPropsMixin := awscdkcfnpropertymixins.Aws_s3files.NewCfnMountTargetPropsMixin(&CfnMountTargetMixinProps{
...
// Create a mixin to apply properties to `AWS::S3Files::MountTarget`.
