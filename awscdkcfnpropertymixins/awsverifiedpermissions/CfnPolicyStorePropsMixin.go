...
//
//   cfnPolicyStorePropsMixin := awscdkcfnpropertymixins.Aws_verifiedpermissions.NewCfnPolicyStorePropsMixin(&CfnPolicyStoreMixinProps{
...
func (j *jsiiProxy_CfnPolicyStorePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPolicyStorePropsMixin(props *CfnPolicyStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPolicyStorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::VerifiedPermissions::PolicyStore`.
func NewCfnPolicyStorePropsMixin_Override(c CfnPolicyStorePropsMixin, props *CfnPolicyStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
