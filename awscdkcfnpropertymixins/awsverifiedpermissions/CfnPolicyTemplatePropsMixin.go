...
func (j *jsiiProxy_CfnPolicyTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPolicyTemplatePropsMixin(props *CfnPolicyTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPolicyTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::VerifiedPermissions::PolicyTemplate`.
func NewCfnPolicyTemplatePropsMixin_Override(c CfnPolicyTemplatePropsMixin, props *CfnPolicyTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPolicyTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
