...
//
//   cfnSigningProfilePropsMixin := awscdkcfnpropertymixins.Aws_signer.NewCfnSigningProfilePropsMixin(&CfnSigningProfileMixinProps{
...
func NewCfnSigningProfilePropsMixin(props *CfnSigningProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSigningProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Signer::SigningProfile`.
func NewCfnSigningProfilePropsMixin_Override(c CfnSigningProfilePropsMixin, props *CfnSigningProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
