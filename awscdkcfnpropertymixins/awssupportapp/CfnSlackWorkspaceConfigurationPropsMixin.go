...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssupportapp/internal"
...
//
//   cfnSlackWorkspaceConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_supportapp.NewCfnSlackWorkspaceConfigurationPropsMixin(&CfnSlackWorkspaceConfigurationMixinProps{
...
func (j *jsiiProxy_CfnSlackWorkspaceConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSlackWorkspaceConfigurationPropsMixin(props *CfnSlackWorkspaceConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSlackWorkspaceConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_supportapp.CfnSlackWorkspaceConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::SupportApp::SlackWorkspaceConfiguration`.
func NewCfnSlackWorkspaceConfigurationPropsMixin_Override(c CfnSlackWorkspaceConfigurationPropsMixin, props *CfnSlackWorkspaceConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSlackWorkspaceConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
