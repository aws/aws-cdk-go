...
//
//   cfnSlackChannelConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_supportapp.NewCfnSlackChannelConfigurationPropsMixin(&CfnSlackChannelConfigurationMixinProps{
...
func (j *jsiiProxy_CfnSlackChannelConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSlackChannelConfigurationPropsMixin(props *CfnSlackChannelConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSlackChannelConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_supportapp.CfnSlackChannelConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::SupportApp::SlackChannelConfiguration`.
func NewCfnSlackChannelConfigurationPropsMixin_Override(c CfnSlackChannelConfigurationPropsMixin, props *CfnSlackChannelConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
