...
//
//   cfnAccountAliasPropsMixin := awscdkcfnpropertymixins.Aws_supportapp.NewCfnAccountAliasPropsMixin(&CfnAccountAliasMixinProps{
...
func NewCfnAccountAliasPropsMixin(props *CfnAccountAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccountAliasPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_supportapp.CfnAccountAliasPropsMixin",
...
// Create a mixin to apply properties to `AWS::SupportApp::AccountAlias`.
func NewCfnAccountAliasPropsMixin_Override(c CfnAccountAliasPropsMixin, props *CfnAccountAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
