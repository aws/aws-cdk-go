...
//
//   cfnMountTargetPropsMixin := awscdkcfnpropertymixins.Aws_efs.NewCfnMountTargetPropsMixin(&CfnMountTargetMixinProps{
...
func NewCfnMountTargetPropsMixin(props *CfnMountTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMountTargetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EFS::MountTarget`.
func NewCfnMountTargetPropsMixin_Override(c CfnMountTargetPropsMixin, props *CfnMountTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMountTargetPropsMixin) ApplyTo(construct constructs.IConstruct) {
