...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awspaymentcryptography/internal"
...
//
//   cfnAliasPropsMixin := awscdkcfnpropertymixins.Aws_paymentcryptography.NewCfnAliasPropsMixin(&CfnAliasMixinProps{
...
func (j *jsiiProxy_CfnAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAliasPropsMixin(props *CfnAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::PaymentCryptography::Alias`.
func NewCfnAliasPropsMixin_Override(c CfnAliasPropsMixin, props *CfnAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAliasPropsMixin) ApplyTo(construct constructs.IConstruct) {
