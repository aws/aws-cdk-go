...
//
//   cfnQueueInlinePolicyPropsMixin := awscdkcfnpropertymixins.Aws_sqs.NewCfnQueueInlinePolicyPropsMixin(&CfnQueueInlinePolicyMixinProps{
...
func (j *jsiiProxy_CfnQueueInlinePolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnQueueInlinePolicyPropsMixin(props *CfnQueueInlinePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnQueueInlinePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SQS::QueueInlinePolicy`.
func NewCfnQueueInlinePolicyPropsMixin_Override(c CfnQueueInlinePolicyPropsMixin, props *CfnQueueInlinePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
