...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssqs/internal"
...
//
//   cfnQueuePolicyPropsMixin := awscdkcfnpropertymixins.Aws_sqs.NewCfnQueuePolicyPropsMixin(&CfnQueuePolicyMixinProps{
...
func (j *jsiiProxy_CfnQueuePolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnQueuePolicyPropsMixin(props *CfnQueuePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnQueuePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SQS::QueuePolicy`.
func NewCfnQueuePolicyPropsMixin_Override(c CfnQueuePolicyPropsMixin, props *CfnQueuePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnQueuePolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
