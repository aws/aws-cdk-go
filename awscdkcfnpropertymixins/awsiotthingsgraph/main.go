...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_iotthingsgraph.CfnFlowTemplateMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_iotthingsgraph.CfnFlowTemplatePropsMixin.DefinitionDocumentProperty",
