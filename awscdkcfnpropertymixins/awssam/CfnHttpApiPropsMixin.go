...
//
//   cfnHttpApiPropsMixin := awscdkcfnpropertymixins.Aws_sam.NewCfnHttpApiPropsMixin(&CfnHttpApiMixinProps{
...
func NewCfnHttpApiPropsMixin(props *CfnHttpApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHttpApiPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Serverless::HttpApi`.
func NewCfnHttpApiPropsMixin_Override(c CfnHttpApiPropsMixin, props *CfnHttpApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHttpApiPropsMixin) ApplyTo(construct constructs.IConstruct) {
