...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssam/internal"
...
//
//   cfnSimpleTablePropsMixin := awscdkcfnpropertymixins.Aws_sam.NewCfnSimpleTablePropsMixin(&CfnSimpleTableMixinProps{
...
func (j *jsiiProxy_CfnSimpleTablePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSimpleTablePropsMixin(props *CfnSimpleTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSimpleTablePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Serverless::SimpleTable`.
func NewCfnSimpleTablePropsMixin_Override(c CfnSimpleTablePropsMixin, props *CfnSimpleTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
