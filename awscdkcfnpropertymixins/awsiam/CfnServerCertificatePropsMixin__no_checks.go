...
func validateNewCfnServerCertificatePropsMixinParameters(props *CfnServerCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
