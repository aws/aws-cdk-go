...
//
//   cfnSAMLProviderPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnSAMLProviderPropsMixin(&CfnSAMLProviderMixinProps{
...
func (j *jsiiProxy_CfnSAMLProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSAMLProviderPropsMixin(props *CfnSAMLProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSAMLProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::SAMLProvider`.
func NewCfnSAMLProviderPropsMixin_Override(c CfnSAMLProviderPropsMixin, props *CfnSAMLProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSAMLProviderPropsMixin) ApplyTo(construct constructs.IConstruct) {
