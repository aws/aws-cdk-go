...
//
//   cfnManagedPolicyPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnManagedPolicyPropsMixin(&CfnManagedPolicyMixinProps{
...
func NewCfnManagedPolicyPropsMixin(props *CfnManagedPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnManagedPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::ManagedPolicy`.
func NewCfnManagedPolicyPropsMixin_Override(c CfnManagedPolicyPropsMixin, props *CfnManagedPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnManagedPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
