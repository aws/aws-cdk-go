...
//
//   cfnAccessKeyPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnAccessKeyPropsMixin(&CfnAccessKeyMixinProps{
...
func NewCfnAccessKeyPropsMixin(props *CfnAccessKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessKeyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::AccessKey`.
func NewCfnAccessKeyPropsMixin_Override(c CfnAccessKeyPropsMixin, props *CfnAccessKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
