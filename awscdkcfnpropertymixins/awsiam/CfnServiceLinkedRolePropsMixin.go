...
//
//   cfnServiceLinkedRolePropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnServiceLinkedRolePropsMixin(&CfnServiceLinkedRoleMixinProps{
...
func (j *jsiiProxy_CfnServiceLinkedRolePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceLinkedRolePropsMixin(props *CfnServiceLinkedRoleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceLinkedRolePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::ServiceLinkedRole`.
func NewCfnServiceLinkedRolePropsMixin_Override(c CfnServiceLinkedRolePropsMixin, props *CfnServiceLinkedRoleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServiceLinkedRolePropsMixin) ApplyTo(construct constructs.IConstruct) {
