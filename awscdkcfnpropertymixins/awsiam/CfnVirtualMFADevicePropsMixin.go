...
//
//   cfnVirtualMFADevicePropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnVirtualMFADevicePropsMixin(&CfnVirtualMFADeviceMixinProps{
...
func (j *jsiiProxy_CfnVirtualMFADevicePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVirtualMFADevicePropsMixin(props *CfnVirtualMFADeviceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualMFADevicePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::VirtualMFADevice`.
func NewCfnVirtualMFADevicePropsMixin_Override(c CfnVirtualMFADevicePropsMixin, props *CfnVirtualMFADeviceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVirtualMFADevicePropsMixin) ApplyTo(construct constructs.IConstruct) {
