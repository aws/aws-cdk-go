...
func validateNewCfnServiceLinkedRolePropsMixinParameters(props *CfnServiceLinkedRoleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
