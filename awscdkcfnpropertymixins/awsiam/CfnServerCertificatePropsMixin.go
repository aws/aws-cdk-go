...
//
//   cfnServerCertificatePropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnServerCertificatePropsMixin(&CfnServerCertificateMixinProps{
...
func (j *jsiiProxy_CfnServerCertificatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServerCertificatePropsMixin(props *CfnServerCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServerCertificatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::ServerCertificate`.
func NewCfnServerCertificatePropsMixin_Override(c CfnServerCertificatePropsMixin, props *CfnServerCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServerCertificatePropsMixin) ApplyTo(construct constructs.IConstruct) {
