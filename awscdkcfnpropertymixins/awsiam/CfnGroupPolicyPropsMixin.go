...
//
//   cfnGroupPolicyPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnGroupPolicyPropsMixin(&CfnGroupPolicyMixinProps{
...
func (j *jsiiProxy_CfnGroupPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGroupPolicyPropsMixin(props *CfnGroupPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGroupPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::GroupPolicy`.
func NewCfnGroupPolicyPropsMixin_Override(c CfnGroupPolicyPropsMixin, props *CfnGroupPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGroupPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
