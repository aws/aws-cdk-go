...
//
//   cfnOIDCProviderPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnOIDCProviderPropsMixin(&CfnOIDCProviderMixinProps{
//   	ClientIdList: []*string{
...
func (j *jsiiProxy_CfnOIDCProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOIDCProviderPropsMixin(props *CfnOIDCProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOIDCProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::OIDCProvider`.
func NewCfnOIDCProviderPropsMixin_Override(c CfnOIDCProviderPropsMixin, props *CfnOIDCProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnOIDCProviderPropsMixin) ApplyTo(construct constructs.IConstruct) {
