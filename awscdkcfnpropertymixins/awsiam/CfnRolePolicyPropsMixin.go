...
//
//   cfnRolePolicyPropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnRolePolicyPropsMixin(&CfnRolePolicyMixinProps{
...
func NewCfnRolePolicyPropsMixin(props *CfnRolePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRolePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::RolePolicy`.
func NewCfnRolePolicyPropsMixin_Override(c CfnRolePolicyPropsMixin, props *CfnRolePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
