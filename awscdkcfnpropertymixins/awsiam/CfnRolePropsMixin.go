...
//
//   cfnRolePropsMixin := awscdkcfnpropertymixins.Aws_iam.NewCfnRolePropsMixin(&CfnRoleMixinProps{
...
func NewCfnRolePropsMixin(props *CfnRoleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRolePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IAM::Role`.
func NewCfnRolePropsMixin_Override(c CfnRolePropsMixin, props *CfnRoleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
