...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awss3express/internal"
...
//
//   cfnDirectoryBucketPropsMixin := awscdkcfnpropertymixins.Aws_s3express.NewCfnDirectoryBucketPropsMixin(&CfnDirectoryBucketMixinProps{
...
func NewCfnDirectoryBucketPropsMixin(props *CfnDirectoryBucketMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDirectoryBucketPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Express::DirectoryBucket`.
func NewCfnDirectoryBucketPropsMixin_Override(c CfnDirectoryBucketPropsMixin, props *CfnDirectoryBucketMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDirectoryBucketPropsMixin) ApplyTo(construct constructs.IConstruct) {
