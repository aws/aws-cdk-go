...
func validateNewCfnDirectoryBucketPropsMixinParameters(props *CfnDirectoryBucketMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
