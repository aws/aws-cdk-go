...
//
//   cfnVirtualClusterPropsMixin := awscdkcfnpropertymixins.Aws_emrcontainers.NewCfnVirtualClusterPropsMixin(&CfnVirtualClusterMixinProps{
...
func NewCfnVirtualClusterPropsMixin(props *CfnVirtualClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualClusterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EMRContainers::VirtualCluster`.
func NewCfnVirtualClusterPropsMixin_Override(c CfnVirtualClusterPropsMixin, props *CfnVirtualClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
