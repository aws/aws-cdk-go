...
func validateNewCfnContainerGroupDefinitionPropsMixinParameters(props *CfnContainerGroupDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
