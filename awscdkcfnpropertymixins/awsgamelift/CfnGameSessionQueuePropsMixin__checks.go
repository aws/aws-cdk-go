...
func validateNewCfnGameSessionQueuePropsMixinParameters(props *CfnGameSessionQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
