...
//
//   cfnMatchmakingConfigurationMixinProps := &CfnMatchmakingConfigurationMixinProps{
...
//
type CfnMatchmakingConfigurationMixinProps struct {
	...
	//
	RequestTimeoutSeconds *float64 `field:"optional" json:"requestTimeoutSeconds" yaml:"requestTimeoutSeconds"`
