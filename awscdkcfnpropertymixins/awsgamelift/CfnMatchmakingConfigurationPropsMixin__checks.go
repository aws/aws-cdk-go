...
func validateNewCfnMatchmakingConfigurationPropsMixinParameters(props *CfnMatchmakingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
