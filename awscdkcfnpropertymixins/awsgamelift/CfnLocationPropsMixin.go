...
//
//   cfnLocationPropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnLocationPropsMixin(&CfnLocationMixinProps{
...
func (j *jsiiProxy_CfnLocationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationPropsMixin(props *CfnLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::Location`.
func NewCfnLocationPropsMixin_Override(c CfnLocationPropsMixin, props *CfnLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocationPropsMixin) ApplyTo(construct constructs.IConstruct) {
