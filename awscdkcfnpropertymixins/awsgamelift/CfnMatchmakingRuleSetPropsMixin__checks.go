...
func validateNewCfnMatchmakingRuleSetPropsMixinParameters(props *CfnMatchmakingRuleSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
