...
//
//   cfnMatchmakingRuleSetPropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnMatchmakingRuleSetPropsMixin(&CfnMatchmakingRuleSetMixinProps{
...
func (j *jsiiProxy_CfnMatchmakingRuleSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMatchmakingRuleSetPropsMixin(props *CfnMatchmakingRuleSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMatchmakingRuleSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::MatchmakingRuleSet`.
func NewCfnMatchmakingRuleSetPropsMixin_Override(c CfnMatchmakingRuleSetPropsMixin, props *CfnMatchmakingRuleSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMatchmakingRuleSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
