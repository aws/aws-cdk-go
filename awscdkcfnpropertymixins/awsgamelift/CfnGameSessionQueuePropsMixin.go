...
//
//   cfnGameSessionQueuePropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnGameSessionQueuePropsMixin(&CfnGameSessionQueueMixinProps{
...
func (j *jsiiProxy_CfnGameSessionQueuePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGameSessionQueuePropsMixin(props *CfnGameSessionQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGameSessionQueuePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::GameSessionQueue`.
func NewCfnGameSessionQueuePropsMixin_Override(c CfnGameSessionQueuePropsMixin, props *CfnGameSessionQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
