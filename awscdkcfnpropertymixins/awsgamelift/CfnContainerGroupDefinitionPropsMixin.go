...
//
//   cfnContainerGroupDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnContainerGroupDefinitionPropsMixin(&CfnContainerGroupDefinitionMixinProps{
...
func (j *jsiiProxy_CfnContainerGroupDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnContainerGroupDefinitionPropsMixin(props *CfnContainerGroupDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnContainerGroupDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::ContainerGroupDefinition`.
func NewCfnContainerGroupDefinitionPropsMixin_Override(c CfnContainerGroupDefinitionPropsMixin, props *CfnContainerGroupDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnContainerGroupDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
