...
//
//   cfnMatchmakingConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnMatchmakingConfigurationPropsMixin(&CfnMatchmakingConfigurationMixinProps{
...
func (j *jsiiProxy_CfnMatchmakingConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMatchmakingConfigurationPropsMixin(props *CfnMatchmakingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMatchmakingConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::MatchmakingConfiguration`.
func NewCfnMatchmakingConfigurationPropsMixin_Override(c CfnMatchmakingConfigurationPropsMixin, props *CfnMatchmakingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
