...
//
//   cfnGameServerGroupPropsMixin := awscdkcfnpropertymixins.Aws_gamelift.NewCfnGameServerGroupPropsMixin(&CfnGameServerGroupMixinProps{
...
func NewCfnGameServerGroupPropsMixin(props *CfnGameServerGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGameServerGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLift::GameServerGroup`.
func NewCfnGameServerGroupPropsMixin_Override(c CfnGameServerGroupPropsMixin, props *CfnGameServerGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
