...
//
//   cfnDeploymentPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnDeploymentPropsMixin(&CfnDeploymentMixinProps{
...
func NewCfnDeploymentPropsMixin(props *CfnDeploymentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnDeploymentPropsMixin",
