...
//
//   cfnApiKeyPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnApiKeyPropsMixin(&CfnApiKeyMixinProps{
...
func NewCfnApiKeyPropsMixin(props *CfnApiKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApiKeyPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnApiKeyPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::ApiKey`.
func NewCfnApiKeyPropsMixin_Override(c CfnApiKeyPropsMixin, props *CfnApiKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApiKeyPropsMixin) ApplyTo(construct constructs.IConstruct) {
