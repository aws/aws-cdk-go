...
//
//   cfnVpcLinkPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnVpcLinkPropsMixin(&CfnVpcLinkMixinProps{
...
func NewCfnVpcLinkPropsMixin(props *CfnVpcLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcLinkPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnVpcLinkPropsMixin",
