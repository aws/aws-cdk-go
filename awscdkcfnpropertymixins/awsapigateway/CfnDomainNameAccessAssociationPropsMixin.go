...
//
//   cfnDomainNameAccessAssociationPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnDomainNameAccessAssociationPropsMixin(&CfnDomainNameAccessAssociationMixinProps{
...
func (j *jsiiProxy_CfnDomainNameAccessAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDomainNameAccessAssociationPropsMixin(props *CfnDomainNameAccessAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDomainNameAccessAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnDomainNameAccessAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::DomainNameAccessAssociation`.
func NewCfnDomainNameAccessAssociationPropsMixin_Override(c CfnDomainNameAccessAssociationPropsMixin, props *CfnDomainNameAccessAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDomainNameAccessAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
