...
//
//   cfnBasePathMappingPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnBasePathMappingPropsMixin(&CfnBasePathMappingMixinProps{
...
func (j *jsiiProxy_CfnBasePathMappingPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBasePathMappingPropsMixin(props *CfnBasePathMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBasePathMappingPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnBasePathMappingPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::BasePathMapping`.
func NewCfnBasePathMappingPropsMixin_Override(c CfnBasePathMappingPropsMixin, props *CfnBasePathMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBasePathMappingPropsMixin) ApplyTo(construct constructs.IConstruct) {
