...
//
//   cfnGatewayResponsePropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnGatewayResponsePropsMixin(&CfnGatewayResponseMixinProps{
...
func (j *jsiiProxy_CfnGatewayResponsePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGatewayResponsePropsMixin(props *CfnGatewayResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGatewayResponsePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnGatewayResponsePropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::GatewayResponse`.
func NewCfnGatewayResponsePropsMixin_Override(c CfnGatewayResponsePropsMixin, props *CfnGatewayResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
