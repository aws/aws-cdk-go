...
//
//   cfnBasePathMappingV2PropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnBasePathMappingV2PropsMixin(&CfnBasePathMappingV2MixinProps{
...
func NewCfnBasePathMappingV2PropsMixin(props *CfnBasePathMappingV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBasePathMappingV2PropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnBasePathMappingV2PropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::BasePathMappingV2`.
func NewCfnBasePathMappingV2PropsMixin_Override(c CfnBasePathMappingV2PropsMixin, props *CfnBasePathMappingV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
