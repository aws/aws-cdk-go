...
//
//   cfnUsagePlanPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnUsagePlanPropsMixin(&CfnUsagePlanMixinProps{
//   	ApiStages: []interface{}{
//   		&ApiStageProperty{
...
func NewCfnUsagePlanPropsMixin(props *CfnUsagePlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUsagePlanPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnUsagePlanPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::UsagePlan`.
func NewCfnUsagePlanPropsMixin_Override(c CfnUsagePlanPropsMixin, props *CfnUsagePlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
