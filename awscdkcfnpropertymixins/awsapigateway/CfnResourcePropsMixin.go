...
//
//   cfnResourcePropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnResourcePropsMixin(&CfnResourceMixinProps{
...
func (j *jsiiProxy_CfnResourcePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourcePropsMixin(props *CfnResourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourcePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnResourcePropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::Resource`.
func NewCfnResourcePropsMixin_Override(c CfnResourcePropsMixin, props *CfnResourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
