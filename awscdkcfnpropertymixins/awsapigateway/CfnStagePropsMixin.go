...
//
//   cfnStagePropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnStagePropsMixin(&CfnStageMixinProps{
...
func NewCfnStagePropsMixin(props *CfnStageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStagePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnStagePropsMixin",
