...
//
//   cfnAuthorizerPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnAuthorizerPropsMixin(&CfnAuthorizerMixinProps{
...
func NewCfnAuthorizerPropsMixin(props *CfnAuthorizerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAuthorizerPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnAuthorizerPropsMixin",
