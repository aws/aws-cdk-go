...
func validateNewCfnClientCertificatePropsMixinParameters(props *CfnClientCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
