...
//
//   cfnDocumentationVersionPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnDocumentationVersionPropsMixin(&CfnDocumentationVersionMixinProps{
...
func (j *jsiiProxy_CfnDocumentationVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDocumentationVersionPropsMixin(props *CfnDocumentationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDocumentationVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnDocumentationVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::DocumentationVersion`.
func NewCfnDocumentationVersionPropsMixin_Override(c CfnDocumentationVersionPropsMixin, props *CfnDocumentationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDocumentationVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
