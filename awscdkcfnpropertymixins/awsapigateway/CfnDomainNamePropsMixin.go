...
//
//   cfnDomainNamePropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnDomainNamePropsMixin(&CfnDomainNameMixinProps{
...
func NewCfnDomainNamePropsMixin(props *CfnDomainNameMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDomainNamePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnDomainNamePropsMixin",
