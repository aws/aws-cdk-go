...
func validateNewCfnGatewayResponsePropsMixinParameters(props *CfnGatewayResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
