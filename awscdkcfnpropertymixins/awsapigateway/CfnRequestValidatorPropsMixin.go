...
//
//   cfnRequestValidatorPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnRequestValidatorPropsMixin(&CfnRequestValidatorMixinProps{
...
func (j *jsiiProxy_CfnRequestValidatorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRequestValidatorPropsMixin(props *CfnRequestValidatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRequestValidatorPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnRequestValidatorPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::RequestValidator`.
func NewCfnRequestValidatorPropsMixin_Override(c CfnRequestValidatorPropsMixin, props *CfnRequestValidatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
