...
//
//   cfnMethodPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnMethodPropsMixin(&CfnMethodMixinProps{
...
func NewCfnMethodPropsMixin(props *CfnMethodMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMethodPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnMethodPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGateway::Method`.
func NewCfnMethodPropsMixin_Override(c CfnMethodPropsMixin, props *CfnMethodMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
