...
//
//   cfnModelPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnModelPropsMixin(&CfnModelMixinProps{
...
func NewCfnModelPropsMixin(props *CfnModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModelPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnModelPropsMixin",
