...
//
//   cfnAccountPropsMixin := awscdkcfnpropertymixins.Aws_apigateway.NewCfnAccountPropsMixin(&CfnAccountMixinProps{
...
func NewCfnAccountPropsMixin(props *CfnAccountMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccountPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigateway.CfnAccountPropsMixin",
