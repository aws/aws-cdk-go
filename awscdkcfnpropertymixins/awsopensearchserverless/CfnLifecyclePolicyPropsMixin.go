...
//
//   cfnLifecyclePolicyPropsMixin := awscdkcfnpropertymixins.Aws_opensearchserverless.NewCfnLifecyclePolicyPropsMixin(&CfnLifecyclePolicyMixinProps{
...
func NewCfnLifecyclePolicyPropsMixin(props *CfnLifecyclePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLifecyclePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::OpenSearchServerless::LifecyclePolicy`.
func NewCfnLifecyclePolicyPropsMixin_Override(c CfnLifecyclePolicyPropsMixin, props *CfnLifecyclePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
