...
//
//   cfnAccessPolicyPropsMixin := awscdkcfnpropertymixins.Aws_opensearchserverless.NewCfnAccessPolicyPropsMixin(&CfnAccessPolicyMixinProps{
...
func (j *jsiiProxy_CfnAccessPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAccessPolicyPropsMixin(props *CfnAccessPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::OpenSearchServerless::AccessPolicy`.
func NewCfnAccessPolicyPropsMixin_Override(c CfnAccessPolicyPropsMixin, props *CfnAccessPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
