...
//
//   cfnCollectionGroupPropsMixin := awscdkcfnpropertymixins.Aws_opensearchserverless.NewCfnCollectionGroupPropsMixin(&CfnCollectionGroupMixinProps{
...
func NewCfnCollectionGroupPropsMixin(props *CfnCollectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCollectionGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::OpenSearchServerless::CollectionGroup`.
func NewCfnCollectionGroupPropsMixin_Override(c CfnCollectionGroupPropsMixin, props *CfnCollectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
