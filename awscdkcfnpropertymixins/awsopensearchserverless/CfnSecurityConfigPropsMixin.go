...
//
//   cfnSecurityConfigPropsMixin := awscdkcfnpropertymixins.Aws_opensearchserverless.NewCfnSecurityConfigPropsMixin(&CfnSecurityConfigMixinProps{
...
func NewCfnSecurityConfigPropsMixin(props *CfnSecurityConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::OpenSearchServerless::SecurityConfig`.
func NewCfnSecurityConfigPropsMixin_Override(c CfnSecurityConfigPropsMixin, props *CfnSecurityConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
