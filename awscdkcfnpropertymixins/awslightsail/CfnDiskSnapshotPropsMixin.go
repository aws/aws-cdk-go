...
//
//   cfnDiskSnapshotPropsMixin := awscdkcfnpropertymixins.Aws_lightsail.NewCfnDiskSnapshotPropsMixin(&CfnDiskSnapshotMixinProps{
...
func (j *jsiiProxy_CfnDiskSnapshotPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDiskSnapshotPropsMixin(props *CfnDiskSnapshotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDiskSnapshotPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lightsail::DiskSnapshot`.
func NewCfnDiskSnapshotPropsMixin_Override(c CfnDiskSnapshotPropsMixin, props *CfnDiskSnapshotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDiskSnapshotPropsMixin) ApplyTo(construct constructs.IConstruct) {
