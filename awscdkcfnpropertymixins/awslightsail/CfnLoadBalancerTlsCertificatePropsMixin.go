...
//
//   cfnLoadBalancerTlsCertificatePropsMixin := awscdkcfnpropertymixins.Aws_lightsail.NewCfnLoadBalancerTlsCertificatePropsMixin(&CfnLoadBalancerTlsCertificateMixinProps{
...
func (j *jsiiProxy_CfnLoadBalancerTlsCertificatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLoadBalancerTlsCertificatePropsMixin(props *CfnLoadBalancerTlsCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLoadBalancerTlsCertificatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lightsail::LoadBalancerTlsCertificate`.
func NewCfnLoadBalancerTlsCertificatePropsMixin_Override(c CfnLoadBalancerTlsCertificatePropsMixin, props *CfnLoadBalancerTlsCertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLoadBalancerTlsCertificatePropsMixin) ApplyTo(construct constructs.IConstruct) {
