...
//
//   cfnDatabaseSnapshotPropsMixin := awscdkcfnpropertymixins.Aws_lightsail.NewCfnDatabaseSnapshotPropsMixin(&CfnDatabaseSnapshotMixinProps{
...
func (j *jsiiProxy_CfnDatabaseSnapshotPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDatabaseSnapshotPropsMixin(props *CfnDatabaseSnapshotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDatabaseSnapshotPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lightsail::DatabaseSnapshot`.
func NewCfnDatabaseSnapshotPropsMixin_Override(c CfnDatabaseSnapshotPropsMixin, props *CfnDatabaseSnapshotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
