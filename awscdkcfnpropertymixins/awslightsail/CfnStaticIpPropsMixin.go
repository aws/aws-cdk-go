...
//
//   cfnStaticIpPropsMixin := awscdkcfnpropertymixins.Aws_lightsail.NewCfnStaticIpPropsMixin(&CfnStaticIpMixinProps{
...
func (j *jsiiProxy_CfnStaticIpPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStaticIpPropsMixin(props *CfnStaticIpMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStaticIpPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lightsail::StaticIp`.
func NewCfnStaticIpPropsMixin_Override(c CfnStaticIpPropsMixin, props *CfnStaticIpMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStaticIpPropsMixin) ApplyTo(construct constructs.IConstruct) {
