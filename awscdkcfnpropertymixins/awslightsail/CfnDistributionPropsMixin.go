...
//
//   cfnDistributionPropsMixin := awscdkcfnpropertymixins.Aws_lightsail.NewCfnDistributionPropsMixin(&CfnDistributionMixinProps{
...
func NewCfnDistributionPropsMixin(props *CfnDistributionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDistributionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lightsail::Distribution`.
func NewCfnDistributionPropsMixin_Override(c CfnDistributionPropsMixin, props *CfnDistributionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
