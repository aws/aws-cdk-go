...
//
//   cfnVehiclePropsMixin := awscdkcfnpropertymixins.Aws_iotfleetwise.NewCfnVehiclePropsMixin(&CfnVehicleMixinProps{
...
func NewCfnVehiclePropsMixin(props *CfnVehicleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVehiclePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTFleetWise::Vehicle`.
func NewCfnVehiclePropsMixin_Override(c CfnVehiclePropsMixin, props *CfnVehicleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
