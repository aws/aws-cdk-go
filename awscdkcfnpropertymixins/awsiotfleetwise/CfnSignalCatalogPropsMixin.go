...
//
//   cfnSignalCatalogPropsMixin := awscdkcfnpropertymixins.Aws_iotfleetwise.NewCfnSignalCatalogPropsMixin(&CfnSignalCatalogMixinProps{
...
func (j *jsiiProxy_CfnSignalCatalogPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSignalCatalogPropsMixin(props *CfnSignalCatalogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSignalCatalogPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTFleetWise::SignalCatalog`.
func NewCfnSignalCatalogPropsMixin_Override(c CfnSignalCatalogPropsMixin, props *CfnSignalCatalogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
