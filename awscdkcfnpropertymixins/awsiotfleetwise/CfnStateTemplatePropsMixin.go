...
//
//   cfnStateTemplatePropsMixin := awscdkcfnpropertymixins.Aws_iotfleetwise.NewCfnStateTemplatePropsMixin(&CfnStateTemplateMixinProps{
...
func (j *jsiiProxy_CfnStateTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStateTemplatePropsMixin(props *CfnStateTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStateTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTFleetWise::StateTemplate`.
func NewCfnStateTemplatePropsMixin_Override(c CfnStateTemplatePropsMixin, props *CfnStateTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStateTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
