...
//
//   cfnDecoderManifestPropsMixin := awscdkcfnpropertymixins.Aws_iotfleetwise.NewCfnDecoderManifestPropsMixin(&CfnDecoderManifestMixinProps{
...
func NewCfnDecoderManifestPropsMixin(props *CfnDecoderManifestMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDecoderManifestPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTFleetWise::DecoderManifest`.
func NewCfnDecoderManifestPropsMixin_Override(c CfnDecoderManifestPropsMixin, props *CfnDecoderManifestMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
