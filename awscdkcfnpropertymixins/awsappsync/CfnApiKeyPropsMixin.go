...
//
//   cfnApiKeyPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnApiKeyPropsMixin(&CfnApiKeyMixinProps{
...
func NewCfnApiKeyPropsMixin(props *CfnApiKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApiKeyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_appsync.CfnApiKeyPropsMixin",
