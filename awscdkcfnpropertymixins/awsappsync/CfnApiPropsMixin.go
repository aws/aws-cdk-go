...
//
//   cfnApiPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnApiPropsMixin(&CfnApiMixinProps{
...
func NewCfnApiPropsMixin(props *CfnApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApiPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_appsync.CfnApiPropsMixin",
...
// Create a mixin to apply properties to `AWS::AppSync::Api`.
func NewCfnApiPropsMixin_Override(c CfnApiPropsMixin, props *CfnApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
