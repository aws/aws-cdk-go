...
//
//   cfnFunctionConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnFunctionConfigurationPropsMixin(&CfnFunctionConfigurationMixinProps{
...
func NewCfnFunctionConfigurationPropsMixin(props *CfnFunctionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFunctionConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppSync::FunctionConfiguration`.
func NewCfnFunctionConfigurationPropsMixin_Override(c CfnFunctionConfigurationPropsMixin, props *CfnFunctionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
