...
//
//   cfnGraphQLSchemaPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnGraphQLSchemaPropsMixin(&CfnGraphQLSchemaMixinProps{
...
func NewCfnGraphQLSchemaPropsMixin(props *CfnGraphQLSchemaMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGraphQLSchemaPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppSync::GraphQLSchema`.
func NewCfnGraphQLSchemaPropsMixin_Override(c CfnGraphQLSchemaPropsMixin, props *CfnGraphQLSchemaMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
