...
//
//   cfnResolverPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnResolverPropsMixin(&CfnResolverMixinProps{
...
func NewCfnResolverPropsMixin(props *CfnResolverMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppSync::Resolver`.
func NewCfnResolverPropsMixin_Override(c CfnResolverPropsMixin, props *CfnResolverMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
