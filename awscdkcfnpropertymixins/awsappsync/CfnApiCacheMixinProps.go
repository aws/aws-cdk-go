...
//
//   cfnApiCacheMixinProps := &CfnApiCacheMixinProps{
...
//
type CfnApiCacheMixinProps struct {
	// Caching behavior.
	//
	...
	//
	ApiCachingBehavior *string `field:"optional" json:"apiCachingBehavior" yaml:"apiCachingBehavior"`
	// The GraphQL API ID.
