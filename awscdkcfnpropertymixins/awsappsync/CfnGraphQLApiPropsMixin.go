...
//
//   cfnGraphQLApiPropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnGraphQLApiPropsMixin(&CfnGraphQLApiMixinProps{
...
func (j *jsiiProxy_CfnGraphQLApiPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGraphQLApiPropsMixin(props *CfnGraphQLApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGraphQLApiPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppSync::GraphQLApi`.
func NewCfnGraphQLApiPropsMixin_Override(c CfnGraphQLApiPropsMixin, props *CfnGraphQLApiMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGraphQLApiPropsMixin) ApplyTo(construct constructs.IConstruct) {
