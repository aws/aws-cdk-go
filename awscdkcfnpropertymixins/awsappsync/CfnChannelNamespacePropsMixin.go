...
//
//   cfnChannelNamespacePropsMixin := awscdkcfnpropertymixins.Aws_appsync.NewCfnChannelNamespacePropsMixin(&CfnChannelNamespaceMixinProps{
...
func (j *jsiiProxy_CfnChannelNamespacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnChannelNamespacePropsMixin(props *CfnChannelNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnChannelNamespacePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_appsync.CfnChannelNamespacePropsMixin",
...
// Create a mixin to apply properties to `AWS::AppSync::ChannelNamespace`.
func NewCfnChannelNamespacePropsMixin_Override(c CfnChannelNamespacePropsMixin, props *CfnChannelNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnChannelNamespacePropsMixin) ApplyTo(construct constructs.IConstruct) {
