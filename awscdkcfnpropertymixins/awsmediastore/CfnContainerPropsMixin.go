...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsmediastore/internal"
...
//
//   cfnContainerPropsMixin := awscdkcfnpropertymixins.Aws_mediastore.NewCfnContainerPropsMixin(&CfnContainerMixinProps{
