...
//
//   cfnEventDataStorePropsMixin := awscdkcfnpropertymixins.Aws_cloudtrail.NewCfnEventDataStorePropsMixin(&CfnEventDataStoreMixinProps{
...
func (j *jsiiProxy_CfnEventDataStorePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEventDataStorePropsMixin(props *CfnEventDataStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventDataStorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudTrail::EventDataStore`.
func NewCfnEventDataStorePropsMixin_Override(c CfnEventDataStorePropsMixin, props *CfnEventDataStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEventDataStorePropsMixin) ApplyTo(construct constructs.IConstruct) {
