...
//
//   cfnTrailPropsMixin := awscdkcfnpropertymixins.Aws_cloudtrail.NewCfnTrailPropsMixin(&CfnTrailMixinProps{
...
func NewCfnTrailPropsMixin(props *CfnTrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrailPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudTrail::Trail`.
func NewCfnTrailPropsMixin_Override(c CfnTrailPropsMixin, props *CfnTrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
