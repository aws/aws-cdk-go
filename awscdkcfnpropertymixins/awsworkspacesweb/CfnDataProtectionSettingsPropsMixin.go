...
//
//   cfnDataProtectionSettingsPropsMixin := awscdkcfnpropertymixins.Aws_workspacesweb.NewCfnDataProtectionSettingsPropsMixin(&CfnDataProtectionSettingsMixinProps{
...
func (j *jsiiProxy_CfnDataProtectionSettingsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataProtectionSettingsPropsMixin(props *CfnDataProtectionSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataProtectionSettingsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesweb.CfnDataProtectionSettingsPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::DataProtectionSettings`.
func NewCfnDataProtectionSettingsPropsMixin_Override(c CfnDataProtectionSettingsPropsMixin, props *CfnDataProtectionSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataProtectionSettingsPropsMixin) ApplyTo(construct constructs.IConstruct) {
