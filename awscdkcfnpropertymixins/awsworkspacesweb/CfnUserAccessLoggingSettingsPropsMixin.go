...
//
//   cfnUserAccessLoggingSettingsPropsMixin := awscdkcfnpropertymixins.Aws_workspacesweb.NewCfnUserAccessLoggingSettingsPropsMixin(&CfnUserAccessLoggingSettingsMixinProps{
...
func NewCfnUserAccessLoggingSettingsPropsMixin(props *CfnUserAccessLoggingSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserAccessLoggingSettingsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesweb.CfnUserAccessLoggingSettingsPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::UserAccessLoggingSettings`.
func NewCfnUserAccessLoggingSettingsPropsMixin_Override(c CfnUserAccessLoggingSettingsPropsMixin, props *CfnUserAccessLoggingSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
