...
//
//   cfnIdentityProviderPropsMixin := awscdkcfnpropertymixins.Aws_workspacesweb.NewCfnIdentityProviderPropsMixin(&CfnIdentityProviderMixinProps{
...
func (j *jsiiProxy_CfnIdentityProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIdentityProviderPropsMixin(props *CfnIdentityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdentityProviderPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesweb.CfnIdentityProviderPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::IdentityProvider`.
func NewCfnIdentityProviderPropsMixin_Override(c CfnIdentityProviderPropsMixin, props *CfnIdentityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
