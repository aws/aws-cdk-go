...
//
type CfnUserSettingsPropsMixin_LocalizedBrandingStringsProperty struct {
	...
	//
	BrowserTabTitle *string `field:"optional" json:"browserTabTitle" yaml:"browserTabTitle"`
	...
	//
	WelcomeText *string `field:"optional" json:"welcomeText" yaml:"welcomeText"`
}
