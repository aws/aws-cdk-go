...
//
//   cfnPortalPropsMixin := awscdkcfnpropertymixins.Aws_workspacesweb.NewCfnPortalPropsMixin(&CfnPortalMixinProps{
...
func NewCfnPortalPropsMixin(props *CfnPortalMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPortalPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesweb.CfnPortalPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::Portal`.
func NewCfnPortalPropsMixin_Override(c CfnPortalPropsMixin, props *CfnPortalMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
