...
//
//   cfnUserSettingsPropsMixin := awscdkcfnpropertymixins.Aws_workspacesweb.NewCfnUserSettingsPropsMixin(&CfnUserSettingsMixinProps{
...
func (j *jsiiProxy_CfnUserSettingsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUserSettingsPropsMixin(props *CfnUserSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserSettingsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesweb.CfnUserSettingsPropsMixin",
...
// Create a mixin to apply properties to `AWS::WorkSpacesWeb::UserSettings`.
func NewCfnUserSettingsPropsMixin_Override(c CfnUserSettingsPropsMixin, props *CfnUserSettingsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserSettingsPropsMixin) ApplyTo(construct constructs.IConstruct) {
