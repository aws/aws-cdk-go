...
//
//   cfnComputeEnvironmentPropsMixin := awscdkcfnpropertymixins.Aws_batch.NewCfnComputeEnvironmentPropsMixin(&CfnComputeEnvironmentMixinProps{
...
func NewCfnComputeEnvironmentPropsMixin(props *CfnComputeEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComputeEnvironmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Batch::ComputeEnvironment`.
func NewCfnComputeEnvironmentPropsMixin_Override(c CfnComputeEnvironmentPropsMixin, props *CfnComputeEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
