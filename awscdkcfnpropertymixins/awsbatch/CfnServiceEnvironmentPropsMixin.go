...
//
//   cfnServiceEnvironmentPropsMixin := awscdkcfnpropertymixins.Aws_batch.NewCfnServiceEnvironmentPropsMixin(&CfnServiceEnvironmentMixinProps{
...
func (j *jsiiProxy_CfnServiceEnvironmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceEnvironmentPropsMixin(props *CfnServiceEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceEnvironmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Batch::ServiceEnvironment`.
func NewCfnServiceEnvironmentPropsMixin_Override(c CfnServiceEnvironmentPropsMixin, props *CfnServiceEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
