...
func NewCfnJobDefinitionPropsMixin(props *CfnJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnJobDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Batch::JobDefinition`.
func NewCfnJobDefinitionPropsMixin_Override(c CfnJobDefinitionPropsMixin, props *CfnJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
