...
func validateNewCfnSchedulingPolicyPropsMixinParameters(props *CfnSchedulingPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
