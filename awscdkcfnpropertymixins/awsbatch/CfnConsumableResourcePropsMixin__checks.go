...
func validateNewCfnConsumableResourcePropsMixinParameters(props *CfnConsumableResourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
