...
//
//   cfnJobQueuePropsMixin := awscdkcfnpropertymixins.Aws_batch.NewCfnJobQueuePropsMixin(&CfnJobQueueMixinProps{
...
func NewCfnJobQueuePropsMixin(props *CfnJobQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnJobQueuePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Batch::JobQueue`.
func NewCfnJobQueuePropsMixin_Override(c CfnJobQueuePropsMixin, props *CfnJobQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
