...
//
//   cfnSchedulingPolicyPropsMixin := awscdkcfnpropertymixins.Aws_batch.NewCfnSchedulingPolicyPropsMixin(&CfnSchedulingPolicyMixinProps{
...
func (j *jsiiProxy_CfnSchedulingPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSchedulingPolicyPropsMixin(props *CfnSchedulingPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchedulingPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Batch::SchedulingPolicy`.
func NewCfnSchedulingPolicyPropsMixin_Override(c CfnSchedulingPolicyPropsMixin, props *CfnSchedulingPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSchedulingPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
