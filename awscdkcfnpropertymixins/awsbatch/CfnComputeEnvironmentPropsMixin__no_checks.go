...
func validateNewCfnComputeEnvironmentPropsMixinParameters(props *CfnComputeEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
