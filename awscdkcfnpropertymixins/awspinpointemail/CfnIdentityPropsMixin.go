...
//
//   cfnIdentityPropsMixin := awscdkcfnpropertymixins.Aws_pinpointemail.NewCfnIdentityPropsMixin(&CfnIdentityMixinProps{
...
func NewCfnIdentityPropsMixin(props *CfnIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdentityPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpointemail.CfnIdentityPropsMixin",
...
// Create a mixin to apply properties to `AWS::PinpointEmail::Identity`.
func NewCfnIdentityPropsMixin_Override(c CfnIdentityPropsMixin, props *CfnIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
