...
//
//   cfnDedicatedIpPoolPropsMixin := awscdkcfnpropertymixins.Aws_pinpointemail.NewCfnDedicatedIpPoolPropsMixin(&CfnDedicatedIpPoolMixinProps{
...
func NewCfnDedicatedIpPoolPropsMixin(props *CfnDedicatedIpPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDedicatedIpPoolPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpointemail.CfnDedicatedIpPoolPropsMixin",
