...
//
//   cfnConfigurationSetEventDestinationPropsMixin := awscdkcfnpropertymixins.Aws_pinpointemail.NewCfnConfigurationSetEventDestinationPropsMixin(&CfnConfigurationSetEventDestinationMixinProps{
...
func (j *jsiiProxy_CfnConfigurationSetEventDestinationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConfigurationSetEventDestinationPropsMixin(props *CfnConfigurationSetEventDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationSetEventDestinationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpointemail.CfnConfigurationSetEventDestinationPropsMixin",
...
// Create a mixin to apply properties to `AWS::PinpointEmail::ConfigurationSetEventDestination`.
func NewCfnConfigurationSetEventDestinationPropsMixin_Override(c CfnConfigurationSetEventDestinationPropsMixin, props *CfnConfigurationSetEventDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConfigurationSetEventDestinationPropsMixin) ApplyTo(construct constructs.IConstruct) {
