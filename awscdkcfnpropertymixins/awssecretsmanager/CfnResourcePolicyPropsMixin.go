...
//
//   cfnResourcePolicyPropsMixin := awscdkcfnpropertymixins.Aws_secretsmanager.NewCfnResourcePolicyPropsMixin(&CfnResourcePolicyMixinProps{
...
func NewCfnResourcePolicyPropsMixin(props *CfnResourcePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourcePolicyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_secretsmanager.CfnResourcePolicyPropsMixin",
