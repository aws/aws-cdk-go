...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssecretsmanager/internal"
...
//
//   cfnSecretTargetAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_secretsmanager.NewCfnSecretTargetAttachmentPropsMixin(&CfnSecretTargetAttachmentMixinProps{
...
func (j *jsiiProxy_CfnSecretTargetAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecretTargetAttachmentPropsMixin(props *CfnSecretTargetAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecretTargetAttachmentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_secretsmanager.CfnSecretTargetAttachmentPropsMixin",
...
// Create a mixin to apply properties to `AWS::SecretsManager::SecretTargetAttachment`.
func NewCfnSecretTargetAttachmentPropsMixin_Override(c CfnSecretTargetAttachmentPropsMixin, props *CfnSecretTargetAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
