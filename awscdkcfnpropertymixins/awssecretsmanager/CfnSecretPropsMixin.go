...
//
//   cfnSecretPropsMixin := awscdkcfnpropertymixins.Aws_secretsmanager.NewCfnSecretPropsMixin(&CfnSecretMixinProps{
...
func (j *jsiiProxy_CfnSecretPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecretPropsMixin(props *CfnSecretMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecretPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecretsManager::Secret`.
func NewCfnSecretPropsMixin_Override(c CfnSecretPropsMixin, props *CfnSecretMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
