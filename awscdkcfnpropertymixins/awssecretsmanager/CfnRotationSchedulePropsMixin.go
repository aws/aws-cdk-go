...
//
//   cfnRotationSchedulePropsMixin := awscdkcfnpropertymixins.Aws_secretsmanager.NewCfnRotationSchedulePropsMixin(&CfnRotationScheduleMixinProps{
...
func NewCfnRotationSchedulePropsMixin(props *CfnRotationScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRotationSchedulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecretsManager::RotationSchedule`.
func NewCfnRotationSchedulePropsMixin_Override(c CfnRotationSchedulePropsMixin, props *CfnRotationScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRotationSchedulePropsMixin) ApplyTo(construct constructs.IConstruct) {
