...
//
//   cfnLagPropsMixin := awscdkcfnpropertymixins.Aws_directconnect.NewCfnLagPropsMixin(&CfnLagMixinProps{
...
func (j *jsiiProxy_CfnLagPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLagPropsMixin(props *CfnLagMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLagPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_directconnect.CfnLagPropsMixin",
...
// Create a mixin to apply properties to `AWS::DirectConnect::Lag`.
func NewCfnLagPropsMixin_Override(c CfnLagPropsMixin, props *CfnLagMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
