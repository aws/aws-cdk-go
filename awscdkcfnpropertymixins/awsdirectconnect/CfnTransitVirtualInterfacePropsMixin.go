...
//
//   cfnTransitVirtualInterfacePropsMixin := awscdkcfnpropertymixins.Aws_directconnect.NewCfnTransitVirtualInterfacePropsMixin(&CfnTransitVirtualInterfaceMixinProps{
...
func (j *jsiiProxy_CfnTransitVirtualInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitVirtualInterfacePropsMixin(props *CfnTransitVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitVirtualInterfacePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_directconnect.CfnTransitVirtualInterfacePropsMixin",
...
// Create a mixin to apply properties to `AWS::DirectConnect::TransitVirtualInterface`.
func NewCfnTransitVirtualInterfacePropsMixin_Override(c CfnTransitVirtualInterfacePropsMixin, props *CfnTransitVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
