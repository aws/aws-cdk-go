...
//
//   cfnPublicVirtualInterfacePropsMixin := awscdkcfnpropertymixins.Aws_directconnect.NewCfnPublicVirtualInterfacePropsMixin(&CfnPublicVirtualInterfaceMixinProps{
...
func (j *jsiiProxy_CfnPublicVirtualInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPublicVirtualInterfacePropsMixin(props *CfnPublicVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPublicVirtualInterfacePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_directconnect.CfnPublicVirtualInterfacePropsMixin",
...
// Create a mixin to apply properties to `AWS::DirectConnect::PublicVirtualInterface`.
func NewCfnPublicVirtualInterfacePropsMixin_Override(c CfnPublicVirtualInterfacePropsMixin, props *CfnPublicVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
