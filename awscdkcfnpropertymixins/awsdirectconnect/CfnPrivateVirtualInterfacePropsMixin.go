...
//
//   cfnPrivateVirtualInterfacePropsMixin := awscdkcfnpropertymixins.Aws_directconnect.NewCfnPrivateVirtualInterfacePropsMixin(&CfnPrivateVirtualInterfaceMixinProps{
...
func (j *jsiiProxy_CfnPrivateVirtualInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPrivateVirtualInterfacePropsMixin(props *CfnPrivateVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPrivateVirtualInterfacePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_directconnect.CfnPrivateVirtualInterfacePropsMixin",
...
// Create a mixin to apply properties to `AWS::DirectConnect::PrivateVirtualInterface`.
func NewCfnPrivateVirtualInterfacePropsMixin_Override(c CfnPrivateVirtualInterfacePropsMixin, props *CfnPrivateVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
