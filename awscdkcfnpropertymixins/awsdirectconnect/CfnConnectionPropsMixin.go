...
//
//   cfnConnectionPropsMixin := awscdkcfnpropertymixins.Aws_directconnect.NewCfnConnectionPropsMixin(&CfnConnectionMixinProps{
...
func NewCfnConnectionPropsMixin(props *CfnConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectionPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_directconnect.CfnConnectionPropsMixin",
