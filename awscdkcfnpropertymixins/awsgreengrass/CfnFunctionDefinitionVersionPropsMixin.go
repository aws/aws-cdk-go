...
//
//   cfnFunctionDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnFunctionDefinitionVersionPropsMixin(&CfnFunctionDefinitionVersionMixinProps{
...
func (j *jsiiProxy_CfnFunctionDefinitionVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFunctionDefinitionVersionPropsMixin(props *CfnFunctionDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFunctionDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnFunctionDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::FunctionDefinitionVersion`.
func NewCfnFunctionDefinitionVersionPropsMixin_Override(c CfnFunctionDefinitionVersionPropsMixin, props *CfnFunctionDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
