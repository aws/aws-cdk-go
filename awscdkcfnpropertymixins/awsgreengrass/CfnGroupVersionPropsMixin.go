...
//
//   cfnGroupVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnGroupVersionPropsMixin(&CfnGroupVersionMixinProps{
...
func (j *jsiiProxy_CfnGroupVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGroupVersionPropsMixin(props *CfnGroupVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGroupVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnGroupVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::GroupVersion`.
func NewCfnGroupVersionPropsMixin_Override(c CfnGroupVersionPropsMixin, props *CfnGroupVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGroupVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
