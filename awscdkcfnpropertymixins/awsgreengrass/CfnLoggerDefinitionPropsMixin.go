...
//   var tags interface{}
//
//   cfnLoggerDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnLoggerDefinitionPropsMixin(&CfnLoggerDefinitionMixinProps{
...
func (j *jsiiProxy_CfnLoggerDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLoggerDefinitionPropsMixin(props *CfnLoggerDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLoggerDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnLoggerDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::LoggerDefinition`.
func NewCfnLoggerDefinitionPropsMixin_Override(c CfnLoggerDefinitionPropsMixin, props *CfnLoggerDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
