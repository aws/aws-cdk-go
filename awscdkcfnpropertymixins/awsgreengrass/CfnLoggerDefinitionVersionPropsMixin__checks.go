...
func validateNewCfnLoggerDefinitionVersionPropsMixinParameters(props *CfnLoggerDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
