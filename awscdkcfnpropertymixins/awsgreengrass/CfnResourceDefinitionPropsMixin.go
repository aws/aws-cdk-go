...
//   var tags interface{}
//
//   cfnResourceDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnResourceDefinitionPropsMixin(&CfnResourceDefinitionMixinProps{
...
func (j *jsiiProxy_CfnResourceDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceDefinitionPropsMixin(props *CfnResourceDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnResourceDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::ResourceDefinition`.
func NewCfnResourceDefinitionPropsMixin_Override(c CfnResourceDefinitionPropsMixin, props *CfnResourceDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
