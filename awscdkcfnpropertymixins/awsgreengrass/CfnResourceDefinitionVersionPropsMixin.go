...
//
//   cfnResourceDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnResourceDefinitionVersionPropsMixin(&CfnResourceDefinitionVersionMixinProps{
...
func (j *jsiiProxy_CfnResourceDefinitionVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceDefinitionVersionPropsMixin(props *CfnResourceDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnResourceDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::ResourceDefinitionVersion`.
func NewCfnResourceDefinitionVersionPropsMixin_Override(c CfnResourceDefinitionVersionPropsMixin, props *CfnResourceDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceDefinitionVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
