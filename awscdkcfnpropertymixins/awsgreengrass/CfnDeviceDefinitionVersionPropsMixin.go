...
//
//   cfnDeviceDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnDeviceDefinitionVersionPropsMixin(&CfnDeviceDefinitionVersionMixinProps{
...
func NewCfnDeviceDefinitionVersionPropsMixin(props *CfnDeviceDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeviceDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnDeviceDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::DeviceDefinitionVersion`.
func NewCfnDeviceDefinitionVersionPropsMixin_Override(c CfnDeviceDefinitionVersionPropsMixin, props *CfnDeviceDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
