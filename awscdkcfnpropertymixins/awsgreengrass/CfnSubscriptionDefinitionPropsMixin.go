...
//   var tags interface{}
//
//   cfnSubscriptionDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnSubscriptionDefinitionPropsMixin(&CfnSubscriptionDefinitionMixinProps{
...
func (j *jsiiProxy_CfnSubscriptionDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubscriptionDefinitionPropsMixin(props *CfnSubscriptionDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubscriptionDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnSubscriptionDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::SubscriptionDefinition`.
func NewCfnSubscriptionDefinitionPropsMixin_Override(c CfnSubscriptionDefinitionPropsMixin, props *CfnSubscriptionDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
