...
//   var tags interface{}
//
//   cfnDeviceDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnDeviceDefinitionPropsMixin(&CfnDeviceDefinitionMixinProps{
...
func (j *jsiiProxy_CfnDeviceDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeviceDefinitionPropsMixin(props *CfnDeviceDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeviceDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnDeviceDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::DeviceDefinition`.
func NewCfnDeviceDefinitionPropsMixin_Override(c CfnDeviceDefinitionPropsMixin, props *CfnDeviceDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDeviceDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
