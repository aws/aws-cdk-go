...
//
//   cfnConnectorDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnConnectorDefinitionVersionPropsMixin(&CfnConnectorDefinitionVersionMixinProps{
...
func (j *jsiiProxy_CfnConnectorDefinitionVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConnectorDefinitionVersionPropsMixin(props *CfnConnectorDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectorDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnConnectorDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::ConnectorDefinitionVersion`.
func NewCfnConnectorDefinitionVersionPropsMixin_Override(c CfnConnectorDefinitionVersionPropsMixin, props *CfnConnectorDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectorDefinitionVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
