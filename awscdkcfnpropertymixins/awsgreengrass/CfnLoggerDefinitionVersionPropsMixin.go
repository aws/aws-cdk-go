...
//
//   cfnLoggerDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnLoggerDefinitionVersionPropsMixin(&CfnLoggerDefinitionVersionMixinProps{
...
func (j *jsiiProxy_CfnLoggerDefinitionVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLoggerDefinitionVersionPropsMixin(props *CfnLoggerDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLoggerDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnLoggerDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::LoggerDefinitionVersion`.
func NewCfnLoggerDefinitionVersionPropsMixin_Override(c CfnLoggerDefinitionVersionPropsMixin, props *CfnLoggerDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLoggerDefinitionVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
