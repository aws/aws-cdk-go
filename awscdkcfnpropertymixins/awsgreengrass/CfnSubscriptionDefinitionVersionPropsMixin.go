...
//
//   cfnSubscriptionDefinitionVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnSubscriptionDefinitionVersionPropsMixin(&CfnSubscriptionDefinitionVersionMixinProps{
...
func NewCfnSubscriptionDefinitionVersionPropsMixin(props *CfnSubscriptionDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubscriptionDefinitionVersionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnSubscriptionDefinitionVersionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::SubscriptionDefinitionVersion`.
func NewCfnSubscriptionDefinitionVersionPropsMixin_Override(c CfnSubscriptionDefinitionVersionPropsMixin, props *CfnSubscriptionDefinitionVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
