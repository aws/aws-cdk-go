...
//   var tags interface{}
//
//   cfnConnectorDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnConnectorDefinitionPropsMixin(&CfnConnectorDefinitionMixinProps{
...
func NewCfnConnectorDefinitionPropsMixin(props *CfnConnectorDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectorDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnConnectorDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::ConnectorDefinition`.
func NewCfnConnectorDefinitionPropsMixin_Override(c CfnConnectorDefinitionPropsMixin, props *CfnConnectorDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
