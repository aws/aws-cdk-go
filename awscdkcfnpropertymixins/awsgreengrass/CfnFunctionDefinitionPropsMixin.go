...
//
//   cfnFunctionDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnFunctionDefinitionPropsMixin(&CfnFunctionDefinitionMixinProps{
...
func (j *jsiiProxy_CfnFunctionDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFunctionDefinitionPropsMixin(props *CfnFunctionDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFunctionDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnFunctionDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::FunctionDefinition`.
func NewCfnFunctionDefinitionPropsMixin_Override(c CfnFunctionDefinitionPropsMixin, props *CfnFunctionDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFunctionDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
