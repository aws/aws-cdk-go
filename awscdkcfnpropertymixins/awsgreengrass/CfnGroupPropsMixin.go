...
//   var tags interface{}
//
//   cfnGroupPropsMixin := awscdkcfnpropertymixins.Aws_greengrass.NewCfnGroupPropsMixin(&CfnGroupMixinProps{
...
func NewCfnGroupPropsMixin(props *CfnGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_greengrass.CfnGroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::Greengrass::Group`.
func NewCfnGroupPropsMixin_Override(c CfnGroupPropsMixin, props *CfnGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
