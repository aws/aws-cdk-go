...
//
//   cfnAppInstanceUserMixinProps := &CfnAppInstanceUserMixinProps{
...
//
type CfnAppInstanceUserMixinProps struct {
	...
	//
	AppInstanceUserId *string `field:"optional" json:"appInstanceUserId" yaml:"appInstanceUserId"`
