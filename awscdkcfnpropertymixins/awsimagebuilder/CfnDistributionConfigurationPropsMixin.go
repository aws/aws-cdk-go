...
//
//   cfnDistributionConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_imagebuilder.NewCfnDistributionConfigurationPropsMixin(&CfnDistributionConfigurationMixinProps{
...
func (j *jsiiProxy_CfnDistributionConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDistributionConfigurationPropsMixin(props *CfnDistributionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDistributionConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ImageBuilder::DistributionConfiguration`.
func NewCfnDistributionConfigurationPropsMixin_Override(c CfnDistributionConfigurationPropsMixin, props *CfnDistributionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
