...
//
//   cfnImagePropsMixin := awscdkcfnpropertymixins.Aws_imagebuilder.NewCfnImagePropsMixin(&CfnImageMixinProps{
...
func (j *jsiiProxy_CfnImagePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnImagePropsMixin(props *CfnImageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnImagePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ImageBuilder::Image`.
func NewCfnImagePropsMixin_Override(c CfnImagePropsMixin, props *CfnImageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
