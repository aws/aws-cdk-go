...
//
//   cfnImagePipelinePropsMixin := awscdkcfnpropertymixins.Aws_imagebuilder.NewCfnImagePipelinePropsMixin(&CfnImagePipelineMixinProps{
...
func NewCfnImagePipelinePropsMixin(props *CfnImagePipelineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnImagePipelinePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ImageBuilder::ImagePipeline`.
func NewCfnImagePipelinePropsMixin_Override(c CfnImagePipelinePropsMixin, props *CfnImagePipelineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnImagePipelinePropsMixin) ApplyTo(construct constructs.IConstruct) {
