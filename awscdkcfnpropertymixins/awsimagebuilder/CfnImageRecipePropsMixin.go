...
//
//   cfnImageRecipePropsMixin := awscdkcfnpropertymixins.Aws_imagebuilder.NewCfnImageRecipePropsMixin(&CfnImageRecipeMixinProps{
...
func NewCfnImageRecipePropsMixin(props *CfnImageRecipeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnImageRecipePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ImageBuilder::ImageRecipe`.
func NewCfnImageRecipePropsMixin_Override(c CfnImageRecipePropsMixin, props *CfnImageRecipeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
