...
//
//   cfnInfrastructureConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_imagebuilder.NewCfnInfrastructureConfigurationPropsMixin(&CfnInfrastructureConfigurationMixinProps{
...
func (j *jsiiProxy_CfnInfrastructureConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInfrastructureConfigurationPropsMixin(props *CfnInfrastructureConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInfrastructureConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ImageBuilder::InfrastructureConfiguration`.
func NewCfnInfrastructureConfigurationPropsMixin_Override(c CfnInfrastructureConfigurationPropsMixin, props *CfnInfrastructureConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInfrastructureConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
