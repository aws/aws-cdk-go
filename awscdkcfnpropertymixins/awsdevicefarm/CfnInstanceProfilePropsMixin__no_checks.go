...
func validateNewCfnInstanceProfilePropsMixinParameters(props *CfnInstanceProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
