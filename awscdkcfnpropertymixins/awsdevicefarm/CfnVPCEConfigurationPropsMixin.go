...
//
//   cfnVPCEConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_devicefarm.NewCfnVPCEConfigurationPropsMixin(&CfnVPCEConfigurationMixinProps{
...
func NewCfnVPCEConfigurationPropsMixin(props *CfnVPCEConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCEConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DeviceFarm::VPCEConfiguration`.
func NewCfnVPCEConfigurationPropsMixin_Override(c CfnVPCEConfigurationPropsMixin, props *CfnVPCEConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
