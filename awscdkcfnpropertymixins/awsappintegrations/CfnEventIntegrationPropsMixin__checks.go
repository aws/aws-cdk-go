...
func validateNewCfnEventIntegrationPropsMixinParameters(props *CfnEventIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
