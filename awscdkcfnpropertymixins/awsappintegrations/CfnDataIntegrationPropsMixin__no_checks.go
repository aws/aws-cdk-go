...
func validateNewCfnDataIntegrationPropsMixinParameters(props *CfnDataIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
