...
//
//   cfnTrustedEntitySetPropsMixin := awscdkcfnpropertymixins.Aws_guardduty.NewCfnTrustedEntitySetPropsMixin(&CfnTrustedEntitySetMixinProps{
...
func (j *jsiiProxy_CfnTrustedEntitySetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrustedEntitySetPropsMixin(props *CfnTrustedEntitySetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrustedEntitySetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GuardDuty::TrustedEntitySet`.
func NewCfnTrustedEntitySetPropsMixin_Override(c CfnTrustedEntitySetPropsMixin, props *CfnTrustedEntitySetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTrustedEntitySetPropsMixin) ApplyTo(construct constructs.IConstruct) {
