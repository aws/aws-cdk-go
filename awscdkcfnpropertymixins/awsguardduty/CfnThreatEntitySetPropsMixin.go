...
//
//   cfnThreatEntitySetPropsMixin := awscdkcfnpropertymixins.Aws_guardduty.NewCfnThreatEntitySetPropsMixin(&CfnThreatEntitySetMixinProps{
...
func (j *jsiiProxy_CfnThreatEntitySetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnThreatEntitySetPropsMixin(props *CfnThreatEntitySetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnThreatEntitySetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GuardDuty::ThreatEntitySet`.
func NewCfnThreatEntitySetPropsMixin_Override(c CfnThreatEntitySetPropsMixin, props *CfnThreatEntitySetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnThreatEntitySetPropsMixin) ApplyTo(construct constructs.IConstruct) {
