...
//
//   cfnThreatIntelSetPropsMixin := awscdkcfnpropertymixins.Aws_guardduty.NewCfnThreatIntelSetPropsMixin(&CfnThreatIntelSetMixinProps{
...
func (j *jsiiProxy_CfnThreatIntelSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnThreatIntelSetPropsMixin(props *CfnThreatIntelSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnThreatIntelSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GuardDuty::ThreatIntelSet`.
func NewCfnThreatIntelSetPropsMixin_Override(c CfnThreatIntelSetPropsMixin, props *CfnThreatIntelSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnThreatIntelSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
