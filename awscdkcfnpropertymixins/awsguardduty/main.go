...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_guardduty.CfnCustomDetectionRuleAssociationMixinProps",
		reflect.TypeOf((*CfnCustomDetectionRuleAssociationMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_guardduty.CfnCustomDetectionRuleAssociationPropsMixin",
		reflect.TypeOf((*CfnCustomDetectionRuleAssociationPropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_guardduty.CfnCustomDetectionRuleAssociationPropsMixin.TagItemProperty",
		reflect.TypeOf((*CfnCustomDetectionRuleAssociationPropsMixin_TagItemProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
