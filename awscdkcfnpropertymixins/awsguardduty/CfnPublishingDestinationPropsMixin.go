...
//
//   cfnPublishingDestinationPropsMixin := awscdkcfnpropertymixins.Aws_guardduty.NewCfnPublishingDestinationPropsMixin(&CfnPublishingDestinationMixinProps{
...
func (j *jsiiProxy_CfnPublishingDestinationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPublishingDestinationPropsMixin(props *CfnPublishingDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPublishingDestinationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GuardDuty::PublishingDestination`.
func NewCfnPublishingDestinationPropsMixin_Override(c CfnPublishingDestinationPropsMixin, props *CfnPublishingDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPublishingDestinationPropsMixin) ApplyTo(construct constructs.IConstruct) {
