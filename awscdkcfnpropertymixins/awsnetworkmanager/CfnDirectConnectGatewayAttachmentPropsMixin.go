...
//
//   cfnDirectConnectGatewayAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnDirectConnectGatewayAttachmentPropsMixin(&CfnDirectConnectGatewayAttachmentMixinProps{
...
func (j *jsiiProxy_CfnDirectConnectGatewayAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDirectConnectGatewayAttachmentPropsMixin(props *CfnDirectConnectGatewayAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDirectConnectGatewayAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::DirectConnectGatewayAttachment`.
func NewCfnDirectConnectGatewayAttachmentPropsMixin_Override(c CfnDirectConnectGatewayAttachmentPropsMixin, props *CfnDirectConnectGatewayAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
