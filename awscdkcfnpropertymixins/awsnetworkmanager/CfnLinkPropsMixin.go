...
//
//   cfnLinkPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnLinkPropsMixin(&CfnLinkMixinProps{
...
func (j *jsiiProxy_CfnLinkPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLinkPropsMixin(props *CfnLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLinkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::Link`.
func NewCfnLinkPropsMixin_Override(c CfnLinkPropsMixin, props *CfnLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
