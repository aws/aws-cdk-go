...
//
//   cfnCustomerGatewayAssociationPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnCustomerGatewayAssociationPropsMixin(&CfnCustomerGatewayAssociationMixinProps{
...
func (j *jsiiProxy_CfnCustomerGatewayAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCustomerGatewayAssociationPropsMixin(props *CfnCustomerGatewayAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCustomerGatewayAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::CustomerGatewayAssociation`.
func NewCfnCustomerGatewayAssociationPropsMixin_Override(c CfnCustomerGatewayAssociationPropsMixin, props *CfnCustomerGatewayAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCustomerGatewayAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
