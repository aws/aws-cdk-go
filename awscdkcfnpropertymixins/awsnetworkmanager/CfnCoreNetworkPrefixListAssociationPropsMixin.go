...
//
//   cfnCoreNetworkPrefixListAssociationPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnCoreNetworkPrefixListAssociationPropsMixin(&CfnCoreNetworkPrefixListAssociationMixinProps{
...
func NewCfnCoreNetworkPrefixListAssociationPropsMixin(props *CfnCoreNetworkPrefixListAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCoreNetworkPrefixListAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::CoreNetworkPrefixListAssociation`.
func NewCfnCoreNetworkPrefixListAssociationPropsMixin_Override(c CfnCoreNetworkPrefixListAssociationPropsMixin, props *CfnCoreNetworkPrefixListAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
