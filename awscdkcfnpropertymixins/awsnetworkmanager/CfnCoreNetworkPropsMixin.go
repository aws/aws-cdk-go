...
//
//   cfnCoreNetworkPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnCoreNetworkPropsMixin(&CfnCoreNetworkMixinProps{
...
func (j *jsiiProxy_CfnCoreNetworkPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCoreNetworkPropsMixin(props *CfnCoreNetworkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCoreNetworkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::CoreNetwork`.
func NewCfnCoreNetworkPropsMixin_Override(c CfnCoreNetworkPropsMixin, props *CfnCoreNetworkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCoreNetworkPropsMixin) ApplyTo(construct constructs.IConstruct) {
