...
//
//   cfnConnectPeerPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnConnectPeerPropsMixin(&CfnConnectPeerMixinProps{
...
func (j *jsiiProxy_CfnConnectPeerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConnectPeerPropsMixin(props *CfnConnectPeerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectPeerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::ConnectPeer`.
func NewCfnConnectPeerPropsMixin_Override(c CfnConnectPeerPropsMixin, props *CfnConnectPeerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectPeerPropsMixin) ApplyTo(construct constructs.IConstruct) {
