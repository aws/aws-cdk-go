...
//
//   cfnGlobalNetworkPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnGlobalNetworkPropsMixin(&CfnGlobalNetworkMixinProps{
...
func (j *jsiiProxy_CfnGlobalNetworkPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGlobalNetworkPropsMixin(props *CfnGlobalNetworkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGlobalNetworkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::GlobalNetwork`.
func NewCfnGlobalNetworkPropsMixin_Override(c CfnGlobalNetworkPropsMixin, props *CfnGlobalNetworkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGlobalNetworkPropsMixin) ApplyTo(construct constructs.IConstruct) {
