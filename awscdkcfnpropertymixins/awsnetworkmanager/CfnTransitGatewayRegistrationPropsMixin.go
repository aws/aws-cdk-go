...
//
//   cfnTransitGatewayRegistrationPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnTransitGatewayRegistrationPropsMixin(&CfnTransitGatewayRegistrationMixinProps{
...
func (j *jsiiProxy_CfnTransitGatewayRegistrationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayRegistrationPropsMixin(props *CfnTransitGatewayRegistrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayRegistrationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::TransitGatewayRegistration`.
func NewCfnTransitGatewayRegistrationPropsMixin_Override(c CfnTransitGatewayRegistrationPropsMixin, props *CfnTransitGatewayRegistrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransitGatewayRegistrationPropsMixin) ApplyTo(construct constructs.IConstruct) {
