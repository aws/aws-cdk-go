...
//
//   cfnLinkAssociationPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnLinkAssociationPropsMixin(&CfnLinkAssociationMixinProps{
...
func (j *jsiiProxy_CfnLinkAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLinkAssociationPropsMixin(props *CfnLinkAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLinkAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::LinkAssociation`.
func NewCfnLinkAssociationPropsMixin_Override(c CfnLinkAssociationPropsMixin, props *CfnLinkAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLinkAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
