...
//
//   cfnSiteToSiteVpnAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnSiteToSiteVpnAttachmentPropsMixin(&CfnSiteToSiteVpnAttachmentMixinProps{
...
func (j *jsiiProxy_CfnSiteToSiteVpnAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSiteToSiteVpnAttachmentPropsMixin(props *CfnSiteToSiteVpnAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSiteToSiteVpnAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::SiteToSiteVpnAttachment`.
func NewCfnSiteToSiteVpnAttachmentPropsMixin_Override(c CfnSiteToSiteVpnAttachmentPropsMixin, props *CfnSiteToSiteVpnAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
