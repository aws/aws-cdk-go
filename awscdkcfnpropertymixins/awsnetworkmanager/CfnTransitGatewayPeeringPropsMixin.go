...
//
//   cfnTransitGatewayPeeringPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnTransitGatewayPeeringPropsMixin(&CfnTransitGatewayPeeringMixinProps{
...
func NewCfnTransitGatewayPeeringPropsMixin(props *CfnTransitGatewayPeeringMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayPeeringPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::TransitGatewayPeering`.
func NewCfnTransitGatewayPeeringPropsMixin_Override(c CfnTransitGatewayPeeringPropsMixin, props *CfnTransitGatewayPeeringMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
