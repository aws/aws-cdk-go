...
//
//   cfnConnectAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnConnectAttachmentPropsMixin(&CfnConnectAttachmentMixinProps{
...
func (j *jsiiProxy_CfnConnectAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConnectAttachmentPropsMixin(props *CfnConnectAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::ConnectAttachment`.
func NewCfnConnectAttachmentPropsMixin_Override(c CfnConnectAttachmentPropsMixin, props *CfnConnectAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
