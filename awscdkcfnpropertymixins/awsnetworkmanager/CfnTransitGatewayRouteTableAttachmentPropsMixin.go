...
//
//   cfnTransitGatewayRouteTableAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_networkmanager.NewCfnTransitGatewayRouteTableAttachmentPropsMixin(&CfnTransitGatewayRouteTableAttachmentMixinProps{
...
func NewCfnTransitGatewayRouteTableAttachmentPropsMixin(props *CfnTransitGatewayRouteTableAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayRouteTableAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NetworkManager::TransitGatewayRouteTableAttachment`.
func NewCfnTransitGatewayRouteTableAttachmentPropsMixin_Override(c CfnTransitGatewayRouteTableAttachmentPropsMixin, props *CfnTransitGatewayRouteTableAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
