...
//
//   cfnEndpointGroupPropsMixin := awscdkcfnpropertymixins.Aws_globalaccelerator.NewCfnEndpointGroupPropsMixin(&CfnEndpointGroupMixinProps{
...
func NewCfnEndpointGroupPropsMixin(props *CfnEndpointGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEndpointGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GlobalAccelerator::EndpointGroup`.
func NewCfnEndpointGroupPropsMixin_Override(c CfnEndpointGroupPropsMixin, props *CfnEndpointGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
