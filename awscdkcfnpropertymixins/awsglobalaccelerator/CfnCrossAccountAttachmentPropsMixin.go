...
//
//   cfnCrossAccountAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_globalaccelerator.NewCfnCrossAccountAttachmentPropsMixin(&CfnCrossAccountAttachmentMixinProps{
...
func (j *jsiiProxy_CfnCrossAccountAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCrossAccountAttachmentPropsMixin(props *CfnCrossAccountAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCrossAccountAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GlobalAccelerator::CrossAccountAttachment`.
func NewCfnCrossAccountAttachmentPropsMixin_Override(c CfnCrossAccountAttachmentPropsMixin, props *CfnCrossAccountAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCrossAccountAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
