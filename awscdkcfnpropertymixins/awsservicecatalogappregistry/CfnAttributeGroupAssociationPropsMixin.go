...
//
//   cfnAttributeGroupAssociationPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalogappregistry.NewCfnAttributeGroupAssociationPropsMixin(&CfnAttributeGroupAssociationMixinProps{
...
func (j *jsiiProxy_CfnAttributeGroupAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAttributeGroupAssociationPropsMixin(props *CfnAttributeGroupAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAttributeGroupAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ServiceCatalogAppRegistry::AttributeGroupAssociation`.
func NewCfnAttributeGroupAssociationPropsMixin_Override(c CfnAttributeGroupAssociationPropsMixin, props *CfnAttributeGroupAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAttributeGroupAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
