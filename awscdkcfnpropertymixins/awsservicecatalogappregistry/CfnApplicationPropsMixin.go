...
//
//   cfnApplicationPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalogappregistry.NewCfnApplicationPropsMixin(&CfnApplicationMixinProps{
...
func NewCfnApplicationPropsMixin(props *CfnApplicationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalogappregistry.CfnApplicationPropsMixin",
