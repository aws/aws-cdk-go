...
//
//   cfnAttributeGroupPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalogappregistry.NewCfnAttributeGroupPropsMixin(&CfnAttributeGroupMixinProps{
...
func (j *jsiiProxy_CfnAttributeGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAttributeGroupPropsMixin(props *CfnAttributeGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAttributeGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ServiceCatalogAppRegistry::AttributeGroup`.
func NewCfnAttributeGroupPropsMixin_Override(c CfnAttributeGroupPropsMixin, props *CfnAttributeGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
