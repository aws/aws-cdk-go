...
//
//   cfnDataLakePropsMixin := awscdkcfnpropertymixins.Aws_securitylake.NewCfnDataLakePropsMixin(&CfnDataLakeMixinProps{
...
func (j *jsiiProxy_CfnDataLakePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataLakePropsMixin(props *CfnDataLakeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataLakePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityLake::DataLake`.
func NewCfnDataLakePropsMixin_Override(c CfnDataLakePropsMixin, props *CfnDataLakeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataLakePropsMixin) ApplyTo(construct constructs.IConstruct) {
