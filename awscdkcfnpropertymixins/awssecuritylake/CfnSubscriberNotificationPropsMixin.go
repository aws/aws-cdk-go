...
//
//   cfnSubscriberNotificationPropsMixin := awscdkcfnpropertymixins.Aws_securitylake.NewCfnSubscriberNotificationPropsMixin(&CfnSubscriberNotificationMixinProps{
...
func NewCfnSubscriberNotificationPropsMixin(props *CfnSubscriberNotificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubscriberNotificationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityLake::SubscriberNotification`.
func NewCfnSubscriberNotificationPropsMixin_Override(c CfnSubscriberNotificationPropsMixin, props *CfnSubscriberNotificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSubscriberNotificationPropsMixin) ApplyTo(construct constructs.IConstruct) {
