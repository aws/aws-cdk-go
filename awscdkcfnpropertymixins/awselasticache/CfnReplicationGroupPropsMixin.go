...
//
//   cfnReplicationGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnReplicationGroupPropsMixin(&CfnReplicationGroupMixinProps{
...
func (j *jsiiProxy_CfnReplicationGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReplicationGroupPropsMixin(props *CfnReplicationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::ReplicationGroup`.
func NewCfnReplicationGroupPropsMixin_Override(c CfnReplicationGroupPropsMixin, props *CfnReplicationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReplicationGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
