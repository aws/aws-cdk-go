...
//
//   cfnCacheClusterPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnCacheClusterPropsMixin(&CfnCacheClusterMixinProps{
...
func (j *jsiiProxy_CfnCacheClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCacheClusterPropsMixin(props *CfnCacheClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCacheClusterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::CacheCluster`.
func NewCfnCacheClusterPropsMixin_Override(c CfnCacheClusterPropsMixin, props *CfnCacheClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCacheClusterPropsMixin) ApplyTo(construct constructs.IConstruct) {
