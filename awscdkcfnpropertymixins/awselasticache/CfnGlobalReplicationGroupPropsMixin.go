...
//
//   cfnGlobalReplicationGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnGlobalReplicationGroupPropsMixin(&CfnGlobalReplicationGroupMixinProps{
...
func (j *jsiiProxy_CfnGlobalReplicationGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGlobalReplicationGroupPropsMixin(props *CfnGlobalReplicationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGlobalReplicationGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::GlobalReplicationGroup`.
func NewCfnGlobalReplicationGroupPropsMixin_Override(c CfnGlobalReplicationGroupPropsMixin, props *CfnGlobalReplicationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGlobalReplicationGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
