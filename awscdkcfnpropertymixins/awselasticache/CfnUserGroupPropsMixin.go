...
//
//   cfnUserGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnUserGroupPropsMixin(&CfnUserGroupMixinProps{
...
func NewCfnUserGroupPropsMixin(props *CfnUserGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::UserGroup`.
func NewCfnUserGroupPropsMixin_Override(c CfnUserGroupPropsMixin, props *CfnUserGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
