...
//
//   cfnSecurityGroupIngressPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnSecurityGroupIngressPropsMixin(&CfnSecurityGroupIngressMixinProps{
...
func (j *jsiiProxy_CfnSecurityGroupIngressPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecurityGroupIngressPropsMixin(props *CfnSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityGroupIngressPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::SecurityGroupIngress`.
func NewCfnSecurityGroupIngressPropsMixin_Override(c CfnSecurityGroupIngressPropsMixin, props *CfnSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
