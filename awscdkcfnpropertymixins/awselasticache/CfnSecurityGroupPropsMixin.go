...
//
//   cfnSecurityGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnSecurityGroupPropsMixin(&CfnSecurityGroupMixinProps{
...
func NewCfnSecurityGroupPropsMixin(props *CfnSecurityGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::SecurityGroup`.
func NewCfnSecurityGroupPropsMixin_Override(c CfnSecurityGroupPropsMixin, props *CfnSecurityGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
