...
//
//   cfnSubnetGroupPropsMixin := awscdkcfnpropertymixins.Aws_elasticache.NewCfnSubnetGroupPropsMixin(&CfnSubnetGroupMixinProps{
...
func (j *jsiiProxy_CfnSubnetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubnetGroupPropsMixin(props *CfnSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubnetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ElastiCache::SubnetGroup`.
func NewCfnSubnetGroupPropsMixin_Override(c CfnSubnetGroupPropsMixin, props *CfnSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSubnetGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
