...
//
//   cfnMessageTemplateVersionPropsMixin := awscdkcfnpropertymixins.Aws_wisdom.NewCfnMessageTemplateVersionPropsMixin(&CfnMessageTemplateVersionMixinProps{
...
func NewCfnMessageTemplateVersionPropsMixin(props *CfnMessageTemplateVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMessageTemplateVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Wisdom::MessageTemplateVersion`.
func NewCfnMessageTemplateVersionPropsMixin_Override(c CfnMessageTemplateVersionPropsMixin, props *CfnMessageTemplateVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
