...
//
//   cfnAIGuardrailPropsMixin := awscdkcfnpropertymixins.Aws_wisdom.NewCfnAIGuardrailPropsMixin(&CfnAIGuardrailMixinProps{
...
func (j *jsiiProxy_CfnAIGuardrailPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAIGuardrailPropsMixin(props *CfnAIGuardrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAIGuardrailPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Wisdom::AIGuardrail`.
func NewCfnAIGuardrailPropsMixin_Override(c CfnAIGuardrailPropsMixin, props *CfnAIGuardrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAIGuardrailPropsMixin) ApplyTo(construct constructs.IConstruct) {
