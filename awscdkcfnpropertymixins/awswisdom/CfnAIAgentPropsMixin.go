...
//
//   cfnAIAgentPropsMixin := awscdkcfnpropertymixins.Aws_wisdom.NewCfnAIAgentPropsMixin(&CfnAIAgentMixinProps{
...
func (j *jsiiProxy_CfnAIAgentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAIAgentPropsMixin(props *CfnAIAgentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAIAgentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Wisdom::AIAgent`.
func NewCfnAIAgentPropsMixin_Override(c CfnAIAgentPropsMixin, props *CfnAIAgentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAIAgentPropsMixin) ApplyTo(construct constructs.IConstruct) {
