...
func validateNewCfnMessageTemplatePropsMixinParameters(props *CfnMessageTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
