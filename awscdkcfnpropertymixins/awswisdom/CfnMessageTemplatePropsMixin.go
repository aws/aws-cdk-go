...
//
//   cfnMessageTemplatePropsMixin := awscdkcfnpropertymixins.Aws_wisdom.NewCfnMessageTemplatePropsMixin(&CfnMessageTemplateMixinProps{
...
func (j *jsiiProxy_CfnMessageTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMessageTemplatePropsMixin(props *CfnMessageTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMessageTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Wisdom::MessageTemplate`.
func NewCfnMessageTemplatePropsMixin_Override(c CfnMessageTemplatePropsMixin, props *CfnMessageTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMessageTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
