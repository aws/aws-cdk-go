...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_route53profiles.CfnProfileAssociationMixinProps",
		reflect.TypeOf((*CfnProfileAssociationMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_route53profiles.CfnProfileAssociationPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_route53profiles.CfnProfileMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_route53profiles.CfnProfileResourceAssociationMixinProps",
