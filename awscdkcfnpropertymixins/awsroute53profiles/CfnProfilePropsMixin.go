...
//
//   cfnProfilePropsMixin := awscdkcfnpropertymixins.Aws_route53profiles.NewCfnProfilePropsMixin(&CfnProfileMixinProps{
...
func NewCfnProfilePropsMixin(props *CfnProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProfilePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_route53profiles.CfnProfilePropsMixin",
