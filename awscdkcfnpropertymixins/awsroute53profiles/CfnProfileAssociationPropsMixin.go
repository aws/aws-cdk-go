...
//
//   cfnProfileAssociationPropsMixin := awscdkcfnpropertymixins.Aws_route53profiles.NewCfnProfileAssociationPropsMixin(&CfnProfileAssociationMixinProps{
//   	Arn: jsii.String("arn"),
...
func (j *jsiiProxy_CfnProfileAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnProfileAssociationPropsMixin(props *CfnProfileAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProfileAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Profiles::ProfileAssociation`.
func NewCfnProfileAssociationPropsMixin_Override(c CfnProfileAssociationPropsMixin, props *CfnProfileAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnProfileAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
