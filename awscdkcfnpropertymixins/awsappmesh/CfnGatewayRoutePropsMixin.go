...
//
//   cfnGatewayRoutePropsMixin := awscdkcfnpropertymixins.Aws_appmesh.NewCfnGatewayRoutePropsMixin(&CfnGatewayRouteMixinProps{
...
func (j *jsiiProxy_CfnGatewayRoutePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGatewayRoutePropsMixin(props *CfnGatewayRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGatewayRoutePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppMesh::GatewayRoute`.
func NewCfnGatewayRoutePropsMixin_Override(c CfnGatewayRoutePropsMixin, props *CfnGatewayRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGatewayRoutePropsMixin) ApplyTo(construct constructs.IConstruct) {
