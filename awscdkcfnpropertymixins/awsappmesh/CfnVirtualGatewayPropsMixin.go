...
//
//   cfnVirtualGatewayPropsMixin := awscdkcfnpropertymixins.Aws_appmesh.NewCfnVirtualGatewayPropsMixin(&CfnVirtualGatewayMixinProps{
...
func NewCfnVirtualGatewayPropsMixin(props *CfnVirtualGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppMesh::VirtualGateway`.
func NewCfnVirtualGatewayPropsMixin_Override(c CfnVirtualGatewayPropsMixin, props *CfnVirtualGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
