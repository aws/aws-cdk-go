...
//
//   cfnVirtualNodePropsMixin := awscdkcfnpropertymixins.Aws_appmesh.NewCfnVirtualNodePropsMixin(&CfnVirtualNodeMixinProps{
...
func (j *jsiiProxy_CfnVirtualNodePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVirtualNodePropsMixin(props *CfnVirtualNodeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualNodePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppMesh::VirtualNode`.
func NewCfnVirtualNodePropsMixin_Override(c CfnVirtualNodePropsMixin, props *CfnVirtualNodeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
