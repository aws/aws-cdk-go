...
//
//   cfnVirtualServicePropsMixin := awscdkcfnpropertymixins.Aws_appmesh.NewCfnVirtualServicePropsMixin(&CfnVirtualServiceMixinProps{
...
func (j *jsiiProxy_CfnVirtualServicePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVirtualServicePropsMixin(props *CfnVirtualServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualServicePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppMesh::VirtualService`.
func NewCfnVirtualServicePropsMixin_Override(c CfnVirtualServicePropsMixin, props *CfnVirtualServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVirtualServicePropsMixin) ApplyTo(construct constructs.IConstruct) {
