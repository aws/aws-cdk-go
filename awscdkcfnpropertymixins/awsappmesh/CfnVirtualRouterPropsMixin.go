...
//
//   cfnVirtualRouterPropsMixin := awscdkcfnpropertymixins.Aws_appmesh.NewCfnVirtualRouterPropsMixin(&CfnVirtualRouterMixinProps{
...
func NewCfnVirtualRouterPropsMixin(props *CfnVirtualRouterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVirtualRouterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppMesh::VirtualRouter`.
func NewCfnVirtualRouterPropsMixin_Override(c CfnVirtualRouterPropsMixin, props *CfnVirtualRouterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVirtualRouterPropsMixin) ApplyTo(construct constructs.IConstruct) {
