...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsiotevents/internal"
...
//
//   cfnAlarmModelPropsMixin := awscdkcfnpropertymixins.Aws_iotevents.NewCfnAlarmModelPropsMixin(&CfnAlarmModelMixinProps{
...
func (j *jsiiProxy_CfnAlarmModelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAlarmModelPropsMixin(props *CfnAlarmModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAlarmModelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTEvents::AlarmModel`.
func NewCfnAlarmModelPropsMixin_Override(c CfnAlarmModelPropsMixin, props *CfnAlarmModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAlarmModelPropsMixin) ApplyTo(construct constructs.IConstruct) {
