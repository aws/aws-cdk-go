...
//
//   cfnDetectorModelPropsMixin := awscdkcfnpropertymixins.Aws_iotevents.NewCfnDetectorModelPropsMixin(&CfnDetectorModelMixinProps{
...
func NewCfnDetectorModelPropsMixin(props *CfnDetectorModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDetectorModelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTEvents::DetectorModel`.
func NewCfnDetectorModelPropsMixin_Override(c CfnDetectorModelPropsMixin, props *CfnDetectorModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
