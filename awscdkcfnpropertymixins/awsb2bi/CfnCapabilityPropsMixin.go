...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsb2bi/internal"
...
//
//   cfnCapabilityPropsMixin := awscdkcfnpropertymixins.Aws_b2bi.NewCfnCapabilityPropsMixin(&CfnCapabilityMixinProps{
...
func (j *jsiiProxy_CfnCapabilityPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCapabilityPropsMixin(props *CfnCapabilityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCapabilityPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::B2BI::Capability`.
func NewCfnCapabilityPropsMixin_Override(c CfnCapabilityPropsMixin, props *CfnCapabilityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCapabilityPropsMixin) ApplyTo(construct constructs.IConstruct) {
