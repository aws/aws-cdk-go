...
//
//   cfnPartnershipPropsMixin := awscdkcfnpropertymixins.Aws_b2bi.NewCfnPartnershipPropsMixin(&CfnPartnershipMixinProps{
//   	Capabilities: []*string{
...
func NewCfnPartnershipPropsMixin(props *CfnPartnershipMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPartnershipPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::B2BI::Partnership`.
func NewCfnPartnershipPropsMixin_Override(c CfnPartnershipPropsMixin, props *CfnPartnershipMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
