...
//
//   cfnSyncConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_codestarconnections.NewCfnSyncConfigurationPropsMixin(&CfnSyncConfigurationMixinProps{
...
func (j *jsiiProxy_CfnSyncConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSyncConfigurationPropsMixin(props *CfnSyncConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSyncConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_codestarconnections.CfnSyncConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::CodeStarConnections::SyncConfiguration`.
func NewCfnSyncConfigurationPropsMixin_Override(c CfnSyncConfigurationPropsMixin, props *CfnSyncConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
