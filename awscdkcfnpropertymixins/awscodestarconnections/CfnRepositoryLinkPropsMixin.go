...
//
//   cfnRepositoryLinkPropsMixin := awscdkcfnpropertymixins.Aws_codestarconnections.NewCfnRepositoryLinkPropsMixin(&CfnRepositoryLinkMixinProps{
...
func NewCfnRepositoryLinkPropsMixin(props *CfnRepositoryLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRepositoryLinkPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_codestarconnections.CfnRepositoryLinkPropsMixin",
...
// Create a mixin to apply properties to `AWS::CodeStarConnections::RepositoryLink`.
func NewCfnRepositoryLinkPropsMixin_Override(c CfnRepositoryLinkPropsMixin, props *CfnRepositoryLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
