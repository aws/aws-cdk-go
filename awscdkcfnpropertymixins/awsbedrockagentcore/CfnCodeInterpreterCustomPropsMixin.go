...
func NewCfnCodeInterpreterCustomPropsMixin(props *CfnCodeInterpreterCustomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCodeInterpreterCustomPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::CodeInterpreterCustom`.
func NewCfnCodeInterpreterCustomPropsMixin_Override(c CfnCodeInterpreterCustomPropsMixin, props *CfnCodeInterpreterCustomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
