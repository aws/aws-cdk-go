...
//
//   cfnGatewayTargetPropsMixin := awscdkcfnpropertymixins.Aws_bedrockagentcore.NewCfnGatewayTargetPropsMixin(&CfnGatewayTargetMixinProps{
...
func (j *jsiiProxy_CfnGatewayTargetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGatewayTargetPropsMixin(props *CfnGatewayTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGatewayTargetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::GatewayTarget`.
func NewCfnGatewayTargetPropsMixin_Override(c CfnGatewayTargetPropsMixin, props *CfnGatewayTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGatewayTargetPropsMixin) ApplyTo(construct constructs.IConstruct) {
