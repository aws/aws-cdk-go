...
//
//   cfnBrowserCustomPropsMixin := awscdkcfnpropertymixins.Aws_bedrockagentcore.NewCfnBrowserCustomPropsMixin(&CfnBrowserCustomMixinProps{
...
func NewCfnBrowserCustomPropsMixin(props *CfnBrowserCustomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBrowserCustomPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::BrowserCustom`.
func NewCfnBrowserCustomPropsMixin_Override(c CfnBrowserCustomPropsMixin, props *CfnBrowserCustomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
