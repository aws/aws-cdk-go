...
func validateNewCfnCapacityProviderPropsMixinParameters(props *CfnCapacityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
