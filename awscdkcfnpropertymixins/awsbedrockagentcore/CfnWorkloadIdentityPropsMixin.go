...
//
//   cfnWorkloadIdentityPropsMixin := awscdkcfnpropertymixins.Aws_bedrockagentcore.NewCfnWorkloadIdentityPropsMixin(&CfnWorkloadIdentityMixinProps{
...
func (j *jsiiProxy_CfnWorkloadIdentityPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWorkloadIdentityPropsMixin(props *CfnWorkloadIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkloadIdentityPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::WorkloadIdentity`.
func NewCfnWorkloadIdentityPropsMixin_Override(c CfnWorkloadIdentityPropsMixin, props *CfnWorkloadIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWorkloadIdentityPropsMixin) ApplyTo(construct constructs.IConstruct) {
