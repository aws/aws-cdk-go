...
//
//   cfnResourcePolicyPropsMixin := awscdkcfnpropertymixins.Aws_bedrockagentcore.NewCfnResourcePolicyPropsMixin(&CfnResourcePolicyMixinProps{
...
func NewCfnResourcePolicyPropsMixin(props *CfnResourcePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourcePolicyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_bedrockagentcore.CfnResourcePolicyPropsMixin",
