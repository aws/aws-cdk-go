...
//
type CfnOnlineEvaluationConfigPropsMixin interface {
	awscdk.Mixin
	constructs.IMixin
	Props() *CfnOnlineEvaluationConfigMixinProps
...
// The jsii proxy struct for CfnOnlineEvaluationConfigPropsMixin
type jsiiProxy_CfnOnlineEvaluationConfigPropsMixin struct {
	internal.Type__awscdkMixin
	internal.Type__constructsIMixin
}

func (j *jsiiProxy_CfnOnlineEvaluationConfigPropsMixin) Props() *CfnOnlineEvaluationConfigMixinProps {
	var returns *CfnOnlineEvaluationConfigMixinProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func (j *jsiiProxy_CfnOnlineEvaluationConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOnlineEvaluationConfigPropsMixin(props *CfnOnlineEvaluationConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOnlineEvaluationConfigPropsMixin {
	_init_.Initialize()

	if err := validateNewCfnOnlineEvaluationConfigPropsMixinParameters(props, options); err != nil {
		panic(err)
	}
...
// Create a mixin to apply properties to `AWS::BedrockAgentCore::OnlineEvaluationConfig`.
func NewCfnOnlineEvaluationConfigPropsMixin_Override(c CfnOnlineEvaluationConfigPropsMixin, props *CfnOnlineEvaluationConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func CfnOnlineEvaluationConfigPropsMixin_IsMixin(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnOnlineEvaluationConfigPropsMixin_IsMixinParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnOnlineEvaluationConfigPropsMixin_CFN_PROPERTY_KEYS() *[]*string {
	_init_.Initialize()
	var returns *[]*string
	_jsii_.StaticGet(
		"@aws-cdk/cfn-property-mixins.aws_bedrockagentcore.CfnOnlineEvaluationConfigPropsMixin",
...
func (c *jsiiProxy_CfnOnlineEvaluationConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
...
func (c *jsiiProxy_CfnOnlineEvaluationConfigPropsMixin) Supports(construct constructs.IConstruct) *bool {
