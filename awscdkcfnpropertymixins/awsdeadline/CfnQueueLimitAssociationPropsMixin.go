...
//
//   cfnQueueLimitAssociationPropsMixin := awscdkcfnpropertymixins.Aws_deadline.NewCfnQueueLimitAssociationPropsMixin(&CfnQueueLimitAssociationMixinProps{
...
func (j *jsiiProxy_CfnQueueLimitAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnQueueLimitAssociationPropsMixin(props *CfnQueueLimitAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnQueueLimitAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Deadline::QueueLimitAssociation`.
func NewCfnQueueLimitAssociationPropsMixin_Override(c CfnQueueLimitAssociationPropsMixin, props *CfnQueueLimitAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
