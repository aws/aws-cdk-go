...
//
type CfnQueuePropsMixin_SchedulingMinPriorityOverrideProperty struct {
	...
	//
	AlwaysScheduleLast interface{} `field:"optional" json:"alwaysScheduleLast" yaml:"alwaysScheduleLast"`
}
