...
//
//   cfnQueueEnvironmentPropsMixin := awscdkcfnpropertymixins.Aws_deadline.NewCfnQueueEnvironmentPropsMixin(&CfnQueueEnvironmentMixinProps{
...
func (j *jsiiProxy_CfnQueueEnvironmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnQueueEnvironmentPropsMixin(props *CfnQueueEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnQueueEnvironmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Deadline::QueueEnvironment`.
func NewCfnQueueEnvironmentPropsMixin_Override(c CfnQueueEnvironmentPropsMixin, props *CfnQueueEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnQueueEnvironmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
