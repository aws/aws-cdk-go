...
//
//   cfnStorageProfilePropsMixin := awscdkcfnpropertymixins.Aws_deadline.NewCfnStorageProfilePropsMixin(&CfnStorageProfileMixinProps{
...
func (j *jsiiProxy_CfnStorageProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStorageProfilePropsMixin(props *CfnStorageProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStorageProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Deadline::StorageProfile`.
func NewCfnStorageProfilePropsMixin_Override(c CfnStorageProfilePropsMixin, props *CfnStorageProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStorageProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
