...
func validateNewCfnLicenseEndpointPropsMixinParameters(props *CfnLicenseEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
