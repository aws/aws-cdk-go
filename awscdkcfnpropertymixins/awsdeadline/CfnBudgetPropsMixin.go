...
//
//   cfnBudgetPropsMixin := awscdkcfnpropertymixins.Aws_deadline.NewCfnBudgetPropsMixin(&CfnBudgetMixinProps{
//   	Actions: []interface{}{
...
// Create a mixin to apply properties to `AWS::Deadline::Budget`.
func NewCfnBudgetPropsMixin(props *CfnBudgetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBudgetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Deadline::Budget`.
func NewCfnBudgetPropsMixin_Override(c CfnBudgetPropsMixin, props *CfnBudgetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
