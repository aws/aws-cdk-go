...
func validateNewCfnQueueEnvironmentPropsMixinParameters(props *CfnQueueEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
