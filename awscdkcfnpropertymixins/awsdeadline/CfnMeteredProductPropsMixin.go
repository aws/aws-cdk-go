...
//
//   cfnMeteredProductPropsMixin := awscdkcfnpropertymixins.Aws_deadline.NewCfnMeteredProductPropsMixin(&CfnMeteredProductMixinProps{
...
func (j *jsiiProxy_CfnMeteredProductPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMeteredProductPropsMixin(props *CfnMeteredProductMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMeteredProductPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Deadline::MeteredProduct`.
func NewCfnMeteredProductPropsMixin_Override(c CfnMeteredProductPropsMixin, props *CfnMeteredProductMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMeteredProductPropsMixin) ApplyTo(construct constructs.IConstruct) {
