...
//
//   cfnDirectoryConfigPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnDirectoryConfigPropsMixin(&CfnDirectoryConfigMixinProps{
...
func NewCfnDirectoryConfigPropsMixin(props *CfnDirectoryConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDirectoryConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::DirectoryConfig`.
func NewCfnDirectoryConfigPropsMixin_Override(c CfnDirectoryConfigPropsMixin, props *CfnDirectoryConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
