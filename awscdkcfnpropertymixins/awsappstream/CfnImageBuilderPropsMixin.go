...
//
//   cfnImageBuilderPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnImageBuilderPropsMixin(&CfnImageBuilderMixinProps{
...
func (j *jsiiProxy_CfnImageBuilderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnImageBuilderPropsMixin(props *CfnImageBuilderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnImageBuilderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::ImageBuilder`.
func NewCfnImageBuilderPropsMixin_Override(c CfnImageBuilderPropsMixin, props *CfnImageBuilderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
