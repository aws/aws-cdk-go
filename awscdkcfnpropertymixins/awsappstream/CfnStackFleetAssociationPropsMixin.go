...
//
//   cfnStackFleetAssociationPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnStackFleetAssociationPropsMixin(&CfnStackFleetAssociationMixinProps{
...
func (j *jsiiProxy_CfnStackFleetAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStackFleetAssociationPropsMixin(props *CfnStackFleetAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStackFleetAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::StackFleetAssociation`.
func NewCfnStackFleetAssociationPropsMixin_Override(c CfnStackFleetAssociationPropsMixin, props *CfnStackFleetAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
