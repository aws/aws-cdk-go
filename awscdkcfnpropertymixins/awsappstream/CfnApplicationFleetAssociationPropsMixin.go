...
//
//   cfnApplicationFleetAssociationPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnApplicationFleetAssociationPropsMixin(&CfnApplicationFleetAssociationMixinProps{
...
func NewCfnApplicationFleetAssociationPropsMixin(props *CfnApplicationFleetAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationFleetAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::ApplicationFleetAssociation`.
func NewCfnApplicationFleetAssociationPropsMixin_Override(c CfnApplicationFleetAssociationPropsMixin, props *CfnApplicationFleetAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
