...
//
//   cfnAppBlockPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnAppBlockPropsMixin(&CfnAppBlockMixinProps{
...
func (j *jsiiProxy_CfnAppBlockPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAppBlockPropsMixin(props *CfnAppBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAppBlockPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::AppBlock`.
func NewCfnAppBlockPropsMixin_Override(c CfnAppBlockPropsMixin, props *CfnAppBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAppBlockPropsMixin) ApplyTo(construct constructs.IConstruct) {
