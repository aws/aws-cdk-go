...
//
//   cfnStackUserAssociationPropsMixin := awscdkcfnpropertymixins.Aws_appstream.NewCfnStackUserAssociationPropsMixin(&CfnStackUserAssociationMixinProps{
...
func (j *jsiiProxy_CfnStackUserAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStackUserAssociationPropsMixin(props *CfnStackUserAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStackUserAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppStream::StackUserAssociation`.
func NewCfnStackUserAssociationPropsMixin_Override(c CfnStackUserAssociationPropsMixin, props *CfnStackUserAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStackUserAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
