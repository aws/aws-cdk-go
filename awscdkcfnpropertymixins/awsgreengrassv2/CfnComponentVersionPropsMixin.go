...
//
//   cfnComponentVersionPropsMixin := awscdkcfnpropertymixins.Aws_greengrassv2.NewCfnComponentVersionPropsMixin(&CfnComponentVersionMixinProps{
...
func NewCfnComponentVersionPropsMixin(props *CfnComponentVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComponentVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GreengrassV2::ComponentVersion`.
func NewCfnComponentVersionPropsMixin_Override(c CfnComponentVersionPropsMixin, props *CfnComponentVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
