...
//
//   cfnComponentPropsMixin := awscdkcfnpropertymixins.Aws_greengrassv2.NewCfnComponentPropsMixin(&CfnComponentMixinProps{
...
func (j *jsiiProxy_CfnComponentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
// Create a mixin to apply properties to `AWS::GreengrassV2::Component`.
func NewCfnComponentPropsMixin(props *CfnComponentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComponentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GreengrassV2::Component`.
func NewCfnComponentPropsMixin_Override(c CfnComponentPropsMixin, props *CfnComponentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnComponentPropsMixin) ApplyTo(construct constructs.IConstruct) {
