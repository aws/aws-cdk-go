...
//
//   cfnPhoneNumberPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnPhoneNumberPropsMixin(&CfnPhoneNumberMixinProps{
...
func NewCfnPhoneNumberPropsMixin(props *CfnPhoneNumberMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPhoneNumberPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_smsvoice.CfnPhoneNumberPropsMixin",
