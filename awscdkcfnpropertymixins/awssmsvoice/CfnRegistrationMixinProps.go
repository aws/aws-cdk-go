...
//
//   cfnRegistrationMixinProps := &CfnRegistrationMixinProps{
...
//
type CfnRegistrationMixinProps struct {
	...
	//
	RegistrationType *string `field:"optional" json:"registrationType" yaml:"registrationType"`
