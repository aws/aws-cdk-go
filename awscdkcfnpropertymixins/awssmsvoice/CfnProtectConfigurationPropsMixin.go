...
//
//   cfnProtectConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnProtectConfigurationPropsMixin(&CfnProtectConfigurationMixinProps{
...
func (j *jsiiProxy_CfnProtectConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnProtectConfigurationPropsMixin(props *CfnProtectConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProtectConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SMSVOICE::ProtectConfiguration`.
func NewCfnProtectConfigurationPropsMixin_Override(c CfnProtectConfigurationPropsMixin, props *CfnProtectConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
