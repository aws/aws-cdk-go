...
//
//   cfnPoolPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnPoolPropsMixin(&CfnPoolMixinProps{
...
func (j *jsiiProxy_CfnPoolPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPoolPropsMixin(props *CfnPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPoolPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SMSVOICE::Pool`.
func NewCfnPoolPropsMixin_Override(c CfnPoolPropsMixin, props *CfnPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPoolPropsMixin) ApplyTo(construct constructs.IConstruct) {
