...
//
//   cfnOptOutListPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnOptOutListPropsMixin(&CfnOptOutListMixinProps{
...
func (j *jsiiProxy_CfnOptOutListPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOptOutListPropsMixin(props *CfnOptOutListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOptOutListPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SMSVOICE::OptOutList`.
func NewCfnOptOutListPropsMixin_Override(c CfnOptOutListPropsMixin, props *CfnOptOutListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
