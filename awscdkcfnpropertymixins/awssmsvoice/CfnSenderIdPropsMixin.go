...
//
//   cfnSenderIdPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnSenderIdPropsMixin(&CfnSenderIdMixinProps{
...
func (j *jsiiProxy_CfnSenderIdPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSenderIdPropsMixin(props *CfnSenderIdMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSenderIdPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_smsvoice.CfnSenderIdPropsMixin",
...
// Create a mixin to apply properties to `AWS::SMSVOICE::SenderId`.
func NewCfnSenderIdPropsMixin_Override(c CfnSenderIdPropsMixin, props *CfnSenderIdMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSenderIdPropsMixin) ApplyTo(construct constructs.IConstruct) {
