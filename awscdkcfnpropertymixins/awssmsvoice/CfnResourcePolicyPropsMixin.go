...
//
//   cfnResourcePolicyPropsMixin := awscdkcfnpropertymixins.Aws_smsvoice.NewCfnResourcePolicyPropsMixin(&CfnResourcePolicyMixinProps{
...
func NewCfnResourcePolicyPropsMixin(props *CfnResourcePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourcePolicyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_smsvoice.CfnResourcePolicyPropsMixin",
