...
//
//   cfnDiscovererPropsMixin := awscdkcfnpropertymixins.Aws_eventschemas.NewCfnDiscovererPropsMixin(&CfnDiscovererMixinProps{
...
func (j *jsiiProxy_CfnDiscovererPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDiscovererPropsMixin(props *CfnDiscovererMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDiscovererPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EventSchemas::Discoverer`.
func NewCfnDiscovererPropsMixin_Override(c CfnDiscovererPropsMixin, props *CfnDiscovererMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
