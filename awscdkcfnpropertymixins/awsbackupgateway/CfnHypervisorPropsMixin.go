...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsbackupgateway/internal"
...
//
//   cfnHypervisorPropsMixin := awscdkcfnpropertymixins.Aws_backupgateway.NewCfnHypervisorPropsMixin(&CfnHypervisorMixinProps{
...
func (j *jsiiProxy_CfnHypervisorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHypervisorPropsMixin(props *CfnHypervisorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHypervisorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BackupGateway::Hypervisor`.
func NewCfnHypervisorPropsMixin_Override(c CfnHypervisorPropsMixin, props *CfnHypervisorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
