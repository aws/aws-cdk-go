...
//
//   cfnMultiRegionAccessPointPolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnMultiRegionAccessPointPolicyPropsMixin(&CfnMultiRegionAccessPointPolicyMixinProps{
...
func NewCfnMultiRegionAccessPointPolicyPropsMixin(props *CfnMultiRegionAccessPointPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMultiRegionAccessPointPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::MultiRegionAccessPointPolicy`.
func NewCfnMultiRegionAccessPointPolicyPropsMixin_Override(c CfnMultiRegionAccessPointPolicyPropsMixin, props *CfnMultiRegionAccessPointPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
