...
//
//   cfnAccessGrantsLocationPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnAccessGrantsLocationPropsMixin(&CfnAccessGrantsLocationMixinProps{
...
func (j *jsiiProxy_CfnAccessGrantsLocationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAccessGrantsLocationPropsMixin(props *CfnAccessGrantsLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessGrantsLocationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::AccessGrantsLocation`.
func NewCfnAccessGrantsLocationPropsMixin_Override(c CfnAccessGrantsLocationPropsMixin, props *CfnAccessGrantsLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAccessGrantsLocationPropsMixin) ApplyTo(construct constructs.IConstruct) {
