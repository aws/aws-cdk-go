...
//   var sses3 interface{}
//
//   cfnStorageLensPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnStorageLensPropsMixin(&CfnStorageLensMixinProps{
...
func (j *jsiiProxy_CfnStorageLensPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStorageLensPropsMixin(props *CfnStorageLensMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStorageLensPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::StorageLens`.
func NewCfnStorageLensPropsMixin_Override(c CfnStorageLensPropsMixin, props *CfnStorageLensMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStorageLensPropsMixin) ApplyTo(construct constructs.IConstruct) {
