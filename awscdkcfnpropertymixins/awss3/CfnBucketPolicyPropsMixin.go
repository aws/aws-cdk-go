...
//
//   cfnBucketPolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnBucketPolicyPropsMixin(&CfnBucketPolicyMixinProps{
...
func (j *jsiiProxy_CfnBucketPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBucketPolicyPropsMixin(props *CfnBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBucketPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::BucketPolicy`.
func NewCfnBucketPolicyPropsMixin_Override(c CfnBucketPolicyPropsMixin, props *CfnBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBucketPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
