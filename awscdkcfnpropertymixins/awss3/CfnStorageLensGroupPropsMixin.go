...
//
//   cfnStorageLensGroupPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnStorageLensGroupPropsMixin(&CfnStorageLensGroupMixinProps{
...
func (j *jsiiProxy_CfnStorageLensGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStorageLensGroupPropsMixin(props *CfnStorageLensGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStorageLensGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::StorageLensGroup`.
func NewCfnStorageLensGroupPropsMixin_Override(c CfnStorageLensGroupPropsMixin, props *CfnStorageLensGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStorageLensGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
