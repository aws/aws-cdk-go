...
//
//   cfnMultiRegionAccessPointPropsMixin := awscdkcfnpropertymixins.Aws_s3.NewCfnMultiRegionAccessPointPropsMixin(&CfnMultiRegionAccessPointMixinProps{
...
func (j *jsiiProxy_CfnMultiRegionAccessPointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMultiRegionAccessPointPropsMixin(props *CfnMultiRegionAccessPointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMultiRegionAccessPointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3::MultiRegionAccessPoint`.
func NewCfnMultiRegionAccessPointPropsMixin_Override(c CfnMultiRegionAccessPointPropsMixin, props *CfnMultiRegionAccessPointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMultiRegionAccessPointPropsMixin) ApplyTo(construct constructs.IConstruct) {
