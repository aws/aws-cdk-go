...
//
//   cfnFHIRDatastorePropsMixin := awscdkcfnpropertymixins.Aws_healthlake.NewCfnFHIRDatastorePropsMixin(&CfnFHIRDatastoreMixinProps{
...
func NewCfnFHIRDatastorePropsMixin(props *CfnFHIRDatastoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFHIRDatastorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::HealthLake::FHIRDatastore`.
func NewCfnFHIRDatastorePropsMixin_Override(c CfnFHIRDatastorePropsMixin, props *CfnFHIRDatastoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
