...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscur/internal"
...
//
//   cfnReportDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_cur.NewCfnReportDefinitionPropsMixin(&CfnReportDefinitionMixinProps{
...
func (j *jsiiProxy_CfnReportDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReportDefinitionPropsMixin(props *CfnReportDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReportDefinitionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_cur.CfnReportDefinitionPropsMixin",
...
// Create a mixin to apply properties to `AWS::CUR::ReportDefinition`.
func NewCfnReportDefinitionPropsMixin_Override(c CfnReportDefinitionPropsMixin, props *CfnReportDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReportDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
