...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssynthetics/internal"
...
//
//   cfnCanaryPropsMixin := awscdkcfnpropertymixins.Aws_synthetics.NewCfnCanaryPropsMixin(&CfnCanaryMixinProps{
...
func (j *jsiiProxy_CfnCanaryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCanaryPropsMixin(props *CfnCanaryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCanaryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Synthetics::Canary`.
func NewCfnCanaryPropsMixin_Override(c CfnCanaryPropsMixin, props *CfnCanaryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCanaryPropsMixin) ApplyTo(construct constructs.IConstruct) {
