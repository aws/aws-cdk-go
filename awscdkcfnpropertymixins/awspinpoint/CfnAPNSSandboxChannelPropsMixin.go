...
//
//   cfnAPNSSandboxChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnAPNSSandboxChannelPropsMixin(&CfnAPNSSandboxChannelMixinProps{
...
func (j *jsiiProxy_CfnAPNSSandboxChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAPNSSandboxChannelPropsMixin(props *CfnAPNSSandboxChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAPNSSandboxChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnAPNSSandboxChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::APNSSandboxChannel`.
func NewCfnAPNSSandboxChannelPropsMixin_Override(c CfnAPNSSandboxChannelPropsMixin, props *CfnAPNSSandboxChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAPNSSandboxChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
