...
//
//   cfnAPNSChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnAPNSChannelPropsMixin(&CfnAPNSChannelMixinProps{
...
func NewCfnAPNSChannelPropsMixin(props *CfnAPNSChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAPNSChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnAPNSChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::APNSChannel`.
func NewCfnAPNSChannelPropsMixin_Override(c CfnAPNSChannelPropsMixin, props *CfnAPNSChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
