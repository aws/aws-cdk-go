...
//
//   cfnBaiduChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnBaiduChannelPropsMixin(&CfnBaiduChannelMixinProps{
...
func (j *jsiiProxy_CfnBaiduChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBaiduChannelPropsMixin(props *CfnBaiduChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBaiduChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnBaiduChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::BaiduChannel`.
func NewCfnBaiduChannelPropsMixin_Override(c CfnBaiduChannelPropsMixin, props *CfnBaiduChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBaiduChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
