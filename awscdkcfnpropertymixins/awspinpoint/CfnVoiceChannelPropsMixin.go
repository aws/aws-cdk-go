...
//
//   cfnVoiceChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnVoiceChannelPropsMixin(&CfnVoiceChannelMixinProps{
...
func (j *jsiiProxy_CfnVoiceChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVoiceChannelPropsMixin(props *CfnVoiceChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVoiceChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnVoiceChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::VoiceChannel`.
func NewCfnVoiceChannelPropsMixin_Override(c CfnVoiceChannelPropsMixin, props *CfnVoiceChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVoiceChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
