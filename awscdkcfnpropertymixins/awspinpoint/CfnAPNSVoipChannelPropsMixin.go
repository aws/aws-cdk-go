...
//
//   cfnAPNSVoipChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnAPNSVoipChannelPropsMixin(&CfnAPNSVoipChannelMixinProps{
...
func NewCfnAPNSVoipChannelPropsMixin(props *CfnAPNSVoipChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAPNSVoipChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnAPNSVoipChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::APNSVoipChannel`.
func NewCfnAPNSVoipChannelPropsMixin_Override(c CfnAPNSVoipChannelPropsMixin, props *CfnAPNSVoipChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
