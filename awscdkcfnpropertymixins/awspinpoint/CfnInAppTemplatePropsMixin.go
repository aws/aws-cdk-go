...
//   var tags interface{}
//
//   cfnInAppTemplatePropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnInAppTemplatePropsMixin(&CfnInAppTemplateMixinProps{
//   	Content: []interface{}{
...
func NewCfnInAppTemplatePropsMixin(props *CfnInAppTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInAppTemplatePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnInAppTemplatePropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::InAppTemplate`.
func NewCfnInAppTemplatePropsMixin_Override(c CfnInAppTemplatePropsMixin, props *CfnInAppTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInAppTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
