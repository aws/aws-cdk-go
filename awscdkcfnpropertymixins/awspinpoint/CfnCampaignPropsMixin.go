...
//   var tags interface{}
//
//   cfnCampaignPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnCampaignPropsMixin(&CfnCampaignMixinProps{
...
func NewCfnCampaignPropsMixin(props *CfnCampaignMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCampaignPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnCampaignPropsMixin",
