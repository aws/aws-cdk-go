...
//
//   cfnEmailChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnEmailChannelPropsMixin(&CfnEmailChannelMixinProps{
...
func (j *jsiiProxy_CfnEmailChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEmailChannelPropsMixin(props *CfnEmailChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEmailChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnEmailChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::EmailChannel`.
func NewCfnEmailChannelPropsMixin_Override(c CfnEmailChannelPropsMixin, props *CfnEmailChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
