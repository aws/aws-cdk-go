...
//
//   cfnADMChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnADMChannelPropsMixin(&CfnADMChannelMixinProps{
...
func (j *jsiiProxy_CfnADMChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnADMChannelPropsMixin(props *CfnADMChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnADMChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnADMChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::ADMChannel`.
func NewCfnADMChannelPropsMixin_Override(c CfnADMChannelPropsMixin, props *CfnADMChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnADMChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
