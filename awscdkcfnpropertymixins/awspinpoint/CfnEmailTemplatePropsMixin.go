...
//   var tags interface{}
//
//   cfnEmailTemplatePropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnEmailTemplatePropsMixin(&CfnEmailTemplateMixinProps{
...
func (j *jsiiProxy_CfnEmailTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEmailTemplatePropsMixin(props *CfnEmailTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEmailTemplatePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnEmailTemplatePropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::EmailTemplate`.
func NewCfnEmailTemplatePropsMixin_Override(c CfnEmailTemplatePropsMixin, props *CfnEmailTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEmailTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
