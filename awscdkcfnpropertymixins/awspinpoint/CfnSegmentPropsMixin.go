...
//
//   cfnSegmentPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnSegmentPropsMixin(&CfnSegmentMixinProps{
...
func (j *jsiiProxy_CfnSegmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSegmentPropsMixin(props *CfnSegmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSegmentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnSegmentPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::Segment`.
func NewCfnSegmentPropsMixin_Override(c CfnSegmentPropsMixin, props *CfnSegmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
