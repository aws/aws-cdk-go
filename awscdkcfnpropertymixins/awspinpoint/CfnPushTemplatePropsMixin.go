...
//   var tags interface{}
//
//   cfnPushTemplatePropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnPushTemplatePropsMixin(&CfnPushTemplateMixinProps{
...
func NewCfnPushTemplatePropsMixin(props *CfnPushTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPushTemplatePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnPushTemplatePropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::PushTemplate`.
func NewCfnPushTemplatePropsMixin_Override(c CfnPushTemplatePropsMixin, props *CfnPushTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
