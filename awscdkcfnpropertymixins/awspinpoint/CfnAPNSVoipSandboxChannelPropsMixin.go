...
//
//   cfnAPNSVoipSandboxChannelPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnAPNSVoipSandboxChannelPropsMixin(&CfnAPNSVoipSandboxChannelMixinProps{
...
func (j *jsiiProxy_CfnAPNSVoipSandboxChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAPNSVoipSandboxChannelPropsMixin(props *CfnAPNSVoipSandboxChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAPNSVoipSandboxChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnAPNSVoipSandboxChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::Pinpoint::APNSVoipSandboxChannel`.
func NewCfnAPNSVoipSandboxChannelPropsMixin_Override(c CfnAPNSVoipSandboxChannelPropsMixin, props *CfnAPNSVoipSandboxChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAPNSVoipSandboxChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
