...
//
//   cfnEventStreamPropsMixin := awscdkcfnpropertymixins.Aws_pinpoint.NewCfnEventStreamPropsMixin(&CfnEventStreamMixinProps{
...
func NewCfnEventStreamPropsMixin(props *CfnEventStreamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventStreamPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_pinpoint.CfnEventStreamPropsMixin",
