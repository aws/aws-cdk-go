...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsvoiceid/internal"
...
//
//   cfnDomainPropsMixin := awscdkcfnpropertymixins.Aws_voiceid.NewCfnDomainPropsMixin(&CfnDomainMixinProps{
