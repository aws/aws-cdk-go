...
//
//   cfnAssetModelPropsMixin := awscdkcfnpropertymixins.Aws_iotsitewise.NewCfnAssetModelPropsMixin(&CfnAssetModelMixinProps{
...
func (j *jsiiProxy_CfnAssetModelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAssetModelPropsMixin(props *CfnAssetModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAssetModelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTSiteWise::AssetModel`.
func NewCfnAssetModelPropsMixin_Override(c CfnAssetModelPropsMixin, props *CfnAssetModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAssetModelPropsMixin) ApplyTo(construct constructs.IConstruct) {
