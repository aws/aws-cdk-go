...
//
//   cfnWorkspacePropsMixin := awscdkcfnpropertymixins.Aws_iotsitewise.NewCfnWorkspacePropsMixin(&CfnWorkspaceMixinProps{
...
// Create a mixin to apply properties to `AWS::IoTSiteWise::Workspace`.
