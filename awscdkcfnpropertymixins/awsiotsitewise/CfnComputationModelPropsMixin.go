...
//
//   cfnComputationModelPropsMixin := awscdkcfnpropertymixins.Aws_iotsitewise.NewCfnComputationModelPropsMixin(&CfnComputationModelMixinProps{
...
func (j *jsiiProxy_CfnComputationModelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnComputationModelPropsMixin(props *CfnComputationModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComputationModelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTSiteWise::ComputationModel`.
func NewCfnComputationModelPropsMixin_Override(c CfnComputationModelPropsMixin, props *CfnComputationModelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
