...
//
//   cfnTaskPropsMixin := awscdkcfnpropertymixins.Aws_iotsitewise.NewCfnTaskPropsMixin(&CfnTaskMixinProps{
...
// Create a mixin to apply properties to `AWS::IoTSiteWise::Task`.
func NewCfnTaskPropsMixin(props *CfnTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTaskPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTSiteWise::Task`.
func NewCfnTaskPropsMixin_Override(c CfnTaskPropsMixin, props *CfnTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
