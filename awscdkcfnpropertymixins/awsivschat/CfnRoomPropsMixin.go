...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsivschat/internal"
...
//
//   cfnRoomPropsMixin := awscdkcfnpropertymixins.Aws_ivschat.NewCfnRoomPropsMixin(&CfnRoomMixinProps{
...
func (j *jsiiProxy_CfnRoomPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoomPropsMixin(props *CfnRoomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoomPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVSChat::Room`.
func NewCfnRoomPropsMixin_Override(c CfnRoomPropsMixin, props *CfnRoomMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRoomPropsMixin) ApplyTo(construct constructs.IConstruct) {
