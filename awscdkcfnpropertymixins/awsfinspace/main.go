...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_finspace.CfnEnvironmentMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_finspace.CfnEnvironmentPropsMixin.AttributeMapItemsProperty",
		reflect.TypeOf((*CfnEnvironmentPropsMixin_AttributeMapItemsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_finspace.CfnEnvironmentPropsMixin.FederationParametersProperty",
		reflect.TypeOf((*CfnEnvironmentPropsMixin_FederationParametersProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_finspace.CfnEnvironmentPropsMixin.SuperuserParametersProperty",
