...
//
//   cfnDataRepositoryAssociationPropsMixin := awscdkcfnpropertymixins.Aws_fsx.NewCfnDataRepositoryAssociationPropsMixin(&CfnDataRepositoryAssociationMixinProps{
...
func NewCfnDataRepositoryAssociationPropsMixin(props *CfnDataRepositoryAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataRepositoryAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FSx::DataRepositoryAssociation`.
func NewCfnDataRepositoryAssociationPropsMixin_Override(c CfnDataRepositoryAssociationPropsMixin, props *CfnDataRepositoryAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
