...
//
//   cfnS3AccessPointAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_fsx.NewCfnS3AccessPointAttachmentPropsMixin(&CfnS3AccessPointAttachmentMixinProps{
...
func NewCfnS3AccessPointAttachmentPropsMixin(props *CfnS3AccessPointAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnS3AccessPointAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FSx::S3AccessPointAttachment`.
func NewCfnS3AccessPointAttachmentPropsMixin_Override(c CfnS3AccessPointAttachmentPropsMixin, props *CfnS3AccessPointAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
