...
func NewCfnBotPropsMixin(props *CfnBotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBotPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lex::Bot`.
func NewCfnBotPropsMixin_Override(c CfnBotPropsMixin, props *CfnBotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
