...
//
//   cfnBotAliasPropsMixin := awscdkcfnpropertymixins.Aws_lex.NewCfnBotAliasPropsMixin(&CfnBotAliasMixinProps{
...
func NewCfnBotAliasPropsMixin(props *CfnBotAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBotAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lex::BotAlias`.
func NewCfnBotAliasPropsMixin_Override(c CfnBotAliasPropsMixin, props *CfnBotAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
