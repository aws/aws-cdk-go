...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awslex/internal"
...
//
//   cfnBotVersionPropsMixin := awscdkcfnpropertymixins.Aws_lex.NewCfnBotVersionPropsMixin(&CfnBotVersionMixinProps{
...
func NewCfnBotVersionPropsMixin(props *CfnBotVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBotVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lex::BotVersion`.
func NewCfnBotVersionPropsMixin_Override(c CfnBotVersionPropsMixin, props *CfnBotVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
