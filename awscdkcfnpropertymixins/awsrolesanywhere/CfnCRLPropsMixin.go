...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsrolesanywhere/internal"
...
//
//   cfnCRLPropsMixin := awscdkcfnpropertymixins.Aws_rolesanywhere.NewCfnCRLPropsMixin(&CfnCRLMixinProps{
...
func (j *jsiiProxy_CfnCRLPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCRLPropsMixin(props *CfnCRLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCRLPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RolesAnywhere::CRL`.
func NewCfnCRLPropsMixin_Override(c CfnCRLPropsMixin, props *CfnCRLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCRLPropsMixin) ApplyTo(construct constructs.IConstruct) {
