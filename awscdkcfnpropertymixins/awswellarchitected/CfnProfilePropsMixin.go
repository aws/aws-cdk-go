...
//
//   cfnProfilePropsMixin := awscdkcfnpropertymixins.Aws_wellarchitected.NewCfnProfilePropsMixin(&CfnProfileMixinProps{
...
// Create a mixin to apply properties to `AWS::WellArchitected::Profile`.
