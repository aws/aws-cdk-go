...
//
//   cfnCalculatedAttributeDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_customerprofiles.NewCfnCalculatedAttributeDefinitionPropsMixin(&CfnCalculatedAttributeDefinitionMixinProps{
...
func (j *jsiiProxy_CfnCalculatedAttributeDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCalculatedAttributeDefinitionPropsMixin(props *CfnCalculatedAttributeDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCalculatedAttributeDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CustomerProfiles::CalculatedAttributeDefinition`.
func NewCfnCalculatedAttributeDefinitionPropsMixin_Override(c CfnCalculatedAttributeDefinitionPropsMixin, props *CfnCalculatedAttributeDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
