...
//
//   cfnSegmentDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_customerprofiles.NewCfnSegmentDefinitionPropsMixin(&CfnSegmentDefinitionMixinProps{
...
func NewCfnSegmentDefinitionPropsMixin(props *CfnSegmentDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSegmentDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CustomerProfiles::SegmentDefinition`.
func NewCfnSegmentDefinitionPropsMixin_Override(c CfnSegmentDefinitionPropsMixin, props *CfnSegmentDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
