...
//
//   cfnObjectTypePropsMixin := awscdkcfnpropertymixins.Aws_customerprofiles.NewCfnObjectTypePropsMixin(&CfnObjectTypeMixinProps{
...
func NewCfnObjectTypePropsMixin(props *CfnObjectTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnObjectTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CustomerProfiles::ObjectType`.
func NewCfnObjectTypePropsMixin_Override(c CfnObjectTypePropsMixin, props *CfnObjectTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
