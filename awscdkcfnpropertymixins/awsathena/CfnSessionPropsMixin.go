...
//
//   cfnSessionPropsMixin := awscdkcfnpropertymixins.Aws_athena.NewCfnSessionPropsMixin(&CfnSessionMixinProps{
...
// Create a mixin to apply properties to `AWS::Athena::Session`.
