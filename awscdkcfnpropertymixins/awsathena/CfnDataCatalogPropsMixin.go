...
//
//   cfnDataCatalogPropsMixin := awscdkcfnpropertymixins.Aws_athena.NewCfnDataCatalogPropsMixin(&CfnDataCatalogMixinProps{
...
func (j *jsiiProxy_CfnDataCatalogPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataCatalogPropsMixin(props *CfnDataCatalogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataCatalogPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Athena::DataCatalog`.
func NewCfnDataCatalogPropsMixin_Override(c CfnDataCatalogPropsMixin, props *CfnDataCatalogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataCatalogPropsMixin) ApplyTo(construct constructs.IConstruct) {
