...
//
//   cfnNamedQueryPropsMixin := awscdkcfnpropertymixins.Aws_athena.NewCfnNamedQueryPropsMixin(&CfnNamedQueryMixinProps{
...
func (j *jsiiProxy_CfnNamedQueryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNamedQueryPropsMixin(props *CfnNamedQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNamedQueryPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_athena.CfnNamedQueryPropsMixin",
...
// Create a mixin to apply properties to `AWS::Athena::NamedQuery`.
func NewCfnNamedQueryPropsMixin_Override(c CfnNamedQueryPropsMixin, props *CfnNamedQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNamedQueryPropsMixin) ApplyTo(construct constructs.IConstruct) {
