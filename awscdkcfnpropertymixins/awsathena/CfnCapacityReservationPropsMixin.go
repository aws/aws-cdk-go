...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsathena/internal"
...
//
//   cfnCapacityReservationPropsMixin := awscdkcfnpropertymixins.Aws_athena.NewCfnCapacityReservationPropsMixin(&CfnCapacityReservationMixinProps{
...
func (j *jsiiProxy_CfnCapacityReservationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCapacityReservationPropsMixin(props *CfnCapacityReservationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCapacityReservationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_athena.CfnCapacityReservationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Athena::CapacityReservation`.
func NewCfnCapacityReservationPropsMixin_Override(c CfnCapacityReservationPropsMixin, props *CfnCapacityReservationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCapacityReservationPropsMixin) ApplyTo(construct constructs.IConstruct) {
