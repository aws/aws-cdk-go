...
//
//   cfnHostedConfigurationVersionPropsMixin := awscdkcfnpropertymixins.Aws_appconfig.NewCfnHostedConfigurationVersionPropsMixin(&CfnHostedConfigurationVersionMixinProps{
...
func (j *jsiiProxy_CfnHostedConfigurationVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHostedConfigurationVersionPropsMixin(props *CfnHostedConfigurationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHostedConfigurationVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppConfig::HostedConfigurationVersion`.
func NewCfnHostedConfigurationVersionPropsMixin_Override(c CfnHostedConfigurationVersionPropsMixin, props *CfnHostedConfigurationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHostedConfigurationVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
