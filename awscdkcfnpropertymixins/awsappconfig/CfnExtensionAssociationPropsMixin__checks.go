...
func validateNewCfnExtensionAssociationPropsMixinParameters(props *CfnExtensionAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
