...
//
//   cfnDeploymentStrategyPropsMixin := awscdkcfnpropertymixins.Aws_appconfig.NewCfnDeploymentStrategyPropsMixin(&CfnDeploymentStrategyMixinProps{
...
func NewCfnDeploymentStrategyPropsMixin(props *CfnDeploymentStrategyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentStrategyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppConfig::DeploymentStrategy`.
func NewCfnDeploymentStrategyPropsMixin_Override(c CfnDeploymentStrategyPropsMixin, props *CfnDeploymentStrategyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
