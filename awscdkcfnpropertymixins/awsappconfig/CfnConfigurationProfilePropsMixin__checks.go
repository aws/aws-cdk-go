...
func validateNewCfnConfigurationProfilePropsMixinParameters(props *CfnConfigurationProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
