...
//
//   cfnConfigurationProfilePropsMixin := awscdkcfnpropertymixins.Aws_appconfig.NewCfnConfigurationProfilePropsMixin(&CfnConfigurationProfileMixinProps{
...
func (j *jsiiProxy_CfnConfigurationProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConfigurationProfilePropsMixin(props *CfnConfigurationProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppConfig::ConfigurationProfile`.
func NewCfnConfigurationProfilePropsMixin_Override(c CfnConfigurationProfilePropsMixin, props *CfnConfigurationProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
