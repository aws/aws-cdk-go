...
//
//   cfnLifecycleHookPropsMixin := awscdkcfnpropertymixins.Aws_autoscaling.NewCfnLifecycleHookPropsMixin(&CfnLifecycleHookMixinProps{
...
func NewCfnLifecycleHookPropsMixin(props *CfnLifecycleHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLifecycleHookPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScaling::LifecycleHook`.
func NewCfnLifecycleHookPropsMixin_Override(c CfnLifecycleHookPropsMixin, props *CfnLifecycleHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
