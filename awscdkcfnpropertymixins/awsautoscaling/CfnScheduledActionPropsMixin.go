...
//
//   cfnScheduledActionPropsMixin := awscdkcfnpropertymixins.Aws_autoscaling.NewCfnScheduledActionPropsMixin(&CfnScheduledActionMixinProps{
...
func NewCfnScheduledActionPropsMixin(props *CfnScheduledActionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScheduledActionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScaling::ScheduledAction`.
func NewCfnScheduledActionPropsMixin_Override(c CfnScheduledActionPropsMixin, props *CfnScheduledActionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
