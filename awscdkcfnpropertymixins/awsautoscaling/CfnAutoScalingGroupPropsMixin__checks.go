...
func validateNewCfnAutoScalingGroupPropsMixinParameters(props *CfnAutoScalingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
