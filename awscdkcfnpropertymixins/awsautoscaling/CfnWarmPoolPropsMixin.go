...
//
//   cfnWarmPoolPropsMixin := awscdkcfnpropertymixins.Aws_autoscaling.NewCfnWarmPoolPropsMixin(&CfnWarmPoolMixinProps{
...
func (j *jsiiProxy_CfnWarmPoolPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWarmPoolPropsMixin(props *CfnWarmPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWarmPoolPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScaling::WarmPool`.
func NewCfnWarmPoolPropsMixin_Override(c CfnWarmPoolPropsMixin, props *CfnWarmPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWarmPoolPropsMixin) ApplyTo(construct constructs.IConstruct) {
