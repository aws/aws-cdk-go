...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsautoscaling/internal"
...
//
//   cfnLaunchConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_autoscaling.NewCfnLaunchConfigurationPropsMixin(&CfnLaunchConfigurationMixinProps{
...
func NewCfnLaunchConfigurationPropsMixin(props *CfnLaunchConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLaunchConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScaling::LaunchConfiguration`.
func NewCfnLaunchConfigurationPropsMixin_Override(c CfnLaunchConfigurationPropsMixin, props *CfnLaunchConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLaunchConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
