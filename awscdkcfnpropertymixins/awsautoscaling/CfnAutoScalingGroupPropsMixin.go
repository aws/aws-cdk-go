...
//
//   cfnAutoScalingGroupPropsMixin := awscdkcfnpropertymixins.Aws_autoscaling.NewCfnAutoScalingGroupPropsMixin(&CfnAutoScalingGroupMixinProps{
...
func NewCfnAutoScalingGroupPropsMixin(props *CfnAutoScalingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAutoScalingGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScaling::AutoScalingGroup`.
func NewCfnAutoScalingGroupPropsMixin_Override(c CfnAutoScalingGroupPropsMixin, props *CfnAutoScalingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAutoScalingGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
