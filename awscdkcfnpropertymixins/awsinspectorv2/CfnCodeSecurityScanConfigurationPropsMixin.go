...
//
//   cfnCodeSecurityScanConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_inspectorv2.NewCfnCodeSecurityScanConfigurationPropsMixin(&CfnCodeSecurityScanConfigurationMixinProps{
...
func (j *jsiiProxy_CfnCodeSecurityScanConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCodeSecurityScanConfigurationPropsMixin(props *CfnCodeSecurityScanConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCodeSecurityScanConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::InspectorV2::CodeSecurityScanConfiguration`.
func NewCfnCodeSecurityScanConfigurationPropsMixin_Override(c CfnCodeSecurityScanConfigurationPropsMixin, props *CfnCodeSecurityScanConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCodeSecurityScanConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
