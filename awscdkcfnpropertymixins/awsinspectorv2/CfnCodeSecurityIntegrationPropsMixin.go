...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsinspectorv2/internal"
...
//
//   cfnCodeSecurityIntegrationPropsMixin := awscdkcfnpropertymixins.Aws_inspectorv2.NewCfnCodeSecurityIntegrationPropsMixin(&CfnCodeSecurityIntegrationMixinProps{
...
func NewCfnCodeSecurityIntegrationPropsMixin(props *CfnCodeSecurityIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCodeSecurityIntegrationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::InspectorV2::CodeSecurityIntegration`.
func NewCfnCodeSecurityIntegrationPropsMixin_Override(c CfnCodeSecurityIntegrationPropsMixin, props *CfnCodeSecurityIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCodeSecurityIntegrationPropsMixin) ApplyTo(construct constructs.IConstruct) {
