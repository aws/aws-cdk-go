...
//
//   cfnConnectorPropsMixin := awscdkcfnpropertymixins.Aws_inspectorv2.NewCfnConnectorPropsMixin(&CfnConnectorMixinProps{
...
// Create a mixin to apply properties to `AWS::InspectorV2::Connector`.
