...
//
//   cfnCisScanConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_inspectorv2.NewCfnCisScanConfigurationPropsMixin(&CfnCisScanConfigurationMixinProps{
...
func (j *jsiiProxy_CfnCisScanConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCisScanConfigurationPropsMixin(props *CfnCisScanConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCisScanConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::InspectorV2::CisScanConfiguration`.
func NewCfnCisScanConfigurationPropsMixin_Override(c CfnCisScanConfigurationPropsMixin, props *CfnCisScanConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
