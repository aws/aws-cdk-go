...
//
//   cfnFilterPropsMixin := awscdkcfnpropertymixins.Aws_inspectorv2.NewCfnFilterPropsMixin(&CfnFilterMixinProps{
...
func NewCfnFilterPropsMixin(props *CfnFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFilterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::InspectorV2::Filter`.
func NewCfnFilterPropsMixin_Override(c CfnFilterPropsMixin, props *CfnFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
