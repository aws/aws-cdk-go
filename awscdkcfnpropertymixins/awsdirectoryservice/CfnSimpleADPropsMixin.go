...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsdirectoryservice/internal"
...
//
//   cfnSimpleADPropsMixin := awscdkcfnpropertymixins.Aws_directoryservice.NewCfnSimpleADPropsMixin(&CfnSimpleADMixinProps{
...
func (j *jsiiProxy_CfnSimpleADPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSimpleADPropsMixin(props *CfnSimpleADMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSimpleADPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DirectoryService::SimpleAD`.
func NewCfnSimpleADPropsMixin_Override(c CfnSimpleADPropsMixin, props *CfnSimpleADMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSimpleADPropsMixin) ApplyTo(construct constructs.IConstruct) {
