...
//
//   cfnMicrosoftADPropsMixin := awscdkcfnpropertymixins.Aws_directoryservice.NewCfnMicrosoftADPropsMixin(&CfnMicrosoftADMixinProps{
...
func (j *jsiiProxy_CfnMicrosoftADPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMicrosoftADPropsMixin(props *CfnMicrosoftADMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMicrosoftADPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DirectoryService::MicrosoftAD`.
func NewCfnMicrosoftADPropsMixin_Override(c CfnMicrosoftADPropsMixin, props *CfnMicrosoftADMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMicrosoftADPropsMixin) ApplyTo(construct constructs.IConstruct) {
