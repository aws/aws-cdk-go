...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awslaunchwizard/internal"
...
//
//   cfnDeploymentPropsMixin := awscdkcfnpropertymixins.Aws_launchwizard.NewCfnDeploymentPropsMixin(&CfnDeploymentMixinProps{
...
func NewCfnDeploymentPropsMixin(props *CfnDeploymentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_launchwizard.CfnDeploymentPropsMixin",
