...
//
//   cfnRulesetPropsMixin := awscdkcfnpropertymixins.Aws_databrew.NewCfnRulesetPropsMixin(&CfnRulesetMixinProps{
...
func (j *jsiiProxy_CfnRulesetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRulesetPropsMixin(props *CfnRulesetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRulesetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataBrew::Ruleset`.
func NewCfnRulesetPropsMixin_Override(c CfnRulesetPropsMixin, props *CfnRulesetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRulesetPropsMixin) ApplyTo(construct constructs.IConstruct) {
