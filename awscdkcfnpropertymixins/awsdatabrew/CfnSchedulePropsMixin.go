...
//
//   cfnSchedulePropsMixin := awscdkcfnpropertymixins.Aws_databrew.NewCfnSchedulePropsMixin(&CfnScheduleMixinProps{
...
func (j *jsiiProxy_CfnSchedulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSchedulePropsMixin(props *CfnScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchedulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataBrew::Schedule`.
func NewCfnSchedulePropsMixin_Override(c CfnSchedulePropsMixin, props *CfnScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSchedulePropsMixin) ApplyTo(construct constructs.IConstruct) {
