...
//
//   cfnPackagingGroupPropsMixin := awscdkcfnpropertymixins.Aws_mediapackage.NewCfnPackagingGroupPropsMixin(&CfnPackagingGroupMixinProps{
...
func NewCfnPackagingGroupPropsMixin(props *CfnPackagingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPackagingGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaPackage::PackagingGroup`.
func NewCfnPackagingGroupPropsMixin_Override(c CfnPackagingGroupPropsMixin, props *CfnPackagingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
