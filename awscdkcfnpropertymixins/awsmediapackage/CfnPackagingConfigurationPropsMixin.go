...
//
//   cfnPackagingConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_mediapackage.NewCfnPackagingConfigurationPropsMixin(&CfnPackagingConfigurationMixinProps{
...
func NewCfnPackagingConfigurationPropsMixin(props *CfnPackagingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPackagingConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaPackage::PackagingConfiguration`.
func NewCfnPackagingConfigurationPropsMixin_Override(c CfnPackagingConfigurationPropsMixin, props *CfnPackagingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
