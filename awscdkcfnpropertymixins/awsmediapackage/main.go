...
func init() {
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mediapackage.CfnHarvestJobMixinProps",
		reflect.TypeOf((*CfnHarvestJobMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_mediapackage.CfnHarvestJobPropsMixin",
		reflect.TypeOf((*CfnHarvestJobPropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "applyTo", GoMethod: "ApplyTo"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "strategy", GoGetter: "Strategy"},
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mediapackage.CfnHarvestJobPropsMixin.S3DestinationProperty",
		reflect.TypeOf((*CfnHarvestJobPropsMixin_S3DestinationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
