...
//
//   cfnAgentStatusPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnAgentStatusPropsMixin(&CfnAgentStatusMixinProps{
...
func NewCfnAgentStatusPropsMixin(props *CfnAgentStatusMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAgentStatusPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::AgentStatus`.
func NewCfnAgentStatusPropsMixin_Override(c CfnAgentStatusPropsMixin, props *CfnAgentStatusMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAgentStatusPropsMixin) ApplyTo(construct constructs.IConstruct) {
