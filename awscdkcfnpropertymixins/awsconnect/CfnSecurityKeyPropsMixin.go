...
//
//   cfnSecurityKeyPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnSecurityKeyPropsMixin(&CfnSecurityKeyMixinProps{
...
func (j *jsiiProxy_CfnSecurityKeyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecurityKeyPropsMixin(props *CfnSecurityKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityKeyPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_connect.CfnSecurityKeyPropsMixin",
...
// Create a mixin to apply properties to `AWS::Connect::SecurityKey`.
func NewCfnSecurityKeyPropsMixin_Override(c CfnSecurityKeyPropsMixin, props *CfnSecurityKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSecurityKeyPropsMixin) ApplyTo(construct constructs.IConstruct) {
