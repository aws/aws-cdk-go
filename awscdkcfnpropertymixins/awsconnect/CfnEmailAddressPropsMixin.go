...
//
//   cfnEmailAddressPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnEmailAddressPropsMixin(&CfnEmailAddressMixinProps{
...
func NewCfnEmailAddressPropsMixin(props *CfnEmailAddressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEmailAddressPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::EmailAddress`.
func NewCfnEmailAddressPropsMixin_Override(c CfnEmailAddressPropsMixin, props *CfnEmailAddressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
