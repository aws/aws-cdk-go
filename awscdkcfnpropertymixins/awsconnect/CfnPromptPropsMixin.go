...
//
//   cfnPromptPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnPromptPropsMixin(&CfnPromptMixinProps{
...
func (j *jsiiProxy_CfnPromptPropsMixin) Strategy() awscdk.IMergeStrategy {
...
// Create a mixin to apply properties to `AWS::Connect::Prompt`.
func NewCfnPromptPropsMixin(props *CfnPromptMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPromptPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_connect.CfnPromptPropsMixin",
...
// Create a mixin to apply properties to `AWS::Connect::Prompt`.
func NewCfnPromptPropsMixin_Override(c CfnPromptPropsMixin, props *CfnPromptMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPromptPropsMixin) ApplyTo(construct constructs.IConstruct) {
