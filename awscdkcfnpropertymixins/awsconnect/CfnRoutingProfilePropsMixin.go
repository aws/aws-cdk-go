...
//
//   cfnRoutingProfilePropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnRoutingProfilePropsMixin(&CfnRoutingProfileMixinProps{
...
func (j *jsiiProxy_CfnRoutingProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoutingProfilePropsMixin(props *CfnRoutingProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoutingProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::RoutingProfile`.
func NewCfnRoutingProfilePropsMixin_Override(c CfnRoutingProfilePropsMixin, props *CfnRoutingProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRoutingProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
