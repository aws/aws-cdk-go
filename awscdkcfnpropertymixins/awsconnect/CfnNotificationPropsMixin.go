...
//
//   cfnNotificationPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnNotificationPropsMixin(&CfnNotificationMixinProps{
...
func (j *jsiiProxy_CfnNotificationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNotificationPropsMixin(props *CfnNotificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNotificationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::Notification`.
func NewCfnNotificationPropsMixin_Override(c CfnNotificationPropsMixin, props *CfnNotificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
