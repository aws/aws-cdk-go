...
//
//   cfnTaskTemplatePropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnTaskTemplatePropsMixin(&CfnTaskTemplateMixinProps{
...
func (j *jsiiProxy_CfnTaskTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTaskTemplatePropsMixin(props *CfnTaskTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTaskTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::TaskTemplate`.
func NewCfnTaskTemplatePropsMixin_Override(c CfnTaskTemplatePropsMixin, props *CfnTaskTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
