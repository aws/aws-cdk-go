...
//
//   cfnContactFlowPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnContactFlowPropsMixin(&CfnContactFlowMixinProps{
...
func (j *jsiiProxy_CfnContactFlowPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnContactFlowPropsMixin(props *CfnContactFlowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnContactFlowPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_connect.CfnContactFlowPropsMixin",
...
// Create a mixin to apply properties to `AWS::Connect::ContactFlow`.
func NewCfnContactFlowPropsMixin_Override(c CfnContactFlowPropsMixin, props *CfnContactFlowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
