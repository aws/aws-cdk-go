...
func validateNewCfnContactFlowModulePropsMixinParameters(props *CfnContactFlowModuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
