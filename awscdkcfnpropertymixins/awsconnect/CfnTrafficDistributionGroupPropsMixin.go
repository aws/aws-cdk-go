...
//
//   cfnTrafficDistributionGroupPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnTrafficDistributionGroupPropsMixin(&CfnTrafficDistributionGroupMixinProps{
...
func (j *jsiiProxy_CfnTrafficDistributionGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrafficDistributionGroupPropsMixin(props *CfnTrafficDistributionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrafficDistributionGroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_connect.CfnTrafficDistributionGroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::Connect::TrafficDistributionGroup`.
func NewCfnTrafficDistributionGroupPropsMixin_Override(c CfnTrafficDistributionGroupPropsMixin, props *CfnTrafficDistributionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTrafficDistributionGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
