...
//
//   cfnEvaluationFormPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnEvaluationFormPropsMixin(&CfnEvaluationFormMixinProps{
...
func NewCfnEvaluationFormPropsMixin(props *CfnEvaluationFormMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEvaluationFormPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::EvaluationForm`.
func NewCfnEvaluationFormPropsMixin_Override(c CfnEvaluationFormPropsMixin, props *CfnEvaluationFormMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
