...
func validateNewCfnIntegrationAssociationPropsMixinParameters(props *CfnIntegrationAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
