...
//
//   cfnIntegrationAssociationPropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnIntegrationAssociationPropsMixin(&CfnIntegrationAssociationMixinProps{
...
func (j *jsiiProxy_CfnIntegrationAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIntegrationAssociationPropsMixin(props *CfnIntegrationAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIntegrationAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_connect.CfnIntegrationAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Connect::IntegrationAssociation`.
func NewCfnIntegrationAssociationPropsMixin_Override(c CfnIntegrationAssociationPropsMixin, props *CfnIntegrationAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIntegrationAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
