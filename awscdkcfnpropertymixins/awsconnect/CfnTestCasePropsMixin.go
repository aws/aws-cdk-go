...
//
//   cfnTestCasePropsMixin := awscdkcfnpropertymixins.Aws_connect.NewCfnTestCasePropsMixin(&CfnTestCaseMixinProps{
...
func (j *jsiiProxy_CfnTestCasePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTestCasePropsMixin(props *CfnTestCaseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTestCasePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Connect::TestCase`.
func NewCfnTestCasePropsMixin_Override(c CfnTestCasePropsMixin, props *CfnTestCaseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTestCasePropsMixin) ApplyTo(construct constructs.IConstruct) {
