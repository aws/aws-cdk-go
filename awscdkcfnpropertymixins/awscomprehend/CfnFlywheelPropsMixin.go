...
//
//   cfnFlywheelPropsMixin := awscdkcfnpropertymixins.Aws_comprehend.NewCfnFlywheelPropsMixin(&CfnFlywheelMixinProps{
...
func NewCfnFlywheelPropsMixin(props *CfnFlywheelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlywheelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Comprehend::Flywheel`.
func NewCfnFlywheelPropsMixin_Override(c CfnFlywheelPropsMixin, props *CfnFlywheelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
