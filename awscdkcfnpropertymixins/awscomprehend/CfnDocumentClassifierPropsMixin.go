...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscomprehend/internal"
...
//
//   cfnDocumentClassifierPropsMixin := awscdkcfnpropertymixins.Aws_comprehend.NewCfnDocumentClassifierPropsMixin(&CfnDocumentClassifierMixinProps{
...
func NewCfnDocumentClassifierPropsMixin(props *CfnDocumentClassifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDocumentClassifierPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Comprehend::DocumentClassifier`.
func NewCfnDocumentClassifierPropsMixin_Override(c CfnDocumentClassifierPropsMixin, props *CfnDocumentClassifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
