...
//
//   cfnArtifactPropsMixin := awscdkcfnpropertymixins.Aws_securityagent.NewCfnArtifactPropsMixin(&CfnArtifactMixinProps{
...
// Create a mixin to apply properties to `AWS::SecurityAgent::Artifact`.
