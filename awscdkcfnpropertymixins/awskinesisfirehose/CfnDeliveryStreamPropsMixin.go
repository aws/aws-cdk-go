...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awskinesisfirehose/internal"
...
func NewCfnDeliveryStreamPropsMixin(props *CfnDeliveryStreamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeliveryStreamPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::KinesisFirehose::DeliveryStream`.
func NewCfnDeliveryStreamPropsMixin_Override(c CfnDeliveryStreamPropsMixin, props *CfnDeliveryStreamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
