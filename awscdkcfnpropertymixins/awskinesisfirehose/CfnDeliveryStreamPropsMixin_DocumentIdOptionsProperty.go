...
//
type CfnDeliveryStreamPropsMixin_DocumentIdOptionsProperty struct {
	...
	//
	DefaultDocumentIdFormat *string `field:"optional" json:"defaultDocumentIdFormat" yaml:"defaultDocumentIdFormat"`
}
