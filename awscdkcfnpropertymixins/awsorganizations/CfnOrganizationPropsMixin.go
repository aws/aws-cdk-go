...
//
//   cfnOrganizationPropsMixin := awscdkcfnpropertymixins.Aws_organizations.NewCfnOrganizationPropsMixin(&CfnOrganizationMixinProps{
...
func (j *jsiiProxy_CfnOrganizationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOrganizationPropsMixin(props *CfnOrganizationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOrganizationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_organizations.CfnOrganizationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Organizations::Organization`.
func NewCfnOrganizationPropsMixin_Override(c CfnOrganizationPropsMixin, props *CfnOrganizationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
