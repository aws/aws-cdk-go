...
//
//   cfnPlaybackKeyPairPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnPlaybackKeyPairPropsMixin(&CfnPlaybackKeyPairMixinProps{
...
func (j *jsiiProxy_CfnPlaybackKeyPairPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPlaybackKeyPairPropsMixin(props *CfnPlaybackKeyPairMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlaybackKeyPairPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::PlaybackKeyPair`.
func NewCfnPlaybackKeyPairPropsMixin_Override(c CfnPlaybackKeyPairPropsMixin, props *CfnPlaybackKeyPairMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
