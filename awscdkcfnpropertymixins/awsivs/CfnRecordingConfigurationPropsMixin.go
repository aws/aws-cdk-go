...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsivs/internal"
...
//
//   cfnRecordingConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnRecordingConfigurationPropsMixin(&CfnRecordingConfigurationMixinProps{
...
func (j *jsiiProxy_CfnRecordingConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRecordingConfigurationPropsMixin(props *CfnRecordingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRecordingConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::RecordingConfiguration`.
func NewCfnRecordingConfigurationPropsMixin_Override(c CfnRecordingConfigurationPropsMixin, props *CfnRecordingConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRecordingConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
