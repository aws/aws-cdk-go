...
//
//   cfnStreamKeyPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnStreamKeyPropsMixin(&CfnStreamKeyMixinProps{
...
func (j *jsiiProxy_CfnStreamKeyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStreamKeyPropsMixin(props *CfnStreamKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamKeyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::StreamKey`.
func NewCfnStreamKeyPropsMixin_Override(c CfnStreamKeyPropsMixin, props *CfnStreamKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
