...
//
//   cfnIngestConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnIngestConfigurationPropsMixin(&CfnIngestConfigurationMixinProps{
...
func (j *jsiiProxy_CfnIngestConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIngestConfigurationPropsMixin(props *CfnIngestConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIngestConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::IngestConfiguration`.
func NewCfnIngestConfigurationPropsMixin_Override(c CfnIngestConfigurationPropsMixin, props *CfnIngestConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIngestConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
