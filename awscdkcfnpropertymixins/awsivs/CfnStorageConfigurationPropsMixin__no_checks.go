...
func validateNewCfnStorageConfigurationPropsMixinParameters(props *CfnStorageConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
