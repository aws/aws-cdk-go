...
//
//   cfnStorageConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnStorageConfigurationPropsMixin(&CfnStorageConfigurationMixinProps{
...
func (j *jsiiProxy_CfnStorageConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStorageConfigurationPropsMixin(props *CfnStorageConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStorageConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::StorageConfiguration`.
func NewCfnStorageConfigurationPropsMixin_Override(c CfnStorageConfigurationPropsMixin, props *CfnStorageConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStorageConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
