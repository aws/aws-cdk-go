...
//
//   cfnPlaybackRestrictionPolicyPropsMixin := awscdkcfnpropertymixins.Aws_ivs.NewCfnPlaybackRestrictionPolicyPropsMixin(&CfnPlaybackRestrictionPolicyMixinProps{
...
func NewCfnPlaybackRestrictionPolicyPropsMixin(props *CfnPlaybackRestrictionPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlaybackRestrictionPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IVS::PlaybackRestrictionPolicy`.
func NewCfnPlaybackRestrictionPolicyPropsMixin_Override(c CfnPlaybackRestrictionPolicyPropsMixin, props *CfnPlaybackRestrictionPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
