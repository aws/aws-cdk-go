...
//
//   cfnChallengePropsMixin := awscdkcfnpropertymixins.Aws_pcaconnectorscep.NewCfnChallengePropsMixin(&CfnChallengeMixinProps{
...
func (j *jsiiProxy_CfnChallengePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnChallengePropsMixin(props *CfnChallengeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnChallengePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::PCAConnectorSCEP::Challenge`.
func NewCfnChallengePropsMixin_Override(c CfnChallengePropsMixin, props *CfnChallengeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
