...
//
//   cfnAssociationPropsMixin := awscdkcfnpropertymixins.Aws_devopsagent.NewCfnAssociationPropsMixin(&CfnAssociationMixinProps{
...
func (j *jsiiProxy_CfnAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAssociationPropsMixin(props *CfnAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DevOpsAgent::Association`.
func NewCfnAssociationPropsMixin_Override(c CfnAssociationPropsMixin, props *CfnAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
