...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsqldb/internal"
...
//
//   cfnLedgerPropsMixin := awscdkcfnpropertymixins.Aws_qldb.NewCfnLedgerPropsMixin(&CfnLedgerMixinProps{
...
func (j *jsiiProxy_CfnLedgerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLedgerPropsMixin(props *CfnLedgerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLedgerPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_qldb.CfnLedgerPropsMixin",
...
// Create a mixin to apply properties to `AWS::QLDB::Ledger`.
func NewCfnLedgerPropsMixin_Override(c CfnLedgerPropsMixin, props *CfnLedgerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
