...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsproton/internal"
...
//
//   cfnEnvironmentAccountConnectionPropsMixin := awscdkcfnpropertymixins.Aws_proton.NewCfnEnvironmentAccountConnectionPropsMixin(&CfnEnvironmentAccountConnectionMixinProps{
...
func (j *jsiiProxy_CfnEnvironmentAccountConnectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEnvironmentAccountConnectionPropsMixin(props *CfnEnvironmentAccountConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnvironmentAccountConnectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Proton::EnvironmentAccountConnection`.
func NewCfnEnvironmentAccountConnectionPropsMixin_Override(c CfnEnvironmentAccountConnectionPropsMixin, props *CfnEnvironmentAccountConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEnvironmentAccountConnectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
