...
func validateNewCfnEnvironmentTemplatePropsMixinParameters(props *CfnEnvironmentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
