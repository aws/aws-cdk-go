...
//
//   cfnEnvironmentTemplatePropsMixin := awscdkcfnpropertymixins.Aws_proton.NewCfnEnvironmentTemplatePropsMixin(&CfnEnvironmentTemplateMixinProps{
...
func (j *jsiiProxy_CfnEnvironmentTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEnvironmentTemplatePropsMixin(props *CfnEnvironmentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnvironmentTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Proton::EnvironmentTemplate`.
func NewCfnEnvironmentTemplatePropsMixin_Override(c CfnEnvironmentTemplatePropsMixin, props *CfnEnvironmentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEnvironmentTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
