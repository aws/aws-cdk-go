...
//
//   cfnServiceTemplatePropsMixin := awscdkcfnpropertymixins.Aws_proton.NewCfnServiceTemplatePropsMixin(&CfnServiceTemplateMixinProps{
...
func (j *jsiiProxy_CfnServiceTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceTemplatePropsMixin(props *CfnServiceTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Proton::ServiceTemplate`.
func NewCfnServiceTemplatePropsMixin_Override(c CfnServiceTemplatePropsMixin, props *CfnServiceTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServiceTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
