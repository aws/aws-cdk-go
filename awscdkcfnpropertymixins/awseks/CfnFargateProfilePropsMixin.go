...
//
//   cfnFargateProfilePropsMixin := awscdkcfnpropertymixins.Aws_eks.NewCfnFargateProfilePropsMixin(&CfnFargateProfileMixinProps{
...
func (j *jsiiProxy_CfnFargateProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFargateProfilePropsMixin(props *CfnFargateProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFargateProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EKS::FargateProfile`.
func NewCfnFargateProfilePropsMixin_Override(c CfnFargateProfilePropsMixin, props *CfnFargateProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFargateProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
