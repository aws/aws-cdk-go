...
//
//   cfnNodegroupPropsMixin := awscdkcfnpropertymixins.Aws_eks.NewCfnNodegroupPropsMixin(&CfnNodegroupMixinProps{
...
func (j *jsiiProxy_CfnNodegroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNodegroupPropsMixin(props *CfnNodegroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNodegroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EKS::Nodegroup`.
func NewCfnNodegroupPropsMixin_Override(c CfnNodegroupPropsMixin, props *CfnNodegroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNodegroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
