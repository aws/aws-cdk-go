...
//
//   cfnAccessEntryPropsMixin := awscdkcfnpropertymixins.Aws_eks.NewCfnAccessEntryPropsMixin(&CfnAccessEntryMixinProps{
...
func (j *jsiiProxy_CfnAccessEntryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAccessEntryPropsMixin(props *CfnAccessEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessEntryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EKS::AccessEntry`.
func NewCfnAccessEntryPropsMixin_Override(c CfnAccessEntryPropsMixin, props *CfnAccessEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAccessEntryPropsMixin) ApplyTo(construct constructs.IConstruct) {
