...
//
//   cfnPublicRepositoryPropsMixin := awscdkcfnpropertymixins.Aws_ecr.NewCfnPublicRepositoryPropsMixin(&CfnPublicRepositoryMixinProps{
...
func NewCfnPublicRepositoryPropsMixin(props *CfnPublicRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPublicRepositoryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECR::PublicRepository`.
func NewCfnPublicRepositoryPropsMixin_Override(c CfnPublicRepositoryPropsMixin, props *CfnPublicRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
