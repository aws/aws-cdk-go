...
//
//   cfnSigningConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ecr.NewCfnSigningConfigurationPropsMixin(&CfnSigningConfigurationMixinProps{
//   	Rules: []interface{}{
//   		&RuleProperty{
...
func (j *jsiiProxy_CfnSigningConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSigningConfigurationPropsMixin(props *CfnSigningConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSigningConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECR::SigningConfiguration`.
func NewCfnSigningConfigurationPropsMixin_Override(c CfnSigningConfigurationPropsMixin, props *CfnSigningConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
