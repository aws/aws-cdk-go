...
//
//   cfnRegistryScanningConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ecr.NewCfnRegistryScanningConfigurationPropsMixin(&CfnRegistryScanningConfigurationMixinProps{
//   	Rules: []interface{}{
...
func (j *jsiiProxy_CfnRegistryScanningConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRegistryScanningConfigurationPropsMixin(props *CfnRegistryScanningConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRegistryScanningConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECR::RegistryScanningConfiguration`.
func NewCfnRegistryScanningConfigurationPropsMixin_Override(c CfnRegistryScanningConfigurationPropsMixin, props *CfnRegistryScanningConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRegistryScanningConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
