...
//
//   cfnPullThroughCacheRulePropsMixin := awscdkcfnpropertymixins.Aws_ecr.NewCfnPullThroughCacheRulePropsMixin(&CfnPullThroughCacheRuleMixinProps{
...
func NewCfnPullThroughCacheRulePropsMixin(props *CfnPullThroughCacheRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPullThroughCacheRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECR::PullThroughCacheRule`.
func NewCfnPullThroughCacheRulePropsMixin_Override(c CfnPullThroughCacheRulePropsMixin, props *CfnPullThroughCacheRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPullThroughCacheRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
