...
//
//   cfnReplicationConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_ecr.NewCfnReplicationConfigurationPropsMixin(&CfnReplicationConfigurationMixinProps{
...
func (j *jsiiProxy_CfnReplicationConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReplicationConfigurationPropsMixin(props *CfnReplicationConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECR::ReplicationConfiguration`.
func NewCfnReplicationConfigurationPropsMixin_Override(c CfnReplicationConfigurationPropsMixin, props *CfnReplicationConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReplicationConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
