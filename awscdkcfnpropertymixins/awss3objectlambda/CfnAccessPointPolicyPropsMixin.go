...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awss3objectlambda/internal"
...
//
//   cfnAccessPointPolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3objectlambda.NewCfnAccessPointPolicyPropsMixin(&CfnAccessPointPolicyMixinProps{
...
func NewCfnAccessPointPolicyPropsMixin(props *CfnAccessPointPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessPointPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3ObjectLambda::AccessPointPolicy`.
func NewCfnAccessPointPolicyPropsMixin_Override(c CfnAccessPointPolicyPropsMixin, props *CfnAccessPointPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
