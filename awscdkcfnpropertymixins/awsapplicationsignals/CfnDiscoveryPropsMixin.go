...
//
//   cfnDiscoveryPropsMixin := awscdkcfnpropertymixins.Aws_applicationsignals.NewCfnDiscoveryPropsMixin(&CfnDiscoveryMixinProps{
...
func (j *jsiiProxy_CfnDiscoveryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDiscoveryPropsMixin(props *CfnDiscoveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDiscoveryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApplicationSignals::Discovery`.
func NewCfnDiscoveryPropsMixin_Override(c CfnDiscoveryPropsMixin, props *CfnDiscoveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDiscoveryPropsMixin) ApplyTo(construct constructs.IConstruct) {
