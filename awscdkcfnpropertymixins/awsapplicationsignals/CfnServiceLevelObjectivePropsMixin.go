...
//
//   cfnServiceLevelObjectivePropsMixin := awscdkcfnpropertymixins.Aws_applicationsignals.NewCfnServiceLevelObjectivePropsMixin(&CfnServiceLevelObjectiveMixinProps{
...
func (j *jsiiProxy_CfnServiceLevelObjectivePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceLevelObjectivePropsMixin(props *CfnServiceLevelObjectiveMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceLevelObjectivePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApplicationSignals::ServiceLevelObjective`.
func NewCfnServiceLevelObjectivePropsMixin_Override(c CfnServiceLevelObjectivePropsMixin, props *CfnServiceLevelObjectiveMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServiceLevelObjectivePropsMixin) ApplyTo(construct constructs.IConstruct) {
