...
//
//   cfnPlaceIndexPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnPlaceIndexPropsMixin(&CfnPlaceIndexMixinProps{
...
func (j *jsiiProxy_CfnPlaceIndexPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPlaceIndexPropsMixin(props *CfnPlaceIndexMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlaceIndexPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnPlaceIndexPropsMixin",
...
// Create a mixin to apply properties to `AWS::Location::PlaceIndex`.
func NewCfnPlaceIndexPropsMixin_Override(c CfnPlaceIndexPropsMixin, props *CfnPlaceIndexMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
