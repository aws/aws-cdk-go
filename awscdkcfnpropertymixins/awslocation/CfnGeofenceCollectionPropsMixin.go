...
//
//   cfnGeofenceCollectionPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnGeofenceCollectionPropsMixin(&CfnGeofenceCollectionMixinProps{
...
func NewCfnGeofenceCollectionPropsMixin(props *CfnGeofenceCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGeofenceCollectionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnGeofenceCollectionPropsMixin",
...
// Create a mixin to apply properties to `AWS::Location::GeofenceCollection`.
func NewCfnGeofenceCollectionPropsMixin_Override(c CfnGeofenceCollectionPropsMixin, props *CfnGeofenceCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
