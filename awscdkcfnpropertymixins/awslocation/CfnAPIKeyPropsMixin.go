...
//
//   cfnAPIKeyPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnAPIKeyPropsMixin(&CfnAPIKeyMixinProps{
...
func NewCfnAPIKeyPropsMixin(props *CfnAPIKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAPIKeyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnAPIKeyPropsMixin",
