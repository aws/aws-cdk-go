...
//
//   cfnRouteCalculatorPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnRouteCalculatorPropsMixin(&CfnRouteCalculatorMixinProps{
...
func (j *jsiiProxy_CfnRouteCalculatorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRouteCalculatorPropsMixin(props *CfnRouteCalculatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteCalculatorPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnRouteCalculatorPropsMixin",
...
// Create a mixin to apply properties to `AWS::Location::RouteCalculator`.
func NewCfnRouteCalculatorPropsMixin_Override(c CfnRouteCalculatorPropsMixin, props *CfnRouteCalculatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
