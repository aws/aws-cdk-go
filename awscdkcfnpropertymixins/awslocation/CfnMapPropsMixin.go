...
//
//   cfnMapPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnMapPropsMixin(&CfnMapMixinProps{
...
func (j *jsiiProxy_CfnMapPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMapPropsMixin(props *CfnMapMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMapPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnMapPropsMixin",
...
// Create a mixin to apply properties to `AWS::Location::Map`.
func NewCfnMapPropsMixin_Override(c CfnMapPropsMixin, props *CfnMapMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMapPropsMixin) ApplyTo(construct constructs.IConstruct) {
