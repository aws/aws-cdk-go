...
//
//   cfnTrackerConsumerPropsMixin := awscdkcfnpropertymixins.Aws_location.NewCfnTrackerConsumerPropsMixin(&CfnTrackerConsumerMixinProps{
...
func (j *jsiiProxy_CfnTrackerConsumerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrackerConsumerPropsMixin(props *CfnTrackerConsumerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrackerConsumerPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_location.CfnTrackerConsumerPropsMixin",
...
// Create a mixin to apply properties to `AWS::Location::TrackerConsumer`.
func NewCfnTrackerConsumerPropsMixin_Override(c CfnTrackerConsumerPropsMixin, props *CfnTrackerConsumerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTrackerConsumerPropsMixin) ApplyTo(construct constructs.IConstruct) {
