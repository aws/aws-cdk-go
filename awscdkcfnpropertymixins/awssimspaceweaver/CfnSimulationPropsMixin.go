...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssimspaceweaver/internal"
...
//
//   cfnSimulationPropsMixin := awscdkcfnpropertymixins.Aws_simspaceweaver.NewCfnSimulationPropsMixin(&CfnSimulationMixinProps{
...
func (j *jsiiProxy_CfnSimulationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSimulationPropsMixin(props *CfnSimulationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSimulationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SimSpaceWeaver::Simulation`.
func NewCfnSimulationPropsMixin_Override(c CfnSimulationPropsMixin, props *CfnSimulationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSimulationPropsMixin) ApplyTo(construct constructs.IConstruct) {
