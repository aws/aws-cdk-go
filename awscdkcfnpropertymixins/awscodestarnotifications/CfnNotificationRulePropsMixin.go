...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscodestarnotifications/internal"
...
//
//   cfnNotificationRulePropsMixin := awscdkcfnpropertymixins.Aws_codestarnotifications.NewCfnNotificationRulePropsMixin(&CfnNotificationRuleMixinProps{
...
func (j *jsiiProxy_CfnNotificationRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNotificationRulePropsMixin(props *CfnNotificationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNotificationRulePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_codestarnotifications.CfnNotificationRulePropsMixin",
...
// Create a mixin to apply properties to `AWS::CodeStarNotifications::NotificationRule`.
func NewCfnNotificationRulePropsMixin_Override(c CfnNotificationRulePropsMixin, props *CfnNotificationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNotificationRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
