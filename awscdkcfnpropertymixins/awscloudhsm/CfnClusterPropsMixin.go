...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscloudhsm/internal"
...
//
//   cfnClusterPropsMixin := awscdkcfnpropertymixins.Aws_cloudhsm.NewCfnClusterPropsMixin(&CfnClusterMixinProps{
...
func NewCfnClusterPropsMixin(props *CfnClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClusterPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_cloudhsm.CfnClusterPropsMixin",
