...
//
//   cfnDataflowEndpointGroupV2PropsMixin := awscdkcfnpropertymixins.Aws_groundstation.NewCfnDataflowEndpointGroupV2PropsMixin(&CfnDataflowEndpointGroupV2MixinProps{
...
func NewCfnDataflowEndpointGroupV2PropsMixin(props *CfnDataflowEndpointGroupV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataflowEndpointGroupV2PropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GroundStation::DataflowEndpointGroupV2`.
func NewCfnDataflowEndpointGroupV2PropsMixin_Override(c CfnDataflowEndpointGroupV2PropsMixin, props *CfnDataflowEndpointGroupV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
