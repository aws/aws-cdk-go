...
//
//   cfnConfigPropsMixin := awscdkcfnpropertymixins.Aws_groundstation.NewCfnConfigPropsMixin(&CfnConfigMixinProps{
...
func NewCfnConfigPropsMixin(props *CfnConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GroundStation::Config`.
func NewCfnConfigPropsMixin_Override(c CfnConfigPropsMixin, props *CfnConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
