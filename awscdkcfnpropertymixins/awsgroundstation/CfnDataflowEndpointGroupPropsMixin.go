...
//
//   cfnDataflowEndpointGroupPropsMixin := awscdkcfnpropertymixins.Aws_groundstation.NewCfnDataflowEndpointGroupPropsMixin(&CfnDataflowEndpointGroupMixinProps{
...
func (j *jsiiProxy_CfnDataflowEndpointGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataflowEndpointGroupPropsMixin(props *CfnDataflowEndpointGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataflowEndpointGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GroundStation::DataflowEndpointGroup`.
func NewCfnDataflowEndpointGroupPropsMixin_Override(c CfnDataflowEndpointGroupPropsMixin, props *CfnDataflowEndpointGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
