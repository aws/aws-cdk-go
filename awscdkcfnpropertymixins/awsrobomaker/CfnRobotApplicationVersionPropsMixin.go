...
//
//   cfnRobotApplicationVersionPropsMixin := awscdkcfnpropertymixins.Aws_robomaker.NewCfnRobotApplicationVersionPropsMixin(&CfnRobotApplicationVersionMixinProps{
...
func (j *jsiiProxy_CfnRobotApplicationVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRobotApplicationVersionPropsMixin(props *CfnRobotApplicationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRobotApplicationVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RoboMaker::RobotApplicationVersion`.
func NewCfnRobotApplicationVersionPropsMixin_Override(c CfnRobotApplicationVersionPropsMixin, props *CfnRobotApplicationVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRobotApplicationVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
