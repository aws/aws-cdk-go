...
//
//   cfnSimulationApplicationPropsMixin := awscdkcfnpropertymixins.Aws_robomaker.NewCfnSimulationApplicationPropsMixin(&CfnSimulationApplicationMixinProps{
...
func (j *jsiiProxy_CfnSimulationApplicationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSimulationApplicationPropsMixin(props *CfnSimulationApplicationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSimulationApplicationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RoboMaker::SimulationApplication`.
func NewCfnSimulationApplicationPropsMixin_Override(c CfnSimulationApplicationPropsMixin, props *CfnSimulationApplicationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSimulationApplicationPropsMixin) ApplyTo(construct constructs.IConstruct) {
