...
//
//   cfnRobotApplicationPropsMixin := awscdkcfnpropertymixins.Aws_robomaker.NewCfnRobotApplicationPropsMixin(&CfnRobotApplicationMixinProps{
...
func NewCfnRobotApplicationPropsMixin(props *CfnRobotApplicationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRobotApplicationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RoboMaker::RobotApplication`.
func NewCfnRobotApplicationPropsMixin_Override(c CfnRobotApplicationPropsMixin, props *CfnRobotApplicationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
