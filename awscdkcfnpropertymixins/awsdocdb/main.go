...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBClusterMixinProps",
		reflect.TypeOf((*CfnDBClusterMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBClusterParameterGroupMixinProps",
		reflect.TypeOf((*CfnDBClusterParameterGroupMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBClusterParameterGroupPropsMixin",
	...
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBClusterPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBClusterPropsMixin.ServerlessV2ScalingConfigurationProperty",
		reflect.TypeOf((*CfnDBClusterPropsMixin_ServerlessV2ScalingConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBInstanceMixinProps",
		reflect.TypeOf((*CfnDBInstanceMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBInstancePropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBSubnetGroupMixinProps",
		reflect.TypeOf((*CfnDBSubnetGroupMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnDBSubnetGroupPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnEventSubscriptionMixinProps",
		reflect.TypeOf((*CfnEventSubscriptionMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnEventSubscriptionPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnGlobalClusterMixinProps",
		reflect.TypeOf((*CfnGlobalClusterMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_docdb.CfnGlobalClusterPropsMixin",
