...
//
//   cfnDBInstancePropsMixin := awscdkcfnpropertymixins.Aws_docdb.NewCfnDBInstancePropsMixin(&CfnDBInstanceMixinProps{
...
func NewCfnDBInstancePropsMixin(props *CfnDBInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DocDB::DBInstance`.
func NewCfnDBInstancePropsMixin_Override(c CfnDBInstancePropsMixin, props *CfnDBInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
