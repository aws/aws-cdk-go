...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsdocdb/internal"
...
//
//   cfnGlobalClusterPropsMixin := awscdkcfnpropertymixins.Aws_docdb.NewCfnGlobalClusterPropsMixin(&CfnGlobalClusterMixinProps{
...
func (j *jsiiProxy_CfnGlobalClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGlobalClusterPropsMixin(props *CfnGlobalClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGlobalClusterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DocDB::GlobalCluster`.
func NewCfnGlobalClusterPropsMixin_Override(c CfnGlobalClusterPropsMixin, props *CfnGlobalClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
