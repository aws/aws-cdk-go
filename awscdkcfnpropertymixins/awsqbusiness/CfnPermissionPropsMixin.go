...
//
//   cfnPermissionPropsMixin := awscdkcfnpropertymixins.Aws_qbusiness.NewCfnPermissionPropsMixin(&CfnPermissionMixinProps{
//   	Actions: []*string{
//   		jsii.String("actions"),
//   	},
...
func (j *jsiiProxy_CfnPermissionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPermissionPropsMixin(props *CfnPermissionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPermissionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QBusiness::Permission`.
func NewCfnPermissionPropsMixin_Override(c CfnPermissionPropsMixin, props *CfnPermissionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
