...
//
//   cfnDataAccessorPropsMixin := awscdkcfnpropertymixins.Aws_qbusiness.NewCfnDataAccessorPropsMixin(&CfnDataAccessorMixinProps{
...
func NewCfnDataAccessorPropsMixin(props *CfnDataAccessorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataAccessorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::QBusiness::DataAccessor`.
func NewCfnDataAccessorPropsMixin_Override(c CfnDataAccessorPropsMixin, props *CfnDataAccessorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
