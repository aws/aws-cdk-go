...
//
//   cfnActivityPropsMixin := awscdkcfnpropertymixins.Aws_stepfunctions.NewCfnActivityPropsMixin(&CfnActivityMixinProps{
...
func NewCfnActivityPropsMixin(props *CfnActivityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnActivityPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::StepFunctions::Activity`.
func NewCfnActivityPropsMixin_Override(c CfnActivityPropsMixin, props *CfnActivityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
