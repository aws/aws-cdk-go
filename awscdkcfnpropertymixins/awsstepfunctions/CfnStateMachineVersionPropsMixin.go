...
//
//   cfnStateMachineVersionPropsMixin := awscdkcfnpropertymixins.Aws_stepfunctions.NewCfnStateMachineVersionPropsMixin(&CfnStateMachineVersionMixinProps{
...
func NewCfnStateMachineVersionPropsMixin(props *CfnStateMachineVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStateMachineVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::StepFunctions::StateMachineVersion`.
func NewCfnStateMachineVersionPropsMixin_Override(c CfnStateMachineVersionPropsMixin, props *CfnStateMachineVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
