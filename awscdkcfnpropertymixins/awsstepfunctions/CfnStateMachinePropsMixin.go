...
//
//   cfnStateMachinePropsMixin := awscdkcfnpropertymixins.Aws_stepfunctions.NewCfnStateMachinePropsMixin(&CfnStateMachineMixinProps{
...
func (j *jsiiProxy_CfnStateMachinePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStateMachinePropsMixin(props *CfnStateMachineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStateMachinePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::StepFunctions::StateMachine`.
func NewCfnStateMachinePropsMixin_Override(c CfnStateMachinePropsMixin, props *CfnStateMachineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStateMachinePropsMixin) ApplyTo(construct constructs.IConstruct) {
