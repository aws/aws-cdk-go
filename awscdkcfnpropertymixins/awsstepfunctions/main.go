...
func init() {
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_stepfunctions.CfnMapRunMixinProps",
		reflect.TypeOf((*CfnMapRunMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_stepfunctions.CfnMapRunPropsMixin",
		reflect.TypeOf((*CfnMapRunPropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "applyTo", GoMethod: "ApplyTo"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "strategy", GoGetter: "Strategy"},
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_stepfunctions.CfnMapRunPropsMixin.MapRunExecutionCountsProperty",
		reflect.TypeOf((*CfnMapRunPropsMixin_MapRunExecutionCountsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_stepfunctions.CfnMapRunPropsMixin.MapRunItemCountsProperty",
		reflect.TypeOf((*CfnMapRunPropsMixin_MapRunItemCountsProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
