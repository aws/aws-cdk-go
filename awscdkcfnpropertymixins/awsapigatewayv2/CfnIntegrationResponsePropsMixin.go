...
//
//   cfnIntegrationResponsePropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnIntegrationResponsePropsMixin(&CfnIntegrationResponseMixinProps{
...
func (j *jsiiProxy_CfnIntegrationResponsePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIntegrationResponsePropsMixin(props *CfnIntegrationResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIntegrationResponsePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::IntegrationResponse`.
func NewCfnIntegrationResponsePropsMixin_Override(c CfnIntegrationResponsePropsMixin, props *CfnIntegrationResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIntegrationResponsePropsMixin) ApplyTo(construct constructs.IConstruct) {
