...
//
//   cfnRoutePropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnRoutePropsMixin(&CfnRouteMixinProps{
...
func (j *jsiiProxy_CfnRoutePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoutePropsMixin(props *CfnRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoutePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigatewayv2.CfnRoutePropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::Route`.
func NewCfnRoutePropsMixin_Override(c CfnRoutePropsMixin, props *CfnRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
