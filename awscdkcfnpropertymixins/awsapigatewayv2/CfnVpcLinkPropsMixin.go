...
//
//   cfnVpcLinkPropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnVpcLinkPropsMixin(&CfnVpcLinkMixinProps{
...
func NewCfnVpcLinkPropsMixin(props *CfnVpcLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcLinkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::VpcLink`.
func NewCfnVpcLinkPropsMixin_Override(c CfnVpcLinkPropsMixin, props *CfnVpcLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
