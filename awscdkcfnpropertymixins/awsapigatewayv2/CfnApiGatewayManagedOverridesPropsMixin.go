...
//
//   cfnApiGatewayManagedOverridesPropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnApiGatewayManagedOverridesPropsMixin(&CfnApiGatewayManagedOverridesMixinProps{
...
func (j *jsiiProxy_CfnApiGatewayManagedOverridesPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnApiGatewayManagedOverridesPropsMixin(props *CfnApiGatewayManagedOverridesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApiGatewayManagedOverridesPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigatewayv2.CfnApiGatewayManagedOverridesPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::ApiGatewayManagedOverrides`.
func NewCfnApiGatewayManagedOverridesPropsMixin_Override(c CfnApiGatewayManagedOverridesPropsMixin, props *CfnApiGatewayManagedOverridesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
