...
//
//   cfnDeploymentPropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnDeploymentPropsMixin(&CfnDeploymentMixinProps{
...
func (j *jsiiProxy_CfnDeploymentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeploymentPropsMixin(props *CfnDeploymentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigatewayv2.CfnDeploymentPropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::Deployment`.
func NewCfnDeploymentPropsMixin_Override(c CfnDeploymentPropsMixin, props *CfnDeploymentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
