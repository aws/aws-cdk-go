...
//
//   cfnRoutingRulePropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnRoutingRulePropsMixin(&CfnRoutingRuleMixinProps{
//   	Actions: []interface{}{
//   		&ActionProperty{
...
func (j *jsiiProxy_CfnRoutingRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoutingRulePropsMixin(props *CfnRoutingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoutingRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::RoutingRule`.
func NewCfnRoutingRulePropsMixin_Override(c CfnRoutingRulePropsMixin, props *CfnRoutingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
