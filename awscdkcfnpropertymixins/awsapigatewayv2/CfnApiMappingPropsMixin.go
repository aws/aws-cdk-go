...
//
//   cfnApiMappingPropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnApiMappingPropsMixin(&CfnApiMappingMixinProps{
...
func NewCfnApiMappingPropsMixin(props *CfnApiMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApiMappingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::ApiMapping`.
func NewCfnApiMappingPropsMixin_Override(c CfnApiMappingPropsMixin, props *CfnApiMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
