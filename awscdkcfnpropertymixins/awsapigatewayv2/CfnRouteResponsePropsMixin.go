...
//
//   cfnRouteResponsePropsMixin := awscdkcfnpropertymixins.Aws_apigatewayv2.NewCfnRouteResponsePropsMixin(&CfnRouteResponseMixinProps{
...
func (j *jsiiProxy_CfnRouteResponsePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRouteResponsePropsMixin(props *CfnRouteResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteResponsePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_apigatewayv2.CfnRouteResponsePropsMixin",
...
// Create a mixin to apply properties to `AWS::ApiGatewayV2::RouteResponse`.
func NewCfnRouteResponsePropsMixin_Override(c CfnRouteResponsePropsMixin, props *CfnRouteResponseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRouteResponsePropsMixin) ApplyTo(construct constructs.IConstruct) {
