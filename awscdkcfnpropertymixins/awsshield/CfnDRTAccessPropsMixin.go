...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsshield/internal"
...
//
//   cfnDRTAccessPropsMixin := awscdkcfnpropertymixins.Aws_shield.NewCfnDRTAccessPropsMixin(&CfnDRTAccessMixinProps{
...
func NewCfnDRTAccessPropsMixin(props *CfnDRTAccessMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDRTAccessPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Shield::DRTAccess`.
func NewCfnDRTAccessPropsMixin_Override(c CfnDRTAccessPropsMixin, props *CfnDRTAccessMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDRTAccessPropsMixin) ApplyTo(construct constructs.IConstruct) {
