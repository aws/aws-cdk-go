...
//
//   cfnProtectionGroupPropsMixin := awscdkcfnpropertymixins.Aws_shield.NewCfnProtectionGroupPropsMixin(&CfnProtectionGroupMixinProps{
...
func NewCfnProtectionGroupPropsMixin(props *CfnProtectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProtectionGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Shield::ProtectionGroup`.
func NewCfnProtectionGroupPropsMixin_Override(c CfnProtectionGroupPropsMixin, props *CfnProtectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
