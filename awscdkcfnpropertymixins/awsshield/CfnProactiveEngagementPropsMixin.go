...
//
//   cfnProactiveEngagementPropsMixin := awscdkcfnpropertymixins.Aws_shield.NewCfnProactiveEngagementPropsMixin(&CfnProactiveEngagementMixinProps{
...
func NewCfnProactiveEngagementPropsMixin(props *CfnProactiveEngagementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProactiveEngagementPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Shield::ProactiveEngagement`.
func NewCfnProactiveEngagementPropsMixin_Override(c CfnProactiveEngagementPropsMixin, props *CfnProactiveEngagementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
