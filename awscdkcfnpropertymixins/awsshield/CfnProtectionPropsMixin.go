...
//
//   cfnProtectionPropsMixin := awscdkcfnpropertymixins.Aws_shield.NewCfnProtectionPropsMixin(&CfnProtectionMixinProps{
...
func NewCfnProtectionPropsMixin(props *CfnProtectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProtectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Shield::Protection`.
func NewCfnProtectionPropsMixin_Override(c CfnProtectionPropsMixin, props *CfnProtectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
