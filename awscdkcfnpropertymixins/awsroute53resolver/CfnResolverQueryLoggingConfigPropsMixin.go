...
//
//   cfnResolverQueryLoggingConfigPropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnResolverQueryLoggingConfigPropsMixin(&CfnResolverQueryLoggingConfigMixinProps{
...
func (j *jsiiProxy_CfnResolverQueryLoggingConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResolverQueryLoggingConfigPropsMixin(props *CfnResolverQueryLoggingConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverQueryLoggingConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverQueryLoggingConfig`.
func NewCfnResolverQueryLoggingConfigPropsMixin_Override(c CfnResolverQueryLoggingConfigPropsMixin, props *CfnResolverQueryLoggingConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResolverQueryLoggingConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
