...
func (j *jsiiProxy_CfnResolverEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResolverEndpointPropsMixin(props *CfnResolverEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverEndpoint`.
func NewCfnResolverEndpointPropsMixin_Override(c CfnResolverEndpointPropsMixin, props *CfnResolverEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResolverEndpointPropsMixin) ApplyTo(construct constructs.IConstruct) {
