...
//
//   cfnResolverRuleAssociationPropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnResolverRuleAssociationPropsMixin(&CfnResolverRuleAssociationMixinProps{
...
func NewCfnResolverRuleAssociationPropsMixin(props *CfnResolverRuleAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverRuleAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverRuleAssociation`.
func NewCfnResolverRuleAssociationPropsMixin_Override(c CfnResolverRuleAssociationPropsMixin, props *CfnResolverRuleAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResolverRuleAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
