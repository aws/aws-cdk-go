...
//
//   cfnFirewallRuleGroupPropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnFirewallRuleGroupPropsMixin(&CfnFirewallRuleGroupMixinProps{
...
func NewCfnFirewallRuleGroupPropsMixin(props *CfnFirewallRuleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFirewallRuleGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::FirewallRuleGroup`.
func NewCfnFirewallRuleGroupPropsMixin_Override(c CfnFirewallRuleGroupPropsMixin, props *CfnFirewallRuleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
