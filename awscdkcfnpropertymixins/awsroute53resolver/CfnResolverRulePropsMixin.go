...
//
//   cfnResolverRulePropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnResolverRulePropsMixin(&CfnResolverRuleMixinProps{
...
func (j *jsiiProxy_CfnResolverRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResolverRulePropsMixin(props *CfnResolverRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverRule`.
func NewCfnResolverRulePropsMixin_Override(c CfnResolverRulePropsMixin, props *CfnResolverRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
