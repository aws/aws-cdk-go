...
//
//   cfnResolverConfigPropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnResolverConfigPropsMixin(&CfnResolverConfigMixinProps{
...
func (j *jsiiProxy_CfnResolverConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResolverConfigPropsMixin(props *CfnResolverConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResolverConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::ResolverConfig`.
func NewCfnResolverConfigPropsMixin_Override(c CfnResolverConfigPropsMixin, props *CfnResolverConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
