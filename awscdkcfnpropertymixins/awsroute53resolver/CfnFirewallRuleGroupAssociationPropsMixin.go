...
//
//   cfnFirewallRuleGroupAssociationPropsMixin := awscdkcfnpropertymixins.Aws_route53resolver.NewCfnFirewallRuleGroupAssociationPropsMixin(&CfnFirewallRuleGroupAssociationMixinProps{
...
func NewCfnFirewallRuleGroupAssociationPropsMixin(props *CfnFirewallRuleGroupAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFirewallRuleGroupAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53Resolver::FirewallRuleGroupAssociation`.
func NewCfnFirewallRuleGroupAssociationPropsMixin_Override(c CfnFirewallRuleGroupAssociationPropsMixin, props *CfnFirewallRuleGroupAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
