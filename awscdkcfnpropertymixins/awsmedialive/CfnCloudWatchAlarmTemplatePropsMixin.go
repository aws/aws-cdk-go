...
//
//   cfnCloudWatchAlarmTemplatePropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnCloudWatchAlarmTemplatePropsMixin(&CfnCloudWatchAlarmTemplateMixinProps{
...
func (j *jsiiProxy_CfnCloudWatchAlarmTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCloudWatchAlarmTemplatePropsMixin(props *CfnCloudWatchAlarmTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCloudWatchAlarmTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::CloudWatchAlarmTemplate`.
func NewCfnCloudWatchAlarmTemplatePropsMixin_Override(c CfnCloudWatchAlarmTemplatePropsMixin, props *CfnCloudWatchAlarmTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCloudWatchAlarmTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
