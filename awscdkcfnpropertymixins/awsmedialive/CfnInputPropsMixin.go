...
//   var tags interface{}
//
//   cfnInputPropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnInputPropsMixin(&CfnInputMixinProps{
...
func (j *jsiiProxy_CfnInputPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInputPropsMixin(props *CfnInputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::Input`.
func NewCfnInputPropsMixin_Override(c CfnInputPropsMixin, props *CfnInputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
