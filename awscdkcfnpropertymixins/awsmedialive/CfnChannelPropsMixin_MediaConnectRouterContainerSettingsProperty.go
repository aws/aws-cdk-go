...
//
//   mediaConnectRouterContainerSettingsProperty := &MediaConnectRouterContainerSettingsProperty{
...
//
type CfnChannelPropsMixin_MediaConnectRouterContainerSettingsProperty struct {
