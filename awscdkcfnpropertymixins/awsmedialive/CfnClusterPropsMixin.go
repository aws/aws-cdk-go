...
//
//   cfnClusterPropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnClusterPropsMixin(&CfnClusterMixinProps{
...
// Create a mixin to apply properties to `AWS::MediaLive::Cluster`.
