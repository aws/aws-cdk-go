...
//
//   cfnEventBridgeRuleTemplatePropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnEventBridgeRuleTemplatePropsMixin(&CfnEventBridgeRuleTemplateMixinProps{
...
func (j *jsiiProxy_CfnEventBridgeRuleTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEventBridgeRuleTemplatePropsMixin(props *CfnEventBridgeRuleTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventBridgeRuleTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::EventBridgeRuleTemplate`.
func NewCfnEventBridgeRuleTemplatePropsMixin_Override(c CfnEventBridgeRuleTemplatePropsMixin, props *CfnEventBridgeRuleTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEventBridgeRuleTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
