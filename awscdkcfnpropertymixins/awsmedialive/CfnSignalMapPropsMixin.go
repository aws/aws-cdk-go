...
//
//   cfnSignalMapPropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnSignalMapPropsMixin(&CfnSignalMapMixinProps{
...
func NewCfnSignalMapPropsMixin(props *CfnSignalMapMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSignalMapPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::SignalMap`.
func NewCfnSignalMapPropsMixin_Override(c CfnSignalMapPropsMixin, props *CfnSignalMapMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
