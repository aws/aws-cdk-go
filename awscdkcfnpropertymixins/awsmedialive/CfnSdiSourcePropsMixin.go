...
//
//   cfnSdiSourcePropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnSdiSourcePropsMixin(&CfnSdiSourceMixinProps{
...
func (j *jsiiProxy_CfnSdiSourcePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSdiSourcePropsMixin(props *CfnSdiSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSdiSourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::SdiSource`.
func NewCfnSdiSourcePropsMixin_Override(c CfnSdiSourcePropsMixin, props *CfnSdiSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSdiSourcePropsMixin) ApplyTo(construct constructs.IConstruct) {
