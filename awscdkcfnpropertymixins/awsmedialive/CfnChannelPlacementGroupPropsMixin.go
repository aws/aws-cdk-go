...
//
//   cfnChannelPlacementGroupPropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnChannelPlacementGroupPropsMixin(&CfnChannelPlacementGroupMixinProps{
...
func (j *jsiiProxy_CfnChannelPlacementGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnChannelPlacementGroupPropsMixin(props *CfnChannelPlacementGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnChannelPlacementGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::ChannelPlacementGroup`.
func NewCfnChannelPlacementGroupPropsMixin_Override(c CfnChannelPlacementGroupPropsMixin, props *CfnChannelPlacementGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnChannelPlacementGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
