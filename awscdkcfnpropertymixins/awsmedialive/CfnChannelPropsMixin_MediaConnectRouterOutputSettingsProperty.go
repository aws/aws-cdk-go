...
//
//   mediaConnectRouterOutputSettingsProperty := &MediaConnectRouterOutputSettingsProperty{
//   	ConnectedRouterInputs: &MediaConnectRouterOutputConnectionMapProperty{
//   		Pipeline0: jsii.String("pipeline0"),
//   		Pipeline1: jsii.String("pipeline1"),
//   	},
//   	ContainerSettings: &MediaConnectRouterContainerSettingsProperty{
...
//
type CfnChannelPropsMixin_MediaConnectRouterOutputSettingsProperty struct {
	...
	//
	ConnectedRouterInputs interface{} `field:"optional" json:"connectedRouterInputs" yaml:"connectedRouterInputs"`
