...
//
//   cfnMultiplexprogramPropsMixin := awscdkcfnpropertymixins.Aws_medialive.NewCfnMultiplexprogramPropsMixin(&CfnMultiplexprogramMixinProps{
...
func NewCfnMultiplexprogramPropsMixin(props *CfnMultiplexprogramMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMultiplexprogramPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaLive::Multiplexprogram`.
func NewCfnMultiplexprogramPropsMixin_Override(c CfnMultiplexprogramPropsMixin, props *CfnMultiplexprogramMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMultiplexprogramPropsMixin) ApplyTo(construct constructs.IConstruct) {
