...
//
//   cfnBrokerPropsMixin := awscdkcfnpropertymixins.Aws_amazonmq.NewCfnBrokerPropsMixin(&CfnBrokerMixinProps{
...
func (j *jsiiProxy_CfnBrokerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBrokerPropsMixin(props *CfnBrokerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBrokerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AmazonMQ::Broker`.
func NewCfnBrokerPropsMixin_Override(c CfnBrokerPropsMixin, props *CfnBrokerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
