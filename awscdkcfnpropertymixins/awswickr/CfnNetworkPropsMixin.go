...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awswickr/internal"
...
//
//   cfnNetworkPropsMixin := awscdkcfnpropertymixins.Aws_wickr.NewCfnNetworkPropsMixin(&CfnNetworkMixinProps{
...
// Create a mixin to apply properties to `AWS::Wickr::Network`.
func NewCfnNetworkPropsMixin(props *CfnNetworkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_wickr.CfnNetworkPropsMixin",
