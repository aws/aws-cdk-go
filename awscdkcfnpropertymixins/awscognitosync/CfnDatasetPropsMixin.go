...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscognitosync/internal"
...
//
//   cfnDatasetPropsMixin := awscdkcfnpropertymixins.Aws_cognitosync.NewCfnDatasetPropsMixin(&CfnDatasetMixinProps{
...
// Create a mixin to apply properties to `AWS::CognitoSync::Dataset`.
