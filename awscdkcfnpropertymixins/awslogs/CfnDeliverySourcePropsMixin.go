...
func (j *jsiiProxy_CfnDeliverySourcePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeliverySourcePropsMixin(props *CfnDeliverySourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeliverySourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::DeliverySource`.
func NewCfnDeliverySourcePropsMixin_Override(c CfnDeliverySourcePropsMixin, props *CfnDeliverySourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDeliverySourcePropsMixin) ApplyTo(construct constructs.IConstruct) {
