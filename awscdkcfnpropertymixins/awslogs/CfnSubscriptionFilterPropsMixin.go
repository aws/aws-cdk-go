...
//
//   cfnSubscriptionFilterPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnSubscriptionFilterPropsMixin(&CfnSubscriptionFilterMixinProps{
...
func NewCfnSubscriptionFilterPropsMixin(props *CfnSubscriptionFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubscriptionFilterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::SubscriptionFilter`.
func NewCfnSubscriptionFilterPropsMixin_Override(c CfnSubscriptionFilterPropsMixin, props *CfnSubscriptionFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
