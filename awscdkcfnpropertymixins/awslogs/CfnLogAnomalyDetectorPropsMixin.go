...
//
//   cfnLogAnomalyDetectorPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnLogAnomalyDetectorPropsMixin(&CfnLogAnomalyDetectorMixinProps{
...
func (j *jsiiProxy_CfnLogAnomalyDetectorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLogAnomalyDetectorPropsMixin(props *CfnLogAnomalyDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLogAnomalyDetectorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::LogAnomalyDetector`.
func NewCfnLogAnomalyDetectorPropsMixin_Override(c CfnLogAnomalyDetectorPropsMixin, props *CfnLogAnomalyDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLogAnomalyDetectorPropsMixin) ApplyTo(construct constructs.IConstruct) {
