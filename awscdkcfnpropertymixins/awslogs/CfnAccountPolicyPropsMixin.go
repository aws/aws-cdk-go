...
//
//   cfnAccountPolicyPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnAccountPolicyPropsMixin(&CfnAccountPolicyMixinProps{
...
func NewCfnAccountPolicyPropsMixin(props *CfnAccountPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccountPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::AccountPolicy`.
func NewCfnAccountPolicyPropsMixin_Override(c CfnAccountPolicyPropsMixin, props *CfnAccountPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
