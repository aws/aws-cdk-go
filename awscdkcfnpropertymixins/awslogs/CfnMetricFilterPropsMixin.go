...
//
//   cfnMetricFilterPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnMetricFilterPropsMixin(&CfnMetricFilterMixinProps{
...
func (j *jsiiProxy_CfnMetricFilterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMetricFilterPropsMixin(props *CfnMetricFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMetricFilterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::MetricFilter`.
func NewCfnMetricFilterPropsMixin_Override(c CfnMetricFilterPropsMixin, props *CfnMetricFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMetricFilterPropsMixin) ApplyTo(construct constructs.IConstruct) {
