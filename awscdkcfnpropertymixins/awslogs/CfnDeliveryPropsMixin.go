...
//
//   cfnDeliveryPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnDeliveryPropsMixin(&CfnDeliveryMixinProps{
...
func (j *jsiiProxy_CfnDeliveryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeliveryPropsMixin(props *CfnDeliveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeliveryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::Delivery`.
func NewCfnDeliveryPropsMixin_Override(c CfnDeliveryPropsMixin, props *CfnDeliveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDeliveryPropsMixin) ApplyTo(construct constructs.IConstruct) {
