...
//
//   cfnTransformerPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnTransformerPropsMixin(&CfnTransformerMixinProps{
...
func (j *jsiiProxy_CfnTransformerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransformerPropsMixin(props *CfnTransformerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransformerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::Transformer`.
func NewCfnTransformerPropsMixin_Override(c CfnTransformerPropsMixin, props *CfnTransformerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransformerPropsMixin) ApplyTo(construct constructs.IConstruct) {
