...
func validateNewCfnDeliveryDestinationPropsMixinParameters(props *CfnDeliveryDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
