...
func validateNewCfnSubscriptionFilterPropsMixinParameters(props *CfnSubscriptionFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
