...
//
//   cfnDeliveryDestinationPropsMixin := awscdkcfnpropertymixins.Aws_logs.NewCfnDeliveryDestinationPropsMixin(&CfnDeliveryDestinationMixinProps{
...
func (j *jsiiProxy_CfnDeliveryDestinationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeliveryDestinationPropsMixin(props *CfnDeliveryDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeliveryDestinationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Logs::DeliveryDestination`.
func NewCfnDeliveryDestinationPropsMixin_Override(c CfnDeliveryDestinationPropsMixin, props *CfnDeliveryDestinationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
