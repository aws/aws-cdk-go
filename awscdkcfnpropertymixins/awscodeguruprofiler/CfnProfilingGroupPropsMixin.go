...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscodeguruprofiler/internal"
...
//
//   cfnProfilingGroupPropsMixin := awscdkcfnpropertymixins.Aws_codeguruprofiler.NewCfnProfilingGroupPropsMixin(&CfnProfilingGroupMixinProps{
...
func NewCfnProfilingGroupPropsMixin(props *CfnProfilingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProfilingGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodeGuruProfiler::ProfilingGroup`.
func NewCfnProfilingGroupPropsMixin_Override(c CfnProfilingGroupPropsMixin, props *CfnProfilingGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
