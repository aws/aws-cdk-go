...
//
//   cfnNotificationChannelPropsMixin := awscdkcfnpropertymixins.Aws_fms.NewCfnNotificationChannelPropsMixin(&CfnNotificationChannelMixinProps{
...
func (j *jsiiProxy_CfnNotificationChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNotificationChannelPropsMixin(props *CfnNotificationChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNotificationChannelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FMS::NotificationChannel`.
func NewCfnNotificationChannelPropsMixin_Override(c CfnNotificationChannelPropsMixin, props *CfnNotificationChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNotificationChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
