...
func validateNewCfnNotificationChannelPropsMixinParameters(props *CfnNotificationChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
