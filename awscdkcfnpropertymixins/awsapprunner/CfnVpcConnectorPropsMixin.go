...
//
//   cfnVpcConnectorPropsMixin := awscdkcfnpropertymixins.Aws_apprunner.NewCfnVpcConnectorPropsMixin(&CfnVpcConnectorMixinProps{
...
func (j *jsiiProxy_CfnVpcConnectorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVpcConnectorPropsMixin(props *CfnVpcConnectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcConnectorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppRunner::VpcConnector`.
func NewCfnVpcConnectorPropsMixin_Override(c CfnVpcConnectorPropsMixin, props *CfnVpcConnectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVpcConnectorPropsMixin) ApplyTo(construct constructs.IConstruct) {
