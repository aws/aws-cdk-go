...
//
//   cfnVpcIngressConnectionPropsMixin := awscdkcfnpropertymixins.Aws_apprunner.NewCfnVpcIngressConnectionPropsMixin(&CfnVpcIngressConnectionMixinProps{
...
func NewCfnVpcIngressConnectionPropsMixin(props *CfnVpcIngressConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcIngressConnectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppRunner::VpcIngressConnection`.
func NewCfnVpcIngressConnectionPropsMixin_Override(c CfnVpcIngressConnectionPropsMixin, props *CfnVpcIngressConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVpcIngressConnectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
