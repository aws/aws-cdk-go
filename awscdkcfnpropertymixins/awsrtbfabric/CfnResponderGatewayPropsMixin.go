...
func NewCfnResponderGatewayPropsMixin(props *CfnResponderGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResponderGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RTBFabric::ResponderGateway`.
func NewCfnResponderGatewayPropsMixin_Override(c CfnResponderGatewayPropsMixin, props *CfnResponderGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResponderGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) {
