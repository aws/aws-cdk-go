...
//
//   cfnOutboundExternalLinkPropsMixin := awscdkcfnpropertymixins.Aws_rtbfabric.NewCfnOutboundExternalLinkPropsMixin(&CfnOutboundExternalLinkMixinProps{
...
func (j *jsiiProxy_CfnOutboundExternalLinkPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOutboundExternalLinkPropsMixin(props *CfnOutboundExternalLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOutboundExternalLinkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RTBFabric::OutboundExternalLink`.
func NewCfnOutboundExternalLinkPropsMixin_Override(c CfnOutboundExternalLinkPropsMixin, props *CfnOutboundExternalLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
