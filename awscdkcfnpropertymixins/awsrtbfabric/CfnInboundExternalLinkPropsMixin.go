...
//
//   cfnInboundExternalLinkPropsMixin := awscdkcfnpropertymixins.Aws_rtbfabric.NewCfnInboundExternalLinkPropsMixin(&CfnInboundExternalLinkMixinProps{
...
func NewCfnInboundExternalLinkPropsMixin(props *CfnInboundExternalLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInboundExternalLinkPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RTBFabric::InboundExternalLink`.
func NewCfnInboundExternalLinkPropsMixin_Override(c CfnInboundExternalLinkPropsMixin, props *CfnInboundExternalLinkMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
