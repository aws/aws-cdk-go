...
//
//   cfnOrganizationTelemetryRulePropsMixin := awscdkcfnpropertymixins.Aws_observabilityadmin.NewCfnOrganizationTelemetryRulePropsMixin(&CfnOrganizationTelemetryRuleMixinProps{
...
func (j *jsiiProxy_CfnOrganizationTelemetryRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOrganizationTelemetryRulePropsMixin(props *CfnOrganizationTelemetryRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOrganizationTelemetryRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ObservabilityAdmin::OrganizationTelemetryRule`.
func NewCfnOrganizationTelemetryRulePropsMixin_Override(c CfnOrganizationTelemetryRulePropsMixin, props *CfnOrganizationTelemetryRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnOrganizationTelemetryRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
