...
func (j *jsiiProxy_CfnTelemetryRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTelemetryRulePropsMixin(props *CfnTelemetryRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTelemetryRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ObservabilityAdmin::TelemetryRule`.
func NewCfnTelemetryRulePropsMixin_Override(c CfnTelemetryRulePropsMixin, props *CfnTelemetryRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTelemetryRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
