...
//
//   cfnS3TableIntegrationPropsMixin := awscdkcfnpropertymixins.Aws_observabilityadmin.NewCfnS3TableIntegrationPropsMixin(&CfnS3TableIntegrationMixinProps{
...
func NewCfnS3TableIntegrationPropsMixin(props *CfnS3TableIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnS3TableIntegrationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ObservabilityAdmin::S3TableIntegration`.
func NewCfnS3TableIntegrationPropsMixin_Override(c CfnS3TableIntegrationPropsMixin, props *CfnS3TableIntegrationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnS3TableIntegrationPropsMixin) ApplyTo(construct constructs.IConstruct) {
