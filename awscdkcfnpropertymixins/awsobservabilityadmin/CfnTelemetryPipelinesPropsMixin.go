...
//
//   cfnTelemetryPipelinesPropsMixin := awscdkcfnpropertymixins.Aws_observabilityadmin.NewCfnTelemetryPipelinesPropsMixin(&CfnTelemetryPipelinesMixinProps{
...
func (j *jsiiProxy_CfnTelemetryPipelinesPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTelemetryPipelinesPropsMixin(props *CfnTelemetryPipelinesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTelemetryPipelinesPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ObservabilityAdmin::TelemetryPipelines`.
func NewCfnTelemetryPipelinesPropsMixin_Override(c CfnTelemetryPipelinesPropsMixin, props *CfnTelemetryPipelinesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
