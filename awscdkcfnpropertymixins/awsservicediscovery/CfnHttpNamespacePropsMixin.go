...
//
//   cfnHttpNamespacePropsMixin := awscdkcfnpropertymixins.Aws_servicediscovery.NewCfnHttpNamespacePropsMixin(&CfnHttpNamespaceMixinProps{
...
func NewCfnHttpNamespacePropsMixin(props *CfnHttpNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHttpNamespacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ServiceDiscovery::HttpNamespace`.
func NewCfnHttpNamespacePropsMixin_Override(c CfnHttpNamespacePropsMixin, props *CfnHttpNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
