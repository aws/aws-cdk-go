...
//
//   cfnPrivateDnsNamespacePropsMixin := awscdkcfnpropertymixins.Aws_servicediscovery.NewCfnPrivateDnsNamespacePropsMixin(&CfnPrivateDnsNamespaceMixinProps{
...
func (j *jsiiProxy_CfnPrivateDnsNamespacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPrivateDnsNamespacePropsMixin(props *CfnPrivateDnsNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPrivateDnsNamespacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ServiceDiscovery::PrivateDnsNamespace`.
func NewCfnPrivateDnsNamespacePropsMixin_Override(c CfnPrivateDnsNamespacePropsMixin, props *CfnPrivateDnsNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPrivateDnsNamespacePropsMixin) ApplyTo(construct constructs.IConstruct) {
