...
//
//   cfnKeyPropsMixin := awscdkcfnpropertymixins.Aws_kms.NewCfnKeyPropsMixin(&CfnKeyMixinProps{
...
func (j *jsiiProxy_CfnKeyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnKeyPropsMixin(props *CfnKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnKeyPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_kms.CfnKeyPropsMixin",
...
// Create a mixin to apply properties to `AWS::KMS::Key`.
func NewCfnKeyPropsMixin_Override(c CfnKeyPropsMixin, props *CfnKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
