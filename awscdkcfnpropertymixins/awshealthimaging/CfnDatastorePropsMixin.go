...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awshealthimaging/internal"
...
//
//   cfnDatastorePropsMixin := awscdkcfnpropertymixins.Aws_healthimaging.NewCfnDatastorePropsMixin(&CfnDatastoreMixinProps{
...
func NewCfnDatastorePropsMixin(props *CfnDatastoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDatastorePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_healthimaging.CfnDatastorePropsMixin",
...
// Create a mixin to apply properties to `AWS::HealthImaging::Datastore`.
func NewCfnDatastorePropsMixin_Override(c CfnDatastorePropsMixin, props *CfnDatastoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDatastorePropsMixin) ApplyTo(construct constructs.IConstruct) {
