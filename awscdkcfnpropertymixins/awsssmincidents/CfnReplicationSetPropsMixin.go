...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsssmincidents/internal"
...
//
//   cfnReplicationSetPropsMixin := awscdkcfnpropertymixins.Aws_ssmincidents.NewCfnReplicationSetPropsMixin(&CfnReplicationSetMixinProps{
...
func (j *jsiiProxy_CfnReplicationSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReplicationSetPropsMixin(props *CfnReplicationSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSMIncidents::ReplicationSet`.
func NewCfnReplicationSetPropsMixin_Override(c CfnReplicationSetPropsMixin, props *CfnReplicationSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
