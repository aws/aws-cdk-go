...
//
//   cfnResponsePlanPropsMixin := awscdkcfnpropertymixins.Aws_ssmincidents.NewCfnResponsePlanPropsMixin(&CfnResponsePlanMixinProps{
//   	Actions: []interface{}{
//   		&ActionProperty{
...
func (j *jsiiProxy_CfnResponsePlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResponsePlanPropsMixin(props *CfnResponsePlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResponsePlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSMIncidents::ResponsePlan`.
func NewCfnResponsePlanPropsMixin_Override(c CfnResponsePlanPropsMixin, props *CfnResponsePlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
