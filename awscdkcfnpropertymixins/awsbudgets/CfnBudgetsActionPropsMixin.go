...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsbudgets/internal"
...
//
//   cfnBudgetsActionPropsMixin := awscdkcfnpropertymixins.Aws_budgets.NewCfnBudgetsActionPropsMixin(&CfnBudgetsActionMixinProps{
...
func (j *jsiiProxy_CfnBudgetsActionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBudgetsActionPropsMixin(props *CfnBudgetsActionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBudgetsActionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Budgets::BudgetsAction`.
func NewCfnBudgetsActionPropsMixin_Override(c CfnBudgetsActionPropsMixin, props *CfnBudgetsActionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
