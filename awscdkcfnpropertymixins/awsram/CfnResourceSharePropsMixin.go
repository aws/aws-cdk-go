...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsram/internal"
...
//
//   cfnResourceSharePropsMixin := awscdkcfnpropertymixins.Aws_ram.NewCfnResourceSharePropsMixin(&CfnResourceShareMixinProps{
...
func (j *jsiiProxy_CfnResourceSharePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceSharePropsMixin(props *CfnResourceShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceSharePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RAM::ResourceShare`.
func NewCfnResourceSharePropsMixin_Override(c CfnResourceSharePropsMixin, props *CfnResourceShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceSharePropsMixin) ApplyTo(construct constructs.IConstruct) {
