...
//
//   cfnCostCategoryPropsMixin := awscdkcfnpropertymixins.Aws_ce.NewCfnCostCategoryPropsMixin(&CfnCostCategoryMixinProps{
...
func (j *jsiiProxy_CfnCostCategoryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCostCategoryPropsMixin(props *CfnCostCategoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCostCategoryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CE::CostCategory`.
func NewCfnCostCategoryPropsMixin_Override(c CfnCostCategoryPropsMixin, props *CfnCostCategoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCostCategoryPropsMixin) ApplyTo(construct constructs.IConstruct) {
