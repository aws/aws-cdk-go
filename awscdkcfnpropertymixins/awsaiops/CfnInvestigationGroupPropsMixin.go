...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsaiops/internal"
...
//
//   cfnInvestigationGroupPropsMixin := awscdkcfnpropertymixins.Aws_aiops.NewCfnInvestigationGroupPropsMixin(&CfnInvestigationGroupMixinProps{
...
func (j *jsiiProxy_CfnInvestigationGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInvestigationGroupPropsMixin(props *CfnInvestigationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInvestigationGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AIOps::InvestigationGroup`.
func NewCfnInvestigationGroupPropsMixin_Override(c CfnInvestigationGroupPropsMixin, props *CfnInvestigationGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
