...
func validateNewCfnAssessmentTargetPropsMixinParameters(props *CfnAssessmentTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
