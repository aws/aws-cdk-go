...
func validateNewCfnAssessmentTemplatePropsMixinParameters(props *CfnAssessmentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
