...
//
//   cfnResourceGroupPropsMixin := awscdkcfnpropertymixins.Aws_inspector.NewCfnResourceGroupPropsMixin(&CfnResourceGroupMixinProps{
...
func (j *jsiiProxy_CfnResourceGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceGroupPropsMixin(props *CfnResourceGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceGroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_inspector.CfnResourceGroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::Inspector::ResourceGroup`.
func NewCfnResourceGroupPropsMixin_Override(c CfnResourceGroupPropsMixin, props *CfnResourceGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
