...
//
//   cfnConfigurationPolicyPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnConfigurationPolicyPropsMixin(&CfnConfigurationPolicyMixinProps{
...
func (j *jsiiProxy_CfnConfigurationPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConfigurationPolicyPropsMixin(props *CfnConfigurationPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::ConfigurationPolicy`.
func NewCfnConfigurationPolicyPropsMixin_Override(c CfnConfigurationPolicyPropsMixin, props *CfnConfigurationPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
