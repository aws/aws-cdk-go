...
//
//   cfnFindingAggregatorPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnFindingAggregatorPropsMixin(&CfnFindingAggregatorMixinProps{
...
func (j *jsiiProxy_CfnFindingAggregatorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFindingAggregatorPropsMixin(props *CfnFindingAggregatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFindingAggregatorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::FindingAggregator`.
func NewCfnFindingAggregatorPropsMixin_Override(c CfnFindingAggregatorPropsMixin, props *CfnFindingAggregatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFindingAggregatorPropsMixin) ApplyTo(construct constructs.IConstruct) {
