...
//
//   cfnInsightPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnInsightPropsMixin(&CfnInsightMixinProps{
...
func NewCfnInsightPropsMixin(props *CfnInsightMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInsightPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::Insight`.
func NewCfnInsightPropsMixin_Override(c CfnInsightPropsMixin, props *CfnInsightMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInsightPropsMixin) ApplyTo(construct constructs.IConstruct) {
