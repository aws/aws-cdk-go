...
//
//   cfnStandardPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnStandardPropsMixin(&CfnStandardMixinProps{
...
func NewCfnStandardPropsMixin(props *CfnStandardMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStandardPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::Standard`.
func NewCfnStandardPropsMixin_Override(c CfnStandardPropsMixin, props *CfnStandardMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
