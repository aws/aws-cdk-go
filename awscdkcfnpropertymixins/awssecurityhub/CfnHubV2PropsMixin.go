...
//
//   cfnHubV2PropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnHubV2PropsMixin(&CfnHubV2MixinProps{
...
func (j *jsiiProxy_CfnHubV2PropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHubV2PropsMixin(props *CfnHubV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHubV2PropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::HubV2`.
func NewCfnHubV2PropsMixin_Override(c CfnHubV2PropsMixin, props *CfnHubV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHubV2PropsMixin) ApplyTo(construct constructs.IConstruct) {
