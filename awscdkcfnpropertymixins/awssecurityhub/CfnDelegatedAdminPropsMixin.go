...
//
//   cfnDelegatedAdminPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnDelegatedAdminPropsMixin(&CfnDelegatedAdminMixinProps{
...
func (j *jsiiProxy_CfnDelegatedAdminPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDelegatedAdminPropsMixin(props *CfnDelegatedAdminMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDelegatedAdminPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::DelegatedAdmin`.
func NewCfnDelegatedAdminPropsMixin_Override(c CfnDelegatedAdminPropsMixin, props *CfnDelegatedAdminMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDelegatedAdminPropsMixin) ApplyTo(construct constructs.IConstruct) {
