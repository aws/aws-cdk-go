...
//
//   cfnSecurityControlPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnSecurityControlPropsMixin(&CfnSecurityControlMixinProps{
...
func (j *jsiiProxy_CfnSecurityControlPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecurityControlPropsMixin(props *CfnSecurityControlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityControlPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::SecurityControl`.
func NewCfnSecurityControlPropsMixin_Override(c CfnSecurityControlPropsMixin, props *CfnSecurityControlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSecurityControlPropsMixin) ApplyTo(construct constructs.IConstruct) {
