...
//
//   cfnAutomationRulePropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnAutomationRulePropsMixin(&CfnAutomationRuleMixinProps{
//   	Actions: []interface{}{
...
func (j *jsiiProxy_CfnAutomationRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAutomationRulePropsMixin(props *CfnAutomationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAutomationRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::AutomationRule`.
func NewCfnAutomationRulePropsMixin_Override(c CfnAutomationRulePropsMixin, props *CfnAutomationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
