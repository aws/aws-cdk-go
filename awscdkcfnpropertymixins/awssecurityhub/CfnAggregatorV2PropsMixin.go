...
//
//   cfnAggregatorV2PropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnAggregatorV2PropsMixin(&CfnAggregatorV2MixinProps{
...
func (j *jsiiProxy_CfnAggregatorV2PropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAggregatorV2PropsMixin(props *CfnAggregatorV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAggregatorV2PropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::AggregatorV2`.
func NewCfnAggregatorV2PropsMixin_Override(c CfnAggregatorV2PropsMixin, props *CfnAggregatorV2MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
