...
//
//   cfnOrganizationConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_securityhub.NewCfnOrganizationConfigurationPropsMixin(&CfnOrganizationConfigurationMixinProps{
...
func (j *jsiiProxy_CfnOrganizationConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOrganizationConfigurationPropsMixin(props *CfnOrganizationConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOrganizationConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SecurityHub::OrganizationConfiguration`.
func NewCfnOrganizationConfigurationPropsMixin_Override(c CfnOrganizationConfigurationPropsMixin, props *CfnOrganizationConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnOrganizationConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
