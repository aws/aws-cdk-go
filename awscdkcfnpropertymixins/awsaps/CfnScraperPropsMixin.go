...
//
//   cfnScraperPropsMixin := awscdkcfnpropertymixins.Aws_aps.NewCfnScraperPropsMixin(&CfnScraperMixinProps{
...
func (j *jsiiProxy_CfnScraperPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnScraperPropsMixin(props *CfnScraperMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScraperPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::APS::Scraper`.
func NewCfnScraperPropsMixin_Override(c CfnScraperPropsMixin, props *CfnScraperMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
