...
//
//   cfnAnomalyDetectorPropsMixin := awscdkcfnpropertymixins.Aws_aps.NewCfnAnomalyDetectorPropsMixin(&CfnAnomalyDetectorMixinProps{
...
func NewCfnAnomalyDetectorPropsMixin(props *CfnAnomalyDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAnomalyDetectorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::APS::AnomalyDetector`.
func NewCfnAnomalyDetectorPropsMixin_Override(c CfnAnomalyDetectorPropsMixin, props *CfnAnomalyDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAnomalyDetectorPropsMixin) ApplyTo(construct constructs.IConstruct) {
