...
func validateNewCfnAnomalyDetectorPropsMixinParameters(props *CfnAnomalyDetectorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
