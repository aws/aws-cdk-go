...
//
//   cfnComponentTypePropsMixin := awscdkcfnpropertymixins.Aws_iottwinmaker.NewCfnComponentTypePropsMixin(&CfnComponentTypeMixinProps{
...
func NewCfnComponentTypePropsMixin(props *CfnComponentTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComponentTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTTwinMaker::ComponentType`.
func NewCfnComponentTypePropsMixin_Override(c CfnComponentTypePropsMixin, props *CfnComponentTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnComponentTypePropsMixin) ApplyTo(construct constructs.IConstruct) {
