...
//
//   cfnSyncJobPropsMixin := awscdkcfnpropertymixins.Aws_iottwinmaker.NewCfnSyncJobPropsMixin(&CfnSyncJobMixinProps{
...
func (j *jsiiProxy_CfnSyncJobPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSyncJobPropsMixin(props *CfnSyncJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSyncJobPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTTwinMaker::SyncJob`.
func NewCfnSyncJobPropsMixin_Override(c CfnSyncJobPropsMixin, props *CfnSyncJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
