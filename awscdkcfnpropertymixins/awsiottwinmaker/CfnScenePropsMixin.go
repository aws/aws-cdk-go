...
//
//   cfnScenePropsMixin := awscdkcfnpropertymixins.Aws_iottwinmaker.NewCfnScenePropsMixin(&CfnSceneMixinProps{
//   	Capabilities: []*string{
...
func NewCfnScenePropsMixin(props *CfnSceneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScenePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoTTwinMaker::Scene`.
func NewCfnScenePropsMixin_Override(c CfnScenePropsMixin, props *CfnSceneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
