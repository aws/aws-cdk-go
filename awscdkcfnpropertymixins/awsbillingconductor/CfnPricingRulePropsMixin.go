...
//
//   cfnPricingRulePropsMixin := awscdkcfnpropertymixins.Aws_billingconductor.NewCfnPricingRulePropsMixin(&CfnPricingRuleMixinProps{
...
func (j *jsiiProxy_CfnPricingRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPricingRulePropsMixin(props *CfnPricingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPricingRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BillingConductor::PricingRule`.
func NewCfnPricingRulePropsMixin_Override(c CfnPricingRulePropsMixin, props *CfnPricingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPricingRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
