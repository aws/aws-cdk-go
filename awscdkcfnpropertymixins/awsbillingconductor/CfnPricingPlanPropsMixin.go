...
//
//   cfnPricingPlanPropsMixin := awscdkcfnpropertymixins.Aws_billingconductor.NewCfnPricingPlanPropsMixin(&CfnPricingPlanMixinProps{
...
func (j *jsiiProxy_CfnPricingPlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPricingPlanPropsMixin(props *CfnPricingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPricingPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::BillingConductor::PricingPlan`.
func NewCfnPricingPlanPropsMixin_Override(c CfnPricingPlanPropsMixin, props *CfnPricingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPricingPlanPropsMixin) ApplyTo(construct constructs.IConstruct) {
