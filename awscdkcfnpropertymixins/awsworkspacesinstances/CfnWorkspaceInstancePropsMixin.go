...
//
//   cfnWorkspaceInstancePropsMixin := awscdkcfnpropertymixins.Aws_workspacesinstances.NewCfnWorkspaceInstancePropsMixin(&CfnWorkspaceInstanceMixinProps{
...
func (j *jsiiProxy_CfnWorkspaceInstancePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWorkspaceInstancePropsMixin(props *CfnWorkspaceInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkspaceInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WorkspacesInstances::WorkspaceInstance`.
func NewCfnWorkspaceInstancePropsMixin_Override(c CfnWorkspaceInstancePropsMixin, props *CfnWorkspaceInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWorkspaceInstancePropsMixin) ApplyTo(construct constructs.IConstruct) {
