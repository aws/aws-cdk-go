...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsdevopsguru/internal"
...
//
//   cfnResourceCollectionPropsMixin := awscdkcfnpropertymixins.Aws_devopsguru.NewCfnResourceCollectionPropsMixin(&CfnResourceCollectionMixinProps{
...
func (j *jsiiProxy_CfnResourceCollectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceCollectionPropsMixin(props *CfnResourceCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceCollectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DevOpsGuru::ResourceCollection`.
func NewCfnResourceCollectionPropsMixin_Override(c CfnResourceCollectionPropsMixin, props *CfnResourceCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceCollectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
