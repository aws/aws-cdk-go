...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsworkspacesthinclient/internal"
...
//
//   cfnEnvironmentPropsMixin := awscdkcfnpropertymixins.Aws_workspacesthinclient.NewCfnEnvironmentPropsMixin(&CfnEnvironmentMixinProps{
...
func NewCfnEnvironmentPropsMixin(props *CfnEnvironmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnvironmentPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_workspacesthinclient.CfnEnvironmentPropsMixin",
