...
//
type CfnNetworkMigrationDefinitionPropsMixin_SourceConfigurationProperty struct {
	...
	//
	SourceEnvironment *string `field:"optional" json:"sourceEnvironment" yaml:"sourceEnvironment"`
	...
	//
	SourceS3Configuration interface{} `field:"optional" json:"sourceS3Configuration" yaml:"sourceS3Configuration"`
}
