...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscodecommit/internal"
...
//
//   cfnRepositoryPropsMixin := awscdkcfnpropertymixins.Aws_codecommit.NewCfnRepositoryPropsMixin(&CfnRepositoryMixinProps{
//   	Code: &CodeProperty{
...
func NewCfnRepositoryPropsMixin(props *CfnRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRepositoryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodeCommit::Repository`.
func NewCfnRepositoryPropsMixin_Override(c CfnRepositoryPropsMixin, props *CfnRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
