...
//
//   cfnCustomResourcePropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnCustomResourcePropsMixin(&CfnCustomResourceMixinProps{
...
func NewCfnCustomResourcePropsMixin(props *CfnCustomResourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCustomResourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::CustomResource`.
func NewCfnCustomResourcePropsMixin_Override(c CfnCustomResourcePropsMixin, props *CfnCustomResourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
