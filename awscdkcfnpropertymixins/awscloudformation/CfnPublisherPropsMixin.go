...
//
//   cfnPublisherPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnPublisherPropsMixin(&CfnPublisherMixinProps{
...
func (j *jsiiProxy_CfnPublisherPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPublisherPropsMixin(props *CfnPublisherMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPublisherPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::Publisher`.
func NewCfnPublisherPropsMixin_Override(c CfnPublisherPropsMixin, props *CfnPublisherMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
