...
//
//   cfnHookVersionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnHookVersionPropsMixin(&CfnHookVersionMixinProps{
...
func (j *jsiiProxy_CfnHookVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHookVersionPropsMixin(props *CfnHookVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHookVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::HookVersion`.
func NewCfnHookVersionPropsMixin_Override(c CfnHookVersionPropsMixin, props *CfnHookVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHookVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
