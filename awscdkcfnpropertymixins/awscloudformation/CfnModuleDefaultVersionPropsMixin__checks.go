...
func validateNewCfnModuleDefaultVersionPropsMixinParameters(props *CfnModuleDefaultVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
