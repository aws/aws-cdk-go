...
func NewCfnLambdaHookPropsMixin(props *CfnLambdaHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLambdaHookPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::LambdaHook`.
func NewCfnLambdaHookPropsMixin_Override(c CfnLambdaHookPropsMixin, props *CfnLambdaHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
