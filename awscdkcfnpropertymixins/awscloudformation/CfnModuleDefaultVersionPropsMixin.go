...
//
//   cfnModuleDefaultVersionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnModuleDefaultVersionPropsMixin(&CfnModuleDefaultVersionMixinProps{
//   	Arn: jsii.String("arn"),
...
func (j *jsiiProxy_CfnModuleDefaultVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnModuleDefaultVersionPropsMixin(props *CfnModuleDefaultVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModuleDefaultVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::ModuleDefaultVersion`.
func NewCfnModuleDefaultVersionPropsMixin_Override(c CfnModuleDefaultVersionPropsMixin, props *CfnModuleDefaultVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnModuleDefaultVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
