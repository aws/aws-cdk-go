...
//
//   cfnTypeActivationPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnTypeActivationPropsMixin(&CfnTypeActivationMixinProps{
...
func (j *jsiiProxy_CfnTypeActivationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTypeActivationPropsMixin(props *CfnTypeActivationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTypeActivationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::TypeActivation`.
func NewCfnTypeActivationPropsMixin_Override(c CfnTypeActivationPropsMixin, props *CfnTypeActivationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTypeActivationPropsMixin) ApplyTo(construct constructs.IConstruct) {
