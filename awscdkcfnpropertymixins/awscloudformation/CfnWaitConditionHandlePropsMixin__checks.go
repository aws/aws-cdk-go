...
func validateNewCfnWaitConditionHandlePropsMixinParameters(props *CfnWaitConditionHandleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
