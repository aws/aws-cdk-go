...
//
//   cfnHookTypeConfigPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnHookTypeConfigPropsMixin(&CfnHookTypeConfigMixinProps{
...
func (j *jsiiProxy_CfnHookTypeConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHookTypeConfigPropsMixin(props *CfnHookTypeConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHookTypeConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::HookTypeConfig`.
func NewCfnHookTypeConfigPropsMixin_Override(c CfnHookTypeConfigPropsMixin, props *CfnHookTypeConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHookTypeConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
