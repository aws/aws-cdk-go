...
//
//   cfnWaitConditionHandlePropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnWaitConditionHandlePropsMixin(&CfnWaitConditionHandleMixinProps{
...
func (j *jsiiProxy_CfnWaitConditionHandlePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWaitConditionHandlePropsMixin(props *CfnWaitConditionHandleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWaitConditionHandlePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::WaitConditionHandle`.
func NewCfnWaitConditionHandlePropsMixin_Override(c CfnWaitConditionHandlePropsMixin, props *CfnWaitConditionHandleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWaitConditionHandlePropsMixin) ApplyTo(construct constructs.IConstruct) {
