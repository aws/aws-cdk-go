...
//
//   cfnWaitConditionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnWaitConditionPropsMixin(&CfnWaitConditionMixinProps{
...
func (j *jsiiProxy_CfnWaitConditionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWaitConditionPropsMixin(props *CfnWaitConditionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWaitConditionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::WaitCondition`.
func NewCfnWaitConditionPropsMixin_Override(c CfnWaitConditionPropsMixin, props *CfnWaitConditionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWaitConditionPropsMixin) ApplyTo(construct constructs.IConstruct) {
