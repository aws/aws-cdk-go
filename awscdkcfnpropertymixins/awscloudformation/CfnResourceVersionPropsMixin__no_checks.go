...
func validateNewCfnResourceVersionPropsMixinParameters(props *CfnResourceVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
