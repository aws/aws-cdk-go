...
//
//   cfnHookDefaultVersionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnHookDefaultVersionPropsMixin(&CfnHookDefaultVersionMixinProps{
...
func (j *jsiiProxy_CfnHookDefaultVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHookDefaultVersionPropsMixin(props *CfnHookDefaultVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHookDefaultVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::HookDefaultVersion`.
func NewCfnHookDefaultVersionPropsMixin_Override(c CfnHookDefaultVersionPropsMixin, props *CfnHookDefaultVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHookDefaultVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
