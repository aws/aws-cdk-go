...
//
//   cfnGuardHookPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnGuardHookPropsMixin(&CfnGuardHookMixinProps{
...
func (j *jsiiProxy_CfnGuardHookPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGuardHookPropsMixin(props *CfnGuardHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGuardHookPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::GuardHook`.
func NewCfnGuardHookPropsMixin_Override(c CfnGuardHookPropsMixin, props *CfnGuardHookMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
