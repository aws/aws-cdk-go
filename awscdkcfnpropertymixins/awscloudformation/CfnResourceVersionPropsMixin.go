...
//
//   cfnResourceVersionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnResourceVersionPropsMixin(&CfnResourceVersionMixinProps{
...
func (j *jsiiProxy_CfnResourceVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceVersionPropsMixin(props *CfnResourceVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::ResourceVersion`.
func NewCfnResourceVersionPropsMixin_Override(c CfnResourceVersionPropsMixin, props *CfnResourceVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
