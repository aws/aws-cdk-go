...
//
//   cfnPublicTypeVersionPropsMixin := awscdkcfnpropertymixins.Aws_cloudformation.NewCfnPublicTypeVersionPropsMixin(&CfnPublicTypeVersionMixinProps{
//   	Arn: jsii.String("arn"),
...
func (j *jsiiProxy_CfnPublicTypeVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPublicTypeVersionPropsMixin(props *CfnPublicTypeVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPublicTypeVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFormation::PublicTypeVersion`.
func NewCfnPublicTypeVersionPropsMixin_Override(c CfnPublicTypeVersionPropsMixin, props *CfnPublicTypeVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
