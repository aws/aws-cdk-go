...
//
//   cfnDeploymentGroupPropsMixin := awscdkcfnpropertymixins.Aws_codedeploy.NewCfnDeploymentGroupPropsMixin(&CfnDeploymentGroupMixinProps{
...
func NewCfnDeploymentGroupPropsMixin(props *CfnDeploymentGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodeDeploy::DeploymentGroup`.
func NewCfnDeploymentGroupPropsMixin_Override(c CfnDeploymentGroupPropsMixin, props *CfnDeploymentGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
