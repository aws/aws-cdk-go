...
//
//   cfnDeploymentConfigPropsMixin := awscdkcfnpropertymixins.Aws_codedeploy.NewCfnDeploymentConfigPropsMixin(&CfnDeploymentConfigMixinProps{
...
func (j *jsiiProxy_CfnDeploymentConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDeploymentConfigPropsMixin(props *CfnDeploymentConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeploymentConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodeDeploy::DeploymentConfig`.
func NewCfnDeploymentConfigPropsMixin_Override(c CfnDeploymentConfigPropsMixin, props *CfnDeploymentConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
