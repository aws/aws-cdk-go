...
//
//   cfnTargetAccountConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_fis.NewCfnTargetAccountConfigurationPropsMixin(&CfnTargetAccountConfigurationMixinProps{
...
func (j *jsiiProxy_CfnTargetAccountConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTargetAccountConfigurationPropsMixin(props *CfnTargetAccountConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTargetAccountConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FIS::TargetAccountConfiguration`.
func NewCfnTargetAccountConfigurationPropsMixin_Override(c CfnTargetAccountConfigurationPropsMixin, props *CfnTargetAccountConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTargetAccountConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
