...
//
//   cfnExperimentTemplatePropsMixin := awscdkcfnpropertymixins.Aws_fis.NewCfnExperimentTemplatePropsMixin(&CfnExperimentTemplateMixinProps{
...
func NewCfnExperimentTemplatePropsMixin(props *CfnExperimentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnExperimentTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::FIS::ExperimentTemplate`.
func NewCfnExperimentTemplatePropsMixin_Override(c CfnExperimentTemplatePropsMixin, props *CfnExperimentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
