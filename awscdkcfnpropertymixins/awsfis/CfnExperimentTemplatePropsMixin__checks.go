...
func validateNewCfnExperimentTemplatePropsMixinParameters(props *CfnExperimentTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
