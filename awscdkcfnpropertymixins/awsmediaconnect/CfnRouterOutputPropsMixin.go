...
//
//   cfnRouterOutputPropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnRouterOutputPropsMixin(&CfnRouterOutputMixinProps{
...
func (j *jsiiProxy_CfnRouterOutputPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRouterOutputPropsMixin(props *CfnRouterOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouterOutputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::RouterOutput`.
func NewCfnRouterOutputPropsMixin_Override(c CfnRouterOutputPropsMixin, props *CfnRouterOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRouterOutputPropsMixin) ApplyTo(construct constructs.IConstruct) {
