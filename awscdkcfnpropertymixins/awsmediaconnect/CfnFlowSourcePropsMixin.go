...
//
//   cfnFlowSourcePropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnFlowSourcePropsMixin(&CfnFlowSourceMixinProps{
...
func (j *jsiiProxy_CfnFlowSourcePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowSourcePropsMixin(props *CfnFlowSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowSourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::FlowSource`.
func NewCfnFlowSourcePropsMixin_Override(c CfnFlowSourcePropsMixin, props *CfnFlowSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFlowSourcePropsMixin) ApplyTo(construct constructs.IConstruct) {
