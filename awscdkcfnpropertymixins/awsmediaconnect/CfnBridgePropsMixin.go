...
//
//   cfnBridgePropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnBridgePropsMixin(&CfnBridgeMixinProps{
...
func (j *jsiiProxy_CfnBridgePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBridgePropsMixin(props *CfnBridgeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBridgePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::Bridge`.
func NewCfnBridgePropsMixin_Override(c CfnBridgePropsMixin, props *CfnBridgeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBridgePropsMixin) ApplyTo(construct constructs.IConstruct) {
