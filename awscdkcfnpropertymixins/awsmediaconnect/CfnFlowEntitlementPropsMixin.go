...
//
//   cfnFlowEntitlementPropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnFlowEntitlementPropsMixin(&CfnFlowEntitlementMixinProps{
...
func (j *jsiiProxy_CfnFlowEntitlementPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowEntitlementPropsMixin(props *CfnFlowEntitlementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowEntitlementPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::FlowEntitlement`.
func NewCfnFlowEntitlementPropsMixin_Override(c CfnFlowEntitlementPropsMixin, props *CfnFlowEntitlementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFlowEntitlementPropsMixin) ApplyTo(construct constructs.IConstruct) {
