...
//
//   cfnFlowVpcInterfacePropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnFlowVpcInterfacePropsMixin(&CfnFlowVpcInterfaceMixinProps{
...
func (j *jsiiProxy_CfnFlowVpcInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowVpcInterfacePropsMixin(props *CfnFlowVpcInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowVpcInterfacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::FlowVpcInterface`.
func NewCfnFlowVpcInterfacePropsMixin_Override(c CfnFlowVpcInterfacePropsMixin, props *CfnFlowVpcInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
