...
//
//   cfnBridgeOutputPropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnBridgeOutputPropsMixin(&CfnBridgeOutputMixinProps{
...
func (j *jsiiProxy_CfnBridgeOutputPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBridgeOutputPropsMixin(props *CfnBridgeOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBridgeOutputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::BridgeOutput`.
func NewCfnBridgeOutputPropsMixin_Override(c CfnBridgeOutputPropsMixin, props *CfnBridgeOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBridgeOutputPropsMixin) ApplyTo(construct constructs.IConstruct) {
