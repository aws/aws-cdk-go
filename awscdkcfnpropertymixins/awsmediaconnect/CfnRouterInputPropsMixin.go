...
//
//   cfnRouterInputPropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnRouterInputPropsMixin(&CfnRouterInputMixinProps{
...
func NewCfnRouterInputPropsMixin(props *CfnRouterInputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouterInputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::RouterInput`.
func NewCfnRouterInputPropsMixin_Override(c CfnRouterInputPropsMixin, props *CfnRouterInputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRouterInputPropsMixin) ApplyTo(construct constructs.IConstruct) {
