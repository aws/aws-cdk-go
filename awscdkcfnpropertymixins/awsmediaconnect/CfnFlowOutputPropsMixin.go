...
//
//   cfnFlowOutputPropsMixin := awscdkcfnpropertymixins.Aws_mediaconnect.NewCfnFlowOutputPropsMixin(&CfnFlowOutputMixinProps{
...
func NewCfnFlowOutputPropsMixin(props *CfnFlowOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowOutputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaConnect::FlowOutput`.
func NewCfnFlowOutputPropsMixin_Override(c CfnFlowOutputPropsMixin, props *CfnFlowOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
