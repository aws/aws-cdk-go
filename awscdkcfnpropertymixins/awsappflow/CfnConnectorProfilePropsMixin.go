...
//
//   cfnConnectorProfilePropsMixin := awscdkcfnpropertymixins.Aws_appflow.NewCfnConnectorProfilePropsMixin(&CfnConnectorProfileMixinProps{
...
func NewCfnConnectorProfilePropsMixin(props *CfnConnectorProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectorProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppFlow::ConnectorProfile`.
func NewCfnConnectorProfilePropsMixin_Override(c CfnConnectorProfilePropsMixin, props *CfnConnectorProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectorProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
