...
//
//   cfnFlowPropsMixin := awscdkcfnpropertymixins.Aws_appflow.NewCfnFlowPropsMixin(&CfnFlowMixinProps{
...
func NewCfnFlowPropsMixin(props *CfnFlowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AppFlow::Flow`.
func NewCfnFlowPropsMixin_Override(c CfnFlowPropsMixin, props *CfnFlowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
