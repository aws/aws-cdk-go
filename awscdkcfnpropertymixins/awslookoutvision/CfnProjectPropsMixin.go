...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awslookoutvision/internal"
...
//
//   cfnProjectPropsMixin := awscdkcfnpropertymixins.Aws_lookoutvision.NewCfnProjectPropsMixin(&CfnProjectMixinProps{
...
func NewCfnProjectPropsMixin(props *CfnProjectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProjectPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_lookoutvision.CfnProjectPropsMixin",
