...
func validateNewCfnOrganizationAdminPropsMixinParameters(props *CfnOrganizationAdminMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
