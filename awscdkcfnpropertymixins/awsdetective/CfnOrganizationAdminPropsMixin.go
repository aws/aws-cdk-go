...
//
//   cfnOrganizationAdminPropsMixin := awscdkcfnpropertymixins.Aws_detective.NewCfnOrganizationAdminPropsMixin(&CfnOrganizationAdminMixinProps{
...
func NewCfnOrganizationAdminPropsMixin(props *CfnOrganizationAdminMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOrganizationAdminPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Detective::OrganizationAdmin`.
func NewCfnOrganizationAdminPropsMixin_Override(c CfnOrganizationAdminPropsMixin, props *CfnOrganizationAdminMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
