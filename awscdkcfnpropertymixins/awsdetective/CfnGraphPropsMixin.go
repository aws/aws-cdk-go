...
//
//   cfnGraphPropsMixin := awscdkcfnpropertymixins.Aws_detective.NewCfnGraphPropsMixin(&CfnGraphMixinProps{
...
func (j *jsiiProxy_CfnGraphPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGraphPropsMixin(props *CfnGraphMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGraphPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_detective.CfnGraphPropsMixin",
...
// Create a mixin to apply properties to `AWS::Detective::Graph`.
func NewCfnGraphPropsMixin_Override(c CfnGraphPropsMixin, props *CfnGraphMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGraphPropsMixin) ApplyTo(construct constructs.IConstruct) {
