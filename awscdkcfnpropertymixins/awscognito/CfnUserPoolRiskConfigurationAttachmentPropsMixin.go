...
//
//   cfnUserPoolRiskConfigurationAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnUserPoolRiskConfigurationAttachmentPropsMixin(&CfnUserPoolRiskConfigurationAttachmentMixinProps{
...
func (j *jsiiProxy_CfnUserPoolRiskConfigurationAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUserPoolRiskConfigurationAttachmentPropsMixin(props *CfnUserPoolRiskConfigurationAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolRiskConfigurationAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolRiskConfigurationAttachment`.
func NewCfnUserPoolRiskConfigurationAttachmentPropsMixin_Override(c CfnUserPoolRiskConfigurationAttachmentPropsMixin, props *CfnUserPoolRiskConfigurationAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserPoolRiskConfigurationAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
