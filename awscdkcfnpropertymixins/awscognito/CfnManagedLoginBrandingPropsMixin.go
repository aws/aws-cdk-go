...
//
//   cfnManagedLoginBrandingPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnManagedLoginBrandingPropsMixin(&CfnManagedLoginBrandingMixinProps{
//   	Assets: []interface{}{
//   		&AssetTypeProperty{
...
func NewCfnManagedLoginBrandingPropsMixin(props *CfnManagedLoginBrandingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnManagedLoginBrandingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::ManagedLoginBranding`.
func NewCfnManagedLoginBrandingPropsMixin_Override(c CfnManagedLoginBrandingPropsMixin, props *CfnManagedLoginBrandingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
