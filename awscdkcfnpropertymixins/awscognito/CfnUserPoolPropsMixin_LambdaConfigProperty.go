...
type CfnUserPoolPropsMixin_LambdaConfigProperty struct {
	...
	//
	CreateAuthChallenge interface{} `field:"optional" json:"createAuthChallenge" yaml:"createAuthChallenge"`
	...
	//
	DefineAuthChallenge interface{} `field:"optional" json:"defineAuthChallenge" yaml:"defineAuthChallenge"`
	...
	//
	PostAuthentication interface{} `field:"optional" json:"postAuthentication" yaml:"postAuthentication"`
	...
	//
	PostConfirmation interface{} `field:"optional" json:"postConfirmation" yaml:"postConfirmation"`
	...
	//
	PreAuthentication interface{} `field:"optional" json:"preAuthentication" yaml:"preAuthentication"`
	...
	//
	PreSignUp interface{} `field:"optional" json:"preSignUp" yaml:"preSignUp"`
	...
	//
	PreTokenGeneration interface{} `field:"optional" json:"preTokenGeneration" yaml:"preTokenGeneration"`
	...
	//
	VerifyAuthChallengeResponse interface{} `field:"optional" json:"verifyAuthChallengeResponse" yaml:"verifyAuthChallengeResponse"`
}
