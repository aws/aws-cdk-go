...
//
//   cfnUserPoolUICustomizationAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnUserPoolUICustomizationAttachmentPropsMixin(&CfnUserPoolUICustomizationAttachmentMixinProps{
...
func NewCfnUserPoolUICustomizationAttachmentPropsMixin(props *CfnUserPoolUICustomizationAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolUICustomizationAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolUICustomizationAttachment`.
func NewCfnUserPoolUICustomizationAttachmentPropsMixin_Override(c CfnUserPoolUICustomizationAttachmentPropsMixin, props *CfnUserPoolUICustomizationAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
