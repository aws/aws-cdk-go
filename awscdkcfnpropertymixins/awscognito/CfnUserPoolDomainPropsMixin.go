...
func (j *jsiiProxy_CfnUserPoolDomainPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUserPoolDomainPropsMixin(props *CfnUserPoolDomainMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolDomainPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolDomain`.
func NewCfnUserPoolDomainPropsMixin_Override(c CfnUserPoolDomainPropsMixin, props *CfnUserPoolDomainMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserPoolDomainPropsMixin) ApplyTo(construct constructs.IConstruct) {
