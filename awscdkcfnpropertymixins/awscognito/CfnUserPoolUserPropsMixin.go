...
//
//   cfnUserPoolUserPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnUserPoolUserPropsMixin(&CfnUserPoolUserMixinProps{
...
func (j *jsiiProxy_CfnUserPoolUserPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUserPoolUserPropsMixin(props *CfnUserPoolUserMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolUserPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolUser`.
func NewCfnUserPoolUserPropsMixin_Override(c CfnUserPoolUserPropsMixin, props *CfnUserPoolUserMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserPoolUserPropsMixin) ApplyTo(construct constructs.IConstruct) {
