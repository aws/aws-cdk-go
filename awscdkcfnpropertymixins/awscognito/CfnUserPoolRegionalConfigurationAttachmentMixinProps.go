...
//
//   cfnUserPoolRegionalConfigurationAttachmentMixinProps := &CfnUserPoolRegionalConfigurationAttachmentMixinProps{
...
//
type CfnUserPoolRegionalConfigurationAttachmentMixinProps struct {
