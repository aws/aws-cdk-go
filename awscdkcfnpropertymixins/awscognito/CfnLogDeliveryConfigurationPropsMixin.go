...
//
//   cfnLogDeliveryConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnLogDeliveryConfigurationPropsMixin(&CfnLogDeliveryConfigurationMixinProps{
...
func (j *jsiiProxy_CfnLogDeliveryConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLogDeliveryConfigurationPropsMixin(props *CfnLogDeliveryConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLogDeliveryConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::LogDeliveryConfiguration`.
func NewCfnLogDeliveryConfigurationPropsMixin_Override(c CfnLogDeliveryConfigurationPropsMixin, props *CfnLogDeliveryConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLogDeliveryConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
