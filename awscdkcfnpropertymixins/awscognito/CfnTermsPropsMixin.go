...
//
//   cfnTermsPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnTermsPropsMixin(&CfnTermsMixinProps{
...
func (j *jsiiProxy_CfnTermsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTermsPropsMixin(props *CfnTermsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTermsPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::Terms`.
func NewCfnTermsPropsMixin_Override(c CfnTermsPropsMixin, props *CfnTermsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
