...
func validateNewCfnUserPoolResourceServerPropsMixinParameters(props *CfnUserPoolResourceServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
