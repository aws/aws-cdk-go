...
func validateNewCfnUserPoolIdentityProviderPropsMixinParameters(props *CfnUserPoolIdentityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
