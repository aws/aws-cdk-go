...
//
//   cfnIdentityPoolPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnIdentityPoolPropsMixin(&CfnIdentityPoolMixinProps{
...
func NewCfnIdentityPoolPropsMixin(props *CfnIdentityPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdentityPoolPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::IdentityPool`.
func NewCfnIdentityPoolPropsMixin_Override(c CfnIdentityPoolPropsMixin, props *CfnIdentityPoolMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
