...
//
//   cfnUserPoolUserToGroupAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnUserPoolUserToGroupAttachmentPropsMixin(&CfnUserPoolUserToGroupAttachmentMixinProps{
...
func NewCfnUserPoolUserToGroupAttachmentPropsMixin(props *CfnUserPoolUserToGroupAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolUserToGroupAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolUserToGroupAttachment`.
func NewCfnUserPoolUserToGroupAttachmentPropsMixin_Override(c CfnUserPoolUserToGroupAttachmentPropsMixin, props *CfnUserPoolUserToGroupAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
