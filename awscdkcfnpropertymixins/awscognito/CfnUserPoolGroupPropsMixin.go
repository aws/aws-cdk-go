...
//
//   cfnUserPoolGroupPropsMixin := awscdkcfnpropertymixins.Aws_cognito.NewCfnUserPoolGroupPropsMixin(&CfnUserPoolGroupMixinProps{
...
func NewCfnUserPoolGroupPropsMixin(props *CfnUserPoolGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserPoolGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cognito::UserPoolGroup`.
func NewCfnUserPoolGroupPropsMixin_Override(c CfnUserPoolGroupPropsMixin, props *CfnUserPoolGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
