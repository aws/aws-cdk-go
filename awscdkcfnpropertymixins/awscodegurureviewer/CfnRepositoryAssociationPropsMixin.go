...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscodegurureviewer/internal"
...
//
//   cfnRepositoryAssociationPropsMixin := awscdkcfnpropertymixins.Aws_codegurureviewer.NewCfnRepositoryAssociationPropsMixin(&CfnRepositoryAssociationMixinProps{
...
func (j *jsiiProxy_CfnRepositoryAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRepositoryAssociationPropsMixin(props *CfnRepositoryAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRepositoryAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_codegurureviewer.CfnRepositoryAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::CodeGuruReviewer::RepositoryAssociation`.
func NewCfnRepositoryAssociationPropsMixin_Override(c CfnRepositoryAssociationPropsMixin, props *CfnRepositoryAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
