...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_cloud9.CfnEnvironmentEC2MixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_cloud9.CfnEnvironmentEC2PropsMixin.RepositoryProperty",
