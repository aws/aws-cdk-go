...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsgameliftstreams/internal"
...
//
//   cfnStreamGroupPropsMixin := awscdkcfnpropertymixins.Aws_gameliftstreams.NewCfnStreamGroupPropsMixin(&CfnStreamGroupMixinProps{
...
func (j *jsiiProxy_CfnStreamGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStreamGroupPropsMixin(props *CfnStreamGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::GameLiftStreams::StreamGroup`.
func NewCfnStreamGroupPropsMixin_Override(c CfnStreamGroupPropsMixin, props *CfnStreamGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStreamGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
