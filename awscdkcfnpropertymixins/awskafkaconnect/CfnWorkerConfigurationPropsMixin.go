...
//
//   cfnWorkerConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_kafkaconnect.NewCfnWorkerConfigurationPropsMixin(&CfnWorkerConfigurationMixinProps{
...
func (j *jsiiProxy_CfnWorkerConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWorkerConfigurationPropsMixin(props *CfnWorkerConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkerConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::KafkaConnect::WorkerConfiguration`.
func NewCfnWorkerConfigurationPropsMixin_Override(c CfnWorkerConfigurationPropsMixin, props *CfnWorkerConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
