...
//
//   cfnSlackChannelConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_chatbot.NewCfnSlackChannelConfigurationPropsMixin(&CfnSlackChannelConfigurationMixinProps{
...
func NewCfnSlackChannelConfigurationPropsMixin(props *CfnSlackChannelConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSlackChannelConfigurationPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_chatbot.CfnSlackChannelConfigurationPropsMixin",
