...
//
//   cfnMicrosoftTeamsChannelConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_chatbot.NewCfnMicrosoftTeamsChannelConfigurationPropsMixin(&CfnMicrosoftTeamsChannelConfigurationMixinProps{
...
func (j *jsiiProxy_CfnMicrosoftTeamsChannelConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMicrosoftTeamsChannelConfigurationPropsMixin(props *CfnMicrosoftTeamsChannelConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMicrosoftTeamsChannelConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_chatbot.CfnMicrosoftTeamsChannelConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Chatbot::MicrosoftTeamsChannelConfiguration`.
func NewCfnMicrosoftTeamsChannelConfigurationPropsMixin_Override(c CfnMicrosoftTeamsChannelConfigurationPropsMixin, props *CfnMicrosoftTeamsChannelConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMicrosoftTeamsChannelConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
