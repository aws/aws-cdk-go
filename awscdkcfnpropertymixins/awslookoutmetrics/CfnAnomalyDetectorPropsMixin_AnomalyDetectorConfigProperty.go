...
//
type CfnAnomalyDetectorPropsMixin_AnomalyDetectorConfigProperty struct {
	...
	//
	AnomalyDetectorFrequency *string `field:"optional" json:"anomalyDetectorFrequency" yaml:"anomalyDetectorFrequency"`
}
