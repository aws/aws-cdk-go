...
//
//   cfnSchemaPropsMixin := awscdkcfnpropertymixins.Aws_personalize.NewCfnSchemaPropsMixin(&CfnSchemaMixinProps{
...
func (j *jsiiProxy_CfnSchemaPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSchemaPropsMixin(props *CfnSchemaMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchemaPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Personalize::Schema`.
func NewCfnSchemaPropsMixin_Override(c CfnSchemaPropsMixin, props *CfnSchemaMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
