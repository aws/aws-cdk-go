...
//
//   cfnRecipePropsMixin := awscdkcfnpropertymixins.Aws_personalize.NewCfnRecipePropsMixin(&CfnRecipeMixinProps{
...
// Create a mixin to apply properties to `AWS::Personalize::Recipe`.
