...
//
//   cfnDatasetGroupPropsMixin := awscdkcfnpropertymixins.Aws_personalize.NewCfnDatasetGroupPropsMixin(&CfnDatasetGroupMixinProps{
...
func NewCfnDatasetGroupPropsMixin(props *CfnDatasetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDatasetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Personalize::DatasetGroup`.
func NewCfnDatasetGroupPropsMixin_Override(c CfnDatasetGroupPropsMixin, props *CfnDatasetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
