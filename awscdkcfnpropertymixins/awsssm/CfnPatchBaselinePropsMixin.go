...
//
//   cfnPatchBaselinePropsMixin := awscdkcfnpropertymixins.Aws_ssm.NewCfnPatchBaselinePropsMixin(&CfnPatchBaselineMixinProps{
...
func NewCfnPatchBaselinePropsMixin(props *CfnPatchBaselineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPatchBaselinePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSM::PatchBaseline`.
func NewCfnPatchBaselinePropsMixin_Override(c CfnPatchBaselinePropsMixin, props *CfnPatchBaselineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
