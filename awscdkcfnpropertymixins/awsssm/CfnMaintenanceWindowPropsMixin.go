...
//
//   cfnMaintenanceWindowPropsMixin := awscdkcfnpropertymixins.Aws_ssm.NewCfnMaintenanceWindowPropsMixin(&CfnMaintenanceWindowMixinProps{
...
func (j *jsiiProxy_CfnMaintenanceWindowPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMaintenanceWindowPropsMixin(props *CfnMaintenanceWindowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMaintenanceWindowPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSM::MaintenanceWindow`.
func NewCfnMaintenanceWindowPropsMixin_Override(c CfnMaintenanceWindowPropsMixin, props *CfnMaintenanceWindowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMaintenanceWindowPropsMixin) ApplyTo(construct constructs.IConstruct) {
