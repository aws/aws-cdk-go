...
//
//   cfnDocumentPropsMixin := awscdkcfnpropertymixins.Aws_ssm.NewCfnDocumentPropsMixin(&CfnDocumentMixinProps{
...
func (j *jsiiProxy_CfnDocumentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDocumentPropsMixin(props *CfnDocumentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDocumentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSM::Document`.
func NewCfnDocumentPropsMixin_Override(c CfnDocumentPropsMixin, props *CfnDocumentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDocumentPropsMixin) ApplyTo(construct constructs.IConstruct) {
