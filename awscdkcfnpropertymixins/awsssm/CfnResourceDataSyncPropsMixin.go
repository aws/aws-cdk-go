...
//
//   cfnResourceDataSyncPropsMixin := awscdkcfnpropertymixins.Aws_ssm.NewCfnResourceDataSyncPropsMixin(&CfnResourceDataSyncMixinProps{
...
func (j *jsiiProxy_CfnResourceDataSyncPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceDataSyncPropsMixin(props *CfnResourceDataSyncMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceDataSyncPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSM::ResourceDataSync`.
func NewCfnResourceDataSyncPropsMixin_Override(c CfnResourceDataSyncPropsMixin, props *CfnResourceDataSyncMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
