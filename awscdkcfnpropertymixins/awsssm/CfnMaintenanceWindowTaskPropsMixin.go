...
//
//   cfnMaintenanceWindowTaskPropsMixin := awscdkcfnpropertymixins.Aws_ssm.NewCfnMaintenanceWindowTaskPropsMixin(&CfnMaintenanceWindowTaskMixinProps{
...
func (j *jsiiProxy_CfnMaintenanceWindowTaskPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMaintenanceWindowTaskPropsMixin(props *CfnMaintenanceWindowTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMaintenanceWindowTaskPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSM::MaintenanceWindowTask`.
func NewCfnMaintenanceWindowTaskPropsMixin_Override(c CfnMaintenanceWindowTaskPropsMixin, props *CfnMaintenanceWindowTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMaintenanceWindowTaskPropsMixin) ApplyTo(construct constructs.IConstruct) {
