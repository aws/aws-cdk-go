...
//
//   cfnMaintenanceWindowMixinProps := &CfnMaintenanceWindowMixinProps{
...
//
type CfnMaintenanceWindowMixinProps struct {
	...
	//
	Cutoff *float64 `field:"optional" json:"cutoff" yaml:"cutoff"`
