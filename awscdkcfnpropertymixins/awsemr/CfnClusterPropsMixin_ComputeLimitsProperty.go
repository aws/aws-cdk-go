...
//
type CfnClusterPropsMixin_ComputeLimitsProperty struct {
	...
	//
	MaximumCapacityUnits *float64 `field:"optional" json:"maximumCapacityUnits" yaml:"maximumCapacityUnits"`
	...
	//
	MinimumCapacityUnits *float64 `field:"optional" json:"minimumCapacityUnits" yaml:"minimumCapacityUnits"`
	...
	//
	UnitType *string `field:"optional" json:"unitType" yaml:"unitType"`
}
