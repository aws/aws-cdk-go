...
func validateNewCfnInstanceGroupConfigPropsMixinParameters(props *CfnInstanceGroupConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
