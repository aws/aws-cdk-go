...
//
//   cfnStudioSessionMappingPropsMixin := awscdkcfnpropertymixins.Aws_emr.NewCfnStudioSessionMappingPropsMixin(&CfnStudioSessionMappingMixinProps{
...
func (j *jsiiProxy_CfnStudioSessionMappingPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStudioSessionMappingPropsMixin(props *CfnStudioSessionMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStudioSessionMappingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EMR::StudioSessionMapping`.
func NewCfnStudioSessionMappingPropsMixin_Override(c CfnStudioSessionMappingPropsMixin, props *CfnStudioSessionMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
