...
//
//   cfnInstanceFleetConfigPropsMixin := awscdkcfnpropertymixins.Aws_emr.NewCfnInstanceFleetConfigPropsMixin(&CfnInstanceFleetConfigMixinProps{
...
func (j *jsiiProxy_CfnInstanceFleetConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInstanceFleetConfigPropsMixin(props *CfnInstanceFleetConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstanceFleetConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EMR::InstanceFleetConfig`.
func NewCfnInstanceFleetConfigPropsMixin_Override(c CfnInstanceFleetConfigPropsMixin, props *CfnInstanceFleetConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
