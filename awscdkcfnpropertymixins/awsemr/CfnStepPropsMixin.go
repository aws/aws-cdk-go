...
//
//   cfnStepPropsMixin := awscdkcfnpropertymixins.Aws_emr.NewCfnStepPropsMixin(&CfnStepMixinProps{
...
func NewCfnStepPropsMixin(props *CfnStepMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStepPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EMR::Step`.
func NewCfnStepPropsMixin_Override(c CfnStepPropsMixin, props *CfnStepMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStepPropsMixin) ApplyTo(construct constructs.IConstruct) {
