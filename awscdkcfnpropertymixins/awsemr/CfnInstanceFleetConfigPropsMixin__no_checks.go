...
func validateNewCfnInstanceFleetConfigPropsMixinParameters(props *CfnInstanceFleetConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
