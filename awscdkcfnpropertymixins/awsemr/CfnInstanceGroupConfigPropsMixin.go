...
//
//   cfnInstanceGroupConfigPropsMixin := awscdkcfnpropertymixins.Aws_emr.NewCfnInstanceGroupConfigPropsMixin(&CfnInstanceGroupConfigMixinProps{
...
func NewCfnInstanceGroupConfigPropsMixin(props *CfnInstanceGroupConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstanceGroupConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EMR::InstanceGroupConfig`.
func NewCfnInstanceGroupConfigPropsMixin_Override(c CfnInstanceGroupConfigPropsMixin, props *CfnInstanceGroupConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
