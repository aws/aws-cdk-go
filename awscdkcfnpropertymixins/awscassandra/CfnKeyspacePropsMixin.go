...
//
//   cfnKeyspacePropsMixin := awscdkcfnpropertymixins.Aws_cassandra.NewCfnKeyspacePropsMixin(&CfnKeyspaceMixinProps{
...
func NewCfnKeyspacePropsMixin(props *CfnKeyspaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnKeyspacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cassandra::Keyspace`.
func NewCfnKeyspacePropsMixin_Override(c CfnKeyspacePropsMixin, props *CfnKeyspaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
