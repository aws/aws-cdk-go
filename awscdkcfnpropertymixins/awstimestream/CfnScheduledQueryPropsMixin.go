...
//
//   cfnScheduledQueryPropsMixin := awscdkcfnpropertymixins.Aws_timestream.NewCfnScheduledQueryPropsMixin(&CfnScheduledQueryMixinProps{
...
func NewCfnScheduledQueryPropsMixin(props *CfnScheduledQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScheduledQueryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Timestream::ScheduledQuery`.
func NewCfnScheduledQueryPropsMixin_Override(c CfnScheduledQueryPropsMixin, props *CfnScheduledQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
