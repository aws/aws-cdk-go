...
//
//   cfnInfluxDBInstancePropsMixin := awscdkcfnpropertymixins.Aws_timestream.NewCfnInfluxDBInstancePropsMixin(&CfnInfluxDBInstanceMixinProps{
...
func NewCfnInfluxDBInstancePropsMixin(props *CfnInfluxDBInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInfluxDBInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Timestream::InfluxDBInstance`.
func NewCfnInfluxDBInstancePropsMixin_Override(c CfnInfluxDBInstancePropsMixin, props *CfnInfluxDBInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInfluxDBInstancePropsMixin) ApplyTo(construct constructs.IConstruct) {
