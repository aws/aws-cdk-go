...
func validateNewCfnInfluxDBClusterPropsMixinParameters(props *CfnInfluxDBClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
