...
func validateNewCfnInfluxDBInstancePropsMixinParameters(props *CfnInfluxDBInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
