...
//
//   cfnCollectionPropsMixin := awscdkcfnpropertymixins.Aws_rekognition.NewCfnCollectionPropsMixin(&CfnCollectionMixinProps{
...
func NewCfnCollectionPropsMixin(props *CfnCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCollectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Rekognition::Collection`.
func NewCfnCollectionPropsMixin_Override(c CfnCollectionPropsMixin, props *CfnCollectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
