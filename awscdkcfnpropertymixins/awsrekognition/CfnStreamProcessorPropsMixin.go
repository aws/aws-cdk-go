...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsrekognition/internal"
...
//
//   cfnStreamProcessorPropsMixin := awscdkcfnpropertymixins.Aws_rekognition.NewCfnStreamProcessorPropsMixin(&CfnStreamProcessorMixinProps{
...
func (j *jsiiProxy_CfnStreamProcessorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStreamProcessorPropsMixin(props *CfnStreamProcessorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamProcessorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Rekognition::StreamProcessor`.
func NewCfnStreamProcessorPropsMixin_Override(c CfnStreamProcessorPropsMixin, props *CfnStreamProcessorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStreamProcessorPropsMixin) ApplyTo(construct constructs.IConstruct) {
