...
//
//   cfnDatasetPropsMixin := awscdkcfnpropertymixins.Aws_rekognition.NewCfnDatasetPropsMixin(&CfnDatasetMixinProps{
...
// Create a mixin to apply properties to `AWS::Rekognition::Dataset`.
func NewCfnDatasetPropsMixin(props *CfnDatasetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDatasetPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_rekognition.CfnDatasetPropsMixin",
