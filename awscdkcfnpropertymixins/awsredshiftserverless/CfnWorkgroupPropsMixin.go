...
//
//   cfnWorkgroupPropsMixin := awscdkcfnpropertymixins.Aws_redshiftserverless.NewCfnWorkgroupPropsMixin(&CfnWorkgroupMixinProps{
...
func NewCfnWorkgroupPropsMixin(props *CfnWorkgroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkgroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_redshiftserverless.CfnWorkgroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::RedshiftServerless::Workgroup`.
func NewCfnWorkgroupPropsMixin_Override(c CfnWorkgroupPropsMixin, props *CfnWorkgroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWorkgroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
