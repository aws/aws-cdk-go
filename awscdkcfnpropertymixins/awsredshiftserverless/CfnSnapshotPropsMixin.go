...
//
//   cfnSnapshotPropsMixin := awscdkcfnpropertymixins.Aws_redshiftserverless.NewCfnSnapshotPropsMixin(&CfnSnapshotMixinProps{
...
func NewCfnSnapshotPropsMixin(props *CfnSnapshotMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSnapshotPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_redshiftserverless.CfnSnapshotPropsMixin",
