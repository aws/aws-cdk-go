...
//
//   cfnIdMappingWorkflowPropsMixin := awscdkcfnpropertymixins.Aws_entityresolution.NewCfnIdMappingWorkflowPropsMixin(&CfnIdMappingWorkflowMixinProps{
...
func (j *jsiiProxy_CfnIdMappingWorkflowPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIdMappingWorkflowPropsMixin(props *CfnIdMappingWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdMappingWorkflowPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EntityResolution::IdMappingWorkflow`.
func NewCfnIdMappingWorkflowPropsMixin_Override(c CfnIdMappingWorkflowPropsMixin, props *CfnIdMappingWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
