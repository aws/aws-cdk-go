...
//
//   cfnMatchingWorkflowPropsMixin := awscdkcfnpropertymixins.Aws_entityresolution.NewCfnMatchingWorkflowPropsMixin(&CfnMatchingWorkflowMixinProps{
...
func (j *jsiiProxy_CfnMatchingWorkflowPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMatchingWorkflowPropsMixin(props *CfnMatchingWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMatchingWorkflowPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EntityResolution::MatchingWorkflow`.
func NewCfnMatchingWorkflowPropsMixin_Override(c CfnMatchingWorkflowPropsMixin, props *CfnMatchingWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
