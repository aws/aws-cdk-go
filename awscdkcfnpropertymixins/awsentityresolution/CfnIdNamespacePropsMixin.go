...
//
//   cfnIdNamespacePropsMixin := awscdkcfnpropertymixins.Aws_entityresolution.NewCfnIdNamespacePropsMixin(&CfnIdNamespaceMixinProps{
...
func (j *jsiiProxy_CfnIdNamespacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIdNamespacePropsMixin(props *CfnIdNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdNamespacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EntityResolution::IdNamespace`.
func NewCfnIdNamespacePropsMixin_Override(c CfnIdNamespacePropsMixin, props *CfnIdNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIdNamespacePropsMixin) ApplyTo(construct constructs.IConstruct) {
