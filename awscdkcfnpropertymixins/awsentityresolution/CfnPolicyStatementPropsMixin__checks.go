...
func validateNewCfnPolicyStatementPropsMixinParameters(props *CfnPolicyStatementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
