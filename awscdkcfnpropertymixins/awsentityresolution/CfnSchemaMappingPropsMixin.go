...
//
//   cfnSchemaMappingPropsMixin := awscdkcfnpropertymixins.Aws_entityresolution.NewCfnSchemaMappingPropsMixin(&CfnSchemaMappingMixinProps{
...
func NewCfnSchemaMappingPropsMixin(props *CfnSchemaMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchemaMappingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EntityResolution::SchemaMapping`.
func NewCfnSchemaMappingPropsMixin_Override(c CfnSchemaMappingPropsMixin, props *CfnSchemaMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
