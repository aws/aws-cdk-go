...
//   var tags interface{}
//
//   cfnCrawlerPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnCrawlerPropsMixin(&CfnCrawlerMixinProps{
//   	Classifiers: []*string{
...
func NewCfnCrawlerPropsMixin(props *CfnCrawlerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCrawlerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::Crawler`.
func NewCfnCrawlerPropsMixin_Override(c CfnCrawlerPropsMixin, props *CfnCrawlerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
