...
func validateNewCfnDataQualityRulesetPropsMixinParameters(props *CfnDataQualityRulesetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
