...
//
//   cfnClassifierPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnClassifierPropsMixin(&CfnClassifierMixinProps{
...
func (j *jsiiProxy_CfnClassifierPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClassifierPropsMixin(props *CfnClassifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClassifierPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::Classifier`.
func NewCfnClassifierPropsMixin_Override(c CfnClassifierPropsMixin, props *CfnClassifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
