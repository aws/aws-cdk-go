...
//
//   cfnBlueprintPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnBlueprintPropsMixin(&CfnBlueprintMixinProps{
...
// Create a mixin to apply properties to `AWS::Glue::Blueprint`.
