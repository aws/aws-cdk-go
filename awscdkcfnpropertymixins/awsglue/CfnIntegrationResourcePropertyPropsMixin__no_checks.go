...
func validateNewCfnIntegrationResourcePropertyPropsMixinParameters(props *CfnIntegrationResourcePropertyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
