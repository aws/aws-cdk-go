...
//
//   cfnPartitionPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnPartitionPropsMixin(&CfnPartitionMixinProps{
...
func (j *jsiiProxy_CfnPartitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPartitionPropsMixin(props *CfnPartitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPartitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::Partition`.
func NewCfnPartitionPropsMixin_Override(c CfnPartitionPropsMixin, props *CfnPartitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPartitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
