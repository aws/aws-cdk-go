...
func (j *jsiiProxy_CfnDataQualityRulesetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataQualityRulesetPropsMixin(props *CfnDataQualityRulesetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataQualityRulesetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::DataQualityRuleset`.
func NewCfnDataQualityRulesetPropsMixin_Override(c CfnDataQualityRulesetPropsMixin, props *CfnDataQualityRulesetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDataQualityRulesetPropsMixin) ApplyTo(construct constructs.IConstruct) {
