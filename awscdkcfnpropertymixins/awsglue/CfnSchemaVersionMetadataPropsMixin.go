...
//
//   cfnSchemaVersionMetadataPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnSchemaVersionMetadataPropsMixin(&CfnSchemaVersionMetadataMixinProps{
//   	Key: jsii.String("key"),
...
func (j *jsiiProxy_CfnSchemaVersionMetadataPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSchemaVersionMetadataPropsMixin(props *CfnSchemaVersionMetadataMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchemaVersionMetadataPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::SchemaVersionMetadata`.
func NewCfnSchemaVersionMetadataPropsMixin_Override(c CfnSchemaVersionMetadataPropsMixin, props *CfnSchemaVersionMetadataMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSchemaVersionMetadataPropsMixin) ApplyTo(construct constructs.IConstruct) {
