...
//
//   cfnTableOptimizerPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnTableOptimizerPropsMixin(&CfnTableOptimizerMixinProps{
...
func (j *jsiiProxy_CfnTableOptimizerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTableOptimizerPropsMixin(props *CfnTableOptimizerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTableOptimizerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::TableOptimizer`.
func NewCfnTableOptimizerPropsMixin_Override(c CfnTableOptimizerPropsMixin, props *CfnTableOptimizerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTableOptimizerPropsMixin) ApplyTo(construct constructs.IConstruct) {
