...
//
//   cfnIdentityCenterConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnIdentityCenterConfigurationPropsMixin(&CfnIdentityCenterConfigurationMixinProps{
...
func NewCfnIdentityCenterConfigurationPropsMixin(props *CfnIdentityCenterConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdentityCenterConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::IdentityCenterConfiguration`.
func NewCfnIdentityCenterConfigurationPropsMixin_Override(c CfnIdentityCenterConfigurationPropsMixin, props *CfnIdentityCenterConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
