...
//   var tags interface{}
//
//   cfnDevEndpointPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnDevEndpointPropsMixin(&CfnDevEndpointMixinProps{
...
func NewCfnDevEndpointPropsMixin(props *CfnDevEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDevEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::DevEndpoint`.
func NewCfnDevEndpointPropsMixin_Override(c CfnDevEndpointPropsMixin, props *CfnDevEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDevEndpointPropsMixin) ApplyTo(construct constructs.IConstruct) {
