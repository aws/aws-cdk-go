...
//
//   cfnSchemaVersionPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnSchemaVersionPropsMixin(&CfnSchemaVersionMixinProps{
...
func NewCfnSchemaVersionPropsMixin(props *CfnSchemaVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSchemaVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::SchemaVersion`.
func NewCfnSchemaVersionPropsMixin_Override(c CfnSchemaVersionPropsMixin, props *CfnSchemaVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
