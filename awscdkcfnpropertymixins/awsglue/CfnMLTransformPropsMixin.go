...
//   var tags interface{}
//
//   cfnMLTransformPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnMLTransformPropsMixin(&CfnMLTransformMixinProps{
...
func NewCfnMLTransformPropsMixin(props *CfnMLTransformMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMLTransformPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::MLTransform`.
func NewCfnMLTransformPropsMixin_Override(c CfnMLTransformPropsMixin, props *CfnMLTransformMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
