...
//
//   cfnIntegrationResourcePropertyPropsMixin := awscdkcfnpropertymixins.Aws_glue.NewCfnIntegrationResourcePropertyPropsMixin(&CfnIntegrationResourcePropertyMixinProps{
...
func NewCfnIntegrationResourcePropertyPropsMixin(props *CfnIntegrationResourcePropertyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIntegrationResourcePropertyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Glue::IntegrationResourceProperty`.
func NewCfnIntegrationResourcePropertyPropsMixin_Override(c CfnIntegrationResourcePropertyPropsMixin, props *CfnIntegrationResourcePropertyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
