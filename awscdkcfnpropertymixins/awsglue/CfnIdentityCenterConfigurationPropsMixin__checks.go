...
func validateNewCfnIdentityCenterConfigurationPropsMixinParameters(props *CfnIdentityCenterConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
