...
func validateNewCfnCustomEntityTypePropsMixinParameters(props *CfnCustomEntityTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
