...
//
//   cfnZonalAutoshiftConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_arczonalshift.NewCfnZonalAutoshiftConfigurationPropsMixin(&CfnZonalAutoshiftConfigurationMixinProps{
...
func NewCfnZonalAutoshiftConfigurationPropsMixin(props *CfnZonalAutoshiftConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnZonalAutoshiftConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ARCZonalShift::ZonalAutoshiftConfiguration`.
func NewCfnZonalAutoshiftConfigurationPropsMixin_Override(c CfnZonalAutoshiftConfigurationPropsMixin, props *CfnZonalAutoshiftConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnZonalAutoshiftConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
