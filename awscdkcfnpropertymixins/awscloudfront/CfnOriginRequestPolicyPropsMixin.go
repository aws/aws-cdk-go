...
//
//   cfnOriginRequestPolicyPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnOriginRequestPolicyPropsMixin(&CfnOriginRequestPolicyMixinProps{
...
func (j *jsiiProxy_CfnOriginRequestPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOriginRequestPolicyPropsMixin(props *CfnOriginRequestPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOriginRequestPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::OriginRequestPolicy`.
func NewCfnOriginRequestPolicyPropsMixin_Override(c CfnOriginRequestPolicyPropsMixin, props *CfnOriginRequestPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
