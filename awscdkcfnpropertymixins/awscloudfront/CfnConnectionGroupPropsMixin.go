...
//
//   cfnConnectionGroupPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnConnectionGroupPropsMixin(&CfnConnectionGroupMixinProps{
...
func NewCfnConnectionGroupPropsMixin(props *CfnConnectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectionGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::ConnectionGroup`.
func NewCfnConnectionGroupPropsMixin_Override(c CfnConnectionGroupPropsMixin, props *CfnConnectionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
