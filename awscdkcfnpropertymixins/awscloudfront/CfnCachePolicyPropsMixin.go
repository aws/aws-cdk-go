...
//
//   cfnCachePolicyPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnCachePolicyPropsMixin(&CfnCachePolicyMixinProps{
...
func (j *jsiiProxy_CfnCachePolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCachePolicyPropsMixin(props *CfnCachePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCachePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::CachePolicy`.
func NewCfnCachePolicyPropsMixin_Override(c CfnCachePolicyPropsMixin, props *CfnCachePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCachePolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
