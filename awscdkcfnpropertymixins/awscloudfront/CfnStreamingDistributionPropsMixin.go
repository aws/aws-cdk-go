...
//
//   cfnStreamingDistributionPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnStreamingDistributionPropsMixin(&CfnStreamingDistributionMixinProps{
...
func (j *jsiiProxy_CfnStreamingDistributionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStreamingDistributionPropsMixin(props *CfnStreamingDistributionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamingDistributionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::StreamingDistribution`.
func NewCfnStreamingDistributionPropsMixin_Override(c CfnStreamingDistributionPropsMixin, props *CfnStreamingDistributionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStreamingDistributionPropsMixin) ApplyTo(construct constructs.IConstruct) {
