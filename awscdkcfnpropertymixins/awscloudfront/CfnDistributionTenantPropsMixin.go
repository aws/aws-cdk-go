...
//
//   cfnDistributionTenantPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnDistributionTenantPropsMixin(&CfnDistributionTenantMixinProps{
...
func (j *jsiiProxy_CfnDistributionTenantPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDistributionTenantPropsMixin(props *CfnDistributionTenantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDistributionTenantPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::DistributionTenant`.
func NewCfnDistributionTenantPropsMixin_Override(c CfnDistributionTenantPropsMixin, props *CfnDistributionTenantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDistributionTenantPropsMixin) ApplyTo(construct constructs.IConstruct) {
