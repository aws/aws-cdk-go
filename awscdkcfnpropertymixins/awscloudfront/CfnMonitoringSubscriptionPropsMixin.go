...
//
//   cfnMonitoringSubscriptionPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnMonitoringSubscriptionPropsMixin(&CfnMonitoringSubscriptionMixinProps{
...
func NewCfnMonitoringSubscriptionPropsMixin(props *CfnMonitoringSubscriptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMonitoringSubscriptionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::MonitoringSubscription`.
func NewCfnMonitoringSubscriptionPropsMixin_Override(c CfnMonitoringSubscriptionPropsMixin, props *CfnMonitoringSubscriptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
