...
//
//   cfnKeyGroupPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnKeyGroupPropsMixin(&CfnKeyGroupMixinProps{
...
func (j *jsiiProxy_CfnKeyGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnKeyGroupPropsMixin(props *CfnKeyGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnKeyGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::KeyGroup`.
func NewCfnKeyGroupPropsMixin_Override(c CfnKeyGroupPropsMixin, props *CfnKeyGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
