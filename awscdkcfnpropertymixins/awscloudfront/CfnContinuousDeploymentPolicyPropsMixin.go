...
//
//   cfnContinuousDeploymentPolicyPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnContinuousDeploymentPolicyPropsMixin(&CfnContinuousDeploymentPolicyMixinProps{
...
func (j *jsiiProxy_CfnContinuousDeploymentPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnContinuousDeploymentPolicyPropsMixin(props *CfnContinuousDeploymentPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnContinuousDeploymentPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::ContinuousDeploymentPolicy`.
func NewCfnContinuousDeploymentPolicyPropsMixin_Override(c CfnContinuousDeploymentPolicyPropsMixin, props *CfnContinuousDeploymentPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnContinuousDeploymentPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
