...
//
//   cfnConnectionFunctionPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnConnectionFunctionPropsMixin(&CfnConnectionFunctionMixinProps{
...
func (j *jsiiProxy_CfnConnectionFunctionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConnectionFunctionPropsMixin(props *CfnConnectionFunctionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectionFunctionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::ConnectionFunction`.
func NewCfnConnectionFunctionPropsMixin_Override(c CfnConnectionFunctionPropsMixin, props *CfnConnectionFunctionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectionFunctionPropsMixin) ApplyTo(construct constructs.IConstruct) {
