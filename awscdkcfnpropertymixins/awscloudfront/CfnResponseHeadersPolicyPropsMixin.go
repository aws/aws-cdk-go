...
//
//   cfnResponseHeadersPolicyPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnResponseHeadersPolicyPropsMixin(&CfnResponseHeadersPolicyMixinProps{
...
func (j *jsiiProxy_CfnResponseHeadersPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResponseHeadersPolicyPropsMixin(props *CfnResponseHeadersPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResponseHeadersPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::ResponseHeadersPolicy`.
func NewCfnResponseHeadersPolicyPropsMixin_Override(c CfnResponseHeadersPolicyPropsMixin, props *CfnResponseHeadersPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResponseHeadersPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
