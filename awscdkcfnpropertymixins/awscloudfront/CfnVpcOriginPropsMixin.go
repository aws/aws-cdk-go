...
//
//   cfnVpcOriginPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnVpcOriginPropsMixin(&CfnVpcOriginMixinProps{
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func (j *jsiiProxy_CfnVpcOriginPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVpcOriginPropsMixin(props *CfnVpcOriginMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVpcOriginPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::VpcOrigin`.
func NewCfnVpcOriginPropsMixin_Override(c CfnVpcOriginPropsMixin, props *CfnVpcOriginMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
