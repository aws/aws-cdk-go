...
//
//   cfnCloudFrontOriginAccessIdentityPropsMixin := awscdkcfnpropertymixins.Aws_cloudfront.NewCfnCloudFrontOriginAccessIdentityPropsMixin(&CfnCloudFrontOriginAccessIdentityMixinProps{
...
func (j *jsiiProxy_CfnCloudFrontOriginAccessIdentityPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCloudFrontOriginAccessIdentityPropsMixin(props *CfnCloudFrontOriginAccessIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCloudFrontOriginAccessIdentityPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudFront::CloudFrontOriginAccessIdentity`.
func NewCfnCloudFrontOriginAccessIdentityPropsMixin_Override(c CfnCloudFrontOriginAccessIdentityPropsMixin, props *CfnCloudFrontOriginAccessIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCloudFrontOriginAccessIdentityPropsMixin) ApplyTo(construct constructs.IConstruct) {
