...
//
//   cfnTablePolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3tables.NewCfnTablePolicyPropsMixin(&CfnTablePolicyMixinProps{
...
func (j *jsiiProxy_CfnTablePolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTablePolicyPropsMixin(props *CfnTablePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTablePolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Tables::TablePolicy`.
func NewCfnTablePolicyPropsMixin_Override(c CfnTablePolicyPropsMixin, props *CfnTablePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTablePolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
