...
//
//   cfnNamespacePropsMixin := awscdkcfnpropertymixins.Aws_s3tables.NewCfnNamespacePropsMixin(&CfnNamespaceMixinProps{
...
func (j *jsiiProxy_CfnNamespacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNamespacePropsMixin(props *CfnNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNamespacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Tables::Namespace`.
func NewCfnNamespacePropsMixin_Override(c CfnNamespacePropsMixin, props *CfnNamespaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNamespacePropsMixin) ApplyTo(construct constructs.IConstruct) {
