...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awss3tables/internal"
...
//
//   cfnTableBucketPolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3tables.NewCfnTableBucketPolicyPropsMixin(&CfnTableBucketPolicyMixinProps{
...
func (j *jsiiProxy_CfnTableBucketPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTableBucketPolicyPropsMixin(props *CfnTableBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTableBucketPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Tables::TableBucketPolicy`.
func NewCfnTableBucketPolicyPropsMixin_Override(c CfnTableBucketPolicyPropsMixin, props *CfnTableBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTableBucketPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
