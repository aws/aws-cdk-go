...
//
//   cfnTableBucketPropsMixin := awscdkcfnpropertymixins.Aws_s3tables.NewCfnTableBucketPropsMixin(&CfnTableBucketMixinProps{
...
func (j *jsiiProxy_CfnTableBucketPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTableBucketPropsMixin(props *CfnTableBucketMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTableBucketPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Tables::TableBucket`.
func NewCfnTableBucketPropsMixin_Override(c CfnTableBucketPropsMixin, props *CfnTableBucketMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
