...
//
//   cfnFormPropsMixin := awscdkcfnpropertymixins.Aws_amplifyuibuilder.NewCfnFormPropsMixin(&CfnFormMixinProps{
...
func (j *jsiiProxy_CfnFormPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFormPropsMixin(props *CfnFormMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFormPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_amplifyuibuilder.CfnFormPropsMixin",
...
// Create a mixin to apply properties to `AWS::AmplifyUIBuilder::Form`.
func NewCfnFormPropsMixin_Override(c CfnFormPropsMixin, props *CfnFormMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFormPropsMixin) ApplyTo(construct constructs.IConstruct) {
