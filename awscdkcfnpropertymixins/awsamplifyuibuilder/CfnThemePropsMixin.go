...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsamplifyuibuilder/internal"
...
//
//   cfnThemePropsMixin := awscdkcfnpropertymixins.Aws_amplifyuibuilder.NewCfnThemePropsMixin(&CfnThemeMixinProps{
...
func (j *jsiiProxy_CfnThemePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnThemePropsMixin(props *CfnThemeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnThemePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_amplifyuibuilder.CfnThemePropsMixin",
...
// Create a mixin to apply properties to `AWS::AmplifyUIBuilder::Theme`.
func NewCfnThemePropsMixin_Override(c CfnThemePropsMixin, props *CfnThemeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnThemePropsMixin) ApplyTo(construct constructs.IConstruct) {
