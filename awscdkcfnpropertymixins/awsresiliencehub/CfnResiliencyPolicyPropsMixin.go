...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsresiliencehub/internal"
...
//
//   cfnResiliencyPolicyPropsMixin := awscdkcfnpropertymixins.Aws_resiliencehub.NewCfnResiliencyPolicyPropsMixin(&CfnResiliencyPolicyMixinProps{
...
func (j *jsiiProxy_CfnResiliencyPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResiliencyPolicyPropsMixin(props *CfnResiliencyPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResiliencyPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ResilienceHub::ResiliencyPolicy`.
func NewCfnResiliencyPolicyPropsMixin_Override(c CfnResiliencyPolicyPropsMixin, props *CfnResiliencyPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResiliencyPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
