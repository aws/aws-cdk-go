...
//
//   cfnNatGatewayPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnNatGatewayPropsMixin(&CfnNatGatewayMixinProps{
...
func (j *jsiiProxy_CfnNatGatewayPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNatGatewayPropsMixin(props *CfnNatGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNatGatewayPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnNatGatewayPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::NatGateway`.
func NewCfnNatGatewayPropsMixin_Override(c CfnNatGatewayPropsMixin, props *CfnNatGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNatGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) {
