...
//
//   cfnEIPPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnEIPPropsMixin(&CfnEIPMixinProps{
...
func (j *jsiiProxy_CfnEIPPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEIPPropsMixin(props *CfnEIPMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEIPPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnEIPPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::EIP`.
func NewCfnEIPPropsMixin_Override(c CfnEIPPropsMixin, props *CfnEIPMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
