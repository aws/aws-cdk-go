...
//
//   cfnFlowLogPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnFlowLogPropsMixin(&CfnFlowLogMixinProps{
...
func (j *jsiiProxy_CfnFlowLogPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowLogPropsMixin(props *CfnFlowLogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowLogPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::FlowLog`.
func NewCfnFlowLogPropsMixin_Override(c CfnFlowLogPropsMixin, props *CfnFlowLogMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFlowLogPropsMixin) ApplyTo(construct constructs.IConstruct) {
