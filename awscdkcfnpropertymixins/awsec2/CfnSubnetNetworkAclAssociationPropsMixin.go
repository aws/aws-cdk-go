...
//
//   cfnSubnetNetworkAclAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSubnetNetworkAclAssociationPropsMixin(&CfnSubnetNetworkAclAssociationMixinProps{
...
func (j *jsiiProxy_CfnSubnetNetworkAclAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubnetNetworkAclAssociationPropsMixin(props *CfnSubnetNetworkAclAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubnetNetworkAclAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::SubnetNetworkAclAssociation`.
func NewCfnSubnetNetworkAclAssociationPropsMixin_Override(c CfnSubnetNetworkAclAssociationPropsMixin, props *CfnSubnetNetworkAclAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSubnetNetworkAclAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
