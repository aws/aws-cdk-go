...
//
//   cfnSubnetCidrBlockPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSubnetCidrBlockPropsMixin(&CfnSubnetCidrBlockMixinProps{
...
func (j *jsiiProxy_CfnSubnetCidrBlockPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubnetCidrBlockPropsMixin(props *CfnSubnetCidrBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubnetCidrBlockPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnSubnetCidrBlockPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::SubnetCidrBlock`.
func NewCfnSubnetCidrBlockPropsMixin_Override(c CfnSubnetCidrBlockPropsMixin, props *CfnSubnetCidrBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSubnetCidrBlockPropsMixin) ApplyTo(construct constructs.IConstruct) {
