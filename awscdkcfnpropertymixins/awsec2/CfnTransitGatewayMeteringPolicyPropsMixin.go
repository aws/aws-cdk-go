...
//
//   cfnTransitGatewayMeteringPolicyPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayMeteringPolicyPropsMixin(&CfnTransitGatewayMeteringPolicyMixinProps{
...
func NewCfnTransitGatewayMeteringPolicyPropsMixin(props *CfnTransitGatewayMeteringPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayMeteringPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayMeteringPolicy`.
func NewCfnTransitGatewayMeteringPolicyPropsMixin_Override(c CfnTransitGatewayMeteringPolicyPropsMixin, props *CfnTransitGatewayMeteringPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
