...
func validateNewCfnVerifiedAccessGroupPropsMixinParameters(props *CfnVerifiedAccessGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
