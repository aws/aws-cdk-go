...
//
//   cfnNetworkAclEntryPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnNetworkAclEntryPropsMixin(&CfnNetworkAclEntryMixinProps{
...
func NewCfnNetworkAclEntryPropsMixin(props *CfnNetworkAclEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkAclEntryPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnNetworkAclEntryPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::NetworkAclEntry`.
func NewCfnNetworkAclEntryPropsMixin_Override(c CfnNetworkAclEntryPropsMixin, props *CfnNetworkAclEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNetworkAclEntryPropsMixin) ApplyTo(construct constructs.IConstruct) {
