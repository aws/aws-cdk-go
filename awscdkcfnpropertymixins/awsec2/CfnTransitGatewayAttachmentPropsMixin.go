...
//
//   cfnTransitGatewayAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayAttachmentPropsMixin(&CfnTransitGatewayAttachmentMixinProps{
//   	Options: options,
//   	SubnetIds: []interface{}{
...
func (j *jsiiProxy_CfnTransitGatewayAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayAttachmentPropsMixin(props *CfnTransitGatewayAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayAttachmentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTransitGatewayAttachmentPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayAttachment`.
func NewCfnTransitGatewayAttachmentPropsMixin_Override(c CfnTransitGatewayAttachmentPropsMixin, props *CfnTransitGatewayAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransitGatewayAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
