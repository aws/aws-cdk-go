...
//
//   cfnCustomerGatewayPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnCustomerGatewayPropsMixin(&CfnCustomerGatewayMixinProps{
...
func (j *jsiiProxy_CfnCustomerGatewayPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCustomerGatewayPropsMixin(props *CfnCustomerGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCustomerGatewayPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnCustomerGatewayPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::CustomerGateway`.
func NewCfnCustomerGatewayPropsMixin_Override(c CfnCustomerGatewayPropsMixin, props *CfnCustomerGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
