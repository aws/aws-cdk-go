...
//
//   cfnTransitGatewayMulticastDomainPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayMulticastDomainPropsMixin(&CfnTransitGatewayMulticastDomainMixinProps{
//   	Options: options,
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func NewCfnTransitGatewayMulticastDomainPropsMixin(props *CfnTransitGatewayMulticastDomainMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayMulticastDomainPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayMulticastDomain`.
func NewCfnTransitGatewayMulticastDomainPropsMixin_Override(c CfnTransitGatewayMulticastDomainPropsMixin, props *CfnTransitGatewayMulticastDomainMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
