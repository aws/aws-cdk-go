...
func (j *jsiiProxy_CfnPlacementGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPlacementGroupPropsMixin(props *CfnPlacementGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlacementGroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnPlacementGroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::PlacementGroup`.
func NewCfnPlacementGroupPropsMixin_Override(c CfnPlacementGroupPropsMixin, props *CfnPlacementGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPlacementGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
