...
//
//   cfnVPCBlockPublicAccessExclusionPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCBlockPublicAccessExclusionPropsMixin(&CfnVPCBlockPublicAccessExclusionMixinProps{
...
func (j *jsiiProxy_CfnVPCBlockPublicAccessExclusionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPCBlockPublicAccessExclusionPropsMixin(props *CfnVPCBlockPublicAccessExclusionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCBlockPublicAccessExclusionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCBlockPublicAccessExclusionPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPCBlockPublicAccessExclusion`.
func NewCfnVPCBlockPublicAccessExclusionPropsMixin_Override(c CfnVPCBlockPublicAccessExclusionPropsMixin, props *CfnVPCBlockPublicAccessExclusionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
