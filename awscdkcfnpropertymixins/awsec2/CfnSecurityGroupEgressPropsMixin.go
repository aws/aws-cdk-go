...
//
//   cfnSecurityGroupEgressPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSecurityGroupEgressPropsMixin(&CfnSecurityGroupEgressMixinProps{
...
func (j *jsiiProxy_CfnSecurityGroupEgressPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecurityGroupEgressPropsMixin(props *CfnSecurityGroupEgressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityGroupEgressPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnSecurityGroupEgressPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::SecurityGroupEgress`.
func NewCfnSecurityGroupEgressPropsMixin_Override(c CfnSecurityGroupEgressPropsMixin, props *CfnSecurityGroupEgressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSecurityGroupEgressPropsMixin) ApplyTo(construct constructs.IConstruct) {
