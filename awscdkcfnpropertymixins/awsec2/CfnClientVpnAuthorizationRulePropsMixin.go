...
//
//   cfnClientVpnAuthorizationRulePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnClientVpnAuthorizationRulePropsMixin(&CfnClientVpnAuthorizationRuleMixinProps{
...
func (j *jsiiProxy_CfnClientVpnAuthorizationRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClientVpnAuthorizationRulePropsMixin(props *CfnClientVpnAuthorizationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClientVpnAuthorizationRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::ClientVpnAuthorizationRule`.
func NewCfnClientVpnAuthorizationRulePropsMixin_Override(c CfnClientVpnAuthorizationRulePropsMixin, props *CfnClientVpnAuthorizationRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
