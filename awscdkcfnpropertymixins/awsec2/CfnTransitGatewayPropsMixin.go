...
//
//   cfnTransitGatewayPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayPropsMixin(&CfnTransitGatewayMixinProps{
...
func (j *jsiiProxy_CfnTransitGatewayPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayPropsMixin(props *CfnTransitGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGateway`.
func NewCfnTransitGatewayPropsMixin_Override(c CfnTransitGatewayPropsMixin, props *CfnTransitGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
