...
//
//   cfnTrafficMirrorFilterRulePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTrafficMirrorFilterRulePropsMixin(&CfnTrafficMirrorFilterRuleMixinProps{
...
func NewCfnTrafficMirrorFilterRulePropsMixin(props *CfnTrafficMirrorFilterRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrafficMirrorFilterRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TrafficMirrorFilterRule`.
func NewCfnTrafficMirrorFilterRulePropsMixin_Override(c CfnTrafficMirrorFilterRulePropsMixin, props *CfnTrafficMirrorFilterRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
