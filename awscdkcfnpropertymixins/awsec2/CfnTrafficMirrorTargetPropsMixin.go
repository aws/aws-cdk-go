...
//
//   cfnTrafficMirrorTargetPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTrafficMirrorTargetPropsMixin(&CfnTrafficMirrorTargetMixinProps{
...
func (j *jsiiProxy_CfnTrafficMirrorTargetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrafficMirrorTargetPropsMixin(props *CfnTrafficMirrorTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrafficMirrorTargetPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTrafficMirrorTargetPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TrafficMirrorTarget`.
func NewCfnTrafficMirrorTargetPropsMixin_Override(c CfnTrafficMirrorTargetPropsMixin, props *CfnTrafficMirrorTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
