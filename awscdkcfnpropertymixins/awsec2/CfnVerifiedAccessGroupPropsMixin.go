...
//
//   cfnVerifiedAccessGroupPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVerifiedAccessGroupPropsMixin(&CfnVerifiedAccessGroupMixinProps{
...
func (j *jsiiProxy_CfnVerifiedAccessGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVerifiedAccessGroupPropsMixin(props *CfnVerifiedAccessGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVerifiedAccessGroupPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVerifiedAccessGroupPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VerifiedAccessGroup`.
func NewCfnVerifiedAccessGroupPropsMixin_Override(c CfnVerifiedAccessGroupPropsMixin, props *CfnVerifiedAccessGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
