...
//
//   cfnEC2FleetPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnEC2FleetPropsMixin(&CfnEC2FleetMixinProps{
...
func NewCfnEC2FleetPropsMixin(props *CfnEC2FleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEC2FleetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::EC2Fleet`.
func NewCfnEC2FleetPropsMixin_Override(c CfnEC2FleetPropsMixin, props *CfnEC2FleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
