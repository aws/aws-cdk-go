...
//
//   cfnPrefixListPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnPrefixListPropsMixin(&CfnPrefixListMixinProps{
...
func NewCfnPrefixListPropsMixin(props *CfnPrefixListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPrefixListPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnPrefixListPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::PrefixList`.
func NewCfnPrefixListPropsMixin_Override(c CfnPrefixListPropsMixin, props *CfnPrefixListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
