...
func validateNewCfnSecurityGroupIngressPropsMixinParameters(props *CfnSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
