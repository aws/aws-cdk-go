...
//
//   cfnInstanceConnectEndpointPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnInstanceConnectEndpointPropsMixin(&CfnInstanceConnectEndpointMixinProps{
...
func (j *jsiiProxy_CfnInstanceConnectEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInstanceConnectEndpointPropsMixin(props *CfnInstanceConnectEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstanceConnectEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::InstanceConnectEndpoint`.
func NewCfnInstanceConnectEndpointPropsMixin_Override(c CfnInstanceConnectEndpointPropsMixin, props *CfnInstanceConnectEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
