...
//
//   cfnLaunchTemplatePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnLaunchTemplatePropsMixin(&CfnLaunchTemplateMixinProps{
...
func NewCfnLaunchTemplatePropsMixin(props *CfnLaunchTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLaunchTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::LaunchTemplate`.
func NewCfnLaunchTemplatePropsMixin_Override(c CfnLaunchTemplatePropsMixin, props *CfnLaunchTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
