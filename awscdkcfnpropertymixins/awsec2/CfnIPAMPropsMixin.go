...
//
//   cfnIPAMPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnIPAMPropsMixin(&CfnIPAMMixinProps{
...
func NewCfnIPAMPropsMixin(props *CfnIPAMMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPAMPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::IPAM`.
func NewCfnIPAMPropsMixin_Override(c CfnIPAMPropsMixin, props *CfnIPAMMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
