...
//
//   cfnVPNGatewayPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPNGatewayPropsMixin(&CfnVPNGatewayMixinProps{
...
func NewCfnVPNGatewayPropsMixin(props *CfnVPNGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPNGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VPNGateway`.
func NewCfnVPNGatewayPropsMixin_Override(c CfnVPNGatewayPropsMixin, props *CfnVPNGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
