...
//
//   cfnLocalGatewayRouteTablePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnLocalGatewayRouteTablePropsMixin(&CfnLocalGatewayRouteTableMixinProps{
...
func (j *jsiiProxy_CfnLocalGatewayRouteTablePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocalGatewayRouteTablePropsMixin(props *CfnLocalGatewayRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocalGatewayRouteTablePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::LocalGatewayRouteTable`.
func NewCfnLocalGatewayRouteTablePropsMixin_Override(c CfnLocalGatewayRouteTablePropsMixin, props *CfnLocalGatewayRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocalGatewayRouteTablePropsMixin) ApplyTo(construct constructs.IConstruct) {
