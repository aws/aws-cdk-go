...
//
//   cfnVPCEndpointServicePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCEndpointServicePropsMixin(&CfnVPCEndpointServiceMixinProps{
...
func NewCfnVPCEndpointServicePropsMixin(props *CfnVPCEndpointServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCEndpointServicePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VPCEndpointService`.
func NewCfnVPCEndpointServicePropsMixin_Override(c CfnVPCEndpointServicePropsMixin, props *CfnVPCEndpointServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
