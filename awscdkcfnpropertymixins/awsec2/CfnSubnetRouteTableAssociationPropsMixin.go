...
//
//   cfnSubnetRouteTableAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSubnetRouteTableAssociationPropsMixin(&CfnSubnetRouteTableAssociationMixinProps{
...
func (j *jsiiProxy_CfnSubnetRouteTableAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubnetRouteTableAssociationPropsMixin(props *CfnSubnetRouteTableAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubnetRouteTableAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnSubnetRouteTableAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::SubnetRouteTableAssociation`.
func NewCfnSubnetRouteTableAssociationPropsMixin_Override(c CfnSubnetRouteTableAssociationPropsMixin, props *CfnSubnetRouteTableAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
