...
//
//   cfnVPCPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCPropsMixin(&CfnVPCMixinProps{
...
func (j *jsiiProxy_CfnVPCPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPCPropsMixin(props *CfnVPCMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPC`.
func NewCfnVPCPropsMixin_Override(c CfnVPCPropsMixin, props *CfnVPCMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPCPropsMixin) ApplyTo(construct constructs.IConstruct) {
