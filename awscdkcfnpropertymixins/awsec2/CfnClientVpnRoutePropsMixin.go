...
//
//   cfnClientVpnRoutePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnClientVpnRoutePropsMixin(&CfnClientVpnRouteMixinProps{
...
func (j *jsiiProxy_CfnClientVpnRoutePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClientVpnRoutePropsMixin(props *CfnClientVpnRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClientVpnRoutePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnClientVpnRoutePropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::ClientVpnRoute`.
func NewCfnClientVpnRoutePropsMixin_Override(c CfnClientVpnRoutePropsMixin, props *CfnClientVpnRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
