...
func validateNewCfnVPNConnectionRoutePropsMixinParameters(props *CfnVPNConnectionRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
