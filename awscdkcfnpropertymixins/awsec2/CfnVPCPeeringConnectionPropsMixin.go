...
//
//   cfnVPCPeeringConnectionPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCPeeringConnectionPropsMixin(&CfnVPCPeeringConnectionMixinProps{
...
func (j *jsiiProxy_CfnVPCPeeringConnectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPCPeeringConnectionPropsMixin(props *CfnVPCPeeringConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCPeeringConnectionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCPeeringConnectionPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPCPeeringConnection`.
func NewCfnVPCPeeringConnectionPropsMixin_Override(c CfnVPCPeeringConnectionPropsMixin, props *CfnVPCPeeringConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPCPeeringConnectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
