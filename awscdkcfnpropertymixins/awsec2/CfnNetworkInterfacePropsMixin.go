...
//
//   cfnNetworkInterfacePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnNetworkInterfacePropsMixin(&CfnNetworkInterfaceMixinProps{
...
func (j *jsiiProxy_CfnNetworkInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNetworkInterfacePropsMixin(props *CfnNetworkInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkInterfacePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnNetworkInterfacePropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::NetworkInterface`.
func NewCfnNetworkInterfacePropsMixin_Override(c CfnNetworkInterfacePropsMixin, props *CfnNetworkInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNetworkInterfacePropsMixin) ApplyTo(construct constructs.IConstruct) {
