...
//
//   cfnEnclaveCertificateIamRoleAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnEnclaveCertificateIamRoleAssociationPropsMixin(&CfnEnclaveCertificateIamRoleAssociationMixinProps{
...
func (j *jsiiProxy_CfnEnclaveCertificateIamRoleAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEnclaveCertificateIamRoleAssociationPropsMixin(props *CfnEnclaveCertificateIamRoleAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnclaveCertificateIamRoleAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::EnclaveCertificateIamRoleAssociation`.
func NewCfnEnclaveCertificateIamRoleAssociationPropsMixin_Override(c CfnEnclaveCertificateIamRoleAssociationPropsMixin, props *CfnEnclaveCertificateIamRoleAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
