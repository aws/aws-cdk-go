...
//
//   cfnTransitGatewayMulticastGroupMemberPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayMulticastGroupMemberPropsMixin(&CfnTransitGatewayMulticastGroupMemberMixinProps{
...
func (j *jsiiProxy_CfnTransitGatewayMulticastGroupMemberPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayMulticastGroupMemberPropsMixin(props *CfnTransitGatewayMulticastGroupMemberMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayMulticastGroupMemberPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTransitGatewayMulticastGroupMemberPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayMulticastGroupMember`.
func NewCfnTransitGatewayMulticastGroupMemberPropsMixin_Override(c CfnTransitGatewayMulticastGroupMemberPropsMixin, props *CfnTransitGatewayMulticastGroupMemberMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransitGatewayMulticastGroupMemberPropsMixin) ApplyTo(construct constructs.IConstruct) {
