...
//
//   cfnNetworkInterfaceAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnNetworkInterfaceAttachmentPropsMixin(&CfnNetworkInterfaceAttachmentMixinProps{
...
func (j *jsiiProxy_CfnNetworkInterfaceAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNetworkInterfaceAttachmentPropsMixin(props *CfnNetworkInterfaceAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkInterfaceAttachmentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnNetworkInterfaceAttachmentPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::NetworkInterfaceAttachment`.
func NewCfnNetworkInterfaceAttachmentPropsMixin_Override(c CfnNetworkInterfaceAttachmentPropsMixin, props *CfnNetworkInterfaceAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNetworkInterfaceAttachmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
