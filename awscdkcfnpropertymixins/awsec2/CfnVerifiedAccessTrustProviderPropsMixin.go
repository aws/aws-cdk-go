...
//
//   cfnVerifiedAccessTrustProviderPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVerifiedAccessTrustProviderPropsMixin(&CfnVerifiedAccessTrustProviderMixinProps{
...
func (j *jsiiProxy_CfnVerifiedAccessTrustProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVerifiedAccessTrustProviderPropsMixin(props *CfnVerifiedAccessTrustProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVerifiedAccessTrustProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VerifiedAccessTrustProvider`.
func NewCfnVerifiedAccessTrustProviderPropsMixin_Override(c CfnVerifiedAccessTrustProviderPropsMixin, props *CfnVerifiedAccessTrustProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVerifiedAccessTrustProviderPropsMixin) ApplyTo(construct constructs.IConstruct) {
