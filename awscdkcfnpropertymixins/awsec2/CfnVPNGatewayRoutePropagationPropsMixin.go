...
//
//   cfnVPNGatewayRoutePropagationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPNGatewayRoutePropagationPropsMixin(&CfnVPNGatewayRoutePropagationMixinProps{
...
func NewCfnVPNGatewayRoutePropagationPropsMixin(props *CfnVPNGatewayRoutePropagationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPNGatewayRoutePropagationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VPNGatewayRoutePropagation`.
func NewCfnVPNGatewayRoutePropagationPropsMixin_Override(c CfnVPNGatewayRoutePropagationPropsMixin, props *CfnVPNGatewayRoutePropagationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
