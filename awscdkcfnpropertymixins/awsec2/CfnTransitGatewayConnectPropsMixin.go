...
//
//   cfnTransitGatewayConnectPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayConnectPropsMixin(&CfnTransitGatewayConnectMixinProps{
...
func NewCfnTransitGatewayConnectPropsMixin(props *CfnTransitGatewayConnectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayConnectPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayConnect`.
func NewCfnTransitGatewayConnectPropsMixin_Override(c CfnTransitGatewayConnectPropsMixin, props *CfnTransitGatewayConnectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
