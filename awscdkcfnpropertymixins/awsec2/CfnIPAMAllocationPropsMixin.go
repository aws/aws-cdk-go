...
//
//   cfnIPAMAllocationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnIPAMAllocationPropsMixin(&CfnIPAMAllocationMixinProps{
...
func (j *jsiiProxy_CfnIPAMAllocationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIPAMAllocationPropsMixin(props *CfnIPAMAllocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPAMAllocationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::IPAMAllocation`.
func NewCfnIPAMAllocationPropsMixin_Override(c CfnIPAMAllocationPropsMixin, props *CfnIPAMAllocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIPAMAllocationPropsMixin) ApplyTo(construct constructs.IConstruct) {
