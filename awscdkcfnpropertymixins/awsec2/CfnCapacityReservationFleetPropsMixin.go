...
//
//   cfnCapacityReservationFleetPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnCapacityReservationFleetPropsMixin(&CfnCapacityReservationFleetMixinProps{
...
func (j *jsiiProxy_CfnCapacityReservationFleetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCapacityReservationFleetPropsMixin(props *CfnCapacityReservationFleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCapacityReservationFleetPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnCapacityReservationFleetPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::CapacityReservationFleet`.
func NewCfnCapacityReservationFleetPropsMixin_Override(c CfnCapacityReservationFleetPropsMixin, props *CfnCapacityReservationFleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCapacityReservationFleetPropsMixin) ApplyTo(construct constructs.IConstruct) {
