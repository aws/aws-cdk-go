...
//
//   cfnVPCCidrBlockPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCCidrBlockPropsMixin(&CfnVPCCidrBlockMixinProps{
...
func NewCfnVPCCidrBlockPropsMixin(props *CfnVPCCidrBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCCidrBlockPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCCidrBlockPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPCCidrBlock`.
func NewCfnVPCCidrBlockPropsMixin_Override(c CfnVPCCidrBlockPropsMixin, props *CfnVPCCidrBlockMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPCCidrBlockPropsMixin) ApplyTo(construct constructs.IConstruct) {
