...
//
//   cfnRouteTablePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnRouteTablePropsMixin(&CfnRouteTableMixinProps{
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func NewCfnRouteTablePropsMixin(props *CfnRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteTablePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::RouteTable`.
func NewCfnRouteTablePropsMixin_Override(c CfnRouteTablePropsMixin, props *CfnRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
