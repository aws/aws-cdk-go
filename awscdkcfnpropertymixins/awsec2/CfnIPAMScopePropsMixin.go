...
//
//   cfnIPAMScopePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnIPAMScopePropsMixin(&CfnIPAMScopeMixinProps{
...
func (j *jsiiProxy_CfnIPAMScopePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIPAMScopePropsMixin(props *CfnIPAMScopeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPAMScopePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::IPAMScope`.
func NewCfnIPAMScopePropsMixin_Override(c CfnIPAMScopePropsMixin, props *CfnIPAMScopeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
