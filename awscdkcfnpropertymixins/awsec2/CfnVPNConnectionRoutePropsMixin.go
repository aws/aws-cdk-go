...
//
//   cfnVPNConnectionRoutePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPNConnectionRoutePropsMixin(&CfnVPNConnectionRouteMixinProps{
...
func (j *jsiiProxy_CfnVPNConnectionRoutePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPNConnectionRoutePropsMixin(props *CfnVPNConnectionRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPNConnectionRoutePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VPNConnectionRoute`.
func NewCfnVPNConnectionRoutePropsMixin_Override(c CfnVPNConnectionRoutePropsMixin, props *CfnVPNConnectionRouteMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPNConnectionRoutePropsMixin) ApplyTo(construct constructs.IConstruct) {
