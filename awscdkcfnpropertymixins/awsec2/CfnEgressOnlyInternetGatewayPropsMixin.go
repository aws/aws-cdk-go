...
//
//   cfnEgressOnlyInternetGatewayPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnEgressOnlyInternetGatewayPropsMixin(&CfnEgressOnlyInternetGatewayMixinProps{
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func NewCfnEgressOnlyInternetGatewayPropsMixin(props *CfnEgressOnlyInternetGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEgressOnlyInternetGatewayPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::EgressOnlyInternetGateway`.
func NewCfnEgressOnlyInternetGatewayPropsMixin_Override(c CfnEgressOnlyInternetGatewayPropsMixin, props *CfnEgressOnlyInternetGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
