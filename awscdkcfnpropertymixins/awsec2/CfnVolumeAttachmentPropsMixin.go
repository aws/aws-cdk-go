...
//
//   cfnVolumeAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVolumeAttachmentPropsMixin(&CfnVolumeAttachmentMixinProps{
...
func NewCfnVolumeAttachmentPropsMixin(props *CfnVolumeAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVolumeAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VolumeAttachment`.
func NewCfnVolumeAttachmentPropsMixin_Override(c CfnVolumeAttachmentPropsMixin, props *CfnVolumeAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
