...
//
//   cfnTransitGatewayPolicyTableEntryMixinProps := &CfnTransitGatewayPolicyTableEntryMixinProps{
...
//
type CfnTransitGatewayPolicyTableEntryMixinProps struct {
	...
	//
	PolicyRuleNumber *string `field:"optional" json:"policyRuleNumber" yaml:"policyRuleNumber"`
	...
	//
	TargetRouteTableId *string `field:"optional" json:"targetRouteTableId" yaml:"targetRouteTableId"`
