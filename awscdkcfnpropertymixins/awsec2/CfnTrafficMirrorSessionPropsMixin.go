...
//
//   cfnTrafficMirrorSessionPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTrafficMirrorSessionPropsMixin(&CfnTrafficMirrorSessionMixinProps{
...
func (j *jsiiProxy_CfnTrafficMirrorSessionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrafficMirrorSessionPropsMixin(props *CfnTrafficMirrorSessionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrafficMirrorSessionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTrafficMirrorSessionPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TrafficMirrorSession`.
func NewCfnTrafficMirrorSessionPropsMixin_Override(c CfnTrafficMirrorSessionPropsMixin, props *CfnTrafficMirrorSessionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
