...
//
//   cfnNetworkInsightsAccessScopePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnNetworkInsightsAccessScopePropsMixin(&CfnNetworkInsightsAccessScopeMixinProps{
...
func (j *jsiiProxy_CfnNetworkInsightsAccessScopePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNetworkInsightsAccessScopePropsMixin(props *CfnNetworkInsightsAccessScopeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkInsightsAccessScopePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::NetworkInsightsAccessScope`.
func NewCfnNetworkInsightsAccessScopePropsMixin_Override(c CfnNetworkInsightsAccessScopePropsMixin, props *CfnNetworkInsightsAccessScopeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNetworkInsightsAccessScopePropsMixin) ApplyTo(construct constructs.IConstruct) {
