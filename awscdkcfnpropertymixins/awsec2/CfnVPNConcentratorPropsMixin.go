...
//
//   cfnVPNConcentratorPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPNConcentratorPropsMixin(&CfnVPNConcentratorMixinProps{
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func (j *jsiiProxy_CfnVPNConcentratorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPNConcentratorPropsMixin(props *CfnVPNConcentratorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPNConcentratorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::VPNConcentrator`.
func NewCfnVPNConcentratorPropsMixin_Override(c CfnVPNConcentratorPropsMixin, props *CfnVPNConcentratorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPNConcentratorPropsMixin) ApplyTo(construct constructs.IConstruct) {
