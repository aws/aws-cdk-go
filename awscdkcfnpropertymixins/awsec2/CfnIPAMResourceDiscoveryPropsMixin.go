...
//
//   cfnIPAMResourceDiscoveryPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnIPAMResourceDiscoveryPropsMixin(&CfnIPAMResourceDiscoveryMixinProps{
...
func (j *jsiiProxy_CfnIPAMResourceDiscoveryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIPAMResourceDiscoveryPropsMixin(props *CfnIPAMResourceDiscoveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPAMResourceDiscoveryPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnIPAMResourceDiscoveryPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::IPAMResourceDiscovery`.
func NewCfnIPAMResourceDiscoveryPropsMixin_Override(c CfnIPAMResourceDiscoveryPropsMixin, props *CfnIPAMResourceDiscoveryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnIPAMResourceDiscoveryPropsMixin) ApplyTo(construct constructs.IConstruct) {
