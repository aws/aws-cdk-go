...
//
//   cfnVPNConnectionPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPNConnectionPropsMixin(&CfnVPNConnectionMixinProps{
...
func (j *jsiiProxy_CfnVPNConnectionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPNConnectionPropsMixin(props *CfnVPNConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPNConnectionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPNConnectionPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPNConnection`.
func NewCfnVPNConnectionPropsMixin_Override(c CfnVPNConnectionPropsMixin, props *CfnVPNConnectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPNConnectionPropsMixin) ApplyTo(construct constructs.IConstruct) {
