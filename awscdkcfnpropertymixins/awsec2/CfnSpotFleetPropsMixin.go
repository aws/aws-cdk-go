...
//
//   cfnSpotFleetPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSpotFleetPropsMixin(&CfnSpotFleetMixinProps{
...
func (j *jsiiProxy_CfnSpotFleetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSpotFleetPropsMixin(props *CfnSpotFleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSpotFleetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::SpotFleet`.
func NewCfnSpotFleetPropsMixin_Override(c CfnSpotFleetPropsMixin, props *CfnSpotFleetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSpotFleetPropsMixin) ApplyTo(construct constructs.IConstruct) {
