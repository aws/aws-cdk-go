...
//
//   cfnLocalGatewayVirtualInterfacePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnLocalGatewayVirtualInterfacePropsMixin(&CfnLocalGatewayVirtualInterfaceMixinProps{
...
func (j *jsiiProxy_CfnLocalGatewayVirtualInterfacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocalGatewayVirtualInterfacePropsMixin(props *CfnLocalGatewayVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocalGatewayVirtualInterfacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::LocalGatewayVirtualInterface`.
func NewCfnLocalGatewayVirtualInterfacePropsMixin_Override(c CfnLocalGatewayVirtualInterfacePropsMixin, props *CfnLocalGatewayVirtualInterfaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocalGatewayVirtualInterfacePropsMixin) ApplyTo(construct constructs.IConstruct) {
