...
//
//   cfnTrafficMirrorFilterPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTrafficMirrorFilterPropsMixin(&CfnTrafficMirrorFilterMixinProps{
...
func (j *jsiiProxy_CfnTrafficMirrorFilterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTrafficMirrorFilterPropsMixin(props *CfnTrafficMirrorFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTrafficMirrorFilterPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTrafficMirrorFilterPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TrafficMirrorFilter`.
func NewCfnTrafficMirrorFilterPropsMixin_Override(c CfnTrafficMirrorFilterPropsMixin, props *CfnTrafficMirrorFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
