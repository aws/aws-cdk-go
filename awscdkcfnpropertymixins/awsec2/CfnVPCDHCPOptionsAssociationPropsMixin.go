...
//
//   cfnVPCDHCPOptionsAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCDHCPOptionsAssociationPropsMixin(&CfnVPCDHCPOptionsAssociationMixinProps{
...
func (j *jsiiProxy_CfnVPCDHCPOptionsAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPCDHCPOptionsAssociationPropsMixin(props *CfnVPCDHCPOptionsAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCDHCPOptionsAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCDHCPOptionsAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPCDHCPOptionsAssociation`.
func NewCfnVPCDHCPOptionsAssociationPropsMixin_Override(c CfnVPCDHCPOptionsAssociationPropsMixin, props *CfnVPCDHCPOptionsAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPCDHCPOptionsAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
