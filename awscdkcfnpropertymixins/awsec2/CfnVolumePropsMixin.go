...
//
//   cfnVolumePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVolumePropsMixin(&CfnVolumeMixinProps{
...
func (j *jsiiProxy_CfnVolumePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVolumePropsMixin(props *CfnVolumeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVolumePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVolumePropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::Volume`.
func NewCfnVolumePropsMixin_Override(c CfnVolumePropsMixin, props *CfnVolumeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
