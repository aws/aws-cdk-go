...
//
//   cfnSecurityGroupVpcAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSecurityGroupVpcAssociationPropsMixin(&CfnSecurityGroupVpcAssociationMixinProps{
...
func (j *jsiiProxy_CfnSecurityGroupVpcAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSecurityGroupVpcAssociationPropsMixin(props *CfnSecurityGroupVpcAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityGroupVpcAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::SecurityGroupVpcAssociation`.
func NewCfnSecurityGroupVpcAssociationPropsMixin_Override(c CfnSecurityGroupVpcAssociationPropsMixin, props *CfnSecurityGroupVpcAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
