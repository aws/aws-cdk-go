...
//
//   cfnTransitGatewayVpcAttachmentPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayVpcAttachmentPropsMixin(&CfnTransitGatewayVpcAttachmentMixinProps{
//   	AddSubnetIds: []*string{
...
func (j *jsiiProxy_CfnTransitGatewayVpcAttachmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayVpcAttachmentPropsMixin(props *CfnTransitGatewayVpcAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayVpcAttachmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayVpcAttachment`.
func NewCfnTransitGatewayVpcAttachmentPropsMixin_Override(c CfnTransitGatewayVpcAttachmentPropsMixin, props *CfnTransitGatewayVpcAttachmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
