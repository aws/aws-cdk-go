...
//
//   cfnVerifiedAccessInstancePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVerifiedAccessInstancePropsMixin(&CfnVerifiedAccessInstanceMixinProps{
...
func (j *jsiiProxy_CfnVerifiedAccessInstancePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVerifiedAccessInstancePropsMixin(props *CfnVerifiedAccessInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVerifiedAccessInstancePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVerifiedAccessInstancePropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VerifiedAccessInstance`.
func NewCfnVerifiedAccessInstancePropsMixin_Override(c CfnVerifiedAccessInstancePropsMixin, props *CfnVerifiedAccessInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVerifiedAccessInstancePropsMixin) ApplyTo(construct constructs.IConstruct) {
