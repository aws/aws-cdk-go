...
//
//   cfnVPCBlockPublicAccessOptionsPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnVPCBlockPublicAccessOptionsPropsMixin(&CfnVPCBlockPublicAccessOptionsMixinProps{
...
func (j *jsiiProxy_CfnVPCBlockPublicAccessOptionsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVPCBlockPublicAccessOptionsPropsMixin(props *CfnVPCBlockPublicAccessOptionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVPCBlockPublicAccessOptionsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnVPCBlockPublicAccessOptionsPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::VPCBlockPublicAccessOptions`.
func NewCfnVPCBlockPublicAccessOptionsPropsMixin_Override(c CfnVPCBlockPublicAccessOptionsPropsMixin, props *CfnVPCBlockPublicAccessOptionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnVPCBlockPublicAccessOptionsPropsMixin) ApplyTo(construct constructs.IConstruct) {
