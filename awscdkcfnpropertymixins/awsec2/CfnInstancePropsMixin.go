...
//
//   cfnInstancePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnInstancePropsMixin(&CfnInstanceMixinProps{
...
func NewCfnInstancePropsMixin(props *CfnInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstancePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnInstancePropsMixin",
