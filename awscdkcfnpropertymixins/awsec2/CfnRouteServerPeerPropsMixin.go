...
//
//   cfnRouteServerPeerPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnRouteServerPeerPropsMixin(&CfnRouteServerPeerMixinProps{
...
func NewCfnRouteServerPeerPropsMixin(props *CfnRouteServerPeerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteServerPeerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::RouteServerPeer`.
func NewCfnRouteServerPeerPropsMixin_Override(c CfnRouteServerPeerPropsMixin, props *CfnRouteServerPeerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
