...
//
//   cfnTransitGatewayMeteringPolicyEntryPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayMeteringPolicyEntryPropsMixin(&CfnTransitGatewayMeteringPolicyEntryMixinProps{
...
func (j *jsiiProxy_CfnTransitGatewayMeteringPolicyEntryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayMeteringPolicyEntryPropsMixin(props *CfnTransitGatewayMeteringPolicyEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayMeteringPolicyEntryPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTransitGatewayMeteringPolicyEntryPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayMeteringPolicyEntry`.
func NewCfnTransitGatewayMeteringPolicyEntryPropsMixin_Override(c CfnTransitGatewayMeteringPolicyEntryPropsMixin, props *CfnTransitGatewayMeteringPolicyEntryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
