...
//
//   cfnDHCPOptionsPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnDHCPOptionsPropsMixin(&CfnDHCPOptionsMixinProps{
...
func (j *jsiiProxy_CfnDHCPOptionsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDHCPOptionsPropsMixin(props *CfnDHCPOptionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDHCPOptionsPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnDHCPOptionsPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::DHCPOptions`.
func NewCfnDHCPOptionsPropsMixin_Override(c CfnDHCPOptionsPropsMixin, props *CfnDHCPOptionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
