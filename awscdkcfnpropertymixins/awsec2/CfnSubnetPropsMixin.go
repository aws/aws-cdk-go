...
//
//   cfnSubnetPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnSubnetPropsMixin(&CfnSubnetMixinProps{
...
func NewCfnSubnetPropsMixin(props *CfnSubnetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubnetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::Subnet`.
func NewCfnSubnetPropsMixin_Override(c CfnSubnetPropsMixin, props *CfnSubnetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
