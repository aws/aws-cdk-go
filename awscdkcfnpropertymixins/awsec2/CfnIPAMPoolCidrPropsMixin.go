...
//
//   cfnIPAMPoolCidrPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnIPAMPoolCidrPropsMixin(&CfnIPAMPoolCidrMixinProps{
...
func (j *jsiiProxy_CfnIPAMPoolCidrPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIPAMPoolCidrPropsMixin(props *CfnIPAMPoolCidrMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPAMPoolCidrPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnIPAMPoolCidrPropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::IPAMPoolCidr`.
func NewCfnIPAMPoolCidrPropsMixin_Override(c CfnIPAMPoolCidrPropsMixin, props *CfnIPAMPoolCidrMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
