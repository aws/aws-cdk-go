...
//
//   cfnRouteServerPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnRouteServerPropsMixin(&CfnRouteServerMixinProps{
...
func (j *jsiiProxy_CfnRouteServerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRouteServerPropsMixin(props *CfnRouteServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteServerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::RouteServer`.
func NewCfnRouteServerPropsMixin_Override(c CfnRouteServerPropsMixin, props *CfnRouteServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
