...
//
//   cfnTransitGatewayRouteTablePropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnTransitGatewayRouteTablePropsMixin(&CfnTransitGatewayRouteTableMixinProps{
//   	Tags: []CfnTag{
//   		&CfnTag{
//   			Key: jsii.String("key"),
...
func (j *jsiiProxy_CfnTransitGatewayRouteTablePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransitGatewayRouteTablePropsMixin(props *CfnTransitGatewayRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransitGatewayRouteTablePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ec2.CfnTransitGatewayRouteTablePropsMixin",
...
// Create a mixin to apply properties to `AWS::EC2::TransitGatewayRouteTable`.
func NewCfnTransitGatewayRouteTablePropsMixin_Override(c CfnTransitGatewayRouteTablePropsMixin, props *CfnTransitGatewayRouteTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTransitGatewayRouteTablePropsMixin) ApplyTo(construct constructs.IConstruct) {
