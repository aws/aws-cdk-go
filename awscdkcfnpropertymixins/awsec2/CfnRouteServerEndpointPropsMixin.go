...
//
//   cfnRouteServerEndpointPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnRouteServerEndpointPropsMixin(&CfnRouteServerEndpointMixinProps{
...
func NewCfnRouteServerEndpointPropsMixin(props *CfnRouteServerEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteServerEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::RouteServerEndpoint`.
func NewCfnRouteServerEndpointPropsMixin_Override(c CfnRouteServerEndpointPropsMixin, props *CfnRouteServerEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
