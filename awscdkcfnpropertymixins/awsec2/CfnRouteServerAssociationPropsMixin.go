...
//
//   cfnRouteServerAssociationPropsMixin := awscdkcfnpropertymixins.Aws_ec2.NewCfnRouteServerAssociationPropsMixin(&CfnRouteServerAssociationMixinProps{
...
func NewCfnRouteServerAssociationPropsMixin(props *CfnRouteServerAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRouteServerAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::EC2::RouteServerAssociation`.
func NewCfnRouteServerAssociationPropsMixin_Override(c CfnRouteServerAssociationPropsMixin, props *CfnRouteServerAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
