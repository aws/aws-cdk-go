...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsauditmanager/internal"
...
//
//   cfnAssessmentPropsMixin := awscdkcfnpropertymixins.Aws_auditmanager.NewCfnAssessmentPropsMixin(&CfnAssessmentMixinProps{
...
func (j *jsiiProxy_CfnAssessmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAssessmentPropsMixin(props *CfnAssessmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAssessmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AuditManager::Assessment`.
func NewCfnAssessmentPropsMixin_Override(c CfnAssessmentPropsMixin, props *CfnAssessmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAssessmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
