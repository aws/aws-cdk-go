...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsrum/internal"
...
//
//   cfnAppMonitorPropsMixin := awscdkcfnpropertymixins.Aws_rum.NewCfnAppMonitorPropsMixin(&CfnAppMonitorMixinProps{
...
func (j *jsiiProxy_CfnAppMonitorPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAppMonitorPropsMixin(props *CfnAppMonitorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAppMonitorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RUM::AppMonitor`.
func NewCfnAppMonitorPropsMixin_Override(c CfnAppMonitorPropsMixin, props *CfnAppMonitorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
