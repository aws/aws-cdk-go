...
//
//   cfnEndpointPropsMixin := awscdkcfnpropertymixins.Aws_s3outposts.NewCfnEndpointPropsMixin(&CfnEndpointMixinProps{
...
func (j *jsiiProxy_CfnEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEndpointPropsMixin(props *CfnEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Outposts::Endpoint`.
func NewCfnEndpointPropsMixin_Override(c CfnEndpointPropsMixin, props *CfnEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
