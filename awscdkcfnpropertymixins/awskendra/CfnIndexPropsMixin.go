...
//
//   cfnIndexPropsMixin := awscdkcfnpropertymixins.Aws_kendra.NewCfnIndexPropsMixin(&CfnIndexMixinProps{
...
func NewCfnIndexPropsMixin(props *CfnIndexMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIndexPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Kendra::Index`.
func NewCfnIndexPropsMixin_Override(c CfnIndexPropsMixin, props *CfnIndexMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
