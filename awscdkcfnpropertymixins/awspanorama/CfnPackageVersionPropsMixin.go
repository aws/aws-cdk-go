...
//
//   cfnPackageVersionPropsMixin := awscdkcfnpropertymixins.Aws_panorama.NewCfnPackageVersionPropsMixin(&CfnPackageVersionMixinProps{
...
func NewCfnPackageVersionPropsMixin(props *CfnPackageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPackageVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Panorama::PackageVersion`.
func NewCfnPackageVersionPropsMixin_Override(c CfnPackageVersionPropsMixin, props *CfnPackageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
