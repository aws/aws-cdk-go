...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awspanorama/internal"
...
//
//   cfnApplicationInstancePropsMixin := awscdkcfnpropertymixins.Aws_panorama.NewCfnApplicationInstancePropsMixin(&CfnApplicationInstanceMixinProps{
...
func NewCfnApplicationInstancePropsMixin(props *CfnApplicationInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Panorama::ApplicationInstance`.
func NewCfnApplicationInstancePropsMixin_Override(c CfnApplicationInstancePropsMixin, props *CfnApplicationInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
