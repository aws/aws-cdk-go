...
//
//   cfnApplicationOutputPropsMixin := awscdkcfnpropertymixins.Aws_kinesisanalyticsv2.NewCfnApplicationOutputPropsMixin(&CfnApplicationOutputMixinProps{
...
func NewCfnApplicationOutputPropsMixin(props *CfnApplicationOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationOutputPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::KinesisAnalyticsV2::ApplicationOutput`.
func NewCfnApplicationOutputPropsMixin_Override(c CfnApplicationOutputPropsMixin, props *CfnApplicationOutputMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApplicationOutputPropsMixin) ApplyTo(construct constructs.IConstruct) {
