...
func validateNewCfnDBSecurityGroupPropsMixinParameters(props *CfnDBSecurityGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
