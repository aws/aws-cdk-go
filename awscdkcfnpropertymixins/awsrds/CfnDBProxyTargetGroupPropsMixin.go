...
//
//   cfnDBProxyTargetGroupPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBProxyTargetGroupPropsMixin(&CfnDBProxyTargetGroupMixinProps{
...
func (j *jsiiProxy_CfnDBProxyTargetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDBProxyTargetGroupPropsMixin(props *CfnDBProxyTargetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBProxyTargetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBProxyTargetGroup`.
func NewCfnDBProxyTargetGroupPropsMixin_Override(c CfnDBProxyTargetGroupPropsMixin, props *CfnDBProxyTargetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDBProxyTargetGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
