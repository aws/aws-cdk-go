...
//
//   cfnDBProxyPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBProxyPropsMixin(&CfnDBProxyMixinProps{
//   	Auth: []interface{}{
//   		&AuthFormatProperty{
...
func NewCfnDBProxyPropsMixin(props *CfnDBProxyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBProxyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBProxy`.
func NewCfnDBProxyPropsMixin_Override(c CfnDBProxyPropsMixin, props *CfnDBProxyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
