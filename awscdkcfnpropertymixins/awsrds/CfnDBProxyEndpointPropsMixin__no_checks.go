...
func validateNewCfnDBProxyEndpointPropsMixinParameters(props *CfnDBProxyEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
