...
//
//   cfnDBProxyEndpointMixinProps := &CfnDBProxyEndpointMixinProps{
...
//
type CfnDBProxyEndpointMixinProps struct {
	...
	//
	Tags *[]*CfnDBProxyEndpointPropsMixin_TagFormatProperty `field:"optional" json:"tags" yaml:"tags"`
