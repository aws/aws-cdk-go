...
func validateNewCfnCustomDBEngineVersionPropsMixinParameters(props *CfnCustomDBEngineVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
