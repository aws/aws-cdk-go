...
func init() {
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_rds.CfnReservedDBInstanceMixinProps",
		reflect.TypeOf((*CfnReservedDBInstanceMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_rds.CfnReservedDBInstancePropsMixin",
		reflect.TypeOf((*CfnReservedDBInstancePropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "applyTo", GoMethod: "ApplyTo"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "strategy", GoGetter: "Strategy"},
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_rds.CfnReservedDBInstancePropsMixin.RecurringChargeProperty",
		reflect.TypeOf((*CfnReservedDBInstancePropsMixin_RecurringChargeProperty)(nil)).Elem(),
	)
}
