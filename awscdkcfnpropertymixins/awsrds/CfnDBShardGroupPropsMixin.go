...
//
//   cfnDBShardGroupPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBShardGroupPropsMixin(&CfnDBShardGroupMixinProps{
...
func NewCfnDBShardGroupPropsMixin(props *CfnDBShardGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBShardGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBShardGroup`.
func NewCfnDBShardGroupPropsMixin_Override(c CfnDBShardGroupPropsMixin, props *CfnDBShardGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
