...
//
//   cfnDBSecurityGroupIngressPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBSecurityGroupIngressPropsMixin(&CfnDBSecurityGroupIngressMixinProps{
...
func NewCfnDBSecurityGroupIngressPropsMixin(props *CfnDBSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBSecurityGroupIngressPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBSecurityGroupIngress`.
func NewCfnDBSecurityGroupIngressPropsMixin_Override(c CfnDBSecurityGroupIngressPropsMixin, props *CfnDBSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
