...
//
//   cfnOptionGroupPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnOptionGroupPropsMixin(&CfnOptionGroupMixinProps{
...
func (j *jsiiProxy_CfnOptionGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOptionGroupPropsMixin(props *CfnOptionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOptionGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::OptionGroup`.
func NewCfnOptionGroupPropsMixin_Override(c CfnOptionGroupPropsMixin, props *CfnOptionGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnOptionGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
