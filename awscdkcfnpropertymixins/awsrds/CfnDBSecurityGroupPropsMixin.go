...
//
//   cfnDBSecurityGroupPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBSecurityGroupPropsMixin(&CfnDBSecurityGroupMixinProps{
...
func (j *jsiiProxy_CfnDBSecurityGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDBSecurityGroupPropsMixin(props *CfnDBSecurityGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBSecurityGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBSecurityGroup`.
func NewCfnDBSecurityGroupPropsMixin_Override(c CfnDBSecurityGroupPropsMixin, props *CfnDBSecurityGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDBSecurityGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
