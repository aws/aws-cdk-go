...
//
//   cfnDBProxyEndpointPropsMixin := awscdkcfnpropertymixins.Aws_rds.NewCfnDBProxyEndpointPropsMixin(&CfnDBProxyEndpointMixinProps{
...
func (j *jsiiProxy_CfnDBProxyEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDBProxyEndpointPropsMixin(props *CfnDBProxyEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBProxyEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::RDS::DBProxyEndpoint`.
func NewCfnDBProxyEndpointPropsMixin_Override(c CfnDBProxyEndpointPropsMixin, props *CfnDBProxyEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDBProxyEndpointPropsMixin) ApplyTo(construct constructs.IConstruct) {
