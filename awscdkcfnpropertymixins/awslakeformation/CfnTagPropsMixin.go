...
//
//   cfnTagPropsMixin := awscdkcfnpropertymixins.Aws_lakeformation.NewCfnTagPropsMixin(&CfnTagMixinProps{
...
func (j *jsiiProxy_CfnTagPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTagPropsMixin(props *CfnTagMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTagPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LakeFormation::Tag`.
func NewCfnTagPropsMixin_Override(c CfnTagPropsMixin, props *CfnTagMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTagPropsMixin) ApplyTo(construct constructs.IConstruct) {
