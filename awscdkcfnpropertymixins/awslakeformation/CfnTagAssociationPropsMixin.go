...
//
//   cfnTagAssociationPropsMixin := awscdkcfnpropertymixins.Aws_lakeformation.NewCfnTagAssociationPropsMixin(&CfnTagAssociationMixinProps{
//   	LfTags: []interface{}{
//   		&LFTagPairProperty{
...
func (j *jsiiProxy_CfnTagAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTagAssociationPropsMixin(props *CfnTagAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTagAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LakeFormation::TagAssociation`.
func NewCfnTagAssociationPropsMixin_Override(c CfnTagAssociationPropsMixin, props *CfnTagAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTagAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
