...
//
//   cfnPermissionsPropsMixin := awscdkcfnpropertymixins.Aws_lakeformation.NewCfnPermissionsPropsMixin(&CfnPermissionsMixinProps{
...
func (j *jsiiProxy_CfnPermissionsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPermissionsPropsMixin(props *CfnPermissionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPermissionsPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LakeFormation::Permissions`.
func NewCfnPermissionsPropsMixin_Override(c CfnPermissionsPropsMixin, props *CfnPermissionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
