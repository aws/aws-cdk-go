...
//
//   cfnPrincipalPermissionsPropsMixin := awscdkcfnpropertymixins.Aws_lakeformation.NewCfnPrincipalPermissionsPropsMixin(&CfnPrincipalPermissionsMixinProps{
...
func (j *jsiiProxy_CfnPrincipalPermissionsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPrincipalPermissionsPropsMixin(props *CfnPrincipalPermissionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPrincipalPermissionsPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LakeFormation::PrincipalPermissions`.
func NewCfnPrincipalPermissionsPropsMixin_Override(c CfnPrincipalPermissionsPropsMixin, props *CfnPrincipalPermissionsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
