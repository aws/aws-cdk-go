...
//
//   cfnReceiptRulePropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnReceiptRulePropsMixin(&CfnReceiptRuleMixinProps{
...
func NewCfnReceiptRulePropsMixin(props *CfnReceiptRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReceiptRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::ReceiptRule`.
func NewCfnReceiptRulePropsMixin_Override(c CfnReceiptRulePropsMixin, props *CfnReceiptRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
