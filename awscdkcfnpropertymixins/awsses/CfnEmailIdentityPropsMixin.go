...
//
//   cfnEmailIdentityPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnEmailIdentityPropsMixin(&CfnEmailIdentityMixinProps{
...
func NewCfnEmailIdentityPropsMixin(props *CfnEmailIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEmailIdentityPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::EmailIdentity`.
func NewCfnEmailIdentityPropsMixin_Override(c CfnEmailIdentityPropsMixin, props *CfnEmailIdentityMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
