...
//
//   cfnMultiRegionEndpointPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnMultiRegionEndpointPropsMixin(&CfnMultiRegionEndpointMixinProps{
...
func (j *jsiiProxy_CfnMultiRegionEndpointPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMultiRegionEndpointPropsMixin(props *CfnMultiRegionEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMultiRegionEndpointPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::MultiRegionEndpoint`.
func NewCfnMultiRegionEndpointPropsMixin_Override(c CfnMultiRegionEndpointPropsMixin, props *CfnMultiRegionEndpointMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
