...
//
//   cfnVdmAttributesPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnVdmAttributesPropsMixin(&CfnVdmAttributesMixinProps{
...
func (j *jsiiProxy_CfnVdmAttributesPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVdmAttributesPropsMixin(props *CfnVdmAttributesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVdmAttributesPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::VdmAttributes`.
func NewCfnVdmAttributesPropsMixin_Override(c CfnVdmAttributesPropsMixin, props *CfnVdmAttributesMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
