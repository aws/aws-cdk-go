...
//
//   cfnConfigurationSetEventDestinationPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnConfigurationSetEventDestinationPropsMixin(&CfnConfigurationSetEventDestinationMixinProps{
