...
//
//   cfnTenantPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnTenantPropsMixin(&CfnTenantMixinProps{
...
func (j *jsiiProxy_CfnTenantPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTenantPropsMixin(props *CfnTenantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTenantPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::Tenant`.
func NewCfnTenantPropsMixin_Override(c CfnTenantPropsMixin, props *CfnTenantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTenantPropsMixin) ApplyTo(construct constructs.IConstruct) {
