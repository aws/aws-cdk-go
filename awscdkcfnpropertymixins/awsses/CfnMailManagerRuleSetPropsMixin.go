...
//
//   cfnMailManagerRuleSetPropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnMailManagerRuleSetPropsMixin(&CfnMailManagerRuleSetMixinProps{
//   	Rules: []interface{}{
//   		&RuleProperty{
//   			Actions: []interface{}{
//   				&RuleActionProperty{
...
func (j *jsiiProxy_CfnMailManagerRuleSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMailManagerRuleSetPropsMixin(props *CfnMailManagerRuleSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMailManagerRuleSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::MailManagerRuleSet`.
func NewCfnMailManagerRuleSetPropsMixin_Override(c CfnMailManagerRuleSetPropsMixin, props *CfnMailManagerRuleSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
