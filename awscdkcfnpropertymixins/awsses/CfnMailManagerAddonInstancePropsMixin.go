...
//
//   cfnMailManagerAddonInstancePropsMixin := awscdkcfnpropertymixins.Aws_ses.NewCfnMailManagerAddonInstancePropsMixin(&CfnMailManagerAddonInstanceMixinProps{
...
func (j *jsiiProxy_CfnMailManagerAddonInstancePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMailManagerAddonInstancePropsMixin(props *CfnMailManagerAddonInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMailManagerAddonInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SES::MailManagerAddonInstance`.
func NewCfnMailManagerAddonInstancePropsMixin_Override(c CfnMailManagerAddonInstancePropsMixin, props *CfnMailManagerAddonInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMailManagerAddonInstancePropsMixin) ApplyTo(construct constructs.IConstruct) {
