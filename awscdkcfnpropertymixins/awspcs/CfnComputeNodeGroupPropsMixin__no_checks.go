...
func validateNewCfnComputeNodeGroupPropsMixinParameters(props *CfnComputeNodeGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
