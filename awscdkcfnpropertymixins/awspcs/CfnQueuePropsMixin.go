...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awspcs/internal"
...
//
//   cfnQueuePropsMixin := awscdkcfnpropertymixins.Aws_pcs.NewCfnQueuePropsMixin(&CfnQueueMixinProps{
...
func (j *jsiiProxy_CfnQueuePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnQueuePropsMixin(props *CfnQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnQueuePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::PCS::Queue`.
func NewCfnQueuePropsMixin_Override(c CfnQueuePropsMixin, props *CfnQueueMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
