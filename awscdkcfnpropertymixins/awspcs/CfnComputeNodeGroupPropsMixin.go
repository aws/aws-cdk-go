...
//
//   cfnComputeNodeGroupPropsMixin := awscdkcfnpropertymixins.Aws_pcs.NewCfnComputeNodeGroupPropsMixin(&CfnComputeNodeGroupMixinProps{
...
func NewCfnComputeNodeGroupPropsMixin(props *CfnComputeNodeGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnComputeNodeGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::PCS::ComputeNodeGroup`.
func NewCfnComputeNodeGroupPropsMixin_Override(c CfnComputeNodeGroupPropsMixin, props *CfnComputeNodeGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
