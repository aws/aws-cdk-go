...
//
//   cfnControlPanelPropsMixin := awscdkcfnpropertymixins.Aws_route53recoverycontrol.NewCfnControlPanelPropsMixin(&CfnControlPanelMixinProps{
...
func (j *jsiiProxy_CfnControlPanelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnControlPanelPropsMixin(props *CfnControlPanelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnControlPanelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53RecoveryControl::ControlPanel`.
func NewCfnControlPanelPropsMixin_Override(c CfnControlPanelPropsMixin, props *CfnControlPanelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnControlPanelPropsMixin) ApplyTo(construct constructs.IConstruct) {
