...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsroute53recoverycontrol/internal"
...
//
//   cfnRoutingControlPropsMixin := awscdkcfnpropertymixins.Aws_route53recoverycontrol.NewCfnRoutingControlPropsMixin(&CfnRoutingControlMixinProps{
...
func (j *jsiiProxy_CfnRoutingControlPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoutingControlPropsMixin(props *CfnRoutingControlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoutingControlPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53RecoveryControl::RoutingControl`.
func NewCfnRoutingControlPropsMixin_Override(c CfnRoutingControlPropsMixin, props *CfnRoutingControlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
