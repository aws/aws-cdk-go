...
//
//   cfnSafetyRulePropsMixin := awscdkcfnpropertymixins.Aws_route53recoverycontrol.NewCfnSafetyRulePropsMixin(&CfnSafetyRuleMixinProps{
...
func NewCfnSafetyRulePropsMixin(props *CfnSafetyRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSafetyRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53RecoveryControl::SafetyRule`.
func NewCfnSafetyRulePropsMixin_Override(c CfnSafetyRulePropsMixin, props *CfnSafetyRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
