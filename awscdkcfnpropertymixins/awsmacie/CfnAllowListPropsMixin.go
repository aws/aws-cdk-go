...
//
//   cfnAllowListPropsMixin := awscdkcfnpropertymixins.Aws_macie.NewCfnAllowListPropsMixin(&CfnAllowListMixinProps{
...
func NewCfnAllowListPropsMixin(props *CfnAllowListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAllowListPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Macie::AllowList`.
func NewCfnAllowListPropsMixin_Override(c CfnAllowListPropsMixin, props *CfnAllowListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
