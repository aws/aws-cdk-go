...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsmacie/internal"
...
//
//   cfnCustomDataIdentifierPropsMixin := awscdkcfnpropertymixins.Aws_macie.NewCfnCustomDataIdentifierPropsMixin(&CfnCustomDataIdentifierMixinProps{
...
func NewCfnCustomDataIdentifierPropsMixin(props *CfnCustomDataIdentifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCustomDataIdentifierPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Macie::CustomDataIdentifier`.
func NewCfnCustomDataIdentifierPropsMixin_Override(c CfnCustomDataIdentifierPropsMixin, props *CfnCustomDataIdentifierMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
