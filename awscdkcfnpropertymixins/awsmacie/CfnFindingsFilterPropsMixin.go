...
//
//   cfnFindingsFilterPropsMixin := awscdkcfnpropertymixins.Aws_macie.NewCfnFindingsFilterPropsMixin(&CfnFindingsFilterMixinProps{
...
func NewCfnFindingsFilterPropsMixin(props *CfnFindingsFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFindingsFilterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Macie::FindingsFilter`.
func NewCfnFindingsFilterPropsMixin_Override(c CfnFindingsFilterPropsMixin, props *CfnFindingsFilterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
