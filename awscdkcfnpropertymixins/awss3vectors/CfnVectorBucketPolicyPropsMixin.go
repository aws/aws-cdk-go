...
//
//   cfnVectorBucketPolicyPropsMixin := awscdkcfnpropertymixins.Aws_s3vectors.NewCfnVectorBucketPolicyPropsMixin(&CfnVectorBucketPolicyMixinProps{
//   	Policy: policy,
...
func NewCfnVectorBucketPolicyPropsMixin(props *CfnVectorBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVectorBucketPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::S3Vectors::VectorBucketPolicy`.
func NewCfnVectorBucketPolicyPropsMixin_Override(c CfnVectorBucketPolicyPropsMixin, props *CfnVectorBucketPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
