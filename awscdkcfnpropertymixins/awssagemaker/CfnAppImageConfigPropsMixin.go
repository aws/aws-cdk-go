...
//
//   cfnAppImageConfigPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnAppImageConfigPropsMixin(&CfnAppImageConfigMixinProps{
...
func (j *jsiiProxy_CfnAppImageConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAppImageConfigPropsMixin(props *CfnAppImageConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAppImageConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::AppImageConfig`.
func NewCfnAppImageConfigPropsMixin_Override(c CfnAppImageConfigPropsMixin, props *CfnAppImageConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAppImageConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
