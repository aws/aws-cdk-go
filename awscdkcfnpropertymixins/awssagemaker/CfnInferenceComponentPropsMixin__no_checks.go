...
func validateNewCfnInferenceComponentPropsMixinParameters(props *CfnInferenceComponentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
