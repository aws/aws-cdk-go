...
//
//   cfnPartnerAppPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnPartnerAppPropsMixin(&CfnPartnerAppMixinProps{
...
func (j *jsiiProxy_CfnPartnerAppPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPartnerAppPropsMixin(props *CfnPartnerAppMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPartnerAppPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::PartnerApp`.
func NewCfnPartnerAppPropsMixin_Override(c CfnPartnerAppPropsMixin, props *CfnPartnerAppMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPartnerAppPropsMixin) ApplyTo(construct constructs.IConstruct) {
