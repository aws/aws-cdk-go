...
//
//   cfnMonitoringSchedulePropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnMonitoringSchedulePropsMixin(&CfnMonitoringScheduleMixinProps{
...
func (j *jsiiProxy_CfnMonitoringSchedulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMonitoringSchedulePropsMixin(props *CfnMonitoringScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMonitoringSchedulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::MonitoringSchedule`.
func NewCfnMonitoringSchedulePropsMixin_Override(c CfnMonitoringSchedulePropsMixin, props *CfnMonitoringScheduleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMonitoringSchedulePropsMixin) ApplyTo(construct constructs.IConstruct) {
