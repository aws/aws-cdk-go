...
//
//   cfnStudioLifecycleConfigPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnStudioLifecycleConfigPropsMixin(&CfnStudioLifecycleConfigMixinProps{
...
func NewCfnStudioLifecycleConfigPropsMixin(props *CfnStudioLifecycleConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStudioLifecycleConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::StudioLifecycleConfig`.
func NewCfnStudioLifecycleConfigPropsMixin_Override(c CfnStudioLifecycleConfigPropsMixin, props *CfnStudioLifecycleConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
