...
//
//   cfnTransformJobPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnTransformJobPropsMixin(&CfnTransformJobMixinProps{
...
//
type CfnTransformJobPropsMixin interface {
	awscdk.Mixin
	constructs.IMixin
	Props() *CfnTransformJobMixinProps
...
// The jsii proxy struct for CfnTransformJobPropsMixin
type jsiiProxy_CfnTransformJobPropsMixin struct {
	internal.Type__awscdkMixin
	internal.Type__constructsIMixin
}

func (j *jsiiProxy_CfnTransformJobPropsMixin) Props() *CfnTransformJobMixinProps {
	var returns *CfnTransformJobMixinProps
	_jsii_.Get(
		j,
		"props",
		&returns,
...
func (j *jsiiProxy_CfnTransformJobPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTransformJobPropsMixin(props *CfnTransformJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTransformJobPropsMixin {
	_init_.Initialize()

	if err := validateNewCfnTransformJobPropsMixinParameters(props, options); err != nil {
		panic(err)
	}
...
// Create a mixin to apply properties to `AWS::SageMaker::TransformJob`.
func NewCfnTransformJobPropsMixin_Override(c CfnTransformJobPropsMixin, props *CfnTransformJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func CfnTransformJobPropsMixin_IsMixin(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCfnTransformJobPropsMixin_IsMixinParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CfnTransformJobPropsMixin_CFN_PROPERTY_KEYS() *[]*string {
	_init_.Initialize()
	var returns *[]*string
	_jsii_.StaticGet(
		"@aws-cdk/cfn-property-mixins.aws_sagemaker.CfnTransformJobPropsMixin",
...
func (c *jsiiProxy_CfnTransformJobPropsMixin) ApplyTo(construct constructs.IConstruct) {
...
func (c *jsiiProxy_CfnTransformJobPropsMixin) Supports(construct constructs.IConstruct) *bool {
