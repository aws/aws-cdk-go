...
//
//   cfnModelQualityJobDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnModelQualityJobDefinitionPropsMixin(&CfnModelQualityJobDefinitionMixinProps{
...
func NewCfnModelQualityJobDefinitionPropsMixin(props *CfnModelQualityJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModelQualityJobDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ModelQualityJobDefinition`.
func NewCfnModelQualityJobDefinitionPropsMixin_Override(c CfnModelQualityJobDefinitionPropsMixin, props *CfnModelQualityJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
