...
//
//   cfnImageVersionPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnImageVersionPropsMixin(&CfnImageVersionMixinProps{
...
func (j *jsiiProxy_CfnImageVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnImageVersionPropsMixin(props *CfnImageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnImageVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ImageVersion`.
func NewCfnImageVersionPropsMixin_Override(c CfnImageVersionPropsMixin, props *CfnImageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
