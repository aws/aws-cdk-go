...
//
//   cfnNotebookInstanceLifecycleConfigPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnNotebookInstanceLifecycleConfigPropsMixin(&CfnNotebookInstanceLifecycleConfigMixinProps{
...
func (j *jsiiProxy_CfnNotebookInstanceLifecycleConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNotebookInstanceLifecycleConfigPropsMixin(props *CfnNotebookInstanceLifecycleConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNotebookInstanceLifecycleConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::NotebookInstanceLifecycleConfig`.
func NewCfnNotebookInstanceLifecycleConfigPropsMixin_Override(c CfnNotebookInstanceLifecycleConfigPropsMixin, props *CfnNotebookInstanceLifecycleConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNotebookInstanceLifecycleConfigPropsMixin) ApplyTo(construct constructs.IConstruct) {
