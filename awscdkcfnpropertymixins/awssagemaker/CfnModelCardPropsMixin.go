...
//   var value interface{}
//
//   cfnModelCardPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnModelCardPropsMixin(&CfnModelCardMixinProps{
...
func (j *jsiiProxy_CfnModelCardPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnModelCardPropsMixin(props *CfnModelCardMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModelCardPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ModelCard`.
func NewCfnModelCardPropsMixin_Override(c CfnModelCardPropsMixin, props *CfnModelCardMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
