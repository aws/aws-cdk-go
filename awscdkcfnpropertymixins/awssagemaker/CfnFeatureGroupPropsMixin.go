...
//
//   cfnFeatureGroupPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnFeatureGroupPropsMixin(&CfnFeatureGroupMixinProps{
...
func NewCfnFeatureGroupPropsMixin(props *CfnFeatureGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFeatureGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::FeatureGroup`.
func NewCfnFeatureGroupPropsMixin_Override(c CfnFeatureGroupPropsMixin, props *CfnFeatureGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
