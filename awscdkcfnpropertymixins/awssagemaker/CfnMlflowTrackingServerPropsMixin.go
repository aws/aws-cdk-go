...
//
//   cfnMlflowTrackingServerPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnMlflowTrackingServerPropsMixin(&CfnMlflowTrackingServerMixinProps{
...
func (j *jsiiProxy_CfnMlflowTrackingServerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMlflowTrackingServerPropsMixin(props *CfnMlflowTrackingServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMlflowTrackingServerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::MlflowTrackingServer`.
func NewCfnMlflowTrackingServerPropsMixin_Override(c CfnMlflowTrackingServerPropsMixin, props *CfnMlflowTrackingServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
