...
//
//   cfnCodeRepositoryPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnCodeRepositoryPropsMixin(&CfnCodeRepositoryMixinProps{
...
func (j *jsiiProxy_CfnCodeRepositoryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCodeRepositoryPropsMixin(props *CfnCodeRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCodeRepositoryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::CodeRepository`.
func NewCfnCodeRepositoryPropsMixin_Override(c CfnCodeRepositoryPropsMixin, props *CfnCodeRepositoryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
