...
//
type CfnEndpointConfigPropsMixin_RoutingConfigProperty struct {
	...
	//
	PrefixAwareRoutingConfig interface{} `field:"optional" json:"prefixAwareRoutingConfig" yaml:"prefixAwareRoutingConfig"`
