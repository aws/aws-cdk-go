...
//
type CfnModelCardExportJobPropsMixin_ModelCardExportArtifactsProperty struct {
	...
	//
	S3ExportArtifacts *string `field:"optional" json:"s3ExportArtifacts" yaml:"s3ExportArtifacts"`
}
