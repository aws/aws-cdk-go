...
//
//   cfnProcessingJobPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnProcessingJobPropsMixin(&CfnProcessingJobMixinProps{
...
func NewCfnProcessingJobPropsMixin(props *CfnProcessingJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnProcessingJobPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ProcessingJob`.
func NewCfnProcessingJobPropsMixin_Override(c CfnProcessingJobPropsMixin, props *CfnProcessingJobMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
