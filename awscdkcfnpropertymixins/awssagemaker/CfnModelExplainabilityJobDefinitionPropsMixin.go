...
//
//   cfnModelExplainabilityJobDefinitionPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnModelExplainabilityJobDefinitionPropsMixin(&CfnModelExplainabilityJobDefinitionMixinProps{
...
func (j *jsiiProxy_CfnModelExplainabilityJobDefinitionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnModelExplainabilityJobDefinitionPropsMixin(props *CfnModelExplainabilityJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModelExplainabilityJobDefinitionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ModelExplainabilityJobDefinition`.
func NewCfnModelExplainabilityJobDefinitionPropsMixin_Override(c CfnModelExplainabilityJobDefinitionPropsMixin, props *CfnModelExplainabilityJobDefinitionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnModelExplainabilityJobDefinitionPropsMixin) ApplyTo(construct constructs.IConstruct) {
