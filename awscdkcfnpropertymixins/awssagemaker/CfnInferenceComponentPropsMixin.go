...
//
//   cfnInferenceComponentPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnInferenceComponentPropsMixin(&CfnInferenceComponentMixinProps{
...
func (j *jsiiProxy_CfnInferenceComponentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInferenceComponentPropsMixin(props *CfnInferenceComponentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInferenceComponentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::InferenceComponent`.
func NewCfnInferenceComponentPropsMixin_Override(c CfnInferenceComponentPropsMixin, props *CfnInferenceComponentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInferenceComponentPropsMixin) ApplyTo(construct constructs.IConstruct) {
