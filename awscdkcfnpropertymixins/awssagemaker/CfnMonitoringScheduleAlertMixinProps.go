...
//
//   cfnMonitoringScheduleAlertMixinProps := &CfnMonitoringScheduleAlertMixinProps{
...
//
type CfnMonitoringScheduleAlertMixinProps struct {
	...
	//
	DatapointsToAlert *float64 `field:"optional" json:"datapointsToAlert" yaml:"datapointsToAlert"`
	...
	//
	EvaluationPeriod *float64 `field:"optional" json:"evaluationPeriod" yaml:"evaluationPeriod"`
	...
	//
	MonitoringAlertName *string `field:"optional" json:"monitoringAlertName" yaml:"monitoringAlertName"`
