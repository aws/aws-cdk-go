...
//
type CfnAlgorithmPropsMixin_TrainingSpecificationProperty struct {
	...
	//
	SupportedTrainingInstanceTypes *[]*string `field:"optional" json:"supportedTrainingInstanceTypes" yaml:"supportedTrainingInstanceTypes"`
