...
//
//   cfnSpacePropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnSpacePropsMixin(&CfnSpaceMixinProps{
...
func (j *jsiiProxy_CfnSpacePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSpacePropsMixin(props *CfnSpaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSpacePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::Space`.
func NewCfnSpacePropsMixin_Override(c CfnSpacePropsMixin, props *CfnSpaceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSpacePropsMixin) ApplyTo(construct constructs.IConstruct) {
