...
//
//   cfnWorkteamPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnWorkteamPropsMixin(&CfnWorkteamMixinProps{
...
func NewCfnWorkteamPropsMixin(props *CfnWorkteamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkteamPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::Workteam`.
func NewCfnWorkteamPropsMixin_Override(c CfnWorkteamPropsMixin, props *CfnWorkteamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
