...
//
//   cfnEndpointConfigPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnEndpointConfigPropsMixin(&CfnEndpointConfigMixinProps{
...
func NewCfnEndpointConfigPropsMixin(props *CfnEndpointConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEndpointConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::EndpointConfig`.
func NewCfnEndpointConfigPropsMixin_Override(c CfnEndpointConfigPropsMixin, props *CfnEndpointConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
