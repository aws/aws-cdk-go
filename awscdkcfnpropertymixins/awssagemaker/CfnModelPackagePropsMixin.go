...
//
//   cfnModelPackagePropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnModelPackagePropsMixin(&CfnModelPackageMixinProps{
...
func (j *jsiiProxy_CfnModelPackagePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnModelPackagePropsMixin(props *CfnModelPackageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnModelPackagePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::ModelPackage`.
func NewCfnModelPackagePropsMixin_Override(c CfnModelPackagePropsMixin, props *CfnModelPackageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnModelPackagePropsMixin) ApplyTo(construct constructs.IConstruct) {
