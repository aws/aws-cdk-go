...
//
//   cfnInferenceExperimentPropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnInferenceExperimentPropsMixin(&CfnInferenceExperimentMixinProps{
...
func (j *jsiiProxy_CfnInferenceExperimentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInferenceExperimentPropsMixin(props *CfnInferenceExperimentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInferenceExperimentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::InferenceExperiment`.
func NewCfnInferenceExperimentPropsMixin_Override(c CfnInferenceExperimentPropsMixin, props *CfnInferenceExperimentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInferenceExperimentPropsMixin) ApplyTo(construct constructs.IConstruct) {
