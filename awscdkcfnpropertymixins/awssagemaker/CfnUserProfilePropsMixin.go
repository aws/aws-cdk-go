...
//
//   cfnUserProfilePropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnUserProfilePropsMixin(&CfnUserProfileMixinProps{
...
func (j *jsiiProxy_CfnUserProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUserProfilePropsMixin(props *CfnUserProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUserProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::UserProfile`.
func NewCfnUserProfilePropsMixin_Override(c CfnUserProfilePropsMixin, props *CfnUserProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnUserProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
