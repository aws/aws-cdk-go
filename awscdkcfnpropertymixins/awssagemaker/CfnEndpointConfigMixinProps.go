...
// Properties for CfnEndpointConfigPropsMixin.
//
// Example:
...
//
//   cfnEndpointConfigMixinProps := &CfnEndpointConfigMixinProps{
...
//
type CfnEndpointConfigMixinProps struct {
	...
	//
	ProductionVariants interface{} `field:"optional" json:"productionVariants" yaml:"productionVariants"`
