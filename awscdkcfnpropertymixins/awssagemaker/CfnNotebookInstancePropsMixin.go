...
//
//   cfnNotebookInstancePropsMixin := awscdkcfnpropertymixins.Aws_sagemaker.NewCfnNotebookInstancePropsMixin(&CfnNotebookInstanceMixinProps{
...
func NewCfnNotebookInstancePropsMixin(props *CfnNotebookInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNotebookInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SageMaker::NotebookInstance`.
func NewCfnNotebookInstancePropsMixin_Override(c CfnNotebookInstancePropsMixin, props *CfnNotebookInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
