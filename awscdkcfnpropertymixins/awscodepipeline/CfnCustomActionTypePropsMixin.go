...
//
//   cfnCustomActionTypePropsMixin := awscdkcfnpropertymixins.Aws_codepipeline.NewCfnCustomActionTypePropsMixin(&CfnCustomActionTypeMixinProps{
...
func NewCfnCustomActionTypePropsMixin(props *CfnCustomActionTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCustomActionTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodePipeline::CustomActionType`.
func NewCfnCustomActionTypePropsMixin_Override(c CfnCustomActionTypePropsMixin, props *CfnCustomActionTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
