...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awscodepipeline/internal"
...
//
//   cfnPipelinePropsMixin := awscdkcfnpropertymixins.Aws_codepipeline.NewCfnPipelinePropsMixin(&CfnPipelineMixinProps{
