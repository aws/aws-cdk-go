...
//
type CfnAcmeEndpointPropsMixin_CertificateAuthorityProperty struct {
	...
	//
	PublicCertificateAuthority interface{} `field:"optional" json:"publicCertificateAuthority" yaml:"publicCertificateAuthority"`
}
