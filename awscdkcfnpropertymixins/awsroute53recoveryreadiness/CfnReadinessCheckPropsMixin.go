...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsroute53recoveryreadiness/internal"
...
//
//   cfnReadinessCheckPropsMixin := awscdkcfnpropertymixins.Aws_route53recoveryreadiness.NewCfnReadinessCheckPropsMixin(&CfnReadinessCheckMixinProps{
...
func (j *jsiiProxy_CfnReadinessCheckPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReadinessCheckPropsMixin(props *CfnReadinessCheckMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReadinessCheckPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53RecoveryReadiness::ReadinessCheck`.
func NewCfnReadinessCheckPropsMixin_Override(c CfnReadinessCheckPropsMixin, props *CfnReadinessCheckMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReadinessCheckPropsMixin) ApplyTo(construct constructs.IConstruct) {
