...
//
//   cfnCellPropsMixin := awscdkcfnpropertymixins.Aws_route53recoveryreadiness.NewCfnCellPropsMixin(&CfnCellMixinProps{
...
func (j *jsiiProxy_CfnCellPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCellPropsMixin(props *CfnCellMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCellPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53RecoveryReadiness::Cell`.
func NewCfnCellPropsMixin_Override(c CfnCellPropsMixin, props *CfnCellMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCellPropsMixin) ApplyTo(construct constructs.IConstruct) {
