...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamMixinProps",
		reflect.TypeOf((*CfnApprovalTeamMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamPropsMixin.ApprovalStrategyProperty",
		reflect.TypeOf((*CfnApprovalTeamPropsMixin_ApprovalStrategyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamPropsMixin.ApproverProperty",
		reflect.TypeOf((*CfnApprovalTeamPropsMixin_ApproverProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamPropsMixin.MofNApprovalStrategyProperty",
		reflect.TypeOf((*CfnApprovalTeamPropsMixin_MofNApprovalStrategyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnApprovalTeamPropsMixin.PolicyProperty",
		reflect.TypeOf((*CfnApprovalTeamPropsMixin_PolicyProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnIdentitySourceMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnIdentitySourcePropsMixin.IamIdentityCenterProperty",
		reflect.TypeOf((*CfnIdentitySourcePropsMixin_IamIdentityCenterProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_mpa.CfnIdentitySourcePropsMixin.IdentitySourceParametersProperty",
