...
//
//   cfnApprovalTeamPropsMixin := awscdkcfnpropertymixins.Aws_mpa.NewCfnApprovalTeamPropsMixin(&CfnApprovalTeamMixinProps{
...
func (j *jsiiProxy_CfnApprovalTeamPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnApprovalTeamPropsMixin(props *CfnApprovalTeamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApprovalTeamPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MPA::ApprovalTeam`.
func NewCfnApprovalTeamPropsMixin_Override(c CfnApprovalTeamPropsMixin, props *CfnApprovalTeamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApprovalTeamPropsMixin) ApplyTo(construct constructs.IConstruct) {
