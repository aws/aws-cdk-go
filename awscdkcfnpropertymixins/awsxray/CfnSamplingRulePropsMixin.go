...
//
//   cfnSamplingRulePropsMixin := awscdkcfnpropertymixins.Aws_xray.NewCfnSamplingRulePropsMixin(&CfnSamplingRuleMixinProps{
...
func (j *jsiiProxy_CfnSamplingRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSamplingRulePropsMixin(props *CfnSamplingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSamplingRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::XRay::SamplingRule`.
func NewCfnSamplingRulePropsMixin_Override(c CfnSamplingRulePropsMixin, props *CfnSamplingRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
