...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnGroupMixinProps",
		reflect.TypeOf((*CfnGroupMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnGroupPropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnGroupPropsMixin.InsightsConfigurationProperty",
		reflect.TypeOf((*CfnGroupPropsMixin_InsightsConfigurationProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnResourcePolicyMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnSamplingRuleMixinProps",
		reflect.TypeOf((*CfnSamplingRuleMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnSamplingRulePropsMixin",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnSamplingRulePropsMixin.SamplingRuleRecordProperty",
		reflect.TypeOf((*CfnSamplingRulePropsMixin_SamplingRuleRecordProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnSamplingRulePropsMixin.SamplingRuleUpdateProperty",
		reflect.TypeOf((*CfnSamplingRulePropsMixin_SamplingRuleUpdateProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_xray.CfnTransactionSearchConfigMixinProps",
