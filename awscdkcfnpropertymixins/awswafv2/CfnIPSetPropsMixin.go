...
//
//   cfnIPSetPropsMixin := awscdkcfnpropertymixins.Aws_wafv2.NewCfnIPSetPropsMixin(&CfnIPSetMixinProps{
//   	Addresses: []*string{
...
func (j *jsiiProxy_CfnIPSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnIPSetPropsMixin(props *CfnIPSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIPSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFv2::IPSet`.
func NewCfnIPSetPropsMixin_Override(c CfnIPSetPropsMixin, props *CfnIPSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
