...
func NewCfnRuleGroupPropsMixin(props *CfnRuleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRuleGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFv2::RuleGroup`.
func NewCfnRuleGroupPropsMixin_Override(c CfnRuleGroupPropsMixin, props *CfnRuleGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRuleGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
