...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awswafv2/internal"
...
//
//   cfnWebACLAssociationPropsMixin := awscdkcfnpropertymixins.Aws_wafv2.NewCfnWebACLAssociationPropsMixin(&CfnWebACLAssociationMixinProps{
...
func (j *jsiiProxy_CfnWebACLAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWebACLAssociationPropsMixin(props *CfnWebACLAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWebACLAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFv2::WebACLAssociation`.
func NewCfnWebACLAssociationPropsMixin_Override(c CfnWebACLAssociationPropsMixin, props *CfnWebACLAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWebACLAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
