...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsdatapipeline/internal"
...
//
//   cfnPipelinePropsMixin := awscdkcfnpropertymixins.Aws_datapipeline.NewCfnPipelinePropsMixin(&CfnPipelineMixinProps{
