...
//
//   cfnVodSourcePropsMixin := awscdkcfnpropertymixins.Aws_mediatailor.NewCfnVodSourcePropsMixin(&CfnVodSourceMixinProps{
...
func (j *jsiiProxy_CfnVodSourcePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnVodSourcePropsMixin(props *CfnVodSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnVodSourcePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaTailor::VodSource`.
func NewCfnVodSourcePropsMixin_Override(c CfnVodSourcePropsMixin, props *CfnVodSourceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
