...
//
//   cfnPlaybackConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_mediatailor.NewCfnPlaybackConfigurationPropsMixin(&CfnPlaybackConfigurationMixinProps{
...
func NewCfnPlaybackConfigurationPropsMixin(props *CfnPlaybackConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlaybackConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaTailor::PlaybackConfiguration`.
func NewCfnPlaybackConfigurationPropsMixin_Override(c CfnPlaybackConfigurationPropsMixin, props *CfnPlaybackConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPlaybackConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
