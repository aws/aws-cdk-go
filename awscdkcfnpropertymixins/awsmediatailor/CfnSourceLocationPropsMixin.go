...
//
//   cfnSourceLocationPropsMixin := awscdkcfnpropertymixins.Aws_mediatailor.NewCfnSourceLocationPropsMixin(&CfnSourceLocationMixinProps{
...
func (j *jsiiProxy_CfnSourceLocationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSourceLocationPropsMixin(props *CfnSourceLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSourceLocationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MediaTailor::SourceLocation`.
func NewCfnSourceLocationPropsMixin_Override(c CfnSourceLocationPropsMixin, props *CfnSourceLocationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
