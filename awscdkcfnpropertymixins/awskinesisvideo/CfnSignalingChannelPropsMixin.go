...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awskinesisvideo/internal"
...
//
//   cfnSignalingChannelPropsMixin := awscdkcfnpropertymixins.Aws_kinesisvideo.NewCfnSignalingChannelPropsMixin(&CfnSignalingChannelMixinProps{
...
func (j *jsiiProxy_CfnSignalingChannelPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSignalingChannelPropsMixin(props *CfnSignalingChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSignalingChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_kinesisvideo.CfnSignalingChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::KinesisVideo::SignalingChannel`.
func NewCfnSignalingChannelPropsMixin_Override(c CfnSignalingChannelPropsMixin, props *CfnSignalingChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSignalingChannelPropsMixin) ApplyTo(construct constructs.IConstruct) {
