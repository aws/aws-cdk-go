...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsautoscalingplans/internal"
...
//
//   cfnScalingPlanPropsMixin := awscdkcfnpropertymixins.Aws_autoscalingplans.NewCfnScalingPlanPropsMixin(&CfnScalingPlanMixinProps{
...
func NewCfnScalingPlanPropsMixin(props *CfnScalingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScalingPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::AutoScalingPlans::ScalingPlan`.
func NewCfnScalingPlanPropsMixin_Override(c CfnScalingPlanPropsMixin, props *CfnScalingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
