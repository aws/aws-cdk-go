...
//
//   cfnEnvironmentProfilePropsMixin := awscdkcfnpropertymixins.Aws_datazone.NewCfnEnvironmentProfilePropsMixin(&CfnEnvironmentProfileMixinProps{
...
func NewCfnEnvironmentProfilePropsMixin(props *CfnEnvironmentProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnvironmentProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::EnvironmentProfile`.
func NewCfnEnvironmentProfilePropsMixin_Override(c CfnEnvironmentProfilePropsMixin, props *CfnEnvironmentProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
