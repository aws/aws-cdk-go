...
//
//   cfnPolicyGrantPropsMixin := awscdkcfnpropertymixins.Aws_datazone.NewCfnPolicyGrantPropsMixin(&CfnPolicyGrantMixinProps{
...
func (j *jsiiProxy_CfnPolicyGrantPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPolicyGrantPropsMixin(props *CfnPolicyGrantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPolicyGrantPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::PolicyGrant`.
func NewCfnPolicyGrantPropsMixin_Override(c CfnPolicyGrantPropsMixin, props *CfnPolicyGrantMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPolicyGrantPropsMixin) ApplyTo(construct constructs.IConstruct) {
