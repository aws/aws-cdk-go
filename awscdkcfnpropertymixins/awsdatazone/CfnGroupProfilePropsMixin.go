...
func (j *jsiiProxy_CfnGroupProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGroupProfilePropsMixin(props *CfnGroupProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGroupProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::GroupProfile`.
func NewCfnGroupProfilePropsMixin_Override(c CfnGroupProfilePropsMixin, props *CfnGroupProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
