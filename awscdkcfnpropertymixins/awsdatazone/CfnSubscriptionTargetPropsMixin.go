...
//
//   cfnSubscriptionTargetPropsMixin := awscdkcfnpropertymixins.Aws_datazone.NewCfnSubscriptionTargetPropsMixin(&CfnSubscriptionTargetMixinProps{
...
func (j *jsiiProxy_CfnSubscriptionTargetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSubscriptionTargetPropsMixin(props *CfnSubscriptionTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSubscriptionTargetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::SubscriptionTarget`.
func NewCfnSubscriptionTargetPropsMixin_Override(c CfnSubscriptionTargetPropsMixin, props *CfnSubscriptionTargetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
