...
//
//   cfnOwnerPropsMixin := awscdkcfnpropertymixins.Aws_datazone.NewCfnOwnerPropsMixin(&CfnOwnerMixinProps{
...
func (j *jsiiProxy_CfnOwnerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOwnerPropsMixin(props *CfnOwnerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOwnerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::Owner`.
func NewCfnOwnerPropsMixin_Override(c CfnOwnerPropsMixin, props *CfnOwnerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
