...
//
//   cfnEnvironmentBlueprintConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_datazone.NewCfnEnvironmentBlueprintConfigurationPropsMixin(&CfnEnvironmentBlueprintConfigurationMixinProps{
...
func NewCfnEnvironmentBlueprintConfigurationPropsMixin(props *CfnEnvironmentBlueprintConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEnvironmentBlueprintConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataZone::EnvironmentBlueprintConfiguration`.
func NewCfnEnvironmentBlueprintConfigurationPropsMixin_Override(c CfnEnvironmentBlueprintConfigurationPropsMixin, props *CfnEnvironmentBlueprintConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
