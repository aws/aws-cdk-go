...
//
//   cfnMetricStreamPropsMixin := awscdkcfnpropertymixins.Aws_cloudwatch.NewCfnMetricStreamPropsMixin(&CfnMetricStreamMixinProps{
...
func (j *jsiiProxy_CfnMetricStreamPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMetricStreamPropsMixin(props *CfnMetricStreamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMetricStreamPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudWatch::MetricStream`.
func NewCfnMetricStreamPropsMixin_Override(c CfnMetricStreamPropsMixin, props *CfnMetricStreamMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMetricStreamPropsMixin) ApplyTo(construct constructs.IConstruct) {
