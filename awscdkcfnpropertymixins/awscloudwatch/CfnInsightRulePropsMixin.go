...
//
//   cfnInsightRulePropsMixin := awscdkcfnpropertymixins.Aws_cloudwatch.NewCfnInsightRulePropsMixin(&CfnInsightRuleMixinProps{
...
func (j *jsiiProxy_CfnInsightRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnInsightRulePropsMixin(props *CfnInsightRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInsightRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudWatch::InsightRule`.
func NewCfnInsightRulePropsMixin_Override(c CfnInsightRulePropsMixin, props *CfnInsightRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInsightRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
