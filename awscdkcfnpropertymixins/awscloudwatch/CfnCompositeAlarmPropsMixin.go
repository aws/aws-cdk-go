...
//
//   cfnCompositeAlarmPropsMixin := awscdkcfnpropertymixins.Aws_cloudwatch.NewCfnCompositeAlarmPropsMixin(&CfnCompositeAlarmMixinProps{
...
func NewCfnCompositeAlarmPropsMixin(props *CfnCompositeAlarmMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCompositeAlarmPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CloudWatch::CompositeAlarm`.
func NewCfnCompositeAlarmPropsMixin_Override(c CfnCompositeAlarmPropsMixin, props *CfnCompositeAlarmMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
