...
//
//   cfnConnectionAliasPropsMixin := awscdkcfnpropertymixins.Aws_workspaces.NewCfnConnectionAliasPropsMixin(&CfnConnectionAliasMixinProps{
...
func (j *jsiiProxy_CfnConnectionAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConnectionAliasPropsMixin(props *CfnConnectionAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConnectionAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WorkSpaces::ConnectionAlias`.
func NewCfnConnectionAliasPropsMixin_Override(c CfnConnectionAliasPropsMixin, props *CfnConnectionAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConnectionAliasPropsMixin) ApplyTo(construct constructs.IConstruct) {
