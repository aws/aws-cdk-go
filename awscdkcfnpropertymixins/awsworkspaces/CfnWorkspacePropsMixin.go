...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsworkspaces/internal"
...
//
//   cfnWorkspacePropsMixin := awscdkcfnpropertymixins.Aws_workspaces.NewCfnWorkspacePropsMixin(&CfnWorkspaceMixinProps{
