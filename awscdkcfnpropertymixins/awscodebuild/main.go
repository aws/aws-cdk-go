...
func init() {
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_codebuild.CfnSandboxMixinProps",
		reflect.TypeOf((*CfnSandboxMixinProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@aws-cdk/cfn-property-mixins.aws_codebuild.CfnSandboxPropsMixin",
		reflect.TypeOf((*CfnSandboxPropsMixin)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "applyTo", GoMethod: "ApplyTo"},
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberProperty{JsiiProperty: "strategy", GoGetter: "Strategy"},
		...
		func() interface{} {
			j := jsiiProxy_CfnSandboxPropsMixin{}
			_jsii_.InitJsiiProxy(&j.Type__awscdkMixin)
			_jsii_.InitJsiiProxy(&j.Type__constructsIMixin)
			return &j
		},
