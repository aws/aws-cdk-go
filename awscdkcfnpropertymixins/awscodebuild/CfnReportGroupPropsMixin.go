...
//
//   cfnReportGroupPropsMixin := awscdkcfnpropertymixins.Aws_codebuild.NewCfnReportGroupPropsMixin(&CfnReportGroupMixinProps{
...
func (j *jsiiProxy_CfnReportGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReportGroupPropsMixin(props *CfnReportGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReportGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CodeBuild::ReportGroup`.
func NewCfnReportGroupPropsMixin_Override(c CfnReportGroupPropsMixin, props *CfnReportGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReportGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
