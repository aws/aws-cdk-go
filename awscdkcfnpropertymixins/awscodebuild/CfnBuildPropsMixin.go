...
//
//   cfnBuildPropsMixin := awscdkcfnpropertymixins.Aws_codebuild.NewCfnBuildPropsMixin(&CfnBuildMixinProps{
...
func (j *jsiiProxy_CfnBuildPropsMixin) Strategy() awscdk.IMergeStrategy {
...
// Create a mixin to apply properties to `AWS::CodeBuild::Build`.
func NewCfnBuildPropsMixin(props *CfnBuildMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBuildPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_codebuild.CfnBuildPropsMixin",
...
// Create a mixin to apply properties to `AWS::CodeBuild::Build`.
func NewCfnBuildPropsMixin_Override(c CfnBuildPropsMixin, props *CfnBuildMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
