...
//
//   cfnReplicatorPropsMixin := awscdkcfnpropertymixins.Aws_msk.NewCfnReplicatorPropsMixin(&CfnReplicatorMixinProps{
...
func NewCfnReplicatorPropsMixin(props *CfnReplicatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicatorPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MSK::Replicator`.
func NewCfnReplicatorPropsMixin_Override(c CfnReplicatorPropsMixin, props *CfnReplicatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
