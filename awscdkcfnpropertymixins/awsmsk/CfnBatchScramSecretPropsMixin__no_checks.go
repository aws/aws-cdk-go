...
func validateNewCfnBatchScramSecretPropsMixinParameters(props *CfnBatchScramSecretMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
