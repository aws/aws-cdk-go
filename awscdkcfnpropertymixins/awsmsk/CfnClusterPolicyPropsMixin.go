...
//
//   cfnClusterPolicyPropsMixin := awscdkcfnpropertymixins.Aws_msk.NewCfnClusterPolicyPropsMixin(&CfnClusterPolicyMixinProps{
...
func (j *jsiiProxy_CfnClusterPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClusterPolicyPropsMixin(props *CfnClusterPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClusterPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::MSK::ClusterPolicy`.
func NewCfnClusterPolicyPropsMixin_Override(c CfnClusterPolicyPropsMixin, props *CfnClusterPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnClusterPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
