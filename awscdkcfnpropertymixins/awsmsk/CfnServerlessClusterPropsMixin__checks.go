...
func validateNewCfnServerlessClusterPropsMixinParameters(props *CfnServerlessClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
