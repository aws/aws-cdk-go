...
func validateNewCfnNotificationHubPropsMixinParameters(props *CfnNotificationHubMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
