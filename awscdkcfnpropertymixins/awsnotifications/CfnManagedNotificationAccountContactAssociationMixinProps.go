...
//
//   cfnManagedNotificationAccountContactAssociationMixinProps := &CfnManagedNotificationAccountContactAssociationMixinProps{
...
//
type CfnManagedNotificationAccountContactAssociationMixinProps struct {
	...
	//
	ContactIdentifier *string `field:"optional" json:"contactIdentifier" yaml:"contactIdentifier"`
