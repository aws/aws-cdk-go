...
//
//   cfnManagedNotificationAdditionalChannelAssociationPropsMixin := awscdkcfnpropertymixins.Aws_notifications.NewCfnManagedNotificationAdditionalChannelAssociationPropsMixin(&CfnManagedNotificationAdditionalChannelAssociationMixinProps{
...
func (j *jsiiProxy_CfnManagedNotificationAdditionalChannelAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnManagedNotificationAdditionalChannelAssociationPropsMixin(props *CfnManagedNotificationAdditionalChannelAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnManagedNotificationAdditionalChannelAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_notifications.CfnManagedNotificationAdditionalChannelAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Notifications::ManagedNotificationAdditionalChannelAssociation`.
func NewCfnManagedNotificationAdditionalChannelAssociationPropsMixin_Override(c CfnManagedNotificationAdditionalChannelAssociationPropsMixin, props *CfnManagedNotificationAdditionalChannelAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnManagedNotificationAdditionalChannelAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
