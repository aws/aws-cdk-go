...
//
//   cfnManagedNotificationAccountContactAssociationPropsMixin := awscdkcfnpropertymixins.Aws_notifications.NewCfnManagedNotificationAccountContactAssociationPropsMixin(&CfnManagedNotificationAccountContactAssociationMixinProps{
...
func NewCfnManagedNotificationAccountContactAssociationPropsMixin(props *CfnManagedNotificationAccountContactAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnManagedNotificationAccountContactAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_notifications.CfnManagedNotificationAccountContactAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::Notifications::ManagedNotificationAccountContactAssociation`.
func NewCfnManagedNotificationAccountContactAssociationPropsMixin_Override(c CfnManagedNotificationAccountContactAssociationPropsMixin, props *CfnManagedNotificationAccountContactAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
