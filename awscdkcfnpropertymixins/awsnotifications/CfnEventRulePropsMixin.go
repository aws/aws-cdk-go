...
//
//   cfnEventRulePropsMixin := awscdkcfnpropertymixins.Aws_notifications.NewCfnEventRulePropsMixin(&CfnEventRuleMixinProps{
...
func NewCfnEventRulePropsMixin(props *CfnEventRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventRulePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_notifications.CfnEventRulePropsMixin",
...
// Create a mixin to apply properties to `AWS::Notifications::EventRule`.
func NewCfnEventRulePropsMixin_Override(c CfnEventRulePropsMixin, props *CfnEventRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
