...
//
//   cfnReplicationSubnetGroupPropsMixin := awscdkcfnpropertymixins.Aws_dms.NewCfnReplicationSubnetGroupPropsMixin(&CfnReplicationSubnetGroupMixinProps{
...
func (j *jsiiProxy_CfnReplicationSubnetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReplicationSubnetGroupPropsMixin(props *CfnReplicationSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationSubnetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DMS::ReplicationSubnetGroup`.
func NewCfnReplicationSubnetGroupPropsMixin_Override(c CfnReplicationSubnetGroupPropsMixin, props *CfnReplicationSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnReplicationSubnetGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
