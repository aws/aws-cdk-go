...
func validateNewCfnEventSubscriptionPropsMixinParameters(props *CfnEventSubscriptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
