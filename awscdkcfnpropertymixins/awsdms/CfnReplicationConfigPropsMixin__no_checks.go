...
func validateNewCfnReplicationConfigPropsMixinParameters(props *CfnReplicationConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
