...
func validateNewCfnReplicationInstancePropsMixinParameters(props *CfnReplicationInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
