...
//
//   cfnDataProviderPropsMixin := awscdkcfnpropertymixins.Aws_dms.NewCfnDataProviderPropsMixin(&CfnDataProviderMixinProps{
...
func (j *jsiiProxy_CfnDataProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataProviderPropsMixin(props *CfnDataProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DMS::DataProvider`.
func NewCfnDataProviderPropsMixin_Override(c CfnDataProviderPropsMixin, props *CfnDataProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
