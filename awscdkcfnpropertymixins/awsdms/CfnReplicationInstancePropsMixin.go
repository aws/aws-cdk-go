...
//
//   cfnReplicationInstancePropsMixin := awscdkcfnpropertymixins.Aws_dms.NewCfnReplicationInstancePropsMixin(&CfnReplicationInstanceMixinProps{
...
func (j *jsiiProxy_CfnReplicationInstancePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReplicationInstancePropsMixin(props *CfnReplicationInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationInstancePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DMS::ReplicationInstance`.
func NewCfnReplicationInstancePropsMixin_Override(c CfnReplicationInstancePropsMixin, props *CfnReplicationInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
