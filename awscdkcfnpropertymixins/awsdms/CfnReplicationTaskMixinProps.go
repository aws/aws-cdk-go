...
//
//   cfnReplicationTaskMixinProps := &CfnReplicationTaskMixinProps{
...
//
type CfnReplicationTaskMixinProps struct {
	...
	//
	ReplicationInstanceArn *string `field:"optional" json:"replicationInstanceArn" yaml:"replicationInstanceArn"`
