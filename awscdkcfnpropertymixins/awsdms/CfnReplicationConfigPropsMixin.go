...
//
//   cfnReplicationConfigPropsMixin := awscdkcfnpropertymixins.Aws_dms.NewCfnReplicationConfigPropsMixin(&CfnReplicationConfigMixinProps{
...
func NewCfnReplicationConfigPropsMixin(props *CfnReplicationConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReplicationConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DMS::ReplicationConfig`.
func NewCfnReplicationConfigPropsMixin_Override(c CfnReplicationConfigPropsMixin, props *CfnReplicationConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
