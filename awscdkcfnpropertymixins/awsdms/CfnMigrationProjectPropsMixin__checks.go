...
func validateNewCfnMigrationProjectPropsMixinParameters(props *CfnMigrationProjectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
