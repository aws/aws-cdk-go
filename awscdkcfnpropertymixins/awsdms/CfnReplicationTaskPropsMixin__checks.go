...
func validateNewCfnReplicationTaskPropsMixinParameters(props *CfnReplicationTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
