...
func validateNewCfnReplicationSubnetGroupPropsMixinParameters(props *CfnReplicationSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
