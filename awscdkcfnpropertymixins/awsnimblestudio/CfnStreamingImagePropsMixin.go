...
//
//   cfnStreamingImagePropsMixin := awscdkcfnpropertymixins.Aws_nimblestudio.NewCfnStreamingImagePropsMixin(&CfnStreamingImageMixinProps{
...
func (j *jsiiProxy_CfnStreamingImagePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStreamingImagePropsMixin(props *CfnStreamingImageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamingImagePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NimbleStudio::StreamingImage`.
func NewCfnStreamingImagePropsMixin_Override(c CfnStreamingImagePropsMixin, props *CfnStreamingImageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStreamingImagePropsMixin) ApplyTo(construct constructs.IConstruct) {
