...
//
//   cfnLaunchProfilePropsMixin := awscdkcfnpropertymixins.Aws_nimblestudio.NewCfnLaunchProfilePropsMixin(&CfnLaunchProfileMixinProps{
...
func (j *jsiiProxy_CfnLaunchProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLaunchProfilePropsMixin(props *CfnLaunchProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLaunchProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::NimbleStudio::LaunchProfile`.
func NewCfnLaunchProfilePropsMixin_Override(c CfnLaunchProfilePropsMixin, props *CfnLaunchProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
