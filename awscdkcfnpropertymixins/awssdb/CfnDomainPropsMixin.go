...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awssdb/internal"
...
//
//   cfnDomainPropsMixin := awscdkcfnpropertymixins.Aws_sdb.NewCfnDomainPropsMixin(&CfnDomainMixinProps{
