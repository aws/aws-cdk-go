...
//
//   cfnExpressGatewayServicePropsMixin := awscdkcfnpropertymixins.Aws_ecs.NewCfnExpressGatewayServicePropsMixin(&CfnExpressGatewayServiceMixinProps{
...
func (j *jsiiProxy_CfnExpressGatewayServicePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnExpressGatewayServicePropsMixin(props *CfnExpressGatewayServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnExpressGatewayServicePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECS::ExpressGatewayService`.
func NewCfnExpressGatewayServicePropsMixin_Override(c CfnExpressGatewayServicePropsMixin, props *CfnExpressGatewayServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
