...
//
//   cfnTaskSetPropsMixin := awscdkcfnpropertymixins.Aws_ecs.NewCfnTaskSetPropsMixin(&CfnTaskSetMixinProps{
...
func (j *jsiiProxy_CfnTaskSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTaskSetPropsMixin(props *CfnTaskSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTaskSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECS::TaskSet`.
func NewCfnTaskSetPropsMixin_Override(c CfnTaskSetPropsMixin, props *CfnTaskSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnTaskSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
