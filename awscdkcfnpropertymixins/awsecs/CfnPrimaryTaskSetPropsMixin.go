...
//
//   cfnPrimaryTaskSetPropsMixin := awscdkcfnpropertymixins.Aws_ecs.NewCfnPrimaryTaskSetPropsMixin(&CfnPrimaryTaskSetMixinProps{
...
func NewCfnPrimaryTaskSetPropsMixin(props *CfnPrimaryTaskSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPrimaryTaskSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECS::PrimaryTaskSet`.
func NewCfnPrimaryTaskSetPropsMixin_Override(c CfnPrimaryTaskSetPropsMixin, props *CfnPrimaryTaskSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
