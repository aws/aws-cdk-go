...
//
//   cfnClusterCapacityProviderAssociationsPropsMixin := awscdkcfnpropertymixins.Aws_ecs.NewCfnClusterCapacityProviderAssociationsPropsMixin(&CfnClusterCapacityProviderAssociationsMixinProps{
...
func (j *jsiiProxy_CfnClusterCapacityProviderAssociationsPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClusterCapacityProviderAssociationsPropsMixin(props *CfnClusterCapacityProviderAssociationsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClusterCapacityProviderAssociationsPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECS::ClusterCapacityProviderAssociations`.
func NewCfnClusterCapacityProviderAssociationsPropsMixin_Override(c CfnClusterCapacityProviderAssociationsPropsMixin, props *CfnClusterCapacityProviderAssociationsMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
