...
//
//   cfnCapacityProviderPropsMixin := awscdkcfnpropertymixins.Aws_ecs.NewCfnCapacityProviderPropsMixin(&CfnCapacityProviderMixinProps{
...
func (j *jsiiProxy_CfnCapacityProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCapacityProviderPropsMixin(props *CfnCapacityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCapacityProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ECS::CapacityProvider`.
func NewCfnCapacityProviderPropsMixin_Override(c CfnCapacityProviderPropsMixin, props *CfnCapacityProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
