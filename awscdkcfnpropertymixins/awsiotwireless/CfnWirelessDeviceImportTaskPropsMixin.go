...
//
//   cfnWirelessDeviceImportTaskPropsMixin := awscdkcfnpropertymixins.Aws_iotwireless.NewCfnWirelessDeviceImportTaskPropsMixin(&CfnWirelessDeviceImportTaskMixinProps{
...
func (j *jsiiProxy_CfnWirelessDeviceImportTaskPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWirelessDeviceImportTaskPropsMixin(props *CfnWirelessDeviceImportTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWirelessDeviceImportTaskPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_iotwireless.CfnWirelessDeviceImportTaskPropsMixin",
...
// Create a mixin to apply properties to `AWS::IoTWireless::WirelessDeviceImportTask`.
func NewCfnWirelessDeviceImportTaskPropsMixin_Override(c CfnWirelessDeviceImportTaskPropsMixin, props *CfnWirelessDeviceImportTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWirelessDeviceImportTaskPropsMixin) ApplyTo(construct constructs.IConstruct) {
