...
//
//   cfnFuotaTaskPropsMixin := awscdkcfnpropertymixins.Aws_iotwireless.NewCfnFuotaTaskPropsMixin(&CfnFuotaTaskMixinProps{
...
func (j *jsiiProxy_CfnFuotaTaskPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFuotaTaskPropsMixin(props *CfnFuotaTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFuotaTaskPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_iotwireless.CfnFuotaTaskPropsMixin",
...
// Create a mixin to apply properties to `AWS::IoTWireless::FuotaTask`.
func NewCfnFuotaTaskPropsMixin_Override(c CfnFuotaTaskPropsMixin, props *CfnFuotaTaskMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFuotaTaskPropsMixin) ApplyTo(construct constructs.IConstruct) {
