...
//
//   cfnNetworkAnalyzerConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_iotwireless.NewCfnNetworkAnalyzerConfigurationPropsMixin(&CfnNetworkAnalyzerConfigurationMixinProps{
...
func (j *jsiiProxy_CfnNetworkAnalyzerConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnNetworkAnalyzerConfigurationPropsMixin(props *CfnNetworkAnalyzerConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnNetworkAnalyzerConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_iotwireless.CfnNetworkAnalyzerConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::IoTWireless::NetworkAnalyzerConfiguration`.
func NewCfnNetworkAnalyzerConfigurationPropsMixin_Override(c CfnNetworkAnalyzerConfigurationPropsMixin, props *CfnNetworkAnalyzerConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnNetworkAnalyzerConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
