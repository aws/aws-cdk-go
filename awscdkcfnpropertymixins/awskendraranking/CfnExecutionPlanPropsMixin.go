...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awskendraranking/internal"
...
//
//   cfnExecutionPlanPropsMixin := awscdkcfnpropertymixins.Aws_kendraranking.NewCfnExecutionPlanPropsMixin(&CfnExecutionPlanMixinProps{
...
func (j *jsiiProxy_CfnExecutionPlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnExecutionPlanPropsMixin(props *CfnExecutionPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnExecutionPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::KendraRanking::ExecutionPlan`.
func NewCfnExecutionPlanPropsMixin_Override(c CfnExecutionPlanPropsMixin, props *CfnExecutionPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnExecutionPlanPropsMixin) ApplyTo(construct constructs.IConstruct) {
