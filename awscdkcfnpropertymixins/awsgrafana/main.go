...
func init() {
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspaceMixinProps",
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspacePropsMixin.AssertionAttributesProperty",
		reflect.TypeOf((*CfnWorkspacePropsMixin_AssertionAttributesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspacePropsMixin.IdpMetadataProperty",
		reflect.TypeOf((*CfnWorkspacePropsMixin_IdpMetadataProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspacePropsMixin.NetworkAccessControlProperty",
		reflect.TypeOf((*CfnWorkspacePropsMixin_NetworkAccessControlProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspacePropsMixin.RoleValuesProperty",
		reflect.TypeOf((*CfnWorkspacePropsMixin_RoleValuesProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_grafana.CfnWorkspacePropsMixin.SamlConfigurationProperty",
