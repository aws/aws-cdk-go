...
//
//   cfnRecordSetPropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnRecordSetPropsMixin(&CfnRecordSetMixinProps{
...
func (j *jsiiProxy_CfnRecordSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRecordSetPropsMixin(props *CfnRecordSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRecordSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::RecordSet`.
func NewCfnRecordSetPropsMixin_Override(c CfnRecordSetPropsMixin, props *CfnRecordSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRecordSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
