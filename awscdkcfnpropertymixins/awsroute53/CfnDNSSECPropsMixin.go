...
//
//   cfnDNSSECPropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnDNSSECPropsMixin(&CfnDNSSECMixinProps{
...
func (j *jsiiProxy_CfnDNSSECPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDNSSECPropsMixin(props *CfnDNSSECMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDNSSECPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::DNSSEC`.
func NewCfnDNSSECPropsMixin_Override(c CfnDNSSECPropsMixin, props *CfnDNSSECMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
