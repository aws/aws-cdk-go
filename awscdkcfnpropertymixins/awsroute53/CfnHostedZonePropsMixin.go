...
//
//   cfnHostedZonePropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnHostedZonePropsMixin(&CfnHostedZoneMixinProps{
...
func (j *jsiiProxy_CfnHostedZonePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnHostedZonePropsMixin(props *CfnHostedZoneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHostedZonePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::HostedZone`.
func NewCfnHostedZonePropsMixin_Override(c CfnHostedZonePropsMixin, props *CfnHostedZoneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHostedZonePropsMixin) ApplyTo(construct constructs.IConstruct) {
