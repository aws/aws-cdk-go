...
//
//   cfnHealthCheckPropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnHealthCheckPropsMixin(&CfnHealthCheckMixinProps{
...
func NewCfnHealthCheckPropsMixin(props *CfnHealthCheckMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnHealthCheckPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::HealthCheck`.
func NewCfnHealthCheckPropsMixin_Override(c CfnHealthCheckPropsMixin, props *CfnHealthCheckMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnHealthCheckPropsMixin) ApplyTo(construct constructs.IConstruct) {
