...
//
//   cfnKeySigningKeyPropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnKeySigningKeyPropsMixin(&CfnKeySigningKeyMixinProps{
...
func (j *jsiiProxy_CfnKeySigningKeyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnKeySigningKeyPropsMixin(props *CfnKeySigningKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnKeySigningKeyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::KeySigningKey`.
func NewCfnKeySigningKeyPropsMixin_Override(c CfnKeySigningKeyPropsMixin, props *CfnKeySigningKeyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnKeySigningKeyPropsMixin) ApplyTo(construct constructs.IConstruct) {
