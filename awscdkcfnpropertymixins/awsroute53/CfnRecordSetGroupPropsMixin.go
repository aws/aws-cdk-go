...
//
//   cfnRecordSetGroupPropsMixin := awscdkcfnpropertymixins.Aws_route53.NewCfnRecordSetGroupPropsMixin(&CfnRecordSetGroupMixinProps{
...
func (j *jsiiProxy_CfnRecordSetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRecordSetGroupPropsMixin(props *CfnRecordSetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRecordSetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Route53::RecordSetGroup`.
func NewCfnRecordSetGroupPropsMixin_Override(c CfnRecordSetGroupPropsMixin, props *CfnRecordSetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
