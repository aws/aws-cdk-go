...
//
//   cfnScalingPolicyPropsMixin := awscdkcfnpropertymixins.Aws_applicationautoscaling.NewCfnScalingPolicyPropsMixin(&CfnScalingPolicyMixinProps{
...
func NewCfnScalingPolicyPropsMixin(props *CfnScalingPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnScalingPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ApplicationAutoScaling::ScalingPolicy`.
func NewCfnScalingPolicyPropsMixin_Override(c CfnScalingPolicyPropsMixin, props *CfnScalingPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnScalingPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
