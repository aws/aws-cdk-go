...
//
//   cfnCloudAutonomousVmClusterPropsMixin := awscdkcfnpropertymixins.Aws_odb.NewCfnCloudAutonomousVmClusterPropsMixin(&CfnCloudAutonomousVmClusterMixinProps{
...
func (j *jsiiProxy_CfnCloudAutonomousVmClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCloudAutonomousVmClusterPropsMixin(props *CfnCloudAutonomousVmClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCloudAutonomousVmClusterPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_odb.CfnCloudAutonomousVmClusterPropsMixin",
...
// Create a mixin to apply properties to `AWS::ODB::CloudAutonomousVmCluster`.
func NewCfnCloudAutonomousVmClusterPropsMixin_Override(c CfnCloudAutonomousVmClusterPropsMixin, props *CfnCloudAutonomousVmClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCloudAutonomousVmClusterPropsMixin) ApplyTo(construct constructs.IConstruct) {
