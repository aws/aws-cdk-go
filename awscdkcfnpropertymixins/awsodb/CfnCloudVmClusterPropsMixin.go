...
//
//   cfnCloudVmClusterPropsMixin := awscdkcfnpropertymixins.Aws_odb.NewCfnCloudVmClusterPropsMixin(&CfnCloudVmClusterMixinProps{
...
func (j *jsiiProxy_CfnCloudVmClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCloudVmClusterPropsMixin(props *CfnCloudVmClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCloudVmClusterPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_odb.CfnCloudVmClusterPropsMixin",
...
// Create a mixin to apply properties to `AWS::ODB::CloudVmCluster`.
func NewCfnCloudVmClusterPropsMixin_Override(c CfnCloudVmClusterPropsMixin, props *CfnCloudVmClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
