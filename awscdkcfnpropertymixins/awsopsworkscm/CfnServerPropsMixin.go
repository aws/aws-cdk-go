...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsopsworkscm/internal"
...
//
//   cfnServerPropsMixin := awscdkcfnpropertymixins.Aws_opsworkscm.NewCfnServerPropsMixin(&CfnServerMixinProps{
...
func (j *jsiiProxy_CfnServerPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServerPropsMixin(props *CfnServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServerPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_opsworkscm.CfnServerPropsMixin",
...
// Create a mixin to apply properties to `AWS::OpsWorksCM::Server`.
func NewCfnServerPropsMixin_Override(c CfnServerPropsMixin, props *CfnServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
