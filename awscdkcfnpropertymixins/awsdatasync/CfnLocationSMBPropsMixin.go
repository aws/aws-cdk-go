...
//
//   cfnLocationSMBPropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationSMBPropsMixin(&CfnLocationSMBMixinProps{
//   	AgentArns: []*string{
...
func (j *jsiiProxy_CfnLocationSMBPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationSMBPropsMixin(props *CfnLocationSMBMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationSMBPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationSMB`.
func NewCfnLocationSMBPropsMixin_Override(c CfnLocationSMBPropsMixin, props *CfnLocationSMBMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocationSMBPropsMixin) ApplyTo(construct constructs.IConstruct) {
