...
//
//   cfnLocationEFSPropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationEFSPropsMixin(&CfnLocationEFSMixinProps{
...
func NewCfnLocationEFSPropsMixin(props *CfnLocationEFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationEFSPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationEFS`.
func NewCfnLocationEFSPropsMixin_Override(c CfnLocationEFSPropsMixin, props *CfnLocationEFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
