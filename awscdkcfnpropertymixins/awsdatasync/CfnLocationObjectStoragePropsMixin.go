...
//
//   cfnLocationObjectStoragePropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationObjectStoragePropsMixin(&CfnLocationObjectStorageMixinProps{
...
func (j *jsiiProxy_CfnLocationObjectStoragePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationObjectStoragePropsMixin(props *CfnLocationObjectStorageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationObjectStoragePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationObjectStorage`.
func NewCfnLocationObjectStoragePropsMixin_Override(c CfnLocationObjectStoragePropsMixin, props *CfnLocationObjectStorageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
