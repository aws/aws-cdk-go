...
//
//   cfnLocationS3PropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationS3PropsMixin(&CfnLocationS3MixinProps{
...
func (j *jsiiProxy_CfnLocationS3PropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationS3PropsMixin(props *CfnLocationS3MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationS3PropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationS3`.
func NewCfnLocationS3PropsMixin_Override(c CfnLocationS3PropsMixin, props *CfnLocationS3MixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocationS3PropsMixin) ApplyTo(construct constructs.IConstruct) {
