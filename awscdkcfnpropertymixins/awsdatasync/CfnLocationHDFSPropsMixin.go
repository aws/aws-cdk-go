...
//
//   cfnLocationHDFSPropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationHDFSPropsMixin(&CfnLocationHDFSMixinProps{
//   	AgentArns: []*string{
...
func (j *jsiiProxy_CfnLocationHDFSPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationHDFSPropsMixin(props *CfnLocationHDFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationHDFSPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationHDFS`.
func NewCfnLocationHDFSPropsMixin_Override(c CfnLocationHDFSPropsMixin, props *CfnLocationHDFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocationHDFSPropsMixin) ApplyTo(construct constructs.IConstruct) {
