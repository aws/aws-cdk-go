...
//
//   cfnLocationFSxOpenZFSPropsMixin := awscdkcfnpropertymixins.Aws_datasync.NewCfnLocationFSxOpenZFSPropsMixin(&CfnLocationFSxOpenZFSMixinProps{
...
func (j *jsiiProxy_CfnLocationFSxOpenZFSPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLocationFSxOpenZFSPropsMixin(props *CfnLocationFSxOpenZFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLocationFSxOpenZFSPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::DataSync::LocationFSxOpenZFS`.
func NewCfnLocationFSxOpenZFSPropsMixin_Override(c CfnLocationFSxOpenZFSPropsMixin, props *CfnLocationFSxOpenZFSMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLocationFSxOpenZFSPropsMixin) ApplyTo(construct constructs.IConstruct) {
