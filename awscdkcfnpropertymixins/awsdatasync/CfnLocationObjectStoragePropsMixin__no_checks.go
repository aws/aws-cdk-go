...
func validateNewCfnLocationObjectStoragePropsMixinParameters(props *CfnLocationObjectStorageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
