...
//
//   cfnAnalysisTemplatePropsMixin := awscdkcfnpropertymixins.Aws_cleanrooms.NewCfnAnalysisTemplatePropsMixin(&CfnAnalysisTemplateMixinProps{
...
func (j *jsiiProxy_CfnAnalysisTemplatePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAnalysisTemplatePropsMixin(props *CfnAnalysisTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAnalysisTemplatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CleanRooms::AnalysisTemplate`.
func NewCfnAnalysisTemplatePropsMixin_Override(c CfnAnalysisTemplatePropsMixin, props *CfnAnalysisTemplateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAnalysisTemplatePropsMixin) ApplyTo(construct constructs.IConstruct) {
