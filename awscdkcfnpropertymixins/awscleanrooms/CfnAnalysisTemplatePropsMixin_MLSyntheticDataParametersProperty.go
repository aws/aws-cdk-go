...
//
type CfnAnalysisTemplatePropsMixin_MLSyntheticDataParametersProperty struct {
	...
	//
	ColumnClassification interface{} `field:"optional" json:"columnClassification" yaml:"columnClassification"`
