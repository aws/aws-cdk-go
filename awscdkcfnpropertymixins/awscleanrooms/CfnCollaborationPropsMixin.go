...
//
//   cfnCollaborationPropsMixin := awscdkcfnpropertymixins.Aws_cleanrooms.NewCfnCollaborationPropsMixin(&CfnCollaborationMixinProps{
...
func (j *jsiiProxy_CfnCollaborationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCollaborationPropsMixin(props *CfnCollaborationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCollaborationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CleanRooms::Collaboration`.
func NewCfnCollaborationPropsMixin_Override(c CfnCollaborationPropsMixin, props *CfnCollaborationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCollaborationPropsMixin) ApplyTo(construct constructs.IConstruct) {
