...
//
type CfnAnalysisTemplatePropsMixin_SyntheticDataParametersProperty struct {
	...
	//
	MlSyntheticDataParameters interface{} `field:"optional" json:"mlSyntheticDataParameters" yaml:"mlSyntheticDataParameters"`
}
