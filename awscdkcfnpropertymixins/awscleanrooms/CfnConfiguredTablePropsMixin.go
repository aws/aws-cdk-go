...
//
//   cfnConfiguredTablePropsMixin := awscdkcfnpropertymixins.Aws_cleanrooms.NewCfnConfiguredTablePropsMixin(&CfnConfiguredTableMixinProps{
...
func (j *jsiiProxy_CfnConfiguredTablePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConfiguredTablePropsMixin(props *CfnConfiguredTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfiguredTablePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CleanRooms::ConfiguredTable`.
func NewCfnConfiguredTablePropsMixin_Override(c CfnConfiguredTablePropsMixin, props *CfnConfiguredTableMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConfiguredTablePropsMixin) ApplyTo(construct constructs.IConstruct) {
