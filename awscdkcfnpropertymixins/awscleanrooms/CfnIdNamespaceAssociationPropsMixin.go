...
//
//   cfnIdNamespaceAssociationPropsMixin := awscdkcfnpropertymixins.Aws_cleanrooms.NewCfnIdNamespaceAssociationPropsMixin(&CfnIdNamespaceAssociationMixinProps{
...
func NewCfnIdNamespaceAssociationPropsMixin(props *CfnIdNamespaceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnIdNamespaceAssociationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CleanRooms::IdNamespaceAssociation`.
func NewCfnIdNamespaceAssociationPropsMixin_Override(c CfnIdNamespaceAssociationPropsMixin, props *CfnIdNamespaceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
