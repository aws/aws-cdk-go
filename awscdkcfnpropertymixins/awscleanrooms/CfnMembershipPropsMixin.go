...
//
//   cfnMembershipPropsMixin := awscdkcfnpropertymixins.Aws_cleanrooms.NewCfnMembershipPropsMixin(&CfnMembershipMixinProps{
...
func (j *jsiiProxy_CfnMembershipPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnMembershipPropsMixin(props *CfnMembershipMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnMembershipPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::CleanRooms::Membership`.
func NewCfnMembershipPropsMixin_Override(c CfnMembershipPropsMixin, props *CfnMembershipMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnMembershipPropsMixin) ApplyTo(construct constructs.IConstruct) {
