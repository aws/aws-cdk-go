...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awslookoutequipment/internal"
...
//
//   cfnInferenceSchedulerPropsMixin := awscdkcfnpropertymixins.Aws_lookoutequipment.NewCfnInferenceSchedulerPropsMixin(&CfnInferenceSchedulerMixinProps{
...
func NewCfnInferenceSchedulerPropsMixin(props *CfnInferenceSchedulerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInferenceSchedulerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LookoutEquipment::InferenceScheduler`.
func NewCfnInferenceSchedulerPropsMixin_Override(c CfnInferenceSchedulerPropsMixin, props *CfnInferenceSchedulerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnInferenceSchedulerPropsMixin) ApplyTo(construct constructs.IConstruct) {
