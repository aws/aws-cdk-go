...
//
//   cfnFieldPropsMixin := awscdkcfnpropertymixins.Aws_cases.NewCfnFieldPropsMixin(&CfnFieldMixinProps{
...
func (j *jsiiProxy_CfnFieldPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFieldPropsMixin(props *CfnFieldMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFieldPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Cases::Field`.
func NewCfnFieldPropsMixin_Override(c CfnFieldPropsMixin, props *CfnFieldMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
