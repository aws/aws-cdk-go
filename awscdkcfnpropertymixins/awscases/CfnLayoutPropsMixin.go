...
//
//   cfnLayoutPropsMixin := awscdkcfnpropertymixins.Aws_cases.NewCfnLayoutPropsMixin(&CfnLayoutMixinProps{
...
func (j *jsiiProxy_CfnLayoutPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLayoutPropsMixin(props *CfnLayoutMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLayoutPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_cases.CfnLayoutPropsMixin",
...
// Create a mixin to apply properties to `AWS::Cases::Layout`.
func NewCfnLayoutPropsMixin_Override(c CfnLayoutPropsMixin, props *CfnLayoutMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLayoutPropsMixin) ApplyTo(construct constructs.IConstruct) {
