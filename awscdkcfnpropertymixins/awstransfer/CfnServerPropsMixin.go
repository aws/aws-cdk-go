...
//
//   cfnServerPropsMixin := awscdkcfnpropertymixins.Aws_transfer.NewCfnServerPropsMixin(&CfnServerMixinProps{
...
func NewCfnServerPropsMixin(props *CfnServerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServerPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_transfer.CfnServerPropsMixin",
