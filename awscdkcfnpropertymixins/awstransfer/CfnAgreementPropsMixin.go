...
//
//   cfnAgreementPropsMixin := awscdkcfnpropertymixins.Aws_transfer.NewCfnAgreementPropsMixin(&CfnAgreementMixinProps{
...
func NewCfnAgreementPropsMixin(props *CfnAgreementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAgreementPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Transfer::Agreement`.
func NewCfnAgreementPropsMixin_Override(c CfnAgreementPropsMixin, props *CfnAgreementMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
