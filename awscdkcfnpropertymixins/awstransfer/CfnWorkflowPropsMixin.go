...
//
//   cfnWorkflowPropsMixin := awscdkcfnpropertymixins.Aws_transfer.NewCfnWorkflowPropsMixin(&CfnWorkflowMixinProps{
...
func NewCfnWorkflowPropsMixin(props *CfnWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkflowPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Transfer::Workflow`.
func NewCfnWorkflowPropsMixin_Override(c CfnWorkflowPropsMixin, props *CfnWorkflowMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
