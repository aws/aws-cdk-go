...
func validateNewCfnCodeSigningConfigPropsMixinParameters(props *CfnCodeSigningConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
