...
//
//   cfnUrlPropsMixin := awscdkcfnpropertymixins.Aws_lambda.NewCfnUrlPropsMixin(&CfnUrlMixinProps{
...
func (j *jsiiProxy_CfnUrlPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnUrlPropsMixin(props *CfnUrlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnUrlPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lambda::Url`.
func NewCfnUrlPropsMixin_Override(c CfnUrlPropsMixin, props *CfnUrlMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
