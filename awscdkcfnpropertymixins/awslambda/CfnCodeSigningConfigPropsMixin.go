...
//
//   cfnCodeSigningConfigPropsMixin := awscdkcfnpropertymixins.Aws_lambda.NewCfnCodeSigningConfigPropsMixin(&CfnCodeSigningConfigMixinProps{
...
func (j *jsiiProxy_CfnCodeSigningConfigPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCodeSigningConfigPropsMixin(props *CfnCodeSigningConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCodeSigningConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lambda::CodeSigningConfig`.
func NewCfnCodeSigningConfigPropsMixin_Override(c CfnCodeSigningConfigPropsMixin, props *CfnCodeSigningConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
