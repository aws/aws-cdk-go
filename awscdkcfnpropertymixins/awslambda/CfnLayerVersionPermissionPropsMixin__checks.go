...
func validateNewCfnLayerVersionPermissionPropsMixinParameters(props *CfnLayerVersionPermissionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
