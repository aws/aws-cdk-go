...
//
//   cfnEventSourceMappingPropsMixin := awscdkcfnpropertymixins.Aws_lambda.NewCfnEventSourceMappingPropsMixin(&CfnEventSourceMappingMixinProps{
...
func (j *jsiiProxy_CfnEventSourceMappingPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnEventSourceMappingPropsMixin(props *CfnEventSourceMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventSourceMappingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lambda::EventSourceMapping`.
func NewCfnEventSourceMappingPropsMixin_Override(c CfnEventSourceMappingPropsMixin, props *CfnEventSourceMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
