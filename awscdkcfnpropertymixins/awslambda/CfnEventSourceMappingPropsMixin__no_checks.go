...
func validateNewCfnEventSourceMappingPropsMixinParameters(props *CfnEventSourceMappingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
