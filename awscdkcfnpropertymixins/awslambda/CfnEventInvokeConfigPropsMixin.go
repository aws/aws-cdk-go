...
//
//   cfnEventInvokeConfigPropsMixin := awscdkcfnpropertymixins.Aws_lambda.NewCfnEventInvokeConfigPropsMixin(&CfnEventInvokeConfigMixinProps{
...
func NewCfnEventInvokeConfigPropsMixin(props *CfnEventInvokeConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEventInvokeConfigPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lambda::EventInvokeConfig`.
func NewCfnEventInvokeConfigPropsMixin_Override(c CfnEventInvokeConfigPropsMixin, props *CfnEventInvokeConfigMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
