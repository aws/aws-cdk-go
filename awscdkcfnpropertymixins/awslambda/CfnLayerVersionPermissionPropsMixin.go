...
//
//   cfnLayerVersionPermissionPropsMixin := awscdkcfnpropertymixins.Aws_lambda.NewCfnLayerVersionPermissionPropsMixin(&CfnLayerVersionPermissionMixinProps{
...
func (j *jsiiProxy_CfnLayerVersionPermissionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLayerVersionPermissionPropsMixin(props *CfnLayerVersionPermissionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLayerVersionPermissionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Lambda::LayerVersionPermission`.
func NewCfnLayerVersionPermissionPropsMixin_Override(c CfnLayerVersionPermissionPropsMixin, props *CfnLayerVersionPermissionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLayerVersionPermissionPropsMixin) ApplyTo(construct constructs.IConstruct) {
