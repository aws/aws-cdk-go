...
//
type CfnNetworkConnectorPropsMixin_VpcEgressConfigurationProperty struct {
	...
	//
	AssociatedComputeResourceTypes *[]*string `field:"optional" json:"associatedComputeResourceTypes" yaml:"associatedComputeResourceTypes"`
