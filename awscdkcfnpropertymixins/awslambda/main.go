...
func init() {
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_lambda.CfnFunctionPropsMixin.S3FilesConfigProperty",
		reflect.TypeOf((*CfnFunctionPropsMixin_S3FilesConfigProperty)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"@aws-cdk/cfn-property-mixins.aws_lambda.CfnResourcePolicyMixinProps",
