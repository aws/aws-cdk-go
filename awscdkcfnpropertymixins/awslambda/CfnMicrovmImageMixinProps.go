...
//
//   cfnMicrovmImageMixinProps := &CfnMicrovmImageMixinProps{
...
//
type CfnMicrovmImageMixinProps struct {
	...
	//
	BaseImageArn *string `field:"optional" json:"baseImageArn" yaml:"baseImageArn"`
	...
	//
	BuildRoleArn *string `field:"optional" json:"buildRoleArn" yaml:"buildRoleArn"`
	...
	//
	CpuConfigurations interface{} `field:"optional" json:"cpuConfigurations" yaml:"cpuConfigurations"`
