...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsevs/internal"
...
//
//   cfnEnvironmentPropsMixin := awscdkcfnpropertymixins.Aws_evs.NewCfnEnvironmentPropsMixin(&CfnEnvironmentMixinProps{
