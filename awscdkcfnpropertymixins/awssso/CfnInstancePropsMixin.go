...
//
//   cfnInstancePropsMixin := awscdkcfnpropertymixins.Aws_sso.NewCfnInstancePropsMixin(&CfnInstanceMixinProps{
...
func NewCfnInstancePropsMixin(props *CfnInstanceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstancePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_sso.CfnInstancePropsMixin",
