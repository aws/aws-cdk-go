...
//
//   cfnApplicationAssignmentPropsMixin := awscdkcfnpropertymixins.Aws_sso.NewCfnApplicationAssignmentPropsMixin(&CfnApplicationAssignmentMixinProps{
...
func (j *jsiiProxy_CfnApplicationAssignmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnApplicationAssignmentPropsMixin(props *CfnApplicationAssignmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationAssignmentPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_sso.CfnApplicationAssignmentPropsMixin",
...
// Create a mixin to apply properties to `AWS::SSO::ApplicationAssignment`.
func NewCfnApplicationAssignmentPropsMixin_Override(c CfnApplicationAssignmentPropsMixin, props *CfnApplicationAssignmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
