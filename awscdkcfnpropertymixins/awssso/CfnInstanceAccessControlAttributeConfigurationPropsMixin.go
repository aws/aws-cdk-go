...
//
//   cfnInstanceAccessControlAttributeConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_sso.NewCfnInstanceAccessControlAttributeConfigurationPropsMixin(&CfnInstanceAccessControlAttributeConfigurationMixinProps{
...
func NewCfnInstanceAccessControlAttributeConfigurationPropsMixin(props *CfnInstanceAccessControlAttributeConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnInstanceAccessControlAttributeConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSO::InstanceAccessControlAttributeConfiguration`.
func NewCfnInstanceAccessControlAttributeConfigurationPropsMixin_Override(c CfnInstanceAccessControlAttributeConfigurationPropsMixin, props *CfnInstanceAccessControlAttributeConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
