...
//
//   cfnAssignmentPropsMixin := awscdkcfnpropertymixins.Aws_sso.NewCfnAssignmentPropsMixin(&CfnAssignmentMixinProps{
...
func (j *jsiiProxy_CfnAssignmentPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAssignmentPropsMixin(props *CfnAssignmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAssignmentPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSO::Assignment`.
func NewCfnAssignmentPropsMixin_Override(c CfnAssignmentPropsMixin, props *CfnAssignmentMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAssignmentPropsMixin) ApplyTo(construct constructs.IConstruct) {
