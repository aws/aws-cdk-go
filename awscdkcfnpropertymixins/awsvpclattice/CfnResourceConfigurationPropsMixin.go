...
//
//   cfnResourceConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnResourceConfigurationPropsMixin(&CfnResourceConfigurationMixinProps{
...
func (j *jsiiProxy_CfnResourceConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceConfigurationPropsMixin(props *CfnResourceConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceConfigurationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnResourceConfigurationPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::ResourceConfiguration`.
func NewCfnResourceConfigurationPropsMixin_Override(c CfnResourceConfigurationPropsMixin, props *CfnResourceConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
