...
//
//   cfnServicePropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnServicePropsMixin(&CfnServiceMixinProps{
...
func NewCfnServicePropsMixin(props *CfnServiceMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServicePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnServicePropsMixin",
