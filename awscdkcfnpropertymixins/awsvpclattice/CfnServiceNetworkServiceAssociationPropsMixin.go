...
//
//   cfnServiceNetworkServiceAssociationPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnServiceNetworkServiceAssociationPropsMixin(&CfnServiceNetworkServiceAssociationMixinProps{
...
func (j *jsiiProxy_CfnServiceNetworkServiceAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceNetworkServiceAssociationPropsMixin(props *CfnServiceNetworkServiceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceNetworkServiceAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnServiceNetworkServiceAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::ServiceNetworkServiceAssociation`.
func NewCfnServiceNetworkServiceAssociationPropsMixin_Override(c CfnServiceNetworkServiceAssociationPropsMixin, props *CfnServiceNetworkServiceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
