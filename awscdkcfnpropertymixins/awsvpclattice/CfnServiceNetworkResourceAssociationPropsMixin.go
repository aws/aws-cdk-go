...
//
//   cfnServiceNetworkResourceAssociationPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnServiceNetworkResourceAssociationPropsMixin(&CfnServiceNetworkResourceAssociationMixinProps{
...
func (j *jsiiProxy_CfnServiceNetworkResourceAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceNetworkResourceAssociationPropsMixin(props *CfnServiceNetworkResourceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceNetworkResourceAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnServiceNetworkResourceAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::ServiceNetworkResourceAssociation`.
func NewCfnServiceNetworkResourceAssociationPropsMixin_Override(c CfnServiceNetworkResourceAssociationPropsMixin, props *CfnServiceNetworkResourceAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServiceNetworkResourceAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
