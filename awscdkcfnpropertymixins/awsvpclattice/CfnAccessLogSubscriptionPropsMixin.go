...
//
//   cfnAccessLogSubscriptionPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnAccessLogSubscriptionPropsMixin(&CfnAccessLogSubscriptionMixinProps{
...
func (j *jsiiProxy_CfnAccessLogSubscriptionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAccessLogSubscriptionPropsMixin(props *CfnAccessLogSubscriptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccessLogSubscriptionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnAccessLogSubscriptionPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::AccessLogSubscription`.
func NewCfnAccessLogSubscriptionPropsMixin_Override(c CfnAccessLogSubscriptionPropsMixin, props *CfnAccessLogSubscriptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
