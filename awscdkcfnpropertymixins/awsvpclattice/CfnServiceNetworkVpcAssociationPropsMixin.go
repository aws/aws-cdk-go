...
//
//   cfnServiceNetworkVpcAssociationPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnServiceNetworkVpcAssociationPropsMixin(&CfnServiceNetworkVpcAssociationMixinProps{
...
func (j *jsiiProxy_CfnServiceNetworkVpcAssociationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnServiceNetworkVpcAssociationPropsMixin(props *CfnServiceNetworkVpcAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnServiceNetworkVpcAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnServiceNetworkVpcAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::ServiceNetworkVpcAssociation`.
func NewCfnServiceNetworkVpcAssociationPropsMixin_Override(c CfnServiceNetworkVpcAssociationPropsMixin, props *CfnServiceNetworkVpcAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnServiceNetworkVpcAssociationPropsMixin) ApplyTo(construct constructs.IConstruct) {
