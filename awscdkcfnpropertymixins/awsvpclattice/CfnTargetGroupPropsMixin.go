...
//
//   cfnTargetGroupPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnTargetGroupPropsMixin(&CfnTargetGroupMixinProps{
...
func NewCfnTargetGroupPropsMixin(props *CfnTargetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTargetGroupPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnTargetGroupPropsMixin",
