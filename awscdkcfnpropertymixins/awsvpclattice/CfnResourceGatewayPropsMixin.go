...
//
//   cfnResourceGatewayPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnResourceGatewayPropsMixin(&CfnResourceGatewayMixinProps{
...
func NewCfnResourceGatewayPropsMixin(props *CfnResourceGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceGatewayPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnResourceGatewayPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::ResourceGateway`.
func NewCfnResourceGatewayPropsMixin_Override(c CfnResourceGatewayPropsMixin, props *CfnResourceGatewayMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnResourceGatewayPropsMixin) ApplyTo(construct constructs.IConstruct) {
