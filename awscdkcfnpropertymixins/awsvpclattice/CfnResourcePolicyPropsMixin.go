...
//
//   cfnResourcePolicyPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnResourcePolicyPropsMixin(&CfnResourcePolicyMixinProps{
//   	Policy: policy,
...
func NewCfnResourcePolicyPropsMixin(props *CfnResourcePolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourcePolicyPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnResourcePolicyPropsMixin",
