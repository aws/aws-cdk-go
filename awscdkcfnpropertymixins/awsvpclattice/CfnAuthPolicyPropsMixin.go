...
//
//   cfnAuthPolicyPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnAuthPolicyPropsMixin(&CfnAuthPolicyMixinProps{
//   	Policy: policy,
...
func (j *jsiiProxy_CfnAuthPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAuthPolicyPropsMixin(props *CfnAuthPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAuthPolicyPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnAuthPolicyPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::AuthPolicy`.
func NewCfnAuthPolicyPropsMixin_Override(c CfnAuthPolicyPropsMixin, props *CfnAuthPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAuthPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
