...
//
//   cfnRulePropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnRulePropsMixin(&CfnRuleMixinProps{
...
func NewCfnRulePropsMixin(props *CfnRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRulePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnRulePropsMixin",
