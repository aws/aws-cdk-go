...
//
//   cfnDomainVerificationPropsMixin := awscdkcfnpropertymixins.Aws_vpclattice.NewCfnDomainVerificationPropsMixin(&CfnDomainVerificationMixinProps{
...
func (j *jsiiProxy_CfnDomainVerificationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDomainVerificationPropsMixin(props *CfnDomainVerificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDomainVerificationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_vpclattice.CfnDomainVerificationPropsMixin",
...
// Create a mixin to apply properties to `AWS::VpcLattice::DomainVerification`.
func NewCfnDomainVerificationPropsMixin_Override(c CfnDomainVerificationPropsMixin, props *CfnDomainVerificationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDomainVerificationPropsMixin) ApplyTo(construct constructs.IConstruct) {
