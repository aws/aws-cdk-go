...
//
//   cfnBackupVaultPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnBackupVaultPropsMixin(&CfnBackupVaultMixinProps{
...
func NewCfnBackupVaultPropsMixin(props *CfnBackupVaultMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBackupVaultPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::BackupVault`.
func NewCfnBackupVaultPropsMixin_Override(c CfnBackupVaultPropsMixin, props *CfnBackupVaultMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
