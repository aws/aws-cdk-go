...
//
//   cfnLogicallyAirGappedBackupVaultPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnLogicallyAirGappedBackupVaultPropsMixin(&CfnLogicallyAirGappedBackupVaultMixinProps{
...
func (j *jsiiProxy_CfnLogicallyAirGappedBackupVaultPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLogicallyAirGappedBackupVaultPropsMixin(props *CfnLogicallyAirGappedBackupVaultMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLogicallyAirGappedBackupVaultPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::LogicallyAirGappedBackupVault`.
func NewCfnLogicallyAirGappedBackupVaultPropsMixin_Override(c CfnLogicallyAirGappedBackupVaultPropsMixin, props *CfnLogicallyAirGappedBackupVaultMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
