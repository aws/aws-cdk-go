...
func validateNewCfnBackupSelectionPropsMixinParameters(props *CfnBackupSelectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
