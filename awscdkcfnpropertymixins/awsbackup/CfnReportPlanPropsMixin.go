...
//
//   cfnReportPlanPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnReportPlanPropsMixin(&CfnReportPlanMixinProps{
...
func NewCfnReportPlanPropsMixin(props *CfnReportPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReportPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::ReportPlan`.
func NewCfnReportPlanPropsMixin_Override(c CfnReportPlanPropsMixin, props *CfnReportPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
