...
//
//   cfnTieringConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnTieringConfigurationPropsMixin(&CfnTieringConfigurationMixinProps{
...
func (j *jsiiProxy_CfnTieringConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnTieringConfigurationPropsMixin(props *CfnTieringConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTieringConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::TieringConfiguration`.
func NewCfnTieringConfigurationPropsMixin_Override(c CfnTieringConfigurationPropsMixin, props *CfnTieringConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
