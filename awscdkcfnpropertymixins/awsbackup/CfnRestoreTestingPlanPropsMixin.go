...
//
//   cfnRestoreTestingPlanPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnRestoreTestingPlanPropsMixin(&CfnRestoreTestingPlanMixinProps{
...
func (j *jsiiProxy_CfnRestoreTestingPlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRestoreTestingPlanPropsMixin(props *CfnRestoreTestingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRestoreTestingPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::RestoreTestingPlan`.
func NewCfnRestoreTestingPlanPropsMixin_Override(c CfnRestoreTestingPlanPropsMixin, props *CfnRestoreTestingPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRestoreTestingPlanPropsMixin) ApplyTo(construct constructs.IConstruct) {
