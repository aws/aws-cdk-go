...
//
//   cfnRestoreTestingSelectionPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnRestoreTestingSelectionPropsMixin(&CfnRestoreTestingSelectionMixinProps{
...
func NewCfnRestoreTestingSelectionPropsMixin(props *CfnRestoreTestingSelectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRestoreTestingSelectionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::RestoreTestingSelection`.
func NewCfnRestoreTestingSelectionPropsMixin_Override(c CfnRestoreTestingSelectionPropsMixin, props *CfnRestoreTestingSelectionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
