...
func validateNewCfnTieringConfigurationPropsMixinParameters(props *CfnTieringConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
