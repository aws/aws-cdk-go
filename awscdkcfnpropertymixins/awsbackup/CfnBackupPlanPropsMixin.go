...
//
//   cfnBackupPlanPropsMixin := awscdkcfnpropertymixins.Aws_backup.NewCfnBackupPlanPropsMixin(&CfnBackupPlanMixinProps{
...
func (j *jsiiProxy_CfnBackupPlanPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnBackupPlanPropsMixin(props *CfnBackupPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBackupPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Backup::BackupPlan`.
func NewCfnBackupPlanPropsMixin_Override(c CfnBackupPlanPropsMixin, props *CfnBackupPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
