...
//
//   cfnFirewallDomainListPropsMixin := awscdkcfnpropertymixins.Aws_route53globalresolver.NewCfnFirewallDomainListPropsMixin(&CfnFirewallDomainListMixinProps{
...
func (j *jsiiProxy_CfnFirewallDomainListPropsMixin) Strategy() awscdk.IMergeStrategy {
...
// Create a mixin to apply properties to `AWS::Route53GlobalResolver::FirewallDomainList`.
func NewCfnFirewallDomainListPropsMixin(props *CfnFirewallDomainListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFirewallDomainListPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_route53globalresolver.CfnFirewallDomainListPropsMixin",
...
// Create a mixin to apply properties to `AWS::Route53GlobalResolver::FirewallDomainList`.
func NewCfnFirewallDomainListPropsMixin_Override(c CfnFirewallDomainListPropsMixin, props *CfnFirewallDomainListMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
