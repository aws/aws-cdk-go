...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awskinesis/internal"
...
//
//   cfnStreamConsumerPropsMixin := awscdkcfnpropertymixins.Aws_kinesis.NewCfnStreamConsumerPropsMixin(&CfnStreamConsumerMixinProps{
...
func NewCfnStreamConsumerPropsMixin(props *CfnStreamConsumerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStreamConsumerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Kinesis::StreamConsumer`.
func NewCfnStreamConsumerPropsMixin_Override(c CfnStreamConsumerPropsMixin, props *CfnStreamConsumerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
