...
//
//   cfnLicensePropsMixin := awscdkcfnpropertymixins.Aws_licensemanager.NewCfnLicensePropsMixin(&CfnLicenseMixinProps{
...
func (j *jsiiProxy_CfnLicensePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLicensePropsMixin(props *CfnLicenseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLicensePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::LicenseManager::License`.
func NewCfnLicensePropsMixin_Override(c CfnLicensePropsMixin, props *CfnLicenseMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
