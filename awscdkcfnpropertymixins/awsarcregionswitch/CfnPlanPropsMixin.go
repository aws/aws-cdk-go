...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsarcregionswitch/internal"
...
//
//   cfnPlanPropsMixin := awscdkcfnpropertymixins.Aws_arcregionswitch.NewCfnPlanPropsMixin(&CfnPlanMixinProps{
...
func NewCfnPlanPropsMixin(props *CfnPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlanPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ARCRegionSwitch::Plan`.
func NewCfnPlanPropsMixin_Override(c CfnPlanPropsMixin, props *CfnPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnPlanPropsMixin) ApplyTo(construct constructs.IConstruct) {
