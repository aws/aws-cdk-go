...
//
//   cfnFeaturePropsMixin := awscdkcfnpropertymixins.Aws_evidently.NewCfnFeaturePropsMixin(&CfnFeatureMixinProps{
...
func (j *jsiiProxy_CfnFeaturePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFeaturePropsMixin(props *CfnFeatureMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFeaturePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Evidently::Feature`.
func NewCfnFeaturePropsMixin_Override(c CfnFeaturePropsMixin, props *CfnFeatureMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
