...
//
//   cfnLaunchTemplateConstraintPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnLaunchTemplateConstraintPropsMixin(&CfnLaunchTemplateConstraintMixinProps{
...
func (j *jsiiProxy_CfnLaunchTemplateConstraintPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLaunchTemplateConstraintPropsMixin(props *CfnLaunchTemplateConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLaunchTemplateConstraintPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnLaunchTemplateConstraintPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::LaunchTemplateConstraint`.
func NewCfnLaunchTemplateConstraintPropsMixin_Override(c CfnLaunchTemplateConstraintPropsMixin, props *CfnLaunchTemplateConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnLaunchTemplateConstraintPropsMixin) ApplyTo(construct constructs.IConstruct) {
