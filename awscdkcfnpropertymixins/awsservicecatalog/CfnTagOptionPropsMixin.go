...
//
//   cfnTagOptionPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnTagOptionPropsMixin(&CfnTagOptionMixinProps{
...
func NewCfnTagOptionPropsMixin(props *CfnTagOptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTagOptionPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnTagOptionPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::TagOption`.
func NewCfnTagOptionPropsMixin_Override(c CfnTagOptionPropsMixin, props *CfnTagOptionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
