...
//
//   cfnPortfolioSharePropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnPortfolioSharePropsMixin(&CfnPortfolioShareMixinProps{
...
func (j *jsiiProxy_CfnPortfolioSharePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnPortfolioSharePropsMixin(props *CfnPortfolioShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPortfolioSharePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnPortfolioSharePropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::PortfolioShare`.
func NewCfnPortfolioSharePropsMixin_Override(c CfnPortfolioSharePropsMixin, props *CfnPortfolioShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
