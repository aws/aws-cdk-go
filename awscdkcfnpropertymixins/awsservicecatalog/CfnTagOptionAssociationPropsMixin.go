...
//
//   cfnTagOptionAssociationPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnTagOptionAssociationPropsMixin(&CfnTagOptionAssociationMixinProps{
...
func NewCfnTagOptionAssociationPropsMixin(props *CfnTagOptionAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTagOptionAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnTagOptionAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::TagOptionAssociation`.
func NewCfnTagOptionAssociationPropsMixin_Override(c CfnTagOptionAssociationPropsMixin, props *CfnTagOptionAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
