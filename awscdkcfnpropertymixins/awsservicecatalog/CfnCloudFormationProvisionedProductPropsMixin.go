...
//
//   cfnCloudFormationProvisionedProductPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnCloudFormationProvisionedProductPropsMixin(&CfnCloudFormationProvisionedProductMixinProps{
...
func NewCfnCloudFormationProvisionedProductPropsMixin(props *CfnCloudFormationProvisionedProductMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCloudFormationProvisionedProductPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnCloudFormationProvisionedProductPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::CloudFormationProvisionedProduct`.
func NewCfnCloudFormationProvisionedProductPropsMixin_Override(c CfnCloudFormationProvisionedProductPropsMixin, props *CfnCloudFormationProvisionedProductMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
