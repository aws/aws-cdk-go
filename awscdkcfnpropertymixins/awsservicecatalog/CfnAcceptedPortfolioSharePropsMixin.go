...
//
//   cfnAcceptedPortfolioSharePropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnAcceptedPortfolioSharePropsMixin(&CfnAcceptedPortfolioShareMixinProps{
...
func NewCfnAcceptedPortfolioSharePropsMixin(props *CfnAcceptedPortfolioShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAcceptedPortfolioSharePropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnAcceptedPortfolioSharePropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::AcceptedPortfolioShare`.
func NewCfnAcceptedPortfolioSharePropsMixin_Override(c CfnAcceptedPortfolioSharePropsMixin, props *CfnAcceptedPortfolioShareMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
