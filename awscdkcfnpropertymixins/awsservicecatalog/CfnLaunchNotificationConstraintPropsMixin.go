...
//
//   cfnLaunchNotificationConstraintPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnLaunchNotificationConstraintPropsMixin(&CfnLaunchNotificationConstraintMixinProps{
...
func (j *jsiiProxy_CfnLaunchNotificationConstraintPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnLaunchNotificationConstraintPropsMixin(props *CfnLaunchNotificationConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLaunchNotificationConstraintPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnLaunchNotificationConstraintPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::LaunchNotificationConstraint`.
func NewCfnLaunchNotificationConstraintPropsMixin_Override(c CfnLaunchNotificationConstraintPropsMixin, props *CfnLaunchNotificationConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
