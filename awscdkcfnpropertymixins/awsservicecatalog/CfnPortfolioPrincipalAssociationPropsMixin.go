...
//
//   cfnPortfolioPrincipalAssociationPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnPortfolioPrincipalAssociationPropsMixin(&CfnPortfolioPrincipalAssociationMixinProps{
...
func NewCfnPortfolioPrincipalAssociationPropsMixin(props *CfnPortfolioPrincipalAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPortfolioPrincipalAssociationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnPortfolioPrincipalAssociationPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::PortfolioPrincipalAssociation`.
func NewCfnPortfolioPrincipalAssociationPropsMixin_Override(c CfnPortfolioPrincipalAssociationPropsMixin, props *CfnPortfolioPrincipalAssociationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
