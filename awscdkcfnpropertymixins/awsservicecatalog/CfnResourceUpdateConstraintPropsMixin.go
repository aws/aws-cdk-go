...
//
//   cfnResourceUpdateConstraintPropsMixin := awscdkcfnpropertymixins.Aws_servicecatalog.NewCfnResourceUpdateConstraintPropsMixin(&CfnResourceUpdateConstraintMixinProps{
...
func NewCfnResourceUpdateConstraintPropsMixin(props *CfnResourceUpdateConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceUpdateConstraintPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_servicecatalog.CfnResourceUpdateConstraintPropsMixin",
...
// Create a mixin to apply properties to `AWS::ServiceCatalog::ResourceUpdateConstraint`.
func NewCfnResourceUpdateConstraintPropsMixin_Override(c CfnResourceUpdateConstraintPropsMixin, props *CfnResourceUpdateConstraintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
