...
//
//   cfnAnnotationStorePropsMixin := awscdkcfnpropertymixins.Aws_omics.NewCfnAnnotationStorePropsMixin(&CfnAnnotationStoreMixinProps{
...
func (j *jsiiProxy_CfnAnnotationStorePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAnnotationStorePropsMixin(props *CfnAnnotationStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAnnotationStorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Omics::AnnotationStore`.
func NewCfnAnnotationStorePropsMixin_Override(c CfnAnnotationStorePropsMixin, props *CfnAnnotationStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAnnotationStorePropsMixin) ApplyTo(construct constructs.IConstruct) {
