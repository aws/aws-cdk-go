...
//
//   cfnReferenceStorePropsMixin := awscdkcfnpropertymixins.Aws_omics.NewCfnReferenceStorePropsMixin(&CfnReferenceStoreMixinProps{
...
func (j *jsiiProxy_CfnReferenceStorePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnReferenceStorePropsMixin(props *CfnReferenceStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnReferenceStorePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Omics::ReferenceStore`.
func NewCfnReferenceStorePropsMixin_Override(c CfnReferenceStorePropsMixin, props *CfnReferenceStoreMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
