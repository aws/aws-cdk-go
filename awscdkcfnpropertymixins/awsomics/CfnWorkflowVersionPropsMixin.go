...
//
//   cfnWorkflowVersionPropsMixin := awscdkcfnpropertymixins.Aws_omics.NewCfnWorkflowVersionPropsMixin(&CfnWorkflowVersionMixinProps{
...
func (j *jsiiProxy_CfnWorkflowVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnWorkflowVersionPropsMixin(props *CfnWorkflowVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWorkflowVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Omics::WorkflowVersion`.
func NewCfnWorkflowVersionPropsMixin_Override(c CfnWorkflowVersionPropsMixin, props *CfnWorkflowVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnWorkflowVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
