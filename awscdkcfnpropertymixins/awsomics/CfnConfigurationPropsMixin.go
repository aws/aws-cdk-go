...
//
//   cfnConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_omics.NewCfnConfigurationPropsMixin(&CfnConfigurationMixinProps{
...
func (j *jsiiProxy_CfnConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnConfigurationPropsMixin(props *CfnConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Omics::Configuration`.
func NewCfnConfigurationPropsMixin_Override(c CfnConfigurationPropsMixin, props *CfnConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
