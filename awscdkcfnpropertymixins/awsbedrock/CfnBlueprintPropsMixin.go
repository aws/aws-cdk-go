...
//
//   cfnBlueprintPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnBlueprintPropsMixin(&CfnBlueprintMixinProps{
...
func NewCfnBlueprintPropsMixin(props *CfnBlueprintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBlueprintPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::Blueprint`.
func NewCfnBlueprintPropsMixin_Override(c CfnBlueprintPropsMixin, props *CfnBlueprintMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnBlueprintPropsMixin) ApplyTo(construct constructs.IConstruct) {
