...
//
//   cfnGuardrailPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnGuardrailPropsMixin(&CfnGuardrailMixinProps{
...
func NewCfnGuardrailPropsMixin(props *CfnGuardrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGuardrailPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::Guardrail`.
func NewCfnGuardrailPropsMixin_Override(c CfnGuardrailPropsMixin, props *CfnGuardrailMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
