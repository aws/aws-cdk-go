...
//
//   cfnAgentAliasPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnAgentAliasPropsMixin(&CfnAgentAliasMixinProps{
...
func (j *jsiiProxy_CfnAgentAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAgentAliasPropsMixin(props *CfnAgentAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAgentAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::AgentAlias`.
func NewCfnAgentAliasPropsMixin_Override(c CfnAgentAliasPropsMixin, props *CfnAgentAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAgentAliasPropsMixin) ApplyTo(construct constructs.IConstruct) {
