...
//
//   cfnApplicationInferenceProfilePropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnApplicationInferenceProfilePropsMixin(&CfnApplicationInferenceProfileMixinProps{
...
func (j *jsiiProxy_CfnApplicationInferenceProfilePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnApplicationInferenceProfilePropsMixin(props *CfnApplicationInferenceProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnApplicationInferenceProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::ApplicationInferenceProfile`.
func NewCfnApplicationInferenceProfilePropsMixin_Override(c CfnApplicationInferenceProfilePropsMixin, props *CfnApplicationInferenceProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnApplicationInferenceProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
