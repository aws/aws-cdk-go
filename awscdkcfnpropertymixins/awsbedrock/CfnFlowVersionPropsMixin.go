...
//
//   cfnFlowVersionPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnFlowVersionPropsMixin(&CfnFlowVersionMixinProps{
...
func (j *jsiiProxy_CfnFlowVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowVersionPropsMixin(props *CfnFlowVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::FlowVersion`.
func NewCfnFlowVersionPropsMixin_Override(c CfnFlowVersionPropsMixin, props *CfnFlowVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFlowVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
