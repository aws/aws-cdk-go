...
//
//   cfnGuardrailVersionPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnGuardrailVersionPropsMixin(&CfnGuardrailVersionMixinProps{
...
func (j *jsiiProxy_CfnGuardrailVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGuardrailVersionPropsMixin(props *CfnGuardrailVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGuardrailVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::GuardrailVersion`.
func NewCfnGuardrailVersionPropsMixin_Override(c CfnGuardrailVersionPropsMixin, props *CfnGuardrailVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGuardrailVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
