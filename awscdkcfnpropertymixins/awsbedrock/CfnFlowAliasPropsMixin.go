...
//
//   cfnFlowAliasPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnFlowAliasPropsMixin(&CfnFlowAliasMixinProps{
...
func (j *jsiiProxy_CfnFlowAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFlowAliasPropsMixin(props *CfnFlowAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFlowAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::FlowAlias`.
func NewCfnFlowAliasPropsMixin_Override(c CfnFlowAliasPropsMixin, props *CfnFlowAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnFlowAliasPropsMixin) ApplyTo(construct constructs.IConstruct) {
