...
func validateNewCfnGuardrailVersionPropsMixinParameters(props *CfnGuardrailVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
