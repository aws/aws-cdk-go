...
//
//   cfnResourcePolicyPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnResourcePolicyPropsMixin(&CfnResourcePolicyMixinProps{
...
// Create a mixin to apply properties to `AWS::Bedrock::ResourcePolicy`.
