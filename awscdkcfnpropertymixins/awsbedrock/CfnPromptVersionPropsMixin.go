...
//
//   cfnPromptVersionPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnPromptVersionPropsMixin(&CfnPromptVersionMixinProps{
...
func NewCfnPromptVersionPropsMixin(props *CfnPromptVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPromptVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::PromptVersion`.
func NewCfnPromptVersionPropsMixin_Override(c CfnPromptVersionPropsMixin, props *CfnPromptVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
