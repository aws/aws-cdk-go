...
//
//   cfnSessionPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnSessionPropsMixin(&CfnSessionMixinProps{
...
// Create a mixin to apply properties to `AWS::Bedrock::Session`.
