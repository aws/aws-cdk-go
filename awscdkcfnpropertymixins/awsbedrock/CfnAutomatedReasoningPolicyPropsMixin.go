...
//
//   cfnAutomatedReasoningPolicyPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnAutomatedReasoningPolicyPropsMixin(&CfnAutomatedReasoningPolicyMixinProps{
...
func (j *jsiiProxy_CfnAutomatedReasoningPolicyPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAutomatedReasoningPolicyPropsMixin(props *CfnAutomatedReasoningPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAutomatedReasoningPolicyPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::AutomatedReasoningPolicy`.
func NewCfnAutomatedReasoningPolicyPropsMixin_Override(c CfnAutomatedReasoningPolicyPropsMixin, props *CfnAutomatedReasoningPolicyMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAutomatedReasoningPolicyPropsMixin) ApplyTo(construct constructs.IConstruct) {
