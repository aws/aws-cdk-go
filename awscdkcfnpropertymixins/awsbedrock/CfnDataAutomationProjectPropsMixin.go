...
//
//   cfnDataAutomationProjectPropsMixin := awscdkcfnpropertymixins.Aws_bedrock.NewCfnDataAutomationProjectPropsMixin(&CfnDataAutomationProjectMixinProps{
...
func (j *jsiiProxy_CfnDataAutomationProjectPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDataAutomationProjectPropsMixin(props *CfnDataAutomationProjectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDataAutomationProjectPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Bedrock::DataAutomationProject`.
func NewCfnDataAutomationProjectPropsMixin_Override(c CfnDataAutomationProjectPropsMixin, props *CfnDataAutomationProjectMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
