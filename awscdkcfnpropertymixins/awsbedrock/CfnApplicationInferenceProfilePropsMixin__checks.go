...
func validateNewCfnApplicationInferenceProfilePropsMixinParameters(props *CfnApplicationInferenceProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
