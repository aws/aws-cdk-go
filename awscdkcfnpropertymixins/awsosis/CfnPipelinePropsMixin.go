...
//
//   cfnPipelinePropsMixin := awscdkcfnpropertymixins.Aws_osis.NewCfnPipelinePropsMixin(&CfnPipelineMixinProps{
...
func NewCfnPipelinePropsMixin(props *CfnPipelineMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPipelinePropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_osis.CfnPipelinePropsMixin",
