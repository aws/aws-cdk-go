...
//
//   cfnDBParameterGroupPropsMixin := awscdkcfnpropertymixins.Aws_neptune.NewCfnDBParameterGroupPropsMixin(&CfnDBParameterGroupMixinProps{
...
func NewCfnDBParameterGroupPropsMixin(props *CfnDBParameterGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBParameterGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Neptune::DBParameterGroup`.
func NewCfnDBParameterGroupPropsMixin_Override(c CfnDBParameterGroupPropsMixin, props *CfnDBParameterGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
