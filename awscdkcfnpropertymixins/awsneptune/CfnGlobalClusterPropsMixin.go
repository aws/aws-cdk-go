...
//
//   cfnGlobalClusterPropsMixin := awscdkcfnpropertymixins.Aws_neptune.NewCfnGlobalClusterPropsMixin(&CfnGlobalClusterMixinProps{
...
// Create a mixin to apply properties to `AWS::Neptune::GlobalCluster`.
