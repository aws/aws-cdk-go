...
//
//   cfnDBClusterPropsMixin := awscdkcfnpropertymixins.Aws_neptune.NewCfnDBClusterPropsMixin(&CfnDBClusterMixinProps{
...
func (j *jsiiProxy_CfnDBClusterPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDBClusterPropsMixin(props *CfnDBClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDBClusterPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Neptune::DBCluster`.
func NewCfnDBClusterPropsMixin_Override(c CfnDBClusterPropsMixin, props *CfnDBClusterMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
