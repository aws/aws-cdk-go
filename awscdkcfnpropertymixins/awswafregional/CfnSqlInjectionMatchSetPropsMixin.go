...
//
//   cfnSqlInjectionMatchSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnSqlInjectionMatchSetPropsMixin(&CfnSqlInjectionMatchSetMixinProps{
...
func (j *jsiiProxy_CfnSqlInjectionMatchSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSqlInjectionMatchSetPropsMixin(props *CfnSqlInjectionMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSqlInjectionMatchSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::SqlInjectionMatchSet`.
func NewCfnSqlInjectionMatchSetPropsMixin_Override(c CfnSqlInjectionMatchSetPropsMixin, props *CfnSqlInjectionMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
