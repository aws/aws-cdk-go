...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awswafregional/internal"
...
//
//   cfnSizeConstraintSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnSizeConstraintSetPropsMixin(&CfnSizeConstraintSetMixinProps{
...
func (j *jsiiProxy_CfnSizeConstraintSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSizeConstraintSetPropsMixin(props *CfnSizeConstraintSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSizeConstraintSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::SizeConstraintSet`.
func NewCfnSizeConstraintSetPropsMixin_Override(c CfnSizeConstraintSetPropsMixin, props *CfnSizeConstraintSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSizeConstraintSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
