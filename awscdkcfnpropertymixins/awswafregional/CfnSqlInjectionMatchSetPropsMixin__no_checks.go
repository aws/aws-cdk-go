...
func validateNewCfnSqlInjectionMatchSetPropsMixinParameters(props *CfnSqlInjectionMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
