...
//
//   cfnXssMatchSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnXssMatchSetPropsMixin(&CfnXssMatchSetMixinProps{
...
func (j *jsiiProxy_CfnXssMatchSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnXssMatchSetPropsMixin(props *CfnXssMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnXssMatchSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::XssMatchSet`.
func NewCfnXssMatchSetPropsMixin_Override(c CfnXssMatchSetPropsMixin, props *CfnXssMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnXssMatchSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
