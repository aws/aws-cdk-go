...
//
//   cfnByteMatchSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnByteMatchSetPropsMixin(&CfnByteMatchSetMixinProps{
...
func (j *jsiiProxy_CfnByteMatchSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnByteMatchSetPropsMixin(props *CfnByteMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnByteMatchSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::ByteMatchSet`.
func NewCfnByteMatchSetPropsMixin_Override(c CfnByteMatchSetPropsMixin, props *CfnByteMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnByteMatchSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
