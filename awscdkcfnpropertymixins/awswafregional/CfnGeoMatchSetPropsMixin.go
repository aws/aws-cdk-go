...
//
//   cfnGeoMatchSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnGeoMatchSetPropsMixin(&CfnGeoMatchSetMixinProps{
...
func (j *jsiiProxy_CfnGeoMatchSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnGeoMatchSetPropsMixin(props *CfnGeoMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnGeoMatchSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::GeoMatchSet`.
func NewCfnGeoMatchSetPropsMixin_Override(c CfnGeoMatchSetPropsMixin, props *CfnGeoMatchSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnGeoMatchSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
