...
//
//   cfnRateBasedRulePropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnRateBasedRulePropsMixin(&CfnRateBasedRuleMixinProps{
...
func NewCfnRateBasedRulePropsMixin(props *CfnRateBasedRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRateBasedRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::RateBasedRule`.
func NewCfnRateBasedRulePropsMixin_Override(c CfnRateBasedRulePropsMixin, props *CfnRateBasedRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
