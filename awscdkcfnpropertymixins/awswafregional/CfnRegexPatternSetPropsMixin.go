...
//
//   cfnRegexPatternSetPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnRegexPatternSetPropsMixin(&CfnRegexPatternSetMixinProps{
...
func (j *jsiiProxy_CfnRegexPatternSetPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRegexPatternSetPropsMixin(props *CfnRegexPatternSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRegexPatternSetPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::RegexPatternSet`.
func NewCfnRegexPatternSetPropsMixin_Override(c CfnRegexPatternSetPropsMixin, props *CfnRegexPatternSetMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRegexPatternSetPropsMixin) ApplyTo(construct constructs.IConstruct) {
