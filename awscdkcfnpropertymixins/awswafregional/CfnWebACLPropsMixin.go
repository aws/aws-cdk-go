...
//
//   cfnWebACLPropsMixin := awscdkcfnpropertymixins.Aws_wafregional.NewCfnWebACLPropsMixin(&CfnWebACLMixinProps{
...
func NewCfnWebACLPropsMixin(props *CfnWebACLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnWebACLPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::WAFRegional::WebACL`.
func NewCfnWebACLPropsMixin_Override(c CfnWebACLPropsMixin, props *CfnWebACLMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
