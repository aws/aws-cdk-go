...
//
//   cfnClusterSecurityGroupIngressPropsMixin := awscdkcfnpropertymixins.Aws_redshift.NewCfnClusterSecurityGroupIngressPropsMixin(&CfnClusterSecurityGroupIngressMixinProps{
...
func (j *jsiiProxy_CfnClusterSecurityGroupIngressPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClusterSecurityGroupIngressPropsMixin(props *CfnClusterSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClusterSecurityGroupIngressPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Redshift::ClusterSecurityGroupIngress`.
func NewCfnClusterSecurityGroupIngressPropsMixin_Override(c CfnClusterSecurityGroupIngressPropsMixin, props *CfnClusterSecurityGroupIngressMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
