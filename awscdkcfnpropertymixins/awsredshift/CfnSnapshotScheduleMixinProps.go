...
//
//   cfnSnapshotScheduleMixinProps := &CfnSnapshotScheduleMixinProps{
...
//
type CfnSnapshotScheduleMixinProps struct {
	...
	//
	ScheduleDefinitions *[]*string `field:"optional" json:"scheduleDefinitions" yaml:"scheduleDefinitions"`
	...
	//
	ScheduleIdentifier *string `field:"optional" json:"scheduleIdentifier" yaml:"scheduleIdentifier"`
