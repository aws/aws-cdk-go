...
//
//   cfnClusterSubnetGroupPropsMixin := awscdkcfnpropertymixins.Aws_redshift.NewCfnClusterSubnetGroupPropsMixin(&CfnClusterSubnetGroupMixinProps{
...
func (j *jsiiProxy_CfnClusterSubnetGroupPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnClusterSubnetGroupPropsMixin(props *CfnClusterSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnClusterSubnetGroupPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Redshift::ClusterSubnetGroup`.
func NewCfnClusterSubnetGroupPropsMixin_Override(c CfnClusterSubnetGroupPropsMixin, props *CfnClusterSubnetGroupMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnClusterSubnetGroupPropsMixin) ApplyTo(construct constructs.IConstruct) {
