...
//
//   cfnPlanPropsMixin := awscdkcfnpropertymixins.Aws_ssmcontacts.NewCfnPlanPropsMixin(&CfnPlanMixinProps{
...
func NewCfnPlanPropsMixin(props *CfnPlanMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnPlanPropsMixin {
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ssmcontacts.CfnPlanPropsMixin",
