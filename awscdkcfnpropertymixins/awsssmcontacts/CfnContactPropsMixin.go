...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsssmcontacts/internal"
...
//
//   cfnContactPropsMixin := awscdkcfnpropertymixins.Aws_ssmcontacts.NewCfnContactPropsMixin(&CfnContactMixinProps{
...
func (j *jsiiProxy_CfnContactPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnContactPropsMixin(props *CfnContactMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnContactPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ssmcontacts.CfnContactPropsMixin",
...
// Create a mixin to apply properties to `AWS::SSMContacts::Contact`.
func NewCfnContactPropsMixin_Override(c CfnContactPropsMixin, props *CfnContactMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnContactPropsMixin) ApplyTo(construct constructs.IConstruct) {
