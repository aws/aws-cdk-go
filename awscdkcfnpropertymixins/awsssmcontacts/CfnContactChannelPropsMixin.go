...
//
//   cfnContactChannelPropsMixin := awscdkcfnpropertymixins.Aws_ssmcontacts.NewCfnContactChannelPropsMixin(&CfnContactChannelMixinProps{
...
func NewCfnContactChannelPropsMixin(props *CfnContactChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnContactChannelPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ssmcontacts.CfnContactChannelPropsMixin",
...
// Create a mixin to apply properties to `AWS::SSMContacts::ContactChannel`.
func NewCfnContactChannelPropsMixin_Override(c CfnContactChannelPropsMixin, props *CfnContactChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
