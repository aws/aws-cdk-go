...
//
//   cfnRotationPropsMixin := awscdkcfnpropertymixins.Aws_ssmcontacts.NewCfnRotationPropsMixin(&CfnRotationMixinProps{
//   	ContactIds: []*string{
...
func NewCfnRotationPropsMixin(props *CfnRotationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRotationPropsMixin {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@aws-cdk/cfn-property-mixins.aws_ssmcontacts.CfnRotationPropsMixin",
...
// Create a mixin to apply properties to `AWS::SSMContacts::Rotation`.
func NewCfnRotationPropsMixin_Override(c CfnRotationPropsMixin, props *CfnRotationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnRotationPropsMixin) ApplyTo(construct constructs.IConstruct) {
