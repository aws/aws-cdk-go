...
//
//   cfnBranchPropsMixin := awscdkcfnpropertymixins.Aws_amplify.NewCfnBranchPropsMixin(&CfnBranchMixinProps{
...
func NewCfnBranchPropsMixin(props *CfnBranchMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnBranchPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Amplify::Branch`.
func NewCfnBranchPropsMixin_Override(c CfnBranchPropsMixin, props *CfnBranchMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
