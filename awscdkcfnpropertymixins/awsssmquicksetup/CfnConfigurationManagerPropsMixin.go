...
//
//   cfnConfigurationManagerPropsMixin := awscdkcfnpropertymixins.Aws_ssmquicksetup.NewCfnConfigurationManagerPropsMixin(&CfnConfigurationManagerMixinProps{
...
func NewCfnConfigurationManagerPropsMixin(props *CfnConfigurationManagerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationManagerPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::SSMQuickSetup::ConfigurationManager`.
func NewCfnConfigurationManagerPropsMixin_Override(c CfnConfigurationManagerPropsMixin, props *CfnConfigurationManagerMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
