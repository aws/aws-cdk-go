...
//
//   cfnResourceSpecificLoggingPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnResourceSpecificLoggingPropsMixin(&CfnResourceSpecificLoggingMixinProps{
...
func (j *jsiiProxy_CfnResourceSpecificLoggingPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnResourceSpecificLoggingPropsMixin(props *CfnResourceSpecificLoggingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnResourceSpecificLoggingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::ResourceSpecificLogging`.
func NewCfnResourceSpecificLoggingPropsMixin_Override(c CfnResourceSpecificLoggingPropsMixin, props *CfnResourceSpecificLoggingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
