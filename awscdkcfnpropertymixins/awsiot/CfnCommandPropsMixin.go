...
//
//   cfnCommandPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnCommandPropsMixin(&CfnCommandMixinProps{
...
func NewCfnCommandPropsMixin(props *CfnCommandMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCommandPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::Command`.
func NewCfnCommandPropsMixin_Override(c CfnCommandPropsMixin, props *CfnCommandMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
