...
//
//   cfnEncryptionConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnEncryptionConfigurationPropsMixin(&CfnEncryptionConfigurationMixinProps{
...
func NewCfnEncryptionConfigurationPropsMixin(props *CfnEncryptionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnEncryptionConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::EncryptionConfiguration`.
func NewCfnEncryptionConfigurationPropsMixin_Override(c CfnEncryptionConfigurationPropsMixin, props *CfnEncryptionConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnEncryptionConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
