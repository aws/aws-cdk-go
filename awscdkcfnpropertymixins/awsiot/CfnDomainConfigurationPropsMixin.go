...
//
//   cfnDomainConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnDomainConfigurationPropsMixin(&CfnDomainConfigurationMixinProps{
...
func NewCfnDomainConfigurationPropsMixin(props *CfnDomainConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDomainConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::DomainConfiguration`.
func NewCfnDomainConfigurationPropsMixin_Override(c CfnDomainConfigurationPropsMixin, props *CfnDomainConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
