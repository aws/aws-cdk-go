...
//
//   cfnCertificateProviderPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnCertificateProviderPropsMixin(&CfnCertificateProviderMixinProps{
...
func (j *jsiiProxy_CfnCertificateProviderPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnCertificateProviderPropsMixin(props *CfnCertificateProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCertificateProviderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::CertificateProvider`.
func NewCfnCertificateProviderPropsMixin_Override(c CfnCertificateProviderPropsMixin, props *CfnCertificateProviderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnCertificateProviderPropsMixin) ApplyTo(construct constructs.IConstruct) {
