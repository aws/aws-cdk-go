...
//
//   cfnSoftwarePackageVersionPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnSoftwarePackageVersionPropsMixin(&CfnSoftwarePackageVersionMixinProps{
...
func (j *jsiiProxy_CfnSoftwarePackageVersionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnSoftwarePackageVersionPropsMixin(props *CfnSoftwarePackageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSoftwarePackageVersionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::SoftwarePackageVersion`.
func NewCfnSoftwarePackageVersionPropsMixin_Override(c CfnSoftwarePackageVersionPropsMixin, props *CfnSoftwarePackageVersionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSoftwarePackageVersionPropsMixin) ApplyTo(construct constructs.IConstruct) {
