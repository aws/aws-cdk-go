...
//
//   cfnThingTypePropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnThingTypePropsMixin(&CfnThingTypeMixinProps{
...
func NewCfnThingTypePropsMixin(props *CfnThingTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnThingTypePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::ThingType`.
func NewCfnThingTypePropsMixin_Override(c CfnThingTypePropsMixin, props *CfnThingTypeMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
