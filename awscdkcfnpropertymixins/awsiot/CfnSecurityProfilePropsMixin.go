...
//
//   cfnSecurityProfilePropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnSecurityProfilePropsMixin(&CfnSecurityProfileMixinProps{
...
func NewCfnSecurityProfilePropsMixin(props *CfnSecurityProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSecurityProfilePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::SecurityProfile`.
func NewCfnSecurityProfilePropsMixin_Override(c CfnSecurityProfilePropsMixin, props *CfnSecurityProfileMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnSecurityProfilePropsMixin) ApplyTo(construct constructs.IConstruct) {
