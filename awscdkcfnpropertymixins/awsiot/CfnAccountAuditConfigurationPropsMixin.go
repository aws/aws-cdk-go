...
//
//   cfnAccountAuditConfigurationPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnAccountAuditConfigurationPropsMixin(&CfnAccountAuditConfigurationMixinProps{
...
func (j *jsiiProxy_CfnAccountAuditConfigurationPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnAccountAuditConfigurationPropsMixin(props *CfnAccountAuditConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnAccountAuditConfigurationPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::AccountAuditConfiguration`.
func NewCfnAccountAuditConfigurationPropsMixin_Override(c CfnAccountAuditConfigurationPropsMixin, props *CfnAccountAuditConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnAccountAuditConfigurationPropsMixin) ApplyTo(construct constructs.IConstruct) {
