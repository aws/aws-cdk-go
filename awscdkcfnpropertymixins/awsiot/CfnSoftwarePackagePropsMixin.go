...
//
//   cfnSoftwarePackagePropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnSoftwarePackagePropsMixin(&CfnSoftwarePackageMixinProps{
...
func NewCfnSoftwarePackagePropsMixin(props *CfnSoftwarePackageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnSoftwarePackagePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::SoftwarePackage`.
func NewCfnSoftwarePackagePropsMixin_Override(c CfnSoftwarePackagePropsMixin, props *CfnSoftwarePackageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
