...
//
//   cfnFleetMetricPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnFleetMetricPropsMixin(&CfnFleetMetricMixinProps{
...
func (j *jsiiProxy_CfnFleetMetricPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnFleetMetricPropsMixin(props *CfnFleetMetricMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnFleetMetricPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::FleetMetric`.
func NewCfnFleetMetricPropsMixin_Override(c CfnFleetMetricPropsMixin, props *CfnFleetMetricMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
