...
func validateNewCfnMitigationActionPropsMixinParameters(props *CfnMitigationActionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
