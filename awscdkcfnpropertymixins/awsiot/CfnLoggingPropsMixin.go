...
//
//   cfnLoggingPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnLoggingPropsMixin(&CfnLoggingMixinProps{
...
func NewCfnLoggingPropsMixin(props *CfnLoggingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLoggingPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::Logging`.
func NewCfnLoggingPropsMixin_Override(c CfnLoggingPropsMixin, props *CfnLoggingMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
