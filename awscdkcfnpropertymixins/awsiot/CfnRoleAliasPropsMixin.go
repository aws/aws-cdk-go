...
//
//   cfnRoleAliasPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnRoleAliasPropsMixin(&CfnRoleAliasMixinProps{
...
func (j *jsiiProxy_CfnRoleAliasPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnRoleAliasPropsMixin(props *CfnRoleAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnRoleAliasPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::RoleAlias`.
func NewCfnRoleAliasPropsMixin_Override(c CfnRoleAliasPropsMixin, props *CfnRoleAliasMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
