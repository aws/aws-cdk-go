...
//
//   cfnCACertificatePropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnCACertificatePropsMixin(&CfnCACertificateMixinProps{
...
func NewCfnCACertificatePropsMixin(props *CfnCACertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnCACertificatePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::CACertificate`.
func NewCfnCACertificatePropsMixin_Override(c CfnCACertificatePropsMixin, props *CfnCACertificateMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
