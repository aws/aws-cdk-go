...
//
//   cfnDimensionPropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnDimensionPropsMixin(&CfnDimensionMixinProps{
...
func (j *jsiiProxy_CfnDimensionPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnDimensionPropsMixin(props *CfnDimensionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDimensionPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::Dimension`.
func NewCfnDimensionPropsMixin_Override(c CfnDimensionPropsMixin, props *CfnDimensionMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnDimensionPropsMixin) ApplyTo(construct constructs.IConstruct) {
