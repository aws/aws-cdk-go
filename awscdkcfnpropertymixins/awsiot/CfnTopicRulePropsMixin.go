...
//
//   cfnTopicRulePropsMixin := awscdkcfnpropertymixins.Aws_iot.NewCfnTopicRulePropsMixin(&CfnTopicRuleMixinProps{
...
func NewCfnTopicRulePropsMixin(props *CfnTopicRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnTopicRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::IoT::TopicRule`.
func NewCfnTopicRulePropsMixin_Override(c CfnTopicRulePropsMixin, props *CfnTopicRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
