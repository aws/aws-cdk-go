...
func validateNewCfnSoftwarePackagePropsMixinParameters(props *CfnSoftwarePackageMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
