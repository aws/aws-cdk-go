...
//
//   cfnLandingZonePropsMixin := awscdkcfnpropertymixins.Aws_controltower.NewCfnLandingZonePropsMixin(&CfnLandingZoneMixinProps{
//   	Manifest: manifest,
...
func NewCfnLandingZonePropsMixin(props *CfnLandingZoneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnLandingZonePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::ControlTower::LandingZone`.
func NewCfnLandingZonePropsMixin_Override(c CfnLandingZonePropsMixin, props *CfnLandingZoneMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
