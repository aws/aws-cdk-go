...
import (
	...
	"github.com/aws/aws-cdk-go/awscdkcfnpropertymixins/v2/awsrbin/internal"
...
//
//   cfnRulePropsMixin := awscdkcfnpropertymixins.Aws_rbin.NewCfnRulePropsMixin(&CfnRuleMixinProps{
