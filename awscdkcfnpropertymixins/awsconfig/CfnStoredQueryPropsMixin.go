...
//
//   cfnStoredQueryPropsMixin := awscdkcfnpropertymixins.Aws_config.NewCfnStoredQueryPropsMixin(&CfnStoredQueryMixinProps{
...
func (j *jsiiProxy_CfnStoredQueryPropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnStoredQueryPropsMixin(props *CfnStoredQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnStoredQueryPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Config::StoredQuery`.
func NewCfnStoredQueryPropsMixin_Override(c CfnStoredQueryPropsMixin, props *CfnStoredQueryMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnStoredQueryPropsMixin) ApplyTo(construct constructs.IConstruct) {
