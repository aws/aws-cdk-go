...
func validateNewCfnConformancePackPropsMixinParameters(props *CfnConformancePackMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
