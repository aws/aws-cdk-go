...
func validateNewCfnConfigurationRecorderPropsMixinParameters(props *CfnConfigurationRecorderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
