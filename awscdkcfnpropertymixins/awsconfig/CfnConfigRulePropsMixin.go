...
//
//   cfnConfigRulePropsMixin := awscdkcfnpropertymixins.Aws_config.NewCfnConfigRulePropsMixin(&CfnConfigRuleMixinProps{
...
func NewCfnConfigRulePropsMixin(props *CfnConfigRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Config::ConfigRule`.
func NewCfnConfigRulePropsMixin_Override(c CfnConfigRulePropsMixin, props *CfnConfigRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
