...
//
//   cfnOrganizationConfigRulePropsMixin := awscdkcfnpropertymixins.Aws_config.NewCfnOrganizationConfigRulePropsMixin(&CfnOrganizationConfigRuleMixinProps{
...
func (j *jsiiProxy_CfnOrganizationConfigRulePropsMixin) Strategy() awscdk.IMergeStrategy {
...
func NewCfnOrganizationConfigRulePropsMixin(props *CfnOrganizationConfigRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnOrganizationConfigRulePropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Config::OrganizationConfigRule`.
func NewCfnOrganizationConfigRulePropsMixin_Override(c CfnOrganizationConfigRulePropsMixin, props *CfnOrganizationConfigRuleMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnOrganizationConfigRulePropsMixin) ApplyTo(construct constructs.IConstruct) {
