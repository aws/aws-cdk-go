...
func validateNewCfnConfigurationAggregatorPropsMixinParameters(props *CfnConfigurationAggregatorMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	return nil
}
