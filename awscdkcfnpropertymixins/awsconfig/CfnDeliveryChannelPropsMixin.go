...
//
//   cfnDeliveryChannelPropsMixin := awscdkcfnpropertymixins.Aws_config.NewCfnDeliveryChannelPropsMixin(&CfnDeliveryChannelMixinProps{
...
func NewCfnDeliveryChannelPropsMixin(props *CfnDeliveryChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnDeliveryChannelPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Config::DeliveryChannel`.
func NewCfnDeliveryChannelPropsMixin_Override(c CfnDeliveryChannelPropsMixin, props *CfnDeliveryChannelMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
