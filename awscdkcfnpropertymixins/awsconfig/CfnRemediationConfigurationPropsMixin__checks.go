...
func validateNewCfnRemediationConfigurationPropsMixinParameters(props *CfnRemediationConfigurationMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) error {
	if props == nil {
