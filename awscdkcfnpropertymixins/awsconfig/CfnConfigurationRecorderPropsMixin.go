...
//
//   cfnConfigurationRecorderPropsMixin := awscdkcfnpropertymixins.Aws_config.NewCfnConfigurationRecorderPropsMixin(&CfnConfigurationRecorderMixinProps{
...
func NewCfnConfigurationRecorderPropsMixin(props *CfnConfigurationRecorderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) CfnConfigurationRecorderPropsMixin {
	_init_.Initialize()
...
// Create a mixin to apply properties to `AWS::Config::ConfigurationRecorder`.
func NewCfnConfigurationRecorderPropsMixin_Override(c CfnConfigurationRecorderPropsMixin, props *CfnConfigurationRecorderMixinProps, options *awscdkcfnpropertymixins.CfnPropertyMixinOptions) {
	_init_.Initialize()
...
func (c *jsiiProxy_CfnConfigurationRecorderPropsMixin) ApplyTo(construct constructs.IConstruct) {
